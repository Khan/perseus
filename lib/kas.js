...
case 41:return "TRIG"
break;
case 42:yy_.yytext = "sin"; return "TRIG"
break;
case 43:yy_.yytext = "cos"; return "TRIG"
break;
case 44:yy_.yytext = "tan"; return "TRIG"
break;
case 45:yy_.yytext = "csc"; return "TRIG"
break;
case 46:yy_.yytext = "sec"; return "TRIG"
break;
case 47:yy_.yytext = "cot"; return "TRIG"
break;
case 48:yy_.yytext = "arcsin"; return "TRIG"
break;
case 49:yy_.yytext = "arccos"; return "TRIG"
break;
case 50:yy_.yytext = "arctan"; return "TRIG"
break;
case 51:yy_.yytext = "arccsc"; return "TRIG"
break;
case 52:yy_.yytext = "arcsec"; return "TRIG"
break;
case 53:yy_.yytext = "arccot"; return "TRIG"
break;
case 54:return "TRIGINV"
break;
case 55:return "TRIGINV"
break;
case 56:return "CONST"
break;
case 57:yy_.yytext = "pi"; return "CONST"
break;
case 58:yy_.yytext = "pi"; return "CONST"
break;
case 59:return "VAR"
break;
case 60:yy_.yytext = "theta"; return "VAR"
break;
case 61:yy_.yytext = "theta"; return "VAR"
break;
case 62:return "VAR"
break;
case 63:yy_.yytext = "phi"; return "VAR"
break;
case 64:yy_.yytext = "phi"; return "VAR"
break;
case 65:return yy.symbolLexer(yy_.yytext)
break;
case 66:return "EOF"
break;
...
rules: [/^(?:\s+)/,/^(?:\\space)/,/^(?:\\ )/,/^(?:[0-9]+\.?)/,/^(?:([0-9]+)?\.[0-9]+)/,/^(?:\*\*)/,/^(?:\*)/,/^(?:\\cdot|·)/,/^(?:\\times|×)/,/^(?:\/)/,/^(?:-)/,/^(?:−)/,/^(?:\+)/,/^(?:\^)/,/^(?:\()/,/^(?:\))/,/^(?:\\left\()/,/^(?:\\right\))/,/^(?:\{)/,/^(?:\})/,/^(?:\\left\{)/,/^(?:\\right\})/,/^(?:_)/,/^(?:\|)/,/^(?:\\left\|)/,/^(?:\\right\|)/,/^(?:\!)/,/^(?:<=|>=|<>|<|>|=)/,/^(?:\\le)/,/^(?:\\ge)/,/^(?:=\/=)/,/^(?:\\ne)/,/^(?:≠)/,/^(?:≤)/,/^(?:≥)/,/^(?:\\frac)/,/^(?:sqrt|\\sqrt)/,/^(?:abs|\\abs)/,/^(?:ln|\\ln)/,/^(?:log|\\log)/,/^(?:sin|cos|tan)/,/^(?:csc|sec|cot)/,/^(?:\\sin)/,/^(?:\\cos)/,/^(?:\\tan)/,/^(?:\\csc)/,/^(?:\\sec)/,/^(?:\\cot)/,/^(?:\\arcsin)/,/^(?:\\arccos)/,/^(?:\\arctan)/,/^(?:\\arccsc)/,/^(?:\\arcsec)/,/^(?:\\arccot)/,/^(?:arcsin|arccos|arctan)/,/^(?:arccsc|arcsec|arccot)/,/^(?:pi)/,/^(?:π)/,/^(?:\\pi)/,/^(?:theta)/,/^(?:θ)/,/^(?:\\theta)/,/^(?:phi)/,/^(?:φ)/,/^(?:\\phi)/,/^(?:[a-zA-Z])/,/^(?:$)/,/^(?:.)/,/^(?:.)/,/^(?:\\div|÷)/],
    ...
    */
    ...
    if (!vars.equal) {
        ...
        if (vars.equalIgnoringCase) {
            message = "你的答案其實很接近了！請將字母換成正確的大小寫噢！";
        }
    ...
    if (options.form && !expr1.sameForm(expr2)) {
        return {equal: false, message: "你的列式錯誤"};
    }

    // syntactic check
    if (options.simplify && !expr1.isSimplified()) {
        return {equal: false, message: "你的答案未化簡或未展開"};
    }
