...
const extractRawCode = function(elem) {
...
function addExamplesToInput($input, examples) {
    ...
    const $examples = $('<ul class="examples" style="display: none"></ul>');
...
function numberAnswerType(forms) {
    return {
        setupFunctional: function(solutionarea, solutionText, solutionData) {
            return KhanAnswerTypes.number.setupFunctional(
                    solutionarea,
                    solutionText,
...
const KhanAnswerTypes = {
    ...
    letters: {
        setupFunctional: function(solutionarea, solutionText, solutionData) {
            return KhanAnswerTypes.text.setupFunctional(
                solutionarea, solutionText, solutionData, 'letters');
        },
        createValidatorFunctional: function(correct, options) {
            return KhanAnswerTypes.text.createValidatorFunctional(
                correct, options);
        },
    },
    ...
    lowers: {
        setupFunctional: function(solutionarea, solutionText, solutionData) {
            return KhanAnswerTypes.text.setupFunctional(
                solutionarea, solutionText, solutionData, 'lowers');
        },
        createValidatorFunctional: function(correct, options) {
            return KhanAnswerTypes.text.createValidatorFunctional(
                correct, options);
    ...
    caps: {
        setupFunctional: function(solutionarea, solutionText, solutionData) {
            return KhanAnswerTypes.text.setupFunctional(
                solutionarea, solutionText, solutionData, 'caps');
        },
        createValidatorFunctional: function(correct, options) {
            return KhanAnswerTypes.text.createValidatorFunctional(
                correct, options);
    ...
    text: {
        setupFunctional: function(solutionarea, solutionText, solutionData,
            ...
            if (window.Modernizr && Modernizr.touchevents) {
                ...
                input = $('<input data-solution-grammar="' +
                          solutionGrammar +
            ...
            return {
                validator: KhanAnswerTypes.text.createValidatorFunctional(
    ...
    predicate: {
        ...
        setupFunctional: function(solutionarea, solutionText, solutionData) {
            ...
            const acceptableForms = options.forms.split(/\s*,\s*/);
            ...
            const $input = $('<input type="text" autocapitalize="off">');
            $(solutionarea).append($input);
            ...
            const exampleForms = {
                ...
                improper: (function() {
                    if (options.simplify === "optional") {
                        return i18n._(
                            "an <em>improper</em> fraction, like " +
                                "<code>10/7</code> or <code>14/8</code>");
                    } else {
                        return i18n._(
                            "a <em>simplified improper</em> " +
                                "fraction, like <code>7/4</code>");
                    }
                })(),

                pi: i18n._("a multiple of pi, like <code>12\\ \\text{pi}" +
                           "</code> or <code>2/3\\ \\text{pi}</code>"),
            ...
            if (options.forms !== KhanAnswerTypes.predicate.defaultForms) {
                addExamplesToInput($input, examples);
            }

            return {
                validator: KhanAnswerTypes.predicate.createValidatorFunctional(
                        solutionText, solutionData),
                answer: function() {
                    return $input.val();
                },
    ...
    number: {
        ...
        setupFunctional: function(solutionarea, solutionText, solutionData) {
            const args = KhanAnswerTypes.number.convertToPredicate(
                    solutionText, solutionData);
            return KhanAnswerTypes.predicate.setupFunctional(
                    solutionarea,
    ...
    regex: {
        setupFunctional: function(solutionarea, solutionText, solutionData) {
            ...
            return {
                validator: KhanAnswerTypes.regex.createValidatorFunctional(
                    solutionText, solutionData),
                answer: function() {
                    return input.val();
                },
    ...
    radical: {
        setupFunctional: function(solutionarea, solutionText, solutionData) {
            ...
            // Add two input boxes
            const inte = $('<input type="text" autocapitalize="off">');
            const rad = $('<input type="text" autocapitalize="off">');

            const examples = (options.simplify === "required") ?
        ...
        createValidatorFunctional: function(ansSquared, options) {
            ...
            return function(guess) {
                ...
                const inteGuess = parseFloat(guess[0]);
                const radGuess = parseFloat(guess[1]);
                ...
                const simplified = inteGuess === ans[0] && radGuess === ans[1];
                ...
                if (correct) {
                    if (simplified || options.simplify === "optional") {
                        ...
                        score.message = i18n._(
                            "Your answer is almost correct, but it needs to " +
                                "be simplified.");
                    }
                }
                return score;
    ...
    cuberoot: {
        setupFunctional: function(solutionarea, solutionText, solutionData) {
            ...
            $("<div class='radical'>")
                .append($("<span>").append(inte))
                .append('<span class="surd" style="vertical-align: 6px;">' +
                        '<code>\\sqrt[3]{}</code></span>')
                .append($("<span>").append(rad).addClass("overline"))
        ...
        createValidatorFunctional: function(ansCubed, options) {
            ...
            return function(guess) {
                ...
                // given solution
                const correct =
                    Math.abs(inteGuess) * inteGuess * inteGuess * radGuess ===
                    ansCubed;
                // the answer is simplified if the sqrt portion and integer
    ...
    multiple: {
        setup: function(solutionarea, solution) {
            ...
            $(solutionarea).find(".sol").each(function(idx) {
                ...
                const sol = $(solution).find(".sol").eq(idx);

                // empty the .sol element in preperation for treating it as a
                // solutionarea
                const solarea = $(this).empty();

                // perform setup on each of the areas
                const answerData = KhanAnswerTypes[type].setup(solarea, sol);
        ...
        createValidator: function(solution) {
            ...
            $(solution).find(".sol").each(function() {
                ...
                let type = sol.data("type");
                type = type != null ? type : "number";

                // create a validator for each of the solutions
                const validator = KhanAnswerTypes[type].createValidator(sol);
    ...
    set: {
        setup: function(solutionarea, solution) {
            ...
            $(solutionarea).find(".entry").each(function() {
                ...
                const sol = input.clone(true);
                const solarea = input.empty();

                // Perform setup within that element
                const validator = KhanAnswerTypes[type].setup(solarea, sol);
            ...
            $(solution).find(".set-sol").clone(true).each(function() {
                ...
                const validator = KhanAnswerTypes[type].setup(
                    solarea, $(this));
        ...
        createValidator: function(solution) {
            ...
            $(solution).find(".set-sol").clone(true).each(function() {
                ...
                const validator = KhanAnswerTypes[type]
            ...
            return function(guess) {
                ...
                const unusedValidators = validatorArray.slice(0);
    ...
    radio: {
        setup: function(solutionarea, solution) {
            ...
            const $choices = $(solution).siblings(".choices");
            ...
            const $choicesClone = $choices.clone(true).texCleanup();
            const $solutionClone = $(solution).clone(true).texCleanup();

            // Retrieve the text of the solution so we can store it later
            const solutionText = $solutionClone.text();

            // Whether this is a category question, or if we should shuffle the
            // answers up.
            const isCategory = !!$choices.data("category");
            ...
            if (isCategory) {
                ...
                const correctText = getTextSquish($solutionClone);
            ...
            const noneIsCorrect = showNone && correctIndex === numChoices - 1;
            ...
            if (showNone) {
                const $none = $("<span>").html(i18n._("None of the above"));
                ...
                let noneIndex = shownChoices.length - 1;
                if (addNoneChoice) {
            ...
            const wrappedChoices = _.map(shownChoices, function(choice, i) {
            ...
            return {
                ...
                answer: function() {
                    ...
                    const $choice = $list.find("input:checked");
        ...
        createValidator: function(solution) {
            ...
            function showReal() {
                ...
                $choice.next().fadeOut("fast", function() {
                    const $real = $list.data("realAnswer");
    ...
    list: {
        setupFunctional: function(solutionarea, solutionText, solutionData) {
            ...
            // Get the choices
            const choices = $.tmpl.getVAR(solutionData.choices);
            ...
            return {
                validator: KhanAnswerTypes.list.createValidatorFunctional(
                        solutionText, solutionData),
                answer: function() {
                    return input.val();
                },
    ...
    custom: {
        setup: function(solutionarea, solution) {
            ...
            // Retrieve some code
            const guessCode = solution.find(".guess").text();
            const showCustomGuessCode = solution.find(".show-guess").text();
            const showGuessCode =
                solution.find(".show-guess-solutionarea").text();
        ...
        createValidator: function(solution) {
            // store some code
            const validatorCode =
                $(solution).find(".validator-function").text();

            const validator = function(guess) {
    ...
    primeFactorization: {
        ...
        setupFunctional: function(solutionarea, solutionText, solutionData) {
            ...
            const examples = [
                i18n._("a product of prime factors, like <code>2 \\times 3" +
                       "</code>"),
            ...
            return {
                validator: KhanAnswerTypes.primeFactorization
                    .createValidatorFunctional(solutionText, solutionData),
                answer: function() {
                    return $input.val();
                },
                solution: $.trim(solutionText),
    ...
    checkbox: {
        setupFunctional: function(solutionarea, solutionText, solutionData) {
            ...
            return {
                validator: KhanAnswerTypes.checkbox.createValidatorFunctional(
                        solutionText, solutionData),
                answer: function() {
    ...
    expression: {
        setup: function(solutionarea, solution) {
            const options = this._parseOptions($(solution).data());

            // Assemble the solution area
            const $tex = $('<span class="tex"/>');
            const $input = $('<input type="text">');
            const $error = $('<div class="error-div" style="display: none;"/>');
                ...
                $('<span class="expression"/>').append(
                    ...
                    $('<span class="input"/>').append(
                        ...
                        $error.append(
                            ...
                            //
                            // TODO(riley): Replace this with a wrapped SVG
                            //              generated by <InlineIcon />
            ...
            const update = function() {
                ...
                const result = KAS.parse($input.val(), options);
                if (result.parsed) {
                    hideError();
                    $tex.css({opacity: 1.0});
                    const tex = result.expr.asTex(options);
            ...
            $input.on("keydown", function(event) {
                ...
                if (supported && event.which === 8 /* backspace */) {
                    ...
                    if (start === end &&
                            val.slice(start - 1, start + 1) === "()") {
                        // "f(|)" + backspace -> "f|" (| is the cursor position)
                        event.preventDefault();
                        input.value = val.slice(0, start - 1) +
                            val.slice(start + 1);
            ...
            // Examples
            let explicitMul = i18n._("For <code>2\\cdot2</code>, enter " +
                                     "<strong>2*2</strong>");
            ...
            const examples = [
                explicitMul,
                i18n._("For <code>3y</code>, enter <strong>3y</strong> or " +
                       "<strong>3*y</strong>"),
                i18n._("For <code>\\dfrac{1}{x}</code>, enter <strong>1/x" +
                       "</strong>"),
                i18n._("For <code>x^{y}</code>, enter <strong>x^y</strong>"),
                i18n._("For <code>\\sqrt{x}</code>, enter <strong>sqrt(x)" +
                       "</strong>"),
                i18n._("For <code>\\pi</code>, enter <strong>pi</strong>"),
                i18n._("For <code>\\sin \\theta</code>, enter <strong>" +
                       "sin(theta)</strong>"),
                i18n._("For <code>\\le</code> or <code>\\ge</code>, enter " +
            ...
            return {
                validator: KhanAnswerTypes.expression.createValidator(
                    solution),
        ...
        _parseOptions: function(solutionData) {
            ...
            const form = solutionData.form !== undefined ?
                solutionData.form :
                solutionData.sameForm;
            const notFalseOrNil = function(x) {
        ...
        createValidator: function(solution) {
            ...
            if (validatorArray.length === 0) {
                const options = parseOptions($solution.data());
                validatorArray.push(createValidatorFunctional(
