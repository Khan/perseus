...
describe("i18n", () => {
    describe("Image finding", () => {
        it("should find all of the images in items", () => {
            var foundImages = i18n.findImagesInItemData(imagesEverywhere);

            assert(
                foundImages.length <= allImages.length,
                "More images were found than we expected (" +
                    foundImages.length + " > " + allImages.length + ")"
            );
