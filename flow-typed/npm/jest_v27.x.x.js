...
type EnzymeMatchersType = {
    ...
    // KA>
    toContainMatchingElement(selector: string | React$ComponentType<any>): void,
    toContainMatchingElements(
        n: number,
        selector: string | React$ComponentType<any>,
    ): void,
    // KA<
...
type JestExtendedMatchersType = {
    ...
    // KA >
    // NOTE(jeff): Added as they are currently missing from these type defs.
    /**
     * Use `.toReject` when checking if a `Promise` rejects.
     */
    toReject(): Promise<any>,
    /**
