...
declare interface Cypress$Chainable {
    ...
    trigger(eventName: string, options?: any): Cypress$Global;
    ...
    getCookies(
        options?: Cypress$LoggableTimeoutable,
    ): Array<Cypress$SetCookieResponse>;
    ...
    viewport(width: number, height: number, options?: Cypress$Loggable): void;
    ...
    // >KA
    /** KHAN ADDITIONS
     * defined in services/static/dev/cypress/cypress-support.js
     */
    dragTo(pos: {|x: number, y: number|}): Cypress$Global;

    /**
     * Wait until the check function returns truthy
     */
    waitUntil(
        () => boolean | Promise<mixed>,
        options?: Cypress$LoggableTimeoutable,
    ): void;
    // KA<
}
