import{B as i}from"./index-71P4mDMp.js";import{V as v}from"./index-hw7d7wq0.js";import{S as k}from"./index-v_a-r9JG.js";import{r as e}from"./index-6oxdNXpR.js";import"./underscore-885MUNGo.js";import"./core-widget-registry-lKD0wS3Q.js";import{s as P}from"./split-perseus-item-1aCvi3PH.js";import{s as T}from"./util-VofM5AGr.js";import"./jquery-5v7aFUvu.js";import"./all-widgets-iqsavYGq.js";import"./phet-simulation-ZEc6HIcw.js";import"./dependencies-CP7Uh8Kq.js";import"./perseus-api-Y55S7ZPk.js";import{r as R}from"./server-item-renderer-plcZYpxO.js";import"./article-renderer-yR10tbU9.js";import"./hints-renderer-SYFvOHTN.js";import"./renderer-fwR9fPUO.js";import"./base-radio-_n9bQDfd.js";import{k as q}from"./scoring-QePtPrdm.js";import"./button-group-f5V3tSn8.js";import"./svg-image-0WmcnIq_.js";import"./hud-VpTa1tZ-.js";import"./icon-H34hvC3Q.js";import"./index-3j9EmwNK.js";import"./inline-icon-8e4u-lSW.js";import"./math-input-7Yt9TSLI.js";import"./multi-button-group-7ejnk4_z.js";import"./number-input-sZ8tHclR.js";import"./range-input--qUg3jId.js";import"./text-input-9x5mqlXT.js";import"./text-list-editor-9dKImvgD.js";import"./i18n-context-T9Cdk0dK.js";import"./index-smZ6iCr_.js";import{H as o}from"./index-jek-Xksa.js";import{R as s,S as I}from"./split-view-ZwWleG5_.js";import{s as A}from"./test-dependencies-7efVmWKc.js";function d({score:n}){return n==null?null:e.createElement(e.Fragment,null,e.createElement("table",{style:{marginTop:"20px"}},e.createElement("thead",null,e.createElement("tr",{style:{fontWeight:"bold"}},e.createElement("td",null,"Empty"),e.createElement("td",null,"Correct"),e.createElement("td",{style:{width:"100%"}},"Message"))),e.createElement("tbody",null,e.createElement("tr",null,e.createElement("td",null,n.empty.toString()),e.createElement("td",null,n.correct.toString()),e.createElement("td",null,n.message)))),e.createElement(o,{style:{marginTop:"10px"}},"Guess"),e.createElement(s,{quotesOnKeys:!1,enableClipboard:!1,src:n.guess}),e.createElement(o,{style:{marginTop:"10px"}},"State"),e.createElement(s,{quotesOnKeys:!1,enableClipboard:!1,src:n.state}))}d.__docgenInfo={description:"",methods:[],displayName:"KEScoreUI",props:{score:{required:!0,tsType:{name:"union",raw:"KEScore | null | undefined",elements:[{name:"signature",type:"object",raw:`{
    empty: boolean;
    correct: boolean;
    ...
    guess: any;
    state: any;
}`,signature:{properties:[{key:"empty",value:{name:"boolean",required:!0}},{key:"correct",value:{name:"boolean",required:!0}},{key:"message",value:{name:"union",raw:"string | null | undefined",elements:[{name:"string"},{name:"null"},{name:"undefined"}],required:!1}},{key:"suppressAlmostThere",value:{name:"union",raw:"boolean | null | undefined",elements:[{name:"boolean"},{name:"null"},{name:"undefined"}],required:!1}},{key:"guess",value:{name:"any",required:!0}},{key:"state",value:{name:"any",required:!0}}]}},{name:"null"},{name:"undefined"}]},description:""}}};const E=({item:n,apiOptions:l,keypadElement:u,answerless:h=!1})=>{const a=e.useRef(null),[c,m]=e.useState(null),p=l||Object.freeze({}),g=()=>{const t=a.current;if(!t)return;const w=t.getUserInput(),f=T(n.question,w,"en"),b=[t.getUserInputLegacy(),[]];return q(f,b,t.getSerializedState().question)},y=h?P(n.question):n.question,r={...n,question:y};return e.createElement(I,{rendererTitle:"Renderer",renderer:e.createElement(e.Fragment,null,e.createElement(R,{ref:a,problemNum:0,apiOptions:p,item:r,dependencies:A,keypadElement:u}),e.createElement(v,{style:{flexDirection:"row",alignItems:"center"}},e.createElement(i,{onClick:()=>{a.current&&m(g())}},"Check"),e.createElement(k,{size:8}),e.createElement(i,{onClick:()=>{var t;(t=a.current)==null||t.showRationalesForCurrentlySelectedChoices()}},"Show Rationales")),e.createElement(d,{score:c})),jsonObject:r})};E.__docgenInfo={description:"",methods:[],displayName:"ServerItemRendererWithDebugUI",props:{item:{required:!0,tsType:{name:"signature",type:"object",raw:`{
...
the available choices.`}]}}],raw:`Readonly<{
     ...
     */
    onWidgetStartProps?: (widgets: PerseusWidgetsMap) => void;
}>`},description:""},keypadElement:{required:!1,tsType:{name:"union",raw:"KeypadAPI | null | undefined",elements:[{name:"KeypadAPI"},{name:"null"},{name:"undefined"}]},description:""},answerless:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};export{E as S};
