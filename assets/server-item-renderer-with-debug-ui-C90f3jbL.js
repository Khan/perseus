import{j as e}from"./jsx-runtime-BT65X5dW.js";import{B as h}from"./index-YIIULV-M.js";import{V as l}from"./index-CW2s7ekB.js";import{P as N}from"./index-Bdux6mmb.js";import{S as y}from"./index-CUPgSPQO.js";import{S}from"./all-widgets-Ci2EVG02.js";import{T as D,d as E}from"./test-keypad-context-wrapper-CC92WQkn.js";import{r as s}from"./index-C6mWTJJr.js";import"./underscore-U-AHniOr.js";import"./core-widget-registry-BDqK5cn0.js";import{s as C}from"./split-perseus-item-DPq5gkED.js";import{s as W}from"./util-CqRduJsD.js";import"./jquery-CkHB0_Mt.js";import{a as M}from"./mobile-keypad-xjCPHxcj.js";import{S as O}from"./server-item-renderer-BU1lu1GY.js";import{P as K,E as G}from"./perseus-error-CSETqePQ.js";import{H as f}from"./index-CFvGmn7i.js";import{R as w,S as U}from"./split-view-D7Gvtmhq.js";import{s as L}from"./test-dependencies-2LuEtiW0.js";function H(n){return n.type==="points"&&n.earned>=n.total}function V(n,t,r){if(n.type==="points")return{empty:!1,correct:H(n),message:n.message,guess:t,state:r};if(n.type==="invalid")return{empty:!0,correct:!1,message:n.message,suppressAlmostThere:n.suppressAlmostThere,guess:t,state:r};throw new K("Invalid score type: "+n.type,G.InvalidInput,{metadata:{score:JSON.stringify(n),guess:JSON.stringify(t),state:JSON.stringify(r)}})}function b({score:n}){return n==null?null:e.jsxs(e.Fragment,{children:[e.jsxs("table",{style:{marginTop:"20px"},children:[e.jsx("thead",{children:e.jsxs("tr",{style:{fontWeight:"bold"},children:[e.jsx("td",{children:"Empty"}),e.jsx("td",{children:"Correct"}),e.jsx("td",{style:{width:"100%"},children:"Message"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:n.empty.toString()}),e.jsx("td",{children:n.correct.toString()}),e.jsx("td",{children:n.message})]})})]}),e.jsx(f,{style:{marginTop:"10px"},children:"Guess"}),e.jsx(w,{quotesOnKeys:!1,enableClipboard:!1,src:n.guess}),e.jsx(f,{style:{marginTop:"10px"},children:"State"}),e.jsx(w,{quotesOnKeys:!1,enableClipboard:!1,src:n.state})]})}b.__docgenInfo={description:"",methods:[],displayName:"KEScoreUI",props:{score:{required:!0,tsType:{name:"union",raw:"KEScore | null | undefined",elements:[{name:"signature",type:"object",raw:`{
    empty: boolean;
    correct: boolean;
    ...
    guess: any;
    state: any;
}`,signature:{properties:[{key:"empty",value:{name:"boolean",required:!0}},{key:"correct",value:{name:"boolean",required:!0}},{key:"message",value:{name:"union",raw:"string | null | undefined",elements:[{name:"string"},{name:"null"},{name:"undefined"}],required:!1}},{key:"suppressAlmostThere",value:{name:"union",raw:"boolean | null | undefined",elements:[{name:"boolean"},{name:"null"},{name:"undefined"}],required:!1}},{key:"guess",value:{name:"any",required:!0}},{key:"state",value:{name:"any",required:!0}}]}},{name:"null"},{name:"undefined"}]},description:""}}};const z=({title:n="Widget",item:t,apiOptions:r=Object.freeze({}),linterContext:v,reviewMode:c=!1,startAnswerless:k=!1,showSolutions:u})=>{const o=s.useRef(null),[m,P]=s.useState(null),[d,T]=s.useState(r.isMobile??!1),[i,x]=s.useState(0),[R,p]=s.useState(k),q={...r,isMobile:d,customKeypad:d},A=()=>{const a=o.current;if(!a)return;const I=a.getUserInput(),j=W(t.question,I,"en"),F=[a.getUserInputLegacy(),[]];return V(j,F,a.getSerializedState().question)},g=R&&!c&&(u==="none"||!u)?C(t):t;return e.jsx(D,{children:e.jsx(U,{rendererTitle:e.jsxs(l,{style:{flexDirection:"row",alignItems:"center",width:"100%"},children:[n,e.jsx(l,{style:{marginLeft:"auto"},children:e.jsx(S,{icon:e.jsx(N,{icon:E}),checked:d,onChange:T})})]}),renderer:e.jsxs(e.Fragment,{children:[e.jsx(l,{className:d?"perseus-mobile":"",children:e.jsx(M.Consumer,{children:({keypadElement:a})=>e.jsx(O,{ref:o,problemNum:0,score:m,apiOptions:q,item:g,dependencies:L,keypadElement:a,linterContext:v,reviewMode:c,showSolutions:u,hintsVisible:i})})}),e.jsxs(l,{style:{flexDirection:"row",alignItems:"center"},children:[e.jsx(h,{onClick:()=>{p(!1),o.current&&P(A())},children:"Check"}),e.jsx(y,{size:8}),e.jsx(h,{onClick:()=>{var a;p(!1),(a=o.current)==null||a.showRationalesForCurrentlySelectedChoices()},children:"Show Rationales"}),e.jsx(y,{size:8}),e.jsx(h,{disabled:i>=t.hints.length,onClick:()=>{x(i+1)},children:i>=t.hints.length?"No hints left":`Take Hint ${i+1}`})]}),e.jsx(b,{score:m})]}),jsonObject:g})})};z.__docgenInfo={description:"",methods:[],displayName:"ServerItemRendererWithDebugUI",props:{title:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'"Widget"',computed:!1}},item:{required:!0,tsType:{name:"signature",type:"object",raw:`{
