import{cL as p,j as o}from"./iframe-B9Y7vzCP.js";import{S as l}from"./server-item-renderer-with-debug-ui-CXzw0Dpy.js";import"./split-view-E5QCRLdp.js";import"./test-keypad-context-wrapper-Bl9Q8Qdl.js";import"./server-item-renderer-qvZIhmuu.js";import"./hints-renderer-DMpno9jz.js";function S(e,n){const u=`${e} 1`,m={type:e,options:n},c={};c[u]=m;const _={content:`[[☃ ${u}]]`,images:{},widgets:c};return p({question:_})}const z={content:`Denis baked a peach pie and cut it into $3$ equal-sized pieces.  Denis's dad eats $1$ section of the pie.  
...
`,images:Object.freeze({}),widgets:{"input-number 1":{type:"input-number",graded:!0,options:{maxError:.1,inexact:!1,value:.5,simplify:"optional",answerType:"percent",size:"small"}}}},U={title:"Perseus/Widgets/InputNumber",argTypes:{maxError:{control:{type:"range",min:0,max:1,step:.1}},inexact:{control:{type:"boolean"}},value:{control:{type:"number"}},simplify:{control:{type:"select",options:["required","optional","enforced"]}},answerType:{control:{type:"select",options:["number","decimal","integer","rational","improper","mixed","percent","pi"]}},size:{control:{type:"select",options:["normal","small"]}},rightAlign:{control:{type:"boolean"}}}},d=(e,n,u)=>{const m=e.widgets[n];return{...e,widgets:{[n]:{...m,options:{...m.options,...u}}}}},t=e=>{const n=d(z,"input-number 1",e);return o.jsx(l,{item:p({question:n})})};t.args=z.widgets["input-number 1"].options;const r=e=>{const n=d(E,"input-number 1",e);return o.jsx(l,{item:p({question:n})})};r.args=E.widgets["input-number 1"].options;const a=e=>{const n=d(O,"input-number 1",e);return o.jsx(l,{item:p({question:n})})};a.args=O.widgets["input-number 1"].options;const i=()=>{const e=S("input-number",{simplify:"optional",size:"normal",value:42});return e.question.content=`The answer is 42
${e.question.content}`,o.jsx(l,{item:e})},s=()=>{const e=S("input-number",{simplify:"optional",size:"normal",value:42});return e.question.content=`The answer is 42
${e.question.content}`,o.jsx(l,{item:e,startAnswerless:!0})};t.__docgenInfo={description:"",methods:[],displayName:"Rational",props:{answerType:{required:!1,tsType:{name:"union",raw:`| "number"
| "decimal"
| "integer"
| "rational"
| "improper"
...
| "mixed"
| "percent"
| "pi"`,elements:[{name:"literal",value:'"number"'},{name:"literal",value:'"decimal"'},{name:"literal",value:'"integer"'},{name:"literal",value:'"rational"'},{name:"literal",value:'"improper"'},{name:"literal",value:'"mixed"'},{name:"literal",value:'"percent"'},{name:"literal",value:'"pi"'}]},description:""},inexact:{required:!1,tsType:{name:"boolean"},description:""},maxError:{required:!1,tsType:{name:"union",raw:"number | string",elements:[{name:"number"},{name:"string"}]},description:""},rightAlign:{required:!1,tsType:{name:"boolean"},description:""},simplify:{required:!0,tsType:{name:"union",raw:'"required" | "optional" | "enforced"',elements:[{name:"literal",value:'"required"'},{name:"literal",value:'"optional"'},{name:"literal",value:'"enforced"'}]},description:""},size:{required:!0,tsType:{name:"union",raw:'"normal" | "small"',elements:[{name:"literal",value:'"normal"'},{name:"literal",value:'"small"'}]},description:""},value:{required:!0,tsType:{name:"union",raw:"string | number",elements:[{name:"string"},{name:"number"}]},description:""},customKeypad:{required:!1,tsType:{name:"boolean"},description:""}}};i.__docgenInfo={description:"",methods:[],displayName:"Answerful"};s.__docgenInfo={description:"",methods:[],displayName:"Answerless"};var b,g,f;t.parameters={...t.parameters,docs:{...(b=t.parameters)==null?void 0:b.docs,source:{originalSource:`(args: InputNumberOptions): React.ReactElement => {
...
}`,...(f=(g=t.parameters)==null?void 0:g.docs)==null?void 0:f.source}}};var y,h,w;r.parameters={...r.parameters,docs:{...(y=r.parameters)==null?void 0:y.docs,source:{originalSource:`(args: InputNumberOptions): React.ReactElement => {
  const question = updateWidgetOptions(question2, "input-number 1", args);
  return <ServerItemRendererWithDebugUI item={generateTestPerseusItem({
    question
  })} />;
}`,...(w=(h=r.parameters)==null?void 0:h.docs)==null?void 0:w.source}}};var $,v,q;a.parameters={...a.parameters,docs:{...($=a.parameters)==null?void 0:$.docs,source:{originalSource:`(args: InputNumberOptions): React.ReactElement => {
  const question = updateWidgetOptions(question3, "input-number 1", args);
  return <ServerItemRendererWithDebugUI item={generateTestPerseusItem({
    question
  })} />;
}`,...(q=(v=a.parameters)==null?void 0:v.docs)==null?void 0:q.source}}};var x,Z,T;i.parameters={...i.parameters,docs:{...(x=i.parameters)==null?void 0:x.docs,source:{originalSource:`(): React.ReactElement => {
...
}`,...(T=(Z=i.parameters)==null?void 0:Z.docs)==null?void 0:T.source}}};var A,I,R;s.parameters={...s.parameters,docs:{...(A=s.parameters)==null?void 0:A.docs,source:{originalSource:`(): React.ReactElement => {
  const item = getAnswerfulItem("input-number", {
    simplify: "optional",
    size: "normal",
    value: 42
...
}`,...(R=(I=s.parameters)==null?void 0:I.docs)==null?void 0:R.source}}};const K=["Rational","PiSimplify","Percent","Answerful","Answerless"];export{i as Answerful,s as Answerless,a as Percent,r as PiSimplify,t as Rational,K as __namedExportsOrder,U as default};
