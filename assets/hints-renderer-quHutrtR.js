import{j as r}from"./jsx-runtime-63Ea5SlK.js";import{l as P,R as N,p as x}from"./renderer-xeSf3CLl.js";import{l as s}from"./index-awljIyHI.js";import{c as R}from"./index-dnMhQZ-1.js";import{r as A}from"./index-6oxdNXpR.js";import{F as C}from"./index-9gkyvru-.js";import{_ as g}from"./index-default-4_ZsnO94.js";import{P as I}from"./i18n-context-ihOeIMY_.js";import{l as u,m as W,o as q,k as S,q as M,h as E}from"./constants-iPV6vHZm.js";import{m as h}from"./media-queries-gbofTbz-.js";import{A as D}from"./perseus-api-_PWPZoDE.js";import{s as O}from"./shared-4TdECMLk.js";import{U as j}from"./util-FOHsj4WS.js";const f=class f extends A.Component{constructor(){super(...arguments),this.getSerializedState=()=>this.refs.renderer.getSerializedState(),this.restoreSerializedState=(e,n)=>{this.refs.renderer.restoreSerializedState(e,n)}}render(){const{apiOptions:e,className:n,hint:t,lastHint:a,lastRendered:i,pos:c,totalHints:p}=this.props,{isMobile:m}=e,o=R("hint",!m&&"perseus-hint-renderer",m&&s.css(T.newHint),m&&i&&s.css(T.lastRenderedNewHint),a&&"last-hint",i&&"last-rendered",n),l={...e,customKeypad:!1};return r.jsxs("div",{className:o,tabIndex:"-1",children:[!e.isMobile&&r.jsx("span",{className:"perseus-sr-only",children:this.context.strings.hintPos({pos:c+1})}),!e.isMobile&&p!=null&&c!=null&&r.jsx("span",{className:"perseus-hint-label",style:{display:"block",color:e.hintProgressColor},children:`${c+1} / ${p}`}),r.jsx(N,{ref:"renderer",widgets:t.widgets,content:t.content||"",images:t.images,apiOptions:l,findExternalWidgets:this.props.findExternalWidgets,linterContext:x(this.props.linterContext,"hint"),strings:this.context.strings})]})}};f.contextType=I,f.defaultProps={linterContext:P};let y=f;const T=s.StyleSheet.create({newHint:{marginBottom:1.5*u,borderLeftColor:W,borderLeftStyle:"solid",borderLeftWidth:q,[h.lgOrSmaller]:{paddingLeft:u},[h.smOrSmaller]:{paddingLeft:0},":focus":{outline:"none"}},lastRenderedNewHint:{marginBottom:0,borderLeftColor:S}});y.__docgenInfo={description:"",methods:[{name:"getSerializedState",docblock:null,modifiers:[],params:[],returns:null},{name:"restoreSerializedState",docblock:null,modifiers:[],params:[{name:"state",optional:!1,type:null},{name:"callback",optional:!1,type:null}],returns:null}],displayName:"HintRenderer",props:{apiOptions:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
...
}`,computed:!1}},className:{required:!1,tsType:{name:"string"},description:""},hint:{required:!0,tsType:{name:"any"},description:""},lastHint:{required:!1,tsType:{name:"boolean"},description:""},lastRendered:{required:!1,tsType:{name:"boolean"},description:""},pos:{required:!0,tsType:{name:"number"},description:""},totalHints:{required:!1,tsType:{name:"number"},description:""},findExternalWidgets:{required:!1,tsType:{name:"any"},description:""}}};const b=class b extends A.Component{constructor(){super(...arguments),this.state={isFinalHelpPage:!1},this._hintsVisible=()=>this.props.hintsVisible==null||this.props.hintsVisible===-1?this.props.hints.length:this.props.hintsVisible,this._cacheImagesInHint=e=>{g.each(e.images,(n,t)=>{const a=new Image;a.src=j.getRealImageUrl(t)})},this._cacheHintImages=()=>{this._hintsVisible()>0?g.each(this.props.hints,this._cacheImagesInHint):this.props.hints.length>0&&this._cacheImagesInHint(this.props.hints[0])},this.getApiOptions=()=>({...D.defaults,...this.props.apiOptions,readOnly:!1}),this.getSerializedState=()=>g.times(this._hintsVisible(),e=>this.refs["hintRenderer"+e].getSerializedState()),this.restoreSerializedState=(e,n)=>{let t=1;const a=()=>{--t,n&&t===0&&n()};g.each(e,(i,c)=>{const p=this.refs["hintRenderer"+c];p&&(++t,p.restoreSerializedState(i,a))}),a()}}componentDidMount(){this._cacheHintImages()}UNSAFE_componentWillReceiveProps(e){e.hintsVisible-this.props.hintsVisible>1&&this.setState({isFinalHelpPage:!0})}componentDidUpdate(e,n){(!g.isEqual(e.hints,this.props.hints)||e.hintsVisible!==this.props.hintsVisible)&&this._cacheHintImages();const t=e.hintsVisible||0,a=this.props.hintsVisible||0;if(t<a&&a<=this.props.hints.length&&a>=0){const i=a-1;C.findDOMNode(this.refs["hintRenderer"+i]).focus()}}render(){const e=this.getApiOptions(),n=this._hintsVisible(),t=[],a=this.state.isFinalHelpPage;this.props.hints.slice(0,n).forEach((o,l)=>{const F=l===this.props.hints.length-1&&!/\*\*/.test(o.content),H=l===n-1,w=r.jsx(y,{lastHint:F,lastRendered:H,hint:o,pos:l,totalHints:this.props.hints.length,ref:"hintRenderer"+l,apiOptions:e,findExternalWidgets:this.props.findExternalWidgets,linterContext:x(this.props.linterContext,"hints["+l+"]")},"hintRenderer"+l);a?t.push(w):o.replace&&t.length>0?t[t.length-1]=w:t.push(w)});const{getAnotherHint:i}=e,c=i&&n>0&&n<this.props.hints.length,p=`(${n}/${this.props.hints.length})`,m=R(this.props.className,e.isMobile&&n>0&&s.css(d.mobileHintStylesHintsRenderer));return r.jsxs("div",{className:m,children:[e.isMobile&&n>0&&r.jsx("div",{className:s.css(d.mobileHintStylesHintTitle,O.responsiveLabel),children:this.context.strings.hints}),t,c&&r.jsxs("button",{rel:"button",className:s.css(d.linkButton,d.getAnotherHintButton,e.isMobile&&d.mobileHintStylesGetAnotherHintButton),onClick:o=>{o.preventDefault(),o.stopPropagation(),i&&i()},children:[r.jsx("span",{className:s.css(d.plusText,e.isMobile&&d.mobileHintStylesPlusText),children:"+"}),r.jsxs("span",{className:s.css(d.getAnotherHintText),children:[this.context.strings.getAnotherHint," ",p]})]})]})}};b.contextType=I,b.defaultProps={linterContext:P};let k=b;const v=u+q,d=s.StyleSheet.create({rendererMargins:{marginTop:u},linkButton:{cursor:"pointer",border:"none",backgroundColor:"transparent",fontSize:"100%",fontFamily:"inherit",fontWeight:"bold",color:S,padding:0,position:"relative"},plusText:{fontSize:20,position:"absolute",top:-3,left:0},getAnotherHintText:{marginLeft:16},mobileHintStylesHintsRenderer:{marginTop:4*u,border:`solid ${M}`,borderWidth:"1px 0 0 0",position:"relative",":before":{content:'""',display:"table",clear:"both"},":after":{content:'""',display:"table",clear:"both"}},mobileHintStylesHintTitle:{fontFamily:"inherit",fontStyle:"normal",fontWeight:"bold",color:E,paddingTop:u,paddingBottom:1.5*u,[h.lgOrSmaller]:{paddingLeft:0},[h.smOrSmaller]:{paddingLeft:v}},getAnotherHintButton:{marginTop:1.5*u},mobileHintStylesGetAnotherHintButton:{[h.lgOrSmaller]:{paddingLeft:0},[h.smOrSmaller]:{paddingLeft:v}},mobileHintStylesPlusText:{[h.lgOrSmaller]:{left:0},[h.smOrSmaller]:{left:v}}});k.__docgenInfo={description:"",methods:[{name:"_hintsVisible",docblock:null,modifiers:[],params:[],returns:null},{name:"_cacheImagesInHint",docblock:null,modifiers:[],params:[{name:"hint",optional:!1,type:null}],returns:null},{name:"_cacheHintImages",docblock:null,modifiers:[],params:[],returns:null},{name:"getApiOptions",docblock:null,modifiers:[],params:[],returns:null},{name:"getSerializedState",docblock:null,modifiers:[],params:[],returns:null},{name:"restoreSerializedState",docblock:null,modifiers:[],params:[{name:"state",optional:!1,type:null},{name:"callback",optional:!1,type:null}],returns:null}],displayName:"HintsRenderer",props:{className:{required:!1,tsType:{name:"string"},description:""},hints:{required:!0,tsType:{name:"ReadonlyArray",elements:[{name:"intersection",raw:`PerseusRenderer & {
    /**
