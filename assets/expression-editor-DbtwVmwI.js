var j=Object.defineProperty;var A=(l,o,e)=>o in l?j(l,o,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[o]=e;var t=(l,o,e)=>(A(l,typeof o!="symbol"?o+"":o,e),e);import{r as C,br as q,bs as w,_ as T,bt as L,bu as E,j as s,ah as h,V as v,H as x,n as m,bv as f,bw as K,bx as P,s as p,y as S,z as b,by as k,bz as N,bA as V,e as g}from"./iframe-CQulAyj4.js";import"./item-version-CiqeGUu5.js";import"./article-renderer-cQoZ0G63.js";import"./server-item-renderer-BZGqR-cd.js";import"./hints-renderer-BRKqsHiV.js";import{c as D}from"./components-KUKGpydJ.js";const{ButtonGroup:I,InfoTip:c}=D,F=["basic","trig","prealgebra","logarithms","scientific","basic relations","advanced relations"];class y extends C.Component{constructor(e){super(e);t(this,"getSaveWarnings",()=>{const e=[];return this.props.answerForms.length===0?e.push("No answers specified"):(this.props.answerForms.some(a=>a.considered==="correct")||e.push("No correct answer specified"),T(this.props.answerForms).each((a,r)=>{if(this.props.value==="")e.push(`Answer ${r+1} is empty`);else{const u=L(a.value,{functions:this.props.functions});u.parsed?a.simplify&&!u.expr.isSimplified()&&e.push(`${a.value} isn't simplified, but is required" +
                            " to be`):e.push(`Couldn't parse ${a.value}`)}})),e});t(this,"newAnswer",()=>{const e=this.props.answerForms.slice(),a={considered:"correct",form:!1,key:`${crypto.randomUUID()}`,simplify:!1,value:""};e.push(a),this.props.onChange({answerForms:e})});t(this,"handleRemoveForm",e=>{const n=this.props.answerForms.slice();n.splice(e,1),this.props.onChange({answerForms:n})});t(this,"handleButtonSet",e=>{const a=F.filter(r=>this.props.buttonSets.includes(r)!==(r===e));this.props.onChange({buttonSets:a})});t(this,"handleToggleDiv",()=>{let e,n;this.props.buttonSets.includes("basic+div")?(e="basic",n="basic+div"):(e="basic+div",n="basic");const a=this.props.buttonSets.filter(r=>r!==n).concat(e);this.props.onChange({buttonSets:a})});t(this,"handleTexInsert",e=>{this.refs.expression.insert(e)});t(this,"handleFunctions",e=>{this.setState({functionsInternal:e});const n={};n.functions=e.split(/[ ,]+/).filter(E),this.props.onChange(n)});t(this,"handleVisibleLabel",e=>{this.props.onChange({visibleLabel:e})});t(this,"handleAriaLabel",e=>{this.props.onChange({ariaLabel:e})});t(this,"changeExpressionWidget",(e,n)=>{const a={...this.props.answerForms[e],value:n.value};this.updateAnswerForm(e,a)});this.state={functionsInternal:this.props.functions.join(" ")}}serialize(){const{answerForms:e,buttonSets:n,functions:a,times:r,visibleLabel:u,ariaLabel:d}=this.props;return{answerForms:e,buttonSets:n,functions:a,times:r,visibleLabel:u,ariaLabel:d,extraKeys:w(this.props)}}updateAnswerForm(e,n){const a=this.props.answerForms.slice();a[e]=n;const{extraKeys:r,...u}=this.props,d=w({...u,answerForms:a});this.props.onChange({answerForms:a,extraKeys:d})}changeSimplify(e,n){const a={...this.props.answerForms[e],simplify:n};this.updateAnswerForm(e,a)}changeForm(e,n){const a={...this.props.answerForms[e],form:n};this.updateAnswerForm(e,a)}changeConsidered(e,n){const a={...this.props.answerForms[e],considered:n};this.updateAnswerForm(e,a)}changeTimes(e){this.props.onChange({times:e})}render(){const e=this.props.answerForms.map((a,r)=>{const u={times:this.props.times,functions:this.props.functions,buttonSets:this.props.buttonSets,buttonsVisible:"focused",value:a.value,onChange:d=>this.changeExpressionWidget(r,d),trackInteraction:()=>{},widgetId:this.props.widgetId+"-"+a.key,visibleLabel:this.props.visibleLabel,ariaLabel:this.props.ariaLabel};return s.jsx(W,{considered:a.considered,expressionProps:u,form:a.form,simplify:a.simplify,onDelete:()=>this.handleRemoveForm(r),onChangeSimplify:d=>this.changeSimplify(r,d),onChangeForm:d=>this.changeForm(r,d),onChangeConsidered:d=>this.changeConsidered(r,d)},a.key)}),n=F.map(a=>{const r=a==="basic",u=this.props.buttonSets.includes(a)||r;return s.jsx(h,{label:a,checked:u,disabled:r,onChange:()=>this.handleButtonSet(a)},a)});return n.unshift(s.jsx(h,{label:"show ÷ button",checked:this.props.buttonSets.includes("basic+div"),onChange:this.handleToggleDiv},"show ÷ button")),s.jsxs(v,{children:[s.jsx(x,{children:"Global Options"}),s.jsx("div",{className:m.css(i.paddedY),children:s.jsx(f,{label:s.jsxs(s.Fragment,{children:["Visible label",s.jsx(c,{children:"Optional visible text; strongly encouraged to help learners using dictation software, but can be omitted if the surrounding content provides enough context."})]}),value:this.props.visibleLabel||"",onChange:this.handleVisibleLabel})}),s.jsx("div",{className:m.css(i.paddedY),children:s.jsx(f,{label:s.jsxs(s.Fragment,{children:["Aria label",s.jsxs(c,{children:["Label text that's read by screen readers. Highly recommend adding a label here to ensure your exercise is accessible. For more information on writting accessible labels, please see"," ",s.jsx("a",{href:"https://www.w3.org/WAI/tips/designing/#ensure-that-form-elements-include-clearly-associated-labels",target:"_blank",rel:"noreferrer",children:"this article."})]})]}),value:this.props.ariaLabel||"",onChange:this.handleAriaLabel})}),s.jsx("div",{className:m.css(i.paddedY),children:s.jsx(f,{label:s.jsxs(s.Fragment,{children:["Function variables",s.jsx(c,{children:'Single-letter variables listed here will be interpreted as functions. This let us know that f(x) means "f of x" and not "f times x".'})]}),value:this.state.functionsInternal,onChange:this.handleFunctions})}),s.jsx("div",{className:m.css(i.paddedY),children:s.jsx(h,{label:s.jsxs(s.Fragment,{children:["Use × instead of ⋅ for multiplication",s.jsx(c,{children:"For pre-algebra problems this option displays multiplication as \\times instead of \\cdot in both the rendered output and the acceptable formats examples."})]}),checked:this.props.times,onChange:a=>{this.changeTimes(a)}})}),s.jsxs("div",{className:m.css(i.paddedY),children:[s.jsx(K,{children:"Button Sets"}),n]}),s.jsx(x,{children:"Answers"}),s.jsx(P,{style:i.answersSubtitle,children:"student responses area matched against these from top to bottom"}),s.jsx(v,{style:{gap:p.xSmall_8},children:e}),s.jsx(S,{size:p.small_12}),s.jsx(b,{size:"small",onClick:this.newAnswer,children:"Add new answer"})]})}}t(y,"widgetName","expression"),t(y,"defaultProps",q.defaultWidgetOptions);const O=function(l,o){let e=l.indexOf(o);return e=(e+1)%l.length,l[e]};class W extends C.Component{constructor(){super(...arguments);t(this,"state",{deleteFocused:!1});t(this,"handleImSure",()=>{this.props.onDelete(),this.handleCancelDelete()});t(this,"handleCancelDelete",()=>{this.setState({deleteFocused:!1})});t(this,"handleDelete",()=>{this.setState({deleteFocused:!0})});t(this,"toggleConsidered",()=>{const e=O(k,this.props.considered);this.props.onChangeConsidered(e)})}render(){const e=this.state.deleteFocused?s.jsxs(s.Fragment,{children:[s.jsx(b,{size:"small",onClick:this.handleImSure,actionType:"destructive",children:"I'm sure!"}),s.jsx(S,{size:p.small_12}),s.jsx(b,{size:"small",onClick:this.handleCancelDelete,kind:"secondary",children:"Cancel"})]}):s.jsx(b,{size:"small",onClick:this.handleDelete,actionType:"destructive",kind:"tertiary",style:i.deleteButton,children:"Delete"});return s.jsxs("div",{className:m.css(i.answerOption),children:[s.jsx(I,{onChange:this.toggleConsidered,allowEmpty:!1,value:this.props.considered,selectedButtonStyle:B[this.props.considered],buttons:k.map(n=>({value:n,content:n,title:`This answer will be considered ${n}`}))}),s.jsx(N,{...this.props.expressionProps}),s.jsx("div",{className:m.css(i.paddedY,i.paddedX),children:s.jsx(h,{label:s.jsxs(s.Fragment,{children:["Answer expression must have the same form.",s.jsx(c,{children:"The student's answer must be in the same form. Commutativity and excess negative signs are ignored."})]}),checked:this.props.form,onChange:this.props.onChangeForm})}),s.jsx("div",{className:m.css(i.paddedY,i.paddedX),children:s.jsx(h,{label:s.jsxs(s.Fragment,{children:["Answer expression must be fully expanded and simplified.",s.jsx(c,{children:`The student's answer must be fully expanded and simplified. Answering this equation (x^2+2x+1) with this factored equation (x+1)^2 will render this response "Your answer is not fully expanded and simplified."`})]}),checked:this.props.simplify,onChange:this.props.onChangeSimplify})}),s.jsx("div",{className:m.css(i.buttonRow,i.paddedY),children:e})]})}}const i=m.StyleSheet.create({paddedX:{paddingLeft:p.xSmall_8,paddingRight:p.xSmall_8},paddedY:{paddingTop:p.xxSmall_6,paddingBottom:p.xxSmall_6},answersSubtitle:{fontStyle:"italic"},answerOption:{border:"1px solid #ddd",borderRadius:"3px",display:"flex",flexDirection:"column"},answerStatusWrong:{backgroundColor:g.fadedRed16},answerStatusCorrect:{backgroundColor:g.fadedGreen16},answerStatusUngraded:{backgroundColor:g.fadedBlue16},buttonRow:{display:"flex"},deleteButton:{paddingInline:V.size_160}}),B={wrong:i.answerStatusWrong,correct:i.answerStatusCorrect,ungraded:i.answerStatusUngraded};y.__docgenInfo={description:"",methods:[{name:"serialize",docblock:null,modifiers:[],params:[],returns:{type:{name:"signature",type:"object",raw:`{
