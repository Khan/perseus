import{j as e}from"./jsx-runtime-63Ea5SlK.js";import{c as p}from"./article-renderer-_RJtcGCn.js";import"./phet-simulation-CMJUXUZB.js";import{_ as s}from"./index-default-4_ZsnO94.js";import{i as m}from"./core-widget-registry-uiKfW1Am.js";import"./dependencies-CP7Uh8Kq.js";import"./perseus-api-DO0X8arb.js";import"./server-item-renderer-uldJW-VW.js";import"./hints-renderer-99VOO1xF.js";import"./renderer-5W1KYZ8O.js";import"./base-radio-1Hhes3XT.js";import{c as g}from"./components-3H0VhsK5.js";import{i as w}from"./icon-paths-5JCXzGsq.js";import"./i18n-context-_hhyRM-i.js";import{U as d}from"./util-gHYooniF.js";import"./svg-image-e2j_53PB.js";import"./jquery-5v7aFUvu.js";import"./index-smZ6iCr_.js";import{E as f}from"./editor-jsonify-gCp7EwVL.js";import{r as b}from"./index-6oxdNXpR.js";import{B as y}from"./blur-input-6j4bgLwx.js";import{E as h}from"./editor-wGCc3Z3S.js";const{InfoTip:u,InlineIcon:v,RangeInput:k}=g,x="(ka-.*.s3.amazonaws.com|(fastly|cdn).kastatic.org|khanacademy.org|kasandbox.org)",R=new RegExp("^(https?|web\\+graphie)://[^/]*"+x),T=["center","above","above right","right","below right","below","below left","left","above left"],r=class r extends b.Component{constructor(){super(...arguments),this._isMounted=!1,this.state={backgroundImageError:""},this.change=(...n)=>p.apply(this,n)}componentDidMount(){this._isMounted=!0}componentWillUnmount(){this._isMounted=!1}_renderRowForLabel(n,a){return e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(k,{value:n.coordinates,onChange:this.onCoordinateChange.bind(this,a)})}),e.jsx("td",{style:{verticalAlign:"bottom",width:"5px"},children:e.jsx("input",{type:"text",className:"graph-settings-axis-label",value:n.content,onChange:this.onContentChange.bind(this,a)})}),e.jsx("td",{children:e.jsx("select",{className:"perseus-widget-dropdown",value:n.alignment,onChange:this.onAlignmentChange.bind(this,a),children:T.map(function(t,o){return e.jsx("option",{value:t,children:t},""+o)},this)})}),e.jsx("td",{children:e.jsx("a",{href:"#",className:"simple-button orange delete-label",title:"Remove this label",onClick:this.removeLabel.bind(this,a),children:e.jsx(v,{...w})})})]},a)}removeLabel(n,a){a.preventDefault();const t=[...this.props.labels];t.splice(n,1),this.props.onChange({labels:t})}onCoordinateChange(n,a){const t=this.props.labels.slice();t[n]=s.extend({},t[n],{coordinates:a}),this.props.onChange({labels:t})}onContentChange(n,a){const t=a.target.value,o=this.props.labels.slice();o[n]=s.extend({},o[n],{content:t}),this.props.onChange({labels:o})}onAlignmentChange(n,a){const t=a.target.value,o=this.props.labels.slice();o[n]=s.extend({},o[n],{alignment:t}),this.props.onChange({labels:o})}setUrl(n,a,t,o){if(!this._isMounted)return;const i=s.clone(this.props.backgroundImage);i.url=n,i.width=a,i.height=t;const c=[i.width,i.height];this.props.onChange({backgroundImage:i,box:c},null,o)}async onUrlChange(n,a){if(!n){this.setUrl(n,0,0,a);return}if(!R.test(n)){this.setState({backgroundImageError:"Images must be from sites hosted by Khan Academy. Please input a Khan Academy-owned address, or use the Add Image tool to rehost an existing image"});return}this.setState({backgroundImageError:""});try{const t=await d.getImageSizeModern(n);this.setUrl(n,t[0],t[1],!0)}catch(t){this.setState({backgroundImageError:`There was an error loading the image URL: ${JSON.stringify(t,null,2)}`})}}onRangeChange(n,a){const t=this.props.range.slice();t[n]=a,this.props.onChange({range:t})}serialize(){return f.serialize.call(this)}render(){const n=this.props.backgroundImage,a=e.jsxs("div",{className:"image-settings",children:[!d.isLabeledSVG(n.url)&&e.jsx("div",{children:e.jsxs("label",{children:[e.jsx("div",{children:"Preview:"}),e.jsx("img",{alt:"Editor preview of image",src:n.url,style:{width:"100%"}})]})}),e.jsx("div",{children:e.jsxs("label",{children:[e.jsx("div",{children:"Dimensions:"}),e.jsxs("p",{children:[n.width,"x",n.height]})]})}),e.jsx("div",{children:e.jsxs("label",{children:[e.jsxs("div",{children:["Alt text:",e.jsx(u,{children:"This is important for screenreaders. The content of this alt text will be formatted as markdown (tables, emphasis, etc. are supported)."})]}),e.jsx(h,{apiOptions:this.props.apiOptions,content:this.props.alt,onChange:o=>{o.content!=null&&this.change("alt",o.content)},widgetEnabled:!1})]})}),e.jsx("div",{children:e.jsxs("label",{children:[e.jsx("div",{children:"Caption:"}),e.jsx(h,{apiOptions:this.props.apiOptions,content:this.props.caption,onChange:o=>{o.content!=null&&this.change("caption",o.content)},widgetEnabled:!1})]})})]}),t=e.jsx("div",{className:"renderer-widget-error",children:this.state.backgroundImageError});return e.jsxs("div",{className:"perseus-image-editor",children:[e.jsxs("label",{children:["Image url:",e.jsx(u,{children:"Paste an image or graphie image URL."}),this.state.backgroundImageError&&t,e.jsx(y,{value:n.url||"",style:{width:332},onChange:o=>this.onUrlChange(o,!1)})]}),n.url&&a]})}};r.displayName="ImageEditor",r.widgetName="image",r.defaultProps=m.defaultWidgetOptions;let l=r;l.__docgenInfo={description:"",methods:[{name:"_renderRowForLabel",docblock:null,modifiers:[],params:[{name:"label",optional:!1,type:null},{name:"i",optional:!1,type:null}],returns:null},{name:"change",docblock:null,modifiers:[],params:[{name:"...args",optional:!1,type:null}],returns:null},{name:"removeLabel",docblock:null,modifiers:[],params:[{name:"labelIndex",optional:!1,type:null},{name:"e",optional:!1,type:null}],returns:null},{name:"onCoordinateChange",docblock:null,modifiers:[],params:[{name:"labelIndex",optional:!1,type:null},{name:"newCoordinates",optional:!1,type:null}],returns:null},{name:"onContentChange",docblock:null,modifiers:[],params:[{name:"labelIndex",optional:!1,type:null},{name:"e",optional:!1,type:null}],returns:null},{name:"onAlignmentChange",docblock:null,modifiers:[],params:[{name:"labelIndex",optional:!1,type:null},{name:"e",optional:!1,type:null}],returns:null},{name:"setUrl",docblock:null,modifiers:[],params:[{name:"url",optional:!1,type:null},{name:"width",optional:!1,type:null},{name:"height",optional:!1,type:null},{name:"silent",optional:!1,type:null}],returns:null},{name:"onUrlChange",docblock:null,modifiers:["async"],params:[{name:"url",optional:!1,type:{name:"union",raw:"string | undefined | null",elements:[{name:"string"},{name:"undefined"},{name:"null"}]}},{name:"silent",optional:!1,type:{name:"boolean"}}],returns:null},{name:"onRangeChange",docblock:null,modifiers:[],params:[{name:"type",optional:!1,type:null},{name:"newRange",optional:!1,type:null}],returns:null},{name:"serialize",docblock:null,modifiers:[],params:[],returns:null}],displayName:"ImageEditor",props:{apiOptions:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
