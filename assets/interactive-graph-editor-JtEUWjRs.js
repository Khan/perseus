import{l as se,d as ue,c as De,e as Ge,U as te}from"./util-AXsb50Si.js";import{_ as N}from"./underscore-885MUNGo.js";import{C as Ve}from"./random-util-qPwTTOJz.js";import{i as c}from"./tiny-invariant-bHgPayXn.js";import"./jquery-5v7aFUvu.js";import{S as Me,g as me,a as de,f as pe,h as ce,i as he,j as ye,k as ge,l as we,n as be,I as ze}from"./all-widgets-aMhhV6KF.js";import"./phet-simulation-ZEc6HIcw.js";import"./dependencies-CP7Uh8Kq.js";import"./perseus-api-Y55S7ZPk.js";import"./server-item-renderer-0FlDpsCg.js";import"./article-renderer-DKqZ3-vj.js";import"./hints-renderer-R-DL0bdp.js";import{j as We,k as _e}from"./renderer-GgilJG6V.js";import"./base-radio-i3prI0yk.js";import{c as ke}from"./components-pH0UwuFS.js";import{j as He}from"./constants-vGHYchdS.js";import"./i18n-context-T9Cdk0dK.js";import"./svg-image-QtqEBn5V.js";import{w as fe}from"./index-J2t_5nK1.js";import"./index-smZ6iCr_.js";import{V as u,b as $e,I as Be}from"./index-hw7d7wq0.js";import{S as E,O as d}from"./answer-choices-DvMFGLln.js";import{T as Ke,a as Xe,C as D}from"./index-F5uqTDBi.js";import{s as o,c as b,f as K}from"./index-zRqVZh6A.js";import{d as ve,f as z,L as g,b as I,a as X}from"./index-jek-Xksa.js";import{n as v}from"./no-important-xCWWYXQR.js";import{r as e}from"./index-6oxdNXpR.js";import{H as W}from"./heading-Irlk3f2q.js";import{S as y,a as Ue}from"./index-v_a-r9JG.js";import{L as A,I as Qe}from"./interactive-graph-settings-z-gKq1ha.js";import{P as oe}from"./index-L0cWnnN3.js";import{L as Je}from"./locked-figures-section-xOHwcInn.js";import"./button-group-f5V3tSn8.js";import"./hud-VpTa1tZ-.js";import"./icon-H34hvC3Q.js";import"./index-3j9EmwNK.js";import"./inline-icon-8e4u-lSW.js";import"./math-input-OfplhNyP.js";import"./multi-button-group-7ejnk4_z.js";import"./number-input-arstEMF_.js";import"./range-input-EVLe-O5o.js";import"./text-input-W13PSE1A.js";import"./text-list-editor-9dKImvgD.js";import{B as Ye}from"./index-71P4mDMp.js";import{C as k}from"./locked-label-settings-ICwxEGi-.js";import{S as Ze}from"./scrollless-number-text-field-rQL1rvNx.js";import{P as en}from"./trash-bold-HKrKoe79.js";const $="unlimited",Ce=r=>{const n=parseInt(r,10);return isNaN(n)||n===0?$:n},qe=({numPoints:r=1,onChange:n})=>e.createElement(E,{selectedValue:`${r}`,onChange:a=>{n(Ce(a))},placeholder:"",style:nn.singleSelectShort},[...[...Array(7).keys()].map(a=>e.createElement(d,{key:a,value:`${a}`,label:`${a} point${a>1?"s":""}`})),e.createElement(d,{key:"unlimited",value:$,label:"unlimited"})]),nn=v.StyleSheet.create({singleSelectShort:{height:26}});qe.__docgenInfo={description:"",methods:[],displayName:"GraphPointsCountSelector",props:{numPoints:{required:!1,tsType:{name:"union",raw:"number | typeof UNLIMITED",elements:[{name:"number"},{name:"UNLIMITED"}]},description:"",defaultValue:{value:"1",computed:!1}},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(points: PointValue) => void",signature:{arguments:[{type:{name:"union",raw:"number | typeof UNLIMITED",elements:[{name:"number"},{name:"UNLIMITED"}]},name:"points"}],return:{name:"void"}}},description:""}}};const Te=r=>e.createElement(E,{selectedValue:r.graphType,onChange:r.onChange,placeholder:"Select an answer type",style:rn.singleSelectShort},e.createElement(d,{value:"none",label:"None"}),e.createElement(d,{value:"linear",label:"Linear function"}),e.createElement(d,{value:"quadratic",label:"Quadratic function"}),e.createElement(d,{value:"sinusoid",label:"Sinusoid function"}),e.createElement(d,{value:"circle",label:"Circle"}),e.createElement(d,{value:"point",label:"Point(s)"}),e.createElement(d,{value:"linear-system",label:"Linear System"}),e.createElement(d,{value:"polygon",label:"Polygon"}),e.createElement(d,{value:"segment",label:"Line Segment(s)"}),e.createElement(d,{value:"ray",label:"Ray"}),e.createElement(d,{value:"angle",label:"Angle"})),rn=v.StyleSheet.create({singleSelectShort:{height:26}});Te.__docgenInfo={description:"",methods:[],displayName:"GraphTypeSelector",props:{graphType:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(newGraphType: string) => void",signature:{arguments:[{type:{name:"string"},name:"newGraphType"}],return:{name:"void"}}},description:""}}};function xe(r){return e.createElement(e.Fragment,null,e.createElement(W,{title:"Correct Answer",isOpen:!0,isCollapsible:!1}),e.createElement(u,{id:r.id},e.createElement(u,null,e.createElement(ve,{style:{paddingTop:o.xxSmall_6,paddingBottom:o.xxSmall_6,color:b.offBlack64}},"Graph the correct answer in the graph below and ensure the equation or point coordinates displayed represent the correct answer."),e.createElement(z,{style:{fontSize:12,backgroundColor:"#eee",paddingInline:o.xxSmall_6,borderColor:"#ccc",borderStyle:"solid",borderWidth:1}},r.equationString)),r.children))}xe.__docgenInfo={description:"",methods:[],displayName:"InteractiveGraphCorrectAnswer",props:{id:{required:!0,tsType:{name:"string"},description:""},equationString:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};function Ae(r){const{ariaLabelValue:n,ariaDescriptionValue:a,onChange:t}=r,[l,i]=e.useState(!0);return e.createElement(e.Fragment,null,e.createElement(W,{title:"Description",isCollapsible:!0,isOpen:l,onToggle:i}),l&&e.createElement(u,null,e.createElement(ve,{style:_.caption},"Use these fields to describe the graph as a whole. These are used by screen readers to describe content to users who may be visually impaired."),e.createElement(g,{tag:"label"},"Title",e.createElement(Ke,{value:n,onChange:s=>t({fullGraphAriaLabel:s||void 0}),style:_.spaceAbove})),e.createElement(y,{size:o.small_12}),e.createElement(g,{tag:"label"},"Description",e.createElement(Xe,{rows:8,resizeType:"vertical",value:a,onChange:s=>t({fullGraphAriaDescription:s||void 0}),style:_.spaceAbove}))))}const _=v.StyleSheet.create({caption:{color:b.offBlack64,paddingTop:o.xxSmall_6,paddingBottom:o.xxSmall_6},spaceAbove:{marginTop:o.xxxSmall_4}});Ae.__docgenInfo={description:"",methods:[],displayName:"InteractiveGraphDescription",props:{ariaLabelValue:{required:!0,tsType:{name:"string"},description:""},ariaDescriptionValue:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(graphProps: Partial<EditorProps>) => void",signature:{arguments:[{type:{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
...
Locked figures are graph elements (points, lines, line segmeents,
etc.) that are locked in place and not interactive.`},{key:"fullGraphAriaLabel",value:{name:"string",required:!1}},{key:"fullGraphAriaDescription",value:{name:"string",required:!1}},{key:"graph",value:{name:'PropsFor["graph"]',raw:'InteractiveGraphProps["graph"]',required:!0},description:"The graph to display in the graph area."},{key:"onChange",value:{name:"signature",type:"function",raw:"(props: Partial<Props>) => void",signature:{arguments:[{type:{name:"Partial",elements:[{name:"Props"}],raw:"Partial<Props>"},name:"props"}],return:{name:"void"}},required:!0}},{key:"static",value:{name:"boolean",required:!1}}]}}],raw:"Partial<EditorProps>"},name:"graphProps"}],return:{name:"void"}}},description:""}}};const{InfoTip:an}=ke,tn=$e("ul");function on(r){const n=[],a=document.getElementById(r);return a&&a.querySelectorAll("*").forEach(t=>{var h;const l=[],i=t.getAttribute("aria-label"),s=t.getAttribute("aria-describedby");if(i&&l.unshift({name:"label",value:i}),s){const p=s.split(/ +/);for(const w of p){const C=(h=document.getElementById(w))==null?void 0:h.textContent;C&&l.push({name:"description",value:C})}}l.length>0&&n.push({roleOrTag:t.getAttribute("role")||t.tagName.toLowerCase(),className:t.classList[t.classList.length-1]||"",attributes:l})}),n}function ln(r){const{elementArias:n,showTags:a}=r;return e.createElement("ol",{style:{listStyle:"revert",marginLeft:8}},n.map((t,l)=>e.createElement("li",{key:l},a&&e.createElement(oe,{size:"small",kind:"success",style:O.smallSpaceRight},t.roleOrTag),t.className,e.createElement(tn,{style:O.indentListLeft},t.attributes.map((i,s)=>e.createElement("li",{key:s},e.createElement(oe,{size:"small",kind:i.name==="label"?"info":"neutral",style:O.smallSpaceRight},i.name),i.value))))))}function Pe({graphId:r,correct:n,fullGraphAriaLabel:a,fullGraphAriaDescription:t,lockedFigures:l}){const[i,s]=e.useState(!0),[h,p]=e.useState(!1),[w,C]=e.useState([]),x=e.useId();return e.useEffect(()=>{C(on(r))},[n,a,t,r,l]),e.createElement(e.Fragment,null,e.createElement(W,{title:"Screen reader tree",isOpen:i,onToggle:s,isCollapsible:!0}),i&&e.createElement(e.Fragment,null,e.createElement(u,{style:[O.row,O.tagSwitch]},e.createElement(Me,{id:x,checked:h,onChange:p}),e.createElement(y,{size:o.xSmall_8}),e.createElement(I,{tag:"label",htmlFor:x},"Show HTML roles/tags"),e.createElement(Ue,null),e.createElement(an,null,'This screen reader tree shows the ARIA labels and descriptions for elements within the "correct answer" Interactive Graph widget displayed above.')),e.createElement(ln,{elementArias:w,showTags:h})))}const O=v.StyleSheet.create({smallSpaceRight:{marginRight:o.xxSmall_6},indentListLeft:{listStyle:"revert",marginLeft:o.small_12},tagSwitch:{marginTop:o.xSmall_8,marginBottom:o.xSmall_8},row:{flexDirection:"row",alignItems:"center"}});Pe.__docgenInfo={description:"",methods:[],displayName:"InteractiveGraphSRTree"};const Ne=({numSegments:r=1,onChange:n})=>e.createElement(E,{key:"segment-select",selectedValue:`${r}`,placeholder:"",onChange:a=>{const t=+a;n(t)},style:sn.singleSelectShort},N.range(1,7).map(a=>e.createElement(d,{key:a,value:`${a}`,label:`${a} segment${a>1?"s":""}`}))),sn=v.StyleSheet.create({singleSelectShort:{height:26}});Ne.__docgenInfo={description:"",methods:[],displayName:"SegmentCountSelector",props:{numSegments:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"1",computed:!1}},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(numSegments: number) => void",signature:{arguments:[{type:{name:"number"},name:"numSegments"}],return:{name:"void"}}},description:""}}};const un=""+new URL("arrow-counter-clockwise-bold-Zg1fUITb.svg",import.meta.url).href,{getClockwiseAngle:mn}=De;function dn(r){if("startCoords"in r)return r.startCoords}function pn(r,n,a){switch(r.type){case"linear":case"ray":return be({...r,startCoords:void 0},n,a);case"segment":return we({...r,startCoords:void 0},n,a);case"linear-system":return ge({...r,startCoords:void 0},n,a);case"circle":const t=ye({...r,startCoords:void 0}),l=se(ue(t.radiusPoint,t.center));return{center:t.center,radius:l};case"sinusoid":return he({...r,startCoords:void 0},n,a);case"quadratic":return ce({...r,startCoords:void 0},n,a);case"point":return pe({...r,startCoords:void 0},n,a);case"polygon":return de({...r,startCoords:void 0},n,a);case"angle":return me({graph:{...r,startCoords:void 0},range:n,step:a});default:return}}const cn=r=>{const n=r[0],a=r[1],t=a[1]-n[1],l=Math.PI/(2*(a[0]-n[0])),i=n[0]*l,s=n[1];return"y = "+t.toFixed(3)+"sin("+l.toFixed(3)+"x - "+i.toFixed(3)+") + "+s.toFixed(3)},hn=r=>{const n=r[0],a=r[1],t=r[2],l=(n[0]-a[0])*(n[0]-t[0])*(a[0]-t[0]);if(l===0)return"Division by zero error";const i=(t[0]*(a[1]-n[1])+a[0]*(n[1]-t[1])+n[0]*(t[1]-a[1]))/l,s=(t[0]*t[0]*(n[1]-a[1])+a[0]*a[0]*(t[1]-n[1])+n[0]*n[0]*(a[1]-t[1]))/l,h=(a[0]*t[0]*(a[0]-t[0])*n[1]+t[0]*n[0]*(t[0]-n[0])*a[1]+n[0]*a[0]*(n[0]-a[0])*t[1])/l;return"y = "+i.toFixed(3)+"x^2 + "+s.toFixed(3)+"x + "+h.toFixed(3)},yn=(r,n=!1)=>{const a=r[1];return`${mn(r,n).toFixed(0)}° angle at (${a[0]}, ${a[1]})`},gn=(r,n)=>{if(n)return!1;switch(r.type){case"point":return r.numPoints!=="unlimited";case"polygon":return r.numSides!=="unlimited"&&r.snapTo!=="angles"&&r.snapTo!=="sides";case"none":return!1;case"angle":case"circle":case"linear":case"linear-system":case"quadratic":case"ray":case"segment":case"sinusoid":return!0;default:throw new fe(r)}},Ee=r=>{const{startCoords:n,allowReflexAngles:a,onChange:t}=r;return e.createElement(e.Fragment,null,e.createElement(u,{style:L.equationSection},e.createElement(X,null,"Starting equation:"),e.createElement(z,{style:L.equationBody},yn(n,a))),e.createElement(u,{style:L.tile},e.createElement(g,null,"Point 1:"),e.createElement(y,{size:o.small_12}),e.createElement(k,{coord:n[0],labels:["x","y"],onChange:l=>t([l,n[1],n[2]])})),e.createElement(u,{style:L.tile},e.createElement(g,null,"Vertex:"),e.createElement(y,{size:o.small_12}),e.createElement(k,{coord:n[1],labels:["x","y"],onChange:l=>t([n[0],l,n[2]])})),e.createElement(u,{style:L.tile},e.createElement(g,null,"Point 2:"),e.createElement(y,{size:o.small_12}),e.createElement(k,{coord:n[2],labels:["x","y"],onChange:l=>t([n[0],n[1],l])})))},L=v.StyleSheet.create({tile:{backgroundColor:b.fadedBlue8,marginTop:o.xSmall_8,padding:o.small_12,borderRadius:o.xSmall_8,flexDirection:"row",alignItems:"center"},equationSection:{marginTop:o.small_12},equationBody:{backgroundColor:b.fadedOffBlack8,border:`1px solid ${b.fadedOffBlack32}`,marginTop:o.xSmall_8,paddingLeft:o.xSmall_8,paddingRight:o.xSmall_8,fontSize:K.size.xSmall}});Ee.__docgenInfo={description:"",methods:[],displayName:"StartCoordsAngle",props:{startCoords:{required:!0,tsType:{name:"tuple",raw:"[Coord, Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},description:""},allowReflexAngles:{required:!1,tsType:{name:"boolean"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: AngleCoords) => void",signature:{arguments:[{type:{name:"tuple",raw:"[Coord, Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},name:"startCoords"}],return:{name:"void"}}},description:""}}};const Re=r=>{const{startCoords:n,onChange:a}=r,[t,l]=e.useState(n.radius.toString());e.useEffect(()=>{l(n.radius.toString())},[n.radius]);function i(s){l(s),!(isNaN(+s)||s===""||+s==0)&&a({center:n.center,radius:parseFloat(s)})}return e.createElement(u,{style:G.tile},e.createElement(u,{style:G.row},e.createElement(g,null,"Center:"),e.createElement(y,{size:o.small_12}),e.createElement(k,{coord:n.center,labels:["x","y"],onChange:s=>a({center:s,radius:n.radius})})),e.createElement(y,{size:o.small_12}),e.createElement(g,{tag:"label",style:G.row},"Radius:",e.createElement(y,{size:o.small_12}),e.createElement(Ze,{value:t,onChange:i,style:G.textField})))},G=v.StyleSheet.create({tile:{backgroundColor:b.fadedBlue8,marginTop:o.xSmall_8,padding:o.small_12,borderRadius:o.xSmall_8},row:{display:"flex",flexDirection:"row",alignItems:"center"},textField:{width:o.xxxLarge_64}});Re.__docgenInfo={description:"",methods:[],displayName:"StartCoordsCircle",props:{startCoords:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    center: Coord;
    radius: number;
    ...
    center: Coord;
    radius: number;
}`,signature:{properties:[{key:"center",value:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}],required:!0}},{key:"radius",value:{name:"number",required:!0}}]}},name:"startCoords"}],return:{name:"void"}}},description:""}}};const Le=r=>{const{startCoords:n,onChange:a}=r;return e.createElement(e.Fragment,null,e.createElement(u,{style:le.tile},e.createElement(g,null,"Point 1:"),e.createElement(y,{size:o.small_12}),e.createElement(k,{coord:n[0],labels:["x","y"],onChange:t=>a([t,n[1]])})),e.createElement(u,{style:le.tile},e.createElement(g,null,"Point 2:"),e.createElement(y,{size:o.small_12}),e.createElement(k,{coord:n[1],labels:["x","y"],onChange:t=>a([n[0],t])})))},le=v.StyleSheet.create({tile:{backgroundColor:b.fadedBlue8,marginTop:o.xSmall_8,padding:o.small_12,borderRadius:o.xSmall_8,flexDirection:"row",alignItems:"center"}});Le.__docgenInfo={description:"",methods:[],displayName:"StartCoordsLine",props:{startCoords:{required:!0,tsType:{name:"tuple",raw:"[Vector2, Vector2]",elements:[{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]},{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]}]},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: CollinearTuple) => void",signature:{arguments:[{type:{name:"tuple",raw:"[Vector2, Vector2]",elements:[{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]},{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]}]},name:"startCoords"}],return:{name:"void"}}},description:""}}};const Se=r=>{const{startCoords:n,type:a,onChange:t}=r,l=a==="segment"?"Segment":"Line";return e.createElement(e.Fragment,null,n.map((i,s)=>e.createElement(en,{key:`segment-${s}-start-coords`,header:e.createElement(g,null,`${l} ${s+1}`),expanded:!0},e.createElement(u,{style:ie.nestedTile},e.createElement(g,null,"Point 1:"),e.createElement(y,{size:o.small_12}),e.createElement(k,{coord:i[0],labels:["x","y"],onChange:h=>{const p=[...n];p[s]=[h,i[1]],t(p)}})),e.createElement(u,{style:ie.nestedTile},e.createElement(g,null,"Point 2:"),e.createElement(y,{size:o.small_12}),e.createElement(k,{coord:i[1],labels:["x","y"],onChange:h=>{const p=[...n];p[s]=[i[0],h],t(p)}})))))},ie=v.StyleSheet.create({nestedTile:{paddingBottom:o.small_12,flexDirection:"row",alignItems:"center"}});Se.__docgenInfo={description:"",methods:[],displayName:"StartCoordsMultiline",props:{type:{required:!0,tsType:{name:"union",raw:'"linear-system" | "segment"',elements:[{name:"literal",value:'"linear-system"'},{name:"literal",value:'"segment"'}]},description:""},startCoords:{required:!0,tsType:{name:"Array",elements:[{name:"tuple",raw:"[Vector2, Vector2]",elements:[{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]},{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]}]}],raw:"CollinearTuple[]"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: CollinearTuple[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"tuple",raw:"[Vector2, Vector2]",elements:[{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]},{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]}]}],raw:"CollinearTuple[]"},name:"startCoords"}],return:{name:"void"}}},description:""}}};const Ie=r=>{const{startCoords:n,onChange:a}=r;return e.createElement(e.Fragment,null,n.map((t,l)=>e.createElement(u,{key:l,style:wn.tile},e.createElement(g,null,`Point ${l+1}:`),e.createElement(y,{size:o.small_12}),e.createElement(k,{coord:t,labels:["x","y"],onChange:i=>{const s=[...n];s[l]=i,a(s)}}))))},wn=v.StyleSheet.create({tile:{backgroundColor:b.fadedBlue8,marginTop:o.xSmall_8,padding:o.small_12,borderRadius:o.xSmall_8,flexDirection:"row",alignItems:"center"}});Ie.__docgenInfo={description:"",methods:[],displayName:"StartCoordsPoint",props:{startCoords:{required:!0,tsType:{name:"ReadonlyArray",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}],raw:"ReadonlyArray<Coord>"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: ReadonlyArray<Coord>) => void",signature:{arguments:[{type:{name:"ReadonlyArray",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}],raw:"ReadonlyArray<Coord>"},name:"startCoords"}],return:{name:"void"}}},description:""}}};const Oe=r=>{const{startCoords:n,onChange:a}=r;return e.createElement(e.Fragment,null,e.createElement(u,{style:S.equationSection},e.createElement(X,null,"Starting equation:"),e.createElement(z,{style:S.equationBody},hn(n))),e.createElement(u,{style:S.tile},e.createElement(g,null,"Point 1:"),e.createElement(y,{size:o.small_12}),e.createElement(k,{coord:n[0],labels:["x","y"],onChange:t=>a([t,n[1],n[2]])})),e.createElement(u,{style:S.tile},e.createElement(g,null,"Point 2:"),e.createElement(y,{size:o.small_12}),e.createElement(k,{coord:n[1],labels:["x","y"],onChange:t=>a([n[0],t,n[2]])})),e.createElement(u,{style:S.tile},e.createElement(g,null,"Point 3:"),e.createElement(y,{size:o.small_12}),e.createElement(k,{coord:n[2],labels:["x","y"],onChange:t=>a([n[0],n[1],t])})))},S=v.StyleSheet.create({tile:{backgroundColor:b.fadedBlue8,marginTop:o.xSmall_8,padding:o.small_12,borderRadius:o.xSmall_8,flexDirection:"row",alignItems:"center"},equationSection:{marginTop:o.small_12},equationBody:{backgroundColor:b.fadedOffBlack8,border:`1px solid ${b.fadedOffBlack32}`,marginTop:o.xSmall_8,paddingLeft:o.xSmall_8,paddingRight:o.xSmall_8,fontSize:K.size.xSmall}});Oe.__docgenInfo={description:"",methods:[],displayName:"StartCoordsQuadratic",props:{startCoords:{required:!0,tsType:{name:"tuple",raw:"[Coord, Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: [Coord, Coord, Coord]) => void",signature:{arguments:[{type:{name:"tuple",raw:"[Coord, Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},name:"startCoords"}],return:{name:"void"}}},description:""}}};const Fe=r=>{const{startCoords:n,onChange:a}=r;return e.createElement(e.Fragment,null,e.createElement(u,{style:V.equationSection},e.createElement(X,null,"Starting equation:"),e.createElement(z,{style:V.equationBody},cn(n))),e.createElement(u,{style:V.tile},e.createElement(g,null,"Point 1:"),e.createElement(y,{size:o.small_12}),e.createElement(k,{coord:n[0],labels:["x","y"],onChange:t=>a([t,n[1]])})),e.createElement(u,{style:V.tile},e.createElement(g,null,"Point 2:"),e.createElement(y,{size:o.small_12}),e.createElement(k,{coord:n[1],labels:["x","y"],onChange:t=>a([n[0],t])})))},V=v.StyleSheet.create({tile:{backgroundColor:b.fadedBlue8,marginTop:o.xSmall_8,padding:o.small_12,borderRadius:o.xSmall_8,flexDirection:"row",alignItems:"center"},equationSection:{marginTop:o.small_12},equationBody:{backgroundColor:b.fadedOffBlack8,border:`1px solid ${b.fadedOffBlack32}`,marginTop:o.xSmall_8,paddingLeft:o.xSmall_8,paddingRight:o.xSmall_8,fontSize:K.size.xSmall}});Fe.__docgenInfo={description:"",methods:[],displayName:"StartCoordsSinusoid",props:{startCoords:{required:!0,tsType:{name:"tuple",raw:"[Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: SinusoidCoords) => void",signature:{arguments:[{type:{name:"tuple",raw:"[Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},name:"startCoords"}],return:{name:"void"}}},description:""}}};const bn=r=>{const{type:n,range:a,step:t,allowReflexAngles:l,onChange:i}=r;switch(n){case"linear":case"ray":const s=be(r,a,t);return e.createElement(Le,{startCoords:s,onChange:i});case"linear-system":case"segment":const h=n==="segment"?we(r,a,t):ge(r,a,t);return e.createElement(Se,{type:n,startCoords:h,onChange:i});case"circle":const p=ye(r),w=se(ue(p.radiusPoint,p.center));return e.createElement(Re,{startCoords:{center:p.center,radius:w},onChange:i});case"sinusoid":const C=he(r,a,t);return e.createElement(Fe,{startCoords:C,onChange:i});case"quadratic":const x=ce(r,a,t);return e.createElement(Oe,{startCoords:x,onChange:i});case"point":case"polygon":const F=n==="point"?pe(r,a,t):de(r,a,t);return e.createElement(Ie,{startCoords:F,onChange:i});case"angle":const j=me({graph:r,range:a,step:t});return e.createElement(Ee,{startCoords:j,allowReflexAngles:l,onChange:i});default:return null}},je=r=>{const{range:n,step:a,onChange:t}=r,[l,i]=e.useState(!0);return e.createElement(u,null,e.createElement(W,{isCollapsible:!0,title:"Start coordinates",isOpen:l,onToggle:()=>i(!l)}),l&&e.createElement(e.Fragment,null,e.createElement(bn,{...r}),e.createElement(y,{size:o.small_12}),e.createElement(Ye,{startIcon:un,kind:"tertiary",size:"small",onClick:()=>{t(pn(r,n,a))}},"Use default start coordinates")))};je.__docgenInfo={description:"",methods:[],displayName:"StartCoordsSettings",props:{range:{required:!0,tsType:{name:"tuple",raw:"[x: Range, y: Range]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},step:{required:!0,tsType:{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},allowReflexAngles:{required:!1,tsType:{name:"boolean"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: StartCoords) => void",signature:{arguments:[{type:{name:'Extract["startCoords"]',raw:`Extract<
    PerseusGraphType,
    GraphTypesThatHaveStartCoords
>["startCoords"]`},name:"startCoords"}],return:{name:"void"}}},description:""}}};const{InfoTip:P}=ke,H=ze.widget,kn=N.map(N.range(3,13),function(r){return e.createElement(d,{key:`polygon-sides-${r}`,value:`${r}`,label:`${r} sides`})}),M=class M extends e.Component{constructor(){super(...arguments),this.displayName="InteractiveGraphEditor",this.className="perseus-widget-interactive-graph",this.changeStartCoords=n=>{var t;if(!((t=this.props.graph)!=null&&t.type))return;const a={...this.props.graph,startCoords:n};this.props.onChange({graph:a})},this.getSaveWarnings=()=>{var a;const n=[];for(const t of this.props.lockedFigures??[])t.type==="line"&&Ge(t.points[0].coord,t.points[1].coord)&&n.push("The line cannot have length 0.");return((a=this.props.graph)==null?void 0:a.type)==="polygon"&&this.props.graph.numSides==="unlimited"&&this.props.graph.coords===null&&n.push("Polygon must be closed."),n}}serialize(){const n=N.pick(this.props,"step","backgroundImage","markings","labels","showProtractor","showTooltips","range","gridStep","snapStep","lockedFigures","fullGraphAriaLabel","fullGraphAriaDescription"),a=this.refs.graph;if(a){const t=a&&a.getUserInput();N.extend(n,{graph:{type:t.type,startCoords:this.props.graph&&dn(this.props.graph)},correct:t}),N.each(["allowReflexAngles","angleOffsetDeg","numPoints","numSides","numSegments","showAngles","showSides","snapTo","snapDegrees"],function(l){N.has(t,l)&&(n.graph[l]=t[l])})}return n}render(){let n,a;const t=this.props.gridStep||te.getGridStep(this.props.range,this.props.step,He.defaultBoxSize),l=this.props.snapStep||te.snapStepFromGridStep(t),i=_e.SMALL;if(this.props.valid===!0){const s=this.props.correct,h={ref:"graph",box:this.props.box,range:this.props.range,labels:this.props.labels,step:this.props.step,gridStep:t,snapStep:l,graph:s,backgroundImage:this.props.backgroundImage,markings:this.props.markings,showProtractor:this.props.showProtractor,showTooltips:this.props.showTooltips,lockedFigures:this.props.lockedFigures,fullGraphAriaLabel:this.props.fullGraphAriaLabel,fullGraphAriaDescription:this.props.fullGraphAriaDescription,trackInteraction:function(){},onChange:({graph:p})=>{let w=this.props.correct;c(p!=null),w.type===p.type?w=fn(w,p):w=p,this.props.onChange({correct:w,graph:this.props.graph})}};n=e.createElement(H,{...h,containerSizeClass:i,apiOptions:{...this.props.apiOptions,isMobile:!1}}),a=H.getEquationString(h)}else n=e.createElement("div",{className:"perseus-error"},this.props.valid);return e.createElement(Be,null,s=>{var h,p,w,C,x,F,j,U,Q,J,Y,Z,ee,ne,re,ae;return e.createElement(u,null,e.createElement(A,{label:"Answer type:"},e.createElement(Te,{graphType:((h=this.props.graph)==null?void 0:h.type)??H.defaultProps.graph.type,onChange:m=>{this.props.onChange({graph:{type:m},correct:{type:m}})}})),e.createElement(Ae,{ariaLabelValue:this.props.fullGraphAriaLabel??"",ariaDescriptionValue:this.props.fullGraphAriaDescription??"",onChange:this.props.onChange}),e.createElement(xe,{id:s,equationString:a},n),((p=this.props.correct)==null?void 0:p.type)==="point"&&e.createElement(A,{label:"Number of Points:"},e.createElement(qe,{numPoints:(w=this.props.correct)==null?void 0:w.numPoints,onChange:m=>{this.props.onChange({correct:{type:"point",numPoints:m},graph:{type:"point",numPoints:m}})}})),((C=this.props.correct)==null?void 0:C.type)==="angle"&&e.createElement(e.Fragment,null,e.createElement(u,{style:T.row},e.createElement(D,{label:e.createElement(I,null,"Show angle measures"),checked:!!((x=this.props.correct)!=null&&x.showAngles),onChange:m=>{var f;((f=this.props.graph)==null?void 0:f.type)==="angle"&&(c(this.props.correct.type==="angle",`Expected graph type to be angle, but got ${this.props.correct.type}`),this.props.onChange({correct:{...this.props.correct,showAngles:m},graph:{...this.props.graph,showAngles:m}}))}}),e.createElement(P,null,e.createElement("p",null,"Displays the interior angle measures."))),e.createElement(u,{style:T.row},e.createElement(D,{label:e.createElement(I,null,"Allow reflex angles"),checked:!!((F=this.props.correct)!=null&&F.allowReflexAngles),onChange:m=>{var q,R;c(this.props.correct.type==="angle",`Expected graph type to be angle, but got ${this.props.correct.type}`),c(((q=this.props.graph)==null?void 0:q.type)==="angle",`Expected graph type to be angle, but got ${(R=this.props.graph)==null?void 0:R.type}`);const f={allowReflexAngles:m};this.props.onChange({correct:{...this.props.correct,...f},graph:{...this.props.graph,...f}})}}),e.createElement(P,null,e.createElement("p",null,"Allow students to be able to create reflex angles.")))),((j=this.props.correct)==null?void 0:j.type)==="polygon"&&e.createElement(e.Fragment,null,e.createElement(A,{label:"Number of sides:"},e.createElement(E,{key:"polygon-select",selectedValue:(U=this.props.correct)!=null&&U.numSides?`${this.props.correct.numSides}`:"3",placeholder:"",onChange:m=>{var q;c(((q=this.props.graph)==null?void 0:q.type)==="polygon");const f={numSides:Ce(m),coords:null,startCoords:void 0,snapTo:"grid"};this.props.onChange({correct:{...this.props.correct,...f},graph:{...this.props.graph,...f}})},style:T.singleSelectShort},[...kn,e.createElement(d,{key:"unlimited",value:"unlimited",label:"unlimited sides"})])),e.createElement(A,{label:"Snap to:"},e.createElement(E,{selectedValue:((Q=this.props.correct)==null?void 0:Q.snapTo)||"grid",placeholder:"",onChange:m=>{var q,R;c(this.props.correct.type==="polygon",`Expected correct answer type to be polygon, but got ${this.props.correct.type}`),c(((q=this.props.graph)==null?void 0:q.type)==="polygon",`Expected graph type to be polygon, but got ${(R=this.props.graph)==null?void 0:R.type}`);const f={snapTo:m,coords:null};this.props.onChange({correct:{...this.props.correct,...f},graph:{...this.props.graph,...f}})},style:T.singleSelectShort},e.createElement(d,{value:"grid",label:"grid"}),((J=this.props.correct)==null?void 0:J.numSides)!=="unlimited"&&e.createElement(d,{value:"angles",label:"interior angles"}),((Y=this.props.correct)==null?void 0:Y.numSides)!=="unlimited"&&e.createElement(d,{value:"sides",label:"side measures"})),e.createElement(P,null,e.createElement("p",null,"These options affect the movement of the vertex points. The grid option will guide the points to the nearest half step along the grid."),e.createElement("p",null,"The interior angle and side measure options guide the points to the nearest whole angle or side measure respectively."))),e.createElement(u,{style:T.row},e.createElement(D,{label:e.createElement(I,null,"Show angle measures"),checked:!!((Z=this.props.correct)!=null&&Z.showAngles),onChange:()=>{var m;((m=this.props.graph)==null?void 0:m.type)==="polygon"&&(c(this.props.correct.type==="polygon",`Expected graph type to be polygon, but got ${this.props.correct.type}`),this.props.onChange({correct:{...this.props.correct,showAngles:!this.props.correct.showAngles},graph:{...this.props.graph,showAngles:!this.props.graph.showAngles}}))}}),e.createElement(P,null,e.createElement("p",null,"Displays the interior angle measures."))),e.createElement(u,{style:T.row},e.createElement(D,{label:e.createElement(I,null,"Show side measures"),checked:!!((ee=this.props.correct)!=null&&ee.showSides),onChange:()=>{var m;((m=this.props.graph)==null?void 0:m.type)==="polygon"&&this.props.correct.type==="polygon"&&this.props.onChange({correct:{...this.props.correct,showSides:!this.props.correct.showSides},graph:{...this.props.graph,showSides:!this.props.graph.showSides}})}}),e.createElement(P,null,e.createElement("p",null,"Displays the side lengths.")))),((ne=this.props.correct)==null?void 0:ne.type)==="segment"&&e.createElement(A,{label:"Number of segments:"},e.createElement(Ne,{numSegments:(re=this.props.correct)==null?void 0:re.numSegments,onChange:m=>{this.props.onChange({correct:{type:"segment",numSegments:m,coords:null},graph:{type:"segment",numSegments:m}})}})),((ae=this.props.graph)==null?void 0:ae.type)&&gn(this.props.graph,this.props.static)&&e.createElement(je,{...this.props.graph,range:this.props.range,step:this.props.step,onChange:this.changeStartCoords}),e.createElement(Pe,{graphId:s,correct:this.props.correct,fullGraphAriaLabel:this.props.fullGraphAriaLabel,fullGraphAriaDescription:this.props.fullGraphAriaDescription,lockedFigures:this.props.lockedFigures}),e.createElement(Qe,{box:We(i),range:this.props.range,labels:this.props.labels,step:this.props.step,gridStep:t,snapStep:l,valid:this.props.valid,backgroundImage:this.props.backgroundImage,markings:this.props.markings,showProtractor:this.props.showProtractor,showTooltips:this.props.showTooltips,onChange:this.props.onChange}),this.props.correct.type==="polygon"&&e.createElement(A,{label:"Student answer must"},e.createElement(E,{selectedValue:this.props.correct.match||"exact",onChange:m=>{c(this.props.correct.type==="polygon",`Expected graph type to be polygon, but got ${this.props.correct.type}`);const f={...this.props.correct,match:m};this.props.onChange({correct:f})},placeholder:"",style:T.singleSelectShort},e.createElement(d,{value:"exact",label:"match exactly"}),e.createElement(d,{value:"congruent",label:"be congruent"}),e.createElement(d,{value:"approx",label:"be approximately congruent"}),e.createElement(d,{value:"similar",label:"be similar"})),e.createElement(P,null,e.createElement("ul",null,e.createElement("li",null,e.createElement("p",null,e.createElement("b",null,"Match Exactly:")," Match exactly in size, orientation, and location on the grid even if it is not shown in the background.")),e.createElement("li",null,e.createElement("p",null,e.createElement("b",null,"Be Congruent:")," Be congruent in size and shape, but can be located anywhere on the grid.")),e.createElement("li",null,e.createElement("p",null,e.createElement("b",null,"Be Approximately Congruent:")," ","Be exactly similar, and congruent in size and shape to within 0.1 units, but can be located anywhere on the grid."," ",e.createElement("em",null,"Use this with snapping to angle measure."))),e.createElement("li",null,e.createElement("p",null,e.createElement("b",null,"Be Similar:")," Be similar with matching interior angles, and side measures that are matching or a multiple of the correct side measures. The figure can be located anywhere on the grid."))))),this.props.correct.type==="angle"&&e.createElement(A,{label:"Student answer must"},e.createElement(E,{selectedValue:this.props.correct.match||"exact",onChange:m=>{this.props.onChange({correct:{...this.props.correct,match:m}})},placeholder:"",style:T.singleSelectShort},e.createElement(d,{value:"exact",label:"match exactly"}),e.createElement(d,{value:"congruent",label:"be congruent"})),e.createElement(P,null,e.createElement("p",null,"Congruency requires only that the angle measures are the same. An exact match implies congruency, but also requires that the angles have the same orientation and that the vertices are in the same position."))),e.createElement(Je,{figures:this.props.lockedFigures,onChange:this.props.onChange}))})}};M.widgetName="interactive-graph",M.defaultProps={...Ve.defaultWidgetOptions,valid:!0};let B=M;function fn(r,n){if(r.type!==n.type)throw new Error(`Cannot merge graphs with different types (${r.type} and ${n.type})`);switch(r.type){case"angle":return c(n.type==="angle"),{...r,...n};case"circle":return c(n.type==="circle"),{...r,...n};case"linear":return c(n.type==="linear"),{...r,...n};case"linear-system":return c(n.type==="linear-system"),{...r,...n};case"none":return c(n.type==="none"),{...r,...n};case"point":return c(n.type==="point"),{...r,...n};case"polygon":return c(n.type==="polygon"),{...r,...n};case"quadratic":return c(n.type==="quadratic"),{...r,...n};case"ray":return c(n.type==="ray"),{...r,...n};case"segment":return c(n.type==="segment"),{...r,...n};case"sinusoid":return c(n.type==="sinusoid"),{...r,...n};default:throw new fe(r)}}const T=v.StyleSheet.create({singleSelectShort:{height:26},row:{flexDirection:"row",marginTop:o.xSmall_8,alignItems:"center"}});B.__docgenInfo={description:`An editor for the InteractiveGraph widget, which allows the user to
...
>`},description:""},labels:{required:!1,tsType:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},description:"The labels for the x and y axes.",defaultValue:{value:'["x", "y"]',computed:!1}},range:{required:!1,tsType:{name:"tuple",raw:"[x: Range, y: Range]",elements:[{name:"unknown"},{name:"unknown"}]},description:"The range of the graph in the x and y directions.",defaultValue:{value:`[
    [-10, 10],
    [-10, 10],
...
Locked figures are graph elements (points, lines, line segmeents,
etc.) that are locked in place and not interactive.`},{key:"fullGraphAriaLabel",value:{name:"string",required:!1}},{key:"fullGraphAriaDescription",value:{name:"string",required:!1}},{key:"graph",value:{name:'PropsFor["graph"]',raw:'InteractiveGraphProps["graph"]',required:!0},description:"The graph to display in the graph area."},{key:"onChange",value:{name:"signature",type:"function",raw:"(props: Partial<Props>) => void",signature:{arguments:[{type:{name:"Partial",elements:[{name:"Props"}],raw:"Partial<Props>"},name:"props"}],return:{name:"void"}},required:!0}},{key:"static",value:{name:"boolean",required:!1}}]}}],raw:"Partial<Props>"},name:"props"}],return:{name:"void"}}},description:""},static:{required:!1,tsType:{name:"boolean"},description:""}}};export{B as I};
