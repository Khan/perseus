import{j as o,a as y,F as R}from"./jsx-runtime-5BUNAZ9W.js";import{B as _}from"./choice--doa5VMp.js";import{V as k,u as H}from"./index-e4P84RkC.js";import{S as W}from"./index-wjVcXLkf.js";import{s as g,c as $}from"./index-lUErx3pE.js";import{l as F}from"./index-awljIyHI.js";import{r as f}from"./index-4g5l5LRQ.js";import{H as O}from"./heading-JjOPNpXt.js";import{g as B}from"./util-00_Q93kT.js";import{a as j,b as D}from"./answer-choices-91H7kwe8.js";import{L as G}from"./locked-ellipse-settings-fd_9ksT0.js";import{L as N}from"./locked-function-settings-pQUR-spx.js";import{L as z}from"./locked-line-settings-JRDXo3gg.js";import{L as U}from"./locked-point-settings-cGNucCsF.js";import{L as V}from"./locked-polygon-settings-7CaCSr86.js";import{L as J}from"./locked-vector-settings-WhCuw11_.js";const T=r=>{const{id:m,onChange:s}=r,l=["point","line","vector","ellipse","polygon"],d=r.showM2bFeatures?[...l,"function"]:l;return o(k,{style:v.container,children:o(j,{menuText:"Add locked figure",style:v.addElementSelect,children:d.map(c=>o(D,{label:c,onClick:()=>s(c)},`${m}-${c}`))})})},v=F.StyleSheet.create({container:{marginTop:g.xSmall_8},addElementSelect:{backgroundColor:$.fadedBlue8,borderRadius:g.xxxSmall_4}});T.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSelect",props:{showM2bFeatures:{required:!0,tsType:{name:"boolean"},description:""},id:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: string) => void",signature:{arguments:[{type:{name:"string"},name:"value"}],return:{name:"void"}}},description:""}}};const S=r=>{switch(r.type){case"point":return o(U,{...r});case"line":return o(z,{...r});case"vector":return o(J,{...r});case"ellipse":return o(G,{...r});case"polygon":return o(V,{...r});case"function":if(r.showM2bFeatures)return o(N,{...r});break}return null};S.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSettings",props:{showM2bFeatures:{required:!1,tsType:{name:"boolean"},description:""},onMove:{required:!0,tsType:{name:"signature",type:"function",raw:"(movement: LockedFigureSettingsMovementType) => void",signature:{arguments:[{type:{name:"union",raw:`| "back"
| "backward"
| "forward"
| "front"`,elements:[{name:"literal",value:'"back"'},{name:"literal",value:'"backward"'},{name:"literal",value:'"forward"'},{name:"literal",value:'"front"'}]},name:"movement"}],return:{name:"void"}}},description:"Called when a movement button (top, up, down, bottom) is pressed."},onRemove:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Called when the delete button is pressed."},expanded:{required:!1,tsType:{name:"boolean"},description:"Whether this accordion is expanded."},onToggle:{required:!1,tsType:{name:"signature",type:"function",raw:"(expanded: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"expanded"}],return:{name:"void"}}},description:"Called when the accordion is expanded or collapsed."}}};const L=r=>{const m=Array((r.figures??[]).length).fill(!1),[s,l]=f.useState(m),[d,c]=f.useState(!0),w=H().get("locked-figures-section"),{figures:t,onChange:p}=r;function q(e){const a={lockedFigures:[...t||[],B(e)]};p(a),l([...s,!0])}function P(e,n){if(e===0&&(n==="back"||n==="backward")||t&&e===t.length-1&&(n==="front"||n==="forward"))return;const i=[...t||[]],u=[...s],[h]=i.splice(e,1);switch(u.splice(e,1),n){case"back":i.unshift(h),u.unshift(!0);break;case"backward":i.splice(e-1,0,h),u.splice(e-1,0,!0);break;case"forward":i.splice(e+1,0,h),u.splice(e+1,0,!0);break;case"front":i.push(h),u.push(!0);break}p({lockedFigures:i}),l(u)}function C(e){if(window.confirm("Are you sure you want to delete this figure?")){const n=t||[];p({lockedFigures:[...n.slice(0,e),...n.slice(e+1)]});const a=[...s];a.splice(e,1),l(a)}}function I(e,n){const a=t||[],i={lockedFigures:[...a.slice(0,e),{...a[e],...n},...a.slice(e+1)]};p(i)}function A(e){l(Array(t==null?void 0:t.length).fill(e))}const b=s.every(e=>!e),E=b?"Expand all":"Collapse all",M=!!(t!=null&&t.length);return y(R,{children:[o(O,{title:"Locked Figures",isOpen:d,onToggle:()=>c(!d),isCollapsible:!0}),d&&y(k,{children:[t==null?void 0:t.map((e,n)=>{if(e.type!=="label")return o(S,{showM2bFeatures:r.showM2bFeatures,expanded:s[n],onToggle:a=>{const i=[...s];i[n]=a,l(i)},...e,onChangeProps:a=>I(n,a),onMove:a=>P(n,a),onRemove:()=>C(n)},`${w}-locked-${e}-${n}`)}),y(k,{style:x.buttonContainer,children:[o(T,{showM2bFeatures:r.showM2bFeatures,id:`${w}-select`,onChange:q}),o(W,{size:g.small_12}),M&&o(_,{kind:"secondary",onClick:()=>A(b),style:x.button,children:E})]})]})]})},x=F.StyleSheet.create({buttonContainer:{flexDirection:"row",alignItems:"center"},button:{marginTop:g.xSmall_8,flexGrow:1}}),ce=L;L.__docgenInfo={description:"",methods:[],displayName:"LockedFiguresSection",props:{showM2bFeatures:{required:!0,tsType:{name:"boolean"},description:""},figures:{required:!1,tsType:{name:"Array",elements:[{name:"LockedFigure"}],raw:"Array<LockedFigure>"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(props: Partial<InteractiveGraphEditorProps>) => void",signature:{arguments:[{type:{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
