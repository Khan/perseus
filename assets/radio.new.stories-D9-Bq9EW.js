import{cL as t,j as s}from"./iframe-DUcWS4Kc.js";import{S as oe}from"./server-item-renderer-with-debug-ui-Bx-Z22oz.js";import{a as p,c as ie,S as $,b as ee,m as ae,d as te,e as se}from"./radio.testdata-C1vj3X_t.js";import"./split-view-CvDZe8wx.js";import"./test-keypad-context-wrapper-BwchvXCS.js";import"./server-item-renderer-C1A2hIGM.js";import"./hints-renderer-B13fU_rg.js";const ye={title:"Perseus/Widgets/RadioNew",args:{static:!1,startAnswerless:!1,reviewMode:!1,showSolutions:"none",item:t({question:p})},argTypes:{showSolutions:{options:["none","all","selected"],control:{type:"select"}}},render:e=>s.jsx(oe,{item:ce(e),apiOptions:le(),reviewMode:e.reviewMode,showSolutions:e.showSolutions,startAnswerless:e.startAnswerless}),parameters:{docs:{description:{component:`This is a story for the new radio widget.
