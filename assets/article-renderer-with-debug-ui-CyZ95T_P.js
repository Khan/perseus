import{j as e}from"./jsx-runtime-BT65X5dW.js";import{V as t}from"./index-CskvhqFA.js";import{P as c}from"./index-CIHqsnLr.js";import{S as p}from"./all-widgets-hzI2gZnU.js";import{T as m,d as g}from"./test-keypad-context-wrapper-kAMYxp7I.js";import{r as i}from"./index-C6mWTJJr.js";import{a as y}from"./mobile-keypad-DXbo4ks3.js";import{A as w}from"./article-renderer-DsYmzQwx.js";import{S as f}from"./split-view-ymrOLumz.js";import{s as b}from"./test-dependencies-CsL3D0O6.js";const k=({title:o="📜 Article",json:a,apiOptions:r=Object.freeze({}),linterContext:s})=>{const d=i.useRef(null),[n,l]=i.useState(r.isMobile??!1),u={...r,isMobile:n,customKeypad:n};return e.jsx(f,{rendererTitle:e.jsxs(t,{style:{flexDirection:"row",alignItems:"center",width:"100%"},children:[o,e.jsx(t,{style:{marginLeft:"auto"},children:e.jsx(p,{icon:e.jsx(c,{icon:g}),checked:n,onChange:l})})]}),renderer:e.jsx(e.Fragment,{children:e.jsx(m,{children:e.jsx(y.Consumer,{children:({keypadElement:h})=>e.jsx(t,{className:n?"perseus-mobile":"",children:e.jsx(w,{ref:d,apiOptions:u,json:a,dependencies:b,keypadElement:h,linterContext:s})})})})}),jsonObject:a})};k.__docgenInfo={description:"",methods:[],displayName:"ArticleRendererWithDebugUI",props:{title:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'"📜 Article"',computed:!1}},json:{required:!0,tsType:{name:"union",raw:"PerseusRenderer | ReadonlyArray<PerseusRenderer>",elements:[{name:"signature",type:"object",raw:`{
    /**
...
@deprecated`},{key:"images",value:{name:"signature",type:"object",raw:`{
    ...
    height: number;
}`,signature:{properties:[{key:"width",value:{name:"number",required:!0}},{key:"height",value:{name:"number",required:!0}}]},required:!0}}]},required:!0},description:"A dictionary of {[imageUrl]: PerseusImageDetail}."}]}},{name:"ReadonlyArray",elements:[{name:"signature",type:"object",raw:`{
    /**
     * Translatable Markdown content to be rendered.  May include references to
     * widgets (as [[☃ widgetName]]) or images (as ![image text](imageUrl)).
     * For each image found in this content, there can be an entry in the
...
@deprecated`},{key:"images",value:{name:"signature",type:"object",raw:`{
    ...
    // the height of the image
    height: number;
}`,signature:{properties:[{key:"width",value:{name:"number",required:!0}},{key:"height",value:{name:"number",required:!0}}]},required:!0}}]},required:!0},description:"A dictionary of {[imageUrl]: PerseusImageDetail}."}]}}],raw:"ReadonlyArray<PerseusRenderer>"}]},description:"The Perseus Article to render. Under the hood this has been named\n`json`, but it is the article. Trust me."},apiOptions:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
...
}`,signature:{properties:[{key:"contentType",value:{name:"string",required:!0}},{key:"highlightLint",value:{name:"boolean",required:!0}},{key:"paths",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!0}},{key:"stack",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!0}}]}},description:""}}};export{k as A};
