import{j as n}from"./jsx-runtime-63Ea5SlK.js";import{B as R}from"./index-69t9pbsh.js";import{V as g}from"./index-CgfdZoMj.js";import{S}from"./index-C1N8lBvx.js";import{s as c,c as E}from"./index-dmcq622U.js";import{l as f}from"./index-awljIyHI.js";import{r as h}from"./index-6oxdNXpR.js";import{H as j}from"./heading-ZiSKfWRf.js";import{a as D,b as G}from"./answer-choices-fn2xDQQF.js";import{L as M}from"./locked-ellipse-settings-oMTonBiw.js";import{L as W}from"./locked-function-settings-vWBwTndf.js";import{L as z}from"./locked-label-settings-s02zBwIZ.js";import{L as V}from"./locked-line-settings-_AwFPjIS.js";import{L as H}from"./locked-point-settings-uinQlNXg.js";import{L as K}from"./locked-polygon-settings-5HHoo4Vn.js";import{L as X}from"./locked-vector-settings-m_LdoFO6.js";import{g as _}from"./util-H2zlKSnO.js";const q=a=>{const{id:y,onChange:i}=a,u=["point","line","vector","ellipse","polygon","function",...a.showLabelsFlag?["label"]:[]];return n.jsx(g,{style:k.container,children:n.jsx(D,{menuText:"Add locked figure",style:k.addElementSelect,children:u.map(s=>n.jsx(G,{label:s,onClick:()=>i(s)},`${y}-${s}`))})})},k=f.StyleSheet.create({container:{marginTop:c.xSmall_8},addElementSelect:{backgroundColor:E.fadedBlue8,borderRadius:c.xxxSmall_4}});q.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSelect",props:{showLabelsFlag:{required:!1,tsType:{name:"boolean"},description:""},id:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: LockedFigureType) => void",signature:{arguments:[{type:{name:'union["type"]',raw:'LockedFigure["type"]'},name:"value"}],return:{name:"void"}}},description:""}}};const C=a=>{switch(a.type){case"point":return n.jsx(H,{...a});case"line":return n.jsx(V,{...a});case"vector":return n.jsx(X,{...a});case"ellipse":return n.jsx(M,{...a});case"polygon":return n.jsx(K,{...a});case"function":return n.jsx(W,{...a});case"label":if(a.showLabelsFlag)return n.jsx(z,{...a});break}return null};C.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSettings",props:{flags:{required:!1,tsType:{name:'Readonly["flags"]',raw:'APIOptions["flags"]'},description:""},showLabelsFlag:{required:!1,tsType:{name:"boolean"},description:""},onMove:{required:!0,tsType:{name:"signature",type:"function",raw:"(movement: LockedFigureSettingsMovementType) => void",signature:{arguments:[{type:{name:"union",raw:`| "back"
| "backward"
| "forward"
| "front"`,elements:[{name:"literal",value:'"back"'},{name:"literal",value:'"backward"'},{name:"literal",value:'"forward"'},{name:"literal",value:'"front"'}]},name:"movement"}],return:{name:"void"}}},description:"Called when a movement button (top, up, down, bottom) is pressed."},onRemove:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Called when the delete button is pressed."},expanded:{required:!1,tsType:{name:"boolean"},description:"Whether this accordion is expanded."},onToggle:{required:!1,tsType:{name:"signature",type:"function",raw:"(expanded: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"expanded"}],return:{name:"void"}}},description:"Called when the accordion is expanded or collapsed."}}};const T=a=>{const y=Array((a.figures??[]).length).fill(!1),[i,u]=h.useState(y),[s,A]=h.useState(!0),w=h.useId(),{figures:t,onChange:m}=a;function x(e){const o={lockedFigures:[...t||[],_(e)]};m(o),u([...i,!0])}function L(e,r){if(e===0&&(r==="back"||r==="backward")||t&&e===t.length-1&&(r==="front"||r==="forward"))return;const l=[...t||[]],d=[...i],[p]=l.splice(e,1);switch(d.splice(e,1),r){case"back":l.unshift(p),d.unshift(!0);break;case"backward":l.splice(e-1,0,p),d.splice(e-1,0,!0);break;case"forward":l.splice(e+1,0,p),d.splice(e+1,0,!0);break;case"front":l.push(p),d.push(!0);break}m({lockedFigures:l}),u(d)}function P(e){if(window.confirm("Are you sure you want to delete this figure?")){const r=t||[];m({lockedFigures:[...r.slice(0,e),...r.slice(e+1)]});const o=[...i];o.splice(e,1),u(o)}}function N(e,r){const o=t||[],l={lockedFigures:[...o.slice(0,e),{...o[e],...r},...o.slice(e+1)]};m(l)}function F(e){u(Array(t==null?void 0:t.length).fill(e))}const b=i.every(e=>!e),I=b?"Expand all":"Collapse all",O=!!(t!=null&&t.length);return n.jsxs(n.Fragment,{children:[n.jsx(j,{title:"Locked Figures",isOpen:s,onToggle:()=>A(!s),isCollapsible:!0}),s&&n.jsxs(g,{children:[t==null?void 0:t.map((e,r)=>n.jsx(C,{flags:a.flags,showLabelsFlag:a.showLabelsFlag,expanded:i[r],onToggle:o=>{const l=[...i];l[r]=o,u(l)},...e,onChangeProps:o=>N(r,o),onMove:o=>L(r,o),onRemove:()=>P(r)},`${w}-locked-${e}-${r}`)),n.jsxs(g,{style:v.buttonContainer,children:[n.jsx(q,{showLabelsFlag:a.showLabelsFlag,id:`${w}-select`,onChange:x}),n.jsx(S,{size:c.small_12}),O&&n.jsx(R,{kind:"secondary",onClick:()=>F(b),style:v.button,children:I})]})]})]})},v=f.StyleSheet.create({buttonContainer:{flexDirection:"row",alignItems:"center"},button:{marginTop:c.xSmall_8,flexGrow:1}}),de=T;T.__docgenInfo={description:"",methods:[],displayName:"LockedFiguresSection",props:{flags:{required:!1,tsType:{name:'Readonly["flags"]',raw:'APIOptions["flags"]'},description:""},showLabelsFlag:{required:!1,tsType:{name:"boolean"},description:""},figures:{required:!1,tsType:{name:"Array",elements:[{name:"union",raw:`| LockedPointType
| LockedLineType
| LockedVectorType
| LockedEllipseType
| LockedPolygonType
