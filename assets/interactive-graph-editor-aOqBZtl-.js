import{j as e}from"./jsx-runtime-63Ea5SlK.js";import{U as pe}from"./util-AYeX86gl.js";import{l as ve,s as we,e as Ue}from"./svg-image-FcZanvM1.js";import{g as fe,f as ke,h as qe,i as Te,j as Ae,k as Re,n as Ce,o as xe,q as Oe,r as He,s as Ke}from"./article-renderer-h_m-tvVP.js";import{_ as C}from"./jquery-yG1GhClm.js";import"./phet-simulation-_7qOO4_B.js";import"./version-akiLXZts.js";import"./dependencies-CP7Uh8Kq.js";import"./perseus-api-1-ethIrW.js";import"./perseus-item-334dAsMX.js";import"./hints-renderer-Ebeftjch.js";import{m as Be,n as Xe}from"./renderer-yXFj-6ty.js";import"./base-radio-XsQBfrsT.js";import{c as Qe}from"./components-2XngBvY8.js";import{i as Ye}from"./constants-iPV6vHZm.js";import"./index-k-0mNqHS.js";import"./i18n-context-fsWEgybQ.js";import{w as je}from"./index-J2t_5nK1.js";import{i as y}from"./tiny-invariant-bHgPayXn.js";import"./index-smZ6iCr_.js";import{V as d}from"./index-0DbkllkJ.js";import{S as x,O as m}from"./answer-choices-o46t7GFm.js";import{T as Ze,a as Je,C as F}from"./index-V5gl6frG.js";import{s as i,c,a as H}from"./index-deFLJwr4.js";import{c as Ne,f as D,L as h,a as K,b as S}from"./index-18qWGOW7.js";import{l as f}from"./index-awljIyHI.js";import{r as P}from"./index-6oxdNXpR.js";import{H as B}from"./heading-1izW0-GJ.js";import{S as g}from"./index-nqMmpXbO.js";import{L as A,I as er}from"./interactive-graph-settings-pw3hKJzp.js";import{L as rr}from"./locked-figures-section-TVvL2-a2.js";import"./button-group-G5CZaedn.js";import"./graph-4ZDD3NK_.js";import"./hud-ifw9Ofbw.js";import"./icon-7RFbyLiL.js";import"./index-BIPwuHvF.js";import"./inline-icon-6fh0Wu1y.js";import"./math-input-ILg8RrvB.js";import"./multi-button-group-QUVHbBcE.js";import"./number-input-ogh82yD8.js";import"./range-input-w5Z3sPK5.js";import"./text-input-e6f7u9S5.js";import"./text-list-editor-aj1SAzcA.js";import{B as nr}from"./choice-Xr-SKHrB.js";import{C as b,P as tr}from"./locked-label-settings-6ht0io0O.js";import{S as ar}from"./scrollless-number-text-field-d5PK69vy.js";const G="unlimited",Pe=n=>{const r=parseInt(n,10);return isNaN(r)||r===0?G:r},We=({numPoints:n=1,onChange:r})=>e.jsx(x,{selectedValue:`${n}`,onChange:t=>{r(Pe(t))},placeholder:"",style:ir.singleSelectShort,children:[...[...Array(7).keys()].map(t=>e.jsx(m,{value:`${t}`,label:`${t} point${t>1?"s":""}`},t)),e.jsx(m,{value:G,label:"unlimited"},"unlimited")]}),ir=f.StyleSheet.create({singleSelectShort:{height:26}});We.__docgenInfo={description:"",methods:[],displayName:"GraphPointsCountSelector",props:{numPoints:{required:!1,tsType:{name:"union",raw:"number | typeof UNLIMITED",elements:[{name:"number"},{name:"UNLIMITED"}]},description:"",defaultValue:{value:"1",computed:!1}},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(points: PointValue) => void",signature:{arguments:[{type:{name:"union",raw:"number | typeof UNLIMITED",elements:[{name:"number"},{name:"UNLIMITED"}]},name:"points"}],return:{name:"void"}}},description:""}}};const Ie=n=>e.jsxs(x,{selectedValue:n.graphType,onChange:n.onChange,placeholder:"Select an answer type",style:sr.singleSelectShort,children:[n.showNoneOption&&e.jsx(m,{value:"none",label:"None"}),e.jsx(m,{value:"linear",label:"Linear function"}),e.jsx(m,{value:"quadratic",label:"Quadratic function"}),e.jsx(m,{value:"sinusoid",label:"Sinusoid function"}),e.jsx(m,{value:"circle",label:"Circle"}),e.jsx(m,{value:"point",label:"Point(s)"}),e.jsx(m,{value:"linear-system",label:"Linear System"}),e.jsx(m,{value:"polygon",label:"Polygon"}),e.jsx(m,{value:"segment",label:"Line Segment(s)"}),e.jsx(m,{value:"ray",label:"Ray"}),e.jsx(m,{value:"angle",label:"Angle"})]}),sr=f.StyleSheet.create({singleSelectShort:{height:26}});Ie.__docgenInfo={description:"",methods:[],displayName:"GraphTypeSelector",props:{graphType:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(newGraphType: string) => void",signature:{arguments:[{type:{name:"string"},name:"newGraphType"}],return:{name:"void"}}},description:""},showNoneOption:{required:!0,tsType:{name:"boolean"},description:""}}};function Le(n){return e.jsxs(e.Fragment,{children:[e.jsx(B,{title:"Correct Answer",isOpen:!0,isCollapsible:!1}),e.jsxs(d,{children:[e.jsxs(d,{children:[e.jsx(Ne,{style:{paddingTop:i.xxSmall_6,paddingBottom:i.xxSmall_6,color:c.offBlack64},children:"Graph the correct answer in the graph below and ensure the equation or point coordinates displayed represent the correct answer."}),e.jsx(D,{style:{fontSize:12,backgroundColor:"#eee",paddingInline:i.xxSmall_6,borderColor:"#ccc",borderStyle:"solid",borderWidth:1},children:n.equationString})]}),n.children]})]})}Le.__docgenInfo={description:"",methods:[],displayName:"InteractiveGraphCorrectAnswer",props:{equationString:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};function Ee(n){const{ariaLabelValue:r,ariaDescriptionValue:t,onChange:a}=n,[s,u]=P.useState(!0);return e.jsxs(e.Fragment,{children:[e.jsx(B,{title:"Description",isCollapsible:!0,isOpen:s,onToggle:u}),s&&e.jsxs(d,{children:[e.jsx(Ne,{style:M.caption,children:"Use these fields to describe the graph as a whole. These are used by screen readers to describe content to users who may be visually impaired."}),e.jsxs(h,{tag:"label",children:["Title",e.jsx(Ze,{value:r,onChange:l=>a({fullGraphAriaLabel:l||void 0}),style:M.spaceAbove})]}),e.jsx(g,{size:i.small_12}),e.jsxs(h,{tag:"label",children:["Description",e.jsx(Je,{rows:8,resizeType:"vertical",value:t,onChange:l=>a({fullGraphAriaDescription:l||void 0}),style:M.spaceAbove})]})]})]})}const M=f.StyleSheet.create({caption:{color:c.offBlack64,paddingTop:i.xxSmall_6,paddingBottom:i.xxSmall_6},spaceAbove:{marginTop:i.xxxSmall_4}});Ee.__docgenInfo={description:"",methods:[],displayName:"InteractiveGraphDescription",props:{ariaLabelValue:{required:!0,tsType:{name:"string"},description:""},ariaDescriptionValue:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(graphProps: Partial<EditorProps>) => void",signature:{arguments:[{type:{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
...
Locked figures are graph elements (points, lines, line segmeents,
etc.) that are locked in place and not interactive.`},{key:"fullGraphAriaLabel",value:{name:"string",required:!1}},{key:"fullGraphAriaDescription",value:{name:"string",required:!1}},{key:"graph",value:{name:'PropsFor["graph"]',raw:'InteractiveGraphProps["graph"]',required:!0},description:"The graph to display in the graph area."},{key:"onChange",value:{name:"signature",type:"function",raw:"(props: Partial<Props>) => void",signature:{arguments:[{type:{name:"Partial",elements:[{name:"Props"}],raw:"Partial<Props>"},name:"props"}],return:{name:"void"}},required:!0}},{key:"static",value:{name:"boolean",required:!1}}]}}],raw:"Partial<EditorProps>"},name:"graphProps"}],return:{name:"void"}}},description:""}}};const ze=({numSegments:n=1,onChange:r})=>e.jsx(x,{selectedValue:`${n}`,placeholder:"",onChange:t=>{const a=+t;r(a)},style:or.singleSelectShort,children:C.range(1,7).map(t=>e.jsx(m,{value:`${t}`,label:`${t} segment${t>1?"s":""}`},t))},"segment-select"),or=f.StyleSheet.create({singleSelectShort:{height:26}});ze.__docgenInfo={description:"",methods:[],displayName:"SegmentCountSelector",props:{numSegments:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"1",computed:!1}},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(numSegments: number) => void",signature:{arguments:[{type:{name:"number"},name:"numSegments"}],return:{name:"void"}}},description:""}}};const lr=""+new URL("arrow-counter-clockwise-bold-Zg1fUITb.svg",import.meta.url).href;function ur(n){if("startCoords"in n)return n.startCoords}function dr(n,r,t){switch(n.type){case"linear":case"ray":return Oe({...n,startCoords:void 0},r,t);case"segment":return xe({...n,startCoords:void 0},r,t);case"linear-system":return Ce({...n,startCoords:void 0},r,t);case"circle":const a=Re({...n,startCoords:void 0}),s=ve(we(a.radiusPoint,a.center));return{center:a.center,radius:s};case"sinusoid":return Ae({...n,startCoords:void 0},r,t);case"quadratic":return Te({...n,startCoords:void 0},r,t);case"point":return qe({...n,startCoords:void 0},r,t);case"polygon":return ke({...n,startCoords:void 0},r,t);case"angle":return fe({graph:{...n,startCoords:void 0},range:r,step:t});default:return}}const mr=n=>{const r=n[0],t=n[1],a=t[1]-r[1],s=Math.PI/(2*(t[0]-r[0])),u=r[0]*s,l=r[1];return"y = "+a.toFixed(3)+"sin("+s.toFixed(3)+"x - "+u.toFixed(3)+") + "+l.toFixed(3)},yr=n=>{const r=n[0],t=n[1],a=n[2],s=(r[0]-t[0])*(r[0]-a[0])*(t[0]-a[0]);if(s===0)return"Division by zero error";const u=(a[0]*(t[1]-r[1])+t[0]*(r[1]-a[1])+r[0]*(a[1]-t[1]))/s,l=(a[0]*a[0]*(r[1]-t[1])+t[0]*t[0]*(a[1]-r[1])+r[0]*r[0]*(t[1]-a[1]))/s,q=(t[0]*a[0]*(t[0]-a[0])*r[1]+a[0]*r[0]*(a[0]-r[0])*t[1]+r[0]*t[0]*(r[0]-t[0])*a[1])/s;return"y = "+u.toFixed(3)+"x^2 + "+l.toFixed(3)+"x + "+q.toFixed(3)},hr=(n,r=!1)=>{const t=n[1];return`${He(n,r).toFixed(0)}° angle at (${t[0]}, ${t[1]})`},gr=(n,r)=>{if(r)return!1;switch(n.type){case"point":return n.numPoints!=="unlimited";case"polygon":return n.numSides!=="unlimited"&&n.snapTo!=="angles"&&n.snapTo!=="sides";case"none":return!1;case"angle":case"circle":case"linear":case"linear-system":case"quadratic":case"ray":case"segment":case"sinusoid":return!0;default:throw new je(n)}},Fe=n=>{const{startCoords:r,allowReflexAngles:t,onChange:a}=n;return e.jsxs(e.Fragment,{children:[e.jsxs(d,{style:O.equationSection,children:[e.jsx(K,{children:"Starting equation:"}),e.jsx(D,{style:O.equationBody,children:hr(r,t)})]}),e.jsxs(d,{style:O.tile,children:[e.jsx(h,{children:"Point 1:"}),e.jsx(g,{size:i.small_12}),e.jsx(b,{coord:r[0],labels:["x","y"],onChange:s=>a([s,r[1],r[2]])})]}),e.jsxs(d,{style:O.tile,children:[e.jsx(h,{children:"Vertex:"}),e.jsx(g,{size:i.small_12}),e.jsx(b,{coord:r[1],labels:["x","y"],onChange:s=>a([r[0],s,r[2]])})]}),e.jsxs(d,{style:O.tile,children:[e.jsx(h,{children:"Point 2:"}),e.jsx(g,{size:i.small_12}),e.jsx(b,{coord:r[2],labels:["x","y"],onChange:s=>a([r[0],r[1],s])})]})]})},O=f.StyleSheet.create({tile:{backgroundColor:c.fadedBlue8,marginTop:i.xSmall_8,padding:i.small_12,borderRadius:i.xSmall_8,flexDirection:"row",alignItems:"center"},equationSection:{marginTop:i.small_12},equationBody:{backgroundColor:c.fadedOffBlack8,border:`1px solid ${c.fadedOffBlack32}`,marginTop:i.xSmall_8,paddingLeft:i.xSmall_8,paddingRight:i.xSmall_8,fontSize:H.size.xSmall}});Fe.__docgenInfo={description:"",methods:[],displayName:"StartCoordsAngle",props:{startCoords:{required:!0,tsType:{name:"tuple",raw:"[Coord, Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},description:""},allowReflexAngles:{required:!1,tsType:{name:"boolean"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: AngleCoords) => void",signature:{arguments:[{type:{name:"tuple",raw:"[Coord, Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},name:"startCoords"}],return:{name:"void"}}},description:""}}};const Se=n=>{const{startCoords:r,onChange:t}=n,[a,s]=P.useState(r.radius.toString());P.useEffect(()=>{s(r.radius.toString())},[r.radius]);function u(l){s(l),!(isNaN(+l)||l===""||+l==0)&&t({center:r.center,radius:parseFloat(l)})}return e.jsxs(d,{style:_.tile,children:[e.jsxs(d,{style:_.row,children:[e.jsx(h,{children:"Center:"}),e.jsx(g,{size:i.small_12}),e.jsx(b,{coord:r.center,labels:["x","y"],onChange:l=>t({center:l,radius:r.radius})})]}),e.jsx(g,{size:i.small_12}),e.jsxs(h,{tag:"label",style:_.row,children:["Radius:",e.jsx(g,{size:i.small_12}),e.jsx(ar,{value:a,onChange:u,style:_.textField})]})]})},_=f.StyleSheet.create({tile:{backgroundColor:c.fadedBlue8,marginTop:i.xSmall_8,padding:i.small_12,borderRadius:i.xSmall_8},row:{display:"flex",flexDirection:"row",alignItems:"center"},textField:{width:i.xxxLarge_64}});Se.__docgenInfo={description:"",methods:[],displayName:"StartCoordsCircle",props:{startCoords:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    center: Coord;
    radius: number;
    ...
    center: Coord;
    radius: number;
}`,signature:{properties:[{key:"center",value:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}],required:!0}},{key:"radius",value:{name:"number",required:!0}}]}},name:"startCoords"}],return:{name:"void"}}},description:""}}};const _e=n=>{const{startCoords:r,onChange:t}=n;return e.jsxs(e.Fragment,{children:[e.jsxs(d,{style:ce.tile,children:[e.jsx(h,{children:"Point 1:"}),e.jsx(g,{size:i.small_12}),e.jsx(b,{coord:r[0],labels:["x","y"],onChange:a=>t([a,r[1]])})]}),e.jsxs(d,{style:ce.tile,children:[e.jsx(h,{children:"Point 2:"}),e.jsx(g,{size:i.small_12}),e.jsx(b,{coord:r[1],labels:["x","y"],onChange:a=>t([r[0],a])})]})]})},ce=f.StyleSheet.create({tile:{backgroundColor:c.fadedBlue8,marginTop:i.xSmall_8,padding:i.small_12,borderRadius:i.xSmall_8,flexDirection:"row",alignItems:"center"}});_e.__docgenInfo={description:"",methods:[],displayName:"StartCoordsLine",props:{startCoords:{required:!0,tsType:{name:"tuple",raw:"[vec.Vector2, vec.Vector2]",elements:[{name:"vec.Vector2"},{name:"vec.Vector2"}]},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: CollinearTuple) => void",signature:{arguments:[{type:{name:"tuple",raw:"[vec.Vector2, vec.Vector2]",elements:[{name:"vec.Vector2"},{name:"vec.Vector2"}]},name:"startCoords"}],return:{name:"void"}}},description:""}}};const Ve=n=>{const{startCoords:r,type:t,onChange:a}=n,s=t==="segment"?"Segment":"Line";return e.jsx(e.Fragment,{children:r.map((u,l)=>e.jsxs(tr,{header:e.jsx(h,{children:`${s} ${l+1}`}),expanded:!0,children:[e.jsxs(d,{style:be.nestedTile,children:[e.jsx(h,{children:"Point 1:"}),e.jsx(g,{size:i.small_12}),e.jsx(b,{coord:u[0],labels:["x","y"],onChange:q=>{const w=[...r];w[l]=[q,u[1]],a(w)}})]}),e.jsxs(d,{style:be.nestedTile,children:[e.jsx(h,{children:"Point 2:"}),e.jsx(g,{size:i.small_12}),e.jsx(b,{coord:u[1],labels:["x","y"],onChange:q=>{const w=[...r];w[l]=[u[0],q],a(w)}})]})]},`segment-${l}-start-coords`))})},be=f.StyleSheet.create({nestedTile:{paddingBottom:i.small_12,flexDirection:"row",alignItems:"center"}});Ve.__docgenInfo={description:"",methods:[],displayName:"StartCoordsMultiline",props:{type:{required:!0,tsType:{name:"union",raw:'"linear-system" | "segment"',elements:[{name:"literal",value:'"linear-system"'},{name:"literal",value:'"segment"'}]},description:""},startCoords:{required:!0,tsType:{name:"Array",elements:[{name:"tuple",raw:"[vec.Vector2, vec.Vector2]",elements:[{name:"vec.Vector2"},{name:"vec.Vector2"}]}],raw:"CollinearTuple[]"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: CollinearTuple[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"tuple",raw:"[vec.Vector2, vec.Vector2]",elements:[{name:"vec.Vector2"},{name:"vec.Vector2"}]}],raw:"CollinearTuple[]"},name:"startCoords"}],return:{name:"void"}}},description:""}}};const $e=n=>{const{startCoords:r,onChange:t}=n;return e.jsx(e.Fragment,{children:r.map((a,s)=>e.jsxs(d,{style:pr.tile,children:[e.jsx(h,{children:`Point ${s+1}:`}),e.jsx(g,{size:i.small_12}),e.jsx(b,{coord:a,labels:["x","y"],onChange:u=>{const l=[...r];l[s]=u,t(l)}})]},s))})},pr=f.StyleSheet.create({tile:{backgroundColor:c.fadedBlue8,marginTop:i.xSmall_8,padding:i.small_12,borderRadius:i.xSmall_8,flexDirection:"row",alignItems:"center"}});$e.__docgenInfo={description:"",methods:[],displayName:"StartCoordsPoint",props:{startCoords:{required:!0,tsType:{name:"ReadonlyArray",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}],raw:"ReadonlyArray<Coord>"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: ReadonlyArray<Coord>) => void",signature:{arguments:[{type:{name:"ReadonlyArray",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}],raw:"ReadonlyArray<Coord>"},name:"startCoords"}],return:{name:"void"}}},description:""}}};const De=n=>{const{startCoords:r,onChange:t}=n;return e.jsxs(e.Fragment,{children:[e.jsxs(d,{style:j.equationSection,children:[e.jsx(K,{children:"Starting equation:"}),e.jsx(D,{style:j.equationBody,children:yr(r)})]}),e.jsxs(d,{style:j.tile,children:[e.jsx(h,{children:"Point 1:"}),e.jsx(g,{size:i.small_12}),e.jsx(b,{coord:r[0],labels:["x","y"],onChange:a=>t([a,r[1],r[2]])})]}),e.jsxs(d,{style:j.tile,children:[e.jsx(h,{children:"Point 2:"}),e.jsx(g,{size:i.small_12}),e.jsx(b,{coord:r[1],labels:["x","y"],onChange:a=>t([r[0],a,r[2]])})]}),e.jsxs(d,{style:j.tile,children:[e.jsx(h,{children:"Point 3:"}),e.jsx(g,{size:i.small_12}),e.jsx(b,{coord:r[2],labels:["x","y"],onChange:a=>t([r[0],r[1],a])})]})]})},j=f.StyleSheet.create({tile:{backgroundColor:c.fadedBlue8,marginTop:i.xSmall_8,padding:i.small_12,borderRadius:i.xSmall_8,flexDirection:"row",alignItems:"center"},equationSection:{marginTop:i.small_12},equationBody:{backgroundColor:c.fadedOffBlack8,border:`1px solid ${c.fadedOffBlack32}`,marginTop:i.xSmall_8,paddingLeft:i.xSmall_8,paddingRight:i.xSmall_8,fontSize:H.size.xSmall}});De.__docgenInfo={description:"",methods:[],displayName:"StartCoordsQuadratic",props:{startCoords:{required:!0,tsType:{name:"tuple",raw:"[Coord, Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: [Coord, Coord, Coord]) => void",signature:{arguments:[{type:{name:"tuple",raw:"[Coord, Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},name:"startCoords"}],return:{name:"void"}}},description:""}}};const Me=n=>{const{startCoords:r,onChange:t}=n;return e.jsxs(e.Fragment,{children:[e.jsxs(d,{style:V.equationSection,children:[e.jsx(K,{children:"Starting equation:"}),e.jsx(D,{style:V.equationBody,children:mr(r)})]}),e.jsxs(d,{style:V.tile,children:[e.jsx(h,{children:"Point 1:"}),e.jsx(g,{size:i.small_12}),e.jsx(b,{coord:r[0],labels:["x","y"],onChange:a=>t([a,r[1]])})]}),e.jsxs(d,{style:V.tile,children:[e.jsx(h,{children:"Point 2:"}),e.jsx(g,{size:i.small_12}),e.jsx(b,{coord:r[1],labels:["x","y"],onChange:a=>t([r[0],a])})]})]})},V=f.StyleSheet.create({tile:{backgroundColor:c.fadedBlue8,marginTop:i.xSmall_8,padding:i.small_12,borderRadius:i.xSmall_8,flexDirection:"row",alignItems:"center"},equationSection:{marginTop:i.small_12},equationBody:{backgroundColor:c.fadedOffBlack8,border:`1px solid ${c.fadedOffBlack32}`,marginTop:i.xSmall_8,paddingLeft:i.xSmall_8,paddingRight:i.xSmall_8,fontSize:H.size.xSmall}});Me.__docgenInfo={description:"",methods:[],displayName:"StartCoordsSinusoid",props:{startCoords:{required:!0,tsType:{name:"tuple",raw:"[Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: SinusoidCoords) => void",signature:{arguments:[{type:{name:"tuple",raw:"[Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},name:"startCoords"}],return:{name:"void"}}},description:""}}};const cr=n=>{const{type:r,range:t,step:a,allowReflexAngles:s,onChange:u}=n;switch(r){case"linear":case"ray":const l=Oe(n,t,a);return e.jsx(_e,{startCoords:l,onChange:u});case"linear-system":case"segment":const q=r==="segment"?xe(n,t,a):Ce(n,t,a);return e.jsx(Ve,{type:r,startCoords:q,onChange:u});case"circle":const w=Re(n),W=ve(we(w.radiusPoint,w.center));return e.jsx(Se,{startCoords:{center:w.center,radius:W},onChange:u});case"sinusoid":const I=Ae(n,t,a);return e.jsx(Me,{startCoords:I,onChange:u});case"quadratic":const L=Te(n,t,a);return e.jsx(De,{startCoords:L,onChange:u});case"point":case"polygon":const E=r==="point"?qe(n,t,a):ke(n,t,a);return e.jsx($e,{startCoords:E,onChange:u});case"angle":const z=fe({graph:n,range:t,step:a});return e.jsx(Fe,{startCoords:z,allowReflexAngles:s,onChange:u});default:return null}},Ge=n=>{const{range:r,step:t,onChange:a}=n,[s,u]=P.useState(!0);return e.jsxs(d,{children:[e.jsx(B,{isCollapsible:!0,title:"Start coordinates",isOpen:s,onToggle:()=>u(!s)}),s&&e.jsxs(e.Fragment,{children:[e.jsx(cr,{...n}),e.jsx(g,{size:i.small_12}),e.jsx(nr,{startIcon:lr,kind:"tertiary",size:"small",onClick:()=>{a(dr(n,r,t))},children:"Use default start coordinates"})]})]})};Ge.__docgenInfo={description:"",methods:[],displayName:"StartCoordsSettings",props:{range:{required:!0,tsType:{name:"tuple",raw:"[x: Range, y: Range]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},step:{required:!0,tsType:{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},allowReflexAngles:{required:!1,tsType:{name:"boolean"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: StartCoords) => void",signature:{arguments:[{type:{name:'Extract["startCoords"]',raw:`Extract<
    PerseusGraphType,
    GraphTypesThatHaveStartCoords
>["startCoords"]`},name:"startCoords"}],return:{name:"void"}}},description:""}}};const{InfoTip:R}=Qe,N=Ke.widget,br={url:null},vr=C.map(C.range(3,13),function(n){return e.jsx(m,{value:`${n}`,label:`${n} sides`},`polygon-sides-${n}`)}),$=class $ extends P.Component{constructor(){super(...arguments),this.displayName="InteractiveGraphEditor",this.className="perseus-widget-interactive-graph",this.changeStartCoords=r=>{var a;if(!((a=this.props.graph)!=null&&a.type))return;const t={...this.props.graph,startCoords:r};this.props.onChange({graph:t})},this.getSaveWarnings=()=>{const r=[];for(const t of this.props.lockedFigures??[])t.type==="line"&&Ue(t.points[0].coord,t.points[1].coord)&&r.push("The line cannot have length 0.");return r}}serialize(){const r=C.pick(this.props,"step","backgroundImage","markings","labels","showProtractor","showTooltips","range","gridStep","snapStep","lockedFigures","fullGraphAriaLabel","fullGraphAriaDescription"),t=this.refs.graph;if(t){const a=t&&t.getUserInput();C.extend(r,{graph:{type:a.type,startCoords:this.props.graph&&ur(this.props.graph)},correct:a}),C.each(["allowReflexAngles","angleOffsetDeg","numPoints","numSides","numSegments","showAngles","showSides","snapTo","snapDegrees"],function(s){C.has(a,s)&&(r.graph[s]=a[s])})}return r}render(){var l,q,w,W,I,L,E,z,X,Q,Y,Z,J,ee,re,ne,te,ae,ie,se,oe,le,ue,de,me,ye,he,ge;let r,t;const a=this.props.gridStep||pe.getGridStep(this.props.range,this.props.step,Ye.defaultBoxSize),s=this.props.snapStep||pe.snapStepFromGridStep(a),u=Xe.SMALL;if(this.props.valid===!0){const o=this.props.correct,p={ref:"graph",box:this.props.box,range:this.props.range,labels:this.props.labels,step:this.props.step,gridStep:a,snapStep:s,graph:o,backgroundImage:this.props.backgroundImage,markings:this.props.markings,showProtractor:this.props.showProtractor,showTooltips:this.props.showTooltips,lockedFigures:this.props.lockedFigures,fullGraphAriaLabel:this.props.fullGraphAriaLabel,fullGraphAriaDescription:this.props.fullGraphAriaDescription,trackInteraction:function(){},onChange:({graph:v})=>{let k=this.props.correct;y(v!=null),k.type===v.type?k=wr(k,v):k=v,this.props.onChange({correct:k,graph:this.props.graph})}};r=e.jsx(N,{...p,containerSizeClass:u,apiOptions:{...this.props.apiOptions,isMobile:!1}}),t=N.getEquationString(p)}else r=e.jsx("div",{className:"perseus-error",children:this.props.valid});return e.jsxs(d,{children:[e.jsx(A,{label:"Answer type:",children:e.jsx(Ie,{graphType:((l=this.props.graph)==null?void 0:l.type)??N.defaultProps.graph.type,onChange:o=>{this.props.onChange({graph:{type:o},correct:{type:o}})},showNoneOption:(W=(w=(q=this.props.apiOptions)==null?void 0:q.flags)==null?void 0:w.mafs)==null?void 0:W.none})}),this.props.graph&&((E=(L=(I=this.props.apiOptions)==null?void 0:I.flags)==null?void 0:L.mafs)==null?void 0:E[this.props.graph.type])&&e.jsx(Ee,{ariaLabelValue:this.props.fullGraphAriaLabel??"",ariaDescriptionValue:this.props.fullGraphAriaDescription??"",onChange:this.props.onChange}),e.jsx(Le,{equationString:t,children:r}),((z=this.props.correct)==null?void 0:z.type)==="point"&&e.jsx(A,{label:"Number of Points:",children:e.jsx(We,{numPoints:(X=this.props.correct)==null?void 0:X.numPoints,onChange:o=>{this.props.onChange({correct:{type:"point",numPoints:o},graph:{type:"point",numPoints:o}})}})}),((Q=this.props.correct)==null?void 0:Q.type)==="angle"&&e.jsxs(e.Fragment,{children:[e.jsxs(d,{style:T.row,children:[e.jsx(F,{label:e.jsx(S,{children:"Show angle measures"}),checked:!!((Y=this.props.correct)!=null&&Y.showAngles),onChange:o=>{var p;((p=this.props.graph)==null?void 0:p.type)==="angle"&&(y(this.props.correct.type==="angle",`Expected graph type to be angle, but got ${this.props.correct.type}`),this.props.onChange({correct:{...this.props.correct,showAngles:o},graph:{...this.props.graph,showAngles:o}}))}}),e.jsx(R,{children:e.jsx("p",{children:"Displays the interior angle measures."})})]}),e.jsxs(d,{style:T.row,children:[e.jsx(F,{label:e.jsx(S,{children:"Allow reflex angles"}),checked:!!((Z=this.props.correct)!=null&&Z.allowReflexAngles),onChange:o=>{var v,k;y(this.props.correct.type==="angle",`Expected graph type to be angle, but got ${this.props.correct.type}`),y(((v=this.props.graph)==null?void 0:v.type)==="angle",`Expected graph type to be angle, but got ${(k=this.props.graph)==null?void 0:k.type}`);const p={allowReflexAngles:o};this.props.onChange({correct:{...this.props.correct,...p},graph:{...this.props.graph,...p}})}}),e.jsx(R,{children:e.jsx("p",{children:"Allow students to be able to create reflex angles."})})]})]}),((J=this.props.correct)==null?void 0:J.type)==="polygon"&&e.jsxs(e.Fragment,{children:[e.jsx(A,{label:"Number of sides:",children:e.jsx(x,{selectedValue:(ee=this.props.correct)!=null&&ee.numSides?`${this.props.correct.numSides}`:"3",placeholder:"",onChange:o=>{var v;y(((v=this.props.graph)==null?void 0:v.type)==="polygon");const p={numSides:Pe(o),coords:null,snapTo:"grid"};this.props.onChange({correct:{...this.props.correct,...p},graph:{...this.props.graph,...p}})},style:T.singleSelectShort,children:[...vr,e.jsx(m,{value:"unlimited",label:"unlimited sides"},"unlimited")]},"polygon-select")}),e.jsxs(A,{label:"Snap to:",children:[e.jsxs(x,{selectedValue:((re=this.props.correct)==null?void 0:re.snapTo)||"grid",placeholder:"",onChange:o=>{var v,k;y(this.props.correct.type==="polygon",`Expected correct answer type to be polygon, but got ${this.props.correct.type}`),y(((v=this.props.graph)==null?void 0:v.type)==="polygon",`Expected graph type to be polygon, but got ${(k=this.props.graph)==null?void 0:k.type}`);const p={snapTo:o,coords:null};this.props.onChange({correct:{...this.props.correct,...p},graph:{...this.props.graph,...p}})},style:T.singleSelectShort,children:[e.jsx(m,{value:"grid",label:"grid"}),((ne=this.props.correct)==null?void 0:ne.numSides)!=="unlimited"&&e.jsx(m,{value:"angles",label:"interior angles"}),((te=this.props.correct)==null?void 0:te.numSides)!=="unlimited"&&e.jsx(m,{value:"sides",label:"side measures"})]}),e.jsxs(R,{children:[e.jsx("p",{children:"These options affect the movement of the vertex points. The grid option will guide the points to the nearest half step along the grid."}),e.jsx("p",{children:"The interior angle and side measure options guide the points to the nearest whole angle or side measure respectively."})]})]}),e.jsxs(d,{style:T.row,children:[e.jsx(F,{label:e.jsx(S,{children:"Show angle measures"}),checked:!!((ae=this.props.correct)!=null&&ae.showAngles),onChange:()=>{var o;((o=this.props.graph)==null?void 0:o.type)==="polygon"&&(y(this.props.correct.type==="polygon",`Expected graph type to be polygon, but got ${this.props.correct.type}`),this.props.onChange({correct:{...this.props.correct,showAngles:!this.props.correct.showAngles},graph:{...this.props.graph,showAngles:!this.props.graph.showAngles}}))}}),e.jsx(R,{children:e.jsx("p",{children:"Displays the interior angle measures."})})]}),e.jsxs(d,{style:T.row,children:[e.jsx(F,{label:e.jsx(S,{children:"Show side measures"}),checked:!!((ie=this.props.correct)!=null&&ie.showSides),onChange:()=>{var o;((o=this.props.graph)==null?void 0:o.type)==="polygon"&&this.props.correct.type==="polygon"&&this.props.onChange({correct:{...this.props.correct,showSides:!this.props.correct.showSides},graph:{...this.props.graph,showSides:!this.props.graph.showSides}})}}),e.jsx(R,{children:e.jsx("p",{children:"Displays the side lengths."})})]})]}),((se=this.props.correct)==null?void 0:se.type)==="segment"&&e.jsx(A,{label:"Number of segments:",children:e.jsx(ze,{numSegments:(oe=this.props.correct)==null?void 0:oe.numSegments,onChange:o=>{this.props.onChange({correct:{type:"segment",numSegments:o,coords:null},graph:{type:"segment",numSegments:o}})}})}),((le=this.props.graph)==null?void 0:le.type)&&gr(this.props.graph,this.props.static)&&e.jsx(Ge,{...this.props.graph,range:this.props.range,step:this.props.step,onChange:this.changeStartCoords}),e.jsx(er,{box:Be(u),range:this.props.range,labels:this.props.labels,step:this.props.step,gridStep:a,snapStep:s,valid:this.props.valid,backgroundImage:this.props.backgroundImage,markings:this.props.markings,showProtractor:this.props.showProtractor,showTooltips:this.props.showTooltips,onChange:this.props.onChange}),this.props.correct.type==="polygon"&&e.jsxs(A,{label:"Student answer must",children:[e.jsxs(x,{selectedValue:this.props.correct.match||"exact",onChange:o=>{y(this.props.correct.type==="polygon",`Expected graph type to be polygon, but got ${this.props.correct.type}`);const p={...this.props.correct,match:o};this.props.onChange({correct:p})},placeholder:"",style:T.singleSelectShort,children:[e.jsx(m,{value:"exact",label:"match exactly"}),e.jsx(m,{value:"congruent",label:"be congruent"}),e.jsx(m,{value:"approx",label:"be approximately congruent"}),e.jsx(m,{value:"similar",label:"be similar"})]}),e.jsx(R,{children:e.jsxs("ul",{children:[e.jsx("li",{children:e.jsxs("p",{children:[e.jsx("b",{children:"Match Exactly:"})," Match exactly in size, orientation, and location on the grid even if it is not shown in the background."]})}),e.jsx("li",{children:e.jsxs("p",{children:[e.jsx("b",{children:"Be Congruent:"})," Be congruent in size and shape, but can be located anywhere on the grid."]})}),e.jsx("li",{children:e.jsxs("p",{children:[e.jsx("b",{children:"Be Approximately Congruent:"})," Be exactly similar, and congruent in size and shape to within 0.1 units, but can be located anywhere on the grid."," ",e.jsx("em",{children:"Use this with snapping to angle measure."})]})}),e.jsx("li",{children:e.jsxs("p",{children:[e.jsx("b",{children:"Be Similar:"})," Be similar with matching interior angles, and side measures that are matching or a multiple of the correct side measures. The figure can be located anywhere on the grid."]})})]})})]}),this.props.correct.type==="angle"&&e.jsxs(A,{label:"Student answer must",children:[e.jsxs(x,{selectedValue:this.props.correct.match||"exact",onChange:o=>{this.props.onChange({correct:{...this.props.correct,match:o}})},placeholder:"",style:T.singleSelectShort,children:[e.jsx(m,{value:"exact",label:"match exactly"}),e.jsx(m,{value:"congruent",label:"be congruent"})]}),e.jsx(R,{children:e.jsx("p",{children:"Congruency requires only that the angle measures are the same. An exact match implies congruency, but also requires that the angles have the same orientation and that the vertices are in the same position."})})]}),this.props.graph&&((me=(de=(ue=this.props.apiOptions)==null?void 0:ue.flags)==null?void 0:de.mafs)==null?void 0:me[this.props.graph.type])&&e.jsx(rr,{flags:this.props.apiOptions.flags,showLabelsFlag:(ge=(he=(ye=this.props.apiOptions)==null?void 0:ye.flags)==null?void 0:he.mafs)==null?void 0:ge["interactive-graph-locked-features-labels"],figures:this.props.lockedFigures,onChange:this.props.onChange})]})}};$.widgetName="interactive-graph",$.defaultProps={...N.defaultProps,valid:!0,backgroundImage:br,showTooltips:!1,correct:{type:N.defaultProps.graph.type,coords:null}};let U=$;function wr(n,r){if(n.type!==r.type)throw new Error(`Cannot merge graphs with different types (${n.type} and ${r.type})`);switch(n.type){case"angle":return y(r.type==="angle"),{...n,...r};case"circle":return y(r.type==="circle"),{...n,...r};case"linear":return y(r.type==="linear"),{...n,...r};case"linear-system":return y(r.type==="linear-system"),{...n,...r};case"none":return y(r.type==="none"),{...n,...r};case"point":return y(r.type==="point"),{...n,...r};case"polygon":return y(r.type==="polygon"),{...n,...r};case"quadratic":return y(r.type==="quadratic"),{...n,...r};case"ray":return y(r.type==="ray"),{...n,...r};case"segment":return y(r.type==="segment"),{...n,...r};case"sinusoid":return y(r.type==="sinusoid"),{...n,...r};default:throw new je(n)}}const T=f.StyleSheet.create({singleSelectShort:{height:26},row:{flexDirection:"row",marginTop:i.xSmall_8,alignItems:"center"}});U.__docgenInfo={description:`An editor for the InteractiveGraph widget, which allows the user to
...
| PerseusGraphTypeSinusoid`,elements:[{name:"signature",type:"object",raw:`{
    ...
    // production data that still has this.
    coord?: Coord; // Legacy!
}`,signature:{properties:[{key:"coord",value:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}],required:!0}}]}}]}],required:!0}},{key:"correct",value:{name:"union",raw:`| PerseusGraphTypeAngle
| PerseusGraphTypeCircle
| PerseusGraphTypeLinear
| PerseusGraphTypeLinearSystem
| PerseusGraphTypeNone
...
| PerseusGraphTypeSinusoid`,elements:[{name:"signature",type:"object",raw:`{
    ...
    // production data that still has this.
    coord?: Coord; // Legacy!
}`,signature:{properties:[{key:"coord",value:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}],required:!0}}]}}]}],required:!0}},{key:"lockedFigures",value:{name:"ReadonlyArray",elements:[{name:"union",raw:`| LockedPointType
| LockedLineType
| LockedVectorType
| LockedEllipseType
| LockedPolygonType
...
| PerseusGraphTypeSinusoid`,elements:[{name:"signature",type:"object",raw:`{
    ...
    // production data that still has this.
    coord?: Coord; // Legacy!
}`,signature:{properties:[{key:"coord",value:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}],required:!1}}]}}]}]},description:`The current correct answer for the graph. Updated by this component
when the graph is changed.
...
Locked figures are graph elements (points, lines, line segmeents,
etc.) that are locked in place and not interactive.`},{key:"fullGraphAriaLabel",value:{name:"string",required:!1}},{key:"fullGraphAriaDescription",value:{name:"string",required:!1}},{key:"graph",value:{name:'PropsFor["graph"]',raw:'InteractiveGraphProps["graph"]',required:!0},description:"The graph to display in the graph area."},{key:"onChange",value:{name:"signature",type:"function",raw:"(props: Partial<Props>) => void",signature:{arguments:[{type:{name:"Partial",elements:[{name:"Props"}],raw:"Partial<Props>"},name:"props"}],return:{name:"void"}},required:!0}},{key:"static",value:{name:"boolean",required:!1}}]}}],raw:"Partial<Props>"},name:"props"}],return:{name:"void"}}},description:""},static:{required:!1,tsType:{name:"boolean"},description:""}}};export{U as I};
