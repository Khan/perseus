var F=Object.defineProperty;var C=(l,d,e)=>d in l?F(l,d,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[d]=e;var t=(l,d,e)=>(C(l,typeof d!="symbol"?d+"":d,e),e);import{j as s}from"./jsx-runtime-BT65X5dW.js";import{b as j,f as w,p as S,P as A}from"./core-widget-registry-BDqK5cn0.js";import{E as q}from"./all-widgets-Ci2EVG02.js";import"./index-CW2s7ekB.js";import"./answer-choices-BL1QNWX1.js";import{H as v,e as T}from"./index-CFvGmn7i.js";import{r as k}from"./index-C6mWTJJr.js";import"./index-B1Gws05u.js";import"./i18n-context-3AkWzTTj.js";import"./perseus-api-Ty_QvlNi.js";import"./renderer-MnwUqKiq.js";import"./index-D7h-teXI.js";import"./jquery-CkHB0_Mt.js";import{_ as L}from"./underscore-U-AHniOr.js";import"./dependencies-BsVPGK1s.js";import"./util-CqRduJsD.js";import"./zoomable-tex-Dy-nElJT.js";import"./svg-image-Cfg9MzBk.js";import{n as o}from"./no-important-DlFk8a1I.js";import"./number-input-CoXYXYV4.js";import"./simple-keypad-input-BgCkC0on.js";import"./text-input-sx8AZWeZ.js";import"./phet-simulation-Cq7tYlR_.js";import"./sortable-BYWQvUMB.js";import"./fixed-to-responsive-CTsII9Xx.js";import"./math-input-l6UetJTH.js";import"./video-transcript-link-D8sL2s9W.js";import"./item-version-CQSJ0s4k.js";import"./article-renderer-D2RcX4oT.js";import"./server-item-renderer-BU1lu1GY.js";import"./hints-renderer-B4RsSymp.js";import"./base-radio-B2t7aSnm.js";import{c as E}from"./components-Ek61zMW4.js";import{f as K}from"./index-BzwLglMS.js";import"./index-Dd-cahjY.js";import{B as b}from"./index-YIIULV-M.js";import{C as h,l as f}from"./index-C3jIZeAf.js";import{S as N}from"./index-CUPgSPQO.js";import{s as p,c as g}from"./index-Ds5N5m2R.js";const{InfoTip:c}=E,x=["basic","trig","prealgebra","logarithms","scientific","basic relations","advanced relations"];class y extends k.Component{constructor(e){super(e);t(this,"getSaveWarnings",()=>{const e=[];return this.props.answerForms.length===0?e.push("No answers specified"):(this.props.answerForms.some(a=>a.considered==="correct")||e.push("No correct answer specified"),L(this.props.answerForms).each((a,r)=>{if(this.props.value==="")e.push(`Answer ${r+1} is empty`);else{const m=S(a.value,{functions:this.props.functions});m.parsed?a.simplify&&!m.expr.isSimplified()&&e.push(`${a.value} isn't simplified, but is required" +
                            " to be`):e.push(`Couldn't parse ${a.value}`)}})),e});t(this,"newAnswer",()=>{const e=this.props.answerForms.slice(),a={considered:"correct",form:!1,key:`${crypto.randomUUID()}`,simplify:!1,value:""};e.push(a),this.props.onChange({answerForms:e})});t(this,"handleRemoveForm",e=>{const n=this.props.answerForms.slice();n.splice(e,1),this.props.onChange({answerForms:n})});t(this,"handleButtonSet",e=>{const a=x.filter(r=>this.props.buttonSets.includes(r)!==(r===e));this.props.onChange({buttonSets:a})});t(this,"handleToggleDiv",()=>{let e,n;this.props.buttonSets.includes("basic+div")?(e="basic",n="basic+div"):(e="basic+div",n="basic");const a=this.props.buttonSets.filter(r=>r!==n).concat(e);this.props.onChange({buttonSets:a})});t(this,"handleTexInsert",e=>{this.refs.expression.insert(e)});t(this,"handleFunctions",e=>{this.setState({functionsInternal:e});const n={};n.functions=e.split(/[ ,]+/).filter(K),this.props.onChange(n)});t(this,"handleVisibleLabel",e=>{this.props.onChange({visibleLabel:e})});t(this,"handleAriaLabel",e=>{this.props.onChange({ariaLabel:e})});t(this,"changeExpressionWidget",(e,n)=>{const a={...this.props.answerForms[e],value:n.value};this.updateAnswerForm(e,a)});this.state={functionsInternal:this.props.functions.join(" ")}}serialize(){const{answerForms:e,buttonSets:n,functions:a,times:r,visibleLabel:m,ariaLabel:u}=this.props;return{answerForms:e,buttonSets:n,functions:a,times:r,visibleLabel:m,ariaLabel:u,extraKeys:w(this.props)}}updateAnswerForm(e,n){const a=this.props.answerForms.slice();a[e]=n;const{extraKeys:r,...m}=this.props,u=w({...m,answerForms:a});this.props.onChange({answerForms:a,extraKeys:u})}changeSimplify(e,n){const a={...this.props.answerForms[e],simplify:n};this.updateAnswerForm(e,a)}changeForm(e,n){const a={...this.props.answerForms[e],form:n};this.updateAnswerForm(e,a)}changeConsidered(e,n){const a={...this.props.answerForms[e],considered:n};this.updateAnswerForm(e,a)}changeTimes(e){this.props.onChange({times:e})}render(){const e=this.props.answerForms.map((a,r)=>{const m={times:this.props.times,functions:this.props.functions,buttonSets:this.props.buttonSets,buttonsVisible:"focused",value:a.value,onChange:u=>this.changeExpressionWidget(r,u),trackInteraction:()=>{},widgetId:this.props.widgetId+"-"+a.key,visibleLabel:this.props.visibleLabel,ariaLabel:this.props.ariaLabel};return s.jsx(O,{considered:a.considered,expressionProps:m,form:a.form,simplify:a.simplify,onDelete:()=>this.handleRemoveForm(r),onChangeSimplify:u=>this.changeSimplify(r,u),onChangeForm:u=>this.changeForm(r,u),onChangeConsidered:u=>this.changeConsidered(r,u)},a.key)}),n=x.map(a=>{const r=a==="basic",m=this.props.buttonSets.includes(a)||r;return s.jsx(h,{label:a,checked:m,disabled:r,onChange:()=>this.handleButtonSet(a)},a)});return n.unshift(s.jsx(h,{label:"show ÷ button",checked:this.props.buttonSets.includes("basic+div"),onChange:this.handleToggleDiv},"show ÷ button")),s.jsxs("div",{children:[s.jsx(v,{children:"Global Options"}),s.jsxs("div",{className:o.css(i.paddedY),children:[s.jsx(f,{label:"Visible label",value:this.props.visibleLabel||"",onChange:this.handleVisibleLabel}),s.jsx(c,{children:s.jsx("p",{children:"Optional visible text; strongly encouraged to help learners using dictation software, but can be omitted if the surrounding content provides enough context."})})]}),s.jsxs("div",{className:o.css(i.paddedY),children:[s.jsx(f,{label:"Aria label",value:this.props.ariaLabel||"",onChange:this.handleAriaLabel}),s.jsx(c,{children:s.jsxs("p",{children:["Label text that's read by screen readers. Highly recommend adding a label here to ensure your exercise is accessible. For more information on writting accessible labels, please see"," ",s.jsx("a",{href:"https://www.w3.org/WAI/tips/designing/#ensure-that-form-elements-include-clearly-associated-labels",target:"_blank",rel:"noreferrer",children:"this article."})]})})]}),s.jsxs("div",{className:o.css(i.paddedY),children:[s.jsx(f,{label:"Function variables",value:this.state.functionsInternal,onChange:this.handleFunctions}),s.jsx(c,{children:s.jsx("p",{children:'Single-letter variables listed here will be interpreted as functions. This let us know that f(x) means "f of x" and not "f times x".'})})]}),s.jsxs("div",{className:o.css(i.paddedY),children:[s.jsx(h,{label:"Use × instead of ⋅ for multiplication",checked:this.props.times,onChange:a=>{this.changeTimes(a)}}),s.jsx(c,{children:s.jsx("p",{children:"For pre-algebra problems this option displays multiplication as \\times instead of \\cdot in both the rendered output and the acceptable formats examples."})})]}),s.jsxs("div",{className:o.css(i.paddedY),children:[s.jsx(T,{children:"Button Sets"}),n]}),s.jsx(v,{children:"Answers"}),s.jsx("p",{style:{margin:"4px 0"},children:"student responses area matched against these from top to bottom"}),e,s.jsx("div",{children:s.jsx(b,{size:"small",onClick:this.newAnswer,children:"Add new answer"})})]})}}t(y,"widgetName","expression"),t(y,"defaultProps",j.defaultWidgetOptions);const P=function(l,d){let e=l.indexOf(d);return e=(e+1)%l.length,l[e]};class O extends k.Component{constructor(){super(...arguments);t(this,"state",{deleteFocused:!1});t(this,"handleImSure",()=>{this.props.onDelete(),this.handleCancelDelete()});t(this,"handleCancelDelete",()=>{this.setState({deleteFocused:!1})});t(this,"handleDelete",()=>{this.setState({deleteFocused:!0})});t(this,"toggleConsidered",()=>{const e=P(A,this.props.considered);this.props.onChangeConsidered(e)})}render(){const e=this.state.deleteFocused?s.jsxs(s.Fragment,{children:[s.jsx(b,{size:"small",onClick:this.handleImSure,color:"destructive",children:"I'm sure!"}),s.jsx(N,{size:p.small_12}),s.jsx(b,{size:"small",onClick:this.handleCancelDelete,light:!0,children:"Cancel"})]}):s.jsx(b,{size:"small",onClick:this.handleDelete,color:"destructive",light:!0,children:"Delete"}),n=o.css(i.answerStatus,this.props.considered==="wrong"&&i.answerStatusWrong,this.props.considered==="correct"&&i.answerStatusCorrect,this.props.considered==="ungraded"&&i.answerStatusUngraded);return s.jsx("div",{className:o.css(i.answerOption),children:s.jsxs("div",{className:o.css(i.answerBody),children:[s.jsxs("div",{children:[s.jsx("button",{onClick:this.toggleConsidered,className:n,children:this.props.considered}),s.jsx("div",{children:s.jsx(q,{...this.props.expressionProps})})]}),s.jsxs("div",{className:o.css(i.paddedY,i.paddedX),children:[s.jsx(h,{label:"Answer expression must have the same form.",checked:this.props.form,onChange:this.props.onChangeForm}),s.jsx(c,{children:s.jsx("p",{children:"The student's answer must be in the same form. Commutativity and excess negative signs are ignored."})})]}),s.jsxs("div",{className:o.css(i.paddedY,i.paddedX),children:[s.jsx(h,{label:"Answer expression must be fully expanded and simplified.",checked:this.props.simplify,onChange:this.props.onChangeSimplify}),s.jsx(c,{children:s.jsx("p",{children:`The student's answer must be fully expanded and simplified. Answering this equation (x^2+2x+1) with this factored equation (x+1)^2 will render this response "Your answer is not fully expanded and simplified."`})})]}),s.jsx("div",{className:o.css(i.buttonRow,i.paddedY),children:e})]})})}}const i=o.StyleSheet.create({paddedX:{paddingLeft:p.xSmall_8,paddingRight:p.xSmall_8},paddedY:{paddingTop:p.xxSmall_6,paddingBottom:p.xxSmall_6},answerOption:{border:"1px solid #ddd",borderRadius:"3px",display:"flex"},answerStatus:{border:"none",userSelect:"none",width:"100px",paddingTop:p.small_12,paddingBottom:p.small_12},answerStatusWrong:{backgroundColor:g.fadedRed16},answerStatusCorrect:{backgroundColor:g.fadedGreen16},answerStatusUngraded:{backgroundColor:g.fadedBlue16},answerBody:{},buttonRow:{display:"flex"}});y.__docgenInfo={description:"",methods:[{name:"serialize",docblock:null,modifiers:[],params:[],returns:{type:{name:"signature",type:"object",raw:`{
