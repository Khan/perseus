import"./prop-types-Bt57fpTf.js";import{g as b,c as K,a as m,m as x}from"./key-translator-bknjHtsc.js";import{C as V,K as A,c as _}from"./mobile-keypad-BTuEqmKk.js";import{M as S}from"./button-assets-CICggd4J.js";import{C}from"./index-1LDQje0j.js";import{V as T}from"./index-CskvhqFA.js";import{P as R,a as I}from"./index-D3YmW7kw.js";import{c as l,s as D}from"./index-CC9jxhwQ.js";import{c as P}from"./index-CbNKSLRm.js";import{n as q}from"./no-important-DlFk8a1I.js";import{c as F}from"./index-D7h-teXI.js";import{$ as j}from"./jquery-CkHB0_Mt.js";import{r as n}from"./index-C6mWTJJr.js";import{_ as M}from"./underscore-U-AHniOr.js";import{a as O}from"./i18n-context-glBZFVwC.js";var i=[];for(var g=0;g<256;++g)i.push((g+256).toString(16).slice(1));function N(r,e=0){return(i[r[e+0]]+i[r[e+1]]+i[r[e+2]]+i[r[e+3]]+"-"+i[r[e+4]]+i[r[e+5]]+"-"+i[r[e+6]]+i[r[e+7]]+"-"+i[r[e+8]]+i[r[e+9]]+"-"+i[r[e+10]]+i[r[e+11]]+i[r[e+12]]+i[r[e+13]]+i[r[e+14]]+i[r[e+15]]).toLowerCase()}var d,L=new Uint8Array(16);function U(){if(!d&&(d=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!d))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return d(L)}var B=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto);const w={randomUUID:B};function H(r,e,t){if(w.randomUUID&&!r)return w.randomUUID();r=r||{};var a=r.random||(r.rng||U)();return a[6]=a[6]&15|64,a[8]=a[8]&63|128,N(a)}const W=q.StyleSheet.create({srOnly:{border:0,clip:"rect(0,0,0,0)",height:1,margin:-1,overflow:"hidden",padding:0,position:"absolute",width:1}}),Y=(r,e)=>{let t=null;return(...a)=>{t&&clearTimeout(t),t=window.setTimeout(()=>{r(...a)},e)}},c=class c extends n.Component{constructor(){super(...arguments),this.__mathFieldWrapperRef=null,this.__mathField=null,this.state={focused:!1,keypadOpen:this.props.buttonsVisible==="always",cursorContext:V.NONE},this.insert=e=>{const t=this.mathField(),{locale:a}=this.context,o={...b(a,this.context.strings),FRAC:u=>{const E=u.latex();u.typedText("/"),u.latex()===E&&u.cmd("\\frac")}}[e];if(o){o(t,e),t==null||t.focus();return}M(e).isFunction()?e(t):e[0]==="\\"?t==null||t.cmd(e).focus():t==null||t.write(e).focus(),t==null||t.focus()},this.mathField=()=>{var e;if(!this.__mathField&&this.__mathFieldWrapperRef){const{locale:t}=this.context;this.__mathField=K(this.__mathFieldWrapperRef,t,this.props.mathInputStrings,a=>({...a,handlers:{edit:Y(s=>{let o=s.latex();if(o=o.replace(/<>/g,"\\ne"),_(t,this.props.convertDotToTimes)){o=o.replace(/\\cdot/g,"\\times");const u=s.cursor()[x.L];u&&u.ctrlSeq==="\\cdot "&&(s.controller().backspace(),s.cmd("\\times"))}else o=o.replace(/\\times/g,"\\cdot");this.props.value!==o&&this.props.onChange(o),this.setState({cursorContext:m(s)})},100),enter:()=>{this.__mathFieldWrapperRef&&j(this.__mathFieldWrapperRef).submit()},upOutOf:s=>{s.typedText("^")}}}))}return(e=this.__mathField)==null||e.setAriaLabel(this.props.ariaLabel),this.__mathField},this.focus=()=>{var e;(e=this.mathField())==null||e.focus(),this.setState({focused:!0})},this.blur=()=>this.setState({focused:!1}),this.handleKeypadPress=(e,t)=>{const{locale:a}=this.context,s=b(a,this.context.strings)[e],o=this.mathField();o&&(s&&s(o,e),this.setState({cursorContext:m(o)})),(t==null?void 0:t.type)==="click"&&this.focus(),e==="DISMISS"&&this.closeKeypad()}}componentDidMount(){var e;(e=this.mathField())==null||e.latex(this.props.value)}openKeypad(){this.props.buttonsVisible!=="never"&&this.setState({keypadOpen:!0})}closeKeypad(){this.setState({keypadOpen:!1})}render(){let e=F({"perseus-math-input":!0,"mq-editable-field":!0,"mq-math-mode":!0});const t=H().slice(0,8);return this.props.className&&(e=e+" "+this.props.className),n.createElement(T,{style:[p.outerWrapper,this.state.focused&&p.wrapperFocused,this.props.hasError&&p.wrapperError]},n.createElement("div",{style:{display:"flex",padding:1},onClick:a=>{a.stopPropagation();const s=this.mathField();s&&this.setState({cursorContext:m(s)})}},n.createElement("span",{className:e,ref:a=>this.__mathFieldWrapperRef=a,onFocus:()=>this.focus(),onBlur:()=>this.blur()}),n.createElement(R,{opened:this.state.keypadOpen,dismissEnabled:!0,rootBoundary:"document","aria-label":this.context.strings.mathInputTitle,"aria-describedby":`popover-content-${t}`,content:()=>{var a;return n.createElement(n.Fragment,null,n.createElement(P,{id:`popover-content-${t}`,style:W.srOnly},this.context.strings.mathInputDescription),n.createElement(I,{style:p.popoverContent},n.createElement(A,{onAnalyticsEvent:this.props.onAnalyticsEvent,extraKeys:this.props.extraKeys,onClickKey:this.handleKeypadPress,cursorContext:this.state.cursorContext,convertDotToTimes:this.props.convertDotToTimes,...this.props.keypadButtonSets??Z((a=this.props)==null?void 0:a.buttonSets),showDismiss:!0})))}},this.props.buttonsVisible==="never"?n.createElement(f,{hovered:!1,focused:!1,active:!1}):n.createElement(C,{"aria-label":this.state.keypadOpen?this.context.strings.closeKeypad:this.context.strings.openKeypad,role:"button",onClick:()=>this.state.keypadOpen?this.closeKeypad():this.openKeypad()},a=>n.createElement(f,{active:this.state.keypadOpen,...a})))))}};c.contextType=O,c.defaultProps={value:"",convertDotToTimes:!1};let h=c;const y=class y extends n.Component{constructor(){super(...arguments),this.inputRef=n.createRef()}blur(){var e;(e=this.inputRef.current)==null||e.blur()}focus(){var e;(e=this.inputRef.current)==null||e.focus()}insert(e){var t;(t=this.inputRef.current)==null||t.insert(e)}render(){return n.createElement(h,{...this.props,ref:this.inputRef,mathInputStrings:this.context.strings})}};y.contextType=S,y.defaultProps={ariaLabel:"Math input"};let v=y;const f=({hovered:r,focused:e,active:t})=>{let a;switch(!0){case(e||t):a=l.white;break;case r:a=l.blue;break;default:a=l.offBlack;break}const s=t||e?p.iconActive:p.iconInactive;return n.createElement(T,{style:[p.iconContainer,s]},n.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:"16",height:"16",fill:a,viewBox:"0 0 256 256"},n.createElement("path",{d:"M112,72a8,8,0,0,1-8,8H40a8,8,0,0,1,0-16h64A8,8,0,0,1,112,72Zm-8,104H80V152a8,8,0,0,0-16,0v24H40a8,8,0,0,0,0,16H64v24a8,8,0,0,0,16,0V192h24a8,8,0,0,0,0-16Zm48,0h64a8,8,0,0,0,0-16H152a8,8,0,0,0,0,16Zm64,16H152a8,8,0,0,0,0,16h64a8,8,0,0,0,0-16Zm-61.66-90.34a8,8,0,0,0,11.32,0L184,83.31l18.34,18.35a8,8,0,0,0,11.32-11.32L195.31,72l18.35-18.34a8,8,0,0,0-11.32-11.32L184,60.69,165.66,42.34a8,8,0,0,0-11.32,11.32L172.69,72,154.34,90.34A8,8,0,0,0,154.34,101.66Z"})))},Z=r=>{const e={};return r&&r.forEach(t=>{switch(t){case"advanced relations":e.advancedRelations=!0;break;case"basic relations":e.basicRelations=!0;break;case"basic+div":e.divisionKey=!0;break;case"logarithms":e.logarithms=!0;break;case"prealgebra":e.preAlgebra=!0;break;case"trig":e.trigonometry=!0;break;case"scientific":e.scientific=!0;break}}),e},k={borderWidth:2,borderColor:l.blue,margin:-1},p=q.StyleSheet.create({iconContainer:{display:"flex",justifyContent:"center",height:"100%",padding:D.xxxSmall_4,borderRadius:1},iconInactive:{border:"2px solid transparent",backgroundColor:l.offBlack8},iconActive:{border:`2px solid ${l.white}`,backgroundColor:l.offBlack64},outerWrapper:{display:"inline-block",borderStyle:"solid",borderWidth:1,borderColor:l.offBlack50,borderRadius:3,background:l.white,":hover":k},wrapperFocused:k,wrapperError:{borderColor:l.red,background:l.fadedRed8,":hover":{borderColor:l.red}},popoverContent:{padding:0,maxWidth:"initial"}});v.__docgenInfo={description:"",methods:[{name:"blur",docblock:null,modifiers:[],params:[],returns:null},{name:"focus",docblock:null,modifiers:[],params:[],returns:null},{name:"insert",docblock:null,modifiers:[],params:[{name:"value",optional:!1,type:{name:"any"}}],returns:null}],displayName:"MathInput",props:{className:{required:!1,tsType:{name:"string"},description:""},value:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"any"},description:""},convertDotToTimes:{required:!0,tsType:{name:"boolean"},description:""},buttonSets:{required:!1,tsType:{name:"ReadonlyArray",elements:[{name:"union",raw:`| "basic"
| "basic+div"
| "trig"
| "prealgebra"
| "logarithms"
