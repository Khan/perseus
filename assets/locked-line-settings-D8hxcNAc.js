import{c2 as D,j as n,aF as T,n as O,y as k,s as c,V as q,r as J,z as Y,cN as b,L as K,e as S,bP as Z}from"./iframe-DWRR6BFw.js";import{S as G,O as P,C as H}from"./color-select-DnNbNLuK.js";import{p as Q}from"./plus-circle-DsgEZe2H.js";import{P as ee}from"./trash-bold-Dh12O6KF.js";import{L as ne}from"./line-stroke-select-CaJlU0pu.js";import{L as ae}from"./line-swatch--NqT3a1_.js";import{L as re}from"./line-weight-select-CRqA4PrF.js";import{L as le}from"./locked-figure-aria-DGGVFtIK.js";import{L as te,a as oe}from"./locked-label-settings-CxMjvVOC.js";import{L as N}from"./locked-point-settings-BjYbTSCM.js";import{g as ie,j,a as x,b as ue}from"./util-4W5ASnJz.js";const F="The line cannot have length 0.",se=w=>{const{kind:g,points:d,color:h,lineStyle:f="solid",showPoint1:V,showPoint2:X,weight:$,labels:o,ariaLabel:_,onChangeProps:l,onMove:I,onRemove:M}=w,[i,u]=d,L=g.charAt(0).toUpperCase()+g.slice(1),R=`${L} (${i.coord[0]},
