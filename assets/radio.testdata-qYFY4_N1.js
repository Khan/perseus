var i=Object.defineProperty;var s=(n,e,t)=>e in n?i(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var a=(n,e,t)=>s(n,typeof e!="symbol"?e+"":e,t);function o(){return new r}class r{constructor(){a(this,"content","[[☃ radio 1]]");a(this,"choices",[]);a(this,"countChoices");a(this,"hasNoneOfTheAbove");a(this,"multipleSelect");a(this,"randomize")}build(){return{content:this.content,images:{},widgets:{"radio 1":{graded:!0,version:{major:0,minor:0},static:!1,type:"radio",alignment:"default",options:{choices:this.choices,hasNoneOfTheAbove:this.hasNoneOfTheAbove,multipleSelect:this.multipleSelect,countChoices:this.countChoices,randomize:this.randomize}}}}}withContent(e){return this.content=e,this}withCountChoices(e){return this.countChoices=e,this}withHasNoneOfTheAbove(e){return this.hasNoneOfTheAbove=e,this}withMultipleSelect(e){return this.multipleSelect=e,this}withRandomize(e){return this.randomize=e,this}addChoice(e,t){return this.choices.push({id:crypto.randomUUID(),content:e,correct:t==null?void 0:t.correct,rationale:t==null?void 0:t.rationale,isNoneOfTheAbove:t==null?void 0:t.isNoneOfTheAbove}),this}}o().withContent(`Which of the following values of $x$ satisfies the equation $\\sqrt{64}=x$ ?

[[☃ radio 1]]

`).addChoice("$-8$ and $8$",{correct:!1,rationale:"The square root operation ($\\sqrt{\\phantom{x}}$) calculates *only* the positive square root when performed on a number, so $x$ is equal to *only* $8$."}).addChoice("$-8$",{correct:!1,rationale:"While $(-8)^2=64$, the square root operation ($\\sqrt{\\phantom{x}}$) calculates *only* the positive square root when performed on a number."}).addChoice("$8$",{correct:!0,rationale:"$8$ is the positive square root of $64$."}).addChoice("No value of $x$ satisfies the equation.",{correct:!1,rationale:"$8$ satisfies the equation."}).build();const h={content:`Read the following passage:
...
[[☃ radio 1]]`).addChoice("Choice A",{correct:void 0}).addChoice("Choice B",{correct:!0}).addChoice("Choice C",{correct:void 0}).withMultipleSelect(!0).withRandomize(!0).build();export{d as S,f as a,u as b,l as c,p as d,m,h as q};
