import{c2 as O,j as n,aF as T,n as W,y as k,s as c,V as q,r as J,z as Y,cN as v,L as K,e as S,bP as Z}from"./iframe-Fv9__JIn.js";import{S as G,O as P,C as H}from"./color-select-jDOn1p5o.js";import{p as Q}from"./plus-circle-DsgEZe2H.js";import{P as ee}from"./trash-bold-BXOwgqOZ.js";import{L as ne}from"./line-stroke-select-DuSL_BD5.js";import{L as ae}from"./line-swatch-DQ_Eq31u.js";import{L as re}from"./line-weight-select-Cqor9uhN.js";import{L as le}from"./locked-figure-aria-BVGR8kkY.js";import{L as te,a as oe}from"./locked-label-settings-DK-HYlXZ.js";import{L as N}from"./locked-point-settings-K_ekoSNo.js";import{g as ie,j,a as x,b as ue}from"./util-DTnki1AO.js";const F="The line cannot have length 0.",se=w=>{const{kind:g,points:d,color:h,lineStyle:f="solid",showPoint1:V,showPoint2:X,weight:$,labels:o,ariaLabel:_,onChangeProps:l,onMove:I,onRemove:M}=w,[i,u]=d,L=g.charAt(0).toUpperCase()+g.slice(1),R=`${L} (${i.coord[0]},
        ${i.coord[1]}), (${u.coord[0]}, ${u.coord[1]})`,C=O(i.coord,u.coord);async function B(){const e=await j(o),r=await j(i.labels),a=await j(u.labels),m=await x(`$${i.coord[0]}$`),p=await x(`$${i.coord[1]}$`),y=await x(`$${u.coord[0]}$`),b=await x(`$${u.coord[1]}$`);let s;switch(g){case"line":s=`${L}${e} through point${r} at ${m} comma ${p} and point${a} at ${y} comma ${b}`;break;case"ray":s=`${L}${e} from point${r} at ${m} comma ${p} through point${a} at ${y} comma ${b}`;break;case"segment":s=`${L}${e} from point${r} at ${m} comma ${p} to point${a} at ${y} comma ${b}`;break;default:throw new Z(g,"Unknown line kind")}const A=ue(h,f,void 0,$);return s+=A,s}function z(e,r){const a=[...d];a[r]={...d[r],...e};const m=v.midpoint(d[0].coord,d[1].coord),p=v.midpoint(a[0].coord,a[1].coord),y=[p[0]-m[0],p[1]-m[1]],b=o.map((s,A)=>({...s,coord:[s.coord[0]+y[0],s.coord[1]+y[1]]}));l({points:a,labels:b})}function E(e){const r=o.map(a=>({...a,color:e}));l({color:e,points:[{...i,color:e,labels:i.labels.map(a=>({...a,color:e}))},{...u,color:e,labels:u.labels.map(a=>({...a,color:e}))}],labels:r})}function U(e,r){const a=[...o];a[r]={...o[r],...e},l({labels:a})}function D(e){const r=o.filter((a,m)=>m!==e);l({labels:r})}return n.jsxs(ee,{expanded:w.expanded,onToggle:w.onToggle,header:n.jsxs(q,{style:t.row,children:[n.jsx(K,{children:R}),n.jsx(k,{size:c.xSmall_8}),n.jsx(ae,{color:h,lineStyle:f})]}),children:[n.jsxs(T,{tag:"label",style:[t.row,t.spaceUnder],children:["kind",n.jsx(k,{size:c.xxxSmall_4}),n.jsxs(G,{selectedValue:g,onChange:e=>l({kind:e}),placeholder:"",children:[n.jsx(P,{value:"line",label:"line"}),n.jsx(P,{value:"ray",label:"ray"}),n.jsx(P,{value:"segment",label:"segment"})]})]}),n.jsxs(q,{style:[t.row,t.spaceUnder],children:[n.jsx(H,{selectedValue:h,onChange:E}),n.jsx(k,{size:c.small_12}),n.jsx(ne,{selectedValue:f,onChange:e=>l({lineStyle:e})})]}),n.jsx(re,{selectedValue:$,onChange:e=>l({weight:e})}),C&&n.jsx(T,{style:t.errorText,children:F}),n.jsx(N,{headerLabel:"Point 1",expanded:!0,showPoint:V,error:C?F:null,...i,onTogglePoint:e=>l({showPoint1:e}),onChangeProps:e=>z(e,0)}),n.jsx(N,{headerLabel:"Point 2",expanded:!0,showPoint:X,error:C?F:null,...u,onTogglePoint:e=>l({showPoint2:e}),onChangeProps:e=>z(e,1)}),n.jsx(k,{size:c.small_12}),n.jsx(q,{style:t.horizontalRule}),n.jsx(le,{ariaLabel:_,getPrepopulatedAriaLabel:B,onChangeProps:e=>{l(e)}}),n.jsx(k,{size:c.xxxSmall_4}),n.jsx(q,{style:t.horizontalRule}),n.jsx(k,{size:c.small_12}),n.jsx(T,{children:"Visible labels"}),o.map((e,r)=>J.createElement(te,{...e,key:r,expanded:!0,onChangeProps:a=>{U(a,r)},onRemove:()=>{D(r)},containerStyle:t.labelContainer})),n.jsx(Y,{kind:"tertiary",startIcon:Q,onClick:()=>{const e=[0,-1],r=v.add(v.scale(e,o.length),v.midpoint(d[0].coord,d[1].coord)),a={...ie("label"),coord:r,color:h};l({labels:[...o,a]})},style:t.addButton,children:"Add visible label"}),n.jsx(oe,{figureType:w.type,onMove:I,onRemove:M})]})},t=W.StyleSheet.create({row:{display:"flex",flexDirection:"row",alignItems:"center"},spaceUnder:{marginBottom:c.xSmall_8},errorText:{color:S.red},addButton:{alignSelf:"start"},horizontalRule:{height:1,backgroundColor:S.offBlack16},labelContainer:{backgroundColor:S.white}});se.__docgenInfo={description:"",methods:[],displayName:"LockedLineSettings",props:{type:{required:!0,tsType:{name:"literal",value:'"line"'},description:""},kind:{required:!0,tsType:{name:"union",raw:'"line" | "ray" | "segment"',elements:[{name:"literal",value:'"line"'},{name:"literal",value:'"ray"'},{name:"literal",value:'"segment"'}]},description:""},points:{required:!0,tsType:{name:"tuple",raw:"[point1: LockedPointType, point2: LockedPointType]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},color:{required:!0,tsType:{name:"unknown[number]",raw:"(typeof lockedFigureColorNames)[number]"},description:""},lineStyle:{required:!0,tsType:{name:"union",raw:'"solid" | "dashed"',elements:[{name:"literal",value:'"solid"'},{name:"literal",value:'"dashed"'}]},description:""},showPoint1:{required:!0,tsType:{name:"boolean"},description:""},showPoint2:{required:!0,tsType:{name:"boolean"},description:""},weight:{required:!0,tsType:{name:"union",raw:'"thin" | "medium" | "thick"',elements:[{name:"literal",value:'"thin"'},{name:"literal",value:'"medium"'},{name:"literal",value:'"thick"'}]},description:""},labels:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    type: "label";
    coord: Coord;
