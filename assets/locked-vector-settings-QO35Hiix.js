import{c2 as M,j as e,bA as R,aF as j,n as B,V as c,L as q,y as g,s,r as I,z as E,cN as m,e as v}from"./iframe-BILzkKRO.js";import{p as W}from"./plus-circle-DsgEZe2H.js";import{C as F,L as D,a as J}from"./locked-label-settings-UcW8xMYx.js";import{P as f}from"./trash-bold-Co_9nyHz.js";import{C as O}from"./color-select-BprMzO6O.js";import{L as Y}from"./line-swatch-CymnLI0i.js";import{L as G}from"./line-weight-select-DKvNhGry.js";import{L as H}from"./locked-figure-aria-BdRLl7Iq.js";import{g as K,j as Q,a as b,b as U}from"./util-rMrxO8bv.js";const Z="The vector cannot have length 0.",ee=p=>{const{points:x,color:y,weight:C,labels:i,ariaLabel:P,onChangeProps:u,onMove:z,onRemove:$}=p,[t,o]=x,A=`Vector (${t[0]}, ${t[1]}), (${o[0]}, ${o[1]})`,w=M(t,o);async function N(){const n=await Q(i),r=await b(`$${t[0]}$`),a=await b(`$${t[1]}$`),d=await b(`$${o[0]}$`),h=await b(`$${o[1]}$`);let k=`Vector${n} from ${r} comma ${a} to ${d} comma ${h}`;const L=U(y,"solid",void 0,C);return k+=L,k}function T(n,r){if(typeof n<"u"){const a=[...x];a[r]=[...n];const d=m.midpoint(t,o),h=m.midpoint(a[0],a[1]),k=m.sub(h,d),L=i.map(S=>({...S,coord:m.add(S.coord,k)}));u({points:a,labels:L})}}function V(n){const r={color:n};r.labels=i.map(a=>({...a,color:n})),u(r)}function _(n,r){const a=[...i];a[r]={...i[r],...n},u({labels:a})}function X(n){const r=i.filter((a,d)=>d!==n);u({labels:r})}return e.jsxs(f,{expanded:p.expanded,onToggle:p.onToggle,header:e.jsxs(c,{style:l.row,children:[e.jsx(q,{children:A}),e.jsx(g,{size:s.xSmall_8}),e.jsx(Y,{color:y,lineStyle:"solid"})]}),children:[e.jsx(O,{selectedValue:y,onChange:V,style:{marginBottom:R.size_080}}),e.jsx(G,{selectedValue:C,onChange:n=>u({weight:n})}),w&&e.jsx(j,{style:l.errorText,children:Z}),e.jsx(f,{expanded:!0,containerStyle:l.container,panelStyle:l.accordionPanel,header:e.jsx(c,{style:l.row,children:e.jsx(q,{children:`Tail (${t[0]}, ${t[1]})`})}),children:e.jsx(F,{coord:t,error:w,onChange:n=>{T(n,0)}})}),e.jsx(f,{expanded:!0,containerStyle:l.container,panelStyle:l.accordionPanel,header:e.jsx(c,{style:l.row,children:e.jsx(q,{children:`Tip (${o[0]}, ${o[1]})`})}),children:e.jsx(F,{coord:o,error:w,onChange:n=>{T(n,1)}})}),e.jsx(g,{size:s.small_12}),e.jsx(c,{style:l.horizontalRule}),e.jsx(H,{ariaLabel:P,getPrepopulatedAriaLabel:N,onChangeProps:n=>{u(n)}}),e.jsx(g,{size:s.xxxSmall_4}),e.jsx(c,{style:l.horizontalRule}),e.jsx(g,{size:s.small_12}),e.jsx(j,{children:"Visible labels"}),i.map((n,r)=>I.createElement(D,{...n,key:r,expanded:!0,onChangeProps:a=>{_(a,r)},onRemove:()=>{X(r)},containerStyle:l.labelContainer})),e.jsx(E,{kind:"tertiary",startIcon:W,onClick:()=>{const n=[0,-1],r=m.add(m.scale(n,i.length),m.midpoint(t,o)),a={...K("label"),coord:r,color:y};u({labels:[...i,a]})},style:l.addButton,children:"Add visible label"}),e.jsx(J,{figureType:p.type,onMove:z,onRemove:$})]})},l=B.StyleSheet.create({accordionPanel:{paddingBottom:s.medium_16},container:{marginTop:s.xSmall_8,marginBottom:0,marginLeft:-4,marginRight:-4,backgroundColor:v.white},errorText:{color:v.red,marginTop:s.xSmall_8},row:{flexDirection:"row",alignItems:"center"},addButton:{alignSelf:"start"},horizontalRule:{height:1,backgroundColor:v.offBlack16},labelContainer:{backgroundColor:v.white}});ee.__docgenInfo={description:"",methods:[],displayName:"LockedVectorSettings",props:{type:{required:!0,tsType:{name:"literal",value:'"vector"'},description:""},points:{required:!0,tsType:{name:"tuple",raw:"[tail: Coord, tip: Coord]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},color:{required:!0,tsType:{name:"unknown[number]",raw:"(typeof lockedFigureColorNames)[number]"},description:""},weight:{required:!0,tsType:{name:"union",raw:'"thin" | "medium" | "thick"',elements:[{name:"literal",value:'"thin"'},{name:"literal",value:'"medium"'},{name:"literal",value:'"thick"'}]},description:""},labels:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    type: "label";
    coord: Coord;
