import{r as t}from"./index-C6mWTJJr.js";const a=({path:r,width:n,height:i,style:l={},title:e})=>t.createElement("svg",{role:"img","aria-hidden":!e,style:{verticalAlign:"middle",...l},width:`${n/i}em`,height:"1em",viewBox:`0 0 ${n} ${i}`},!!e&&t.createElement("title",null,e),t.createElement("path",{d:r,fill:"currentColor"}));a.__docgenInfo={description:`A stripped version of Icon.jsx from webapp. Takes an SVG icon and renders it
