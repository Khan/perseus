import{j as m}from"./jsx-runtime-BT65X5dW.js";import{_ as J}from"./underscore-U-AHniOr.js";import{w as X}from"./core-widget-registry-CzCPDXFL.js";import{n as y}from"./no-important-DlFk8a1I.js";import{c as N}from"./index-D7h-teXI.js";import{r as T}from"./index-C6mWTJJr.js";import{h as j}from"./index-B1Gws05u.js";import{u as Z}from"./i18n-context-3AkWzTTj.js";import{C as R}from"./perseus-api-Ty_QvlNi.js";import{l as W,n as x,r as I,g as ee}from"./constants-BIpV3g0K.js";import{m as O}from"./media-queries-D4w_O5TS.js";import{U as ne}from"./util-B91OeOTw.js";import{C as te}from"./choice-Bj0k_uqp.js";import{C as ae}from"./choice-none-above-DB8xKewf.js";typeof HTMLElement<"u"&&!HTMLElement.prototype.scrollTo&&(HTMLElement.prototype.scrollTo=function(e,o){this.scrollLeft=e,this.scrollTop=o});const B=(e,o)=>{typeof e.scrollTo=="function"?e.scrollTo(0,o):"scrollTop"in e&&(e.scrollTop=o)},oe=(e,o,r=0,t)=>{const s=e===window?window.pageYOffset:e.scrollTop,d=o,g=d-s,u=17,v=r/u;let f=0;const P=setInterval(function(){if(f<v){const b=f/v,q=(-Math.cos(Math.PI*b)+1)/2,k=s+g*q;B(e,k),f+=1}else B(e,d),clearInterval(P)},u)},_=e=>e===document.body||e==null?window:e.scrollHeight>e.clientHeight?e:_(e.parentElement),re=750,ie=(e,o)=>{setTimeout(()=>{const r=_(e),t=e.getBoundingClientRect(),s=r===window?{top:0,bottom:window.innerHeight}:r.getBoundingClientRect();let d=0;const g=r===window?window.scrollY:r.scrollTop;if(t.bottom>s.bottom){let u=t.bottom-s.bottom;t.top+u<s.top&&(u=t.top-s.top),d=g+u}else if(t.top<s.top){const u=t.top-s.top;d=g+u}oe(r,d,re)},0)},{captureScratchpadTouchStart:se}=ne;function le(e,o,r,t){return e?X(e,!!o,r)?t.chooseNumAnswers({numCorrect:String(r)}):t.chooseAllAnswers:t.chooseOneAnswer}const de=function({apiOptions:e,reviewModeRubric:o,reviewMode:r,choices:t,editMode:s=!1,multipleSelect:d=!1,labelWrap:g,countChoices:u,numCorrect:v,isLastUsedWidget:f,onChange:P,registerFocusFunction:b}){const{strings:q}=Z(),k=T.useRef(),A=T.useRef([]);T.useEffect(()=>{if(e.canScrollPage&&f&&o&&!k.current){const n=t.findIndex(a=>a.checked);if(n>=0){const a=A.current[n],l=j.findDOMNode(a.current);l&&ie(l)}}k.current=o},[e,t,f,o]);function E(n,a){let c;a.checked&&!d?c=t.map(p=>!1):c=t.map(p=>p.checked);const l=t.map(p=>p.crossedOut);c[n]=a.checked,l[n]=a.crossedOut,P({checked:c,crossedOut:l})}b==null||b(n=>{const a=A.current[n||0],l=j.findDOMNode(a.current);if(l)l.focus();else return!1;return!0});const C=e.isMobile,K=t[0].highlighted,G=t[t.length-1].highlighted,z=N("perseus-widget-radio",!s&&"perseus-rendered-radio",y.css(i.radio,i.responsiveRadioContainer,K&&C&&i.radioContainerFirstHighlighted,G&&C&&i.radioContainerLastHighlighted)),$=N("instructions",y.css(i.instructions,C&&i.instructionsMobile)),F=le(d,u,v,q),U=y.css(i.responsiveFieldset),V=m.jsxs("fieldset",{className:`perseus-widget-radio-fieldset ${U}`,children:[m.jsx("legend",{className:"perseus-sr-only",children:F}),m.jsx("div",{className:$,"aria-hidden":"true",children:F}),m.jsx("ul",{className:z,style:{listStyle:"none"},children:t.map((n,a)=>{let c=te;const l=T.createRef();A.current[a]=l;const p={apiOptions:e,multipleSelect:d,checked:n.checked,crossedOut:n.crossedOut,previouslyAnswered:n.previouslyAnswered,reviewMode:r,correct:n.correct,rationale:n.rationale,content:n.content,disabled:e.readOnly||n.disabled,showCorrectness:r||!!n.showCorrectness,showRationale:n.hasRationale&&(r||n.showRationale),pos:a,onChange:h=>{s||E(a,h)}};n.isNoneOfTheAbove&&(c=ae,J.extend(p,{showContent:n.revealNoneOfTheAbove}));const D=t[a+1],Y=!!D&&D.highlighted,S=h=>y.css(i.item,i.responsiveItem,h&&i.selectedItem,h&&n.highlighted&&i.aboveBackdrop,h&&n.highlighted&&e.isMobile&&i.aboveBackdropMobile,Y&&e.isMobile&&i.nextHighlighted);S(!0);let M;r&&o&&(M=o.choices[a].correct?R.CORRECT:R.INCORRECT);const Q=N(S(n.checked),R.RADIO.OPTION,n.checked&&R.RADIO.SELECTED,M);let L=null,H;return s&&(H=h=>{let w=h.target;for(;w&&w!==L;){if(w.getAttribute("data-is-radio-icon")){E(a,{checked:!n.checked,crossedOut:n.crossedOut});return}w=w.parentNode}}),m.jsx("li",{ref:h=>L=h,className:Q,onClick:H,onTouchStart:g?void 0:se,children:m.jsx(c,{...p,ref:l})},a)})})]});return m.jsx("div",{className:y.css(i.responsiveContainer),children:V})},i=y.StyleSheet.create({instructions:{display:"block",color:ee,fontSize:14,lineHeight:1.25,fontFamily:"inherit",fontStyle:"normal",fontWeight:"bold",marginBottom:16},instructionsMobile:{fontSize:18,[O.smOrSmaller]:{fontSize:16},[O.xl]:{fontSize:20}},radio:{padding:0},responsiveRadioContainer:{borderBottom:`1px solid ${I}`,borderTop:`1px solid ${I}`,width:"auto",[O.smOrSmaller]:{marginLeft:x,marginRight:x}},radioContainerFirstHighlighted:{borderTop:"1px solid rgba(0, 0, 0, 0)"},radioContainerLastHighlighted:{borderBottom:"1px solid rgba(0, 0, 0, 0)"},item:{marginLeft:20},responsiveItem:{marginLeft:0,padding:0,":not(:last-child)":{borderBottom:`1px solid ${I}`}},selectedItem:{background:"white"},aboveBackdrop:{position:"relative",zIndex:1062},aboveBackdropMobile:{boxShadow:"0 0 4px 0 rgba(0, 0, 0, 0.2),0 0 2px 0 rgba(0, 0, 0, 0.1)",":not(:last-child)":{borderBottom:"1px solid rgba(0, 0, 0, 0)"}},nextHighlighted:{":not(:last-child)":{borderBottom:"1px solid rgba(0, 0, 0, 0)"}},responsiveContainer:{overflow:"auto",marginLeft:x,paddingLeft:W},responsiveFieldset:{paddingRight:W,minWidth:"auto"}});de.__docgenInfo={description:"",methods:[],displayName:"BaseRadio",props:{apiOptions:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
