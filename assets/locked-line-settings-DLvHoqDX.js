import{e as O}from"./util-Cjm22Ttl.js";import"./underscore-U-AHniOr.js";import"./core-widget-registry-2tCIH_GM.js";import"./jquery-CkHB0_Mt.js";import{B as U}from"./index-CYrfVekP.js";import{V as w}from"./index-CskvhqFA.js";import{S as J,O as T}from"./answer-choices-DVQOAvoJ.js";import{S as y}from"./index-B-CZbs2J.js";import{s as c,c as x}from"./index-C9RM_t1w.js";import{L as Y,a as S}from"./index-CbNKSLRm.js";import{L as K,p as W}from"./locked-figure-aria-BvRGGr0Z.js";import{n as Z}from"./no-important-DlFk8a1I.js";import{v as k}from"./index-Dd-cahjY.js";import{r as n}from"./index-C6mWTJJr.js";import{P as G}from"./trash-bold-CHX2KdYF.js";import{C as H}from"./color-select-C8JPGQ7w.js";import{L as Q}from"./line-stroke-select-CYm4pbHo.js";import{L as ee}from"./line-swatch-ClCO8WF5.js";import{L as ne,a as re}from"./locked-label-settings-yDTs91kU.js";import{L as A}from"./locked-point-settings-B1aeYEHs.js";import{g as ae,j as P,a as L,b as le}from"./util-D1_6LeEu.js";const F="The line cannot have length 0.",te=g=>{const{kind:q,points:d,color:b,lineStyle:f="solid",showPoint1:N,showPoint2:j,labels:r,ariaLabel:V,onChangeProps:t,onMove:R,onRemove:X}=g,[i,u]=d,E=q.charAt(0).toUpperCase()+q.slice(1),_=`${E} (${i.coord[0]},
        ${i.coord[1]}), (${u.coord[0]}, ${u.coord[1]})`,h=O(i.coord,u.coord);async function I(){const e=await P(r),a=await P(i.labels),l=await P(u.labels),m=await L(`$${i.coord[0]}$`),o=await L(`$${i.coord[1]}$`),v=await L(`$${u.coord[0]}$`),C=await L(`$${u.coord[1]}$`);let p=`${E}${e} from point${a} at ${m} comma ${o} to point${l} at ${v} comma ${C}`;const $=le(b,f);return p+=$,p}function z(e,a){const l=[...d];l[a]={...d[a],...e};const m=k.midpoint(d[0].coord,d[1].coord),o=k.midpoint(l[0].coord,l[1].coord),v=[o[0]-m[0],o[1]-m[1]],C=r==null?void 0:r.map((p,$)=>({...p,coord:[p.coord[0]+v[0],p.coord[1]+v[1]]}));t({points:l,labels:C})}function M(e){var l,m;const a=r==null?void 0:r.map(o=>({...o,color:e}));t({color:e,points:[{...i,color:e,labels:(l=i.labels)==null?void 0:l.map(o=>({...o,color:e}))},{...u,color:e,labels:(m=u.labels)==null?void 0:m.map(o=>({...o,color:e}))}],labels:a})}function B(e,a){if(!r)return;const l=[...r];l[a]={...r[a],...e},t({labels:l})}function D(e){if(!r)return;const a=r.filter((l,m)=>m!==e);t({labels:a})}return n.createElement(G,{expanded:g.expanded,onToggle:g.onToggle,header:n.createElement(w,{style:s.row},n.createElement(Y,null,_),n.createElement(y,{size:c.xSmall_8}),n.createElement(ee,{color:b,lineStyle:f}))},n.createElement(S,{tag:"label",style:[s.row,s.spaceUnder]},"kind",n.createElement(y,{size:c.xxxSmall_4}),n.createElement(J,{selectedValue:q,onChange:e=>t({kind:e}),placeholder:""},n.createElement(T,{value:"line",label:"line"}),n.createElement(T,{value:"ray",label:"ray"}),n.createElement(T,{value:"segment",label:"segment"}))),n.createElement(w,{style:s.row},n.createElement(H,{selectedValue:b,onChange:M}),n.createElement(y,{size:c.small_12}),n.createElement(Q,{selectedValue:f,onChange:e=>t({lineStyle:e})})),h&&n.createElement(S,{style:s.errorText},F),n.createElement(A,{headerLabel:"Point 1",expanded:!0,showPoint:N,error:h?F:null,...i,onTogglePoint:e=>t({showPoint1:e}),onChangeProps:e=>z(e,0)}),n.createElement(A,{headerLabel:"Point 2",expanded:!0,showPoint:j,error:h?F:null,...u,onTogglePoint:e=>t({showPoint2:e}),onChangeProps:e=>z(e,1)}),n.createElement(y,{size:c.small_12}),n.createElement(w,{style:s.horizontalRule}),n.createElement(K,{ariaLabel:V,getPrepopulatedAriaLabel:I,onChangeProps:e=>{t(e)}}),n.createElement(y,{size:c.xxxSmall_4}),n.createElement(w,{style:s.horizontalRule}),n.createElement(y,{size:c.small_12}),n.createElement(S,null,"Visible labels"),r==null?void 0:r.map((e,a)=>n.createElement(ne,{...e,key:a,expanded:!0,onChangeProps:l=>{B(l,a)},onRemove:()=>{D(a)},containerStyle:s.labelContainer})),n.createElement(U,{kind:"tertiary",startIcon:W,onClick:()=>{const e=[0,-1],a=k.add(k.scale(e,(r==null?void 0:r.length)??0),k.midpoint(d[0].coord,d[1].coord)),l={...ae("label"),coord:a,color:b};t({labels:[...r??[],l]})},style:s.addButton},"Add visible label"),n.createElement(re,{figureType:g.type,onMove:R,onRemove:X}))},s=Z.StyleSheet.create({row:{display:"flex",flexDirection:"row",alignItems:"center"},spaceUnder:{marginBottom:c.xSmall_8},errorText:{color:x.red},addButton:{alignSelf:"start"},horizontalRule:{height:1,backgroundColor:x.offBlack16},labelContainer:{backgroundColor:x.white}});te.__docgenInfo={description:"",methods:[],displayName:"LockedLineSettings",props:{type:{required:!0,tsType:{name:"literal",value:'"line"'},description:""},kind:{required:!0,tsType:{name:"union",raw:'"line" | "ray" | "segment"',elements:[{name:"literal",value:'"line"'},{name:"literal",value:'"ray"'},{name:"literal",value:'"segment"'}]},description:""},points:{required:!0,tsType:{name:"tuple",raw:"[point1: LockedPointType, point2: LockedPointType]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},color:{required:!0,tsType:{name:"unknown[number]",raw:"(typeof lockedFigureColorNames)[number]"},description:""},lineStyle:{required:!0,tsType:{name:"union",raw:'"solid" | "dashed"',elements:[{name:"literal",value:'"solid"'},{name:"literal",value:'"dashed"'}]},description:""},showPoint1:{required:!0,tsType:{name:"boolean"},description:""},showPoint2:{required:!0,tsType:{name:"boolean"},description:""},labels:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    type: "label";
    coord: Coord;
