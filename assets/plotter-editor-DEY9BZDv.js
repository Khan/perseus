var k=Object.defineProperty;var x=(l,d,e)=>d in l?k(l,d,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[d]=e;var r=(l,d,e)=>(x(l,typeof d!="symbol"?d+"":d,e),e);import{j as n}from"./jsx-runtime-BT65X5dW.js";import{k as P,U as T,r as R}from"./util-sPnaD2Np.js";import{_ as o}from"./index-default-BcKQpA1a.js";import{a as C}from"./index-C-7MqfDi.js";import"./jquery-CkHB0_Mt.js";import{P as j}from"./all-widgets-B4Wu3Z6X.js";import"./index-DyG-XbLr.js";import"./answer-choices-BZdbOh4u.js";import"./index-gdjMQqRz.js";import{r as I}from"./index-C6mWTJJr.js";import{h}from"./index-B1Gws05u.js";import"./i18n-context-BlpvwUdd.js";import"./perseus-api-fTM3z0tF.js";import"./renderer-P3vol8Hh.js";import"./free-response-CSaI50Qh.js";import"./index-D7h-teXI.js";import"./dependencies-BsVPGK1s.js";import"./zoomable-tex-Dy-nElJT.js";import"./svg-image-tOD9ENIR.js";import"./no-important-DlFk8a1I.js";import"./number-input-BAk8q4hD.js";import"./simple-keypad-input-Dem2a--N.js";import"./text-input-DtjuhGyQ.js";import"./phet-simulation-BaMZDrAC.js";import"./sortable-BkOR-YuH.js";import"./fixed-to-responsive-CTsII9Xx.js";import"./math-input-COLK-7WA.js";import"./video-transcript-link-RsYwKknS.js";import"./item-version-BoQo51U_.js";import"./article-renderer-D7aIT3_O.js";import"./server-item-renderer-f2Loqclb.js";import"./hints-renderer-DlON21tI.js";import"./base-radio-DlUdDsvv.js";import{c as A}from"./components-lDYVAn8F.js";import"./index-Dd-cahjY.js";import{B as q}from"./blur-input-CN1PFvB4.js";const{InfoTip:c,NumberInput:y,RangeInput:F,TextListEditor:S}=A,E=j.widget,m="starting",g="correct",N=[m,g];function b(l,d,e){const t=o.clone(l);t.length=d;for(let i=l.length;i<d;i++)t[i]=e;return t}const u={scaleY:1,maxY:10,snapsPerLine:2},w=l=>"$"+R(l,2)+"$";class f extends I.Component{constructor(){super(...arguments);r(this,"state",{editing:this.props.static?m:g,pic:null,loadedUrl:null,minX:null,maxX:null,tickStep:null});r(this,"fetchPic",e=>{if(this.state.loadedUrl!==e){const t=new Image;t.src=e,t.onload=()=>{this.setState({pic:t,loadedUrl:e})}}});r(this,"handleChangeTickStep",e=>{this.setState({tickStep:e})});r(this,"handleChangeRange",e=>{this.setState({minX:e[0],maxX:e[1]})});r(this,"changeLabelInterval",e=>{this.props.onChange({labelInterval:e})});r(this,"handlePlotterChange",e=>{const t={};t[this.state.editing]=e.values,this.props.onChange(t)});r(this,"changeType",e=>{let t;if(e==="histogram"?(t=[w(0)].concat(this.props.categories),this.props.onChange({type:e,categories:t})):this.props.type==="histogram"?(t=this.props.categories.slice(1),this.props.onChange({type:e,categories:t})):this.props.onChange({type:e}),t){const i=h.findDOMNode(this.refs.categories);i.value=t.join(", ")}});r(this,"changeLabel",(e,t)=>{const i=o.clone(this.props.labels);i[e]=t.target.value,this.props.onChange({labels:i})});r(this,"changePicUrl",e=>{const t=T.getRealImageUrl(e);this.props.onChange({picUrl:t})});r(this,"changeCategories",e=>{let t=e.length;this.props.type==="histogram"&&t--;const i=this.props.scaleY;this.props.onChange({categories:e,correct:b(this.props.correct,t,i),starting:b(this.props.starting,t,i)})});r(this,"changeScale",e=>{const t=this.props.scaleY,i=+e.target.value||u.scaleY,a=function(p){return p*i/t},s=a(this.props.maxY);this.props.onChange({scaleY:i,maxY:s,correct:o.map(this.props.correct,a),starting:o.map(this.props.starting,a)}),h.findDOMNode(this.refs.maxY).value=s});r(this,"changeMax",e=>{this.props.onChange({maxY:+e.target.value||u.maxY})});r(this,"changeSnaps",e=>{this.props.onChange({snapsPerLine:+e.target.value||u.snapsPerLine})});r(this,"changeEditing",e=>{this.setState({editing:e})});r(this,"setCategoriesFromScale",()=>{const e=this.state.tickStep||1,t=this.state.minX||0,i=this.state.maxX||0,a=Math.floor((i-t)/e)*e;let s;this.props.type==="histogram"||this.props.type==="dotplot"?s=o.range(0,a+e,e):s=o.range(e,a+e,e),s=o.map(s,v=>v+t),s=o.map(s,w),this.changeCategories(s);const p=h.findDOMNode(this.refs.categories);p.value=s.join(", ")});r(this,"serialize",()=>{const e=o.pick(this.props,"correct","starting","type","labels","categories","scaleY","maxY","snapsPerLine","labelInterval");return this.props.type==="pic"&&(e.picUrl=this.props.picUrl),e})}UNSAFE_componentWillMount(){this.fetchPic(this.props.picUrl)}UNSAFE_componentWillReceiveProps(e){this.fetchPic(e.picUrl),e.static&&this.setState({editing:"starting"})}render(){const e=o.contains(["line","histogram","dotplot"],this.props.type),t=!o.contains(["pic","dotplot"],this.props.type),i={trackInteraction:()=>{},...this.props};return n.jsxs("div",{className:"perseus-widget-plotter-editor",children:[n.jsxs("div",{children:["Chart type:"," ",C.map(a=>n.jsxs("label",{children:[n.jsx("input",{type:"radio",name:"chart-type",checked:this.props.type===a,onChange:o.partial(this.changeType,a)}),a]},a),this)]}),n.jsxs("div",{children:["Labels:"," ",["x","y"].map((a,s)=>n.jsxs("label",{children:[a+":",n.jsx("input",{type:"text",onChange:o.partial(this.changeLabel,s),defaultValue:this.props.labels[s]})]},a),this)]}),e&&n.jsxs("div",{className:"set-from-scale-box",children:[n.jsx("span",{className:"categories-title",children:"Set Categories From Scale"}),n.jsxs("div",{children:[n.jsxs("label",{children:["Tick Step:"," ",n.jsx(y,{placeholder:1,useArrowKeys:!0,value:this.state.tickStep,onChange:this.handleChangeTickStep})]}),n.jsx(c,{children:n.jsx("p",{children:"The difference between adjacent ticks."})})]}),n.jsx("div",{children:n.jsxs("label",{children:["Range:"," ",n.jsx(F,{placeholder:[0,10],useArrowKeys:!0,value:[this.state.minX,this.state.maxX],onChange:this.handleChangeRange})]})}),n.jsx("div",{children:n.jsxs("button",{onClick:this.setCategoriesFromScale,children:["Set Categories"," "]})})]}),n.jsxs("div",{children:[n.jsxs("label",{children:["Label Interval:"," ",n.jsx(y,{useArrowKeys:!0,value:this.props.labelInterval,onChange:this.changeLabelInterval})]}),n.jsx(c,{children:n.jsx("p",{children:'Which ticks to display the labels for. For instance, setting this to "4" will only show every 4th label (plus the last one)'})})]}),this.props.type==="pic"&&n.jsxs("div",{children:[n.jsxs("label",{children:["Picture:"," ",n.jsx(q,{className:"pic-url",value:this.props.picUrl,onChange:this.changePicUrl}),n.jsx(c,{children:n.jsx("p",{children:'Use the default picture of Earth, or insert the URL for a different picture using the "Add image" function.'})})]}),this.state.pic&&this.state.pic.width!==this.state.pic.height&&n.jsxs("p",{className:"warning",children:[n.jsx("b",{children:"Warning"}),": You are using a picture which is not square. This means the image will get distorted. You should probably crop it to be square."]})]}),n.jsx("div",{children:n.jsxs("label",{children:["Categories:"," ",n.jsx(S,{ref:"categories",layout:"horizontal",options:this.props.categories,onChange:this.changeCategories})]})}),n.jsx("div",{children:n.jsxs("label",{children:["Scale (y):"," ",n.jsx("input",{type:"text",onChange:this.changeScale,defaultValue:this.props.scaleY})]})}),n.jsx("div",{children:n.jsxs("label",{children:["Max y:"," ",n.jsx("input",{type:"text",ref:"maxY",onChange:this.changeMax,defaultValue:this.props.maxY})]})}),t&&n.jsxs("div",{children:[n.jsxs("label",{children:["Snaps per line:"," ",n.jsx("input",{type:"text",onChange:this.changeSnaps,defaultValue:this.props.snapsPerLine})]}),n.jsx(c,{children:n.jsx("p",{children:"Creates the specified number of divisions between the horizontal lines. Fewer snaps between lines makes the graph easier for the student to create correctly."})})]}),n.jsxs("div",{children:["Editing values:"," ",N.map(a=>n.jsxs("label",{children:[n.jsx("input",{type:"radio",disabled:a===g&&this.props.static,checked:this.props.static?a===m:this.state.editing===a,onChange:s=>this.changeEditing(a)}),a]},a)),n.jsxs(c,{children:[n.jsx("p",{children:"Use this toggle to switch between editing the correct answer (what the student will be graded on) and the starting values (what the student will see plotted when they start the problem). Note: These cannot be the same."}),n.jsx("p",{children:"In static mode, the starting values are rendered out to the displayed widget."})]})]}),n.jsx(E,{...i,starting:this.props[this.state.editing],onChange:this.handlePlotterChange})]})}}r(f,"widgetName","plotter"),r(f,"defaultProps",P.defaultWidgetOptions);f.__docgenInfo={description:"",methods:[{name:"fetchPic",docblock:null,modifiers:[],params:[{name:"url",optional:!1,type:null}],returns:null},{name:"handleChangeTickStep",docblock:null,modifiers:[],params:[{name:"value",optional:!1,type:null}],returns:null},{name:"handleChangeRange",docblock:null,modifiers:[],params:[{name:"newValue",optional:!1,type:null}],returns:null},{name:"changeLabelInterval",docblock:null,modifiers:[],params:[{name:"value",optional:!1,type:null}],returns:null},{name:"handlePlotterChange",docblock:null,modifiers:[],params:[{name:"newProps",optional:!1,type:null}],returns:null},{name:"changeType",docblock:null,modifiers:[],params:[{name:"type",optional:!1,type:null}],returns:null},{name:"changeLabel",docblock:null,modifiers:[],params:[{name:"i",optional:!1,type:null},{name:"e",optional:!1,type:null}],returns:null},{name:"changePicUrl",docblock:null,modifiers:[],params:[{name:"value",optional:!1,type:null}],returns:null},{name:"changeCategories",docblock:null,modifiers:[],params:[{name:"categories",optional:!1,type:null}],returns:null},{name:"changeScale",docblock:null,modifiers:[],params:[{name:"e",optional:!1,type:null}],returns:null},{name:"changeMax",docblock:null,modifiers:[],params:[{name:"e",optional:!1,type:null}],returns:null},{name:"changeSnaps",docblock:null,modifiers:[],params:[{name:"e",optional:!1,type:null}],returns:null},{name:"changeEditing",docblock:null,modifiers:[],params:[{name:"editing",optional:!1,type:null}],returns:null},{name:"setCategoriesFromScale",docblock:null,modifiers:[],params:[],returns:null},{name:"serialize",docblock:null,modifiers:[],params:[],returns:null}],displayName:"PlotterEditor",props:{apiOptions:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
