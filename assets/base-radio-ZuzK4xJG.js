import{_ as Q}from"./underscore-885MUNGo.js";import{u as J}from"./core-widget-registry-lKD0wS3Q.js";import{n as f}from"./no-important-xCWWYXQR.js";import{c as C}from"./index-dnMhQZ-1.js";import{r as d}from"./index-6oxdNXpR.js";import{F as H}from"./index-9gkyvru-.js";import{u as X}from"./i18n-context-X2Y0qeee.js";import{C as T}from"./perseus-api-Y55S7ZPk.js";import{g as Z,r as N,n as I,l as W}from"./constants-vGHYchdS.js";import{m as x}from"./media-queries-OayJ4KsJ.js";import{U as ee}from"./util-VofM5AGr.js";import{C as ne}from"./choice-iY0uKhlg.js";import{C as te}from"./choice-none-above-h75nNuCW.js";typeof HTMLElement<"u"&&!HTMLElement.prototype.scrollTo&&(HTMLElement.prototype.scrollTo=function(e,o){this.scrollLeft=e,this.scrollTop=o});const B=(e,o)=>{typeof e.scrollTo=="function"?e.scrollTo(0,o):"scrollTop"in e&&(e.scrollTop=o)},ae=(e,o,r=0,t)=>{const s=e===window?window.pageYOffset:e.scrollTop,u=o,g=u-s,c=17,v=r/c;let y=0;const R=setInterval(function(){if(y<v){const b=y/v,P=(-Math.cos(Math.PI*b)+1)/2,k=s+g*P;B(e,k),y+=1}else B(e,u),clearInterval(R),t==null||t()},c)},j=e=>e===document.body||e==null?window:e.scrollHeight>e.clientHeight?e:j(e.parentElement),oe=750,re=(e,o)=>{setTimeout(()=>{const r=j(e),t=e.getBoundingClientRect(),s=r===window?{top:0,bottom:window.innerHeight}:r.getBoundingClientRect();let u=0;const g=r===window?window.scrollY:r.scrollTop;if(t.bottom>s.bottom){let c=t.bottom-s.bottom;t.top+c<s.top&&(c=t.top-s.top),u=g+c}else if(t.top<s.top){const c=t.top-s.top;u=g+c}ae(r,u,oe,o)},0)},{captureScratchpadTouchStart:ie}=ee;function se(e,o,r,t){return e?J(e,!!o,r)?t.chooseNumAnswers({numCorrect:String(r)}):t.chooseAllAnswers:t.chooseOneAnswer}const le=function({apiOptions:e,reviewModeRubric:o,reviewMode:r,choices:t,editMode:s=!1,multipleSelect:u=!1,labelWrap:g,countChoices:c,numCorrect:v,isLastUsedWidget:y,onChange:R,registerFocusFunction:b}){const{strings:P}=X(),k=d.useRef(),q=d.useRef([]);d.useEffect(()=>{if(e.canScrollPage&&y&&o&&!k.current){const n=t.findIndex(a=>a.checked);if(n>=0){const a=q.current[n],l=H.findDOMNode(a.current);l&&re(l)}}k.current=o},[e,t,y,o]);function E(n,a){let h;a.checked&&!u?h=t.map(m=>!1):h=t.map(m=>m.checked);const l=t.map(m=>m.crossedOut);h[n]=a.checked,l[n]=a.crossedOut,R({checked:h,crossedOut:l})}b==null||b(n=>{const a=q.current[n||0],l=H.findDOMNode(a.current);if(l)l.focus();else return!1;return!0});const A=e.isMobile,_=t[0].highlighted,K=t[t.length-1].highlighted,G=C("perseus-widget-radio",!s&&"perseus-rendered-radio",f.css(i.radio,i.responsiveRadioContainer,_&&A&&i.radioContainerFirstHighlighted,K&&A&&i.radioContainerLastHighlighted)),z=C("instructions",f.css(i.instructions,A&&i.instructionsMobile)),O=se(u,c,v,P),$=f.css(i.responsiveFieldset),U=d.createElement("fieldset",{className:`perseus-widget-radio-fieldset ${$}`},d.createElement("legend",{className:"perseus-sr-only"},O),d.createElement("div",{className:z,"aria-hidden":"true"},O),d.createElement("ul",{className:G,style:{listStyle:"none"}},t.map((n,a)=>{let h=ne;const l=d.createRef();q.current[a]=l;const m={apiOptions:e,multipleSelect:u,checked:n.checked,crossedOut:n.crossedOut,previouslyAnswered:n.previouslyAnswered,reviewMode:r,correct:n.correct,rationale:n.rationale,content:n.content,disabled:e.readOnly||n.disabled,showCorrectness:r||!!n.showCorrectness,showRationale:n.hasRationale&&(r||n.showRationale),pos:a,onChange:p=>{s||E(a,p)}};n.isNoneOfTheAbove&&(h=te,Q.extend(m,{showContent:n.revealNoneOfTheAbove}));const S=t[a+1],V=!!S&&S.highlighted,M=p=>f.css(i.item,i.responsiveItem,p&&i.selectedItem,p&&n.highlighted&&i.aboveBackdrop,p&&n.highlighted&&e.isMobile&&i.aboveBackdropMobile,V&&e.isMobile&&i.nextHighlighted);M(!0);let D;r&&o&&(D=o.choices[a].correct?T.CORRECT:T.INCORRECT);const Y=C(M(n.checked),T.RADIO.OPTION,n.checked&&T.RADIO.SELECTED,D);let F=null,L;return s&&(L=p=>{let w=p.target;for(;w&&w!==F;){if(w.getAttribute("data-is-radio-icon")){E(a,{checked:!n.checked,crossedOut:n.crossedOut});return}w=w.parentNode}}),d.createElement("li",{key:a,ref:p=>F=p,className:Y,onClick:L,onTouchStart:g?void 0:ie},d.createElement(h,{...m,ref:l}))})));return d.createElement("div",{className:f.css(i.responsiveContainer)},U)},i=f.StyleSheet.create({instructions:{display:"block",color:Z,fontSize:14,lineHeight:1.25,fontFamily:"inherit",fontStyle:"normal",fontWeight:"bold",marginBottom:16},instructionsMobile:{fontSize:18,[x.smOrSmaller]:{fontSize:16},[x.xl]:{fontSize:20}},radio:{padding:0},responsiveRadioContainer:{borderBottom:`1px solid ${N}`,borderTop:`1px solid ${N}`,width:"auto",[x.smOrSmaller]:{marginLeft:I,marginRight:I}},radioContainerFirstHighlighted:{borderTop:"1px solid rgba(0, 0, 0, 0)"},radioContainerLastHighlighted:{borderBottom:"1px solid rgba(0, 0, 0, 0)"},item:{marginLeft:20},responsiveItem:{marginLeft:0,padding:0,":not(:last-child)":{borderBottom:`1px solid ${N}`}},selectedItem:{background:"white"},aboveBackdrop:{position:"relative",zIndex:1062},aboveBackdropMobile:{boxShadow:"0 0 4px 0 rgba(0, 0, 0, 0.2),0 0 2px 0 rgba(0, 0, 0, 0.1)",":not(:last-child)":{borderBottom:"1px solid rgba(0, 0, 0, 0)"}},nextHighlighted:{":not(:last-child)":{borderBottom:"1px solid rgba(0, 0, 0, 0)"}},responsiveContainer:{overflow:"auto",marginLeft:I,paddingLeft:W},responsiveFieldset:{paddingRight:W,minWidth:"auto"}});le.__docgenInfo={description:"",methods:[],displayName:"BaseRadio",props:{apiOptions:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
