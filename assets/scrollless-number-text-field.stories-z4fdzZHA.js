import{j as e}from"./jsx-runtime-63Ea5SlK.js";import{V as i}from"./index-wtbtsH8q.js";import{L as c}from"./index-vvS-NDPJ.js";import{r as V}from"./index-6oxdNXpR.js";import{S as s}from"./scrollless-number-text-field-B-xR8iJD.js";import"./extends-wRoo2ExD.js";import"./index-awljIyHI.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./index-i3rSs_ir.js";import"./index-GoufVIe2.js";import"./index-Pc_lv_ia.js";import"./index-I-Vn3Q8r.js";import"./minus-bold-ONmDo3Ve.js";const z={title:"PerseusEditor/Components/Scrollless Number Text Field",component:s},t=n=>e.jsx(s,{...n}),C={value:"",onChange:()=>{}};t.args=C;const r={render:function(){const[a,l]=V.useState("");return e.jsx(s,{value:a,onChange:l})}};r.parameters={chromatic:{disableSnapshot:!0}};const o={render:function(){const[a,l]=V.useState("");return e.jsxs(e.Fragment,{children:[e.jsx(c,{children:"Scroll down to see the input."}),e.jsx(i,{style:{height:"100vh"}}),e.jsx(c,{children:"Observe that scrolling on the input field with a mouse wheel changes the number, but does not scroll the page."}),e.jsx(s,{value:a,onChange:l}),e.jsx(i,{style:{height:"100vh"}})]})}};o.parameters={chromatic:{disableSnapshot:!0}};t.__docgenInfo={description:`Uncontrolled story. Interact with the control panel to see the component
...
changes the number, but does not scroll the page.`,...(j=(L=o.parameters)==null?void 0:L.docs)==null?void 0:j.description}}};const A=["Default","Controlled","LongPageScroll"];export{r as Controlled,t as Default,o as LongPageScroll,A as __namedExportsOrder,z as default};
