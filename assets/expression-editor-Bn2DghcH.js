var j=Object.defineProperty;var A=(l,o,e)=>o in l?j(l,o,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[o]=e;var t=(l,o,e)=>(A(l,typeof o!="symbol"?o+"":o,e),e);import{r as C,br as q,bs as w,_ as T,bt as L,bu as E,j as s,ah as h,V as v,H as x,n as m,bv as f,bw as K,bx as P,s as p,y as S,z as b,by as k,bz as I,bA as N,e as g}from"./iframe-Av__LOls.js";import"./item-version-CHgavrtG.js";import"./article-renderer-C0sZ0ydP.js";import"./server-item-renderer-aIl7SK8E.js";import"./hints-renderer-C2VM9sFD.js";import{c as V}from"./components-BrYWmJxs.js";const{ButtonGroup:D,InfoTip:c}=V,F=["basic","trig","prealgebra","logarithms","scientific","basic relations","advanced relations"];class y extends C.Component{constructor(e){super(e);t(this,"getSaveWarnings",()=>{const e=[];return this.props.answerForms.length===0?e.push("No answers specified"):(this.props.answerForms.some(n=>n.considered==="correct")||e.push("No correct answer specified"),T(this.props.answerForms).each((n,r)=>{if(this.props.value==="")e.push(`Answer ${r+1} is empty`);else{const u=L(n.value,{functions:this.props.functions});u.parsed?n.simplify&&!u.expr.isSimplified()&&e.push(`${n.value} isn't simplified, but is required" +
