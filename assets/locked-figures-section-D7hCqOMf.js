import{j as n}from"./jsx-runtime-BT65X5dW.js";import{B as S}from"./phet-simulation-BaMZDrAC.js";import{V as h}from"./index-DyG-XbLr.js";import{S as O}from"./index-BWwc-H8c.js";import{s as c,c as R}from"./index-BfjDPqC2.js";import{n as f}from"./no-important-DlFk8a1I.js";import{r as g}from"./index-C6mWTJJr.js";import{H as j}from"./heading-CX3Kt_jc.js";import{a as E,b as D}from"./answer-choices-BZdbOh4u.js";import{w as M}from"./index-BzwLglMS.js";import{L as z}from"./locked-ellipse-settings-sB6CmM_z.js";import{L as G}from"./locked-function-settings-DVe9u3fO.js";import{L as V}from"./locked-label-settings-Be6cnIAe.js";import{L as W}from"./locked-line-settings-B5BsN1MN.js";import{L as H}from"./locked-point-settings-BQJPcC8w.js";import{L as K}from"./locked-polygon-settings-VByIt8DO.js";import{L as X}from"./locked-vector-settings-DfL0qLqa.js";import{g as _}from"./util-B9KD-X2-.js";const q=o=>{const{id:y,onChange:i}=o,u=["point","line","vector","ellipse","polygon","function","label"];return n.jsx(h,{style:k.container,children:n.jsx(E,{menuText:"Add locked figure",style:k.addElementSelect,children:u.map(s=>n.jsx(D,{label:s,onClick:()=>i(s)},`${y}-${s}`))})})},k=f.StyleSheet.create({container:{marginTop:c.xSmall_8},addElementSelect:{backgroundColor:R.fadedBlue8,borderRadius:c.xxxSmall_4}});q.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSelect",props:{id:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: LockedFigureType) => void",signature:{arguments:[{type:{name:'union["type"]',raw:'LockedFigure["type"]'},name:"value"}],return:{name:"void"}}},description:""}}};const x=o=>{switch(o.type){case"point":return n.jsx(H,{...o});case"line":return n.jsx(W,{...o});case"vector":return n.jsx(X,{...o});case"ellipse":return n.jsx(z,{...o});case"polygon":return n.jsx(K,{...o});case"function":return n.jsx(G,{...o});case"label":return n.jsx(V,{...o});default:throw new M(o)}};x.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSettings",props:{onMove:{required:!0,tsType:{name:"signature",type:"function",raw:"(movement: LockedFigureSettingsMovementType) => void",signature:{arguments:[{type:{name:"union",raw:`| "back"
| "backward"
| "forward"
| "front"`,elements:[{name:"literal",value:'"back"'},{name:"literal",value:'"backward"'},{name:"literal",value:'"forward"'},{name:"literal",value:'"front"'}]},name:"movement"}],return:{name:"void"}}},description:"Called when a movement button (top, up, down, bottom) is pressed."},onRemove:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Called when the delete button is pressed."},expanded:{required:!1,tsType:{name:"boolean"},description:"Whether this accordion is expanded."},onToggle:{required:!1,tsType:{name:"signature",type:"function",raw:"(expanded: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"expanded"}],return:{name:"void"}}},description:"Called when the accordion is expanded or collapsed."}}};const $=o=>{const y=Array((o.figures??[]).length).fill(!1),[i,u]=g.useState(y),[s,A]=g.useState(!0),w=g.useId(),{figures:r,onChange:m}=o;function C(e){const t={lockedFigures:[...r||[],_(e)]};m(t),u([...i,!0])}function T(e,a){if(e===0&&(a==="back"||a==="backward")||r&&e===r.length-1&&(a==="front"||a==="forward"))return;const l=[...r||[]],d=[...i],[p]=l.splice(e,1);switch(d.splice(e,1),a){case"back":l.unshift(p),d.unshift(!0);break;case"backward":l.splice(e-1,0,p),d.splice(e-1,0,!0);break;case"forward":l.splice(e+1,0,p),d.splice(e+1,0,!0);break;case"front":l.push(p),d.push(!0);break}m({lockedFigures:l}),u(d)}function L(e){if(window.confirm("Are you sure you want to delete this figure?")){const a=r||[];m({lockedFigures:[...a.slice(0,e),...a.slice(e+1)]});const t=[...i];t.splice(e,1),u(t)}}function P(e,a){const t=r||[],l={lockedFigures:[...t.slice(0,e),{...t[e],...a},...t.slice(e+1)]};m(l)}function N(e){u(Array(r==null?void 0:r.length).fill(e))}const b=i.every(e=>!e),F=b?"Expand all":"Collapse all",I=!!(r!=null&&r.length);return n.jsxs(n.Fragment,{children:[n.jsx(j,{title:"Locked Figures",isOpen:s,onToggle:()=>A(!s),isCollapsible:!0}),s&&n.jsxs(h,{children:[r==null?void 0:r.map((e,a)=>n.jsx(x,{expanded:i[a],onToggle:t=>{const l=[...i];l[a]=t,u(l)},...e,onChangeProps:t=>P(a,t),onMove:t=>T(a,t),onRemove:()=>L(a)},`${w}-locked-${e}-${a}`)),n.jsxs(h,{style:v.buttonContainer,children:[n.jsx(q,{id:`${w}-select`,onChange:C}),n.jsx(O,{size:c.small_12}),I&&n.jsx(S,{kind:"secondary",onClick:()=>N(b),style:v.button,children:F})]})]})]})},v=f.StyleSheet.create({buttonContainer:{flexDirection:"row",alignItems:"center"},button:{marginTop:c.xSmall_8,flexGrow:1}});$.__docgenInfo={description:"",methods:[],displayName:"LockedFiguresSection",props:{figures:{required:!1,tsType:{name:"Array",elements:[{name:"union",raw:`| LockedPointType
| LockedLineType
| LockedVectorType
| LockedEllipseType
| LockedPolygonType
