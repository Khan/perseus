import{j as a,V as li,aM as gi,a1 as hi,A as pi,w as mi,cU as wi,d0 as bi}from"./iframe-JBJONHHl.js";import{i as e}from"./interactive-graph-question-builder-B1ub-b6F.js";import{j as fi}from"./interactive-graph.testdata-Bm5RtNWD.js";const qi={title:"Perseus/Widgets/Interactive Graph Visual Regression Tests",component:Li,parameters:{chromatic:{disableSnapshot:!1}},decorators:s=>a.jsx(li,{style:{marginInlineStart:32},children:a.jsx(s,{})})};function ci(s){return a.jsx("div",{className:"framework-perseus perseus-mobile",children:a.jsx(s,{})})}const t={args:{question:e().withAxisLabels("\\text{Custom $x$ label}","\\text{Custom $y$ label}").build()}},r={args:{question:e().withGridStep(2.571,3.123).build()}},o={args:{question:e().withTickStep(1.5,1.5).build()}},n={args:{question:e().withMarkings("axes").build()}},c={args:{question:e().withMarkings("grid").build()}},u={args:{question:e().withMarkings("none").build()}},d={args:{question:e().withXRange(-2,2).withYRange(-2,2).build()}},l={args:{question:e().withXRange(-50,50).withYRange(-50,50).build()}},g={args:{question:e().withXRange(0,20).addLockedLine([1,1],[5,2]).build()}},h={args:{question:e().withXRange(-1,20).addLockedLine([1,1],[5,2]).build()}},p={args:{question:e().withXRange(-3,20).addLockedLine([1,1],[5,2]).build()}},m={args:{question:e().withXRange(1,20).build()}},w={args:{question:e().withXRange(6,20).build()}},b={args:{question:e().withXRange(-20,0).build()}},f={args:{question:e().withXRange(-20,-1).build()}},L={args:{question:e().withXRange(-20,-6).build()}},W={args:{question:e().withYRange(0,20).build()}},M={args:{question:e().withYRange(-1,20).build()}},R={args:{question:e().withYRange(1,20).build()}},q={args:{question:e().withYRange(-3,20).addLockedLine([-3,2],[5,16]).build()}},k={args:{question:e().withYRange(-20,0).build()}},A={args:{question:e().withYRange(-20,-1).build()}},S={args:{question:e().withXRange(-10,10).withYRange(-10,10).withAxisLabels("Video Game Hours per Week","Reaction Time (milliseconds)").withLabelLocation("alongEdge").build()}},x={args:{question:e().withXRange(0,10).withYRange(0,10).withAxisLabels("Video Game Hours per Week","Reaction Time (milliseconds)").withLabelLocation("alongEdge").build()}},G={args:{question:e().withXRange(-1,10).withYRange(-1,10).withAxisLabels("Video Game Hours per Week","Reaction Time (milliseconds)").withLabelLocation("alongEdge").build()}},X={args:{question:e().withXRange(0,.01).withYRange(0,.01).withTickStep(.001,.001).withGridStep(.001,.001).withAxisLabels("Video Game Hours per Week","Reaction Time (milliseconds)").withLabelLocation("alongEdge").build()}},Y={args:{question:e().withXRange(-.03,.84).withYRange(-2.8,63).withTickStep(.2,10).withGridStep(.05,5).withSnapStep(.025,2).withAxisLabels("Time (seconds)","Distance (meters)").withLabelLocation("alongEdge").build()}},v={args:{question:e().withXRange(-30,840).withYRange(-2.8,63).withTickStep(200,10).withGridStep(50,5).withSnapStep(25,2).withAxisLabels("Time (seconds)","Distance (meters)").withLabelLocation("alongEdge").build()}},B={args:{question:e().withXRange(0,.5).withYRange(0,.5).withTickStep(.1,.1).withGridStep(.1,.1).withAxisLabels("Video Game Hours per Week","Reaction Time (milliseconds)").withLabelLocation("alongEdge").build()}},T={args:{question:e().build()},decorators:[ci]},Q={args:{question:e().withSegments({numSegments:3}).build()}},E={args:{question:e().withCircle().withXRange(-10,10).withYRange(-5,5).build()},decorators:[ci]},O={args:{question:e().addLockedLine([-3,-3],[3,3]).withXRange(-5,5).withYRange(-10,10).build()}},P={args:{question:e().addLockedPointAt(3,2).addLockedPointAt(-1,1).addLockedPointAt(0,-4).build()}},F={args:{question:e().addLockedLine([-1,1],[2,3]).build()}},C={args:{question:e().withAngle().withProtractor().build()}},I={args:{question:fi}},N={args:{question:(()=>{const s=e().build(),i=wi({question:s});return bi(i).question})()}};function H(s){return e().withNoInteractiveFigure().addLockedLine([2,2],[9,9],{kind:"segment",weight:s}).addLockedLine([2,1],[9,8],{kind:"ray",weight:s}).addLockedLine([2,0],[9,7],{kind:"line",weight:s}).addLockedVector([4,-7],[7,-4],{weight:s,color:"green"}).addLockedEllipse([-5,5],[1,1],{weight:s,color:"blue"}).addLockedPolygon([[-7.5,-3.5],[-6.5,-2.5],[-5.5,-3.5],[-6.5,-4.5]],{weight:s,color:"pink"}).addLockedFunction("x^2",{weight:s,color:"red"}).build()}const V={args:{question:H("thin")}},y={args:{question:H("medium")}},j={args:{question:H("thick")}};function Li(s){const{question:i}=s;return a.jsx(gi,{widgets:i.widgets,problemNum:0,children:({userInput:D,handleUserInput:ui,initializeUserInput:di})=>a.jsx(hi,{userInput:D,handleUserInput:ui,initializeUserInput:di,strings:mi,content:i.content,widgets:i.widgets,images:i.images,apiOptions:pi.defaults})})}var $,J,Z;t.parameters={...t.parameters,docs:{...($=t.parameters)==null?void 0:$.docs,source:{originalSource:`{
...
}`,...(Qe=(Te=b.parameters)==null?void 0:Te.docs)==null?void 0:Qe.source}}};var Ee,Oe,Pe;f.parameters={...f.parameters,docs:{...(Ee=f.parameters)==null?void 0:Ee.docs,source:{originalSource:`{
  args: {
    question: interactiveGraphQuestionBuilder().withXRange(-20, -1).build()
  }
}`,...(Pe=(Oe=f.parameters)==null?void 0:Oe.docs)==null?void 0:Pe.source}}};var Fe,Ce,Ie;L.parameters={...L.parameters,docs:{...(Fe=L.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
  args: {
...
}`,...(ye=(Ve=W.parameters)==null?void 0:Ve.docs)==null?void 0:ye.source}}};var je,He,De;M.parameters={...M.parameters,docs:{...(je=M.parameters)==null?void 0:je.docs,source:{originalSource:`{
  args: {
    question: interactiveGraphQuestionBuilder().withYRange(-1, 20).build()
  }
}`,...(De=(He=M.parameters)==null?void 0:He.docs)==null?void 0:De.source}}};var $e,Je,Ze;R.parameters={...R.parameters,docs:{...($e=R.parameters)==null?void 0:$e.docs,source:{originalSource:`{
  args: {
    question: interactiveGraphQuestionBuilder().withYRange(1, 20).build()
  }
}`,...(Ze=(Je=R.parameters)==null?void 0:Je.docs)==null?void 0:Ze.source}}};var Ue,_e,ze;q.parameters={...q.parameters,docs:{...(Ue=q.parameters)==null?void 0:Ue.docs,source:{originalSource:`{
  args: {
    question: interactiveGraphQuestionBuilder().withYRange(-3, 20).addLockedLine([-3, 2], [5, 16]).build()
  }
}`,...(ze=(_e=q.parameters)==null?void 0:_e.docs)==null?void 0:ze.source}}};var Ke,es,ss;k.parameters={...k.parameters,docs:{...(Ke=k.parameters)==null?void 0:Ke.docs,source:{originalSource:`{
  args: {
  ...
  decorators: [MobileContainerDecorator]
}`,...(Qs=(Ts=E.parameters)==null?void 0:Ts.docs)==null?void 0:Qs.source}}};var Es,Os,Ps;O.parameters={...O.parameters,docs:{...(Es=O.parameters)==null?void 0:Es.docs,source:{originalSource:`{
  args: {
    question: interactiveGraphQuestionBuilder().addLockedLine([-3, -3], [3, 3]).withXRange(-5, 5).withYRange(-10, 10).build()
  }
}`,...(Ps=(Os=O.parameters)==null?void 0:Os.docs)==null?void 0:Ps.source}}};var Fs,Cs,Is;P.parameters={...P.parameters,docs:{...(Fs=P.parameters)==null?void 0:Fs.docs,source:{originalSource:`{
  args: {
    question: interactiveGraphQuestionBuilder().addLockedPointAt(3, 2).addLockedPointAt(-1, 1).addLockedPointAt(0, -4).build()
  }
}`,...(Is=(Cs=P.parameters)==null?void 0:Cs.docs)==null?void 0:Is.source}}};var Ns,Vs,ys;F.parameters={...F.parameters,docs:{...(Ns=F.parameters)==null?void 0:Ns.docs,source:{originalSource:`{
  args: {
    question: interactiveGraphQuestionBuilder().addLockedLine([-1, 1], [2, 3]).build()
  }
}`,...(ys=(Vs=F.parameters)==null?void 0:Vs.docs)==null?void 0:ys.source}}};var js,Hs,Ds;C.parameters={...C.parameters,docs:{...(js=C.parameters)==null?void 0:js.docs,source:{originalSource:`{
  args: {
    question: interactiveGraphQuestionBuilder().withAngle().withProtractor().build()
  }
}`,...(Ds=(Hs=C.parameters)==null?void 0:Hs.docs)==null?void 0:Ds.source}}};var $s,Js,Zs;I.parameters={...I.parameters,docs:{...($s=I.parameters)==null?void 0:$s.docs,source:{originalSource:`{
  args: {
    question: sinusoidWithPiTicks
  }
}`,...(Zs=(Js=I.parameters)==null?void 0:Js.docs)==null?void 0:Zs.source}}};var Us,_s,zs;N.parameters={...N.parameters,docs:{...(Us=N.parameters)==null?void 0:Us.docs,source:{originalSource:`{
  args: {
    question: (() => {
...
}`,...(zs=(_s=N.parameters)==null?void 0:_s.docs)==null?void 0:zs.source}}};var Ks,ei,si;V.parameters={...V.parameters,docs:{...(Ks=V.parameters)==null?void 0:Ks.docs,source:{originalSource:`{
  args: {
