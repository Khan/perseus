var j=Object.defineProperty;var A=(l,o,e)=>o in l?j(l,o,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[o]=e;var t=(l,o,e)=>(A(l,typeof o!="symbol"?o+"":o,e),e);import{r as C,al as q,am as w,_ as T,an as L,ao as E,j as s,ae as h,V as v,H as x,n as m,ap as f,aq as K,ar as P,s as p,k as S,as as b,at as k,au as I,av as N,l as g}from"./iframe-DFbBIt0y.js";import"./item-version-DpOJMRSg.js";import"./article-renderer-Czhy2ZZS.js";import"./server-item-renderer-CqRBl6lr.js";import"./hints-renderer-BRb-J5Ky.js";import{c as V}from"./components-DyjAWM_u.js";const{ButtonGroup:D,InfoTip:c}=V,F=["basic","trig","prealgebra","logarithms","scientific","basic relations","advanced relations"];class y extends C.Component{constructor(e){super(e);t(this,"getSaveWarnings",()=>{const e=[];return this.props.answerForms.length===0?e.push("No answers specified"):(this.props.answerForms.some(a=>a.considered==="correct")||e.push("No correct answer specified"),T(this.props.answerForms).each((a,r)=>{if(this.props.value==="")e.push(`Answer ${r+1} is empty`);else{const u=L(a.value,{functions:this.props.functions});u.parsed?a.simplify&&!u.expr.isSimplified()&&e.push(`${a.value} isn't simplified, but is required" +
