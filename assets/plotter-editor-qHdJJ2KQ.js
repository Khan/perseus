import{j as e}from"./jsx-runtime-63Ea5SlK.js";import{U as v,r as k}from"./util-gHYooniF.js";import{_ as s}from"./index-default-4_ZsnO94.js";import{g as x,h as T}from"./core-widget-registry-uiKfW1Am.js";import"./jquery-5v7aFUvu.js";import{P}from"./article-renderer-leaqqgtk.js";import"./phet-simulation-YCnlPLBr.js";import"./dependencies-CP7Uh8Kq.js";import"./perseus-api-DO0X8arb.js";import"./server-item-renderer-435spoxU.js";import"./hints-renderer-x8agiMqq.js";import"./renderer-hOwF9UTk.js";import"./base-radio-LPYVEr8T.js";import{c as R}from"./components-vJjHbI4Q.js";import"./i18n-context-4c65FWra.js";import"./svg-image-e2j_53PB.js";import"./index-smZ6iCr_.js";import{r as C}from"./index-6oxdNXpR.js";import{F as h}from"./index-9gkyvru-.js";import{B as j}from"./blur-input-6j4bgLwx.js";const{InfoTip:o,NumberInput:f,RangeInput:I,TextListEditor:A}=R,q=P.widget,p="starting",m="correct",S=[p,m];function y(l,n,t){const i=s.clone(l);i.length=n;for(let a=l.length;a<n;a++)i[a]=t;return i}const u={scaleY:1,maxY:10,snapsPerLine:2},w=l=>"$"+k(l,2)+"$",d=class d extends C.Component{constructor(){super(...arguments),this.state={editing:this.props.static?p:m,pic:null,loadedUrl:null,minX:null,maxX:null,tickStep:null},this.fetchPic=n=>{if(this.state.loadedUrl!==n){const t=new Image;t.src=n,t.onload=()=>{this.setState({pic:t,loadedUrl:n})}}},this.handleChangeTickStep=n=>{this.setState({tickStep:n})},this.handleChangeRange=n=>{this.setState({minX:n[0],maxX:n[1]})},this.changeLabelInterval=n=>{this.props.onChange({labelInterval:n})},this.handlePlotterChange=n=>{const t={};t[this.state.editing]=n.values,this.props.onChange(t)},this.changeType=n=>{let t;if(n==="histogram"?(t=[w(0)].concat(this.props.categories),this.props.onChange({type:n,categories:t})):this.props.type==="histogram"?(t=this.props.categories.slice(1),this.props.onChange({type:n,categories:t})):this.props.onChange({type:n}),t){const i=h.findDOMNode(this.refs.categories);i.value=t.join(", ")}},this.changeLabel=(n,t)=>{const i=s.clone(this.props.labels);i[n]=t.target.value,this.props.onChange({labels:i})},this.changePicUrl=n=>{const t=v.getRealImageUrl(n);this.props.onChange({picUrl:t})},this.changeCategories=n=>{let t=n.length;this.props.type==="histogram"&&t--;const i=this.props.scaleY;this.props.onChange({categories:n,correct:y(this.props.correct,t,i),starting:y(this.props.starting,t,i)})},this.changeScale=n=>{const t=this.props.scaleY,i=+n.target.value||u.scaleY,a=function(c){return c*i/t},r=a(this.props.maxY);this.props.onChange({scaleY:i,maxY:r,correct:s.map(this.props.correct,a),starting:s.map(this.props.starting,a)}),h.findDOMNode(this.refs.maxY).value=r},this.changeMax=n=>{this.props.onChange({maxY:+n.target.value||u.maxY})},this.changeSnaps=n=>{this.props.onChange({snapsPerLine:+n.target.value||u.snapsPerLine})},this.changeEditing=n=>{this.setState({editing:n})},this.setCategoriesFromScale=()=>{const n=this.state.tickStep||1,t=this.state.minX||0,i=this.state.maxX||0,a=Math.floor((i-t)/n)*n;let r;this.props.type==="histogram"||this.props.type==="dotplot"?r=s.range(0,a+n,n):r=s.range(n,a+n,n),r=s.map(r,b=>b+t),r=s.map(r,w),this.changeCategories(r);const c=h.findDOMNode(this.refs.categories);c.value=r.join(", ")},this.serialize=()=>{const n=s.pick(this.props,"correct","starting","type","labels","categories","scaleY","maxY","snapsPerLine","labelInterval");return this.props.type==="pic"&&(n.picUrl=this.props.picUrl),n}}UNSAFE_componentWillMount(){this.fetchPic(this.props.picUrl)}UNSAFE_componentWillReceiveProps(n){this.fetchPic(n.picUrl),n.static&&this.setState({editing:"starting"})}render(){const n=s.contains(["line","histogram","dotplot"],this.props.type),t=!s.contains(["pic","dotplot"],this.props.type),i={trackInteraction:()=>{},...this.props};return e.jsxs("div",{className:"perseus-widget-plotter-editor",children:[e.jsxs("div",{children:["Chart type:"," ",T.map(a=>e.jsxs("label",{children:[e.jsx("input",{type:"radio",name:"chart-type",checked:this.props.type===a,onChange:s.partial(this.changeType,a)}),a]},a),this)]}),e.jsxs("div",{children:["Labels:"," ",["x","y"].map((a,r)=>e.jsxs("label",{children:[a+":",e.jsx("input",{type:"text",onChange:s.partial(this.changeLabel,r),defaultValue:this.props.labels[r]})]},a),this)]}),n&&e.jsxs("div",{className:"set-from-scale-box",children:[e.jsx("span",{className:"categories-title",children:"Set Categories From Scale"}),e.jsxs("div",{children:[e.jsxs("label",{children:["Tick Step:"," ",e.jsx(f,{placeholder:1,useArrowKeys:!0,value:this.state.tickStep,onChange:this.handleChangeTickStep})]}),e.jsx(o,{children:e.jsx("p",{children:"The difference between adjacent ticks."})})]}),e.jsx("div",{children:e.jsxs("label",{children:["Range:"," ",e.jsx(I,{placeholder:[0,10],useArrowKeys:!0,value:[this.state.minX,this.state.maxX],onChange:this.handleChangeRange})]})}),e.jsx("div",{children:e.jsxs("button",{onClick:this.setCategoriesFromScale,children:["Set Categories"," "]})})]}),e.jsxs("div",{children:[e.jsxs("label",{children:["Label Interval:"," ",e.jsx(f,{useArrowKeys:!0,value:this.props.labelInterval,onChange:this.changeLabelInterval})]}),e.jsx(o,{children:e.jsx("p",{children:'Which ticks to display the labels for. For instance, setting this to "4" will only show every 4th label (plus the last one)'})})]}),this.props.type==="pic"&&e.jsxs("div",{children:[e.jsxs("label",{children:["Picture:"," ",e.jsx(j,{className:"pic-url",value:this.props.picUrl,onChange:this.changePicUrl}),e.jsx(o,{children:e.jsx("p",{children:'Use the default picture of Earth, or insert the URL for a different picture using the "Add image" function.'})})]}),this.state.pic&&this.state.pic.width!==this.state.pic.height&&e.jsxs("p",{className:"warning",children:[e.jsx("b",{children:"Warning"}),": You are using a picture which is not square. This means the image will get distorted. You should probably crop it to be square."]})]}),e.jsx("div",{children:e.jsxs("label",{children:["Categories:"," ",e.jsx(A,{ref:"categories",layout:"horizontal",options:this.props.categories,onChange:this.changeCategories})]})}),e.jsx("div",{children:e.jsxs("label",{children:["Scale (y):"," ",e.jsx("input",{type:"text",onChange:this.changeScale,defaultValue:this.props.scaleY})]})}),e.jsx("div",{children:e.jsxs("label",{children:["Max y:"," ",e.jsx("input",{type:"text",ref:"maxY",onChange:this.changeMax,defaultValue:this.props.maxY})]})}),t&&e.jsxs("div",{children:[e.jsxs("label",{children:["Snaps per line:"," ",e.jsx("input",{type:"text",onChange:this.changeSnaps,defaultValue:this.props.snapsPerLine})]}),e.jsx(o,{children:e.jsx("p",{children:"Creates the specified number of divisions between the horizontal lines. Fewer snaps between lines makes the graph easier for the student to create correctly."})})]}),e.jsxs("div",{children:["Editing values:"," ",S.map(a=>e.jsxs("label",{children:[e.jsx("input",{type:"radio",disabled:a===m&&this.props.static,checked:this.props.static?a===p:this.state.editing===a,onChange:r=>this.changeEditing(a)}),a]},a)),e.jsxs(o,{children:[e.jsx("p",{children:"Use this toggle to switch between editing the correct answer (what the student will be graded on) and the starting values (what the student will see plotted when they start the problem). Note: These cannot be the same."}),e.jsx("p",{children:"In static mode, the starting values are rendered out to the displayed widget."})]})]}),e.jsx(q,{...i,starting:this.props[this.state.editing],onChange:this.handlePlotterChange})]})}};d.widgetName="plotter",d.defaultProps=x.defaultWidgetOptions;let g=d;g.__docgenInfo={description:"",methods:[{name:"fetchPic",docblock:null,modifiers:[],params:[{name:"url",optional:!1,type:null}],returns:null},{name:"handleChangeTickStep",docblock:null,modifiers:[],params:[{name:"value",optional:!1,type:null}],returns:null},{name:"handleChangeRange",docblock:null,modifiers:[],params:[{name:"newValue",optional:!1,type:null}],returns:null},{name:"changeLabelInterval",docblock:null,modifiers:[],params:[{name:"value",optional:!1,type:null}],returns:null},{name:"handlePlotterChange",docblock:null,modifiers:[],params:[{name:"newProps",optional:!1,type:null}],returns:null},{name:"changeType",docblock:null,modifiers:[],params:[{name:"type",optional:!1,type:null}],returns:null},{name:"changeLabel",docblock:null,modifiers:[],params:[{name:"i",optional:!1,type:null},{name:"e",optional:!1,type:null}],returns:null},{name:"changePicUrl",docblock:null,modifiers:[],params:[{name:"value",optional:!1,type:null}],returns:null},{name:"changeCategories",docblock:null,modifiers:[],params:[{name:"categories",optional:!1,type:null}],returns:null},{name:"changeScale",docblock:null,modifiers:[],params:[{name:"e",optional:!1,type:null}],returns:null},{name:"changeMax",docblock:null,modifiers:[],params:[{name:"e",optional:!1,type:null}],returns:null},{name:"changeSnaps",docblock:null,modifiers:[],params:[{name:"e",optional:!1,type:null}],returns:null},{name:"changeEditing",docblock:null,modifiers:[],params:[{name:"editing",optional:!1,type:null}],returns:null},{name:"setCategoriesFromScale",docblock:null,modifiers:[],params:[],returns:null},{name:"serialize",docblock:null,modifiers:[],params:[],returns:null}],displayName:"PlotterEditor",props:{apiOptions:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
