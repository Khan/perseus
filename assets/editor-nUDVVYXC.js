var w=Object.defineProperty;var v=(l,i,e)=>i in l?w(l,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[i]=e;var r=(l,i,e)=>(v(l,typeof i!="symbol"?i+"":i,e),e);import{j as a}from"./jsx-runtime-BT65X5dW.js";import{_ as s}from"./index-default-BcKQpA1a.js";import{b as p}from"./index-DktHmiAd.js";import{q as k}from"./util-AEEC48XJ.js";import{c as T}from"./all-widgets-DbXhSGpA.js";import"./index-DyG-XbLr.js";import"./answer-choices-By4zjEDp.js";import"./index-gdjMQqRz.js";import{r as f}from"./index-C6mWTJJr.js";import"./index-B1Gws05u.js";import"./i18n-context-CwGtWZ68.js";import"./perseus-api-fTM3z0tF.js";import"./renderer-C1IoSrZC.js";import"./free-response-Dtj1JbM2.js";import"./index-D7h-teXI.js";import"./jquery-CkHB0_Mt.js";import"./dependencies-BsVPGK1s.js";import"./zoomable-tex-Dy-nElJT.js";import"./svg-image-8T6Bqk5w.js";import"./no-important-DlFk8a1I.js";import"./number-input-Bqp2ujXM.js";import"./simple-keypad-input-Bl9QRvgR.js";import"./text-input-BdlNOW-6.js";import"./phet-simulation-DB19JjkO.js";import"./sortable-02mkrIKd.js";import"./fixed-to-responsive-CTsII9Xx.js";import"./math-input-DR_U1ncu.js";import"./video-transcript-link-CkTN7Z-b.js";import"./item-version-Bo-kovBX.js";import"./article-renderer-DQZ_NlRP.js";import"./server-item-renderer-Dl2jhlsm.js";import"./hints-renderer-C62gY8Lh.js";import{B as C}from"./base-radio-Bu4Eqt0j.js";import{c as P}from"./components-D_6o-wmV.js";import{i as q}from"./icon-paths-C3bPmxpL.js";import"./index-Dd-cahjY.js";import{C as c}from"./index-6t7BHVg9.js";import{E as m}from"./editor-C6zq-Vey.js";import{i as g}from"./icon-paths-Cfjy_uoj.js";const{InlineIcon:u}=P;class R extends f.Component{render(){const i=this.props.choice.correct?"correct":"incorrect";let e="Type a choice here...";this.props.choice.isNoneOfTheAbove&&(e=this.props.choice.correct?"Type the answer to reveal to the user...":"None of the above");const t=a.jsx(m,{ref:"content-editor",apiOptions:this.props.apiOptions,content:this.props.choice.content||"",widgetEnabled:!1,placeholder:e,disabled:this.props.choice.isNoneOfTheAbove&&!this.props.choice.correct,onChange:this.props.onContentChange}),n=a.jsx(m,{ref:"clue-editor",apiOptions:this.props.apiOptions,content:this.props.choice.clue||"",widgetEnabled:!1,placeholder:`Why is this choice ${i}?`,onChange:this.props.onClueChange}),o=a.jsx("a",{className:"simple-button orange delete-choice",href:"#",onClick:d=>{d.stopPropagation(),d.preventDefault(),this.props.onDelete()},title:"Remove this choice",children:a.jsx(u,{...q})});return a.jsxs("div",{className:"choice-clue-editors",children:[a.jsx("div",{className:`choice-editor ${i}`,children:t}),a.jsx("div",{className:"clue-editor",children:n}),this.props.showDelete&&o]})}}class h extends f.Component{constructor(){super(...arguments);r(this,"change",(...e)=>T.apply(this,e));r(this,"onMultipleSelectChange",e=>{e=e.multipleSelect;const t=s.reduce(this.props.choices,function(n,o){return o.correct?n+1:n},0);if(!e&&t>1){const n=s.map(this.props.choices,function(o){return s.defaults({correct:!1},o)});this.props.onChange({multipleSelect:e,choices:n})}else this.props.onChange({multipleSelect:e})});r(this,"onCountChoicesChange",e=>{e=e.countChoices,this.props.onChange({countChoices:e})});r(this,"onChange",({checked:e})=>{const t=this.props.choices.map((n,o)=>({...n,correct:e[o],content:n.isNoneOfTheAbove&&!e[o]?"":n.content}));this.props.onChange({choices:t,numCorrect:p({...this.props,choices:t,numCorrect:void 0})})});r(this,"onContentChange",(e,t)=>{const n=this.props.choices.slice();n[e]=s.extend({},n[e],{content:t}),this.props.onChange({choices:n})});r(this,"onDelete",e=>{const t=this.props.choices.slice(),n=t[e];t.splice(e,1),this.props.onChange({choices:t,hasNoneOfTheAbove:this.props.hasNoneOfTheAbove&&!n.isNoneOfTheAbove})});r(this,"addChoice",(e,t)=>{t.preventDefault();const n=this.props.choices.slice(),o={isNoneOfTheAbove:e,content:""},d=n.length-(this.props.hasNoneOfTheAbove?1:0);n.splice(d,0,o),this.props.onChange({choices:n,hasNoneOfTheAbove:e||this.props.hasNoneOfTheAbove},()=>{this.refs[`choice-editor${d}`].refs["content-editor"].focus()})});r(this,"setDisplayCount",e=>{this.props.onChange({displayCount:e})});r(this,"focus",()=>(this.refs["choice-editor0"].refs["content-editor"].focus(),!0));r(this,"getSaveWarnings",()=>s.some(s.pluck(this.props.choices,"correct"))?[]:["No choice is marked as correct."])}onClueChange(e,t){const n=this.props.choices.slice();n[e]=s.extend({},n[e],{clue:t}),t===""&&delete n[e].clue,this.props.onChange({choices:n})}serialize(){const{choices:e,randomize:t,multipleSelect:n,countChoices:o,displayCount:d,hasNoneOfTheAbove:y,deselectEnabled:b}=this.props;return{choices:e,randomize:t,multipleSelect:n,countChoices:o,displayCount:d,hasNoneOfTheAbove:y,deselectEnabled:b,numCorrect:p({...this.props,numCorrect:void 0})}}render(){const e=s.reduce(this.props.choices,function(t,n){return n.correct?t+1:t},0);return a.jsxs("div",{children:[a.jsxs("div",{className:"perseus-widget-row",children:[a.jsx("a",{href:"https://docs.google.com/document/d/1frZf7yrWVWb1n4tVjqlzqVUiv1pn4cZXbxgP62-JDBY/edit#heading=h.8ng1isya19nu",target:"_blank",rel:"noreferrer",children:"Multiple choice style guide"}),a.jsx("br",{}),a.jsx("div",{className:"perseus-widget-left-col",children:a.jsx(c,{label:"Multiple selections",checked:this.props.multipleSelect,onChange:t=>{this.onMultipleSelectChange({multipleSelect:t})}})}),a.jsx("div",{className:"perseus-widget-right-col",children:a.jsx(c,{label:"Randomize order",checked:this.props.randomize,onChange:t=>{this.props.onChange({randomize:t})}})}),this.props.multipleSelect&&a.jsx("div",{className:"perseus-widget-left-col",children:a.jsx(c,{label:"Specify number correct",checked:this.props.countChoices,onChange:t=>{this.onCountChoicesChange({countChoices:t})}})})]}),a.jsx(C,{multipleSelect:this.props.multipleSelect,countChoices:this.props.countChoices,numCorrect:e,editMode:!0,labelWrap:!1,apiOptions:this.props.apiOptions,reviewMode:!1,choices:this.props.choices.map((t,n)=>({content:a.jsx(R,{ref:`choice-editor${n}`,apiOptions:this.props.apiOptions,choice:t,onContentChange:o=>{o.content!=null&&this.onContentChange(n,o.content)},onClueChange:o=>{o.content!=null&&this.onClueChange(n,o.content)},onDelete:()=>this.onDelete(n),showDelete:this.props.choices.length>=2}),isNoneOfTheAbove:t.isNoneOfTheAbove,checked:t.correct}),this),onChange:this.onChange}),a.jsxs("div",{className:"add-choice-container",children:[a.jsxs("a",{className:"simple-button orange",href:"#",onClick:this.addChoice.bind(this,!1),children:[a.jsx(u,{...g})," Add a choice"," "]}),!this.props.hasNoneOfTheAbove&&a.jsxs("a",{className:"simple-button",href:"#",onClick:this.addChoice.bind(this,!0),children:[a.jsx(u,{...g})," None of the above"," "]})]})]})}}r(h,"widgetName","radio"),r(h,"defaultProps",k.defaultWidgetOptions);h.__docgenInfo={description:"",methods:[{name:"change",docblock:null,modifiers:[],params:[{name:"...args",optional:!1,type:null}],returns:null},{name:"onMultipleSelectChange",docblock:null,modifiers:[],params:[{name:"allowMultiple",optional:!1,type:null}],returns:null},{name:"onCountChoicesChange",docblock:null,modifiers:[],params:[{name:"count",optional:!1,type:null}],returns:null},{name:"onChange",docblock:null,modifiers:[],params:[{name:"{checked}",optional:!1,type:null}],returns:null},{name:"onContentChange",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null},{name:"newContent",optional:!1,type:null}],returns:null},{name:"onClueChange",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:{name:"number"}},{name:"newClue",optional:!1,type:{name:"string"}}],returns:{type:{name:"void"}}},{name:"onDelete",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null}],returns:null},{name:"addChoice",docblock:null,modifiers:[],params:[{name:"noneOfTheAbove",optional:!1,type:null},{name:"e",optional:!1,type:null}],returns:null},{name:"setDisplayCount",docblock:null,modifiers:[],params:[{name:"num",optional:!1,type:null}],returns:null},{name:"focus",docblock:null,modifiers:[],params:[],returns:null},{name:"getSaveWarnings",docblock:null,modifiers:[],params:[],returns:null},{name:"serialize",docblock:null,modifiers:[],params:[],returns:{type:{name:"signature",type:"object",raw:`{
