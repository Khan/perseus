import{cU as s,j as B}from"./iframe-C-wjKudE.js";import{S as F}from"./server-item-renderer-with-debug-ui-XQ1UbxGz.js";import{a as u,c as G,S as H,b as J,d as K,m as N,e as V}from"./radio.testdata-NzwFXOAU.js";import"./server-item-renderer-DbBQSC2v.js";import"./hints-renderer-Dxk8feSH.js";import"./main-r_iJmxr-.js";import"./test-keypad-context-wrapper-DsLXonwu.js";import"./Popper-CzCRypv7.js";const ie={title:"Perseus/Widgets/RadioNew",args:{static:!1,startAnswerless:!1,reviewMode:!1,showSolutions:"none",item:s({question:u})},argTypes:{showSolutions:{options:["none","all","selected"],control:{type:"select"}}},render:e=>B.jsx(F,{item:X(e),apiOptions:Y(),reviewMode:e.reviewMode,showSolutions:e.showSolutions,startAnswerless:e.startAnswerless}),parameters:{docs:{description:{component:`This is a story for the new radio widget.
It will replace radio.stories.tsx after the feature flag is no longer needed.

TODO(LEMS-2994): Clean up this file.`}}}},X=e=>{const g={...e.item,question:{...e.item.question,widgets:{}},apiOptions:{flags:{"new-radio-widget":!0}}};for(const[k,z]of Object.entries(e.item.question.widgets))g.question.widgets[k]={...z,static:e.static};return g},Y=e=>({flags:{"new-radio-widget":!0}}),t={args:{item:s({question:u})}},r={args:{item:s({question:G})}},o={args:{item:s({question:H})}},n={args:{item:s({question:J})}},i={args:{item:s({question:K})}},a={args:{item:s({question:N})}},c={args:{item:s({question:V})}},l={args:{item:s({question:u}),startAnswerless:!0}},m={args:{item:s({question:N}),startAnswerless:!0}};var p,S,d;t.parameters={...t.parameters,docs:{...(p=t.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
...
}`,...(R=(E=l.parameters)==null?void 0:E.docs)==null?void 0:R.source}}};var D,U,L;m.parameters={...m.parameters,docs:{...(D=m.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: multiChoiceQuestion
    }),
