import{c3 as O,j as n,aG as T,n as U,y as k,s as c,V as q,r as G,z as J,cG as v,L as Y,e as P,bQ as K}from"./iframe-C7PW0sis.js";import{S as Q,O as S,C as W}from"./color-select-D6FTkYE6.js";import{p as Z}from"./plus-circle-DsgEZe2H.js";import{P as H}from"./perseus-editor-accordion-C1gIZO7M.js";import{L as ee}from"./line-stroke-select-B7G4JZ0N.js";import{L as ne}from"./line-swatch-CEPKNkkj.js";import{L as ae}from"./locked-figure-aria-BJchdu7I.js";import{L as re,a as le}from"./locked-label-settings-CG5lhsLI.js";import{L as A}from"./locked-point-settings-BGE5MPk9.js";import{g as te,j,a as x,b as oe}from"./util-CZ-1dilU.js";const F="The line cannot have length 0.",ie=w=>{const{kind:g,points:d,color:L,lineStyle:f="solid",showPoint1:N,showPoint2:V,labels:t,ariaLabel:X,onChangeProps:l,onMove:_,onRemove:I}=w,[o,i]=d,h=g.charAt(0).toUpperCase()+g.slice(1),M=`${h} (${o.coord[0]},
        ${o.coord[1]}), (${i.coord[0]}, ${i.coord[1]})`,C=O(o.coord,i.coord);async function R(){const e=await j(t),r=await j(o.labels),a=await j(i.labels),m=await x(`$${o.coord[0]}$`),p=await x(`$${o.coord[1]}$`),y=await x(`$${i.coord[0]}$`),b=await x(`$${i.coord[1]}$`);let u;switch(g){case"line":u=`${h}${e} through point${r} at ${m} comma ${p} and point${a} at ${y} comma ${b}`;break;case"ray":u=`${h}${e} from point${r} at ${m} comma ${p} through point${a} at ${y} comma ${b}`;break;case"segment":u=`${h}${e} from point${r} at ${m} comma ${p} to point${a} at ${y} comma ${b}`;break;default:throw new K(g,"Unknown line kind")}const z=oe(L,f);return u+=z,u}function $(e,r){const a=[...d];a[r]={...d[r],...e};const m=v.midpoint(d[0].coord,d[1].coord),p=v.midpoint(a[0].coord,a[1].coord),y=[p[0]-m[0],p[1]-m[1]],b=t.map((u,z)=>({...u,coord:[u.coord[0]+y[0],u.coord[1]+y[1]]}));l({points:a,labels:b})}function B(e){const r=t.map(a=>({...a,color:e}));l({color:e,points:[{...o,color:e,labels:o.labels.map(a=>({...a,color:e}))},{...i,color:e,labels:i.labels.map(a=>({...a,color:e}))}],labels:r})}function E(e,r){const a=[...t];a[r]={...t[r],...e},l({labels:a})}function D(e){const r=t.filter((a,m)=>m!==e);l({labels:r})}return n.jsxs(H,{expanded:w.expanded,onToggle:w.onToggle,header:n.jsxs(q,{style:s.row,children:[n.jsx(Y,{children:M}),n.jsx(k,{size:c.xSmall_8}),n.jsx(ne,{color:L,lineStyle:f})]}),children:[n.jsxs(T,{tag:"label",style:[s.row,s.spaceUnder],children:["kind",n.jsx(k,{size:c.xxxSmall_4}),n.jsxs(Q,{selectedValue:g,onChange:e=>l({kind:e}),placeholder:"",children:[n.jsx(S,{value:"line",label:"line"}),n.jsx(S,{value:"ray",label:"ray"}),n.jsx(S,{value:"segment",label:"segment"})]})]}),n.jsxs(q,{style:s.row,children:[n.jsx(W,{selectedValue:L,onChange:B}),n.jsx(k,{size:c.small_12}),n.jsx(ee,{selectedValue:f,onChange:e=>l({lineStyle:e})})]}),C&&n.jsx(T,{style:s.errorText,children:F}),n.jsx(A,{headerLabel:"Point 1",expanded:!0,showPoint:N,error:C?F:null,...o,onTogglePoint:e=>l({showPoint1:e}),onChangeProps:e=>$(e,0)}),n.jsx(A,{headerLabel:"Point 2",expanded:!0,showPoint:V,error:C?F:null,...i,onTogglePoint:e=>l({showPoint2:e}),onChangeProps:e=>$(e,1)}),n.jsx(k,{size:c.small_12}),n.jsx(q,{style:s.horizontalRule}),n.jsx(ae,{ariaLabel:X,getPrepopulatedAriaLabel:R,onChangeProps:e=>{l(e)}}),n.jsx(k,{size:c.xxxSmall_4}),n.jsx(q,{style:s.horizontalRule}),n.jsx(k,{size:c.small_12}),n.jsx(T,{children:"Visible labels"}),t.map((e,r)=>G.createElement(re,{...e,key:r,expanded:!0,onChangeProps:a=>{E(a,r)},onRemove:()=>{D(r)},containerStyle:s.labelContainer})),n.jsx(J,{kind:"tertiary",startIcon:Z,onClick:()=>{const e=[0,-1],r=v.add(v.scale(e,t.length),v.midpoint(d[0].coord,d[1].coord)),a={...te("label"),coord:r,color:L};l({labels:[...t,a]})},style:s.addButton,children:"Add visible label"}),n.jsx(le,{figureType:w.type,onMove:_,onRemove:I})]})},s=U.StyleSheet.create({row:{display:"flex",flexDirection:"row",alignItems:"center"},spaceUnder:{marginBottom:c.xSmall_8},errorText:{color:P.red},addButton:{alignSelf:"start"},horizontalRule:{height:1,backgroundColor:P.offBlack16},labelContainer:{backgroundColor:P.white}});ie.__docgenInfo={description:"",methods:[],displayName:"LockedLineSettings",props:{type:{required:!0,tsType:{name:"literal",value:'"line"'},description:""},kind:{required:!0,tsType:{name:"union",raw:'"line" | "ray" | "segment"',elements:[{name:"literal",value:'"line"'},{name:"literal",value:'"ray"'},{name:"literal",value:'"segment"'}]},description:""},points:{required:!0,tsType:{name:"tuple",raw:"[point1: LockedPointType, point2: LockedPointType]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},color:{required:!0,tsType:{name:"unknown[number]",raw:"(typeof lockedFigureColorNames)[number]"},description:""},lineStyle:{required:!0,tsType:{name:"union",raw:'"solid" | "dashed"',elements:[{name:"literal",value:'"solid"'},{name:"literal",value:'"dashed"'}]},description:""},showPoint1:{required:!0,tsType:{name:"boolean"},description:""},showPoint2:{required:!0,tsType:{name:"boolean"},description:""},labels:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    type: "label";
    coord: Coord;
