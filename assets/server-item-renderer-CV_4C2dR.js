var b=Object.defineProperty;var f=(s,i,e)=>i in s?b(s,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[i]=e;var a=(s,i,e)=>(f(s,typeof i!="symbol"?i+"":i,e),e);import{y as v}from"./core-widget-registry-CDAZ8ZOy.js";import{w as k}from"./all-widgets-ajMKWVys.js";import{r as q,g as R,l as A,R as P,p as y}from"./renderer-B7o_Dw9e.js";import{j as o}from"./jsx-runtime-BT65X5dW.js";import{n as c}from"./no-important-DlFk8a1I.js";import{r as g}from"./index-C6mWTJJr.js";import{_ as p}from"./underscore-U-AHniOr.js";import{c as I}from"./zoomable-tex-Dy-nElJT.js";import{a as T}from"./i18n-context-3AkWzTTj.js";import{D as C}from"./dependencies-BsVPGK1s.js";import{H as x}from"./hints-renderer-CZ-9M_6R.js";import{A as S}from"./perseus-api-Ty_QvlNi.js";import{U as j}from"./util-CDUz5xj6.js";const N="@khanacademy/perseus",O="__lib_version__";v(N,O);const F={major:0,minor:1};q(k);const D=R();D["::renderer::"]=F;const W={onRendered:s=>{}},M=g.createContext(W);class d extends g.Component{constructor(e){super(e);a(this,"questionRenderer");a(this,"hintsRenderer");a(this,"_currentFocus");a(this,"_fullyRendered");a(this,"blurTimeoutID");a(this,"_handleFocusChange",(e,t)=>{e!=null?this._setCurrentFocus(e):this._onRendererBlur(t)});a(this,"handleInteractWithWidget",e=>{var n,r;const t=p.difference(this.state.questionHighlightedWidgets,[e]);this.setState({questionCompleted:!1,questionHighlightedWidgets:t}),(r=(n=this.props.apiOptions)==null?void 0:n.interactionCallback)==null||r.call(n,this.questionRenderer.getUserInputMap())});a(this,"setAssetStatus",(e,t)=>{const n={...this.state.assetStatuses,[e]:t};this.setState({assetStatuses:n})});this.state={questionCompleted:!1,questionHighlightedWidgets:[],assetStatuses:{}},this._fullyRendered=!1}componentDidMount(){this._currentFocus=null,this._fullyRendered=!1}UNSAFE_componentWillReceiveProps(e){this.setState({questionHighlightedWidgets:[]})}componentDidUpdate(e,t){const n=this.props.apiOptions.answerableCallback;if(n!=null){const r=this.questionRenderer.emptyWidgets().length===0;n(r)}if(this._fullyRendered||Object.values(this.state.assetStatuses).every(Boolean)&&(this._fullyRendered=!0,this.props.onRendered(!0)),this.props.score&&this.props.score!==e.score){const r=this.questionRenderer.emptyWidgets();this.setState({questionCompleted:this.props.score.correct,questionHighlightedWidgets:r})}}componentWillUnmount(){this.blurTimeoutID!=null&&(clearTimeout(this.blurTimeoutID),this.blurTimeoutID=null)}_setCurrentFocus(e){const{apiOptions:{isMobile:t,onFocusChange:n},keypadElement:r}=this.props,u=this._currentFocus;this._currentFocus=e;const h=this.getInputPaths(),m=this._currentFocus&&h.some(l=>j.inputPathsEqual(l,this._currentFocus));n!=null&&setTimeout(()=>{const l=r==null?void 0:r.getDOMNode(),w=l&&m?l.getBoundingClientRect().height:0;n(this._currentFocus,u,w,m&&this.questionRenderer.getDOMNodeForPath(e))},0),r&&t&&(m?r.activate():r.dismiss())}_onRendererBlur(e){const t=this._currentFocus;p.isEqual(e,t)&&(this.blurTimeoutID=setTimeout(()=>{p.isEqual(this._currentFocus,t)&&this._setCurrentFocus(null)},0))}_setWidgetProps(e,t,n){this.questionRenderer._setWidgetProps(e,t,n)}setInputValue(e,t,n){return this.questionRenderer.setInputValue(e,t,n)}focusPath(e){return this.questionRenderer.focusPath(e)}blurPath(e){return this.questionRenderer.blurPath(e)}getDOMNodeForPath(e){return this.questionRenderer.getDOMNodeForPath(e)}getInputPaths(){return this.questionRenderer.getInputPaths()}focus(){return this.questionRenderer.focus()}blur(){this._currentFocus&&this.blurPath(this._currentFocus)}getNumHints(){return this.props.item.hints.length}getPromptJSON(){return this.questionRenderer.getPromptJSON()}getUserInputLegacy(){return this.questionRenderer.getUserInput()}getUserInput(){return this.questionRenderer.getUserInputMap()}getWidgetIds(){return this.questionRenderer.getWidgetIds()}getSerializedState(){return{question:this.questionRenderer.getSerializedState(),hints:this.hintsRenderer.getSerializedState()}}restoreSerializedState(e,t){let n=2;const r=()=>{--n,t&&n===0&&t()};this.questionRenderer.restoreSerializedState(e.question,r),this.hintsRenderer.restoreSerializedState(e.hints,r)}showRationalesForCurrentlySelectedChoices(){this.questionRenderer.showRationalesForCurrentlySelectedChoices()}deselectIncorrectSelectedChoices(){this.questionRenderer.deselectIncorrectSelectedChoices()}render(){const e={...S.defaults,...this.props.apiOptions,onFocusChange:this._handleFocusChange},t={assetStatuses:this.state.assetStatuses,setAssetStatus:this.setAssetStatus},n=o.jsx(I.Provider,{value:t,children:o.jsx(P,{keypadElement:this.props.keypadElement,problemNum:this.props.problemNum,onInteractWithWidget:this.handleInteractWithWidget,highlightedWidgets:this.state.questionHighlightedWidgets,apiOptions:e,questionCompleted:this.state.questionCompleted,reviewMode:this.props.reviewMode,showSolutions:this.props.showSolutions,ref:u=>{u!=null&&(this.questionRenderer=u)},content:this.props.item.question.content,widgets:this.props.item.question.widgets,images:this.props.item.question.images,linterContext:y(this.props.linterContext,"question"),strings:this.context.strings,...this.props.dependencies})}),r=o.jsx(x,{hints:this.props.item.hints,hintsVisible:this.props.hintsVisible,apiOptions:e,ref:u=>this.hintsRenderer=u,linterContext:y(this.props.linterContext,"hints"),strings:this.context.strings});return o.jsx(C.Provider,{value:this.props.dependencies,children:o.jsxs("div",{children:[o.jsx("div",{children:n}),o.jsx("div",{className:e.isMobile?void 0:c.css(U.hintsContainer),children:r})]})})}}a(d,"contextType",T),a(d,"defaultProps",{apiOptions:{},linterContext:A,onRendered:e=>{}});const U=c.StyleSheet.create({hintsContainer:{marginLeft:50}}),E=g.forwardRef((s,i)=>o.jsx(M.Consumer,{children:({onRendered:e})=>o.jsx(d,{...s,onRendered:e,ref:i})}));d.__docgenInfo={description:"",methods:[{name:"_handleFocusChange",docblock:null,modifiers:[],params:[{name:"newFocus",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}},{name:"oldFocus",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"_setCurrentFocus",docblock:null,modifiers:[],params:[{name:"newFocus",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"_onRendererBlur",docblock:null,modifiers:[],params:[{name:"blurPath",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"_setWidgetProps",docblock:`Accepts a question area widgetId, or an answer area widgetId of
...
}`,computed:!1},required:!1},onRendered:{defaultValue:{value:"(isRendered: boolean) => {}",computed:!1},required:!1}}};E.__docgenInfo={description:"",methods:[],displayName:"ref"};export{d as S,F as i,E as r};
