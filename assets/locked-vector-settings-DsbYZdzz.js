import{c2 as X,j as e,V as d,n as M,aF as F,L as h,y as g,s as u,r as R,z as I,cF as s,e as b}from"./iframe-CQulAyj4.js";import{p as B}from"./plus-circle-DsgEZe2H.js";import{C as j,L as E,a as D}from"./locked-label-settings-Be4tns3Y.js";import{P as x}from"./perseus-editor-accordion-C7a69MEy.js";import{C as J}from"./color-select-Cj4pSvu5.js";import{L as O}from"./line-swatch-C9uXrkjD.js";import{L as Y}from"./locked-figure-aria-DGvSQblV.js";import{g as U,j as W,a as v,b as G}from"./util-BBrYuiGM.js";const H="The vector cannot have length 0.",K=p=>{const{points:f,color:y,labels:i,ariaLabel:S,onChangeProps:m,onMove:P,onRemove:z}=p,[t,o]=f,$=`Vector (${t[0]}, ${t[1]}), (${o[0]}, ${o[1]})`,w=X(t,o);async function A(){const n=await W(i),r=await v(`$${t[0]}$`),a=await v(`$${t[1]}$`),c=await v(`$${o[0]}$`),L=await v(`$${o[1]}$`);let k=`Vector${n} from ${r} comma ${a} to ${c} comma ${L}`;const q=G(y);return k+=q,k}function C(n,r){if(typeof n<"u"){const a=[...f];a[r]=[...n];const c=s.midpoint(t,o),L=s.midpoint(a[0],a[1]),k=s.sub(L,c),q=i.map(T=>({...T,coord:s.add(T.coord,k)}));m({points:a,labels:q})}}function N(n){const r={color:n};r.labels=i.map(a=>({...a,color:n})),m(r)}function V(n,r){const a=[...i];a[r]={...i[r],...n},m({labels:a})}function _(n){const r=i.filter((a,c)=>c!==n);m({labels:r})}return e.jsxs(x,{expanded:p.expanded,onToggle:p.onToggle,header:e.jsxs(d,{style:l.row,children:[e.jsx(h,{children:$}),e.jsx(g,{size:u.xSmall_8}),e.jsx(O,{color:y,lineStyle:"solid"})]}),children:[e.jsx(d,{style:[l.row,l.spaceUnder],children:e.jsx(J,{selectedValue:y,onChange:N})}),w&&e.jsx(F,{style:l.errorText,children:H}),e.jsx(x,{expanded:!0,containerStyle:l.container,panelStyle:l.accordionPanel,header:e.jsx(d,{style:l.row,children:e.jsx(h,{children:`Tail (${t[0]}, ${t[1]})`})}),children:e.jsx(j,{coord:t,error:w,onChange:n=>{C(n,0)}})}),e.jsx(x,{expanded:!0,containerStyle:l.container,panelStyle:l.accordionPanel,header:e.jsx(d,{style:l.row,children:e.jsx(h,{children:`Tip (${o[0]}, ${o[1]})`})}),children:e.jsx(j,{coord:o,error:w,onChange:n=>{C(n,1)}})}),e.jsx(g,{size:u.small_12}),e.jsx(d,{style:l.horizontalRule}),e.jsx(Y,{ariaLabel:S,getPrepopulatedAriaLabel:A,onChangeProps:n=>{m(n)}}),e.jsx(g,{size:u.xxxSmall_4}),e.jsx(d,{style:l.horizontalRule}),e.jsx(g,{size:u.small_12}),e.jsx(F,{children:"Visible labels"}),i.map((n,r)=>R.createElement(E,{...n,key:r,expanded:!0,onChangeProps:a=>{V(a,r)},onRemove:()=>{_(r)},containerStyle:l.labelContainer})),e.jsx(I,{kind:"tertiary",startIcon:B,onClick:()=>{const n=[0,-1],r=s.add(s.scale(n,i.length),s.midpoint(t,o)),a={...U("label"),coord:r,color:y};m({labels:[...i,a]})},style:l.addButton,children:"Add visible label"}),e.jsx(D,{figureType:p.type,onMove:P,onRemove:z})]})},l=M.StyleSheet.create({accordionPanel:{paddingBottom:u.medium_16},container:{marginTop:u.xSmall_8,marginBottom:0,marginLeft:-u.xxxSmall_4,marginRight:-u.xxxSmall_4,backgroundColor:b.white},errorText:{color:b.red,marginTop:u.xSmall_8},row:{flexDirection:"row",alignItems:"center"},addButton:{alignSelf:"start"},horizontalRule:{height:1,backgroundColor:b.offBlack16},labelContainer:{backgroundColor:b.white}});K.__docgenInfo={description:"",methods:[],displayName:"LockedVectorSettings",props:{type:{required:!0,tsType:{name:"literal",value:'"vector"'},description:""},points:{required:!0,tsType:{name:"tuple",raw:"[tail: Coord, tip: Coord]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},color:{required:!0,tsType:{name:"unknown[number]",raw:"(typeof lockedFigureColorNames)[number]"},description:""},labels:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    type: "label";
    coord: Coord;
