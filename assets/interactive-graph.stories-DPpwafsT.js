...
}`,...(Se=(fe=j.parameters)==null?void 0:fe.docs)==null?void 0:Se.source}}};var qe,we,Ie;P.parameters={...P.parameters,docs:{...(qe=P.parameters)==null?void 0:qe.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: linearQuestion
    })
  }
}`,...(Ie=(we=P.parameters)==null?void 0:we.docs)==null?void 0:Ie.source}}};var ke,je,Pe;L.parameters={...L.parameters,docs:{...(ke=L.parameters)==null?void 0:ke.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: linearSystemQuestion
    })
  }
}`,...(Pe=(je=L.parameters)==null?void 0:je.docs)==null?void 0:Pe.source}}};var Le,Ae,Te;A.parameters={...A.parameters,docs:{...(Le=A.parameters)==null?void 0:Le.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: pointQuestion
    })
  }
}`,...(Te=(Ae=A.parameters)==null?void 0:Ae.docs)==null?void 0:Te.source}}};var be,Qe,ve;T.parameters={...T.parameters,docs:{...(be=T.parameters)==null?void 0:be.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: polygonQuestion
    })
  }
}`,...(ve=(Qe=T.parameters)==null?void 0:Qe.docs)==null?void 0:ve.source}}};var We,Ce,Re;b.parameters={...b.parameters,docs:{...(We=b.parameters)==null?void 0:We.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: unlimitedPolygonQuestion
    })
  }
}`,...(Re=(Ce=b.parameters)==null?void 0:Ce.docs)==null?void 0:Re.source}}};var Oe,_e,Ne;Q.parameters={...Q.parameters,docs:{...(Oe=Q.parameters)==null?void 0:Oe.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: rayQuestion
    })
  }
}`,...(Ne=(_e=Q.parameters)==null?void 0:_e.docs)==null?void 0:Ne.source}}};var Be,Fe,Ee;v.parameters={...v.parameters,docs:{...(Be=v.parameters)==null?void 0:Be.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentQuestion
    })
  }
}`,...(Ee=(Fe=v.parameters)==null?void 0:Fe.docs)==null?void 0:Ee.source}}};var Ve,Ge,De;W.parameters={...W.parameters,docs:{...(Ve=W.parameters)==null?void 0:Ve.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: sinusoidQuestion
    })
  }
}`,...(De=(Ge=W.parameters)==null?void 0:Ge.docs)==null?void 0:De.source}}};var Ue,Je,ze;C.parameters={...C.parameters,docs:{...(Ue=C.parameters)==null?void 0:Ue.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentWithLockedPointsQuestion
    })
  }
}`,...(ze=(Je=C.parameters)==null?void 0:Je.docs)==null?void 0:ze.source}}};var He,Me,$e;R.parameters={...R.parameters,docs:{...(He=R.parameters)==null?void 0:He.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentWithLockedLineQuestion
    })
  }
}`,...($e=(Me=R.parameters)==null?void 0:Me.docs)==null?void 0:$e.source}}};var Ke,Ye,Ze;O.parameters={...O.parameters,docs:{...(Ke=O.parameters)==null?void 0:Ke.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentWithAllLockedLineSegmentVariations
    })
  }
}`,...(Ze=(Ye=O.parameters)==null?void 0:Ye.docs)==null?void 0:Ze.source}}};var Xe,es,ss;_.parameters={..._.parameters,docs:{...(Xe=_.parameters)==null?void 0:Xe.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentWithAllLockedLineVariations
    })
  }
}`,...(ss=(es=_.parameters)==null?void 0:es.docs)==null?void 0:ss.source}}};var ts,ns,rs;N.parameters={...N.parameters,docs:{...(ts=N.parameters)==null?void 0:ts.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentWithAllLockedRayVariations
    })
  }
}`,...(rs=(ns=N.parameters)==null?void 0:ns.docs)==null?void 0:rs.source}}};var os,as,is;B.parameters={...B.parameters,docs:{...(os=B.parameters)==null?void 0:os.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentWithLockedVectors
    })
  }
}`,...(is=(as=B.parameters)==null?void 0:as.docs)==null?void 0:is.source}}};var cs,us,ls;F.parameters={...F.parameters,docs:{...(cs=F.parameters)==null?void 0:cs.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentWithLockedEllipses
    })
  }
}`,...(ls=(us=F.parameters)==null?void 0:us.docs)==null?void 0:ls.source}}};var ms,ds,ps;E.parameters={...E.parameters,docs:{...(ms=E.parameters)==null?void 0:ms.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentWithLockedPolygons
    })
  }
}`,...(ps=(ds=E.parameters)==null?void 0:ds.docs)==null?void 0:ps.source}}};var gs,hs,xs;V.parameters={...V.parameters,docs:{...(gs=V.parameters)==null?void 0:gs.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentWithLockedLabels
    })
  }
}`,...(xs=(hs=V.parameters)==null?void 0:hs.docs)==null?void 0:xs.source}}};var ys,fs,Ss,qs,ws;y.parameters={...y.parameters,docs:{...(ys=y.parameters)==null?void 0:ys.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: polygonQuestion
    }),
...
}`,...(Ss=(fs=y.parameters)==null?void 0:fs.docs)==null?void 0:Ss.source},description:{story:"Read only mode appears after a question is answered.",...(ws=(qs=y.parameters)==null?void 0:qs.docs)==null?void 0:ws.description}}};var Is,ks,js,Ps,Ls;f.parameters={...f.parameters,docs:{...(Is=f.parameters)==null?void 0:Is.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
...
makes the graph non-interactive. This is generally used for hints.`,...(Ls=(Ps=f.parameters)==null?void 0:Ps.docs)==null?void 0:Ls.description}}};var As,Ts,bs;G.parameters={...G.parameters,docs:{...(As=G.parameters)==null?void 0:As.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: staticGraphQuestionWithAnotherWidget()
    })
  }
}`,...(bs=(Ts=G.parameters)==null?void 0:Ts.docs)==null?void 0:bs.source}}};var Qs,vs,Ws;D.parameters={...D.parameters,docs:{...(Qs=D.parameters)==null?void 0:Qs.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: floatingPointIssueQuestion
    })
  }
}`,...(Ws=(vs=D.parameters)==null?void 0:vs.docs)==null?void 0:Ws.source}}};var Cs,Rs,Os;U.parameters={...U.parameters,docs:{...(Cs=U.parameters)==null?void 0:Cs.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: angleQuestion
    })
  }
}`,...(Os=(Rs=U.parameters)==null?void 0:Rs.docs)==null?void 0:Os.source}}};var _s,Ns,Bs;J.parameters={...J.parameters,docs:{...(_s=J.parameters)==null?void 0:_s.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: circleQuestion
    }),
...
}`,...(Bs=(Ns=J.parameters)==null?void 0:Ns.docs)==null?void 0:Bs.source}}};var Fs,Es,Vs;z.parameters={...z.parameters,docs:{...(Fs=z.parameters)==null?void 0:Fs.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: linearQuestion
    }),
...
}`,...(Vs=(Es=z.parameters)==null?void 0:Es.docs)==null?void 0:Vs.source}}};var Gs,Ds,Us;H.parameters={...H.parameters,docs:{...(Gs=H.parameters)==null?void 0:Gs.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: linearSystemQuestion
    }),
...
}`,...(Us=(Ds=H.parameters)==null?void 0:Ds.docs)==null?void 0:Us.source}}};var Js,zs,Hs;M.parameters={...M.parameters,docs:{...(Js=M.parameters)==null?void 0:Js.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: pointQuestion
    }),
...
}`,...(Hs=(zs=M.parameters)==null?void 0:zs.docs)==null?void 0:Hs.source}}};var Ms,$s,Ks;$.parameters={...$.parameters,docs:{...(Ms=$.parameters)==null?void 0:Ms.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: polygonQuestion
    }),
...
}`,...(ct=(it=X.parameters)==null?void 0:it.docs)==null?void 0:ct.source}}};const Rn=["Angle","SideBySideFlipbook","Circle","Linear","LinearSystem","Point","Polygon","UnlimitedPolygon","Ray","Segment","Sinusoid","LockedPoints","LockedLines","AllLockedLineSegmentStyles","AllLockedLineStyles","AllLockedRayStyles","LockedVector","LockedEllipse","LockedPolygon","LockedLabel","PolygonReadOnly","StaticGraph","StaticGraphWithAnotherWidget","TooltipsWithFloatingPointIssues","AnswerlessAngle","AnswerlessCircle","AnswerlessLinear","AnswerlessLinearSystem","AnswerlessPoint","AnswerlessPolygon","AnswerlessUnlimitedPolygon","AnswerlessRay","AnswerlessSegment","AnswerlessSinusoid"];export{O as AllLockedLineSegmentStyles,_ as AllLockedLineStyles,N as AllLockedRayStyles,k as Angle,U as AnswerlessAngle,J as AnswerlessCircle,z as AnswerlessLinear,H as AnswerlessLinearSystem,M as AnswerlessPoint,$ as AnswerlessPolygon,Y as AnswerlessRay,Z as AnswerlessSegment,X as AnswerlessSinusoid,K as AnswerlessUnlimitedPolygon,j as Circle,P as Linear,L as LinearSystem,F as LockedEllipse,V as LockedLabel,R as LockedLines,C as LockedPoints,E as LockedPolygon,B as LockedVector,A as Point,T as Polygon,y as PolygonReadOnly,Q as Ray,v as Segment,S as SideBySideFlipbook,W as Sinusoid,f as StaticGraph,G as StaticGraphWithAnotherWidget,D as TooltipsWithFloatingPointIssues,b as UnlimitedPolygon,Rn as __namedExportsOrder,Cn as default};
