...
}`,...(G=(_=u.parameters)==null?void 0:_.docs)==null?void 0:G.source}}};var K,U,j;g.parameters={...g.parameters,docs:{...(K=g.parameters)==null?void 0:K.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentWithLockedFunction("tan(x)")
    })
  }
}`,...(j=(U=g.parameters)==null?void 0:U.docs)==null?void 0:j.source}}};var w,z,H;d.parameters={...d.parameters,docs:{...(w=d.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentWithLockedFunction("arctan(x)")
    })
  }
}`,...(H=(z=d.parameters)==null?void 0:z.docs)==null?void 0:H.source}}};var J,N,X;p.parameters={...p.parameters,docs:{...(J=p.parameters)==null?void 0:J.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
