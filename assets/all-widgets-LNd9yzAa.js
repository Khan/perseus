...
viewport) is hovering over this highlight.`}],displayName:"HighlightRenderer",props:{highlight:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    ...
    belowContent: number;
}`,signature:{properties:[{key:"belowContent",value:{name:"number",required:!0}}]}},description:""}}};class Dr extends o.PureComponent{_getFocusRect(){const{focusNode:e,focusOffset:t,offsetParent:r}=this.props,a=document.createRange();a.setStart(e,t),a.setEnd(e,t);const i=a.getClientRects()[0];if(!i)return Ai.log('[Highlighting] Known bug: Could not determine the focus position, so did not show an "Add Highlight" tooltip. https://app.asana.com/0/329800276300868/413878480039713 (see also /r/asana-links)'),null;const{left:s,top:l}=r.getBoundingClientRect();return Di({left:i.left,top:i.top,width:i.width,height:i.height},{left:s,top:l})}render(){const e=this._getFocusRect();if(!e)return null;const t=o.createElement("div",{className:T.css(vu.tooltipLabel),onClick:this.props.onClick},this.props.label),r={position:"absolute",left:e.left,top:`calc(${Math.round(e.top)}px + 0.95em)`,height:0};return o.createElement("div",{style:r,onMouseEnter:this.props.onMouseEnter,onMouseLeave:this.props.onMouseLeave},o.createElement(Rr,{content:t,opened:!0},o.createElement("div",null)))}}const vu=T.StyleSheet.create({tooltipLabel:{userSelect:"none",fontFamily:'"Lato", sans-serif',padding:`10px ${de.medium_16}px`,cursor:"pointer"}});Dr.__docgenInfo={description:"",methods:[{name:"_getFocusRect",docblock:null,modifiers:[],params:[],returns:{type:{name:"union",raw:"Rect | null | undefined",elements:[{name:"intersection",raw:`Position & {
    width: number;
    height: number;
}`,elements:[{name:"signature",type:"object",raw:`{
    left: number;
...
| "video"`,elements:[{name:"literal",value:'"cs-program"'},{name:"literal",value:'"iframe"'},{name:"literal",value:'"interaction"'},{name:"literal",value:'"interactive-graph-unsupported"'},{name:"literal",value:'"measurer"'},{name:"literal",value:'"phet-simulation"'},{name:"literal",value:'"plotter"'},{name:"literal",value:'"python-program"'},{name:"literal",value:'"video"'}],required:!0}},{key:"message",value:{name:"string",required:!1}},{key:"isSupported",value:{name:"boolean",required:!0}}]}}],required:!0}}]},required:!0}}]}},{name:"string"}],required:!0}}]}}]}}},{name:"setInputValue",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:null},{name:"newValue",optional:!1,type:null},{name:"cb",optional:!1,type:null}],returns:null},{name:"focus",docblock:null,modifiers:[],params:[],returns:null},{name:"focusInputPath",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:null}],returns:null},{name:"blurInputPath",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:null}],returns:null}],displayName:"GradedGroup",props:{title:{defaultValue:{value:'""',computed:!1},required:!1},content:{defaultValue:{value:'""',computed:!1},required:!1},widgets:{defaultValue:{value:"{}",computed:!1},required:!1},images:{defaultValue:{value:"{}",computed:!1},required:!1},hint:{defaultValue:{value:"null",computed:!1},required:!1},hasHint:{defaultValue:{value:"false",computed:!1},required:!1},linterContext:{defaultValue:{value:`{
    ...
    point2X: string;
    point2Y: string;
}`,signature:{properties:[{key:"point1X",value:{name:"string",required:!0}},{key:"point1Y",value:{name:"string",required:!0}},{key:"point2X",value:{name:"string",required:!0}},{key:"point2Y",value:{name:"string",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}}]},required:!0}},{key:"locale",value:{name:"string",required:!0}}]}},description:""}}};const Qn=10,He=14,Zd=({y:n,range:e,tickStep:t,showPi:r})=>{let a=0;e[q][ce]>0&&(a=e[q][ce]),e[q][me]<0&&(a=e[q][me]);const i=[a,n],[[s,l]]=Q(i),u=s-Qn/2,d=l,m=s+Qn/2,p=l,c=e[q][me]<=0?He*1.5:-He*1.1,g=s+c,y=l+He*.25,w=nm(n,e,t),v=r?so(n):n.toString();return o.createElement("g",{className:"tick","aria-hidden":!0},o.createElement("line",{x1:u,y1:d,x2:m,y2:p,className:"axis-tick"}),w&&o.createElement("text",{className:"axis-tick-label",style:{fontSize:He},textAnchor:"end",x:g,y},v))},em=({x:n,range:e,showPi:t})=>{let r=0;e[C][ce]>0&&(r=e[C][ce]),e[C][me]<0&&(r=e[C][me]);const a=[n,r],[[i,s]]=Q(a),l=i,u=s+Qn/2,d=i,m=s-Qn/2,p=e[C][me]<0?-He:He*1.75,c=n<0?-2:0,g=i+c,y=s+p,w=t?so(n):n.toString();return o.createElement("g",{className:"tick","aria-hidden":!0},o.createElement("line",{x1:l,y1:u,x2:d,y2:m,className:"axis-tick"}),o.createElement("text",{className:"axis-tick-label",style:{fontSize:He},textAnchor:"middle",x:g,y},w))},nm=(n,e,t)=>{let r=!0;return e[q][ce]<-t&&e[q][me]>0&&n===-t&&(r=!1),r};function Ya(n,e,t){const r=[],a=tm(n),i=Math.max(e,0);for(let l=i+n;l<t;l+=n)r.push(parseFloat(l.toFixed(a)));let s=Math.min(t,0)-n;for(s;s>e;s-=n)r.push(s);return r}const tm=n=>{const e=n.toString();return e.includes(".")?e.split(".")[1].length:0};function so(n){const e=n/Math.PI;switch(e){case 1:return"π";case-1:return"-π";case 0:return"0";default:return e+"π"}}const lo=()=>{const{tickStep:n,range:e}=X(),[[t,r],[a,i]]=e,[s,l]=n,u=Ya(l,a,i),d=Ya(s,t,r);return o.createElement("g",{className:"axis-ticks",role:"presentation"},o.createElement("g",{className:"y-axis-ticks"},u.map(m=>o.createElement(Zd,{y:m,key:`y-grid-tick-${m}`,range:e,tickStep:n[C],showPi:n[C]%Math.PI===0}))),o.createElement("g",{className:"x-axis-ticks"},d.map(m=>o.createElement(em,{x:m,key:`x-grid-tick-${m}`,range:e,showPi:n[q]%Math.PI===0}))))};lo.__docgenInfo={description:"",methods:[],displayName:"AxisTicks"};const za=(n,e)=>{const t=n.markings==="axes"?!1:n.gridStep[e];return{axis:n.markings==="graph"||n.markings==="axes",lines:t,labels:!1}},uo=n=>n.markings==="none"?null:o.createElement(Il.Cartesian,{xAxis:za(n,q),yAxis:za(n,C)});uo.__docgenInfo={description:"",methods:[],displayName:"Grid",props:{gridStep:{required:!0,tsType:{name:"vec.Vector2"},description:""},range:{required:!0,tsType:{name:"tuple",raw:`[
    x: [min: number, max: number],
    y: [min: number, max: number],
]`,elements:[{name:"unknown"},{name:"unknown"}]},description:""},containerSizeClass:{required:!0,tsType:{name:"unknown[union]",raw:"(typeof containerSizeClass)[keyof typeof containerSizeClass]"},description:""},markings:{required:!0,tsType:{name:"union",raw:'"axes" | "graph" | "grid" | "none"',elements:[{name:"literal",value:'"axes"'},{name:"literal",value:'"graph"'},{name:"literal",value:'"grid"'},{name:"literal",value:'"none"'}]},description:""},width:{required:!0,tsType:{name:"number"},description:""},height:{required:!0,tsType:{name:"number"},description:""}}};const mo=({box:n,backgroundImage:e})=>{const{url:t,width:r,height:a}=e??{};if(t&&typeof t=="string"){const i=n[q]/Ri.defaultBoxSize;return o.createElement(_,{style:{position:"absolute",bottom:0,left:0}},o.createElement(Sr.Consumer,null,({setAssetStatus:s})=>o.createElement(In,{src:t,width:r,height:a,scale:i,responsive:!1,setAssetStatus:s,alt:""})))}return null};mo.__docgenInfo={description:"If a graphie URL is provided in `backgroundImage`, will return the rendered graphie background.\nOtherwise, returns `null`.",methods:[],displayName:"LegacyGrid",props:{box:{required:!0,tsType:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},description:""},backgroundImage:{required:!1,tsType:{name:"signature",type:"object",raw:`{
...
}`,signature:{properties:[{key:"type",value:{name:"literal",value:'"label"',required:!0}},{key:"coord",value:{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}],required:!0}},{key:"text",value:{name:"string",required:!0}},{key:"color",value:{name:"unknown[number]",raw:"(typeof lockedFigureColorNames)[number]",required:!0}},{key:"size",value:{name:"union",raw:'"small" | "medium" | "large"',elements:[{name:"literal",value:'"small"'},{name:"literal",value:'"medium"'},{name:"literal",value:'"large"'}],required:!0}}]}}],raw:"LockedLabelType[]"},description:""},ariaLabel:{required:!1,tsType:{name:"string"},description:""}}};const po=n=>{const[e,t]=o.useState(),{color:r,strokeStyle:a,directionalAxis:i,domain:s}=n,l={color:ee[r],style:a,domain:s},u=!!n.ariaLabel;return o.useEffect(()=>{t(kt(n.equation).expr)},[n.equation]),typeof e>"u"?null:o.createElement("g",{className:"locked-function","aria-label":u?n.ariaLabel:void 0,"aria-hidden":!u,role:"img"},i==="x"&&o.createElement($n.OfX,{y:d=>e.eval({x:d}),...l}),i==="y"&&o.createElement($n.OfY,{x:d=>e.eval({y:d}),...l}))};po.__docgenInfo={description:"",methods:[],displayName:"LockedFunction",props:{type:{required:!0,tsType:{name:"literal",value:'"function"'},description:""},color:{required:!0,tsType:{name:"unknown[number]",raw:"(typeof lockedFigureColorNames)[number]"},description:""},strokeStyle:{required:!0,tsType:{name:"union",raw:'"solid" | "dashed"',elements:[{name:"literal",value:'"solid"'},{name:"literal",value:'"dashed"'}]},description:""},equation:{required:!0,tsType:{name:"string"},description:"This is the user-defined equation (as it was typed)"},directionalAxis:{required:!0,tsType:{name:"union",raw:'"x" | "y"',elements:[{name:"literal",value:'"x"'},{name:"literal",value:'"y"'}]},description:"The independent variable of this function"},domain:{required:!0,tsType:{name:"tuple",raw:"[min: number, max: number]",elements:[{name:"unknown"},{name:"unknown"}]},description:"The minimum and maximum values along the `directionalAxis` at which\nthis function should be graphed. Values of -Infinity and Infinity are\nallowed. Note that infinite values are serialized as `null` in JSON."},labels:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    type: "label";
    coord: Coord;
    // TeX-supported string
    text: string;
    ...
    color: LockedFigureColor;
    size: "small" | "medium" | "large";
}`,signature:{properties:[{key:"type",value:{name:"literal",value:'"label"',required:!0}},{key:"coord",value:{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}],required:!0}},{key:"text",value:{name:"string",required:!0}},{key:"color",value:{name:"unknown[number]",raw:"(typeof lockedFigureColorNames)[number]",required:!0}},{key:"size",value:{name:"union",raw:'"small" | "medium" | "large"',elements:[{name:"literal",value:'"small"'},{name:"literal",value:'"medium"'},{name:"literal",value:'"large"'}],required:!0}}]}}],raw:"LockedLabelType[]"},description:""},ariaLabel:{required:!1,tsType:{name:"string"},description:""}}};const qo=n=>{const{lockedFigures:e}=n;return o.createElement(o.Fragment,null,e.map((t,r)=>{switch(t.type){case"point":return o.createElement(vo,{key:`point-${r}`,...t});case"line":return o.createElement(bo,{key:`line-${r}`,range:n.range,...t});case"vector":return o.createElement(xo,{key:`vector-${r}`,...t});case"ellipse":return o.createElement(co,{key:`ellipse-${r}`,...t});case"polygon":return o.createElement(ko,{key:`polygon-${r}`,...t});case"function":return o.createElement(po,{key:`function-${r}`,...t});case"label":return null;default:throw new fe(t)}}))};qo.__docgenInfo={description:"",methods:[],displayName:"GraphLockedLayer",props:{lockedFigures:{required:!0,tsType:{name:"ReadonlyArray",elements:[{name:"union",raw:`| LockedPointType
| LockedLineType
| LockedVectorType
| LockedEllipseType
| LockedPolygonType
