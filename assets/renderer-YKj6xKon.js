import{j as y}from"./jsx-runtime-63Ea5SlK.js";import{a as xe}from"./version-akiLXZts.js";import{P as N,E as R}from"./perseus-error-l3K_anoI.js";import{g as mn}from"./_commonjsHelpers-4gQjN7DL.js";import{e as gn,i as pn}from"./invariant-bu5zBsRS.js";import{e as yn}from"./index-J2t_5nK1.js";import{c as ve}from"./index-dnMhQZ-1.js";import{_ as g,d as cn,$ as hn}from"./jquery-yG1GhClm.js";import{r as j}from"./index-6oxdNXpR.js";import{F as ke}from"./index-9gkyvru-.js";import{c as he}from"./asset-context-H6Iqp7Gi.js";import{P as bn}from"./i18n-context-fsWEgybQ.js";import{L as K,o as Ke,S as fn}from"./svg-image-FcZanvM1.js";import{T as je}from"./tex-MX5FPdQh.js";import{Z as wn}from"./zoomable-_uYFBX1Q.js";import{Z as vn}from"./zoomable-tex-Jjwex-Ep.js";import{g as J,D as kn}from"./dependencies-CP7Uh8Kq.js";import{A as qn,C as be}from"./perseus-api-1-ethIrW.js";import{L as Tn}from"./lint-CRWxUAIQ.js";import{U as B}from"./util-AYeX86gl.js";import{f as An,t as Rn,u as Pn,z as Cn}from"./constants-iPV6vHZm.js";class X{static parse(e){return new ge(e).parse()}match(e){throw new N("Selector subclasses must implement match()",R.NotAllowed)}toString(){return"Unknown selector class"}}class ge{constructor(e){e=e.trim().replace(/\s+/g," "),this.tokens=e.match(ge.TOKENS)||[],this.tokenIndex=0}nextToken(){return this.tokens[this.tokenIndex]||""}consume(){this.tokenIndex++}isIdentifier(){const e=this.tokens[this.tokenIndex][0];return e>="a"&&e<="z"||e>="A"&&e<="Z"}skipSpace(){for(;this.nextToken()===" ";)this.consume()}parse(){const e=this.parseTreeSelector();let n=this.nextToken();if(!n)return e;const t=[e];for(;n;){if(n===",")this.consume();else throw new fe("Expected comma");t.push(this.parseTreeSelector()),n=this.nextToken()}return new xn(t)}parseTreeSelector(){this.skipSpace();let e=this.parseNodeSelector();for(;;){const n=this.nextToken();if(!n||n===",")break;if(n===" ")this.consume(),e=new En(e,this.parseNodeSelector());else if(n===">")this.consume(),e=new Nn(e,this.parseNodeSelector());else if(n==="+")this.consume(),e=new Sn(e,this.parseNodeSelector());else if(n==="~")this.consume(),e=new jn(e,this.parseNodeSelector());else throw new fe("Unexpected token: "+n)}return e}parseNodeSelector(){this.skipSpace();const e=this.nextToken();if(e==="*")return this.consume(),new In;if(this.isIdentifier())return this.consume(),new On(e);throw new fe("Expected node type")}}ge.TOKENS=/([a-zA-Z][\w-]*)|(\d+)|[^\s]|(\s(?=[a-zA-Z\*]))/g;class fe extends Error{constructor(e){super(e)}}class xn extends X{constructor(e){super(),this.selectors=e}match(e){for(let n=0;n<this.selectors.length;n++){const a=this.selectors[n].match(e);if(a)return a}return null}toString(){let e="";for(let n=0;n<this.selectors.length;n++)e+=n>0?", ":"",e+=this.selectors[n].toString();return e}}class In extends X{match(e){return[e.currentNode()]}toString(){return"*"}}class On extends X{constructor(e){super(),this.type=e}match(e){const n=e.currentNode();return n.type===this.type?[n]:null}toString(){return this.type}}class pe extends X{constructor(e,n){super(),this.left=e,this.right=n}}class En extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n)for(e=e.clone();e.hasParent();){e.goToParent();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" "+this.right.toString()}}class Nn extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n&&e.hasParent()){e=e.clone(),e.goToParent();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" > "+this.right.toString()}}class Sn extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n&&e.hasPreviousSibling()){e=e.clone(),e.goToPreviousSibling();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" + "+this.right.toString()}}class jn extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n)for(e=e.clone();e.hasPreviousSibling();){e.goToPreviousSibling();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" ~ "+this.right.toString()}}const L=class L{constructor(e,n,t,a,i,o){if(!t&&!a)throw new N("Lint rules must have a selector or pattern",R.InvalidInput,{metadata:{name:e}});this.name=e||"unnamed rule",this.severity=n||L.Severity.BULK_WARNING,this.selector=t||L.DEFAULT_SELECTOR,this.pattern=a||null,typeof i=="function"?(this.lint=i,this.message=null):(this.lint=(...s)=>this._defaultLintFunction(...s),this.message=i),this.applies=o||function(){return!0}}static makeRule(e){return new L(e.name,e.severity,e.selector?X.parse(e.selector):null,L.makePattern(e.pattern),e.lint||e.message,e.applies)}check(e,n,t,a){const i=this.selector.match(n);if(!i)return null;let o;if(this.pattern?o=t.match(this.pattern):o=L.FakePatternMatch(t,t,0),!o)return null;try{const s=this.lint(n,t,i,o,a);return s?typeof s=="string"?{rule:this.name,severity:this.severity,message:s,start:0,end:t.length}:{rule:this.name,severity:this.severity,message:s.message,start:s.start,end:s.end}:null}catch(s){return{rule:"lint-rule-failure",message:`Exception in rule ${this.name}: ${s.message}
Stack trace:
${s.stack}`,start:0,end:t.length}}}_defaultLintFunction(e,n,t,a,i){return{message:this.message||"",start:a.index,end:a.index+a[0].length}}static makePattern(e){if(!e)return null;if(e instanceof RegExp)return e;if(e[0]==="/"){const n=e.lastIndexOf("/"),t=e.substring(1,n),a=e.substring(n+1);return new RegExp(t,a)}return new RegExp(e)}static FakePatternMatch(e,n,t){const a=[n];return a.index=t,a.input=e,a}};L.Severity={ERROR:1,WARNING:2,GUIDELINE:3,BULK_WARNING:4};let m=L;m.DEFAULT_SELECTOR=X.parse("text");const Wn=/\/\/([^\/]+)/;function Ln(r){if(!r)return"";const e=r.match(Wn);return e?e[1]:""}const Mn=m.makeRule({name:"absolute-url",severity:m.Severity.GUIDELINE,selector:"link, image",lint:function(r,e,n,t){const a=n[0].target,i=Ln(a);if(i==="khanacademy.org"||i.endsWith(".khanacademy.org"))return`Don't use absolute URLs:
...
math should not be indented.`}),_n=m.makeRule({name:"blockquoted-widget",severity:m.Severity.WARNING,selector:"blockQuote widget",message:`Blockquoted widget:
...
any other kind of terminal punctuation.`});function Gn(r,e){return`Answer requires a button not found in the button sets: ${r} (in ${e})`}const Vn={"\\sqrt":"prealgebra","\\sin":"trig","\\cos":"trig","\\tan":"trig","\\log":"logarithms","\\ln":"logarithms"},zn=m.makeRule({name:"expression-widget",severity:m.Severity.WARNING,selector:"widget",lint:function(r,e,n,t,a){var u;if(r.currentNode().widgetType!=="expression")return;const i=r.currentNode().id;if(!i)return;const o=(u=a==null?void 0:a.widgets)==null?void 0:u[i];if(!o)return;const s=o.options.answerForms,l=o.options.buttonSets;for(const d of s)for(const[p,b]of Object.entries(Vn))if(d.value.includes(p)&&!l.includes(b))return Gn(p,b)}}),Un=m.makeRule({name:"extra-content-spacing",selector:"paragraph",pattern:/\s+$/,applies:function(r){return(r==null?void 0:r.contentType)==="article"},message:"No extra whitespace at the end of content blocks."}),Hn=m.makeRule({name:"heading-level-1",severity:m.Severity.WARNING,selector:"heading",lint:function(r,e,n,t){if(n[0].level===1)return`Don't use level-1 headings:
Begin headings with two or more # characters.`}}),Kn=m.makeRule({name:"heading-level-skip",severity:m.Severity.WARNING,selector:"heading ~ heading",lint:function(r,e,n,t){const a=n[1],i=n[0];if(a.level>i.level+1)return`Skipped heading level:
this heading is level ${a.level} but
the previous heading was level ${i.level}`}}),Bn=m.makeRule({name:"heading-sentence-case",severity:m.Severity.GUIDELINE,selector:"heading",pattern:/^\W*[a-z]/,message:`First letter is lowercase:
the first letter of a heading should be capitalized.`}),Xn={and:!0,nor:!0,but:!0,the:!0,for:!0};function $n(r){const e=r[0];return e===e.toUpperCase()}const Yn=m.makeRule({name:"heading-title-case",severity:m.Severity.GUIDELINE,selector:"heading",pattern:/[^\s:]\s+[A-Z]+[a-z]/,locale:"en",lint:function(r,e,n,t){let i=e.trim().split(/\s+/);if(i.shift(),i=i.filter(o=>o.length>2&&!Xn.hasOwnProperty(o)),i.length>=3&&i.every(o=>$n(o)))return`Title-case heading:
...
This image's alt text is only ${a.alt.length} characters long.`}}),Qn=m.makeRule({name:"image-in-table",severity:m.Severity.BULK_WARNING,selector:"table image",message:`Image in table:
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{ga as D,De as J,D as P,Ce as R,h as S,ya as a,ka as b,ca as c,ha as d,ba as e,wa as f,xt as g,va as h,It as i,Rt as j,Ft as k,Xe as l,Ta as m,z as n,fa as o,Er as p,At as q,pa as r,qa as s,O as t,Pt as u};
