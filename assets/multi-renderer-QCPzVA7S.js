import{a as Y}from"./version-akiLXZts.js";import{w as J}from"./article-renderer-rCLm7fhA.js";import{r as X,k as Z,l as ee,R as H,p as M}from"./renderer-BDe3lowH.js";import{j as s,a as p}from"./jsx-runtime-5BUNAZ9W.js";import{l as j}from"./index-awljIyHI.js";import{r as m}from"./index-4g5l5LRQ.js";import{_ as q}from"./index-default-4_ZsnO94.js";import{c as ne}from"./asset-context-4nzQV6k0.js";import{P as V}from"./i18n-context-3gTlIcWM.js";import{D as G}from"./dependencies-9B_Bv_mA.js";import{H as x}from"./hints-renderer-UX03BjI0.js";import{o as re,K as l,L as te}from"./svg-image-sHK76CH4.js";import{A as ae}from"./perseus-api-7QXTiCE7.js";import{U as c}from"./util-hMu2nkBL.js";import{B as _}from"./button-group-KR3umc1e.js";import{I as b}from"./inline-icon-QIU9thzn.js";import{b as ie,d as se,e as oe,f as ue,c as le}from"./icon-paths-AuJwhOz7.js";import{P as h,E as y}from"./perseus-error-l3K_anoI.js";import{l as k}from"./unit-3x0ZR6Ko.js";const de="@khanacademy/perseus",ye="__lib_version__";Y(de,ye);const me={major:0,minor:1};X(J);const ge=Z();ge["::renderer::"]=me;const he={onRendered:a=>{}},pe=m.createContext(he),{mapObject:ce}=re,O=class O extends m.Component{constructor(e){super(e),this._handleFocusChange=(n,r)=>{n!=null?this._setCurrentFocus(n):this._onRendererBlur(r)},this.handleInteractWithWidget=n=>{var t,i;const r=q.difference(this.state.questionHighlightedWidgets,[n]);this.setState({questionCompleted:!1,questionHighlightedWidgets:r}),(i=(t=this.props.apiOptions)==null?void 0:t.interactionCallback)==null||i.call(t,this.questionRenderer.getUserInputForWidgets())},this.setAssetStatus=(n,r)=>{const t={...this.state.assetStatuses,[n]:r};this.setState({assetStatuses:t})},this.state={questionCompleted:!1,questionHighlightedWidgets:[],assetStatuses:{}},this._fullyRendered=!1}componentDidMount(){this._currentFocus=null,this._fullyRendered=!1}UNSAFE_componentWillReceiveProps(e){this.setState({questionHighlightedWidgets:[]})}componentDidUpdate(e,n){if(this.props.apiOptions.answerableCallback){const r=this.questionRenderer.emptyWidgets().length===0,{answerableCallback:t}=this.props.apiOptions;t&&t(r)}this._fullyRendered||Object.values(this.state.assetStatuses).every(Boolean)&&(this._fullyRendered=!0,this.props.onRendered(!0))}componentWillUnmount(){this.blurTimeoutID!=null&&(clearTimeout(this.blurTimeoutID),this.blurTimeoutID=null)}_setCurrentFocus(e){const{apiOptions:{isMobile:n,onFocusChange:r},keypadElement:t}=this.props,i=this._currentFocus;this._currentFocus=e;const u=this.getInputPaths(),o=this._currentFocus&&u.some(d=>c.inputPathsEqual(d,this._currentFocus));r!=null&&setTimeout(()=>{const d=t==null?void 0:t.getDOMNode(),f=d&&o?d.getBoundingClientRect().height:0;r(this._currentFocus,i,f,o&&this.questionRenderer.getDOMNodeForPath(e))},0),t&&n&&(o?t.activate():t.dismiss())}_onRendererBlur(e){const n=this._currentFocus;q.isEqual(e,n)&&(this.blurTimeoutID=setTimeout(()=>{q.isEqual(this._currentFocus,n)&&this._setCurrentFocus(null)},0))}_setWidgetProps(e,n,r){this.questionRenderer._setWidgetProps(e,n,r)}setInputValue(e,n,r){return this.questionRenderer.setInputValue(e,n,r)}focusPath(e){return this.questionRenderer.focusPath(e)}blurPath(e){return this.questionRenderer.blurPath(e)}getDOMNodeForPath(e){return this.questionRenderer.getDOMNodeForPath(e)}getGrammarTypeForPath(e){return this.questionRenderer.getGrammarTypeForPath(e)}getInputPaths(){return this.questionRenderer.getInputPaths()}focus(){return this.questionRenderer.focus()}blur(){this._currentFocus&&this.blurPath(this._currentFocus)}getNumHints(){return this.props.item.hints.length}scoreInput(){const e=this.questionRenderer.guessAndScore(),n=e[0],r=e[1],t=[n,[]],i=c.keScoreFromPerseusScore(r,t,this.questionRenderer.getSerializedState()),u=this.questionRenderer.emptyWidgets();return this.setState({questionCompleted:i.correct,questionHighlightedWidgets:u}),i}getWidgetIds(){return this.questionRenderer.getWidgetIds()}scoreWidgets(){const e=this.questionRenderer.scoreWidgets(),n=this.questionRenderer.getUserInputForWidgets(),r=this.questionRenderer.getSerializedState();return ce(e,(t,i)=>c.keScoreFromPerseusScore(t,n[i],r))}getSerializedState(){return{question:this.questionRenderer.getSerializedState(),hints:this.hintsRenderer.getSerializedState()}}restoreSerializedState(e,n){let r=2;const t=()=>{--r,n&&r===0&&n()};this.questionRenderer.restoreSerializedState(e.question,t),this.hintsRenderer.restoreSerializedState(e.hints,t)}showRationalesForCurrentlySelectedChoices(){this.questionRenderer.showRationalesForCurrentlySelectedChoices()}deselectIncorrectSelectedChoices(){this.questionRenderer.deselectIncorrectSelectedChoices()}render(){const e={...ae.defaults,...this.props.apiOptions,onFocusChange:this._handleFocusChange},n={assetStatuses:this.state.assetStatuses,setAssetStatus:this.setAssetStatus},r=s(ne.Provider,{value:n,children:s(H,{keypadElement:this.props.keypadElement,problemNum:this.props.problemNum,onInteractWithWidget:this.handleInteractWithWidget,highlightedWidgets:this.state.questionHighlightedWidgets,apiOptions:e,questionCompleted:this.state.questionCompleted,reviewMode:this.props.reviewMode,showSolutions:this.props.showSolutions,ref:i=>{i!=null&&(this.questionRenderer=i)},content:this.props.item.question.content,widgets:this.props.item.question.widgets,images:this.props.item.question.images,linterContext:M(this.props.linterContext,"question"),strings:this.context.strings,...this.props.dependencies})}),t=s(x,{hints:this.props.item.hints,hintsVisible:this.props.hintsVisible,apiOptions:e,ref:i=>this.hintsRenderer=i,linterContext:M(this.props.linterContext,"hints"),strings:this.context.strings});return s(G.Provider,{value:this.props.dependencies,children:p("div",{children:[s("div",{children:r}),s("div",{className:e.isMobile?void 0:j.css(be.hintsContainer),children:t})]})})}};O.contextType=V,O.defaultProps={apiOptions:{},linterContext:ee,onRendered:e=>{}};let T=O;const be=j.StyleSheet.create({hintsContainer:{marginLeft:50}}),we=m.forwardRef((a,e)=>s(pe.Consumer,{children:({onRendered:n})=>s(T,{...a,onRendered:n,ref:e})}));T.__docgenInfo={description:"",methods:[{name:"_handleFocusChange",docblock:null,modifiers:[],params:[{name:"newFocus",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}},{name:"oldFocus",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"_setCurrentFocus",docblock:null,modifiers:[],params:[{name:"newFocus",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"_onRendererBlur",docblock:null,modifiers:[],params:[{name:"blurPath",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"_setWidgetProps",docblock:`Accepts a question area widgetId, or an answer area widgetId of
...
Add values to the relevant array to create new flags.`}]},required:!1},description:"Feature flags that can be passed from consuming application."},{key:"onWidgetStartProps",value:{name:"signature",type:"function",raw:"(widgets: PerseusWidgetsMap) => void",signature:{arguments:[{type:{name:"intersection",raw:"{\n    [key in `categorizer ${number}`]: CategorizerWidget;\n} & {\n    [key in `cs-program ${number}`]: CSProgramWidget;\n} & {\n    [key in `definition ${number}`]: DefinitionWidget;\n} & {\n    [key in `dropdown ${number}`]: DropdownWidget;\n} & {\n    [key in `example-widget ${number}`]: ExampleWidget;\n} & {\n    [key in `example-graphie-widget ${number}`]: ExampleGraphieWidget;\n} & {\n    [key in `explanation ${number}`]: ExplanationWidget;\n} & {\n    [key in `expression ${number}`]: ExpressionWidget;\n} & {\n    [key in `grapher ${number}`]: GrapherWidget;\n} & {\n    [key in `group ${number}`]: GroupWidget;\n} & {\n    [key in `graded-group ${number}`]: GradedGroupWidget;\n} & {\n    [key in `graded-group-set ${number}`]: GradedGroupSetWidget;\n} & {\n    [key in `iframe ${number}`]: IFrameWidget;\n} & {\n    [key in `image ${number}`]: ImageWidget;\n} & {\n    [key in `input-number ${number}`]: InputNumberWidget;\n} & {\n    [key in `interaction ${number}`]: InteractionWidget;\n} & {\n    [key in `interactive-graph ${number}`]: InteractiveGraphWidget;\n} & {\n    [key in `label-image ${number}`]: LabelImageWidget;\n} & {\n    [key in `matcher ${number}`]: MatcherWidget;\n} & {\n    [key in `matrix ${number}`]: MatrixWidget;\n} & {\n    [key in `measurer ${number}`]: MeasurerWidget;\n} & {\n    [key in `molecule-renderer ${number}`]: MoleculeRendererWidget;\n} & {\n    [key in `number-line ${number}`]: NumberLineWidget;\n} & {\n    [key in `numeric-input ${number}`]: NumericInputWidget;\n} & {\n    [key in `orderer ${number}`]: OrdererWidget;\n} & {\n    [key in `passage ${number}`]: PassageWidget;\n} & {\n    [key in `passage-ref ${number}`]: PassageRefWidget;\n} & {\n    [key in `passage-ref-target ${number}`]: PassageRefWidget;\n} & {\n    [key in `plotter ${number}`]: PlotterWidget;\n} & {\n    [key in `python-program ${number}`]: PythonProgramWidget;\n} & {\n    [key in `radio ${number}`]: RadioWidget;\n} & {\n    [key in `simple-markdown-tester ${number}`]: SimpleMarkdownTesterWidget;\n} & {\n    [key in `sorter ${number}`]: SorterWidget;\n} & {\n    [key in `table ${number}`]: TableWidget;\n} & {\n    [key in `unit-input ${number}`]: UnitInputWidget;\n} & {\n    [key in `video ${number}`]: VideoWidget;\n}",elements:[{name:"signature",type:"object",raw:"{\n    [key in `categorizer ${number}`]: CategorizerWidget;\n}",signature:{properties:[{key:{name:"literal",value:"`categorizer ${number}`",required:!0},value:{name:"signature",type:"object",raw:`{
    ...
    // The minor part of the version
    minor: number;
}`,signature:{properties:[{key:"major",value:{name:"number",required:!0}},{key:"minor",value:{name:"number",required:!0}}]},required:!0}}]}}}]}},{name:"signature",type:"object",raw:"{\n    [key in `unit-input ${number}`]: UnitInputWidget;\n}",signature:{properties:[{key:{name:"literal",value:"`unit-input ${number}`",required:!0},value:{name:"signature",type:"object",raw:`{
    // The "type" of widget which will define what the Options field looks like
    type: Type;
    // Whether this widget is displayed with the values and is immutable.  For display only
    // NOTE: perseus_data.go says this is required even though it isn't necessary.
...
the question content.`},{name:"scoreWidgets",docblock:"Returns an object mapping from widget ID to KE-style score.\nThe keys of this object are the values of the array returned\nfrom `getWidgetIds`.",modifiers:[],params:[],returns:{type:{name:"signature",type:"object",raw:`{
    ...
    [key: string]: any;
}`,signature:{properties:[{key:{name:"string"},value:{name:"any",required:!0}}]}},name:"values"},{type:{name:"union",raw:"(() => unknown) | null | undefined",elements:[{name:"unknown"},{name:"null"},{name:"undefined"}]},name:"callback"},{type:{name:"boolean"},name:"silent"}],return:{name:"unknown"}}},description:""}}};const ve=[l.BLACK,l.BLUE,l.GREEN,l.PINK,l.PURPLE,l.RED,l.GRAY],fe=[l.LIGHT_BLUE,l.LIGHT_ORANGE,l.LIGHT_PINK,l.LIGHT_GREEN,l.LIGHT_PURPLE,l.LIGHT_RED,"#fff"],L=class L extends m.Component{render(){const e=this.props.lightColors?fe:ve;return s(_,{value:this.props.value,allowEmpty:!1,buttons:q.map(e,n=>({value:n,content:p("span",{children:[s("span",{className:"colorpicker-circle",style:{background:n}})," "]})})),onChange:this.props.onChange})}};L.defaultProps={value:l.BLACK,lightColors:!1};let E=L;E.__docgenInfo={description:"",methods:[],displayName:"ColorPicker",props:{lightColors:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},value:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'"black"',computed:!1}},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:`(
    values: {
        [key: string]: any;
    },
    callback?: (() => unknown) | null | undefined,
    ...
    [key: string]: any;
}`,signature:{properties:[{key:{name:"string"},value:{name:"any",required:!0}}]}},name:"values"},{type:{name:"union",raw:"(() => unknown) | null | undefined",elements:[{name:"unknown"},{name:"null"},{name:"undefined"}]},name:"callback"},{type:{name:"boolean"},name:"silent"}],return:{name:"unknown"}}},description:""}}};const $=class $ extends m.Component{render(){return s(_,{value:this.props.value,allowEmpty:!1,buttons:[{value:"",content:s("span",{children:"—"})},{value:"-",content:s("span",{children:"–––"})},{value:"- ",content:s("span",{children:"–  –"})},{value:".",content:s("span",{children:"····"})},{value:". ",content:s("span",{children:"· · ·"})}],onChange:this.props.onChange})}};$.defaultProps={value:""};let C=$;C.__docgenInfo={description:"",methods:[],displayName:"DashPicker",props:{value:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'""',computed:!1}},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:`(
    values: {
        [key: string]: any;
    },
    callback?: (() => unknown) | null | undefined,
    ...
    [key: string]: any;
}`,signature:{properties:[{key:{name:"string"},value:{name:"any",required:!0}}]}},name:"values"},{type:{name:"union",raw:"(() => unknown) | null | undefined",elements:[{name:"unknown"},{name:"null"},{name:"undefined"}]},name:"callback"},{type:{name:"boolean"},name:"silent"}],return:{name:"unknown"}}},description:""}}};const D=class D extends m.Component{constructor(e){super(e),this.toggle=n=>{n.preventDefault(),this.setState({show:!this.state.show})},this.state={show:e.initiallyVisible}}render(){return p("div",{className:"perseus-interaction-element",children:[p("a",{href:"#",className:"perseus-interaction-element-title "+(this.state.show?"open":"closed"),onClick:this.toggle,children:[this.state.show?s(b,{...ie}):s(b,{...se}),this.props.title]}),p("div",{className:"perseus-interaction-element-content "+(this.state.show?"enter":"leave"),children:[this.props.children,(this.props.onUp!=null||this.props.onDown!=null||this.props.onDelete!=null)&&p("div",{className:"edit-controls",children:[this.props.onUp!=null&&s("button",{onClick:this.props.onUp,children:s(b,{...oe})}),this.props.onDown!=null&&s("button",{onClick:this.props.onDown,children:s(b,{...ue})}),this.props.onDelete!=null&&s("button",{onClick:this.props.onDelete,children:s(b,{...le})})]})]})]})}};D.defaultProps={initiallyVisible:!1,title:"More"};let P=D;P.__docgenInfo={description:"",methods:[{name:"toggle",docblock:null,modifiers:[],params:[{name:"e",optional:!1,type:{name:"ReactSyntheticEvent",raw:"React.SyntheticEvent",alias:"React.SyntheticEvent"}}],returns:null}],displayName:"ElementContainer",props:{children:{required:!0,tsType:{name:"union",raw:"React.ReactElement<any> | ReadonlyArray<React.ReactElement<any>>",elements:[{name:"ReactReactElement",raw:"React.ReactElement<any>",elements:[{name:"any"}]},{name:"ReadonlyArray",elements:[{name:"ReactReactElement",raw:"React.ReactElement<any>",elements:[{name:"any"}]}],raw:"ReadonlyArray<React.ReactElement<any>>"}]},description:""},initiallyVisible:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},onDelete:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void | null | undefined",signature:{arguments:[],return:{name:"union",raw:"void | null | undefined",elements:[{name:"void"},{name:"null"},{name:"undefined"}]}}},description:""},onDown:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void | null | undefined",signature:{arguments:[],return:{name:"union",raw:"void | null | undefined",elements:[{name:"void"},{name:"null"},{name:"undefined"}]}}},description:""},onUp:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void | null | undefined",signature:{arguments:[],return:{name:"union",raw:"void | null | undefined",elements:[{name:"void"},{name:"null"},{name:"undefined"}]}}},description:""},title:{required:!1,tsType:{name:"union",raw:"string | React.ReactElement<any>",elements:[{name:"string"},{name:"ReactReactElement",raw:"React.ReactElement<any>",elements:[{name:"any"}]}]},description:"",defaultValue:{value:'"More"',computed:!1}}}};const ke={type:"content"},K={type:"hint"},qe={type:"tags"},B=a=>({type:"array",elementShape:a}),Re=a=>({type:"object",shape:a}),Te=B(K),g={content:ke,hint:K,hints:Te,tags:qe,arrayOf:B,shape:Re};class w{constructor(e,n,r){this.content=e,this.hint=n,this.tags=r,this.array=R}setContentMapper(e){return new w(e,this.hint,this.tags)}setHintMapper(e){return new w(this.content,e,this.tags)}setTagsMapper(e){return new w(this.content,this.hint,e)}setArrayMapper(e){return new F(this.content,this.hint,this.tags,e)}mapTree(e,n){return A(e,n,[],this)}}class F{constructor(e,n,r,t){this.content=e,this.hint=n,this.tags=r,this.array=t}setArrayMapper(e){return new F(this.content,this.hint,this.tags,e)}mapTree(e,n){return A(e,n,[],this)}}function R(a){return a}function v(){return new w(R,R,R)}function A(a,e,n,r){if(e.type==="content"){const t=a;return r.content(t,e,n)}if(e.type==="hint"){const t=a;return r.hint(t,e,n)}if(e.type==="tags"){const t=a;return r.tags(t,e,n)}if(e.type==="array"){const t=a;if(!Array.isArray(t))throw new h(`Invalid object of type "${typeof t}" found at path ${["<root>"].concat(n).join(".")}. Expected array.`,y.Internal);const i=e.elementShape,u=t.map((o,d)=>A(o,i,n.concat(d),r));return r.array(u,t,e,n)}if(e.type==="object"){const t=a;if(t&&typeof t!="object")throw new h(`Invalid object of type "${typeof t}" found at path ${["<root>"].concat(n).join(".")}. Expected "object" type.`,y.InvalidInput);const i=e.shape;if(!i)throw new h(`Unexpected shape ${JSON.stringify(e)} at path ${["<root>"].concat(n).join(".")}.`,y.InvalidInput);const u={};return Object.keys(i).forEach(o=>{if(!(o in t))throw new h(`Key "${o}" is missing from shape at path ${["<root>"].concat(n).join(".")}.`,y.InvalidInput);u[o]=A(t[o],i[o],n.concat(o),r)}),u}throw new h(`unexpected shape type ${e.type}`,y.InvalidInput)}function Q(a){if(a.type==="content")return{__type:"content",content:"",images:{},widgets:{}};if(a.type==="hint")return{__type:"hint",replace:!1,content:"",images:{},widgets:{}};if(a.type==="tags")return[];if(a.type==="array")return[];if(a.type==="object"){const e=a.shape,n={};return Object.keys(e).forEach(r=>{n[r]=Q(e[r])}),n}throw new h(`unexpected shape type ${a.type}`,y.InvalidInput)}function Ge(a){return Ae(Q(a))}function Ke(a,e,n){const r=W(a);v().setContentMapper(n).mapTree(r,e)}function Be(a,e,n){const r=W(a);v().setHintMapper(n).mapTree(r,e)}function Qe(a){const e=W(a);return z(e)}function z(a){if(Array.isArray(a))return a.length?typeof a[0]=="string"?g.tags:g.arrayOf(z(a[0])):g.arrayOf(g.content);if(typeof a=="object"&&(a.__type==="content"||a.__type==="item"))return g.content;if(typeof a=="object"&&a.__type==="hint")return g.hint;if(typeof a=="object"){const e={};return Object.keys(a).forEach(n=>{e[n]=z(a[n])}),g.shape(e)}throw new h(`unexpected multi-item node ${JSON.stringify(a)}`,y.InvalidInput)}function W(a){return a._multi}function Ae(a){return{_multi:a}}const U=class U extends m.Component{constructor(e){super(e),this._handleSerializedStateUpdated=(n,r)=>{const{onSerializedStateUpdated:t}=this.props;if(t){const i=this._getSerializedState(this.props.serializedState);t(k(i).set(n,r).freeze())}},this.rendererDataTreeMapper=v().setContentMapper((n,r,t)=>this._makeContentRendererData(n,t)).setHintMapper(n=>this._makeHintRendererData(n)).setTagsMapper(n=>null),this.getRenderersMapper=v().setContentMapper(n=>n.makeRenderer()).setHintMapper(n=>n.makeRenderer()).setArrayMapper((n,r,t)=>this._annotateRendererArray(n,r,t)),this.state=this._tryMakeRendererState(this.props)}UNSAFE_componentWillReceiveProps(e){e.item!==this.props.item&&this.setState(this._tryMakeRendererState(e))}_tryMakeRendererState(e){try{return{rendererDataTree:this._makeRendererDataTree(e.item,e.shape),renderError:null}}catch(n){return te.error("Error building tree state",y.Internal,{cause:n}),{rendererDataTree:null,renderError:n}}}_getRendererProps(){const{item:e,children:n,shape:r,serializedState:t,onSerializedStateUpdated:i,...u}=this.props;return{...u,strings:this.context.strings}}_makeContentRendererData(e,n){const r={ref:null,makeRenderer:null},t=o=>r.ref=o,i=o=>this._findWidgets(r,o),u=o=>this._handleSerializedStateUpdated(n,o);return r.makeRenderer=()=>s(H,{...this._getRendererProps(),...e,ref:t,findExternalWidgets:i,serializedState:this.props.serializedState?k(this.props.serializedState).get(n):null,onSerializedStateUpdated:u}),r}_makeHintRendererData(e){const n=r=>this._findWidgets({},r);return{hint:e,findExternalWidgets:n,ref:null,makeRenderer:()=>s(x,{...this._getRendererProps(),findExternalWidgets:n,hints:[e]})}}_makeRendererDataTree(e,n){const r=W(e);return this.rendererDataTreeMapper.mapTree(r,n)}_findWidgets(e,n){const r=[];return this._mapRenderers(t=>{e!==t&&t.ref&&r.push(...t.ref.findInternalWidgets(n))}),r}_mapRenderers(e){const{rendererDataTree:n}=this.state;return n?v().setContentMapper(e).setHintMapper(e).mapTree(n,this.props.shape):null}_scoreFromRef(e){if(!e)return null;const[n,r]=e.guessAndScore();let t;return e.getSerializedState&&(t=e.getSerializedState()),c.keScoreFromPerseusScore(r,n,t)}getScores(){return this._mapRenderers(e=>this._scoreFromRef(e.ref))}score(){const e=[],n=[],r=this._mapRenderers(i=>{var u;return i.ref?(i.ref.getSerializedState&&n.push(i.ref.getSerializedState()),e.push(i.ref.score()),(u=i.ref)==null?void 0:u.getUserInput()):null}),t=e.reduce(c.combineScores);return c.keScoreFromPerseusScore(t,r,n)}_getSerializedState(e){return this._mapRenderers((n,r,t)=>n.ref?n.ref.getSerializedState():e?k(e).get(t):null)}restoreSerializedState(e,n){let r=0;const t=()=>{r--,n&&r===0&&n()};this._mapRenderers((i,u,o)=>{var f;if(!i.ref)return;const d=k(e).get(o);d&&(r++,(f=i.ref)==null||f.restoreSerializedState(d,t))})}_annotateRendererArray(e,n,r){if(r.elementShape.type==="hint"){const t=n;e=[...e],e.firstN=i=>s(x,{...this._getRendererProps(),findExternalWidgets:t[0]?t[0].findExternalWidgets:void 0,hints:t.map(u=>u.hint),hintsVisible:i})}return e}_getRenderers(){return this.getRenderersMapper.mapTree(this.state.rendererDataTree,this.props.shape)}render(){return this.state.renderError?s("div",{className:j.css(Oe.error),children:this.context.strings.errorRendering({error:String(this.state.renderError)})}):s(G.Provider,{value:this.props.dependencies,children:this.props.children({renderers:this._getRenderers()})})}};U.contextType=V;let N=U;const Oe=j.StyleSheet.create({error:{color:"red"}});N.__docgenInfo={description:"",methods:[{name:"_tryMakeRendererState",docblock:"Attempt to build a State that includes a renderer tree corresponding to\nthe item provided in props. On error, return a state with `renderError`\nset instead.",modifiers:[],params:[{name:"props",optional:!1,type:{name:"signature",type:"object",raw:`{
    item: Item;
    shape: Shape;
...
the available choices.`}]}}],raw:`Readonly<{
    ...
    analytics: {onAnalyticsEvent: AnalyticsEventHandlerFn};
}`,signature:{properties:[{key:"analytics",value:{name:"signature",type:"object",raw:"{onAnalyticsEvent: AnalyticsEventHandlerFn}",signature:{properties:[{key:"onAnalyticsEvent",value:{name:"AnalyticsEventHandlerFn",required:!0}}]},required:!0}}]}},description:""}}};export{I as A,E as C,C as D,P as E,N as M,T as S,Be as a,Ge as b,v as c,W as d,Q as e,Ke as f,me as g,Qe as i,we as r,g as s};
