...
any other kind of terminal punctuation.`});function Dn(r,e){return`Answer requires a button not found in the button sets: ${r} (in ${e})`}const Gn={"\\sqrt":"prealgebra","\\sin":"trig","\\cos":"trig","\\tan":"trig","\\log":"logarithms","\\ln":"logarithms"},zn=d.makeRule({name:"expression-widget",severity:d.Severity.WARNING,selector:"widget",lint:function(r,e,n,t,a){var l;if(r.currentNode().widgetType!=="expression")return;const i=r.currentNode().id;if(!i)return;const o=(l=a==null?void 0:a.widgets)==null?void 0:l[i];if(!o)return;const s=o.options.answerForms,u=o.options.buttonSets;for(const m of s)for(const[p,b]of Object.entries(Gn))if(m.value.includes(p)&&!u.includes(b))return Dn(p,b)}}),Un=d.makeRule({name:"extra-content-spacing",selector:"paragraph",pattern:/\s+$/,applies:function(r){return(r==null?void 0:r.contentType)==="article"},message:"No extra whitespace at the end of content blocks."}),Vn=d.makeRule({name:"heading-level-1",severity:d.Severity.WARNING,selector:"heading",lint:function(r,e,n,t){if(n[0].level===1)return`Don't use level-1 headings:
Begin headings with two or more # characters.`}}),Xn=d.makeRule({name:"heading-level-skip",severity:d.Severity.WARNING,selector:"heading ~ heading",lint:function(r,e,n,t){const a=n[1],i=n[0];if(a.level>i.level+1)return`Skipped heading level:
this heading is level ${a.level} but
the previous heading was level ${i.level}`}}),Yn=d.makeRule({name:"heading-sentence-case",severity:d.Severity.GUIDELINE,selector:"heading",pattern:/^\W*[a-z]/,message:`First letter is lowercase:
the first letter of a heading should be capitalized.`}),Hn={and:!0,nor:!0,but:!0,the:!0,for:!0};function Kn(r){const e=r[0];return e===e.toUpperCase()}const Bn=d.makeRule({name:"heading-title-case",severity:d.Severity.GUIDELINE,selector:"heading",pattern:/[^\s:]\s+[A-Z]+[a-z]/,locale:"en",lint:function(r,e,n,t){let i=e.trim().split(/\s+/);if(i.shift(),i=i.filter(o=>o.length>2&&!Hn.hasOwnProperty(o)),i.length>=3&&i.every(o=>Kn(o)))return`Title-case heading:
...
the linter and any warnings will be highlighted in the rendered output.`},{key:"legacyPerseusLint",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!1}},{key:"widgets",value:{name:"signature",raw:'PerseusRenderer["widgets"]',required:!0}},{key:"inline",value:{name:"boolean",required:!1},description:"Skip adding paragraph class"},{key:"strings",value:{name:"signature",type:"object",raw:`{
    ...
    x: string;
    y: string;
}`,signature:{properties:[{key:"num",value:{name:"number",required:!0}},{key:"x",value:{name:"string",required:!0}},{key:"y",value:{name:"string",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}},{key:"srInteractiveElements",value:{name:"signature",type:"function",raw:"({elements}: {elements: string}) => string",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{elements: string}",signature:{properties:[{key:"elements",value:{name:"string",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}},{key:"srNoInteractiveElements",value:{name:"string",required:!0}},{key:"circleGraphAriaLabel",value:{name:"string",required:!0}},{key:"circleShapeAriaLabel",value:{name:"signature",type:"function",raw:`({
    centerX,
    centerY,
}: {
    centerX: number;
    ...
    centerX: number;
    centerY: number;
}`,signature:{properties:[{key:"centerX",value:{name:"number",required:!0}},{key:"centerY",value:{name:"number",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}},{key:"circleRadiusPointAriaLabel",value:{name:"signature",type:"function",raw:`({
    radiusPointX,
    radiusPointY,
}: {
    radiusPointX: number;
    ...
    radiusPointX: number;
    radiusPointY: number;
}`,signature:{properties:[{key:"radiusPointX",value:{name:"number",required:!0}},{key:"radiusPointY",value:{name:"number",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}},{key:"circleRadiusDescription",value:{name:"signature",type:"function",raw:"({radius}: {radius: number}) => string",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{radius: number}",signature:{properties:[{key:"radius",value:{name:"number",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}},{key:"circleOuterPointsDescription",value:{name:"signature",type:"function",raw:`({
    point1X,
    point1Y,
    point2X,
    point2Y,
    ...
    point4X: number;
    point4Y: number;
}`,signature:{properties:[{key:"point1X",value:{name:"number",required:!0}},{key:"point1Y",value:{name:"number",required:!0}},{key:"point2X",value:{name:"number",required:!0}},{key:"point2Y",value:{name:"number",required:!0}},{key:"point3X",value:{name:"number",required:!0}},{key:"point3Y",value:{name:"number",required:!0}},{key:"point4X",value:{name:"number",required:!0}},{key:"point4Y",value:{name:"number",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}}]},required:!0}}]}}],alias:"Props"}}],returns:null},{name:"_getAllWidgetsStartProps",docblock:null,modifiers:[],params:[{name:"allWidgetInfo",optional:!1,type:null},{name:"props",optional:!1,type:null}],returns:null},{name:"_getDefaultWidgetInfo",docblock:null,modifiers:[],params:[{name:"widgetId",optional:!1,type:{name:"string"}}],returns:null},{name:"_getWidgetInfo",docblock:null,modifiers:[],params:[{name:"widgetId",optional:!1,type:{name:"string"}}],returns:{type:{name:"union",raw:`| CategorizerWidget
| CSProgramWidget
| DefinitionWidget
| DropdownWidget
| ExplanationWidget
...
the linter and any warnings will be highlighted in the rendered output.`},{key:"legacyPerseusLint",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!1}},{key:"widgets",value:{name:"signature",raw:'PerseusRenderer["widgets"]',required:!0}},{key:"inline",value:{name:"boolean",required:!1},description:"Skip adding paragraph class"},{key:"strings",value:{name:"signature",type:"object",raw:`{
    ...
    point4X: number;
    point4Y: number;
}`,signature:{properties:[{key:"point1X",value:{name:"number",required:!0}},{key:"point1Y",value:{name:"number",required:!0}},{key:"point2X",value:{name:"number",required:!0}},{key:"point2Y",value:{name:"number",required:!0}},{key:"point3X",value:{name:"number",required:!0}},{key:"point3Y",value:{name:"number",required:!0}},{key:"point4X",value:{name:"number",required:!0}},{key:"point4Y",value:{name:"number",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}}]},required:!0}}]}}],alias:"Props"}},{name:"state",optional:!1,type:{name:"signature",type:"object",raw:`{
...
the linter and any warnings will be highlighted in the rendered output.`},{key:"legacyPerseusLint",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!1}},{key:"widgets",value:{name:"signature",raw:'PerseusRenderer["widgets"]',required:!0}},{key:"inline",value:{name:"boolean",required:!1},description:"Skip adding paragraph class"},{key:"strings",value:{name:"signature",type:"object",raw:`{
    ...
    point4X: number;
    point4Y: number;
}`,signature:{properties:[{key:"point1X",value:{name:"number",required:!0}},{key:"point1Y",value:{name:"number",required:!0}},{key:"point2X",value:{name:"number",required:!0}},{key:"point2Y",value:{name:"number",required:!0}},{key:"point3X",value:{name:"number",required:!0}},{key:"point3Y",value:{name:"number",required:!0}},{key:"point4X",value:{name:"number",required:!0}},{key:"point4Y",value:{name:"number",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}}]},required:!0}}]}}],alias:"Props"}}],returns:null},{name:"_setCurrentFocus",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"focus",docblock:null,modifiers:[],params:[],returns:null},{name:"getDOMNodeForPath",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"getInputPaths",docblock:null,modifiers:[],params:[],returns:null},{name:"focusPath",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"blurPath",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"blur",docblock:null,modifiers:[],params:[],returns:null},{name:"serialize",docblock:null,modifiers:[],params:[],returns:null},{name:"emptyWidgets",docblock:`Returns an array of widget ids that are empty (meaning widgets where the
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{ca as D,_e as J,D as P,Pe as R,h as S,wa as a,Ra as b,fa as c,va as d,ka as e,Ta as f,Nt as g,Aa as h,St as i,It as j,ha as k,Xe as l,Gt as m,kt as n,xa as o,Or as p,U as q,ba as r,Pa as s,qa as t,Ot as u,Ct as v,un as w,an as x,O as y};
