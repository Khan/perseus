import{aI as a}from"./iframe-CDagQRjv.js";import{S as g}from"./server-item-renderer-with-debug-ui-4f6Znu3j.js";import"./server-item-renderer-BqGpUYA5.js";import"./hints-renderer-D9m6ukVh.js";import"./main-DzIlmCQD.js";import"./test-keypad-context-wrapper-mmqizsW8.js";import"./Popper-BvVW5jD0.js";const p={content:`[[☃ passage 1]]

`,images:{},widgets:{"passage 1":{alignment:"default",graded:!0,options:{footnotes:"",passageText:`Sociologists study folktales because they provide a means of understanding the distinctive values of a culture. However, the folktales in almost all cultures are adaptations of the same ancient narratives to the local milieu.
`,passageTitle:"",showLineNumbers:!1,static:!1},static:!1,type:"passage",version:{major:0,minor:0}}}},m={content:`>Select text to highlight it. *(Laptop/desktop only)*
...
`,passageTitle:"Passage 2",showLineNumbers:!0,static:!1},static:!1,type:"passage",version:{major:0,minor:0}}}},f={content:"[[☃ passage 1]]",images:{},widgets:{"passage 1":{alignment:"default",graded:!0,options:{footnotes:"An example footnote",passageText:`{{For reasons that are not entirely clear, when animals make their way to isolated islands [[1]], they tend to evolve relatively quickly toward an outsized or pint-sized version of their mainland counterpart.}} 
...
The authors characterized the rates of sequence evolution within mitochondrial DNA to establish the evolutionary relationships between the different eagle species. Their analysis places Haast's eagle in the same evolutionary lineage as a group of small eagle species in the genus _Hieraaetus_. Surprisingly, the genetic distance separating the giant eagle and its more diminutive _Hieraaetus_ cousins from their last {{common}} ancestor is relatively small.
`,passageTitle:"Passage 1",showLineNumbers:!0,static:!1},static:!1,type:"passage",version:{major:0,minor:0}}}},q={title:"Widgets/Passage",component:g,tags:["!dev"],parameters:{docs:{description:{component:"A widget that presents formatted text passages for reading comprehension exercises,                    supporting rich text formatting and reference points for questions."}}}},e={args:{item:a({question:p})}},t={args:{item:a({question:m})}},s={args:{item:a({question:f})}};var i,o,n;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: question1
    })
  }
}`,...(n=(o=e.parameters)==null?void 0:o.docs)==null?void 0:n.source}}};var r,l,d;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: question2
    })
  }
}`,...(d=(l=t.parameters)==null?void 0:l.docs)==null?void 0:d.source}}};var h,c,u;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: question3
    })
  }
}`,...(u=(c=s.parameters)==null?void 0:c.docs)==null?void 0:u.source}}};const A=["SimpleQuestion","MultiPassageQuestion","SingleNumberedPassage"];export{t as MultiPassageQuestion,e as SimpleQuestion,s as SingleNumberedPassage,A as __namedExportsOrder,q as default};
