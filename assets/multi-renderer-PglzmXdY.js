...
| EmptyUserInput`,elements:[{name:"signature",type:"object",raw:`{
    values: ReadonlyArray<number>;
    ...
    value: number;
}`,signature:{properties:[{key:"value",value:{name:"number",required:!0}}]}},{name:"string"},{name:"signature",type:"object",raw:`{
    type: string;
...
| PerseusGraphTypeSinusoid`,elements:[{name:"signature",type:"object",raw:`{
    ...
    changed: boolean;
}`,signature:{properties:[{key:"options",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!0}},{key:"changed",value:{name:"boolean",required:!0}}]}},{name:"ReadonlyArray",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"}],raw:"ReadonlyArray<ReadonlyArray<string>>"},{name:"Empty"}]},{name:"null"},{name:"undefined"}]}},required:!1}},{key:"simpleValidate",value:{name:"signature",type:"function",raw:`(
    options?: any,
    onOutputError?: (
        widgetId: any,
        value: string,
