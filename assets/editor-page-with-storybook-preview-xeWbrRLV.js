import{r as a,j as n,V as o,as as P,n as T,aL as R,aM as x,k as A,s as t,i as I,R as q,g as F,l as m}from"./iframe-CNFYEH7L.js";import"./item-version-D9gT7eGP.js";import"./article-renderer-B9ordAQy.js";import"./server-item-renderer-Cqj5d7ud.js";import"./hints-renderer-DoIG0YVZ.js";import{C as M}from"./content-preview-6ony7U9U.js";import{E as D}from"./editor-page-BUssIgt8.js";const{action:E}=__STORYBOOK_MODULE_ACTIONS__,N=E("onChange");function j(d){const[u,g]=a.useState("phone"),[y,w]=a.useState(!1),[f,b]=a.useState(),[h,k]=a.useState(d.question),[i,v]=a.useState(d.hints),[r,c]=a.useState(!0),l=d.apiOptions??{isMobile:!1};return n.jsxs(o,{children:[n.jsx(D,{apiOptions:l,previewDevice:u,onPreviewDeviceChange:e=>g(e),developerMode:!0,jsonMode:y,answerArea:f,question:h,hints:i,frameSource:"about:blank",previewURL:"about:blank",itemId:"1",onChange:e=>{N(e),"jsonMode"in e&&w(e.jsonMode),"answerArea"in e&&b(e.answerArea),"question"in e&&k(e.question),"hints"in e&&v(e.hints)},additionalTemplates:{"Side by Side":`Left hand side
=====
Right hand side`}}),!r&&n.jsx(P,{onClick:()=>c(!r),style:s.openPanelButton,children:"Open preview (storybook only)"}),r&&n.jsxs(o,{style:s.panel,children:[n.jsx(R,{icon:x,kind:"tertiary",onClick:()=>c(!r)}),n.jsx(o,{style:s.panelInner,children:n.jsx(M,{question:h,previewDevice:u,apiOptions:l,linterContext:{contentType:"exercise",highlightLint:!0,paths:[],stack:[]}})}),i==null?void 0:i.map((e,p)=>n.jsxs(o,{style:s.panelInner,children:[n.jsx(A,{size:t.medium_16}),n.jsx(I,{children:`Hint ${p+1}`}),n.jsx(q,{strings:F,apiOptions:l,...e})]},p))]})]})}const s=T.StyleSheet.create({panel:{position:"fixed",right:0,minWidth:500,height:"90vh",overflow:"auto",flex:"none",backgroundColor:m.fadedBlue16,padding:t.medium_16,borderRadius:t.small_12,alignItems:"end"},panelInner:{flex:"none",backgroundColor:m.white,borderRadius:t.xSmall_8,marginTop:t.medium_16,width:"100%",padding:t.xSmall_8},openPanelButton:{position:"fixed",right:t.medium_16,bottom:t.xxxLarge_64}});j.__docgenInfo={description:"",methods:[],displayName:"EditorPageWithStorybookPreview",props:{apiOptions:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
