...
}`,...(De=(Ve=C.parameters)==null?void 0:Ve.docs)==null?void 0:De.source}}};var Ue,Je,ze;W.parameters={...W.parameters,docs:{...(Ue=W.parameters)==null?void 0:Ue.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentWithLockedPointsQuestion
    })
  }
}`,...(ze=(Je=W.parameters)==null?void 0:Je.docs)==null?void 0:ze.source}}};var He,$e,Me;R.parameters={...R.parameters,docs:{...(He=R.parameters)==null?void 0:He.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentWithLockedLineQuestion
    })
  }
}`,...(Me=($e=R.parameters)==null?void 0:$e.docs)==null?void 0:Me.source}}};var Ke,Ye,Ze;_.parameters={..._.parameters,docs:{...(Ke=_.parameters)==null?void 0:Ke.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
...
makes the graph non-interactive. This is generally used for hints.`,...(Ls=(Ps=f.parameters)==null?void 0:Ps.docs)==null?void 0:Ls.description}}};var As,Ts,Qs;V.parameters={...V.parameters,docs:{...(As=V.parameters)==null?void 0:As.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
...
}`,...(_s=(Rs=U.parameters)==null?void 0:Rs.docs)==null?void 0:_s.source}}};var Os,Ns,Fs;J.parameters={...J.parameters,docs:{...(Os=J.parameters)==null?void 0:Os.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: circleQuestion
    }),
...
}`,...(Fs=(Ns=J.parameters)==null?void 0:Ns.docs)==null?void 0:Fs.source}}};var Bs,Es,Gs;z.parameters={...z.parameters,docs:{...(Bs=z.parameters)==null?void 0:Bs.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: linearQuestion
    }),
...
}`,...(Gs=(Es=z.parameters)==null?void 0:Es.docs)==null?void 0:Gs.source}}};var Vs,Ds,Us;H.parameters={...H.parameters,docs:{...(Vs=H.parameters)==null?void 0:Vs.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: linearSystemQuestion
    }),
...
}`,...(Us=(Ds=H.parameters)==null?void 0:Ds.docs)==null?void 0:Us.source}}};var Js,zs,Hs;$.parameters={...$.parameters,docs:{...(Js=$.parameters)==null?void 0:Js.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: pointQuestion
    }),
...
}`,...(Hs=(zs=$.parameters)==null?void 0:zs.docs)==null?void 0:Hs.source}}};var $s,Ms,Ks;M.parameters={...M.parameters,docs:{...($s=M.parameters)==null?void 0:$s.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: polygonQuestion
    }),
...
}`,...(ct=(it=X.parameters)==null?void 0:it.docs)==null?void 0:ct.source}}};const Rn=["SideBySideFlipbook","Angle","Circle","Linear","LinearSystem","Point","Polygon","UnlimitedPolygon","Ray","Segment","Sinusoid","LockedPoints","LockedLines","AllLockedLineSegmentStyles","AllLockedLineStyles","AllLockedRayStyles","LockedVector","LockedEllipse","LockedPolygon","LockedLabel","PolygonReadOnly","StaticGraph","StaticGraphWithAnotherWidget","TooltipsWithFloatingPointIssues","AnswerlessAngle","AnswerlessCircle","AnswerlessLinear","AnswerlessLinearSystem","AnswerlessPoint","AnswerlessPolygon","AnswerlessUnlimitedPolygon","AnswerlessRay","AnswerlessSegment","AnswerlessSinusoid"];export{_ as AllLockedLineSegmentStyles,O as AllLockedLineStyles,N as AllLockedRayStyles,k as Angle,U as AnswerlessAngle,J as AnswerlessCircle,z as AnswerlessLinear,H as AnswerlessLinearSystem,$ as AnswerlessPoint,M as AnswerlessPolygon,Y as AnswerlessRay,Z as AnswerlessSegment,X as AnswerlessSinusoid,K as AnswerlessUnlimitedPolygon,j as Circle,P as Linear,L as LinearSystem,B as LockedEllipse,G as LockedLabel,R as LockedLines,W as LockedPoints,E as LockedPolygon,F as LockedVector,A as Point,T as Polygon,y as PolygonReadOnly,b as Ray,v as Segment,S as SideBySideFlipbook,C as Sinusoid,f as StaticGraph,V as StaticGraphWithAnotherWidget,D as TooltipsWithFloatingPointIssues,Q as UnlimitedPolygon,Rn as __namedExportsOrder,Wn as default};
