var nn=Object.defineProperty;var rn=(r,n,e)=>n in r?nn(r,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[n]=e;var l=(r,n,e)=>(rn(r,typeof n!="symbol"?n+"":n,e),e);import{j as c}from"./jsx-runtime-BT65X5dW.js";import{_ as p,u as tn}from"./underscore-U-AHniOr.js";import{x as Ae,A as an}from"./core-widget-registry-DemQrLPv.js";import{P as Y,E}from"./perseus-error-CSETqePQ.js";import{g as sn,U as on,E as Ne,F as un,G as ln,H as dn}from"./util-BU0fl0Cx.js";import{P as M}from"./index-CrGd2QqM.js";import{$ as mn}from"./jquery-CkHB0_Mt.js";import{e as gn}from"./index-BzwLglMS.js";import{c as we}from"./index-D7h-teXI.js";import{r as j}from"./index-C6mWTJJr.js";import{h as fe}from"./index-B1Gws05u.js";import{Z as pn,c as ce}from"./zoomable-tex-Dy-nElJT.js";import{a as cn}from"./i18n-context-3AkWzTTj.js";import{L as $,S as yn}from"./svg-image-DAY0n-SP.js";import{T as Ee}from"./tex-BONImhZG.js";import{Z as hn}from"./zoomable-C_CCSKDG.js";import{g as B,D as bn}from"./dependencies-BsVPGK1s.js";import{A as wn,C as ye}from"./perseus-api-Ty_QvlNi.js";import{L as fn}from"./lint-D0FI20JF.js";import{c as kn,t as vn,u as qn}from"./constants-BIpV3g0K.js";class z{static parse(n){return new ue(n).parse()}match(n){throw new Y("Selector subclasses must implement match()",E.NotAllowed)}toString(){return"Unknown selector class"}}const me=class me{constructor(n){l(this,"tokens");l(this,"tokenIndex");n=n.trim().replace(/\s+/g," "),this.tokens=n.match(me.TOKENS)||[],this.tokenIndex=0}nextToken(){return this.tokens[this.tokenIndex]||""}consume(){this.tokenIndex++}isIdentifier(){const n=this.tokens[this.tokenIndex][0];return n>="a"&&n<="z"||n>="A"&&n<="Z"}skipSpace(){for(;this.nextToken()===" ";)this.consume()}parse(){const n=this.parseTreeSelector();let e=this.nextToken();if(!e)return n;const t=[n];for(;e;){if(e===",")this.consume();else throw new he("Expected comma");t.push(this.parseTreeSelector()),e=this.nextToken()}return new xn(t)}parseTreeSelector(){this.skipSpace();let n=this.parseNodeSelector();for(;;){const e=this.nextToken();if(!e||e===",")break;if(e===" ")this.consume(),n=new An(n,this.parseNodeSelector());else if(e===">")this.consume(),n=new Cn(n,this.parseNodeSelector());else if(e==="+")this.consume(),n=new Sn(n,this.parseNodeSelector());else if(e==="~")this.consume(),n=new Rn(n,this.parseNodeSelector());else throw new he("Unexpected token: "+e)}return n}parseNodeSelector(){this.skipSpace();const n=this.nextToken();if(n==="*")return this.consume(),new Tn;if(this.isIdentifier())return this.consume(),new Pn(n);throw new he("Expected node type")}};l(me,"TOKENS");let ue=me;ue.TOKENS=/([a-zA-Z][\w-]*)|(\d+)|[^\s]|(\s(?=[a-zA-Z\*]))/g;class he extends Error{constructor(n){super(n)}}class xn extends z{constructor(e){super();l(this,"selectors");this.selectors=e}match(e){for(let t=0;t<this.selectors.length;t++){const i=this.selectors[t].match(e);if(i)return i}return null}toString(){let e="";for(let t=0;t<this.selectors.length;t++)e+=t>0?", ":"",e+=this.selectors[t].toString();return e}}class Tn extends z{match(n){return[n.currentNode()]}toString(){return"*"}}class Pn extends z{constructor(e){super();l(this,"type");this.type=e}match(e){const t=e.currentNode();return t.type===this.type?[t]:null}toString(){return this.type}}class ge extends z{constructor(e,t){super();l(this,"left");l(this,"right");this.left=e,this.right=t}}class An extends ge{constructor(n,e){super(n,e)}match(n){const e=this.right.match(n);if(e)for(n=n.clone();n.hasParent();){n.goToParent();const t=this.left.match(n);if(t)return t.concat(e)}return null}toString(){return this.left.toString()+" "+this.right.toString()}}class Cn extends ge{constructor(n,e){super(n,e)}match(n){const e=this.right.match(n);if(e&&n.hasParent()){n=n.clone(),n.goToParent();const t=this.left.match(n);if(t)return t.concat(e)}return null}toString(){return this.left.toString()+" > "+this.right.toString()}}class Sn extends ge{constructor(n,e){super(n,e)}match(n){const e=this.right.match(n);if(e&&n.hasPreviousSibling()){n=n.clone(),n.goToPreviousSibling();const t=this.left.match(n);if(t)return t.concat(e)}return null}toString(){return this.left.toString()+" + "+this.right.toString()}}class Rn extends ge{constructor(n,e){super(n,e)}match(n){const e=this.right.match(n);if(e)for(n=n.clone();n.hasPreviousSibling();){n.goToPreviousSibling();const t=this.left.match(n);if(t)return t.concat(e)}return null}toString(){return this.left.toString()+" ~ "+this.right.toString()}}const L=class L{constructor(n,e,t,a,i,o){l(this,"name");l(this,"severity");l(this,"selector");l(this,"pattern");l(this,"lint");l(this,"applies");l(this,"message");if(!t&&!a)throw new Y("Lint rules must have a selector or pattern",E.InvalidInput,{metadata:{name:n}});this.name=n||"unnamed rule",this.severity=e||L.Severity.BULK_WARNING,this.selector=t||L.DEFAULT_SELECTOR,this.pattern=a||null,typeof i=="function"?(this.lint=i,this.message=null):(this.lint=(...s)=>this._defaultLintFunction(...s),this.message=i),this.applies=o||function(){return!0}}static makeRule(n){return new L(n.name,n.severity,n.selector?z.parse(n.selector):null,L.makePattern(n.pattern),n.lint||n.message,n.applies)}check(n,e,t,a){const i=this.selector.match(e);if(!i)return null;let o;if(this.pattern?o=t.match(this.pattern):o=L.FakePatternMatch(t,t,0),!o)return null;try{const s=this.lint(e,t,i,o,a);return s?typeof s=="string"?{rule:this.name,severity:this.severity,message:s,start:0,end:t.length}:{rule:this.name,severity:this.severity,message:s.message,start:s.start,end:s.end}:null}catch(s){return{rule:"lint-rule-failure",message:`Exception in rule ${this.name}: ${s.message}
Stack trace:
${s.stack}`,start:0,end:t.length}}}_defaultLintFunction(n,e,t,a,i){return{message:this.message||"",start:a.index,end:a.index+a[0].length}}static makePattern(n){if(!n)return null;if(n instanceof RegExp)return n;if(n[0]==="/"){const e=n.lastIndexOf("/"),t=n.substring(1,e),a=n.substring(e+1);return new RegExp(t,a)}return new RegExp(n)}static FakePatternMatch(n,e,t){const a=[e];return a.index=t,a.input=n,a}};l(L,"DEFAULT_SELECTOR"),l(L,"Severity",{ERROR:1,WARNING:2,GUIDELINE:3,BULK_WARNING:4});let m=L;m.DEFAULT_SELECTOR=z.parse("text");const In=/\/\/([^\/]+)/;function Nn(r){if(!r)return"";const n=r.match(In);return n?n[1]:""}const En=m.makeRule({name:"absolute-url",severity:m.Severity.GUIDELINE,selector:"link, image",lint:function(r,n,e,t){const a=e[0].target,i=Nn(a);if(i==="khanacademy.org"||i.endsWith(".khanacademy.org"))return`Don't use absolute URLs:
When linking to KA content or images, omit the
https://www.khanacademy.org URL prefix.
Use a relative URL beginning with / instead.`}}),On=m.makeRule({name:"blockquoted-math",severity:m.Severity.WARNING,selector:"blockQuote math, blockQuote blockMath",message:`Blockquoted math:
math should not be indented.`}),jn=m.makeRule({name:"blockquoted-widget",severity:m.Severity.WARNING,selector:"blockQuote widget",message:`Blockquoted widget:
widgets should not be indented.`}),Xn=m.makeRule({name:"double-spacing-after-terminal",severity:m.Severity.BULK_WARNING,selector:"paragraph",pattern:/[.!\?] {2}/i,message:`Use a single space after a sentence-ending period, or
any other kind of terminal punctuation.`});function Ln(r,n){return`Answer requires a button not found in the button sets: ${r} (in ${n})`}const Yn={"\\sqrt":"prealgebra","\\sin":"trig","\\cos":"trig","\\tan":"trig","\\log":"logarithms","\\ln":"logarithms"},Wn=m.makeRule({name:"expression-widget",severity:m.Severity.WARNING,selector:"widget",lint:function(r,n,e,t,a){var d;if(r.currentNode().widgetType!=="expression")return;const i=r.currentNode().id;if(!i)return;const o=(d=a==null?void 0:a.widgets)==null?void 0:d[i];if(!o)return;const s=o.options.answerForms,u=o.options.buttonSets;for(const g of s)for(const[y,w]of Object.entries(Yn))if(g.value.includes(y)&&!u.includes(w))return Ln(y,w)}}),Mn=m.makeRule({name:"extra-content-spacing",selector:"paragraph",pattern:/\s+$/,applies:function(r){return(r==null?void 0:r.contentType)==="article"},message:"No extra whitespace at the end of content blocks."}),Gn=m.makeRule({name:"heading-level-1",severity:m.Severity.WARNING,selector:"heading",lint:function(r,n,e,t){if(e[0].level===1)return`Don't use level-1 headings:
Begin headings with two or more # characters.`}}),Fn=m.makeRule({name:"heading-level-skip",severity:m.Severity.WARNING,selector:"heading ~ heading",lint:function(r,n,e,t){const a=e[1],i=e[0];if(a.level>i.level+1)return`Skipped heading level:
this heading is level ${a.level} but
the previous heading was level ${i.level}`}}),Dn=m.makeRule({name:"heading-sentence-case",severity:m.Severity.GUIDELINE,selector:"heading",pattern:/^\W*[a-z]/,message:`First letter is lowercase:
the first letter of a heading should be capitalized.`}),_n={and:!0,nor:!0,but:!0,the:!0,for:!0};function Un(r){const n=r[0];return n===n.toUpperCase()}const Vn=m.makeRule({name:"heading-title-case",severity:m.Severity.GUIDELINE,selector:"heading",pattern:/[^\s:]\s+[A-Z]+[a-z]/,locale:"en",lint:function(r,n,e,t){let i=n.trim().split(/\s+/);if(i.shift(),i=i.filter(o=>o.length>2&&!_n.hasOwnProperty(o)),i.length>=3&&i.every(o=>Un(o)))return`Title-case heading:
This heading appears to be in title-case, but should be sentence-case.
Only capitalize the first letter and proper nouns.`}}),zn=m.makeRule({name:"image-alt-text",severity:m.Severity.WARNING,selector:"image",lint:function(r,n,e,t){const a=e[0];if(!a.alt||!a.alt.trim())return`Images should have alt text:
...
This image's alt text is only ${a.alt.length} characters long.`}}),Hn=m.makeRule({name:"image-in-table",severity:m.Severity.BULK_WARNING,selector:"table image",message:`Image in table:
do not put images inside of tables.`}),Kn=m.makeRule({name:"image-spaces-around-urls",severity:m.Severity.ERROR,selector:"image",lint:function(r,n,e,t,a){const o=e[0].target;if(a&&a.content){const s=a.content.indexOf(o);if(s===-1)return;if(a.content[s-1]!=="("||a.content[s+o.length]!==")")return`Whitespace before or after image url:
For images, don't include any space or newlines after '(' or before ')'.
Whitespace in image URLs causes translation difficulties.`}}}),Bn=m.makeRule({name:"image-url-empty",severity:m.Severity.ERROR,selector:"image",lint:function(r,n,e){const a=e[0].target;if(!a||!a.trim())return"Images should have a URL"}}),Qn=m.makeRule({name:"image-widget",severity:m.Severity.WARNING,selector:"widget",lint:function(r,n,e,t,a){if(r.currentNode().widgetType!=="image")return;const i=r.currentNode().id;if(!i)return;const o=a&&a.widgets&&a.widgets[i];if(!o)return;const s=o.options.alt;if(!s)return`Images should have alt text:
...
Don't include math expressions in image captions.`}}),$n=m.makeRule({name:"link-click-here",severity:m.Severity.WARNING,selector:"link",pattern:/click here/i,message:`Inappropriate link text:
Do not use the words "click here" in links.`}),Jn=m.makeRule({name:"long-paragraph",severity:m.Severity.GUIDELINE,selector:"paragraph",pattern:/^.{501,}/,lint:function(r,n,e,t){return`Paragraph too long:
This paragraph is ${n.length} characters long.
Shorten it to 500 characters or fewer.`}}),Zn=m.makeRule({name:"math-adjacent",severity:m.Severity.WARNING,selector:"blockMath+blockMath",message:`Adjacent math blocks:
combine the blocks between \\begin{align} and \\end{align}`}),er=m.makeRule({name:"math-align-extra-break",severity:m.Severity.WARNING,selector:"blockMath",pattern:/(\\{2,})\s*\\end{align}/,message:`Extra space at end of block:
Don't end an align block with backslashes`}),nr=m.makeRule({name:"math-align-linebreaks",severity:m.Severity.WARNING,selector:"blockMath",pattern:/\\begin{align}[\s\S]*\\\\[\s\S]+\\end{align}/,lint:function(r,n,e,t){let a=t[0];for(;a.length;){const i=a.indexOf("\\\\");if(i===-1)return;a=a.substring(i+2);const o=a.match(/^\s*\\\\\s*(?!\\\\)/);if(!o)return"Use four backslashes between lines of an align block";a=a.substring(o[0].length)}}}),rr=m.makeRule({name:"math-empty",severity:m.Severity.WARNING,selector:"math, blockMath",pattern:/^$/,message:"Empty math: don't use $$ in your markdown."}),tr=m.makeRule({name:"math-frac",severity:m.Severity.GUIDELINE,selector:"math, blockMath",pattern:/\\frac[ {]/,message:"Use \\dfrac instead of \\frac in your math expressions."}),ar=m.makeRule({name:"math-nested",severity:m.Severity.ERROR,selector:"math, blockMath",pattern:/\\text{[^$}]*\$[^$}]*\$[^}]*}/,message:`Nested math:
Don't nest math expressions inside \\text{} blocks`}),ir=m.makeRule({name:"math-starts-with-space",severity:m.Severity.GUIDELINE,selector:"math, blockMath",pattern:/^\s*(~|\\qquad|\\quad|\\,|\\;|\\:|\\ |\\!|\\enspace|\\phantom)/,message:`Math starts with space:
math should not be indented. Do not begin math expressions with
LaTeX space commands like ~, \\;, \\quad, or \\phantom`}),sr=m.makeRule({name:"math-text-empty",severity:m.Severity.WARNING,selector:"math, blockMath",pattern:/\\text{\s*}/,message:"Empty \\text{} block in math expression"}),or=m.makeRule({name:"math-without-dollars",severity:m.Severity.GUIDELINE,pattern:/\\\w+{[^}]*}|{|}/,message:`This looks like LaTeX:
did you mean to put it inside dollar signs?`}),ur=m.makeRule({name:"nested-lists",severity:m.Severity.WARNING,selector:"list list",message:`Nested lists:
nested lists are hard to read on mobile devices;
do not use additional indentation.`}),lr=m.makeRule({name:"static-widget-in-question-stem",severity:m.Severity.WARNING,selector:"widget",lint:(r,n,e,t,a)=>{var s;if((a==null?void 0:a.contentType)!=="exercise"||a.stack.includes("hint"))return;const i=r.currentNode().id;if(!i)return;const o=(s=a==null?void 0:a.widgets)==null?void 0:s[i];if(o&&o.static)return"Widget in question stem is static (non-interactive)."}}),dr=m.makeRule({name:"table-missing-cells",severity:m.Severity.WARNING,selector:"table",lint:function(r,n,e,t){const a=e[0],i=a.header.length,o=a.cells.map(s=>s.length);for(let s=0;s<o.length;s++)if(o[s]!==i)return`Table rows don't match header:
The table header has ${i} cells, but
Row ${s+1} has ${o[s]} cells.`}}),mr=m.makeRule({name:"unbalanced-code-delimiters",severity:m.Severity.ERROR,pattern:/[`~]+/,message:`Unbalanced code delimiters:
code blocks should begin and end with the same type and number of delimiters`}),gr=m.makeRule({name:"unescaped-dollar",severity:m.Severity.ERROR,selector:"unescapedDollar",message:`Unescaped dollar sign:
Dollar signs must appear in pairs or be escaped as \\$`}),pr=m.makeRule({name:"widget-in-table",severity:m.Severity.BULK_WARNING,selector:"table widget",message:`Widget in table:
do not put widgets inside of tables.`}),cr=[En,On,jn,Xn,Bn,Wn,Mn,Gn,Fn,Dn,Vn,zn,Hn,$n,Jn,Zn,er,nr,rr,tr,ar,ir,sr,ur,lr,dr,gr,pr,or,mr,Kn,Qn];class U{constructor(n){l(this,"root");this.root=n}static isNode(n){return n&&typeof n=="object"&&typeof n.type=="string"}static isTextNode(n){return U.isNode(n)&&n.type==="text"&&typeof n.content=="string"}traverse(n){this._traverse(this.root,new Ce(this.root),n)}_traverse(n,e,t){let a="";if(U.isNode(n)){const i=n;e._containers.push(i),e._ancestors.push(i),typeof i.content=="string"&&(a=i.content),Object.keys(i).forEach(s=>{if(s==="type")return;const u=i[s];u&&typeof u=="object"&&(e._indexes.push(s),a+=this._traverse(u,e,t),e._indexes.pop())}),e._currentNode=e._ancestors.pop(),e._containers.pop(),t(i,e,a)}else if(Array.isArray(n)){const i=n;e._containers.push(i);let o=0;for(;o<i.length;)e._indexes.push(o),a+=this._traverse(i[o],e,t),o=e._indexes.pop()+1;e._containers.pop()}return a}}class Ce{constructor(n){l(this,"root");l(this,"_currentNode");l(this,"_containers");l(this,"_indexes");l(this,"_ancestors");this.root=n,this._currentNode=null,this._containers=new Q,this._indexes=new Q,this._ancestors=new Q}currentNode(){return this._currentNode||this.root}parent(){return this._ancestors.top()}ancestors(){return this._ancestors.values()}nextSibling(){const n=this._containers.top();if(!n||!Array.isArray(n))return null;const e=this._indexes.top();return n.length>e+1?n[e+1]:null}previousSibling(){const n=this._containers.top();if(!n||!Array.isArray(n))return null;const e=this._indexes.top();return e>0?n[e-1]:null}removeNextSibling(){const n=this._containers.top();if(n&&Array.isArray(n)){const e=this._indexes.top();if(n.length>e+1)return n.splice(e+1,1)[0]}return null}replace(...n){const e=this._containers.top();if(!e)throw new Y("Can't replace the root of the tree",E.Internal);if(Array.isArray(e)){const t=this._indexes.top();e.splice(t,1,...n),this._indexes.pop(),this._indexes.push(t+n.length-1)}else{const t=this._indexes.top();n.length===0?delete e[t]:n.length===1?e[t]=n[0]:e[t]=n}}hasPreviousSibling(){return Array.isArray(this._containers.top())&&this._indexes.top()>0}goToPreviousSibling(){if(!this.hasPreviousSibling())throw new Y("goToPreviousSibling(): node has no previous sibling",E.Internal);this._currentNode=this.previousSibling();const n=this._indexes.pop();this._indexes.push(n-1)}hasParent(){return this._ancestors.size()!==0}goToParent(){if(!this.hasParent())throw new Y("goToParent(): node has no ancestor",E.NotAllowed);for(this._currentNode=this._ancestors.pop();this._containers.size()&&this._containers.top()[this._indexes.top()]!==this._currentNode;)this._containers.pop(),this._indexes.pop()}clone(){const n=new Ce(this.root);return n._currentNode=this._currentNode,n._containers=this._containers.clone(),n._indexes=this._indexes.clone(),n._ancestors=this._ancestors.clone(),n}equals(n){return this.root===n.root&&this._currentNode===n._currentNode&&this._containers.equals(n._containers)&&this._indexes.equals(n._indexes)&&this._ancestors.equals(n._ancestors)}}class Q{constructor(n){l(this,"stack");this.stack=n?n.slice(0):[]}push(n){this.stack.push(n)}pop(){return this.stack.pop()}top(){return this.stack[this.stack.length-1]}values(){return this.stack.slice(0)}size(){return this.stack.length}toString(){return this.stack.toString()}clone(){return new Q(this.stack)}equals(n){if(!n||!n.stack||n.stack.length!==this.stack.length)return!1;for(let e=0;e<this.stack.length;e++)if(this.stack[e]!==n.stack[e])return!1;return!0}}const yr="@khanacademy/perseus-linter",hr="__lib_version__";Ae(yr,hr);M.shape({contentType:M.string,highlightLint:M.bool,paths:M.arrayOf(M.string),stack:M.arrayOf(M.string)});const Fe={contentType:"",highlightLint:!1,paths:[],stack:[]},br=cr.filter(r=>r.severity<m.Severity.BULK_WARNING);function wr(r,n,e,t=br){const a=[],i=new U(r);i.traverse((u,d,g)=>{if(U.isTextNode(u)){let y=d.nextSibling();for(;U.isTextNode(y);)u.content+=y.content,d.removeNextSibling(),y=d.nextSibling()}});let o=[],s=!1;return i.traverse((u,d,g)=>{const y=[],w=t.filter(h=>h.applies(n)),v=[...n.stack];v.push(u.type);const x={...n,stack:v.join(".")};if(w.forEach(h=>{const k=h.check(u,d,g,x);k&&((k.start||k.end)&&(k.target=g.substring(k.start,k.end)),a.push(k),y.push(k))}),u.type==="table"?(o.length&&y.push(...o),s=!1,o=[]):s||(s=d.ancestors().some(h=>h.type==="table")),s&&y.length&&o.push(...y),y.length)if(y.sort((h,k)=>h.severity-k.severity),u.type!=="text"||y.length>1)d.replace({type:"lint",content:u,message:y.map(h=>h.message).join(`

`),ruleName:y[0].rule,blockHighlight:x.blockHighlight,insideTable:s,severity:y[0].severity});else{const h=u.content,k=y[0],A=k.start||0,R=k.end||h.length,W=h.substring(0,A),C=h.substring(A,R),ne=h.substring(R),re=[];W&&re.push({type:"text",content:W}),re.push({type:"lint",content:{type:"text",content:C},message:k.message,ruleName:k.rule,insideTable:s,severity:k.severity}),ne&&re.push({type:"text",content:ne}),d.replace(...re)}}),a}function fr(r,n){const e=r.stack||[];return{...r,stack:e.concat(n)}}const kr={activeDefinitionId:null,setActiveDefinitionId:()=>{}},De=j.createContext(kr);class ke extends j.Component{constructor(){super(...arguments);l(this,"state",{activeDefinitionId:null});l(this,"setActiveDefinitionId",e=>{this.setState(t=>({activeDefinitionId:e}))})}render(){const{children:e}=this.props,{activeDefinitionId:t}=this.state,{setActiveDefinitionId:a}=this;return c.jsx(De.Provider,{value:{activeDefinitionId:t,setActiveDefinitionId:a},children:e})}}const Vt=De.Consumer;ke.__docgenInfo={description:"",methods:[{name:"setActiveDefinitionId",docblock:null,modifiers:[],params:[{name:"activeDefinitionId",optional:!0,type:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]}}],returns:{type:{name:"void"}}}],displayName:"DefinitionProvider",props:{children:{required:!0,tsType:{name:"any"},description:""}}};class O extends j.Component{constructor(n){super(n),this.state={error:""}}componentDidCatch(n,e){var t,a;this.setState({error:n.toString()}),(a=(t=this.props).onError)==null||a.call(t,n,e),$.error("Unhandled Perseus error: "+n.message,E.Internal,{cause:n,loggedMetadata:{componentStack:e&&"componentStack"in e?e.componentStack:"componentStack not provided",...this.props.metadata}})}render(){return this.state.error?c.jsxs("svg",{height:"16",width:"16",viewBox:"0 0 16 16",role:"img",children:[c.jsx("title",{children:"Rendering Error!"}),c.jsx("path",{d:"m8 16c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm0-3c0.55 0 1-0.45 1-1s-0.45-1-1-1-1 0.45-1 1 0.45 1 1 1zm0-9c-0.55 0-1 0.45-1 1v4c0 0.55.45 1 1 1s1-0.45 1-1v-4c0-0.55-0.45-1-1-1z",fill:"#d92916",fillRule:"evenodd"})]}):this.props.children}}O.__docgenInfo={description:"",methods:[],displayName:"ErrorBoundary",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},metadata:{required:!1,tsType:{name:"Record",elements:[{name:"string"},{name:"string"}],raw:"Record<string, string>"},description:""},onError:{required:!1,tsType:{name:"signature",type:"function",raw:"(error: Error, info: any) => void",signature:{arguments:[{type:{name:"Error"},name:"error"},{type:{name:"any"},name:"info"}],return:{name:"void"}}},description:""}}};function vr(){}class qr{constructor(n,e,t,a){l(this,"_tracked");l(this,"setting");l(this,"track");l(this,"trackApi");l(this,"widgetID");l(this,"widgetType");l(this,"_track",n=>{this._tracked&&!this.setting||(this._tracked=!0,this.trackApi({type:this.widgetType,id:this.widgetID,...n}))});n?(this._tracked=!1,this.trackApi=n,this.widgetType=e,this.widgetID=t,this.setting=a,this.track=this._track):this.track=vr}}const xr="@khanacademy/simple-markdown",Tr="__lib_version__";Ae(xr,Tr);var Pr=/\r\n?/g,Ar=/\t/g,Cr=/\f/g,_e=function(r){return r.replace(Pr,`
`).replace(Cr,"").replace(Ar,"    ")},Ue=function(r,n){var e=r||{};if(n!=null)for(var t in n)Object.prototype.hasOwnProperty.call(n,t)&&(e[t]=n[t]);return e},Ve=function(r,n){var e=Object.keys(r).filter(function(o){var s=r[o];if(s==null||s.match==null)return!1;var u=s.order;return(typeof u!="number"||!isFinite(u))&&typeof console<"u"&&console.warn("simple-markdown: Invalid order for rule `"+o+"`: "+String(u)),!0});e.sort(function(o,s){var u=r[o],d=r[s],g=u.order,y=d.order;if(g!==y)return g-y;var w=u.quality?0:1,v=d.quality?0:1;return w!==v?w-v:o<s?-1:o>s?1:0});var t,a=function(o,s){var u=[];for(s=s||t,t=s;o;){var d=null,g=null,y=null,w=NaN,v=0,x=e[0],h=r[x];do{var k=h.order,A=s.prevCapture==null?"":s.prevCapture[0],R=h.match(o,s,A);if(R){var W=h.quality?h.quality(R,s,A):0;W<=w||(d=x,g=h,y=R,w=W)}v++,x=e[v],h=r[x]}while(h&&(!y||h.order===k&&h.quality));if(g==null||y==null)throw new Error("Could not find a matching rule for the below content. The rule with highest `order` should always match content provided to it. Check the definition of `match` for '"+e[e.length-1]+`'. It seems to not match the following source:
`+o);if(y.index)throw new Error("`match` must return a capture starting at index 0 (the current parse index). Did you forget a ^ at the start of the RegExp?");var C=g.parse(y,a,s);if(Array.isArray(C))Array.prototype.push.apply(u,C);else{if(C==null||typeof C!="object")throw new Error(`parse() function returned invalid parse result: '${C}'`);C.type==null&&(C.type=d),u.push(C)}s.prevCapture=y,o=o.substring(s.prevCapture[0].length)}return u},i=function(o,s){return t=Ue(s,n),!t.inline&&!t.disableAutoBlockNewlines&&(o=o+`

`),t.prevCapture=null,a(_e(o),t)};return i},S=function(r){var n=function(e,t,a){return t.inline?r.exec(e):null};return n.regex=r,n},N=function(r){var n=function(e,t){return t.inline?null:r.exec(e)};return n.regex=r,n},ve=function(r){var n=function(e,t){return r.exec(e)};return n.regex=r,n},Sr=typeof Symbol=="function"&&Symbol.for&&Symbol.for("react.element")||60103,q=function(r,n,e){var t={$$typeof:Sr,type:r,key:n??void 0,ref:null,props:e,_owner:null};return t},T=function(r,n,e,t){e=e||{},t=typeof t<"u"?t:!0;var a="";for(var i in e){var o=e[i];Object.prototype.hasOwnProperty.call(e,i)&&o&&(a+=" "+V(i)+'="'+V(o)+'"')}var s="<"+r+a+">";return t?s+n+"</"+r+">":s},Rr={},K=function(r){if(r==null)return null;try{var n=new URL(r,"https://localhost").protocol;if(n.indexOf("javascript:")===0||n.indexOf("vbscript:")===0||n.indexOf("data:")===0)return null}catch{return null}return r},Ir=/[<>&"']/g,Nr={"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;","'":"&#x27;","/":"&#x2F;","`":"&#96;"},V=function(r){return String(r).replace(Ir,function(n){return Nr[n]})},Er=/\\([^0-9A-Za-z\s])/g,qe=function(r){return r.replace(Er,"$1")},le=function(r,n,e){var t=e.inline||!1;e.inline=!0;var a=r(n,e);return e.inline=t,a},Or=function(r,n,e){var t=e.inline||!1;e.inline=!1;var a=r(n+`

`,e);return e.inline=t,a},te=function(r,n,e){return{content:le(n,r[1],e)}},be=function(){return{}},de="(?:[*+-]|\\d+\\.)",ze="( *)("+de+") +",Oe=new RegExp("^"+ze),jr=new RegExp(ze+"[^\\n]*(?:\\n(?!\\1"+de+` )[^\\n]*)*(
|$)`,"gm"),He=/\n{2,}$/,Xr=/^ (?= *`)|(` *) $/g,Lr=He,je=/ *\n+$/,Yr=new RegExp("^( *)("+de+`) [\\s\\S]+?(?:
{2,}(?! )(?!\\1`+de+` )\\n*|\\s*
*$)`),Wr=/(?:^|\n)( *)$/,ae=function(){var r=/^ *\| *| *\| *$/g,n=/ *$/,e=/^ *-+: *$/,t=/^ *:-+: *$/,a=/^ *:-+ *$/,i=function(g){return e.test(g)?"right":t.test(g)?"center":a.test(g)?"left":null},o=function(g,y,w,v){v&&(g=g.replace(r,""));var x=g.trim().split("|");return x.map(i)},s=function(g,y,w,v){var x=w.inTable;w.inTable=!0;var h=y(g.trim(),w);w.inTable=x;var k=[[]];return h.forEach(function(A,R){A.type==="tableSeparator"?(!v||R!==0&&R!==h.length-1)&&k.push([]):(A.type==="text"&&(h[R+1]==null||h[R+1].type==="tableSeparator")&&(A.content=A.content.replace(n,"")),k[k.length-1].push(A))}),k},u=function(g,y,w,v){var x=g.trim().split(`
`);return x.map(function(h){return s(h,y,w,v)})},d=function(g){return function(y,w,v){v.inline=!0;var x=s(y[1],w,v,g),h=o(y[2],w,v,g),k=u(y[3],w,v,g);return v.inline=!1,{type:"table",header:x,align:h,cells:k}}};return{parseTable:d(!0),parseNpTable:d(!1),TABLE_REGEX:/^ *(\|.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/,NPTABLE_REGEX:/^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/}}(),ie="(?:\\[[^\\]]*\\]|[^\\[\\]]|\\](?=[^\\[]*\\]))*",Xe=`\\s*<?((?:\\([^)]*\\)|[^\\s\\\\]|\\\\.)*?)>?(?:\\s+['"]([\\s\\S]*?)['"])?\\s*`,Mr=/mailto:/i,Le=function(r,n,e){var t=(r[2]||r[1]).replace(/\s+/g," ").toLowerCase();if(n._defs&&n._defs[t]){var a=n._defs[t];e.target=a.target,e.title=a.title}return n._refs=n._refs||{},n._refs[t]=n._refs[t]||[],n._refs[t].push(e),e},f=0,ee={Array:{react:function(r,n,e){for(var t=e.key,a=[],i=0,o=0;i<r.length;i++,o++){e.key=""+i;var s=r[i];if(s.type==="text")for(s={type:"text",content:s.content};i+1<r.length&&r[i+1].type==="text";i++)s.content+=r[i+1].content;a.push(n(s,e))}return e.key=t,a},html:function(r,n,e){for(var t="",a=0;a<r.length;a++){var i=r[a];if(i.type==="text")for(i={type:"text",content:i.content};a+1<r.length&&r[a+1].type==="text";a++)i.content+=r[a+1].content;t+=n(i,e)}return t}},heading:{order:f++,match:N(/^ *(#{1,6})([^\n]+?)#* *(?:\n *)+\n/),parse:function(r,n,e){return{level:r[1].length,content:le(n,r[2].trim(),e)}},react:function(r,n,e){return q("h"+r.level,e.key,{children:n(r.content,e)})},html:function(r,n,e){return T("h"+r.level,n(r.content,e))}},nptable:{order:f++,match:N(ae.NPTABLE_REGEX),parse:ae.parseNpTable,react:null,html:null},lheading:{order:f++,match:N(/^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/),parse:function(r,n,e){return{type:"heading",level:r[2]==="="?1:2,content:le(n,r[1],e)}},react:null,html:null},hr:{order:f++,match:N(/^( *[-*_]){3,} *(?:\n *)+\n/),parse:be,react:function(r,n,e){return q("hr",e.key,{"aria-hidden":!0})},html:function(r,n,e){return'<hr aria-hidden="true">'}},codeBlock:{order:f++,match:N(/^(?:    [^\n]+\n*)+(?:\n *)+\n/),parse:function(r,n,e){var t=r[0].replace(/^    /gm,"").replace(/\n+$/,"");return{lang:void 0,content:t}},react:function(r,n,e){var t=r.lang?"markdown-code-"+r.lang:void 0;return q("pre",e.key,{children:q("code",null,{className:t,children:r.content})})},html:function(r,n,e){var t=r.lang?"markdown-code-"+r.lang:void 0,a=T("code",V(r.content),{class:t});return T("pre",a)}},fence:{order:f++,match:N(/^ *(`{3,}|~{3,}) *(?:(\S+) *)?\n([\s\S]+?)\n?\1 *(?:\n *)+\n/),parse:function(r,n,e){return{type:"codeBlock",lang:r[2]||void 0,content:r[3]}},react:null,html:null},blockQuote:{order:f++,match:N(/^( *>[^\n]+(\n[^\n]+)*\n*)+\n{2,}/),parse:function(r,n,e){var t=r[0].replace(/^ *> ?/gm,"");return{content:n(t,e)}},react:function(r,n,e){return q("blockquote",e.key,{children:n(r.content,e)})},html:function(r,n,e){return T("blockquote",n(r.content,e))}},list:{order:f++,match:function(r,n){var e=n.prevCapture==null?"":n.prevCapture[0],t=Wr.exec(e),a=n._list||!n.inline;return t&&a?(r=t[1]+r,Yr.exec(r)):null},parse:function(r,n,e){var t=r[2],a=t.length>1,i=a?+t:void 0,o=r[0].replace(Lr,`
`).match(jr),s=!1,u=o.map(function(d,g){var y=Oe.exec(d),w=y?y[0].length:0,v=new RegExp("^ {1,"+w+"}","gm"),x=d.replace(v,"").replace(Oe,""),h=g===o.length-1,k=x.indexOf(`

`)!==-1,A=k||h&&s;s=A;var R=e.inline,W=e._list;e._list=!0;var C;A?(e.inline=!1,C=x.replace(je,`

`)):(e.inline=!0,C=x.replace(je,""));var ne=n(C,e);return e.inline=R,e._list=W,ne});return{ordered:a,start:i,items:u}},react:function(r,n,e){var t=r.ordered?"ol":"ul";return q(t,e.key,{start:r.start,children:r.items.map(function(a,i){return q("li",""+i,{children:n(a,e)})})})},html:function(r,n,e){var t=r.items.map(function(o){return T("li",n(o,e))}).join(""),a=r.ordered?"ol":"ul",i={start:r.start};return T(a,t,i)}},def:{order:f++,match:N(/^ *\[([^\]]+)\]: *<?([^\s>]*)>?(?: +["(]([^\n]+)[")])? *\n(?: *\n)*/),parse:function(r,n,e){var t=r[1].replace(/\s+/g," ").toLowerCase(),a=r[2],i=r[3];return e._refs&&e._refs[t]&&e._refs[t].forEach(function(o){o.target=a,o.title=i}),e._defs=e._defs||{},e._defs[t]={target:a,title:i},{def:t,target:a,title:i}},react:function(){return null},html:function(){return""}},table:{order:f++,match:N(ae.TABLE_REGEX),parse:ae.parseTable,react:function(r,n,e){var t=function(o){return r.align[o]==null?{}:{textAlign:r.align[o]}},a=r.header.map(function(o,s){return q("th",""+s,{style:t(s),scope:"col",children:n(o,e)})}),i=r.cells.map(function(o,s){return q("tr",""+s,{children:o.map(function(u,d){return q("td",""+d,{style:t(d),children:n(u,e)})})})});return q("table",e.key,{children:[q("thead","thead",{children:q("tr",null,{children:a})}),q("tbody","tbody",{children:i})]})},html:function(r,n,e){var t=function(u){return r.align[u]==null?"":"text-align:"+r.align[u]+";"},a=r.header.map(function(u,d){return T("th",n(u,e),{style:t(d),scope:"col"})}).join(""),i=r.cells.map(function(u){var d=u.map(function(g,y){return T("td",n(g,e),{style:t(y)})}).join("");return T("tr",d)}).join(""),o=T("thead",T("tr",a)),s=T("tbody",i);return T("table",o+s)}},newline:{order:f++,match:N(/^(?:\n *)*\n/),parse:be,react:function(r,n,e){return`
`},html:function(r,n,e){return`
`}},paragraph:{order:f++,match:N(/^((?:[^\n]|\n(?! *\n))+)(?:\n *)+\n/),parse:te,react:function(r,n,e){return q("div",e.key,{className:"paragraph",children:n(r.content,e)})},html:function(r,n,e){var t={class:"paragraph"};return T("div",n(r.content,e),t)}},escape:{order:f++,match:S(/^\\([^0-9A-Za-z\s])/),parse:function(r,n,e){return{type:"text",content:r[1]}},react:null,html:null},tableSeparator:{order:f++,match:function(r,n){return n.inTable?/^ *\| */.exec(r):null},parse:function(){return{type:"tableSeparator"}},react:function(){return" | "},html:function(){return" &vert; "}},autolink:{order:f++,match:S(/^<([^: >]+:\/[^ >]+)>/),parse:function(r,n,e){return{type:"link",content:[{type:"text",content:r[1]}],target:r[1]}},react:null,html:null},mailto:{order:f++,match:S(/^<([^ >]+@[^ >]+)>/),parse:function(r,n,e){var t=r[1],a=r[1];return Mr.test(a)||(a="mailto:"+a),{type:"link",content:[{type:"text",content:t}],target:a}},react:null,html:null},url:{order:f++,match:S(/^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/),parse:function(r,n,e){return{type:"link",content:[{type:"text",content:r[1]}],target:r[1],title:void 0}},react:null,html:null},link:{order:f++,match:S(new RegExp("^\\[("+ie+")\\]\\("+Xe+"\\)")),parse:function(r,n,e){var t={content:n(r[1],e),target:qe(r[2]),title:r[3]};return t},react:function(r,n,e){return q("a",e.key,{href:K(r.target),title:r.title,children:n(r.content,e)})},html:function(r,n,e){var t={href:K(r.target),title:r.title};return T("a",n(r.content,e),t)}},image:{order:f++,match:S(new RegExp("^!\\[("+ie+")\\]\\("+Xe+"\\)")),parse:function(r,n,e){var t={alt:r[1],target:qe(r[2]),title:r[3]};return t},react:function(r,n,e){return q("img",e.key,{src:K(r.target),alt:r.alt,title:r.title})},html:function(r,n,e){var t={src:K(r.target),alt:r.alt,title:r.title};return T("img","",t,!1)}},reflink:{order:f++,match:S(new RegExp("^\\[("+ie+")\\]\\s*\\[([^\\]]*)\\]")),parse:function(r,n,e){return Le(r,e,{type:"link",content:n(r[1],e)})},react:null,html:null},refimage:{order:f++,match:S(new RegExp("^!\\[("+ie+")\\]\\s*\\[([^\\]]*)\\]")),parse:function(r,n,e){return Le(r,e,{type:"image",alt:r[1]})},react:null,html:null},em:{order:f,match:S(new RegExp("^\\b_((?:__|\\\\[\\s\\S]|[^\\\\_])+?)_\\b|^\\*(?=\\S)((?:\\*\\*|\\\\[\\s\\S]|\\s+(?:\\\\[\\s\\S]|[^\\s\\*\\\\]|\\*\\*)|[^\\s\\*\\\\])+?)\\*(?!\\*)")),quality:function(r){return r[0].length+.2},parse:function(r,n,e){return{content:n(r[2]||r[1],e)}},react:function(r,n,e){return q("em",e.key,{children:n(r.content,e)})},html:function(r,n,e){return T("em",n(r.content,e))}},strong:{order:f,match:S(/^\*\*((?:\\[\s\S]|[^\\])+?)\*\*(?!\*)/),quality:function(r){return r[0].length+.1},parse:te,react:function(r,n,e){return q("strong",e.key,{children:n(r.content,e)})},html:function(r,n,e){return T("strong",n(r.content,e))}},u:{order:f++,match:S(/^__((?:\\[\s\S]|[^\\])+?)__(?!_)/),quality:function(r){return r[0].length},parse:te,react:function(r,n,e){return q("u",e.key,{children:n(r.content,e)})},html:function(r,n,e){return T("u",n(r.content,e))}},del:{order:f++,match:S(/^~~(?=\S)((?:\\[\s\S]|~(?!~)|[^\s~\\]|\s(?!~~))+?)~~/),parse:te,react:function(r,n,e){return q("del",e.key,{children:n(r.content,e)})},html:function(r,n,e){return T("del",n(r.content,e))}},inlineCode:{order:f++,match:S(/^(`+)([\s\S]*?[^`])\1(?!`)/),parse:function(r,n,e){return{content:r[2].replace(Xr,"$1")}},react:function(r,n,e){return q("code",e.key,{children:r.content})},html:function(r,n,e){return T("code",V(r.content))}},br:{order:f++,match:ve(/^ {2,}\n/),parse:be,react:function(r,n,e){return q("br",e.key,Rr)},html:function(r,n,e){return"<br>"}},text:{order:f++,match:ve(/^[\s\S]+?(?=[^0-9A-Za-z\s\u00c0-\uffff]|\n\n| {2,}\n|\w+:\S|$)/),parse:function(r,n,e){return{content:r[0]}},react:function(r,n,e){return r.content},html:function(r,n,e){return V(r.content)}}},Gr=function(r,n){!n&&typeof console<"u"&&console.warn("simple-markdown ruleOutput should take 'react' or 'html' as the second argument.");var e=function(t,a,i){return r[t.type][n](t,a,i)};return e},Fr=function(r){var n=function(e,t){if(t=t||{},Array.isArray(e)){for(var a=t.key,i=[],o=null,s=0;s<e.length;s++){t.key=""+s;var u=n(e[s],t);typeof u=="string"&&typeof o=="string"?(o=o+u,i[i.length-1]=o):(i.push(u),o=u)}return t.key=a,i}else return r(e,n,t)};return n},Dr=function(r){var n=function(e,t){return t=t||{},Array.isArray(e)?e.map(function(a){return n(a,t)}).join(""):r(e,n,t)};return n},Se=function(r,n,e={}){if(!n)throw new Error("simple-markdown: outputFor: `property` must be defined. if you just upgraded, you probably need to replace `outputFor` with `reactFor`");var t,a=r.Array||ee.Array,i=a[n];if(!i)throw new Error("simple-markdown: outputFor: to join nodes of type `"+n+"` you must provide an `Array:` joiner rule with that type, Please see the docs for details on specifying an Array rule.");var o=i,s=function(d,g){return g=g||t,t=g,Array.isArray(d)?o(d,s,g):r[d.type][n](d,s,g)},u=function(d,g){return t=Ue(g,e),s(d,t)};return u},pe=Ve(ee),Re=function(r,n){return n=n||{},n.inline=!1,pe(r,n)},_r=function(r,n){return n=n||{},n.inline=!0,pe(r,n)},Ye=function(r,n){var e=He.test(r);return n=n||{},n.inline=!e,pe(r,n)},xe=Se(ee,"react"),Ke=Se(ee,"html"),Be=function(r,n){return xe(Re(r,n),n)},Ur=function(r,n){return Ke(Re(r,n),n)},Vr=function(r){var n={};for(var e in r)e!=="source"&&Object.prototype.hasOwnProperty.call(r,e)&&(n[e]=r[e]);return n.children=Be(r.source),q("div",null,n)},b={defaultRules:ee,parserFor:Ve,outputFor:Se,inlineRegex:S,blockRegex:N,anyScopeRegex:ve,parseInline:le,parseBlock:Or,markdownToReact:Be,markdownToHtml:Ur,ReactMarkdown:Vr,defaultBlockParse:Re,defaultInlineParse:_r,defaultImplicitParse:Ye,defaultReactOutput:xe,defaultHtmlOutput:Ke,preprocess:_e,sanitizeText:V,sanitizeUrl:K,unescapeUrl:qe,htmlTag:T,reactElement:q,defaultRawParse:pe,ruleOutput:Gr,reactFor:Fr,htmlFor:Dr,defaultParse:function(...r){return typeof console<"u"&&console.warn("defaultParse is deprecated, please use `defaultImplicitParse`"),Ye.apply(null,r)},defaultOutput:function(...r){return typeof console<"u"&&console.warn("defaultOutput is deprecated, please use `defaultReactOutput`"),xe.apply(null,r)}};const zr={fence:{match:b.defaultRules.fence.match,order:1,parse:(r,n,e)=>({type:"codeBlock",lang:r[2]||void 0,content:r[3]})},paragraph:{match:b.defaultRules.paragraph.match,order:2,parse:(r,n,e)=>({content:r[1]})}},Hr=b.parserFor(zr),Kr=r=>{const n=r.replace(/^\n\s*\n/,"")+`

`;return Hr(n,{inline:!1}).map(e=>e.content)},Br=r=>r.join(`

`),We={parseToArray:Kr,joinFromArray:Br},Qr="@khanacademy/pure-markdown",$r="__lib_version__";Ae(Qr,$r);const Jr=/^\[\[\u2603 (([a-z-]+) ([0-9]+))\]\]/,Qe=(r,n,e)=>{const t=r.length;let a=0;if(e){if(n.inline)return null;for(;a<t&&r[a]===" ";)a++}if(!(a<t&&r[a]==="$"))return null;a++;const i=a;let o=0;for(;a<t;){const s=r[a];if(s==="\\")a++;else if(o<=0&&s==="$"){let u=a+1;if(e){const d=/^(?: *\n){2,}/.exec(r.slice(u));u=d?u+d[0].length:null}return u?[r.substring(0,u),r.substring(i,a)]:null}else if(s==="{")o++;else if(s==="}")o--;else if(s===`
`&&r[a-1]===`
`)return null;a++}return null},Zr=(r,n)=>Qe(r,n,!1),et=(r,n)=>Qe(r,n,!0),nt=new RegExp("^\\|\\| +(.*) +\\|\\| *\\n("+b.defaultRules.nptable.match.regex.source.substring(1)+")"),rt=b.blockRegex(/^(crwdns.*)\n\s*\n/),I={...b.defaultRules,columns:{order:-2,match:b.blockRegex(/^([\s\S]*\n\n)={5,}\n\n([\s\S]*)/),parse:(r,n,e)=>({col1:n(r[1],e),col2:n(r[2],e)})},crowdinId:{order:-1,match:(r,n,e)=>n.isJipt?rt(r,n,e):null,parse:(r,n,e)=>({id:r[1]})},titledTable:{order:b.defaultRules.nptable.order-.5,match:b.blockRegex(nt),parse:(r,n,e)=>{const t=b.parseInline(n,r[1],e),a=r.slice(2),i=b.defaultRules.nptable.parse(a,n,e);return{title:t,table:i}}},widget:{order:b.defaultRules.link.order-.75,match:b.inlineRegex(Jr),parse:(r,n,e)=>({id:r[1],widgetType:r[2]})},blockMath:{order:b.defaultRules.codeBlock.order+.5,match:et,parse:(r,n,e)=>({content:r[1]})},math:{order:b.defaultRules.link.order-.25,match:Zr,parse:(r,n,e)=>({content:r[1]})},unescapedDollar:{order:b.defaultRules.link.order-.24,match:b.inlineRegex(/^(?!\\)\$/),parse:(r,n,e)=>({})},fence:{...b.defaultRules.fence,parse:(r,n,e)=>{const t=b.defaultRules.fence.parse(r,n,e);return t.lang==="alt"?{type:"codeBlock",lang:"alt",content:n(t.content+`

`,e)}:t}},blockQuote:{...b.defaultRules.blockQuote,match:b.blockRegex(/^ *>[^\n]+(\n( *>)?[^\n]+)*\n{2,}/)},lint:{order:1e3,match:r=>null,parse:(r,n,e)=>({})}};b.parserFor(I);const J={...I,columns:{...I.columns,react:(r,n,e)=>c.jsxs("div",{className:"perseus-two-columns",children:[c.jsx("div",{className:"perseus-column",children:c.jsx("div",{className:"perseus-column-content",children:n(r.col1,e)})}),c.jsx("div",{className:"perseus-column",children:c.jsx("div",{className:"perseus-column-content",children:n(r.col2,e)})})]},e.key)},crowdinId:{...I.crowdinId,react:(r,n,e)=>r.id},table:{...I.table,react:function(r,n,e){const t=b.defaultRules.table.react(r,n,e);return e.isMobile?j.cloneElement(t,{tabIndex:0}):t}},titledTable:{...I.titledTable,react:(r,n,e)=>{var a;let t;if(!r.table)t="//invalid table//";else if(r.table.type==="lint")((a=r.table.content)==null?void 0:a.type)==="table"?t=J.lint.react({...r.table,content:{...r,table:r.table.content}},n,{...e,unwrapTitledTableContents:!0}):t=J.lint.react(r.table,n,e);else{const i=b.defaultRules.table.react(r.table,n,e),o=c.jsx("caption",{className:"perseus-table-title",children:n(r.title,e)},"caption");t=j.cloneElement(i,null,[o,...i.props.children])}return e.unwrapTitledTableContents?t:c.jsx("div",{className:"perseus-titled-table",children:t},e.key)}},widget:{...I.widget,react:(r,n,e)=>c.jsx("em",{children:`[Widget: ${r.id}]`},e.key)},blockMath:{...I.blockMath,react:(r,n,e)=>{const{TeX:t}=B();return c.jsx(t,{children:r.content},e.key)}},math:{...I.math,react:(r,n,e)=>{const{TeX:t}=B();return c.jsx(t,{children:r.content},e.key)}},unescapedDollar:{...I.unescapedDollar,react:(r,n,e)=>"$"},link:{...I.link,react:function(r,n,e){const t=b.defaultRules.link.react(r,n,e),a=t.props.href;let i=null;(a?a.match(/https?:\/\/[^/]*khanacademy.org|^\//):!1)||(i="noopener noreferrer");const s={...t.props,target:"_blank",href:a,rel:i};return e.baseElements&&e.baseElements.Link?e.baseElements.Link(s):j.cloneElement(t,s)}},codeBlock:{...I.codeBlock,react:(r,n,e)=>r.lang==="alt"?c.jsx("div",{className:"perseus-markdown-alt perseus-sr-only",children:n(r.content,e)},e.key):b.defaultRules.codeBlock.react(r,n,e)},lint:{...I.lint,react:(r,n,e)=>c.jsx(fn,{message:r.message,ruleName:r.ruleName,inline:tt(r.content),blockHighlight:r.blockHighlight,insideTable:r.insideTable,severity:r.severity,children:n(r.content,e)})}};function tt(r){return!!(r&&r.type&&at.hasOwnProperty(r.type))}const at={text:!0,math:!0,unescapedDollar:!0,link:!0,img:!0,strong:!0,u:!0,em:!0,del:!0,code:!0},$e=b.parserFor(J),Je=(r,n)=>{const e=r+`

`;return $e(e,{...n,inline:!1})},it=(r,n)=>$e(r,{...n,inline:!0}),X=(r,n)=>{p.isArray(r)?p.each(r,e=>X(e,n)):p.isObject(r)&&(n(r),r.type==="table"?(X(r.header,n),X(r.cells,n)):r.type==="list"?X(r.items,n):r.type==="titledTable"?X(r.table,n):r.type==="columns"?(X(r.col1,n),X(r.col2,n)):p.isArray(r.content)&&X(r.content,n))},Te=r=>{if(p.isArray(r))return p.flatten(p.map(r,Te));if(r.content&&p.isString(r.content))return r.type.toLowerCase().indexOf("code")!==-1?["",r.content,""]:[r.content.replace(/\s+/g," ")];const n=p.chain(r).values().flatten().filter(t=>t!=null&&p.has(t,"type")).value();if(!n.length)return[];const e=Te(n);if(r.type==="paragraph"&&e.length){e[0]=e[0].replace(/^\s+/,"");const t=e.length-1;e[t]=e[t].replace(/\s+$/,"")}return e},st=r=>{const n=Je(r);return Te(n).join("").length},G={characterCount:st,traverseContent:X,parse:Je,parseInline:it,reactFor:b.reactFor,ruleOutput:b.ruleOutput(J,"react"),basicOutput:b.reactFor(b.ruleOutput(J,"react")),sanitizeUrl:b.sanitizeUrl};class Ze extends j.Component{render(){const n=this.props.className?"paragraph "+this.props.className:"paragraph";return c.jsx("div",{className:this.props.inline?this.props.className??void 0:n,"data-perseus-component-index":this.props.translationIndex,"data-perseus-paragraph-index":this.props.paragraphIndex,children:this.props.children})}}Ze.__docgenInfo={description:"",methods:[],displayName:"QuestionParagraph",props:{className:{required:!1,tsType:{name:"union",raw:"string | null | undefined",elements:[{name:"string"},{name:"null"},{name:"undefined"}]},description:""},translationIndex:{required:!0,tsType:{name:"number"},description:""},paragraphIndex:{required:!1,tsType:{name:"number"},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},inline:{required:!1,tsType:{name:"boolean"},description:""}}};const ot=1e3;class ut{constructor(){l(this,"previousContent",null);l(this,"runLinter",tn.debounce((n,e)=>{if(!(typeof KA>"u")&&n!==this.previousContent){if(this.previousContent=n,n===""){e([]);return}fetch("/api/internal/translations/lint_poentry?preview=1&lang=en",{headers:{"Content-Type":"application/json"},body:JSON.stringify({msgid:n,msgstr:n,format:"perseus_text",filename:""}),method:"POST"}).then(t=>t.status>=400?{status:"error",message:"Could not run i18n linter."}:t.json(),t=>({status:"error",message:"Could not run i18n linter."})).then(t=>{t.status==="error"?e(["Some part of this text makes it untranslatable. The specific message from the i18n linter was: "+t.message.replace(/\n/g," ")]):e([])})}},ot))}applyLintErrors(n,e){if(e.length){const t=e.join(`

`);n.unshift({content:{type:"text",content:""},insideTable:!1,message:t,ruleName:"legacy-error",severity:m.Severity.ERROR,type:"lint"})}}}const lt=r=>r.replace(/\{align[*]?\}/g,"{aligned}").replace(/[\u00a0]/g," "),{interactiveSizes:se}=kn,dt=vn,mt=qn,_={SMALL:"small",MEDIUM:"medium",LARGE:"large"},gt=r=>r?r<=dt?_.SMALL:r<=mt?_.MEDIUM:_.LARGE:_.MEDIUM,zt=r=>r===_.SMALL?[se.defaultBoxSizeSmall,se.defaultBoxSizeSmall]:[se.defaultBoxSize,se.defaultBoxSize],pt="",ct=!1,P={},Z={},en=(r,n)=>{P[r]=n},Ht=r=>{r.forEach(n=>{en(n.name,n)})},F=(r,n)=>{const e=P[n];if(!e){const t=`Failed to replace ${r} with ${n}`;throw new Y(t,E.Internal)}en(r,e)},Kt=()=>{F("transformer","deprecated-standin"),F("lights-puzzle","deprecated-standin"),F("reaction-diagram","deprecated-standin"),F("sequence","deprecated-standin"),F("simulator","deprecated-standin"),F("unit-input","deprecated-standin")},Bt=r=>{r.forEach(n=>{if(!n.widgetName)throw new Y(`Editor ${n.displayName} doesn't have a widgetName property`,E.Internal);Z[n.widgetName]=n})},D=(r,n)=>{const e=Z[n];if(!e&&$){const t=`Failed to replace editor ${r} with ${n}`;$.error(t,E.Internal);return}Z[r]=e},Qt=()=>{D("transformer","deprecated-standin"),D("lights-puzzle","deprecated-standin"),D("reaction-diagram","deprecated-standin"),D("sequence","deprecated-standin"),D("simulator","deprecated-standin"),D("unit-input","deprecated-standin")},yt=r=>{var n,e,t;return p.has(P,r)?(n=P[r])!=null&&n.getWidget?(t=(e=P[r]).getWidget)==null?void 0:t.call(e):P[r].widget:null},$t=r=>p.has(Z,r)?Z[r]:null,ht=r=>{if(P[r])return P[r].version||{major:0,minor:0}},Jt=()=>{const r={};return p.each(p.keys(P),function(n){r[n]=ht(n)}),r},Zt=()=>p.pick(P,p.reject(p.keys(P),function(r){return P[r].hidden})),ea=()=>p.keys(P),bt=(r,n,e)=>{const t=r.type,a=P[t];if(a==null)return r;let i;return r.static?i=wt(t)||p.identity:i=a.transform||p.identity,i(r.options,n,e)},na=r=>{const n=P[r];return n&&n.staticTransform!=null},wt=r=>{const n=P[r];return n&&n.staticTransform},ft=r=>{const n=P[r];return n&&n.tracking||pt},kt=r=>{const n=P[r];return n&&n.isLintable||ct};class Ie extends j.Component{constructor(){super(...arguments);l(this,"widgetRef",j.createRef());l(this,"state",{sizeClass:_.MEDIUM,widgetProps:this.props.initialProps});l(this,"getWidget",()=>this.widgetRef.current);l(this,"replaceWidgetProps",e=>{this.setState({widgetProps:e})})}componentDidMount(){if(this.state.widgetProps.apiOptions.isMobile){const e=fe.findDOMNode(this).offsetWidth;this.setState({sizeClass:gt(e)})}}UNSAFE_componentWillReceiveProps(e){if(this.props.type!==e.type)throw new Error("WidgetContainer can't change widget type; set a different key instead to recreate the container.")}shouldComponentUpdate(e,t){return this.props.shouldHighlight!==e.shouldHighlight||this.props.type!==e.type||this.state.widgetProps!==t.widgetProps||this.state.sizeClass!==t.sizeClass}render(){var v;let e=we({"perseus-widget-container":!0,"widget-highlight":this.props.shouldHighlight,"widget-nohighlight":!this.props.shouldHighlight,"perseus-widget__definition":this.props.type==="definition"});const t=this.props.type,a=navigator.userAgent,i=yt(t);if(i==null)return console.warn(`Widget type '${t}' not found!`),c.jsx("div",{className:e});let o="null";t==="interactive-graph"&&(o=((v=this.state.widgetProps.graph)==null?void 0:v.type)??"null");let s=this.state.widgetProps.alignment;s==="default"&&(s=an(t)),e+=" widget-"+s;const u=this.state.widgetProps.apiOptions,d=this.state.widgetProps.static||u.readOnly,g={position:"relative",overflow:"visible"},y={width:"100%",height:"100%",position:"absolute",top:0,left:0,zIndex:3},w=kt(t)?this.props.linterContext:{...this.props.linterContext,highlightLint:!1};return c.jsx("div",{className:e,style:d?g:{},children:c.jsx(bn.Consumer,{children:({analytics:x})=>c.jsxs(O,{metadata:{widget_type:t,widget_id:this.props.id},onError:h=>{x.onAnalyticsEvent({type:"perseus:widget-rendering-error:ti",payload:{widgetSubType:o,widgetType:t,widgetId:this.props.id,message:h.message,userAgent:a}})},children:[c.jsx(i,{...this.state.widgetProps,linterContext:w,containerSizeClass:this.state.sizeClass,ref:this.widgetRef}),d&&c.jsx("div",{style:y})]})})})}}l(Ie,"defaultProps",{linterContext:Fe});Ie.__docgenInfo={description:"",methods:[{name:"getWidget",docblock:null,modifiers:[],params:[],returns:null},{name:"replaceWidgetProps",docblock:null,modifiers:[],params:[{name:"newWidgetProps",optional:!1,type:null}],returns:null}],displayName:"WidgetContainer",props:{shouldHighlight:{required:!0,tsType:{name:"boolean"},description:""},type:{required:!0,tsType:{name:"string"},description:""},id:{required:!0,tsType:{name:"string"},description:""},initialProps:{required:!0,tsType:{name:"intersection",raw:`RenderProps & {
...
| PerseusVideoWidgetOptions`,elements:[{name:"signature",type:"object",raw:`{
...
}`,signature:{properties:[{key:"items",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"categories",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"randomizeItems",value:{name:"boolean",required:!0}},{key:"static",value:{name:"boolean",required:!0}},{key:"values",value:{name:"Array",elements:[{name:"number"}],raw:"number[]",required:!0}},{key:"highlightLint",value:{name:"boolean",required:!1}},{key:"linterContext",value:{name:"signature",type:"object",raw:`{
    contentType: string;
    paths: string[];
    stack: string[];
}`,signature:{properties:[{key:"contentType",value:{name:"string",required:!0}},{key:"paths",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"stack",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]},required:!1}}]}},{name:"signature",type:"object",raw:`{
    ...
    // Always false
    static: boolean;
}`,signature:{properties:[{key:"programID",value:{name:"string",required:!0}},{key:"programType",value:{name:"any",required:!1}},{key:"settings",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    // The name/key of the setting
    name: string;
    // The value of the setting
    value: string;
}`,signature:{properties:[{key:"name",value:{name:"string",required:!0}},{key:"value",value:{name:"string",required:!0}}]}}],raw:"PerseusCSProgramSetting[]",required:!0}},{key:"showEditor",value:{name:"boolean",required:!0}},{key:"showButtons",value:{name:"boolean",required:!0}},{key:"height",value:{name:"number",required:!0}},{key:"static",value:{name:"boolean",required:!0}}]}},{name:"signature",type:"object",raw:`{
    ...
    correct: boolean;
}`,signature:{properties:[{key:"content",value:{name:"string",required:!0}},{key:"correct",value:{name:"boolean",required:!0}}]}}],raw:"PerseusDropdownChoice[]",required:!0}},{key:"placeholder",value:{name:"string",required:!0}},{key:"static",value:{name:"boolean",required:!0}},{key:"visibleLabel",value:{name:"string",required:!1}},{key:"ariaLabel",value:{name:"string",required:!1}}]}},{name:"signature",type:"object",raw:`{
    ...
    // Always false.  Not used for this widget
    static: boolean;
}`,signature:{properties:[{key:"showPrompt",value:{name:"string",required:!0}},{key:"hidePrompt",value:{name:"string",required:!0}},{key:"explanation",value:{name:"string",required:!0}},{key:"widgets",value:{name:"signature",type:"object",raw:"{\n    [Property in keyof TRegistry as `${Property & string} ${number}`]: TRegistry[Property];\n}",signature:{properties:[{key:{name:"PerseusWidgetTypes",required:!0},value:{name:"PerseusWidgetTypes[Property]",raw:"TRegistry[Property]"}}]},required:!1}},{key:"static",value:{name:"boolean",required:!0}}]}},{name:"signature",type:"object",raw:`{
...
| "scientific"`,elements:[{name:"literal",value:'"basic"'},{name:"literal",value:'"basic+div"'},{name:"literal",value:'"trig"'},{name:"literal",value:'"prealgebra"'},{name:"literal",value:'"logarithms"'},{name:"literal",value:'"basic relations"'},{name:"literal",value:'"advanced relations"'},{name:"literal",value:'"scientific"'}]}],raw:`Array<
    ...
    | "advanced relations"
    | "scientific"
>`,required:!0}},{key:"functions",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"times",value:{name:"boolean",required:!0}},{key:"extraKeys",value:{name:"Array",elements:[{name:"unknown[number]",raw:"(typeof KeypadKeys)[number]"}],raw:"KeypadKey[]",required:!1}},{key:"visibleLabel",value:{name:"string",required:!1}},{key:"ariaLabel",value:{name:"string",required:!1}},{key:"buttonsVisible",value:{name:"union",raw:'"always" | "never" | "focused"',elements:[{name:"literal",value:'"always"'},{name:"literal",value:'"never"'},{name:"literal",value:'"focused"'}],required:!1}}]}},{name:"signature",type:"object",raw:`{
    // A list of Widget Groups
    gradedGroups: PerseusGradedGroupWidgetOptions[];
}`,signature:{properties:[{key:"gradedGroups",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
@deprecated`},{key:"images",value:{name:"signature",type:"object",raw:`{
    ...
    height: number;
}`,signature:{properties:[{key:"width",value:{name:"number",required:!0}},{key:"height",value:{name:"number",required:!0}}]},required:!0}}]},required:!0},description:"A dictionary of {[imageUrl]: PerseusImageDetail}."}]}},{name:"null"},{name:"undefined"}],required:!1}},{key:"content",value:{name:"string",required:!0}},{key:"widgets",value:{name:"signature",type:"object",raw:"{\n    [Property in keyof TRegistry as `${Property & string} ${number}`]: TRegistry[Property];\n}",signature:{properties:[{key:{name:"PerseusWidgetTypes",required:!0},value:{name:"PerseusWidgetTypes[Property]",raw:"TRegistry[Property]"}}]},required:!1}},{key:"widgetEnabled",value:{name:"union",raw:"boolean | null | undefined",elements:[{name:"boolean"},{name:"null"},{name:"undefined"}],required:!1}},{key:"immutableWidgets",value:{name:"union",raw:"boolean | null | undefined",elements:[{name:"boolean"},{name:"null"},{name:"undefined"}],required:!1}},{key:"images",value:{name:"signature",type:"object",raw:`{
    [key: string]: PerseusImageDetail;
}`,signature:{properties:[{key:{name:"string"},value:{name:"signature",type:"object",raw:`{
    // The width of the image
    width: number;
    // the height of the image
    height: number;
}`,signature:{properties:[{key:"width",value:{name:"number",required:!0}},{key:"height",value:{name:"number",required:!0}}]},required:!0}}]},required:!0}}]}}],raw:"PerseusGradedGroupWidgetOptions[]",required:!0}}]}},{name:"signature",type:"object",raw:`{
    // Translatable Text; A title to be displayed for the group.
    title: string;
    // Not used in Perseus (but is set in (en, pt) production data)
    hasHint?: boolean | null | undefined;
...
@deprecated`},{key:"images",value:{name:"signature",type:"object",raw:`{
    ...
    // Always false
    static: boolean;
}`,signature:{properties:[{key:"url",value:{name:"string",required:!0}},{key:"settings",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    // The name/key of the setting
    name: string;
    // The value of the setting
    value: string;
}`,signature:{properties:[{key:"name",value:{name:"string",required:!0}},{key:"value",value:{name:"string",required:!0}}]}}],raw:"PerseusCSProgramSetting[]",required:!1}},{key:"width",value:{name:"union",raw:"number | string",elements:[{name:"number"},{name:"string"}],required:!0}},{key:"height",value:{name:"union",raw:"number | string",elements:[{name:"number"},{name:"string"}],required:!0}},{key:"allowFullScreen",value:{name:"boolean",required:!0}},{key:"allowTopNavigation",value:{name:"boolean",required:!1}},{key:"static",value:{name:"boolean",required:!0}}]}},{name:"signature",type:"object",raw:`{
...
}`,signature:{properties:[{key:"editableSettings",value:{name:"Array",elements:[{name:"union",raw:'"canvas" | "graph"',elements:[{name:"literal",value:'"canvas"'},{name:"literal",value:'"graph"'}]}],raw:'Array<"canvas" | "graph">',required:!1}},{key:"box",value:{name:"tuple",raw:"[width: number, height: number]",elements:[{name:"unknown"},{name:"unknown"}],required:!0}},{key:"labels",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"range",value:{name:"tuple",raw:"[Interval, Interval]",elements:[{name:"tuple",raw:"[min: number, max: number]",elements:[{name:"unknown"},{name:"unknown"}]},{name:"tuple",raw:"[min: number, max: number]",elements:[{name:"unknown"},{name:"unknown"}]}],required:!0}},{key:"gridStep",value:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}],required:!0}},{key:"markings",value:{name:"union",raw:'"axes" | "graph" | "grid" | "none"',elements:[{name:"literal",value:'"axes"'},{name:"literal",value:'"graph"'},{name:"literal",value:'"grid"'},{name:"literal",value:'"none"'}],required:!0},description:"The type of markings to display on the graph."},{key:"snapStep",value:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}],required:!1}},{key:"valid",value:{name:"union",raw:"boolean | string",elements:[{name:"boolean"},{name:"string"}],required:!1}},{key:"backgroundImage",value:{name:"signature",type:"object",raw:`{
    // The URL of the image
    url?: string | null;
    // The width of the image
    width?: number;
...
| {
    ...
    height: string;
}`,signature:{properties:[{key:"color",value:{name:"string",required:!0}},{key:"coordX",value:{name:"string",required:!0}},{key:"coordY",value:{name:"string",required:!0}},{key:"width",value:{name:"string",required:!0}},{key:"height",value:{name:"string",required:!0}}]},required:!0}}]}}]}],raw:"PerseusInteractionElement[]",required:!0}},{key:"static",value:{name:"boolean",required:!0}}]}},{name:"signature",type:"object",raw:`{
...
| PerseusGraphTypeSinusoid`,elements:[{name:"signature",type:"object",raw:`{
    ...
    // The initial coordinates the graph renders with.
    startCoords?: Coord[];
}`,signature:{properties:[{key:"type",value:{name:"literal",value:'"point"',required:!0}},{key:"numPoints",value:{name:"union",raw:'number | "unlimited"',elements:[{name:"number"},{name:"literal",value:'"unlimited"'}],required:!1}},{key:"coords",value:{name:"union",raw:"Coord[] | null",elements:[{name:"Array",elements:[{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}],required:!0}],raw:"Coord[]"},{name:"null"}],required:!1}},{key:"startCoords",value:{name:"Array",elements:[{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}],required:!0}],raw:"Coord[]",required:!1}}]}},{name:"signature",type:"object",raw:`{
    // NOTE(jeremy): This is referenced in the component. Verify if there's any
    // production data that still has this.
    coord?: Coord; // Legacy!
}`,signature:{properties:[{key:"coord",value:{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}],required:!0}}]}}]},{name:"intersection",raw:`{
    ...
    // The initial coordinates the graph renders with.
    startCoords?: Coord[];
}`,signature:{properties:[{key:"type",value:{name:"literal",value:'"sinusoid"',required:!0}},{key:"coords",value:{name:"union",raw:"Coord[] | null",elements:[{name:"Array",elements:[{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}],required:!0}],raw:"Coord[]"},{name:"null"}],required:!1}},{key:"startCoords",value:{name:"Array",elements:[{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}],required:!0}],raw:"Coord[]",required:!1}}]}},{name:"signature",type:"object",raw:`{
    // NOTE(jeremy): This is referenced in the component. Verify if there's any
    // production data that still has this.
    coord?: Coord; // Legacy!
...
| PerseusGraphTypeSinusoid`,elements:[{name:"signature",type:"object",raw:`{
    ...
    // production data that still has this.
    coord?: Coord; // Legacy!
}`,signature:{properties:[{key:"coord",value:{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}],required:!0}}]}}]}],required:!1}},{key:"lockedFigures",value:{name:"Array",elements:[{name:"union",raw:`| LockedPointType
| LockedLineType
| LockedVectorType
| LockedEllipseType
| LockedPolygonType
...
| LockedLabelType`,elements:[{name:"signature",type:"object",raw:`{
    ...
    // Always false.  Not used for this widget
    static: boolean;
}`,signature:{properties:[{key:"choices",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"imageUrl",value:{name:"string",required:!0}},{key:"imageAlt",value:{name:"string",required:!0}},{key:"imageHeight",value:{name:"number",required:!0}},{key:"imageWidth",value:{name:"number",required:!0}},{key:"markers",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    ...
    y: number;
}`,signature:{properties:[{key:"answers",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"label",value:{name:"string",required:!0}},{key:"x",value:{name:"number",required:!0}},{key:"y",value:{name:"number",required:!0}}]}}],raw:"PerseusLabelImageMarker[]",required:!0}},{key:"hideChoicesFromInstructions",value:{name:"boolean",required:!0}},{key:"multipleAnswers",value:{name:"boolean",required:!0}},{key:"static",value:{name:"boolean",required:!0}}]}},{name:"signature",type:"object",raw:`{
    ...
    padding: boolean;
}`,signature:{properties:[{key:"labels",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"left",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"right",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"orderMatters",value:{name:"boolean",required:!0}},{key:"padding",value:{name:"boolean",required:!0}}]}},{name:"signature",type:"object",raw:`{
...
}`,signature:{properties:[{key:"prefix",value:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}],required:!1}},{key:"suffix",value:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}],required:!1}},{key:"answers",value:{name:"Array",elements:[{name:"Array",elements:[{name:"number"}],raw:"number[]"}],raw:"number[][]",required:!0}},{key:"cursorPosition",value:{name:"union",raw:"number[] | undefined",elements:[{name:"Array",elements:[{name:"number"}],raw:"number[]"},{name:"undefined"}],required:!1}},{key:"matrixBoardSize",value:{name:"Array",elements:[{name:"number"}],raw:"number[]",required:!0}},{key:"static",value:{name:"union",raw:"boolean | undefined",elements:[{name:"boolean"},{name:"undefined"}],required:!1}}]}},{name:"signature",type:"object",raw:`{
    ...
    static: boolean;
}`,signature:{properties:[{key:"range",value:{name:"Array",elements:[{name:"number"}],raw:"number[]",required:!0}},{key:"labelRange",value:{name:"Array",elements:[{name:"union",raw:"number | null",elements:[{name:"number"},{name:"null"}]}],raw:"Array<number | null>",required:!0}},{key:"labelStyle",value:{name:"string",required:!0}},{key:"labelTicks",value:{name:"boolean",required:!0}},{key:"isTickCtrl",value:{name:"union",raw:"boolean | null",elements:[{name:"boolean"},{name:"null"}],required:!1}},{key:"divisionRange",value:{name:"Array",elements:[{name:"number"}],raw:"number[]",required:!0}},{key:"numDivisions",value:{name:"union",raw:"number | null",elements:[{name:"number"},{name:"null"}],required:!1}},{key:"snapDivisions",value:{name:"number",required:!0}},{key:"tickStep",value:{name:"union",raw:"number | null",elements:[{name:"number"},{name:"null"}],required:!1}},{key:"correctRel",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!1}},{key:"correctX",value:{name:"union",raw:"number | null",elements:[{name:"number"},{name:"null"}],required:!0}},{key:"initialX",value:{name:"union",raw:"number | null",elements:[{name:"number"},{name:"null"}],required:!1}},{key:"showTooltips",value:{name:"boolean",required:!1}},{key:"static",value:{name:"boolean",required:!0}}]}},{name:"signature",type:"object",raw:`{
...
@deprecated`},{key:"images",value:{name:"signature",type:"object",raw:`{
    ...
    // the height of the image
    height: number;
}`,signature:{properties:[{key:"width",value:{name:"number",required:!0}},{key:"height",value:{name:"number",required:!0}}]},required:!0}}]},required:!0},description:"A dictionary of {[imageUrl]: PerseusImageDetail}."}]}}],raw:"PerseusRenderer[]",required:!0}},{key:"correctOptions",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    /**
     * Translatable Markdown content to be rendered.  May include references to
     * widgets (as [[☃ widgetName]]) or images (as ![image text](imageUrl)).
     * For each image found in this content, there can be an entry in the
...
@deprecated`},{key:"images",value:{name:"signature",type:"object",raw:`{
    ...
    // the height of the image
    height: number;
}`,signature:{properties:[{key:"width",value:{name:"number",required:!0}},{key:"height",value:{name:"number",required:!0}}]},required:!0}}]},required:!0},description:"A dictionary of {[imageUrl]: PerseusImageDetail}."}]}}],raw:"PerseusRenderer[]",required:!0}},{key:"otherOptions",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    /**
     * Translatable Markdown content to be rendered.  May include references to
     * widgets (as [[☃ widgetName]]) or images (as ![image text](imageUrl)).
     * For each image found in this content, there can be an entry in the
...
@deprecated`},{key:"images",value:{name:"signature",type:"object",raw:`{
    ...
    // the height of the image
    height: number;
}`,signature:{properties:[{key:"width",value:{name:"number",required:!0}},{key:"height",value:{name:"number",required:!0}}]},required:!0}}]},required:!0},description:"A dictionary of {[imageUrl]: PerseusImageDetail}."}]}}],raw:"PerseusRenderer[]",required:!0}},{key:"height",value:{name:"union",raw:'"normal" | "auto"',elements:[{name:"literal",value:'"normal"'},{name:"literal",value:'"auto"'}],required:!0}},{key:"layout",value:{name:"union",raw:'"horizontal" | "vertical"',elements:[{name:"literal",value:'"horizontal"'},{name:"literal",value:'"vertical"'}],required:!0}}]}},{name:"signature",type:"object",raw:`{
    content: string;
...
}`,signature:{properties:[{key:"labels",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"categories",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"type",value:{name:"unknown[number]",raw:"(typeof plotterPlotTypes)[number]",required:!0}},{key:"maxY",value:{name:"number",required:!0}},{key:"scaleY",value:{name:"number",required:!0}},{key:"labelInterval",value:{name:"union",raw:"number | null",elements:[{name:"number"},{name:"null"}],required:!1}},{key:"snapsPerLine",value:{name:"number",required:!0}},{key:"starting",value:{name:"Array",elements:[{name:"number"}],raw:"number[]",required:!0}},{key:"correct",value:{name:"Array",elements:[{name:"number"}],raw:"number[]",required:!0}},{key:"picUrl",value:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}],required:!1}},{key:"picSize",value:{name:"union",raw:"number | null",elements:[{name:"number"},{name:"null"}],required:!1}},{key:"picBoxHeight",value:{name:"union",raw:"number | null",elements:[{name:"number"},{name:"null"}],required:!1}},{key:"plotDimensions",value:{name:"Array",elements:[{name:"number"}],raw:"number[]",required:!0}}]}},{name:"signature",type:"object",raw:`{
    ...
    layout: "horizontal" | "vertical";
}`,signature:{properties:[{key:"correct",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"padding",value:{name:"boolean",required:!0}},{key:"layout",value:{name:"union",raw:'"horizontal" | "vertical"',elements:[{name:"literal",value:'"horizontal"'},{name:"literal",value:'"vertical"'}],required:!0}}]}},{name:"signature",type:"object",raw:`{
    ...
    answers: string[][];
}`,signature:{properties:[{key:"headers",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}},{key:"rows",value:{name:"number",required:!0}},{key:"columns",value:{name:"number",required:!0}},{key:"answers",value:{name:"Array",elements:[{name:"Array",elements:[{name:"string"}],raw:"string[]"}],raw:"string[][]",required:!0}}]}},{name:"signature",type:"object",raw:`{
    location: string;
    static?: boolean;
...
}`,computed:!1}}}};const vt=/\S/,qt=/(web\+graphie|https):\/\/[^\s]*/,H=()=>{},Me=["content","problemNum","widgets"],oe=r=>"container:"+r,xt=function(r,n){return r===null||n===null?r===n:p.every(r,(e,t)=>{if(n!=null)return p.isEqual(e,n[t])})};class Pe extends j.Component{constructor(e){super(e);l(this,"_currentFocus");l(this,"_foundTextNodes");l(this,"_interactionTrackers");l(this,"_isMounted");l(this,"_isTwoColumn");l(this,"_translationLinter");l(this,"_widgetContainers",new Map);l(this,"lastRenderedMarkdown");l(this,"reuseMarkdown");l(this,"translationIndex");l(this,"widgetIds");l(this,"getApiOptions",()=>({...wn.defaults,...this.props.apiOptions}));l(this,"_getInitialWidgetState",e=>{const t=sn(e.widgets);return{widgetInfo:t,widgetProps:this._getAllWidgetsStartProps(t,e)}});l(this,"_getAllWidgetsStartProps",(e,t)=>{var u;const{apiOptions:a,problemNum:i}=t,o={},{strings:s}=this.props;return gn(e).forEach(([d,g])=>{o[d]=bt(g,s,i)}),(u=a==null?void 0:a.onWidgetStartProps)==null||u.call(a,o),o});l(this,"_getDefaultWidgetInfo",e=>{const t=on.rTypeFromWidgetId.exec(e);return t==null?{}:{type:t[1],graded:!0,options:{}}});l(this,"_getWidgetInfo",e=>this.state.widgetInfo[e]||this._getDefaultWidgetInfo(e));l(this,"renderWidget",(e,t,a)=>{const i=this.state.widgetInfo[t];if(i&&i.alignment==="full-width"&&(a.foundFullWidth=!0),i){const o=i&&i.type||e,s=p.contains(this.props.highlightedWidgets,t);return c.jsx(Ie,{id:t,ref:u=>{const d=oe(t);u!=null?this._widgetContainers.set(d,u):this._widgetContainers.delete(d)},type:o,initialProps:this.getWidgetProps(t),shouldHighlight:s,linterContext:fr(this.props.linterContext,"widget")},oe(t))}return null});l(this,"getSerializedState",e=>Ne(e||this.state.widgetProps,(t,a)=>{const i=this.getWidgetInstance(a);return i&&i.getSerializedState?i.getSerializedState():t}));l(this,"restoreSerializedState",(e,t)=>{const a=p.keys(e),i=p.keys(this.state.widgetProps);if(a.length!==i.length||p.intersection(a,i).length!==a.length){$.error("Refusing to restore bad serialized state:",E.Internal,{loggedMetadata:{serializedState:JSON.stringify(e),currentProps:JSON.stringify(this.state.widgetProps)}});return}let o=1;const s=()=>{--o,t&&o===0&&t()};this.setState({widgetProps:Ne(e,(u,d)=>{const g=this.getWidgetInstance(d);if(g&&g.restoreSerializedState){++o;const y=g.restoreSerializedState(u,s);return p.extend({},this.state.widgetProps[d],y)}return u})},()=>{setTimeout(s,0)})});l(this,"showRationalesForCurrentlySelectedChoices",()=>{Object.keys(this.props.widgets).forEach(e=>{const t=this.getWidgetInstance(e);t&&t.showRationalesForCurrentlySelectedChoices&&t.showRationalesForCurrentlySelectedChoices(this._getWidgetInfo(e).options)})});l(this,"deselectIncorrectSelectedChoices",()=>{Object.keys(this.props.widgets).forEach(e=>{const t=this.getWidgetInstance(e);t&&t.deselectIncorrectSelectedChoices&&t.deselectIncorrectSelectedChoices()})});l(this,"findInternalWidgets",e=>{let t;if(typeof e=="string")if(e.indexOf(" ")!==-1){const i=e;t=(o,s,u)=>o===i}else{const i=e;t=(o,s,u)=>s.type===i}else t=e;return this.widgetIds.filter(i=>{const o=this._getWidgetInfo(i),s=this.getWidgetInstance(i);return t(i,o,s)}).map(this.getWidgetInstance)});l(this,"findWidgets",e=>[...this.findInternalWidgets(e),...this.props.findExternalWidgets(e)]);l(this,"getWidgetInstance",e=>{const t=this._widgetContainers.get(oe(e));return t?t.getWidget():null});l(this,"_onWidgetFocus",(e,t=[])=>{if(!p.isArray(t))throw new Y("widget props.onFocus focusPath must be an Array, but was"+JSON.stringify(t),E.Internal);this._setCurrentFocus([e].concat(t))});l(this,"_onWidgetBlur",(e,t)=>{const a=this._currentFocus,i=[e].concat(t);p.isEqual(i,a)&&p.defer(()=>{p.isEqual(this._currentFocus,a)&&this._setCurrentFocus(null)})});l(this,"getContent",(e,t)=>t.jiptContent||e.content);l(this,"shouldRenderJiptPlaceholder",(e,t)=>B().JIPT.useJIPT&&t.jiptContent==null&&e.content.indexOf("crwdns")!==-1);l(this,"replaceJiptContent",(e,t)=>{if(t==null)this.setState({jiptContent:e});else{/^\s*(`{3,}|~{3,})\s*(\S+)?\s*\n([\s\S]+?)\s*\1\s*$/.test(e)||(/\S\n\s*\n\S/.test(e)?e="$\\large{\\red{\\text{Please translate each paragraph to a single paragraph.}}}$":/^\s*$/.test(e)&&(e="$\\large{\\red{\\text{Translated paragraph is currently empty}}}$"));const i=this.getContent(this.props,this.state),o=We.parseToArray(i);o[t]=e,this.setState({jiptContent:We.joinFromArray(o)})}});l(this,"outputMarkdown",(e,t)=>{if(p.isArray(e)){const o=t.key,s=[];let u=!1;for(let d=0;d<e.length;d++){t.key=d,t.paragraphIndex=d;const g=this.outputMarkdown(e[d],t),y=typeof g=="string";typeof g=="string"&&u?s[s.length-1]+=g:s.push(g),u=y}return t.key=o,s}this._foundTextNodes=!1,t.foundFullWidth=!1;const a=this.outputNested(e,t);let i;return this.translationIndex!=null?i=null:i=we({"perseus-paragraph-centered":!this._foundTextNodes,"perseus-paragraph-full-width":t.foundFullWidth&&e.content.length===1}),c.jsx(Ze,{className:i,translationIndex:this.translationIndex,paragraphIndex:t.paragraphIndex,inline:this.props.inline,children:c.jsx(O,{children:a})},t.key)});l(this,"outputNested",(e,t)=>{if(p.isArray(e)){const a=t.key,i=[];let o=!1;for(let s=0;s<e.length;s++){t.key=s;const u=this.outputNested(e[s],t),d=typeof u=="string";typeof u=="string"&&o?i[i.length-1]+=u:i.push(u),o=d}return t.key=a,i}return this.outputNode(e,this.outputNested,t)});l(this,"outputNode",(e,t,a)=>{const i=this.getApiOptions(),o=i.imagePlaceholder;if(e.type==="widget"){const s=i.widgetPlaceholder;return s||(this._foundTextNodes=!0,this.widgetIds.includes(e.id)?c.jsx("span",{className:"renderer-widget-error",children:["Widget [[","☃"," ",e.id,"]] already exists."].join("")},a.key):(this.widgetIds.push(e.id),this.renderWidget(e.widgetType,e.id,a)))}if(e.type==="blockMath"){const s=lt(e.content),u={overflowX:"auto",overflowY:"hidden",paddingTop:10,paddingBottom:10,marginTop:-10,marginBottom:-10};if(i.isMobile){const g={marginLeft:-16,marginRight:-16},y={paddingLeft:16,paddingRight:16},w={...u,...Ge.mobileZoomableParentFix};return c.jsx("div",{className:"perseus-block-math",style:g,children:c.jsx(O,{children:c.jsx("div",{className:"perseus-block-math-inner",style:{...w,...y},children:c.jsx(pn,{children:s})})})},a.key)}return c.jsx("div",{className:"perseus-block-math",children:c.jsx(O,{children:c.jsx("div",{className:"perseus-block-math-inner",style:u,children:c.jsx(ce.Consumer,{children:({setAssetStatus:d})=>c.jsx(Ee,{setAssetStatus:d,children:s})})})})},a.key)}if(e.type==="math"){const s=e.content;return c.jsx("span",{style:{whiteSpace:"nowrap"},children:c.jsxs(O,{children:[c.jsx("span",{}),c.jsx(ce.Consumer,{children:({setAssetStatus:u})=>c.jsx(Ee,{onRender:this.props.onRender,setAssetStatus:u,children:s})}),c.jsx("span",{})]})},a.key)}if(e.type==="image"){if(o)return o;const s=p.has(this.props.images,e.target)?this.props.images[e.target]:null,u=!a.inTable;return c.jsx(O,{children:c.jsx(ce.Consumer,{children:({setAssetStatus:d})=>c.jsx(yn,{setAssetStatus:d,src:G.sanitizeUrl(e.target),alt:e.alt,title:e.title,responsive:u,onUpdate:this.props.onRender,zoomToFullSizeOnMobile:i.isMobile&&i.isArticle,...s})})},a.key)}if(e.type==="columns")return this._isTwoColumn=!0,c.jsx(O,{children:G.ruleOutput(e,t,a)},a.key);if(e.type==="text")return vt.test(e.content)&&(this._foundTextNodes=!0),o&&qt.test(e.content)?o:e.content;if(e.type==="table"||e.type==="titledTable"){const s=G.ruleOutput(e,t,{...a,isMobile:i.isMobile,inTable:!0});if(!i.isMobile)return s;const u={marginLeft:-16,marginRight:-16},g={...{paddingLeft:0,paddingRight:0},...Ge.mobileZoomableParentFix},y=c.jsx("div",{style:{...g,overflowX:"auto"},children:c.jsx(O,{children:c.jsx(hn,{animateHeight:!0,children:s})})});return c.jsx("div",{style:u,children:y})}return c.jsx(O,{children:G.ruleOutput(e,t,a)},a.key)});l(this,"handleRender",e=>{const t=this.props.onRender,a=e.onRender;if(t!==H||a!==H){const i=mn(fe.findDOMNode(this)).find("img");a!==H&&i.off("load",a),t!==H&&i.on("load",t)}t()});l(this,"_setCurrentFocus",e=>{const t=this.getApiOptions();if(!xt(e,this._currentFocus)){const a=this._currentFocus;a&&this.blurPath(a),this._currentFocus=e,t.onFocusChange(this._currentFocus,a)}});l(this,"focus",()=>{var a;let e,t;for(let i=0;i<this.widgetIds.length;i++){const o=this.widgetIds[i],s=this.getWidgetInstance(o),u=(a=s==null?void 0:s.focus)==null?void 0:a.call(s);if(u){e=o,t=u;break}}if(e){let i;return typeof t=="object"?(i=[e].concat(t.path||[]),$.error("Renderer received a focus result of type 'object' instead of the expected type 'boolean'",E.Internal,{loggedMetadata:{focusResult:JSON.stringify(t),currentProps:JSON.stringify(this.state.widgetProps)}})):i=[e],this._setCurrentFocus(i),!0}});l(this,"getDOMNodeForPath",e=>{const t=p.first(e),a=p.rest(e),i=this.getWidgetInstance(t);if(i!=null&&i.getDOMNodeForPath)return i.getDOMNodeForPath(a);if(a.length===0)return fe.findDOMNode(i)});l(this,"getInputPaths",()=>{const e=[];return this.widgetIds.forEach(t=>{const a=this.getWidgetInstance(t);a&&a.getInputPaths&&a.getInputPaths().forEach(o=>{const s=[t].concat(o);e.push(s)})}),e});l(this,"focusPath",e=>{var o;if(p.isEqual(this._currentFocus,e))return;this._currentFocus&&this.blurPath(this._currentFocus);const t=p.first(e),a=p.rest(e),i=this.getWidgetInstance(t);(o=i==null?void 0:i.focusInputPath)==null||o.call(i,a)});l(this,"blurPath",e=>{var o;if(!p.isEqual(this._currentFocus,e))return;const t=p.first(e),a=p.rest(e);if(this.getWidgetInstance(t)){const s=this.getWidgetInstance(t);(o=s==null?void 0:s.blurInputPath)==null||o.call(s,a)}});l(this,"blur",()=>{this._currentFocus&&this.blurPath(this._currentFocus)});l(this,"serialize",()=>{const e={};return p.each(this.state.widgetInfo,function(t,a){const o=this.getWidgetInstance(a).serialize();p.isEmpty(o)||(e[a]=o)},this),e});l(this,"_setWidgetProps",(e,t,a,i)=>{this.setState(o=>{const s={...o.widgetProps,[e]:{...o.widgetProps[e],...t}},u=i?o.lastUsedWidgetId:e;return i||this.props.onSerializedStateUpdated(this.getSerializedState(s)),{lastUsedWidgetId:u,widgetProps:s}},()=>{setTimeout(()=>{const o=a&&a();i||this.props.onInteractWithWidget(e),o!==!1&&this._setCurrentFocus([e])},0)})});l(this,"setInputValue",(e,t,a)=>{var u;const i=p.first(e),o=p.rest(e),s=this.getWidgetInstance(i);(u=s==null?void 0:s.setInputValue)==null||u.call(s,o,t,a)});l(this,"getWidgetIds",()=>this.widgetIds);l(this,"handletranslationLintErrors",e=>{this._isMounted&&this.setState({translationLintErrors:e})});this._translationLinter=new ut,this.state={jiptContent:null,translationLintErrors:[],lastUsedWidgetId:null,...this._getInitialWidgetState(e)}}componentDidMount(){this._isMounted=!0,this.handleRender({}),this._currentFocus=null,this.props.serializedState&&this.restoreSerializedState(this.props.serializedState),this.props.linterContext.highlightLint&&this._translationLinter.runLinter(this.props.content,this.handletranslationLintErrors)}UNSAFE_componentWillReceiveProps(e){p.isEqual(p.pick(this.props,Me),p.pick(e,Me))||this.setState(this._getInitialWidgetState(e))}shouldComponentUpdate(e,t){if(this.props.alwaysUpdate)return!0;const a=!p.isEqual(this.state,t);return!p.isEqual(this.props,e)||a}UNSAFE_componentWillUpdate(e,t){const a=this.shouldRenderJiptPlaceholder(this.props,this.state),i=this.shouldRenderJiptPlaceholder(e,t),o=this.getContent(this.props,this.state),s=this.getContent(e,t),u=this.props.highlightedWidgets,d=e.highlightedWidgets;this.reuseMarkdown=!a&&!i&&o===s&&p.isEqual(this.state.translationLintErrors,t.translationLintErrors)&&(!this.props.linterContext.highlightLint||p.isEqual(this.props.widgets,e.widgets))&&this.props.linterContext.highlightLint===e.linterContext.highlightLint&&u===d}componentDidUpdate(e,t){this.handleRender(e),this.widgetIds.forEach(a=>{const i=this._widgetContainers.get(oe(a));i==null||i.replaceWidgetProps(this.getWidgetProps(a))}),this.props.serializedState&&!p.isEqual(this.props.serializedState,this.getSerializedState())&&this.restoreSerializedState(this.props.serializedState),this.props.linterContext.highlightLint&&this._translationLinter.runLinter(this.props.content,this.handletranslationLintErrors)}componentWillUnmount(){this.widgetIds=[],this.translationIndex!=null&&B().rendererTranslationComponents.removeComponentAtIndex(this.translationIndex),this._isMounted=!1}getWidgetProps(e){const t=this.getApiOptions(),a=this.state.widgetProps[e]||{},i=this.state.widgetInfo[e],o=this.props.reviewMode&&i?i.options:null;this._interactionTrackers||(this._interactionTrackers={});let s=this._interactionTrackers[e];return s||(s=this._interactionTrackers[e]=new qr(t.trackInteraction,i&&i.type,e,ft(i&&i.type))),{...a,widgetId:e,alignment:i&&i.alignment,static:i==null?void 0:i.static,problemNum:this.props.problemNum,apiOptions:this.getApiOptions(),keypadElement:this.props.keypadElement,questionCompleted:this.props.questionCompleted,showSolutions:this.props.showSolutions,onFocus:p.partial(this._onWidgetFocus,e),onBlur:p.partial(this._onWidgetBlur,e),findWidgets:this.findWidgets,reviewModeRubric:o,reviewMode:this.props.reviewMode,onChange:(u,d,g=!1)=>{this._setWidgetProps(e,u,d,g)},trackInteraction:s.track,isLastUsedWidget:e===this.state.lastUsedWidgetId}}emptyWidgets(){return un(this.state.widgetInfo,this.widgetIds,this.getUserInputMap(),this.context.locale)}getUserInput(){return this.widgetIds.map(e=>{const t=this.getWidgetInstance(e);if(t&&t.getUserInput)return t.getUserInput()})}getUserInputMap(){const e={};return this.widgetIds.forEach(t=>{const a=this.getWidgetInstance(t);a!=null&&a.getUserInputMap?e[t]=a.getUserInputMap():a!=null&&a.getUserInput&&(e[t]=a.getUserInput())}),e}getPromptJSON(){const{content:e}=this.props,t={};return this.widgetIds.forEach(a=>{var o;const i=this.getWidgetInstance(a);t[a]=((o=i==null?void 0:i.getPromptJSON)==null?void 0:o.call(i))||{}}),{content:e,widgets:t}}score(){const e=ln(this.state.widgetInfo,this.widgetIds,this.getUserInputMap(),this.context.locale);return dn(e)}render(){const e=this.getApiOptions();if(this.reuseMarkdown)return this.lastRenderedMarkdown;const t=this.getContent(this.props,this.state);if(this.widgetIds=[],this.shouldRenderJiptPlaceholder(this.props,this.state)&&(this.translationIndex||(this.translationIndex=B().rendererTranslationComponents.addComponent(this)),!e.isArticle))return c.jsx(ke,{children:c.jsx("div",{"data-perseus-component-index":this.translationIndex,children:t})});this._isTwoColumn=!1;const a=this.props.inline?G.parseInline(t,{isJipt:this.translationIndex!=null}):G.parse(t,{isJipt:this.translationIndex!=null});if(this.props.linterContext.highlightLint){const s={content:this.props.content,widgets:this.props.widgets,...this.props.linterContext};wr(a,s),this._translationLinter.applyLintErrors(a,[...this.state.translationLintErrors,...this.props.legacyPerseusLint||[]])}const i=this.outputMarkdown(a,{baseElements:e.baseElements}),o=we({[ye.RENDERER]:!0,[ye.RESPONSIVE_RENDERER]:!0,[ye.TWO_COLUMN_RENDERER]:this._isTwoColumn});return this.lastRenderedMarkdown=c.jsx(ke,{children:c.jsx("div",{className:o,children:i})}),this.lastRenderedMarkdown}}l(Pe,"contextType",cn),l(Pe,"defaultProps",{content:"",widgets:{},images:{},highlightedWidgets:[],questionCompleted:!1,showSolutions:"none",onRender:H,onInteractWithWidget:function(){},findExternalWidgets:()=>[],alwaysUpdate:!1,reviewMode:!1,serializedState:null,onSerializedStateUpdated:()=>{},linterContext:Fe});const Ge={mobileZoomableParentFix:{transform:"translate3d(0,0,0)"}};Pe.__docgenInfo={description:"",methods:[{name:"getApiOptions",docblock:null,modifiers:[],params:[],returns:null},{name:"_getInitialWidgetState",docblock:null,modifiers:[],params:[{name:"props",optional:!1,type:{name:"intersection",raw:`Partial<React.ContextType<typeof DependenciesContext>> & {
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{Vt as D,We as J,G as P,Pe as R,b as S,Kt as a,Bt as b,Qt as c,$t as d,Zt as e,ea as f,Jt as g,ht as h,lt as i,_ as j,zt as k,Fe as l,I as m,fr as p,Ht as r,na as s};
