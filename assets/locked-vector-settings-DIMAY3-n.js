import{e as _}from"./util-Cjm22Ttl.js";import"./underscore-U-AHniOr.js";import"./core-widget-registry-2tCIH_GM.js";import"./jquery-CkHB0_Mt.js";import{B as R}from"./index-CYrfVekP.js";import{V as d}from"./index-CskvhqFA.js";import{S as g}from"./index-B-CZbs2J.js";import{s as u,c as v}from"./index-C9RM_t1w.js";import{L as q,a as S}from"./index-CbNKSLRm.js";import{L as X,p as M}from"./locked-figure-aria-CTYA5WOE.js";import{n as B}from"./no-important-DlFk8a1I.js";import{v as m}from"./index-Dd-cahjY.js";import{r as e}from"./index-C6mWTJJr.js";import{C as F,L as I,a as D}from"./locked-label-settings-CoTGjXY0.js";import{P as h}from"./trash-bold-CHX2KdYF.js";import{C as J}from"./color-select-0cKfgXJ1.js";import{L as O}from"./line-swatch-ClCO8WF5.js";import{g as Y,j as U,a as b,b as W}from"./util-BIwsV71q.js";const G="The vector cannot have length 0.",H=p=>{const{points:C,color:y,labels:r,ariaLabel:E,onChangeProps:s,onMove:P,onRemove:z}=p,[o,i]=C,$=`Vector (${o[0]}, ${o[1]}), (${i[0]}, ${i[1]})`,w=_(o,i);async function A(){const n=await U(r),a=await b(`$${o[0]}$`),l=await b(`$${o[1]}$`),c=await b(`$${i[0]}$`),L=await b(`$${i[1]}$`);let k=`Vector${n} from ${a} comma ${l} to ${c} comma ${L}`;const f=W(y);return k+=f,k}function T(n,a){if(typeof n<"u"){const l=[...C];l[a]=[...n];const c=m.midpoint(o,i),L=m.midpoint(l[0],l[1]),k=m.sub(L,c),f=r==null?void 0:r.map(x=>({...x,coord:m.add(x.coord,k)}));s({points:l,labels:f})}}function N(n){const a={color:n};a.labels=r==null?void 0:r.map(l=>({...l,color:n})),s(a)}function j(n,a){if(!r)return;const l=[...r];l[a]={...r[a],...n},s({labels:l})}function V(n){if(!r)return;const a=r.filter((l,c)=>c!==n);s({labels:a})}return e.createElement(h,{expanded:p.expanded,onToggle:p.onToggle,header:e.createElement(d,{style:t.row},e.createElement(q,null,$),e.createElement(g,{size:u.xSmall_8}),e.createElement(O,{color:y,lineStyle:"solid"}))},e.createElement(d,{style:[t.row,t.spaceUnder]},e.createElement(J,{selectedValue:y,onChange:N})),w&&e.createElement(S,{style:t.errorText},G),e.createElement(h,{expanded:!0,containerStyle:t.container,panelStyle:t.accordionPanel,header:e.createElement(d,{style:t.row},e.createElement(q,null,`Tail (${o[0]}, ${o[1]})`))},e.createElement(F,{coord:o,error:w,onChange:n=>{T(n,0)}})),e.createElement(h,{expanded:!0,containerStyle:t.container,panelStyle:t.accordionPanel,header:e.createElement(d,{style:t.row},e.createElement(q,null,`Tip (${i[0]}, ${i[1]})`))},e.createElement(F,{coord:i,error:w,onChange:n=>{T(n,1)}})),e.createElement(g,{size:u.small_12}),e.createElement(d,{style:t.horizontalRule}),e.createElement(X,{ariaLabel:E,getPrepopulatedAriaLabel:A,onChangeProps:n=>{s(n)}}),e.createElement(g,{size:u.xxxSmall_4}),e.createElement(d,{style:t.horizontalRule}),e.createElement(g,{size:u.small_12}),e.createElement(S,null,"Visible labels"),r==null?void 0:r.map((n,a)=>e.createElement(I,{...n,key:a,expanded:!0,onChangeProps:l=>{j(l,a)},onRemove:()=>{V(a)},containerStyle:t.labelContainer})),e.createElement(R,{kind:"tertiary",startIcon:M,onClick:()=>{const n=[0,-1],a=m.add(m.scale(n,(r==null?void 0:r.length)??0),m.midpoint(o,i)),l={...Y("label"),coord:a,color:y};s({labels:[...r??[],l]})},style:t.addButton},"Add visible label"),e.createElement(D,{figureType:p.type,onMove:P,onRemove:z}))},t=B.StyleSheet.create({accordionPanel:{paddingBottom:u.medium_16},container:{marginTop:u.xSmall_8,marginBottom:0,marginLeft:-u.xxxSmall_4,marginRight:-u.xxxSmall_4,backgroundColor:v.white},errorText:{color:v.red,marginTop:u.xSmall_8},row:{flexDirection:"row",alignItems:"center"},addButton:{alignSelf:"start"},horizontalRule:{height:1,backgroundColor:v.offBlack16},labelContainer:{backgroundColor:v.white}});H.__docgenInfo={description:"",methods:[],displayName:"LockedVectorSettings",props:{type:{required:!0,tsType:{name:"literal",value:'"vector"'},description:""},points:{required:!0,tsType:{name:"tuple",raw:"[tail: Coord, tip: Coord]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},color:{required:!0,tsType:{name:"unknown[number]",raw:"(typeof lockedFigureColorNames)[number]"},description:""},labels:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    type: "label";
    coord: Coord;
