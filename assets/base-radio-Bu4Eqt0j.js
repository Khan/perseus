import{j as p}from"./jsx-runtime-BT65X5dW.js";import{_ as J}from"./index-default-BcKQpA1a.js";import"./index-DktHmiAd.js";import{U as X,w as Z}from"./util-AEEC48XJ.js";import{n as f}from"./no-important-DlFk8a1I.js";import{c as C}from"./index-D7h-teXI.js";import{r as k}from"./index-C6mWTJJr.js";import{h as j}from"./index-B1Gws05u.js";import{u as ee}from"./i18n-context-CwGtWZ68.js";import{C as T}from"./perseus-api-fTM3z0tF.js";import{l as B,n as I,r as x,g as ne}from"./constants-BIpV3g0K.js";import{m as N}from"./media-queries-D4w_O5TS.js";import{C as te}from"./choice-DY04hgVS.js";import{C as ae}from"./choice-none-above-C-Rv9qVu.js";typeof HTMLElement<"u"&&!HTMLElement.prototype.scrollTo&&(HTMLElement.prototype.scrollTo=function(e,o){this.scrollLeft=e,this.scrollTop=o});const _=(e,o)=>{typeof e.scrollTo=="function"?e.scrollTo(0,o):"scrollTop"in e&&(e.scrollTop=o)},oe=(e,o,r=0,t)=>{const s=e===window?window.pageYOffset:e.scrollTop,d=o,m=d-s,u=17,w=r/u;let g=0;const R=setInterval(function(){if(g<w){const y=g/w,P=(-Math.cos(Math.PI*y)+1)/2,v=s+m*P;_(e,v),g+=1}else _(e,d),clearInterval(R)},u)},K=e=>e===document.body||e==null?window:e.scrollHeight>e.clientHeight?e:K(e.parentElement),re=750,ie=(e,o)=>{setTimeout(()=>{const r=K(e),t=e.getBoundingClientRect(),s=r===window?{top:0,bottom:window.innerHeight}:r.getBoundingClientRect();let d=0;const m=r===window?window.scrollY:r.scrollTop;if(t.bottom>s.bottom){let u=t.bottom-s.bottom;t.top+u<s.top&&(u=t.top-s.top),d=m+u}else if(t.top<s.top){const u=t.top-s.top;d=m+u}oe(r,d,re)},0)},{captureScratchpadTouchStart:se}=X;function le(e,o,r,t){return e?Z(e,!!o,r)?t.chooseNumAnswers({numCorrect:String(r)}):t.chooseAllAnswers:t.chooseOneAnswer}const de=function({apiOptions:e,reviewModeRubric:o,reviewMode:r,choices:t,editMode:s=!1,multipleSelect:d=!1,labelWrap:m,countChoices:u,numCorrect:w,isLastUsedWidget:g,onChange:R,registerFocusFunction:y}){const{strings:P}=ee(),v=k.useRef(),q=k.useRef([]);k.useEffect(()=>{if(e.canScrollPage&&g&&o&&!v.current){const n=t.findIndex(a=>a.checked);if(n>=0){const a=q.current[n],l=j.findDOMNode(a.current);l&&ie(l)}}v.current=o},[e,t,g,o]);function E(n,a){let c;a.checked&&!d?c=t.map(l=>!1):c=t.map(l=>l.checked),c[n]=a.checked,R({checked:c})}y==null||y(n=>{const a=q.current[n||0],l=j.findDOMNode(a.current);if(l)l.focus();else return!1;return!0});const A=e.isMobile,W=t[0].highlighted,G=t[t.length-1].highlighted,z=C("perseus-widget-radio",!s&&"perseus-rendered-radio",f.css(i.radio,i.responsiveRadioContainer,W&&A&&i.radioContainerFirstHighlighted,G&&A&&i.radioContainerLastHighlighted)),$=C("instructions",f.css(i.instructions,A&&i.instructionsMobile)),O=le(d,u,w,P),U=f.css(i.responsiveFieldset),V=p.jsxs("fieldset",{className:`perseus-widget-radio-fieldset ${U}`,children:[p.jsx("legend",{className:"perseus-sr-only",children:O}),p.jsx("div",{className:$,"aria-hidden":"true",children:O}),p.jsx("ul",{className:z,style:{listStyle:"none"},children:t.map((n,a)=>{let c=te;const l=k.createRef();q.current[a]=l;const F={apiOptions:e,multipleSelect:d,checked:n.checked,previouslyAnswered:n.previouslyAnswered,reviewMode:r,correct:n.correct,rationale:n.rationale,content:n.content,disabled:e.readOnly||n.disabled,showCorrectness:r||!!n.showCorrectness,showRationale:n.hasRationale&&(r||n.showRationale),pos:a,onChange:h=>{s||E(a,h)}};n.isNoneOfTheAbove&&(c=ae,J.extend(F,{showContent:n.revealNoneOfTheAbove}));const M=t[a+1],Y=!!M&&M.highlighted,D=h=>f.css(i.item,i.responsiveItem,h&&i.selectedItem,h&&n.highlighted&&i.aboveBackdrop,h&&n.highlighted&&e.isMobile&&i.aboveBackdropMobile,Y&&e.isMobile&&i.nextHighlighted);D(!0);let S;r&&o&&(S=o.choices[a].correct?T.CORRECT:T.INCORRECT);const Q=C(D(n.checked),T.RADIO.OPTION,n.checked&&T.RADIO.SELECTED,S);let L=null,H;return s&&(H=h=>{let b=h.target;for(;b&&b!==L;){if(b.getAttribute("data-is-radio-icon")){E(a,{checked:!n.checked});return}b=b.parentNode}}),p.jsx("li",{ref:h=>L=h,className:Q,onClick:H,onTouchStart:m?void 0:se,children:p.jsx(c,{...F,ref:l})},a)})})]});return p.jsx("div",{className:f.css(i.responsiveContainer),children:V})},i=f.StyleSheet.create({instructions:{display:"block",color:ne,fontSize:14,lineHeight:1.25,fontFamily:"inherit",fontStyle:"normal",fontWeight:"bold",marginBottom:16},instructionsMobile:{fontSize:18,[N.smOrSmaller]:{fontSize:16},[N.xl]:{fontSize:20}},radio:{padding:0},responsiveRadioContainer:{borderBottom:`1px solid ${x}`,borderTop:`1px solid ${x}`,width:"auto",[N.smOrSmaller]:{marginLeft:I,marginRight:I}},radioContainerFirstHighlighted:{borderTop:"1px solid rgba(0, 0, 0, 0)"},radioContainerLastHighlighted:{borderBottom:"1px solid rgba(0, 0, 0, 0)"},item:{marginLeft:20},responsiveItem:{marginLeft:0,padding:0,":not(:last-child)":{borderBottom:`1px solid ${x}`}},selectedItem:{background:"white"},aboveBackdrop:{position:"relative",zIndex:1062},aboveBackdropMobile:{boxShadow:"0 0 4px 0 rgba(0, 0, 0, 0.2),0 0 2px 0 rgba(0, 0, 0, 0.1)",":not(:last-child)":{borderBottom:"1px solid rgba(0, 0, 0, 0)"}},nextHighlighted:{":not(:last-child)":{borderBottom:"1px solid rgba(0, 0, 0, 0)"}},responsiveContainer:{overflow:"auto",marginLeft:I,paddingLeft:B},responsiveFieldset:{paddingRight:B,minWidth:"auto"}});de.__docgenInfo={description:"",methods:[],displayName:"BaseRadio",props:{apiOptions:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
