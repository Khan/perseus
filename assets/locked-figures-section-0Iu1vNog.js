import{j as n}from"./jsx-runtime-63Ea5SlK.js";import{B as R}from"./index-sN6aPTh8.js";import{V as g}from"./index-Cj1jPHW9.js";import{S}from"./index-GucNpBmh.js";import{s as c,c as E}from"./index-dmcq622U.js";import{l as f}from"./index-awljIyHI.js";import{r as h}from"./index-6oxdNXpR.js";import{H as j}from"./heading-eqcfcAGD.js";import{a as M,b as D}from"./answer-choices-YKfNCloZ.js";import{w as G}from"./index-J2t_5nK1.js";import{L as W}from"./locked-ellipse-settings-saOdkMWM.js";import{L as z}from"./locked-function-settings-pyFr2iaQ.js";import{L as V}from"./locked-label-settings-CUzL6bCp.js";import{L as H}from"./locked-line-settings-WlqjGu92.js";import{L as K}from"./locked-point-settings-AI4LB-0f.js";import{L as X}from"./locked-polygon-settings-FDbV0PeL.js";import{L as _}from"./locked-vector-settings-bVYWFVr8.js";import{g as $}from"./util-y2LNFVeb.js";const q=o=>{const{id:y,onChange:i}=o,u=["point","line","vector","ellipse","polygon","function","label"];return n.jsx(g,{style:k.container,children:n.jsx(M,{menuText:"Add locked figure",style:k.addElementSelect,children:u.map(s=>n.jsx(D,{label:s,onClick:()=>i(s)},`${y}-${s}`))})})},k=f.StyleSheet.create({container:{marginTop:c.xSmall_8},addElementSelect:{backgroundColor:E.fadedBlue8,borderRadius:c.xxxSmall_4}});q.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSelect",props:{id:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: LockedFigureType) => void",signature:{arguments:[{type:{name:'union["type"]',raw:'LockedFigure["type"]'},name:"value"}],return:{name:"void"}}},description:""}}};const C=o=>{switch(o.type){case"point":return n.jsx(K,{...o});case"line":return n.jsx(H,{...o});case"vector":return n.jsx(_,{...o});case"ellipse":return n.jsx(W,{...o});case"polygon":return n.jsx(X,{...o});case"function":return n.jsx(z,{...o});case"label":return n.jsx(V,{...o});default:throw new G(o)}};C.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSettings",props:{onMove:{required:!0,tsType:{name:"signature",type:"function",raw:"(movement: LockedFigureSettingsMovementType) => void",signature:{arguments:[{type:{name:"union",raw:`| "back"
| "backward"
| "forward"
| "front"`,elements:[{name:"literal",value:'"back"'},{name:"literal",value:'"backward"'},{name:"literal",value:'"forward"'},{name:"literal",value:'"front"'}]},name:"movement"}],return:{name:"void"}}},description:"Called when a movement button (top, up, down, bottom) is pressed."},onRemove:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Called when the delete button is pressed."},expanded:{required:!1,tsType:{name:"boolean"},description:"Whether this accordion is expanded."},onToggle:{required:!1,tsType:{name:"signature",type:"function",raw:"(expanded: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"expanded"}],return:{name:"void"}}},description:"Called when the accordion is expanded or collapsed."}}};const T=o=>{const y=Array((o.figures??[]).length).fill(!1),[i,u]=h.useState(y),[s,A]=h.useState(!0),w=h.useId(),{figures:r,onChange:m}=o;function x(e){const t={lockedFigures:[...r||[],$(e)]};m(t),u([...i,!0])}function P(e,a){if(e===0&&(a==="back"||a==="backward")||r&&e===r.length-1&&(a==="front"||a==="forward"))return;const l=[...r||[]],d=[...i],[p]=l.splice(e,1);switch(d.splice(e,1),a){case"back":l.unshift(p),d.unshift(!0);break;case"backward":l.splice(e-1,0,p),d.splice(e-1,0,!0);break;case"forward":l.splice(e+1,0,p),d.splice(e+1,0,!0);break;case"front":l.push(p),d.push(!0);break}m({lockedFigures:l}),u(d)}function L(e){if(window.confirm("Are you sure you want to delete this figure?")){const a=r||[];m({lockedFigures:[...a.slice(0,e),...a.slice(e+1)]});const t=[...i];t.splice(e,1),u(t)}}function N(e,a){const t=r||[],l={lockedFigures:[...t.slice(0,e),{...t[e],...a},...t.slice(e+1)]};m(l)}function F(e){u(Array(r==null?void 0:r.length).fill(e))}const b=i.every(e=>!e),I=b?"Expand all":"Collapse all",O=!!(r!=null&&r.length);return n.jsxs(n.Fragment,{children:[n.jsx(j,{title:"Locked Figures",isOpen:s,onToggle:()=>A(!s),isCollapsible:!0}),s&&n.jsxs(g,{children:[r==null?void 0:r.map((e,a)=>n.jsx(C,{expanded:i[a],onToggle:t=>{const l=[...i];l[a]=t,u(l)},...e,onChangeProps:t=>N(a,t),onMove:t=>P(a,t),onRemove:()=>L(a)},`${w}-locked-${e}-${a}`)),n.jsxs(g,{style:v.buttonContainer,children:[n.jsx(q,{id:`${w}-select`,onChange:x}),n.jsx(S,{size:c.small_12}),O&&n.jsx(R,{kind:"secondary",onClick:()=>F(b),style:v.button,children:I})]})]})]})},v=f.StyleSheet.create({buttonContainer:{flexDirection:"row",alignItems:"center"},button:{marginTop:c.xSmall_8,flexGrow:1}}),pe=T;T.__docgenInfo={description:"",methods:[],displayName:"LockedFiguresSection",props:{figures:{required:!1,tsType:{name:"Array",elements:[{name:"union",raw:`| LockedPointType
| LockedLineType
| LockedVectorType
| LockedEllipseType
| LockedPolygonType
