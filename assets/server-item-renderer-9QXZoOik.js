var v=Object.defineProperty;var k=(o,i,e)=>i in o?v(o,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):o[i]=e;var a=(o,i,e)=>k(o,typeof i!="symbol"?i+"":i,e);import{r as c,u as q,v as R,U as A,_ as y,A as P,j as s,be as I,y as x,R as C,z as h,D as T,n as w}from"./iframe-BUmzxHYu.js";import{H as S}from"./hints-renderer-CvoZhUOY.js";const j={onRendered:o=>{}},N=c.createContext(j);class p extends c.Component{constructor(e){super(e);a(this,"questionRenderer");a(this,"hintsRenderer");a(this,"_currentFocus");a(this,"_fullyRendered");a(this,"blurTimeoutID");a(this,"userInput");a(this,"_handleFocusChange",(e,n)=>{e!=null?this._setCurrentFocus(e):this._onRendererBlur(n)});a(this,"handleInteractWithWidget",e=>{const n=y.difference(this.state.questionHighlightedWidgets,[e]);this.setState({questionCompleted:!1,questionHighlightedWidgets:n},()=>{var t,r;(r=(t=this.props.apiOptions)==null?void 0:t.interactionCallback)==null||r.call(t,this.questionRenderer.getUserInputMap())})});a(this,"setAssetStatus",(e,n)=>{const t={...this.state.assetStatuses,[e]:n};this.setState({assetStatuses:t})});this.state={questionCompleted:!1,questionHighlightedWidgets:[],assetStatuses:{}},this._fullyRendered=!1,this.userInput={}}componentDidMount(){this._currentFocus=null,this._fullyRendered=!1,this.maybeCallOnRendered()}UNSAFE_componentWillReceiveProps(e){this.setState({questionHighlightedWidgets:[]})}componentDidUpdate(e,n){const t=this.props.apiOptions.answerableCallback;if(t!=null){const r=this.questionRenderer.emptyWidgets().length===0;t(r)}if(this.maybeCallOnRendered(),this.props.score&&this.props.score!==e.score){const r=this.questionRenderer.emptyWidgets();this.setState({questionCompleted:this.props.score.correct,questionHighlightedWidgets:r})}}componentWillUnmount(){this.blurTimeoutID!=null&&(clearTimeout(this.blurTimeoutID),this.blurTimeoutID=null)}maybeCallOnRendered(){this._fullyRendered||Object.values(this.state.assetStatuses).every(Boolean)&&(this._fullyRendered=!0,this.props.onRendered(!0))}_setCurrentFocus(e){const{apiOptions:{isMobile:n,onFocusChange:t},keypadElement:r}=this.props,l=this._currentFocus;this._currentFocus=e;const g=this.getInputPaths(),m=this._currentFocus&&g.some(d=>A.inputPathsEqual(d,this._currentFocus));t!=null&&setTimeout(()=>{const d=r==null?void 0:r.getDOMNode(),u=d&&m?d.getBoundingClientRect().height:0;t(this._currentFocus,l,u,m&&this.questionRenderer.getDOMNodeForPath(e))},0),r&&n&&(m?r.activate():r.dismiss())}_onRendererBlur(e){const n=this._currentFocus;y.isEqual(e,n)&&(this.blurTimeoutID=setTimeout(()=>{y.isEqual(this._currentFocus,n)&&this._setCurrentFocus(null)},0))}_setWidgetProps(e,n,t){this.questionRenderer._setWidgetProps(e,n,t)}focusPath(e){return this.questionRenderer.focusPath(e)}blurPath(e){return this.questionRenderer.blurPath(e)}getDOMNodeForPath(e){return this.questionRenderer.getDOMNodeForPath(e)}getInputPaths(){return this.questionRenderer.getInputPaths()}focus(){return this.questionRenderer.focus()}blur(){this._currentFocus&&this.blurPath(this._currentFocus)}getNumHints(){return this.props.item.hints.length}getPromptJSON(){return this.questionRenderer.getPromptJSON()}getUserInputLegacy(){return this.questionRenderer.getUserInput()}getUserInput(){return this.userInput}getWidgetIds(){return this.questionRenderer.getWidgetIds()}getSerializedState(){return{question:this.questionRenderer.getSerializedState(),hints:this.hintsRenderer.getSerializedState()}}restoreSerializedState(e,n){let t=2;const r=()=>{--t,n&&t===0&&n()};this.questionRenderer.restoreSerializedState(e.question,r),this.hintsRenderer.restoreSerializedState(e.hints,r)}render(){const e={...P.defaults,...this.props.apiOptions,onFocusChange:this._handleFocusChange},n={assetStatuses:this.state.assetStatuses,setAssetStatus:this.setAssetStatus},t=s.jsx(I.Provider,{value:n,children:s.jsx(x,{widgets:this.props.item.question.widgets,problemNum:this.props.problemNum??0,children:({userInput:l,handleUserInput:g,initializeUserInput:m,restoreUserInputFromSerializedState:d})=>(this.userInput=l,s.jsx(C,{keypadElement:this.props.keypadElement,problemNum:this.props.problemNum,onInteractWithWidget:this.handleInteractWithWidget,highlightedWidgets:this.state.questionHighlightedWidgets,apiOptions:e,questionCompleted:this.state.questionCompleted,reviewMode:this.props.reviewMode,showSolutions:this.props.showSolutions,ref:u=>{u!=null&&(this.questionRenderer=u)},content:this.props.item.question.content,widgets:this.props.item.question.widgets,images:this.props.item.question.images,linterContext:h(this.props.linterContext,"question"),strings:this.context.strings,...this.props.dependencies,userInput:l,handleUserInput:(u,b,f)=>{g(u,b,f),this.handleInteractWithWidget(u)},initializeUserInput:m,restoreUserInputFromSerializedState:d}))})}),r=s.jsx(S,{hints:this.props.item.hints,hintsVisible:this.props.hintsVisible,apiOptions:e,ref:l=>this.hintsRenderer=l,linterContext:h(this.props.linterContext,"hints"),strings:this.context.strings});return s.jsx(T.Provider,{value:this.props.dependencies,children:s.jsxs("div",{children:[s.jsx("div",{children:t}),s.jsx("div",{className:e.isMobile?void 0:w.css(O.hintsContainer),children:r})]})})}}a(p,"contextType",q),a(p,"defaultProps",{apiOptions:{},linterContext:R,onRendered:e=>{}});const O=w.StyleSheet.create({hintsContainer:{marginLeft:50}});c.forwardRef(function(i,e){return s.jsx(N.Consumer,{children:({onRendered:n})=>s.jsx(p,{...i,onRendered:n,ref:e})})});p.__docgenInfo={description:"",methods:[{name:"maybeCallOnRendered",docblock:null,modifiers:[],params:[],returns:null},{name:"_handleFocusChange",docblock:null,modifiers:[],params:[{name:"newFocus",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}},{name:"oldFocus",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"_setCurrentFocus",docblock:null,modifiers:[],params:[{name:"newFocus",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"_onRendererBlur",docblock:null,modifiers:[],params:[{name:"blurPath",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"_setWidgetProps",docblock:`Accepts a question area widgetId, or an answer area widgetId of
...
the question content.`},{name:"getSerializedState",docblock:"@deprecated - do not use in new code.",modifiers:[],params:[],returns:{type:{name:"signature",type:"object",raw:`{
    ...
    paths: [],
    stack: [],
}`,computed:!1},required:!1},onRendered:{defaultValue:{value:"(isRendered: boolean) => {}",computed:!1},required:!1}}};export{p as S};
