import{j as n}from"./jsx-runtime-63Ea5SlK.js";import{r as O}from"./index-6oxdNXpR.js";import{e as Y}from"./util-BtPxNFcx.js";import"./index-default-4_ZsnO94.js";import"./core-widget-registry-uiKfW1Am.js";import"./jquery-5v7aFUvu.js";import{B as K}from"./index-_CVl-B2F.js";import{V as w}from"./index-_3CKOwHy.js";import{S as W,O as C}from"./answer-choices-4sRk9QeP.js";import{S as y}from"./index-o999uk82.js";import{s as p,c as T}from"./index-QHkT31Yt.js";import{L as Z,a as P}from"./index-4dAUYsag.js";import{L as G,p as H}from"./locked-figure-aria-siBoHdO_.js";import{n as J}from"./no-important-xCWWYXQR.js";import{v as k}from"./index-smZ6iCr_.js";import{P as Q}from"./trash-bold-1S_9arBJ.js";import{C as ee}from"./color-select-I9yy_zqT.js";import{L as ne}from"./line-stroke-select-494mYSwQ.js";import{L as re}from"./line-swatch-KCivvEOH.js";import{L as ae,a as le}from"./locked-label-settings-agCRjSs4.js";import{L as A}from"./locked-point-settings-Hq7dJrC3.js";import{g as oe,j as S,a as L,b as te}from"./util-09Xnx9LP.js";const j="The line cannot have length 0.",N=g=>{const{kind:q,points:d,color:b,lineStyle:f="solid",showPoint1:R,showPoint2:V,labels:r,ariaLabel:X,onChangeProps:o,onMove:_,onRemove:M}=g,[i,u]=d,F=q.charAt(0).toUpperCase()+q.slice(1),B=`${F} (${i.coord[0]},
        ${i.coord[1]}), (${u.coord[0]}, ${u.coord[1]})`,h=Y(i.coord,u.coord);async function E(){const e=await S(r),a=await S(i.labels),l=await S(u.labels),s=await L(`$${i.coord[0]}$`),t=await L(`$${i.coord[1]}$`),v=await L(`$${u.coord[0]}$`),x=await L(`$${u.coord[1]}$`);let c=`${F}${e} from point${a} at ${s} comma ${t} to point${l} at ${v} comma ${x}`;const $=te(b,f);return c+=$,c}function z(e,a){const l=[...d];l[a]={...d[a],...e};const s=k.midpoint(d[0].coord,d[1].coord),t=k.midpoint(l[0].coord,l[1].coord),v=[t[0]-s[0],t[1]-s[1]],x=r==null?void 0:r.map((c,$)=>({...c,coord:[c.coord[0]+v[0],c.coord[1]+v[1]]}));o({points:l,labels:x})}function I(e){var l,s;const a=r==null?void 0:r.map(t=>({...t,color:e}));o({color:e,points:[{...i,color:e,labels:(l=i.labels)==null?void 0:l.map(t=>({...t,color:e}))},{...u,color:e,labels:(s=u.labels)==null?void 0:s.map(t=>({...t,color:e}))}],labels:a})}function D(e,a){if(!r)return;const l=[...r];l[a]={...r[a],...e},o({labels:l})}function U(e){if(!r)return;const a=r.filter((l,s)=>s!==e);o({labels:a})}return n.jsxs(Q,{expanded:g.expanded,onToggle:g.onToggle,header:n.jsxs(w,{style:m.row,children:[n.jsx(Z,{children:B}),n.jsx(y,{size:p.xSmall_8}),n.jsx(re,{color:b,lineStyle:f})]}),children:[n.jsxs(P,{tag:"label",style:[m.row,m.spaceUnder],children:["kind",n.jsx(y,{size:p.xxxSmall_4}),n.jsxs(W,{selectedValue:q,onChange:e=>o({kind:e}),placeholder:"",children:[n.jsx(C,{value:"line",label:"line"}),n.jsx(C,{value:"ray",label:"ray"}),n.jsx(C,{value:"segment",label:"segment"})]})]}),n.jsxs(w,{style:m.row,children:[n.jsx(ee,{selectedValue:b,onChange:I}),n.jsx(y,{size:p.small_12}),n.jsx(ne,{selectedValue:f,onChange:e=>o({lineStyle:e})})]}),h&&n.jsx(P,{style:m.errorText,children:j}),n.jsx(A,{headerLabel:"Point 1",expanded:!0,showPoint:R,error:h?j:null,...i,onTogglePoint:e=>o({showPoint1:e}),onChangeProps:e=>z(e,0)}),n.jsx(A,{headerLabel:"Point 2",expanded:!0,showPoint:V,error:h?j:null,...u,onTogglePoint:e=>o({showPoint2:e}),onChangeProps:e=>z(e,1)}),n.jsx(y,{size:p.small_12}),n.jsx(w,{style:m.horizontalRule}),n.jsx(G,{ariaLabel:X,getPrepopulatedAriaLabel:E,onChangeProps:e=>{o(e)}}),n.jsx(y,{size:p.xxxSmall_4}),n.jsx(w,{style:m.horizontalRule}),n.jsx(y,{size:p.small_12}),n.jsx(P,{children:"Visible labels"}),r==null?void 0:r.map((e,a)=>O.createElement(ae,{...e,key:a,expanded:!0,onChangeProps:l=>{D(l,a)},onRemove:()=>{U(a)},containerStyle:m.labelContainer})),n.jsx(K,{kind:"tertiary",startIcon:H,onClick:()=>{const e=[0,-1],a=k.add(k.scale(e,(r==null?void 0:r.length)??0),k.midpoint(d[0].coord,d[1].coord)),l={...oe("label"),coord:a,color:b};o({labels:[...r??[],l]})},style:m.addButton,children:"Add visible label"}),n.jsx(le,{figureType:g.type,onMove:_,onRemove:M})]})},m=J.StyleSheet.create({row:{display:"flex",flexDirection:"row",alignItems:"center"},spaceUnder:{marginBottom:p.xSmall_8},errorText:{color:T.red},addButton:{alignSelf:"start"},horizontalRule:{height:1,backgroundColor:T.offBlack16},labelContainer:{backgroundColor:T.white}}),je=N;N.__docgenInfo={description:"",methods:[],displayName:"LockedLineSettings",props:{type:{required:!0,tsType:{name:"literal",value:'"line"'},description:""},kind:{required:!0,tsType:{name:"union",raw:'"line" | "ray" | "segment"',elements:[{name:"literal",value:'"line"'},{name:"literal",value:'"ray"'},{name:"literal",value:'"segment"'}]},description:""},points:{required:!0,tsType:{name:"tuple",raw:"[point1: LockedPointType, point2: LockedPointType]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},color:{required:!0,tsType:{name:"unknown[number]",raw:"(typeof lockedFigureColorNames)[number]"},description:""},lineStyle:{required:!0,tsType:{name:"union",raw:'"solid" | "dashed"',elements:[{name:"literal",value:'"solid"'},{name:"literal",value:'"dashed"'}]},description:""},showPoint1:{required:!0,tsType:{name:"boolean"},description:""},showPoint2:{required:!0,tsType:{name:"boolean"},description:""},labels:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    type: "label";
    coord: Coord;
