import{e as R}from"./util-VofM5AGr.js";import"./underscore-885MUNGo.js";import"./core-widget-registry-lKD0wS3Q.js";import"./jquery-5v7aFUvu.js";import{B as X}from"./index-71P4mDMp.js";import{V as d}from"./index-hw7d7wq0.js";import{S as g}from"./index-v_a-r9JG.js";import{s as u,c as v}from"./index-zRqVZh6A.js";import{L as q,a as S}from"./index-jek-Xksa.js";import{L as M,p as B}from"./locked-figure-aria-csiDSVXI.js";import{n as I}from"./no-important-xCWWYXQR.js";import{v as m}from"./index-smZ6iCr_.js";import{r as e}from"./index-6oxdNXpR.js";import{C as F,L as D,a as J}from"./locked-label-settings-Fia60LuZ.js";import{P as h}from"./trash-bold-fB90jBjf.js";import{C as O}from"./color-select-XYAMkNXq.js";import{L as Y}from"./line-swatch-yUlF76V-.js";import{g as U,j as W,a as b,b as G}from"./util-x82Enrto.js";const H="The vector cannot have length 0.",E=p=>{const{points:C,color:y,labels:r,ariaLabel:P,onChangeProps:s,onMove:$,onRemove:z}=p,[o,i]=C,A=`Vector (${o[0]}, ${o[1]}), (${i[0]}, ${i[1]})`,w=R(o,i);async function N(){const n=await W(r),a=await b(`$${o[0]}$`),l=await b(`$${o[1]}$`),c=await b(`$${i[0]}$`),L=await b(`$${i[1]}$`);let k=`Vector${n} from ${a} comma ${l} to ${c} comma ${L}`;const f=G(y);return k+=f,k}function T(n,a){if(typeof n<"u"){const l=[...C];l[a]=[...n];const c=m.midpoint(o,i),L=m.midpoint(l[0],l[1]),k=m.sub(L,c),f=r==null?void 0:r.map(x=>({...x,coord:m.add(x.coord,k)}));s({points:l,labels:f})}}function j(n){const a={color:n};a.labels=r==null?void 0:r.map(l=>({...l,color:n})),s(a)}function V(n,a){if(!r)return;const l=[...r];l[a]={...r[a],...n},s({labels:l})}function _(n){if(!r)return;const a=r.filter((l,c)=>c!==n);s({labels:a})}return e.createElement(h,{expanded:p.expanded,onToggle:p.onToggle,header:e.createElement(d,{style:t.row},e.createElement(q,null,A),e.createElement(g,{size:u.xSmall_8}),e.createElement(Y,{color:y,lineStyle:"solid"}))},e.createElement(d,{style:[t.row,t.spaceUnder]},e.createElement(O,{selectedValue:y,onChange:j})),w&&e.createElement(S,{style:t.errorText},H),e.createElement(h,{expanded:!0,containerStyle:t.container,panelStyle:t.accordionPanel,header:e.createElement(d,{style:t.row},e.createElement(q,null,`Tail (${o[0]}, ${o[1]})`))},e.createElement(F,{coord:o,error:w,onChange:n=>{T(n,0)}})),e.createElement(h,{expanded:!0,containerStyle:t.container,panelStyle:t.accordionPanel,header:e.createElement(d,{style:t.row},e.createElement(q,null,`Tip (${i[0]}, ${i[1]})`))},e.createElement(F,{coord:i,error:w,onChange:n=>{T(n,1)}})),e.createElement(g,{size:u.small_12}),e.createElement(d,{style:t.horizontalRule}),e.createElement(M,{ariaLabel:P,getPrepopulatedAriaLabel:N,onChangeProps:n=>{s(n)}}),e.createElement(g,{size:u.xxxSmall_4}),e.createElement(d,{style:t.horizontalRule}),e.createElement(g,{size:u.small_12}),e.createElement(S,null,"Visible labels"),r==null?void 0:r.map((n,a)=>e.createElement(D,{...n,key:a,expanded:!0,onChangeProps:l=>{V(l,a)},onRemove:()=>{_(a)},containerStyle:t.labelContainer})),e.createElement(X,{kind:"tertiary",startIcon:B,onClick:()=>{const n=[0,-1],a=m.add(m.scale(n,(r==null?void 0:r.length)??0),m.midpoint(o,i)),l={...U("label"),coord:a,color:y};s({labels:[...r??[],l]})},style:t.addButton},"Add visible label"),e.createElement(J,{figureType:p.type,onMove:$,onRemove:z}))},t=I.StyleSheet.create({accordionPanel:{paddingBottom:u.medium_16},container:{marginTop:u.xSmall_8,marginBottom:0,marginLeft:-u.xxxSmall_4,marginRight:-u.xxxSmall_4,backgroundColor:v.white},errorText:{color:v.red,marginTop:u.xSmall_8},row:{flexDirection:"row",alignItems:"center"},addButton:{alignSelf:"start"},horizontalRule:{height:1,backgroundColor:v.offBlack16},labelContainer:{backgroundColor:v.white}}),ke=E;E.__docgenInfo={description:"",methods:[],displayName:"LockedVectorSettings",props:{type:{required:!0,tsType:{name:"literal",value:'"vector"'},description:""},points:{required:!0,tsType:{name:"tuple",raw:"[tail: Coord, tip: Coord]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},color:{required:!0,tsType:{name:"unknown[number]",raw:"(typeof lockedFigureColorNames)[number]"},description:""},labels:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    type: "label";
    coord: Coord;
