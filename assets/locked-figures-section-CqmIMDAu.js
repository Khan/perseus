import{j as n,V as g,n as f,s as c,e as S,bP as O,r as y,y as R,z as j}from"./iframe-fUEXi0re.js";import{H as E}from"./heading-D79Qv17Y.js";import{A as D,a as M}from"./color-select-B7QP3UMD.js";import{L as z}from"./locked-ellipse-settings-6xPNzxye.js";import{L as G}from"./locked-function-settings-B-bnh3EX.js";import{L as W}from"./locked-label-settings-Coy7R8en.js";import{L as V}from"./locked-line-settings-C6cNCW5C.js";import{L as H}from"./locked-point-settings-BXZepLNQ.js";import{L as K}from"./locked-polygon-settings-DIQacP7t.js";import{L as X}from"./locked-vector-settings-DfnTFAc2.js";import{g as _}from"./util-CGoQxivr.js";const q=l=>{const{id:h,onChange:i}=l,u=["point","line","vector","ellipse","polygon","function","label"];return n.jsx(g,{style:k.container,children:n.jsx(D,{menuText:"Add locked figure",style:k.addElementSelect,children:u.map(s=>n.jsx(M,{label:s,onClick:()=>i(s)},`${h}-${s}`))})})},k=f.StyleSheet.create({container:{marginTop:c.xSmall_8},addElementSelect:{backgroundColor:S.fadedBlue8,borderRadius:c.xxxSmall_4}});q.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSelect",props:{id:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: LockedFigureType) => void",signature:{arguments:[{type:{name:'union["type"]',raw:'LockedFigure["type"]'},name:"value"}],return:{name:"void"}}},description:""}}};const x=l=>{switch(l.type){case"point":return n.jsx(H,{...l});case"line":return n.jsx(V,{...l});case"vector":return n.jsx(X,{...l});case"ellipse":return n.jsx(z,{...l});case"polygon":return n.jsx(K,{...l});case"function":return n.jsx(G,{...l});case"label":return n.jsx(W,{...l});default:throw new O(l)}};x.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSettings",props:{onMove:{required:!0,tsType:{name:"signature",type:"function",raw:"(movement: LockedFigureSettingsMovementType) => void",signature:{arguments:[{type:{name:"union",raw:`| "back"
| "backward"
| "forward"
| "front"`,elements:[{name:"literal",value:'"back"'},{name:"literal",value:'"backward"'},{name:"literal",value:'"forward"'},{name:"literal",value:'"front"'}]},name:"movement"}],return:{name:"void"}}},description:"Called when a movement button (top, up, down, bottom) is pressed."},onRemove:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Called when the delete button is pressed."},expanded:{required:!1,tsType:{name:"boolean"},description:"Whether this accordion is expanded."},onToggle:{required:!1,tsType:{name:"signature",type:"function",raw:"(expanded: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"expanded"}],return:{name:"void"}}},description:"Called when the accordion is expanded or collapsed."}}};const $=l=>{const h=Array((l.figures??[]).length).fill(!1),[i,u]=y.useState(h),[s,A]=y.useState(!0),w=y.useId(),{figures:r,onChange:d}=l;function C(e){const t={lockedFigures:[...r||[],_(e)]};d(t),u([...i,!0])}function T(e,a){if(e===0&&(a==="back"||a==="backward")||r&&e===r.length-1&&(a==="front"||a==="forward"))return;const o=[...r||[]],m=[...i],[p]=o.splice(e,1);switch(m.splice(e,1),a){case"back":o.unshift(p),m.unshift(!0);break;case"backward":o.splice(e-1,0,p),m.splice(e-1,0,!0);break;case"forward":o.splice(e+1,0,p),m.splice(e+1,0,!0);break;case"front":o.push(p),m.push(!0);break}d({lockedFigures:o}),u(m)}function L(e){if(window.confirm("Are you sure you want to delete this figure?")){const a=r||[];d({lockedFigures:[...a.slice(0,e),...a.slice(e+1)]});const t=[...i];t.splice(e,1),u(t)}}function P(e,a){const t=r||[],o={lockedFigures:[...t.slice(0,e),{...t[e],...a},...t.slice(e+1)]};d(o)}function N(e){u(Array(r==null?void 0:r.length).fill(e))}const b=i.every(e=>!e),F=b?"Expand all":"Collapse all",I=!!(r!=null&&r.length);return n.jsxs(n.Fragment,{children:[n.jsx(E,{title:"Locked Figures",isOpen:s,onToggle:()=>A(!s),isCollapsible:!0}),s&&n.jsxs(g,{children:[r==null?void 0:r.map((e,a)=>n.jsx(x,{expanded:i[a],onToggle:t=>{const o=[...i];o[a]=t,u(o)},...e,onChangeProps:t=>P(a,t),onMove:t=>T(a,t),onRemove:()=>L(a)},`${w}-locked-${e}-${a}`)),n.jsxs(g,{style:v.buttonContainer,children:[n.jsx(q,{id:`${w}-select`,onChange:C}),n.jsx(R,{size:c.small_12}),I&&n.jsx(j,{kind:"secondary",onClick:()=>N(b),style:v.button,children:F})]})]})]})},v=f.StyleSheet.create({buttonContainer:{flexDirection:"row",alignItems:"center"},button:{marginTop:c.xSmall_8,flexGrow:1}});$.__docgenInfo={description:"",methods:[],displayName:"LockedFiguresSection",props:{figures:{required:!1,tsType:{name:"Array",elements:[{name:"union",raw:`| LockedPointType
| LockedLineType
| LockedVectorType
| LockedEllipseType
| LockedPolygonType
