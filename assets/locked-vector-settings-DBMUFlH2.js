import{j as e}from"./jsx-runtime-BT65X5dW.js";import{r as X}from"./index-C6mWTJJr.js";import{t as M}from"./util-Cnd0Ukpp.js";import"./index-default-BcKQpA1a.js";import"./index-DktHmiAd.js";import"./jquery-CkHB0_Mt.js";import{B as R}from"./phet-simulation-7JtZXm76.js";import{V as d}from"./index-DyG-XbLr.js";import{S as g}from"./index-BWwc-H8c.js";import{s as u,c as b}from"./index-BfjDPqC2.js";import{a as S,L as h}from"./index-gdjMQqRz.js";import{p as B}from"./plus-circle-DsgEZe2H.js";import{n as I}from"./no-important-DlFk8a1I.js";import{v as m}from"./index-Dd-cahjY.js";import{C as j,L as E,a as D}from"./locked-label-settings-bLk0W3GA.js";import{P as f}from"./trash-bold-C47ReFev.js";import{C as J}from"./color-select-CV7ncaQv.js";import{L as O}from"./line-swatch-BKwP-n_p.js";import{L as Y}from"./locked-figure-aria-DJgo0Sb7.js";import{g as U,j as W,a as v,b as G}from"./util-BTctv2Dj.js";const H="The vector cannot have length 0.",K=c=>{const{points:x,color:y,labels:i,ariaLabel:F,onChangeProps:s,onMove:P,onRemove:z}=c,[t,o]=x,$=`Vector (${t[0]}, ${t[1]}), (${o[0]}, ${o[1]})`,w=M(t,o);async function A(){const n=await W(i),r=await v(`$${t[0]}$`),a=await v(`$${t[1]}$`),p=await v(`$${o[0]}$`),L=await v(`$${o[1]}$`);let k=`Vector${n} from ${r} comma ${a} to ${p} comma ${L}`;const q=G(y);return k+=q,k}function C(n,r){if(typeof n<"u"){const a=[...x];a[r]=[...n];const p=m.midpoint(t,o),L=m.midpoint(a[0],a[1]),k=m.sub(L,p),q=i.map(T=>({...T,coord:m.add(T.coord,k)}));s({points:a,labels:q})}}function N(n){const r={color:n};r.labels=i.map(a=>({...a,color:n})),s(r)}function V(n,r){const a=[...i];a[r]={...i[r],...n},s({labels:a})}function _(n){const r=i.filter((a,p)=>p!==n);s({labels:r})}return e.jsxs(f,{expanded:c.expanded,onToggle:c.onToggle,header:e.jsxs(d,{style:l.row,children:[e.jsx(h,{children:$}),e.jsx(g,{size:u.xSmall_8}),e.jsx(O,{color:y,lineStyle:"solid"})]}),children:[e.jsx(d,{style:[l.row,l.spaceUnder],children:e.jsx(J,{selectedValue:y,onChange:N})}),w&&e.jsx(S,{style:l.errorText,children:H}),e.jsx(f,{expanded:!0,containerStyle:l.container,panelStyle:l.accordionPanel,header:e.jsx(d,{style:l.row,children:e.jsx(h,{children:`Tail (${t[0]}, ${t[1]})`})}),children:e.jsx(j,{coord:t,error:w,onChange:n=>{C(n,0)}})}),e.jsx(f,{expanded:!0,containerStyle:l.container,panelStyle:l.accordionPanel,header:e.jsx(d,{style:l.row,children:e.jsx(h,{children:`Tip (${o[0]}, ${o[1]})`})}),children:e.jsx(j,{coord:o,error:w,onChange:n=>{C(n,1)}})}),e.jsx(g,{size:u.small_12}),e.jsx(d,{style:l.horizontalRule}),e.jsx(Y,{ariaLabel:F,getPrepopulatedAriaLabel:A,onChangeProps:n=>{s(n)}}),e.jsx(g,{size:u.xxxSmall_4}),e.jsx(d,{style:l.horizontalRule}),e.jsx(g,{size:u.small_12}),e.jsx(S,{children:"Visible labels"}),i.map((n,r)=>X.createElement(E,{...n,key:r,expanded:!0,onChangeProps:a=>{V(a,r)},onRemove:()=>{_(r)},containerStyle:l.labelContainer})),e.jsx(R,{kind:"tertiary",startIcon:B,onClick:()=>{const n=[0,-1],r=m.add(m.scale(n,i.length),m.midpoint(t,o)),a={...U("label"),coord:r,color:y};s({labels:[...i,a]})},style:l.addButton,children:"Add visible label"}),e.jsx(D,{figureType:c.type,onMove:P,onRemove:z})]})},l=I.StyleSheet.create({accordionPanel:{paddingBottom:u.medium_16},container:{marginTop:u.xSmall_8,marginBottom:0,marginLeft:-u.xxxSmall_4,marginRight:-u.xxxSmall_4,backgroundColor:b.white},errorText:{color:b.red,marginTop:u.xSmall_8},row:{flexDirection:"row",alignItems:"center"},addButton:{alignSelf:"start"},horizontalRule:{height:1,backgroundColor:b.offBlack16},labelContainer:{backgroundColor:b.white}});K.__docgenInfo={description:"",methods:[],displayName:"LockedVectorSettings",props:{type:{required:!0,tsType:{name:"literal",value:'"vector"'},description:""},points:{required:!0,tsType:{name:"tuple",raw:"[tail: Coord, tip: Coord]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},color:{required:!0,tsType:{name:"unknown[number]",raw:"(typeof lockedFigureColorNames)[number]"},description:""},labels:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    type: "label";
    coord: Coord;
