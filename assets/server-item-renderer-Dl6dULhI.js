var f=Object.defineProperty;var v=(o,i,e)=>i in o?f(o,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):o[i]=e;var a=(o,i,e)=>(v(o,typeof i!="symbol"?i+"":i,e),e);import{r as c,aJ as k,aK as q,aB as R,_ as y,A,j as s,aP as P,aM as I,a1 as x,aN as h,aO as T,n as w}from"./iframe-DnQciuiI.js";import{H as C}from"./hints-renderer-C71IX-9-.js";const S={onRendered:o=>{}},j=c.createContext(S);class p extends c.Component{constructor(e){super(e);a(this,"questionRenderer");a(this,"hintsRenderer");a(this,"_currentFocus");a(this,"_fullyRendered");a(this,"blurTimeoutID");a(this,"userInput");a(this,"_handleFocusChange",(e,t)=>{e!=null?this._setCurrentFocus(e):this._onRendererBlur(t)});a(this,"handleInteractWithWidget",e=>{const t=y.difference(this.state.questionHighlightedWidgets,[e]);this.setState({questionCompleted:!1,questionHighlightedWidgets:t},()=>{var n,r;(r=(n=this.props.apiOptions)==null?void 0:n.interactionCallback)==null||r.call(n,this.questionRenderer.getUserInputMap())})});a(this,"setAssetStatus",(e,t)=>{const n={...this.state.assetStatuses,[e]:t};this.setState({assetStatuses:n})});this.state={questionCompleted:!1,questionHighlightedWidgets:[],assetStatuses:{}},this._fullyRendered=!1,this.userInput={}}componentDidMount(){this._currentFocus=null,this._fullyRendered=!1,this.maybeCallOnRendered()}UNSAFE_componentWillReceiveProps(e){this.setState({questionHighlightedWidgets:[]})}componentDidUpdate(e,t){const n=this.props.apiOptions.answerableCallback;if(n!=null){const r=this.questionRenderer.emptyWidgets().length===0;n(r)}if(this.maybeCallOnRendered(),this.props.score&&this.props.score!==e.score){const r=this.questionRenderer.emptyWidgets();this.setState({questionCompleted:this.props.score.correct,questionHighlightedWidgets:r})}}componentWillUnmount(){this.blurTimeoutID!=null&&(clearTimeout(this.blurTimeoutID),this.blurTimeoutID=null)}maybeCallOnRendered(){this._fullyRendered||Object.values(this.state.assetStatuses).every(Boolean)&&(this._fullyRendered=!0,this.props.onRendered(!0))}_setCurrentFocus(e){const{apiOptions:{isMobile:t,onFocusChange:n},keypadElement:r}=this.props,l=this._currentFocus;this._currentFocus=e;const g=this.getInputPaths(),m=this._currentFocus&&g.some(d=>R.inputPathsEqual(d,this._currentFocus));n!=null&&setTimeout(()=>{const d=r==null?void 0:r.getDOMNode(),u=d&&m?d.getBoundingClientRect().height:0;n(this._currentFocus,l,u,m&&this.questionRenderer.getDOMNodeForPath(e))},0),r&&t&&(m?r.activate():r.dismiss())}_onRendererBlur(e){const t=this._currentFocus;y.isEqual(e,t)&&(this.blurTimeoutID=setTimeout(()=>{y.isEqual(this._currentFocus,t)&&this._setCurrentFocus(null)},0))}_setWidgetProps(e,t,n){this.questionRenderer._setWidgetProps(e,t,n)}focusPath(e){return this.questionRenderer.focusPath(e)}blurPath(e){return this.questionRenderer.blurPath(e)}getDOMNodeForPath(e){return this.questionRenderer.getDOMNodeForPath(e)}getInputPaths(){return this.questionRenderer.getInputPaths()}focus(){return this.questionRenderer.focus()}blur(){this._currentFocus&&this.blurPath(this._currentFocus)}getNumHints(){return this.props.item.hints.length}getPromptJSON(){return this.questionRenderer.getPromptJSON()}getUserInputLegacy(){return this.questionRenderer.getUserInput()}getUserInput(){return this.userInput}getWidgetIds(){return this.questionRenderer.getWidgetIds()}getSerializedState(){return{question:this.questionRenderer.getSerializedState(),hints:this.hintsRenderer.getSerializedState()}}restoreSerializedState(e,t){let n=2;const r=()=>{--n,t&&n===0&&t()};this.questionRenderer.restoreSerializedState(e.question,r),this.hintsRenderer.restoreSerializedState(e.hints,r)}render(){const e={...A.defaults,...this.props.apiOptions,onFocusChange:this._handleFocusChange},t={assetStatuses:this.state.assetStatuses,setAssetStatus:this.setAssetStatus},n=s.jsx(P.Provider,{value:t,children:s.jsx(I,{widgets:this.props.item.question.widgets,problemNum:this.props.problemNum??0,children:({userInput:l,handleUserInput:g,initializeUserInput:m,restoreUserInputFromSerializedState:d})=>(this.userInput=l,s.jsx(x,{keypadElement:this.props.keypadElement,problemNum:this.props.problemNum,onInteractWithWidget:this.handleInteractWithWidget,highlightedWidgets:this.state.questionHighlightedWidgets,apiOptions:e,questionCompleted:this.state.questionCompleted,reviewMode:this.props.reviewMode,showSolutions:this.props.showSolutions,ref:u=>{u!=null&&(this.questionRenderer=u)},content:this.props.item.question.content,widgets:this.props.item.question.widgets,images:this.props.item.question.images,linterContext:h(this.props.linterContext,"question"),strings:this.context.strings,...this.props.dependencies,userInput:l,handleUserInput:(u,b)=>{g(u,b),this.handleInteractWithWidget(u)},initializeUserInput:m,restoreUserInputFromSerializedState:d}))})}),r=s.jsx(C,{hints:this.props.item.hints,hintsVisible:this.props.hintsVisible,apiOptions:e,ref:l=>this.hintsRenderer=l,linterContext:h(this.props.linterContext,"hints"),strings:this.context.strings});return s.jsx(T.Provider,{value:this.props.dependencies,children:s.jsxs("div",{children:[s.jsx("div",{children:n}),s.jsx("div",{className:e.isMobile?void 0:w.css(N.hintsContainer),children:r})]})})}}a(p,"contextType",k),a(p,"defaultProps",{apiOptions:{},linterContext:q,onRendered:e=>{}});const N=w.StyleSheet.create({hintsContainer:{marginLeft:50}}),O=c.forwardRef((o,i)=>s.jsx(j.Consumer,{children:({onRendered:e})=>s.jsx(p,{...o,onRendered:e,ref:i})}));p.__docgenInfo={description:"",methods:[{name:"maybeCallOnRendered",docblock:null,modifiers:[],params:[],returns:null},{name:"_handleFocusChange",docblock:null,modifiers:[],params:[{name:"newFocus",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}},{name:"oldFocus",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"_setCurrentFocus",docblock:null,modifiers:[],params:[{name:"newFocus",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"_onRendererBlur",docblock:null,modifiers:[],params:[{name:"blurPath",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"_setWidgetProps",docblock:`Accepts a question area widgetId, or an answer area widgetId of
...
the question content.`},{name:"getSerializedState",docblock:"@deprecated - do not use in new code.",modifiers:[],params:[],returns:{type:{name:"signature",type:"object",raw:`{
    question: any;
    hints: any;
}`,signature:{properties:[{key:"question",value:{name:"any",required:!0}},{key:"hints",value:{name:"any",required:!0}}]}}},description:null},{name:"restoreSerializedState",docblock:"@deprecated - do not use in new code.",modifiers:[],params:[{name:"state",optional:!1,type:{name:"signature",type:"object",raw:`{
    question: any;
    hints: any;
}`,signature:{properties:[{key:"question",value:{name:"any",required:!0}},{key:"hints",value:{name:"any",required:!0}}]},alias:"SerializedState"}},{name:"callback",optional:!0,type:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}}}],returns:null,description:null},{name:"setAssetStatus",docblock:null,modifiers:[],params:[{name:"assetKey",optional:!1,type:null},{name:"status",optional:!1,type:null}],returns:null}],displayName:"ServerItemRenderer",props:{apiOptions:{defaultValue:{value:"{}",computed:!1},required:!1},linterContext:{defaultValue:{value:`{
    contentType: "",
    highlightLint: false,
    paths: [],
    stack: [],
}`,computed:!1},required:!1},onRendered:{defaultValue:{value:"(isRendered: boolean) => {}",computed:!1},required:!1}}};O.__docgenInfo={description:"",methods:[],displayName:"ref"};export{p as S};
