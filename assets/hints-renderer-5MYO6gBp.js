import{a as c,j as h}from"./jsx-runtime-5BUNAZ9W.js";import{l as R,R as E,p as A}from"./renderer-jXtsf37s.js";import{l as i}from"./index-awljIyHI.js";import{c as x}from"./index-dnMhQZ-1.js";import{r as O}from"./index-4g5l5LRQ.js";import{R as N}from"./index-jmm5gWkb.js";import{_ as p}from"./index-default-4_ZsnO94.js";import{P as W}from"./i18n-context-3gTlIcWM.js";import{l as d,m as L,o as j,k as I,q as P,h as _}from"./constants-I_nlPaPx.js";import{m as u}from"./media-queries-MaBBbpNq.js";import{A as F}from"./perseus-api-cFDIds9P.js";import{s as $}from"./shared-3pf9YZIg.js";import{U as S}from"./util-Kf-UsGkl.js";const v=class v extends O.Component{constructor(){super(...arguments),this.getSerializedState=()=>this.refs.renderer.getSerializedState(),this.restoreSerializedState=(e,r)=>{this.refs.renderer.restoreSerializedState(e,r)}}render(){const{apiOptions:e,className:r,hint:t,lastHint:n,lastRendered:a,pos:y,totalHints:m}=this.props,{isMobile:g}=e,s=x("hint",!g&&"perseus-hint-renderer",g&&i.css(T.newHint),g&&a&&i.css(T.lastRenderedNewHint),n&&"last-hint",a&&"last-rendered",r),o={...e,customKeypad:!1};return c("div",{className:s,tabIndex:"-1",children:[!e.isMobile&&h("span",{className:"perseus-sr-only",children:this.context.strings.hintPos({pos:y+1})}),!e.isMobile&&m!=null&&y!=null&&h("span",{className:"perseus-hint-label",style:{display:"block",color:e.hintProgressColor},children:`${y+1} / ${m}`}),h(E,{ref:"renderer",hintMode:!0,widgets:t.widgets,content:t.content||"",images:t.images,apiOptions:o,findExternalWidgets:this.props.findExternalWidgets,linterContext:A(this.props.linterContext,"hint"),strings:this.context.strings})]})}};v.contextType=W,v.defaultProps={linterContext:R};let b=v;const T=i.StyleSheet.create({newHint:{marginBottom:1.5*d,borderLeftColor:L,borderLeftStyle:"solid",borderLeftWidth:j,[u.lgOrSmaller]:{paddingLeft:d},[u.smOrSmaller]:{paddingLeft:0},":focus":{outline:"none"}},lastRenderedNewHint:{marginBottom:0,borderLeftColor:I}});b.__docgenInfo={description:"",methods:[{name:"getSerializedState",docblock:null,modifiers:[],params:[],returns:null},{name:"restoreSerializedState",docblock:null,modifiers:[],params:[{name:"state",optional:!1,type:null},{name:"callback",optional:!1,type:null}],returns:null}],displayName:"HintRenderer",props:{apiOptions:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onInputError?: (
        widgetId: any,
        value: string,
...
the available choices.`}]}}],raw:`Readonly<{
     ...
     */
    onWidgetStartProps?: (widgets: PerseusWidgetsMap) => void;
}>`},description:""},className:{required:!1,tsType:{name:"string"},description:""},hint:{required:!0,tsType:{name:"any"},description:""},lastHint:{required:!1,tsType:{name:"boolean"},description:""},lastRendered:{required:!1,tsType:{name:"boolean"},description:""},pos:{required:!0,tsType:{name:"number"},description:""},totalHints:{required:!1,tsType:{name:"number"},description:""},findExternalWidgets:{required:!1,tsType:{name:"any"},description:""},linterContext:{required:!1,tsType:{name:"LinterContextProps"},description:"",defaultValue:{value:"PerseusLinter.linterContextDefault",computed:!0}}}};const f=class f extends O.Component{constructor(){super(...arguments),this.state={isFinalHelpPage:!1},this._hintsVisible=()=>this.props.hintsVisible==null||this.props.hintsVisible===-1?this.props.hints.length:this.props.hintsVisible,this._cacheImagesInHint=e=>{p.each(e.images,(r,t)=>{const n=new Image;n.src=S.getRealImageUrl(t)})},this._cacheHintImages=()=>{this._hintsVisible()>0?p.each(this.props.hints,this._cacheImagesInHint):this.props.hints.length>0&&this._cacheImagesInHint(this.props.hints[0])},this.getApiOptions=()=>({...F.defaults,...this.props.apiOptions,readOnly:!1}),this.getSerializedState=()=>p.times(this._hintsVisible(),e=>this.refs["hintRenderer"+e].getSerializedState()),this.restoreSerializedState=(e,r)=>{let t=1;const n=()=>{--t,r&&t===0&&r()};p.each(e,(a,y)=>{const m=this.refs["hintRenderer"+y];m&&(++t,m.restoreSerializedState(a,n))}),n()}}componentDidMount(){this._cacheHintImages()}UNSAFE_componentWillReceiveProps(e){e.hintsVisible-this.props.hintsVisible>1&&this.setState({isFinalHelpPage:!0})}componentDidUpdate(e,r){(!p.isEqual(e.hints,this.props.hints)||e.hintsVisible!==this.props.hintsVisible)&&this._cacheHintImages();const t=e.hintsVisible||0,n=this.props.hintsVisible||0;if(t<n&&n<=this.props.hints.length&&n>=0){const a=n-1;N.findDOMNode(this.refs["hintRenderer"+a]).focus()}}render(){const e=this.getApiOptions(),r=this._hintsVisible(),t=[],n=this.state.isFinalHelpPage;this.props.hints.slice(0,r).forEach((s,o)=>{const z=o===this.props.hints.length-1&&!/\*\*/.test(s.content),C=o===r-1,w=h(b,{lastHint:z,lastRendered:C,hint:s,pos:o,totalHints:this.props.hints.length,ref:"hintRenderer"+o,apiOptions:e,findExternalWidgets:this.props.findExternalWidgets,linterContext:A(this.props.linterContext,"hints["+o+"]")},"hintRenderer"+o);n?t.push(w):s.replace&&t.length>0?t[t.length-1]=w:t.push(w)});const{getAnotherHint:a}=e,y=a&&r>0&&r<this.props.hints.length,m=`(${r}/${this.props.hints.length})`,g=x(this.props.className,e.isMobile&&r>0&&i.css(l.mobileHintStylesHintsRenderer));return c("div",{className:g,children:[e.isMobile&&r>0&&h("div",{className:i.css(l.mobileHintStylesHintTitle,$.responsiveLabel),children:this.context.strings.hints}),t,y&&c("button",{rel:"button",className:i.css(l.linkButton,l.getAnotherHintButton,e.isMobile&&l.mobileHintStylesGetAnotherHintButton),onClick:s=>{s.preventDefault(),s.stopPropagation(),a&&a()},children:[h("span",{className:i.css(l.plusText,e.isMobile&&l.mobileHintStylesPlusText),children:"+"}),c("span",{className:i.css(l.getAnotherHintText),children:[this.context.strings.getAnotherHint," ",m]})]})]})}};f.contextType=W,f.defaultProps={linterContext:R};let q=f;const k=d+j,l=i.StyleSheet.create({rendererMargins:{marginTop:d},linkButton:{cursor:"pointer",border:"none",backgroundColor:"transparent",fontSize:"100%",fontFamily:"inherit",fontWeight:"bold",color:I,padding:0,position:"relative"},plusText:{fontSize:20,position:"absolute",top:-3,left:0},getAnotherHintText:{marginLeft:16},mobileHintStylesHintsRenderer:{marginTop:4*d,border:`solid ${P}`,borderWidth:"1px 0 0 0",position:"relative",":before":{content:'""',display:"table",clear:"both"},":after":{content:'""',display:"table",clear:"both"}},mobileHintStylesHintTitle:{fontFamily:"inherit",fontStyle:"normal",fontWeight:"bold",color:_,paddingTop:d,paddingBottom:1.5*d,[u.lgOrSmaller]:{paddingLeft:0},[u.smOrSmaller]:{paddingLeft:k}},getAnotherHintButton:{marginTop:1.5*d},mobileHintStylesGetAnotherHintButton:{[u.lgOrSmaller]:{paddingLeft:0},[u.smOrSmaller]:{paddingLeft:k}},mobileHintStylesPlusText:{[u.lgOrSmaller]:{left:0},[u.smOrSmaller]:{left:k}}});q.__docgenInfo={description:"",methods:[{name:"_hintsVisible",docblock:null,modifiers:[],params:[],returns:null},{name:"_cacheImagesInHint",docblock:null,modifiers:[],params:[{name:"hint",optional:!1,type:null}],returns:null},{name:"_cacheHintImages",docblock:null,modifiers:[],params:[],returns:null},{name:"getApiOptions",docblock:null,modifiers:[],params:[],returns:null},{name:"getSerializedState",docblock:null,modifiers:[],params:[],returns:null},{name:"restoreSerializedState",docblock:null,modifiers:[],params:[{name:"state",optional:!1,type:null},{name:"callback",optional:!1,type:null}],returns:null}],displayName:"HintsRenderer",props:{className:{required:!1,tsType:{name:"string"},description:""},hints:{required:!0,tsType:{name:"ReadonlyArray",elements:[{name:"any"}],raw:"ReadonlyArray<any>"},description:""},hintsVisible:{required:!1,tsType:{name:"number"},description:""},linterContext:{defaultValue:{value:"PerseusLinter.linterContextDefault",computed:!0},required:!1}}};export{q as H};
