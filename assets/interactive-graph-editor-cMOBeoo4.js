...
Locked figures are graph elements (points, lines, line segmeents,
etc.) that are locked in place and not interactive.`},{key:"fullGraphAriaLabel",value:{name:"string",required:!1}},{key:"fullGraphAriaDescription",value:{name:"string",required:!1}},{key:"graph",value:{name:'PropsFor["graph"]',raw:'InteractiveGraphProps["graph"]',required:!0},description:"The graph to display in the graph area."},{key:"onChange",value:{name:"signature",type:"function",raw:"(props: Partial<Props>) => void",signature:{arguments:[{type:{name:"Partial",elements:[{name:"Props"}],raw:"Partial<Props>"},name:"props"}],return:{name:"void"}},required:!0}},{key:"static",value:{name:"boolean",required:!1}}]}}],raw:"Partial<EditorProps>"},name:"graphProps"}],return:{name:"void"}}},description:""}}};const rn=$e("ul");function an(r){const n=[],a=document.getElementById(r);return a&&a.querySelectorAll("*").forEach(t=>{var h;const l=[],i=t.getAttribute("aria-label"),s=t.getAttribute("aria-describedby");if(i&&l.unshift({name:"label",value:i}),s){const p=s.split(/ +/);for(const w of p){const C=(h=document.getElementById(w))==null?void 0:h.textContent;C&&l.push({name:"description",value:C})}}l.length>0&&n.push({roleOrTag:t.getAttribute("role")||t.tagName.toLowerCase(),className:t.classList[t.classList.length-1]||"",attributes:l})}),n}function tn(r){const{elementArias:n,showTags:a}=r;return e.createElement("ol",{style:{listStyle:"revert",marginLeft:8}},n.map((t,l)=>e.createElement("li",{key:l},a&&e.createElement(oe,{size:"small",kind:"success",style:O.smallSpaceRight},t.roleOrTag),t.className,e.createElement(rn,{style:O.indentListLeft},t.attributes.map((i,s)=>e.createElement("li",{key:s},e.createElement(oe,{size:"small",kind:i.name==="label"?"info":"neutral",style:O.smallSpaceRight},i.name),i.value))))))}function Ae({graphId:r,correct:n,fullGraphAriaLabel:a,fullGraphAriaDescription:t,lockedFigures:l}){const[i,s]=e.useState(!0),[h,p]=e.useState(!1),[w,C]=e.useState([]),x=e.useId();return e.useEffect(()=>{C(an(r))},[n,a,t,r,l]),e.createElement(e.Fragment,null,e.createElement(W,{title:"Screen reader tree",isOpen:i,onToggle:s,isCollapsible:!0}),i&&e.createElement(e.Fragment,null,e.createElement(u,{style:[O.row,O.tagSwitch]},e.createElement(Ve,{id:x,checked:h,onChange:p}),e.createElement(y,{size:o.xSmall_8}),e.createElement(I,{tag:"label",htmlFor:x},"Show HTML roles/tags")),e.createElement(tn,{elementArias:w,showTags:h})))}const O=v.StyleSheet.create({smallSpaceRight:{marginRight:o.xxSmall_6},indentListLeft:{listStyle:"revert",marginLeft:o.small_12},tagSwitch:{marginTop:o.xSmall_8,marginBottom:o.xSmall_8},row:{flexDirection:"row",alignItems:"center"}});Ae.__docgenInfo={description:"",methods:[],displayName:"InteractiveGraphSRTree"};const Pe=({numSegments:r=1,onChange:n})=>e.createElement(E,{key:"segment-select",selectedValue:`${r}`,placeholder:"",onChange:a=>{const t=+a;n(t)},style:on.singleSelectShort},N.range(1,7).map(a=>e.createElement(d,{key:a,value:`${a}`,label:`${a} segment${a>1?"s":""}`}))),on=v.StyleSheet.create({singleSelectShort:{height:26}});Pe.__docgenInfo={description:"",methods:[],displayName:"SegmentCountSelector",props:{numSegments:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"1",computed:!1}},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(numSegments: number) => void",signature:{arguments:[{type:{name:"number"},name:"numSegments"}],return:{name:"void"}}},description:""}}};const ln=""+new URL("arrow-counter-clockwise-bold-Zg1fUITb.svg",import.meta.url).href,{getClockwiseAngle:sn}=je;function un(r){if("startCoords"in r)return r.startCoords}function mn(r,n,a){switch(r.type){case"linear":case"ray":return be({...r,startCoords:void 0},n,a);case"segment":return we({...r,startCoords:void 0},n,a);case"linear-system":return ge({...r,startCoords:void 0},n,a);case"circle":const t=ye({...r,startCoords:void 0}),l=se(ue(t.radiusPoint,t.center));return{center:t.center,radius:l};case"sinusoid":return he({...r,startCoords:void 0},n,a);case"quadratic":return ce({...r,startCoords:void 0},n,a);case"point":return pe({...r,startCoords:void 0},n,a);case"polygon":return de({...r,startCoords:void 0},n,a);case"angle":return me({graph:{...r,startCoords:void 0},range:n,step:a});default:return}}const dn=r=>{const n=r[0],a=r[1],t=a[1]-n[1],l=Math.PI/(2*(a[0]-n[0])),i=n[0]*l,s=n[1];return"y = "+t.toFixed(3)+"sin("+l.toFixed(3)+"x - "+i.toFixed(3)+") + "+s.toFixed(3)},pn=r=>{const n=r[0],a=r[1],t=r[2],l=(n[0]-a[0])*(n[0]-t[0])*(a[0]-t[0]);if(l===0)return"Division by zero error";const i=(t[0]*(a[1]-n[1])+a[0]*(n[1]-t[1])+n[0]*(t[1]-a[1]))/l,s=(t[0]*t[0]*(n[1]-a[1])+a[0]*a[0]*(t[1]-n[1])+n[0]*n[0]*(a[1]-t[1]))/l,h=(a[0]*t[0]*(a[0]-t[0])*n[1]+t[0]*n[0]*(t[0]-n[0])*a[1]+n[0]*a[0]*(n[0]-a[0])*t[1])/l;return"y = "+i.toFixed(3)+"x^2 + "+s.toFixed(3)+"x + "+h.toFixed(3)},cn=(r,n=!1)=>{const a=r[1];return`${sn(r,n).toFixed(0)}° angle at (${a[0]}, ${a[1]})`},hn=(r,n)=>{if(n)return!1;switch(r.type){case"point":return r.numPoints!=="unlimited";case"polygon":return r.numSides!=="unlimited"&&r.snapTo!=="angles"&&r.snapTo!=="sides";case"none":return!1;case"angle":case"circle":case"linear":case"linear-system":case"quadratic":case"ray":case"segment":case"sinusoid":return!0;default:throw new ke(r)}},Ne=r=>{const{startCoords:n,allowReflexAngles:a,onChange:t}=r;return e.createElement(e.Fragment,null,e.createElement(u,{style:L.equationSection},e.createElement(X,null,"Starting equation:"),e.createElement(z,{style:L.equationBody},cn(n,a))),e.createElement(u,{style:L.tile},e.createElement(g,null,"Point 1:"),e.createElement(y,{size:o.small_12}),e.createElement(k,{coord:n[0],labels:["x","y"],onChange:l=>t([l,n[1],n[2]])})),e.createElement(u,{style:L.tile},e.createElement(g,null,"Vertex:"),e.createElement(y,{size:o.small_12}),e.createElement(k,{coord:n[1],labels:["x","y"],onChange:l=>t([n[0],l,n[2]])})),e.createElement(u,{style:L.tile},e.createElement(g,null,"Point 2:"),e.createElement(y,{size:o.small_12}),e.createElement(k,{coord:n[2],labels:["x","y"],onChange:l=>t([n[0],n[1],l])})))},L=v.StyleSheet.create({tile:{backgroundColor:b.fadedBlue8,marginTop:o.xSmall_8,padding:o.small_12,borderRadius:o.xSmall_8,flexDirection:"row",alignItems:"center"},equationSection:{marginTop:o.small_12},equationBody:{backgroundColor:b.fadedOffBlack8,border:`1px solid ${b.fadedOffBlack32}`,marginTop:o.xSmall_8,paddingLeft:o.xSmall_8,paddingRight:o.xSmall_8,fontSize:K.size.xSmall}});Ne.__docgenInfo={description:"",methods:[],displayName:"StartCoordsAngle",props:{startCoords:{required:!0,tsType:{name:"tuple",raw:"[Coord, Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},description:""},allowReflexAngles:{required:!1,tsType:{name:"boolean"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: AngleCoords) => void",signature:{arguments:[{type:{name:"tuple",raw:"[Coord, Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},name:"startCoords"}],return:{name:"void"}}},description:""}}};const Ee=r=>{const{startCoords:n,onChange:a}=r,[t,l]=e.useState(n.radius.toString());e.useEffect(()=>{l(n.radius.toString())},[n.radius]);function i(s){l(s),!(isNaN(+s)||s===""||+s==0)&&a({center:n.center,radius:parseFloat(s)})}return e.createElement(u,{style:G.tile},e.createElement(u,{style:G.row},e.createElement(g,null,"Center:"),e.createElement(y,{size:o.small_12}),e.createElement(k,{coord:n.center,labels:["x","y"],onChange:s=>a({center:s,radius:n.radius})})),e.createElement(y,{size:o.small_12}),e.createElement(g,{tag:"label",style:G.row},"Radius:",e.createElement(y,{size:o.small_12}),e.createElement(Ze,{value:t,onChange:i,style:G.textField})))},G=v.StyleSheet.create({tile:{backgroundColor:b.fadedBlue8,marginTop:o.xSmall_8,padding:o.small_12,borderRadius:o.xSmall_8},row:{display:"flex",flexDirection:"row",alignItems:"center"},textField:{width:o.xxxLarge_64}});Ee.__docgenInfo={description:"",methods:[],displayName:"StartCoordsCircle",props:{startCoords:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    center: Coord;
    radius: number;
