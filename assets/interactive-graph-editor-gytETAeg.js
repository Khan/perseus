import{j as e}from"./jsx-runtime-63Ea5SlK.js";import{U as pe}from"./util-_iDv4tVD.js";import{l as ye,s as ge,e as ze}from"./svg-image-3LTMuTsF.js";import{g as we,f as be,h as ke,i as fe,j as ve,k as Ce,n as qe,o as xe,q as Te,r as _e,s as He}from"./article-renderer-zPjdUlLS.js";import{_ as A}from"./jquery-yG1GhClm.js";import"./phet-simulation-VOua3fMz.js";import"./version-akiLXZts.js";import"./dependencies-CP7Uh8Kq.js";import"./perseus-api-ooj0_ZRv.js";import"./perseus-item-AHZmJsDh.js";import"./hints-renderer-_vvYsFS8.js";import{o as Ke,q as $e}from"./renderer-fE8shvP-.js";import"./base-radio-pgwo-5L3.js";import{c as Be}from"./components-h3JKYRA5.js";import{i as Xe}from"./constants-iPV6vHZm.js";import"./i18n-context-ei4f54eq.js";import{w as Ae}from"./index-J2t_5nK1.js";import{i as p}from"./tiny-invariant-bHgPayXn.js";import"./index-smZ6iCr_.js";import{V as m}from"./index-glC8WTvQ.js";import{S as P,O as d}from"./answer-choices-FNRVtUNv.js";import{T as Ue,a as Qe,C as G}from"./index-WDW9kCBC.js";import{s as o,c as g,f as $}from"./index-dmcq622U.js";import{d as Pe,f as z,L as c,a as B,b as D}from"./index-SZdB7w_U.js";import{l as f}from"./index-awljIyHI.js";import{r as j}from"./index-6oxdNXpR.js";import{H as X}from"./heading-HY6ltyel.js";import{S as h}from"./index-R5O7Arjo.js";import{L as x,I as Ye}from"./interactive-graph-settings-1_p0u1h9.js";import{L as Ze}from"./locked-figures-section-0py__TKk.js";import"./button-group-G5CZaedn.js";import"./graph-lX85VXnO.js";import"./hud-ifw9Ofbw.js";import"./icon-7RFbyLiL.js";import"./index-ZIpjk6I_.js";import"./inline-icon-6fh0Wu1y.js";import"./math-input-N_MDxKlQ.js";import"./multi-button-group-QUVHbBcE.js";import"./number-input-T6lG2NEQ.js";import"./range-input-Gg2JKhNA.js";import"./text-input-0d3Qfm7R.js";import"./text-list-editor-K49FGdd7.js";import{B as Je}from"./index-o183v7SS.js";import{C as w,P as en}from"./locked-label-settings-rBXh6kM5.js";import{S as nn}from"./scrollless-number-text-field-ylv3j7Ao.js";const H="unlimited",Ne=r=>{const n=parseInt(r,10);return isNaN(n)||n===0?H:n},Re=({numPoints:r=1,onChange:n})=>e.jsx(P,{selectedValue:`${r}`,onChange:a=>{n(Ne(a))},placeholder:"",style:rn.singleSelectShort,children:[...[...Array(7).keys()].map(a=>e.jsx(d,{value:`${a}`,label:`${a} point${a>1?"s":""}`},a)),e.jsx(d,{value:H,label:"unlimited"},"unlimited")]}),rn=f.StyleSheet.create({singleSelectShort:{height:26}});Re.__docgenInfo={description:"",methods:[],displayName:"GraphPointsCountSelector",props:{numPoints:{required:!1,tsType:{name:"union",raw:"number | typeof UNLIMITED",elements:[{name:"number"},{name:"UNLIMITED"}]},description:"",defaultValue:{value:"1",computed:!1}},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(points: PointValue) => void",signature:{arguments:[{type:{name:"union",raw:"number | typeof UNLIMITED",elements:[{name:"number"},{name:"UNLIMITED"}]},name:"points"}],return:{name:"void"}}},description:""}}};const Le=r=>e.jsxs(P,{selectedValue:r.graphType,onChange:r.onChange,placeholder:"Select an answer type",style:an.singleSelectShort,children:[r.showNoneOption&&e.jsx(d,{value:"none",label:"None"}),e.jsx(d,{value:"linear",label:"Linear function"}),e.jsx(d,{value:"quadratic",label:"Quadratic function"}),e.jsx(d,{value:"sinusoid",label:"Sinusoid function"}),e.jsx(d,{value:"circle",label:"Circle"}),e.jsx(d,{value:"point",label:"Point(s)"}),e.jsx(d,{value:"linear-system",label:"Linear System"}),e.jsx(d,{value:"polygon",label:"Polygon"}),e.jsx(d,{value:"segment",label:"Line Segment(s)"}),e.jsx(d,{value:"ray",label:"Ray"}),e.jsx(d,{value:"angle",label:"Angle"})]}),an=f.StyleSheet.create({singleSelectShort:{height:26}});Le.__docgenInfo={description:"",methods:[],displayName:"GraphTypeSelector",props:{graphType:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(newGraphType: string) => void",signature:{arguments:[{type:{name:"string"},name:"newGraphType"}],return:{name:"void"}}},description:""},showNoneOption:{required:!0,tsType:{name:"boolean"},description:""}}};function je(r){return e.jsxs(e.Fragment,{children:[e.jsx(X,{title:"Correct Answer",isOpen:!0,isCollapsible:!1}),e.jsxs(m,{children:[e.jsxs(m,{children:[e.jsx(Pe,{style:{paddingTop:o.xxSmall_6,paddingBottom:o.xxSmall_6,color:g.offBlack64},children:"Graph the correct answer in the graph below and ensure the equation or point coordinates displayed represent the correct answer."}),e.jsx(z,{style:{fontSize:12,backgroundColor:"#eee",paddingInline:o.xxSmall_6,borderColor:"#ccc",borderStyle:"solid",borderWidth:1},children:r.equationString})]}),r.children]})]})}je.__docgenInfo={description:"",methods:[],displayName:"InteractiveGraphCorrectAnswer",props:{equationString:{required:!0,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""}}};function Ie(r){const{ariaLabelValue:n,ariaDescriptionValue:a,onChange:t}=r,[l,u]=j.useState(!0);return e.jsxs(e.Fragment,{children:[e.jsx(X,{title:"Description",isCollapsible:!0,isOpen:l,onToggle:u}),l&&e.jsxs(m,{children:[e.jsx(Pe,{style:_.caption,children:"Use these fields to describe the graph as a whole. These are used by screen readers to describe content to users who may be visually impaired."}),e.jsxs(c,{tag:"label",children:["Title",e.jsx(Ue,{value:n,onChange:s=>t({fullGraphAriaLabel:s||void 0}),style:_.spaceAbove})]}),e.jsx(h,{size:o.small_12}),e.jsxs(c,{tag:"label",children:["Description",e.jsx(Qe,{rows:8,resizeType:"vertical",value:a,onChange:s=>t({fullGraphAriaDescription:s||void 0}),style:_.spaceAbove})]})]})]})}const _=f.StyleSheet.create({caption:{color:g.offBlack64,paddingTop:o.xxSmall_6,paddingBottom:o.xxSmall_6},spaceAbove:{marginTop:o.xxxSmall_4}});Ie.__docgenInfo={description:"",methods:[],displayName:"InteractiveGraphDescription",props:{ariaLabelValue:{required:!0,tsType:{name:"string"},description:""},ariaDescriptionValue:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(graphProps: Partial<EditorProps>) => void",signature:{arguments:[{type:{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
...
Locked figures are graph elements (points, lines, line segmeents,
etc.) that are locked in place and not interactive.`},{key:"fullGraphAriaLabel",value:{name:"string",required:!1}},{key:"fullGraphAriaDescription",value:{name:"string",required:!1}},{key:"graph",value:{name:'PropsFor["graph"]',raw:'InteractiveGraphProps["graph"]',required:!0},description:"The graph to display in the graph area."},{key:"onChange",value:{name:"signature",type:"function",raw:"(props: Partial<Props>) => void",signature:{arguments:[{type:{name:"Partial",elements:[{name:"Props"}],raw:"Partial<Props>"},name:"props"}],return:{name:"void"}},required:!0}},{key:"static",value:{name:"boolean",required:!1}}]}}],raw:"Partial<EditorProps>"},name:"graphProps"}],return:{name:"void"}}},description:""}}};const Se=({numSegments:r=1,onChange:n})=>e.jsx(P,{selectedValue:`${r}`,placeholder:"",onChange:a=>{const t=+a;n(t)},style:tn.singleSelectShort,children:A.range(1,7).map(a=>e.jsx(d,{value:`${a}`,label:`${a} segment${a>1?"s":""}`},a))},"segment-select"),tn=f.StyleSheet.create({singleSelectShort:{height:26}});Se.__docgenInfo={description:"",methods:[],displayName:"SegmentCountSelector",props:{numSegments:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"1",computed:!1}},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(numSegments: number) => void",signature:{arguments:[{type:{name:"number"},name:"numSegments"}],return:{name:"void"}}},description:""}}};const on=""+new URL("arrow-counter-clockwise-bold-Zg1fUITb.svg",import.meta.url).href;function ln(r){if("startCoords"in r)return r.startCoords}function sn(r,n,a){switch(r.type){case"linear":case"ray":return Te({...r,startCoords:void 0},n,a);case"segment":return xe({...r,startCoords:void 0},n,a);case"linear-system":return qe({...r,startCoords:void 0},n,a);case"circle":const t=Ce({...r,startCoords:void 0}),l=ye(ge(t.radiusPoint,t.center));return{center:t.center,radius:l};case"sinusoid":return ve({...r,startCoords:void 0},n,a);case"quadratic":return fe({...r,startCoords:void 0},n,a);case"point":return ke({...r,startCoords:void 0},n,a);case"polygon":return be({...r,startCoords:void 0},n,a);case"angle":return we({graph:{...r,startCoords:void 0},range:n,step:a});default:return}}const un=r=>{const n=r[0],a=r[1],t=a[1]-n[1],l=Math.PI/(2*(a[0]-n[0])),u=n[0]*l,s=n[1];return"y = "+t.toFixed(3)+"sin("+l.toFixed(3)+"x - "+u.toFixed(3)+") + "+s.toFixed(3)},mn=r=>{const n=r[0],a=r[1],t=r[2],l=(n[0]-a[0])*(n[0]-t[0])*(a[0]-t[0]);if(l===0)return"Division by zero error";const u=(t[0]*(a[1]-n[1])+a[0]*(n[1]-t[1])+n[0]*(t[1]-a[1]))/l,s=(t[0]*t[0]*(n[1]-a[1])+a[0]*a[0]*(t[1]-n[1])+n[0]*n[0]*(a[1]-t[1]))/l,C=(a[0]*t[0]*(a[0]-t[0])*n[1]+t[0]*n[0]*(t[0]-n[0])*a[1]+n[0]*a[0]*(n[0]-a[0])*t[1])/l;return"y = "+u.toFixed(3)+"x^2 + "+s.toFixed(3)+"x + "+C.toFixed(3)},dn=(r,n=!1)=>{const a=r[1];return`${_e(r,n).toFixed(0)}° angle at (${a[0]}, ${a[1]})`},pn=(r,n)=>{if(n)return!1;switch(r.type){case"point":return r.numPoints!=="unlimited";case"polygon":return r.numSides!=="unlimited"&&r.snapTo!=="angles"&&r.snapTo!=="sides";case"none":return!1;case"angle":case"circle":case"linear":case"linear-system":case"quadratic":case"ray":case"segment":case"sinusoid":return!0;default:throw new Ae(r)}},Oe=r=>{const{startCoords:n,allowReflexAngles:a,onChange:t}=r;return e.jsxs(e.Fragment,{children:[e.jsxs(m,{style:N.equationSection,children:[e.jsx(B,{children:"Starting equation:"}),e.jsx(z,{style:N.equationBody,children:dn(n,a)})]}),e.jsxs(m,{style:N.tile,children:[e.jsx(c,{children:"Point 1:"}),e.jsx(h,{size:o.small_12}),e.jsx(w,{coord:n[0],labels:["x","y"],onChange:l=>t([l,n[1],n[2]])})]}),e.jsxs(m,{style:N.tile,children:[e.jsx(c,{children:"Vertex:"}),e.jsx(h,{size:o.small_12}),e.jsx(w,{coord:n[1],labels:["x","y"],onChange:l=>t([n[0],l,n[2]])})]}),e.jsxs(m,{style:N.tile,children:[e.jsx(c,{children:"Point 2:"}),e.jsx(h,{size:o.small_12}),e.jsx(w,{coord:n[2],labels:["x","y"],onChange:l=>t([n[0],n[1],l])})]})]})},N=f.StyleSheet.create({tile:{backgroundColor:g.fadedBlue8,marginTop:o.xSmall_8,padding:o.small_12,borderRadius:o.xSmall_8,flexDirection:"row",alignItems:"center"},equationSection:{marginTop:o.small_12},equationBody:{backgroundColor:g.fadedOffBlack8,border:`1px solid ${g.fadedOffBlack32}`,marginTop:o.xSmall_8,paddingLeft:o.xSmall_8,paddingRight:o.xSmall_8,fontSize:$.size.xSmall}});Oe.__docgenInfo={description:"",methods:[],displayName:"StartCoordsAngle",props:{startCoords:{required:!0,tsType:{name:"tuple",raw:"[Coord, Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},description:""},allowReflexAngles:{required:!1,tsType:{name:"boolean"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: AngleCoords) => void",signature:{arguments:[{type:{name:"tuple",raw:"[Coord, Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},name:"startCoords"}],return:{name:"void"}}},description:""}}};const Fe=r=>{const{startCoords:n,onChange:a}=r,[t,l]=j.useState(n.radius.toString());j.useEffect(()=>{l(n.radius.toString())},[n.radius]);function u(s){l(s),!(isNaN(+s)||s===""||+s==0)&&a({center:n.center,radius:parseFloat(s)})}return e.jsxs(m,{style:M.tile,children:[e.jsxs(m,{style:M.row,children:[e.jsx(c,{children:"Center:"}),e.jsx(h,{size:o.small_12}),e.jsx(w,{coord:n.center,labels:["x","y"],onChange:s=>a({center:s,radius:n.radius})})]}),e.jsx(h,{size:o.small_12}),e.jsxs(c,{tag:"label",style:M.row,children:["Radius:",e.jsx(h,{size:o.small_12}),e.jsx(nn,{value:t,onChange:u,style:M.textField})]})]})},M=f.StyleSheet.create({tile:{backgroundColor:g.fadedBlue8,marginTop:o.xSmall_8,padding:o.small_12,borderRadius:o.xSmall_8},row:{display:"flex",flexDirection:"row",alignItems:"center"},textField:{width:o.xxxLarge_64}});Fe.__docgenInfo={description:"",methods:[],displayName:"StartCoordsCircle",props:{startCoords:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    center: Coord;
    radius: number;
    ...
    center: Coord;
    radius: number;
}`,signature:{properties:[{key:"center",value:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}],required:!0}},{key:"radius",value:{name:"number",required:!0}}]}},name:"startCoords"}],return:{name:"void"}}},description:""}}};const Ee=r=>{const{startCoords:n,onChange:a}=r;return e.jsxs(e.Fragment,{children:[e.jsxs(m,{style:ce.tile,children:[e.jsx(c,{children:"Point 1:"}),e.jsx(h,{size:o.small_12}),e.jsx(w,{coord:n[0],labels:["x","y"],onChange:t=>a([t,n[1]])})]}),e.jsxs(m,{style:ce.tile,children:[e.jsx(c,{children:"Point 2:"}),e.jsx(h,{size:o.small_12}),e.jsx(w,{coord:n[1],labels:["x","y"],onChange:t=>a([n[0],t])})]})]})},ce=f.StyleSheet.create({tile:{backgroundColor:g.fadedBlue8,marginTop:o.xSmall_8,padding:o.small_12,borderRadius:o.xSmall_8,flexDirection:"row",alignItems:"center"}});Ee.__docgenInfo={description:"",methods:[],displayName:"StartCoordsLine",props:{startCoords:{required:!0,tsType:{name:"tuple",raw:"[Vector2, Vector2]",elements:[{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]},{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]}]},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: CollinearTuple) => void",signature:{arguments:[{type:{name:"tuple",raw:"[Vector2, Vector2]",elements:[{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]},{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]}]},name:"startCoords"}],return:{name:"void"}}},description:""}}};const Ge=r=>{const{startCoords:n,type:a,onChange:t}=r,l=a==="segment"?"Segment":"Line";return e.jsx(e.Fragment,{children:n.map((u,s)=>e.jsxs(en,{header:e.jsx(c,{children:`${l} ${s+1}`}),expanded:!0,children:[e.jsxs(m,{style:he.nestedTile,children:[e.jsx(c,{children:"Point 1:"}),e.jsx(h,{size:o.small_12}),e.jsx(w,{coord:u[0],labels:["x","y"],onChange:C=>{const k=[...n];k[s]=[C,u[1]],t(k)}})]}),e.jsxs(m,{style:he.nestedTile,children:[e.jsx(c,{children:"Point 2:"}),e.jsx(h,{size:o.small_12}),e.jsx(w,{coord:u[1],labels:["x","y"],onChange:C=>{const k=[...n];k[s]=[u[0],C],t(k)}})]})]},`segment-${s}-start-coords`))})},he=f.StyleSheet.create({nestedTile:{paddingBottom:o.small_12,flexDirection:"row",alignItems:"center"}});Ge.__docgenInfo={description:"",methods:[],displayName:"StartCoordsMultiline",props:{type:{required:!0,tsType:{name:"union",raw:'"linear-system" | "segment"',elements:[{name:"literal",value:'"linear-system"'},{name:"literal",value:'"segment"'}]},description:""},startCoords:{required:!0,tsType:{name:"Array",elements:[{name:"tuple",raw:"[Vector2, Vector2]",elements:[{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]},{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]}]}],raw:"CollinearTuple[]"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: CollinearTuple[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"tuple",raw:"[Vector2, Vector2]",elements:[{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]},{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]}]}],raw:"CollinearTuple[]"},name:"startCoords"}],return:{name:"void"}}},description:""}}};const De=r=>{const{startCoords:n,onChange:a}=r;return e.jsx(e.Fragment,{children:n.map((t,l)=>e.jsxs(m,{style:cn.tile,children:[e.jsx(c,{children:`Point ${l+1}:`}),e.jsx(h,{size:o.small_12}),e.jsx(w,{coord:t,labels:["x","y"],onChange:u=>{const s=[...n];s[l]=u,a(s)}})]},l))})},cn=f.StyleSheet.create({tile:{backgroundColor:g.fadedBlue8,marginTop:o.xSmall_8,padding:o.small_12,borderRadius:o.xSmall_8,flexDirection:"row",alignItems:"center"}});De.__docgenInfo={description:"",methods:[],displayName:"StartCoordsPoint",props:{startCoords:{required:!0,tsType:{name:"ReadonlyArray",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}],raw:"ReadonlyArray<Coord>"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: ReadonlyArray<Coord>) => void",signature:{arguments:[{type:{name:"ReadonlyArray",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}],raw:"ReadonlyArray<Coord>"},name:"startCoords"}],return:{name:"void"}}},description:""}}};const Me=r=>{const{startCoords:n,onChange:a}=r;return e.jsxs(e.Fragment,{children:[e.jsxs(m,{style:R.equationSection,children:[e.jsx(B,{children:"Starting equation:"}),e.jsx(z,{style:R.equationBody,children:mn(n)})]}),e.jsxs(m,{style:R.tile,children:[e.jsx(c,{children:"Point 1:"}),e.jsx(h,{size:o.small_12}),e.jsx(w,{coord:n[0],labels:["x","y"],onChange:t=>a([t,n[1],n[2]])})]}),e.jsxs(m,{style:R.tile,children:[e.jsx(c,{children:"Point 2:"}),e.jsx(h,{size:o.small_12}),e.jsx(w,{coord:n[1],labels:["x","y"],onChange:t=>a([n[0],t,n[2]])})]}),e.jsxs(m,{style:R.tile,children:[e.jsx(c,{children:"Point 3:"}),e.jsx(h,{size:o.small_12}),e.jsx(w,{coord:n[2],labels:["x","y"],onChange:t=>a([n[0],n[1],t])})]})]})},R=f.StyleSheet.create({tile:{backgroundColor:g.fadedBlue8,marginTop:o.xSmall_8,padding:o.small_12,borderRadius:o.xSmall_8,flexDirection:"row",alignItems:"center"},equationSection:{marginTop:o.small_12},equationBody:{backgroundColor:g.fadedOffBlack8,border:`1px solid ${g.fadedOffBlack32}`,marginTop:o.xSmall_8,paddingLeft:o.xSmall_8,paddingRight:o.xSmall_8,fontSize:$.size.xSmall}});Me.__docgenInfo={description:"",methods:[],displayName:"StartCoordsQuadratic",props:{startCoords:{required:!0,tsType:{name:"tuple",raw:"[Coord, Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: [Coord, Coord, Coord]) => void",signature:{arguments:[{type:{name:"tuple",raw:"[Coord, Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},name:"startCoords"}],return:{name:"void"}}},description:""}}};const Ve=r=>{const{startCoords:n,onChange:a}=r;return e.jsxs(e.Fragment,{children:[e.jsxs(m,{style:V.equationSection,children:[e.jsx(B,{children:"Starting equation:"}),e.jsx(z,{style:V.equationBody,children:un(n)})]}),e.jsxs(m,{style:V.tile,children:[e.jsx(c,{children:"Point 1:"}),e.jsx(h,{size:o.small_12}),e.jsx(w,{coord:n[0],labels:["x","y"],onChange:t=>a([t,n[1]])})]}),e.jsxs(m,{style:V.tile,children:[e.jsx(c,{children:"Point 2:"}),e.jsx(h,{size:o.small_12}),e.jsx(w,{coord:n[1],labels:["x","y"],onChange:t=>a([n[0],t])})]})]})},V=f.StyleSheet.create({tile:{backgroundColor:g.fadedBlue8,marginTop:o.xSmall_8,padding:o.small_12,borderRadius:o.xSmall_8,flexDirection:"row",alignItems:"center"},equationSection:{marginTop:o.small_12},equationBody:{backgroundColor:g.fadedOffBlack8,border:`1px solid ${g.fadedOffBlack32}`,marginTop:o.xSmall_8,paddingLeft:o.xSmall_8,paddingRight:o.xSmall_8,fontSize:$.size.xSmall}});Ve.__docgenInfo={description:"",methods:[],displayName:"StartCoordsSinusoid",props:{startCoords:{required:!0,tsType:{name:"tuple",raw:"[Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: SinusoidCoords) => void",signature:{arguments:[{type:{name:"tuple",raw:"[Coord, Coord]",elements:[{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]}]},name:"startCoords"}],return:{name:"void"}}},description:""}}};const hn=r=>{const{type:n,range:a,step:t,allowReflexAngles:l,onChange:u}=r;switch(n){case"linear":case"ray":const s=Te(r,a,t);return e.jsx(Ee,{startCoords:s,onChange:u});case"linear-system":case"segment":const C=n==="segment"?xe(r,a,t):qe(r,a,t);return e.jsx(Ge,{type:n,startCoords:C,onChange:u});case"circle":const k=Ce(r),I=ye(ge(k.radiusPoint,k.center));return e.jsx(Fe,{startCoords:{center:k.center,radius:I},onChange:u});case"sinusoid":const S=ve(r,a,t);return e.jsx(Ve,{startCoords:S,onChange:u});case"quadratic":const O=fe(r,a,t);return e.jsx(Me,{startCoords:O,onChange:u});case"point":case"polygon":const F=n==="point"?ke(r,a,t):be(r,a,t);return e.jsx(De,{startCoords:F,onChange:u});case"angle":const E=we({graph:r,range:a,step:t});return e.jsx(Oe,{startCoords:E,allowReflexAngles:l,onChange:u});default:return null}},We=r=>{const{range:n,step:a,onChange:t}=r,[l,u]=j.useState(!0);return e.jsxs(m,{children:[e.jsx(X,{isCollapsible:!0,title:"Start coordinates",isOpen:l,onToggle:()=>u(!l)}),l&&e.jsxs(e.Fragment,{children:[e.jsx(hn,{...r}),e.jsx(h,{size:o.small_12}),e.jsx(Je,{startIcon:on,kind:"tertiary",size:"small",onClick:()=>{t(sn(r,n,a))},children:"Use default start coordinates"})]})]})};We.__docgenInfo={description:"",methods:[],displayName:"StartCoordsSettings",props:{range:{required:!0,tsType:{name:"tuple",raw:"[x: Range, y: Range]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},step:{required:!0,tsType:{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},allowReflexAngles:{required:!1,tsType:{name:"boolean"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(startCoords: StartCoords) => void",signature:{arguments:[{type:{name:'Extract["startCoords"]',raw:`Extract<
    PerseusGraphType,
    GraphTypesThatHaveStartCoords
>["startCoords"]`},name:"startCoords"}],return:{name:"void"}}},description:""}}};const{InfoTip:T}=Be,L=He.widget,yn={url:null},gn=A.map(A.range(3,13),function(r){return e.jsx(d,{value:`${r}`,label:`${r} sides`},`polygon-sides-${r}`)}),W=class W extends j.Component{constructor(){super(...arguments),this.displayName="InteractiveGraphEditor",this.className="perseus-widget-interactive-graph",this.changeStartCoords=n=>{var t;if(!((t=this.props.graph)!=null&&t.type))return;const a={...this.props.graph,startCoords:n};this.props.onChange({graph:a})},this.getSaveWarnings=()=>{var a;const n=[];for(const t of this.props.lockedFigures??[])t.type==="line"&&ze(t.points[0].coord,t.points[1].coord)&&n.push("The line cannot have length 0.");return((a=this.props.graph)==null?void 0:a.type)==="polygon"&&this.props.graph.numSides==="unlimited"&&this.props.graph.coords===null&&n.push("Polygon must be closed."),n}}serialize(){const n=A.pick(this.props,"step","backgroundImage","markings","labels","showProtractor","showTooltips","range","gridStep","snapStep","lockedFigures","fullGraphAriaLabel","fullGraphAriaDescription"),a=this.refs.graph;if(a){const t=a&&a.getUserInput();A.extend(n,{graph:{type:t.type,startCoords:this.props.graph&&ln(this.props.graph)},correct:t}),A.each(["allowReflexAngles","angleOffsetDeg","numPoints","numSides","numSegments","showAngles","showSides","snapTo","snapDegrees"],function(l){A.has(t,l)&&(n.graph[l]=t[l])})}return n}render(){var s,C,k,I,S,O,F,E,U,Q,Y,Z,J,ee,ne,re,ae,te,oe,le,ie,se,ue,me,de;let n,a;const t=this.props.gridStep||pe.getGridStep(this.props.range,this.props.step,Xe.defaultBoxSize),l=this.props.snapStep||pe.snapStepFromGridStep(t),u=$e.SMALL;if(this.props.valid===!0){const i=this.props.correct,y={ref:"graph",box:this.props.box,range:this.props.range,labels:this.props.labels,step:this.props.step,gridStep:t,snapStep:l,graph:i,backgroundImage:this.props.backgroundImage,markings:this.props.markings,showProtractor:this.props.showProtractor,showTooltips:this.props.showTooltips,lockedFigures:this.props.lockedFigures,fullGraphAriaLabel:this.props.fullGraphAriaLabel,fullGraphAriaDescription:this.props.fullGraphAriaDescription,trackInteraction:function(){},onChange:({graph:b})=>{let v=this.props.correct;p(b!=null),v.type===b.type?v=wn(v,b):v=b,this.props.onChange({correct:v,graph:this.props.graph})}};n=e.jsx(L,{...y,containerSizeClass:u,apiOptions:{...this.props.apiOptions,isMobile:!1}}),a=L.getEquationString(y)}else n=e.jsx("div",{className:"perseus-error",children:this.props.valid});return e.jsxs(m,{children:[e.jsx(x,{label:"Answer type:",children:e.jsx(Le,{graphType:((s=this.props.graph)==null?void 0:s.type)??L.defaultProps.graph.type,onChange:i=>{this.props.onChange({graph:{type:i},correct:{type:i}})},showNoneOption:(I=(k=(C=this.props.apiOptions)==null?void 0:C.flags)==null?void 0:k.mafs)==null?void 0:I.none})}),this.props.graph&&((F=(O=(S=this.props.apiOptions)==null?void 0:S.flags)==null?void 0:O.mafs)==null?void 0:F[this.props.graph.type])&&e.jsx(Ie,{ariaLabelValue:this.props.fullGraphAriaLabel??"",ariaDescriptionValue:this.props.fullGraphAriaDescription??"",onChange:this.props.onChange}),e.jsx(je,{equationString:a,children:n}),((E=this.props.correct)==null?void 0:E.type)==="point"&&e.jsx(x,{label:"Number of Points:",children:e.jsx(Re,{numPoints:(U=this.props.correct)==null?void 0:U.numPoints,onChange:i=>{this.props.onChange({correct:{type:"point",numPoints:i},graph:{type:"point",numPoints:i}})}})}),((Q=this.props.correct)==null?void 0:Q.type)==="angle"&&e.jsxs(e.Fragment,{children:[e.jsxs(m,{style:q.row,children:[e.jsx(G,{label:e.jsx(D,{children:"Show angle measures"}),checked:!!((Y=this.props.correct)!=null&&Y.showAngles),onChange:i=>{var y;((y=this.props.graph)==null?void 0:y.type)==="angle"&&(p(this.props.correct.type==="angle",`Expected graph type to be angle, but got ${this.props.correct.type}`),this.props.onChange({correct:{...this.props.correct,showAngles:i},graph:{...this.props.graph,showAngles:i}}))}}),e.jsx(T,{children:e.jsx("p",{children:"Displays the interior angle measures."})})]}),e.jsxs(m,{style:q.row,children:[e.jsx(G,{label:e.jsx(D,{children:"Allow reflex angles"}),checked:!!((Z=this.props.correct)!=null&&Z.allowReflexAngles),onChange:i=>{var b,v;p(this.props.correct.type==="angle",`Expected graph type to be angle, but got ${this.props.correct.type}`),p(((b=this.props.graph)==null?void 0:b.type)==="angle",`Expected graph type to be angle, but got ${(v=this.props.graph)==null?void 0:v.type}`);const y={allowReflexAngles:i};this.props.onChange({correct:{...this.props.correct,...y},graph:{...this.props.graph,...y}})}}),e.jsx(T,{children:e.jsx("p",{children:"Allow students to be able to create reflex angles."})})]})]}),((J=this.props.correct)==null?void 0:J.type)==="polygon"&&e.jsxs(e.Fragment,{children:[e.jsx(x,{label:"Number of sides:",children:e.jsx(P,{selectedValue:(ee=this.props.correct)!=null&&ee.numSides?`${this.props.correct.numSides}`:"3",placeholder:"",onChange:i=>{var b;p(((b=this.props.graph)==null?void 0:b.type)==="polygon");const y={numSides:Ne(i),coords:null,snapTo:"grid"};this.props.onChange({correct:{...this.props.correct,...y},graph:{...this.props.graph,...y}})},style:q.singleSelectShort,children:[...gn,e.jsx(d,{value:"unlimited",label:"unlimited sides"},"unlimited")]},"polygon-select")}),e.jsxs(x,{label:"Snap to:",children:[e.jsxs(P,{selectedValue:((ne=this.props.correct)==null?void 0:ne.snapTo)||"grid",placeholder:"",onChange:i=>{var b,v;p(this.props.correct.type==="polygon",`Expected correct answer type to be polygon, but got ${this.props.correct.type}`),p(((b=this.props.graph)==null?void 0:b.type)==="polygon",`Expected graph type to be polygon, but got ${(v=this.props.graph)==null?void 0:v.type}`);const y={snapTo:i,coords:null};this.props.onChange({correct:{...this.props.correct,...y},graph:{...this.props.graph,...y}})},style:q.singleSelectShort,children:[e.jsx(d,{value:"grid",label:"grid"}),((re=this.props.correct)==null?void 0:re.numSides)!=="unlimited"&&e.jsx(d,{value:"angles",label:"interior angles"}),((ae=this.props.correct)==null?void 0:ae.numSides)!=="unlimited"&&e.jsx(d,{value:"sides",label:"side measures"})]}),e.jsxs(T,{children:[e.jsx("p",{children:"These options affect the movement of the vertex points. The grid option will guide the points to the nearest half step along the grid."}),e.jsx("p",{children:"The interior angle and side measure options guide the points to the nearest whole angle or side measure respectively."})]})]}),e.jsxs(m,{style:q.row,children:[e.jsx(G,{label:e.jsx(D,{children:"Show angle measures"}),checked:!!((te=this.props.correct)!=null&&te.showAngles),onChange:()=>{var i;((i=this.props.graph)==null?void 0:i.type)==="polygon"&&(p(this.props.correct.type==="polygon",`Expected graph type to be polygon, but got ${this.props.correct.type}`),this.props.onChange({correct:{...this.props.correct,showAngles:!this.props.correct.showAngles},graph:{...this.props.graph,showAngles:!this.props.graph.showAngles}}))}}),e.jsx(T,{children:e.jsx("p",{children:"Displays the interior angle measures."})})]}),e.jsxs(m,{style:q.row,children:[e.jsx(G,{label:e.jsx(D,{children:"Show side measures"}),checked:!!((oe=this.props.correct)!=null&&oe.showSides),onChange:()=>{var i;((i=this.props.graph)==null?void 0:i.type)==="polygon"&&this.props.correct.type==="polygon"&&this.props.onChange({correct:{...this.props.correct,showSides:!this.props.correct.showSides},graph:{...this.props.graph,showSides:!this.props.graph.showSides}})}}),e.jsx(T,{children:e.jsx("p",{children:"Displays the side lengths."})})]})]}),((le=this.props.correct)==null?void 0:le.type)==="segment"&&e.jsx(x,{label:"Number of segments:",children:e.jsx(Se,{numSegments:(ie=this.props.correct)==null?void 0:ie.numSegments,onChange:i=>{this.props.onChange({correct:{type:"segment",numSegments:i,coords:null},graph:{type:"segment",numSegments:i}})}})}),((se=this.props.graph)==null?void 0:se.type)&&pn(this.props.graph,this.props.static)&&e.jsx(We,{...this.props.graph,range:this.props.range,step:this.props.step,onChange:this.changeStartCoords}),e.jsx(Ye,{box:Ke(u),range:this.props.range,labels:this.props.labels,step:this.props.step,gridStep:t,snapStep:l,valid:this.props.valid,backgroundImage:this.props.backgroundImage,markings:this.props.markings,showProtractor:this.props.showProtractor,showTooltips:this.props.showTooltips,onChange:this.props.onChange}),this.props.correct.type==="polygon"&&e.jsxs(x,{label:"Student answer must",children:[e.jsxs(P,{selectedValue:this.props.correct.match||"exact",onChange:i=>{p(this.props.correct.type==="polygon",`Expected graph type to be polygon, but got ${this.props.correct.type}`);const y={...this.props.correct,match:i};this.props.onChange({correct:y})},placeholder:"",style:q.singleSelectShort,children:[e.jsx(d,{value:"exact",label:"match exactly"}),e.jsx(d,{value:"congruent",label:"be congruent"}),e.jsx(d,{value:"approx",label:"be approximately congruent"}),e.jsx(d,{value:"similar",label:"be similar"})]}),e.jsx(T,{children:e.jsxs("ul",{children:[e.jsx("li",{children:e.jsxs("p",{children:[e.jsx("b",{children:"Match Exactly:"})," Match exactly in size, orientation, and location on the grid even if it is not shown in the background."]})}),e.jsx("li",{children:e.jsxs("p",{children:[e.jsx("b",{children:"Be Congruent:"})," Be congruent in size and shape, but can be located anywhere on the grid."]})}),e.jsx("li",{children:e.jsxs("p",{children:[e.jsx("b",{children:"Be Approximately Congruent:"})," Be exactly similar, and congruent in size and shape to within 0.1 units, but can be located anywhere on the grid."," ",e.jsx("em",{children:"Use this with snapping to angle measure."})]})}),e.jsx("li",{children:e.jsxs("p",{children:[e.jsx("b",{children:"Be Similar:"})," Be similar with matching interior angles, and side measures that are matching or a multiple of the correct side measures. The figure can be located anywhere on the grid."]})})]})})]}),this.props.correct.type==="angle"&&e.jsxs(x,{label:"Student answer must",children:[e.jsxs(P,{selectedValue:this.props.correct.match||"exact",onChange:i=>{this.props.onChange({correct:{...this.props.correct,match:i}})},placeholder:"",style:q.singleSelectShort,children:[e.jsx(d,{value:"exact",label:"match exactly"}),e.jsx(d,{value:"congruent",label:"be congruent"})]}),e.jsx(T,{children:e.jsx("p",{children:"Congruency requires only that the angle measures are the same. An exact match implies congruency, but also requires that the angles have the same orientation and that the vertices are in the same position."})})]}),this.props.graph&&((de=(me=(ue=this.props.apiOptions)==null?void 0:ue.flags)==null?void 0:me.mafs)==null?void 0:de[this.props.graph.type])&&e.jsx(Ze,{figures:this.props.lockedFigures,onChange:this.props.onChange})]})}};W.widgetName="interactive-graph",W.defaultProps={...L.defaultProps,valid:!0,backgroundImage:yn,showTooltips:!1,correct:{type:L.defaultProps.graph.type,coords:null}};let K=W;function wn(r,n){if(r.type!==n.type)throw new Error(`Cannot merge graphs with different types (${r.type} and ${n.type})`);switch(r.type){case"angle":return p(n.type==="angle"),{...r,...n};case"circle":return p(n.type==="circle"),{...r,...n};case"linear":return p(n.type==="linear"),{...r,...n};case"linear-system":return p(n.type==="linear-system"),{...r,...n};case"none":return p(n.type==="none"),{...r,...n};case"point":return p(n.type==="point"),{...r,...n};case"polygon":return p(n.type==="polygon"),{...r,...n};case"quadratic":return p(n.type==="quadratic"),{...r,...n};case"ray":return p(n.type==="ray"),{...r,...n};case"segment":return p(n.type==="segment"),{...r,...n};case"sinusoid":return p(n.type==="sinusoid"),{...r,...n};default:throw new Ae(r)}}const q=f.StyleSheet.create({singleSelectShort:{height:26},row:{flexDirection:"row",marginTop:o.xSmall_8,alignItems:"center"}});K.__docgenInfo={description:`An editor for the InteractiveGraph widget, which allows the user to
