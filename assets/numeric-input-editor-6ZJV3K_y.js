import{j as e}from"./jsx-runtime-63Ea5SlK.js";import{K as P,U as D}from"./util-Deofanvy.js";import{_ as m}from"./index-default-4_ZsnO94.js";import"./index-VBBZE5E5.js";import{c as M}from"./article-renderer-NINt4j4t.js";import"./jquery-5v7aFUvu.js";import"./phet-simulation-VzxNL4J6.js";import"./dependencies-CP7Uh8Kq.js";import"./perseus-api-_PWPZoDE.js";import"./server-item-renderer-D0v6QUaZ.js";import"./hints-renderer-938D-MIy.js";import"./renderer-BI1FyBLz.js";import"./base-radio-9naw8cnM.js";import{c as W}from"./components-kOj4NR2D.js";import{P as G}from"./i18n-context-YAdgKrxn.js";import"./svg-image-Ah59ySlS.js";import"./index-smZ6iCr_.js";import{E as K}from"./editor-jsonify-zs-pjldG.js";import{B as I}from"./index-sN6aPTh8.js";import{P as g}from"./index-YAvX_VSA.js";import{L}from"./index-SAZ92ybN.js";import{P as H,t as z}from"./trash-bold-Er4Wp4s-.js";import{r as $}from"./index-6oxdNXpR.js";import{H as O}from"./heading---SbL3JQ.js";import{E as U}from"./editor-cjz-YLuI.js";const B={answers:[{value:null,status:"correct",message:"",simplify:"required",answerForms:[],strict:!1,maxError:null}],size:"normal",coefficient:!1,labelText:"",rightAlign:!1},V={name:"numeric-input",defaultWidgetOptions:B},{InfoTip:v,NumberInput:T,TextInput:J}=W,{firstNumericalParse:j}=D,Q=[{title:"Integers",value:"integer",content:"6"},{title:"Decimals",value:"decimal",content:"0.75"},{title:"Proper fractions",value:"proper",content:"⅗"},{title:"Improper fractions",value:"improper",content:"⁷⁄₄"},{title:"Mixed numbers",value:"mixed",content:"1¾"},{title:"Numbers with π",value:"pi",content:"π"}],C=R=>({value:null,status:R,message:"",simplify:"required",answerForms:[],strict:!1,maxError:null}),w=class w extends $.Component{constructor(l){super(l),this.change=(...n)=>M.apply(this,n),this.onToggleAnswers=n=>{const t=this.state.showAnswerDetails.slice();t[n]=!t[n],this.setState({showAnswerDetails:t})},this.onToggleAnswerForm=(n,t)=>{let a=[...this.props.answers[n].answerForms??[]];a.includes(t)?a=a.filter(f=>f!==t):a.push(t);const i=this.updateAnswer(n,"answerForms");i&&i(a)},this.onToggleHeading=n=>()=>{const t=`show${n}`,a={...this.state};a[t]=!a[t],this.setState(a)},this.onTrashAnswer=n=>{if(n>=0&&n<this.props.answers.length){const t=this.props.answers.slice(0);t.splice(n,1),this.props.onChange({answers:t})}},this.onSpace=(n,t,...a)=>{n.key===" "&&(n.preventDefault(),t.apply(this,a))},this.onStatusChange=n=>{const t=["wrong","ungraded","correct"],a=this.props.answers,o=t.indexOf(a[n].status),i=t[(o+1)%t.length];this.updateAnswer(n,{status:i,simplify:i==="correct"?"required":"accepted"})},this.onEvaluationChange=(n,t)=>{this.updateAnswer(n,{status:t,simplify:t==="correct"?"required":"accepted"})},this.updateAnswer=(n,t)=>{if(!m.isObject(t))return m.partial((o,i,f)=>{const A={};A[i]=f,this.updateAnswer(o,A)},n,t);let a=[...this.props.answers];if(n===a.length){const o=C(this.state.lastStatus);a=a.concat(o)}a[n]=m.extend({},a[n],t),this.props.onChange({answers:a})},this.addAnswer=()=>{const n=C(this.state.lastStatus),t=this.props.answers.concat(n),a=this.state.showAnswerDetails.concat(!0);this.setState({showAnswerDetails:a}),this.props.onChange({answers:t})},this.getSaveWarnings=()=>{const n=[];return m.contains(m.pluck(this.props.answers,"value"),"")&&n.push("One or more answers is empty"),this.props.answers.forEach((t,a)=>{t.strict&&(!t.answerForms||t.answerForms.length===0)&&n.push(`Answer ${a+1} is set to string format matching, but no format was selected`)}),n},this.serialize=()=>K.serialize.call(this),this.state={lastStatus:"wrong",showAnswerDetails:Array(this.props.answers.length).fill(!0),showSettings:!0,showAnswers:!0}}render(){const l=this.props.answers,n={size:"medium",role:"radio",style:{marginRight:"8px"}},t=s=>{const{kind:r,onClick:p,ariaLabel:d,children:c}=s,h=s.role??"radio",b={...n,"aria-label":d,kind:r,role:h,onClick:p};return e.jsx(g,{...b,children:c})},a=s=>{const{answerIndex:r,answerProperty:p,value:d,children:c}=s,b=l[r][p]===d?"accent":"transparent",y={};y[p]=d;const u=s.onClick??(()=>{this.updateAnswer(r,y)});return e.jsx(t,{kind:b,onClick:u,children:c})},o=s=>e.jsxs("fieldset",{className:"perseus-widget-row unsimplified-options",children:[l[s].status!=="correct"&&e.jsx(e.Fragment,{children:e.jsx("legend",{className:"inline-options",children:"Unsimplified answers are irrelevant for this status"})}),l[s].status==="correct"&&e.jsxs(e.Fragment,{children:[e.jsx("legend",{className:"inline-options",children:"Unsimplified answers are"}),e.jsx("span",{className:"tooltip-for-legend",children:e.jsxs(v,{children:[e.jsx("p",{children:'Normally select "ungraded". This will give the user a message saying the answer is correct but not simplified. The user will then have to simplify it and re-enter, but will not be penalized. (5th grade and after)'}),e.jsx("p",{children:'Select "accepted" only if the user is not expected to know how to simplify fractions yet. (Anything prior to 5th grade)'}),e.jsxs("p",{children:['Select "wrong" ',e.jsx("em",{children:"only"})," if we are specifically assessing the ability to simplify."]})]})}),e.jsx("br",{}),e.jsx(a,{answerIndex:s,answerProperty:"simplify",value:"required",children:"Ungraded"}),e.jsx(a,{answerIndex:s,answerProperty:"simplify",value:"optional",children:"Accepted"}),e.jsx(a,{answerIndex:s,answerProperty:"simplify",value:"enforced",children:"Wrong"})]})]}),i=s=>e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"perseus-widget-row",children:[e.jsx("label",{children:"Possible answer formats "}),e.jsxs(v,{children:[e.jsx("p",{children:'Formats will be autoselected for you based on the given answer; to show no suggested formats and accept all types, simply have a decimal/integer be the answer. Values with π will have format "pi", and values that are fractions will have some subset (mixed will be "mixed" and "proper"; improper/proper will both be "improper" and "proper"). If you would like to specify that it is only a proper fraction (or only a mixed/improper fraction), deselect the other format. Except for specific cases, you should not need to change the autoselected formats.'}),e.jsxs("p",{children:["To restrict the answer to ",e.jsx("em",{children:"only"}),' an improper fraction (i.e. 7/4), select the improper fraction and toggle "strict" to true. This ',e.jsx("b",{children:"will not"})," ","accept 1.75 as an answer."," "]}),e.jsx("p",{children:"Unless you are testing that specific skill, please do not restrict the answer format."})]}),e.jsx("br",{}),Q.map(r=>{var h;const d=((h=l[s].answerForms)==null?void 0:h.includes(r.value))?"accent":"transparent",c=()=>{this.onToggleAnswerForm(s,r.value)};return e.jsx(t,{ariaLabel:r.title,kind:d,role:"checkbox",onClick:c,children:r.content},r.value)})]}),e.jsxs("fieldset",{className:"perseus-widget-row",children:[e.jsx("legend",{children:"Answer formats are: "}),e.jsx(a,{answerIndex:s,answerProperty:"strict",value:!1,children:"Suggested"}),e.jsx(a,{answerIndex:s,answerProperty:"strict",value:!0,children:"Required"})]})]}),f=e.jsxs("fieldset",{className:"perseus-widget-row",children:[e.jsx("legend",{className:"inline-options",children:"Width: "}),e.jsx(g,{...n,kind:this.props.size==="normal"?"accent":"transparent",onClick:()=>{this.change("size")("normal")},children:"Normal (80px)"}),e.jsx(g,{...n,kind:this.props.size==="small"?"accent":"transparent",onClick:()=>{this.change("size")("small")},children:"Small (40px)"}),e.jsx(v,{children:e.jsx("p",{children:'Use size "Normal" for all text boxes, unless there are multiple text boxes in one line and the answer area is too narrow to fit them.'})})]}),A=e.jsxs("fieldset",{className:"perseus-widget-row",children:[e.jsx("legend",{className:"inline-options",children:"Alignment: "}),e.jsx(g,{...n,kind:this.props.rightAlign?"transparent":"accent",onClick:()=>{this.props.onChange({rightAlign:!1})},children:"Left"}),e.jsx(g,{...n,kind:this.props.rightAlign?"accent":"transparent",onClick:()=>{this.props.onChange({rightAlign:!0})},children:"Right"})]}),E=e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"perseus-widget-row",children:[e.jsx("label",{children:"Aria label"}),e.jsx(v,{children:e.jsx("p",{children:"Text to describe this input. This will be shown to users using screenreaders."})})]}),e.jsx(J,{labelText:"aria label",value:this.props.labelText,onChange:this.change("labelText")})]}),F=e.jsxs("fieldset",{className:"perseus-widget-row",children:[e.jsx("legend",{className:"inline-options",children:"Number style: "}),e.jsx(g,{...n,kind:this.props.coefficient?"transparent":"accent",onClick:()=>{this.props.onChange({coefficient:!1})},children:"Standard"}),e.jsx(g,{...n,kind:this.props.coefficient?"accent":"transparent",onClick:()=>{this.props.onChange({coefficient:!0})},children:"Coefficient"}),e.jsx(v,{children:e.jsx("p",{children:"A coefficient style number allows the student to use - for -1 and an empty string to mean 1."})})]}),q={wrong:"(address the mistake/misconception)",ungraded:"(explain in detail to avoid confusion)",correct:"(reinforce the user's understanding)"},S=()=>l.map((s,r)=>{const p=e.jsx(U,{apiOptions:this.props.apiOptions,content:s.message||"",placeholder:"Why is this answer "+s.status+"?	"+q[s.status],widgetEnabled:!1,onChange:u=>{"content"in u&&this.updateAnswer(r,{message:u.content})}}),d=s.status.charAt(0).toUpperCase()+s.status.slice(1),c=(s.answerForms||[]).at(-1),h=P.toNumericString(s.value??0,c),b=s.maxError?`± ${P.toNumericString(s.maxError,c)}`:"",y=s.value===null?"New Answer":`${d} answer: ${h} ${b}`;return e.jsx("div",{className:"perseus-widget-row answer-option",children:e.jsxs(H,{animated:!0,expanded:this.state.showAnswerDetails[r],onToggle:()=>{this.onToggleAnswers(r)},header:e.jsx(L,{children:y}),children:[e.jsxs("div",{className:"input-answer-editor-value-container"+(s.maxError?" with-max-error":""),children:[e.jsx("label",{children:"User input:"}),e.jsx(T,{value:s.value,className:"numeric-input-value",placeholder:"answer",format:m.last(s.answerForms||[]),onFormatChange:(u,k)=>{let x;k==="pi"?x=["pi"]:k==="mixed"?x=["proper","mixed"]:(k==="proper"||k==="improper")&&(x=["proper","improper"]),this.updateAnswer(r,{value:j(u,this.context.strings),answerForms:x})},onChange:u=>{this.updateAnswer(r,{value:j(u,this.context.strings)})}}),e.jsx("span",{className:"max-error-plusmn",children:"±"}),e.jsx(T,{className:"max-error-input-value",placeholder:0,value:l[r].maxError,format:m.last(s.answerForms||[]),onChange:this.updateAnswer(r,"maxError")})]}),e.jsxs("fieldset",{className:"perseus-widget-row",children:[e.jsx("legend",{className:"inline-options",children:"Status:"}),e.jsx(a,{answerIndex:r,answerProperty:"status",value:"correct",onClick:()=>{this.onEvaluationChange(r,"correct")},children:"Correct"}),e.jsx(a,{answerIndex:r,answerProperty:"status",value:"wrong",onClick:()=>{this.onEvaluationChange(r,"wrong")},children:"Wrong"}),e.jsx(a,{answerIndex:r,answerProperty:"status",value:"ungraded",onClick:()=>{this.onEvaluationChange(r,"ungraded")},children:"Ungraded"})]}),o(r),e.jsx("div",{className:"perseus-widget-row",children:"Message shown to user in article:"}),p,i(r),e.jsx(I,{startIcon:z,"aria-label":`Delete ${y}`,className:"delete-item-button",onClick:()=>{this.onTrashAnswer(r)},kind:"tertiary",children:"Delete"})]})},r)});return e.jsxs("div",{className:"perseus-input-number-editor",children:[e.jsx(O,{title:"General Settings",isCollapsible:!0,isOpen:this.state.showSettings,onToggle:this.onToggleHeading("Settings")}),e.jsx("div",{className:`perseus-editor-accordion-container ${this.state.showSettings?"expanded":"collapsed"}`,children:e.jsxs("div",{className:"perseus-editor-accordion-content",children:[f,A,F,E]})}),e.jsx(O,{title:"Answers",isCollapsible:!0,isOpen:this.state.showAnswers,onToggle:this.onToggleHeading("Answers")}),e.jsx("div",{className:`perseus-editor-accordion-container ${this.state.showAnswers?"expanded":"collapsed"}`,children:e.jsxs("div",{className:"perseus-editor-accordion-content",children:[S(),e.jsx(I,{kind:"tertiary",onClick:this.addAnswer,children:"Add new answer"})]})})]})}};w.contextType=G,w.widgetName="numeric-input",w.displayName="NumericInputEditor",w.defaultProps=V.defaultWidgetOptions;let N=w;N.__docgenInfo={description:"",methods:[{name:"change",docblock:null,modifiers:[],params:[{name:"...args",optional:!1,type:null}],returns:null},{name:"onToggleAnswers",docblock:null,modifiers:[],params:[{name:"answerIndex",optional:!1,type:{name:"number"}}],returns:null},{name:"onToggleAnswerForm",docblock:null,modifiers:[],params:[{name:"answerIndex",optional:!1,type:{name:"number"}},{name:"answerForm",optional:!1,type:null}],returns:null},{name:"onToggleHeading",docblock:null,modifiers:[],params:[{name:"accordionName",optional:!1,type:{name:"string"}}],returns:null},{name:"onTrashAnswer",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null}],returns:null},{name:"onSpace",docblock:null,modifiers:[],params:[{name:"e",optional:!1,type:null},{name:"callback",optional:!1,type:null},{name:"...args",optional:!1,type:null}],returns:null},{name:"onStatusChange",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null}],returns:null},{name:"onEvaluationChange",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null},{name:"newStatus",optional:!1,type:null}],returns:null},{name:"updateAnswer",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null},{name:"update",optional:!1,type:null}],returns:null},{name:"addAnswer",docblock:null,modifiers:[],params:[],returns:null},{name:"getSaveWarnings",docblock:null,modifiers:[],params:[],returns:null},{name:"serialize",docblock:null,modifiers:[],params:[],returns:null}],displayName:"NumericInputEditor",props:{onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(results: any) => any",signature:{arguments:[{type:{name:"any"},name:"results"}],return:{name:"any"}}},description:""},apiOptions:{required:!1,tsType:{name:"Readonly",elements:[{name:"intersection",raw:`APIOptions & {
...
]`,computed:!1},required:!1},size:{defaultValue:{value:'"normal"',computed:!1},required:!1},coefficient:{defaultValue:{value:"false",computed:!1},required:!1},labelText:{defaultValue:{value:'""',computed:!1},required:!1},rightAlign:{defaultValue:{value:"false",computed:!1},required:!1}}};export{N};
