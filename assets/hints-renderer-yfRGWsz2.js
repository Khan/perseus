import{j as r}from"./jsx-runtime-63Ea5SlK.js";import{l as P,R as C,p as R}from"./renderer-1Ef0Bf1y.js";import{n as s}from"./no-important-xCWWYXQR.js";import{c as x}from"./index-dnMhQZ-1.js";import{r as A}from"./index-6oxdNXpR.js";import{F}from"./index-9gkyvru-.js";import{_ as g}from"./index-default-4_ZsnO94.js";import{P as I}from"./i18n-context-GVCAGr7t.js";import{l as c,m as W,o as q,k as S,q as E,h as D}from"./constants-qvNmarDy.js";import{m as h}from"./media-queries-AtsgWQBm.js";import{A as M}from"./perseus-api-DO0X8arb.js";import{s as O}from"./shared-apNPYhSn.js";import{U as j}from"./util-5sPUHjVJ.js";const f=class f extends A.Component{constructor(){super(...arguments),this.getSerializedState=()=>this.refs.renderer.getSerializedState(),this.restoreSerializedState=(e,n)=>{this.refs.renderer.restoreSerializedState(e,n)}}render(){const{apiOptions:e,className:n,hint:t,lastHint:a,lastRendered:i,pos:u,totalHints:p}=this.props,{isMobile:m}=e,o=x("hint",!m&&"perseus-hint-renderer",m&&s.css(T.newHint),m&&i&&s.css(T.lastRenderedNewHint),a&&"last-hint",i&&"last-rendered",n),l={...e,customKeypad:!1};return r.jsxs("div",{className:o,tabIndex:"-1",children:[!e.isMobile&&r.jsx("span",{className:"perseus-sr-only",children:this.context.strings.hintPos({pos:u+1})}),!e.isMobile&&p!=null&&u!=null&&r.jsx("span",{className:"perseus-hint-label",style:{display:"block",color:e.hintProgressColor},children:`${u+1} / ${p}`}),r.jsx(C,{ref:"renderer",widgets:t.widgets,content:t.content||"",images:t.images,apiOptions:l,findExternalWidgets:this.props.findExternalWidgets,linterContext:R(this.props.linterContext,"hint"),strings:this.context.strings})]})}};f.contextType=I,f.defaultProps={linterContext:P};let y=f;const T=s.StyleSheet.create({newHint:{marginBottom:1.5*c,borderLeftColor:W,borderLeftStyle:"solid",borderLeftWidth:q,[h.lgOrSmaller]:{paddingLeft:c},[h.smOrSmaller]:{paddingLeft:0},":focus":{outline:"none"}},lastRenderedNewHint:{marginBottom:0,borderLeftColor:S}});y.__docgenInfo={description:"",methods:[{name:"getSerializedState",docblock:null,modifiers:[],params:[],returns:null},{name:"restoreSerializedState",docblock:null,modifiers:[],params:[{name:"state",optional:!1,type:null},{name:"callback",optional:!1,type:null}],returns:null}],displayName:"HintRenderer",props:{apiOptions:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
