import{a as Re}from"./version-akiLXZts.js";import{w as Te,F as Ae,B as Pe,I as xe}from"./article-renderer-H7paFTjH.js";import{r as Ie,t as Se,l as je,R as Ne,p as ae,v as Oe}from"./renderer-wB4ymqub.js";import{j as T}from"./jsx-runtime-63Ea5SlK.js";import{l as le}from"./index-awljIyHI.js";import{r as K}from"./index-6oxdNXpR.js";import{_ as J}from"./jquery-yG1GhClm.js";import{c as We}from"./asset-context-H6Iqp7Gi.js";import{P as Fe}from"./i18n-context-BsFRgdNa.js";import{D as Le}from"./dependencies-CP7Uh8Kq.js";import{H as Me}from"./hints-renderer-z7KLc5U6.js";import{A as De}from"./perseus-api-ooj0_ZRv.js";import{U as Ge}from"./util-_iDv4tVD.js";const Ee="@khanacademy/perseus",Ue="__lib_version__";Re(Ee,Ue);const $e={major:0,minor:1};Ie(Te);const Ve=Se();Ve["::renderer::"]=$e;const Je={onRendered:t=>{}},_e=K.createContext(Je),E=class E extends K.Component{constructor(n){super(n),this._handleFocusChange=(s,l)=>{s!=null?this._setCurrentFocus(s):this._onRendererBlur(l)},this.handleInteractWithWidget=s=>{var m,g;const l=J.difference(this.state.questionHighlightedWidgets,[s]);this.setState({questionCompleted:!1,questionHighlightedWidgets:l}),(g=(m=this.props.apiOptions)==null?void 0:m.interactionCallback)==null||g.call(m,this.questionRenderer.getUserInputMap())},this.setAssetStatus=(s,l)=>{const m={...this.state.assetStatuses,[s]:l};this.setState({assetStatuses:m})},this.state={questionCompleted:!1,questionHighlightedWidgets:[],assetStatuses:{}},this._fullyRendered=!1}componentDidMount(){this._currentFocus=null,this._fullyRendered=!1}UNSAFE_componentWillReceiveProps(n){this.setState({questionHighlightedWidgets:[]})}componentDidUpdate(n,s){const l=this.props.apiOptions.answerableCallback;if(l!=null){const m=this.questionRenderer.emptyWidgets().length===0;l(m)}if(this._fullyRendered||Object.values(this.state.assetStatuses).every(Boolean)&&(this._fullyRendered=!0,this.props.onRendered(!0)),this.props.score&&this.props.score!==n.score){const m=this.questionRenderer.emptyWidgets();this.setState({questionCompleted:this.props.score.correct,questionHighlightedWidgets:m})}}componentWillUnmount(){this.blurTimeoutID!=null&&(clearTimeout(this.blurTimeoutID),this.blurTimeoutID=null)}_setCurrentFocus(n){const{apiOptions:{isMobile:s,onFocusChange:l},keypadElement:m}=this.props,g=this._currentFocus;this._currentFocus=n;const y=this.getInputPaths(),p=this._currentFocus&&y.some(q=>Ge.inputPathsEqual(q,this._currentFocus));l!=null&&setTimeout(()=>{const q=m==null?void 0:m.getDOMNode(),A=q&&p?q.getBoundingClientRect().height:0;l(this._currentFocus,g,A,p&&this.questionRenderer.getDOMNodeForPath(n))},0),m&&s&&(p?m.activate():m.dismiss())}_onRendererBlur(n){const s=this._currentFocus;J.isEqual(n,s)&&(this.blurTimeoutID=setTimeout(()=>{J.isEqual(this._currentFocus,s)&&this._setCurrentFocus(null)},0))}_setWidgetProps(n,s,l){this.questionRenderer._setWidgetProps(n,s,l)}setInputValue(n,s,l){return this.questionRenderer.setInputValue(n,s,l)}focusPath(n){return this.questionRenderer.focusPath(n)}blurPath(n){return this.questionRenderer.blurPath(n)}getDOMNodeForPath(n){return this.questionRenderer.getDOMNodeForPath(n)}getInputPaths(){return this.questionRenderer.getInputPaths()}focus(){return this.questionRenderer.focus()}blur(){this._currentFocus&&this.blurPath(this._currentFocus)}getNumHints(){return this.props.item.hints.length}getPromptJSON(){return this.questionRenderer.getPromptJSON()}getUserInputLegacy(){return this.questionRenderer.getUserInput()}getUserInput(){return this.questionRenderer.getUserInputMap()}getWidgetIds(){return this.questionRenderer.getWidgetIds()}getSerializedState(){return{question:this.questionRenderer.getSerializedState(),hints:this.hintsRenderer.getSerializedState()}}restoreSerializedState(n,s){let l=2;const m=()=>{--l,s&&l===0&&s()};this.questionRenderer.restoreSerializedState(n.question,m),this.hintsRenderer.restoreSerializedState(n.hints,m)}showRationalesForCurrentlySelectedChoices(){this.questionRenderer.showRationalesForCurrentlySelectedChoices()}deselectIncorrectSelectedChoices(){this.questionRenderer.deselectIncorrectSelectedChoices()}render(){const n={...De.defaults,...this.props.apiOptions,onFocusChange:this._handleFocusChange},s={assetStatuses:this.state.assetStatuses,setAssetStatus:this.setAssetStatus},l=T.jsx(We.Provider,{value:s,children:T.jsx(Ne,{keypadElement:this.props.keypadElement,problemNum:this.props.problemNum,onInteractWithWidget:this.handleInteractWithWidget,highlightedWidgets:this.state.questionHighlightedWidgets,apiOptions:n,questionCompleted:this.state.questionCompleted,reviewMode:this.props.reviewMode,showSolutions:this.props.showSolutions,ref:g=>{g!=null&&(this.questionRenderer=g)},content:this.props.item.question.content,widgets:this.props.item.question.widgets,images:this.props.item.question.images,linterContext:ae(this.props.linterContext,"question"),strings:this.context.strings,...this.props.dependencies})}),m=T.jsx(Me,{hints:this.props.item.hints,hintsVisible:this.props.hintsVisible,apiOptions:n,ref:g=>this.hintsRenderer=g,linterContext:ae(this.props.linterContext,"hints"),strings:this.context.strings});return T.jsx(Le.Provider,{value:this.props.dependencies,children:T.jsxs("div",{children:[T.jsx("div",{children:l}),T.jsx("div",{className:n.isMobile?void 0:le.css(ze.hintsContainer),children:m})]})})}};E.contextType=Fe,E.defaultProps={apiOptions:{},linterContext:je,onRendered:n=>{}};let D=E;const ze=le.StyleSheet.create({hintsContainer:{marginLeft:50}}),He=K.forwardRef((t,n)=>T.jsx(_e.Consumer,{children:({onRendered:s})=>T.jsx(D,{...t,onRendered:s,ref:n})}));D.__docgenInfo={description:"",methods:[{name:"_handleFocusChange",docblock:null,modifiers:[],params:[{name:"newFocus",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}},{name:"oldFocus",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"_setCurrentFocus",docblock:null,modifiers:[],params:[{name:"newFocus",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"_onRendererBlur",docblock:null,modifiers:[],params:[{name:"blurPath",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"_setWidgetProps",docblock:`Accepts a question area widgetId, or an answer area widgetId of
...
}`,computed:!1},required:!1},onRendered:{defaultValue:{value:"(isRendered: boolean) => {}",computed:!1},required:!1}}};He.__docgenInfo={description:"",methods:[],displayName:"ref"};function B(t){return{type:"success",value:t}}function X(t){return{type:"failure",detail:t}}function C(t){return t.type==="failure"}function S(t){return t.type==="success"}function Ke(t,n=s=>s){const s=[],l=[];for(const m of t)m.type==="success"?s.push(m.value):l.push(m.detail);return l.length>0?X(l.reduce(n)):B(s)}const F=(t,n)=>n.success(t);function d(t){return(n,s)=>{if(!Array.isArray(n))return s.failure("array",n);const l=n.map((m,g)=>t(m,s.forSubtree(g)));return Ke(l,Be)}}function Be(t,n){return[...t,...n]}function u(t,n){return typeof t=="boolean"?n.success(t):n.failure("boolean",t)}function i(t){return(n,s)=>n!==t?s.failure(String(JSON.stringify(t)),n):s.success(t)}function w(...t){return(n,s)=>{if(typeof n=="string"){const m=t.indexOf(n);if(m>-1)return s.success(t[m])}const l=t.map(m=>JSON.stringify(m));return s.failure(l,n)}}function Y(t){return t!=null&&Object.getPrototypeOf(t)===Object.prototype}function b(t){return(n,s)=>n===null?s.success(n):t(n,s)}const o=(t,n)=>typeof t=="number"?n.success(t):n.failure("number",t);function a(t){return(n,s)=>{if(!Y(n))return s.failure("object",n);const l={...n},m=[];for(const[g,y]of Object.entries(t)){const p=y(n[g],s.forSubtree(g));S(p)?l[g]=p.value:m.push(...p.detail)}return m.length>0?X(m):s.success(l)}}function e(t){return(n,s)=>n===void 0?s.success(n):t(n,s)}function k(t,n){return(s,l)=>{if(!Array.isArray(s))return l.failure("array",s);if(s.length!==2)return l.failure("array of length 2",s);const[m,g]=s,y=t(m,l.forSubtree(0));if(C(y))return y;const p=n(g,l.forSubtree(1));return C(p)?p:l.success([y.value,p.value])}}function I(t){return new Q(t)}class Q{constructor(n){this.parser=n}then(n){return new Q(Xe(this.parser,n))}}function Xe(t,n){return(s,l)=>{const m=t(s,l);return C(m)?m:n(m.value,l)}}function Z(t,n){return(s,l)=>{if(!Y(s))return l.failure("object",s);const m={},g=[];for(const[y,p]of Object.entries(s)){const q=l.forSubtree(y),A=t(y,q);C(A)&&g.push(...A.detail);const P=n(p,q);C(P)&&g.push(...P.detail),S(A)&&S(P)&&(m[A.value]=P.value)}return g.length>0?X(g):l.success(m)}}const r=(t,n)=>typeof t=="string"?n.success(t):n.failure("string",t);function G(t,n,s){return(l,m)=>{if(!Array.isArray(l))return m.failure("array",l);if(l.length!==3)return m.failure("array of length 3",l);const g=t(l[0],m.forSubtree(0));if(C(g))return g;const y=n(l[1],m.forSubtree(1));if(C(y))return y;const p=s(l[2],m.forSubtree(2));return C(p)?p:m.success([g.value,y.value,p.value])}}function v(t){return new ee(t)}class ee{constructor(n){this.parser=n}or(n){return new ee(Ye(this.parser,n))}}function Ye(t,n){return(s,l)=>{const m=t(s,l);return S(m)?m:n(s,l)}}function f(t,n){return(s,l)=>s==null?B(n(s)):t(s,l)}const me=f(Z(r,a({width:o,height:o})),()=>({}));function h(t,n){return a({type:t,static:e(u),graded:e(u),alignment:e(r),options:n,key:e(o),version:e(a({major:o,minor:o}))})}function de(t,n,s){return a({type:n,static:e(u),graded:e(u),alignment:e(r),options:s,key:e(o),version:t})}const Qe=h(i("categorizer"),a({items:d(r),categories:d(r),randomizeItems:u,static:f(u,()=>!1),values:d(o),highlightLint:e(u),linterContext:e(a({contentType:r,paths:d(r),stack:d(r)}))})),Ze=h(i("cs-program"),a({programID:r,programType:F,settings:d(a({name:r,value:r})),showEditor:u,showButtons:u,width:o,height:o,static:u})),en=h(i("definition"),a({togglePrompt:r,definition:r,static:f(u,()=>!1)})),nn=h(i("dropdown"),a({placeholder:r,ariaLabel:e(r),visibleLabel:e(r),static:f(u,()=>!1),choices:d(a({content:r,correct:u}))})),rn=h(i("explanation"),a({showPrompt:r,hidePrompt:r,explanation:r,widgets:f((t,n)=>L(t,n),()=>({})),static:f(u,()=>!1)}));function ne(t){return(n,s)=>s.success(t(n))}function tn(t){return new re(t,n=>n)}class re{constructor(n,s){this.parser=n,this.migrate=s}withMigrationFrom(n,s){const l=this.parser,m=g=>this.migrate(s(g));return new re((g,y)=>{const p=l(g,y);if(S(p))return p;const q=n(g,y);return S(q)?B(m(q.value)):q},m)}}const an=a({value:e(r),form:f(u,()=>!1),simplify:f(u,()=>!1),considered:w("correct","wrong","ungraded"),key:I(e(v(r).or(o).parser)).then((t,n)=>n.success(String(t))).parser});function sn(t){const n=[];for(const s of t){const{value:l}=s;l!=null&&n.push({...s,value:l})}return n}const on=a({major:i(1),minor:o}),un=de(on,i("expression"),a({answerForms:I(d(an)).then(ne(sn)).parser,functions:d(r),times:u,visibleLabel:e(r),ariaLabel:e(r),buttonSets:d(w("basic","basic+div","trig","prealgebra","logarithms","basic relations","advanced relations")),buttonsVisible:e(w("always","never","focused"))})),ln=e(a({major:i(0),minor:o})),mn=de(ln,i("expression"),a({functions:d(r),times:u,visibleLabel:e(r),ariaLabel:e(r),form:u,simplify:u,value:r,buttonSets:d(w("basic","basic+div","trig","prealgebra","logarithms","basic relations","advanced relations")),buttonsVisible:e(w("always","never","focused"))}));function dn(t){const{options:n}=t;return{...t,version:{major:1,minor:0},options:{times:n.times,buttonSets:n.buttonSets,functions:n.functions,buttonsVisible:n.buttonsVisible,visibleLabel:n.visibleLabel,ariaLabel:n.ariaLabel,answerForms:[{considered:"correct",form:n.form,simplify:n.simplify,value:n.value}]}}}const pn=tn(un).withMigrationFrom(mn,dn).parser,U=f(a({content:f(r,()=>""),widgets:f((t,n)=>L(t,n),()=>({})),metadata:e(d(r)),images:me}),()=>({content:"",widgets:{},images:{}})),pe=a({title:f(r,()=>""),hasHint:e(b(u)),hint:e(b((t,n)=>U(t,n))),content:r,widgets:(t,n)=>L(t,n),widgetEnabled:e(b(u)),immutableWidgets:e(b(u)),images:Z(r,a({width:o,height:o}))}),cn=h(i("graded-group"),pe),yn=h(i("graded-group-set"),a({gradedGroups:d(pe)}));function ce(t,n){return new te(I(t).then(n).parser)}class te{constructor(n){this.parser=n}or(n,s){return new te(gn(n,s,this.parser))}}function gn(t,n,s){return(l,m)=>S(t(l,m))?n(l,m):s(l,m)}const x=k(o,o),R=k(x,x),hn=h(i("grapher"),a({availableTypes:d(w("absolute_value","exponential","linear","logarithm","quadratic","sinusoid","tangent")),correct:ce(a({type:i("absolute_value")}),a({type:i("absolute_value"),coords:R})).or(a({type:i("exponential")}),a({type:i("exponential"),asymptote:R,coords:R})).or(a({type:i("linear")}),a({type:i("linear"),coords:R})).or(a({type:i("logarithm")}),a({type:i("logarithm"),asymptote:R,coords:R})).or(a({type:i("quadratic")}),a({type:i("quadratic"),coords:R})).or(a({type:i("sinusoid")}),a({type:i("sinusoid"),coords:R})).or(a({type:i("tangent")}),a({type:i("tangent"),coords:R})).parser,graph:a({backgroundImage:a({bottom:e(o),height:e(o),left:e(o),scale:e(o),url:e(b(r)),width:e(o)}),box:e(x),editableSettings:e(d(w("graph","snap","image","measure"))),gridStep:e(x),labels:k(r,r),markings:w("graph","none","grid"),range:k(x,x),rulerLabel:i(""),rulerTicks:o,showProtractor:e(u),showRuler:e(u),showTooltips:e(u),snapStep:e(x),step:x,valid:e(v(u).or(r).parser)})})),wn=h(i("group"),(t,n)=>U(t,n)),bn=h(i("iframe"),a({url:r,settings:d(a({name:r,value:r})),width:v(o).or(r).parser,height:v(o).or(r).parser,allowFullScreen:u,allowTopNavigation:e(u),static:f(u,()=>!1)})),ye=(t,n)=>{if(typeof t=="number")return n.success(t);const s=+t;return t===""||isNaN(s)?n.failure("a number or numeric string",t):n.success(s)};function fn(t){return t===""?0:t}const O=I(v(o).or(r).parser).then(ne(fn)).then(ye).parser,$=a({url:e(b(r)),width:e(O),height:e(O),top:e(O),left:e(O),bottom:e(O),scale:e(O)}),_=k(o,o),kn=h(i("image"),a({title:e(r),caption:e(r),alt:e(r),backgroundImage:$,static:e(u),labels:e(d(a({content:r,alignment:r,coordinates:d(o)}))),range:e(k(_,_)),box:e(_)})),vn=(t,n)=>typeof t=="boolean"?n.success(String(t)):n.failure("boolean",t),qn=h(i("input-number"),a({answerType:e(w("number","decimal","integer","rational","improper","mixed","percent","pi")),inexact:e(u),maxError:e(v(o).or(r).parser),rightAlign:e(u),simplify:w("required","optional","enforced"),size:w("normal","small"),value:v(o).or(r).or(vn).parser,customKeypad:e(u)})),W=k(o,o),M=f(r,()=>""),ge=i("function"),Cn=a({type:ge,key:r,options:a({value:r,funcName:r,rangeMin:r,rangeMax:r,color:r,strokeDasharray:r,strokeWidth:o})}),he=i("label"),Rn=a({type:he,key:r,options:a({label:r,color:r,coordX:r,coordY:r})}),we=i("line"),Tn=a({type:we,key:r,options:a({color:r,startX:r,startY:r,endX:r,endY:r,strokeDasharray:r,strokeWidth:o,arrows:r})}),be=i("movable-line"),An=a({type:be,key:r,options:a({startX:r,startY:r,startSubscript:o,endX:r,endY:r,endSubscript:o,constraint:r,snap:o,constraintFn:r,constraintXMin:r,constraintXMax:r,constraintYMin:r,constraintYMax:r})}),fe=i("movable-point"),Pn=a({type:fe,key:r,options:a({startX:r,startY:r,varSubscript:o,constraint:r,snap:o,constraintFn:r,constraintXMin:M,constraintXMax:M,constraintYMin:M,constraintYMax:M})}),ke=i("parametric"),xn=a({type:ke,key:r,options:a({x:r,y:r,rangeMin:r,rangeMax:r,color:r,strokeDasharray:r,strokeWidth:o})}),ve=i("point"),In=a({type:ve,key:r,options:a({color:r,coordX:r,coordY:r})}),qe=i("rectangle"),Sn=a({type:qe,key:r,options:a({color:r,coordX:r,coordY:r,width:r,height:r})}),jn=h(i("interaction"),a({static:f(u,()=>!1),graph:a({editableSettings:e(d(w("canvas","graph"))),box:W,labels:d(r),range:k(W,W),gridStep:W,markings:w("graph","grid","none"),snapStep:e(W),valid:e(v(u).or(r).parser),backgroundImage:e($),showProtractor:e(u),showRuler:e(u),rulerLabel:e(r),rulerTicks:e(o),tickStep:W}),elements:d(ce(a({type:ge}),Cn).or(a({type:he}),Rn).or(a({type:we}),Tn).or(a({type:be}),An).or(a({type:fe}),Pn).or(a({type:ke}),xn).or(a({type:ve}),In).or(a({type:qe}),Sn).parser)})),c=k(o,o),se=a({type:i("angle"),showAngles:e(u),allowReflexAngles:e(u),angleOffsetDeg:e(o),snapDegrees:e(o),match:e(i("congruent")),coords:e(G(c,c,c)),startCoords:e(G(c,c,c))}),Nn=a({type:i("circle"),center:e(c),radius:e(o),startCoords:e(a({center:c,radius:o})),coord:e(c)}),On=a({type:i("linear"),coords:e(b(k(c,c))),startCoords:e(k(c,c)),coord:e(c)}),Wn=a({type:i("linear-system"),coords:e(b(d(k(c,c)))),startCoords:e(d(k(c,c))),coord:e(c)}),Fn=a({type:i("none")}),Ln=a({type:i("point"),numPoints:e(v(o).or(i("unlimited")).parser),coords:e(b(d(c))),startCoords:e(d(c)),coord:e(c)}),Mn=a({type:i("polygon"),numSides:e(v(o).or(i("unlimited")).parser),showAngles:e(u),showSides:e(u),snapTo:e(w("grid","angles","sides")),match:e(w("similar","congruent","approx")),startCoords:e(d(c)),coord:e(c)}),Dn=a({type:i("quadratic"),coords:e(b(G(c,c,c))),startCoords:e(G(c,c,c)),coord:e(c)}),Gn=a({type:i("ray"),coords:e(b(k(c,c))),startCoords:e(k(c,c)),coord:e(c)}),En=a({type:i("segment"),numSegments:e(o),coords:e(b(d(k(c,c)))),startCoords:e(d(k(c,c))),coord:e(c)}),Un=a({type:i("sinusoid"),coords:e(b(d(c))),startCoords:e(d(c)),coord:e(c)}),oe=v(se).or(se).or(Nn).or(On).or(Wn).or(Fn).or(Ln).or(Mn).or(Dn).or(Gn).or(En).or(Un).parser,j=w(...Ae),Ce=w("none","white","translucent","solid"),V=w("solid","dashed"),N=a({type:i("label"),coord:c,text:r,color:j,size:w("small","medium","large")}),H=a({type:i("point"),coord:c,color:j,filled:u,labels:e(d(N)),ariaLabel:e(r)}),$n=a({type:i("line"),kind:w("line","ray","segment"),points:k(H,H),color:j,lineStyle:V,showPoint1:u,showPoint2:u,labels:e(d(N)),ariaLabel:e(r)}),Vn=a({type:i("vector"),points:k(c,c),color:j,labels:e(d(N)),ariaLabel:e(r)}),Jn=a({type:i("ellipse"),center:c,radius:c,angle:o,color:j,fillStyle:Ce,strokeStyle:V,labels:e(d(N)),ariaLabel:e(r)}),_n=a({type:i("polygon"),points:d(c),color:j,showVertices:u,fillStyle:Ce,strokeStyle:V,labels:e(d(N)),ariaLabel:e(r)}),zn=a({type:i("function"),color:j,strokeStyle:V,equation:r,directionalAxis:w("x","y"),domain:e(c),labels:e(d(N)),ariaLabel:e(r)}),Hn=v(H).or($n).or(Vn).or(Jn).or(_n).or(zn).or(N).parser,Kn=h(i("interactive-graph"),a({step:c,gridStep:e(c),snapStep:e(c),backgroundImage:e($),markings:w("graph","grid","none"),labels:e(d(r)),showProtractor:u,showRuler:e(u),showTooltips:e(u),rulerLabel:e(r),rulerTicks:e(o),range:k(c,c),graph:f(oe,()=>({type:"linear"})),correct:oe,lockedFigures:e(d(Hn)),fullGraphLabel:e(r),fullGraphAriaDescription:e(r)})),Bn=h(i("label-image"),a({choices:d(r),imageUrl:r,imageAlt:r,imageHeight:o,imageWidth:o,markers:d(a({answers:d(r),label:r,x:o,y:o})),hideChoicesFromInstructions:u,multipleAnswers:u,static:u})),Xn=h(i("matcher"),a({labels:d(r),left:d(r),right:d(r),orderMatters:u,padding:u})),Yn=I(v(o).or(r).parser).then(ye).parser,Qn=h(f(i("matrix"),()=>"matrix"),a({prefix:e(r),suffix:e(r),answers:d(d(Yn)),cursorPosition:e(d(o)),matrixBoardSize:d(o),static:e(u)})),Zn=h(i("measurer"),a({image:$,showProtractor:u,showRuler:u,rulerLabel:r,rulerTicks:o,rulerPixels:o,rulerLength:o,box:k(o,o),static:u})),er=h(i("molecule-renderer"),a({widgetId:r,rotationAngle:e(o),smiles:e(r)})),nr=h(i("number-line"),a({range:d(o),labelRange:d(b(o)),labelStyle:r,labelTicks:u,isTickCtrl:e(b(u)),divisionRange:d(o),numDivisions:e(b(o)),snapDivisions:f(o,()=>2),tickStep:e(b(o)),correctRel:e(b(r)),correctX:o,initialX:e(b(o)),showTooltip:e(u),static:u})),ie=w("integer","mixed","improper","proper","decimal","percent","pi"),rr=h(i("numeric-input"),a({answers:d(a({message:r,value:e(b(o)),status:r,answerForms:e(d(ie)),strict:u,maxError:e(b(o)),simplify:e(b(v(r).or(I(i(!0)).then(ne(String)).parser).parser))})),labelText:e(r),size:r,coefficient:u,rightAlign:e(u),static:f(u,()=>!1),answerForms:e(d(a({name:ie,simplify:e(b(w("required","correct","enforced","optional")))})))}));function z(t,n){return U(t,n)}const tr=(t,n)=>t==="large"?n.success("auto"):n.success(t),ar=h(i("orderer"),a({options:f(d(z),()=>[]),correctOptions:d(z),otherOptions:d(z),height:I(w("normal","auto","large")).then(tr).parser,layout:f(w("horizontal","vertical"),()=>"horizontal")})),sr=h(i("passage-ref"),a({passageNumber:o,referenceNumber:o,summaryText:e(r)})),or=h(i("passage"),a({footnotes:r,passageText:r,passageTitle:r,showLineNumbers:u,static:f(u,()=>!1)})),ir=h(i("phet-simulation"),a({url:r,description:r})),ur=h(i("plotter"),a({labels:d(r),categories:d(r),type:w(...Pe),maxY:o,scaleY:o,labelInterval:e(b(o)),snapsPerLine:o,starting:d(o),correct:d(o),picUrl:e(b(r)),picSize:e(b(o)),picBoxHeight:e(b(o)),plotDimensions:f(d(o),()=>[380,300])})),lr=h(i("python-program"),a({programID:r,height:o})),mr=h(i("radio"),a({choices:d(a({content:f(r,()=>""),clue:e(r),correct:e(u),isNoneOfTheAbove:e(u),widgets:e((t,n)=>L(t,n))})),hasNoneOfTheAbove:e(u),countChoices:e(u),randomize:e(u),multipleSelect:e(u),deselectEnabled:e(u),onePerLine:e(u),displayCount:e(F),noneOfTheAbove:e(i(!1))})),dr=h(i("sorter"),a({correct:d(r),padding:u,layout:w("horizontal","vertical")})),pr=h(i("table"),a({headers:d(r),rows:o,columns:o,answers:d(d(r))})),cr=h(i("video"),a({location:r,static:e(u)})),L=(t,n)=>{if(!Y(t))return n.failure("PerseusWidgetsMap",t);const s={};for(const l of Object.keys(t)){const m=yr([l,t[l]],s,n.forSubtree(l));if(C(m))return m}return n.success(s)},yr=([t,n],s,l)=>{const m=hr(t.split(" "),l);if(C(m))return m;const[g,y]=m.value;function p(q,A){const P=A(n,l);return C(P)?P:(s[q]=P.value,l.success(void 0))}switch(g){case"categorizer":return p(`categorizer ${y}`,Qe);case"cs-program":return p(`cs-program ${y}`,Ze);case"definition":return p(`definition ${y}`,en);case"dropdown":return p(`dropdown ${y}`,nn);case"explanation":return p(`explanation ${y}`,rn);case"expression":return p(`expression ${y}`,pn);case"grapher":return p(`grapher ${y}`,hn);case"group":return p(`group ${y}`,wn);case"graded-group":return p(`graded-group ${y}`,cn);case"graded-group-set":return p(`graded-group-set ${y}`,yn);case"iframe":return p(`iframe ${y}`,bn);case"image":return p(`image ${y}`,kn);case"input-number":return p(`input-number ${y}`,qn);case"interaction":return p(`interaction ${y}`,jn);case"interactive-graph":return p(`interactive-graph ${y}`,Kn);case"label-image":return p(`label-image ${y}`,Bn);case"matcher":return p(`matcher ${y}`,Xn);case"matrix":return p(`matrix ${y}`,Qn);case"measurer":return p(`measurer ${y}`,Zn);case"molecule-renderer":return p(`molecule-renderer ${y}`,er);case"number-line":return p(`number-line ${y}`,nr);case"numeric-input":return p(`numeric-input ${y}`,rr);case"orderer":return p(`orderer ${y}`,ar);case"passage":return p(`passage ${y}`,or);case"passage-ref":return p(`passage-ref ${y}`,sr);case"passage-ref-target":return p(`passage-ref-target ${y}`,F);case"phet-simulation":return p(`phet-simulation ${y}`,ir);case"plotter":return p(`plotter ${y}`,ur);case"python-program":return p(`python-program ${y}`,lr);case"radio":return p(`radio ${y}`,mr);case"sorter":return p(`sorter ${y}`,dr);case"table":return p(`table ${y}`,pr);case"video":return p(`video ${y}`,cr);case"sequence":return p(`sequence ${y}`,ue);case"lights-puzzle":return p(`lights-puzzle ${y}`,ue);default:return Oe(g)?p(`${g} ${y}`,F):l.failure("a valid widget type",g)}},ue=h((t,n)=>n.success("deprecated-standin"),a({})),gr=(t,n)=>typeof t!="string"||!/^[1-9][0-9]*$/.test(t)?n.failure("numeric string",t):n.success(+t),hr=k(r,gr),wr=a({replace:e(u),content:r,widgets:f(L,()=>({})),metadata:e(d(r)),images:me});a({question:U,hints:f(d(wr),()=>[]),answerArea:I(f(a({}),()=>({}))).then(br).then(Z(w(...xe),u)).parser,itemDataVersion:e(a({major:o,minor:o})),answer:F});function br(t,n){const{type:s,options:l,...m}=t;return n.success(m)}export{D as S,$e as i,He as r};
