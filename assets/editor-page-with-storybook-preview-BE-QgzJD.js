import{r as a,j as n,V as s,ap as P,n as R,aq as T,ar as x,l as A,s as t,as as I,R as q,at as F,o as m}from"./iframe-CheXZuhR.js";import"./changeable-C91qCaHf.js";import"./article-renderer-CThTZZgG.js";import"./server-item-renderer-C2NfoI_F.js";import"./hints-renderer-3GvFGRdL.js";import{C as D}from"./content-preview-FbUpLrLE.js";import{E as C}from"./editor-page-DYZAqAlc.js";const{action:M}=__STORYBOOK_MODULE_ACTIONS__,j={analytics:{onAnalyticsEvent:async()=>{}},generateUrl:r=>r.url,useVideo:()=>({status:"success",data:{video:null}})},E=M("onChange");function N(r){const[u,g]=a.useState("phone"),[y,w]=a.useState(!1),[b,f]=a.useState(),[h,k]=a.useState(r.question),[i,v]=a.useState(r.hints),[o,c]=a.useState(!0),l=r.apiOptions??{isMobile:!1};return n.jsxs(s,{children:[n.jsx(C,{apiOptions:l,previewDevice:u,onPreviewDeviceChange:e=>g(e),dependencies:j,developerMode:!0,jsonMode:y,answerArea:b,question:h,hints:i,previewURL:"about:blank",itemId:"1",onChange:e=>{E(e),"jsonMode"in e&&w(e.jsonMode),"answerArea"in e&&f(e.answerArea),"question"in e&&k(e.question),"hints"in e&&v(e.hints)},additionalTemplates:{"Side by Side":`Left hand side
=====
Right hand side`}}),!o&&n.jsx(P,{onClick:()=>c(!o),style:d.openPanelButton,children:"Open preview (storybook only)"}),o&&n.jsxs(s,{style:d.panel,children:[n.jsx(T,{icon:x,kind:"tertiary","aria-label":"Close preview",onClick:()=>c(!o)}),n.jsx(s,{style:d.panelInner,children:n.jsx(D,{question:h,previewDevice:u,apiOptions:l,linterContext:{contentType:"exercise",highlightLint:!0,paths:[],stack:[]}})}),i==null?void 0:i.map((e,p)=>n.jsxs(s,{style:d.panelInner,children:[n.jsx(A,{size:t.medium_16}),n.jsx(I,{children:`Hint ${p+1}`}),n.jsx(q,{strings:F,apiOptions:l,...e})]},p))]})]})}const d=R.StyleSheet.create({panel:{position:"fixed",right:0,minWidth:500,height:"90vh",overflow:"auto",flex:"none",backgroundColor:m.fadedBlue16,padding:t.medium_16,borderRadius:t.small_12,alignItems:"end"},panelInner:{flex:"none",backgroundColor:m.white,borderRadius:t.xSmall_8,marginTop:t.medium_16,width:"100%",padding:t.xSmall_8},openPanelButton:{position:"fixed",right:t.medium_16,bottom:t.xxxLarge_64}});N.__docgenInfo={description:"",methods:[],displayName:"EditorPageWithStorybookPreview",props:{apiOptions:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
