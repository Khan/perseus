import{r as a,R as v}from"./index-C6mWTJJr.js";import{n as g}from"./no-important-DlFk8a1I.js";import{F as _}from"./index-Xl5L4rvz.js";import{w as te}from"./index-3H81sEQ1.js";import{e as ne}from"./index-BzwLglMS.js";import{V as T,_ as re,a as ae}from"./index-CskvhqFA.js";import{_ as ie}from"./assertThisInitialized-B9jnkVVz.js";import{_ as se}from"./index-1LDQje0j.js";import{c as K}from"./index-CC9jxhwQ.js";import{T as oe}from"./tabbar-ShCvdYam.js";import{u as R,K as m}from"./button-assets-CICggd4J.js";import{K as p}from"./keypad-button-Ce4opAXu.js";import{N as le,O as ue,G as de}from"./operators-page-ByyAQb6A.js";import{N as pe}from"./navigation-pad-DdOxfhts.js";var y=(n=>(n.NONE="NONE",n.IN_PARENS="IN_PARENS",n.IN_SUPER_SCRIPT="IN_SUPER_SCRIPT",n.IN_SUB_SCRIPT="IN_SUB_SCRIPT",n.IN_NUMERATOR="IN_NUMERATOR",n.IN_DENOMINATOR="IN_DENOMINATOR",n.BEFORE_FRACTION="BEFORE_FRACTION",n))(y||{});const ce=["az","cs","da","de","hu","hy","kk","ky","lt","lv","nb","sk","sr","sv","uz"],me=["fr","tr","pt-pt"];function ye(n,e){return ce.includes(n)?!1:me.includes(n)?!0:e}var D;const Le=typeof process<"u"&&!!((D=process==null?void 0:process.env)!=null&&D.JEST_WORKER_ID),q=3;function O(n){const{extraKeys:e,onClickKey:t}=n,{strings:s}=R(),i=m(s);return a.createElement(a.Fragment,null,e.map((r,o)=>{const l=o%q,u=o/q;return a.createElement(p,{key:r,keyConfig:i[r],onClickKey:t,coord:[l,u]})}))}O.__docgenInfo={description:"",methods:[],displayName:"ExtrasPage",props:{extraKeys:{required:!0,tsType:{name:"ReadonlyArray",elements:[{name:"unknown[number]",raw:"(typeof KeypadKeys)[number]"}],raw:"ReadonlyArray<KeypadKey>"},description:""},onClickKey:{required:!0,tsType:{name:"signature",type:"function",raw:`(
    key: KeypadKey,
