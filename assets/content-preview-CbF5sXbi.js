import{j as e,bk as f,V as v,n as k,S as P,e as T,y as R,R as x,f as A,s as I}from"./iframe-hRc7QVRN.js";import"./item-version-Ew2WYzNF.js";import"./article-renderer-njUThmNe.js";import"./server-item-renderer-CuSEeggd.js";import"./hints-renderer-DLx3rRlR.js";import{c as q}from"./components-DQbsTmhw.js";import{d as i,c as F,e as D,f as C,l as N}from"./icon-paths-BWCL0yzl.js";const{ButtonGroup:E,InlineIcon:o}=q,M=n=>{const t=e.jsxs("span",{children:[e.jsx(o,{...F})," Phone"]}),a=e.jsxs("span",{children:[e.jsx(o,{...D})," Tablet"]}),r=e.jsxs("span",{children:[e.jsx(o,{...C})," Desktop"]});return e.jsxs("span",{className:"viewport-resizer",children:["Viewport:"," ",e.jsx(E,{value:n.deviceType,allowEmpty:!1,buttons:[{value:i.PHONE,content:t},{value:i.TABLET,content:a},{value:i.DESKTOP,content:r}],onChange:n.onViewportSizeChanged})]})};M.__docgenInfo={description:"",methods:[],displayName:"ViewportResizer",props:{deviceType:{required:!0,tsType:{name:"union",raw:'"phone" | "tablet" | "desktop"',elements:[{name:"literal",value:'"phone"'},{name:"literal",value:'"tablet"'},{name:"literal",value:'"desktop"'}]},description:"The current device type that is selected."},onViewportSizeChanged:{required:!0,tsType:{name:"signature",type:"function",raw:"(deviceType: DeviceType) => unknown",signature:{arguments:[{type:{name:"union",raw:'"phone" | "tablet" | "desktop"',elements:[{name:"literal",value:'"phone"'},{name:"literal",value:'"tablet"'},{name:"literal",value:'"desktop"'}]},name:"deviceType"}],return:{name:"unknown"}}},description:`A callback that is passed (width, height) as the dimensions of the
viewport to resize to.`}}};function j({question:n,apiOptions:t,seamless:a,linterContext:r,legacyPerseusLint:l,previewDevice:u}){const c=f(),s=u!=="desktop",h=s?"perseus-mobile":"";return e.jsx(v,{className:`framework-perseus ${h}`,style:[d.container,a?void 0:d.gutter],children:e.jsx(P,{children:e.jsx(T.Consumer,{children:({setKeypadActive:p,keypadElement:m,setKeypadElement:g})=>e.jsxs(e.Fragment,{children:[e.jsx(R,{widgets:(n==null?void 0:n.widgets)||{},problemNum:0,children:({userInput:y,handleUserInput:w,initializeUserInput:b})=>e.jsx(x,{strings:c.strings,apiOptions:{...t,isMobile:s},keypadElement:m,linterContext:r,legacyPerseusLint:l,userInput:y,handleUserInput:w,initializeUserInput:b,...n})}),e.jsx(A,{onAnalyticsEvent:()=>Promise.resolve(),onDismiss:()=>p(!1),onElementMounted:g})]})})})})}const d=k.StyleSheet.create({container:{padding:I.xxxSmall_4,containerType:"inline-size",containerName:"perseus-root"},gutter:{marginRight:N}});j.__docgenInfo={description:"The `ContentPreview` component provides a simple preview system for Perseus\nContent. Due to how Persus styles are built, the preview styling matches the\ncurrent device based on the viewport width (using `@media` queries for\n`min-width` and `max-width`).\n\nThe preview will render the mobile variant (styling and layout) when the\n`previewDevice` is phone or tablet. Note that the styling cannot be matched\n100% due to the above `@media` query limitation.",methods:[],displayName:"ContentPreview",props:{question:{required:!1,tsType:{name:"signature",type:"object",raw:`{
    /**
...
media queries based on the screen width).`}}};export{j as C,M as V};
