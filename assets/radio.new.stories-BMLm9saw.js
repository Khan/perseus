import{cL as e,j as oe}from"./iframe-BLnk7R3A.js";import{S as ne}from"./server-item-renderer-with-debug-ui-BpDbvDpj.js";import{a as p,c as ie,S as Z,b as $,m as ae,d as ee,e as se}from"./radio.testdata-Bgd99Ljq.js";import"./split-view-BG80KCyO.js";import"./test-keypad-context-wrapper-DWOL8fCQ.js";import"./server-item-renderer-IpHh8sRL.js";import"./hints-renderer-DEhrvpZS.js";const he={title:"Perseus/Widgets/RadioNew",args:{static:!1,startAnswerless:!1,reviewMode:!1,showSolutions:"none",item:e({question:p})},argTypes:{showSolutions:{options:["none","all","selected"],control:{type:"select"}}},render:s=>oe.jsx(ne,{item:ce(s),apiOptions:le(),reviewMode:s.reviewMode,showSolutions:s.showSolutions,startAnswerless:s.startAnswerless}),parameters:{docs:{description:{component:`This is a story for the new radio widget.
