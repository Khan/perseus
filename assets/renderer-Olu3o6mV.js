...
This image's alt text is only ${a.alt.length} characters long.`}}),Un=d.makeRule({name:"image-in-table",severity:d.Severity.BULK_WARNING,selector:"table image",message:`Image in table:
do not put images inside of tables.`}),Vn=d.makeRule({name:"image-spaces-around-urls",severity:d.Severity.ERROR,selector:"image",lint:function(r,e,n,t,a){const o=n[0].target;if(a&&a.content){const s=a.content.indexOf(o);if(s===-1)return;if(a.content[s-1]!=="("||a.content[s+o.length]!==")")return`Whitespace before or after image url:
...
Don't include math expressions in image captions.`}}),Hn=d.makeRule({name:"link-click-here",severity:d.Severity.WARNING,selector:"link",pattern:/click here/i,message:`Inappropriate link text:
Do not use the words "click here" in links.`}),Kn=d.makeRule({name:"long-paragraph",severity:d.Severity.GUIDELINE,selector:"paragraph",pattern:/^.{501,}/,lint:function(r,e,n,t){return`Paragraph too long:
This paragraph is ${e.length} characters long.
Shorten it to 500 characters or fewer.`}}),Bn=d.makeRule({name:"math-adjacent",severity:d.Severity.WARNING,selector:"blockMath+blockMath",message:`Adjacent math blocks:
combine the blocks between \\begin{align} and \\end{align}`}),Qn=d.makeRule({name:"math-align-extra-break",severity:d.Severity.WARNING,selector:"blockMath",pattern:/(\\{2,})\s*\\end{align}/,message:`Extra space at end of block:
Don't end an align block with backslashes`}),$n=d.makeRule({name:"math-align-linebreaks",severity:d.Severity.WARNING,selector:"blockMath",pattern:/\\begin{align}[\s\S]*\\\\[\s\S]+\\end{align}/,lint:function(r,e,n,t){let a=t[0];for(;a.length;){const i=a.indexOf("\\\\");if(i===-1)return;a=a.substring(i+2);const o=a.match(/^\s*\\\\\s*(?!\\\\)/);if(!o)return"Use four backslashes between lines of an align block";a=a.substring(o[0].length)}}}),Jn=d.makeRule({name:"math-empty",severity:d.Severity.WARNING,selector:"math, blockMath",pattern:/^$/,message:"Empty math: don't use $$ in your markdown."}),Zn=d.makeRule({name:"math-frac",severity:d.Severity.GUIDELINE,selector:"math, blockMath",pattern:/\\frac[ {]/,message:"Use \\dfrac instead of \\frac in your math expressions."}),er=d.makeRule({name:"math-nested",severity:d.Severity.ERROR,selector:"math, blockMath",pattern:/\\text{[^$}]*\$[^$}]*\$[^}]*}/,message:`Nested math:
Don't nest math expressions inside \\text{} blocks`}),nr=d.makeRule({name:"math-starts-with-space",severity:d.Severity.GUIDELINE,selector:"math, blockMath",pattern:/^\s*(~|\\qquad|\\quad|\\,|\\;|\\:|\\ |\\!|\\enspace|\\phantom)/,message:`Math starts with space:
math should not be indented. Do not begin math expressions with
LaTeX space commands like ~, \\;, \\quad, or \\phantom`}),rr=d.makeRule({name:"math-text-empty",severity:d.Severity.WARNING,selector:"math, blockMath",pattern:/\\text{\s*}/,message:"Empty \\text{} block in math expression"}),tr=d.makeRule({name:"math-without-dollars",severity:d.Severity.GUIDELINE,pattern:/\\\w+{[^}]*}|{|}/,message:`This looks like LaTeX:
did you mean to put it inside dollar signs?`}),ar=d.makeRule({name:"nested-lists",severity:d.Severity.WARNING,selector:"list list",message:`Nested lists:
nested lists are hard to read on mobile devices;
do not use additional indentation.`}),ir=d.makeRule({name:"static-widget-in-question-stem",severity:d.Severity.WARNING,selector:"widget",lint:(r,e,n,t,a)=>{var s;if((a==null?void 0:a.contentType)!=="exercise"||a.stack.includes("hint"))return;const i=r.currentNode().id;if(!i)return;const o=(s=a==null?void 0:a.widgets)==null?void 0:s[i];if(o&&o.static)return"Widget in question stem is static (non-interactive)."}}),sr=d.makeRule({name:"table-missing-cells",severity:d.Severity.WARNING,selector:"table",lint:function(r,e,n,t){const a=n[0],i=a.header.length,o=a.cells.map(s=>s.length);for(let s=0;s<o.length;s++)if(o[s]!==i)return`Table rows don't match header:
The table header has ${i} cells, but
Row ${s+1} has ${o[s]} cells.`}}),or=d.makeRule({name:"unbalanced-code-delimiters",severity:d.Severity.ERROR,pattern:/[`~]+/,message:`Unbalanced code delimiters:
code blocks should begin and end with the same type and number of delimiters`}),ur=d.makeRule({name:"unescaped-dollar",severity:d.Severity.ERROR,selector:"unescapedDollar",message:`Unescaped dollar sign:
Dollar signs must appear in pairs or be escaped as \\$`}),lr=d.makeRule({name:"widget-in-table",severity:d.Severity.BULK_WARNING,selector:"table widget",message:`Widget in table:
do not put widgets inside of tables.`}),dr=[Sn,In,Nn,En,Xn,Ln,Yn,Wn,Mn,Fn,_n,Un,Hn,Kn,Bn,Qn,$n,Jn,Zn,er,nr,rr,ar,ir,sr,ur,lr,tr,or,Vn,zn];class F{constructor(e){this.root=e}static isNode(e){return e&&typeof e=="object"&&typeof e.type=="string"}static isTextNode(e){return F.isNode(e)&&e.type==="text"&&typeof e.content=="string"}traverse(e){this._traverse(this.root,new Pe(this.root),e)}_traverse(e,n,t){let a="";if(F.isNode(e)){const i=e;n._containers.push(i),n._ancestors.push(i),typeof i.content=="string"&&(a=i.content),Object.keys(i).forEach(s=>{if(s==="type")return;const u=i[s];u&&typeof u=="object"&&(n._indexes.push(s),a+=this._traverse(u,n,t),n._indexes.pop())}),n._currentNode=n._ancestors.pop(),n._containers.pop(),t(i,n,a)}else if(Array.isArray(e)){const i=e;n._containers.push(i);let o=0;for(;o<i.length;)n._indexes.push(o),a+=this._traverse(i[o],n,t),o=n._indexes.pop()+1;n._containers.pop()}return a}}class Pe{constructor(e){this.root=e,this._currentNode=null,this._containers=new K,this._indexes=new K,this._ancestors=new K}currentNode(){return this._currentNode||this.root}parent(){return this._ancestors.top()}ancestors(){return this._ancestors.values()}nextSibling(){const e=this._containers.top();if(!e||!Array.isArray(e))return null;const n=this._indexes.top();return e.length>n+1?e[n+1]:null}previousSibling(){const e=this._containers.top();if(!e||!Array.isArray(e))return null;const n=this._indexes.top();return n>0?e[n-1]:null}removeNextSibling(){const e=this._containers.top();if(e&&Array.isArray(e)){const n=this._indexes.top();if(e.length>n+1)return e.splice(n+1,1)[0]}return null}replace(...e){const n=this._containers.top();if(!n)throw new X("Can't replace the root of the tree",N.Internal);if(Array.isArray(n)){const t=this._indexes.top();n.splice(t,1,...e),this._indexes.pop(),this._indexes.push(t+e.length-1)}else{const t=this._indexes.top();e.length===0?delete n[t]:e.length===1?n[t]=e[0]:n[t]=e}}hasPreviousSibling(){return Array.isArray(this._containers.top())&&this._indexes.top()>0}goToPreviousSibling(){if(!this.hasPreviousSibling())throw new X("goToPreviousSibling(): node has no previous sibling",N.Internal);this._currentNode=this.previousSibling();const e=this._indexes.pop();this._indexes.push(e-1)}hasParent(){return this._ancestors.size()!==0}goToParent(){if(!this.hasParent())throw new X("goToParent(): node has no ancestor",N.NotAllowed);for(this._currentNode=this._ancestors.pop();this._containers.size()&&this._containers.top()[this._indexes.top()]!==this._currentNode;)this._containers.pop(),this._indexes.pop()}clone(){const e=new Pe(this.root);return e._currentNode=this._currentNode,e._containers=this._containers.clone(),e._indexes=this._indexes.clone(),e._ancestors=this._ancestors.clone(),e}equals(e){return this.root===e.root&&this._currentNode===e._currentNode&&this._containers.equals(e._containers)&&this._indexes.equals(e._indexes)&&this._ancestors.equals(e._ancestors)}}class K{constructor(e){this.stack=e?e.slice(0):[]}push(e){this.stack.push(e)}pop(){return this.stack.pop()}top(){return this.stack[this.stack.length-1]}values(){return this.stack.slice(0)}size(){return this.stack.length}toString(){return this.stack.toString()}clone(){return new K(this.stack)}equals(e){if(!e||!e.stack||e.stack.length!==this.stack.length)return!1;for(let n=0;n<this.stack.length;n++)if(this.stack[n]!==e.stack[n])return!1;return!0}}const mr="@khanacademy/perseus-linter",gr="__lib_version__";Ae(mr,gr);Y.shape({contentType:Y.string,highlightLint:Y.bool,paths:Y.arrayOf(Y.string),stack:Y.arrayOf(Y.string)});const Ge={contentType:"",highlightLint:!1,paths:[],stack:[]},pr=dr.filter(r=>r.severity<d.Severity.BULK_WARNING);function yr(r,e,n,t=pr){const a=[],i=new F(r);i.traverse((u,l,g)=>{if(F.isTextNode(u)){let y=l.nextSibling();for(;F.isTextNode(y);)u.content+=y.content,l.removeNextSibling(),y=l.nextSibling()}});let o=[],s=!1;return i.traverse((u,l,g)=>{const y=[],b=t.filter(c=>c.applies(e)),f=[...e.stack];f.push(u.type);const q={...e,stack:f.join(".")};if(b.forEach(c=>{const k=c.check(u,l,g,q);k&&((k.start||k.end)&&(k.target=g.substring(k.start,k.end)),a.push(k),n&&y.push(k))}),!!n&&(u.type==="table"?(o.length&&y.push(...o),s=!1,o=[]):s||(s=l.ancestors().some(c=>c.type==="table")),s&&y.length&&o.push(...y),y.length))if(y.sort((c,k)=>c.severity-k.severity),u.type!=="text"||y.length>1)l.replace({type:"lint",content:u,message:y.map(c=>c.message).join(`

`),ruleName:y[0].rule,blockHighlight:q.blockHighlight,insideTable:s,severity:y[0].severity});else{const c=u.content,k=y[0],A=k.start||0,C=k.end||c.length,L=c.substring(0,A),P=c.substring(A,C),Z=c.substring(C),ee=[];L&&ee.push({type:"text",content:L}),ee.push({type:"lint",content:{type:"text",content:P},message:k.message,ruleName:k.rule,insideTable:s,severity:k.severity}),Z&&ee.push({type:"text",content:Z}),l.replace(...ee)}}),a}function cr(r,e){const n=r.stack||[];return{...r,stack:n.concat(e)}}const hr={activeDefinitionId:null,setActiveDefinitionId:()=>{}},De=m.createContext(hr);class ke extends m.Component{constructor(){super(...arguments),this.state={activeDefinitionId:null},this.setActiveDefinitionId=e=>{this.setState(n=>({activeDefinitionId:e}))}}render(){const{children:e}=this.props,{activeDefinitionId:n}=this.state,{setActiveDefinitionId:t}=this;return m.createElement(De.Provider,{value:{activeDefinitionId:n,setActiveDefinitionId:t}},e)}}const Mt=De.Consumer;ke.__docgenInfo={description:"",methods:[{name:"setActiveDefinitionId",docblock:null,modifiers:[],params:[{name:"activeDefinitionId",optional:!0,type:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]}}],returns:{type:{name:"void"}}}],displayName:"DefinitionProvider",props:{children:{required:!0,tsType:{name:"any"},description:""}}};class E extends m.Component{constructor(e){super(e),this.state={error:""}}componentDidCatch(e,n){var t,a;this.setState({error:e.toString()}),(a=(t=this.props).onError)==null||a.call(t,e,n),B.error("Unhandled Perseus error: "+e.message,N.Internal,{cause:e,loggedMetadata:{componentStack:n&&"componentStack"in n?n.componentStack:"componentStack not provided",...this.props.metadata}})}render(){return this.state.error?m.createElement("svg",{height:"16",width:"16",viewBox:"0 0 16 16",role:"img"},m.createElement("title",null,"Rendering Error!"),m.createElement("path",{d:"m8 16c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm0-3c0.55 0 1-0.45 1-1s-0.45-1-1-1-1 0.45-1 1 0.45 1 1 1zm0-9c-0.55 0-1 0.45-1 1v4c0 0.55.45 1 1 1s1-0.45 1-1v-4c0-0.55-0.45-1-1-1z",fill:"#d92916",fillRule:"evenodd"})):this.props.children}}E.__docgenInfo={description:"",methods:[],displayName:"ErrorBoundary",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},metadata:{required:!1,tsType:{name:"Record",elements:[{name:"string"},{name:"string"}],raw:"Record<string, string>"},description:""},onError:{required:!1,tsType:{name:"signature",type:"function",raw:"(error: Error, info: any) => void",signature:{arguments:[{type:{name:"Error"},name:"error"},{type:{name:"any"},name:"info"}],return:{name:"void"}}},description:""}}};function br(){}class wr{constructor(e,n,t,a){this._track=i=>{this._tracked&&!this.setting||(this._tracked=!0,this.trackApi({type:this.widgetType,id:this.widgetID,...i}))},e?(this._tracked=!1,this.trackApi=e,this.widgetType=n,this.widgetID=t,this.setting=a,this.track=this._track):this.track=br}}const kr="@khanacademy/simple-markdown",fr="__lib_version__";Ae(kr,fr);var vr=/\r\n?/g,qr=/\t/g,Tr=/\f/g,Fe=function(r){return r.replace(vr,`
`).replace(Tr,"").replace(qr,"    ")},_e=function(r,e){var n=r||{};if(e!=null)for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&(n[t]=e[t]);return n},Ue=function(r,e){var n=Object.keys(r).filter(function(o){var s=r[o];if(s==null||s.match==null)return!1;var u=s.order;return(typeof u!="number"||!isFinite(u))&&typeof console<"u"&&console.warn("simple-markdown: Invalid order for rule `"+o+"`: "+String(u)),!0});n.sort(function(o,s){var u=r[o],l=r[s],g=u.order,y=l.order;if(g!==y)return g-y;var b=u.quality?0:1,f=l.quality?0:1;return b!==f?b-f:o<s?-1:o>s?1:0});var t,a=function(o,s){var u=[];for(s=s||t,t=s;o;){var l=null,g=null,y=null,b=NaN,f=0,q=n[0],c=r[q];do{var k=c.order,A=s.prevCapture==null?"":s.prevCapture[0],C=c.match(o,s,A);if(C){var L=c.quality?c.quality(C,s,A):0;L<=b||(l=q,g=c,y=C,b=L)}f++,q=n[f],c=r[q]}while(c&&(!y||c.order===k&&c.quality));if(g==null||y==null)throw new Error("Could not find a matching rule for the below content. The rule with highest `order` should always match content provided to it. Check the definition of `match` for '"+n[n.length-1]+`'. It seems to not match the following source:
...
`),t.prevCapture=null,a(Fe(o),t)};return i},R=function(r){var e=function(n,t,a){return t.inline?r.exec(n):null};return e.regex=r,e},I=function(r){var e=function(n,t){return t.inline?null:r.exec(n)};return e.regex=r,e},fe=function(r){var e=function(n,t){return r.exec(n)};return e.regex=r,e},xr=typeof Symbol=="function"&&Symbol.for&&Symbol.for("react.element")||60103,v=function(r,e,n){var t={$$typeof:xr,type:r,key:e??void 0,ref:null,props:n,_owner:null};return t},T=function(r,e,n,t){n=n||{},t=typeof t<"u"?t:!0;var a="";for(var i in n){var o=n[i];Object.prototype.hasOwnProperty.call(n,i)&&o&&(a+=" "+_(i)+'="'+_(o)+'"')}var s="<"+r+a+">";return t?s+e+"</"+r+">":s},Ar={},z=function(r){if(r==null)return null;try{var e=new URL(r,"https://localhost").protocol;if(e.indexOf("javascript:")===0||e.indexOf("vbscript:")===0||e.indexOf("data:")===0)return null}catch{return null}return r},Pr=/[<>&"']/g,Rr={"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;","'":"&#x27;","/":"&#x2F;","`":"&#96;"},_=function(r){return String(r).replace(Pr,function(e){return Rr[e]})},Cr=/\\([^0-9A-Za-z\s])/g,ve=function(r){return r.replace(Cr,"$1")},se=function(r,e,n){var t=n.inline||!1;n.inline=!0;var a=r(e,n);return n.inline=t,a},Sr=function(r,e,n){var t=n.inline||!1;n.inline=!1;var a=r(e+`

`,n);return n.inline=t,a},ne=function(r,e,n){return{content:se(e,r[1],n)}},he=function(){return{}},oe="(?:[*+-]|\\d+\\.)",Ve="( *)("+oe+") +",Ee=new RegExp("^"+Ve),Ir=new RegExp(Ve+"[^\\n]*(?:\\n(?!\\1"+oe+` )[^\\n]*)*(
|$)`,"gm"),ze=/\n{2,}$/,Nr=/^ (?= *`)|(` *) $/g,Er=ze,Oe=/ *\n+$/,Or=new RegExp("^( *)("+oe+`) [\\s\\S]+?(?:
{2,}(?! )(?!\\1`+oe+` )\\n*|\\s*
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{Mt as D,Ye as J,W as P,xe as R,h as S,Ft as a,_t as b,Ut as c,Vt as d,Ht as e,Kt as f,zt as g,gt as h,it as i,Gt as j,D as k,Ge as l,S as m,cr as p,Dt as r,Bt as s};
