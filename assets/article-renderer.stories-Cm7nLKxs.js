import{A as x}from"./article-renderer-with-debug-ui-Ijfz9Beq.js";import"./iframe-BI7ThRyc.js";import"./test-keypad-context-wrapper-B4K-Iqjo.js";import"./article-renderer-uNMUXAfC.js";import"./split-view-BHNYDS8g.js";import"./main-Cmo8mjYG.js";const $={content:`[[☃ image 2]]
...
`,images:{},widgets:{"image 2":{type:"image",alignment:"block",static:!1,graded:!0,options:{static:!1,title:"",range:[[0,10],[0,10]],box:[1258,703],backgroundImage:{url:"https://ka-perseus-images.s3.amazonaws.com/b08029bc1786fbe54468a2ddc96aaa20be7a663a.png",width:1258,height:703},labels:[],alt:`A scene from Pixar's film "Toy Story 3" where the characters are swimming in a sea of trash and look very afraid.`,caption:`A scene from Pixar's film "Toy Story 3" where the characters are swimming in a sea of trash and look very afraid."`},version:{major:0,minor:0}}}},A={content:`###Group/Pair Activity 
...
Matrices have tons of real-world applications! They can be used in computer graphics to perform transformations on images, in physics to model physical systems, and in statistics to analyze data, just to name a few.`,images:{},widgets:{}}],S=[{content:`### Practice Problem
...
*Your answer should be a complex number in the form $a+bi$ where $a$ and $b$ are real numbers.*`,images:{},widgets:{"expression 3":{alignment:"default",graded:!0,options:{answerForms:[{considered:"correct",form:!0,simplify:!1,value:"16+88i"}],buttonSets:["basic"],functions:["f","g","h"],times:!1},static:!1,type:"expression",version:{major:1,minor:0}}}}],{action:P}=__STORYBOOK_MODULE_ACTIONS__,C={title:"Renderers/Article Renderer",component:x,argTypes:{useNewStyles:{control:"boolean"}}},e={args:{json:$}},t={args:{json:v}},n={args:{json:A}},a={args:{json:k,apiOptions:{onFocusChange:P("onFocusChange")}}},s={args:{json:S}};var i,o,r;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    json: singleSectionArticle
  }
}`,...(r=(o=e.parameters)==null?void 0:o.docs)==null?void 0:r.source}}};var h,c,l;t.parameters={...t.parameters,docs:{...(h=t.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    json: multiSectionArticle
  }
}`,...(l=(c=t.parameters)==null?void 0:c.docs)==null?void 0:l.source}}};var m,d,u;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    json: passageArticle
  }
}`,...(u=(d=n.parameters)==null?void 0:d.docs)==null?void 0:u.source}}};var g,f,p;a.parameters={...a.parameters,docs:{...(g=a.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
...
}`,...(p=(f=a.parameters)==null?void 0:f.docs)==null?void 0:p.source}}};var w,b,y;s.parameters={...s.parameters,docs:{...(w=s.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    json: multiSectionArticleWithExpression
  }
}`,...(y=(b=s.parameters)==null?void 0:b.docs)==null?void 0:y.source}}};const F=["ASingleSectionArticle","BMultiSectionArticle","PassageArticle","ExpressionArticle","MultiSectionedExpressionArticle"];export{e as ASingleSectionArticle,t as BMultiSectionArticle,a as ExpressionArticle,s as MultiSectionedExpressionArticle,n as PassageArticle,F as __namedExportsOrder,C as default};
