var nn=Object.defineProperty;var tn=(t,n,e)=>n in t?nn(t,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[n]=e;var l=(t,n,e)=>(tn(t,typeof n!="symbol"?n+"":n,e),e);import{j as c}from"./jsx-runtime-BT65X5dW.js";import{_ as p,u as rn}from"./underscore-U-AHniOr.js";import{e as Se}from"./index-BWagKz4k.js";import{P as j,E}from"./perseus-error-CSETqePQ.js";import{C as an,ad as sn,U as un,ae as Ce,af as on,ag as ln,ah as gn}from"./util-2bFi3N3g.js";import{P as G}from"./index-CrGd2QqM.js";import{$ as dn}from"./jquery-CkHB0_Mt.js";import{e as mn}from"./index-BzwLglMS.js";import{c as be}from"./index-D7h-teXI.js";import{r as Y}from"./index-C6mWTJJr.js";import{h as ve}from"./index-B1Gws05u.js";import{Z as pn,c as ce}from"./zoomable-tex-Dy-nElJT.js";import{a as cn}from"./i18n-context-3AkWzTTj.js";import{L as $,S as yn}from"./svg-image-ywfOpLF6.js";import{T as Ee}from"./tex-BONImhZG.js";import{Z as hn}from"./zoomable-C_CCSKDG.js";import{g as Q,D as wn}from"./dependencies-BsVPGK1s.js";import{A as bn,C as ye}from"./perseus-api-Ty_QvlNi.js";import{L as vn}from"./lint-D0FI20JF.js";import{c as fn,t as kn,u as qn}from"./constants-BIpV3g0K.js";class z{static parse(n){return new oe(n).parse()}match(n){throw new j("Selector subclasses must implement match()",E.NotAllowed)}toString(){return"Unknown selector class"}}const de=class de{constructor(n){l(this,"tokens");l(this,"tokenIndex");n=n.trim().replace(/\s+/g," "),this.tokens=n.match(de.TOKENS)||[],this.tokenIndex=0}nextToken(){return this.tokens[this.tokenIndex]||""}consume(){this.tokenIndex++}isIdentifier(){const n=this.tokens[this.tokenIndex][0];return n>="a"&&n<="z"||n>="A"&&n<="Z"}skipSpace(){for(;this.nextToken()===" ";)this.consume()}parse(){const n=this.parseTreeSelector();let e=this.nextToken();if(!e)return n;const r=[n];for(;e;){if(e===",")this.consume();else throw new he("Expected comma");r.push(this.parseTreeSelector()),e=this.nextToken()}return new xn(r)}parseTreeSelector(){this.skipSpace();let n=this.parseNodeSelector();for(;;){const e=this.nextToken();if(!e||e===",")break;if(e===" ")this.consume(),n=new Sn(n,this.parseNodeSelector());else if(e===">")this.consume(),n=new An(n,this.parseNodeSelector());else if(e==="+")this.consume(),n=new In(n,this.parseNodeSelector());else if(e==="~")this.consume(),n=new Tn(n,this.parseNodeSelector());else throw new he("Unexpected token: "+e)}return n}parseNodeSelector(){this.skipSpace();const n=this.nextToken();if(n==="*")return this.consume(),new Pn;if(this.isIdentifier())return this.consume(),new Rn(n);throw new he("Expected node type")}};l(de,"TOKENS");let oe=de;oe.TOKENS=/([a-zA-Z][\w-]*)|(\d+)|[^\s]|(\s(?=[a-zA-Z\*]))/g;class he extends Error{constructor(n){super(n)}}class xn extends z{constructor(e){super();l(this,"selectors");this.selectors=e}match(e){for(let r=0;r<this.selectors.length;r++){const a=this.selectors[r].match(e);if(a)return a}return null}toString(){let e="";for(let r=0;r<this.selectors.length;r++)e+=r>0?", ":"",e+=this.selectors[r].toString();return e}}class Pn extends z{match(n){return[n.currentNode()]}toString(){return"*"}}class Rn extends z{constructor(e){super();l(this,"type");this.type=e}match(e){const r=e.currentNode();return r.type===this.type?[r]:null}toString(){return this.type}}class me extends z{constructor(e,r){super();l(this,"left");l(this,"right");this.left=e,this.right=r}}class Sn extends me{constructor(n,e){super(n,e)}match(n){const e=this.right.match(n);if(e)for(n=n.clone();n.hasParent();){n.goToParent();const r=this.left.match(n);if(r)return r.concat(e)}return null}toString(){return this.left.toString()+" "+this.right.toString()}}class An extends me{constructor(n,e){super(n,e)}match(n){const e=this.right.match(n);if(e&&n.hasParent()){n=n.clone(),n.goToParent();const r=this.left.match(n);if(r)return r.concat(e)}return null}toString(){return this.left.toString()+" > "+this.right.toString()}}class In extends me{constructor(n,e){super(n,e)}match(n){const e=this.right.match(n);if(e&&n.hasPreviousSibling()){n=n.clone(),n.goToPreviousSibling();const r=this.left.match(n);if(r)return r.concat(e)}return null}toString(){return this.left.toString()+" + "+this.right.toString()}}class Tn extends me{constructor(n,e){super(n,e)}match(n){const e=this.right.match(n);if(e)for(n=n.clone();n.hasPreviousSibling();){n.goToPreviousSibling();const r=this.left.match(n);if(r)return r.concat(e)}return null}toString(){return this.left.toString()+" ~ "+this.right.toString()}}const L=class L{constructor(n,e,r,i,a,u){l(this,"name");l(this,"severity");l(this,"selector");l(this,"pattern");l(this,"lint");l(this,"applies");l(this,"message");if(!r&&!i)throw new j("Lint rules must have a selector or pattern",E.InvalidInput,{metadata:{name:n}});this.name=n||"unnamed rule",this.severity=e||L.Severity.BULK_WARNING,this.selector=r||L.DEFAULT_SELECTOR,this.pattern=i||null,typeof a=="function"?(this.lint=a,this.message=null):(this.lint=(...s)=>this._defaultLintFunction(...s),this.message=a),this.applies=u||function(){return!0}}static makeRule(n){return new L(n.name,n.severity,n.selector?z.parse(n.selector):null,L.makePattern(n.pattern),n.lint||n.message,n.applies)}check(n,e,r,i){const a=this.selector.match(e);if(!a)return null;let u;if(this.pattern?u=r.match(this.pattern):u=L.FakePatternMatch(r,r,0),!u)return null;try{const s=this.lint(e,r,a,u,i);return s?typeof s=="string"?{rule:this.name,severity:this.severity,message:s,start:0,end:r.length}:{rule:this.name,severity:this.severity,message:s.message,start:s.start,end:s.end}:null}catch(s){return{rule:"lint-rule-failure",message:`Exception in rule ${this.name}: ${s.message}
Stack trace:
${s.stack}`,start:0,end:r.length}}}_defaultLintFunction(n,e,r,i,a){return{message:this.message||"",start:i.index,end:i.index+i[0].length}}static makePattern(n){if(!n)return null;if(n instanceof RegExp)return n;if(n[0]==="/"){const e=n.lastIndexOf("/"),r=n.substring(1,e),i=n.substring(e+1);return new RegExp(r,i)}return new RegExp(n)}static FakePatternMatch(n,e,r){const i=[e];return i.index=r,i.input=n,i}};l(L,"DEFAULT_SELECTOR"),l(L,"Severity",{ERROR:1,WARNING:2,GUIDELINE:3,BULK_WARNING:4});let d=L;d.DEFAULT_SELECTOR=z.parse("text");const Nn=/\/\/([^\/]+)/;function Cn(t){if(!t)return"";const n=t.match(Nn);return n?n[1]:""}const En=d.makeRule({name:"absolute-url",severity:d.Severity.GUIDELINE,selector:"link, image",lint:function(t,n,e,r){const i=e[0].target,a=Cn(i);if(a==="khanacademy.org"||a.endsWith(".khanacademy.org"))return`Don't use absolute URLs:
...
math should not be indented.`}),Yn=d.makeRule({name:"blockquoted-widget",severity:d.Severity.WARNING,selector:"blockQuote widget",message:`Blockquoted widget:
widgets should not be indented.`}),On=d.makeRule({name:"double-spacing-after-terminal",severity:d.Severity.BULK_WARNING,selector:"paragraph",pattern:/[.!\?] {2}/i,message:`Use a single space after a sentence-ending period, or
any other kind of terminal punctuation.`});function Ln(t,n){return`Answer requires a button not found in the button sets: ${t} (in ${n})`}const jn={"\\sqrt":"prealgebra","\\sin":"trig","\\cos":"trig","\\tan":"trig","\\log":"logarithms","\\ln":"logarithms"},Mn=d.makeRule({name:"expression-widget",severity:d.Severity.WARNING,selector:"widget",lint:function(t,n,e,r,i){var g;if(t.currentNode().widgetType!=="expression")return;const a=t.currentNode().id;if(!a)return;const u=(g=i==null?void 0:i.widgets)==null?void 0:g[a];if(!u)return;const s=u.options.answerForms,o=u.options.buttonSets;for(const m of s)for(const[y,b]of Object.entries(jn))if(m.value.includes(y)&&!o.includes(b))return Ln(y,b)}}),Gn=d.makeRule({name:"extra-content-spacing",selector:"paragraph",pattern:/\s+$/,applies:function(t){return(t==null?void 0:t.contentType)==="article"},message:"No extra whitespace at the end of content blocks."}),Fn=d.makeRule({name:"heading-level-1",severity:d.Severity.WARNING,selector:"heading",lint:function(t,n,e,r){if(e[0].level===1)return`Don't use level-1 headings:
Begin headings with two or more # characters.`}}),Dn=d.makeRule({name:"heading-level-skip",severity:d.Severity.WARNING,selector:"heading ~ heading",lint:function(t,n,e,r){const i=e[1],a=e[0];if(i.level>a.level+1)return`Skipped heading level:
this heading is level ${i.level} but
the previous heading was level ${a.level}`}}),Wn=d.makeRule({name:"heading-sentence-case",severity:d.Severity.GUIDELINE,selector:"heading",pattern:/^\W*[a-z]/,message:`First letter is lowercase:
the first letter of a heading should be capitalized.`}),_n={and:!0,nor:!0,but:!0,the:!0,for:!0};function Un(t){const n=t[0];return n===n.toUpperCase()}const Vn=d.makeRule({name:"heading-title-case",severity:d.Severity.GUIDELINE,selector:"heading",pattern:/[^\s:]\s+[A-Z]+[a-z]/,locale:"en",lint:function(t,n,e,r){let a=n.trim().split(/\s+/);if(a.shift(),a=a.filter(u=>u.length>2&&!_n.hasOwnProperty(u)),a.length>=3&&a.every(u=>Un(u)))return`Title-case heading:
...
This image's alt text is only ${i.alt.length} characters long.`}}),Hn=d.makeRule({name:"image-in-table",severity:d.Severity.BULK_WARNING,selector:"table image",message:`Image in table:
do not put images inside of tables.`}),Kn=d.makeRule({name:"image-spaces-around-urls",severity:d.Severity.ERROR,selector:"image",lint:function(t,n,e,r,i){const u=e[0].target;if(i&&i.content){const s=i.content.indexOf(u);if(s===-1)return;if(i.content[s-1]!=="("||i.content[s+u.length]!==")")return`Whitespace before or after image url:
For images, don't include any space or newlines after '(' or before ')'.
Whitespace in image URLs causes translation difficulties.`}}}),Qn=d.makeRule({name:"image-url-empty",severity:d.Severity.ERROR,selector:"image",lint:function(t,n,e){const i=e[0].target;if(!i||!i.trim())return"Images should have a URL"}}),Bn=d.makeRule({name:"image-widget",severity:d.Severity.WARNING,selector:"widget",lint:function(t,n,e,r,i){if(t.currentNode().widgetType!=="image")return;const a=t.currentNode().id;if(!a)return;const u=i&&i.widgets&&i.widgets[a];if(!u)return;const s=u.options.alt;if(!s)return`Images should have alt text:
...
Don't include math expressions in image captions.`}}),$n=d.makeRule({name:"link-click-here",severity:d.Severity.WARNING,selector:"link",pattern:/click here/i,message:`Inappropriate link text:
Do not use the words "click here" in links.`}),Jn=d.makeRule({name:"long-paragraph",severity:d.Severity.GUIDELINE,selector:"paragraph",pattern:/^.{501,}/,lint:function(t,n,e,r){return`Paragraph too long:
This paragraph is ${n.length} characters long.
Shorten it to 500 characters or fewer.`}}),Zn=d.makeRule({name:"math-adjacent",severity:d.Severity.WARNING,selector:"blockMath+blockMath",message:`Adjacent math blocks:
combine the blocks between \\begin{align} and \\end{align}`}),et=d.makeRule({name:"math-align-extra-break",severity:d.Severity.WARNING,selector:"blockMath",pattern:/(\\{2,})\s*\\end{align}/,message:`Extra space at end of block:
Don't end an align block with backslashes`}),nt=d.makeRule({name:"math-align-linebreaks",severity:d.Severity.WARNING,selector:"blockMath",pattern:/\\begin{align}[\s\S]*\\\\[\s\S]+\\end{align}/,lint:function(t,n,e,r){let i=r[0];for(;i.length;){const a=i.indexOf("\\\\");if(a===-1)return;i=i.substring(a+2);const u=i.match(/^\s*\\\\\s*(?!\\\\)/);if(!u)return"Use four backslashes between lines of an align block";i=i.substring(u[0].length)}}}),tt=d.makeRule({name:"math-empty",severity:d.Severity.WARNING,selector:"math, blockMath",pattern:/^$/,message:"Empty math: don't use $$ in your markdown."}),rt=d.makeRule({name:"math-frac",severity:d.Severity.GUIDELINE,selector:"math, blockMath",pattern:/\\frac[ {]/,message:"Use \\dfrac instead of \\frac in your math expressions."}),it=d.makeRule({name:"math-nested",severity:d.Severity.ERROR,selector:"math, blockMath",pattern:/\\text{[^$}]*\$[^$}]*\$[^}]*}/,message:`Nested math:
Don't nest math expressions inside \\text{} blocks`}),at=d.makeRule({name:"math-starts-with-space",severity:d.Severity.GUIDELINE,selector:"math, blockMath",pattern:/^\s*(~|\\qquad|\\quad|\\,|\\;|\\:|\\ |\\!|\\enspace|\\phantom)/,message:`Math starts with space:
math should not be indented. Do not begin math expressions with
LaTeX space commands like ~, \\;, \\quad, or \\phantom`}),st=d.makeRule({name:"math-text-empty",severity:d.Severity.WARNING,selector:"math, blockMath",pattern:/\\text{\s*}/,message:"Empty \\text{} block in math expression"}),ut=d.makeRule({name:"math-without-dollars",severity:d.Severity.GUIDELINE,pattern:/\\\w+{[^}]*}|{|}/,message:`This looks like LaTeX:
did you mean to put it inside dollar signs?`}),ot=d.makeRule({name:"nested-lists",severity:d.Severity.WARNING,selector:"list list",message:`Nested lists:
nested lists are hard to read on mobile devices;
do not use additional indentation.`}),lt=d.makeRule({name:"static-widget-in-question-stem",severity:d.Severity.WARNING,selector:"widget",lint:(t,n,e,r,i)=>{var s;if((i==null?void 0:i.contentType)!=="exercise"||i.stack.includes("hint"))return;const a=t.currentNode().id;if(!a)return;const u=(s=i==null?void 0:i.widgets)==null?void 0:s[a];if(u&&u.static)return"Widget in question stem is static (non-interactive)."}}),gt=d.makeRule({name:"table-missing-cells",severity:d.Severity.WARNING,selector:"table",lint:function(t,n,e,r){const i=e[0],a=i.header.length,u=i.cells.map(s=>s.length);for(let s=0;s<u.length;s++)if(u[s]!==a)return`Table rows don't match header:
The table header has ${a} cells, but
Row ${s+1} has ${u[s]} cells.`}}),dt=d.makeRule({name:"unbalanced-code-delimiters",severity:d.Severity.ERROR,pattern:/[`~]+/,message:`Unbalanced code delimiters:
code blocks should begin and end with the same type and number of delimiters`}),mt=d.makeRule({name:"unescaped-dollar",severity:d.Severity.ERROR,selector:"unescapedDollar",message:`Unescaped dollar sign:
Dollar signs must appear in pairs or be escaped as \\$`}),pt=d.makeRule({name:"widget-in-table",severity:d.Severity.BULK_WARNING,selector:"table widget",message:`Widget in table:
do not put widgets inside of tables.`}),ct=[En,Xn,Yn,On,Qn,Mn,Gn,Fn,Dn,Wn,Vn,zn,Hn,$n,Jn,Zn,et,nt,tt,rt,it,at,st,ot,lt,gt,mt,pt,ut,dt,Kn,Bn];class U{constructor(n){l(this,"root");this.root=n}static isNode(n){return n&&typeof n=="object"&&typeof n.type=="string"}static isTextNode(n){return U.isNode(n)&&n.type==="text"&&typeof n.content=="string"}traverse(n){this._traverse(this.root,new Ae(this.root),n)}_traverse(n,e,r){let i="";if(U.isNode(n)){const a=n;e._containers.push(a),e._ancestors.push(a),typeof a.content=="string"&&(i=a.content),Object.keys(a).forEach(s=>{if(s==="type")return;const o=a[s];o&&typeof o=="object"&&(e._indexes.push(s),i+=this._traverse(o,e,r),e._indexes.pop())}),e._currentNode=e._ancestors.pop(),e._containers.pop(),r(a,e,i)}else if(Array.isArray(n)){const a=n;e._containers.push(a);let u=0;for(;u<a.length;)e._indexes.push(u),i+=this._traverse(a[u],e,r),u=e._indexes.pop()+1;e._containers.pop()}return i}}class Ae{constructor(n){l(this,"root");l(this,"_currentNode");l(this,"_containers");l(this,"_indexes");l(this,"_ancestors");this.root=n,this._currentNode=null,this._containers=new B,this._indexes=new B,this._ancestors=new B}currentNode(){return this._currentNode||this.root}parent(){return this._ancestors.top()}ancestors(){return this._ancestors.values()}nextSibling(){const n=this._containers.top();if(!n||!Array.isArray(n))return null;const e=this._indexes.top();return n.length>e+1?n[e+1]:null}previousSibling(){const n=this._containers.top();if(!n||!Array.isArray(n))return null;const e=this._indexes.top();return e>0?n[e-1]:null}removeNextSibling(){const n=this._containers.top();if(n&&Array.isArray(n)){const e=this._indexes.top();if(n.length>e+1)return n.splice(e+1,1)[0]}return null}replace(...n){const e=this._containers.top();if(!e)throw new j("Can't replace the root of the tree",E.Internal);if(Array.isArray(e)){const r=this._indexes.top();e.splice(r,1,...n),this._indexes.pop(),this._indexes.push(r+n.length-1)}else{const r=this._indexes.top();n.length===0?delete e[r]:n.length===1?e[r]=n[0]:e[r]=n}}hasPreviousSibling(){return Array.isArray(this._containers.top())&&this._indexes.top()>0}goToPreviousSibling(){if(!this.hasPreviousSibling())throw new j("goToPreviousSibling(): node has no previous sibling",E.Internal);this._currentNode=this.previousSibling();const n=this._indexes.pop();this._indexes.push(n-1)}hasParent(){return this._ancestors.size()!==0}goToParent(){if(!this.hasParent())throw new j("goToParent(): node has no ancestor",E.NotAllowed);for(this._currentNode=this._ancestors.pop();this._containers.size()&&this._containers.top()[this._indexes.top()]!==this._currentNode;)this._containers.pop(),this._indexes.pop()}clone(){const n=new Ae(this.root);return n._currentNode=this._currentNode,n._containers=this._containers.clone(),n._indexes=this._indexes.clone(),n._ancestors=this._ancestors.clone(),n}equals(n){return this.root===n.root&&this._currentNode===n._currentNode&&this._containers.equals(n._containers)&&this._indexes.equals(n._indexes)&&this._ancestors.equals(n._ancestors)}}class B{constructor(n){l(this,"stack");this.stack=n?n.slice(0):[]}push(n){this.stack.push(n)}pop(){return this.stack.pop()}top(){return this.stack[this.stack.length-1]}values(){return this.stack.slice(0)}size(){return this.stack.length}toString(){return this.stack.toString()}clone(){return new B(this.stack)}equals(n){if(!n||!n.stack||n.stack.length!==this.stack.length)return!1;for(let e=0;e<this.stack.length;e++)if(this.stack[e]!==n.stack[e])return!1;return!0}}const yt="@khanacademy/perseus-linter",ht="__lib_version__";Se(yt,ht);G.shape({contentType:G.string,highlightLint:G.bool,paths:G.arrayOf(G.string),stack:G.arrayOf(G.string)});const De={contentType:"",highlightLint:!1,paths:[],stack:[]},wt=ct.filter(t=>t.severity<d.Severity.BULK_WARNING);function bt(t,n,e,r=wt){const i=[],a=new U(t);a.traverse((o,g,m)=>{if(U.isTextNode(o)){let y=g.nextSibling();for(;U.isTextNode(y);)o.content+=y.content,g.removeNextSibling(),y=g.nextSibling()}});let u=[],s=!1;return a.traverse((o,g,m)=>{const y=[],b=r.filter(h=>h.applies(n)),k=[...n.stack];k.push(o.type);const x={...n,stack:k.join(".")};if(b.forEach(h=>{const f=h.check(o,g,m,x);f&&((f.start||f.end)&&(f.target=m.substring(f.start,f.end)),i.push(f),y.push(f))}),o.type==="table"?(u.length&&y.push(...u),s=!1,u=[]):s||(s=g.ancestors().some(h=>h.type==="table")),s&&y.length&&u.push(...y),y.length)if(y.sort((h,f)=>h.severity-f.severity),o.type!=="text"||y.length>1)g.replace({type:"lint",content:o,message:y.map(h=>h.message).join(`

`),ruleName:y[0].rule,blockHighlight:x.blockHighlight,insideTable:s,severity:y[0].severity});else{const h=o.content,f=y[0],S=f.start||0,T=f.end||h.length,M=h.substring(0,S),A=h.substring(S,T),ne=h.substring(T),te=[];M&&te.push({type:"text",content:M}),te.push({type:"lint",content:{type:"text",content:A},message:f.message,ruleName:f.rule,insideTable:s,severity:f.severity}),ne&&te.push({type:"text",content:ne}),g.replace(...te)}}),i}function vt(t,n){const e=t.stack||[];return{...t,stack:e.concat(n)}}const ft={activeDefinitionId:null,setActiveDefinitionId:()=>{}},We=Y.createContext(ft);class fe extends Y.Component{constructor(){super(...arguments);l(this,"state",{activeDefinitionId:null});l(this,"setActiveDefinitionId",e=>{this.setState(r=>({activeDefinitionId:e}))})}render(){const{children:e}=this.props,{activeDefinitionId:r}=this.state,{setActiveDefinitionId:i}=this;return c.jsx(We.Provider,{value:{activeDefinitionId:r,setActiveDefinitionId:i},children:e})}}const Vr=We.Consumer;fe.__docgenInfo={description:"",methods:[{name:"setActiveDefinitionId",docblock:null,modifiers:[],params:[{name:"activeDefinitionId",optional:!0,type:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]}}],returns:{type:{name:"void"}}}],displayName:"DefinitionProvider",props:{children:{required:!0,tsType:{name:"any"},description:""}}};class X extends Y.Component{constructor(n){super(n),this.state={error:""}}componentDidCatch(n,e){var r,i;this.setState({error:n.toString()}),(i=(r=this.props).onError)==null||i.call(r,n,e),$.error("Unhandled Perseus error: "+n.message,E.Internal,{cause:n,loggedMetadata:{componentStack:e&&"componentStack"in e?e.componentStack:"componentStack not provided",...this.props.metadata}})}render(){return this.state.error?c.jsxs("svg",{height:"16",width:"16",viewBox:"0 0 16 16",role:"img",children:[c.jsx("title",{children:"Rendering Error!"}),c.jsx("path",{d:"m8 16c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm0-3c0.55 0 1-0.45 1-1s-0.45-1-1-1-1 0.45-1 1 0.45 1 1 1zm0-9c-0.55 0-1 0.45-1 1v4c0 0.55.45 1 1 1s1-0.45 1-1v-4c0-0.55-0.45-1-1-1z",fill:"#d92916",fillRule:"evenodd"})]}):this.props.children}}X.__docgenInfo={description:"",methods:[],displayName:"ErrorBoundary",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},metadata:{required:!1,tsType:{name:"Record",elements:[{name:"string"},{name:"string"}],raw:"Record<string, string>"},description:""},onError:{required:!1,tsType:{name:"signature",type:"function",raw:"(error: Error, info: any) => void",signature:{arguments:[{type:{name:"Error"},name:"error"},{type:{name:"any"},name:"info"}],return:{name:"void"}}},description:""}}};function kt(){}class qt{constructor(n,e,r,i){l(this,"_tracked");l(this,"setting");l(this,"track");l(this,"trackApi");l(this,"widgetID");l(this,"widgetType");l(this,"_track",n=>{this._tracked&&!this.setting||(this._tracked=!0,this.trackApi({type:this.widgetType,id:this.widgetID,...n}))});n?(this._tracked=!1,this.trackApi=n,this.widgetType=e,this.widgetID=r,this.setting=i,this.track=this._track):this.track=kt}}const xt="@khanacademy/simple-markdown",Pt="__lib_version__";Se(xt,Pt);var Rt=/\r\n?/g,St=/\t/g,At=/\f/g,_e=function(t){return t.replace(Rt,`
`).replace(At,"").replace(St,"    ")},Ue=function(t,n){var e=t||{};if(n!=null)for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r]);return e},Ve=function(t,n){var e=Object.keys(t).filter(function(u){var s=t[u];if(s==null||s.match==null)return!1;var o=s.order;return(typeof o!="number"||!isFinite(o))&&typeof console<"u"&&console.warn("simple-markdown: Invalid order for rule `"+u+"`: "+String(o)),!0});e.sort(function(u,s){var o=t[u],g=t[s],m=o.order,y=g.order;if(m!==y)return m-y;var b=o.quality?0:1,k=g.quality?0:1;return b!==k?b-k:u<s?-1:u>s?1:0});var r,i=function(u,s){var o=[];for(s=s||r,r=s;u;){var g=null,m=null,y=null,b=NaN,k=0,x=e[0],h=t[x];do{var f=h.order,S=s.prevCapture==null?"":s.prevCapture[0],T=h.match(u,s,S);if(T){var M=h.quality?h.quality(T,s,S):0;M<=b||(g=x,m=h,y=T,b=M)}k++,x=e[k],h=t[x]}while(h&&(!y||h.order===f&&h.quality));if(m==null||y==null)throw new Error("Could not find a matching rule for the below content. The rule with highest `order` should always match content provided to it. Check the definition of `match` for '"+e[e.length-1]+`'. It seems to not match the following source:
`+u);if(y.index)throw new Error("`match` must return a capture starting at index 0 (the current parse index). Did you forget a ^ at the start of the RegExp?");var A=m.parse(y,i,s);if(Array.isArray(A))Array.prototype.push.apply(o,A);else{if(A==null||typeof A!="object")throw new Error(`parse() function returned invalid parse result: '${A}'`);A.type==null&&(A.type=g),o.push(A)}s.prevCapture=y,u=u.substring(s.prevCapture[0].length)}return o},a=function(u,s){return r=Ue(s,n),!r.inline&&!r.disableAutoBlockNewlines&&(u=u+`

`),r.prevCapture=null,i(_e(u),r)};return a},I=function(t){var n=function(e,r,i){return r.inline?t.exec(e):null};return n.regex=t,n},C=function(t){var n=function(e,r){return r.inline?null:t.exec(e)};return n.regex=t,n},ke=function(t){var n=function(e,r){return t.exec(e)};return n.regex=t,n},It=typeof Symbol=="function"&&Symbol.for&&Symbol.for("react.element")||60103,q=function(t,n,e){var r={$$typeof:It,type:t,key:n??void 0,ref:null,props:e,_owner:null};return r},P=function(t,n,e,r){e=e||{},r=typeof r<"u"?r:!0;var i="";for(var a in e){var u=e[a];Object.prototype.hasOwnProperty.call(e,a)&&u&&(i+=" "+V(a)+'="'+V(u)+'"')}var s="<"+t+i+">";return r?s+n+"</"+t+">":s},Tt={},K=function(t){if(t==null)return null;try{var n=new URL(t,"https://localhost").protocol;if(n.indexOf("javascript:")===0||n.indexOf("vbscript:")===0||n.indexOf("data:")===0)return null}catch{return null}return t},Nt=/[<>&"']/g,Ct={"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;","'":"&#x27;","/":"&#x2F;","`":"&#96;"},V=function(t){return String(t).replace(Nt,function(n){return Ct[n]})},Et=/\\([^0-9A-Za-z\s])/g,qe=function(t){return t.replace(Et,"$1")},le=function(t,n,e){var r=e.inline||!1;e.inline=!0;var i=t(n,e);return e.inline=r,i},Xt=function(t,n,e){var r=e.inline||!1;e.inline=!1;var i=t(n+`

`,e);return e.inline=r,i},re=function(t,n,e){return{content:le(n,t[1],e)}},we=function(){return{}},ge="(?:[*+-]|\\d+\\.)",ze="( *)("+ge+") +",Xe=new RegExp("^"+ze),Yt=new RegExp(ze+"[^\\n]*(?:\\n(?!\\1"+ge+` )[^\\n]*)*(
|$)`,"gm"),He=/\n{2,}$/,Ot=/^ (?= *`)|(` *) $/g,Lt=He,Ye=/ *\n+$/,jt=new RegExp("^( *)("+ge+`) [\\s\\S]+?(?:
{2,}(?! )(?!\\1`+ge+` )\\n*|\\s*
*$)`),Mt=/(?:^|\n)( *)$/,ie=function(){var t=/^ *\| *| *\| *$/g,n=/ *$/,e=/^ *-+: *$/,r=/^ *:-+: *$/,i=/^ *:-+ *$/,a=function(m){return e.test(m)?"right":r.test(m)?"center":i.test(m)?"left":null},u=function(m,y,b,k){k&&(m=m.replace(t,""));var x=m.trim().split("|");return x.map(a)},s=function(m,y,b,k){var x=b.inTable;b.inTable=!0;var h=y(m.trim(),b);b.inTable=x;var f=[[]];return h.forEach(function(S,T){S.type==="tableSeparator"?(!k||T!==0&&T!==h.length-1)&&f.push([]):(S.type==="text"&&(h[T+1]==null||h[T+1].type==="tableSeparator")&&(S.content=S.content.replace(n,"")),f[f.length-1].push(S))}),f},o=function(m,y,b,k){var x=m.trim().split(`
`);return x.map(function(h){return s(h,y,b,k)})},g=function(m){return function(y,b,k){k.inline=!0;var x=s(y[1],b,k,m),h=u(y[2],b,k,m),f=o(y[3],b,k,m);return k.inline=!1,{type:"table",header:x,align:h,cells:f}}};return{parseTable:g(!0),parseNpTable:g(!1),TABLE_REGEX:/^ *(\|.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/,NPTABLE_REGEX:/^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/}}(),ae="(?:\\[[^\\]]*\\]|[^\\[\\]]|\\](?=[^\\[]*\\]))*",Oe=`\\s*<?((?:\\([^)]*\\)|[^\\s\\\\]|\\\\.)*?)>?(?:\\s+['"]([\\s\\S]*?)['"])?\\s*`,Gt=/mailto:/i,Le=function(t,n,e){var r=(t[2]||t[1]).replace(/\s+/g," ").toLowerCase();if(n._defs&&n._defs[r]){var i=n._defs[r];e.target=i.target,e.title=i.title}return n._refs=n._refs||{},n._refs[r]=n._refs[r]||[],n._refs[r].push(e),e},v=0,ee={Array:{react:function(t,n,e){for(var r=e.key,i=[],a=0,u=0;a<t.length;a++,u++){e.key=""+a;var s=t[a];if(s.type==="text")for(s={type:"text",content:s.content};a+1<t.length&&t[a+1].type==="text";a++)s.content+=t[a+1].content;i.push(n(s,e))}return e.key=r,i},html:function(t,n,e){for(var r="",i=0;i<t.length;i++){var a=t[i];if(a.type==="text")for(a={type:"text",content:a.content};i+1<t.length&&t[i+1].type==="text";i++)a.content+=t[i+1].content;r+=n(a,e)}return r}},heading:{order:v++,match:C(/^ *(#{1,6})([^\n]+?)#* *(?:\n *)+\n/),parse:function(t,n,e){return{level:t[1].length,content:le(n,t[2].trim(),e)}},react:function(t,n,e){return q("h"+t.level,e.key,{children:n(t.content,e)})},html:function(t,n,e){return P("h"+t.level,n(t.content,e))}},nptable:{order:v++,match:C(ie.NPTABLE_REGEX),parse:ie.parseNpTable,react:null,html:null},lheading:{order:v++,match:C(/^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/),parse:function(t,n,e){return{type:"heading",level:t[2]==="="?1:2,content:le(n,t[1],e)}},react:null,html:null},hr:{order:v++,match:C(/^( *[-*_]){3,} *(?:\n *)+\n/),parse:we,react:function(t,n,e){return q("hr",e.key,{"aria-hidden":!0})},html:function(t,n,e){return'<hr aria-hidden="true">'}},codeBlock:{order:v++,match:C(/^(?:    [^\n]+\n*)+(?:\n *)+\n/),parse:function(t,n,e){var r=t[0].replace(/^    /gm,"").replace(/\n+$/,"");return{lang:void 0,content:r}},react:function(t,n,e){var r=t.lang?"markdown-code-"+t.lang:void 0;return q("pre",e.key,{children:q("code",null,{className:r,children:t.content})})},html:function(t,n,e){var r=t.lang?"markdown-code-"+t.lang:void 0,i=P("code",V(t.content),{class:r});return P("pre",i)}},fence:{order:v++,match:C(/^ *(`{3,}|~{3,}) *(?:(\S+) *)?\n([\s\S]+?)\n?\1 *(?:\n *)+\n/),parse:function(t,n,e){return{type:"codeBlock",lang:t[2]||void 0,content:t[3]}},react:null,html:null},blockQuote:{order:v++,match:C(/^( *>[^\n]+(\n[^\n]+)*\n*)+\n{2,}/),parse:function(t,n,e){var r=t[0].replace(/^ *> ?/gm,"");return{content:n(r,e)}},react:function(t,n,e){return q("blockquote",e.key,{children:n(t.content,e)})},html:function(t,n,e){return P("blockquote",n(t.content,e))}},list:{order:v++,match:function(t,n){var e=n.prevCapture==null?"":n.prevCapture[0],r=Mt.exec(e),i=n._list||!n.inline;return r&&i?(t=r[1]+t,jt.exec(t)):null},parse:function(t,n,e){var r=t[2],i=r.length>1,a=i?+r:void 0,u=t[0].replace(Lt,`
`).match(Yt),s=!1,o=u.map(function(g,m){var y=Xe.exec(g),b=y?y[0].length:0,k=new RegExp("^ {1,"+b+"}","gm"),x=g.replace(k,"").replace(Xe,""),h=m===u.length-1,f=x.indexOf(`

`)!==-1,S=f||h&&s;s=S;var T=e.inline,M=e._list;e._list=!0;var A;S?(e.inline=!1,A=x.replace(Ye,`

`)):(e.inline=!0,A=x.replace(Ye,""));var ne=n(A,e);return e.inline=T,e._list=M,ne});return{ordered:i,start:a,items:o}},react:function(t,n,e){var r=t.ordered?"ol":"ul";return q(r,e.key,{start:t.start,children:t.items.map(function(i,a){return q("li",""+a,{children:n(i,e)})})})},html:function(t,n,e){var r=t.items.map(function(u){return P("li",n(u,e))}).join(""),i=t.ordered?"ol":"ul",a={start:t.start};return P(i,r,a)}},def:{order:v++,match:C(/^ *\[([^\]]+)\]: *<?([^\s>]*)>?(?: +["(]([^\n]+)[")])? *\n(?: *\n)*/),parse:function(t,n,e){var r=t[1].replace(/\s+/g," ").toLowerCase(),i=t[2],a=t[3];return e._refs&&e._refs[r]&&e._refs[r].forEach(function(u){u.target=i,u.title=a}),e._defs=e._defs||{},e._defs[r]={target:i,title:a},{def:r,target:i,title:a}},react:function(){return null},html:function(){return""}},table:{order:v++,match:C(ie.TABLE_REGEX),parse:ie.parseTable,react:function(t,n,e){var r=function(u){return t.align[u]==null?{}:{textAlign:t.align[u]}},i=t.header.map(function(u,s){return q("th",""+s,{style:r(s),scope:"col",children:n(u,e)})}),a=t.cells.map(function(u,s){return q("tr",""+s,{children:u.map(function(o,g){return q("td",""+g,{style:r(g),children:n(o,e)})})})});return q("table",e.key,{children:[q("thead","thead",{children:q("tr",null,{children:i})}),q("tbody","tbody",{children:a})]})},html:function(t,n,e){var r=function(o){return t.align[o]==null?"":"text-align:"+t.align[o]+";"},i=t.header.map(function(o,g){return P("th",n(o,e),{style:r(g),scope:"col"})}).join(""),a=t.cells.map(function(o){var g=o.map(function(m,y){return P("td",n(m,e),{style:r(y)})}).join("");return P("tr",g)}).join(""),u=P("thead",P("tr",i)),s=P("tbody",a);return P("table",u+s)}},newline:{order:v++,match:C(/^(?:\n *)*\n/),parse:we,react:function(t,n,e){return`
`},html:function(t,n,e){return`
`}},paragraph:{order:v++,match:C(/^((?:[^\n]|\n(?! *\n))+)(?:\n *)+\n/),parse:re,react:function(t,n,e){return q("div",e.key,{className:"paragraph",children:n(t.content,e)})},html:function(t,n,e){var r={class:"paragraph"};return P("div",n(t.content,e),r)}},escape:{order:v++,match:I(/^\\([^0-9A-Za-z\s])/),parse:function(t,n,e){return{type:"text",content:t[1]}},react:null,html:null},tableSeparator:{order:v++,match:function(t,n){return n.inTable?/^ *\| */.exec(t):null},parse:function(){return{type:"tableSeparator"}},react:function(){return" | "},html:function(){return" &vert; "}},autolink:{order:v++,match:I(/^<([^: >]+:\/[^ >]+)>/),parse:function(t,n,e){return{type:"link",content:[{type:"text",content:t[1]}],target:t[1]}},react:null,html:null},mailto:{order:v++,match:I(/^<([^ >]+@[^ >]+)>/),parse:function(t,n,e){var r=t[1],i=t[1];return Gt.test(i)||(i="mailto:"+i),{type:"link",content:[{type:"text",content:r}],target:i}},react:null,html:null},url:{order:v++,match:I(/^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/),parse:function(t,n,e){return{type:"link",content:[{type:"text",content:t[1]}],target:t[1],title:void 0}},react:null,html:null},link:{order:v++,match:I(new RegExp("^\\[("+ae+")\\]\\("+Oe+"\\)")),parse:function(t,n,e){var r={content:n(t[1],e),target:qe(t[2]),title:t[3]};return r},react:function(t,n,e){return q("a",e.key,{href:K(t.target),title:t.title,children:n(t.content,e)})},html:function(t,n,e){var r={href:K(t.target),title:t.title};return P("a",n(t.content,e),r)}},image:{order:v++,match:I(new RegExp("^!\\[("+ae+")\\]\\("+Oe+"\\)")),parse:function(t,n,e){var r={alt:t[1],target:qe(t[2]),title:t[3]};return r},react:function(t,n,e){return q("img",e.key,{src:K(t.target),alt:t.alt,title:t.title})},html:function(t,n,e){var r={src:K(t.target),alt:t.alt,title:t.title};return P("img","",r,!1)}},reflink:{order:v++,match:I(new RegExp("^\\[("+ae+")\\]\\s*\\[([^\\]]*)\\]")),parse:function(t,n,e){return Le(t,e,{type:"link",content:n(t[1],e)})},react:null,html:null},refimage:{order:v++,match:I(new RegExp("^!\\[("+ae+")\\]\\s*\\[([^\\]]*)\\]")),parse:function(t,n,e){return Le(t,e,{type:"image",alt:t[1]})},react:null,html:null},em:{order:v,match:I(new RegExp("^\\b_((?:__|\\\\[\\s\\S]|[^\\\\_])+?)_\\b|^\\*(?=\\S)((?:\\*\\*|\\\\[\\s\\S]|\\s+(?:\\\\[\\s\\S]|[^\\s\\*\\\\]|\\*\\*)|[^\\s\\*\\\\])+?)\\*(?!\\*)")),quality:function(t){return t[0].length+.2},parse:function(t,n,e){return{content:n(t[2]||t[1],e)}},react:function(t,n,e){return q("em",e.key,{children:n(t.content,e)})},html:function(t,n,e){return P("em",n(t.content,e))}},strong:{order:v,match:I(/^\*\*((?:\\[\s\S]|[^\\])+?)\*\*(?!\*)/),quality:function(t){return t[0].length+.1},parse:re,react:function(t,n,e){return q("strong",e.key,{children:n(t.content,e)})},html:function(t,n,e){return P("strong",n(t.content,e))}},u:{order:v++,match:I(/^__((?:\\[\s\S]|[^\\])+?)__(?!_)/),quality:function(t){return t[0].length},parse:re,react:function(t,n,e){return q("u",e.key,{children:n(t.content,e)})},html:function(t,n,e){return P("u",n(t.content,e))}},del:{order:v++,match:I(/^~~(?=\S)((?:\\[\s\S]|~(?!~)|[^\s~\\]|\s(?!~~))+?)~~/),parse:re,react:function(t,n,e){return q("del",e.key,{children:n(t.content,e)})},html:function(t,n,e){return P("del",n(t.content,e))}},inlineCode:{order:v++,match:I(/^(`+)([\s\S]*?[^`])\1(?!`)/),parse:function(t,n,e){return{content:t[2].replace(Ot,"$1")}},react:function(t,n,e){return q("code",e.key,{children:t.content})},html:function(t,n,e){return P("code",V(t.content))}},br:{order:v++,match:ke(/^ {2,}\n/),parse:we,react:function(t,n,e){return q("br",e.key,Tt)},html:function(t,n,e){return"<br>"}},text:{order:v++,match:ke(/^[\s\S]+?(?=[^0-9A-Za-z\s\u00c0-\uffff]|\n\n| {2,}\n|\w+:\S|$)/),parse:function(t,n,e){return{content:t[0]}},react:function(t,n,e){return t.content},html:function(t,n,e){return V(t.content)}}},Ft=function(t,n){!n&&typeof console<"u"&&console.warn("simple-markdown ruleOutput should take 'react' or 'html' as the second argument.");var e=function(r,i,a){return t[r.type][n](r,i,a)};return e},Dt=function(t){var n=function(e,r){if(r=r||{},Array.isArray(e)){for(var i=r.key,a=[],u=null,s=0;s<e.length;s++){r.key=""+s;var o=n(e[s],r);typeof o=="string"&&typeof u=="string"?(u=u+o,a[a.length-1]=u):(a.push(o),u=o)}return r.key=i,a}else return t(e,n,r)};return n},Wt=function(t){var n=function(e,r){return r=r||{},Array.isArray(e)?e.map(function(i){return n(i,r)}).join(""):t(e,n,r)};return n},Ie=function(t,n,e={}){if(!n)throw new Error("simple-markdown: outputFor: `property` must be defined. if you just upgraded, you probably need to replace `outputFor` with `reactFor`");var r,i=t.Array||ee.Array,a=i[n];if(!a)throw new Error("simple-markdown: outputFor: to join nodes of type `"+n+"` you must provide an `Array:` joiner rule with that type, Please see the docs for details on specifying an Array rule.");var u=a,s=function(g,m){return m=m||r,r=m,Array.isArray(g)?u(g,s,m):t[g.type][n](g,s,m)},o=function(g,m){return r=Ue(m,e),s(g,r)};return o},pe=Ve(ee),Te=function(t,n){return n=n||{},n.inline=!1,pe(t,n)},_t=function(t,n){return n=n||{},n.inline=!0,pe(t,n)},je=function(t,n){var e=He.test(t);return n=n||{},n.inline=!e,pe(t,n)},xe=Ie(ee,"react"),Ke=Ie(ee,"html"),Qe=function(t,n){return xe(Te(t,n),n)},Ut=function(t,n){return Ke(Te(t,n),n)},Vt=function(t){var n={};for(var e in t)e!=="source"&&Object.prototype.hasOwnProperty.call(t,e)&&(n[e]=t[e]);return n.children=Qe(t.source),q("div",null,n)},w={defaultRules:ee,parserFor:Ve,outputFor:Ie,inlineRegex:I,blockRegex:C,anyScopeRegex:ke,parseInline:le,parseBlock:Xt,markdownToReact:Qe,markdownToHtml:Ut,ReactMarkdown:Vt,defaultBlockParse:Te,defaultInlineParse:_t,defaultImplicitParse:je,defaultReactOutput:xe,defaultHtmlOutput:Ke,preprocess:_e,sanitizeText:V,sanitizeUrl:K,unescapeUrl:qe,htmlTag:P,reactElement:q,defaultRawParse:pe,ruleOutput:Ft,reactFor:Dt,htmlFor:Wt,defaultParse:function(...t){return typeof console<"u"&&console.warn("defaultParse is deprecated, please use `defaultImplicitParse`"),je.apply(null,t)},defaultOutput:function(...t){return typeof console<"u"&&console.warn("defaultOutput is deprecated, please use `defaultReactOutput`"),xe.apply(null,t)}};const zt={fence:{match:w.defaultRules.fence.match,order:1,parse:(t,n,e)=>({type:"codeBlock",lang:t[2]||void 0,content:t[3]})},paragraph:{match:w.defaultRules.paragraph.match,order:2,parse:(t,n,e)=>({content:t[1]})}},Ht=w.parserFor(zt),Kt=t=>{const n=t.replace(/^\n\s*\n/,"")+`

`;return Ht(n,{inline:!1}).map(e=>e.content)},Qt=t=>t.join(`

`),Me={parseToArray:Kt,joinFromArray:Qt},Bt="@khanacademy/pure-markdown",$t="__lib_version__";Se(Bt,$t);const Jt=/^\[\[\u2603 (([a-z-]+) ([0-9]+))\]\]/,Be=(t,n,e)=>{const r=t.length;let i=0;if(e){if(n.inline)return null;for(;i<r&&t[i]===" ";)i++}if(!(i<r&&t[i]==="$"))return null;i++;const a=i;let u=0;for(;i<r;){const s=t[i];if(s==="\\")i++;else if(u<=0&&s==="$"){let o=i+1;if(e){const g=/^(?: *\n){2,}/.exec(t.slice(o));o=g?o+g[0].length:null}return o?[t.substring(0,o),t.substring(a,i)]:null}else if(s==="{")u++;else if(s==="}")u--;else if(s===`
`&&t[i-1]===`
`)return null;i++}return null},Zt=(t,n)=>Be(t,n,!1),er=(t,n)=>Be(t,n,!0),nr=new RegExp("^\\|\\| +(.*) +\\|\\| *\\n("+w.defaultRules.nptable.match.regex.source.substring(1)+")"),tr=w.blockRegex(/^(crwdns.*)\n\s*\n/),N={...w.defaultRules,columns:{order:-2,match:w.blockRegex(/^([\s\S]*\n\n)={5,}\n\n([\s\S]*)/),parse:(t,n,e)=>({col1:n(t[1],e),col2:n(t[2],e)})},crowdinId:{order:-1,match:(t,n,e)=>n.isJipt?tr(t,n,e):null,parse:(t,n,e)=>({id:t[1]})},titledTable:{order:w.defaultRules.nptable.order-.5,match:w.blockRegex(nr),parse:(t,n,e)=>{const r=w.parseInline(n,t[1],e),i=t.slice(2),a=w.defaultRules.nptable.parse(i,n,e);return{title:r,table:a}}},widget:{order:w.defaultRules.link.order-.75,match:w.inlineRegex(Jt),parse:(t,n,e)=>({id:t[1],widgetType:t[2]})},blockMath:{order:w.defaultRules.codeBlock.order+.5,match:er,parse:(t,n,e)=>({content:t[1]})},math:{order:w.defaultRules.link.order-.25,match:Zt,parse:(t,n,e)=>({content:t[1]})},unescapedDollar:{order:w.defaultRules.link.order-.24,match:w.inlineRegex(/^(?!\\)\$/),parse:(t,n,e)=>({})},fence:{...w.defaultRules.fence,parse:(t,n,e)=>{const r=w.defaultRules.fence.parse(t,n,e);return r.lang==="alt"?{type:"codeBlock",lang:"alt",content:n(r.content+`

`,e)}:r}},blockQuote:{...w.defaultRules.blockQuote,match:w.blockRegex(/^ *>[^\n]+(\n( *>)?[^\n]+)*\n{2,}/)},lint:{order:1e3,match:t=>null,parse:(t,n,e)=>({})}};w.parserFor(N);const J={...N,columns:{...N.columns,react:(t,n,e)=>c.jsxs("div",{className:"perseus-two-columns",children:[c.jsx("div",{className:"perseus-column",children:c.jsx("div",{className:"perseus-column-content",children:n(t.col1,e)})}),c.jsx("div",{className:"perseus-column",children:c.jsx("div",{className:"perseus-column-content",children:n(t.col2,e)})})]},e.key)},crowdinId:{...N.crowdinId,react:(t,n,e)=>t.id},table:{...N.table,react:function(t,n,e){const r=w.defaultRules.table.react(t,n,e);return e.isMobile?Y.cloneElement(r,{tabIndex:0}):r}},titledTable:{...N.titledTable,react:(t,n,e)=>{var i;let r;if(!t.table)r="//invalid table//";else if(t.table.type==="lint")((i=t.table.content)==null?void 0:i.type)==="table"?r=J.lint.react({...t.table,content:{...t,table:t.table.content}},n,{...e,unwrapTitledTableContents:!0}):r=J.lint.react(t.table,n,e);else{const a=w.defaultRules.table.react(t.table,n,e),u=c.jsx("caption",{className:"perseus-table-title",children:n(t.title,e)},"caption");r=Y.cloneElement(a,null,[u,...a.props.children])}return e.unwrapTitledTableContents?r:c.jsx("div",{className:"perseus-titled-table",children:r},e.key)}},widget:{...N.widget,react:(t,n,e)=>c.jsx("em",{children:`[Widget: ${t.id}]`},e.key)},blockMath:{...N.blockMath,react:(t,n,e)=>{const{TeX:r}=Q();return c.jsx(r,{children:t.content},e.key)}},math:{...N.math,react:(t,n,e)=>{const{TeX:r}=Q();return c.jsx(r,{children:t.content},e.key)}},unescapedDollar:{...N.unescapedDollar,react:(t,n,e)=>"$"},link:{...N.link,react:function(t,n,e){const r=w.defaultRules.link.react(t,n,e),i=r.props.href;let a=null;(i?i.match(/https?:\/\/[^/]*khanacademy.org|^\//):!1)||(a="noopener noreferrer");const s={...r.props,target:"_blank",href:i,rel:a};return e.baseElements&&e.baseElements.Link?e.baseElements.Link(s):Y.cloneElement(r,s)}},codeBlock:{...N.codeBlock,react:(t,n,e)=>t.lang==="alt"?c.jsx("div",{className:"perseus-markdown-alt perseus-sr-only",children:n(t.content,e)},e.key):w.defaultRules.codeBlock.react(t,n,e)},lint:{...N.lint,react:(t,n,e)=>c.jsx(vn,{message:t.message,ruleName:t.ruleName,inline:rr(t.content),blockHighlight:t.blockHighlight,insideTable:t.insideTable,severity:t.severity,children:n(t.content,e)})}};function rr(t){return!!(t&&t.type&&ir.hasOwnProperty(t.type))}const ir={text:!0,math:!0,unescapedDollar:!0,link:!0,img:!0,strong:!0,u:!0,em:!0,del:!0,code:!0},$e=w.parserFor(J),Je=(t,n)=>{const e=t+`

`;return $e(e,{...n,inline:!1})},ar=(t,n)=>$e(t,{...n,inline:!0}),O=(t,n)=>{p.isArray(t)?p.each(t,e=>O(e,n)):p.isObject(t)&&(n(t),t.type==="table"?(O(t.header,n),O(t.cells,n)):t.type==="list"?O(t.items,n):t.type==="titledTable"?O(t.table,n):t.type==="columns"?(O(t.col1,n),O(t.col2,n)):p.isArray(t.content)&&O(t.content,n))},Pe=t=>{if(p.isArray(t))return p.flatten(p.map(t,Pe));if(t.content&&p.isString(t.content))return t.type.toLowerCase().indexOf("code")!==-1?["",t.content,""]:[t.content.replace(/\s+/g," ")];const n=p.chain(t).values().flatten().filter(r=>r!=null&&p.has(r,"type")).value();if(!n.length)return[];const e=Pe(n);if(t.type==="paragraph"&&e.length){e[0]=e[0].replace(/^\s+/,"");const r=e.length-1;e[r]=e[r].replace(/\s+$/,"")}return e},sr=t=>{const n=Je(t);return Pe(n).join("").length},F={characterCount:sr,traverseContent:O,parse:Je,parseInline:ar,reactFor:w.reactFor,ruleOutput:w.ruleOutput(J,"react"),basicOutput:w.reactFor(w.ruleOutput(J,"react")),sanitizeUrl:w.sanitizeUrl};class Ze extends Y.Component{render(){const n=this.props.className?"paragraph "+this.props.className:"paragraph";return c.jsx("div",{className:this.props.inline?this.props.className??void 0:n,"data-perseus-component-index":this.props.translationIndex,"data-perseus-paragraph-index":this.props.paragraphIndex,children:this.props.children})}}Ze.__docgenInfo={description:"",methods:[],displayName:"QuestionParagraph",props:{className:{required:!1,tsType:{name:"union",raw:"string | null | undefined",elements:[{name:"string"},{name:"null"},{name:"undefined"}]},description:""},translationIndex:{required:!0,tsType:{name:"number"},description:""},paragraphIndex:{required:!1,tsType:{name:"number"},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},inline:{required:!1,tsType:{name:"boolean"},description:""}}};const ur=1e3;class or{constructor(){l(this,"previousContent",null);l(this,"runLinter",rn.debounce((n,e)=>{if(!(typeof KA>"u")&&n!==this.previousContent){if(this.previousContent=n,n===""){e([]);return}fetch("/api/internal/translations/lint_poentry?preview=1&lang=en",{headers:{"Content-Type":"application/json"},body:JSON.stringify({msgid:n,msgstr:n,format:"perseus_text",filename:""}),method:"POST"}).then(r=>r.status>=400?{status:"error",message:"Could not run i18n linter."}:r.json(),r=>({status:"error",message:"Could not run i18n linter."})).then(r=>{r.status==="error"?e(["Some part of this text makes it untranslatable. The specific message from the i18n linter was: "+r.message.replace(/\n/g," ")]):e([])})}},ur))}applyLintErrors(n,e){if(e.length){const r=e.join(`

`);n.unshift({content:{type:"text",content:""},insideTable:!1,message:r,ruleName:"legacy-error",severity:d.Severity.ERROR,type:"lint"})}}}const lr=t=>t.replace(/\{align[*]?\}/g,"{aligned}").replace(/[\u00a0]/g," "),{interactiveSizes:se}=fn,gr=kn,dr=qn,_={SMALL:"small",MEDIUM:"medium",LARGE:"large"},mr=t=>t?t<=gr?_.SMALL:t<=dr?_.MEDIUM:_.LARGE:_.MEDIUM,zr=t=>t===_.SMALL?[se.defaultBoxSizeSmall,se.defaultBoxSizeSmall]:[se.defaultBoxSize,se.defaultBoxSize],pr="",cr=!1,R={},Z={},en=(t,n)=>{R[t]=n},Hr=t=>{t.forEach(n=>{en(n.name,n)})},D=(t,n)=>{const e=R[n];if(!e){const r=`Failed to replace ${t} with ${n}`;throw new j(r,E.Internal)}en(t,e)},Kr=()=>{D("transformer","deprecated-standin"),D("lights-puzzle","deprecated-standin"),D("reaction-diagram","deprecated-standin"),D("sequence","deprecated-standin"),D("simulator","deprecated-standin"),D("unit-input","deprecated-standin")},Qr=t=>{t.forEach(n=>{if(!n.widgetName)throw new j(`Editor ${n.displayName} doesn't have a widgetName property`,E.Internal);Z[n.widgetName]=n})},W=(t,n)=>{const e=Z[n];if(!e&&$){const r=`Failed to replace editor ${t} with ${n}`;$.error(r,E.Internal);return}Z[t]=e},Br=()=>{W("transformer","deprecated-standin"),W("lights-puzzle","deprecated-standin"),W("reaction-diagram","deprecated-standin"),W("sequence","deprecated-standin"),W("simulator","deprecated-standin"),W("unit-input","deprecated-standin")},yr=t=>{var n,e,r;return p.has(R,t)?(n=R[t])!=null&&n.getWidget?(r=(e=R[t]).getWidget)==null?void 0:r.call(e):R[t].widget:null},$r=t=>p.has(Z,t)?Z[t]:null,hr=t=>{if(R[t])return R[t].version||{major:0,minor:0}},Jr=()=>{const t={};return p.each(p.keys(R),function(n){t[n]=hr(n)}),t},Zr=()=>p.pick(R,p.reject(p.keys(R),function(t){return R[t].hidden})),ei=()=>p.keys(R),wr=(t,n,e)=>{const r=t.type,i=R[r];if(i==null)return t;let a;return t.static?a=br(r)||p.identity:a=i.transform||p.identity,a(t.options,n,e)},ni=t=>{const n=R[t];return n&&n.staticTransform!=null},br=t=>{const n=R[t];return n&&n.staticTransform},vr=t=>{const n=R[t];return n&&n.tracking||pr},fr=t=>{const n=R[t];return n&&n.isLintable||cr};class Ne extends Y.Component{constructor(){super(...arguments);l(this,"widgetRef",Y.createRef());l(this,"state",{sizeClass:_.MEDIUM,widgetProps:this.props.initialProps});l(this,"getWidget",()=>this.widgetRef.current);l(this,"replaceWidgetProps",e=>{this.setState({widgetProps:e})})}componentDidMount(){if(this.state.widgetProps.apiOptions.isMobile){const e=ve.findDOMNode(this).offsetWidth;this.setState({sizeClass:mr(e)})}}UNSAFE_componentWillReceiveProps(e){if(this.props.type!==e.type)throw new Error("WidgetContainer can't change widget type; set a different key instead to recreate the container.")}shouldComponentUpdate(e,r){return this.props.shouldHighlight!==e.shouldHighlight||this.props.type!==e.type||this.state.widgetProps!==r.widgetProps||this.state.sizeClass!==r.sizeClass}render(){var k;let e=be({"perseus-widget-container":!0,"widget-highlight":this.props.shouldHighlight,"widget-nohighlight":!this.props.shouldHighlight,"perseus-widget__definition":this.props.type==="definition"});const r=this.props.type,i=navigator.userAgent,a=yr(r);if(a==null)return console.warn(`Widget type '${r}' not found!`),c.jsx("div",{className:e});let u="null";r==="interactive-graph"&&(u=((k=this.state.widgetProps.graph)==null?void 0:k.type)??"null");let s=this.state.widgetProps.alignment;s==="default"&&(s=an(r)),e+=" widget-"+s;const o=this.state.widgetProps.apiOptions,g=this.state.widgetProps.static||o.readOnly,m={position:"relative",overflow:"visible"},y={width:"100%",height:"100%",position:"absolute",top:0,left:0,zIndex:3},b=fr(r)?this.props.linterContext:{...this.props.linterContext,highlightLint:!1};return c.jsx("div",{className:e,style:g?m:{},children:c.jsx(wn.Consumer,{children:({analytics:x})=>c.jsxs(X,{metadata:{widget_type:r,widget_id:this.props.id},onError:h=>{x.onAnalyticsEvent({type:"perseus:widget-rendering-error:ti",payload:{widgetSubType:u,widgetType:r,widgetId:this.props.id,message:h.message,userAgent:i}})},children:[c.jsx(a,{...this.state.widgetProps,linterContext:b,containerSizeClass:this.state.sizeClass,ref:this.widgetRef}),g&&c.jsx("div",{style:y})]})})})}}l(Ne,"defaultProps",{linterContext:De});Ne.__docgenInfo={description:"",methods:[{name:"getWidget",docblock:null,modifiers:[],params:[],returns:null},{name:"replaceWidgetProps",docblock:null,modifiers:[],params:[{name:"newWidgetProps",optional:!1,type:null}],returns:null}],displayName:"WidgetContainer",props:{shouldHighlight:{required:!0,tsType:{name:"boolean"},description:""},type:{required:!0,tsType:{name:"string"},description:""},id:{required:!0,tsType:{name:"string"},description:""},initialProps:{required:!0,tsType:{name:"intersection",raw:"RenderProps & UniversalWidgetProps<Rubric, TrackingExtraArgs>",elements:[{name:"any"},{name:"signature",type:"object",raw:`{
...
}`,computed:!1}}}};const kr=/\S/,qr=/(web\+graphie|https):\/\/[^\s]*/,H=()=>{},Ge=["content","problemNum","widgets"],ue=t=>"container:"+t,xr=function(t,n){return t===null||n===null?t===n:p.every(t,(e,r)=>{if(n!=null)return p.isEqual(e,n[r])})};class Re extends Y.Component{constructor(e){super(e);l(this,"_currentFocus");l(this,"_foundTextNodes");l(this,"_interactionTrackers");l(this,"_isMounted");l(this,"_isTwoColumn");l(this,"_translationLinter");l(this,"_widgetContainers",new Map);l(this,"lastRenderedMarkdown");l(this,"reuseMarkdown");l(this,"translationIndex");l(this,"widgetIds");l(this,"getApiOptions",()=>({...bn.defaults,...this.props.apiOptions}));l(this,"_getInitialWidgetState",e=>{const r=sn(e.widgets);return{widgetInfo:r,widgetProps:this._getAllWidgetsStartProps(r,e)}});l(this,"_getAllWidgetsStartProps",(e,r)=>{var o;const{apiOptions:i,problemNum:a}=r,u={},{strings:s}=this.props;return mn(e).forEach(([g,m])=>{u[g]=wr(m,s,a)}),(o=i==null?void 0:i.onWidgetStartProps)==null||o.call(i,u),u});l(this,"_getDefaultWidgetInfo",e=>{const r=un.rTypeFromWidgetId.exec(e);return r==null?{}:{type:r[1],graded:!0,options:{}}});l(this,"_getWidgetInfo",e=>this.state.widgetInfo[e]||this._getDefaultWidgetInfo(e));l(this,"renderWidget",(e,r,i)=>{const a=this.state.widgetInfo[r];if(a&&a.alignment==="full-width"&&(i.foundFullWidth=!0),a){const u=a&&a.type||e,s=p.contains(this.props.highlightedWidgets,r);return c.jsx(Ne,{id:r,ref:o=>{const g=ue(r);o!=null?this._widgetContainers.set(g,o):this._widgetContainers.delete(g)},type:u,initialProps:this.getWidgetProps(r),shouldHighlight:s,linterContext:vt(this.props.linterContext,"widget")},ue(r))}return null});l(this,"getSerializedState",e=>Ce(e||this.state.widgetProps,(r,i)=>{const a=this.getWidgetInstance(i);return a&&a.getSerializedState?a.getSerializedState():r}));l(this,"restoreSerializedState",(e,r)=>{const i=p.keys(e),a=p.keys(this.state.widgetProps);if(i.length!==a.length||p.intersection(i,a).length!==i.length){$.error("Refusing to restore bad serialized state:",E.Internal,{loggedMetadata:{serializedState:JSON.stringify(e),currentProps:JSON.stringify(this.state.widgetProps)}});return}let u=1;const s=()=>{--u,r&&u===0&&r()};this.setState({widgetProps:Ce(e,(o,g)=>{const m=this.getWidgetInstance(g);if(m&&m.restoreSerializedState){++u;const y=m.restoreSerializedState(o,s);return p.extend({},this.state.widgetProps[g],y)}return o})},()=>{setTimeout(s,0)})});l(this,"showRationalesForCurrentlySelectedChoices",()=>{Object.keys(this.props.widgets).forEach(e=>{const r=this.getWidgetInstance(e);r&&r.showRationalesForCurrentlySelectedChoices&&r.showRationalesForCurrentlySelectedChoices(this._getWidgetInfo(e).options)})});l(this,"deselectIncorrectSelectedChoices",()=>{Object.keys(this.props.widgets).forEach(e=>{const r=this.getWidgetInstance(e);r&&r.deselectIncorrectSelectedChoices&&r.deselectIncorrectSelectedChoices()})});l(this,"findInternalWidgets",e=>{let r;if(typeof e=="string")if(e.indexOf(" ")!==-1){const a=e;r=(u,s,o)=>u===a}else{const a=e;r=(u,s,o)=>s.type===a}else r=e;return this.widgetIds.filter(a=>{const u=this._getWidgetInfo(a),s=this.getWidgetInstance(a);return r(a,u,s)}).map(this.getWidgetInstance)});l(this,"findWidgets",e=>[...this.findInternalWidgets(e),...this.props.findExternalWidgets(e)]);l(this,"getWidgetInstance",e=>{const r=this._widgetContainers.get(ue(e));return r?r.getWidget():null});l(this,"_onWidgetFocus",(e,r=[])=>{if(!p.isArray(r))throw new j("widget props.onFocus focusPath must be an Array, but was"+JSON.stringify(r),E.Internal);this._setCurrentFocus([e].concat(r))});l(this,"_onWidgetBlur",(e,r)=>{const i=this._currentFocus,a=[e].concat(r);p.isEqual(a,i)&&p.defer(()=>{p.isEqual(this._currentFocus,i)&&this._setCurrentFocus(null)})});l(this,"getContent",(e,r)=>r.jiptContent||e.content);l(this,"shouldRenderJiptPlaceholder",(e,r)=>Q().JIPT.useJIPT&&r.jiptContent==null&&e.content.indexOf("crwdns")!==-1);l(this,"replaceJiptContent",(e,r)=>{if(r==null)this.setState({jiptContent:e});else{/^\s*(`{3,}|~{3,})\s*(\S+)?\s*\n([\s\S]+?)\s*\1\s*$/.test(e)||(/\S\n\s*\n\S/.test(e)?e="$\\large{\\red{\\text{Please translate each paragraph to a single paragraph.}}}$":/^\s*$/.test(e)&&(e="$\\large{\\red{\\text{Translated paragraph is currently empty}}}$"));const a=this.getContent(this.props,this.state),u=Me.parseToArray(a);u[r]=e,this.setState({jiptContent:Me.joinFromArray(u)})}});l(this,"outputMarkdown",(e,r)=>{if(p.isArray(e)){const u=r.key,s=[];let o=!1;for(let g=0;g<e.length;g++){r.key=g,r.paragraphIndex=g;const m=this.outputMarkdown(e[g],r),y=typeof m=="string";typeof m=="string"&&o?s[s.length-1]+=m:s.push(m),o=y}return r.key=u,s}this._foundTextNodes=!1,r.foundFullWidth=!1;const i=this.outputNested(e,r);let a;return this.translationIndex!=null?a=null:a=be({"perseus-paragraph-centered":!this._foundTextNodes,"perseus-paragraph-full-width":r.foundFullWidth&&e.content.length===1}),c.jsx(Ze,{className:a,translationIndex:this.translationIndex,paragraphIndex:r.paragraphIndex,inline:this.props.inline,children:c.jsx(X,{children:i})},r.key)});l(this,"outputNested",(e,r)=>{if(p.isArray(e)){const i=r.key,a=[];let u=!1;for(let s=0;s<e.length;s++){r.key=s;const o=this.outputNested(e[s],r),g=typeof o=="string";typeof o=="string"&&u?a[a.length-1]+=o:a.push(o),u=g}return r.key=i,a}return this.outputNode(e,this.outputNested,r)});l(this,"outputNode",(e,r,i)=>{const a=this.getApiOptions(),u=a.imagePlaceholder;if(e.type==="widget"){const s=a.widgetPlaceholder;return s||(this._foundTextNodes=!0,this.widgetIds.includes(e.id)?c.jsx("span",{className:"renderer-widget-error",children:["Widget [[","☃"," ",e.id,"]] already exists."].join("")},i.key):(this.widgetIds.push(e.id),this.renderWidget(e.widgetType,e.id,i)))}if(e.type==="blockMath"){const s=lr(e.content),o={overflowX:"auto",overflowY:"hidden",paddingTop:10,paddingBottom:10,marginTop:-10,marginBottom:-10};if(a.isMobile){const m={marginLeft:-16,marginRight:-16},y={paddingLeft:16,paddingRight:16},b={...o,...Fe.mobileZoomableParentFix};return c.jsx("div",{className:"perseus-block-math",style:m,children:c.jsx(X,{children:c.jsx("div",{className:"perseus-block-math-inner",style:{...b,...y},children:c.jsx(pn,{children:s})})})},i.key)}return c.jsx("div",{className:"perseus-block-math",children:c.jsx(X,{children:c.jsx("div",{className:"perseus-block-math-inner",style:o,children:c.jsx(ce.Consumer,{children:({setAssetStatus:g})=>c.jsx(Ee,{setAssetStatus:g,children:s})})})})},i.key)}if(e.type==="math"){const s=e.content;return c.jsx("span",{style:{whiteSpace:"nowrap"},children:c.jsxs(X,{children:[c.jsx("span",{}),c.jsx(ce.Consumer,{children:({setAssetStatus:o})=>c.jsx(Ee,{onRender:this.props.onRender,setAssetStatus:o,children:s})}),c.jsx("span",{})]})},i.key)}if(e.type==="image"){if(u)return u;const s=p.has(this.props.images,e.target)?this.props.images[e.target]:null,o=!i.inTable;return c.jsx(X,{children:c.jsx(ce.Consumer,{children:({setAssetStatus:g})=>c.jsx(yn,{setAssetStatus:g,src:F.sanitizeUrl(e.target),alt:e.alt,title:e.title,responsive:o,onUpdate:this.props.onRender,zoomToFullSizeOnMobile:a.isMobile&&a.isArticle,...s})})},i.key)}if(e.type==="columns")return this._isTwoColumn=!0,c.jsx(X,{children:F.ruleOutput(e,r,i)},i.key);if(e.type==="text")return kr.test(e.content)&&(this._foundTextNodes=!0),u&&qr.test(e.content)?u:e.content;if(e.type==="table"||e.type==="titledTable"){const s=F.ruleOutput(e,r,{...i,isMobile:a.isMobile,inTable:!0});if(!a.isMobile)return s;const o={marginLeft:-16,marginRight:-16},m={...{paddingLeft:0,paddingRight:0},...Fe.mobileZoomableParentFix},y=c.jsx("div",{style:{...m,overflowX:"auto"},children:c.jsx(X,{children:c.jsx(hn,{animateHeight:!0,children:s})})});return c.jsx("div",{style:o,children:y})}return c.jsx(X,{children:F.ruleOutput(e,r,i)},i.key)});l(this,"handleRender",e=>{const r=this.props.onRender,i=e.onRender;if(r!==H||i!==H){const a=dn(ve.findDOMNode(this)).find("img");i!==H&&a.off("load",i),r!==H&&a.on("load",r)}r()});l(this,"_setCurrentFocus",e=>{const r=this.getApiOptions();if(!xr(e,this._currentFocus)){const i=this._currentFocus;i&&this.blurPath(i),this._currentFocus=e,r.onFocusChange(this._currentFocus,i)}});l(this,"focus",()=>{var i;let e,r;for(let a=0;a<this.widgetIds.length;a++){const u=this.widgetIds[a],s=this.getWidgetInstance(u),o=(i=s==null?void 0:s.focus)==null?void 0:i.call(s);if(o){e=u,r=o;break}}if(e){let a;return typeof r=="object"?(a=[e].concat(r.path||[]),$.error("Renderer received a focus result of type 'object' instead of the expected type 'boolean'",E.Internal,{loggedMetadata:{focusResult:JSON.stringify(r),currentProps:JSON.stringify(this.state.widgetProps)}})):a=[e],this._setCurrentFocus(a),!0}});l(this,"getDOMNodeForPath",e=>{const r=p.first(e),i=p.rest(e),a=this.getWidgetInstance(r);if(a!=null&&a.getDOMNodeForPath)return a.getDOMNodeForPath(i);if(i.length===0)return ve.findDOMNode(a)});l(this,"getInputPaths",()=>{const e=[];return this.widgetIds.forEach(r=>{const i=this.getWidgetInstance(r);i&&i.getInputPaths&&i.getInputPaths().forEach(u=>{const s=[r].concat(u);e.push(s)})}),e});l(this,"focusPath",e=>{var u;if(p.isEqual(this._currentFocus,e))return;this._currentFocus&&this.blurPath(this._currentFocus);const r=p.first(e),i=p.rest(e),a=this.getWidgetInstance(r);(u=a==null?void 0:a.focusInputPath)==null||u.call(a,i)});l(this,"blurPath",e=>{var u;if(!p.isEqual(this._currentFocus,e))return;const r=p.first(e),i=p.rest(e);if(this.getWidgetInstance(r)){const s=this.getWidgetInstance(r);(u=s==null?void 0:s.blurInputPath)==null||u.call(s,i)}});l(this,"blur",()=>{this._currentFocus&&this.blurPath(this._currentFocus)});l(this,"serialize",()=>{const e={};return p.each(this.state.widgetInfo,function(r,i){const u=this.getWidgetInstance(i).serialize();p.isEmpty(u)||(e[i]=u)},this),e});l(this,"_setWidgetProps",(e,r,i,a)=>{this.setState(u=>{const s={...u.widgetProps,[e]:{...u.widgetProps[e],...r}},o=a?u.lastUsedWidgetId:e;return a||this.props.onSerializedStateUpdated(this.getSerializedState(s)),{lastUsedWidgetId:o,widgetProps:s}},()=>{setTimeout(()=>{const u=i&&i();a||this.props.onInteractWithWidget(e),u!==!1&&this._setCurrentFocus([e])},0)})});l(this,"setInputValue",(e,r,i)=>{var o;const a=p.first(e),u=p.rest(e),s=this.getWidgetInstance(a);(o=s==null?void 0:s.setInputValue)==null||o.call(s,u,r,i)});l(this,"getWidgetIds",()=>this.widgetIds);l(this,"handletranslationLintErrors",e=>{this._isMounted&&this.setState({translationLintErrors:e})});this._translationLinter=new or,this.state={jiptContent:null,translationLintErrors:[],lastUsedWidgetId:null,...this._getInitialWidgetState(e)}}componentDidMount(){this._isMounted=!0,this.handleRender({}),this._currentFocus=null,this.props.serializedState&&this.restoreSerializedState(this.props.serializedState),this.props.linterContext.highlightLint&&this._translationLinter.runLinter(this.props.content,this.handletranslationLintErrors)}UNSAFE_componentWillReceiveProps(e){p.isEqual(p.pick(this.props,Ge),p.pick(e,Ge))||this.setState(this._getInitialWidgetState(e))}shouldComponentUpdate(e,r){if(this.props.alwaysUpdate)return!0;const i=!p.isEqual(this.state,r);return!p.isEqual(this.props,e)||i}UNSAFE_componentWillUpdate(e,r){const i=this.shouldRenderJiptPlaceholder(this.props,this.state),a=this.shouldRenderJiptPlaceholder(e,r),u=this.getContent(this.props,this.state),s=this.getContent(e,r),o=this.props.highlightedWidgets,g=e.highlightedWidgets;this.reuseMarkdown=!i&&!a&&u===s&&p.isEqual(this.state.translationLintErrors,r.translationLintErrors)&&(!this.props.linterContext.highlightLint||p.isEqual(this.props.widgets,e.widgets))&&this.props.linterContext.highlightLint===e.linterContext.highlightLint&&o===g}componentDidUpdate(e,r){this.handleRender(e),this.widgetIds.forEach(i=>{const a=this._widgetContainers.get(ue(i));a==null||a.replaceWidgetProps(this.getWidgetProps(i))}),this.props.serializedState&&!p.isEqual(this.props.serializedState,this.getSerializedState())&&this.restoreSerializedState(this.props.serializedState),this.props.linterContext.highlightLint&&this._translationLinter.runLinter(this.props.content,this.handletranslationLintErrors)}componentWillUnmount(){this.widgetIds=[],this.translationIndex!=null&&Q().rendererTranslationComponents.removeComponentAtIndex(this.translationIndex),this._isMounted=!1}getWidgetProps(e){const r=this.getApiOptions(),i=this.state.widgetProps[e]||{},a=this.state.widgetInfo[e],u=this.props.reviewMode&&a?a.options:null;this._interactionTrackers||(this._interactionTrackers={});let s=this._interactionTrackers[e];return s||(s=this._interactionTrackers[e]=new qt(r.trackInteraction,a&&a.type,e,vr(a&&a.type))),{...i,widgetId:e,alignment:a&&a.alignment,static:a==null?void 0:a.static,problemNum:this.props.problemNum,apiOptions:this.getApiOptions(),keypadElement:this.props.keypadElement,questionCompleted:this.props.questionCompleted,showSolutions:this.props.showSolutions,onFocus:p.partial(this._onWidgetFocus,e),onBlur:p.partial(this._onWidgetBlur,e),findWidgets:this.findWidgets,reviewModeRubric:u,reviewMode:this.props.reviewMode,onChange:(o,g,m=!1)=>{this._setWidgetProps(e,o,g,m)},trackInteraction:s.track,isLastUsedWidget:e===this.state.lastUsedWidgetId}}emptyWidgets(){return on(this.state.widgetInfo,this.widgetIds,this.getUserInputMap(),this.context.locale)}getUserInput(){return this.widgetIds.map(e=>{const r=this.getWidgetInstance(e);if(r&&r.getUserInput)return r.getUserInput()})}getUserInputMap(){const e={};return this.widgetIds.forEach(r=>{const i=this.getWidgetInstance(r);i!=null&&i.getUserInputMap?e[r]=i.getUserInputMap():i!=null&&i.getUserInput&&(e[r]=i.getUserInput())}),e}getPromptJSON(){const{content:e}=this.props,r={};return this.widgetIds.forEach(i=>{var u;const a=this.getWidgetInstance(i);r[i]=((u=a==null?void 0:a.getPromptJSON)==null?void 0:u.call(a))||{}}),{content:e,widgets:r}}score(){const e=ln(this.state.widgetInfo,this.widgetIds,this.getUserInputMap(),this.context.locale);return gn(e)}render(){const e=this.getApiOptions();if(this.reuseMarkdown)return this.lastRenderedMarkdown;const r=this.getContent(this.props,this.state);if(this.widgetIds=[],this.shouldRenderJiptPlaceholder(this.props,this.state)&&(this.translationIndex||(this.translationIndex=Q().rendererTranslationComponents.addComponent(this)),!e.isArticle))return c.jsx(fe,{children:c.jsx("div",{"data-perseus-component-index":this.translationIndex,children:r})});this._isTwoColumn=!1;const i=this.props.inline?F.parseInline(r,{isJipt:this.translationIndex!=null}):F.parse(r,{isJipt:this.translationIndex!=null});if(this.props.linterContext.highlightLint){const s={content:this.props.content,widgets:this.props.widgets,...this.props.linterContext};bt(i,s),this._translationLinter.applyLintErrors(i,[...this.state.translationLintErrors,...this.props.legacyPerseusLint||[]])}const a=this.outputMarkdown(i,{baseElements:e.baseElements}),u=be({[ye.RENDERER]:!0,[ye.RESPONSIVE_RENDERER]:!0,[ye.TWO_COLUMN_RENDERER]:this._isTwoColumn});return this.lastRenderedMarkdown=c.jsx(fe,{children:c.jsx("div",{className:u,children:a})}),this.lastRenderedMarkdown}}l(Re,"contextType",cn),l(Re,"defaultProps",{content:"",widgets:{},images:{},highlightedWidgets:[],questionCompleted:!1,showSolutions:"none",onRender:H,onInteractWithWidget:function(){},findExternalWidgets:()=>[],alwaysUpdate:!1,reviewMode:!1,serializedState:null,onSerializedStateUpdated:()=>{},linterContext:De});const Fe={mobileZoomableParentFix:{transform:"translate3d(0,0,0)"}};Re.__docgenInfo={description:"",methods:[{name:"getApiOptions",docblock:null,modifiers:[],params:[],returns:null},{name:"_getInitialWidgetState",docblock:null,modifiers:[],params:[{name:"props",optional:!1,type:{name:"intersection",raw:`Partial<React.ContextType<typeof DependenciesContext>> & {
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{Vr as D,Me as J,F as P,Re as R,w as S,Kr as a,Qr as b,Br as c,$r as d,Zr as e,ei as f,Jr as g,hr as h,lr as i,_ as j,zr as k,De as l,N as m,vt as p,Hr as r,ni as s};
