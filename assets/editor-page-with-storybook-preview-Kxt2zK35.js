import{j as r}from"./jsx-runtime-63Ea5SlK.js";import"./article-renderer-h_m-tvVP.js";import"./jquery-yG1GhClm.js";import"./util-AYeX86gl.js";import"./phet-simulation-_7qOO4_B.js";import"./version-akiLXZts.js";import"./dependencies-CP7Uh8Kq.js";import"./perseus-api-1-ethIrW.js";import"./perseus-item-334dAsMX.js";import"./hints-renderer-Ebeftjch.js";import{R as g}from"./renderer-yXFj-6ty.js";import"./base-radio-XsQBfrsT.js";import"./button-group-G5CZaedn.js";import"./graph-4ZDD3NK_.js";import"./svg-image-FcZanvM1.js";import"./hud-ifw9Ofbw.js";import"./icon-7RFbyLiL.js";import"./index-BIPwuHvF.js";import"./inline-icon-6fh0Wu1y.js";import"./math-input-ILg8RrvB.js";import"./multi-button-group-QUVHbBcE.js";import"./number-input-ogh82yD8.js";import"./range-input-w5Z3sPK5.js";import"./text-input-e6f7u9S5.js";import"./text-list-editor-aj1SAzcA.js";import"./index-k-0mNqHS.js";import{m as h}from"./i18n-context-fsWEgybQ.js";import"./index-smZ6iCr_.js";import{B as R}from"./choice-Xr-SKHrB.js";import{V as o}from"./index-0DbkllkJ.js";import{I as A}from"./locked-label-settings-6ht0io0O.js";import{S as O}from"./index-nqMmpXbO.js";import{c as p,s as t}from"./index-deFLJwr4.js";import{L as j}from"./index-18qWGOW7.js";import{x as W}from"./index-f-3iKkZU.js";import{a as x}from"./chunk-D5ZWXAHU-vR62DWf0.js";import{l as z}from"./index-awljIyHI.js";import{r as n}from"./index-6oxdNXpR.js";import{E as I}from"./editor-page-lRZ_qmez.js";import{f as C}from"./flags-for-api-options-buw2ikR-.js";const N=x("onChange");function E(l){const[c,b]=n.useState("phone"),[v,w]=n.useState(!1),[f,k]=n.useState(),[d,q]=n.useState(l.question),[i,T]=n.useState(l.hints),[s,y]=n.useState(!0),u=l.apiOptions??{isMobile:!1,flags:C};return r.jsxs(o,{children:[r.jsx(I,{apiOptions:u,previewDevice:c,onPreviewDeviceChange:e=>b(e),developerMode:!0,jsonMode:v,answerArea:f,question:d,hints:i,frameSource:"about:blank",previewURL:"about:blank",itemId:"1",onChange:e=>{N(e),"jsonMode"in e&&w(e.jsonMode),"answerArea"in e&&k(e.answerArea),"question"in e&&q(e.question),"hints"in e&&T(e.hints)}}),!s&&r.jsx(R,{onClick:()=>y(!s),style:a.openPanelButton,children:"Open preview (storybook only)"}),s&&r.jsxs(o,{style:a.panel,children:[r.jsx(A,{icon:W,onClick:()=>y(!s),style:a.closeButton}),r.jsx(o,{style:a.panelInner,children:r.jsx(g,{strings:h,apiOptions:u,...d})}),i==null?void 0:i.map((e,m)=>r.jsxs(o,{style:a.panelInner,children:[r.jsx(O,{size:t.medium_16}),r.jsx(j,{children:`Hint ${m+1}`}),r.jsx(g,{strings:h,apiOptions:u,...e})]},m))]})]})}const a=z.StyleSheet.create({panel:{position:"fixed",right:0,minWidth:500,height:"90vh",overflow:"auto",flex:"none",backgroundColor:p.fadedBlue16,padding:t.medium_16,borderRadius:t.small_12,alignItems:"end"},panelInner:{flex:"none",backgroundColor:p.white,borderRadius:t.xSmall_8,marginTop:t.medium_16,width:"100%",padding:t.xSmall_8},closeButton:{margin:0},openPanelButton:{position:"fixed",right:t.medium_16,bottom:t.xxxLarge_64}});E.__docgenInfo={description:"",methods:[],displayName:"EditorPageWithStorybookPreview",props:{apiOptions:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
