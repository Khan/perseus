import{j as e,Z as n,r as f}from"./iframe-CvGQi9qb.js";import{S}from"./select-image-Dq9gJufW.js";import"./changeable-B_DQ3EPK.js";import"./article-renderer-DZLC-LFO.js";import"./server-item-renderer-C6vuhUwR.js";import"./hints-renderer-C1LnFr0S.js";import"./form-wrapped-text-field-DDPA_S32.js";import"./global-colors-DSS4FaUr.js";const N={title:"Widgets/Label Image/Widget Internal Components/Select Image"},x=n.StyleSheet.create({wrapper:{width:338}}),I=r=>e.jsx("div",{className:n.css(x.wrapper),children:e.jsx(S,{...r})}),j=()=>{const[r,s]=f.useState("");return e.jsx("div",{className:n.css(x.wrapper),children:e.jsx(S,{onChange:y=>s(y),url:r})})},t=r=>{const s={url:"",onChange:()=>{}};return e.jsx(I,{...s})},a=r=>{const s={url:"https://ka-perseus-images.s3.amazonaws.com/2ee5fc32e35c5178373b39fd304b325b2994c913.png",onChange:()=>{}};return e.jsx(I,{...s})},o=r=>e.jsx(j,{});t.__docgenInfo={description:"",methods:[],displayName:"Empty"};a.__docgenInfo={description:"",methods:[],displayName:"Filled"};o.__docgenInfo={description:"",methods:[],displayName:"Interactive"};var c,p,m;t.parameters={...t.parameters,docs:{...(c=t.parameters)==null?void 0:c.docs,source:{originalSource:`(args: StoryArgs): React.ReactElement => {
  const props = {
    url: "",
    onChange: () => {}
  } as const;
