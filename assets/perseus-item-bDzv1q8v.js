...
}`,computed:!1},required:!1},onRendered:{defaultValue:{value:"(isRendered: boolean) => {}",computed:!1},required:!1}}};We.__docgenInfo={description:"",methods:[],displayName:"ref"};function ae(t){return{type:"success",value:t}}function K(t){return{type:"failure",detail:t}}function q(t){return t.type==="failure"}function M(t){return t.type==="success"}function Fe(t,r=s=>s){const s=[],m=[];for(const d of t)d.type==="success"?s.push(d.value):m.push(d.detail);return m.length>0?K(m.reduce(r)):ae(s)}const O=(t,r)=>r.success(t);function l(t){return(r,s)=>{if(!Array.isArray(r))return s.failure("array",r);const m=r.map((d,g)=>t(d,s.forSubtree(g)));return Fe(m,Le)}}function Le(t,r){return[...t,...r]}function i(t,r){return typeof t=="boolean"?r.success(t):r.failure("boolean",t)}function u(t){return(r,s)=>r!==t?s.failure(String(JSON.stringify(t)),r):s.success(t)}function w(...t){return(r,s)=>{if(typeof r=="string"){const d=t.indexOf(r);if(d>-1)return s.success(t[d])}const m=t.map(d=>JSON.stringify(d));return s.failure(m,r)}}function B(t){return t!=null&&Object.getPrototypeOf(t)===Object.prototype}function b(t){return(r,s)=>r===null?s.success(r):t(r,s)}const o=(t,r)=>typeof t=="number"?r.success(t):r.failure("number",t);function a(t){return(r,s)=>{if(!B(r))return s.failure("object",r);const m={...r},d=[];for(const[g,y]of Object.entries(t)){const c=y(r[g],s.forSubtree(g));M(c)?m[g]=c.value:d.push(...c.detail)}return d.length>0?K(d):s.success(m)}}function e(t){return(r,s)=>r===void 0?s.success(r):t(r,s)}function f(t,r){return(s,m)=>{if(!Array.isArray(s))return m.failure("array",s);if(s.length!==2)return m.failure("array of length 2",s);const[d,g]=s,y=t(d,m.forSubtree(0));if(q(y))return y;const c=r(g,m.forSubtree(1));return q(c)?c:m.success([y.value,c.value])}}function W(t){return new X(t)}class X{constructor(r){this.parser=r}then(r){return new X(Me(this.parser,r))}}function Me(t,r){return(s,m)=>{const d=t(s,m);return q(d)?d:r(d.value,m)}}function Y(t,r){return(s,m)=>{if(!B(s))return m.failure("object",s);const d={},g=[];for(const[y,c]of Object.entries(s)){const C=m.forSubtree(y),T=t(y,C);q(T)&&g.push(...T.detail);const P=r(c,C);q(P)&&g.push(...P.detail),M(T)&&M(P)&&(d[T.value]=P.value)}return g.length>0?K(g):m.success(d)}}const n=(t,r)=>typeof t=="string"?r.success(t):r.failure("string",t);function G(t,r,s){return(m,d)=>{if(!Array.isArray(m))return d.failure("array",m);if(m.length!==3)return d.failure("array of length 3",m);const g=t(m[0],d.forSubtree(0));if(q(g))return g;const y=r(m[1],d.forSubtree(1));if(q(y))return y;const c=s(m[2],d.forSubtree(2));return q(c)?c:d.success([g.value,y.value,c.value])}}function v(t){return new Q(t)}class Q{constructor(r){this.parser=r}or(r){return new Q(Ge(this.parser,r))}}function Ge(t,r){return(s,m)=>{const d=t(s,m);return M(d)?d:r(s,m)}}function k(t,r){return(s,m)=>s==null?ae(r(s)):t(s,m)}const se=k(Y(n,a({width:o,height:o})),()=>({}));function h(t,r){return a({type:t,static:e(i),graded:e(i),alignment:e(n),options:r,key:e(o),version:e(a({major:o,minor:o}))})}function oe(t,r,s){return a({type:r,static:e(i),graded:e(i),alignment:e(n),options:s,key:e(o),version:t})}const De=h(u("categorizer"),a({items:l(n),categories:l(n),randomizeItems:i,static:k(i,()=>!1),values:l(o),highlightLint:e(i),linterContext:e(a({contentType:n,paths:l(n),stack:l(n)}))})),Ee=h(u("cs-program"),a({programID:n,programType:O,settings:l(a({name:n,value:n})),showEditor:i,showButtons:i,width:o,height:o,static:i})),Ue=h(u("definition"),a({togglePrompt:n,definition:n,static:k(i,()=>!1)})),Ve=h(u("dropdown"),a({placeholder:n,ariaLabel:e(n),visibleLabel:e(n),static:k(i,()=>!1),choices:l(a({content:n,correct:i}))})),$e=h(u("explanation"),a({showPrompt:n,hidePrompt:n,explanation:n,widgets:(t,r)=>F(t,r),static:i})),Je=a({value:n,form:i,simplify:i,considered:w("correct","wrong","ungraded"),key:W(e(v(n).or(o).parser)).then((t,r)=>r.success(String(t))).parser}),_e=oe(a({major:u(1),minor:o}),u("expression"),a({answerForms:l(Je),functions:l(n),times:i,visibleLabel:e(n),ariaLabel:e(n),buttonSets:l(w("basic","basic+div","trig","prealgebra","logarithms","basic relations","advanced relations")),buttonsVisible:e(w("always","never","focused"))})),ze=oe(e(a({major:u(0),minor:o})),u("expression"),a({functions:l(n),times:i,visibleLabel:e(n),ariaLabel:e(n),form:i,simplify:i,value:n,buttonSets:l(w("basic","basic+div","trig","prealgebra","logarithms","basic relations","advanced relations")),buttonsVisible:e(w("always","never","focused"))}));function He(t,r){const{options:s}=t;return r.success({...t,version:{major:1,minor:0},options:{times:s.times,buttonSets:s.buttonSets,functions:s.functions,buttonsVisible:s.buttonsVisible,visibleLabel:s.visibleLabel,ariaLabel:s.ariaLabel,answerForms:[{considered:"correct",form:s.form,simplify:s.simplify,value:s.value}]}})}const Ke=v(_e).or(W(ze).then(He).parser).parser,E=k(a({content:k(n,()=>""),widgets:k((t,r)=>F(t,r),()=>({})),metadata:e(l(n)),images:se}),()=>({content:"",widgets:{},images:{}})),ie=a({title:k(n,()=>""),hasHint:e(b(i)),hint:e(b((t,r)=>E(t,r))),content:n,widgets:(t,r)=>F(t,r),widgetEnabled:e(b(i)),immutableWidgets:e(b(i)),images:Y(n,a({width:o,height:o}))}),Be=h(u("graded-group"),ie),Xe=h(u("graded-group-set"),a({gradedGroups:l(ie)})),x=f(o,o),R=f(x,x),Ye=h(u("grapher"),a({availableTypes:l(w("absolute_value","exponential","linear","logarithm","quadratic","sinusoid","tangent")),correct:v(a({type:u("absolute_value"),coords:R})).or(a({type:u("exponential"),asymptote:R,coords:R})).or(a({type:u("linear"),coords:R})).or(a({type:u("logarithm"),asymptote:R,coords:R})).or(a({type:u("quadratic"),coords:R})).or(a({type:u("sinusoid"),coords:R})).or(a({type:u("tangent"),coords:R})).parser,graph:a({backgroundImage:a({bottom:e(o),height:e(o),left:e(o),scale:e(o),url:e(b(n)),width:e(o)}),box:e(x),editableSettings:e(l(w("graph","snap","image","measure"))),gridStep:e(x),labels:f(n,n),markings:w("graph","none","grid"),range:f(x,x),rulerLabel:u(""),rulerTicks:o,showProtractor:e(i),showRuler:e(i),showTooltips:e(i),snapStep:e(x),step:x,valid:e(v(i).or(n).parser)})})),Qe=h(u("group"),(t,r)=>E(t,r)),Ze=h(u("iframe"),a({url:n,settings:l(a({name:n,value:n})),width:v(o).or(n).parser,height:v(o).or(n).parser,allowFullScreen:i,allowTopNavigation:e(i),static:k(i,()=>!1)})),en=(t,r)=>{if(typeof t=="number")return r.success(t);const s=+t;return t===""||isNaN(s)?r.failure("a number or numeric string",t):r.success(s)},j=W(v(o).or(n).parser).then(en).parser,U=a({url:e(b(n)),width:e(j),height:e(j),top:e(j),left:e(j),bottom:e(j),scale:e(j)}),J=f(o,o),nn=h(u("image"),a({title:e(n),caption:e(n),alt:e(n),backgroundImage:U,static:e(i),labels:e(l(a({content:n,alignment:n,coordinates:l(o)}))),range:e(f(J,J)),box:e(J)})),rn=(t,r)=>typeof t=="boolean"?r.success(String(t)):r.failure("boolean",t),tn=h(u("input-number"),a({answerType:e(w("number","decimal","integer","rational","improper","mixed","percent","pi")),inexact:e(i),maxError:e(v(o).or(n).parser),rightAlign:e(i),simplify:w("required","optional","enforced"),size:w("normal","small"),value:v(o).or(n).or(rn).parser,customKeypad:e(i)})),N=f(o,o),an=a({type:u("function"),key:n,options:a({value:n,funcName:n,rangeMin:n,rangeMax:n,color:n,strokeDasharray:n,strokeWidth:o})}),sn=a({type:u("label"),key:n,options:a({label:n,color:n,coordX:n,coordY:n})}),on=a({type:u("line"),key:n,options:a({color:n,startX:n,startY:n,endX:n,endY:n,strokeDasharray:n,strokeWidth:o,arrows:n})}),un=a({type:u("movable-line"),key:n,options:a({startX:n,startY:n,startSubscript:o,endX:n,endY:n,endSubscript:o,constraint:n,snap:o,constraintFn:n,constraintXMin:n,constraintXMax:n,constraintYMin:n,constraintYMax:n})}),ln=a({type:u("movable-point"),key:n,options:a({startX:n,startY:n,varSubscript:o,constraint:n,snap:o,constraintFn:n,constraintXMin:n,constraintXMax:n,constraintYMin:n,constraintYMax:n})}),mn=a({type:u("parametric"),key:n,options:a({x:n,y:n,rangeMin:n,rangeMax:n,color:n,strokeDasharray:n,strokeWidth:o})}),dn=a({type:u("point"),key:n,options:a({color:n,coordX:n,coordY:n})}),pn=a({type:u("rectangle"),key:n,options:a({color:n,coordX:n,coordY:n,width:n,height:n})}),cn=h(u("interaction"),a({static:i,graph:a({editableSettings:e(l(w("canvas","graph"))),box:N,labels:l(n),range:f(N,N),gridStep:N,markings:w("graph","grid","none"),snapStep:e(N),valid:e(v(i).or(n).parser),backgroundImage:e(U),showProtractor:e(i),showRuler:e(i),rulerLabel:e(n),rulerTicks:e(o),tickStep:N}),elements:l(v(an).or(sn).or(on).or(un).or(ln).or(mn).or(dn).or(pn).parser)})),p=f(o,o),ee=a({type:u("angle"),showAngles:e(i),allowReflexAngles:e(i),angleOffsetDeg:e(o),snapDegrees:e(o),match:e(u("congruent")),coords:e(G(p,p,p)),startCoords:e(G(p,p,p))}),yn=a({type:u("circle"),center:e(p),radius:e(o),startCoords:e(a({center:p,radius:o})),coord:e(p)}),gn=a({type:u("linear"),coords:e(b(f(p,p))),startCoords:e(f(p,p)),coord:e(p)}),hn=a({type:u("linear-system"),coords:e(b(l(f(p,p)))),startCoords:e(l(f(p,p))),coord:e(p)}),wn=a({type:u("none")}),bn=a({type:u("point"),numPoints:e(v(o).or(u("unlimited")).parser),coords:e(b(l(p))),startCoords:e(l(p)),coord:e(p)}),fn=a({type:u("polygon"),numSides:e(v(o).or(u("unlimited")).parser),showAngles:e(i),showSides:e(i),snapTo:e(w("grid","angles","sides")),match:e(w("similar","congruent","approx")),startCoords:e(l(p)),coord:e(p)}),kn=a({type:u("quadratic"),coords:e(b(G(p,p,p))),startCoords:e(G(p,p,p)),coord:e(p)}),vn=a({type:u("ray"),coords:e(b(f(p,p))),startCoords:e(f(p,p)),coord:e(p)}),qn=a({type:u("segment"),numSegments:e(o),coords:e(b(l(f(p,p)))),startCoords:e(l(f(p,p))),coord:e(p)}),Cn=a({type:u("sinusoid"),coords:e(b(l(p))),startCoords:e(l(p)),coord:e(p)}),ne=v(ee).or(ee).or(yn).or(gn).or(hn).or(wn).or(bn).or(fn).or(kn).or(vn).or(qn).or(Cn).parser,I=w(...de),ue=w("none","white","translucent","solid"),V=w("solid","dashed"),S=a({type:u("label"),coord:p,text:n,color:I,size:w("small","medium","large")}),z=a({type:u("point"),coord:p,color:I,filled:i,labels:e(l(S)),ariaLabel:e(n)}),Rn=a({type:u("line"),kind:w("line","ray","segment"),points:f(z,z),color:I,lineStyle:V,showPoint1:i,showPoint2:i,labels:e(l(S)),ariaLabel:e(n)}),An=a({type:u("vector"),points:f(p,p),color:I,labels:e(l(S)),ariaLabel:e(n)}),Tn=a({type:u("ellipse"),center:p,radius:p,angle:o,color:I,fillStyle:ue,strokeStyle:V,labels:e(l(S)),ariaLabel:e(n)}),Pn=a({type:u("polygon"),points:l(p),color:I,showVertices:i,fillStyle:ue,strokeStyle:V,labels:e(l(S)),ariaLabel:e(n)}),xn=a({type:u("function"),color:I,strokeStyle:V,equation:n,directionalAxis:w("x","y"),domain:e(p),labels:e(l(S)),ariaLabel:e(n)}),In=v(z).or(Rn).or(An).or(Tn).or(Pn).or(xn).or(S).parser,Sn=h(u("interactive-graph"),a({step:p,gridStep:e(p),snapStep:e(p),backgroundImage:e(U),markings:w("graph","grid","none"),labels:e(l(n)),showProtractor:i,showRuler:e(i),showTooltips:e(i),rulerLabel:e(n),rulerTicks:e(o),range:f(p,p),graph:k(ne,()=>({type:"linear"})),correct:ne,lockedFigures:e(l(In)),fullGraphLabel:e(n),fullGraphAriaDescription:e(n)})),jn=h(u("label-image"),a({choices:l(n),imageUrl:n,imageAlt:n,imageHeight:o,imageWidth:o,markers:l(a({answers:l(n),label:n,x:o,y:o})),hideChoicesFromInstructions:i,multipleAnswers:i,static:i})),Nn=h(u("matcher"),a({labels:l(n),left:l(n),right:l(n),orderMatters:i,padding:i})),On=h(k(u("matrix"),()=>"matrix"),a({prefix:e(n),suffix:e(n),answers:l(l(o)),cursorPosition:e(l(o)),matrixBoardSize:l(o),static:e(i)})),Wn=h(u("measurer"),a({image:U,showProtractor:i,showRuler:i,rulerLabel:n,rulerTicks:o,rulerPixels:o,rulerLength:o,box:f(o,o),static:i})),Fn=h(u("molecule-renderer"),a({widgetId:n,rotationAngle:e(o),smiles:e(n)})),Ln=h(u("number-line"),a({range:l(o),labelRange:l(b(o)),labelStyle:n,labelTicks:i,isTickCtrl:e(b(i)),divisionRange:l(o),numDivisions:e(b(o)),snapDivisions:k(o,()=>2),tickStep:e(b(o)),correctRel:e(b(n)),correctX:o,initialX:e(b(o)),showTooltip:e(i),static:i})),re=w("integer","mixed","improper","proper","decimal","percent","pi"),Mn=h(u("numeric-input"),a({answers:l(a({message:n,value:e(o),status:n,answerForms:e(l(re)),strict:i,maxError:e(b(o)),simplify:e(b(n))})),labelText:e(n),size:n,coefficient:i,rightAlign:e(i),static:k(i,()=>!1),answerForms:e(l(a({name:re,simplify:e(b(w("required","correct","enforced","optional")))})))}));function _(t,r){return E(t,r)}const Gn=(t,r)=>t==="large"?r.success("auto"):r.success(t),Dn=h(u("orderer"),a({options:k(l(_),()=>[]),correctOptions:l(_),otherOptions:l(_),height:W(w("normal","auto","large")).then(Gn).parser,layout:k(w("horizontal","vertical"),()=>"horizontal")})),En=h(u("passage-ref"),a({passageNumber:o,referenceNumber:o,summaryText:n})),Un=h(u("passage"),a({footnotes:n,passageText:n,passageTitle:n,showLineNumbers:i,static:k(i,()=>!1)})),Vn=h(u("phet-simulation"),a({url:n,description:n})),$n=h(u("plotter"),a({labels:l(n),categories:l(n),type:w(...pe),maxY:o,scaleY:o,labelInterval:e(b(o)),snapsPerLine:o,starting:l(o),correct:l(o),picUrl:e(b(n)),picSize:e(b(o)),picBoxHeight:e(b(o)),plotDimensions:k(l(o),()=>[380,300])})),Jn=h(u("python-program"),a({programID:n,height:o})),_n=h(u("radio"),a({choices:l(a({content:k(n,()=>""),clue:e(n),correct:e(i),isNoneOfTheAbove:e(i),widgets:e((t,r)=>F(t,r))})),hasNoneOfTheAbove:e(i),countChoices:e(i),randomize:e(i),multipleSelect:e(i),deselectEnabled:e(i),onePerLine:e(i),displayCount:e(O),noneOfTheAbove:e(u(!1))})),zn=h(u("sorter"),a({correct:l(n),padding:i,layout:w("horizontal","vertical")})),Hn=h(u("table"),a({headers:l(n),rows:o,columns:o,answers:l(l(n))})),Kn=h(u("video"),a({location:n,static:e(i)})),F=(t,r)=>{if(!B(t))return r.failure("PerseusWidgetsMap",t);const s={};for(const m of Object.keys(t)){const d=Bn([m,t[m]],s,r.forSubtree(m));if(q(d))return d}return r.success(s)},Bn=([t,r],s,m)=>{const d=Qn(t.split(" "),m);if(q(d))return d;const[g,y]=d.value;function c(C,T){const P=T(r,m);return q(P)?P:(s[C]=P.value,m.success(void 0))}switch(g){case"categorizer":return c(`categorizer ${y}`,De);case"cs-program":return c(`cs-program ${y}`,Ee);case"definition":return c(`definition ${y}`,Ue);case"dropdown":return c(`dropdown ${y}`,Ve);case"explanation":return c(`explanation ${y}`,$e);case"expression":return c(`expression ${y}`,Ke);case"grapher":return c(`grapher ${y}`,Ye);case"group":return c(`group ${y}`,Qe);case"graded-group":return c(`graded-group ${y}`,Be);case"graded-group-set":return c(`graded-group-set ${y}`,Xe);case"iframe":return c(`iframe ${y}`,Ze);case"image":return c(`image ${y}`,nn);case"input-number":return c(`input-number ${y}`,tn);case"interaction":return c(`interaction ${y}`,cn);case"interactive-graph":return c(`interactive-graph ${y}`,Sn);case"label-image":return c(`label-image ${y}`,jn);case"matcher":return c(`matcher ${y}`,Nn);case"matrix":return c(`matrix ${y}`,On);case"measurer":return c(`measurer ${y}`,Wn);case"molecule-renderer":return c(`molecule-renderer ${y}`,Fn);case"number-line":return c(`number-line ${y}`,Ln);case"numeric-input":return c(`numeric-input ${y}`,Mn);case"orderer":return c(`orderer ${y}`,Dn);case"passage":return c(`passage ${y}`,Un);case"passage-ref":return c(`passage-ref ${y}`,En);case"passage-ref-target":return c(`passage-ref-target ${y}`,O);case"phet-simulation":return c(`phet-simulation ${y}`,Vn);case"plotter":return c(`plotter ${y}`,$n);case"python-program":return c(`python-program ${y}`,Jn);case"radio":return c(`radio ${y}`,_n);case"sorter":return c(`sorter ${y}`,zn);case"table":return c(`table ${y}`,Hn);case"video":return c(`video ${y}`,Kn);case"sequence":return c(`sequence ${y}`,Xn);default:return ke(g)?c(`${g} ${y}`,O):m.failure("a valid widget type",g)}},Xn=h((t,r)=>r.success("deprecated-standin"),a({})),Yn=(t,r)=>typeof t!="string"||!/^[1-9][0-9]*$/.test(t)?r.failure("numeric string",t):r.success(+t),Qn=f(n,Yn),Zn=a({replace:e(i),content:n,widgets:k(F,()=>({})),metadata:e(l(n)),images:se});a({question:E,hints:k(l(Zn),()=>[]),answerArea:W(k(a({}),()=>({}))).then(er).then(Y(w(...ce),i)).parser,itemDataVersion:e(a({major:o,minor:o})),answer:O});function er(t,r){const{type:s,options:m,...d}=t;return r.success(d)}export{L as S,Ie as i,We as r};
