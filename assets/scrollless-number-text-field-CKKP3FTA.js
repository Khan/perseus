import{r as s,j as m,br as v}from"./iframe-B-MePfAZ.js";const f=o=>{const{value:i,onChange:u,...l}=o,[c,a]=s.useState(!1),[h,r]=s.useState(""),n=s.useRef(null);return s.useEffect(()=>{const e=n.current,t=d=>{d.stopPropagation()};return e==null||e.addEventListener("wheel",t),()=>{e==null||e.removeEventListener("wheel",t)}},[n]),m.jsx(v,{...l,type:"number",value:c?h:i,onChange:e=>{r(e),u(e)},onFocus:e=>{var t;r(i),a(!0),(t=o.onFocus)==null||t.call(o,e)},onBlur:e=>{var t;a(!1),(t=o.onBlur)==null||t.call(o,e)},ref:n})};f.__docgenInfo={description:`This is a custom text field of type="number" for use in Perseus Editors.
