...
the first letter of a heading should be capitalized.`}),Bn={and:!0,nor:!0,but:!0,the:!0,for:!0};function $n(r){const e=r[0];return e===e.toUpperCase()}const Jn=m.makeRule({name:"heading-title-case",severity:m.Severity.GUIDELINE,selector:"heading",pattern:/[^\s:]\s+[A-Z]+[a-z]/,locale:"en",lint:function(r,e,n,t){let i=e.trim().split(/\s+/);if(i.shift(),i=i.filter(o=>o.length>2&&!Bn.hasOwnProperty(o)),i.length>=3&&i.every(o=>$n(o)))return`Title-case heading:
This heading appears to be in title-case, but should be sentence-case.
Only capitalize the first letter and proper nouns.`}}),Qn=m.makeRule({name:"image-alt-text",severity:m.Severity.WARNING,selector:"image",lint:function(r,e,n,t){const a=n[0];if(!a.alt||!a.alt.trim())return`Images should have alt text:
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{fa as D,Fe as J,D as P,Ce as R,b as S,qa as a,Ia as b,Ta as c,Aa as d,xa as e,Pa as f,Mt as g,Ca as h,Xt as i,Ot as j,va as k,Ve as l,zt as m,Rt as n,Na as o,Lr as p,U as q,ka as r,Sa as s,Ra as t,jt as u,Nt as v,dn as w,sn as x,Gt as y,S as z};
