import{j as m}from"./jsx-runtime-63Ea5SlK.js";import{n as y}from"./no-important-xCWWYXQR.js";import{c as x}from"./index-dnMhQZ-1.js";import{r as T}from"./index-6oxdNXpR.js";import{F as H}from"./index-9gkyvru-.js";import{_ as J}from"./index-default-4_ZsnO94.js";import{u as X}from"./i18n-context-dE2bX2K_.js";import{C as R}from"./perseus-api-DO0X8arb.js";import{h as Z,r as N,n as I,s as W}from"./constants-NhstHO4m.js";import{m as O}from"./media-queries-9nQcKCnE.js";import{U as ee}from"./util-CFc6mjZH.js";import{C as ne}from"./choice-Wt8wG6Cp.js";import{C as te}from"./choice-none-above-BSdwhDxS.js";typeof HTMLElement<"u"&&!HTMLElement.prototype.scrollTo&&(HTMLElement.prototype.scrollTo=function(e,o){this.scrollLeft=e,this.scrollTop=o});const B=(e,o)=>{typeof e.scrollTo=="function"?e.scrollTo(0,o):"scrollTop"in e&&(e.scrollTop=o)},ae=(e,o,r=0,t)=>{const s=e===window?window.pageYOffset:e.scrollTop,d=o,g=d-s,u=17,v=r/u;let f=0;const P=setInterval(function(){if(f<v){const b=f/v,A=(-Math.cos(Math.PI*b)+1)/2,k=s+g*A;B(e,k),f+=1}else B(e,d),clearInterval(P),t==null||t()},u)},K=e=>e===document.body||e==null?window:e.scrollHeight>e.clientHeight?e:K(e.parentElement),oe=750,re=(e,o)=>{setTimeout(()=>{const r=K(e),t=e.getBoundingClientRect(),s=r===window?{top:0,bottom:window.innerHeight}:r.getBoundingClientRect();let d=0;const g=r===window?window.scrollY:r.scrollTop;if(t.bottom>s.bottom){let u=t.bottom-s.bottom;t.top+u<s.top&&(u=t.top-s.top),d=g+u}else if(t.top<s.top){const u=t.top-s.top;d=g+u}ae(r,d,oe,o)},0)},{captureScratchpadTouchStart:ie}=ee;function se(e,o,r,t){return e?o?t.chooseNumAnswers({numCorrect:String(r)}):t.chooseAllAnswers:t.chooseOneAnswer}const le=function({apiOptions:e,reviewModeRubric:o,reviewMode:r,choices:t,editMode:s=!1,multipleSelect:d=!1,labelWrap:g,countChoices:u,numCorrect:v,isLastUsedWidget:f,onChange:P,registerFocusFunction:b}){const{strings:A}=X(),k=T.useRef(),q=T.useRef([]);T.useEffect(()=>{if(e.canScrollPage&&f&&o&&!k.current){const n=t.findIndex(a=>a.checked);if(n>=0){const a=q.current[n],l=H.findDOMNode(a.current);l&&re(l)}}k.current=o},[e,t,f,o]);function E(n,a){let c;a.checked&&!d?c=t.map(p=>!1):c=t.map(p=>p.checked);const l=t.map(p=>p.crossedOut);c[n]=a.checked,l[n]=a.crossedOut,P({checked:c,crossedOut:l})}b==null||b(n=>{const a=q.current[n||0],l=H.findDOMNode(a.current);if(l)l.focus();else return!1;return!0});const C=e.isMobile,_=t[0].highlighted,G=t[t.length-1].highlighted,z=x("perseus-widget-radio",!s&&"perseus-rendered-radio",y.css(i.radio,i.responsiveRadioContainer,_&&C&&i.radioContainerFirstHighlighted,G&&C&&i.radioContainerLastHighlighted)),$=x("instructions",y.css(i.instructions,C&&i.instructionsMobile)),F=se(d,u,v,A),U=y.css(i.responsiveFieldset),V=m.jsxs("fieldset",{className:`perseus-widget-radio-fieldset ${U}`,children:[m.jsx("legend",{className:"perseus-sr-only",children:F}),m.jsx("div",{className:$,"aria-hidden":"true",children:F}),m.jsx("ul",{className:z,style:{listStyle:"none"},children:t.map((n,a)=>{let c=ne;const l=T.createRef();q.current[a]=l;const p={apiOptions:e,multipleSelect:d,checked:n.checked,crossedOut:n.crossedOut,previouslyAnswered:n.previouslyAnswered,reviewMode:r,correct:n.correct,rationale:n.rationale,content:n.content,disabled:e.readOnly||n.disabled,showCorrectness:r||!!n.showCorrectness,showRationale:n.hasRationale&&(r||n.showRationale),pos:a,onChange:h=>{s||E(a,h)}};n.isNoneOfTheAbove&&(c=te,J.extend(p,{showContent:n.revealNoneOfTheAbove}));const M=t[a+1],Y=!!M&&M.highlighted,S=h=>y.css(i.item,i.responsiveItem,h&&i.selectedItem,h&&n.highlighted&&i.aboveBackdrop,h&&n.highlighted&&e.isMobile&&i.aboveBackdropMobile,Y&&e.isMobile&&i.nextHighlighted);S(!0);let D;r&&o&&(D=o.choices[a].correct?R.CORRECT:R.INCORRECT);const Q=x(S(n.checked),R.RADIO.OPTION,n.checked&&R.RADIO.SELECTED,D);let L=null,j;return s&&(j=h=>{let w=h.target;for(;w&&w!==L;){if(w.getAttribute("data-is-radio-icon")){E(a,{checked:!n.checked,crossedOut:n.crossedOut});return}w=w.parentNode}}),m.jsx("li",{ref:h=>L=h,className:Q,onClick:j,onTouchStart:g?void 0:ie,children:m.jsx(c,{...p,ref:l})},a)})})]});return m.jsx("div",{className:y.css(i.responsiveContainer),children:V})},i=y.StyleSheet.create({instructions:{display:"block",color:Z,fontSize:14,lineHeight:1.25,fontFamily:"inherit",fontStyle:"normal",fontWeight:"bold",marginBottom:16},instructionsMobile:{fontSize:18,[O.smOrSmaller]:{fontSize:16},[O.xl]:{fontSize:20}},radio:{padding:0},responsiveRadioContainer:{borderBottom:`1px solid ${N}`,borderTop:`1px solid ${N}`,width:"auto",[O.smOrSmaller]:{marginLeft:I,marginRight:I}},radioContainerFirstHighlighted:{borderTop:"1px solid rgba(0, 0, 0, 0)"},radioContainerLastHighlighted:{borderBottom:"1px solid rgba(0, 0, 0, 0)"},item:{marginLeft:20},responsiveItem:{marginLeft:0,padding:0,":not(:last-child)":{borderBottom:`1px solid ${N}`}},selectedItem:{background:"white"},aboveBackdrop:{position:"relative",zIndex:1062},aboveBackdropMobile:{boxShadow:"0 0 4px 0 rgba(0, 0, 0, 0.2),0 0 2px 0 rgba(0, 0, 0, 0.1)",":not(:last-child)":{borderBottom:"1px solid rgba(0, 0, 0, 0)"}},nextHighlighted:{":not(:last-child)":{borderBottom:"1px solid rgba(0, 0, 0, 0)"}},responsiveContainer:{overflow:"auto",marginLeft:I,paddingLeft:W},responsiveFieldset:{paddingRight:W,minWidth:"auto"}});le.__docgenInfo={description:"",methods:[],displayName:"BaseRadio",props:{apiOptions:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
