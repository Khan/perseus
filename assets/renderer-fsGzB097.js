...
`,n);return n.inline=t,a},ne=function(r,e,n){return{content:se(e,r[1],n)}},he=function(){return{}},oe="(?:[*+-]|\\d+\\.)",Ue="( *)("+oe+") +",Ee=new RegExp("^"+Ue),Nr=new RegExp(Ue+"[^\\n]*(?:\\n(?!\\1"+oe+` )[^\\n]*)*(
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{Gt as D,Ye as J,W as P,xe as R,h as S,_t as a,Vt as b,Ut as c,zt as d,Kt as e,Bt as f,Ht as g,pt as h,st as i,Dt as j,D as k,Ge as l,S as m,hr as p,Ft as r,Qt as s};
