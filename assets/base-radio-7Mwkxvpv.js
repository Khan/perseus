import{a as X,j as c}from"./jsx-runtime-FVsy8kgq.js";import{l as b}from"./index-awljIyHI.js";import{c as C}from"./index-dnMhQZ-1.js";import{r as O}from"./index-TT1qJ6UJ.js";import{R as M}from"./index-7vsPyIck.js";import{_ as Z}from"./jquery-yG1GhClm.js";import{u as ee}from"./i18n-context-vLFBfHTg.js";import{C as x}from"./perseus-api-mOiZT07d.js";import{h as re,r as N,n as z,s as U}from"./constants-iPV6vHZm.js";import{m as E}from"./media-queries-gbofTbz-.js";import{s as te}from"./shared-4TdECMLk.js";import{U as ne}from"./util-F8-MDmsT.js";import{C as ae}from"./choice-D4XD19hc.js";import{C as ie}from"./choice-none-above-g3tM3Sry.js";typeof HTMLElement<"u"&&!HTMLElement.prototype.scrollTo&&(HTMLElement.prototype.scrollTo=function(e,t){this.scrollLeft=e,this.scrollTop=t});const S=(e,t)=>{typeof e.scrollTo=="function"?e.scrollTo(0,t):"scrollTop"in e&&(e.scrollTop=t)},se=(e,t,s=0,n)=>{const a=e===window?window.pageYOffset:e.scrollTop,u=t,m=u-a,d=17,k=s/d;let v=0;const q=setInterval(function(){if(v<k){const w=v/k,j=(-Math.cos(Math.PI*w)+1)/2,T=a+m*j;S(e,T),v+=1}else S(e,u),clearInterval(q),n&&n()},d)},D=e=>e===document.body||e==null?window:e.scrollHeight>e.clientHeight?e:D(e.parentElement),oe=750,le=(e,t)=>{setTimeout(()=>{const s=D(e),n=e.getBoundingClientRect(),a=s===window?{top:0,bottom:window.innerHeight}:s.getBoundingClientRect();let u=0;const m=s===window?window.scrollY:s.scrollTop;if(n.bottom>a.bottom){let d=n.bottom-a.bottom;n.top+d<a.top&&(d=n.top-a.top),u=m+d}else if(n.top<a.top){const d=n.top-a.top;u=m+d}se(s,u,oe,t)},0)},{captureScratchpadTouchStart:ue}=ne;function de(e,t,s,n){return e?t?n.chooseNumAnswers({numCorrect:String(s)}):n.chooseAllAnswers:n.chooseOneAnswer}const H=function(e){const{apiOptions:t,reviewModeRubric:s,reviewMode:n,choices:a,editMode:u,multipleSelect:m,labelWrap:d,countChoices:k,numCorrect:v,isLastUsedWidget:q,registerFocusFunction:w}=e,{strings:j}=ee(),T=O.useRef(),W=O.useRef([]);O.useEffect(()=>{if(t.canScrollPage&&q&&s&&!T.current){const r=a.findIndex(i=>i.checked);if(r>=0){const i=W.current[r],l=M.findDOMNode(i.current);l&&le(l)}}T.current=s},[t,a,q,s]);function L(r,i){const{multipleSelect:p,choices:l,onChange:R}=e;let g;i.checked&&!p?g=l.map(h=>!1):g=l.map(h=>h.checked);const A=l.map(h=>h.crossedOut);g[r]=i.checked,A[r]=i.crossedOut,R({checked:g,crossedOut:A})}w==null||w(r=>{const i=W.current[r||0],l=M.findDOMNode(i.current);if(l)l.focus();else return!1;return!0});const I=t.isMobile,V=a[0].highlighted,G=a[a.length-1].highlighted,K=C("perseus-widget-radio",!u&&"perseus-rendered-radio",b.css(o.radio,o.responsiveRadioContainer,V&&I&&o.radioContainerFirstHighlighted,G&&I&&o.radioContainerLastHighlighted)),B=C("instructions",b.css(o.instructions,I&&o.instructionsMobile)),_=de(m,k,v,j),Y=b.css(o.responsiveFieldset),Q=X("fieldset",{className:`perseus-widget-radio-fieldset ${Y}`,children:[c("legend",{className:"perseus-sr-only",children:_}),c("div",{className:B,"aria-hidden":"true",children:_}),c("ul",{className:K,style:{listStyle:"none"},children:a.map((r,i)=>{let p=ae;const l=O.createRef();W.current[i]=l;const R={apiOptions:t,multipleSelect:m,checked:r.checked,crossedOut:r.crossedOut,previouslyAnswered:r.previouslyAnswered,reviewMode:n,correct:r.correct,rationale:r.rationale,content:r.content,disabled:t.readOnly||r.disabled,showCorrectness:n||!!r.showCorrectness,showRationale:r.hasRationale&&(n||r.showRationale),pos:i,onChange:y=>{u||L(i,y)}};r.isNoneOfTheAbove&&(p=ie,Z.extend(R,{showContent:r.revealNoneOfTheAbove}));const g=a[i+1],A=!!g&&g.highlighted,h=y=>b.css(te.aboveScratchpad,o.item,o.responsiveItem,y&&o.selectedItem,y&&r.highlighted&&o.aboveBackdrop,y&&r.highlighted&&t.isMobile&&o.aboveBackdropMobile,A&&t.isMobile&&o.nextHighlighted);h(!0);let P;n&&s&&(P=s.choices[i].correct?x.CORRECT:x.INCORRECT);const J=C(h(r.checked),x.RADIO.OPTION,r.checked&&x.RADIO.SELECTED,P);let $=null,F;return u&&(F=y=>{let f=y.target;for(;f&&f!==$;){if(f.getAttribute("data-is-radio-icon")){L(i,{checked:!r.checked,crossedOut:r.crossedOut});return}f=f.parentNode}}),c("li",{ref:y=>$=y,className:J,onClick:F,onTouchStart:d?void 0:ue,children:c(p,{...R,ref:l})},i)})})]});return c("div",{className:b.css(o.responsiveContainer),children:Q})};H.defaultProps={editMode:!1,multipleSelect:!1};const o=b.StyleSheet.create({instructions:{display:"block",color:re,fontSize:14,lineHeight:1.25,fontFamily:"inherit",fontStyle:"normal",fontWeight:"bold",marginBottom:16},instructionsMobile:{fontSize:18,[E.smOrSmaller]:{fontSize:16},[E.xl]:{fontSize:20}},radio:{padding:0},responsiveRadioContainer:{borderBottom:`1px solid ${N}`,borderTop:`1px solid ${N}`,width:"auto",[E.smOrSmaller]:{marginLeft:z,marginRight:z}},radioContainerFirstHighlighted:{borderTop:"1px solid rgba(0, 0, 0, 0)"},radioContainerLastHighlighted:{borderBottom:"1px solid rgba(0, 0, 0, 0)"},item:{marginLeft:20},responsiveItem:{marginLeft:0,padding:0,":not(:last-child)":{borderBottom:`1px solid ${N}`}},selectedItem:{background:"white"},aboveBackdrop:{position:"relative",zIndex:1062},aboveBackdropMobile:{boxShadow:"0 0 4px 0 rgba(0, 0, 0, 0.2),0 0 2px 0 rgba(0, 0, 0, 0.1)",":not(:last-child)":{borderBottom:"1px solid rgba(0, 0, 0, 0)"}},nextHighlighted:{":not(:last-child)":{borderBottom:"1px solid rgba(0, 0, 0, 0)"}},responsiveContainer:{overflow:"auto",marginLeft:z,paddingLeft:U},responsiveFieldset:{paddingRight:U,minWidth:"auto"}});H.__docgenInfo={description:"",methods:[],displayName:"BaseRadio",props:{apiOptions:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
