import{j as e,bz as y,V as w,n as b,S as f,e as v,R as k,f as P,s as T}from"./iframe-CivT3IbC.js";import"./item-version-DChSHYeI.js";import"./article-renderer-DN9L9RQu.js";import"./server-item-renderer-NnfSC3sn.js";import"./hints-renderer-CCvrJEkK.js";import{c as R}from"./components-DnYZ8MIN.js";import{d as i,l as x}from"./device-framer-DPbDZ9IV.js";import{c as A,d as q,e as I}from"./icon-paths-Cfjy_uoj.js";const{ButtonGroup:F,InlineIcon:o}=R,D=n=>{const t=e.jsxs("span",{children:[e.jsx(o,{...A})," Phone"]}),a=e.jsxs("span",{children:[e.jsx(o,{...q})," Tablet"]}),r=e.jsxs("span",{children:[e.jsx(o,{...I})," Desktop"]});return e.jsxs("span",{className:"viewport-resizer",children:["Viewport:"," ",e.jsx(F,{value:n.deviceType,allowEmpty:!1,buttons:[{value:i.PHONE,content:t},{value:i.TABLET,content:a},{value:i.DESKTOP,content:r}],onChange:n.onViewportSizeChanged})]})};D.__docgenInfo={description:"",methods:[],displayName:"ViewportResizer",props:{deviceType:{required:!0,tsType:{name:"union",raw:'"phone" | "tablet" | "desktop"',elements:[{name:"literal",value:'"phone"'},{name:"literal",value:'"tablet"'},{name:"literal",value:'"desktop"'}]},description:"The current device type that is selected."},onViewportSizeChanged:{required:!0,tsType:{name:"signature",type:"function",raw:"(deviceType: DeviceType) => unknown",signature:{arguments:[{type:{name:"union",raw:'"phone" | "tablet" | "desktop"',elements:[{name:"literal",value:'"phone"'},{name:"literal",value:'"tablet"'},{name:"literal",value:'"desktop"'}]},name:"deviceType"}],return:{name:"unknown"}}},description:`A callback that is passed (width, height) as the dimensions of the
viewport to resize to.`}}};function C({question:n,apiOptions:t,seamless:a,linterContext:r,legacyPerseusLint:l,previewDevice:u}){const c=y(),s=u!=="desktop",h=s?"perseus-mobile":"";return e.jsx(w,{className:`framework-perseus ${h}`,style:[d.container,a?void 0:d.gutter],children:e.jsx(f,{children:e.jsx(v.Consumer,{children:({setKeypadActive:p,keypadElement:m,setKeypadElement:g})=>e.jsxs(e.Fragment,{children:[e.jsx(k,{strings:c.strings,apiOptions:{...t,isMobile:s},keypadElement:m,linterContext:r,legacyPerseusLint:l,...n}),e.jsx(P,{onAnalyticsEvent:()=>Promise.resolve(),onDismiss:()=>p(!1),onElementMounted:g})]})})})})}const d=b.StyleSheet.create({container:{padding:T.xxxSmall_4,containerType:"inline-size",containerName:"perseus-root"},gutter:{marginRight:x}});C.__docgenInfo={description:"The `ContentPreview` component provides a simple preview system for Perseus\nContent. Due to how Persus styles are built, the preview styling matches the\ncurrent device based on the viewport width (using `@media` queries for\n`min-width` and `max-width`).\n\nThe preview will render the mobile variant (styling and layout) when the\n`previewDevice` is phone or tablet. Note that the styling cannot be matched\n100% due to the above `@media` query limitation.",methods:[],displayName:"ContentPreview",props:{question:{required:!1,tsType:{name:"signature",type:"object",raw:`{
    /**
...
media queries based on the screen width).`}}};export{C,D as V};
