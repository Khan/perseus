...
any other kind of terminal punctuation.`});function Yn(r,e){return`Answer requires a button not found in the button sets: ${r} (in ${e})`}const _n={"\\sqrt":"prealgebra","\\sin":"trig","\\cos":"trig","\\tan":"trig","\\log":"logarithms","\\ln":"logarithms"},Dn=m.makeRule({name:"expression-widget",severity:m.Severity.WARNING,selector:"widget",lint:function(r,e,n,t,a){var l;if(r.currentNode().widgetType!=="expression")return;const i=r.currentNode().id;if(!i)return;const o=(l=a==null?void 0:a.widgets)==null?void 0:l[i];if(!o)return;const s=o.options.answerForms,u=o.options.buttonSets;for(const d of s)for(const[p,b]of Object.entries(_n))if(d.value.includes(p)&&!u.includes(b))return Yn(p,b)}}),Gn=m.makeRule({name:"extra-content-spacing",selector:"paragraph",pattern:/\s+$/,applies:function(r){return(r==null?void 0:r.contentType)==="article"},message:"No extra whitespace at the end of content blocks."}),zn=m.makeRule({name:"heading-level-1",severity:m.Severity.WARNING,selector:"heading",lint:function(r,e,n,t){if(n[0].level===1)return`Don't use level-1 headings:
Begin headings with two or more # characters.`}}),Un=m.makeRule({name:"heading-level-skip",severity:m.Severity.WARNING,selector:"heading ~ heading",lint:function(r,e,n,t){const a=n[1],i=n[0];if(a.level>i.level+1)return`Skipped heading level:
...
`),t.prevCapture=null,a(Be(o),t)};return i},C=function(r){var e=function(n,t,a){return t.inline?r.exec(n):null};return e.regex=r,e},N=function(r){var e=function(n,t){return t.inline?null:r.exec(n)};return e.regex=r,e},Ae=function(r){var e=function(n,t){return r.exec(n)};return e.regex=r,e},Dr=typeof Symbol=="function"&&Symbol.for&&Symbol.for("react.element")||60103,v=function(r,e,n){var t={$$typeof:Dr,type:r,key:e??void 0,ref:null,props:n,_owner:null};return t},T=function(r,e,n,t){n=n||{},t=typeof t<"u"?t:!0;var a="";for(var i in n){var o=n[i];Object.prototype.hasOwnProperty.call(n,i)&&o&&(a+=" "+V(i)+'="'+V(o)+'"')}var s="<"+r+a+">";return t?s+e+"</"+r+">":s},Gr={},$=function(r){if(r==null)return null;try{var e=new URL(r,"https://localhost").protocol;if(e.indexOf("javascript:")===0||e.indexOf("vbscript:")===0||e.indexOf("data:")===0)return null}catch{return null}return r},zr=/[<>&"']/g,Ur={"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;","'":"&#x27;","/":"&#x2F;","`":"&#96;"},V=function(r){return String(r).replace(zr,function(e){return Ur[e]})},Vr=/\\([^0-9A-Za-z\s])/g,Re=function(r){return r.replace(Vr,"$1")},ue=function(r,e,n){var t=n.inline||!1;n.inline=!0;var a=r(e,n);return n.inline=t,a},Hr=function(r,e,n){var t=n.inline||!1;n.inline=!1;var a=r(e+`

`,n);return n.inline=t,a},te=function(r,e,n){return{content:ue(e,r[1],n)}},fe=function(){return{}},le="(?:[*+-]|\\d+\\.)",Qe="( *)("+le+") +",We=new RegExp("^"+Qe),Kr=new RegExp(Qe+"[^\\n]*(?:\\n(?!\\1"+le+` )[^\\n]*)*(
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{wa as D,_e as J,_ as P,Ce as R,h as S,ka as a,Ca as b,qa as c,Ta as d,Aa as e,xa as f,Lt as g,Pa as h,Wt as i,Nt as j,fa as k,He as l,zt as m,At as n,Sa as o,Er as p,z as q,va as r,Ia as s,Ra as t,Et as u,Ot as v,dn as w,on as x,S as y};
