import{j as e}from"./jsx-runtime-63Ea5SlK.js";import{r as B}from"./index-6oxdNXpR.js";import"./util-_iDv4tVD.js";import{e as E}from"./svg-image-wIdVOlIq.js";import{B as I}from"./index-69t9pbsh.js";import{V as c}from"./index-CgfdZoMj.js";import{S as k}from"./index-C1N8lBvx.js";import{s as i,c as g}from"./index-dmcq622U.js";import{L as w,c as T}from"./index-6ID5EQ9c.js";import{L as D,p as O}from"./locked-figure-aria-1Hn9A7el.js";import{l as U}from"./index-awljIyHI.js";import{v as m}from"./index-smZ6iCr_.js";import{P as L,C as j,L as W,a as G}from"./locked-label-settings-9IeTafVY.js";import{C as H}from"./color-select-mdjTD_4v.js";import{L as J}from"./line-swatch-B198KtDT.js";import{g as K,j as Q,a as Y}from"./util-LRFNLe52.js";const Z="The vector cannot have length 0.",F=p=>{var x,h;const{flags:s,points:q,color:y,labels:n,ariaLabel:S,onChangeProps:d,onMove:P,onRemove:z}=p,[o,u]=q,A=`Vector (${o[0]}, ${o[1]}), (${u[0]}, ${u[1]})`,v=E(o,u);async function N(){let a=`Vector${await Q(n)} from ${o[0]} comma ${o[1]} to ${u[0]} comma ${u[1]}`;const l=Y(y);return a+=l,a}function f(r,a){if(typeof r<"u"){const l=[...q];l[a]=[...r];const b=m.midpoint(o,u),_=m.midpoint(l[0],l[1]),M=m.sub(_,b),X=n==null?void 0:n.map(C=>({...C,coord:m.add(C.coord,M)}));d({points:l,labels:X})}}function $(r){const a={color:r};a.labels=n==null?void 0:n.map(l=>({...l,color:r})),d(a)}function R(r,a){if(!n)return;const l=[...n];l[a]={...n[a],...r},d({labels:l})}function V(r){if(!n)return;const a=n.filter((l,b)=>b!==r);d({labels:a})}return e.jsxs(L,{expanded:p.expanded,onToggle:p.onToggle,header:e.jsxs(c,{style:t.row,children:[e.jsx(w,{children:A}),e.jsx(k,{size:i.xSmall_8}),e.jsx(J,{color:y,lineStyle:"solid"})]}),children:[e.jsx(c,{style:[t.row,t.spaceUnder],children:e.jsx(H,{selectedValue:y,onChange:$})}),v&&e.jsx(T,{style:t.errorText,children:Z}),e.jsx(L,{expanded:!0,containerStyle:t.container,panelStyle:t.accordionPanel,header:e.jsx(c,{style:t.row,children:e.jsx(w,{children:`Tail (${o[0]}, ${o[1]})`})}),children:e.jsx(j,{coord:o,error:v,onChange:r=>{f(r,0)}})}),e.jsx(L,{expanded:!0,containerStyle:t.container,panelStyle:t.accordionPanel,header:e.jsx(c,{style:t.row,children:e.jsx(w,{children:`Tip (${u[0]}, ${u[1]})`})}),children:e.jsx(j,{coord:u,error:v,onChange:r=>{f(r,1)}})}),((x=s==null?void 0:s.mafs)==null?void 0:x["locked-figures-aria"])&&e.jsxs(e.Fragment,{children:[e.jsx(k,{size:i.small_12}),e.jsx(c,{style:t.horizontalRule}),e.jsx(D,{ariaLabel:S,getPrepopulatedAriaLabel:N,onChangeProps:r=>{d(r)}})]}),((h=s==null?void 0:s.mafs)==null?void 0:h["locked-vector-labels"])&&e.jsxs(e.Fragment,{children:[e.jsx(k,{size:i.xxxSmall_4}),e.jsx(c,{style:t.horizontalRule}),e.jsx(k,{size:i.small_12}),e.jsx(T,{children:"Visible labels"}),n==null?void 0:n.map((r,a)=>B.createElement(W,{...r,key:a,expanded:!0,onChangeProps:l=>{R(l,a)},onRemove:()=>{V(a)},containerStyle:t.labelContainer})),e.jsx(I,{kind:"tertiary",startIcon:O,onClick:()=>{const r=[0,-1],a=m.add(m.scale(r,(n==null?void 0:n.length)??0),m.midpoint(o,u)),l={...K("label"),coord:a,color:y};d({labels:[...n??[],l]})},style:t.addButton,children:"Add visible label"})]}),e.jsx(G,{figureType:p.type,onMove:P,onRemove:z})]})},t=U.StyleSheet.create({accordionPanel:{paddingBottom:i.medium_16},container:{marginTop:i.xSmall_8,marginBottom:0,marginLeft:-i.xxxSmall_4,marginRight:-i.xxxSmall_4,backgroundColor:g.white},errorText:{color:g.red,marginTop:i.xSmall_8},row:{flexDirection:"row",alignItems:"center"},addButton:{alignSelf:"start"},horizontalRule:{height:1,backgroundColor:g.offBlack16},labelContainer:{backgroundColor:g.white}}),ge=F;F.__docgenInfo={description:"",methods:[],displayName:"LockedVectorSettings",props:{type:{required:!0,tsType:{name:"literal",value:'"vector"'},description:""},points:{required:!0,tsType:{name:"tuple",raw:"[tail: Coord, tip: Coord]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},color:{required:!0,tsType:{name:"unknown[number]",raw:"(typeof lockedFigureColorNames)[number]"},description:""},labels:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    type: "label";
    coord: Coord;
