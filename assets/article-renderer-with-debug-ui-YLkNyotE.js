import{r as i,j as e,e as c,au as t,av as p}from"./iframe-Clm9i0Cj.js";import{T as m,S as g,P as y,d as w}from"./test-keypad-context-wrapper-CEiSBY1a.js";import{A as f}from"./article-renderer-B87WTxaD.js";import{S as b}from"./split-view-CC2QyViQ.js";const k=({title:o="📜 Article",json:a,apiOptions:r=Object.freeze({}),linterContext:s})=>{const d=i.useRef(null),[n,l]=i.useState(r.isMobile??!1),u={...r,isMobile:n,isArticle:!0,customKeypad:n};return e.jsx(b,{rendererTitle:e.jsxs(t,{style:{flexDirection:"row",alignItems:"center",width:"100%"},children:[o,e.jsx(t,{style:{marginLeft:"auto"},children:e.jsx(g,{icon:e.jsx(y,{icon:w}),checked:n,onChange:l})})]}),renderer:e.jsx(e.Fragment,{children:e.jsx(m,{children:e.jsx(c.Consumer,{children:({keypadElement:h})=>e.jsx(t,{className:n?"perseus-mobile":"",children:e.jsx(f,{ref:d,apiOptions:u,json:a,dependencies:p,keypadElement:h,linterContext:s})})})})}),jsonObject:a})};k.__docgenInfo={description:"",methods:[],displayName:"ArticleRendererWithDebugUI",props:{title:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'"📜 Article"',computed:!1}},json:{required:!0,tsType:{name:"union",raw:"PerseusRenderer | PerseusRenderer[]",elements:[{name:"signature",type:"object",raw:`{
    /**
