...
| PerseusGraphTypeSinusoid`,elements:[{name:"signature",type:"object",raw:`{
    ...
    // production data that still has this.
    coord?: Coord; // Legacy!
}`,signature:{properties:[{key:"coord",value:{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}],required:!1}}]}}]}],required:!1}}]}},name:"arg1"},{type:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},name:"callback"},{type:{name:"boolean"},name:"silent"}],return:{name:"unknown"}}},description:"",defaultValue:{value:"() => {}",computed:!1}},itemId:{required:!1,tsType:{name:"string"},description:""}}};const E=C,w=class w extends s.Component{constructor(){super(...arguments),this.frame=s.createRef(),this.questionEditor=s.createRef(),this.itemExtrasEditor=s.createRef(),this.updateProps=(e,n,t)=>{const r=o(this.props).pick("question","answerArea");this.props.onChange(o(r).extend(e),n,t)},this.triggerPreviewUpdate=e=>{var n;(n=this.frame.current)==null||n.sendNewData(e)},this.handleEditorChange=(e,n,t)=>{const r=o.extend({},this.props.question,e);this.updateProps({question:r},n,t)},this.handleItemExtrasChange=(e,n,t)=>{const r=o.extend({},this.props.answerArea,e);this.updateProps({answerArea:r},n,t)},this.getSaveWarnings=()=>{var e;return(e=this.questionEditor.current)==null?void 0:e.getSaveWarnings()},this.serialize=e=>{var n,t;return{question:(n=this.questionEditor.current)==null?void 0:n.serialize(e),answerArea:(t=this.itemExtrasEditor.current)==null?void 0:t.serialize(),itemDataVersion:E}}}render(){const e=this.props.deviceType==="phone"||this.props.deviceType==="tablet";return a.jsxs("div",{className:"perseus-editor-table",children:[a.jsxs("div",{className:"perseus-editor-row perseus-question-container",children:[a.jsxs("div",{className:"perseus-editor-left-cell",children:[a.jsx("div",{className:"pod-title",children:"Question"}),a.jsx(T,{ref:this.questionEditor,placeholder:"Type your question here...",className:"perseus-question-editor",imageUploader:this.props.imageUploader,onChange:this.handleEditorChange,apiOptions:this.props.apiOptions,showWordCount:!0,widgetIsOpen:this.props.widgetIsOpen,...this.props.question},this.props.itemId)]}),a.jsx("div",{className:"perseus-editor-right-cell",children:a.jsxs("div",{id:"problemarea",children:[a.jsx(v,{deviceType:this.props.deviceType,nochrome:!0,children:a.jsx(k,{ref:this.frame,datasetKey:"mobile",datasetValue:e,seamless:!0,url:this.props.previewURL},this.props.deviceType)}),a.jsx("div",{id:"hintsarea",className:"hintsarea",style:{display:"none"}})]})})]}),a.jsxs("div",{className:"perseus-editor-row perseus-answer-container",children:[a.jsxs("div",{className:"perseus-editor-left-cell",children:[a.jsx("div",{className:"pod-title",children:"Question extras"}),a.jsx(M,{ref:this.itemExtrasEditor,onChange:this.handleItemExtrasChange,...this.props.answerArea})]}),a.jsx("div",{className:"perseus-editor-right-cell",children:a.jsx("div",{id:"answer_area"})})]})]})}};w.defaultProps={onChange:()=>{},question:{},answerArea:{}};let m=w;m.__docgenInfo={description:"",methods:[{name:"updateProps",docblock:null,modifiers:[],params:[{name:"newProps",optional:!1,type:null},{name:"cb",optional:!1,type:null},{name:"silent",optional:!1,type:null}],returns:null},{name:"triggerPreviewUpdate",docblock:null,modifiers:[],params:[{name:"newData",optional:!1,type:{name:"any"}}],returns:null},{name:"handleEditorChange",docblock:null,modifiers:[],params:[{name:"newProps",optional:!1,type:null},{name:"cb",optional:!1,type:null},{name:"silent",optional:!1,type:null}],returns:null},{name:"handleItemExtrasChange",docblock:null,modifiers:[],params:[{name:"newProps",optional:!1,type:null},{name:"cb",optional:!1,type:null},{name:"silent",optional:!1,type:null}],returns:null},{name:"getSaveWarnings",docblock:null,modifiers:[],params:[],returns:null},{name:"serialize",docblock:null,modifiers:[],params:[{name:"options",optional:!1,type:{name:"any"}}],returns:null}],displayName:"ItemEditor",props:{apiOptions:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
        newFocusPath: FocusPath,
        oldFocusPath: FocusPath,
...
| PerseusGraphTypeSinusoid`,elements:[{name:"signature",type:"object",raw:`{
    ...
    // production data that still has this.
    coord?: Coord; // Legacy!
}`,signature:{properties:[{key:"coord",value:{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}],required:!1}}]}}]}],required:!1}}]}},name:"arg1"},{type:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},name:"callback"},{type:{name:"boolean"},name:"silent"}],return:{name:"unknown"}}},description:"",defaultValue:{value:"() => {}",computed:!1}},itemId:{required:!1,tsType:{name:"string"},description:""}}};const{HUD:D}=b,f=class f extends s.Component{constructor(e){super(e),this.itemEditor=s.createRef(),this.hintsEditor=s.createRef(),this.toggleJsonMode=()=>{this.setState({json:this.serialize({keepDeletedWidgets:!0})},()=>{this.props.onChange({jsonMode:!this.props.jsonMode})})},this.handleChange=(n,t,r)=>{const i=o(this.props).pick("question","hints","answerArea");o(i).extend(n),this.props.onChange(i,t,r)},this.changeJSON=n=>{this.setState({json:n}),this.props.onChange(n)},this.state={json:o.pick(this.props,"question","answerArea","hints","itemDataVersion"),gradeMessage:"",wasAnswered:!1,highlightLint:!0,widgetsAreOpen:this.props.widgetsAreOpen??!0},this._isMounted=!1}componentDidMount(){this._isMounted=!0,this.updateRenderer()}componentDidUpdate(){setTimeout(()=>{this.updateRenderer()})}componentWillUnmount(){this._isMounted=!1}updateRenderer(){var r,i;const e=!this.props.developerMode||!this.props.jsonMode;if(!this._isMounted||!e)return;const n=this.props.previewDevice==="phone"||this.props.previewDevice==="tablet",t={...this.getApiOptions(),customKeypad:n,isMobile:n};(i=this.itemEditor.current)==null||i.triggerPreviewUpdate({type:"question",data:o({item:this.serialize(),apiOptions:t,initialHintsVisible:0,device:this.props.previewDevice,linterContext:{contentType:"exercise",highlightLint:this.state.highlightLint,paths:this.props.contentPaths||[]},reviewMode:!0,legacyPerseusLint:(r=this.itemEditor.current)==null?void 0:r.getSaveWarnings()}).extend(o(this.props).pick("workAreaSelector","solutionAreaSelector","hintsAreaSelector","problemNum"))})}getApiOptions(){return{...q.defaults,...this.props.apiOptions}}getSaveWarnings(){var t,r;const e=(t=this.itemEditor.current)==null?void 0:t.getSaveWarnings(),n=(r=this.hintsEditor.current)==null?void 0:r.getSaveWarnings();return e.concat(n)}serialize(e){var n,t;return this.props.jsonMode?this.state.json:o.extend((n=this.itemEditor.current)==null?void 0:n.serialize(e),{hints:(t=this.hintsEditor.current)==null?void 0:t.serialize(e)})}render(){let e="framework-perseus";const n=this.props.previewDevice==="phone"||this.props.previewDevice==="tablet",t={...this.getApiOptions(),customKeypad:n,isMobile:n};return t.isMobile&&(e+=" "+P.MOBILE),a.jsxs("div",{id:"perseus",className:e,children:[a.jsxs("div",{style:{marginBottom:10},children:[this.props.developerMode&&a.jsxs("span",{children:[a.jsxs("label",{children:[" ","Developer JSON Mode:"," ",a.jsx("input",{type:"checkbox",checked:this.props.jsonMode,onChange:this.toggleJsonMode})]})," "]}),!this.props.jsonMode&&a.jsx(x,{deviceType:this.props.previewDevice,onViewportSizeChanged:this.props.onPreviewDeviceChange}),!this.props.jsonMode&&a.jsx(D,{message:"Style warnings",enabled:this.state.highlightLint,onClick:()=>{this.setState({highlightLint:!this.state.highlightLint})}})]}),this.props.developerMode&&this.props.jsonMode&&a.jsx("div",{children:a.jsx(A,{multiLine:!0,value:this.state.json,onChange:this.changeJSON})}),(!this.props.developerMode||!this.props.jsonMode)&&a.jsx(m,{ref:this.itemEditor,itemId:this.props.itemId,question:this.props.question,answerArea:this.props.answerArea,imageUploader:this.props.imageUploader,onChange:this.handleChange,wasAnswered:this.state.wasAnswered,gradeMessage:this.state.gradeMessage,deviceType:this.props.previewDevice,widgetIsOpen:this.state.widgetsAreOpen,apiOptions:t,previewURL:this.props.previewURL}),(!this.props.developerMode||!this.props.jsonMode)&&a.jsx(d,{ref:this.hintsEditor,itemId:this.props.itemId,hints:this.props.hints,imageUploader:this.props.imageUploader,onChange:this.handleChange,deviceType:this.props.previewDevice,apiOptions:t,previewURL:this.props.previewURL,highlightLint:this.state.highlightLint})]})}};f.defaultProps={developerMode:!1,jsonMode:!1,onChange:()=>{}};let c=f;c.__docgenInfo={description:"",methods:[{name:"toggleJsonMode",docblock:null,modifiers:[],params:[],returns:null},{name:"updateRenderer",docblock:null,modifiers:[],params:[],returns:null},{name:"getApiOptions",docblock:null,modifiers:[],params:[],returns:{type:{name:"Readonly",elements:[{name:"intersection",raw:`APIOptions & {
