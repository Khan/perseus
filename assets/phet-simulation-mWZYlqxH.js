import{a as Ze,j as Z}from"./jsx-runtime-FVsy8kgq.js";import{r as a}from"./index-TT1qJ6UJ.js";import{l as w}from"./index-awljIyHI.js";import{m as et,c as tt,u as rt,a as nt,T as at,I as Ee,x as it}from"./index--wY930uG.js";import{a as c,_ as l,V as P}from"./index-6h5t6F0w.js";import{c as ae,L as ze,i as Pe,g as Le}from"./index-u34vH4Ah.js";import{C as st}from"./index-ngddCaVG.js";import{c as m,b as L,s as f,a as he,m as ye,f as Ae}from"./index-deFLJwr4.js";import{P as ot}from"./index-xuPsLuPk.js";import{e as lt,_ as Te}from"./arrow-square-out-bold-090vdhrx.js";import{b as ut}from"./index-h_CiYGGb.js";import{P as dt}from"./i18n-context-W41LcU6B.js";import{g as yt}from"./dependencies-8XILypbq.js";import"./version-akiLXZts.js";import{P as mt,E as gt}from"./perseus-error-l3K_anoI.js";import{P as ht}from"./index-tvtfaFq4.js";import{_ as X}from"./index-default-4_ZsnO94.js";import{s as Se}from"./constants-I_nlPaPx.js";const _e=["key","ref","containerSizeClass","widgetId","onChange","problemNum","apiOptions","questionCompleted","findWidgets","onRemove","id","onBlur","onFocus","trackInteraction","keypadElement"],gn=n=>{const e={...n};for(const t of _e)t in e&&delete e[t];return e},ct=`Usage:
  this.change({propName: 5}, callback);
  this.change("propName", 5, callback);
  this.change("propName")`,$e=function(n,e,t){const i=X.omit(n.props,_e),r=X.extend(i,e);n.props.onChange(r,t)},Fe=function(n,e,t,i){if(t===void 0)return X.partial(Fe,n,e);const r={};r[e]=t,$e(n,r,i)},pt=function(n,e,t){if(X.isObject(n)&&t===void 0)return t=e,$e(this,n,t);if(typeof n=="string")return Fe(this,n,e,t);throw new mt("Invalid types sent to this.change(): "+X.toArray(arguments).join()+`
`+ct,gt.Internal)},hn={onChange:ht.func.isRequired};function De(n){const e=[];if(n)if(Array.isArray(n))for(const t of n)e.push(...De(t));else e.push(n);else return e;return e}function Ue(n){const e=[],t=[];if(!n)return{style:{},className:""};const i=typeof global<"u"&&global.SNAPSHOT_INLINE_APHRODITE;De(n).forEach(s=>{const o=s._definition;if(o!=null)if(i){const u={};for(const[d,y]of Object.entries(o))u[d.replace(/-[a-z]/g,h=>h[1].toUpperCase())]=y;t.push(u)}else e.push(s);else t.push(s)});const r=Object.assign({},...t);if(t.length>0&&!i){const s=w.StyleSheet.create({inlineStyles:r});e.push(s.inlineStyles)}return{style:i?r:{},className:w.css(...e)}}const bt=["children","style","tag","testId"],ft=/^h[1-6]$/,Re=w.StyleSheet.create({text:{WebkitFontSmoothing:"antialiased",MozOsxFontSmoothing:"grayscale"},header:{marginTop:0,marginBottom:0}}),O=a.forwardRef(function(e,t){let{children:i,style:r,tag:s="span",testId:o}=e,u=c(e,bt);const d=ft.test(s),y=Ue([Re.text,d&&Re.header,r]),h=u.className?[u.className,y.className].join(" "):y.className;return a.createElement(s,l({},u,{style:y.style,className:h,"data-testid":o,ref:t}),i)}),vt=["className","style"];function D(n,e){return a.forwardRef((t,i)=>{const{className:r,style:s}=t,o=c(t,vt),u=typeof n=="string"?wt[n]:null,{className:d,style:y}=Ue([u,e,s]);return a.createElement(n,l({},o,{ref:i,className:[d,r].filter(Boolean).join(" "),style:y}))})}const wt=w.StyleSheet.create({button:{margin:0,"::-moz-focus-inner":{border:0}}}),kt=["testId","tag"],J=w.StyleSheet.create({default:{alignItems:"stretch",borderWidth:0,borderStyle:"solid",boxSizing:"border-box",display:"flex",flexDirection:"column",margin:0,padding:0,position:"relative",zIndex:0,minHeight:0,minWidth:0}}),qt=D("div",J.default),At=D("article",J.default),Tt=D("aside",J.default),Rt=D("nav",J.default),xt=D("section",J.default),xe=a.forwardRef(function(e,t){const{testId:i,tag:r="div"}=e,s=c(e,kt),o=l({},s,{"data-testid":i});switch(r){case"article":return a.createElement(At,l({},o,{ref:t}));case"aside":return a.createElement(Tt,l({},o,{ref:t}));case"nav":return a.createElement(Rt,l({},o,{ref:t}));case"section":return a.createElement(xt,l({},o,{ref:t}));case"div":return a.createElement(qt,l({},o,{ref:t}));default:throw Error(`${r} is not an allowed value for the 'tag' prop`)}});let M=function(n){return n.Root="root",n.Initial="initial",n.Standard="standard",n}({});const te=a.createContext(M.Root);te.displayName="RenderStateContext";let Ot=class extends a.Component{constructor(...e){super(...e),this.state={mounted:!1},this._isTheRootComponent=!1}componentDidMount(){this._isTheRootComponent&&this.setState({mounted:!0})}_renderAsRootComponent(){const{mounted:e}=this.state,{children:t,fallback:i}=this.props;return this._isTheRootComponent=!0,e?a.createElement(te.Provider,{value:M.Standard},t()):i?a.createElement(te.Provider,{value:M.Initial},i()):null}_maybeRender(e){const{children:t,fallback:i}=this.props;switch(e){case M.Root:return this._renderAsRootComponent();case M.Initial:return i?i():null;case M.Standard:return t()}{var r;return console.log(`We got a render state we don't understand: "${(r=JSON.stringify(e))!=null?r:""}"`),this._maybeRender(M.Root)}}render(){return a.createElement(te.Consumer,null,e=>this._maybeRender(e))}},Me=class He{constructor(e){this._uniqueFactoryName=void 0,this.get=i=>{const r=i.toLowerCase();if(!this._hasValidIdChars(i))throw new Error(`Invalid identifier key: ${i}`);return`${this._uniqueFactoryName}-${r}`},e=typeof e=="string"?e:"";const t=e.toLowerCase();if(!this._hasValidIdChars(t))throw new Error(`Invalid factory scope: ${e}`);this._uniqueFactoryName=`uid-${t}-${He._factoryUniquenessCounter++}`}_hasValidIdChars(e){return typeof e=="string"?!/\s/.test(e):!1}};Me._factoryUniquenessCounter=0;let ce=class{get(e){return e}};ce.Default=new ce;var Wt=ce.Default;let jt=class extends a.Component{constructor(...e){super(...e),this._idFactory=void 0}_performRender(e){const{children:t,mockOnFirstRender:i,scope:r}=this.props;return e?i?t(Wt):null:(this._idFactory||(this._idFactory=new Me(r)),t(this._idFactory))}render(){return a.createElement(Ot,{fallback:()=>this._performRender(!0)},()=>this._performRender(!1))}},It=class Ve extends a.Component{renderChildren(e){const{id:t,children:i}=this.props,r=e?e.get(Ve.defaultId):t;if(!r)throw new Error("Did not get an identifier factory nor a id prop");return i(r)}render(){const{id:e,scope:t}=this.props;return e?this.renderChildren():a.createElement(jt,{scope:t,mockOnFirstRender:!0},i=>this.renderChildren(i))}};It.defaultId="wb-id";const $=400,B=700,Nt=900,me="@media (max-width: 1023px)",ge="@media (min-width: 1024px)",x={display:"block"},N='Lato, "Noto Sans", sans-serif',Oe='"Noto Serif", serif',Ct="Inconsolata, monospace",W=w.StyleSheet.create({Title:l({},x,{fontFamily:N,fontWeight:Nt,[ge]:{fontSize:36,lineHeight:"40px"},[me]:{fontSize:28,lineHeight:"32px"}}),Tagline:l({},x,{fontFamily:N,fontWeight:$,fontSize:20,lineHeight:"24px"}),HeadingLarge:l({},x,{fontFamily:N,fontWeight:B,[ge]:{fontSize:28,lineHeight:"32px"},[me]:{fontSize:24,lineHeight:"28px"}}),HeadingMedium:l({},x,{fontFamily:N,fontWeight:B,[ge]:{fontSize:24,lineHeight:"28px"},[me]:{fontSize:22,lineHeight:"26px"}}),HeadingSmall:l({},x,{fontFamily:N,fontWeight:B,fontSize:20,lineHeight:"24px"}),HeadingXSmall:l({},x,{fontFamily:N,fontWeight:B,fontSize:12,lineHeight:"16px",letterSpacing:.6,textTransform:"uppercase"}),BodySerifBlock:l({},x,{fontFamily:Oe,fontWeight:$,fontSize:22,lineHeight:"28px"}),BodySerif:l({},x,{fontFamily:Oe,fontWeight:$,fontSize:18,lineHeight:"22px"}),BodyMonospace:l({},x,{fontFamily:Ct,fontWeight:$,fontSize:17,lineHeight:"22px"}),Body:l({},x,{fontFamily:N,fontWeight:$,fontSize:16,lineHeight:"22px"}),LabelLarge:l({},x,{fontFamily:N,fontWeight:B,fontSize:16,lineHeight:"20px"}),LabelMedium:l({},x,{fontFamily:N,fontWeight:$,fontSize:16,lineHeight:"20px"}),LabelSmall:l({},x,{fontFamily:N,fontWeight:$,fontSize:14,lineHeight:"18px"}),LabelXSmall:l({},x,{fontFamily:N,fontWeight:$,fontSize:12,lineHeight:"16px"}),Caption:l({},x,{fontFamily:N,fontWeight:$,fontSize:14,lineHeight:"20px"}),Footnote:l({},x,{fontFamily:N,fontWeight:$,fontSize:12,lineHeight:"18px"})}),Et=["style","children","tag"];a.forwardRef(function(e,t){let{style:i,children:r,tag:s="h1"}=e,o=c(e,Et);return a.createElement(O,l({},o,{tag:s,style:[W.Title,i],ref:t}),r)});const zt=["style","children","tag"];a.forwardRef(function(e,t){let{style:i,children:r,tag:s="h2"}=e,o=c(e,zt);return a.createElement(O,l({},o,{tag:s,style:[W.HeadingLarge,i],ref:t}),r)});const Pt=["style","children","tag"];a.forwardRef(function(e,t){let{style:i,children:r,tag:s="h3"}=e,o=c(e,Pt);return a.createElement(O,l({},o,{tag:s,style:[W.HeadingMedium,i],ref:t}),r)});const Lt=["style","children","tag"];a.forwardRef(function(e,t){let{style:i,children:r,tag:s="h4"}=e,o=c(e,Lt);return a.createElement(O,l({},o,{tag:s,style:[W.HeadingSmall,i],ref:t}),r)});const St=["style","children","tag"];a.forwardRef(function(e,t){let{style:i,children:r,tag:s="h4"}=e,o=c(e,St);return a.createElement(O,l({},o,{tag:s,style:[W.HeadingXSmall,i],ref:t}),r)});const _t=["style","children","tag"];a.forwardRef(function(e,t){let{style:i,children:r,tag:s="span"}=e,o=c(e,_t);return a.createElement(O,l({},o,{tag:s,style:[W.BodySerifBlock,i],ref:t}),r)});const $t=["style","children","tag"];a.forwardRef(function(e,t){let{style:i,children:r,tag:s="span"}=e,o=c(e,$t);return a.createElement(O,l({},o,{tag:s,style:[W.BodySerif,i],ref:t}),r)});const Ft=["style","children","tag"];a.forwardRef(function(e,t){let{style:i,children:r,tag:s="span"}=e,o=c(e,Ft);return a.createElement(O,l({},o,{tag:s,style:[W.BodyMonospace,i],ref:t}),r)});const Dt=["style","children","tag"];a.forwardRef(function(e,t){let{style:i,children:r,tag:s="span"}=e,o=c(e,Dt);return a.createElement(O,l({},o,{tag:s,style:[W.Body,i],ref:t}),r)});const Ut=["style","children","tag"],Mt=a.forwardRef(function(e,t){let{style:i,children:r,tag:s="span"}=e,o=c(e,Ut);return a.createElement(O,l({},o,{tag:s,style:[W.LabelLarge,i],ref:t}),r)}),Ht=["style","children","tag"];a.forwardRef(function(e,t){let{style:i,children:r,tag:s="span"}=e,o=c(e,Ht);return a.createElement(O,l({},o,{tag:s,style:[W.LabelMedium,i],ref:t}),r)});const Vt=["style","children","tag"],Gt=a.forwardRef(function(e,t){let{style:i,children:r,tag:s="span"}=e,o=c(e,Vt);return a.createElement(O,l({},o,{tag:s,style:[W.LabelSmall,i],ref:t}),r)}),Bt=["style","children","tag"];a.forwardRef(function(e,t){let{style:i,children:r,tag:s="span"}=e,o=c(e,Bt);return a.createElement(O,l({},o,{tag:s,style:[W.LabelXSmall,i],ref:t}),r)});const Kt=["style","children","tag"];a.forwardRef(function(e,t){let{style:i,children:r,tag:s="span"}=e,o=c(e,Kt);return a.createElement(O,l({},o,{tag:s,style:[W.Tagline,i],ref:t}),r)});const Xt=["style","children","tag"];a.forwardRef(function(e,t){let{style:i,children:r,tag:s="span"}=e,o=c(e,Xt);return a.createElement(O,l({},o,{tag:s,style:[W.Caption,i],ref:t}),r)});const Jt=["style","children","tag"];a.forwardRef(function(e,t){let{style:i,children:r,tag:s="span"}=e,o=c(e,Jt);return a.createElement(O,l({},o,{tag:s,style:[W.Footnote,i],ref:t}),r)});const Qt=n=>({small:16,medium:24,large:48,xlarge:96})[n],Yt=["color","icon","size","style","testId","className"],Zt=D("span"),pe=a.forwardRef(function(e,t){const{color:i="currentColor",icon:r,size:s="small",style:o,testId:u,className:d}=e,y=c(e,Yt),h=Qt(s),p=`${d??""}`,g=er(i,h);return a.createElement(Zt,l({},y,{className:p,style:[be.svg,g.icon,{maskImage:`url(${r})`},o],"data-testid":u,ref:t}))}),We={},er=(n,e)=>{const t=`${n}-${e}`;if(be[t])return be[t];const i={icon:{backgroundColor:n,width:e,height:e}};return We[t]=w.StyleSheet.create(i),We[t]},be=w.StyleSheet.create({svg:{display:"inline-block",verticalAlign:"text-bottom",flexShrink:0,flexGrow:0,maskSize:"100%",maskRepeat:"no-repeat",maskPosition:"center"}});pe.displayName="PhosphorIcon";const ie={color:{bg:{action:{default:m.blue,active:m.activeBlue,inverse:m.fadedBlue},critical:{default:m.red,active:m.activeRed,inverse:m.fadedRed},primary:{default:m.white,disabled:m.offBlack32,inverse:m.darkBlue},secondary:{default:"none",inverse:"none",focus:m.white,active:{action:m.fadedBlue,critical:m.fadedRed}},tertiary:{hover:m.white},icon:{secondaryHover:"transparent"}},text:{disabled:m.offBlack32,inverse:m.white,primary:{disabled:m.white64},secondary:{inverse:m.white50},icon:{secondaryHover:"inherit"}},border:{disabled:m.offBlack32,primary:{inverse:m.white},secondary:{action:m.offBlack50,critical:m.offBlack50,inverse:m.white50},tertiary:{inverse:m.white}}},border:{width:{secondary:L.width.hairline,focused:L.width.thin,disabled:L.width.thin},radius:{default:L.radius.medium_4,tertiary:L.radius.xSmall_2,small:L.radius.medium_4,large:L.radius.large_6,icon:L.radius.full}},size:{height:{tertiaryHover:f.xxxxSmall_2,small:f.xLarge_32,medium:40,large:56}},margin:{icon:{offset:-f.xxxxSmall_2}},padding:{xsmall:f.xxxxSmall_2,small:f.xxSmall_6,medium:f.small_12,large:f.medium_16,xLarge:f.xLarge_32},font:{size:{large:18},lineHeight:{large:he.lineHeight.medium},weight:{default:he.weight.bold}}},tr=et(ie,{color:{bg:{secondary:{default:m.offWhite,active:{action:m.fadedBlue8,critical:m.fadedRed8},focus:m.offWhite},icon:{secondaryHover:m.fadedBlue16}},border:{secondary:{action:m.fadedBlue,critical:m.fadedRed}},text:{icon:{secondaryHover:m.blue}}},border:{radius:{default:L.radius.xLarge_12,small:L.radius.large_6,large:L.radius.xLarge_12},width:{focused:L.width.hairline}},margin:{icon:{offset:-f.xSmall_8}},font:{weight:{default:he.weight.regular}}}),rr={default:ie,khanmigo:tr},Ge=tt(ie);function nr(n){const e=a.useContext(at),t=rr[e]||ie;return a.createElement(Ge.Provider,{value:t},n.children)}function je({icon:n,size:e,style:t,testId:i}){const r={"aria-hidden":!0,color:"currentColor",style:t,testId:i};switch(e){case"small":return a.createElement(pe,l({},r,{size:"small",icon:n}));case"medium":default:return a.createElement(pe,l({},r,{size:"medium",icon:n}))}}const ar=["children","skipClientNav","color","disabled","focused","hovered","href","kind","labelStyle","light","pressed","size","style","testId","type","spinner","startIcon","endIcon","id","waiting"],ir=D("a"),sr=D("button"),or=D(ze),lr=a.forwardRef(function(e,t){const{theme:i,themeName:r}=rt(Ge),s=nt(ur,i),o=u=>{const{children:d,skipClientNav:y,color:h,disabled:p,focused:g,hovered:R,href:A=void 0,kind:v="primary",labelStyle:C,light:E=!1,pressed:k,size:q="medium",style:F,testId:b,type:T=void 0,spinner:j,startIcon:S,endIcon:V,id:oe}=e,le=c(e,ar),z=dr(h,v,E,q,i,r),_=j||p,Y=[s.shared,_&&s.disabled,S&&s.withStartIcon,V&&s.withEndIcon,z.default,_&&z.disabled,v!=="tertiary"&&!_&&(k?z.active:(R||g)&&z.focus),v==="tertiary"&&!k&&g&&[z.focus,_&&z.disabledFocus],q==="small"&&s.small,q==="large"&&s.large],ue=l({"data-testid":b,id:oe,role:"button",style:[Y,F]},le),Je=q==="small"?Gt:Mt,Qe=a.createElement(Je,{style:[s.text,q==="large"&&s.largeText,C,j&&s.hiddenText,v==="tertiary"&&s.textWithFocus,v==="tertiary"&&!_&&(k?[z.hover,z.active]:R&&z.hover)],testId:b?`${b}-inner-label`:void 0},d),Ye={medium:"small",small:"xsmall",large:"medium"},qe=q==="small"?"small":"medium",de=a.createElement(a.Fragment,null,S&&a.createElement(xe,{style:s.iconWrapper},a.createElement(je,{size:qe,icon:S,style:[s.startIcon,v==="tertiary"&&s.tertiaryStartIcon],testId:b?`${b}-start-icon`:void 0})),Qe,j&&a.createElement(st,{style:s.spinner,size:Ye[q],light:v==="primary",testId:`${b||"button"}-spinner`}),V&&a.createElement(xe,{testId:b?`${b}-end-icon-wrapper`:void 0,style:[K.endIcon,s.iconWrapper,s.endIconWrapper,v==="tertiary"&&s.endIconWrapperTertiary,(g||R)&&v!=="primary"&&s.iconWrapperSecondaryHovered]},a.createElement(je,{size:qe,icon:V,testId:b?`${b}-end-icon`:void 0})));return A&&!_?u&&!y&&Pe(A)?a.createElement(or,l({},ue,{to:A,ref:t}),de):a.createElement(ir,l({},ue,{href:A,ref:t}),de):a.createElement(sr,l({type:T||"button"},ue,{"aria-disabled":_,ref:t}),de)};return a.createElement(ae.Consumer,null,u=>o(u))}),ur=n=>({shared:{position:"relative",display:"inline-flex",alignItems:"center",justifyContent:"center",height:n.size.height.medium,paddingTop:0,paddingBottom:0,paddingLeft:n.padding.large,paddingRight:n.padding.large,border:"none",borderRadius:n.border.radius.default,cursor:"pointer",outline:"none",textDecoration:"none",boxSizing:"border-box",touchAction:"manipulation",userSelect:"none",":focus":{WebkitTapHighlightColor:"rgba(0,0,0,0)"}},disabled:{cursor:"auto"},small:{borderRadius:n.border.radius.small,height:n.size.height.small},large:{borderRadius:n.border.radius.large,height:n.size.height.large},text:{alignItems:"center",fontWeight:n.font.weight.default,whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis",display:"inline-block",pointerEvents:"none"},largeText:{fontSize:n.font.size.large,lineHeight:`${n.font.lineHeight.large}px`},textWithFocus:{position:"relative"},hiddenText:{visibility:"hidden"},spinner:{position:"absolute"},startIcon:{marginRight:n.padding.small,marginLeft:n.margin.icon.offset},tertiaryStartIcon:{marginLeft:0},endIcon:{marginLeft:n.padding.small},iconWrapper:{borderRadius:n.border.radius.icon,padding:n.padding.xsmall,minWidth:"auto"},iconWrapperSecondaryHovered:{backgroundColor:n.color.bg.icon.secondaryHover,color:n.color.text.icon.secondaryHover},endIconWrapper:{marginLeft:n.padding.small,marginRight:n.margin.icon.offset},endIconWrapperTertiary:{marginRight:0}}),K={},dr=(n="default",e,t,i,r,s)=>{const o=n==="destructive"?r.color.bg.critical.default:r.color.bg.action.default,u=`${o}-${e}-${t}-${i}-${s}`;if(K[u])return K[u];const d=n==="destructive"?r.color.bg.critical.inverse:r.color.bg.action.inverse,y=n==="destructive"?r.color.bg.critical.active:r.color.bg.action.active,h=i==="large"?r.padding.xLarge:r.padding.large;let p={};if(e==="primary"){const g=t?r.color.bg.primary.inverse:r.color.bg.primary.default;p={default:{background:t?r.color.bg.primary.default:o,color:t?o:r.color.text.inverse,paddingLeft:h,paddingRight:h},focus:{boxShadow:`0 0 0 1px ${g}, 0 0 0 3px ${t?r.color.bg.primary.default:o}`},active:{boxShadow:`0 0 0 1px ${g}, 0 0 0 3px ${t?d:y}`,background:t?d:y,color:t?y:d},disabled:{background:t?d:r.color.bg.primary.disabled,color:t?o:r.color.text.primary.disabled,cursor:"default",":focus":{boxShadow:`0 0 0 1px ${t?r.color.bg.primary.disabled:r.color.bg.primary.default}, 0 0 0 3px ${t?d:r.color.bg.primary.disabled}`}}}}else if(e==="secondary"){const g=n==="destructive"?r.color.border.secondary.critical:r.color.border.secondary.action,R=n==="destructive"?r.color.bg.secondary.active.critical:r.color.bg.secondary.active.action;p={default:{background:t?r.color.bg.secondary.inverse:r.color.bg.secondary.default,color:t?r.color.text.inverse:o,borderColor:t?r.color.border.secondary.inverse:g,borderStyle:"solid",borderWidth:r.border.width.secondary,paddingLeft:h,paddingRight:h},focus:{background:t?r.color.bg.secondary.inverse:r.color.bg.secondary.focus,borderColor:"transparent",outlineColor:t?r.color.border.primary.inverse:o,outlineStyle:"solid",outlineWidth:r.border.width.focused},active:{background:t?y:R,color:t?d:y,borderColor:"transparent",outlineColor:t?d:y,outlineStyle:"solid",outlineWidth:r.border.width.focused},disabled:{color:t?r.color.text.secondary.inverse:r.color.text.disabled,outlineColor:t?d:r.color.border.disabled,cursor:"default",":focus":{outlineColor:t?r.color.border.secondary.inverse:r.color.border.disabled,outlineStyle:"solid",outlineWidth:r.border.width.disabled}}}}else if(e==="tertiary")p={default:{background:"none",color:t?r.color.text.inverse:o,paddingLeft:0,paddingRight:0},hover:{":after":{content:"''",position:"absolute",height:r.size.height.tertiaryHover,width:"100%",right:0,bottom:0,background:t?r.color.bg.tertiary.hover:o,borderRadius:r.border.radius.tertiary}},focus:{outlineStyle:"solid",outlineColor:t?r.color.border.tertiary.inverse:o,outlineWidth:r.border.width.focused,borderRadius:r.border.radius.default},active:{color:t?d:y,":after":{height:r.size.height.tertiaryHover,background:t?d:y}},disabled:{color:t?d:r.color.text.disabled,cursor:"default"},disabledFocus:{outlineColor:t?r.color.border.tertiary.inverse:r.color.border.disabled}};else throw new Error("Button kind not recognized");return K[u]=w.StyleSheet.create(p),K[u]},yr=["href","type","children","skipClientNav","onClick","beforeNav","safeWithNav","tabIndex","target","rel","color","kind","light","size","disabled","spinner"],mr=a.forwardRef(function(e,t){const{href:i=void 0,type:r=void 0,children:s,skipClientNav:o,onClick:u,beforeNav:d=void 0,safeWithNav:y=void 0,tabIndex:h,target:p,rel:g,color:R="default",kind:A="primary",light:v=!1,size:C="medium",disabled:E=!1,spinner:k=!1}=e,q=c(e,yr),F=b=>{const T=Le(i,o,b),j=(S,V)=>a.createElement(lr,l({},q,S,V,{disabled:E,spinner:k||S.waiting,color:R,kind:A,light:v,size:C,skipClientNav:o,href:i,target:p,type:r,tabIndex:h,ref:t}),s);return d?a.createElement(T,{disabled:k||E,href:i,role:"button",type:r,onClick:u,beforeNav:d,safeWithNav:y,rel:g},j):a.createElement(T,{disabled:k||E,href:i,role:"button",type:r,onClick:u,safeWithNav:y,target:p,rel:g},j)};return a.createElement(nr,null,a.createElement(ae.Consumer,null,b=>F(b)))});function Be(n){const e=[];if(n)if(Array.isArray(n))for(const t of n)e.push(...Be(t));else e.push(n);else return e;return e}function Ke(n){const e=[],t=[];if(!n)return{style:{},className:""};const i=typeof global<"u"&&global.SNAPSHOT_INLINE_APHRODITE;Be(n).forEach(s=>{const o=s._definition;if(o!=null)if(i){const u={};for(const[d,y]of Object.entries(o))u[d.replace(/-[a-z]/g,h=>h[1].toUpperCase())]=y;t.push(u)}else e.push(s);else t.push(s)});const r=Object.assign({},...t);if(t.length>0&&!i){const s=w.StyleSheet.create({inlineStyles:r});e.push(s.inlineStyles)}return{style:i?r:{},className:w.css(...e)}}const gr=["children","style","tag","testId"],hr=/^h[1-6]$/,Ie=w.StyleSheet.create({text:{WebkitFontSmoothing:"antialiased",MozOsxFontSmoothing:"grayscale"},header:{marginTop:0,marginBottom:0}});a.forwardRef(function(e,t){let{children:i,style:r,tag:s="span",testId:o}=e,u=c(e,gr);const d=hr.test(s),y=Ke([Ie.text,d&&Ie.header,r]),h=u.className?[u.className,y.className].join(" "):y.className;return a.createElement(s,l({},u,{style:y.style,className:h,"data-testid":o,ref:t}),i)});const cr=["className","style"];function U(n,e){return a.forwardRef((t,i)=>{const{className:r,style:s}=t,o=c(t,cr),u=typeof n=="string"?pr[n]:null,{className:d,style:y}=Ke([u,e,s]);return a.createElement(n,l({},o,{ref:i,className:[d,r].filter(Boolean).join(" "),style:y}))})}const pr=w.StyleSheet.create({button:{margin:0,"::-moz-focus-inner":{border:0}}}),br=["testId","tag"],Q=w.StyleSheet.create({default:{alignItems:"stretch",borderWidth:0,borderStyle:"solid",boxSizing:"border-box",display:"flex",flexDirection:"column",margin:0,padding:0,position:"relative",zIndex:0,minHeight:0,minWidth:0}}),fr=U("div",Q.default),vr=U("article",Q.default),wr=U("aside",Q.default),kr=U("nav",Q.default),qr=U("section",Q.default);a.forwardRef(function(e,t){const{testId:i,tag:r="div"}=e,s=c(e,br),o=l({},s,{"data-testid":i});switch(r){case"article":return a.createElement(vr,l({},o,{ref:t}));case"aside":return a.createElement(wr,l({},o,{ref:t}));case"nav":return a.createElement(kr,l({},o,{ref:t}));case"section":return a.createElement(qr,l({},o,{ref:t}));case"div":return a.createElement(fr,l({},o,{ref:t}));default:throw Error(`${r} is not an allowed value for the 'tag' prop`)}});let H=function(n){return n.Root="root",n.Initial="initial",n.Standard="standard",n}({});const re=a.createContext(H.Root);re.displayName="RenderStateContext";class Ar extends a.Component{constructor(...e){super(...e),this.state={mounted:!1},this._isTheRootComponent=!1}componentDidMount(){this._isTheRootComponent&&this.setState({mounted:!0})}_renderAsRootComponent(){const{mounted:e}=this.state,{children:t,fallback:i}=this.props;return this._isTheRootComponent=!0,e?a.createElement(re.Provider,{value:H.Standard},t()):i?a.createElement(re.Provider,{value:H.Initial},i()):null}_maybeRender(e){const{children:t,fallback:i}=this.props;switch(e){case H.Root:return this._renderAsRootComponent();case H.Initial:return i?i():null;case H.Standard:return t()}{var r;return console.log(`We got a render state we don't understand: "${(r=JSON.stringify(e))!=null?r:""}"`),this._maybeRender(H.Root)}}render(){return a.createElement(re.Consumer,null,e=>this._maybeRender(e))}}class se{constructor(e){this._uniqueFactoryName=void 0,this.get=i=>{const r=i.toLowerCase();if(!this._hasValidIdChars(i))throw new Error(`Invalid identifier key: ${i}`);return`${this._uniqueFactoryName}-${r}`},e=typeof e=="string"?e:"";const t=e.toLowerCase();if(!this._hasValidIdChars(t))throw new Error(`Invalid factory scope: ${e}`);this._uniqueFactoryName=`uid-${t}-${se._factoryUniquenessCounter++}`}_hasValidIdChars(e){return typeof e=="string"?!/\s/.test(e):!1}}se._factoryUniquenessCounter=0;class fe{get(e){return e}}fe.Default=new fe;var Tr=fe.Default;class Rr extends a.Component{constructor(...e){super(...e),this._idFactory=void 0}_performRender(e){const{children:t,mockOnFirstRender:i,scope:r}=this.props;return e?i?t(Tr):null:(this._idFactory||(this._idFactory=new se(r)),t(this._idFactory))}render(){return a.createElement(Ar,{fallback:()=>this._performRender(!0)},()=>this._performRender(!1))}}class we extends a.Component{renderChildren(e){const{id:t,children:i}=this.props,r=e?e.get(we.defaultId):t;if(!r)throw new Error("Did not get an identifier factory nor a id prop");return i(r)}render(){const{id:e,scope:t}=this.props;return e?this.renderChildren():a.createElement(Rr,{scope:t,mockOnFirstRender:!0},i=>this.renderChildren(i))}}we.defaultId="wb-id";const xr=n=>({small:16,medium:24,large:48,xlarge:96})[n],Or=["color","icon","size","style","testId","className"],Wr=U("span"),Xe=a.forwardRef(function(e,t){const{color:i="currentColor",icon:r,size:s="small",style:o,testId:u,className:d}=e,y=c(e,Or),h=xr(s),p=`${d??""}`,g=jr(i,h);return a.createElement(Wr,l({},y,{className:p,style:[ve.svg,g.icon,{maskImage:`url(${r})`},o],"data-testid":u,ref:t}))}),Ne={},jr=(n,e)=>{const t=`${n}-${e}`;if(ve[t])return ve[t];const i={icon:{backgroundColor:n,width:e,height:e}};return Ne[t]=w.StyleSheet.create(i),Ne[t]},ve=w.StyleSheet.create({svg:{display:"inline-block",verticalAlign:"text-bottom",flexShrink:0,flexGrow:0,maskSize:"100%",maskRepeat:"no-repeat",maskPosition:"center"}});Xe.displayName="PhosphorIcon";const Ir=["children","skipClientNav","focused","hovered","href","inline","kind","light","visitable","pressed","style","testId","waiting","target","startIcon","endIcon"],Nr=U("a"),Cr=U(ze),Ce=a.forwardRef(function(e,t){const i=r=>{const{children:s,skipClientNav:o,focused:u,hovered:d,href:y,inline:h=!1,kind:p="primary",light:g=!1,visitable:R=!1,pressed:A,style:v,testId:C,target:E,startIcon:k,endIcon:q}=e,F=c(e,Ir),b=zr(h,p,g,R),T=h?b.restingInline:b.resting,j=[Er.shared,T,A&&b.active,!A&&d&&b.hover,!A&&u&&b.focus],S=l({"data-testid":C,style:[j,v],target:E},F),oe=new URL(y,window.location.origin).origin!==window.location.origin,le=a.createElement(Xe,{icon:lt,size:"small",style:[G.endIcon,G.centered],testId:"external-icon"});let z,_;k&&(z=a.cloneElement(k,l({style:[G.startIcon,G.centered],testId:"start-icon","aria-hidden":"true"},k.props))),q&&(_=a.cloneElement(q,l({style:[G.endIcon,G.centered],testId:"end-icon","aria-hidden":"true"},q.props)));const Y=a.createElement(a.Fragment,null,k&&z,s,q?_:oe&&E==="_blank"&&le);return r&&!o&&Pe(y)?a.createElement(Cr,l({},S,{to:y,ref:t}),Y):a.createElement(Nr,l({},S,{href:y,ref:t}),Y)};return a.createElement(ae.Consumer,null,r=>i(r))}),ee={},G=w.StyleSheet.create({startIcon:{marginInlineEnd:f.xxxSmall_4},endIcon:{marginInlineStart:f.xxxSmall_4},centered:{verticalAlign:"-10%"}}),Er=w.StyleSheet.create({shared:{cursor:"pointer",textDecoration:"none",outline:"none",alignItems:"center"}}),zr=(n,e,t,i)=>{const r=`${e}-${n.toString()}-${t.toString()}-${i.toString()}`;if(ee[r])return ee[r];if(e==="secondary"&&t)throw new Error("Secondary Light links are not supported");if(i&&e!=="primary")throw new Error("Only primary link is visitable");const{blue:s,purple:o,white:u,offBlack:d,offBlack32:y,offBlack64:h}=m,p="#fa50ae",g=ye(Ae(d,.08),o),R=m.fadedBlue,A=ye(Ae(u,.32),p),v=m.activeBlue,k=e==="primary"?t?u:s:n?d:h,b=e==="primary"?t?R:v:n?v:d,T=i?{":visited":{color:t?p:g}}:Object.freeze({}),j=i?{":visited":{color:t?A:ye(y,g)}}:Object.freeze({}),S={resting:l({color:k},T),restingInline:l({color:k,textDecoration:"underline currentcolor solid",textUnderlineOffset:2},T),hover:l({textDecoration:"underline currentcolor solid",color:k},T),focus:{":focus-visible":l({color:k,outline:`1px solid ${t?u:s}`,borderRadius:3},T)},active:l({color:b,textDecoration:"underline currentcolor solid"},j)};return ee[r]=w.StyleSheet.create(S),ee[r]},Pr=["onClick","beforeNav","safeWithNav","href","skipClientNav","children","tabIndex","onKeyDown","onKeyUp","target","inline","kind","light","visitable"],Lr=a.forwardRef(function(e,t){const{onClick:i,beforeNav:r=void 0,safeWithNav:s,href:o,skipClientNav:u,children:d,tabIndex:y,onKeyDown:h,onKeyUp:p,target:g=void 0,inline:R=!1,kind:A="primary",light:v=!1,visitable:C=!1}=e,E=c(e,Pr),k=q=>{const F=Le(o,u,q);return r?a.createElement(F,{disabled:!1,href:o,role:"link",onClick:i,beforeNav:r,safeWithNav:s,onKeyDown:h,onKeyUp:p},(b,T)=>{let j=l({},(Te(T),T));return a.createElement(Ce,l({},E,b,j,{skipClientNav:u,href:o,target:g,tabIndex:y,inline:R,kind:A,light:v,visitable:C,ref:t}),d)}):a.createElement(F,{disabled:!1,href:o,role:"link",onClick:i,safeWithNav:s,target:g,onKeyDown:h,onKeyUp:p},(b,T)=>{let j=l({},(Te(T),T));return a.createElement(Ce,l({},E,b,j,{skipClientNav:u,href:o,target:g,tabIndex:y,inline:R,kind:A,light:v,visitable:C,ref:t}),d)})};return a.createElement(ae.Consumer,null,q=>k(q))}),Sr=""+new URL("info-vUJD1n-8.svg",import.meta.url).href,_r=""+new URL("smiley-xdY6f5H9.svg",import.meta.url).href,$r=""+new URL("warning-ctw6EWuu.svg",import.meta.url).href,Fr=""+new URL("warning-circle-OrBK1ju8.svg",import.meta.url).href,Dr=n=>{switch(n){case"success":return{color:m.green,icon:_r,role:"status"};case"warning":return{color:m.gold,icon:$r,role:"alert",ariaLive:"polite"};case"critical":return{color:m.red,icon:Fr,role:"alert"};default:return{color:m.blue,icon:Sr,role:"status"}}},Ur=n=>{const{actions:e,"aria-label":t,dismissAriaLabel:i="Dismiss banner.",onDismiss:r,kind:s="info",layout:o,text:u,testId:d,icon:y}=n,h=()=>e==null?void 0:e.filter(Boolean).map((g,R)=>{if(g.type==="custom")return a.createElement(P,{style:I.action,key:`custom-action-${R}`},g.node);const A=g.onClick;if(g.type==="link"){var v;return a.createElement(P,{style:I.action,key:g.title},a.createElement(Lr,{kind:"primary",href:g.href,onClick:A,"aria-label":(v=g.ariaLabel)!=null?v:g.title,style:I.link},g.title))}else{var C;return a.createElement(P,{style:I.action,key:g.title},a.createElement(mr,{kind:"tertiary",size:"small","aria-label":(C=g.ariaLabel)!=null?C:g.title,onClick:A},g.title))}}),p=Dr(s);return a.createElement(P,{style:[I.containerOuter,o==="floating"&&I.floatingBorder,{borderInlineStartColor:p.color}],role:p.role,"aria-label":t,"aria-live":p.ariaLive,testId:d},a.createElement(P,{style:[I.backgroundColor,{backgroundColor:p.color}]}),a.createElement(P,{style:I.containerInner},a.createElement(ot,{icon:y||p.icon,size:"medium",style:I.icon,"aria-label":s,testId:"banner-kind-icon",role:"img"}),a.createElement(P,{style:I.labelAndButtonsContainer},a.createElement(P,{style:I.labelContainer},a.createElement(ut,null,u)),e&&a.createElement(P,{style:I.actionsContainer},h())),r?a.createElement(P,{style:I.dismissContainer},a.createElement(Ee,{icon:it,kind:"tertiary",onClick:r,style:I.dismiss,"aria-label":i})):null))},I=w.StyleSheet.create({backgroundColor:{position:"absolute",top:0,bottom:0,left:0,right:0,opacity:.08},containerOuter:{borderInlineStartWidth:f.xxSmall_6,width:"100%",backgroundColor:m.white},containerInner:{flexDirection:"row",padding:f.xSmall_8},icon:{marginTop:f.xSmall_8,marginBottom:f.xSmall_8,marginInlineStart:f.xxxxSmall_2,marginInlineEnd:f.xSmall_8,alignSelf:"flex-start",color:m.offBlack64},labelAndButtonsContainer:{flex:1,flexDirection:"row",alignItems:"center",alignContent:"center",flexWrap:"wrap",justifyContent:"space-between"},labelContainer:{flexShrink:1,margin:f.xSmall_8,textAlign:"start",overflowWrap:"break-word"},actionsContainer:{flexDirection:"row",justifyContent:"flex-start",marginTop:f.xSmall_8,marginBottom:f.xSmall_8,height:18,alignItems:"center"},action:{marginLeft:f.xSmall_8,marginRight:f.xSmall_8,justifyContent:"center"},link:{fontSize:14},dismiss:{flexShrink:1},dismissContainer:{height:40,width:40,justifyContent:"center",alignItems:"center",marginLeft:f.xSmall_8,marginRight:f.xSmall_8},floatingBorder:{borderRadius:4,overflow:"hidden"}}),Mr="6px",fn=1e3,vn="#71B307",wn="#BED47A",kn="#314453",qn="#4D6779",An="#C42420",Tn="#4898FC",Rn="#46A8BF",xn="#00294A",Hr="#CCCCCC",Vr=""+new URL("corners-out-ZcPb1LY6.svg",import.meta.url).href,ke=class ke extends a.Component{constructor(e){super(e),this.iframeRef=a.createRef(),this.state={url:null,banner:null},this.change=(...t)=>pt.apply(this,t),this.getPhetCompatibleLocale=t=>{switch(t){case"pt-pt":return"pt";case"zh-hans":return"zh_CN";case"zh-hant":return"zh_TW";case"fa-af":return"fa_DA";default:return t}},this.displayLoadFailure=()=>{this.setState({url:null,banner:{message:this.context.strings.simulationLoadFail,kind:"critical"}})},this.locale=this.getPhetCompatibleLocale(yt().kaLocale)}async componentDidMount(){await this.updateSimState(this.props.url)}async componentDidUpdate(e){e.url!==this.props.url&&await this.updateSimState(this.props.url)}getUserInput(){return null}async updateSimState(e){const t=Gr(e,this.locale);if(t===null){this.displayLoadFailure();return}if(!(await fetch(t)).ok){this.displayLoadFailure();return}const r=await this.showLocaleWarning(t);this.setState({url:t,banner:r?{message:this.context.strings.simulationLocaleWarning,kind:"warning"}:null})}async showLocaleWarning(e){if(!e)return!1;const i=/https:\/\/phet\.colorado\.edu\/sims\/html\/([a-zA-Z0-9-]+)\/.*/g.exec(e.toString());if(i===null)return!1;const r=i[1],s=await fetch(`https://phet.colorado.edu/sims/html/${r}/latest/string-map.json`);if(!s.ok)return!1;let o;try{o=await s.json()}catch{return!1}const u=Object.keys(o),d=this.locale.split("_")[0];for(const y of u)if(d===y.split("_")[0])return!1;return!0}render(){var t;return Ze(P,{style:Br.container,children:[this.state.banner!==null&&Z(P,{style:{marginBottom:Se},children:Z(Ur,{layout:"floating",kind:this.state.banner.kind,text:this.state.banner.message})}),Z("iframe",{ref:this.iframeRef,title:this.props.description,sandbox:"allow-same-origin allow-scripts",style:{minWidth:400,height:360,width:"100%",borderWidth:0},src:(t=this.state.url)==null?void 0:t.toString(),allow:"fullscreen"}),Z(Ee,{icon:Vr,onClick:()=>{var i;(i=this.iframeRef.current)==null||i.requestFullscreen()},kind:"secondary","aria-label":"Fullscreen",style:{marginTop:5,marginBottom:5,alignSelf:"flex-end"},disabled:this.state.url===null})]})}};ke.contextType=dt;let ne=ke;const Gr=(n,e)=>{if(!URL.canParse(n))return null;const t=new URL(n);return t.origin!=="https://phet.colorado.edu"?null:(t.searchParams.set("locale",e),t)},Br=w.StyleSheet.create({container:{borderRadius:Mr,borderWidth:1,borderColor:Hr,padding:Se,paddingBottom:0,width:650}}),On={name:"phet-simulation",displayName:"PhET Simulation",widget:ne,hidden:!0,isLintable:!0};ne.__docgenInfo={description:"",methods:[{name:"getUserInput",docblock:null,modifiers:[],params:[],returns:{type:{name:"null"}}},{name:"change",docblock:null,modifiers:[],params:[{name:"...args",optional:!1,type:null}],returns:null},{name:"getPhetCompatibleLocale",docblock:null,modifiers:[],params:[{name:"kaLocale",optional:!1,type:null}],returns:null},{name:"displayLoadFailure",docblock:null,modifiers:[],params:[],returns:null},{name:"updateSimState",docblock:null,modifiers:["async"],params:[{name:"urlString",optional:!1,type:{name:"string"}}],returns:null},{name:"showLocaleWarning",docblock:null,modifiers:["async"],params:[{name:"url",optional:!1,type:{name:"URL",alias:"URL"}}],returns:{type:{name:"Promise",elements:[{name:"boolean"}],raw:"Promise<boolean>"}}}],displayName:"PhetSimulation",props:{widgetId:{required:!0,tsType:{name:"string"},description:""},alignment:{required:!0,tsType:{name:"union",raw:"string | null | undefined",elements:[{name:"string"},{name:"null"},{name:"undefined"}]},description:""},static:{required:!0,tsType:{name:"union",raw:"boolean | null | undefined",elements:[{name:"boolean"},{name:"null"},{name:"undefined"}]},description:""},problemNum:{required:!0,tsType:{name:"union",raw:"number | null | undefined",elements:[{name:"number"},{name:"null"},{name:"undefined"}]},description:""},apiOptions:{required:!0,tsType:{name:"Readonly",elements:[{name:"intersection",raw:`APIOptions & {
