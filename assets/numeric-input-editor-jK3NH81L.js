import{j as e}from"./jsx-runtime-63Ea5SlK.js";import{c as R}from"./article-renderer-jzdHncLR.js";import{_ as i}from"./jquery-yG1GhClm.js";import{U as j}from"./util-AYeX86gl.js";import"./phet-simulation-_7qOO4_B.js";import"./version-akiLXZts.js";import"./dependencies-CP7Uh8Kq.js";import"./perseus-api-1-ethIrW.js";import"./perseus-item-k3wxfYBT.js";import"./hints-renderer-qloNP0O2.js";import"./renderer-YHYhEo5S.js";import"./base-radio-lt6Z7E-w.js";import{c as E}from"./components-_HVRA9p2.js";import{i as C}from"./icon-paths-5JCXzGsq.js";import"./index-0C4KXdeC.js";import{P as F}from"./i18n-context-fsWEgybQ.js";import"./svg-image-ZjoZQGiG.js";import"./index-smZ6iCr_.js";import{E as q}from"./editor-jsonify-xum-79qA.js";import{C as f}from"./index-V5gl6frG.js";import{r as D}from"./index-6oxdNXpR.js";import{E as M}from"./editor-aAuETHJB.js";import{c as S}from"./icon-paths-EoBkHOLI.js";const{ButtonGroup:A,InfoTip:p,InlineIcon:k,MultiButtonGroup:G,NumberInput:b,TextInput:K}=E,{firstNumericalParse:N}=j,W=[{title:"Integers",value:"integer",content:"6"},{title:"Decimals",value:"decimal",content:"0.75"},{title:"Proper fractions",value:"proper",content:"⅗"},{title:"Improper fractions",value:"improper",content:"⁷⁄₄"},{title:"Mixed numbers",value:"mixed",content:"1¾"},{title:"Numbers with π",value:"pi",content:"π"}],y=P=>({value:null,status:P,message:"",simplify:"required",answerForms:[],strict:!1,maxError:null}),c=class c extends D.Component{constructor(l){super(l),this.change=(...t)=>R.apply(this,t),this.onToggleOptions=t=>{const a=this.state.showOptions.slice();a[t]=!a[t],this.setState({showOptions:a})},this.onTrashAnswer=t=>{if(t>=0&&t<this.props.answers.length){const a=this.props.answers.slice(0);a.splice(t,1),this.props.onChange({answers:a})}},this.onSpace=(t,a,...o)=>{t.key===" "&&(t.preventDefault(),a.apply(this,o))},this.onStatusChange=t=>{const a=["wrong","ungraded","correct"],o=this.props.answers,d=i.indexOf(a,o[t].status),u=a[(d+1)%a.length];this.updateAnswer(t,{status:u,simplify:u==="correct"?"required":"accepted"})},this.updateAnswer=(t,a)=>{if(!i.isObject(a))return i.partial((d,u,w)=>{const h={};h[u]=w,this.updateAnswer(d,h)},t,a);let o=[...this.props.answers];if(t===o.length){const d=y(this.state.lastStatus);o=o.concat(d)}o[t]=i.extend({},o[t],a),this.props.onChange({answers:o})},this.addAnswer=()=>{const t=y(this.state.lastStatus),a=this.props.answers.concat(t);this.props.onChange({answers:a})},this.getSaveWarnings=()=>{const t=[];return i.contains(i.pluck(this.props.answers,"value"),"")&&t.push("One or more answers is empty"),this.props.answers.forEach((a,o)=>{a.strict&&(!a.answerForms||a.answerForms.length===0)&&t.push(`Answer ${o+1} is set to string format matching, but no format was selected`)}),t},this.serialize=()=>q.serialize.call(this),this.state={lastStatus:"wrong",showOptions:i.map(this.props.answers,()=>!1)}}render(){const l=this.props.answers,t=n=>e.jsxs("div",{className:"perseus-widget-row",children:[e.jsx("label",{children:"Unsimplified answers are"}),e.jsx(A,{value:l[n].simplify,allowEmpty:!1,buttons:[{value:"required",content:"ungraded"},{value:"optional",content:"accepted"},{value:"enforced",content:"wrong"}],onChange:this.updateAnswer(n,"simplify")||(()=>{})}),e.jsxs(p,{children:[e.jsx("p",{children:'Normally select "ungraded". This will give the user a message saying the answer is correct but not simplified. The user will then have to simplify it and re-enter, but will not be penalized. (5th grade and after)'}),e.jsx("p",{children:'Select "accepted" only if the user is not expected to know how to simplify fractions yet. (Anything prior to 5th grade)'}),e.jsxs("p",{children:['Select "wrong" ',e.jsx("em",{children:"only"})," if we are specifically assessing the ability to simplify."]})]})]}),a=n=>e.jsxs("div",{children:[e.jsxs("div",{className:"perseus-widget-row",children:[e.jsx("label",{children:"Choose the suggested answer formats"}),e.jsx(G,{buttons:W,values:l[n].answerForms,onChange:this.updateAnswer(n,"answerForms")||(()=>{})}),e.jsxs(p,{children:[e.jsx("p",{children:'Formats will be autoselected for you based on the given answer; to show no suggested formats and accept all types, simply have a decimal/integer be the answer. Values with π will have format "pi", and values that are fractions will have some subset (mixed will be "mixed" and "proper"; improper/proper will both be "improper" and "proper"). If you would like to specify that it is only a proper fraction (or only a mixed/improper fraction), deselect the other format. Except for specific cases, you should not need to change the autoselected formats.'}),e.jsxs("p",{children:["To restrict the answer to ",e.jsx("em",{children:"only"}),' an improper fraction (i.e. 7/4), select the improper fraction and toggle "strict" to true. This'," ",e.jsx("b",{children:"will not"})," accept 1.75 as an answer."," "]}),e.jsx("p",{children:"Unless you are testing that specific skill, please do not restrict the answer format."})]})]}),e.jsx("div",{className:"perseus-widget-row",children:e.jsx(f,{label:"Strictly match only these formats",checked:l[n].strict,onChange:s=>{this.updateAnswer.bind(this,n)({strict:s})}})})]}),o=n=>e.jsx("div",{className:"perseus-widget-row",children:e.jsxs("label",{children:["Max error"," ",e.jsx(b,{className:"max-error",value:l[n].maxError,onChange:this.updateAnswer(n,"maxError"),placeholder:"0"})]})}),d=e.jsxs("div",{className:"perseus-widget-row",children:[e.jsx("label",{children:"Width: "}),e.jsx(A,{value:this.props.size,allowEmpty:!1,buttons:[{value:"normal",content:"Normal (80px)"},{value:"small",content:"Small (40px)"}],onChange:this.change("size")}),e.jsx(p,{children:e.jsx("p",{children:'Use size "Normal" for all text boxes, unless there are multiple text boxes in one line and the answer area is too narrow to fit them.'})})]}),u=e.jsx("div",{className:"perseus-widget-row",children:e.jsx(f,{label:"Right alignment",checked:this.props.rightAlign,onChange:n=>{this.props.onChange({rightAlign:n})}})}),w=e.jsxs("div",{className:"perseus-widget-row",children:[e.jsxs("label",{children:["Aria label",e.jsx(K,{value:this.props.labelText,onChange:this.change("labelText")})]}),e.jsx(p,{children:e.jsx("p",{children:"Text to describe this input. This will be shown to users using screenreaders."})})]}),h=e.jsx("div",{children:e.jsxs("div",{className:"perseus-widget-row",children:[e.jsx(f,{label:"Coefficient",checked:this.props.coefficient,onChange:n=>{this.props.onChange({coefficient:n})}}),e.jsx(p,{children:e.jsx("p",{children:"A coefficient style number allows the student to use - for -1 and an empty string to mean 1."})})]})}),x=e.jsx("div",{children:e.jsx("a",{href:"#",className:"simple-button orange",onClick:n=>{n.preventDefault(),this.addAnswer()},onKeyDown:n=>this.onSpace(n,this.addAnswer),children:e.jsx("span",{children:"Add new answer"})})}),I={wrong:"(address the mistake/misconception)",ungraded:"(explain in detail to avoid confusion)",correct:"(reinforce the user's understanding)"},O=()=>l.map((n,s)=>{const T=e.jsx(M,{apiOptions:this.props.apiOptions,content:n.message||"",placeholder:"Why is this answer "+n.status+"?	"+I[n.status],widgetEnabled:!1,onChange:r=>{"content"in r&&this.updateAnswer(s,{message:r.content})}});return e.jsxs("div",{className:"perseus-widget-row",children:[e.jsxs("div",{className:"input-answer-editor-value-container"+(n.maxError?" with-max-error":""),children:[e.jsx(b,{value:n.value,className:"numeric-input-value",placeholder:"answer",format:i.last(n.answerForms||[]),onFormatChange:(r,m)=>{let g;m==="pi"?g=["pi"]:m==="mixed"?g=["proper","mixed"]:(m==="proper"||m==="improper")&&(g=["proper","improper"]),this.updateAnswer(s,{value:N(r,this.context.strings),answerForms:g})},onChange:r=>{this.updateAnswer(s,{value:N(r,this.context.strings)})}}),n.strict&&e.jsx("div",{className:"is-strict-indicator",title:"strictly equivalent to",children:"≡"}),n.simplify!=="required"&&n.status==="correct"&&e.jsx("div",{className:"simplify-indicator "+n.simplify,title:"accepts unsimplified answers",children:"‰"}),n.maxError?e.jsxs("div",{className:"max-error-container",children:[e.jsx("div",{className:"max-error-plusmn",children:"±"}),e.jsx(b,{placeholder:0,value:l[s].maxError,format:i.last(n.answerForms||[]),onChange:this.updateAnswer(s,"maxError")})]}):null,e.jsx("div",{className:"value-divider"}),e.jsx("a",{href:"#",className:"answer-status "+n.status,onClick:r=>{r.preventDefault(),this.onStatusChange(s)},onKeyDown:r=>this.onSpace(r,this.onStatusChange),children:n.status}),e.jsx("a",{href:"#",className:"answer-trash","aria-label":"Delete answer",onClick:r=>{r.preventDefault(),this.onTrashAnswer(s)},onKeyDown:r=>this.onSpace(r,this.onTrashAnswer),children:e.jsx(k,{...C})}),e.jsx("a",{href:"#",className:"options-toggle","aria-label":"Toggle options",onClick:r=>{r.preventDefault(),this.onToggleOptions(s)},onKeyDown:r=>this.onSpace(r,this.onToggleOptions),children:e.jsx(k,{...S})})]}),e.jsx("div",{className:"input-answer-editor-message",children:T}),this.state.showOptions[s]&&e.jsxs("div",{className:"options-container",children:[o(s),n.status==="correct"&&t(s),a(s)]})]},s)});return e.jsxs("div",{className:"perseus-input-number-editor",children:[e.jsx("div",{className:"ui-title",children:"User input"}),e.jsx("div",{className:"msg-title",children:"Message shown to user on attempt"}),O(),x,d,u,h,w]})}};c.contextType=F,c.widgetName="numeric-input",c.displayName="NumericInputEditor",c.defaultProps={answers:[y("correct")],size:"normal",coefficient:!1,labelText:"",rightAlign:!1};let v=c;v.__docgenInfo={description:"",methods:[{name:"change",docblock:null,modifiers:[],params:[{name:"...args",optional:!1,type:null}],returns:null},{name:"onToggleOptions",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null}],returns:null},{name:"onTrashAnswer",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null}],returns:null},{name:"onSpace",docblock:null,modifiers:[],params:[{name:"e",optional:!1,type:null},{name:"callback",optional:!1,type:null},{name:"...args",optional:!1,type:null}],returns:null},{name:"onStatusChange",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null}],returns:null},{name:"updateAnswer",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null},{name:"update",optional:!1,type:null}],returns:null},{name:"addAnswer",docblock:null,modifiers:[],params:[],returns:null},{name:"getSaveWarnings",docblock:null,modifiers:[],params:[],returns:null},{name:"serialize",docblock:null,modifiers:[],params:[],returns:null}],displayName:"NumericInputEditor",props:{answers:{required:!1,tsType:{name:"ReadonlyArray",elements:[{name:"signature",type:"object",raw:`{
    message: string;
    value: number;
    status: string;
