import{B as I}from"./index-DpD-xBMx.js";import{V as h}from"./index-CskvhqFA.js";import{S as R}from"./index-D-mrA-Lm.js";import{s as c,c as O}from"./index-CC9jxhwQ.js";import{n as v}from"./no-important-DlFk8a1I.js";import{r as n}from"./index-C6mWTJJr.js";import{H as S}from"./heading-Doe0CpA_.js";import{a as E,b as j}from"./answer-choices-CUdxwhbX.js";import{w as D}from"./index-BzwLglMS.js";import{L as G}from"./locked-ellipse-settings-CiNjTZ1Y.js";import{L as M}from"./locked-function-settings-a1pyErZF.js";import{L as z}from"./locked-label-settings-BYzEG4Nr.js";import{L as V}from"./locked-line-settings-CSfmHmky.js";import{L as W}from"./locked-point-settings-Df1Hg2up.js";import{L as H}from"./locked-polygon-settings-CGj-u7mt.js";import{L as K}from"./locked-vector-settings-BWQ--oOe.js";import{g as X}from"./util-BKOGJ1Mr.js";const f=o=>{const{id:y,onChange:i}=o,u=["point","line","vector","ellipse","polygon","function","label"];return n.createElement(h,{style:b.container},n.createElement(E,{menuText:"Add locked figure",style:b.addElementSelect},u.map(s=>n.createElement(j,{key:`${y}-${s}`,label:s,onClick:()=>i(s)}))))},b=v.StyleSheet.create({container:{marginTop:c.xSmall_8},addElementSelect:{backgroundColor:O.fadedBlue8,borderRadius:c.xxxSmall_4}});f.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSelect",props:{id:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: LockedFigureType) => void",signature:{arguments:[{type:{name:'union["type"]',raw:'LockedFigure["type"]'},name:"value"}],return:{name:"void"}}},description:""}}};const q=o=>{switch(o.type){case"point":return n.createElement(W,{...o});case"line":return n.createElement(V,{...o});case"vector":return n.createElement(K,{...o});case"ellipse":return n.createElement(G,{...o});case"polygon":return n.createElement(H,{...o});case"function":return n.createElement(M,{...o});case"label":return n.createElement(z,{...o});default:throw new D(o)}};q.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSettings",props:{onMove:{required:!0,tsType:{name:"signature",type:"function",raw:"(movement: LockedFigureSettingsMovementType) => void",signature:{arguments:[{type:{name:"union",raw:`| "back"
| "backward"
| "forward"
| "front"`,elements:[{name:"literal",value:'"back"'},{name:"literal",value:'"backward"'},{name:"literal",value:'"forward"'},{name:"literal",value:'"front"'}]},name:"movement"}],return:{name:"void"}}},description:"Called when a movement button (top, up, down, bottom) is pressed."},onRemove:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Called when the delete button is pressed."},expanded:{required:!1,tsType:{name:"boolean"},description:"Whether this accordion is expanded."},onToggle:{required:!1,tsType:{name:"signature",type:"function",raw:"(expanded: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"expanded"}],return:{name:"void"}}},description:"Called when the accordion is expanded or collapsed."}}};const _=o=>{const y=Array((o.figures??[]).length).fill(!1),[i,u]=n.useState(y),[s,C]=n.useState(!0),g=n.useId(),{figures:r,onChange:m}=o;function T(e){const t={lockedFigures:[...r||[],X(e)]};m(t),u([...i,!0])}function A(e,a){if(e===0&&(a==="back"||a==="backward")||r&&e===r.length-1&&(a==="front"||a==="forward"))return;const l=[...r||[]],d=[...i],[p]=l.splice(e,1);switch(d.splice(e,1),a){case"back":l.unshift(p),d.unshift(!0);break;case"backward":l.splice(e-1,0,p),d.splice(e-1,0,!0);break;case"forward":l.splice(e+1,0,p),d.splice(e+1,0,!0);break;case"front":l.push(p),d.push(!0);break}m({lockedFigures:l}),u(d)}function x(e){if(window.confirm("Are you sure you want to delete this figure?")){const a=r||[];m({lockedFigures:[...a.slice(0,e),...a.slice(e+1)]});const t=[...i];t.splice(e,1),u(t)}}function L(e,a){const t=r||[],l={lockedFigures:[...t.slice(0,e),{...t[e],...a},...t.slice(e+1)]};m(l)}function P(e){u(Array(r==null?void 0:r.length).fill(e))}const w=i.every(e=>!e),N=w?"Expand all":"Collapse all",F=!!(r!=null&&r.length);return n.createElement(n.Fragment,null,n.createElement(S,{title:"Locked Figures",isOpen:s,onToggle:()=>C(!s),isCollapsible:!0}),s&&n.createElement(h,null,r==null?void 0:r.map((e,a)=>n.createElement(q,{key:`${g}-locked-${e}-${a}`,expanded:i[a],onToggle:t=>{const l=[...i];l[a]=t,u(l)},...e,onChangeProps:t=>L(a,t),onMove:t=>A(a,t),onRemove:()=>x(a)})),n.createElement(h,{style:k.buttonContainer},n.createElement(f,{id:`${g}-select`,onChange:T}),n.createElement(R,{size:c.small_12}),F&&n.createElement(I,{kind:"secondary",onClick:()=>P(w),style:k.button},N))))},k=v.StyleSheet.create({buttonContainer:{flexDirection:"row",alignItems:"center"},button:{marginTop:c.xSmall_8,flexGrow:1}});_.__docgenInfo={description:"",methods:[],displayName:"LockedFiguresSection",props:{figures:{required:!1,tsType:{name:"Array",elements:[{name:"union",raw:`| LockedPointType
| LockedLineType
| LockedVectorType
| LockedEllipseType
| LockedPolygonType
