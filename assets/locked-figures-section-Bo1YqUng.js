import{j as n}from"./jsx-runtime-BT65X5dW.js";import{B as O}from"./index-CQe11mMd.js";import{V as g}from"./index-CskvhqFA.js";import{S}from"./index-CbIoTxL4.js";import{s as c,c as R}from"./index-CjnMbH_2.js";import{n as v}from"./no-important-DlFk8a1I.js";import{r as y}from"./index-C6mWTJJr.js";import{H as j}from"./heading-BeW2c43C.js";import{a as E,b as D}from"./answer-choices-CEI5I1r0.js";import{w as G}from"./index-BzwLglMS.js";import{L as M}from"./locked-ellipse-settings-hZ4Lm0-F.js";import{L as z}from"./locked-function-settings-eMik_gIA.js";import{L as V}from"./locked-label-settings-Dw2rOCIL.js";import{L as W}from"./locked-line-settings-BuaOd4zk.js";import{L as H}from"./locked-point-settings-7e7fz4BJ.js";import{L as K}from"./locked-polygon-settings-CtvqjnUO.js";import{L as X}from"./locked-vector-settings-DcgPuf7u.js";import{g as _}from"./util-BHQd0ZFm.js";const q=o=>{const{id:h,onChange:i}=o,u=["point","line","vector","ellipse","polygon","function","label"];return n.jsx(g,{style:k.container,children:n.jsx(E,{menuText:"Add locked figure",style:k.addElementSelect,children:u.map(s=>n.jsx(D,{label:s,onClick:()=>i(s)},`${h}-${s}`))})})},k=v.StyleSheet.create({container:{marginTop:c.xSmall_8},addElementSelect:{backgroundColor:R.fadedBlue8,borderRadius:c.xxxSmall_4}});q.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSelect",props:{id:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: LockedFigureType) => void",signature:{arguments:[{type:{name:'union["type"]',raw:'LockedFigure["type"]'},name:"value"}],return:{name:"void"}}},description:""}}};const C=o=>{switch(o.type){case"point":return n.jsx(H,{...o});case"line":return n.jsx(W,{...o});case"vector":return n.jsx(X,{...o});case"ellipse":return n.jsx(M,{...o});case"polygon":return n.jsx(K,{...o});case"function":return n.jsx(z,{...o});case"label":return n.jsx(V,{...o});default:throw new G(o)}};C.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSettings",props:{onMove:{required:!0,tsType:{name:"signature",type:"function",raw:"(movement: LockedFigureSettingsMovementType) => void",signature:{arguments:[{type:{name:"union",raw:`| "back"
| "backward"
| "forward"
| "front"`,elements:[{name:"literal",value:'"back"'},{name:"literal",value:'"backward"'},{name:"literal",value:'"forward"'},{name:"literal",value:'"front"'}]},name:"movement"}],return:{name:"void"}}},description:"Called when a movement button (top, up, down, bottom) is pressed."},onRemove:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Called when the delete button is pressed."},expanded:{required:!1,tsType:{name:"boolean"},description:"Whether this accordion is expanded."},onToggle:{required:!1,tsType:{name:"signature",type:"function",raw:"(expanded: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"expanded"}],return:{name:"void"}}},description:"Called when the accordion is expanded or collapsed."}}};const $=o=>{const h=Array((o.figures??[]).length).fill(!1),[i,u]=y.useState(h),[s,T]=y.useState(!0),w=y.useId(),{figures:r,onChange:m}=o;function x(e){const t={lockedFigures:[...r||[],_(e)]};m(t),u([...i,!0])}function A(e,a){if(e===0&&(a==="back"||a==="backward")||r&&e===r.length-1&&(a==="front"||a==="forward"))return;const l=[...r||[]],d=[...i],[p]=l.splice(e,1);switch(d.splice(e,1),a){case"back":l.unshift(p),d.unshift(!0);break;case"backward":l.splice(e-1,0,p),d.splice(e-1,0,!0);break;case"forward":l.splice(e+1,0,p),d.splice(e+1,0,!0);break;case"front":l.push(p),d.push(!0);break}m({lockedFigures:l}),u(d)}function L(e){if(window.confirm("Are you sure you want to delete this figure?")){const a=r||[];m({lockedFigures:[...a.slice(0,e),...a.slice(e+1)]});const t=[...i];t.splice(e,1),u(t)}}function P(e,a){const t=r||[],l={lockedFigures:[...t.slice(0,e),{...t[e],...a},...t.slice(e+1)]};m(l)}function N(e){u(Array(r==null?void 0:r.length).fill(e))}const b=i.every(e=>!e),F=b?"Expand all":"Collapse all",I=!!(r!=null&&r.length);return n.jsxs(n.Fragment,{children:[n.jsx(j,{title:"Locked Figures",isOpen:s,onToggle:()=>T(!s),isCollapsible:!0}),s&&n.jsxs(g,{children:[r==null?void 0:r.map((e,a)=>n.jsx(C,{expanded:i[a],onToggle:t=>{const l=[...i];l[a]=t,u(l)},...e,onChangeProps:t=>P(a,t),onMove:t=>A(a,t),onRemove:()=>L(a)},`${w}-locked-${e}-${a}`)),n.jsxs(g,{style:f.buttonContainer,children:[n.jsx(q,{id:`${w}-select`,onChange:x}),n.jsx(S,{size:c.small_12}),I&&n.jsx(O,{kind:"secondary",onClick:()=>N(b),style:f.button,children:F})]})]})]})},f=v.StyleSheet.create({buttonContainer:{flexDirection:"row",alignItems:"center"},button:{marginTop:c.xSmall_8,flexGrow:1}});$.__docgenInfo={description:"",methods:[],displayName:"LockedFiguresSection",props:{figures:{required:!1,tsType:{name:"Array",elements:[{name:"union",raw:`| LockedPointType
| LockedLineType
| LockedVectorType
| LockedEllipseType
| LockedPolygonType
