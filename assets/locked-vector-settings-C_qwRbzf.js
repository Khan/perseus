import{j as e}from"./jsx-runtime-BT65X5dW.js";import{r as _}from"./index-C6mWTJJr.js";import{e as X}from"./util-1XJ0fcbr.js";import"./underscore-U-AHniOr.js";import"./core-widget-registry-BW6fao3A.js";import"./jquery-CkHB0_Mt.js";import{B as M}from"./index-CQe11mMd.js";import{V as d}from"./index-CskvhqFA.js";import{S as g}from"./index-CbIoTxL4.js";import{s as u,c as v}from"./index-CjnMbH_2.js";import{a as S,L as q}from"./index-CbNKSLRm.js";import{L as B,p as I}from"./locked-figure-aria-B27cMEYt.js";import{n as E}from"./no-important-DlFk8a1I.js";import{v as m}from"./index-Dd-cahjY.js";import{C as j,L as D,a as J}from"./locked-label-settings-mAROYIuV.js";import{P as h}from"./trash-bold-CxXKE15a.js";import{C as O}from"./color-select-BVmxcs51.js";import{L as Y}from"./line-swatch-Ki2mkqNU.js";import{g as U,j as W,a as b,b as G}from"./util-2_ilPgmL.js";const H="The vector cannot have length 0.",K=c=>{const{points:x,color:y,labels:r,ariaLabel:F,onChangeProps:s,onMove:P,onRemove:z}=c,[o,i]=x,$=`Vector (${o[0]}, ${o[1]}), (${i[0]}, ${i[1]})`,w=X(o,i);async function A(){const n=await W(r),a=await b(`$${o[0]}$`),l=await b(`$${o[1]}$`),p=await b(`$${i[0]}$`),L=await b(`$${i[1]}$`);let k=`Vector${n} from ${a} comma ${l} to ${p} comma ${L}`;const f=G(y);return k+=f,k}function C(n,a){if(typeof n<"u"){const l=[...x];l[a]=[...n];const p=m.midpoint(o,i),L=m.midpoint(l[0],l[1]),k=m.sub(L,p),f=r==null?void 0:r.map(T=>({...T,coord:m.add(T.coord,k)}));s({points:l,labels:f})}}function N(n){const a={color:n};a.labels=r==null?void 0:r.map(l=>({...l,color:n})),s(a)}function V(n,a){if(!r)return;const l=[...r];l[a]={...r[a],...n},s({labels:l})}function R(n){if(!r)return;const a=r.filter((l,p)=>p!==n);s({labels:a})}return e.jsxs(h,{expanded:c.expanded,onToggle:c.onToggle,header:e.jsxs(d,{style:t.row,children:[e.jsx(q,{children:$}),e.jsx(g,{size:u.xSmall_8}),e.jsx(Y,{color:y,lineStyle:"solid"})]}),children:[e.jsx(d,{style:[t.row,t.spaceUnder],children:e.jsx(O,{selectedValue:y,onChange:N})}),w&&e.jsx(S,{style:t.errorText,children:H}),e.jsx(h,{expanded:!0,containerStyle:t.container,panelStyle:t.accordionPanel,header:e.jsx(d,{style:t.row,children:e.jsx(q,{children:`Tail (${o[0]}, ${o[1]})`})}),children:e.jsx(j,{coord:o,error:w,onChange:n=>{C(n,0)}})}),e.jsx(h,{expanded:!0,containerStyle:t.container,panelStyle:t.accordionPanel,header:e.jsx(d,{style:t.row,children:e.jsx(q,{children:`Tip (${i[0]}, ${i[1]})`})}),children:e.jsx(j,{coord:i,error:w,onChange:n=>{C(n,1)}})}),e.jsx(g,{size:u.small_12}),e.jsx(d,{style:t.horizontalRule}),e.jsx(B,{ariaLabel:F,getPrepopulatedAriaLabel:A,onChangeProps:n=>{s(n)}}),e.jsx(g,{size:u.xxxSmall_4}),e.jsx(d,{style:t.horizontalRule}),e.jsx(g,{size:u.small_12}),e.jsx(S,{children:"Visible labels"}),r==null?void 0:r.map((n,a)=>_.createElement(D,{...n,key:a,expanded:!0,onChangeProps:l=>{V(l,a)},onRemove:()=>{R(a)},containerStyle:t.labelContainer})),e.jsx(M,{kind:"tertiary",startIcon:I,onClick:()=>{const n=[0,-1],a=m.add(m.scale(n,(r==null?void 0:r.length)??0),m.midpoint(o,i)),l={...U("label"),coord:a,color:y};s({labels:[...r??[],l]})},style:t.addButton,children:"Add visible label"}),e.jsx(J,{figureType:c.type,onMove:P,onRemove:z})]})},t=E.StyleSheet.create({accordionPanel:{paddingBottom:u.medium_16},container:{marginTop:u.xSmall_8,marginBottom:0,marginLeft:-u.xxxSmall_4,marginRight:-u.xxxSmall_4,backgroundColor:v.white},errorText:{color:v.red,marginTop:u.xSmall_8},row:{flexDirection:"row",alignItems:"center"},addButton:{alignSelf:"start"},horizontalRule:{height:1,backgroundColor:v.offBlack16},labelContainer:{backgroundColor:v.white}});K.__docgenInfo={description:"",methods:[],displayName:"LockedVectorSettings",props:{type:{required:!0,tsType:{name:"literal",value:'"vector"'},description:""},points:{required:!0,tsType:{name:"tuple",raw:"[tail: Coord, tip: Coord]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},color:{required:!0,tsType:{name:"unknown[number]",raw:"(typeof lockedFigureColorNames)[number]"},description:""},labels:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    type: "label";
    coord: Coord;
