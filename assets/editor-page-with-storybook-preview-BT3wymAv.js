import{r as a,j as n,V as o,ao as P,n as R,ap as T,aq as x,l as A,s as t,ar as I,R as q,as as F,o as m}from"./iframe-B7TMQJdi.js";import"./item-version-DWTm3KG2.js";import"./article-renderer-C3ugB7CD.js";import"./server-item-renderer-Dp-6ctHj.js";import"./hints-renderer-BrPYys6H.js";import{C as D}from"./content-preview-CqVWiCl5.js";import{E as C}from"./editor-page-5HEW8n07.js";const{action:M}=__STORYBOOK_MODULE_ACTIONS__,j=M("onChange");function N(d){const[u,g]=a.useState("phone"),[y,w]=a.useState(!1),[b,f]=a.useState(),[h,k]=a.useState(d.question),[r,v]=a.useState(d.hints),[i,c]=a.useState(!0),l=d.apiOptions??{isMobile:!1};return n.jsxs(o,{children:[n.jsx(C,{apiOptions:l,previewDevice:u,onPreviewDeviceChange:e=>g(e),developerMode:!0,jsonMode:y,answerArea:b,question:h,hints:r,previewURL:"about:blank",itemId:"1",onChange:e=>{j(e),"jsonMode"in e&&w(e.jsonMode),"answerArea"in e&&f(e.answerArea),"question"in e&&k(e.question),"hints"in e&&v(e.hints)},additionalTemplates:{"Side by Side":`Left hand side
=====
Right hand side`}}),!i&&n.jsx(P,{onClick:()=>c(!i),style:s.openPanelButton,children:"Open preview (storybook only)"}),i&&n.jsxs(o,{style:s.panel,children:[n.jsx(T,{icon:x,kind:"tertiary","aria-label":"Close preview",onClick:()=>c(!i)}),n.jsx(o,{style:s.panelInner,children:n.jsx(D,{question:h,previewDevice:u,apiOptions:l,linterContext:{contentType:"exercise",highlightLint:!0,paths:[],stack:[]}})}),r==null?void 0:r.map((e,p)=>n.jsxs(o,{style:s.panelInner,children:[n.jsx(A,{size:t.medium_16}),n.jsx(I,{children:`Hint ${p+1}`}),n.jsx(q,{strings:F,apiOptions:l,...e})]},p))]})]})}const s=R.StyleSheet.create({panel:{position:"fixed",right:0,minWidth:500,height:"90vh",overflow:"auto",flex:"none",backgroundColor:m.fadedBlue16,padding:t.medium_16,borderRadius:t.small_12,alignItems:"end"},panelInner:{flex:"none",backgroundColor:m.white,borderRadius:t.xSmall_8,marginTop:t.medium_16,width:"100%",padding:t.xSmall_8},openPanelButton:{position:"fixed",right:t.medium_16,bottom:t.xxxLarge_64}});N.__docgenInfo={description:"",methods:[],displayName:"EditorPageWithStorybookPreview",props:{apiOptions:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
