import{a as $,j as x}from"./jsx-runtime-5BUNAZ9W.js";import{u as v,V as U,E as M,M as D,c as W}from"./compare-59FC1ybr.js";import{$ as O}from"./jquery-5v7aFUvu.js";import{r as V}from"./index-4g5l5LRQ.js";import{R as w}from"./index-jmm5gWkb.js";import{_ as c}from"./index-default-4_ZsnO94.js";import{P as H}from"./i18n-context-3gTlIcWM.js";import"./version-akiLXZts.js";import{P as G,E as K}from"./perseus-error-l3K_anoI.js";import{P as B}from"./index-k-0mNqHS.js";import{A as Q,C as X}from"./perseus-api-7QXTiCE7.js";const C=["key","ref","containerSizeClass","widgetId","onChange","problemNum","apiOptions","questionCompleted","findWidgets","hintMode","onRemove","id","onBlur","onFocus","trackInteraction","keypadElement"],ce=e=>{const r={...e};for(const t of C)t in r&&delete r[t];return r},Z=`Usage:
  this.change({propName: 5}, callback);
  this.change("propName", 5, callback);
  this.change("propName")`,z=function(e,r,t){const n=c.omit(e.props,C),l=c.extend(n,r);e.props.onChange(l,t)},N=function(e,r,t,n){if(t===void 0)return c.partial(N,e,r);const l={};l[r]=t,z(e,l,n)},Y=function(e,r,t){if(c.isObject(e)&&t===void 0)return t=r,z(this,e,t);if(typeof e=="string")return N(this,e,r,t);throw new G("Invalid types sent to this.change(): "+c.toArray(arguments).join()+`
`+Z,K.Internal)},be={onChange:B.func.isRequired};var _=function(e){return e===Object(e)},L=function(){for(var e={},r=0;r<arguments.length;r++){var t=arguments[r];if(t)for(var n in t)e[n]=t[n]}return e},f=function(e){return _(e)?Array.isArray(e)?e.slice():L(e):e},q=function(e){if(Array.isArray(e))return J;if(_(e))return ee;if(typeof e=="string")return re},y=function(e){if(e instanceof y)return e;if(!(this instanceof y))return new y(e);var r=q(e);this._wrapped=r.thaw?r.thaw(e):e};y.prototype.freeze=function(){var e=this._wrapped,r=q(e);return r.freeze?r.freeze(e):e};y.prototype.zoom=function(e){return this._zoomStack===void 0&&(this._zoomStack=[]),this._zoomStack.push({zoom:e,wrapped:this._wrapped}),this._wrapped=y(this._wrapped).get(e),this};y.prototype.deZoom=function(){var e=this._zoomStack.pop();return this._wrapped=y(e.wrapped).set(e.zoom,this._wrapped).freeze(),this};y.prototype.get=function(e){for(var r=this._wrapped,t=0;t<e.length;t++)r=q(r).get(r,e[t]);return r};y.prototype.mod=function(e,r){var t=this._wrapped,n=f(t),l=q(t);if(e.length===0)this._wrapped=r(this._wrapped);else if(e.length===1)this._wrapped=l.mod(n,e[0],r);else{var i=e[0],a=e.slice(1);n[i]=y(t[i]).mod(a,r).freeze(),this._wrapped=n}return this};y.prototype.merge=function(e,r){return this._wrapped=y(this._wrapped).mod(e,function(t){return L(t,r)}).freeze(),this};y.prototype.del=function(e){var r=this._wrapped,t=q(r);if(e.length===1)this._wrapped=t.del(r,e[0]);else{var n=e[0],l=e.slice(1),i=f(r);i[n]=y(r[n]).del(l).freeze(),this._wrapped=i}return this};y.prototype.set=function(e,r){return this.mod(e,function(){return r})};const J={get:function(e,r){return e[r]},set:function(e,r,t){var n=e.splice();return n[r]=t,n},mod:function(e,r,t){var n=e.slice();return n[r]=t(e[r]),n},del:function(e,r){var t=e.slice();return t.splice(r,1),t}},ee={get:function(e,r){return e[r]},set:function(e,r,t){var n=f(e);return n[r]=t,n},mod:function(e,r,t){var n=f(e);return n[r]=t(e[r]),n},del:function(e,r){var t=f(e);return delete t[r],t}},re={get:function(e,r){return e[r]},set:function(e,r,t){var n=e.splice();return n[r]=t,n},mod:function(e,r,t){var n=e.splice();return n[r]=t(e[r]),n},del:function(e,r){var t=e.slice();return t.splice(r),t}};class te{constructor(r){this.order=S(r),this.mantissa=F(r),this.positive=P(r),this.sigFigs=this.mantissa.length,this.sigDecs=this.order-this.mantissa.length}}function ve(e,r,t,n){const l=""+e;let i=S(l),a=F(l),s=P(l),o,u,g,p=!1;if(e==0||a==""||a=="0"){a="";for(let d=0;d<r;d++)a+="0";i=r+t,t<0&&-t>=r&&(p=!0)}else{if(u=i-a.length-t,g=r-a.length,o=Math.min(g,u),o<0){let d=E(a,-o);d.length>a.length+o&&(i++,u>g&&(d=E(d,1))),a=d}else if(o>0)for(let d=0;d<o;d++)a+="0";(a==""||a=="0")&&(a="0",s=!0,i=1+t,i!=0&&(p=!0))}const A=n||a.length>20||i>4||i<-2||i-a.length>0&&I(a)>0||p;let m="";if(s||(m+="-"),A)m+=a.charAt(0),a.length>1&&(m+="."+a.substring(1,a.length)),i-1!=0&&(m+=" x 10^"+(i-1));else{let d="",h="",T=!0;if(i>0)if(a.length>i)d=a.substring(0,i),h=a.substring(i,a.length);else{d=a,T=I(a)!=0;for(let b=0;b<i-a.length;b++)d+="0"}else{for(let b=0;b<-i;b++)h+="0";h+=a}m+=(d==""?"0":d)+(T?".":"")+h}return m}function I(e){let r=0;for(let t=e.length-1;t>=0;t--)if(e.charAt(t)=="0")r++;else return r;return r}function P(e){let r=!0,t=!1,n=!1,l="",i="",a=!0;for(let s=0;s<e.length;s++){const o=e.charAt(s);o>="1"&&o<="9"?(i+=l+o,l="",n=!0,r=!1):o=="0"?(t?n&&(i+=l+o,l=""):n&&(l+=o),r=!1):!t&&o=="."?(i+=l,l="",t=!0,r=!1):o=="e"||o=="E"&&s+1<e.length?(parseInt(e.substring(s+1,e.length)),s=e.length):r&&(o=="+"||o=="-")&&o=="-"&&(a=!a)}return i==""?!0:a}function F(e){let r=!1,t=!1,n="",l="",i="";for(let a=0;a<e.length;a++){const s=e.charAt(a);s>="1"&&s<="9"?(i+=n+s,n="",t=!0):s=="0"?r?t?(i+=n+s,n=""):l+=s:t?(l+=s,n+=s):l+=s:!r&&s=="."?(i+=n,n="",r=!0):(s=="e"||s=="E"&&a+1<e.length)&&(parseInt(e.substring(a+1,e.length)),a=e.length)}return i==""?l:i}function S(e){let r=!1,t=!1,n="",l="",i=0,a=0;for(let s=0;s<e.length;s++){const o=e.charAt(s);if(o>="1"&&o<="9")l+=n+o,n="",t=!0,r||(a++,i++);else if(o=="0")r?t?(l+=n+o,n=""):i--:(a++,t&&(i++,n+=o));else if(!r&&o==".")l+=n,n="",r=!0;else if(o=="e"||o=="E"&&s+1<e.length){const u=parseInt(e.substring(s+1,e.length));i+=u,a+=u,s=e.length}}return l==""?a:i}function E(e,r){const t=e.length-r-1;if(t<0)return"";if(t>=e.length-1)return e;const n=e.charAt(t+1),l=e.charAt(t);let i=!1;if(n>"5")i=!0;else if(n=="5"){for(let s=t+2;s<e.length;s++)e.charAt(s)!="0"&&(i=!0);l%2==1&&(i=!0)}let a="";for(let s=t;s>=0;s--){const o=e.charAt(s);if(i){let u;if(o=="9")u="0";else{switch(o){case"0":u="1";break;case"1":u="2";break;case"2":u="3";break;case"3":u="4";break;case"4":u="5";break;case"5":u="6";break;case"6":u="7";break;case"7":u="8";break;case"8":u="9";break}i=!1}a=u+a}else a=o+a}return i&&(a="1"+a),a}const ne="all",ae=function(e){return new te(e).sigFigs},k=class k extends V.Component{constructor(){super(...arguments),this._showError=()=>{if(this.props.value==="")return;const r=O(w.findDOMNode(this.refs.error));r.is(":visible")||r.css({top:50,opacity:.1}).show().animate({top:0,opacity:1},300)},this._hideError=()=>{const r=O(w.findDOMNode(this.refs.error));r.is(":visible")&&r.animate({top:50,opacity:.1},300,function(){O(this).hide()})},this.change=(...r)=>Y.apply(this,r),this.handleBlur=()=>{this.props.onBlur([]),clearTimeout(this._errorTimeout),v(this.props.value).parsed||this._showError()},this.handleChange=r=>{this._hideError(),this.props.onChange({value:r.target.value})},this.simpleValidate=(r,t)=>k.validate(this.getUserInput(),r,this.context.strings),this.getUserInput=()=>this.props.value,this.getInputPaths=()=>[[]],this.focusInputPath=r=>{const t=w.findDOMNode(this.refs.input);t&&t.focus()},this.handleFocus=()=>{this.props.onFocus([])},this.blurInputPath=r=>{const t=w.findDOMNode(this.refs.input);t&&t.blur()},this.setInputValue=(r,t,n)=>{this.props.onChange({value:t},n)},this.getDOMNodeForPath=()=>w.findDOMNode(this.refs.input),this.getGrammarTypeForPath=r=>"unit"}static validate(r,t,n){const l=v(t.value).expr,i=v(r);if(!i.parsed)return{type:"invalid",message:n.dontUnderstandUnits};let a=null;const s=t.sigfigs,o=ae(i.coefficient)===s;o||(a=n.checkSigFigs);let u;try{const d=new U("x"),T=new M(l.simplify(),"=",new D(d,i.expr.simplify())).solveLinearEquationForVariable(d);u=Number(T.eval()).toPrecision(s)===1 .toPrecision(s)}catch{u=!1}u||(a=n.answerNumericallyIncorrect);let g;const p=j(i.expr.simplify()),A=j(l.simplify());return t.accepting===ne?g=W(p,A).equal:g=c(t.acceptingUnits).any(d=>{const h=j(v(d).unit.simplify());return W(h,p).equal}),g||(a=n.checkUnits),{type:"points",earned:g&&u&&o?1:0,total:1,message:a}}componentDidUpdate(){clearTimeout(this._errorTimeout),v(this.props.value).parsed?this._hideError():this._errorTimeout=setTimeout(this._showError,2e3)}componentWillUnmount(){clearTimeout(this._errorTimeout)}render(){return $("div",{className:"old-unit-input",children:[x("input",{onChange:this.handleChange,ref:"input",className:X.INTERACTIVE,value:this.props.value,onFocus:this.handleFocus,onBlur:this.handleBlur}),x("div",{ref:"error",className:"error",style:{display:"none"},children:this.context.strings.dontUnderstand})]})}};k.contextType=H,k.defaultProps={apiOptions:Q.defaults,value:""};let R=k;const j=function(e){return e.simplify().asMul().partition()[1].flatten().simplify()},we={name:"unit-input",displayName:"Unit input",defaultAlignment:"inline-block",widget:R,transform:e=>y(e).del(["value"]).freeze(),version:{major:0,minor:1},hidden:!0};R.__docgenInfo={description:"",methods:[{name:"validate",docblock:null,modifiers:["static"],params:[{name:"userInput",optional:!1,type:{name:"string"}},{name:"rubric",optional:!1,type:{name:"union",raw:`| {
      value: string;
      sigfigs: number;
      accepting: "all";
  }
| {
    ...
    sigfigs: number;
    accepting: "all";
}`,signature:{properties:[{key:"value",value:{name:"string",required:!0}},{key:"sigfigs",value:{name:"number",required:!0}},{key:"accepting",value:{name:"literal",value:'"all"',required:!0}}]}},{name:"signature",type:"object",raw:`{
    value: string;
    sigfigs: number;
    accepting: "some";
    acceptingUnits: ReadonlyArray<string>;
}`,signature:{properties:[{key:"value",value:{name:"string",required:!0}},{key:"sigfigs",value:{name:"number",required:!0}},{key:"accepting",value:{name:"literal",value:'"some"',required:!0}},{key:"acceptingUnits",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!0}}]}}],alias:"Rubric"}},{name:"strings",optional:!1,type:{name:"signature",type:"object",raw:`{
    closeKeypad: string;
    openKeypad: string;
...
| {
    ...
    message: string | null | undefined;
    total: number;
}`,signature:{properties:[{key:"type",value:{name:"literal",value:'"points"',required:!0}},{key:"earned",value:{name:"union",raw:"1 | 0",elements:[{name:"literal",value:"1"},{name:"literal",value:"0"}],required:!0}},{key:"message",value:{name:"union",raw:"string | null | undefined",elements:[{name:"string"},{name:"null"},{name:"undefined"}],required:!0}},{key:"total",value:{name:"number",required:!0}}]}},{name:"signature",type:"object",raw:`{
    type: "invalid";
    message: string | null | undefined;
}`,signature:{properties:[{key:"type",value:{name:"literal",value:'"invalid"',required:!0}},{key:"message",value:{name:"union",raw:"string | null | undefined",elements:[{name:"string"},{name:"null"},{name:"undefined"}],required:!0}}]}}]}}},{name:"_showError",docblock:null,modifiers:[],params:[],returns:null},{name:"_hideError",docblock:null,modifiers:[],params:[],returns:null},{name:"change",docblock:null,modifiers:[],params:[{name:"...args",optional:!1,type:null}],returns:null},{name:"handleBlur",docblock:null,modifiers:[],params:[],returns:null},{name:"handleChange",docblock:null,modifiers:[],params:[{name:"event",optional:!1,type:{name:"ReactChangeEvent",raw:"React.ChangeEvent<HTMLInputElement>",elements:[{name:"HTMLInputElement"}],alias:"React.ChangeEvent"}}],returns:null},{name:"simpleValidate",docblock:null,modifiers:[],params:[{name:"rubric",optional:!1,type:{name:"union",raw:`| {
      value: string;
      sigfigs: number;
      accepting: "all";
  }
| {
    ...
    accepting: "some";
    acceptingUnits: ReadonlyArray<string>;
}`,signature:{properties:[{key:"value",value:{name:"string",required:!0}},{key:"sigfigs",value:{name:"number",required:!0}},{key:"accepting",value:{name:"literal",value:'"some"',required:!0}},{key:"acceptingUnits",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!0}}]}}],alias:"Rubric"}},{name:"onInputError",optional:!0,type:{name:"signature",type:"function",raw:"() => unknown",signature:{arguments:[],return:{name:"unknown"}}}}],returns:null},{name:"getUserInput",docblock:null,modifiers:[],params:[],returns:null},{name:"getInputPaths",docblock:null,modifiers:[],params:[],returns:null},{name:"focusInputPath",docblock:null,modifiers:[],params:[{name:"inputPath",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"handleFocus",docblock:null,modifiers:[],params:[],returns:null},{name:"blurInputPath",docblock:null,modifiers:[],params:[{name:"inputPath",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"setInputValue",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}},{name:"newValue",optional:!1,type:{name:"string"}},{name:"cb",optional:!1,type:{name:"signature",type:"function",raw:"() => unknown",signature:{arguments:[],return:{name:"unknown"}}}}],returns:null},{name:"getDOMNodeForPath",docblock:null,modifiers:[],params:[],returns:null},{name:"getGrammarTypeForPath",docblock:null,modifiers:[],params:[{name:"inputPath",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null}],displayName:"OldUnitInput",props:{apiOptions:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onInputError?: (
        widgetId: any,
        value: string,
...
the available choices.`}]}}],raw:`Readonly<{
    ...
    editorChangeDelay: 0,
}`,computed:!1}},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:`(
    arg1: {
    ...
    // The minor part of the version
    minor: number;
}`,signature:{properties:[{key:"major",value:{name:"number",required:!0}},{key:"minor",value:{name:"number",required:!0}}]},required:!1}}]},required:!0}}]}}],required:!0}},{key:"replace",value:{name:"boolean",required:!1}},{key:"metadata",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!1}},{key:"images",value:{name:"signature",type:"object",raw:`{
    [key: string]: PerseusImageDetail;
    ...
    replace?: boolean;
}`,signature:{properties:[{key:"replace",value:{name:"boolean",required:!1}}]}}]}],raw:"ReadonlyArray<Hint>",required:!1}},{key:"replace",value:{name:"boolean",required:!1}},{key:"content",value:{name:"string",required:!1}},{key:"widgets",value:{name:"signature",type:"object",raw:`{
    [name: string]: Widget;
}`,signature:{properties:[{key:{name:"string"},value:{name:"signature",type:"object",raw:`{
    // The "type" of widget which will define what the Options field looks like
    type: Type;
...
| CircleGraphState
| QuadraticGraphState
| SinusoidGraphState`,elements:[{name:"AngleGraphState"},{name:"SegmentGraphState"},{name:"LinearSystemGraphState"},{name:"LinearGraphState"},{name:"RayGraphState"},{name:"PolygonGraphState"},{name:"PointGraphState"},{name:"CircleGraphState"},{name:"QuadraticGraphState"},{name:"SinusoidGraphState"}],required:!1}}]}},name:"arg1"},{type:{name:"signature",type:"function",raw:"() => unknown | null | undefined",signature:{arguments:[],return:{name:"union",raw:"unknown | null | undefined",elements:[{name:"unknown"},{name:"null"},{name:"undefined"}]}}},name:"callback"},{type:{name:"boolean"},name:"silent"}],return:{name:"unknown"}}},description:""},value:{required:!1,tsType:{name:"string",raw:'PerseusUnitInputWidgetOptions["value"]'},description:"",defaultValue:{value:'""',computed:!1}},onBlur:{required:!0,tsType:{name:"signature",type:"function",raw:"(arg1: FocusPath) => unknown",signature:{arguments:[{type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}]},name:"arg1"}],return:{name:"unknown"}}},description:""},onFocus:{required:!0,tsType:{name:"signature",type:"function",raw:"(arg1: FocusPath) => unknown",signature:{arguments:[{type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}]},name:"arg1"}],return:{name:"unknown"}}},description:""}}};export{R as O,we as U,ve as a,Y as c,C as d,y as l,be as p,ce as r};
