import{cM as s,j as B}from"./iframe-CTOs5xNT.js";import{S as F}from"./server-item-renderer-with-debug-ui-B48aIbdS.js";import{a as u,c as G,S as H,b as J,m as K,d as U,e as V}from"./radio.testdata-BivRIcl-.js";import"./server-item-renderer-BDe2OHhV.js";import"./hints-renderer-DgXLEwYt.js";import"./main-Du196aIC.js";import"./test-keypad-context-wrapper-BtKnfP1y.js";import"./Popper-CCxsJDV-.js";const ie={title:"Perseus/Widgets/RadioNew",args:{static:!1,startAnswerless:!1,reviewMode:!1,showSolutions:"none",item:s({question:u})},argTypes:{showSolutions:{options:["none","all","selected"],control:{type:"select"}}},render:e=>B.jsx(F,{item:X(e),apiOptions:Y(),reviewMode:e.reviewMode,showSolutions:e.showSolutions,startAnswerless:e.startAnswerless}),parameters:{docs:{description:{component:`This is a story for the new radio widget.
...
}`,...(T=(O=i.parameters)==null?void 0:O.docs)==null?void 0:T.source}}};var v,Q,x;a.parameters={...a.parameters,docs:{...(v=a.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
