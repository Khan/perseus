import{a as l,j as i}from"./jsx-runtime-5BUNAZ9W.js";const r=({path:o,width:t,height:n,style:s={},title:e})=>l("svg",{role:"img","aria-hidden":!e,style:{verticalAlign:"middle",...s},width:`${t/n}em`,height:"1em",viewBox:`0 0 ${t} ${n}`,children:[!!e&&i("title",{children:e}),i("path",{d:o,fill:"currentColor"})]});r.__docgenInfo={description:`A stripped version of Icon.jsx from webapp. Takes an SVG icon and renders it
...
Sample usage:
  ...
  <InlineIcon {...editIcon} />`,methods:[],displayName:"InlineIcon",props:{path:{required:!0,tsType:{name:"string"},description:""},height:{required:!0,tsType:{name:"number"},description:""},width:{required:!0,tsType:{name:"number"},description:""},style:{required:!1,tsType:{name:"ReactCSSProperties",raw:"React.CSSProperties"},description:"",defaultValue:{value:"{}",computed:!1}},title:{required:!1,tsType:{name:"string"},description:""}}};export{r as I};
