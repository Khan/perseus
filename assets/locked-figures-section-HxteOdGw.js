import{j as n}from"./jsx-runtime-63Ea5SlK.js";import{B as O}from"./index-_CVl-B2F.js";import{V as g}from"./index-_3CKOwHy.js";import{S}from"./index-o999uk82.js";import{s as c,c as j}from"./index-QHkT31Yt.js";import{n as f}from"./no-important-xCWWYXQR.js";import{r as h}from"./index-6oxdNXpR.js";import{H as E}from"./heading-8BoNY6Y8.js";import{a as D,b as G}from"./answer-choices-cgnjgndA.js";import{w as M}from"./index-J2t_5nK1.js";import{L as z}from"./locked-ellipse-settings-_KUg008T.js";import{L as V}from"./locked-function-settings-quNb5C_-.js";import{L as W}from"./locked-label-settings-EsAPJw4M.js";import{L as H}from"./locked-line-settings-yWlPrQnP.js";import{L as K}from"./locked-point-settings-07fVvcx3.js";import{L as X}from"./locked-polygon-settings-zpP_xqgx.js";import{L as _}from"./locked-vector-settings-uG-UzU7Z.js";import{g as $}from"./util-JNJGACNb.js";const q=o=>{const{id:y,onChange:i}=o,u=["point","line","vector","ellipse","polygon","function","label"];return n.jsx(g,{style:k.container,children:n.jsx(D,{menuText:"Add locked figure",style:k.addElementSelect,children:u.map(s=>n.jsx(G,{label:s,onClick:()=>i(s)},`${y}-${s}`))})})},k=f.StyleSheet.create({container:{marginTop:c.xSmall_8},addElementSelect:{backgroundColor:j.fadedBlue8,borderRadius:c.xxxSmall_4}});q.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSelect",props:{id:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: LockedFigureType) => void",signature:{arguments:[{type:{name:'union["type"]',raw:'LockedFigure["type"]'},name:"value"}],return:{name:"void"}}},description:""}}};const C=o=>{switch(o.type){case"point":return n.jsx(K,{...o});case"line":return n.jsx(H,{...o});case"vector":return n.jsx(_,{...o});case"ellipse":return n.jsx(z,{...o});case"polygon":return n.jsx(X,{...o});case"function":return n.jsx(V,{...o});case"label":return n.jsx(W,{...o});default:throw new M(o)}};C.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSettings",props:{onMove:{required:!0,tsType:{name:"signature",type:"function",raw:"(movement: LockedFigureSettingsMovementType) => void",signature:{arguments:[{type:{name:"union",raw:`| "back"
| "backward"
| "forward"
| "front"`,elements:[{name:"literal",value:'"back"'},{name:"literal",value:'"backward"'},{name:"literal",value:'"forward"'},{name:"literal",value:'"front"'}]},name:"movement"}],return:{name:"void"}}},description:"Called when a movement button (top, up, down, bottom) is pressed."},onRemove:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Called when the delete button is pressed."},expanded:{required:!1,tsType:{name:"boolean"},description:"Whether this accordion is expanded."},onToggle:{required:!1,tsType:{name:"signature",type:"function",raw:"(expanded: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"expanded"}],return:{name:"void"}}},description:"Called when the accordion is expanded or collapsed."}}};const T=o=>{const y=Array((o.figures??[]).length).fill(!1),[i,u]=h.useState(y),[s,x]=h.useState(!0),w=h.useId(),{figures:a,onChange:m}=o;function A(e){const t={lockedFigures:[...a||[],$(e)]};m(t),u([...i,!0])}function P(e,r){if(e===0&&(r==="back"||r==="backward")||a&&e===a.length-1&&(r==="front"||r==="forward"))return;const l=[...a||[]],d=[...i],[p]=l.splice(e,1);switch(d.splice(e,1),r){case"back":l.unshift(p),d.unshift(!0);break;case"backward":l.splice(e-1,0,p),d.splice(e-1,0,!0);break;case"forward":l.splice(e+1,0,p),d.splice(e+1,0,!0);break;case"front":l.push(p),d.push(!0);break}m({lockedFigures:l}),u(d)}function L(e){if(window.confirm("Are you sure you want to delete this figure?")){const r=a||[];m({lockedFigures:[...r.slice(0,e),...r.slice(e+1)]});const t=[...i];t.splice(e,1),u(t)}}function N(e,r){const t=a||[],l={lockedFigures:[...t.slice(0,e),{...t[e],...r},...t.slice(e+1)]};m(l)}function F(e){u(Array(a==null?void 0:a.length).fill(e))}const b=i.every(e=>!e),I=b?"Expand all":"Collapse all",R=!!(a!=null&&a.length);return n.jsxs(n.Fragment,{children:[n.jsx(E,{title:"Locked Figures",isOpen:s,onToggle:()=>x(!s),isCollapsible:!0}),s&&n.jsxs(g,{children:[a==null?void 0:a.map((e,r)=>n.jsx(C,{expanded:i[r],onToggle:t=>{const l=[...i];l[r]=t,u(l)},...e,onChangeProps:t=>N(r,t),onMove:t=>P(r,t),onRemove:()=>L(r)},`${w}-locked-${e}-${r}`)),n.jsxs(g,{style:v.buttonContainer,children:[n.jsx(q,{id:`${w}-select`,onChange:A}),n.jsx(S,{size:c.small_12}),R&&n.jsx(O,{kind:"secondary",onClick:()=>F(b),style:v.button,children:I})]})]})]})},v=f.StyleSheet.create({buttonContainer:{flexDirection:"row",alignItems:"center"},button:{marginTop:c.xSmall_8,flexGrow:1}}),pe=T;T.__docgenInfo={description:"",methods:[],displayName:"LockedFiguresSection",props:{figures:{required:!1,tsType:{name:"Array",elements:[{name:"union",raw:`| LockedPointType
| LockedLineType
| LockedVectorType
| LockedEllipseType
| LockedPolygonType
