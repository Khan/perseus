import{j as n}from"./jsx-runtime-63Ea5SlK.js";import"./article-renderer-672kQv0H.js";import"./jquery-yG1GhClm.js";import"./util-AYeX86gl.js";import"./phet-simulation-_7qOO4_B.js";import"./version-akiLXZts.js";import"./dependencies-CP7Uh8Kq.js";import"./perseus-api-1-ethIrW.js";import"./perseus-item-tX_UkuqW.js";import"./hints-renderer-55KvvYOM.js";import{R as p}from"./renderer-Fa29TEBe.js";import"./base-radio-lzGbv5LT.js";import"./button-group-G5CZaedn.js";import"./graph-AXw3gRQ0.js";import"./svg-image-ZjoZQGiG.js";import"./hud-ifw9Ofbw.js";import"./icon-7RFbyLiL.js";import"./index-BIPwuHvF.js";import"./inline-icon-6fh0Wu1y.js";import"./math-input-ILg8RrvB.js";import"./multi-button-group-QUVHbBcE.js";import"./number-input-ogh82yD8.js";import"./range-input-w5Z3sPK5.js";import"./text-input-e6f7u9S5.js";import"./text-list-editor-aj1SAzcA.js";import"./index-0C4KXdeC.js";import{m}from"./i18n-context-fsWEgybQ.js";import"./index-smZ6iCr_.js";import{B as R}from"./choice-Xr-SKHrB.js";import{V as s}from"./index-0DbkllkJ.js";import{I as A}from"./locked-label-settings-4eI1sJTY.js";import{S as x}from"./index-nqMmpXbO.js";import{c as g,s as t}from"./index-deFLJwr4.js";import{L as I}from"./index-18qWGOW7.js";import{x as q}from"./index-f-3iKkZU.js";import{a as F}from"./chunk-D5ZWXAHU-vR62DWf0.js";import{l as W}from"./index-awljIyHI.js";import{r as a}from"./index-6oxdNXpR.js";import{E as M}from"./editor-page-6q-lMh_o.js";import{f as j}from"./flags-for-api-options-vkNewrr4.js";const E=F("onChange");function D(d){const[y,w]=a.useState("phone"),[f,b]=a.useState(!1),[v,k]=a.useState(),[u,P]=a.useState(d.question),[i,T]=a.useState(d.hints),[o,h]=a.useState(!0),l=d.apiOptions??{isMobile:!1,flags:j};return n.jsxs(s,{children:[n.jsx(M,{apiOptions:l,previewDevice:y,onPreviewDeviceChange:e=>w(e),developerMode:!0,jsonMode:f,answerArea:v,question:u,hints:i,frameSource:"about:blank",previewURL:"about:blank",itemId:"1",onChange:e=>{E(e),"jsonMode"in e&&b(e.jsonMode),"answerArea"in e&&k(e.answerArea),"question"in e&&P(e.question),"hints"in e&&T(e.hints)}}),!o&&n.jsx(R,{onClick:()=>h(!o),style:r.openPanelButton,children:"Open preview (storybook only)"}),o&&n.jsxs(s,{style:r.panel,children:[n.jsx(A,{icon:q,onClick:()=>h(!o),style:r.closeButton}),n.jsx(s,{style:r.panelInner,children:n.jsx(p,{strings:m,apiOptions:l,...u})}),i==null?void 0:i.map((e,c)=>n.jsxs(s,{style:r.panelInner,children:[n.jsx(x,{size:t.medium_16}),n.jsx(I,{children:`Hint ${c+1}`}),n.jsx(p,{strings:m,apiOptions:l,...e})]},c))]})]})}const r=W.StyleSheet.create({panel:{position:"fixed",right:0,minWidth:500,height:"90vh",overflow:"auto",flex:"none",backgroundColor:g.fadedBlue16,padding:t.medium_16,borderRadius:t.small_12,alignItems:"end"},panelInner:{flex:"none",backgroundColor:g.white,borderRadius:t.xSmall_8,marginTop:t.medium_16,width:"100%",padding:t.xSmall_8},closeButton:{margin:0},openPanelButton:{position:"fixed",right:t.medium_16,bottom:t.xxxLarge_64}});D.__docgenInfo={description:"",methods:[],displayName:"EditorPageWithStorybookPreview",props:{apiOptions:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
