import{j as t}from"./jsx-runtime-63Ea5SlK.js";import"./article-renderer-ChQPaz5X.js";import"./phet-simulation-FB_1B1eX.js";import{_ as o}from"./index-default-4_ZsnO94.js";import"./core-widget-registry-uiKfW1Am.js";import"./dependencies-CP7Uh8Kq.js";import{A as q,C}from"./perseus-api-DO0X8arb.js";import{i as P}from"./server-item-renderer-3vF125nj.js";import"./hints-renderer-ZJhIhgNq.js";import"./renderer-s0nXcNLd.js";import"./base-radio-u_SNTnw6.js";import{c as f}from"./components-7TuWaVNb.js";import"./i18n-context-dE2bX2K_.js";import"./util-CFc6mjZH.js";import"./svg-image-ZSuPTax3.js";import"./jquery-5v7aFUvu.js";import"./index-smZ6iCr_.js";import{r as s}from"./index-6oxdNXpR.js";import{I as k,J as A}from"./register-all-widgets-and-editors-for-testing-ItUXvzfk.js";import{V as x}from"./viewport-resizer-qXfdxIQq.js";import{i as R}from"./icon-paths-5JCXzGsq.js";import{D as v}from"./device-framer-MUDr0WgQ.js";import{E as T}from"./editor-_h5xyzZi.js";import{a as I,b as j,i as N}from"./icon-paths-naSxOxXw.js";import"./button-group-SY8dumRU.js";import"./graph-z47db_ZZ.js";import"./hud-vl2wgoGQ.js";import"./icon-7RFbyLiL.js";import"./index-v9JNnMLE.js";import"./inline-icon-6fh0Wu1y.js";import"./math-input-31AyIaJ4.js";import"./multi-button-group-3E5hf1eq.js";import"./number-input-Y00QdJax.js";import"./range-input-SDS0umcT.js";import"./text-input-Sekx5wCf.js";import"./text-list-editor-ND6Qift6.js";import{I as E}from"./item-extras-editor-w7mbdt7i.js";const{InfoTip:D,InlineIcon:u}=f,g=class g extends s.Component{constructor(){super(...arguments),this.editor=s.createRef(),this.handleChange=e=>{this.props.onChange({replace:e.target.checked})},this.focus=()=>{var e;(e=this.editor.current)==null||e.focus()},this.getSaveWarnings=()=>{var e;return(e=this.editor.current)==null?void 0:e.getSaveWarnings()},this.serialize=e=>{var n;return(n=this.editor.current)==null?void 0:n.serialize(e)}}render(){return t.jsxs("div",{className:"perseus-hint-editor "+this.props.className,children:[this.props.showTitle&&t.jsx("div",{className:"pod-title",children:"Hint"}),t.jsx(T,{ref:this.editor,apiOptions:this.props.apiOptions,widgets:this.props.widgets||void 0,content:this.props.content||void 0,images:this.props.images,replace:this.props.replace,placeholder:"Type your hint here...",imageUploader:this.props.imageUploader,onChange:this.props.onChange},this.props.itemId),t.jsxs("div",{className:"hint-controls-container clearfix",children:[this.props.showMoveButtons&&t.jsxs("span",{className:"reorder-hints",children:[t.jsx("button",{type:"button",className:this.props.isLast?"hidden":"",onClick:o.partial(this.props.onMove,1),children:t.jsx(u,{...I})})," ",t.jsx("button",{type:"button",className:this.props.isFirst?"hidden":"",onClick:o.partial(this.props.onMove,-1),children:t.jsx(u,{...j})})," ",this.props.isLast&&t.jsx(D,{children:t.jsx("p",{children:"The last hint is automatically bolded."})})]}),t.jsx("input",{type:"checkbox",checked:this.props.replace,onChange:this.handleChange}),"Replace previous hint",this.props.showRemoveButton&&t.jsxs("button",{type:"button",className:"remove-hint simple-button orange",onClick:this.props.onRemove,children:[t.jsx(u,{...R}),"Remove this hint"," "]})]})]})}};g.defaultProps={className:"",content:"",replace:!1,showMoveButtons:!0,showTitle:!0,showRemoveButton:!0};let l=g;const y=class y extends s.Component{constructor(){super(...arguments),this.editor=s.createRef(),this.frame=s.createRef(),this.updatePreview=()=>{var n;const e=this.props.isLast&&!/\*\*/.test(this.props.hint.content);(n=this.frame.current)==null||n.sendNewData({type:"hint",data:{hint:this.props.hint,bold:e,pos:this.props.pos,apiOptions:this.props.apiOptions,linterContext:{contentType:"hint",highlightLint:this.props.highlightLint,paths:this.props.contentPaths}}})},this.getSaveWarnings=()=>{var e;return(e=this.editor.current)==null?void 0:e.getSaveWarnings()},this.serialize=e=>{var n;return(n=this.editor.current)==null?void 0:n.serialize(e)},this.focus=()=>{var e;(e=this.editor.current)==null||e.focus()}}componentDidMount(){this.updatePreview()}componentDidUpdate(){this.updatePreview()}render(){const e=this.props.deviceType==="phone"||this.props.deviceType==="tablet";return t.jsxs("div",{className:"perseus-combined-hint-editor perseus-editor-row",children:[t.jsx("div",{className:"perseus-editor-left-cell",children:t.jsx(l,{ref:this.editor,itemId:this.props.itemId,isFirst:this.props.isFirst,isLast:this.props.isLast,widgets:this.props.hint.widgets,content:this.props.hint.content,images:this.props.hint.images,replace:this.props.hint.replace,imageUploader:this.props.imageUploader,onChange:this.props.onChange,onRemove:this.props.onRemove,onMove:this.props.onMove,apiOptions:this.props.apiOptions})}),t.jsx("div",{className:"perseus-editor-right-cell",children:t.jsx(v,{deviceType:this.props.deviceType,nochrome:!0,children:t.jsx(k,{ref:this.frame,datasetKey:"mobile",datasetValue:e,seamless:!0,url:this.props.previewURL})})})]})}};y.defaultProps={highlightLint:!1};let p=y;const h=class h extends s.Component{constructor(){super(...arguments),this.handleHintChange=(e,n,a,r)=>{const i=[...this.props.hints];i[e]=o.extend({},this.serializeHint(e,{keepDeletedWidgets:!0}),n),this.props.onChange({hints:i},a,r)},this.handleHintRemove=e=>{if(!confirm("Are you sure you want to delete this hint?"))return;const n=[...this.props.hints];n.splice(e,1),this.props.onChange({hints:n})},this.handleHintMove=(e,n)=>{const a=[...this.props.hints],r=a.splice(e,1)[0];a.splice(e+n,0,r),this.props.onChange({hints:a},()=>{this.refs["hintEditor"+(e+n)].focus()})},this.addHint=()=>{const e=this.props.hints.concat([{content:"",images:{},widgets:{}}]);this.props.onChange({hints:e},()=>{const n=e.length-1;this.refs["hintEditor"+n].focus()})},this.getSaveWarnings=()=>o.chain(this.props.hints).map((e,n)=>o.map(this.refs["hintEditor"+n].getSaveWarnings(),a=>"Hint "+(n+1)+": "+a)).flatten(!0).value(),this.serialize=e=>this.props.hints.map((n,a)=>this.serializeHint(a,e)),this.serializeHint=(e,n)=>this.refs["hintEditor"+e].serialize(n)}render(){const{itemId:e,hints:n}=this.props,a=o.map(n,function(r,i){return t.jsx(p,{ref:"hintEditor"+i,isFirst:i===0,isLast:i+1===n.length,itemId:e,hint:r,pos:i,imageUploader:this.props.imageUploader,onChange:this.handleHintChange.bind(this,i),onRemove:this.handleHintRemove.bind(this,i),onMove:this.handleHintMove.bind(this,i),deviceType:this.props.deviceType,apiOptions:this.props.apiOptions,highlightLint:this.props.highlightLint,previewURL:this.props.previewURL,contentPaths:[]},"hintEditor"+i)},this);return t.jsxs("div",{className:"perseus-hints-editor perseus-editor-table",children:[a,t.jsx("div",{className:"perseus-editor-row",children:t.jsx("div",{className:"add-hint-container perseus-editor-left-cell",children:t.jsxs("button",{type:"button",className:"add-hint simple-button orange",onClick:this.addHint,children:[t.jsx(u,{...N})," Add a hint"]})})})]})}};h.HintEditor=l,h.defaultProps={onChange:()=>{},hints:[],highlightLint:!1};let d=h;l.__docgenInfo={description:"",methods:[{name:"handleChange",docblock:null,modifiers:[],params:[{name:"e",optional:!1,type:{name:"ReactChangeEvent",raw:"React.ChangeEvent<HTMLInputElement>",elements:[{name:"HTMLInputElement"}],alias:"React.ChangeEvent"}}],returns:null},{name:"focus",docblock:null,modifiers:[],params:[],returns:null},{name:"getSaveWarnings",docblock:null,modifiers:[],params:[],returns:null},{name:"serialize",docblock:null,modifiers:[],params:[{name:"options",optional:!1,type:{name:"any"}}],returns:null}],displayName:"HintEditor",props:{itemId:{required:!1,tsType:{name:"string"},description:""},apiOptions:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
...
| PerseusGraphTypeSinusoid`,elements:[{name:"signature",type:"object",raw:`{
    ...
    // production data that still has this.
    coord?: Coord; // Legacy!
}`,signature:{properties:[{key:"coord",value:{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}],required:!1}}]}}]}],required:!1}}]}},name:"arg1"},{type:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},name:"callback"},{type:{name:"boolean"},name:"silent"}],return:{name:"unknown"}}},description:"",defaultValue:{value:"() => {}",computed:!1}},itemId:{required:!1,tsType:{name:"string"},description:""}}};const M=P,w=class w extends s.Component{constructor(){super(...arguments),this.frame=s.createRef(),this.questionEditor=s.createRef(),this.itemExtrasEditor=s.createRef(),this.updateProps=(e,n,a)=>{const r=o(this.props).pick("question","answerArea");this.props.onChange(o(r).extend(e),n,a)},this.triggerPreviewUpdate=e=>{var n;(n=this.frame.current)==null||n.sendNewData(e)},this.handleEditorChange=(e,n,a)=>{const r=o.extend({},this.props.question,e);this.updateProps({question:r},n,a)},this.handleItemExtrasChange=(e,n,a)=>{const r=o.extend({},this.props.answerArea,e);this.updateProps({answerArea:r},n,a)},this.getSaveWarnings=()=>{var e;return(e=this.questionEditor.current)==null?void 0:e.getSaveWarnings()},this.serialize=e=>{var n,a;return{question:(n=this.questionEditor.current)==null?void 0:n.serialize(e),answerArea:(a=this.itemExtrasEditor.current)==null?void 0:a.serialize(),itemDataVersion:M}}}render(){const e=this.props.deviceType==="phone"||this.props.deviceType==="tablet";return t.jsxs("div",{className:"perseus-editor-table",children:[t.jsxs("div",{className:"perseus-editor-row perseus-question-container",children:[t.jsxs("div",{className:"perseus-editor-left-cell",children:[t.jsx("div",{className:"pod-title",children:"Question"}),t.jsx(T,{ref:this.questionEditor,placeholder:"Type your question here...",className:"perseus-question-editor",imageUploader:this.props.imageUploader,onChange:this.handleEditorChange,apiOptions:this.props.apiOptions,showWordCount:!0,widgetIsOpen:this.props.widgetIsOpen,...this.props.question},this.props.itemId)]}),t.jsx("div",{className:"perseus-editor-right-cell",children:t.jsxs("div",{id:"problemarea",children:[t.jsx(v,{deviceType:this.props.deviceType,nochrome:!0,children:t.jsx(k,{ref:this.frame,datasetKey:"mobile",datasetValue:e,seamless:!0,url:this.props.previewURL},this.props.deviceType)}),t.jsx("div",{id:"hintsarea",className:"hintsarea",style:{display:"none"}})]})})]}),t.jsxs("div",{className:"perseus-editor-row perseus-answer-container",children:[t.jsxs("div",{className:"perseus-editor-left-cell",children:[t.jsx("div",{className:"pod-title",children:"Question extras"}),t.jsx(E,{ref:this.itemExtrasEditor,onChange:this.handleItemExtrasChange,...this.props.answerArea})]}),t.jsx("div",{className:"perseus-editor-right-cell",children:t.jsx("div",{id:"answer_area"})})]})]})}};w.defaultProps={onChange:()=>{},question:{},answerArea:{}};let m=w;m.__docgenInfo={description:"",methods:[{name:"updateProps",docblock:null,modifiers:[],params:[{name:"newProps",optional:!1,type:null},{name:"cb",optional:!1,type:null},{name:"silent",optional:!1,type:null}],returns:null},{name:"triggerPreviewUpdate",docblock:null,modifiers:[],params:[{name:"newData",optional:!1,type:{name:"any"}}],returns:null},{name:"handleEditorChange",docblock:null,modifiers:[],params:[{name:"newProps",optional:!1,type:null},{name:"cb",optional:!1,type:null},{name:"silent",optional:!1,type:null}],returns:null},{name:"handleItemExtrasChange",docblock:null,modifiers:[],params:[{name:"newProps",optional:!1,type:null},{name:"cb",optional:!1,type:null},{name:"silent",optional:!1,type:null}],returns:null},{name:"getSaveWarnings",docblock:null,modifiers:[],params:[],returns:null},{name:"serialize",docblock:null,modifiers:[],params:[{name:"options",optional:!1,type:{name:"any"}}],returns:null}],displayName:"ItemEditor",props:{apiOptions:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
        newFocusPath: FocusPath,
        oldFocusPath: FocusPath,
