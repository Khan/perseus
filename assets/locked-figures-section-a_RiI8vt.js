import{j as o,a as m,F as R}from"./jsx-runtime-FVsy8kgq.js";import{B as _}from"./choice-j6w4LtFN.js";import{V as y,u as D}from"./index-6h5t6F0w.js";import{S as H}from"./index-qUyqkRvh.js";import{s as h,c as O}from"./index-deFLJwr4.js";import{l as L}from"./index-awljIyHI.js";import{r as w}from"./index-TT1qJ6UJ.js";import{H as W}from"./heading-8aCiuWUg.js";import{g as $}from"./util-cGc04Dsc.js";import{a as M,b as B}from"./answer-choices-vfrsv3T5.js";import{L as N}from"./locked-ellipse-settings-nVZ5ToSV.js";import{L as j}from"./locked-function-settings-0J-pQ02o.js";import{L as z}from"./locked-label-settings-bG1DuQ10.js";import{L as U}from"./locked-line-settings--Y3hwFkt.js";import{L as V}from"./locked-point-settings-JcSumuJ4.js";import{L as J}from"./locked-polygon-settings-Bf3FTt76.js";import{L as K}from"./locked-vector-settings-z9b8cA78.js";const x=r=>{const{id:g,onChange:s}=r,l=["point","line","vector","ellipse","polygon","function"];return r.showLabelsFlag&&l.push("label"),o(y,{style:b.container,children:o(M,{menuText:"Add locked figure",style:b.addElementSelect,children:l.map(d=>o(B,{label:d,onClick:()=>s(d)},`${g}-${d}`))})})},b=L.StyleSheet.create({container:{marginTop:h.xSmall_8},addElementSelect:{backgroundColor:O.fadedBlue8,borderRadius:h.xxxSmall_4}});x.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSelect",props:{showLabelsFlag:{required:!1,tsType:{name:"boolean"},description:""},id:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: string) => void",signature:{arguments:[{type:{name:"string"},name:"value"}],return:{name:"void"}}},description:""}}};const F=r=>{switch(r.type){case"point":return o(V,{...r});case"line":return o(U,{...r});case"vector":return o(K,{...r});case"ellipse":return o(N,{...r});case"polygon":return o(J,{...r});case"function":return o(j,{...r});case"label":if(r.showLabelsFlag)return o(z,{...r});break}return null};F.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSettings",props:{showLabelsFlag:{required:!1,tsType:{name:"boolean"},description:""},onMove:{required:!0,tsType:{name:"signature",type:"function",raw:"(movement: LockedFigureSettingsMovementType) => void",signature:{arguments:[{type:{name:"union",raw:`| "back"
| "backward"
| "forward"
| "front"`,elements:[{name:"literal",value:'"back"'},{name:"literal",value:'"backward"'},{name:"literal",value:'"forward"'},{name:"literal",value:'"front"'}]},name:"movement"}],return:{name:"void"}}},description:"Called when a movement button (top, up, down, bottom) is pressed."},onRemove:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Called when the delete button is pressed."},expanded:{required:!1,tsType:{name:"boolean"},description:"Whether this accordion is expanded."},onToggle:{required:!1,tsType:{name:"signature",type:"function",raw:"(expanded: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"expanded"}],return:{name:"void"}}},description:"Called when the accordion is expanded or collapsed."}}};const S=r=>{const g=Array((r.figures??[]).length).fill(!1),[s,l]=w.useState(g),[d,T]=w.useState(!0),k=D().get("locked-figures-section"),{figures:t,onChange:p}=r;function q(e){const a={lockedFigures:[...t||[],$(e)]};p(a),l([...s,!0])}function P(e,n){if(e===0&&(n==="back"||n==="backward")||t&&e===t.length-1&&(n==="front"||n==="forward"))return;const i=[...t||[]],u=[...s],[c]=i.splice(e,1);switch(u.splice(e,1),n){case"back":i.unshift(c),u.unshift(!0);break;case"backward":i.splice(e-1,0,c),u.splice(e-1,0,!0);break;case"forward":i.splice(e+1,0,c),u.splice(e+1,0,!0);break;case"front":i.push(c),u.push(!0);break}p({lockedFigures:i}),l(u)}function A(e){if(window.confirm("Are you sure you want to delete this figure?")){const n=t||[];p({lockedFigures:[...n.slice(0,e),...n.slice(e+1)]});const a=[...s];a.splice(e,1),l(a)}}function C(e,n){const a=t||[],i={lockedFigures:[...a.slice(0,e),{...a[e],...n},...a.slice(e+1)]};p(i)}function I(e){l(Array(t==null?void 0:t.length).fill(e))}const f=s.every(e=>!e),E=f?"Expand all":"Collapse all",G=!!(t!=null&&t.length);return m(R,{children:[o(W,{title:"Locked Figures",isOpen:d,onToggle:()=>T(!d),isCollapsible:!0}),d&&m(y,{children:[t==null?void 0:t.map((e,n)=>o(F,{showLabelsFlag:r.showLabelsFlag,expanded:s[n],onToggle:a=>{const i=[...s];i[n]=a,l(i)},...e,onChangeProps:a=>C(n,a),onMove:a=>P(n,a),onRemove:()=>A(n)},`${k}-locked-${e}-${n}`)),m(y,{style:v.buttonContainer,children:[o(x,{showLabelsFlag:r.showLabelsFlag,id:`${k}-select`,onChange:q}),o(H,{size:h.small_12}),G&&o(_,{kind:"secondary",onClick:()=>I(f),style:v.button,children:E})]})]})]})},v=L.StyleSheet.create({buttonContainer:{flexDirection:"row",alignItems:"center"},button:{marginTop:h.xSmall_8,flexGrow:1}}),he=S;S.__docgenInfo={description:"",methods:[],displayName:"LockedFiguresSection",props:{showLabelsFlag:{required:!1,tsType:{name:"boolean"},description:""},figures:{required:!1,tsType:{name:"Array",elements:[{name:"LockedFigure"}],raw:"Array<LockedFigure>"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(props: Partial<InteractiveGraphEditorProps>) => void",signature:{arguments:[{type:{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
