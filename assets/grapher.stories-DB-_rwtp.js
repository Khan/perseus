import{cL as e}from"./iframe-2g4VQTYH.js";import{S as R}from"./server-item-renderer-with-debug-ui-DIdO9EVB.js";import"./server-item-renderer-CeFddfkI.js";import"./hints-renderer-B15MfxEL.js";import"./main-XnTWIwtN.js";import"./test-keypad-context-wrapper-cLcJR_ge.js";import"./Popper-Dw-YncXa.js";const z={content:`The graph of the function $h(x)=2|x|$ is shown on the grid below.
...
`,images:{},widgets:{"grapher 1":{alignment:"default",graded:!0,options:{availableTypes:["linear","absolute_value","quadratic","exponential","logarithm"],correct:{coords:[[1,-3],[2,0]],type:"absolute_value"},graph:{backgroundImage:{height:400,url:"web+graphie://ka-perseus-graphie.s3.amazonaws.com/1c79f8ae7a226fc3dedd9218cf14810e1580424f",width:400},editableSettings:["graph","snap","image"],gridStep:[1,1],labels:["x","y"],markings:"graph",range:[[-10,10],[-10,10]],rulerLabel:"",rulerTicks:10,showProtractor:!1,showRuler:!1,snapStep:[1,1],step:[1,1],valid:!0}},static:!1,type:"grapher",version:{major:0,minor:0}}}},K={title:"Perseus/Widgets/Grapher",component:R},a={args:{item:e({question:z})}},r={args:{item:e({question:_})}},t={args:{item:e({question:V})}},s={args:{item:e({question:E})}},n={args:{item:e({question:G})}},o={args:{item:e({question:W})}},i={args:{item:e({question:C})}},p={args:{item:e({question:z}),startAnswerless:!0}};var l,g,u;a.parameters={...a.parameters,docs:{...(l=a.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: absoluteValueQuestion
    })
  }
}`,...(u=(g=a.parameters)==null?void 0:g.docs)==null?void 0:u.source}}};var c,h,d;r.parameters={...r.parameters,docs:{...(c=r.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: exponentialQuestion
    })
  }
}`,...(d=(h=r.parameters)==null?void 0:h.docs)==null?void 0:d.source}}};var m,b,f;t.parameters={...t.parameters,docs:{...(m=t.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: linearQuestion
    })
  }
}`,...(f=(b=t.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};var w,$,y;s.parameters={...s.parameters,docs:{...(w=s.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: logarithmQuestion
    })
  }
}`,...(y=($=s.parameters)==null?void 0:$.docs)==null?void 0:y.source}}};var v,x,T;n.parameters={...n.parameters,docs:{...(v=n.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: quadraticQuestion
    })
  }
}`,...(T=(x=n.parameters)==null?void 0:x.docs)==null?void 0:T.source}}};var Q,S,k;o.parameters={...o.parameters,docs:{...(Q=o.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: sinusoidQuestion
    })
  }
}`,...(k=(S=o.parameters)==null?void 0:S.docs)==null?void 0:k.source}}};var q,I,P;i.parameters={...i.parameters,docs:{...(q=i.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: multipleAvailableTypesQuestion
    })
  }
}`,...(P=(I=i.parameters)==null?void 0:I.docs)==null?void 0:P.source}}};var L,A,j;p.parameters={...p.parameters,docs:{...(L=p.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: absoluteValueQuestion
    }),
...
}`,...(j=(A=p.parameters)==null?void 0:A.docs)==null?void 0:j.source}}};const M=["AbsoluteValueQuestion","ExponentialQuestion","LinearQuestion","LogarithmQuestion","QuadraticQuestion","SinusoidQuestion","ComplexQuestion","AnswerlessQuestion"];export{a as AbsoluteValueQuestion,p as AnswerlessQuestion,i as ComplexQuestion,r as ExponentialQuestion,t as LinearQuestion,s as LogarithmQuestion,n as QuadraticQuestion,o as SinusoidQuestion,M as __namedExportsOrder,K as default};
