import{j as t}from"./jsx-runtime-63Ea5SlK.js";import"./article-renderer-jzdHncLR.js";import{_ as s}from"./jquery-yG1GhClm.js";import"./util-AYeX86gl.js";import"./phet-simulation-_7qOO4_B.js";import"./version-akiLXZts.js";import"./dependencies-CP7Uh8Kq.js";import{A as q,C as P}from"./perseus-api-1-ethIrW.js";import{c as C}from"./perseus-item-k3wxfYBT.js";import"./hints-renderer-qloNP0O2.js";import"./renderer-YHYhEo5S.js";import"./base-radio-lt6Z7E-w.js";import{c as f}from"./components-_HVRA9p2.js";import"./index-0C4KXdeC.js";import"./i18n-context-fsWEgybQ.js";import"./svg-image-ZjoZQGiG.js";import"./index-smZ6iCr_.js";import{r as o}from"./index-6oxdNXpR.js";import{I as v,J as A}from"./register-all-widgets-and-editors-for-testing-gs1ybHmo.js";import{V as R}from"./viewport-resizer-dnhJJBOR.js";import{i as x}from"./icon-paths-5JCXzGsq.js";import{D as k}from"./device-framer-MUDr0WgQ.js";import{E as T}from"./editor-aAuETHJB.js";import{a as I,b as j,i as W}from"./icon-paths-EoBkHOLI.js";import"./button-group-G5CZaedn.js";import"./graph-AXw3gRQ0.js";import"./hud-ifw9Ofbw.js";import"./icon-7RFbyLiL.js";import"./index-BIPwuHvF.js";import"./inline-icon-6fh0Wu1y.js";import"./math-input-ILg8RrvB.js";import"./multi-button-group-QUVHbBcE.js";import"./number-input-ogh82yD8.js";import"./range-input-w5Z3sPK5.js";import"./text-input-e6f7u9S5.js";import"./text-list-editor-aj1SAzcA.js";import{I as N}from"./item-extras-editor-Az2IzVNm.js";const{InfoTip:M,InlineIcon:u}=f,g=class g extends o.Component{constructor(){super(...arguments),this.editor=o.createRef(),this.handleChange=e=>{this.props.onChange({replace:e.target.checked})},this.focus=()=>{var e;(e=this.editor.current)==null||e.focus()},this.getSaveWarnings=()=>{var e;return(e=this.editor.current)==null?void 0:e.getSaveWarnings()},this.serialize=e=>{var n;return(n=this.editor.current)==null?void 0:n.serialize(e)}}render(){return t.jsxs("div",{className:"perseus-hint-editor "+this.props.className,children:[this.props.showTitle&&t.jsx("div",{className:"pod-title",children:"Hint"}),t.jsx(T,{ref:this.editor,apiOptions:this.props.apiOptions,widgets:this.props.widgets||void 0,content:this.props.content||void 0,images:this.props.images,replace:this.props.replace,placeholder:"Type your hint here...",imageUploader:this.props.imageUploader,onChange:this.props.onChange},this.props.itemId),t.jsxs("div",{className:"hint-controls-container clearfix",children:[this.props.showMoveButtons&&t.jsxs("span",{className:"reorder-hints",children:[t.jsx("button",{type:"button",className:this.props.isLast?"hidden":"",onClick:s.partial(this.props.onMove,1),children:t.jsx(u,{...I})})," ",t.jsx("button",{type:"button",className:this.props.isFirst?"hidden":"",onClick:s.partial(this.props.onMove,-1),children:t.jsx(u,{...j})})," ",this.props.isLast&&t.jsx(M,{children:t.jsx("p",{children:"The last hint is automatically bolded."})})]}),t.jsx("input",{type:"checkbox",checked:this.props.replace,onChange:this.handleChange}),"Replace previous hint",this.props.showRemoveButton&&t.jsxs("button",{type:"button",className:"remove-hint simple-button orange",onClick:this.props.onRemove,children:[t.jsx(u,{...x}),"Remove this hint"," "]})]})]})}};g.defaultProps={className:"",content:"",replace:!1,showMoveButtons:!0,showTitle:!0,showRemoveButton:!0};let l=g;const y=class y extends o.Component{constructor(){super(...arguments),this.editor=o.createRef(),this.frame=o.createRef(),this.updatePreview=()=>{var n;const e=this.props.isLast&&!/\*\*/.test(this.props.hint.content);(n=this.frame.current)==null||n.sendNewData({type:"hint",data:{hint:this.props.hint,bold:e,pos:this.props.pos,apiOptions:this.props.apiOptions,linterContext:{contentType:"hint",highlightLint:this.props.highlightLint,paths:this.props.contentPaths}}})},this.getSaveWarnings=()=>{var e;return(e=this.editor.current)==null?void 0:e.getSaveWarnings()},this.serialize=e=>{var n;return(n=this.editor.current)==null?void 0:n.serialize(e)},this.focus=()=>{var e;(e=this.editor.current)==null||e.focus()}}componentDidMount(){this.updatePreview()}componentDidUpdate(){this.updatePreview()}render(){const e=this.props.deviceType==="phone"||this.props.deviceType==="tablet";return t.jsxs("div",{className:"perseus-combined-hint-editor perseus-editor-row",children:[t.jsx("div",{className:"perseus-editor-left-cell",children:t.jsx(l,{ref:this.editor,itemId:this.props.itemId,isFirst:this.props.isFirst,isLast:this.props.isLast,widgets:this.props.hint.widgets,content:this.props.hint.content,images:this.props.hint.images,replace:this.props.hint.replace,imageUploader:this.props.imageUploader,onChange:this.props.onChange,onRemove:this.props.onRemove,onMove:this.props.onMove,apiOptions:this.props.apiOptions})}),t.jsx("div",{className:"perseus-editor-right-cell",children:t.jsx(k,{deviceType:this.props.deviceType,nochrome:!0,children:t.jsx(v,{ref:this.frame,datasetKey:"mobile",datasetValue:e,seamless:!0,url:this.props.previewURL})})})]})}};y.defaultProps={highlightLint:!1};let h=y;const p=class p extends o.Component{constructor(){super(...arguments),this.handleHintChange=(e,n,a,r)=>{const i=[...this.props.hints];i[e]=s.extend({},this.serializeHint(e,{keepDeletedWidgets:!0}),n),this.props.onChange({hints:i},a,r)},this.handleHintRemove=e=>{if(!confirm("Are you sure you want to delete this hint?"))return;const n=[...this.props.hints];n.splice(e,1),this.props.onChange({hints:n})},this.handleHintMove=(e,n)=>{const a=[...this.props.hints],r=a.splice(e,1)[0];a.splice(e+n,0,r),this.props.onChange({hints:a},()=>{this.refs["hintEditor"+(e+n)].focus()})},this.addHint=()=>{const e=this.props.hints.concat([{content:"",images:{},widgets:{}}]);this.props.onChange({hints:e},()=>{const n=e.length-1;this.refs["hintEditor"+n].focus()})},this.getSaveWarnings=()=>s.chain(this.props.hints).map((e,n)=>s.map(this.refs["hintEditor"+n].getSaveWarnings(),a=>"Hint "+(n+1)+": "+a)).flatten(!0).value(),this.serialize=e=>this.props.hints.map((n,a)=>this.serializeHint(a,e)),this.serializeHint=(e,n)=>this.refs["hintEditor"+e].serialize(n)}render(){const{itemId:e,hints:n}=this.props,a=s.map(n,function(r,i){return t.jsx(h,{ref:"hintEditor"+i,isFirst:i===0,isLast:i+1===n.length,itemId:e,hint:r,pos:i,imageUploader:this.props.imageUploader,onChange:this.handleHintChange.bind(this,i),onRemove:this.handleHintRemove.bind(this,i),onMove:this.handleHintMove.bind(this,i),deviceType:this.props.deviceType,apiOptions:this.props.apiOptions,highlightLint:this.props.highlightLint,previewURL:this.props.previewURL,contentPaths:[]},"hintEditor"+i)},this);return t.jsxs("div",{className:"perseus-hints-editor perseus-editor-table",children:[a,t.jsx("div",{className:"perseus-editor-row",children:t.jsx("div",{className:"add-hint-container perseus-editor-left-cell",children:t.jsxs("button",{type:"button",className:"add-hint simple-button orange",onClick:this.addHint,children:[t.jsx(u,{...W})," Add a hint"]})})})]})}};p.HintEditor=l,p.defaultProps={onChange:()=>{},hints:[],highlightLint:!1};let d=p;l.__docgenInfo={description:"",methods:[{name:"handleChange",docblock:null,modifiers:[],params:[{name:"e",optional:!1,type:{name:"ReactChangeEvent",raw:"React.ChangeEvent<HTMLInputElement>",elements:[{name:"HTMLInputElement"}],alias:"React.ChangeEvent"}}],returns:null},{name:"focus",docblock:null,modifiers:[],params:[],returns:null},{name:"getSaveWarnings",docblock:null,modifiers:[],params:[],returns:null},{name:"serialize",docblock:null,modifiers:[],params:[{name:"options",optional:!1,type:{name:"any"}}],returns:null}],displayName:"HintEditor",props:{itemId:{required:!1,tsType:{name:"string"},description:""},apiOptions:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
...
the available choices.`}]}}],raw:`Readonly<{
     ...
     */
    onWidgetStartProps?: (widgets: PerseusWidgetsMap) => void;
}>`},description:""},className:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'""',computed:!1}},imageUploader:{required:!1,tsType:{name:"signature",type:"function",raw:`(
    file: File,
    callback: (url: string) => unknown,
) => unknown`,signature:{arguments:[{type:{name:"File"},name:"file"},{type:{name:"signature",type:"function",raw:"(url: string) => unknown",signature:{arguments:[{type:{name:"string"},name:"url"}],return:{name:"unknown"}}},name:"callback"}],return:{name:"unknown"}}},description:""},showMoveButtons:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},showRemoveButton:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},showTitle:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},content:{required:!1,tsType:{name:"union",raw:"string | null | undefined",elements:[{name:"string"},{name:"null"},{name:"undefined"}]},description:"",defaultValue:{value:'""',computed:!1}},replace:{required:!1,tsType:{name:"union",raw:"boolean | null | undefined",elements:[{name:"boolean"},{name:"null"},{name:"undefined"}]},description:"",defaultValue:{value:"false",computed:!1}},widgets:{required:!1,tsType:{name:"union",raw:"PerseusWidgetsMap | null | undefined",elements:[{name:"signature",type:"object",raw:"{\n    [Property in keyof PerseusWidgetTypes as `${Property} ${number}`]: PerseusWidgetTypes[Property];\n}",signature:{properties:[{key:{name:"PerseusWidgetTypes",required:!0},value:{name:"PerseusWidgetTypes[Property]",raw:"PerseusWidgetTypes[Property]"}}]}},{name:"null"},{name:"undefined"}]},description:""},images:{required:!1,tsType:{name:"union",raw:"ImageDict | null | undefined",elements:[{name:"signature",type:"object",raw:`{
    [url: string]: Dimensions;
}`,signature:{properties:[{key:{name:"string"},value:{name:"signature",type:"object",raw:`{
    width?: number;
    height?: number;
}`,signature:{properties:[{key:"width",value:{name:"number",required:!1}},{key:"height",value:{name:"number",required:!1}}]},required:!0}}]}},{name:"null"},{name:"undefined"}]},description:""},isLast:{required:!0,tsType:{name:"boolean"},description:""},isFirst:{required:!0,tsType:{name:"boolean"},description:""},onMove:{required:!0,tsType:{name:"signature",type:"function",raw:"(direction: number) => unknown",signature:{arguments:[{type:{name:"number"},name:"direction"}],return:{name:"unknown"}}},description:""},onRemove:{required:!0,tsType:{name:"signature",type:"function",raw:"() => unknown",signature:{arguments:[],return:{name:"unknown"}}},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:`(
    arg1: {
...
| PerseusGraphTypeSinusoid`,elements:[{name:"signature",type:"object",raw:`{
    ...
    // production data that still has this.
    coord?: Coord; // Legacy!
}`,signature:{properties:[{key:"coord",value:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}],required:!1}}]}}]}],required:!1}}]}},name:"arg1"},{type:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},name:"callback"},{type:{name:"boolean"},name:"silent"}],return:{name:"unknown"}}},description:""},__type:{required:!1,tsType:{name:"literal",value:'"hint"'},description:""}}};d.__docgenInfo={description:"",methods:[{name:"handleHintChange",docblock:null,modifiers:[],params:[{name:"i",optional:!1,type:{name:"number"}},{name:"newProps",optional:!1,type:{name:"signature",type:"object",raw:`{
...
| PerseusGraphTypeSinusoid`,elements:[{name:"signature",type:"object",raw:`{
    ...
    // production data that still has this.
    coord?: Coord; // Legacy!
}`,signature:{properties:[{key:"coord",value:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}],required:!1}}]}}]}],required:!1}}]}},name:"arg1"},{type:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},name:"callback"},{type:{name:"boolean"},name:"silent"}],return:{name:"unknown"}}},description:"",defaultValue:{value:"() => {}",computed:!1}},itemId:{required:!1,tsType:{name:"string"},description:""}}};const E=C,w=class w extends o.Component{constructor(){super(...arguments),this.frame=o.createRef(),this.questionEditor=o.createRef(),this.itemExtrasEditor=o.createRef(),this.updateProps=(e,n,a)=>{const r=s(this.props).pick("question","answerArea");this.props.onChange(s(r).extend(e),n,a)},this.triggerPreviewUpdate=e=>{var n;(n=this.frame.current)==null||n.sendNewData(e)},this.handleEditorChange=(e,n,a)=>{const r=s.extend({},this.props.question,e);this.updateProps({question:r},n,a)},this.handleItemExtrasChange=(e,n,a)=>{const r=s.extend({},this.props.answerArea,e);this.updateProps({answerArea:r},n,a)},this.getSaveWarnings=()=>{var e;return(e=this.questionEditor.current)==null?void 0:e.getSaveWarnings()},this.serialize=e=>{var n,a;return{question:(n=this.questionEditor.current)==null?void 0:n.serialize(e),answerArea:(a=this.itemExtrasEditor.current)==null?void 0:a.serialize(),itemDataVersion:E}}}render(){const e=this.props.deviceType==="phone"||this.props.deviceType==="tablet";return t.jsxs("div",{className:"perseus-editor-table",children:[t.jsxs("div",{className:"perseus-editor-row perseus-question-container",children:[t.jsxs("div",{className:"perseus-editor-left-cell",children:[t.jsx("div",{className:"pod-title",children:"Question"}),t.jsx(T,{ref:this.questionEditor,placeholder:"Type your question here...",className:"perseus-question-editor",imageUploader:this.props.imageUploader,onChange:this.handleEditorChange,apiOptions:this.props.apiOptions,showWordCount:!0,widgetIsOpen:this.props.widgetIsOpen,...this.props.question},this.props.itemId)]}),t.jsx("div",{className:"perseus-editor-right-cell",children:t.jsxs("div",{id:"problemarea",children:[t.jsx(k,{deviceType:this.props.deviceType,nochrome:!0,children:t.jsx(v,{ref:this.frame,datasetKey:"mobile",datasetValue:e,seamless:!0,url:this.props.previewURL},this.props.deviceType)}),t.jsx("div",{id:"hintsarea",className:"hintsarea",style:{display:"none"}})]})})]}),t.jsxs("div",{className:"perseus-editor-row perseus-answer-container",children:[t.jsxs("div",{className:"perseus-editor-left-cell",children:[t.jsx("div",{className:"pod-title",children:"Question extras"}),t.jsx(N,{ref:this.itemExtrasEditor,onChange:this.handleItemExtrasChange,...this.props.answerArea})]}),t.jsx("div",{className:"perseus-editor-right-cell",children:t.jsx("div",{id:"answer_area"})})]})]})}};w.defaultProps={onChange:()=>{},question:{},answerArea:{}};let m=w;m.__docgenInfo={description:"",methods:[{name:"updateProps",docblock:null,modifiers:[],params:[{name:"newProps",optional:!1,type:null},{name:"cb",optional:!1,type:null},{name:"silent",optional:!1,type:null}],returns:null},{name:"triggerPreviewUpdate",docblock:null,modifiers:[],params:[{name:"newData",optional:!1,type:{name:"any"}}],returns:null},{name:"handleEditorChange",docblock:null,modifiers:[],params:[{name:"newProps",optional:!1,type:null},{name:"cb",optional:!1,type:null},{name:"silent",optional:!1,type:null}],returns:null},{name:"handleItemExtrasChange",docblock:null,modifiers:[],params:[{name:"newProps",optional:!1,type:null},{name:"cb",optional:!1,type:null},{name:"silent",optional:!1,type:null}],returns:null},{name:"getSaveWarnings",docblock:null,modifiers:[],params:[],returns:null},{name:"serialize",docblock:null,modifiers:[],params:[{name:"options",optional:!1,type:{name:"any"}}],returns:null}],displayName:"ItemEditor",props:{apiOptions:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
        newFocusPath: FocusPath,
        oldFocusPath: FocusPath,
...
| PerseusGraphTypeSinusoid`,elements:[{name:"signature",type:"object",raw:`{
    ...
    // production data that still has this.
    coord?: Coord; // Legacy!
}`,signature:{properties:[{key:"coord",value:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}],required:!1}}]}}]}],required:!1}}]}},name:"arg1"},{type:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},name:"callback"},{type:{name:"boolean"},name:"silent"}],return:{name:"unknown"}}},description:"",defaultValue:{value:"() => {}",computed:!1}},itemId:{required:!1,tsType:{name:"string"},description:""}}};const{HUD:D}=f,b=class b extends o.Component{constructor(e){super(e),this.itemEditor=o.createRef(),this.hintsEditor=o.createRef(),this.toggleJsonMode=()=>{this.setState({json:this.serialize({keepDeletedWidgets:!0})},()=>{this.props.onChange({jsonMode:!this.props.jsonMode})})},this.handleChange=(n,a,r)=>{const i=s(this.props).pick("question","hints","answerArea");s(i).extend(n),this.props.onChange(i,a,r)},this.changeJSON=n=>{this.setState({json:n}),this.props.onChange(n)},this.state={json:s.pick(this.props,"question","answerArea","hints","itemDataVersion"),gradeMessage:"",wasAnswered:!1,highlightLint:!0,widgetsAreOpen:this.props.widgetsAreOpen??!0},this._isMounted=!1}componentDidMount(){this._isMounted=!0,this.updateRenderer()}componentDidUpdate(){setTimeout(()=>{this.updateRenderer()})}componentWillUnmount(){this._isMounted=!1}updateRenderer(){var r,i;const e=!this.props.developerMode||!this.props.jsonMode;if(!this._isMounted||!e)return;const n=this.props.previewDevice==="phone"||this.props.previewDevice==="tablet",a={...this.getApiOptions(),customKeypad:n,isMobile:n};(i=this.itemEditor.current)==null||i.triggerPreviewUpdate({type:"question",data:s({item:this.serialize(),apiOptions:a,initialHintsVisible:0,device:this.props.previewDevice,linterContext:{contentType:"exercise",highlightLint:this.state.highlightLint,paths:this.props.contentPaths||[]},reviewMode:!0,legacyPerseusLint:(r=this.itemEditor.current)==null?void 0:r.getSaveWarnings()}).extend(s(this.props).pick("workAreaSelector","solutionAreaSelector","hintsAreaSelector","problemNum"))})}getApiOptions(){return{...q.defaults,...this.props.apiOptions}}getSaveWarnings(){var a,r;const e=(a=this.itemEditor.current)==null?void 0:a.getSaveWarnings(),n=(r=this.hintsEditor.current)==null?void 0:r.getSaveWarnings();return e.concat(n)}serialize(e){var n,a;return this.props.jsonMode?this.state.json:s.extend((n=this.itemEditor.current)==null?void 0:n.serialize(e),{hints:(a=this.hintsEditor.current)==null?void 0:a.serialize(e)})}render(){let e="framework-perseus";const n=this.props.previewDevice==="phone"||this.props.previewDevice==="tablet",a={...this.getApiOptions(),customKeypad:n,isMobile:n};return a.isMobile&&(e+=" "+P.MOBILE),t.jsxs("div",{id:"perseus",className:e,children:[t.jsxs("div",{style:{marginBottom:10},children:[this.props.developerMode&&t.jsxs("span",{children:[t.jsxs("label",{children:[" ","Developer JSON Mode:"," ",t.jsx("input",{type:"checkbox",checked:this.props.jsonMode,onChange:this.toggleJsonMode})]})," "]}),!this.props.jsonMode&&t.jsx(R,{deviceType:this.props.previewDevice,onViewportSizeChanged:this.props.onPreviewDeviceChange}),!this.props.jsonMode&&t.jsx(D,{message:"Style warnings",enabled:this.state.highlightLint,onClick:()=>{this.setState({highlightLint:!this.state.highlightLint})}})]}),this.props.developerMode&&this.props.jsonMode&&t.jsx("div",{children:t.jsx(A,{multiLine:!0,value:this.state.json,onChange:this.changeJSON})}),(!this.props.developerMode||!this.props.jsonMode)&&t.jsx(m,{ref:this.itemEditor,itemId:this.props.itemId,question:this.props.question,answerArea:this.props.answerArea,imageUploader:this.props.imageUploader,onChange:this.handleChange,wasAnswered:this.state.wasAnswered,gradeMessage:this.state.gradeMessage,deviceType:this.props.previewDevice,widgetIsOpen:this.state.widgetsAreOpen,apiOptions:a,previewURL:this.props.previewURL}),(!this.props.developerMode||!this.props.jsonMode)&&t.jsx(d,{ref:this.hintsEditor,itemId:this.props.itemId,hints:this.props.hints,imageUploader:this.props.imageUploader,onChange:this.handleChange,deviceType:this.props.previewDevice,apiOptions:a,previewURL:this.props.previewURL,highlightLint:this.state.highlightLint})]})}};b.defaultProps={developerMode:!1,jsonMode:!1,onChange:()=>{}};let c=b;c.__docgenInfo={description:"",methods:[{name:"toggleJsonMode",docblock:null,modifiers:[],params:[],returns:null},{name:"updateRenderer",docblock:null,modifiers:[],params:[],returns:null},{name:"getApiOptions",docblock:null,modifiers:[],params:[],returns:{type:{name:"Readonly",elements:[{name:"intersection",raw:`APIOptions & {
