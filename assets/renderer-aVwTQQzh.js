...
|$)`,"gm"),ze=/\n{2,}$/,Er=/^ (?= *`)|(` *) $/g,Or=ze,Oe=/ *\n+$/,Xr=new RegExp("^( *)("+oe+`) [\\s\\S]+?(?:
{2,}(?! )(?!\\1`+oe+` )\\n*|\\s*
*$)`),jr=/(?:^|\n)( *)$/,re=function(){var r=/^ *\| *| *\| *$/g,e=/ *$/,n=/^ *-+: *$/,t=/^ *:-+: *$/,a=/^ *:-+ *$/,i=function(g){return n.test(g)?"right":t.test(g)?"center":a.test(g)?"left":null},o=function(g,y,b,v){v&&(g=g.replace(r,""));var q=g.trim().split("|");return q.map(i)},s=function(g,y,b,v){var q=b.inTable;b.inTable=!0;var c=y(g.trim(),b);b.inTable=q;var k=[[]];return c.forEach(function(P,C){P.type==="tableSeparator"?(!v||C!==0&&C!==c.length-1)&&k.push([]):(P.type==="text"&&(c[C+1]==null||c[C+1].type==="tableSeparator")&&(P.content=P.content.replace(e,"")),k[k.length-1].push(P))}),k},u=function(g,y,b,v){var q=g.trim().split(`
`);return q.map(function(c){return s(c,y,b,v)})},d=function(g){return function(y,b,v){v.inline=!0;var q=s(y[1],b,v,g),c=o(y[2],b,v,g),k=u(y[3],b,v,g);return v.inline=!1,{type:"table",header:q,align:c,cells:k}}};return{parseTable:d(!0),parseNpTable:d(!1),TABLE_REGEX:/^ *(\|.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/,NPTABLE_REGEX:/^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/}}(),te="(?:\\[[^\\]]*\\]|[^\\[\\]]|\\](?=[^\\[]*\\]))*",Xe=`\\s*<?((?:\\([^)]*\\)|[^\\s\\\\]|\\\\.)*?)>?(?:\\s+['"]([\\s\\S]*?)['"])?\\s*`,Lr=/mailto:/i,je=function(r,e,n){var t=(r[2]||r[1]).replace(/\s+/g," ").toLowerCase();if(e._defs&&e._defs[t]){var a=e._defs[t];n.target=a.target,n.title=a.title}return e._refs=e._refs||{},e._refs[t]=e._refs[t]||[],e._refs[t].push(n),n},w=0,J={Array:{react:function(r,e,n){for(var t=n.key,a=[],i=0,o=0;i<r.length;i++,o++){n.key=""+i;var s=r[i];if(s.type==="text")for(s={type:"text",content:s.content};i+1<r.length&&r[i+1].type==="text";i++)s.content+=r[i+1].content;a.push(e(s,n))}return n.key=t,a},html:function(r,e,n){for(var t="",a=0;a<r.length;a++){var i=r[a];if(i.type==="text")for(i={type:"text",content:i.content};a+1<r.length&&r[a+1].type==="text";a++)i.content+=r[a+1].content;t+=e(i,n)}return t}},heading:{order:w++,match:I(/^ *(#{1,6})([^\n]+?)#* *(?:\n *)+\n/),parse:function(r,e,n){return{level:r[1].length,content:se(e,r[2].trim(),n)}},react:function(r,e,n){return f("h"+r.level,n.key,{children:e(r.content,n)})},html:function(r,e,n){return x("h"+r.level,e(r.content,n))}},nptable:{order:w++,match:I(re.NPTABLE_REGEX),parse:re.parseNpTable,react:null,html:null},lheading:{order:w++,match:I(/^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/),parse:function(r,e,n){return{type:"heading",level:r[2]==="="?1:2,content:se(e,r[1],n)}},react:null,html:null},hr:{order:w++,match:I(/^( *[-*_]){3,} *(?:\n *)+\n/),parse:he,react:function(r,e,n){return f("hr",n.key,{"aria-hidden":!0})},html:function(r,e,n){return'<hr aria-hidden="true">'}},codeBlock:{order:w++,match:I(/^(?:    [^\n]+\n*)+(?:\n *)+\n/),parse:function(r,e,n){var t=r[0].replace(/^    /gm,"").replace(/\n+$/,"");return{lang:void 0,content:t}},react:function(r,e,n){var t=r.lang?"markdown-code-"+r.lang:void 0;return f("pre",n.key,{children:f("code",null,{className:t,children:r.content})})},html:function(r,e,n){var t=r.lang?"markdown-code-"+r.lang:void 0,a=x("code",_(r.content),{class:t});return x("pre",a)}},fence:{order:w++,match:I(/^ *(`{3,}|~{3,}) *(?:(\S+) *)?\n([\s\S]+?)\n?\1 *(?:\n *)+\n/),parse:function(r,e,n){return{type:"codeBlock",lang:r[2]||void 0,content:r[3]}},react:null,html:null},blockQuote:{order:w++,match:I(/^( *>[^\n]+(\n[^\n]+)*\n*)+\n{2,}/),parse:function(r,e,n){var t=r[0].replace(/^ *> ?/gm,"");return{content:e(t,n)}},react:function(r,e,n){return f("blockquote",n.key,{children:e(r.content,n)})},html:function(r,e,n){return x("blockquote",e(r.content,n))}},list:{order:w++,match:function(r,e){var n=e.prevCapture==null?"":e.prevCapture[0],t=jr.exec(n),a=e._list||!e.inline;return t&&a?(r=t[1]+r,Xr.exec(r)):null},parse:function(r,e,n){var t=r[2],a=t.length>1,i=a?+t:void 0,o=r[0].replace(Or,`
`).match(Nr),s=!1,u=o.map(function(d,g){var y=Ee.exec(d),b=y?y[0].length:0,v=new RegExp("^ {1,"+b+"}","gm"),q=d.replace(v,"").replace(Ee,""),c=g===o.length-1,k=q.indexOf(`

`)!==-1,P=k||c&&s;s=P;var C=n.inline,L=n._list;n._list=!0;var A;P?(n.inline=!1,A=q.replace(Oe,`

`)):(n.inline=!0,A=q.replace(Oe,""));var Z=e(A,n);return n.inline=C,n._list=L,Z});return{ordered:a,start:i,items:u}},react:function(r,e,n){var t=r.ordered?"ol":"ul";return f(t,n.key,{start:r.start,children:r.items.map(function(a,i){return f("li",""+i,{children:e(a,n)})})})},html:function(r,e,n){var t=r.items.map(function(o){return x("li",e(o,n))}).join(""),a=r.ordered?"ol":"ul",i={start:r.start};return x(a,t,i)}},def:{order:w++,match:I(/^ *\[([^\]]+)\]: *<?([^\s>]*)>?(?: +["(]([^\n]+)[")])? *\n(?: *\n)*/),parse:function(r,e,n){var t=r[1].replace(/\s+/g," ").toLowerCase(),a=r[2],i=r[3];return n._refs&&n._refs[t]&&n._refs[t].forEach(function(o){o.target=a,o.title=i}),n._defs=n._defs||{},n._defs[t]={target:a,title:i},{def:t,target:a,title:i}},react:function(){return null},html:function(){return""}},table:{order:w++,match:I(re.TABLE_REGEX),parse:re.parseTable,react:function(r,e,n){var t=function(o){return r.align[o]==null?{}:{textAlign:r.align[o]}},a=r.header.map(function(o,s){return f("th",""+s,{style:t(s),scope:"col",children:e(o,n)})}),i=r.cells.map(function(o,s){return f("tr",""+s,{children:o.map(function(u,d){return f("td",""+d,{style:t(d),children:e(u,n)})})})});return f("table",n.key,{children:[f("thead","thead",{children:f("tr",null,{children:a})}),f("tbody","tbody",{children:i})]})},html:function(r,e,n){var t=function(u){return r.align[u]==null?"":"text-align:"+r.align[u]+";"},a=r.header.map(function(u,d){return x("th",e(u,n),{style:t(d),scope:"col"})}).join(""),i=r.cells.map(function(u){var d=u.map(function(g,y){return x("td",e(g,n),{style:t(y)})}).join("");return x("tr",d)}).join(""),o=x("thead",x("tr",a)),s=x("tbody",i);return x("table",o+s)}},newline:{order:w++,match:I(/^(?:\n *)*\n/),parse:he,react:function(r,e,n){return`
`},html:function(r,e,n){return`
`}},paragraph:{order:w++,match:I(/^((?:[^\n]|\n(?! *\n))+)(?:\n *)+\n/),parse:ne,react:function(r,e,n){return f("div",n.key,{className:"paragraph",children:e(r.content,n)})},html:function(r,e,n){var t={class:"paragraph"};return x("div",e(r.content,n),t)}},escape:{order:w++,match:R(/^\\([^0-9A-Za-z\s])/),parse:function(r,e,n){return{type:"text",content:r[1]}},react:null,html:null},tableSeparator:{order:w++,match:function(r,e){return e.inTable?/^ *\| */.exec(r):null},parse:function(){return{type:"tableSeparator"}},react:function(){return" | "},html:function(){return" &vert; "}},autolink:{order:w++,match:R(/^<([^: >]+:\/[^ >]+)>/),parse:function(r,e,n){return{type:"link",content:[{type:"text",content:r[1]}],target:r[1]}},react:null,html:null},mailto:{order:w++,match:R(/^<([^ >]+@[^ >]+)>/),parse:function(r,e,n){var t=r[1],a=r[1];return Lr.test(a)||(a="mailto:"+a),{type:"link",content:[{type:"text",content:t}],target:a}},react:null,html:null},url:{order:w++,match:R(/^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/),parse:function(r,e,n){return{type:"link",content:[{type:"text",content:r[1]}],target:r[1],title:void 0}},react:null,html:null},link:{order:w++,match:R(new RegExp("^\\[("+te+")\\]\\("+Xe+"\\)")),parse:function(r,e,n){var t={content:e(r[1],n),target:fe(r[2]),title:r[3]};return t},react:function(r,e,n){return f("a",n.key,{href:z(r.target),title:r.title,children:e(r.content,n)})},html:function(r,e,n){var t={href:z(r.target),title:r.title};return x("a",e(r.content,n),t)}},image:{order:w++,match:R(new RegExp("^!\\[("+te+")\\]\\("+Xe+"\\)")),parse:function(r,e,n){var t={alt:r[1],target:fe(r[2]),title:r[3]};return t},react:function(r,e,n){return f("img",n.key,{src:z(r.target),alt:r.alt,title:r.title})},html:function(r,e,n){var t={src:z(r.target),alt:r.alt,title:r.title};return x("img","",t,!1)}},reflink:{order:w++,match:R(new RegExp("^\\[("+te+")\\]\\s*\\[([^\\]]*)\\]")),parse:function(r,e,n){return je(r,n,{type:"link",content:e(r[1],n)})},react:null,html:null},refimage:{order:w++,match:R(new RegExp("^!\\[("+te+")\\]\\s*\\[([^\\]]*)\\]")),parse:function(r,e,n){return je(r,n,{type:"image",alt:r[1]})},react:null,html:null},em:{order:w,match:R(new RegExp("^\\b_((?:__|\\\\[\\s\\S]|[^\\\\_])+?)_\\b|^\\*(?=\\S)((?:\\*\\*|\\\\[\\s\\S]|\\s+(?:\\\\[\\s\\S]|[^\\s\\*\\\\]|\\*\\*)|[^\\s\\*\\\\])+?)\\*(?!\\*)")),quality:function(r){return r[0].length+.2},parse:function(r,e,n){return{content:e(r[2]||r[1],n)}},react:function(r,e,n){return f("em",n.key,{children:e(r.content,n)})},html:function(r,e,n){return x("em",e(r.content,n))}},strong:{order:w,match:R(/^\*\*((?:\\[\s\S]|[^\\])+?)\*\*(?!\*)/),quality:function(r){return r[0].length+.1},parse:ne,react:function(r,e,n){return f("strong",n.key,{children:e(r.content,n)})},html:function(r,e,n){return x("strong",e(r.content,n))}},u:{order:w++,match:R(/^__((?:\\[\s\S]|[^\\])+?)__(?!_)/),quality:function(r){return r[0].length},parse:ne,react:function(r,e,n){return f("u",n.key,{children:e(r.content,n)})},html:function(r,e,n){return x("u",e(r.content,n))}},del:{order:w++,match:R(/^~~(?=\S)((?:\\[\s\S]|~(?!~)|[^\s~\\]|\s(?!~~))+?)~~/),parse:ne,react:function(r,e,n){return f("del",n.key,{children:e(r.content,n)})},html:function(r,e,n){return x("del",e(r.content,n))}},inlineCode:{order:w++,match:R(/^(`+)([\s\S]*?[^`])\1(?!`)/),parse:function(r,e,n){return{content:r[2].replace(Er,"$1")}},react:function(r,e,n){return f("code",n.key,{children:r.content})},html:function(r,e,n){return x("code",_(r.content))}},br:{order:w++,match:ve(/^ {2,}\n/),parse:he,react:function(r,e,n){return f("br",n.key,Ar)},html:function(r,e,n){return"<br>"}},text:{order:w++,match:ve(/^[\s\S]+?(?=[^0-9A-Za-z\s\u00c0-\uffff]|\n\n| {2,}\n|\w+:\S|$)/),parse:function(r,e,n){return{content:r[0]}},react:function(r,e,n){return r.content},html:function(r,e,n){return _(r.content)}}},Yr=function(r,e){!e&&typeof console<"u"&&console.warn("simple-markdown ruleOutput should take 'react' or 'html' as the second argument.");var n=function(t,a,i){return r[t.type][e](t,a,i)};return n},Wr=function(r){var e=function(n,t){if(t=t||{},Array.isArray(n)){for(var a=t.key,i=[],o=null,s=0;s<n.length;s++){t.key=""+s;var u=e(n[s],t);typeof u=="string"&&typeof o=="string"?(o=o+u,i[i.length-1]=o):(i.push(u),o=u)}return t.key=a,i}else return r(n,e,t)};return e},Mr=function(r){var e=function(n,t){return t=t||{},Array.isArray(n)?n.map(function(a){return e(a,t)}).join(""):r(n,e,t)};return e},Re=function(r,e,n={}){if(!e)throw new Error("simple-markdown: outputFor: `property` must be defined. if you just upgraded, you probably need to replace `outputFor` with `reactFor`");var t,a=r.Array||J.Array,i=a[e];if(!i)throw new Error("simple-markdown: outputFor: to join nodes of type `"+e+"` you must provide an `Array:` joiner rule with that type, Please see the docs for details on specifying an Array rule.");var o=i,s=function(d,g){return g=g||t,t=g,Array.isArray(d)?o(d,s,g):r[d.type][e](d,s,g)},u=function(d,g){return t=_e(g,n),s(d,t)};return u},ge=Ue(J),Ce=function(r,e){return e=e||{},e.inline=!1,ge(r,e)},Gr=function(r,e){return e=e||{},e.inline=!0,ge(r,e)},Le=function(r,e){var n=ze.test(r);return e=e||{},e.inline=!n,ge(r,e)},qe=Re(J,"react"),He=Re(J,"html"),Ke=function(r,e){return qe(Ce(r,e),e)},Dr=function(r,e){return He(Ce(r,e),e)},Fr=function(r){var e={};for(var n in r)n!=="source"&&Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n]);return e.children=Ke(r.source),f("div",null,e)},h={defaultRules:J,parserFor:Ue,outputFor:Re,inlineRegex:R,blockRegex:I,anyScopeRegex:ve,parseInline:se,parseBlock:Ir,markdownToReact:Ke,markdownToHtml:Dr,ReactMarkdown:Fr,defaultBlockParse:Ce,defaultInlineParse:Gr,defaultImplicitParse:Le,defaultReactOutput:qe,defaultHtmlOutput:He,preprocess:Fe,sanitizeText:_,sanitizeUrl:z,unescapeUrl:fe,htmlTag:x,reactElement:f,defaultRawParse:ge,ruleOutput:Yr,reactFor:Wr,htmlFor:Mr,defaultParse:function(...r){return typeof console<"u"&&console.warn("defaultParse is deprecated, please use `defaultImplicitParse`"),Le.apply(null,r)},defaultOutput:function(...r){return typeof console<"u"&&console.warn("defaultOutput is deprecated, please use `defaultReactOutput`"),qe.apply(null,r)}};const _r={fence:{match:h.defaultRules.fence.match,order:1,parse:(r,e,n)=>({type:"codeBlock",lang:r[2]||void 0,content:r[3]})},paragraph:{match:h.defaultRules.paragraph.match,order:2,parse:(r,e,n)=>({content:r[1]})}},Ur=h.parserFor(_r),Vr=r=>{const e=r.replace(/^\n\s*\n/,"")+`

`;return Ur(e,{inline:!1}).map(n=>n.content)},zr=r=>r.join(`

`),Ye={parseToArray:Vr,joinFromArray:zr},Hr="@khanacademy/pure-markdown",Kr="__lib_version__";Pe(Hr,Kr);const Br=/^\[\[\u2603 (([a-z-]+) ([0-9]+))\]\]/,Be=(r,e,n)=>{const t=r.length;let a=0;if(n){if(e.inline)return null;for(;a<t&&r[a]===" ";)a++}if(!(a<t&&r[a]==="$"))return null;a++;const i=a;let o=0;for(;a<t;){const s=r[a];if(s==="\\")a++;else if(o<=0&&s==="$"){let u=a+1;if(n){const d=/^(?: *\n){2,}/.exec(r.slice(u));u=d?u+d[0].length:null}return u?[r.substring(0,u),r.substring(i,a)]:null}else if(s==="{")o++;else if(s==="}")o--;else if(s===`
`&&r[a-1]===`
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{Gt as D,Ye as J,W as P,Te as R,h as S,_t as a,Ut as b,Vt as c,zt as d,Kt as e,Bt as f,Ht as g,pt as h,st as i,Dt as j,D as k,Ge as l,S as m,hr as p,Ft as r,Qt as s};
