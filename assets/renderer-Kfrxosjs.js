...
{2,}(?! )(?!\\1`+oe+` )\\n*|\\s*
*$)`),jr=/(?:^|\n)( *)$/,re=function(){var r=/^ *\| *| *\| *$/g,e=/ *$/,n=/^ *-+: *$/,t=/^ *:-+: *$/,a=/^ *:-+ *$/,i=function(g){return n.test(g)?"right":t.test(g)?"center":a.test(g)?"left":null},o=function(g,y,b,f){f&&(g=g.replace(r,""));var q=g.trim().split("|");return q.map(i)},s=function(g,y,b,f){var q=b.inTable;b.inTable=!0;var c=y(g.trim(),b);b.inTable=q;var k=[[]];return c.forEach(function(P,C){P.type==="tableSeparator"?(!f||C!==0&&C!==c.length-1)&&k.push([]):(P.type==="text"&&(c[C+1]==null||c[C+1].type==="tableSeparator")&&(P.content=P.content.replace(e,"")),k[k.length-1].push(P))}),k},u=function(g,y,b,f){var q=g.trim().split(`
