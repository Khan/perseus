import{r as a,j as n,V as l,o as w,s as b,at as f,R as k,au as v}from"./iframe-BPwAIjyA.js";import"./changeable-D4YjKH_y.js";import"./article-renderer-DzBVkyDZ.js";import"./server-item-renderer-CFojpNoF.js";import"./hints-renderer-x3YbfYDY.js";import{C as P}from"./content-preview-vZFcg3Yi.js";import{E as R}from"./editor-page-Cq1NKLJX.js";import{P as T,s as A}from"./preview-panel-DkQBu0f5.js";const{action:I}=__STORYBOOK_MODULE_ACTIONS__,x={analytics:{onAnalyticsEvent:async()=>{}},generateUrl:t=>t.url,useVideo:()=>({status:"success",data:{video:null}})},q=I("onChange");function F(t){const[o,u]=a.useState("phone"),[h,c]=a.useState(!1),[p,m]=a.useState(),[s,g]=a.useState(t.question),[r,y]=a.useState(t.hints),i=t.apiOptions??{isMobile:!1};return n.jsxs(l,{children:[n.jsx(R,{apiOptions:i,previewDevice:o,onPreviewDeviceChange:e=>u(e),dependencies:x,developerMode:!0,jsonMode:h,answerArea:p,question:s,hints:r,previewURL:"about:blank",itemId:"1",onChange:e=>{q(e),"jsonMode"in e&&c(e.jsonMode),"answerArea"in e&&m(e.answerArea),"question"in e&&g(e.question),"hints"in e&&y(e.hints)},additionalTemplates:{"Side by Side":`Left hand side
=====
