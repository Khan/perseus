...
}`,...(G=(_=u.parameters)==null?void 0:_.docs)==null?void 0:G.source}}};var H,U,j;g.parameters={...g.parameters,docs:{...(H=g.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentWithLockedFunction("tan(x)")
    })
  }
}`,...(j=(U=g.parameters)==null?void 0:U.docs)==null?void 0:j.source}}};var w,z,J;d.parameters={...d.parameters,docs:{...(w=d.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentWithLockedFunction("arctan(x)")
    })
  }
}`,...(J=(z=d.parameters)==null?void 0:z.docs)==null?void 0:J.source}}};var K,N,X;p.parameters={...p.parameters,docs:{...(K=p.parameters)==null?void 0:K.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
