...
}`,computed:!1}},className:{required:!1,tsType:{name:"string"},description:""},hint:{required:!0,tsType:{name:"any"},description:""},lastHint:{required:!1,tsType:{name:"boolean"},description:""},lastRendered:{required:!1,tsType:{name:"boolean"},description:""},pos:{required:!0,tsType:{name:"number"},description:""},totalHints:{required:!1,tsType:{name:"number"},description:""},findExternalWidgets:{required:!1,tsType:{name:"any"},description:""}}};const b=class b extends i.Component{constructor(){super(...arguments),this.state={isFinalHelpPage:!1},this._hintsVisible=()=>this.props.hintsVisible==null||this.props.hintsVisible===-1?this.props.hints.length:this.props.hintsVisible,this._cacheImagesInHint=e=>{g.each(e.images,(n,t)=>{const a=new Image;a.src=O.getRealImageUrl(t)})},this._cacheHintImages=()=>{this._hintsVisible()>0?g.each(this.props.hints,this._cacheImagesInHint):this.props.hints.length>0&&this._cacheImagesInHint(this.props.hints[0])},this.getApiOptions=()=>({...D.defaults,...this.props.apiOptions,readOnly:!1}),this.getSerializedState=()=>g.times(this._hintsVisible(),e=>this.refs["hintRenderer"+e].getSerializedState()),this.restoreSerializedState=(e,n)=>{let t=1;const a=()=>{--t,n&&t===0&&n()};g.each(e,(r,u)=>{const p=this.refs["hintRenderer"+u];p&&(++t,p.restoreSerializedState(r,a))}),a()}}componentDidMount(){this._cacheHintImages()}UNSAFE_componentWillReceiveProps(e){e.hintsVisible-this.props.hintsVisible>1&&this.setState({isFinalHelpPage:!0})}componentDidUpdate(e,n){(!g.isEqual(e.hints,this.props.hints)||e.hintsVisible!==this.props.hintsVisible)&&this._cacheHintImages();const t=e.hintsVisible||0,a=this.props.hintsVisible||0;if(t<a&&a<=this.props.hints.length&&a>=0){const r=a-1;N.findDOMNode(this.refs["hintRenderer"+r]).focus()}}render(){const e=this.getApiOptions(),n=this._hintsVisible(),t=[],a=this.state.isFinalHelpPage;this.props.hints.slice(0,n).forEach((o,l)=>{const S=l===this.props.hints.length-1&&!/\*\*/.test(o.content),H=l===n-1,w=i.createElement(y,{lastHint:S,lastRendered:H,hint:o,pos:l,totalHints:this.props.hints.length,ref:"hintRenderer"+l,key:"hintRenderer"+l,apiOptions:e,findExternalWidgets:this.props.findExternalWidgets,linterContext:R(this.props.linterContext,"hints["+l+"]")});a?t.push(w):o.replace&&t.length>0?t[t.length-1]=w:t.push(w)});const{getAnotherHint:r}=e,u=r&&n>0&&n<this.props.hints.length,p=`(${n}/${this.props.hints.length})`,m=x(this.props.className,e.isMobile&&n>0&&s.css(d.mobileHintStylesHintsRenderer));return i.createElement("div",{className:m},e.isMobile&&n>0&&i.createElement("div",{className:s.css(d.mobileHintStylesHintTitle,M.responsiveLabel)},this.context.strings.hints),t,u&&i.createElement("button",{rel:"button",className:s.css(d.linkButton,d.getAnotherHintButton,e.isMobile&&d.mobileHintStylesGetAnotherHintButton),onClick:o=>{o.preventDefault(),o.stopPropagation(),r&&r()}},i.createElement("span",{className:s.css(d.plusText,e.isMobile&&d.mobileHintStylesPlusText)},"+"),i.createElement("span",{className:s.css(d.getAnotherHintText)},this.context.strings.getAnotherHint," ",p)))}};b.contextType=A,b.defaultProps={linterContext:P};let v=b;const k=c+q,d=s.StyleSheet.create({rendererMargins:{marginTop:c},linkButton:{cursor:"pointer",border:"none",backgroundColor:"transparent",fontSize:"100%",fontFamily:"inherit",fontWeight:"bold",color:I,padding:0,position:"relative"},plusText:{fontSize:20,position:"absolute",top:-3,left:0},getAnotherHintText:{marginLeft:16},mobileHintStylesHintsRenderer:{marginTop:4*c,border:`solid ${W}`,borderWidth:"1px 0 0 0",position:"relative",":before":{content:'""',display:"table",clear:"both"},":after":{content:'""',display:"table",clear:"both"}},mobileHintStylesHintTitle:{fontFamily:"inherit",fontStyle:"normal",fontWeight:"bold",color:F,paddingTop:c,paddingBottom:1.5*c,[h.lgOrSmaller]:{paddingLeft:0},[h.smOrSmaller]:{paddingLeft:k}},getAnotherHintButton:{marginTop:1.5*c},mobileHintStylesGetAnotherHintButton:{[h.lgOrSmaller]:{paddingLeft:0},[h.smOrSmaller]:{paddingLeft:k}},mobileHintStylesPlusText:{[h.lgOrSmaller]:{left:0},[h.smOrSmaller]:{left:k}}});v.__docgenInfo={description:"",methods:[{name:"_hintsVisible",docblock:null,modifiers:[],params:[],returns:null},{name:"_cacheImagesInHint",docblock:null,modifiers:[],params:[{name:"hint",optional:!1,type:null}],returns:null},{name:"_cacheHintImages",docblock:null,modifiers:[],params:[],returns:null},{name:"getApiOptions",docblock:null,modifiers:[],params:[],returns:null},{name:"getSerializedState",docblock:null,modifiers:[],params:[],returns:null},{name:"restoreSerializedState",docblock:null,modifiers:[],params:[{name:"state",optional:!1,type:null},{name:"callback",optional:!1,type:null}],returns:null}],displayName:"HintsRenderer",props:{className:{required:!1,tsType:{name:"string"},description:""},hints:{required:!0,tsType:{name:"ReadonlyArray",elements:[{name:"intersection",raw:`PerseusRenderer & {
    /**
...
@deprecated`},{key:"images",value:{name:"signature",type:"object",raw:`{
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{v as H};
