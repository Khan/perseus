import{_ as p,u as en}from"./underscore-885MUNGo.js";import{u as Ae,w as nn}from"./random-util-wZstT-Qs.js";import{P as X,E as N}from"./perseus-error-l3K_anoI.js";import{g as rn,F as Ie,G as tn,H as an,I as sn,U as on}from"./util-pBxNglIl.js";import{P as Y}from"./index-o42urCig.js";import{$ as un}from"./jquery-5v7aFUvu.js";import{e as ln}from"./index-J2t_5nK1.js";import{c as be}from"./index-dnMhQZ-1.js";import{r as m}from"./index-6oxdNXpR.js";import{F as we}from"./index-9gkyvru-.js";import{Z as dn,c as pe}from"./zoomable-tex-vrUOkV3E.js";import{a as mn}from"./i18n-context-g2lQsEMW.js";import{L as B,S as gn}from"./svg-image-Prev2-2p.js";import{T as Ne}from"./tex-q_4hQMGs.js";import{Z as pn}from"./zoomable-m_J-BBOg.js";import{g as H,D as yn}from"./dependencies-CP7Uh8Kq.js";import{A as cn,C as ye}from"./perseus-api-Y55S7ZPk.js";import{L as hn}from"./lint-a43UkMJQ.js";import{c as bn,t as wn,u as kn}from"./constants-vGHYchdS.js";class U{static parse(e){return new de(e).parse()}match(e){throw new X("Selector subclasses must implement match()",N.NotAllowed)}toString(){return"Unknown selector class"}}class de{constructor(e){e=e.trim().replace(/\s+/g," "),this.tokens=e.match(de.TOKENS)||[],this.tokenIndex=0}nextToken(){return this.tokens[this.tokenIndex]||""}consume(){this.tokenIndex++}isIdentifier(){const e=this.tokens[this.tokenIndex][0];return e>="a"&&e<="z"||e>="A"&&e<="Z"}skipSpace(){for(;this.nextToken()===" ";)this.consume()}parse(){const e=this.parseTreeSelector();let n=this.nextToken();if(!n)return e;const t=[e];for(;n;){if(n===",")this.consume();else throw new ce("Expected comma");t.push(this.parseTreeSelector()),n=this.nextToken()}return new fn(t)}parseTreeSelector(){this.skipSpace();let e=this.parseNodeSelector();for(;;){const n=this.nextToken();if(!n||n===",")break;if(n===" ")this.consume(),e=new Tn(e,this.parseNodeSelector());else if(n===">")this.consume(),e=new xn(e,this.parseNodeSelector());else if(n==="+")this.consume(),e=new An(e,this.parseNodeSelector());else if(n==="~")this.consume(),e=new Pn(e,this.parseNodeSelector());else throw new ce("Unexpected token: "+n)}return e}parseNodeSelector(){this.skipSpace();const e=this.nextToken();if(e==="*")return this.consume(),new vn;if(this.isIdentifier())return this.consume(),new qn(e);throw new ce("Expected node type")}}de.TOKENS=/([a-zA-Z][\w-]*)|(\d+)|[^\s]|(\s(?=[a-zA-Z\*]))/g;class ce extends Error{constructor(e){super(e)}}class fn extends U{constructor(e){super(),this.selectors=e}match(e){for(let n=0;n<this.selectors.length;n++){const a=this.selectors[n].match(e);if(a)return a}return null}toString(){let e="";for(let n=0;n<this.selectors.length;n++)e+=n>0?", ":"",e+=this.selectors[n].toString();return e}}class vn extends U{match(e){return[e.currentNode()]}toString(){return"*"}}class qn extends U{constructor(e){super(),this.type=e}match(e){const n=e.currentNode();return n.type===this.type?[n]:null}toString(){return this.type}}class me extends U{constructor(e,n){super(),this.left=e,this.right=n}}class Tn extends me{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n)for(e=e.clone();e.hasParent();){e.goToParent();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" "+this.right.toString()}}class xn extends me{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n&&e.hasParent()){e=e.clone(),e.goToParent();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" > "+this.right.toString()}}class An extends me{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n&&e.hasPreviousSibling()){e=e.clone(),e.goToPreviousSibling();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" + "+this.right.toString()}}class Pn extends me{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n)for(e=e.clone();e.hasPreviousSibling();){e.goToPreviousSibling();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" ~ "+this.right.toString()}}const j=class j{constructor(e,n,t,a,i,o){if(!t&&!a)throw new X("Lint rules must have a selector or pattern",N.InvalidInput,{metadata:{name:e}});this.name=e||"unnamed rule",this.severity=n||j.Severity.BULK_WARNING,this.selector=t||j.DEFAULT_SELECTOR,this.pattern=a||null,typeof i=="function"?(this.lint=i,this.message=null):(this.lint=(...s)=>this._defaultLintFunction(...s),this.message=i),this.applies=o||function(){return!0}}static makeRule(e){return new j(e.name,e.severity,e.selector?U.parse(e.selector):null,j.makePattern(e.pattern),e.lint||e.message,e.applies)}check(e,n,t,a){const i=this.selector.match(n);if(!i)return null;let o;if(this.pattern?o=t.match(this.pattern):o=j.FakePatternMatch(t,t,0),!o)return null;try{const s=this.lint(n,t,i,o,a);return s?typeof s=="string"?{rule:this.name,severity:this.severity,message:s,start:0,end:t.length}:{rule:this.name,severity:this.severity,message:s.message,start:s.start,end:s.end}:null}catch(s){return{rule:"lint-rule-failure",message:`Exception in rule ${this.name}: ${s.message}
Stack trace:
${s.stack}`,start:0,end:t.length}}}_defaultLintFunction(e,n,t,a,i){return{message:this.message||"",start:a.index,end:a.index+a[0].length}}static makePattern(e){if(!e)return null;if(e instanceof RegExp)return e;if(e[0]==="/"){const n=e.lastIndexOf("/"),t=e.substring(1,n),a=e.substring(n+1);return new RegExp(t,a)}return new RegExp(e)}static FakePatternMatch(e,n,t){const a=[n];return a.index=t,a.input=e,a}};j.Severity={ERROR:1,WARNING:2,GUIDELINE:3,BULK_WARNING:4};let l=j;l.DEFAULT_SELECTOR=U.parse("text");const Rn=/\/\/([^\/]+)/;function Cn(r){if(!r)return"";const e=r.match(Rn);return e?e[1]:""}const Sn=l.makeRule({name:"absolute-url",severity:l.Severity.GUIDELINE,selector:"link, image",lint:function(r,e,n,t){const a=n[0].target,i=Cn(a);if(i==="khanacademy.org"||i.endsWith(".khanacademy.org"))return`Don't use absolute URLs:
When linking to KA content or images, omit the
https://www.khanacademy.org URL prefix.
Use a relative URL beginning with / instead.`}}),In=l.makeRule({name:"blockquoted-math",severity:l.Severity.WARNING,selector:"blockQuote math, blockQuote blockMath",message:`Blockquoted math:
math should not be indented.`}),Nn=l.makeRule({name:"blockquoted-widget",severity:l.Severity.WARNING,selector:"blockQuote widget",message:`Blockquoted widget:
widgets should not be indented.`}),En=l.makeRule({name:"double-spacing-after-terminal",severity:l.Severity.BULK_WARNING,selector:"paragraph",pattern:/[.!\?] {2}/i,message:`Use a single space after a sentence-ending period, or
any other kind of terminal punctuation.`});function On(r,e){return`Answer requires a button not found in the button sets: ${r} (in ${e})`}const jn={"\\sqrt":"prealgebra","\\sin":"trig","\\cos":"trig","\\tan":"trig","\\log":"logarithms","\\ln":"logarithms"},Xn=l.makeRule({name:"expression-widget",severity:l.Severity.WARNING,selector:"widget",lint:function(r,e,n,t,a){var d;if(r.currentNode().widgetType!=="expression")return;const i=r.currentNode().id;if(!i)return;const o=(d=a==null?void 0:a.widgets)==null?void 0:d[i];if(!o)return;const s=o.options.answerForms,u=o.options.buttonSets;for(const g of s)for(const[y,b]of Object.entries(jn))if(g.value.includes(y)&&!u.includes(b))return On(y,b)}}),Ln=l.makeRule({name:"extra-content-spacing",selector:"paragraph",pattern:/\s+$/,applies:function(r){return(r==null?void 0:r.contentType)==="article"},message:"No extra whitespace at the end of content blocks."}),Yn=l.makeRule({name:"heading-level-1",severity:l.Severity.WARNING,selector:"heading",lint:function(r,e,n,t){if(n[0].level===1)return`Don't use level-1 headings:
Begin headings with two or more # characters.`}}),Wn=l.makeRule({name:"heading-level-skip",severity:l.Severity.WARNING,selector:"heading ~ heading",lint:function(r,e,n,t){const a=n[1],i=n[0];if(a.level>i.level+1)return`Skipped heading level:
this heading is level ${a.level} but
the previous heading was level ${i.level}`}}),Mn=l.makeRule({name:"heading-sentence-case",severity:l.Severity.GUIDELINE,selector:"heading",pattern:/^\W*[a-z]/,message:`First letter is lowercase:
the first letter of a heading should be capitalized.`}),Gn={and:!0,nor:!0,but:!0,the:!0,for:!0};function Dn(r){const e=r[0];return e===e.toUpperCase()}const Fn=l.makeRule({name:"heading-title-case",severity:l.Severity.GUIDELINE,selector:"heading",pattern:/[^\s:]\s+[A-Z]+[a-z]/,locale:"en",lint:function(r,e,n,t){let i=e.trim().split(/\s+/);if(i.shift(),i=i.filter(o=>o.length>2&&!Gn.hasOwnProperty(o)),i.length>=3&&i.every(o=>Dn(o)))return`Title-case heading:
This heading appears to be in title-case, but should be sentence-case.
Only capitalize the first letter and proper nouns.`}}),_n=l.makeRule({name:"image-alt-text",severity:l.Severity.WARNING,selector:"image",lint:function(r,e,n,t){const a=n[0];if(!a.alt||!a.alt.trim())return`Images should have alt text:
...
This image's alt text is only ${a.alt.length} characters long.`}}),Un=l.makeRule({name:"image-in-table",severity:l.Severity.BULK_WARNING,selector:"table image",message:`Image in table:
do not put images inside of tables.`}),Vn=l.makeRule({name:"image-spaces-around-urls",severity:l.Severity.ERROR,selector:"image",lint:function(r,e,n,t,a){const o=n[0].target;if(a&&a.content){const s=a.content.indexOf(o);if(s===-1)return;if(a.content[s-1]!=="("||a.content[s+o.length]!==")")return`Whitespace before or after image url:
For images, don't include any space or newlines after '(' or before ')'.
Whitespace in image URLs causes translation difficulties.`}}}),zn=l.makeRule({name:"image-url-empty",severity:l.Severity.ERROR,selector:"image",lint:function(r,e,n){const a=n[0].target;if(!a||!a.trim())return"Images should have a URL"}}),Hn=l.makeRule({name:"image-widget",severity:l.Severity.WARNING,selector:"widget",lint:function(r,e,n,t,a){if(r.currentNode().widgetType!=="image")return;const i=r.currentNode().id;if(!i)return;const o=a&&a.widgets&&a.widgets[i];if(!o)return;const s=o.options.alt;if(!s)return`Images should have alt text:
...
Don't include math expressions in image captions.`}}),Kn=l.makeRule({name:"link-click-here",severity:l.Severity.WARNING,selector:"link",pattern:/click here/i,message:`Inappropriate link text:
Do not use the words "click here" in links.`}),Bn=l.makeRule({name:"long-paragraph",severity:l.Severity.GUIDELINE,selector:"paragraph",pattern:/^.{501,}/,lint:function(r,e,n,t){return`Paragraph too long:
This paragraph is ${e.length} characters long.
Shorten it to 500 characters or fewer.`}}),Qn=l.makeRule({name:"math-adjacent",severity:l.Severity.WARNING,selector:"blockMath+blockMath",message:`Adjacent math blocks:
combine the blocks between \\begin{align} and \\end{align}`}),$n=l.makeRule({name:"math-align-extra-break",severity:l.Severity.WARNING,selector:"blockMath",pattern:/(\\{2,})\s*\\end{align}/,message:`Extra space at end of block:
Don't end an align block with backslashes`}),Jn=l.makeRule({name:"math-align-linebreaks",severity:l.Severity.WARNING,selector:"blockMath",pattern:/\\begin{align}[\s\S]*\\\\[\s\S]+\\end{align}/,lint:function(r,e,n,t){let a=t[0];for(;a.length;){const i=a.indexOf("\\\\");if(i===-1)return;a=a.substring(i+2);const o=a.match(/^\s*\\\\\s*(?!\\\\)/);if(!o)return"Use four backslashes between lines of an align block";a=a.substring(o[0].length)}}}),Zn=l.makeRule({name:"math-empty",severity:l.Severity.WARNING,selector:"math, blockMath",pattern:/^$/,message:"Empty math: don't use $$ in your markdown."}),er=l.makeRule({name:"math-frac",severity:l.Severity.GUIDELINE,selector:"math, blockMath",pattern:/\\frac[ {]/,message:"Use \\dfrac instead of \\frac in your math expressions."}),nr=l.makeRule({name:"math-nested",severity:l.Severity.ERROR,selector:"math, blockMath",pattern:/\\text{[^$}]*\$[^$}]*\$[^}]*}/,message:`Nested math:
Don't nest math expressions inside \\text{} blocks`}),rr=l.makeRule({name:"math-starts-with-space",severity:l.Severity.GUIDELINE,selector:"math, blockMath",pattern:/^\s*(~|\\qquad|\\quad|\\,|\\;|\\:|\\ |\\!|\\enspace|\\phantom)/,message:`Math starts with space:
math should not be indented. Do not begin math expressions with
LaTeX space commands like ~, \\;, \\quad, or \\phantom`}),tr=l.makeRule({name:"math-text-empty",severity:l.Severity.WARNING,selector:"math, blockMath",pattern:/\\text{\s*}/,message:"Empty \\text{} block in math expression"}),ar=l.makeRule({name:"math-without-dollars",severity:l.Severity.GUIDELINE,pattern:/\\\w+{[^}]*}|{|}/,message:`This looks like LaTeX:
did you mean to put it inside dollar signs?`}),ir=l.makeRule({name:"nested-lists",severity:l.Severity.WARNING,selector:"list list",message:`Nested lists:
nested lists are hard to read on mobile devices;
do not use additional indentation.`}),sr=l.makeRule({name:"static-widget-in-question-stem",severity:l.Severity.WARNING,selector:"widget",lint:(r,e,n,t,a)=>{var s;if((a==null?void 0:a.contentType)!=="exercise"||a.stack.includes("hint"))return;const i=r.currentNode().id;if(!i)return;const o=(s=a==null?void 0:a.widgets)==null?void 0:s[i];if(o&&o.static)return"Widget in question stem is static (non-interactive)."}}),or=l.makeRule({name:"table-missing-cells",severity:l.Severity.WARNING,selector:"table",lint:function(r,e,n,t){const a=n[0],i=a.header.length,o=a.cells.map(s=>s.length);for(let s=0;s<o.length;s++)if(o[s]!==i)return`Table rows don't match header:
The table header has ${i} cells, but
Row ${s+1} has ${o[s]} cells.`}}),ur=l.makeRule({name:"unbalanced-code-delimiters",severity:l.Severity.ERROR,pattern:/[`~]+/,message:`Unbalanced code delimiters:
code blocks should begin and end with the same type and number of delimiters`}),lr=l.makeRule({name:"unescaped-dollar",severity:l.Severity.ERROR,selector:"unescapedDollar",message:`Unescaped dollar sign:
Dollar signs must appear in pairs or be escaped as \\$`}),dr=l.makeRule({name:"widget-in-table",severity:l.Severity.BULK_WARNING,selector:"table widget",message:`Widget in table:
do not put widgets inside of tables.`}),mr=[Sn,In,Nn,En,zn,Xn,Ln,Yn,Wn,Mn,Fn,_n,Un,Kn,Bn,Qn,$n,Jn,Zn,er,nr,rr,tr,ir,sr,or,lr,dr,ar,ur,Vn,Hn];class F{constructor(e){this.root=e}static isNode(e){return e&&typeof e=="object"&&typeof e.type=="string"}static isTextNode(e){return F.isNode(e)&&e.type==="text"&&typeof e.content=="string"}traverse(e){this._traverse(this.root,new Pe(this.root),e)}_traverse(e,n,t){let a="";if(F.isNode(e)){const i=e;n._containers.push(i),n._ancestors.push(i),typeof i.content=="string"&&(a=i.content),Object.keys(i).forEach(s=>{if(s==="type")return;const u=i[s];u&&typeof u=="object"&&(n._indexes.push(s),a+=this._traverse(u,n,t),n._indexes.pop())}),n._currentNode=n._ancestors.pop(),n._containers.pop(),t(i,n,a)}else if(Array.isArray(e)){const i=e;n._containers.push(i);let o=0;for(;o<i.length;)n._indexes.push(o),a+=this._traverse(i[o],n,t),o=n._indexes.pop()+1;n._containers.pop()}return a}}class Pe{constructor(e){this.root=e,this._currentNode=null,this._containers=new K,this._indexes=new K,this._ancestors=new K}currentNode(){return this._currentNode||this.root}parent(){return this._ancestors.top()}ancestors(){return this._ancestors.values()}nextSibling(){const e=this._containers.top();if(!e||!Array.isArray(e))return null;const n=this._indexes.top();return e.length>n+1?e[n+1]:null}previousSibling(){const e=this._containers.top();if(!e||!Array.isArray(e))return null;const n=this._indexes.top();return n>0?e[n-1]:null}removeNextSibling(){const e=this._containers.top();if(e&&Array.isArray(e)){const n=this._indexes.top();if(e.length>n+1)return e.splice(n+1,1)[0]}return null}replace(...e){const n=this._containers.top();if(!n)throw new X("Can't replace the root of the tree",N.Internal);if(Array.isArray(n)){const t=this._indexes.top();n.splice(t,1,...e),this._indexes.pop(),this._indexes.push(t+e.length-1)}else{const t=this._indexes.top();e.length===0?delete n[t]:e.length===1?n[t]=e[0]:n[t]=e}}hasPreviousSibling(){return Array.isArray(this._containers.top())&&this._indexes.top()>0}goToPreviousSibling(){if(!this.hasPreviousSibling())throw new X("goToPreviousSibling(): node has no previous sibling",N.Internal);this._currentNode=this.previousSibling();const e=this._indexes.pop();this._indexes.push(e-1)}hasParent(){return this._ancestors.size()!==0}goToParent(){if(!this.hasParent())throw new X("goToParent(): node has no ancestor",N.NotAllowed);for(this._currentNode=this._ancestors.pop();this._containers.size()&&this._containers.top()[this._indexes.top()]!==this._currentNode;)this._containers.pop(),this._indexes.pop()}clone(){const e=new Pe(this.root);return e._currentNode=this._currentNode,e._containers=this._containers.clone(),e._indexes=this._indexes.clone(),e._ancestors=this._ancestors.clone(),e}equals(e){return this.root===e.root&&this._currentNode===e._currentNode&&this._containers.equals(e._containers)&&this._indexes.equals(e._indexes)&&this._ancestors.equals(e._ancestors)}}class K{constructor(e){this.stack=e?e.slice(0):[]}push(e){this.stack.push(e)}pop(){return this.stack.pop()}top(){return this.stack[this.stack.length-1]}values(){return this.stack.slice(0)}size(){return this.stack.length}toString(){return this.stack.toString()}clone(){return new K(this.stack)}equals(e){if(!e||!e.stack||e.stack.length!==this.stack.length)return!1;for(let n=0;n<this.stack.length;n++)if(this.stack[n]!==e.stack[n])return!1;return!0}}const gr="@khanacademy/perseus-linter",pr="__lib_version__";Ae(gr,pr);Y.shape({contentType:Y.string,highlightLint:Y.bool,paths:Y.arrayOf(Y.string),stack:Y.arrayOf(Y.string)});const Ge={contentType:"",highlightLint:!1,paths:[],stack:[]},yr=mr.filter(r=>r.severity<l.Severity.BULK_WARNING);function cr(r,e,n,t=yr){const a=[],i=new F(r);i.traverse((u,d,g)=>{if(F.isTextNode(u)){let y=d.nextSibling();for(;F.isTextNode(y);)u.content+=y.content,d.removeNextSibling(),y=d.nextSibling()}});let o=[],s=!1;return i.traverse((u,d,g)=>{const y=[],b=t.filter(c=>c.applies(e)),f=[...e.stack];f.push(u.type);const q={...e,stack:f.join(".")};if(b.forEach(c=>{const k=c.check(u,d,g,q);k&&((k.start||k.end)&&(k.target=g.substring(k.start,k.end)),a.push(k),n&&y.push(k))}),!!n&&(u.type==="table"?(o.length&&y.push(...o),s=!1,o=[]):s||(s=d.ancestors().some(c=>c.type==="table")),s&&y.length&&o.push(...y),y.length))if(y.sort((c,k)=>c.severity-k.severity),u.type!=="text"||y.length>1)d.replace({type:"lint",content:u,message:y.map(c=>c.message).join(`

`),ruleName:y[0].rule,blockHighlight:q.blockHighlight,insideTable:s,severity:y[0].severity});else{const c=u.content,k=y[0],A=k.start||0,C=k.end||c.length,L=c.substring(0,A),P=c.substring(A,C),Z=c.substring(C),ee=[];L&&ee.push({type:"text",content:L}),ee.push({type:"lint",content:{type:"text",content:P},message:k.message,ruleName:k.rule,insideTable:s,severity:k.severity}),Z&&ee.push({type:"text",content:Z}),d.replace(...ee)}}),a}function hr(r,e){const n=r.stack||[];return{...r,stack:n.concat(e)}}const br={activeDefinitionId:null,setActiveDefinitionId:()=>{}},De=m.createContext(br);class ke extends m.Component{constructor(){super(...arguments),this.state={activeDefinitionId:null},this.setActiveDefinitionId=e=>{this.setState(n=>({activeDefinitionId:e}))}}render(){const{children:e}=this.props,{activeDefinitionId:n}=this.state,{setActiveDefinitionId:t}=this;return m.createElement(De.Provider,{value:{activeDefinitionId:n,setActiveDefinitionId:t}},e)}}const Gt=De.Consumer;ke.__docgenInfo={description:"",methods:[{name:"setActiveDefinitionId",docblock:null,modifiers:[],params:[{name:"activeDefinitionId",optional:!0,type:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]}}],returns:{type:{name:"void"}}}],displayName:"DefinitionProvider",props:{children:{required:!0,tsType:{name:"any"},description:""}}};class E extends m.Component{constructor(e){super(e),this.state={error:""}}componentDidCatch(e,n){var t,a;this.setState({error:e.toString()}),(a=(t=this.props).onError)==null||a.call(t,e,n),B.error("Unhandled Perseus error: "+e.message,N.Internal,{cause:e,loggedMetadata:{componentStack:n&&"componentStack"in n?n.componentStack:"componentStack not provided",...this.props.metadata}})}render(){return this.state.error?m.createElement("svg",{height:"16",width:"16",viewBox:"0 0 16 16",role:"img"},m.createElement("title",null,"Rendering Error!"),m.createElement("path",{d:"m8 16c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm0-3c0.55 0 1-0.45 1-1s-0.45-1-1-1-1 0.45-1 1 0.45 1 1 1zm0-9c-0.55 0-1 0.45-1 1v4c0 0.55.45 1 1 1s1-0.45 1-1v-4c0-0.55-0.45-1-1-1z",fill:"#d92916",fillRule:"evenodd"})):this.props.children}}E.__docgenInfo={description:"",methods:[],displayName:"ErrorBoundary",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},metadata:{required:!1,tsType:{name:"Record",elements:[{name:"string"},{name:"string"}],raw:"Record<string, string>"},description:""},onError:{required:!1,tsType:{name:"signature",type:"function",raw:"(error: Error, info: any) => void",signature:{arguments:[{type:{name:"Error"},name:"error"},{type:{name:"any"},name:"info"}],return:{name:"void"}}},description:""}}};function wr(){}class kr{constructor(e,n,t,a){this._track=i=>{this._tracked&&!this.setting||(this._tracked=!0,this.trackApi({type:this.widgetType,id:this.widgetID,...i}))},e?(this._tracked=!1,this.trackApi=e,this.widgetType=n,this.widgetID=t,this.setting=a,this.track=this._track):this.track=wr}}const fr="@khanacademy/simple-markdown",vr="__lib_version__";Ae(fr,vr);var qr=/\r\n?/g,Tr=/\t/g,xr=/\f/g,Fe=function(r){return r.replace(qr,`
`).replace(xr,"").replace(Tr,"    ")},_e=function(r,e){var n=r||{};if(e!=null)for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&(n[t]=e[t]);return n},Ue=function(r,e){var n=Object.keys(r).filter(function(o){var s=r[o];if(s==null||s.match==null)return!1;var u=s.order;return(typeof u!="number"||!isFinite(u))&&typeof console<"u"&&console.warn("simple-markdown: Invalid order for rule `"+o+"`: "+String(u)),!0});n.sort(function(o,s){var u=r[o],d=r[s],g=u.order,y=d.order;if(g!==y)return g-y;var b=u.quality?0:1,f=d.quality?0:1;return b!==f?b-f:o<s?-1:o>s?1:0});var t,a=function(o,s){var u=[];for(s=s||t,t=s;o;){var d=null,g=null,y=null,b=NaN,f=0,q=n[0],c=r[q];do{var k=c.order,A=s.prevCapture==null?"":s.prevCapture[0],C=c.match(o,s,A);if(C){var L=c.quality?c.quality(C,s,A):0;L<=b||(d=q,g=c,y=C,b=L)}f++,q=n[f],c=r[q]}while(c&&(!y||c.order===k&&c.quality));if(g==null||y==null)throw new Error("Could not find a matching rule for the below content. The rule with highest `order` should always match content provided to it. Check the definition of `match` for '"+n[n.length-1]+`'. It seems to not match the following source:
`+o);if(y.index)throw new Error("`match` must return a capture starting at index 0 (the current parse index). Did you forget a ^ at the start of the RegExp?");var P=g.parse(y,a,s);if(Array.isArray(P))Array.prototype.push.apply(u,P);else{if(P==null||typeof P!="object")throw new Error(`parse() function returned invalid parse result: '${P}'`);P.type==null&&(P.type=d),u.push(P)}s.prevCapture=y,o=o.substring(s.prevCapture[0].length)}return u},i=function(o,s){return t=_e(s,e),!t.inline&&!t.disableAutoBlockNewlines&&(o=o+`

`),t.prevCapture=null,a(Fe(o),t)};return i},R=function(r){var e=function(n,t,a){return t.inline?r.exec(n):null};return e.regex=r,e},I=function(r){var e=function(n,t){return t.inline?null:r.exec(n)};return e.regex=r,e},fe=function(r){var e=function(n,t){return r.exec(n)};return e.regex=r,e},Ar=typeof Symbol=="function"&&Symbol.for&&Symbol.for("react.element")||60103,v=function(r,e,n){var t={$$typeof:Ar,type:r,key:e??void 0,ref:null,props:n,_owner:null};return t},T=function(r,e,n,t){n=n||{},t=typeof t<"u"?t:!0;var a="";for(var i in n){var o=n[i];Object.prototype.hasOwnProperty.call(n,i)&&o&&(a+=" "+_(i)+'="'+_(o)+'"')}var s="<"+r+a+">";return t?s+e+"</"+r+">":s},Pr={},z=function(r){if(r==null)return null;try{var e=new URL(r,"https://localhost").protocol;if(e.indexOf("javascript:")===0||e.indexOf("vbscript:")===0||e.indexOf("data:")===0)return null}catch{return null}return r},Rr=/[<>&"']/g,Cr={"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;","'":"&#x27;","/":"&#x2F;","`":"&#96;"},_=function(r){return String(r).replace(Rr,function(e){return Cr[e]})},Sr=/\\([^0-9A-Za-z\s])/g,ve=function(r){return r.replace(Sr,"$1")},se=function(r,e,n){var t=n.inline||!1;n.inline=!0;var a=r(e,n);return n.inline=t,a},Ir=function(r,e,n){var t=n.inline||!1;n.inline=!1;var a=r(e+`

`,n);return n.inline=t,a},ne=function(r,e,n){return{content:se(e,r[1],n)}},he=function(){return{}},oe="(?:[*+-]|\\d+\\.)",Ve="( *)("+oe+") +",Ee=new RegExp("^"+Ve),Nr=new RegExp(Ve+"[^\\n]*(?:\\n(?!\\1"+oe+` )[^\\n]*)*(
|$)`,"gm"),ze=/\n{2,}$/,Er=/^ (?= *`)|(` *) $/g,Or=ze,Oe=/ *\n+$/,jr=new RegExp("^( *)("+oe+`) [\\s\\S]+?(?:
{2,}(?! )(?!\\1`+oe+` )\\n*|\\s*
*$)`),Xr=/(?:^|\n)( *)$/,re=function(){var r=/^ *\| *| *\| *$/g,e=/ *$/,n=/^ *-+: *$/,t=/^ *:-+: *$/,a=/^ *:-+ *$/,i=function(g){return n.test(g)?"right":t.test(g)?"center":a.test(g)?"left":null},o=function(g,y,b,f){f&&(g=g.replace(r,""));var q=g.trim().split("|");return q.map(i)},s=function(g,y,b,f){var q=b.inTable;b.inTable=!0;var c=y(g.trim(),b);b.inTable=q;var k=[[]];return c.forEach(function(A,C){A.type==="tableSeparator"?(!f||C!==0&&C!==c.length-1)&&k.push([]):(A.type==="text"&&(c[C+1]==null||c[C+1].type==="tableSeparator")&&(A.content=A.content.replace(e,"")),k[k.length-1].push(A))}),k},u=function(g,y,b,f){var q=g.trim().split(`
`);return q.map(function(c){return s(c,y,b,f)})},d=function(g){return function(y,b,f){f.inline=!0;var q=s(y[1],b,f,g),c=o(y[2],b,f,g),k=u(y[3],b,f,g);return f.inline=!1,{type:"table",header:q,align:c,cells:k}}};return{parseTable:d(!0),parseNpTable:d(!1),TABLE_REGEX:/^ *(\|.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/,NPTABLE_REGEX:/^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/}}(),te="(?:\\[[^\\]]*\\]|[^\\[\\]]|\\](?=[^\\[]*\\]))*",je=`\\s*<?((?:\\([^)]*\\)|[^\\s\\\\]|\\\\.)*?)>?(?:\\s+['"]([\\s\\S]*?)['"])?\\s*`,Lr=/mailto:/i,Xe=function(r,e,n){var t=(r[2]||r[1]).replace(/\s+/g," ").toLowerCase();if(e._defs&&e._defs[t]){var a=e._defs[t];n.target=a.target,n.title=a.title}return e._refs=e._refs||{},e._refs[t]=e._refs[t]||[],e._refs[t].push(n),n},w=0,J={Array:{react:function(r,e,n){for(var t=n.key,a=[],i=0,o=0;i<r.length;i++,o++){n.key=""+i;var s=r[i];if(s.type==="text")for(s={type:"text",content:s.content};i+1<r.length&&r[i+1].type==="text";i++)s.content+=r[i+1].content;a.push(e(s,n))}return n.key=t,a},html:function(r,e,n){for(var t="",a=0;a<r.length;a++){var i=r[a];if(i.type==="text")for(i={type:"text",content:i.content};a+1<r.length&&r[a+1].type==="text";a++)i.content+=r[a+1].content;t+=e(i,n)}return t}},heading:{order:w++,match:I(/^ *(#{1,6})([^\n]+?)#* *(?:\n *)+\n/),parse:function(r,e,n){return{level:r[1].length,content:se(e,r[2].trim(),n)}},react:function(r,e,n){return v("h"+r.level,n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("h"+r.level,e(r.content,n))}},nptable:{order:w++,match:I(re.NPTABLE_REGEX),parse:re.parseNpTable,react:null,html:null},lheading:{order:w++,match:I(/^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/),parse:function(r,e,n){return{type:"heading",level:r[2]==="="?1:2,content:se(e,r[1],n)}},react:null,html:null},hr:{order:w++,match:I(/^( *[-*_]){3,} *(?:\n *)+\n/),parse:he,react:function(r,e,n){return v("hr",n.key,{"aria-hidden":!0})},html:function(r,e,n){return'<hr aria-hidden="true">'}},codeBlock:{order:w++,match:I(/^(?:    [^\n]+\n*)+(?:\n *)+\n/),parse:function(r,e,n){var t=r[0].replace(/^    /gm,"").replace(/\n+$/,"");return{lang:void 0,content:t}},react:function(r,e,n){var t=r.lang?"markdown-code-"+r.lang:void 0;return v("pre",n.key,{children:v("code",null,{className:t,children:r.content})})},html:function(r,e,n){var t=r.lang?"markdown-code-"+r.lang:void 0,a=T("code",_(r.content),{class:t});return T("pre",a)}},fence:{order:w++,match:I(/^ *(`{3,}|~{3,}) *(?:(\S+) *)?\n([\s\S]+?)\n?\1 *(?:\n *)+\n/),parse:function(r,e,n){return{type:"codeBlock",lang:r[2]||void 0,content:r[3]}},react:null,html:null},blockQuote:{order:w++,match:I(/^( *>[^\n]+(\n[^\n]+)*\n*)+\n{2,}/),parse:function(r,e,n){var t=r[0].replace(/^ *> ?/gm,"");return{content:e(t,n)}},react:function(r,e,n){return v("blockquote",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("blockquote",e(r.content,n))}},list:{order:w++,match:function(r,e){var n=e.prevCapture==null?"":e.prevCapture[0],t=Xr.exec(n),a=e._list||!e.inline;return t&&a?(r=t[1]+r,jr.exec(r)):null},parse:function(r,e,n){var t=r[2],a=t.length>1,i=a?+t:void 0,o=r[0].replace(Or,`
`).match(Nr),s=!1,u=o.map(function(d,g){var y=Ee.exec(d),b=y?y[0].length:0,f=new RegExp("^ {1,"+b+"}","gm"),q=d.replace(f,"").replace(Ee,""),c=g===o.length-1,k=q.indexOf(`

`)!==-1,A=k||c&&s;s=A;var C=n.inline,L=n._list;n._list=!0;var P;A?(n.inline=!1,P=q.replace(Oe,`

`)):(n.inline=!0,P=q.replace(Oe,""));var Z=e(P,n);return n.inline=C,n._list=L,Z});return{ordered:a,start:i,items:u}},react:function(r,e,n){var t=r.ordered?"ol":"ul";return v(t,n.key,{start:r.start,children:r.items.map(function(a,i){return v("li",""+i,{children:e(a,n)})})})},html:function(r,e,n){var t=r.items.map(function(o){return T("li",e(o,n))}).join(""),a=r.ordered?"ol":"ul",i={start:r.start};return T(a,t,i)}},def:{order:w++,match:I(/^ *\[([^\]]+)\]: *<?([^\s>]*)>?(?: +["(]([^\n]+)[")])? *\n(?: *\n)*/),parse:function(r,e,n){var t=r[1].replace(/\s+/g," ").toLowerCase(),a=r[2],i=r[3];return n._refs&&n._refs[t]&&n._refs[t].forEach(function(o){o.target=a,o.title=i}),n._defs=n._defs||{},n._defs[t]={target:a,title:i},{def:t,target:a,title:i}},react:function(){return null},html:function(){return""}},table:{order:w++,match:I(re.TABLE_REGEX),parse:re.parseTable,react:function(r,e,n){var t=function(o){return r.align[o]==null?{}:{textAlign:r.align[o]}},a=r.header.map(function(o,s){return v("th",""+s,{style:t(s),scope:"col",children:e(o,n)})}),i=r.cells.map(function(o,s){return v("tr",""+s,{children:o.map(function(u,d){return v("td",""+d,{style:t(d),children:e(u,n)})})})});return v("table",n.key,{children:[v("thead","thead",{children:v("tr",null,{children:a})}),v("tbody","tbody",{children:i})]})},html:function(r,e,n){var t=function(u){return r.align[u]==null?"":"text-align:"+r.align[u]+";"},a=r.header.map(function(u,d){return T("th",e(u,n),{style:t(d),scope:"col"})}).join(""),i=r.cells.map(function(u){var d=u.map(function(g,y){return T("td",e(g,n),{style:t(y)})}).join("");return T("tr",d)}).join(""),o=T("thead",T("tr",a)),s=T("tbody",i);return T("table",o+s)}},newline:{order:w++,match:I(/^(?:\n *)*\n/),parse:he,react:function(r,e,n){return`
`},html:function(r,e,n){return`
`}},paragraph:{order:w++,match:I(/^((?:[^\n]|\n(?! *\n))+)(?:\n *)+\n/),parse:ne,react:function(r,e,n){return v("div",n.key,{className:"paragraph",children:e(r.content,n)})},html:function(r,e,n){var t={class:"paragraph"};return T("div",e(r.content,n),t)}},escape:{order:w++,match:R(/^\\([^0-9A-Za-z\s])/),parse:function(r,e,n){return{type:"text",content:r[1]}},react:null,html:null},tableSeparator:{order:w++,match:function(r,e){return e.inTable?/^ *\| */.exec(r):null},parse:function(){return{type:"tableSeparator"}},react:function(){return" | "},html:function(){return" &vert; "}},autolink:{order:w++,match:R(/^<([^: >]+:\/[^ >]+)>/),parse:function(r,e,n){return{type:"link",content:[{type:"text",content:r[1]}],target:r[1]}},react:null,html:null},mailto:{order:w++,match:R(/^<([^ >]+@[^ >]+)>/),parse:function(r,e,n){var t=r[1],a=r[1];return Lr.test(a)||(a="mailto:"+a),{type:"link",content:[{type:"text",content:t}],target:a}},react:null,html:null},url:{order:w++,match:R(/^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/),parse:function(r,e,n){return{type:"link",content:[{type:"text",content:r[1]}],target:r[1],title:void 0}},react:null,html:null},link:{order:w++,match:R(new RegExp("^\\[("+te+")\\]\\("+je+"\\)")),parse:function(r,e,n){var t={content:e(r[1],n),target:ve(r[2]),title:r[3]};return t},react:function(r,e,n){return v("a",n.key,{href:z(r.target),title:r.title,children:e(r.content,n)})},html:function(r,e,n){var t={href:z(r.target),title:r.title};return T("a",e(r.content,n),t)}},image:{order:w++,match:R(new RegExp("^!\\[("+te+")\\]\\("+je+"\\)")),parse:function(r,e,n){var t={alt:r[1],target:ve(r[2]),title:r[3]};return t},react:function(r,e,n){return v("img",n.key,{src:z(r.target),alt:r.alt,title:r.title})},html:function(r,e,n){var t={src:z(r.target),alt:r.alt,title:r.title};return T("img","",t,!1)}},reflink:{order:w++,match:R(new RegExp("^\\[("+te+")\\]\\s*\\[([^\\]]*)\\]")),parse:function(r,e,n){return Xe(r,n,{type:"link",content:e(r[1],n)})},react:null,html:null},refimage:{order:w++,match:R(new RegExp("^!\\[("+te+")\\]\\s*\\[([^\\]]*)\\]")),parse:function(r,e,n){return Xe(r,n,{type:"image",alt:r[1]})},react:null,html:null},em:{order:w,match:R(new RegExp("^\\b_((?:__|\\\\[\\s\\S]|[^\\\\_])+?)_\\b|^\\*(?=\\S)((?:\\*\\*|\\\\[\\s\\S]|\\s+(?:\\\\[\\s\\S]|[^\\s\\*\\\\]|\\*\\*)|[^\\s\\*\\\\])+?)\\*(?!\\*)")),quality:function(r){return r[0].length+.2},parse:function(r,e,n){return{content:e(r[2]||r[1],n)}},react:function(r,e,n){return v("em",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("em",e(r.content,n))}},strong:{order:w,match:R(/^\*\*((?:\\[\s\S]|[^\\])+?)\*\*(?!\*)/),quality:function(r){return r[0].length+.1},parse:ne,react:function(r,e,n){return v("strong",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("strong",e(r.content,n))}},u:{order:w++,match:R(/^__((?:\\[\s\S]|[^\\])+?)__(?!_)/),quality:function(r){return r[0].length},parse:ne,react:function(r,e,n){return v("u",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("u",e(r.content,n))}},del:{order:w++,match:R(/^~~(?=\S)((?:\\[\s\S]|~(?!~)|[^\s~\\]|\s(?!~~))+?)~~/),parse:ne,react:function(r,e,n){return v("del",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("del",e(r.content,n))}},inlineCode:{order:w++,match:R(/^(`+)([\s\S]*?[^`])\1(?!`)/),parse:function(r,e,n){return{content:r[2].replace(Er,"$1")}},react:function(r,e,n){return v("code",n.key,{children:r.content})},html:function(r,e,n){return T("code",_(r.content))}},br:{order:w++,match:fe(/^ {2,}\n/),parse:he,react:function(r,e,n){return v("br",n.key,Pr)},html:function(r,e,n){return"<br>"}},text:{order:w++,match:fe(/^[\s\S]+?(?=[^0-9A-Za-z\s\u00c0-\uffff]|\n\n| {2,}\n|\w+:\S|$)/),parse:function(r,e,n){return{content:r[0]}},react:function(r,e,n){return r.content},html:function(r,e,n){return _(r.content)}}},Yr=function(r,e){!e&&typeof console<"u"&&console.warn("simple-markdown ruleOutput should take 'react' or 'html' as the second argument.");var n=function(t,a,i){return r[t.type][e](t,a,i)};return n},Wr=function(r){var e=function(n,t){if(t=t||{},Array.isArray(n)){for(var a=t.key,i=[],o=null,s=0;s<n.length;s++){t.key=""+s;var u=e(n[s],t);typeof u=="string"&&typeof o=="string"?(o=o+u,i[i.length-1]=o):(i.push(u),o=u)}return t.key=a,i}else return r(n,e,t)};return e},Mr=function(r){var e=function(n,t){return t=t||{},Array.isArray(n)?n.map(function(a){return e(a,t)}).join(""):r(n,e,t)};return e},Re=function(r,e,n={}){if(!e)throw new Error("simple-markdown: outputFor: `property` must be defined. if you just upgraded, you probably need to replace `outputFor` with `reactFor`");var t,a=r.Array||J.Array,i=a[e];if(!i)throw new Error("simple-markdown: outputFor: to join nodes of type `"+e+"` you must provide an `Array:` joiner rule with that type, Please see the docs for details on specifying an Array rule.");var o=i,s=function(d,g){return g=g||t,t=g,Array.isArray(d)?o(d,s,g):r[d.type][e](d,s,g)},u=function(d,g){return t=_e(g,n),s(d,t)};return u},ge=Ue(J),Ce=function(r,e){return e=e||{},e.inline=!1,ge(r,e)},Gr=function(r,e){return e=e||{},e.inline=!0,ge(r,e)},Le=function(r,e){var n=ze.test(r);return e=e||{},e.inline=!n,ge(r,e)},qe=Re(J,"react"),He=Re(J,"html"),Ke=function(r,e){return qe(Ce(r,e),e)},Dr=function(r,e){return He(Ce(r,e),e)},Fr=function(r){var e={};for(var n in r)n!=="source"&&Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n]);return e.children=Ke(r.source),v("div",null,e)},h={defaultRules:J,parserFor:Ue,outputFor:Re,inlineRegex:R,blockRegex:I,anyScopeRegex:fe,parseInline:se,parseBlock:Ir,markdownToReact:Ke,markdownToHtml:Dr,ReactMarkdown:Fr,defaultBlockParse:Ce,defaultInlineParse:Gr,defaultImplicitParse:Le,defaultReactOutput:qe,defaultHtmlOutput:He,preprocess:Fe,sanitizeText:_,sanitizeUrl:z,unescapeUrl:ve,htmlTag:T,reactElement:v,defaultRawParse:ge,ruleOutput:Yr,reactFor:Wr,htmlFor:Mr,defaultParse:function(...r){return typeof console<"u"&&console.warn("defaultParse is deprecated, please use `defaultImplicitParse`"),Le.apply(null,r)},defaultOutput:function(...r){return typeof console<"u"&&console.warn("defaultOutput is deprecated, please use `defaultReactOutput`"),qe.apply(null,r)}};const _r={fence:{match:h.defaultRules.fence.match,order:1,parse:(r,e,n)=>({type:"codeBlock",lang:r[2]||void 0,content:r[3]})},paragraph:{match:h.defaultRules.paragraph.match,order:2,parse:(r,e,n)=>({content:r[1]})}},Ur=h.parserFor(_r),Vr=r=>{const e=r.replace(/^\n\s*\n/,"")+`

`;return Ur(e,{inline:!1}).map(n=>n.content)},zr=r=>r.join(`

`),Ye={parseToArray:Vr,joinFromArray:zr},Hr="@khanacademy/pure-markdown",Kr="__lib_version__";Ae(Hr,Kr);const Br=/^\[\[\u2603 (([a-z-]+) ([0-9]+))\]\]/,Be=(r,e,n)=>{const t=r.length;let a=0;if(n){if(e.inline)return null;for(;a<t&&r[a]===" ";)a++}if(!(a<t&&r[a]==="$"))return null;a++;const i=a;let o=0;for(;a<t;){const s=r[a];if(s==="\\")a++;else if(o<=0&&s==="$"){let u=a+1;if(n){const d=/^(?: *\n){2,}/.exec(r.slice(u));u=d?u+d[0].length:null}return u?[r.substring(0,u),r.substring(i,a)]:null}else if(s==="{")o++;else if(s==="}")o--;else if(s===`
`&&r[a-1]===`
`)return null;a++}return null},Qr=(r,e)=>Be(r,e,!1),$r=(r,e)=>Be(r,e,!0),Jr=new RegExp("^\\|\\| +(.*) +\\|\\| *\\n("+h.defaultRules.nptable.match.regex.source.substring(1)+")"),Zr=h.blockRegex(/^(crwdns.*)\n\s*\n/),S={...h.defaultRules,columns:{order:-2,match:h.blockRegex(/^([\s\S]*\n\n)={5,}\n\n([\s\S]*)/),parse:(r,e,n)=>({col1:e(r[1],n),col2:e(r[2],n)})},crowdinId:{order:-1,match:(r,e,n)=>e.isJipt?Zr(r,e,n):null,parse:(r,e,n)=>({id:r[1]})},titledTable:{order:h.defaultRules.nptable.order-.5,match:h.blockRegex(Jr),parse:(r,e,n)=>{const t=h.parseInline(e,r[1],n),a=r.slice(2),i=h.defaultRules.nptable.parse(a,e,n);return{title:t,table:i}}},widget:{order:h.defaultRules.link.order-.75,match:h.inlineRegex(Br),parse:(r,e,n)=>({id:r[1],widgetType:r[2]})},blockMath:{order:h.defaultRules.codeBlock.order+.5,match:$r,parse:(r,e,n)=>({content:r[1]})},math:{order:h.defaultRules.link.order-.25,match:Qr,parse:(r,e,n)=>({content:r[1]})},unescapedDollar:{order:h.defaultRules.link.order-.24,match:h.inlineRegex(/^(?!\\)\$/),parse:(r,e,n)=>({})},fence:{...h.defaultRules.fence,parse:(r,e,n)=>{const t=h.defaultRules.fence.parse(r,e,n);return t.lang==="alt"?{type:"codeBlock",lang:"alt",content:e(t.content+`

`,n)}:t}},blockQuote:{...h.defaultRules.blockQuote,match:h.blockRegex(/^ *>[^\n]+(\n( *>)?[^\n]+)*\n{2,}/)},lint:{order:1e3,match:r=>null,parse:(r,e,n)=>({})}};h.parserFor(S);const Q={...S,columns:{...S.columns,react:(r,e,n)=>m.createElement("div",{className:"perseus-two-columns",key:n.key},m.createElement("div",{className:"perseus-column"},m.createElement("div",{className:"perseus-column-content"},e(r.col1,n))),m.createElement("div",{className:"perseus-column"},m.createElement("div",{className:"perseus-column-content"},e(r.col2,n))))},crowdinId:{...S.crowdinId,react:(r,e,n)=>r.id},table:{...S.table,react:function(r,e,n){const t=h.defaultRules.table.react(r,e,n);return n.isMobile?m.cloneElement(t,{tabIndex:0}):t}},titledTable:{...S.titledTable,react:(r,e,n)=>{var a;let t;if(!r.table)t="//invalid table//";else if(r.table.type==="lint")((a=r.table.content)==null?void 0:a.type)==="table"?t=Q.lint.react({...r.table,content:{...r,table:r.table.content}},e,{...n,unwrapTitledTableContents:!0}):t=Q.lint.react(r.table,e,n);else{const i=h.defaultRules.table.react(r.table,e,n),o=m.createElement("caption",{key:"caption",className:"perseus-table-title"},e(r.title,n));t=m.cloneElement(i,null,[o,...i.props.children])}return n.unwrapTitledTableContents?t:m.createElement("div",{className:"perseus-titled-table",key:n.key},t)}},widget:{...S.widget,react:(r,e,n)=>m.createElement("em",{key:n.key},`[Widget: ${r.id}]`)},blockMath:{...S.blockMath,react:(r,e,n)=>{const{TeX:t}=H();return m.createElement(t,{key:n.key},r.content)}},math:{...S.math,react:(r,e,n)=>{const{TeX:t}=H();return m.createElement(t,{key:n.key},r.content)}},unescapedDollar:{...S.unescapedDollar,react:(r,e,n)=>"$"},link:{...S.link,react:function(r,e,n){const t=h.defaultRules.link.react(r,e,n),a=t.props.href;let i=null;(a?a.match(/https?:\/\/[^/]*khanacademy.org|^\//):!1)||(i="noopener noreferrer");const s={...t.props,target:"_blank",href:a,rel:i};return n.baseElements&&n.baseElements.Link?n.baseElements.Link(s):m.cloneElement(t,s)}},codeBlock:{...S.codeBlock,react:(r,e,n)=>r.lang==="alt"?m.createElement("div",{key:n.key,className:"perseus-markdown-alt perseus-sr-only"},e(r.content,n)):h.defaultRules.codeBlock.react(r,e,n)},lint:{...S.lint,react:(r,e,n)=>m.createElement(hn,{message:r.message,ruleName:r.ruleName,inline:et(r.content),blockHighlight:r.blockHighlight,insideTable:r.insideTable,severity:r.severity},e(r.content,n))}};function et(r){return!!(r&&r.type&&nt.hasOwnProperty(r.type))}const nt={text:!0,math:!0,unescapedDollar:!0,link:!0,img:!0,strong:!0,u:!0,em:!0,del:!0,code:!0},Qe=h.parserFor(Q),$e=(r,e)=>{const n=r+`

`;return Qe(n,{...e,inline:!1})},rt=(r,e)=>Qe(r,{...e,inline:!0}),O=(r,e)=>{p.isArray(r)?p.each(r,n=>O(n,e)):p.isObject(r)&&(e(r),r.type==="table"?(O(r.header,e),O(r.cells,e)):r.type==="list"?O(r.items,e):r.type==="titledTable"?O(r.table,e):r.type==="columns"?(O(r.col1,e),O(r.col2,e)):p.isArray(r.content)&&O(r.content,e))},Te=r=>{if(p.isArray(r))return p.flatten(p.map(r,Te));if(r.content&&p.isString(r.content))return r.type.toLowerCase().indexOf("code")!==-1?["",r.content,""]:[r.content.replace(/\s+/g," ")];const e=p.chain(r).values().flatten().filter(t=>t!=null&&p.has(t,"type")).value();if(!e.length)return[];const n=Te(e);if(r.type==="paragraph"&&n.length){n[0]=n[0].replace(/^\s+/,"");const t=n.length-1;n[t]=n[t].replace(/\s+$/,"")}return n},tt=r=>{const e=$e(r);return Te(e).join("").length},W={characterCount:tt,traverseContent:O,parse:$e,parseInline:rt,reactFor:h.reactFor,ruleOutput:h.ruleOutput(Q,"react"),basicOutput:h.reactFor(h.ruleOutput(Q,"react")),sanitizeUrl:h.sanitizeUrl};class Je extends m.Component{render(){const e=this.props.className?"paragraph "+this.props.className:"paragraph";return m.createElement("div",{className:this.props.inline?this.props.className??void 0:e,"data-perseus-component-index":this.props.translationIndex,"data-perseus-paragraph-index":this.props.paragraphIndex},this.props.children)}}Je.__docgenInfo={description:"",methods:[],displayName:"QuestionParagraph",props:{className:{required:!1,tsType:{name:"union",raw:"string | null | undefined",elements:[{name:"string"},{name:"null"},{name:"undefined"}]},description:""},translationIndex:{required:!0,tsType:{name:"number"},description:""},paragraphIndex:{required:!1,tsType:{name:"number"},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},inline:{required:!1,tsType:{name:"boolean"},description:""}}};const at=1e3;class it{constructor(){this.previousContent=null,this.runLinter=en.debounce((e,n)=>{if(!(typeof KA>"u")&&e!==this.previousContent){if(this.previousContent=e,e===""){n([]);return}fetch("/api/internal/translations/lint_poentry?preview=1&lang=en",{headers:{"Content-Type":"application/json"},body:JSON.stringify({msgid:e,msgstr:e,format:"perseus_text",filename:""}),method:"POST"}).then(t=>t.status>=400?{status:"error",message:"Could not run i18n linter."}:t.json(),t=>({status:"error",message:"Could not run i18n linter."})).then(t=>{t.status==="error"?n(["Some part of this text makes it untranslatable. The specific message from the i18n linter was: "+t.message.replace(/\n/g," ")]):n([])})}},at)}applyLintErrors(e,n){if(n.length){const t=n.join(`

`);e.unshift({content:{type:"text",content:""},insideTable:!1,message:t,ruleName:"legacy-error",severity:l.Severity.ERROR,type:"lint"})}}}const st=r=>r.replace(/\{align[*]?\}/g,"{aligned}").replace(/[\u00a0]/g," "),{interactiveSizes:ae}=bn,ot=wn,ut=kn,D={SMALL:"small",MEDIUM:"medium",LARGE:"large",XLARGE:"xlarge"},lt=r=>r?r<=ot?D.SMALL:r<=ut?D.MEDIUM:D.LARGE:D.MEDIUM,Dt=r=>r===D.SMALL?[ae.defaultBoxSizeSmall,ae.defaultBoxSizeSmall]:[ae.defaultBoxSize,ae.defaultBoxSize],dt="",mt=!1,x={},$={},Ze=(r,e)=>{x[r]=e},Ft=r=>{r.forEach(e=>{Ze(e.name,e)})},M=(r,e)=>{const n=x[e];if(!n){const t=`Failed to replace ${r} with ${e}`;throw new X(t,N.Internal)}Ze(r,n)},_t=()=>{M("transformer","deprecated-standin"),M("lights-puzzle","deprecated-standin"),M("reaction-diagram","deprecated-standin"),M("sequence","deprecated-standin"),M("simulator","deprecated-standin"),M("unit-input","deprecated-standin")},Ut=r=>{r.forEach(e=>{if(!e.widgetName)throw new X(`Editor ${e.displayName} doesn't have a widgetName property`,N.Internal);$[e.widgetName]=e})},G=(r,e)=>{const n=$[e];if(!n&&B){const t=`Failed to replace editor ${r} with ${e}`;B.error(t,N.Internal);return}$[r]=n},Vt=()=>{G("transformer","deprecated-standin"),G("lights-puzzle","deprecated-standin"),G("reaction-diagram","deprecated-standin"),G("sequence","deprecated-standin"),G("simulator","deprecated-standin"),G("unit-input","deprecated-standin")},gt=r=>{var e,n,t;return p.has(x,r)?(e=x[r])!=null&&e.getWidget?(t=(n=x[r]).getWidget)==null?void 0:t.call(n):x[r].widget:null},zt=r=>p.has($,r)?$[r]:null,pt=r=>{if(x[r])return x[r].version||{major:0,minor:0}},Ht=()=>{const r={};return p.each(p.keys(x),function(e){r[e]=pt(e)}),r},Kt=()=>p.pick(x,p.reject(p.keys(x),function(r){return x[r].hidden})),Bt=()=>p.keys(x),yt=(r,e,n)=>{const t=r.type,a=x[t];if(a==null)return r;let i;return r.static?i=ct(t)||p.identity:i=a.transform||p.identity,i(r.options,e,n)},Qt=r=>{const e=x[r];return e&&e.staticTransform!=null},ct=r=>{const e=x[r];return e&&e.staticTransform},ht=r=>{const e=x[r];return e&&e.tracking||dt},bt=r=>{const e=x[r];return e&&e.isLintable||mt},Se=class Se extends m.Component{constructor(){super(...arguments),this.widgetRef=m.createRef(),this.state={sizeClass:D.MEDIUM,widgetProps:this.props.initialProps},this.getWidget=()=>this.widgetRef.current,this.replaceWidgetProps=e=>{this.setState({widgetProps:e})}}componentDidMount(){if(this.state.widgetProps.apiOptions.isMobile){const e=we.findDOMNode(this).offsetWidth;this.setState({sizeClass:lt(e)})}}UNSAFE_componentWillReceiveProps(e){if(this.props.type!==e.type)throw new Error("WidgetContainer can't change widget type; set a different key instead to recreate the container.")}shouldComponentUpdate(e,n){return this.props.shouldHighlight!==e.shouldHighlight||this.props.type!==e.type||this.state.widgetProps!==n.widgetProps||this.state.sizeClass!==n.sizeClass}render(){var b;let e=be({"perseus-widget-container":!0,"widget-highlight":this.props.shouldHighlight,"widget-nohighlight":!this.props.shouldHighlight,"perseus-widget__definition":this.props.type==="definition"});const n=this.props.type,t=navigator.userAgent,a=gt(n);if(a==null)return console.warn(`Widget type '${n}' not found!`),m.createElement("div",{className:e});let i="null";n==="interactive-graph"&&(i=((b=this.state.widgetProps.graph)==null?void 0:b.type)??"null");let o=this.state.widgetProps.alignment;o==="default"&&(o=nn(n)),e+=" widget-"+o;const s=this.state.widgetProps.apiOptions,u=this.state.widgetProps.static||s.readOnly,d={position:"relative",overflow:"visible"},g={width:"100%",height:"100%",position:"absolute",top:0,left:0,zIndex:3},y=bt(n)?this.props.linterContext:{...this.props.linterContext,highlightLint:!1};return m.createElement("div",{className:e,style:u?d:{}},m.createElement(yn.Consumer,null,({analytics:f})=>m.createElement(E,{metadata:{widget_type:n,widget_id:this.props.id},onError:q=>{f.onAnalyticsEvent({type:"perseus:widget-rendering-error",payload:{widgetSubType:i,widgetType:n,widgetId:this.props.id,message:q.message,userAgent:t}}),f.onAnalyticsEvent({type:"perseus:widget-rendering-error:ti",payload:{widgetSubType:i,widgetType:n,widgetId:this.props.id,message:q.message,userAgent:t}})}},m.createElement(a,{...this.state.widgetProps,linterContext:y,containerSizeClass:this.state.sizeClass,ref:this.widgetRef}),u&&m.createElement("div",{style:g}))))}};Se.defaultProps={linterContext:Ge};let ue=Se;ue.__docgenInfo={description:"",methods:[{name:"getWidget",docblock:null,modifiers:[],params:[],returns:null},{name:"replaceWidgetProps",docblock:null,modifiers:[],params:[{name:"newWidgetProps",optional:!1,type:null}],returns:null}],displayName:"WidgetContainer",props:{shouldHighlight:{required:!0,tsType:{name:"boolean"},description:""},type:{required:!0,tsType:{name:"string"},description:""},id:{required:!0,tsType:{name:"string"},description:""},initialProps:{required:!0,tsType:{name:"intersection",raw:`RenderProps & {
...
}`,computed:!1}}}};const wt=/\S/,kt=/(web\+graphie|https):\/\/[^\s]*/,V=()=>{},We=["content","problemNum","widgets"],ie=r=>"container:"+r,ft=function(r,e){return r===null||e===null?r===e:p.every(r,(n,t)=>{if(e!=null)return p.isEqual(n,e[t])})},le=class le extends m.Component{constructor(e){super(e),this._widgetContainers=new Map,this.getApiOptions=()=>({...cn.defaults,...this.props.apiOptions}),this._getInitialWidgetState=n=>{const t=rn(n.widgets);return{widgetInfo:t,widgetProps:this._getAllWidgetsStartProps(t,n)}},this._getAllWidgetsStartProps=(n,t)=>{var u;const{apiOptions:a,problemNum:i}=t,o={},{strings:s}=this.props;return ln(n).forEach(([d,g])=>{o[d]=yt(g,s,i)}),(u=a==null?void 0:a.onWidgetStartProps)==null||u.call(a,o),o},this._getDefaultWidgetInfo=n=>{const t=on.rTypeFromWidgetId.exec(n);return t==null?{}:{type:t[1],graded:!0,options:{}}},this._getWidgetInfo=n=>this.state.widgetInfo[n]||this._getDefaultWidgetInfo(n),this.renderWidget=(n,t,a)=>{const i=this.state.widgetInfo[t];if(i&&i.alignment==="full-width"&&(a.foundFullWidth=!0),i){const o=i&&i.type||n,s=p.contains(this.props.highlightedWidgets,t);return m.createElement(ue,{key:ie(t),id:t,ref:u=>{const d=ie(t);u!=null?this._widgetContainers.set(d,u):this._widgetContainers.delete(d)},type:o,initialProps:this.getWidgetProps(t),shouldHighlight:s,linterContext:hr(this.props.linterContext,"widget")})}return null},this.getSerializedState=n=>Ie(n||this.state.widgetProps,(t,a)=>{const i=this.getWidgetInstance(a);return i&&i.getSerializedState?i.getSerializedState():t}),this.restoreSerializedState=(n,t)=>{const a=p.keys(n),i=p.keys(this.state.widgetProps);if(a.length!==i.length||p.intersection(a,i).length!==a.length){B.error("Refusing to restore bad serialized state:",N.Internal,{loggedMetadata:{serializedState:JSON.stringify(n),currentProps:JSON.stringify(this.state.widgetProps)}});return}let o=1;const s=()=>{--o,t&&o===0&&t()};this.setState({widgetProps:Ie(n,(u,d)=>{const g=this.getWidgetInstance(d);if(g&&g.restoreSerializedState){++o;const y=g.restoreSerializedState(u,s);return p.extend({},this.state.widgetProps[d],y)}return u})},()=>{setTimeout(s,0)})},this.showRationalesForCurrentlySelectedChoices=()=>{Object.keys(this.props.widgets).forEach(n=>{const t=this.getWidgetInstance(n);t&&t.showRationalesForCurrentlySelectedChoices&&t.showRationalesForCurrentlySelectedChoices(this._getWidgetInfo(n).options)})},this.deselectIncorrectSelectedChoices=()=>{Object.keys(this.props.widgets).forEach(n=>{const t=this.getWidgetInstance(n);t&&t.deselectIncorrectSelectedChoices&&t.deselectIncorrectSelectedChoices()})},this.findInternalWidgets=n=>{let t;if(typeof n=="string")if(n.indexOf(" ")!==-1){const i=n;t=(o,s,u)=>o===i}else{const i=n;t=(o,s,u)=>s.type===i}else t=n;return this.widgetIds.filter(i=>{const o=this._getWidgetInfo(i),s=this.getWidgetInstance(i);return t(i,o,s)}).map(this.getWidgetInstance)},this.findWidgets=n=>[...this.findInternalWidgets(n),...this.props.findExternalWidgets(n)],this.getWidgetInstance=n=>{const t=this._widgetContainers.get(ie(n));return t?t.getWidget():null},this._onWidgetFocus=(n,t=[])=>{if(!p.isArray(t))throw new X("widget props.onFocus focusPath must be an Array, but was"+JSON.stringify(t),N.Internal);this._setCurrentFocus([n].concat(t))},this._onWidgetBlur=(n,t)=>{const a=this._currentFocus,i=[n].concat(t);p.isEqual(i,a)&&p.defer(()=>{p.isEqual(this._currentFocus,a)&&this._setCurrentFocus(null)})},this.getContent=(n,t)=>t.jiptContent||n.content,this.shouldRenderJiptPlaceholder=(n,t)=>H().JIPT.useJIPT&&t.jiptContent==null&&n.content.indexOf("crwdns")!==-1,this.replaceJiptContent=(n,t)=>{if(t==null)this.setState({jiptContent:n});else{/^\s*(`{3,}|~{3,})\s*(\S+)?\s*\n([\s\S]+?)\s*\1\s*$/.test(n)||(/\S\n\s*\n\S/.test(n)?n="$\\large{\\red{\\text{Please translate each paragraph to a single paragraph.}}}$":/^\s*$/.test(n)&&(n="$\\large{\\red{\\text{Translated paragraph is currently empty}}}$"));const i=this.getContent(this.props,this.state),o=Ye.parseToArray(i);o[t]=n,this.setState({jiptContent:Ye.joinFromArray(o)})}},this.outputMarkdown=(n,t)=>{if(p.isArray(n)){const o=t.key,s=[];let u=!1;for(let d=0;d<n.length;d++){t.key=d,t.paragraphIndex=d;const g=this.outputMarkdown(n[d],t),y=typeof g=="string";typeof g=="string"&&u?s[s.length-1]+=g:s.push(g),u=y}return t.key=o,s}this._foundTextNodes=!1,t.foundFullWidth=!1;const a=this.outputNested(n,t);let i;return this.translationIndex!=null?i=null:i=be({"perseus-paragraph-centered":!this._foundTextNodes,"perseus-paragraph-full-width":t.foundFullWidth&&n.content.length===1}),m.createElement(Je,{key:t.key,className:i,translationIndex:this.translationIndex,paragraphIndex:t.paragraphIndex,inline:this.props.inline},m.createElement(E,null,a))},this.outputNested=(n,t)=>{if(p.isArray(n)){const a=t.key,i=[];let o=!1;for(let s=0;s<n.length;s++){t.key=s;const u=this.outputNested(n[s],t),d=typeof u=="string";typeof u=="string"&&o?i[i.length-1]+=u:i.push(u),o=d}return t.key=a,i}return this.outputNode(n,this.outputNested,t)},this.outputNode=(n,t,a)=>{const i=this.getApiOptions(),o=i.imagePlaceholder;if(n.type==="widget"){const s=i.widgetPlaceholder;return s||(this._foundTextNodes=!0,this.widgetIds.includes(n.id)?m.createElement("span",{key:a.key,className:"renderer-widget-error"},["Widget [[","☃"," ",n.id,"]] already exists."].join("")):(this.widgetIds.push(n.id),this.renderWidget(n.widgetType,n.id,a)))}if(n.type==="blockMath"){const s=st(n.content),u={overflowX:"auto",overflowY:"hidden",paddingTop:10,paddingBottom:10,marginTop:-10,marginBottom:-10};if(i.isMobile){const g={marginLeft:-16,marginRight:-16},y={paddingLeft:16,paddingRight:16},b={...u,...Me.mobileZoomableParentFix};return m.createElement("div",{key:a.key,className:"perseus-block-math",style:g},m.createElement(E,null,m.createElement("div",{className:"perseus-block-math-inner",style:{...b,...y}},m.createElement(dn,null,s))))}return m.createElement("div",{key:a.key,className:"perseus-block-math"},m.createElement(E,null,m.createElement("div",{className:"perseus-block-math-inner",style:u},m.createElement(pe.Consumer,null,({setAssetStatus:d})=>m.createElement(Ne,{setAssetStatus:d},s)))))}if(n.type==="math"){const s=n.content.replace(/\{align[*]?\}/g,"{aligned}");return m.createElement("span",{key:a.key,style:{whiteSpace:"nowrap"}},m.createElement(E,null,m.createElement("span",null),m.createElement(pe.Consumer,null,({setAssetStatus:u})=>m.createElement(Ne,{onRender:this.props.onRender,setAssetStatus:u},s)),m.createElement("span",null)))}if(n.type==="image"){if(o)return o;const s=p.has(this.props.images,n.target)?this.props.images[n.target]:null,u=!a.inTable;return m.createElement(E,{key:a.key},m.createElement(pe.Consumer,null,({setAssetStatus:d})=>m.createElement(gn,{setAssetStatus:d,src:W.sanitizeUrl(n.target),alt:n.alt,title:n.title,responsive:u,onUpdate:this.props.onRender,zoomToFullSizeOnMobile:i.isMobile&&i.isArticle,...s})))}if(n.type==="columns")return this._isTwoColumn=!0,m.createElement(E,{key:a.key},W.ruleOutput(n,t,a));if(n.type==="text")return wt.test(n.content)&&(this._foundTextNodes=!0),o&&kt.test(n.content)?o:n.content;if(n.type==="table"||n.type==="titledTable"){const s=W.ruleOutput(n,t,{...a,isMobile:i.isMobile,inTable:!0});if(!i.isMobile)return s;const u=16,d={marginLeft:-u,marginRight:-u},y={...{paddingLeft:0,paddingRight:0},...Me.mobileZoomableParentFix},b=m.createElement("div",{style:{...y,overflowX:"auto"}},m.createElement(E,null,m.createElement(pn,{animateHeight:!0},s)));return m.createElement("div",{style:d},b)}return m.createElement(E,{key:a.key},W.ruleOutput(n,t,a))},this.handleRender=n=>{const t=this.props.onRender,a=n.onRender;if(t!==V||a!==V){const i=un(we.findDOMNode(this)).find("img");a!==V&&i.off("load",a),t!==V&&i.on("load",t)}t()},this._setCurrentFocus=n=>{const t=this.getApiOptions();if(!ft(n,this._currentFocus)){const a=this._currentFocus;a&&this.blurPath(a),this._currentFocus=n,t.onFocusChange(this._currentFocus,a)}},this.focus=()=>{var a;let n,t;for(let i=0;i<this.widgetIds.length;i++){const o=this.widgetIds[i],s=this.getWidgetInstance(o),u=(a=s==null?void 0:s.focus)==null?void 0:a.call(s);if(u){n=o,t=u;break}}if(n){let i;return typeof t=="object"?(i=[n].concat(t.path||[]),B.error("Renderer received a focus result of type 'object' instead of the expected type 'boolean'",N.Internal,{loggedMetadata:{focusResult:JSON.stringify(t),currentProps:JSON.stringify(this.state.widgetProps)}})):i=[n],this._setCurrentFocus(i),!0}},this.getDOMNodeForPath=n=>{const t=p.first(n),a=p.rest(n),i=this.getWidgetInstance(t);if(i!=null&&i.getDOMNodeForPath)return i.getDOMNodeForPath(a);if(a.length===0)return we.findDOMNode(i)},this.getInputPaths=()=>{const n=[];return this.widgetIds.forEach(t=>{const a=this.getWidgetInstance(t);a&&a.getInputPaths&&a.getInputPaths().forEach(o=>{const s=[t].concat(o);n.push(s)})}),n},this.focusPath=n=>{var o;if(p.isEqual(this._currentFocus,n))return;this._currentFocus&&this.blurPath(this._currentFocus);const t=p.first(n),a=p.rest(n),i=this.getWidgetInstance(t);(o=i==null?void 0:i.focusInputPath)==null||o.call(i,a)},this.blurPath=n=>{var o;if(!p.isEqual(this._currentFocus,n))return;const t=p.first(n),a=p.rest(n);if(this.getWidgetInstance(t)){const s=this.getWidgetInstance(t);(o=s==null?void 0:s.blurInputPath)==null||o.call(s,a)}},this.blur=()=>{this._currentFocus&&this.blurPath(this._currentFocus)},this.serialize=()=>{const n={};return p.each(this.state.widgetInfo,function(t,a){const o=this.getWidgetInstance(a).serialize();p.isEmpty(o)||(n[a]=o)},this),n},this._setWidgetProps=(n,t,a,i)=>{this.setState(o=>{const s={...o.widgetProps,[n]:{...o.widgetProps[n],...t}},u=i?o.lastUsedWidgetId:n;return i||this.props.onSerializedStateUpdated(this.getSerializedState(s)),{lastUsedWidgetId:u,widgetProps:s}},()=>{setTimeout(()=>{const o=a&&a();i||this.props.onInteractWithWidget(n),o!==!1&&this._setCurrentFocus([n])},0)})},this.setInputValue=(n,t,a)=>{var u;const i=p.first(n),o=p.rest(n),s=this.getWidgetInstance(i);(u=s==null?void 0:s.setInputValue)==null||u.call(s,o,t,a)},this.getWidgetIds=()=>this.widgetIds,this.handletranslationLintErrors=n=>{this._isMounted&&this.setState({translationLintErrors:n})},this._translationLinter=new it,this.state={jiptContent:null,translationLintErrors:[],lastUsedWidgetId:null,...this._getInitialWidgetState(e)}}componentDidMount(){this._isMounted=!0,this.handleRender({}),this._currentFocus=null,this.props.serializedState&&this.restoreSerializedState(this.props.serializedState),this.props.linterContext.highlightLint&&this._translationLinter.runLinter(this.props.content,this.handletranslationLintErrors)}UNSAFE_componentWillReceiveProps(e){p.isEqual(p.pick(this.props,We),p.pick(e,We))||this.setState(this._getInitialWidgetState(e))}shouldComponentUpdate(e,n){if(this.props.alwaysUpdate)return!0;const t=!p.isEqual(this.state,n);return!p.isEqual(this.props,e)||t}UNSAFE_componentWillUpdate(e,n){const t=this.shouldRenderJiptPlaceholder(this.props,this.state),a=this.shouldRenderJiptPlaceholder(e,n),i=this.getContent(this.props,this.state),o=this.getContent(e,n),s=this.props.highlightedWidgets,u=e.highlightedWidgets;this.reuseMarkdown=!t&&!a&&i===o&&p.isEqual(this.state.translationLintErrors,n.translationLintErrors)&&(!this.props.linterContext.highlightLint||p.isEqual(this.props.widgets,e.widgets))&&this.props.linterContext.highlightLint===e.linterContext.highlightLint&&s===u}componentDidUpdate(e,n){this.handleRender(e),this.widgetIds.forEach(t=>{const a=this._widgetContainers.get(ie(t));a==null||a.replaceWidgetProps(this.getWidgetProps(t))}),this.props.serializedState&&!p.isEqual(this.props.serializedState,this.getSerializedState())&&this.restoreSerializedState(this.props.serializedState),this.props.linterContext.highlightLint&&this._translationLinter.runLinter(this.props.content,this.handletranslationLintErrors)}componentWillUnmount(){this.widgetIds=[],this.translationIndex!=null&&H().rendererTranslationComponents.removeComponentAtIndex(this.translationIndex),this._isMounted=!1}getWidgetProps(e){const n=this.getApiOptions(),t=this.state.widgetProps[e]||{},a=this.state.widgetInfo[e],i=this.props.reviewMode&&a?a.options:null;this._interactionTrackers||(this._interactionTrackers={});let o=this._interactionTrackers[e];return o||(o=this._interactionTrackers[e]=new kr(n.trackInteraction,a&&a.type,e,ht(a&&a.type))),{...t,widgetId:e,alignment:a&&a.alignment,static:a==null?void 0:a.static,problemNum:this.props.problemNum,apiOptions:this.getApiOptions(),keypadElement:this.props.keypadElement,questionCompleted:this.props.questionCompleted,showSolutions:this.props.showSolutions,onFocus:p.partial(this._onWidgetFocus,e),onBlur:p.partial(this._onWidgetBlur,e),findWidgets:this.findWidgets,reviewModeRubric:i,reviewMode:this.props.reviewMode,onChange:(s,u,d=!1)=>{this._setWidgetProps(e,s,u,d)},trackInteraction:o.track,isLastUsedWidget:e===this.state.lastUsedWidgetId}}emptyWidgets(){return tn(this.state.widgetInfo,this.widgetIds,this.getUserInputMap(),this.context.locale)}getUserInput(){return this.widgetIds.map(e=>{const n=this.getWidgetInstance(e);if(n&&n.getUserInput)return n.getUserInput()})}getUserInputMap(){const e={};return this.widgetIds.forEach(n=>{const t=this.getWidgetInstance(n);t!=null&&t.getUserInputMap?e[n]=t.getUserInputMap():t!=null&&t.getUserInput&&(e[n]=t.getUserInput())}),e}getPromptJSON(){const{content:e}=this.props,n={};return this.widgetIds.forEach(t=>{var i;const a=this.getWidgetInstance(t);n[t]=((i=a==null?void 0:a.getPromptJSON)==null?void 0:i.call(a))||{}}),{content:e,widgets:n}}score(){const e=an(this.state.widgetInfo,this.widgetIds,this.getUserInputMap(),this.context.locale);return sn(e)}render(){const e=this.getApiOptions();if(this.reuseMarkdown)return this.lastRenderedMarkdown;const n=this.getContent(this.props,this.state);if(this.widgetIds=[],this.shouldRenderJiptPlaceholder(this.props,this.state)&&(this.translationIndex||(this.translationIndex=H().rendererTranslationComponents.addComponent(this)),!e.isArticle))return m.createElement(ke,null,m.createElement("div",{"data-perseus-component-index":this.translationIndex},n));this._isTwoColumn=!1;const t=this.props.inline?W.parseInline(n,{isJipt:this.translationIndex!=null}):W.parse(n,{isJipt:this.translationIndex!=null});if(this.props.linterContext.highlightLint){const o={content:this.props.content,widgets:this.props.widgets,...this.props.linterContext};cr(t,o,!0),this._translationLinter.applyLintErrors(t,[...this.state.translationLintErrors,...this.props.legacyPerseusLint||[]])}const a=this.outputMarkdown(t,{baseElements:e.baseElements}),i=be({[ye.RENDERER]:!0,[ye.RESPONSIVE_RENDERER]:!0,[ye.TWO_COLUMN_RENDERER]:this._isTwoColumn});return this.lastRenderedMarkdown=m.createElement(ke,null,m.createElement("div",{className:i},a)),this.lastRenderedMarkdown}};le.contextType=mn,le.defaultProps={content:"",widgets:{},images:{},highlightedWidgets:[],questionCompleted:!1,showSolutions:"none",onRender:V,onInteractWithWidget:function(){},findExternalWidgets:()=>[],alwaysUpdate:!1,reviewMode:!1,serializedState:null,onSerializedStateUpdated:()=>{},linterContext:Ge};let xe=le;const Me={mobileZoomableParentFix:{transform:"translate3d(0,0,0)"}};xe.__docgenInfo={description:"",methods:[{name:"getApiOptions",docblock:null,modifiers:[],params:[],returns:null},{name:"_getInitialWidgetState",docblock:null,modifiers:[],params:[{name:"props",optional:!1,type:{name:"intersection",raw:`Partial<React.ContextType<typeof DependenciesContext>> & {
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{Gt as D,Ye as J,W as P,xe as R,h as S,_t as a,Ut as b,Vt as c,zt as d,Kt as e,Bt as f,Ht as g,pt as h,st as i,Dt as j,D as k,Ge as l,S as m,hr as p,Ft as r,Qt as s};
