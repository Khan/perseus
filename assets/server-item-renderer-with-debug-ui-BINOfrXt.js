import{B as u}from"./index-DpD-xBMx.js";import{V as q}from"./index-CskvhqFA.js";import{S as R}from"./index-D-mrA-Lm.js";import{r as e}from"./index-C6mWTJJr.js";import"./underscore-U-AHniOr.js";import"./core-widget-registry-2tCIH_GM.js";import{s as A}from"./split-perseus-item-D_z-OoAi.js";import{s as I}from"./util-Cjm22Ttl.js";import"./jquery-CkHB0_Mt.js";import"./all-widgets-tRlJWtrE.js";import"./phet-simulation-CRP1AVh1.js";import"./dependencies-BsVPGK1s.js";import"./perseus-api-DmwU2RjF.js";import{r as E}from"./server-item-renderer-BYboQbOk.js";import"./article-renderer-BDBMlFVD.js";import"./hints-renderer-D7pIA0Cj.js";import"./renderer-Dk-W13T9.js";import"./base-radio-_o7Aud29.js";import{P as x,E as N}from"./perseus-error-UcbLzupY.js";import"./button-group-q129tbVV.js";import"./svg-image-DAYn0iDa.js";import"./hud--52rQRjV.js";import"./icon-90vA-eeT.js";import"./index-CfM4f3_8.js";import"./inline-icon-olZqfQoG.js";import"./math-input-CYtrbsT8.js";import"./multi-button-group-CGE8ZIlq.js";import"./number-input-CDxfqmZD.js";import"./range-input-pvBjtf5m.js";import"./text-input-wa-toQ9v.js";import"./text-list-editor-Rb8EP659.js";import"./i18n-context-glBZFVwC.js";import"./index-Dd-cahjY.js";import{H as h}from"./index-CbNKSLRm.js";import{R as c,S as F}from"./split-view-DIdTXuH9.js";import{s as D}from"./test-dependencies-_iLD15SY.js";function S(n){return n.type==="points"&&n.earned>=n.total}function W(n,a,r){if(n.type==="points")return{empty:!1,correct:S(n),message:n.message,guess:a,state:r};if(n.type==="invalid")return{empty:!0,correct:!1,message:n.message,suppressAlmostThere:n.suppressAlmostThere,guess:a,state:r};throw new x("Invalid score type: "+n.type,N.InvalidInput,{metadata:{score:JSON.stringify(n),guess:JSON.stringify(a),state:JSON.stringify(r)}})}function m({score:n}){return n==null?null:e.createElement(e.Fragment,null,e.createElement("table",{style:{marginTop:"20px"}},e.createElement("thead",null,e.createElement("tr",{style:{fontWeight:"bold"}},e.createElement("td",null,"Empty"),e.createElement("td",null,"Correct"),e.createElement("td",{style:{width:"100%"}},"Message"))),e.createElement("tbody",null,e.createElement("tr",null,e.createElement("td",null,n.empty.toString()),e.createElement("td",null,n.correct.toString()),e.createElement("td",null,n.message)))),e.createElement(h,{style:{marginTop:"10px"}},"Guess"),e.createElement(c,{quotesOnKeys:!1,enableClipboard:!1,src:n.guess}),e.createElement(h,{style:{marginTop:"10px"}},"State"),e.createElement(c,{quotesOnKeys:!1,enableClipboard:!1,src:n.state}))}m.__docgenInfo={description:"",methods:[],displayName:"KEScoreUI",props:{score:{required:!0,tsType:{name:"union",raw:"KEScore | null | undefined",elements:[{name:"signature",type:"object",raw:`{
    empty: boolean;
    correct: boolean;
    ...
    guess: any;
    state: any;
}`,signature:{properties:[{key:"empty",value:{name:"boolean",required:!0}},{key:"correct",value:{name:"boolean",required:!0}},{key:"message",value:{name:"union",raw:"string | null | undefined",elements:[{name:"string"},{name:"null"},{name:"undefined"}],required:!1}},{key:"suppressAlmostThere",value:{name:"union",raw:"boolean | null | undefined",elements:[{name:"boolean"},{name:"null"},{name:"undefined"}],required:!1}},{key:"guess",value:{name:"any",required:!0}},{key:"state",value:{name:"any",required:!0}}]}},{name:"null"},{name:"undefined"}]},description:""}}};const C=({item:n,apiOptions:a,keypadElement:r,reviewMode:s=!1,startAnswerless:p=!1,showSolutions:o})=>{const i=e.useRef(null),[g,y]=e.useState(null),[w,d]=e.useState(p),f=a||Object.freeze({}),b=()=>{const t=i.current;if(!t)return;const k=t.getUserInput(),P=I(n.question,k,"en"),T=[t.getUserInputLegacy(),[]];return W(P,T,t.getSerializedState().question)},v=w&&!s&&(o==="none"||!o)?A(n.question):n.question,l={...n,question:v};return e.createElement(F,{rendererTitle:"Renderer",renderer:e.createElement(e.Fragment,null,e.createElement(E,{ref:i,problemNum:0,apiOptions:f,item:l,dependencies:D,keypadElement:r,reviewMode:s,showSolutions:o}),e.createElement(q,{style:{flexDirection:"row",alignItems:"center"}},e.createElement(u,{onClick:()=>{d(!1),i.current&&y(b())}},"Check"),e.createElement(R,{size:8}),e.createElement(u,{onClick:()=>{var t;d(!1),(t=i.current)==null||t.showRationalesForCurrentlySelectedChoices()}},"Show Rationales")),e.createElement(m,{score:g})),jsonObject:l})};C.__docgenInfo={description:"",methods:[],displayName:"ServerItemRendererWithDebugUI",props:{item:{required:!0,tsType:{name:"signature",type:"object",raw:`{
