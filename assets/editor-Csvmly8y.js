var v=Object.defineProperty;var k=(l,s,e)=>s in l?v(l,s,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[s]=e;var r=(l,s,e)=>(k(l,typeof s!="symbol"?s+"":s,e),e);import{r as y,ck as T,ad as C,_ as i,cl as m,j as o,cm as P,bB as c,cn as R,z as h,y as q,s as A}from"./iframe-CTOs5xNT.js";import"./item-version-Cc_SfDGX.js";import"./article-renderer-DhN21r3O.js";import"./server-item-renderer-BDe2OHhV.js";import"./hints-renderer-DgXLEwYt.js";import{t as x}from"./trash-bold-BLGUig5L.js";import{L as u}from"./labeled-switch-CirbpeVz.js";import{E as g}from"./editor-NDFLi_dH.js";const f=""+new URL("plus-bold-CG3_Sgx2.svg",import.meta.url).href;class N extends y.Component{render(){const s=this.props.choice.correct?"correct":"incorrect";let e="Type a choice here...";this.props.choice.isNoneOfTheAbove&&(e=this.props.choice.correct?"Type the answer to reveal to the user...":"None of the above");const t=o.jsx(g,{ref:"content-editor",apiOptions:this.props.apiOptions,content:this.props.choice.content||"",widgetEnabled:!1,placeholder:e,disabled:this.props.choice.isNoneOfTheAbove&&!this.props.choice.correct,onChange:this.props.onContentChange}),n=o.jsx(g,{ref:"clue-editor",apiOptions:this.props.apiOptions,content:this.props.choice.clue||"",widgetEnabled:!1,placeholder:`Why is this choice ${s}?`,onChange:this.props.onClueChange}),a=o.jsx(h,{size:"small",kind:"tertiary",startIcon:x,onClick:this.props.onDelete,children:"Remove this choice"});return o.jsxs("div",{className:"choice-clue-editors",children:[o.jsx("div",{className:`choice-editor ${s}`,children:t}),o.jsx("div",{className:"clue-editor",children:n}),this.props.showDelete&&a]})}}class p extends y.Component{constructor(){super(...arguments);r(this,"change",(...e)=>C.apply(this,e));r(this,"onMultipleSelectChange",e=>{e=e.multipleSelect;const t=i.reduce(this.props.choices,function(n,a){return a.correct?n+1:n},0);if(!e&&t>1){const n=i.map(this.props.choices,function(a){return i.defaults({correct:!1},a)});this.props.onChange({multipleSelect:e,choices:n})}else this.props.onChange({multipleSelect:e})});r(this,"onCountChoicesChange",e=>{e=e.countChoices,this.props.onChange({countChoices:e})});r(this,"onChange",({checked:e})=>{const t=this.props.choices.map((n,a)=>({...n,correct:e[a],content:n.isNoneOfTheAbove&&!e[a]?"":n.content}));this.props.onChange({choices:t,numCorrect:m({...this.props,choices:t,numCorrect:void 0})})});r(this,"onContentChange",(e,t)=>{const n=this.props.choices.slice();n[e]=i.extend({},n[e],{content:t}),this.props.onChange({choices:n})});r(this,"onDelete",e=>{const t=this.props.choices.slice(),n=t[e];t.splice(e,1),this.props.onChange({choices:t,hasNoneOfTheAbove:this.props.hasNoneOfTheAbove&&!n.isNoneOfTheAbove})});r(this,"addChoice",(e,t)=>{t.preventDefault();const n=this.props.choices.slice(),a={isNoneOfTheAbove:e,content:""},d=n.length-(this.props.hasNoneOfTheAbove?1:0);n.splice(d,0,a),this.props.onChange({choices:n,hasNoneOfTheAbove:e||this.props.hasNoneOfTheAbove},()=>{this.refs[`choice-editor${d}`].refs["content-editor"].focus()})});r(this,"setDisplayCount",e=>{this.props.onChange({displayCount:e})});r(this,"focus",()=>(this.refs["choice-editor0"].refs["content-editor"].focus(),!0));r(this,"getSaveWarnings",()=>i.some(i.pluck(this.props.choices,"correct"))?[]:["No choice is marked as correct."])}onClueChange(e,t){const n=this.props.choices.slice();n[e]=i.extend({},n[e],{clue:t}),t===""&&delete n[e].clue,this.props.onChange({choices:n})}serialize(){const{choices:e,randomize:t,multipleSelect:n,countChoices:a,displayCount:d,hasNoneOfTheAbove:b,deselectEnabled:w}=this.props;return{choices:e,randomize:t,multipleSelect:n,countChoices:a,displayCount:d,hasNoneOfTheAbove:b,deselectEnabled:w,numCorrect:m({...this.props,numCorrect:void 0})}}render(){const e=i.reduce(this.props.choices,function(t,n){return n.correct?t+1:t},0);return o.jsxs("div",{children:[o.jsx(P,{href:"https://www.khanacademy.org/internal-courses/content-creation-best-practices/xe46daa512cd9c644:question-writing/xe46daa512cd9c644:multiple-choice/a/stems",target:"_blank",children:"Multiple choice best practices"}),o.jsxs("div",{className:"perseus-widget-row",children:[o.jsx(u,{label:"Randomize order",checked:this.props.randomize,onChange:t=>{this.props.onChange({randomize:t})},style:{marginBlockEnd:c.size_060}}),o.jsx(u,{label:"Multiple selections",checked:this.props.multipleSelect,onChange:t=>{this.onMultipleSelectChange({multipleSelect:t})},style:{marginBlockEnd:c.size_060}}),this.props.multipleSelect&&o.jsx(u,{label:"Specify number correct",checked:this.props.countChoices,onChange:t=>{this.onCountChoicesChange({countChoices:t})},style:{marginBlockEnd:c.size_060}})]}),o.jsx(R,{multipleSelect:this.props.multipleSelect,countChoices:this.props.countChoices,numCorrect:e,editMode:!0,labelWrap:!1,apiOptions:this.props.apiOptions,reviewMode:!1,choices:this.props.choices.map((t,n)=>({content:o.jsx(N,{ref:`choice-editor${n}`,apiOptions:this.props.apiOptions,choice:t,onContentChange:a=>{a.content!=null&&this.onContentChange(n,a.content)},onClueChange:a=>{a.content!=null&&this.onClueChange(n,a.content)},onDelete:()=>this.onDelete(n),showDelete:this.props.choices.length>=2}),isNoneOfTheAbove:t.isNoneOfTheAbove,checked:t.correct}),this),onChange:this.onChange}),o.jsxs("div",{className:"add-choice-container",children:[o.jsx(h,{size:"small",kind:"tertiary",startIcon:f,onClick:this.addChoice.bind(this,!1),children:"Add a choice"}),o.jsx(q,{size:A.large_24}),o.jsx(h,{size:"small",kind:"tertiary",startIcon:f,onClick:this.addChoice.bind(this,!0),children:"None of the above"})]})]})}}r(p,"widgetName","radio"),r(p,"defaultProps",T.defaultWidgetOptions);p.__docgenInfo={description:"",methods:[{name:"change",docblock:null,modifiers:[],params:[{name:"...args",optional:!1,type:null}],returns:null},{name:"onMultipleSelectChange",docblock:null,modifiers:[],params:[{name:"allowMultiple",optional:!1,type:null}],returns:null},{name:"onCountChoicesChange",docblock:null,modifiers:[],params:[{name:"count",optional:!1,type:null}],returns:null},{name:"onChange",docblock:null,modifiers:[],params:[{name:"{checked}",optional:!1,type:null}],returns:null},{name:"onContentChange",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null},{name:"newContent",optional:!1,type:null}],returns:null},{name:"onClueChange",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:{name:"number"}},{name:"newClue",optional:!1,type:{name:"string"}}],returns:{type:{name:"void"}}},{name:"onDelete",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null}],returns:null},{name:"addChoice",docblock:null,modifiers:[],params:[{name:"noneOfTheAbove",optional:!1,type:null},{name:"e",optional:!1,type:null}],returns:null},{name:"setDisplayCount",docblock:null,modifiers:[],params:[{name:"num",optional:!1,type:null}],returns:null},{name:"focus",docblock:null,modifiers:[],params:[],returns:null},{name:"getSaveWarnings",docblock:null,modifiers:[],params:[],returns:null},{name:"serialize",docblock:null,modifiers:[],params:[],returns:{type:{name:"signature",type:"object",raw:`{
