...
@deprecated Not used.`},{key:"answer",value:{name:"any",required:!1},description:"@deprecated Superseded by per-widget answers."}]},alias:"PerseusItem"}}],returns:null}],displayName:"EditorPage",props:{apiOptions:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
        newFocusPath: FocusPath,
        oldFocusPath: FocusPath,
