...
}`,...(ve=(Qe=b.parameters)==null?void 0:Qe.docs)==null?void 0:ve.source}}};var Ce,We,Re;Q.parameters={...Q.parameters,docs:{...(Ce=Q.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: unlimitedPolygonQuestion
    })
  }
}`,...(Re=(We=Q.parameters)==null?void 0:We.docs)==null?void 0:Re.source}}};var Oe,_e,Ne;v.parameters={...v.parameters,docs:{...(Oe=v.parameters)==null?void 0:Oe.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: rayQuestion
    })
  }
}`,...(Ne=(_e=v.parameters)==null?void 0:_e.docs)==null?void 0:Ne.source}}};var Be,Fe,Ee;C.parameters={...C.parameters,docs:{...(Be=C.parameters)==null?void 0:Be.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentQuestion
    })
  }
}`,...(Ee=(Fe=C.parameters)==null?void 0:Fe.docs)==null?void 0:Ee.source}}};var Ve,Ge,De;W.parameters={...W.parameters,docs:{...(Ve=W.parameters)==null?void 0:Ve.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: sinusoidQuestion
    })
  }
}`,...(De=(Ge=W.parameters)==null?void 0:Ge.docs)==null?void 0:De.source}}};var Ue,Je,ze;R.parameters={...R.parameters,docs:{...(Ue=R.parameters)==null?void 0:Ue.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentWithLockedPointsQuestion
    })
  }
}`,...(ze=(Je=R.parameters)==null?void 0:Je.docs)==null?void 0:ze.source}}};var He,$e,Me;O.parameters={...O.parameters,docs:{...(He=O.parameters)==null?void 0:He.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: segmentWithLockedLineQuestion
    })
  }
}`,...(Me=($e=O.parameters)==null?void 0:$e.docs)==null?void 0:Me.source}}};var Ke,Ye,Ze;_.parameters={..._.parameters,docs:{...(Ke=_.parameters)==null?void 0:Ke.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
...
}`,...(bs=(Ts=D.parameters)==null?void 0:Ts.docs)==null?void 0:bs.source}}};var Qs,vs,Cs;U.parameters={...U.parameters,docs:{...(Qs=U.parameters)==null?void 0:Qs.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: floatingPointIssueQuestion
    })
  }
}`,...(Cs=(vs=U.parameters)==null?void 0:vs.docs)==null?void 0:Cs.source}}};var Ws,Rs,Os;J.parameters={...J.parameters,docs:{...(Ws=J.parameters)==null?void 0:Ws.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: angleQuestion
    })
  }
}`,...(Os=(Rs=J.parameters)==null?void 0:Rs.docs)==null?void 0:Os.source}}};var _s,Ns,Bs;z.parameters={...z.parameters,docs:{...(_s=z.parameters)==null?void 0:_s.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: circleQuestion
    }),
...
}`,...(Bs=(Ns=z.parameters)==null?void 0:Ns.docs)==null?void 0:Bs.source}}};var Fs,Es,Vs;H.parameters={...H.parameters,docs:{...(Fs=H.parameters)==null?void 0:Fs.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: linearQuestion
    }),
...
}`,...(Vs=(Es=H.parameters)==null?void 0:Es.docs)==null?void 0:Vs.source}}};var Gs,Ds,Us;$.parameters={...$.parameters,docs:{...(Gs=$.parameters)==null?void 0:Gs.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: linearSystemQuestion
    }),
...
}`,...(Us=(Ds=$.parameters)==null?void 0:Ds.docs)==null?void 0:Us.source}}};var Js,zs,Hs;M.parameters={...M.parameters,docs:{...(Js=M.parameters)==null?void 0:Js.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: pointQuestion
    }),
...
}`,...(Hs=(zs=M.parameters)==null?void 0:zs.docs)==null?void 0:Hs.source}}};var $s,Ms,Ks;K.parameters={...K.parameters,docs:{...($s=K.parameters)==null?void 0:$s.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: polygonQuestion
    }),
...
}`,...(ct=(it=ee.parameters)==null?void 0:it.docs)==null?void 0:ct.source}}};const Rn=["Angle","SideBySideFlipbook","Circle","Linear","LinearSystem","Point","Polygon","UnlimitedPolygon","Ray","Segment","Sinusoid","LockedPoints","LockedLines","AllLockedLineSegmentStyles","AllLockedLineStyles","AllLockedRayStyles","LockedVector","LockedEllipse","LockedPolygon","LockedLabel","PolygonReadOnly","StaticGraph","StaticGraphWithAnotherWidget","TooltipsWithFloatingPointIssues","AnswerlessAngle","AnswerlessCircle","AnswerlessLinear","AnswerlessLinearSystem","AnswerlessPoint","AnswerlessPolygon","AnswerlessUnlimitedPolygon","AnswerlessRay","AnswerlessSegment","AnswerlessSinusoid"];export{_ as AllLockedLineSegmentStyles,N as AllLockedLineStyles,B as AllLockedRayStyles,j as Angle,J as AnswerlessAngle,z as AnswerlessCircle,H as AnswerlessLinear,$ as AnswerlessLinearSystem,M as AnswerlessPoint,K as AnswerlessPolygon,Z as AnswerlessRay,X as AnswerlessSegment,ee as AnswerlessSinusoid,Y as AnswerlessUnlimitedPolygon,P as Circle,L as Linear,A as LinearSystem,E as LockedEllipse,G as LockedLabel,O as LockedLines,R as LockedPoints,V as LockedPolygon,F as LockedVector,T as Point,b as Polygon,x as PolygonReadOnly,v as Ray,C as Segment,f as SideBySideFlipbook,W as Sinusoid,y as StaticGraph,D as StaticGraphWithAnotherWidget,U as TooltipsWithFloatingPointIssues,Q as UnlimitedPolygon,Rn as __namedExportsOrder,Wn as default};
