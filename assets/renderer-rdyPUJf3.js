import{j as y}from"./jsx-runtime-63Ea5SlK.js";import{_ as g,d as mn}from"./index-default-4_ZsnO94.js";import{a as Ie}from"./version-zYAx5FCH.js";import{P as O,E as R}from"./perseus-error-l3K_anoI.js";import{L as H,b as ve,S as gn}from"./svg-image-5xpyV1oq.js";import{g as pn}from"./_commonjsHelpers-4gQjN7DL.js";import{e as yn}from"./index-J2t_5nK1.js";import{c as ke}from"./index-dnMhQZ-1.js";import{$ as cn}from"./jquery-5v7aFUvu.js";import{r as j}from"./index-6oxdNXpR.js";import{F as qe}from"./index-9gkyvru-.js";import{c as he}from"./asset-context-H6Iqp7Gi.js";import{P as hn}from"./i18n-context-ihOeIMY_.js";import{T as Le}from"./tex-MX5FPdQh.js";import{Z as bn}from"./zoomable-_uYFBX1Q.js";import{Z as wn}from"./zoomable-tex-Jjwex-Ep.js";import{g as J,D as fn}from"./dependencies-CP7Uh8Kq.js";import{A as vn,C as be}from"./perseus-api-_PWPZoDE.js";import{L as kn}from"./lint-CRWxUAIQ.js";import{U as qn}from"./util-FOHsj4WS.js";import{f as Tn,t as An,u as Rn,z as xn}from"./constants-iPV6vHZm.js";function Pn(){return/\[\[☃ ([A-Za-z0-9- ]+)\]\]/g}function Cn(r){const e=[],n=Pn();let t=n.exec(r);for(;t!==null;)e.push(t[1]),t=n.exec(r);return e}class K{static parse(e){return new ge(e).parse()}match(e){throw new O("Selector subclasses must implement match()",R.NotAllowed)}toString(){return"Unknown selector class"}}class ge{constructor(e){e=e.trim().replace(/\s+/g," "),this.tokens=e.match(ge.TOKENS)||[],this.tokenIndex=0}nextToken(){return this.tokens[this.tokenIndex]||""}consume(){this.tokenIndex++}isIdentifier(){const e=this.tokens[this.tokenIndex][0];return e>="a"&&e<="z"||e>="A"&&e<="Z"}skipSpace(){for(;this.nextToken()===" ";)this.consume()}parse(){const e=this.parseTreeSelector();let n=this.nextToken();if(!n)return e;const t=[e];for(;n;){if(n===",")this.consume();else throw new we("Expected comma");t.push(this.parseTreeSelector()),n=this.nextToken()}return new In(t)}parseTreeSelector(){this.skipSpace();let e=this.parseNodeSelector();for(;;){const n=this.nextToken();if(!n||n===",")break;if(n===" ")this.consume(),e=new Nn(e,this.parseNodeSelector());else if(n===">")this.consume(),e=new En(e,this.parseNodeSelector());else if(n==="+")this.consume(),e=new jn(e,this.parseNodeSelector());else if(n==="~")this.consume(),e=new Ln(e,this.parseNodeSelector());else throw new we("Unexpected token: "+n)}return e}parseNodeSelector(){this.skipSpace();const e=this.nextToken();if(e==="*")return this.consume(),new Sn;if(this.isIdentifier())return this.consume(),new On(e);throw new we("Expected node type")}}ge.TOKENS=/([a-zA-Z][\w-]*)|(\d+)|[^\s]|(\s(?=[a-zA-Z\*]))/g;class we extends Error{constructor(e){super(e)}}class In extends K{constructor(e){super(),this.selectors=e}match(e){for(let n=0;n<this.selectors.length;n++){const a=this.selectors[n].match(e);if(a)return a}return null}toString(){let e="";for(let n=0;n<this.selectors.length;n++)e+=n>0?", ":"",e+=this.selectors[n].toString();return e}}class Sn extends K{match(e){return[e.currentNode()]}toString(){return"*"}}class On extends K{constructor(e){super(),this.type=e}match(e){const n=e.currentNode();return n.type===this.type?[n]:null}toString(){return this.type}}class pe extends K{constructor(e,n){super(),this.left=e,this.right=n}}class Nn extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n)for(e=e.clone();e.hasParent();){e.goToParent();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" "+this.right.toString()}}class En extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n&&e.hasParent()){e=e.clone(),e.goToParent();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" > "+this.right.toString()}}class jn extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n&&e.hasPreviousSibling()){e=e.clone(),e.goToPreviousSibling();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" + "+this.right.toString()}}class Ln extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n)for(e=e.clone();e.hasPreviousSibling();){e.goToPreviousSibling();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" ~ "+this.right.toString()}}const W=class W{constructor(e,n,t,a,i,o){if(!t&&!a)throw new O("Lint rules must have a selector or pattern",R.InvalidInput,{metadata:{name:e}});this.name=e||"unnamed rule",this.severity=n||W.Severity.BULK_WARNING,this.selector=t||W.DEFAULT_SELECTOR,this.pattern=a||null,typeof i=="function"?(this.lint=i,this.message=null):(this.lint=(...s)=>this._defaultLintFunction(...s),this.message=i),this.applies=o||function(){return!0}}static makeRule(e){return new W(e.name,e.severity,e.selector?K.parse(e.selector):null,W.makePattern(e.pattern),e.lint||e.message,e.applies)}check(e,n,t,a){const i=this.selector.match(n);if(!i)return null;let o;if(this.pattern?o=t.match(this.pattern):o=W.FakePatternMatch(t,t,0),!o)return null;try{const s=this.lint(n,t,i,o,a);return s?typeof s=="string"?{rule:this.name,severity:this.severity,message:s,start:0,end:t.length}:{rule:this.name,severity:this.severity,message:s.message,start:s.start,end:s.end}:null}catch(s){return{rule:"lint-rule-failure",message:`Exception in rule ${this.name}: ${s.message}
Stack trace:
${s.stack}`,start:0,end:t.length}}}_defaultLintFunction(e,n,t,a,i){return{message:this.message||"",start:a.index,end:a.index+a[0].length}}static makePattern(e){if(!e)return null;if(e instanceof RegExp)return e;if(e[0]==="/"){const n=e.lastIndexOf("/"),t=e.substring(1,n),a=e.substring(n+1);return new RegExp(t,a)}return new RegExp(e)}static FakePatternMatch(e,n,t){const a=[n];return a.index=t,a.input=e,a}};W.Severity={ERROR:1,WARNING:2,GUIDELINE:3,BULK_WARNING:4};let m=W;m.DEFAULT_SELECTOR=K.parse("text");const Wn=/\/\/([^\/]+)/;function Mn(r){if(!r)return"";const e=r.match(Wn);return e?e[1]:""}const Xn=m.makeRule({name:"absolute-url",severity:m.Severity.GUIDELINE,selector:"link, image",lint:function(r,e,n,t){const a=n[0].target,i=Mn(a);if(i==="khanacademy.org"||i.endsWith(".khanacademy.org"))return`Don't use absolute URLs:
When linking to KA content or images, omit the
https://www.khanacademy.org URL prefix.
Use a relative URL beginning with / instead.`}}),Fn=m.makeRule({name:"blockquoted-math",severity:m.Severity.WARNING,selector:"blockQuote math, blockQuote blockMath",message:`Blockquoted math:
math should not be indented.`}),Yn=m.makeRule({name:"blockquoted-widget",severity:m.Severity.WARNING,selector:"blockQuote widget",message:`Blockquoted widget:
...
any other kind of terminal punctuation.`});function Dn(r,e){return`Answer requires a button not found in the button sets: ${r} (in ${e})`}const Gn={"\\sqrt":"prealgebra","\\sin":"trig","\\cos":"trig","\\tan":"trig","\\log":"logarithms","\\ln":"logarithms"},zn=m.makeRule({name:"expression-widget",severity:m.Severity.WARNING,selector:"widget",lint:function(r,e,n,t,a){var l;if(r.currentNode().widgetType!=="expression")return;const i=r.currentNode().id;if(!i)return;const o=(l=a==null?void 0:a.widgets)==null?void 0:l[i];if(!o)return;const s=o.options.answerForms,u=o.options.buttonSets;for(const d of s)for(const[p,b]of Object.entries(Gn))if(d.value.includes(p)&&!u.includes(b))return Dn(p,b)}}),Un=m.makeRule({name:"extra-content-spacing",selector:"paragraph",pattern:/\s+$/,applies:function(r){return(r==null?void 0:r.contentType)==="article"},message:"No extra whitespace at the end of content blocks."}),Vn=m.makeRule({name:"heading-level-1",severity:m.Severity.WARNING,selector:"heading",lint:function(r,e,n,t){if(n[0].level===1)return`Don't use level-1 headings:
...
did you mean to put it inside dollar signs?`}),yr=m.makeRule({name:"nested-lists",severity:m.Severity.WARNING,selector:"list list",message:`Nested lists:
...
the linter and any warnings will be highlighted in the rendered output.`},{key:"legacyPerseusLint",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!1}},{key:"widgets",value:{name:"signature",raw:'PerseusRenderer["widgets"]',required:!0}},{key:"inline",value:{name:"boolean",required:!1},description:"Skip adding paragraph class"},{key:"strings",value:{name:"signature",type:"object",raw:`{
    ...
    point2X: string;
    point2Y: string;
}`,signature:{properties:[{key:"point1X",value:{name:"string",required:!0}},{key:"point1Y",value:{name:"string",required:!0}},{key:"point2X",value:{name:"string",required:!0}},{key:"point2Y",value:{name:"string",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}}]},required:!0}}]}}],alias:"Props"}}],returns:null},{name:"_getAllWidgetsStartProps",docblock:null,modifiers:[],params:[{name:"allWidgetInfo",optional:!1,type:null},{name:"props",optional:!1,type:null}],returns:null},{name:"_getDefaultWidgetInfo",docblock:null,modifiers:[],params:[{name:"widgetId",optional:!1,type:{name:"string"}}],returns:null},{name:"_getWidgetInfo",docblock:null,modifiers:[],params:[{name:"widgetId",optional:!1,type:{name:"string"}}],returns:{type:{name:"union",raw:`| CategorizerWidget
| CSProgramWidget
| DefinitionWidget
| DropdownWidget
| ExplanationWidget
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{wa as D,_e as J,_ as P,Ce as R,h as S,ka as a,Ca as b,qa as c,Ta as d,Aa as e,xa as f,Lt as g,Pa as h,Wt as i,Nt as j,fa as k,He as l,zt as m,xt as n,Sa as o,Lr as p,z as q,va as r,Ia as s,Ra as t,Et as u,Ot as v,dn as w,on as x,S as y};
