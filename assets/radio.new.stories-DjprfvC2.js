import{cD as t,j as s}from"./iframe-CiZ4rom4.js";import{S as oe}from"./server-item-renderer-with-debug-ui-fSh-i1vP.js";import{a as p,c as ie,S as $,b as ee,m as ae,d as te,e as se}from"./radio.testdata-C1vj3X_t.js";import"./split-view-CgYgUifl.js";import"./test-keypad-context-wrapper-6ynLXwUe.js";import"./server-item-renderer-BPtEzFPN.js";import"./hints-renderer-DUBe4pQj.js";const ye={title:"Perseus/Widgets/RadioNew",args:{static:!1,startAnswerless:!1,reviewMode:!1,showSolutions:"none",item:t({question:p})},argTypes:{showSolutions:{options:["none","all","selected"],control:{type:"select"}}},render:e=>s.jsx(oe,{item:ce(e),apiOptions:le(),reviewMode:e.reviewMode,showSolutions:e.showSolutions,startAnswerless:e.startAnswerless}),parameters:{docs:{description:{component:`This is a story for the new radio widget.
...
}`,...(L=(j=c.parameters)==null?void 0:j.docs)==null?void 0:L.source}}};var Q,_,D;l.parameters={...l.parameters,docs:{...(Q=l.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: multiChoiceQuestionSimpleOverflowContent
    })
  }
}`,...(D=(_=l.parameters)==null?void 0:_.docs)==null?void 0:D.source}}};var E,N,U;u.parameters={...u.parameters,docs:{...(E=u.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: questionWithPassage
    }),
