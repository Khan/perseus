import{j as e}from"./jsx-runtime-63Ea5SlK.js";import{B as r}from"./index-_CVl-B2F.js";import{V as f}from"./index-_3CKOwHy.js";import{S as b}from"./index-o999uk82.js";import{r as i}from"./index-6oxdNXpR.js";import{s as v}from"./util-BtPxNFcx.js";import"./index-default-4_ZsnO94.js";import"./core-widget-registry-uiKfW1Am.js";import"./jquery-5v7aFUvu.js";import"./article-renderer-ixTRxHTM.js";import"./phet-simulation--DntLPhv.js";import"./dependencies-CP7Uh8Kq.js";import"./perseus-api-DO0X8arb.js";import{r as k}from"./server-item-renderer-QWYWnrVU.js";import"./hints-renderer-bbLMg98a.js";import"./renderer-sKOnMOkh.js";import"./base-radio-pX3PPP3a.js";import{k as P}from"./scoring-0YXKUAne.js";import"./button-group-SY8dumRU.js";import"./graph-rv0TmwrM.js";import"./svg-image-gIyesq-y.js";import"./hud-vl2wgoGQ.js";import"./icon-7RFbyLiL.js";import"./index-4SmKKGcF.js";import"./inline-icon-6fh0Wu1y.js";import"./math-input-Mri0JCu1.js";import"./multi-button-group-3E5hf1eq.js";import"./number-input-X-xsqQXH.js";import"./range-input-IlZfZEkU.js";import"./text-input-yqDH3Bgf.js";import"./text-list-editor-ND6Qift6.js";import"./i18n-context-dE2bX2K_.js";import"./index-smZ6iCr_.js";import{H as o}from"./index-4dAUYsag.js";import{R as s,S as T}from"./side-by-side-HzY51GOy.js";import{s as R}from"./test-dependencies-DwvgXmBp.js";function d({score:n}){return n==null?null:e.jsxs(e.Fragment,{children:[e.jsxs("table",{style:{marginTop:"20px"},children:[e.jsx("thead",{children:e.jsxs("tr",{style:{fontWeight:"bold"},children:[e.jsx("td",{children:"Empty"}),e.jsx("td",{children:"Correct"}),e.jsx("td",{style:{width:"100%"},children:"Message"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:n.empty.toString()}),e.jsx("td",{children:n.correct.toString()}),e.jsx("td",{children:n.message})]})})]}),e.jsx(o,{style:{marginTop:"10px"},children:"Guess"}),e.jsx(s,{quotesOnKeys:!1,enableClipboard:!1,src:n.guess}),e.jsx(o,{style:{marginTop:"10px"},children:"State"}),e.jsx(s,{quotesOnKeys:!1,enableClipboard:!1,src:n.state})]})}d.__docgenInfo={description:"",methods:[],displayName:"KEScoreUI",props:{score:{required:!0,tsType:{name:"union",raw:"KEScore | null | undefined",elements:[{name:"signature",type:"object",raw:`{
    empty: boolean;
    correct: boolean;
    ...
    guess: any;
    state: any;
}`,signature:{properties:[{key:"empty",value:{name:"boolean",required:!0}},{key:"correct",value:{name:"boolean",required:!0}},{key:"message",value:{name:"union",raw:"string | null | undefined",elements:[{name:"string"},{name:"null"},{name:"undefined"}],required:!1}},{key:"suppressAlmostThere",value:{name:"union",raw:"boolean | null | undefined",elements:[{name:"boolean"},{name:"null"},{name:"undefined"}],required:!1}},{key:"guess",value:{name:"any",required:!0}},{key:"state",value:{name:"any",required:!0}}]}},{name:"null"},{name:"undefined"}]},description:""}}};const x=({item:n,apiOptions:l,keypadElement:u})=>{const a=i.useRef(null),[h,c]=i.useState(null),m=l||Object.freeze({}),p=()=>{const t=a.current;if(!t)return;const g=t.getUserInput(),y=v(n.question,g,"en"),w=[t.getUserInputLegacy(),[]];return P(y,w,t.getSerializedState().question)};return e.jsx(T,{leftTitle:"Renderer",left:e.jsxs(e.Fragment,{children:[e.jsx(k,{ref:a,problemNum:0,apiOptions:m,item:n,dependencies:R,keypadElement:u}),e.jsxs(f,{style:{flexDirection:"row",alignItems:"center"},children:[e.jsx(r,{onClick:()=>{a.current&&c(p())},children:"Check"}),e.jsx(b,{size:8}),e.jsx(r,{onClick:()=>{var t;(t=a.current)==null||t.showRationalesForCurrentlySelectedChoices()},children:"Show Rationales"})]}),e.jsx(d,{score:h})]}),jsonObject:n})};x.__docgenInfo={description:"",methods:[],displayName:"ServerItemRendererWithDebugUI",props:{item:{required:!0,tsType:{name:"signature",type:"object",raw:`{
...
the available choices.`}]}}],raw:`Readonly<{
     ...
     */
    onWidgetStartProps?: (widgets: PerseusWidgetsMap) => void;
}>`},description:""},keypadElement:{required:!1,tsType:{name:"union",raw:"KeypadAPI | null | undefined",elements:[{name:"KeypadAPI"},{name:"null"},{name:"undefined"}]},description:""}}};export{x as S};
