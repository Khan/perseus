import{j as y}from"./jsx-runtime-63Ea5SlK.js";import{a as xe}from"./version-akiLXZts.js";import{P as N,E as R}from"./perseus-error-l3K_anoI.js";import{g as un}from"./_commonjsHelpers-4gQjN7DL.js";import{e as dn,i as mn}from"./invariant-bu5zBsRS.js";import{e as gn}from"./index-J2t_5nK1.js";import{c as we}from"./index-dnMhQZ-1.js";import{_ as g,d as pn,$ as yn}from"./jquery-yG1GhClm.js";import{r as j}from"./index-6oxdNXpR.js";import{F as ve}from"./index-9gkyvru-.js";import{c as ce}from"./asset-context-H6Iqp7Gi.js";import{P as cn}from"./i18n-context-fsWEgybQ.js";import{L as K,b as ke,S as hn}from"./svg-image-ZjoZQGiG.js";import{T as je}from"./tex-MX5FPdQh.js";import{Z as bn}from"./zoomable-_uYFBX1Q.js";import{Z as fn}from"./zoomable-tex-Jjwex-Ep.js";import{g as Y,D as wn}from"./dependencies-CP7Uh8Kq.js";import{A as vn,C as he}from"./perseus-api-1-ethIrW.js";import{L as kn}from"./lint-CRWxUAIQ.js";import{U as oe}from"./util-AYeX86gl.js";import{f as qn,t as Tn,u as An,z as Rn}from"./constants-iPV6vHZm.js";class B{static parse(e){return new ge(e).parse()}match(e){throw new N("Selector subclasses must implement match()",R.NotAllowed)}toString(){return"Unknown selector class"}}class ge{constructor(e){e=e.trim().replace(/\s+/g," "),this.tokens=e.match(ge.TOKENS)||[],this.tokenIndex=0}nextToken(){return this.tokens[this.tokenIndex]||""}consume(){this.tokenIndex++}isIdentifier(){const e=this.tokens[this.tokenIndex][0];return e>="a"&&e<="z"||e>="A"&&e<="Z"}skipSpace(){for(;this.nextToken()===" ";)this.consume()}parse(){const e=this.parseTreeSelector();let n=this.nextToken();if(!n)return e;const t=[e];for(;n;){if(n===",")this.consume();else throw new be("Expected comma");t.push(this.parseTreeSelector()),n=this.nextToken()}return new Pn(t)}parseTreeSelector(){this.skipSpace();let e=this.parseNodeSelector();for(;;){const n=this.nextToken();if(!n||n===",")break;if(n===" ")this.consume(),e=new In(e,this.parseNodeSelector());else if(n===">")this.consume(),e=new On(e,this.parseNodeSelector());else if(n==="+")this.consume(),e=new En(e,this.parseNodeSelector());else if(n==="~")this.consume(),e=new Nn(e,this.parseNodeSelector());else throw new be("Unexpected token: "+n)}return e}parseNodeSelector(){this.skipSpace();const e=this.nextToken();if(e==="*")return this.consume(),new Cn;if(this.isIdentifier())return this.consume(),new xn(e);throw new be("Expected node type")}}ge.TOKENS=/([a-zA-Z][\w-]*)|(\d+)|[^\s]|(\s(?=[a-zA-Z\*]))/g;class be extends Error{constructor(e){super(e)}}class Pn extends B{constructor(e){super(),this.selectors=e}match(e){for(let n=0;n<this.selectors.length;n++){const a=this.selectors[n].match(e);if(a)return a}return null}toString(){let e="";for(let n=0;n<this.selectors.length;n++)e+=n>0?", ":"",e+=this.selectors[n].toString();return e}}class Cn extends B{match(e){return[e.currentNode()]}toString(){return"*"}}class xn extends B{constructor(e){super(),this.type=e}match(e){const n=e.currentNode();return n.type===this.type?[n]:null}toString(){return this.type}}class pe extends B{constructor(e,n){super(),this.left=e,this.right=n}}class In extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n)for(e=e.clone();e.hasParent();){e.goToParent();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" "+this.right.toString()}}class On extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n&&e.hasParent()){e=e.clone(),e.goToParent();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" > "+this.right.toString()}}class En extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n&&e.hasPreviousSibling()){e=e.clone(),e.goToPreviousSibling();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" + "+this.right.toString()}}class Nn extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n)for(e=e.clone();e.hasPreviousSibling();){e.goToPreviousSibling();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" ~ "+this.right.toString()}}const L=class L{constructor(e,n,t,a,i,o){if(!t&&!a)throw new N("Lint rules must have a selector or pattern",R.InvalidInput,{metadata:{name:e}});this.name=e||"unnamed rule",this.severity=n||L.Severity.BULK_WARNING,this.selector=t||L.DEFAULT_SELECTOR,this.pattern=a||null,typeof i=="function"?(this.lint=i,this.message=null):(this.lint=(...s)=>this._defaultLintFunction(...s),this.message=i),this.applies=o||function(){return!0}}static makeRule(e){return new L(e.name,e.severity,e.selector?B.parse(e.selector):null,L.makePattern(e.pattern),e.lint||e.message,e.applies)}check(e,n,t,a){const i=this.selector.match(n);if(!i)return null;let o;if(this.pattern?o=t.match(this.pattern):o=L.FakePatternMatch(t,t,0),!o)return null;try{const s=this.lint(n,t,i,o,a);return s?typeof s=="string"?{rule:this.name,severity:this.severity,message:s,start:0,end:t.length}:{rule:this.name,severity:this.severity,message:s.message,start:s.start,end:s.end}:null}catch(s){return{rule:"lint-rule-failure",message:`Exception in rule ${this.name}: ${s.message}
Stack trace:
${s.stack}`,start:0,end:t.length}}}_defaultLintFunction(e,n,t,a,i){return{message:this.message||"",start:a.index,end:a.index+a[0].length}}static makePattern(e){if(!e)return null;if(e instanceof RegExp)return e;if(e[0]==="/"){const n=e.lastIndexOf("/"),t=e.substring(1,n),a=e.substring(n+1);return new RegExp(t,a)}return new RegExp(e)}static FakePatternMatch(e,n,t){const a=[n];return a.index=t,a.input=e,a}};L.Severity={ERROR:1,WARNING:2,GUIDELINE:3,BULK_WARNING:4};let d=L;d.DEFAULT_SELECTOR=B.parse("text");const Sn=/\/\/([^\/]+)/;function jn(r){if(!r)return"";const e=r.match(Sn);return e?e[1]:""}const Wn=d.makeRule({name:"absolute-url",severity:d.Severity.GUIDELINE,selector:"link, image",lint:function(r,e,n,t){const a=n[0].target,i=jn(a);if(i==="khanacademy.org"||i.endsWith(".khanacademy.org"))return`Don't use absolute URLs:
When linking to KA content or images, omit the
https://www.khanacademy.org URL prefix.
Use a relative URL beginning with / instead.`}}),Ln=d.makeRule({name:"blockquoted-math",severity:d.Severity.WARNING,selector:"blockQuote math, blockQuote blockMath",message:`Blockquoted math:
math should not be indented.`}),Mn=d.makeRule({name:"blockquoted-widget",severity:d.Severity.WARNING,selector:"blockQuote widget",message:`Blockquoted widget:
widgets should not be indented.`}),Fn=d.makeRule({name:"double-spacing-after-terminal",severity:d.Severity.BULK_WARNING,selector:"paragraph",pattern:/[.!\?] {2}/i,message:`Use a single space after a sentence-ending period, or
any other kind of terminal punctuation.`});function _n(r,e){return`Answer requires a button not found in the button sets: ${r} (in ${e})`}const Dn={"\\sqrt":"prealgebra","\\sin":"trig","\\cos":"trig","\\tan":"trig","\\log":"logarithms","\\ln":"logarithms"},Gn=d.makeRule({name:"expression-widget",severity:d.Severity.WARNING,selector:"widget",lint:function(r,e,n,t,a){var u;if(r.currentNode().widgetType!=="expression")return;const i=r.currentNode().id;if(!i)return;const o=(u=a==null?void 0:a.widgets)==null?void 0:u[i];if(!o)return;const s=o.options.answerForms,l=o.options.buttonSets;for(const m of s)for(const[p,b]of Object.entries(Dn))if(m.value.includes(p)&&!l.includes(b))return _n(p,b)}}),Vn=d.makeRule({name:"extra-content-spacing",selector:"paragraph",pattern:/\s+$/,applies:function(r){return(r==null?void 0:r.contentType)==="article"},message:"No extra whitespace at the end of content blocks."}),zn=d.makeRule({name:"heading-level-1",severity:d.Severity.WARNING,selector:"heading",lint:function(r,e,n,t){if(n[0].level===1)return`Don't use level-1 headings:
Begin headings with two or more # characters.`}}),Un=d.makeRule({name:"heading-level-skip",severity:d.Severity.WARNING,selector:"heading ~ heading",lint:function(r,e,n,t){const a=n[1],i=n[0];if(a.level>i.level+1)return`Skipped heading level:
this heading is level ${a.level} but
the previous heading was level ${i.level}`}}),Hn=d.makeRule({name:"heading-sentence-case",severity:d.Severity.GUIDELINE,selector:"heading",pattern:/^\W*[a-z]/,message:`First letter is lowercase:
the first letter of a heading should be capitalized.`}),Kn={and:!0,nor:!0,but:!0,the:!0,for:!0};function Bn(r){const e=r[0];return e===e.toUpperCase()}const Xn=d.makeRule({name:"heading-title-case",severity:d.Severity.GUIDELINE,selector:"heading",pattern:/[^\s:]\s+[A-Z]+[a-z]/,locale:"en",lint:function(r,e,n,t){let i=e.trim().split(/\s+/);if(i.shift(),i=i.filter(o=>o.length>2&&!Kn.hasOwnProperty(o)),i.length>=3&&i.every(o=>Bn(o)))return`Title-case heading:
This heading appears to be in title-case, but should be sentence-case.
Only capitalize the first letter and proper nouns.`}}),$n=d.makeRule({name:"image-alt-text",severity:d.Severity.WARNING,selector:"image",lint:function(r,e,n,t){const a=n[0];if(!a.alt||!a.alt.trim())return`Images should have alt text:
...
Do not use the words "click here" in links.`}),er=d.makeRule({name:"long-paragraph",severity:d.Severity.GUIDELINE,selector:"paragraph",pattern:/^.{501,}/,lint:function(r,e,n,t){return`Paragraph too long:
This paragraph is ${e.length} characters long.
Shorten it to 500 characters or fewer.`}}),nr=d.makeRule({name:"math-adjacent",severity:d.Severity.WARNING,selector:"blockMath+blockMath",message:`Adjacent math blocks:
combine the blocks between \\begin{align} and \\end{align}`}),rr=d.makeRule({name:"math-align-extra-break",severity:d.Severity.WARNING,selector:"blockMath",pattern:/(\\{2,})\s*\\end{align}/,message:`Extra space at end of block:
Don't end an align block with backslashes`}),tr=d.makeRule({name:"math-align-linebreaks",severity:d.Severity.WARNING,selector:"blockMath",pattern:/\\begin{align}[\s\S]*\\\\[\s\S]+\\end{align}/,lint:function(r,e,n,t){let a=t[0];for(;a.length;){const i=a.indexOf("\\\\");if(i===-1)return;a=a.substring(i+2);const o=a.match(/^\s*\\\\\s*(?!\\\\)/);if(!o)return"Use four backslashes between lines of an align block";a=a.substring(o[0].length)}}}),ar=d.makeRule({name:"math-empty",severity:d.Severity.WARNING,selector:"math, blockMath",pattern:/^$/,message:"Empty math: don't use $$ in your markdown."}),ir=d.makeRule({name:"math-font-size",severity:d.Severity.GUIDELINE,selector:"math, blockMath",pattern:/\\(tiny|Tiny|small|large|Large|LARGE|huge|Huge|scriptsize|normalsize)\s*{/,message:`Math font size:
Don't change the default font size with \\Large{} or similar commands`}),sr=d.makeRule({name:"math-frac",severity:d.Severity.GUIDELINE,selector:"math, blockMath",pattern:/\\frac[ {]/,message:"Use \\dfrac instead of \\frac in your math expressions."}),or=d.makeRule({name:"math-nested",severity:d.Severity.ERROR,selector:"math, blockMath",pattern:/\\text{[^$}]*\$[^$}]*\$[^}]*}/,message:`Nested math:
Don't nest math expressions inside \\text{} blocks`}),lr=d.makeRule({name:"math-starts-with-space",severity:d.Severity.GUIDELINE,selector:"math, blockMath",pattern:/^\s*(~|\\qquad|\\quad|\\,|\\;|\\:|\\ |\\!|\\enspace|\\phantom)/,message:`Math starts with space:
math should not be indented. Do not begin math expressions with
LaTeX space commands like ~, \\;, \\quad, or \\phantom`}),ur=d.makeRule({name:"math-text-empty",severity:d.Severity.WARNING,selector:"math, blockMath",pattern:/\\text{\s*}/,message:"Empty \\text{} block in math expression"}),dr=d.makeRule({name:"math-without-dollars",severity:d.Severity.GUIDELINE,pattern:/\\\w+{[^}]*}|{|}/,message:`This looks like LaTeX:
did you mean to put it inside dollar signs?`}),mr=d.makeRule({name:"nested-lists",severity:d.Severity.WARNING,selector:"list list",message:`Nested lists:
nested lists are hard to read on mobile devices;
do not use additional indentation.`}),gr=d.makeRule({name:"static-widget-in-question-stem",severity:d.Severity.WARNING,selector:"widget",lint:(r,e,n,t,a)=>{var s;if((a==null?void 0:a.contentType)!=="exercise"||a.stack.includes("hint"))return;const i=r.currentNode().id;if(!i)return;const o=(s=a==null?void 0:a.widgets)==null?void 0:s[i];if(o&&o.static)return"Widget in question stem is static (non-interactive)."}}),pr=d.makeRule({name:"table-missing-cells",severity:d.Severity.WARNING,selector:"table",lint:function(r,e,n,t){const a=n[0],i=a.header.length,o=a.cells.map(s=>s.length);for(let s=0;s<o.length;s++)if(o[s]!==i)return`Table rows don't match header:
The table header has ${i} cells, but
Row ${s+1} has ${o[s]} cells.`}}),yr=d.makeRule({name:"unbalanced-code-delimiters",severity:d.Severity.ERROR,pattern:/[`~]+/,message:`Unbalanced code delimiters:
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{da as D,De as J,D as P,Ce as R,h as S,ga as a,wa as b,pa as c,ya as d,ca as e,ba as f,Ct as g,fa as h,xt as i,At as j,Lt as k,Ke as l,ka as m,z as n,ha as o,Ir as p,Tt as q,ma as r,va as s,ln as t,Rt as u,O as v};
