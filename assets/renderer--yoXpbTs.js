import{j as c}from"./jsx-runtime-63Ea5SlK.js";import{_ as g,d as mn}from"./index-default-4_ZsnO94.js";import{b as Ie}from"./index-VBBZE5E5.js";import{P as N,E as x}from"./perseus-error-l3K_anoI.js";import{L as H,b as ve,S as gn}from"./svg-image-dQmvqixs.js";import{g as pn}from"./_commonjsHelpers-4gQjN7DL.js";import{e as cn}from"./index-J2t_5nK1.js";import{c as ke}from"./index-dnMhQZ-1.js";import{$ as yn}from"./jquery-5v7aFUvu.js";import{r as j}from"./index-6oxdNXpR.js";import{F as qe}from"./index-9gkyvru-.js";import{c as he}from"./asset-context-H6Iqp7Gi.js";import{P as hn}from"./i18n-context-YAdgKrxn.js";import{T as je}from"./tex-MX5FPdQh.js";import{Z as bn}from"./zoomable-_uYFBX1Q.js";import{Z as wn}from"./zoomable-tex-Jjwex-Ep.js";import{g as $,D as fn}from"./dependencies-CP7Uh8Kq.js";import{A as vn,C as be}from"./perseus-api-DO0X8arb.js";import{L as kn}from"./lint-ZDfMj7xF.js";import{U as qn}from"./util-Deofanvy.js";import{f as Tn,t as An,u as xn}from"./constants-NhstHO4m.js";function Rn(){return/\[\[☃ ([A-Za-z0-9- ]+)\]\]/g}function Pn(r){const e=[],n=Rn();let t=n.exec(r);for(;t!==null;)e.push(t[1]),t=n.exec(r);return e}class K{static parse(e){return new ge(e).parse()}match(e){throw new N("Selector subclasses must implement match()",x.NotAllowed)}toString(){return"Unknown selector class"}}class ge{constructor(e){e=e.trim().replace(/\s+/g," "),this.tokens=e.match(ge.TOKENS)||[],this.tokenIndex=0}nextToken(){return this.tokens[this.tokenIndex]||""}consume(){this.tokenIndex++}isIdentifier(){const e=this.tokens[this.tokenIndex][0];return e>="a"&&e<="z"||e>="A"&&e<="Z"}skipSpace(){for(;this.nextToken()===" ";)this.consume()}parse(){const e=this.parseTreeSelector();let n=this.nextToken();if(!n)return e;const t=[e];for(;n;){if(n===",")this.consume();else throw new we("Expected comma");t.push(this.parseTreeSelector()),n=this.nextToken()}return new Cn(t)}parseTreeSelector(){this.skipSpace();let e=this.parseNodeSelector();for(;;){const n=this.nextToken();if(!n||n===",")break;if(n===" ")this.consume(),e=new Nn(e,this.parseNodeSelector());else if(n===">")this.consume(),e=new En(e,this.parseNodeSelector());else if(n==="+")this.consume(),e=new On(e,this.parseNodeSelector());else if(n==="~")this.consume(),e=new jn(e,this.parseNodeSelector());else throw new we("Unexpected token: "+n)}return e}parseNodeSelector(){this.skipSpace();const e=this.nextToken();if(e==="*")return this.consume(),new In;if(this.isIdentifier())return this.consume(),new Sn(e);throw new we("Expected node type")}}ge.TOKENS=/([a-zA-Z][\w-]*)|(\d+)|[^\s]|(\s(?=[a-zA-Z\*]))/g;class we extends Error{constructor(e){super(e)}}class Cn extends K{constructor(e){super(),this.selectors=e}match(e){for(let n=0;n<this.selectors.length;n++){const a=this.selectors[n].match(e);if(a)return a}return null}toString(){let e="";for(let n=0;n<this.selectors.length;n++)e+=n>0?", ":"",e+=this.selectors[n].toString();return e}}class In extends K{match(e){return[e.currentNode()]}toString(){return"*"}}class Sn extends K{constructor(e){super(),this.type=e}match(e){const n=e.currentNode();return n.type===this.type?[n]:null}toString(){return this.type}}class pe extends K{constructor(e,n){super(),this.left=e,this.right=n}}class Nn extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n)for(e=e.clone();e.hasParent();){e.goToParent();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" "+this.right.toString()}}class En extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n&&e.hasParent()){e=e.clone(),e.goToParent();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" > "+this.right.toString()}}class On extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n&&e.hasPreviousSibling()){e=e.clone(),e.goToPreviousSibling();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" + "+this.right.toString()}}class jn extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n)for(e=e.clone();e.hasPreviousSibling();){e.goToPreviousSibling();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" ~ "+this.right.toString()}}const X=class X{constructor(e,n,t,a,i,o){if(!t&&!a)throw new N("Lint rules must have a selector or pattern",x.InvalidInput,{metadata:{name:e}});this.name=e||"unnamed rule",this.severity=n||X.Severity.BULK_WARNING,this.selector=t||X.DEFAULT_SELECTOR,this.pattern=a||null,typeof i=="function"?(this.lint=i,this.message=null):(this.lint=(...s)=>this._defaultLintFunction(...s),this.message=i),this.applies=o||function(){return!0}}static makeRule(e){return new X(e.name,e.severity,e.selector?K.parse(e.selector):null,X.makePattern(e.pattern),e.lint||e.message,e.applies)}check(e,n,t,a){const i=this.selector.match(n);if(!i)return null;let o;if(this.pattern?o=t.match(this.pattern):o=X.FakePatternMatch(t,t,0),!o)return null;try{const s=this.lint(n,t,i,o,a);return s?typeof s=="string"?{rule:this.name,severity:this.severity,message:s,start:0,end:t.length}:{rule:this.name,severity:this.severity,message:s.message,start:s.start,end:s.end}:null}catch(s){return{rule:"lint-rule-failure",message:`Exception in rule ${this.name}: ${s.message}
Stack trace:
${s.stack}`,start:0,end:t.length}}}_defaultLintFunction(e,n,t,a,i){return{message:this.message||"",start:a.index,end:a.index+a[0].length}}static makePattern(e){if(!e)return null;if(e instanceof RegExp)return e;if(e[0]==="/"){const n=e.lastIndexOf("/"),t=e.substring(1,n),a=e.substring(n+1);return new RegExp(t,a)}return new RegExp(e)}static FakePatternMatch(e,n,t){const a=[n];return a.index=t,a.input=e,a}};X.Severity={ERROR:1,WARNING:2,GUIDELINE:3,BULK_WARNING:4};let m=X;m.DEFAULT_SELECTOR=K.parse("text");const Ln=/\/\/([^\/]+)/;function Xn(r){if(!r)return"";const e=r.match(Ln);return e?e[1]:""}const Mn=m.makeRule({name:"absolute-url",severity:m.Severity.GUIDELINE,selector:"link, image",lint:function(r,e,n,t){const a=n[0].target,i=Xn(a);if(i==="khanacademy.org"||i.endsWith(".khanacademy.org"))return`Don't use absolute URLs:
When linking to KA content or images, omit the
https://www.khanacademy.org URL prefix.
Use a relative URL beginning with / instead.`}}),Yn=m.makeRule({name:"blockquoted-math",severity:m.Severity.WARNING,selector:"blockQuote math, blockQuote blockMath",message:`Blockquoted math:
math should not be indented.`}),Wn=m.makeRule({name:"blockquoted-widget",severity:m.Severity.WARNING,selector:"blockQuote widget",message:`Blockquoted widget:
widgets should not be indented.`}),Fn=m.makeRule({name:"double-spacing-after-terminal",severity:m.Severity.BULK_WARNING,selector:"paragraph",pattern:/[.!\?] {2}/i,message:`Use a single space after a sentence-ending period, or
any other kind of terminal punctuation.`});function Gn(r,e){return`Answer requires a button not found in the button sets: ${r} (in ${e})`}const Dn={"\\sqrt":"prealgebra","\\sin":"trig","\\cos":"trig","\\tan":"trig","\\log":"logarithms","\\ln":"logarithms"},_n=m.makeRule({name:"expression-widget",severity:m.Severity.WARNING,selector:"widget",lint:function(r,e,n,t,a){var l;if(r.currentNode().widgetType!=="expression")return;const i=r.currentNode().id;if(!i)return;const o=(l=a==null?void 0:a.widgets)==null?void 0:l[i];if(!o)return;const s=o.options.answerForms,u=o.options.buttonSets;for(const d of s)for(const[p,h]of Object.entries(Dn))if(d.value.includes(p)&&!u.includes(h))return Gn(p,h)}}),Un=m.makeRule({name:"extra-content-spacing",selector:"paragraph",pattern:/\s+$/,applies:function(r){return(r==null?void 0:r.contentType)==="article"},message:"No extra whitespace at the end of content blocks."}),Vn=m.makeRule({name:"heading-level-1",severity:m.Severity.WARNING,selector:"heading",lint:function(r,e,n,t){if(n[0].level===1)return`Don't use level-1 headings:
Begin headings with two or more # characters.`}}),zn=m.makeRule({name:"heading-level-skip",severity:m.Severity.WARNING,selector:"heading ~ heading",lint:function(r,e,n,t){const a=n[1],i=n[0];if(a.level>i.level+1)return`Skipped heading level:
this heading is level ${a.level} but
the previous heading was level ${i.level}`}}),Hn=m.makeRule({name:"heading-sentence-case",severity:m.Severity.GUIDELINE,selector:"heading",pattern:/^\W*[a-z]/,message:`First letter is lowercase:
the first letter of a heading should be capitalized.`}),Kn={and:!0,nor:!0,but:!0,the:!0,for:!0};function Qn(r){const e=r[0];return e===e.toUpperCase()}const Bn=m.makeRule({name:"heading-title-case",severity:m.Severity.GUIDELINE,selector:"heading",pattern:/[^\s:]\s+[A-Z]+[a-z]/,locale:"en",lint:function(r,e,n,t){let i=e.trim().split(/\s+/);if(i.shift(),i=i.filter(o=>o.length>2&&!Kn.hasOwnProperty(o)),i.length>=3&&i.every(o=>Qn(o)))return`Title-case heading:
...
Don't include math expressions in image captions.`}}),nr=m.makeRule({name:"link-click-here",severity:m.Severity.WARNING,selector:"link",pattern:/click here/i,message:`Inappropriate link text:
Do not use the words "click here" in links.`}),rr=m.makeRule({name:"long-paragraph",severity:m.Severity.GUIDELINE,selector:"paragraph",pattern:/^.{501,}/,lint:function(r,e,n,t){return`Paragraph too long:
This paragraph is ${e.length} characters long.
Shorten it to 500 characters or fewer.`}}),tr=m.makeRule({name:"math-adjacent",severity:m.Severity.WARNING,selector:"blockMath+blockMath",message:`Adjacent math blocks:
combine the blocks between \\begin{align} and \\end{align}`}),ar=m.makeRule({name:"math-align-extra-break",severity:m.Severity.WARNING,selector:"blockMath",pattern:/(\\{2,})\s*\\end{align}/,message:`Extra space at end of block:
Don't end an align block with backslashes`}),ir=m.makeRule({name:"math-align-linebreaks",severity:m.Severity.WARNING,selector:"blockMath",pattern:/\\begin{align}[\s\S]*\\\\[\s\S]+\\end{align}/,lint:function(r,e,n,t){let a=t[0];for(;a.length;){const i=a.indexOf("\\\\");if(i===-1)return;a=a.substring(i+2);const o=a.match(/^\s*\\\\\s*(?!\\\\)/);if(!o)return"Use four backslashes between lines of an align block";a=a.substring(o[0].length)}}}),sr=m.makeRule({name:"math-empty",severity:m.Severity.WARNING,selector:"math, blockMath",pattern:/^$/,message:"Empty math: don't use $$ in your markdown."}),or=m.makeRule({name:"math-font-size",severity:m.Severity.GUIDELINE,selector:"math, blockMath",pattern:/\\(tiny|Tiny|small|large|Large|LARGE|huge|Huge|scriptsize|normalsize)\s*{/,message:`Math font size:
Don't change the default font size with \\Large{} or similar commands`}),ur=m.makeRule({name:"math-frac",severity:m.Severity.GUIDELINE,selector:"math, blockMath",pattern:/\\frac[ {]/,message:"Use \\dfrac instead of \\frac in your math expressions."}),lr=m.makeRule({name:"math-nested",severity:m.Severity.ERROR,selector:"math, blockMath",pattern:/\\text{[^$}]*\$[^$}]*\$[^}]*}/,message:`Nested math:
Don't nest math expressions inside \\text{} blocks`}),dr=m.makeRule({name:"math-starts-with-space",severity:m.Severity.GUIDELINE,selector:"math, blockMath",pattern:/^\s*(~|\\qquad|\\quad|\\,|\\;|\\:|\\ |\\!|\\enspace|\\phantom)/,message:`Math starts with space:
math should not be indented. Do not begin math expressions with
LaTeX space commands like ~, \\;, \\quad, or \\phantom`}),mr=m.makeRule({name:"math-text-empty",severity:m.Severity.WARNING,selector:"math, blockMath",pattern:/\\text{\s*}/,message:"Empty \\text{} block in math expression"}),gr=m.makeRule({name:"math-without-dollars",severity:m.Severity.GUIDELINE,pattern:/\\\w+{[^}]*}|{|}/,message:`This looks like LaTeX:
did you mean to put it inside dollar signs?`}),pr=m.makeRule({name:"nested-lists",severity:m.Severity.WARNING,selector:"list list",message:`Nested lists:
nested lists are hard to read on mobile devices;
do not use additional indentation.`}),cr=m.makeRule({name:"static-widget-in-question-stem",severity:m.Severity.WARNING,selector:"widget",lint:(r,e,n,t,a)=>{var s;if((a==null?void 0:a.contentType)!=="exercise"||a.stack.includes("hint"))return;const i=r.currentNode().id;if(!i)return;const o=(s=a==null?void 0:a.widgets)==null?void 0:s[i];if(o&&o.static)return"Widget in question stem is static (non-interactive)."}}),yr=m.makeRule({name:"table-missing-cells",severity:m.Severity.WARNING,selector:"table",lint:function(r,e,n,t){const a=n[0],i=a.header.length,o=a.cells.map(s=>s.length);for(let s=0;s<o.length;s++)if(o[s]!==i)return`Table rows don't match header:
The table header has ${i} cells, but
Row ${s+1} has ${o[s]} cells.`}}),hr=m.makeRule({name:"unbalanced-code-delimiters",severity:m.Severity.ERROR,pattern:/[`~]+/,message:`Unbalanced code delimiters:
code blocks should begin and end with the same type and number of delimiters`}),br=m.makeRule({name:"unescaped-dollar",severity:m.Severity.ERROR,selector:"unescapedDollar",message:`Unescaped dollar sign:
...
`),t.prevCapture=null,a(Ke(o),t)};return i},C=function(r){var e=function(n,t,a){return t.inline?r.exec(n):null};return e.regex=r,e},E=function(r){var e=function(n,t){return t.inline?null:r.exec(n)};return e.regex=r,e},Ae=function(r){var e=function(n,t){return r.exec(n)};return e.regex=r,e},_r=typeof Symbol=="function"&&Symbol.for&&Symbol.for("react.element")||60103,k=function(r,e,n){var t={$$typeof:_r,type:r,key:e??void 0,ref:null,props:n,_owner:null};return t},T=function(r,e,n,t){n=n||{},t=typeof t<"u"?t:!0;var a="";for(var i in n){var o=n[i];Object.prototype.hasOwnProperty.call(n,i)&&o&&(a+=" "+z(i)+'="'+z(o)+'"')}var s="<"+r+a+">";return t?s+e+"</"+r+">":s},Ur={},B=function(r){if(r==null)return null;try{var e=new URL(r,"https://localhost").protocol;if(e.indexOf("javascript:")===0||e.indexOf("vbscript:")===0||e.indexOf("data:")===0)return null}catch{return null}return r},Vr=/[<>&"']/g,zr={"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;","'":"&#x27;","/":"&#x2F;","`":"&#96;"},z=function(r){return String(r).replace(Vr,function(e){return zr[e]})},Hr=/\\([^0-9A-Za-z\s])/g,xe=function(r){return r.replace(Hr,"$1")},ue=function(r,e,n){var t=n.inline||!1;n.inline=!0;var a=r(e,n);return n.inline=t,a},Kr=function(r,e,n){var t=n.inline||!1;n.inline=!1;var a=r(e+`

`,n);return n.inline=t,a},te=function(r,e,n){return{content:ue(e,r[1],n)}},fe=function(){return{}},le="(?:[*+-]|\\d+\\.)",$e="( *)("+le+") +",Le=new RegExp("^"+$e),Qr=new RegExp($e+"[^\\n]*(?:\\n(?!\\1"+le+` )[^\\n]*)*(
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{wa as D,Fe as J,G as P,Ce as R,b as S,ka as a,Lt as b,Ca as c,qa as d,Ta as e,Aa as f,xa as g,Ra as h,Pa as i,Xt as j,fa as k,ze as l,Et as m,Ut as n,xt as o,jr as p,Sa as q,va as r,Ia as s,U as t,Ot as u,dn as v,sn as w,Gt as x,S as y};
