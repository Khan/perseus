...
the linter and any warnings will be highlighted in the rendered output.`},{key:"legacyPerseusLint",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!1}},{key:"widgets",value:{name:"signature",raw:'PerseusRenderer["widgets"]',required:!0}},{key:"inline",value:{name:"boolean",required:!1},description:"Skip adding paragraph class"},{key:"strings",value:{name:"signature",type:"object",raw:`{
    ...
    point3X: string;
    point3Y: string;
}`,signature:{properties:[{key:"point1X",value:{name:"string",required:!0}},{key:"point1Y",value:{name:"string",required:!0}},{key:"point2X",value:{name:"string",required:!0}},{key:"point2Y",value:{name:"string",required:!0}},{key:"point3X",value:{name:"string",required:!0}},{key:"point3Y",value:{name:"string",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}},{key:"srPolygonGraph",value:{name:"string",required:!0}},{key:"srPolygonGraphCoordinatePlane",value:{name:"string",required:!0}},{key:"srPolygonGraphPointsNum",value:{name:"signature",type:"function",raw:"({num}: {num: number}) => string",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{num: number}",signature:{properties:[{key:"num",value:{name:"number",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}},{key:"srPolygonElementsNum",value:{name:"signature",type:"function",raw:"({num}: {num: number}) => string",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{num: number}",signature:{properties:[{key:"num",value:{name:"number",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}},{key:"srPolygonPointAngleApprox",value:{name:"signature",type:"function",raw:"({angle}: {angle: string}) => string",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{angle: string}",signature:{properties:[{key:"angle",value:{name:"string",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}},{key:"srPolygonPointAngle",value:{name:"signature",type:"function",raw:"({angle}: {angle: number}) => string",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{angle: number}",signature:{properties:[{key:"angle",value:{name:"number",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}},{key:"srPolygonSideLength",value:{name:"signature",type:"function",raw:`({
    pointNum,
    length,
}: {
    pointNum: number;
    ...
    pointNum: number;
    length: string;
}`,signature:{properties:[{key:"pointNum",value:{name:"number",required:!0}},{key:"length",value:{name:"string",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}}]},required:!0}}]}}],alias:"Props"}}],returns:null},{name:"_getAllWidgetsStartProps",docblock:null,modifiers:[],params:[{name:"allWidgetInfo",optional:!1,type:null},{name:"props",optional:!1,type:null}],returns:null},{name:"_getDefaultWidgetInfo",docblock:null,modifiers:[],params:[{name:"widgetId",optional:!1,type:{name:"string"}}],returns:null},{name:"_getWidgetInfo",docblock:null,modifiers:[],params:[{name:"widgetId",optional:!1,type:{name:"string"}}],returns:{type:{name:"PerseusWidgetTypes[PerseusWidgetTypes]",raw:"PerseusWidgetTypes[keyof PerseusWidgetTypes]"}}},{name:"renderWidget",docblock:null,modifiers:[],params:[{name:"impliedType",optional:!1,type:{name:"string"}},{name:"id",optional:!1,type:{name:"string"}},{name:"state",optional:!1,type:{name:"signature",type:"object",raw:`{
    isMobile?: boolean;
    inTable?: boolean;
    key?: number;
...
the linter and any warnings will be highlighted in the rendered output.`},{key:"legacyPerseusLint",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!1}},{key:"widgets",value:{name:"signature",raw:'PerseusRenderer["widgets"]',required:!0}},{key:"inline",value:{name:"boolean",required:!1},description:"Skip adding paragraph class"},{key:"strings",value:{name:"signature",type:"object",raw:`{
    ...
    pointNum: number;
    length: string;
}`,signature:{properties:[{key:"pointNum",value:{name:"number",required:!0}},{key:"length",value:{name:"string",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}}]},required:!0}}]}}],alias:"Props"}},{name:"state",optional:!1,type:{name:"signature",type:"object",raw:`{
...
the linter and any warnings will be highlighted in the rendered output.`},{key:"legacyPerseusLint",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!1}},{key:"widgets",value:{name:"signature",raw:'PerseusRenderer["widgets"]',required:!0}},{key:"inline",value:{name:"boolean",required:!1},description:"Skip adding paragraph class"},{key:"strings",value:{name:"signature",type:"object",raw:`{
    ...
    pointNum: number;
    length: string;
}`,signature:{properties:[{key:"pointNum",value:{name:"number",required:!0}},{key:"length",value:{name:"string",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}}]},required:!0}}]}}],alias:"Props"}}],returns:null},{name:"_setCurrentFocus",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"focus",docblock:null,modifiers:[],params:[],returns:null},{name:"getDOMNodeForPath",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"getInputPaths",docblock:null,modifiers:[],params:[],returns:null},{name:"focusPath",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"blurPath",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"blur",docblock:null,modifiers:[],params:[],returns:null},{name:"serialize",docblock:null,modifiers:[],params:[],returns:null},{name:"emptyWidgets",docblock:`Returns an array of widget ids that are empty (meaning widgets where the
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{ta as D,Fe as J,F as P,Re as R,h as S,sa as a,oa as b,ua as c,la as d,ma as e,ga as f,da as g,Ct as h,kt as i,aa as j,_ as k,Ue as l,I as m,Nr as p,ia as r,pa as s};
