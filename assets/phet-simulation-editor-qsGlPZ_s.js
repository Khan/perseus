var o=Object.defineProperty;var p=(t,r,e)=>r in t?o(t,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[r]=e;var i=(t,r,e)=>(p(t,typeof r!="symbol"?r+"":r,e),e);import{r as l,cd as u,ce as d,j as s,bx as a,s as c}from"./iframe-ZFgYqQyF.js";import"./item-version-DlZtwoiJ.js";import"./article-renderer-JA5_WgFZ.js";import"./server-item-renderer-jYLlYdnt.js";import"./hints-renderer-CpFykfe9.js";class n extends l.Component{constructor(){super(...arguments);i(this,"getSaveWarnings",()=>d(this.props.url,"en")===null?["Please enter a URL from the PhET domain."]:[])}serialize(){return{url:this.props.url,description:this.props.description}}render(){return s.jsxs("div",{children:[s.jsx(a,{label:"URL",value:this.props.url,onChange:e=>this.props.onChange({url:e}),style:{marginBottom:c.large_24}}),s.jsx(a,{label:"Description",value:this.props.description,onChange:e=>this.props.onChange({description:e})})]})}}i(n,"defaultProps",u.defaultWidgetOptions),i(n,"widgetName","phet-simulation");n.__docgenInfo={description:"",methods:[{name:"serialize",docblock:null,modifiers:[],params:[],returns:{type:{name:"signature",type:"object",raw:`{
