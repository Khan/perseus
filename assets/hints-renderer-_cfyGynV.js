...
the available choices.`}]}}],raw:`Readonly<{
     ...
     */
    onWidgetStartProps?: (widgets: PerseusWidgetsMap) => void;
}>`},description:""},className:{required:!1,tsType:{name:"string"},description:""},hint:{required:!0,tsType:{name:"any"},description:""},lastHint:{required:!1,tsType:{name:"boolean"},description:""},lastRendered:{required:!1,tsType:{name:"boolean"},description:""},pos:{required:!0,tsType:{name:"number"},description:""},totalHints:{required:!1,tsType:{name:"number"},description:""},findExternalWidgets:{required:!1,tsType:{name:"any"},description:""},linterContext:{required:!1,tsType:{name:"LinterContextProps"},description:"",defaultValue:{value:"PerseusLinter.linterContextDefault",computed:!0}}}};const w=class w extends x.Component{constructor(){super(...arguments),this.state={isFinalHelpPage:!1},this._hintsVisible=()=>this.props.hintsVisible==null||this.props.hintsVisible===-1?this.props.hints.length:this.props.hintsVisible,this._cacheImagesInHint=e=>{p.each(e.images,(t,r)=>{const n=new Image;n.src=S.getRealImageUrl(r)})},this._cacheHintImages=()=>{this._hintsVisible()>0?p.each(this.props.hints,this._cacheImagesInHint):this.props.hints.length>0&&this._cacheImagesInHint(this.props.hints[0])},this.getApiOptions=()=>({...$.defaults,...this.props.apiOptions,readOnly:!1}),this.getSerializedState=()=>p.times(this._hintsVisible(),e=>this.refs["hintRenderer"+e].getSerializedState()),this.restoreSerializedState=(e,t)=>{let r=1;const n=()=>{--r,t&&r===0&&t()};p.each(e,(a,y)=>{const m=this.refs["hintRenderer"+y];m&&(++r,m.restoreSerializedState(a,n))}),n()}}componentDidMount(){this._cacheHintImages()}UNSAFE_componentWillReceiveProps(e){e.hintsVisible-this.props.hintsVisible>1&&this.setState({isFinalHelpPage:!0})}componentDidUpdate(e,t){(!p.isEqual(e.hints,this.props.hints)||e.hintsVisible!==this.props.hintsVisible)&&this._cacheHintImages();const r=e.hintsVisible||0,n=this.props.hintsVisible||0;if(r<n&&n<=this.props.hints.length&&n>=0){const a=n-1;N.findDOMNode(this.refs["hintRenderer"+a]).focus()}}render(){const e=this.getApiOptions(),t=this._hintsVisible(),r=[],n=this.state.isFinalHelpPage;this.props.hints.slice(0,t).forEach((s,o)=>{const z=o===this.props.hints.length-1&&!/\*\*/.test(s.content),E=o===t-1,f=g(b,{lastHint:z,lastRendered:E,hint:s,pos:o,totalHints:this.props.hints.length,ref:"hintRenderer"+o,apiOptions:e,findExternalWidgets:this.props.findExternalWidgets,linterContext:A(this.props.linterContext,"hints["+o+"]")},"hintRenderer"+o);n?r.push(f):s.replace&&r.length>0?r[r.length-1]=f:r.push(f)});const{getAnotherHint:a}=e,y=a&&t>0&&t<this.props.hints.length,m=`(${t}/${this.props.hints.length})`,h=O(this.props.className,e.isMobile&&t>0&&i.css(l.mobileHintStylesHintsRenderer));return c("div",{className:h,children:[e.isMobile&&t>0&&g("div",{className:i.css(l.mobileHintStylesHintTitle,F.responsiveLabel),children:this.context.strings.hints}),r,y&&c("button",{rel:"button",className:i.css(l.linkButton,l.getAnotherHintButton,e.isMobile&&l.mobileHintStylesGetAnotherHintButton),onClick:s=>{s.preventDefault(),s.stopPropagation(),a&&a()},children:[g("span",{className:i.css(l.plusText,e.isMobile&&l.mobileHintStylesPlusText),children:"+"}),c("span",{className:i.css(l.getAnotherHintText),children:[this.context.strings.getAnotherHint," ",m]})]})]})}};w.contextType=W,w.defaultProps={linterContext:R};let q=w;const k=d+j,l=i.StyleSheet.create({rendererMargins:{marginTop:d},linkButton:{cursor:"pointer",border:"none",backgroundColor:"transparent",fontSize:"100%",fontFamily:"inherit",fontWeight:"bold",color:I,padding:0,position:"relative"},plusText:{fontSize:20,position:"absolute",top:-3,left:0},getAnotherHintText:{marginLeft:16},mobileHintStylesHintsRenderer:{marginTop:4*d,border:`solid ${_}`,borderWidth:"1px 0 0 0",position:"relative",":before":{content:'""',display:"table",clear:"both"},":after":{content:'""',display:"table",clear:"both"}},mobileHintStylesHintTitle:{fontFamily:"inherit",fontStyle:"normal",fontWeight:"bold",color:P,paddingTop:d,paddingBottom:1.5*d,[u.lgOrSmaller]:{paddingLeft:0},[u.smOrSmaller]:{paddingLeft:k}},getAnotherHintButton:{marginTop:1.5*d},mobileHintStylesGetAnotherHintButton:{[u.lgOrSmaller]:{paddingLeft:0},[u.smOrSmaller]:{paddingLeft:k}},mobileHintStylesPlusText:{[u.lgOrSmaller]:{left:0},[u.smOrSmaller]:{left:k}}});q.__docgenInfo={description:"",methods:[{name:"_hintsVisible",docblock:null,modifiers:[],params:[],returns:null},{name:"_cacheImagesInHint",docblock:null,modifiers:[],params:[{name:"hint",optional:!1,type:null}],returns:null},{name:"_cacheHintImages",docblock:null,modifiers:[],params:[],returns:null},{name:"getApiOptions",docblock:null,modifiers:[],params:[],returns:null},{name:"getSerializedState",docblock:null,modifiers:[],params:[],returns:null},{name:"restoreSerializedState",docblock:null,modifiers:[],params:[{name:"state",optional:!1,type:null},{name:"callback",optional:!1,type:null}],returns:null}],displayName:"HintsRenderer",props:{className:{required:!1,tsType:{name:"string"},description:""},hints:{required:!0,tsType:{name:"ReadonlyArray",elements:[{name:"intersection",raw:`PerseusRenderer & {
    /**
     ...
     */
    replace?: boolean;
}`,signature:{properties:[{key:"replace",value:{name:"boolean",required:!1},description:"When `true`, causes the previous hint to be replaced with this hint when\ndisplayed. When `false`, the previous hint remains visible when this one\nis displayed. This allows for hints that build upon each other."}]}}]}],raw:"ReadonlyArray<Hint>"},description:""},hintsVisible:{required:!1,tsType:{name:"number"},description:""},linterContext:{defaultValue:{value:"PerseusLinter.linterContextDefault",computed:!0},required:!1}}};export{q as H};
