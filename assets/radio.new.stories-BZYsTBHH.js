import{cT as s,j as B}from"./iframe-BILzkKRO.js";import{S as F}from"./server-item-renderer-with-debug-ui-Dam7palk.js";import{a as u,c as G,S as H,b as J,m as K,d as U,e as V}from"./radio.testdata-CcPAYXhw.js";import"./server-item-renderer-BupeiuMF.js";import"./hints-renderer-BGUZEZ3V.js";import"./main-CzrGIgb2.js";import"./test-keypad-context-wrapper-OBReupTI.js";import"./Popper-CLpPPWl3.js";const ie={title:"Perseus/Widgets/RadioNew",args:{static:!1,startAnswerless:!1,reviewMode:!1,showSolutions:"none",item:s({question:u})},argTypes:{showSolutions:{options:["none","all","selected"],control:{type:"select"}}},render:e=>B.jsx(F,{item:X(e),apiOptions:Y(),reviewMode:e.reviewMode,showSolutions:e.showSolutions,startAnswerless:e.startAnswerless}),parameters:{docs:{description:{component:`This is a story for the new radio widget.
...
}`,...(P=(C=n.parameters)==null?void 0:C.docs)==null?void 0:P.source}}};var T,O,M;i.parameters={...i.parameters,docs:{...(T=i.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: multiChoiceQuestionSimple
    })
  }
}`,...(M=(O=i.parameters)==null?void 0:O.docs)==null?void 0:M.source}}};var v,Q,x;a.parameters={...a.parameters,docs:{...(v=a.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
