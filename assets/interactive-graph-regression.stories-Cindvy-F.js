import{j as t}from"./jsx-runtime-BT65X5dW.js";import"./index-default-BcKQpA1a.js";import{g as Qs}from"./index-KqUcn8N7.js";import{R as Ts,s as Os}from"./renderer-u-vUuhtp.js";import{V as Ps}from"./index-DyG-XbLr.js";import{A as Is}from"./perseus-api-fTM3z0tF.js";import{m as Cs}from"./i18n-context-BlpvwUdd.js";import{i as e}from"./interactive-graph-question-builder-ICjdvGjt.js";import{j as Es}from"./interactive-graph.testdata-z73YBaXN.js";import"./index-C6mWTJJr.js";import"./_commonjsHelpers-BosuxZz1.js";import"./perseus-error-CSETqePQ.js";import"./util-DhiHX6ri.js";import"./jquery-CkHB0_Mt.js";import"./get-decimal-separator-B2cicA45.js";import"./index-CrGd2QqM.js";import"./index-BzwLglMS.js";import"./index-D7h-teXI.js";import"./index-B1Gws05u.js";import"./zoomable-tex-Dy-nElJT.js";import"./tex-BONImhZG.js";import"./dependencies-BsVPGK1s.js";import"./zoomable-C_CCSKDG.js";import"./svg-image-vK5xPiMV.js";import"./index-DD9muzfp.js";import"./no-important-DlFk8a1I.js";import"./index-C0xJ1VDw.js";import"./index-BfjDPqC2.js";import"./fixed-to-responsive-CTsII9Xx.js";import"./constants-BIpV3g0K.js";import"./client-CAS5PaPY.js";import"./inline-icon-AJRwMA4Z.js";import"./icon-paths-C3bPmxpL.js";import"./image-loader-CdkY-jNs.js";import"./lint-D0FI20JF.js";import"./stub-tag-editor-CZXxAW63.js";import"./text-list-editor-C2gddtxS.js";import"./index-Dd-cahjY.js";import"./tiny-invariant-CopsF_GD.js";const kr={title:"Perseus/Widgets/Interactive Graph Visual Regression Tests",component:Ns,parameters:{chromatic:{disableSnapshot:!1}},decorators:s=>t.jsx(Ps,{style:{marginInlineStart:32},children:t.jsx(s,{})})};function Ys(s){return t.jsx("div",{className:"framework-perseus perseus-mobile",children:t.jsx(s,{})})}const a={args:{question:e().withAxisLabels("\\text{Custom $x$ label}","\\text{Custom $y$ label}").build()}},i={args:{question:e().withGridStep(2.571,3.123).build()}},o={args:{question:e().withTickStep(1.5,1.5).build()}},n={args:{question:e().withMarkings("axes").build()}},c={args:{question:e().withMarkings("grid").build()}},u={args:{question:e().withMarkings("none").build()}},d={args:{question:e().withXRange(-2,2).withYRange(-2,2).build()}},m={args:{question:e().withXRange(-50,50).withYRange(-50,50).build()}},p={args:{question:e().withXRange(0,20).addLockedLine([1,1],[5,2]).build()}},l={args:{question:e().withXRange(-1,20).addLockedLine([1,1],[5,2]).build()}},g={args:{question:e().withXRange(-3,20).addLockedLine([1,1],[5,2]).build()}},h={args:{question:e().withXRange(1,20).build()}},f={args:{question:e().withXRange(6,20).build()}},w={args:{question:e().withXRange(-20,0).build()}},b={args:{question:e().withXRange(-20,-1).build()}},M={args:{question:e().withXRange(-20,-6).build()}},R={args:{question:e().withYRange(0,20).build()}},L={args:{question:e().withYRange(-1,20).build()}},q={args:{question:e().withYRange(1,20).build()}},W={args:{question:e().withYRange(-3,20).addLockedLine([-3,2],[5,16]).build()}},A={args:{question:e().withYRange(-20,0).build()}},x={args:{question:e().withYRange(-20,-1).build()}},S={args:{question:e().withXRange(0,10).withYRange(0,10).withAxisLabels("Video Game Hours per Week","Reaction Time (milliseconds)").withLabelLocation("alongEdge").build()}},k={args:{question:e().withXRange(-1,10).withYRange(-1,10).withAxisLabels("Video Game Hours per Week","Reaction Time (milliseconds)").withLabelLocation("alongEdge").build()}},G={args:{question:e().withXRange(0,.5).withYRange(0,.5).withTickStep(.1,.1).withGridStep(.1,.1).withAxisLabels("Video Game Hours per Week","Reaction Time (milliseconds)").withLabelLocation("alongEdge").build()}},v={args:{question:e().build()},decorators:[Ys]},B={args:{question:e().withSegments({numSegments:3}).build()}},X={args:{question:e().withCircle().withXRange(-10,10).withYRange(-5,5).build()},decorators:[Ys]},Y={args:{question:e().addLockedLine([-3,-3],[3,3]).withXRange(-5,5).withYRange(-10,10).build()}},Q={args:{question:e().addLockedPointAt(3,2).addLockedPointAt(-1,1).addLockedPointAt(0,-4).build()}},T={args:{question:e().addLockedLine([-1,1],[2,3]).build()}},O={args:{question:e().withAngle().withProtractor().build()}},P={args:{question:Es}},I={args:{question:(()=>{const s=e().build(),r=Qs({question:s});return Os(r).question})()}};function Ns(s){const{question:r}=s;return t.jsx(Ts,{strings:Cs,content:r.content,widgets:r.widgets,images:r.images,apiOptions:Is.defaults})}var C,E,N;a.parameters={...a.parameters,docs:{...(C=a.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    question: interactiveGraphQuestionBuilder().withAxisLabels("\\\\text{Custom $x$ label}", "\\\\text{Custom $y$ label}").build()
  }
}`,...(N=(E=a.parameters)==null?void 0:E.docs)==null?void 0:N.source}}};var j,F,V;i.parameters={...i.parameters,docs:{...(j=i.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
    question: interactiveGraphQuestionBuilder().withGridStep(2.571, 3.123).build()
  }
}`,...(V=(F=i.parameters)==null?void 0:F.docs)==null?void 0:V.source}}};var y,$,H;o.parameters={...o.parameters,docs:{...(y=o.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
...
}`,...(se=(ee=u.parameters)==null?void 0:ee.docs)==null?void 0:se.source}}};var re,te,ae;d.parameters={...d.parameters,docs:{...(re=d.parameters)==null?void 0:re.docs,source:{originalSource:`{
  args: {
    question: interactiveGraphQuestionBuilder().withXRange(-2, 2).withYRange(-2, 2).build()
  }
}`,...(ae=(te=d.parameters)==null?void 0:te.docs)==null?void 0:ae.source}}};var ie,oe,ne;m.parameters={...m.parameters,docs:{...(ie=m.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  args: {
...
}`,...(ss=(es=k.parameters)==null?void 0:es.docs)==null?void 0:ss.source}}};var rs,ts,as;G.parameters={...G.parameters,docs:{...(rs=G.parameters)==null?void 0:rs.docs,source:{originalSource:`{
  args: {
...
}`,...(as=(ts=G.parameters)==null?void 0:ts.docs)==null?void 0:as.source}}};var is,os,ns;v.parameters={...v.parameters,docs:{...(is=v.parameters)==null?void 0:is.docs,source:{originalSource:`{
  args: {
