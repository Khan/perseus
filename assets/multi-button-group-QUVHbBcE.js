import{j as l}from"./jsx-runtime-63Ea5SlK.js";import{l as d}from"./index-awljIyHI.js";import{r as i}from"./index-6oxdNXpR.js";const r=class r extends i.Component{constructor(){super(...arguments),this.buttonContainerRef=i.createRef(),this.toggleSelect=e=>{const t=(this.props.values||[]).slice(0),o=this.props.allowEmpty;t.indexOf(e)>=0&&(t.length>1||o)?t.splice(t.indexOf(e),1):t.indexOf(e)<0&&t.push(e),this.props.onChange(t)}}focus(){var e;return(e=this.buttonContainerRef.current)==null||e.focus(),!0}render(){const e=this.props.values||[],t=this.props.buttons.map((n,s)=>{const c=e.indexOf(n.value)>=0;return l.jsx("button",{title:n.title,type:"button",id:""+s,ref:"button"+s,className:d.css(u.buttonStyle,c&&u.selectedStyle),onClick:()=>this.toggleSelect(n.value),children:n.content||""+n.value},""+s)}),o={display:"inline-block"};return l.jsx("div",{style:o,ref:this.buttonContainerRef,children:t})}};r.defaultProps={values:[],allowEmpty:!0};let a=r;const u=d.StyleSheet.create({buttonStyle:{backgroundColor:"white",border:"1px solid #ccc",borderLeft:"0",cursor:"pointer",margin:"0",padding:"5px 10px",position:"relative",":first-child":{borderLeft:"1px solid #ccc",borderTopLeftRadius:"3px",borderBottomLeftRadius:"3px"},":last-child":{borderRight:"1px solid #ccc",borderTopRightRadius:"3px",borderBottomRightRadius:"3px"},":hover":{backgroundColor:"#ccc"},":focus":{zIndex:2}},selectedStyle:{backgroundColor:"#ddd"}});a.__docgenInfo={description:`MultiButtonGroup is an aesthetically pleasing group of buttons,
