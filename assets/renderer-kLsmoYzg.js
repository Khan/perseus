import{j as y}from"./jsx-runtime-63Ea5SlK.js";import{a as Ce}from"./version-akiLXZts.js";import{P as N,E as R}from"./perseus-error-l3K_anoI.js";import{g as dn}from"./_commonjsHelpers-4gQjN7DL.js";import{e as mn,i as gn}from"./invariant-bu5zBsRS.js";import{e as pn}from"./index-J2t_5nK1.js";import{c as we}from"./index-dnMhQZ-1.js";import{_ as g,d as yn,$ as cn}from"./jquery-yG1GhClm.js";import{r as j}from"./index-6oxdNXpR.js";import{F as ve}from"./index-9gkyvru-.js";import{c as ce}from"./asset-context-H6Iqp7Gi.js";import{P as hn}from"./i18n-context-fsWEgybQ.js";import{L as K,o as He,S as bn}from"./svg-image-FcZanvM1.js";import{T as Se}from"./tex-MX5FPdQh.js";import{Z as fn}from"./zoomable-_uYFBX1Q.js";import{Z as wn}from"./zoomable-tex-Jjwex-Ep.js";import{g as Y,D as vn}from"./dependencies-CP7Uh8Kq.js";import{A as kn,C as he}from"./perseus-api-1-ethIrW.js";import{L as qn}from"./lint-CRWxUAIQ.js";import{U as oe}from"./util-AYeX86gl.js";import{f as Tn,t as An,u as Rn,z as Pn}from"./constants-iPV6vHZm.js";class B{static parse(e){return new ge(e).parse()}match(e){throw new N("Selector subclasses must implement match()",R.NotAllowed)}toString(){return"Unknown selector class"}}class ge{constructor(e){e=e.trim().replace(/\s+/g," "),this.tokens=e.match(ge.TOKENS)||[],this.tokenIndex=0}nextToken(){return this.tokens[this.tokenIndex]||""}consume(){this.tokenIndex++}isIdentifier(){const e=this.tokens[this.tokenIndex][0];return e>="a"&&e<="z"||e>="A"&&e<="Z"}skipSpace(){for(;this.nextToken()===" ";)this.consume()}parse(){const e=this.parseTreeSelector();let n=this.nextToken();if(!n)return e;const t=[e];for(;n;){if(n===",")this.consume();else throw new be("Expected comma");t.push(this.parseTreeSelector()),n=this.nextToken()}return new Cn(t)}parseTreeSelector(){this.skipSpace();let e=this.parseNodeSelector();for(;;){const n=this.nextToken();if(!n||n===",")break;if(n===" ")this.consume(),e=new On(e,this.parseNodeSelector());else if(n===">")this.consume(),e=new En(e,this.parseNodeSelector());else if(n==="+")this.consume(),e=new Nn(e,this.parseNodeSelector());else if(n==="~")this.consume(),e=new Sn(e,this.parseNodeSelector());else throw new be("Unexpected token: "+n)}return e}parseNodeSelector(){this.skipSpace();const e=this.nextToken();if(e==="*")return this.consume(),new xn;if(this.isIdentifier())return this.consume(),new In(e);throw new be("Expected node type")}}ge.TOKENS=/([a-zA-Z][\w-]*)|(\d+)|[^\s]|(\s(?=[a-zA-Z\*]))/g;class be extends Error{constructor(e){super(e)}}class Cn extends B{constructor(e){super(),this.selectors=e}match(e){for(let n=0;n<this.selectors.length;n++){const a=this.selectors[n].match(e);if(a)return a}return null}toString(){let e="";for(let n=0;n<this.selectors.length;n++)e+=n>0?", ":"",e+=this.selectors[n].toString();return e}}class xn extends B{match(e){return[e.currentNode()]}toString(){return"*"}}class In extends B{constructor(e){super(),this.type=e}match(e){const n=e.currentNode();return n.type===this.type?[n]:null}toString(){return this.type}}class pe extends B{constructor(e,n){super(),this.left=e,this.right=n}}class On extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n)for(e=e.clone();e.hasParent();){e.goToParent();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" "+this.right.toString()}}class En extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n&&e.hasParent()){e=e.clone(),e.goToParent();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" > "+this.right.toString()}}class Nn extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n&&e.hasPreviousSibling()){e=e.clone(),e.goToPreviousSibling();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" + "+this.right.toString()}}class Sn extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n)for(e=e.clone();e.hasPreviousSibling();){e.goToPreviousSibling();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" ~ "+this.right.toString()}}const L=class L{constructor(e,n,t,a,i,o){if(!t&&!a)throw new N("Lint rules must have a selector or pattern",R.InvalidInput,{metadata:{name:e}});this.name=e||"unnamed rule",this.severity=n||L.Severity.BULK_WARNING,this.selector=t||L.DEFAULT_SELECTOR,this.pattern=a||null,typeof i=="function"?(this.lint=i,this.message=null):(this.lint=(...s)=>this._defaultLintFunction(...s),this.message=i),this.applies=o||function(){return!0}}static makeRule(e){return new L(e.name,e.severity,e.selector?B.parse(e.selector):null,L.makePattern(e.pattern),e.lint||e.message,e.applies)}check(e,n,t,a){const i=this.selector.match(n);if(!i)return null;let o;if(this.pattern?o=t.match(this.pattern):o=L.FakePatternMatch(t,t,0),!o)return null;try{const s=this.lint(n,t,i,o,a);return s?typeof s=="string"?{rule:this.name,severity:this.severity,message:s,start:0,end:t.length}:{rule:this.name,severity:this.severity,message:s.message,start:s.start,end:s.end}:null}catch(s){return{rule:"lint-rule-failure",message:`Exception in rule ${this.name}: ${s.message}
Stack trace:
${s.stack}`,start:0,end:t.length}}}_defaultLintFunction(e,n,t,a,i){return{message:this.message||"",start:a.index,end:a.index+a[0].length}}static makePattern(e){if(!e)return null;if(e instanceof RegExp)return e;if(e[0]==="/"){const n=e.lastIndexOf("/"),t=e.substring(1,n),a=e.substring(n+1);return new RegExp(t,a)}return new RegExp(e)}static FakePatternMatch(e,n,t){const a=[n];return a.index=t,a.input=e,a}};L.Severity={ERROR:1,WARNING:2,GUIDELINE:3,BULK_WARNING:4};let d=L;d.DEFAULT_SELECTOR=B.parse("text");const jn=/\/\/([^\/]+)/;function Wn(r){if(!r)return"";const e=r.match(jn);return e?e[1]:""}const Ln=d.makeRule({name:"absolute-url",severity:d.Severity.GUIDELINE,selector:"link, image",lint:function(r,e,n,t){const a=n[0].target,i=Wn(a);if(i==="khanacademy.org"||i.endsWith(".khanacademy.org"))return`Don't use absolute URLs:
...
the first letter of a heading should be capitalized.`}),Bn={and:!0,nor:!0,but:!0,the:!0,for:!0};function Xn(r){const e=r[0];return e===e.toUpperCase()}const $n=d.makeRule({name:"heading-title-case",severity:d.Severity.GUIDELINE,selector:"heading",pattern:/[^\s:]\s+[A-Z]+[a-z]/,locale:"en",lint:function(r,e,n,t){let i=e.trim().split(/\s+/);if(i.shift(),i=i.filter(o=>o.length>2&&!Bn.hasOwnProperty(o)),i.length>=3&&i.every(o=>Xn(o)))return`Title-case heading:
...
`);return A.map(function(c){return s(c,p,b,q)})},u=function(m){return function(p,b,q){q.inline=!0;var A=s(p[1],b,q,m),c=o(p[2],b,q,m),w=l(p[3],b,q,m);return q.inline=!1,{type:"table",header:A,align:c,cells:w}}};return{parseTable:u(!0),parseNpTable:u(!1),TABLE_REGEX:/^ *(\|.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/,NPTABLE_REGEX:/^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/}}(),ae="(?:\\[[^\\]]*\\]|[^\\[\\]]|\\](?=[^\\[]*\\]))*",Le=`\\s*<?((?:\\([^)]*\\)|[^\\s\\\\]|\\\\.)*?)>?(?:\\s+['"]([\\s\\S]*?)['"])?\\s*`,Yr=/mailto:/i,Me=function(r,e,n){var t=(r[2]||r[1]).replace(/\s+/g," ").toLowerCase();if(e._defs&&e._defs[t]){var a=e._defs[t];n.target=a.target,n.title=a.title}return e._refs=e._refs||{},e._refs[t]=e._refs[t]||[],e._refs[t].push(n),n},f=0,Z={Array:{react:function(r,e,n){for(var t=n.key,a=[],i=0,o=0;i<r.length;i++,o++){n.key=""+i;var s=r[i];if(s.type==="text")for(s={type:"text",content:s.content};i+1<r.length&&r[i+1].type==="text";i++)s.content+=r[i+1].content;a.push(e(s,n))}return n.key=t,a},html:function(r,e,n){for(var t="",a=0;a<r.length;a++){var i=r[a];if(i.type==="text")for(i={type:"text",content:i.content};a+1<r.length&&r[a+1].type==="text";a++)i.content+=r[a+1].content;t+=e(i,n)}return t}},heading:{order:f++,match:E(/^ *(#{1,6})([^\n]+?)#* *(?:\n *)+\n/),parse:function(r,e,n){return{level:r[1].length,content:le(e,r[2].trim(),n)}},react:function(r,e,n){return v("h"+r.level,n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("h"+r.level,e(r.content,n))}},nptable:{order:f++,match:E(te.NPTABLE_REGEX),parse:te.parseNpTable,react:null,html:null},lheading:{order:f++,match:E(/^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/),parse:function(r,e,n){return{type:"heading",level:r[2]==="="?1:2,content:le(e,r[1],n)}},react:null,html:null},hr:{order:f++,match:E(/^( *[-*_]){3,} *(?:\n *)+\n/),parse:fe,react:function(r,e,n){return v("hr",n.key,{"aria-hidden":!0})},html:function(r,e,n){return'<hr aria-hidden="true">'}},codeBlock:{order:f++,match:E(/^(?:    [^\n]+\n*)+(?:\n *)+\n/),parse:function(r,e,n){var t=r[0].replace(/^    /gm,"").replace(/\n+$/,"");return{lang:void 0,content:t}},react:function(r,e,n){var t=r.lang?"markdown-code-"+r.lang:void 0;return v("pre",n.key,{children:v("code",null,{className:t,children:r.content})})},html:function(r,e,n){var t=r.lang?"markdown-code-"+r.lang:void 0,a=T("code",H(r.content),{class:t});return T("pre",a)}},fence:{order:f++,match:E(/^ *(`{3,}|~{3,}) *(?:(\S+) *)?\n([\s\S]+?)\n?\1 *(?:\n *)+\n/),parse:function(r,e,n){return{type:"codeBlock",lang:r[2]||void 0,content:r[3]}},react:null,html:null},blockQuote:{order:f++,match:E(/^( *>[^\n]+(\n[^\n]+)*\n*)+\n{2,}/),parse:function(r,e,n){var t=r[0].replace(/^ *> ?/gm,"");return{content:e(t,n)}},react:function(r,e,n){return v("blockquote",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("blockquote",e(r.content,n))}},list:{order:f++,match:function(r,e){var n=e.prevCapture==null?"":e.prevCapture[0],t=$r.exec(n),a=e._list||!e.inline;return t&&a?(r=t[1]+r,Xr.exec(r)):null},parse:function(r,e,n){var t=r[2],a=t.length>1,i=a?+t:void 0,o=r[0].replace(Br,`
...
| {
    ...
    total: number;
    message?: string | null | undefined;
}`,signature:{properties:[{key:"type",value:{name:"literal",value:'"points"',required:!0}},{key:"earned",value:{name:"number",required:!0}},{key:"total",value:{name:"number",required:!0}},{key:"message",value:{name:"union",raw:"string | null | undefined",elements:[{name:"string"},{name:"null"},{name:"undefined"}],required:!1}}]}}]}},description:"Scores the content."},{name:"guessAndScore",docblock:"@deprecated use scorePerseusItem",modifiers:[],params:[],returns:null,description:null},{name:"examples",docblock:null,modifiers:[],params:[],returns:null},{name:"handletranslationLintErrors",docblock:null,modifiers:[],params:[{name:"lintErrors",optional:!1,type:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",alias:"ReadonlyArray"}}],returns:null}],displayName:"Renderer",props:{content:{defaultValue:{value:'""',computed:!1},required:!1},widgets:{defaultValue:{value:"{}",computed:!1},required:!1},images:{defaultValue:{value:"{}",computed:!1},required:!1},highlightedWidgets:{defaultValue:{value:"[]",computed:!1},required:!1},questionCompleted:{defaultValue:{value:"false",computed:!1},required:!1},showSolutions:{defaultValue:{value:'"none"',computed:!1},required:!1},onRender:{defaultValue:{value:"() => {}",computed:!1},required:!1},onInteractWithWidget:{defaultValue:{value:"function () {}",computed:!1},required:!1},findExternalWidgets:{defaultValue:{value:"() => []",computed:!1},required:!1},alwaysUpdate:{defaultValue:{value:"false",computed:!1},required:!1},reviewMode:{defaultValue:{value:"false",computed:!1},required:!1},serializedState:{defaultValue:{value:"null",computed:!1},required:!1},onSerializedStateUpdated:{defaultValue:{value:"() => {}",computed:!1},required:!1},linterContext:{defaultValue:{value:`{
    contentType: "",
    highlightLint: false,
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{ga as D,_e as J,D as P,Pe as R,h as S,ya as a,ka as b,ca as c,ha as d,ba as e,wa as f,xt as g,va as h,It as i,Rt as j,Ft as k,Be as l,Ta as m,z as n,fa as o,Or as p,At as q,pa as r,qa as s,un as t,Pt as u,O as v};
