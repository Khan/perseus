var j=Object.defineProperty;var A=(l,o,e)=>o in l?j(l,o,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[o]=e;var t=(l,o,e)=>(A(l,typeof o!="symbol"?o+"":o,e),e);import{r as C,bt as q,bu as w,_ as T,bv as L,bw as E,j as s,ai as h,V as v,H as x,n as m,bx as f,by as K,bz as P,s as p,y as S,z as b,bA as k,bB as N,bC as V,e as g}from"./iframe-DTktfcfm.js";import"./item-version-BvWhgKyI.js";import"./article-renderer-D4VzMFep.js";import"./server-item-renderer-CJUvzYwm.js";import"./hints-renderer-Dab54eyk.js";import{c as D}from"./components-B5t7-my3.js";const{ButtonGroup:I,InfoTip:c}=D,F=["basic","trig","prealgebra","logarithms","scientific","basic relations","advanced relations"];class y extends C.Component{constructor(e){super(e);t(this,"getSaveWarnings",()=>{const e=[];return this.props.answerForms.length===0?e.push("No answers specified"):(this.props.answerForms.some(a=>a.considered==="correct")||e.push("No correct answer specified"),T(this.props.answerForms).each((a,r)=>{if(this.props.value==="")e.push(`Answer ${r+1} is empty`);else{const u=L(a.value,{functions:this.props.functions});u.parsed?a.simplify&&!u.expr.isSimplified()&&e.push(`${a.value} isn't simplified, but is required" +
