import{j as e,n,r as f}from"./iframe-DnQciuiI.js";import{S}from"./select-image-ClTZUtiO.js";import"./item-version-BNtEaiNh.js";import"./article-renderer-CNsp64T0.js";import"./server-item-renderer-Dl6dULhI.js";import"./hints-renderer-C71IX-9-.js";import"./form-wrapped-text-field-YYQSgiX6.js";import"./global-colors-BJx09mFA.js";const N={title:"PerseusEditor/Widgets/Label Image/Select Image"},x=n.StyleSheet.create({wrapper:{width:338}}),y=r=>e.jsx("div",{className:n.css(x.wrapper),children:e.jsx(S,{...r})}),E=()=>{const[r,s]=f.useState("");return e.jsx("div",{className:n.css(x.wrapper),children:e.jsx(S,{onChange:I=>s(I),url:r})})},t=r=>{const s={url:"",onChange:()=>{}};return e.jsx(y,{...s})},a=r=>{const s={url:"https://ka-perseus-images.s3.amazonaws.com/2ee5fc32e35c5178373b39fd304b325b2994c913.png",onChange:()=>{}};return e.jsx(y,{...s})},o=r=>e.jsx(E,{});t.__docgenInfo={description:"",methods:[],displayName:"Empty"};a.__docgenInfo={description:"",methods:[],displayName:"Filled"};o.__docgenInfo={description:"",methods:[],displayName:"Interactive"};var c,p,m;t.parameters={...t.parameters,docs:{...(c=t.parameters)==null?void 0:c.docs,source:{originalSource:`(args: StoryArgs): React.ReactElement => {
  const props = {
    url: "",
    onChange: () => {}
  } as const;
