import{j as n}from"./jsx-runtime-63Ea5SlK.js";import"./article-renderer-m2DxR4DL.js";import{_ as b}from"./jquery-yG1GhClm.js";import"./util-AYeX86gl.js";import"./phet-simulation-_7qOO4_B.js";import"./version-akiLXZts.js";import"./dependencies-CP7Uh8Kq.js";import"./perseus-api-1-ethIrW.js";import{d as D,e as V,g as H,s as G}from"./perseus-item-wU4gIC8p.js";import"./hints-renderer-b_P2F9w3.js";import{g as ae,b as ie}from"./renderer-IhFUya5i.js";import"./base-radio-DUduhCT2.js";import"./button-group-G5CZaedn.js";import"./graph-4ZDD3NK_.js";import"./svg-image-FcZanvM1.js";import"./hud-ifw9Ofbw.js";import"./icon-7RFbyLiL.js";import"./index-BIPwuHvF.js";import"./inline-icon-6fh0Wu1y.js";import"./math-input-ILg8RrvB.js";import"./multi-button-group-QUVHbBcE.js";import"./number-input-ogh82yD8.js";import"./range-input-w5Z3sPK5.js";import"./text-input-5e4vF1bl.js";import"./text-list-editor-aj1SAzcA.js";import"./index-k-0mNqHS.js";import"./i18n-context-fsWEgybQ.js";import"./index-smZ6iCr_.js";import{r as q}from"./index-6oxdNXpR.js";import{T as se}from"./text-diff-i1QZlyL1.js";import{c as oe}from"./components-JJnZE9Qc.js";import{c as O}from"./index-dnMhQZ-1.js";import{P as s}from"./index-0C4KXdeC.js";import{T as le}from"./tags-diff-faY3xfru.js";const _="unchanged",Q="changed",X="added",Y="removed",ue=function(a,e,r){let t;return a===e?t=_:a===void 0?t=X:e===void 0?t=Y:t=Q,{after:JSON.stringify(e),before:JSON.stringify(a),children:[],key:r,status:t}},de=function(a,e,r){const t=b.isObject(a)?b(a).keys():[],i=b.isObject(e)?b(e).keys():[],l=b.union(t,i),o=b.map(l,function(y){return Z((a||{})[y],(e||{})[y],y)});let u;return a===void 0?u=X:e===void 0?u=Y:u=b.any(o,function(p){return p.status!==_})?Q:_,{after:"",before:"",children:o,key:r,status:u}},Z=function(a,e,r){return typeof a=="object"||typeof e=="object"?de(a,e,r):ue(a,e,r)},{SvgImage:K}=oe,ee=function(a){return(a-1)*20},x="before",z="after",ye="unchanged",U=class U extends q.Component{render(){const e=O(this.props.className,{"diff-row":!0,before:this.props.side===x,after:this.props.side===z});return n.jsx("div",{className:e,children:n.jsxs("div",{style:{paddingLeft:ee(this.props.depth)},children:[this.props.showKey&&this.props.propKey+": ",n.jsx("span",{className:"inner-value dark "+this.props.className,children:this.props.value})]})})}};U.propTypes={className:s.string.isRequired,depth:s.number.isRequired,propKey:s.string.isRequired,showKey:s.bool.isRequired,side:s.oneOf([x,z]).isRequired,value:s.string};let N=U;const E=class E extends q.Component{render(){const e=this;return n.jsx("div",{onClick:e.props.onClick,style:{clear:"both"},children:b.map([x,z],function(r){return n.jsx("div",{className:"diff-row collapsed "+r,children:n.jsx("div",{style:{paddingLeft:ee(e.props.depth)},children:n.jsx("span",{children:" [ show unmodified ] "})})},r)})})}};E.propTypes={depth:s.number,onClick:s.func.isRequired},E.defaultProps={depth:0};let $=E;const A=class A extends q.Component{constructor(){super(...arguments),this.state={expanded:this.props.expanded},this.expand=()=>{this.setState({expanded:!0})}}render(){const e=this.props.entry,r=e.status==="removed",t=e.status==="added",i=e.status==="changed",l=e.children.length>0,o=O({removed:r||i&&!l,dark:r,"blank-space":t}),u=O({added:t||i&&!l,dark:t,"blank-space":r});let y;this.state.expanded?y=e.children:y=b(e.children).select(function(g){return g.status!==ye});let p=y.length<e.children.length;e.children.length===y.length+1&&(y=e.children,p=!1);const v=this;return n.jsxs("div",{children:[e.key&&n.jsxs("div",{style:{clear:"both"},children:[n.jsx(N,{side:x,className:o,depth:this.props.depth,propKey:e.key,showKey:!t,value:e.before}),n.jsx(N,{side:z,className:u,depth:this.props.depth,propKey:e.key,showKey:!r,value:e.after})]}),b.map(y,function(g){return n.jsx(A,{depth:v.props.depth+1,entry:g,expanded:v.state.expanded},g.key)}),p&&n.jsx($,{depth:this.props.depth+1,onClick:this.expand})]})}};A.propTypes={depth:s.number,entry:s.shape({after:s.string,before:s.string,children:s.arrayOf(s.any),key:s.string}),expanded:s.bool},A.defaultProps={depth:0};let P=A;const S=class S extends q.Component{render(){const{before:e,after:r}=this.props,t=e.options&&e.options.backgroundImage?e.options.backgroundImage.url:"",i=r.options&&r.options.backgroundImage?r.options.backgroundImage.url:"";return n.jsxs("div",{children:[n.jsx("div",{className:"diff-row before",children:t&&n.jsx("div",{className:O({image:!0,"image-unchanged":t===i,"image-removed":t!==i}),children:n.jsx(K,{src:t,title:t})})}),n.jsx("div",{className:"diff-row after",children:i&&n.jsx("div",{className:O({image:!0,"image-unchanged":t===i,"image-added":t!==i}),children:n.jsx(K,{src:i,title:i})})})]})}};S.propTypes={after:s.shape({options:s.objectOf(s.any)}).isRequired,before:s.shape({options:s.objectOf(s.any)}).isRequired};let F=S;const L=class L extends q.Component{render(){const{after:e,before:r,title:t,type:i}=this.props,l=Z(r,e);return n.jsxs("div",{children:[n.jsx("div",{className:"diff-header",children:t}),n.jsx("div",{className:"diff-header",children:t}),n.jsxs("div",{className:"diff-body ui-helper-clearfix",children:[i==="image"&&n.jsx(F,{before:r,after:e}),n.jsx(P,{entry:l})]})]})}};L.propTypes={after:s.shape({options:s.objectOf(s.any)}),before:s.shape({options:s.objectOf(s.any)}),title:s.string.isRequired,type:s.string},L.defaultProps={after:{},before:{},type:""};let I=L;I.__docgenInfo={description:"",methods:[],displayName:"WidgetDiff",props:{after:{defaultValue:{value:"{}",computed:!1},description:"",type:{name:"shape",value:{options:{name:"objectOf",value:{name:"any"},required:!1}}},required:!1},before:{defaultValue:{value:"{}",computed:!1},description:"",type:{name:"shape",value:{options:{name:"objectOf",value:{name:"any"},required:!1}}},required:!1},type:{defaultValue:{value:'""',computed:!1},description:"",type:{name:"string"},required:!1},title:{description:"",type:{name:"string"},required:!0}}};const B=function(a,e){const{alignment:r,graded:t,options:i,type:l}=a||{},o={options:i};return e&&ae(l).length>1&&(o.alignment=r),l==="transformer"&&(o.graded=t),ie(l)&&(o.static=(a==null?void 0:a.static)??void 0),o},M=class M extends q.Component{render(){const{after:e,before:r,showAlignmentOptions:t,showSeparator:i,title:l}=this.props;let o,u;(r.content||e.content)&&(o=n.jsx(se,{before:r.content,after:e.content,title:l}));const y=Object.keys(r.widgets??{}).filter(v=>r.content.includes(v)),p=Object.keys(e.widgets??{}).filter(v=>e.content.includes(v));return(y.length||p.length)&&(u=b.union(y,p).map(g=>{var d,h,m,T;return n.jsx(I,{before:B((d=r.widgets)==null?void 0:d[g],t),after:B((h=e.widgets)==null?void 0:h[g],t),title:g,type:(((m=r.widgets)==null?void 0:m[g])??{}).type||(((T=e.widgets)==null?void 0:T[g])??{}).type},g)})),n.jsxs("div",{children:[o,u,i&&n.jsx("div",{className:"diff-separator"})]})}};M.defaultProps={after:{content:"",images:{},widgets:{}},before:{content:"",images:{},widgets:{}},showAlignmentOptions:!1,showSeparator:!1};let C=M;C.__docgenInfo={description:"",methods:[],displayName:"RendererDiff",props:{after:{required:!1,tsType:{name:"signature",type:"object",raw:`{
    content: string;
...
}`,signature:{properties:[{key:"content",value:{name:"string",required:!0}},{key:"widgets",value:{name:"union",raw:'PerseusRenderer["widgets"] | null | undefined',elements:[{name:"intersection",raw:'PerseusRenderer["widgets"]'},{name:"null"},{name:"undefined"}],required:!0}},{key:"images",value:{name:"union",raw:'PerseusRenderer["images"] | null | undefined',elements:[{name:"signature",raw:'PerseusRenderer["images"]'},{name:"null"},{name:"undefined"}],required:!0}}]}},description:"",defaultValue:{value:`{
    content: "",
    images: {},
    widgets: {},
    ...
    images: {},
    widgets: {},
}`,computed:!1}},showAlignmentOptions:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},showSeparator:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},title:{required:!0,tsType:{name:"string"},description:""}}};function J(a,e){let r=!0;for(let t=0;t<e.length;t++){if(t>=a.length)return!1;e[t]!==a[t]&&(r=!1)}return r}function W(a,e){if(a.length!==e.length)return!1;for(let r=0,t=a.length;r<t;r++)if(a[r]!==e[r])return!1;return!0}function me(a){const e=[];for(let r=0;r<a.length;r++)typeof a[r]=="number"?e.push((a[r]+1).toString()+":"):e.push(a[r]);return e.join(" ")}class R extends q.Component{static generateCompletePathsList(e,r,t,i,l){if(i.type==="content"||i.type==="hint"||i.type==="tags"){const o=e.length>0&&W(l,e[0][1]),u=r.length>0&&W(l,r[0][1]);o&&u?(t.push(l),e.splice(0,1),r.splice(0,1)):o?(t.push(l),e.splice(0,1)):u&&(t.push(l),r.splice(0,1))}else if(i.type==="array"){let o=0,u=l.concat(o);for(;e.length>0&&J(e[0][1],u)||r.length>0&&J(r[0][1],u);)R.generateCompletePathsList(e,r,t,i.elementShape,u),o++,u=l.concat(o)}else if(i.type==="object"){const o=Object.keys(i.shape);for(let u=0;u<o.length;u++){const y=l.concat([o[u]]);R.generateCompletePathsList(e,r,t,i.shape[o[u]],y)}}}render(){const{before:e,after:r,shape:t,tags:i}=this.props,l=[],o=[];D().setContentMapper((d,h,m)=>l.push([d,m])).setHintMapper((d,h,m)=>l.push([d,m])).setTagsMapper((d,h,m)=>l.push([d,m])).mapTree(V(e),t),D().setContentMapper((d,h,m)=>o.push([d,m])).setHintMapper((d,h,m)=>o.push([d,m])).setTagsMapper((d,h,m)=>o.push([d,m])).mapTree(V(r),t);const u=l.slice(),y=o.slice(),p=[];R.generateCompletePathsList(u,y,p,t,[]);const v=p.length,g=p.map((d,h)=>{const m=d[d.length-1]==="tags",T=me(d);let f=l.find(w=>W(w[1],d)),k=o.find(w=>W(w[1],d));if(m){f||(f=[[],d]),k||(k=[[],d]);const w=[];Array.isArray(f[0])&&f[0].forEach(c=>{typeof c=="string"&&w.push(i.idToName(c))});const j=[];Array.isArray(k[0])&&k[0].forEach(c=>{typeof c=="string"&&j.push(i.idToName(c))});const re=w.filter(c=>j.includes(c)),te=w.filter(c=>!j.includes(c)),ne=j.filter(c=>!w.includes(c));return n.jsx(le,{beforeOnly:te,afterOnly:ne,intersection:re,title:T,showSeparator:h<v-1},h)}return f||(f=[H(G.content),d]),k||(k=[H(G.content),d]),n.jsx(C,{before:f[0],after:k[0],title:T,showAlignmentOptions:!1,showSeparator:h<v-1},h)});return n.jsx("div",{className:"framework-perseus",children:g})}}R.__docgenInfo={description:"",methods:[{name:"generateCompletePathsList",docblock:`Traverses the given shape and adds paths that are present in
...
}`,signature:{properties:[{key:"idToName",value:{name:"signature",type:"function",raw:"(arg1: string) => string",signature:{arguments:[{type:{name:"string"},name:"arg1"}],return:{name:"string"}},required:!0}},{key:"nameToId",value:{name:"signature",type:"function",raw:"(arg1: string) => string",signature:{arguments:[{type:{name:"string"},name:"arg1"}],return:{name:"string"}},required:!0}},{key:"names",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!0}}]}},description:""}}};export{C as R,R as S,I as W};
