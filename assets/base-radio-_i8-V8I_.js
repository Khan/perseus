import{a as X,j as b}from"./jsx-runtime-5BUNAZ9W.js";import{l as v}from"./index-awljIyHI.js";import{c as z}from"./index-dnMhQZ-1.js";import{r as x}from"./index-4g5l5LRQ.js";import{R as U}from"./index-jmm5gWkb.js";import{_ as Z}from"./index-default-4_ZsnO94.js";import{u as ee}from"./i18n-context-3gTlIcWM.js";import{C as j}from"./perseus-api-7QXTiCE7.js";import{h as re,r as C,n as N,s as M}from"./constants-I_nlPaPx.js";import{m as E}from"./media-queries-MaBBbpNq.js";import{s as te}from"./shared-3pf9YZIg.js";import{U as ne}from"./util-hMu2nkBL.js";import{C as ae}from"./choice-qvE2MQTK.js";import{C as ie}from"./choice-none-above-VMjuq9kE.js";typeof HTMLElement<"u"&&!HTMLElement.prototype.scrollTo&&(HTMLElement.prototype.scrollTo=function(e,n){this.scrollLeft=e,this.scrollTop=n});const S=(e,n)=>{typeof e.scrollTo=="function"?e.scrollTo(0,n):"scrollTop"in e&&(e.scrollTop=n)},se=(e,n,i=0,t)=>{const o=e===window?window.pageYOffset:e.scrollTop,d=n,h=d-o,u=17,q=i/u;let p=0;const w=setInterval(function(){if(p<q){const W=p/q,T=(-Math.cos(Math.PI*W)+1)/2,f=o+h*T;S(e,f),p+=1}else S(e,d),clearInterval(w),t&&t()},u)},D=e=>e===document.body||e==null?window:e.scrollHeight>e.clientHeight?e:D(e.parentElement),oe=750,le=(e,n)=>{setTimeout(()=>{const i=D(e),t=e.getBoundingClientRect(),o=i===window?{top:0,bottom:window.innerHeight}:i.getBoundingClientRect();let d=0;const h=i===window?window.scrollY:i.scrollTop;if(t.bottom>o.bottom){let u=t.bottom-o.bottom;t.top+u<o.top&&(u=t.top-o.top),d=h+u}else if(t.top<o.top){const u=t.top-o.top;d=h+u}se(i,d,oe,n)},0)},{captureScratchpadTouchStart:ue}=ne;function de(e,n,i,t){return e?n?t.chooseNumAnswers({numCorrect:String(i)}):t.chooseAllAnswers:t.chooseOneAnswer}const H=function(e){const{apiOptions:n,reviewModeRubric:i,choices:t,editMode:o,multipleSelect:d,labelWrap:h,countChoices:u,numCorrect:q,isLastUsedWidget:p,registerFocusFunction:w}=e,{strings:W}=ee(),T=x.useRef(),f=x.useRef([]);x.useEffect(()=>{if(n.canScrollPage&&p&&i&&!T.current){const r=t.findIndex(a=>a.checked);if(r>=0){const a=f.current[r],l=U.findDOMNode(a.current);l&&le(l)}}T.current=i},[n,t,p,i]);function L(r,a){const{multipleSelect:c,choices:l,onChange:A}=e;let m;a.checked&&!c?m=l.map(g=>!1):m=l.map(g=>g.checked);const O=l.map(g=>g.crossedOut);m[r]=a.checked,O[r]=a.crossedOut,A({checked:m,crossedOut:O})}w==null||w(r=>{const a=f.current[r||0],l=U.findDOMNode(a.current);if(l)l.focus();else return!1;return!0});const R=!!i,I=n.isMobile,V=t[0].highlighted,G=t[t.length-1].highlighted,K=z("perseus-widget-radio",!o&&"perseus-rendered-radio",v.css(s.radio,s.responsiveRadioContainer,V&&I&&s.radioContainerFirstHighlighted,G&&I&&s.radioContainerLastHighlighted)),B=z("instructions",v.css(s.instructions,I&&s.instructionsMobile)),_=de(d,u,q,W),Y=v.css(s.responsiveFieldset),Q=X("fieldset",{className:`perseus-widget-radio-fieldset ${Y}`,children:[b("legend",{className:"perseus-sr-only",children:_}),b("div",{className:B,"aria-hidden":"true",children:_}),b("ul",{className:K,style:{listStyle:"none"},children:t.map((r,a)=>{let c=ae;const l=x.createRef();f.current[a]=l;const A={apiOptions:n,multipleSelect:d,checked:r.checked,crossedOut:r.crossedOut,previouslyAnswered:r.previouslyAnswered,reviewMode:R,correct:r.correct,rationale:r.rationale,content:r.content,disabled:n.readOnly||r.disabled,showCorrectness:R||!!r.showCorrectness,showRationale:r.hasRationale&&(R||r.showRationale),pos:a,onChange:y=>{o||L(a,y)}};r.isNoneOfTheAbove&&(c=ie,Z.extend(A,{showContent:r.revealNoneOfTheAbove}));const m=t[a+1],O=!!m&&m.highlighted,g=y=>v.css(te.aboveScratchpad,s.item,s.responsiveItem,y&&s.selectedItem,y&&r.highlighted&&s.aboveBackdrop,y&&r.highlighted&&n.isMobile&&s.aboveBackdropMobile,O&&n.isMobile&&s.nextHighlighted);g(!0);let P;R&&i&&(P=i.choices[a].correct?j.CORRECT:j.INCORRECT);const J=z(g(r.checked),j.RADIO.OPTION,r.checked&&j.RADIO.SELECTED,P);let $=null,F=null;return o&&(F=y=>{let k=y.target;for(;k&&k!==$;){if(k.getAttribute("data-is-radio-icon")){L(a,{checked:!r.checked,crossedOut:r.crossedOut});return}k=k.parentNode}}),b("li",{ref:y=>$=y,className:J,onClick:F,onTouchStart:h?ue:null,children:b(c,{...A,ref:l})},a)})})]});return b("div",{className:v.css(s.responsiveContainer),children:Q})};H.defaultProps={editMode:!1,multipleSelect:!1};const s=v.StyleSheet.create({instructions:{display:"block",color:re,fontSize:14,lineHeight:1.25,fontFamily:"inherit",fontStyle:"normal",fontWeight:"bold",marginBottom:16},instructionsMobile:{fontSize:18,[E.smOrSmaller]:{fontSize:16},[E.xl]:{fontSize:20}},radio:{padding:0},responsiveRadioContainer:{borderBottom:`1px solid ${C}`,borderTop:`1px solid ${C}`,width:"auto",[E.smOrSmaller]:{marginLeft:N,marginRight:N}},radioContainerFirstHighlighted:{borderTop:"1px solid rgba(0, 0, 0, 0)"},radioContainerLastHighlighted:{borderBottom:"1px solid rgba(0, 0, 0, 0)"},item:{marginLeft:20},responsiveItem:{marginLeft:0,padding:0,":not(:last-child)":{borderBottom:`1px solid ${C}`}},selectedItem:{background:"white"},aboveBackdrop:{position:"relative",zIndex:1062},aboveBackdropMobile:{boxShadow:"0 0 4px 0 rgba(0, 0, 0, 0.2),0 0 2px 0 rgba(0, 0, 0, 0.1)",":not(:last-child)":{borderBottom:"1px solid rgba(0, 0, 0, 0)"}},nextHighlighted:{":not(:last-child)":{borderBottom:"1px solid rgba(0, 0, 0, 0)"}},responsiveContainer:{overflow:"auto",marginLeft:N,paddingLeft:M},responsiveFieldset:{paddingRight:M,minWidth:"auto"}});H.__docgenInfo={description:"",methods:[],displayName:"BaseRadio",props:{apiOptions:{required:!0,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onInputError?: (
        widgetId: any,
        value: string,
...
}`,signature:{properties:[{key:"content",value:{name:"string",required:!0}},{key:"clue",value:{name:"string",required:!1}},{key:"correct",value:{name:"boolean",required:!1}},{key:"isNoneOfTheAbove",value:{name:"boolean",required:!1}},{key:"widgets",value:{name:"intersection",raw:"{\n    [key in `categorizer ${number}`]: CategorizerWidget;\n} & {\n    [key in `cs-program ${number}`]: CSProgramWidget;\n} & {\n    [key in `definition ${number}`]: DefinitionWidget;\n} & {\n    [key in `dropdown ${number}`]: DropdownWidget;\n} & {\n    [key in `example-widget ${number}`]: ExampleWidget;\n} & {\n    [key in `example-graphie-widget ${number}`]: ExampleGraphieWidget;\n} & {\n    [key in `explanation ${number}`]: ExplanationWidget;\n} & {\n    [key in `expression ${number}`]: ExpressionWidget;\n} & {\n    [key in `grapher ${number}`]: GrapherWidget;\n} & {\n    [key in `group ${number}`]: GroupWidget;\n} & {\n    [key in `graded-group ${number}`]: GradedGroupWidget;\n} & {\n    [key in `graded-group-set ${number}`]: GradedGroupSetWidget;\n} & {\n    [key in `iframe ${number}`]: IFrameWidget;\n} & {\n    [key in `image ${number}`]: ImageWidget;\n} & {\n    [key in `input-number ${number}`]: InputNumberWidget;\n} & {\n    [key in `interaction ${number}`]: InteractionWidget;\n} & {\n    [key in `interactive-graph ${number}`]: InteractiveGraphWidget;\n} & {\n    [key in `label-image ${number}`]: LabelImageWidget;\n} & {\n    [key in `matcher ${number}`]: MatcherWidget;\n} & {\n    [key in `matrix ${number}`]: MatrixWidget;\n} & {\n    [key in `measurer ${number}`]: MeasurerWidget;\n} & {\n    [key in `molecule-renderer ${number}`]: MoleculeRendererWidget;\n} & {\n    [key in `number-line ${number}`]: NumberLineWidget;\n} & {\n    [key in `numeric-input ${number}`]: NumericInputWidget;\n} & {\n    [key in `orderer ${number}`]: OrdererWidget;\n} & {\n    [key in `passage ${number}`]: PassageWidget;\n} & {\n    [key in `passage-ref ${number}`]: PassageRefWidget;\n} & {\n    [key in `passage-ref-target ${number}`]: PassageRefWidget;\n} & {\n    [key in `plotter ${number}`]: PlotterWidget;\n} & {\n    [key in `python-program ${number}`]: PythonProgramWidget;\n} & {\n    [key in `radio ${number}`]: RadioWidget;\n} & {\n    [key in `simple-markdown-tester ${number}`]: SimpleMarkdownTesterWidget;\n} & {\n    [key in `sorter ${number}`]: SorterWidget;\n} & {\n    [key in `table ${number}`]: TableWidget;\n} & {\n    [key in `unit-input ${number}`]: UnitInputWidget;\n} & {\n    [key in `video ${number}`]: VideoWidget;\n}",elements:[{name:"signature",type:"object",raw:"{\n    [key in `categorizer ${number}`]: CategorizerWidget;\n}",signature:{properties:[{key:{name:"literal",value:"`categorizer ${number}`",required:!0},value:{name:"signature",type:"object",raw:`{
    // The "type" of widget which will define what the Options field looks like
    type: Type;
    // Whether this widget is displayed with the values and is immutable.  For display only
    // NOTE: perseus_data.go says this is required even though it isn't necessary.
...
) => boolean`,signature:{arguments:[{type:{name:"union",raw:"number | null | undefined",elements:[{name:"number"},{name:"null"},{name:"undefined"}]},name:"choiceIndex"}],return:{name:"boolean"}}},name:"arg1"}],return:{name:"void"}}},description:""},isLastUsedWidget:{required:!1,tsType:{name:"boolean"},description:""}}};export{H as B};
