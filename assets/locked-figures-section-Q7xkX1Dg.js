import{j as n}from"./jsx-runtime-63Ea5SlK.js";import{B as R}from"./choice-Xr-SKHrB.js";import{V as h,u as S}from"./index-0DbkllkJ.js";import{S as E}from"./index-nqMmpXbO.js";import{s as c,c as j}from"./index-deFLJwr4.js";import{l as f}from"./index-awljIyHI.js";import{r as b}from"./index-6oxdNXpR.js";import{H as D}from"./heading-1izW0-GJ.js";import{a as G,b as M}from"./answer-choices-rmGUI42j.js";import{L as W}from"./locked-ellipse-settings-_lgRV_oG.js";import{L as z}from"./locked-function-settings-xUoV6whK.js";import{L as V}from"./locked-label-settings-zpYWRpMh.js";import{L as H}from"./locked-line-settings-OaNIPzTO.js";import{L as K}from"./locked-point-settings-skKig1Jr.js";import{L as X}from"./locked-polygon-settings-Dc7A-zFi.js";import{L as _}from"./locked-vector-settings-bZARKzSN.js";import{g as $}from"./util-MMQIn3DP.js";const q=a=>{const{id:y,onChange:i}=a,u=["point","line","vector","ellipse","polygon","function",...a.showLabelsFlag?["label"]:[]];return n.jsx(h,{style:k.container,children:n.jsx(G,{menuText:"Add locked figure",style:k.addElementSelect,children:u.map(s=>n.jsx(M,{label:s,onClick:()=>i(s)},`${y}-${s}`))})})},k=f.StyleSheet.create({container:{marginTop:c.xSmall_8},addElementSelect:{backgroundColor:j.fadedBlue8,borderRadius:c.xxxSmall_4}});q.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSelect",props:{showLabelsFlag:{required:!1,tsType:{name:"boolean"},description:""},id:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: LockedFigureType) => void",signature:{arguments:[{type:{name:'union["type"]',raw:'LockedFigure["type"]'},name:"value"}],return:{name:"void"}}},description:""}}};const C=a=>{switch(a.type){case"point":return n.jsx(K,{...a});case"line":return n.jsx(H,{...a});case"vector":return n.jsx(_,{...a});case"ellipse":return n.jsx(W,{...a});case"polygon":return n.jsx(X,{...a});case"function":return n.jsx(z,{...a});case"label":if(a.showLabelsFlag)return n.jsx(V,{...a});break}return null};C.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSettings",props:{flags:{required:!1,tsType:{name:'Readonly["flags"]',raw:'APIOptions["flags"]'},description:""},showLabelsFlag:{required:!1,tsType:{name:"boolean"},description:""},onMove:{required:!0,tsType:{name:"signature",type:"function",raw:"(movement: LockedFigureSettingsMovementType) => void",signature:{arguments:[{type:{name:"union",raw:`| "back"
| "backward"
| "forward"
| "front"`,elements:[{name:"literal",value:'"back"'},{name:"literal",value:'"backward"'},{name:"literal",value:'"forward"'},{name:"literal",value:'"front"'}]},name:"movement"}],return:{name:"void"}}},description:"Called when a movement button (top, up, down, bottom) is pressed."},onRemove:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Called when the delete button is pressed."},expanded:{required:!1,tsType:{name:"boolean"},description:"Whether this accordion is expanded."},onToggle:{required:!1,tsType:{name:"signature",type:"function",raw:"(expanded: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"expanded"}],return:{name:"void"}}},description:"Called when the accordion is expanded or collapsed."}}};const T=a=>{const y=Array((a.figures??[]).length).fill(!1),[i,u]=b.useState(y),[s,A]=b.useState(!0),g=S().get("locked-figures-section"),{figures:t,onChange:m}=a;function x(e){const o={lockedFigures:[...t||[],$(e)]};m(o),u([...i,!0])}function L(e,r){if(e===0&&(r==="back"||r==="backward")||t&&e===t.length-1&&(r==="front"||r==="forward"))return;const l=[...t||[]],d=[...i],[p]=l.splice(e,1);switch(d.splice(e,1),r){case"back":l.unshift(p),d.unshift(!0);break;case"backward":l.splice(e-1,0,p),d.splice(e-1,0,!0);break;case"forward":l.splice(e+1,0,p),d.splice(e+1,0,!0);break;case"front":l.push(p),d.push(!0);break}m({lockedFigures:l}),u(d)}function P(e){if(window.confirm("Are you sure you want to delete this figure?")){const r=t||[];m({lockedFigures:[...r.slice(0,e),...r.slice(e+1)]});const o=[...i];o.splice(e,1),u(o)}}function N(e,r){const o=t||[],l={lockedFigures:[...o.slice(0,e),{...o[e],...r},...o.slice(e+1)]};m(l)}function F(e){u(Array(t==null?void 0:t.length).fill(e))}const w=i.every(e=>!e),I=w?"Expand all":"Collapse all",O=!!(t!=null&&t.length);return n.jsxs(n.Fragment,{children:[n.jsx(D,{title:"Locked Figures",isOpen:s,onToggle:()=>A(!s),isCollapsible:!0}),s&&n.jsxs(h,{children:[t==null?void 0:t.map((e,r)=>n.jsx(C,{flags:a.flags,showLabelsFlag:a.showLabelsFlag,expanded:i[r],onToggle:o=>{const l=[...i];l[r]=o,u(l)},...e,onChangeProps:o=>N(r,o),onMove:o=>L(r,o),onRemove:()=>P(r)},`${g}-locked-${e}-${r}`)),n.jsxs(h,{style:v.buttonContainer,children:[n.jsx(q,{showLabelsFlag:a.showLabelsFlag,id:`${g}-select`,onChange:x}),n.jsx(E,{size:c.small_12}),O&&n.jsx(R,{kind:"secondary",onClick:()=>F(w),style:v.button,children:I})]})]})]})},v=f.StyleSheet.create({buttonContainer:{flexDirection:"row",alignItems:"center"},button:{marginTop:c.xSmall_8,flexGrow:1}}),me=T;T.__docgenInfo={description:"",methods:[],displayName:"LockedFiguresSection",props:{flags:{required:!1,tsType:{name:'Readonly["flags"]',raw:'APIOptions["flags"]'},description:""},showLabelsFlag:{required:!1,tsType:{name:"boolean"},description:""},figures:{required:!1,tsType:{name:"Array",elements:[{name:"union",raw:`| LockedPointType
| LockedLineType
| LockedVectorType
| LockedEllipseType
| LockedPolygonType
