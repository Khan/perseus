var o=Object.defineProperty;var p=(t,e,r)=>e in t?o(t,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[e]=r;var i=(t,e,r)=>p(t,typeof e!="symbol"?e+"":e,r);import{r as l,ac as u,ad as d,j as s,ae as n,s as m}from"./iframe-DqR7m31b.js";import"./item-version-CyWSz8UH.js";import"./article-renderer-orqg5Kkn.js";import"./server-item-renderer-CEP2UnIb.js";import"./hints-renderer-Byr7gtNZ.js";class a extends l.Component{constructor(){super(...arguments);i(this,"getSaveWarnings",()=>d(this.props.url,"en")===null?["Please enter a URL from the PhET domain."]:[])}serialize(){return{url:this.props.url,description:this.props.description}}render(){return s.jsxs("div",{children:[s.jsx(n,{label:"URL",value:this.props.url,onChange:r=>this.props.onChange({url:r}),style:{marginBottom:m.large_24}}),s.jsx(n,{label:"Description",value:this.props.description,onChange:r=>this.props.onChange({description:r})})]})}}i(a,"defaultProps",u.defaultWidgetOptions),i(a,"widgetName","phet-simulation");a.__docgenInfo={description:`An editor for adding a PhET simulation widget that allows users to interact
