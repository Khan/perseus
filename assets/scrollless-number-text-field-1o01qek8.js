import{j as d}from"./jsx-runtime-BT65X5dW.js";import{T as f}from"./index-6t7BHVg9.js";import{r as s}from"./index-C6mWTJJr.js";const v=o=>{const{value:i,onChange:u,...l}=o,[c,a]=s.useState(!1),[h,r]=s.useState(""),n=s.useRef(null);return s.useEffect(()=>{const e=n.current,t=m=>{m.stopPropagation()};return e==null||e.addEventListener("wheel",t),()=>{e==null||e.removeEventListener("wheel",t)}},[n]),d.jsx(f,{...l,type:"number",value:c?h:i,onChange:e=>{r(e),u(e)},onFocus:e=>{var t;r(i),a(!0),(t=o.onFocus)==null||t.call(o,e)},onBlur:e=>{var t;a(!1),(t=o.onBlur)==null||t.call(o,e)},ref:n})};v.__docgenInfo={description:`This is a custom text field of type="number" for use in Perseus Editors.
