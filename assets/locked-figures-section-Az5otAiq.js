import{j as n}from"./jsx-runtime-63Ea5SlK.js";import{B as R}from"./choice-Xr-SKHrB.js";import{V as h,u as S}from"./index-0DbkllkJ.js";import{S as E}from"./index-nqMmpXbO.js";import{s as c,c as j}from"./index-deFLJwr4.js";import{l as f}from"./index-awljIyHI.js";import{r as w}from"./index-6oxdNXpR.js";import{H as D}from"./heading-1izW0-GJ.js";import{a as G,b as M}from"./answer-choices-WYuH2_fO.js";import{L as V}from"./locked-ellipse-settings-Tpe9klzt.js";import{L as W}from"./locked-function-settings-N9PbuM5C.js";import{L as z}from"./locked-label-settings-h2_pJaR5.js";import{L as H}from"./locked-line-settings-ANSQSHEo.js";import{L as K}from"./locked-point-settings-KuV5bdGd.js";import{L as X}from"./locked-polygon-settings-16CZAafW.js";import{L as _}from"./locked-vector-settings-Eo8dfcpj.js";import{g as $}from"./util-jOuE8CnU.js";const q=a=>{const{id:y,onChange:i}=a,s=["point","line","vector","ellipse","polygon","function",...a.showLabelsFlag?["label"]:[]];return n.jsx(h,{style:v.container,children:n.jsx(G,{menuText:"Add locked figure",style:v.addElementSelect,children:s.map(u=>n.jsx(M,{label:u,onClick:()=>i(u)},`${y}-${u}`))})})},v=f.StyleSheet.create({container:{marginTop:c.xSmall_8},addElementSelect:{backgroundColor:j.fadedBlue8,borderRadius:c.xxxSmall_4}});q.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSelect",props:{showLabelsFlag:{required:!1,tsType:{name:"boolean"},description:""},id:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: LockedFigureType) => void",signature:{arguments:[{type:{name:'union["type"]',raw:'LockedFigure["type"]'},name:"value"}],return:{name:"void"}}},description:""}}};const C=a=>{switch(a.type){case"point":return n.jsx(K,{...a});case"line":return n.jsx(H,{...a});case"vector":return n.jsx(_,{...a});case"ellipse":return n.jsx(V,{...a});case"polygon":return n.jsx(X,{...a});case"function":return n.jsx(W,{...a});case"label":if(a.showLabelsFlag)return n.jsx(z,{...a});break}return null};C.__docgenInfo={description:"",methods:[],displayName:"LockedFigureSettings",props:{flags:{required:!1,tsType:{name:'Readonly["flags"]',raw:'APIOptions["flags"]'},description:""},showLabelsFlag:{required:!1,tsType:{name:"boolean"},description:""},onMove:{required:!0,tsType:{name:"signature",type:"function",raw:"(movement: LockedFigureSettingsMovementType) => void",signature:{arguments:[{type:{name:"union",raw:`| "back"
| "backward"
| "forward"
| "front"`,elements:[{name:"literal",value:'"back"'},{name:"literal",value:'"backward"'},{name:"literal",value:'"forward"'},{name:"literal",value:'"front"'}]},name:"movement"}],return:{name:"void"}}},description:"Called when a movement button (top, up, down, bottom) is pressed."},onRemove:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"Called when the delete button is pressed."},expanded:{required:!1,tsType:{name:"boolean"},description:"Whether this accordion is expanded."},onToggle:{required:!1,tsType:{name:"signature",type:"function",raw:"(expanded: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"expanded"}],return:{name:"void"}}},description:"Called when the accordion is expanded or collapsed."}}};const T=a=>{const y=Array((a.figures??[]).length).fill(!1),[i,s]=w.useState(y),[u,A]=w.useState(!0),g=S().get("locked-figures-section"),{figures:t,onChange:m}=a;function L(e){const o={lockedFigures:[...t||[],$(e)]};m(o),s([...i,!0])}function P(e,r){if(e===0&&(r==="back"||r==="backward")||t&&e===t.length-1&&(r==="front"||r==="forward"))return;const l=[...t||[]],d=[...i],[p]=l.splice(e,1);switch(d.splice(e,1),r){case"back":l.unshift(p),d.unshift(!0);break;case"backward":l.splice(e-1,0,p),d.splice(e-1,0,!0);break;case"forward":l.splice(e+1,0,p),d.splice(e+1,0,!0);break;case"front":l.push(p),d.push(!0);break}m({lockedFigures:l}),s(d)}function N(e){if(window.confirm("Are you sure you want to delete this figure?")){const r=t||[];m({lockedFigures:[...r.slice(0,e),...r.slice(e+1)]});const o=[...i];o.splice(e,1),s(o)}}function x(e,r){const o=t||[],l={lockedFigures:[...o.slice(0,e),{...o[e],...r},...o.slice(e+1)]};m(l)}function F(e){s(Array(t==null?void 0:t.length).fill(e))}const b=i.every(e=>!e),I=b?"Expand all":"Collapse all",O=!!(t!=null&&t.length);return n.jsxs(n.Fragment,{children:[n.jsx(D,{title:"Locked Figures",isOpen:u,onToggle:()=>A(!u),isCollapsible:!0}),u&&n.jsxs(h,{children:[t==null?void 0:t.map((e,r)=>n.jsx(C,{flags:a.flags,showLabelsFlag:a.showLabelsFlag,expanded:i[r],onToggle:o=>{const l=[...i];l[r]=o,s(l)},...e,onChangeProps:o=>x(r,o),onMove:o=>P(r,o),onRemove:()=>N(r)},`${g}-locked-${e}-${r}`)),n.jsxs(h,{style:k.buttonContainer,children:[n.jsx(q,{showLabelsFlag:a.showLabelsFlag,id:`${g}-select`,onChange:L}),n.jsx(E,{size:c.small_12}),O&&n.jsx(R,{kind:"secondary",onClick:()=>F(b),style:k.button,children:I})]})]})]})},k=f.StyleSheet.create({buttonContainer:{flexDirection:"row",alignItems:"center"},button:{marginTop:c.xSmall_8,flexGrow:1}}),me=T;T.__docgenInfo={description:"",methods:[],displayName:"LockedFiguresSection",props:{flags:{required:!1,tsType:{name:'Readonly["flags"]',raw:'APIOptions["flags"]'},description:""},showLabelsFlag:{required:!1,tsType:{name:"boolean"},description:""},figures:{required:!1,tsType:{name:"Array",elements:[{name:"union",raw:`| LockedPointType
| LockedLineType
| LockedVectorType
| LockedEllipseType
| LockedPolygonType
