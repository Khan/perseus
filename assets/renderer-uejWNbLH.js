...
`).replace(Wr,"").replace(Yr,"    ")},He=function(r,e){var n=r||{};if(e!=null)for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&(n[t]=e[t]);return n},Ke=function(r,e){var n=Object.keys(r).filter(function(o){var s=r[o];if(s==null||s.match==null)return!1;var u=s.order;return(typeof u!="number"||!isFinite(u))&&typeof console<"u"&&console.warn("simple-markdown: Invalid order for rule `"+o+"`: "+String(u)),!0});n.sort(function(o,s){var u=r[o],l=r[s],m=u.order,y=l.order;if(m!==y)return m-y;var b=u.quality?0:1,v=l.quality?0:1;return b!==v?b-v:o<s?-1:o>s?1:0});var t,a=function(o,s){var u=[];for(s=s||t,t=s;o;){var l=null,m=null,y=null,b=NaN,v=0,q=n[0],c=r[q];do{var f=c.order,A=s.prevCapture==null?"":s.prevCapture[0],C=c.match(o,s,A);if(C){var Y=c.quality?c.quality(C,s,A):0;Y<=b||(l=q,m=c,y=C,b=Y)}v++,q=n[v],c=r[q]}while(c&&(!y||c.order===f&&c.quality));if(m==null||y==null)throw new Error("Could not find a matching rule for the below content. The rule with highest `order` should always match content provided to it. Check the definition of `match` for '"+n[n.length-1]+`'. It seems to not match the following source:
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{na as D,Ge as J,G as P,Re as R,h as S,aa as a,ia as b,sa as c,oa as d,la as e,da as f,ua as g,Rt as h,vt as i,ra as j,_ as k,Ue as l,S as m,Ir as p,ta as r,ma as s};
