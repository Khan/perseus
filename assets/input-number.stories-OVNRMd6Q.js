import{aB as p,j as l}from"./iframe-Drd1SmRq.js";import{S as i}from"./server-item-renderer-with-debug-ui-BWwKiLHX.js";import"./server-item-renderer-DSCwYT3W.js";import"./hints-renderer-nULHa8p5.js";import"./main-F-7RzE_d.js";import"./test-keypad-context-wrapper-iC1DAP1t.js";import"./Popper-Ci4RRPxU.js";function S(e,n){const u=`${e} 1`,m={type:e,options:n},c={};c[u]=m;const W={content:`[[☃ ${u}]]`,images:{},widgets:c};return p({question:W})}const z={content:`Denis baked a peach pie and cut it into $3$ equal-sized pieces.  Denis's dad eats $1$ section of the pie.  
...
}`,...(R=(I=o.parameters)==null?void 0:I.docs)==null?void 0:R.source}}};const B=["Rational","PiSimplify","Percent","Answerful","Answerless"];export{s as Answerful,o as Answerless,a as Percent,r as PiSimplify,t as Rational,B as __namedExportsOrder,K as default};
