import{j as n}from"./jsx-runtime-BT65X5dW.js";import{r as O}from"./index-C6mWTJJr.js";import{t as U}from"./util-Cnd0Ukpp.js";import"./index-default-BcKQpA1a.js";import"./index-DktHmiAd.js";import"./jquery-CkHB0_Mt.js";import{B as J}from"./phet-simulation-7JtZXm76.js";import{V as w}from"./index-DyG-XbLr.js";import{S as Y,O as C}from"./answer-choices-CAW9m8Dd.js";import{S as c}from"./index-BWwc-H8c.js";import{s as m,c as T}from"./index-BfjDPqC2.js";import{a as S,L as K}from"./index-gdjMQqRz.js";import{p as W}from"./plus-circle-DsgEZe2H.js";import{n as Z}from"./no-important-DlFk8a1I.js";import{v as y}from"./index-Dd-cahjY.js";import{P as G}from"./trash-bold-C47ReFev.js";import{C as H}from"./color-select-B2sGT6P0.js";import{L as Q}from"./line-stroke-select-UZ8W2z-c.js";import{L as ee}from"./line-swatch-BKwP-n_p.js";import{L as ne}from"./locked-figure-aria-qM5EtFBb.js";import{L as re,a as ae}from"./locked-label-settings-DcBJgKu_.js";import{L as A}from"./locked-point-settings-DRtZNZ0K.js";import{g as le,j as P,a as L,b as te}from"./util-lpYRLJrB.js";const j="The line cannot have length 0.",oe=k=>{const{kind:h,points:s,color:g,lineStyle:q="solid",showPoint1:N,showPoint2:V,labels:t,ariaLabel:X,onChangeProps:l,onMove:_,onRemove:I}=k,[o,i]=s,F=h.charAt(0).toUpperCase()+h.slice(1),M=`${F} (${o.coord[0]},
        ${o.coord[1]}), (${i.coord[0]}, ${i.coord[1]})`,f=U(o.coord,i.coord);async function R(){const e=await P(t),a=await P(o.labels),r=await P(i.labels),d=await L(`$${o.coord[0]}$`),b=await L(`$${o.coord[1]}$`),v=await L(`$${i.coord[0]}$`),x=await L(`$${i.coord[1]}$`);let p=`${F}${e} from point${a} at ${d} comma ${b} to point${r} at ${v} comma ${x}`;const $=te(g,q);return p+=$,p}function z(e,a){const r=[...s];r[a]={...s[a],...e};const d=y.midpoint(s[0].coord,s[1].coord),b=y.midpoint(r[0].coord,r[1].coord),v=[b[0]-d[0],b[1]-d[1]],x=t.map((p,$)=>({...p,coord:[p.coord[0]+v[0],p.coord[1]+v[1]]}));l({points:r,labels:x})}function B(e){const a=t.map(r=>({...r,color:e}));l({color:e,points:[{...o,color:e,labels:o.labels.map(r=>({...r,color:e}))},{...i,color:e,labels:i.labels.map(r=>({...r,color:e}))}],labels:a})}function E(e,a){const r=[...t];r[a]={...t[a],...e},l({labels:r})}function D(e){const a=t.filter((r,d)=>d!==e);l({labels:a})}return n.jsxs(G,{expanded:k.expanded,onToggle:k.onToggle,header:n.jsxs(w,{style:u.row,children:[n.jsx(K,{children:M}),n.jsx(c,{size:m.xSmall_8}),n.jsx(ee,{color:g,lineStyle:q})]}),children:[n.jsxs(S,{tag:"label",style:[u.row,u.spaceUnder],children:["kind",n.jsx(c,{size:m.xxxSmall_4}),n.jsxs(Y,{selectedValue:h,onChange:e=>l({kind:e}),placeholder:"",children:[n.jsx(C,{value:"line",label:"line"}),n.jsx(C,{value:"ray",label:"ray"}),n.jsx(C,{value:"segment",label:"segment"})]})]}),n.jsxs(w,{style:u.row,children:[n.jsx(H,{selectedValue:g,onChange:B}),n.jsx(c,{size:m.small_12}),n.jsx(Q,{selectedValue:q,onChange:e=>l({lineStyle:e})})]}),f&&n.jsx(S,{style:u.errorText,children:j}),n.jsx(A,{headerLabel:"Point 1",expanded:!0,showPoint:N,error:f?j:null,...o,onTogglePoint:e=>l({showPoint1:e}),onChangeProps:e=>z(e,0)}),n.jsx(A,{headerLabel:"Point 2",expanded:!0,showPoint:V,error:f?j:null,...i,onTogglePoint:e=>l({showPoint2:e}),onChangeProps:e=>z(e,1)}),n.jsx(c,{size:m.small_12}),n.jsx(w,{style:u.horizontalRule}),n.jsx(ne,{ariaLabel:X,getPrepopulatedAriaLabel:R,onChangeProps:e=>{l(e)}}),n.jsx(c,{size:m.xxxSmall_4}),n.jsx(w,{style:u.horizontalRule}),n.jsx(c,{size:m.small_12}),n.jsx(S,{children:"Visible labels"}),t.map((e,a)=>O.createElement(re,{...e,key:a,expanded:!0,onChangeProps:r=>{E(r,a)},onRemove:()=>{D(a)},containerStyle:u.labelContainer})),n.jsx(J,{kind:"tertiary",startIcon:W,onClick:()=>{const e=[0,-1],a=y.add(y.scale(e,t.length),y.midpoint(s[0].coord,s[1].coord)),r={...le("label"),coord:a,color:g};l({labels:[...t,r]})},style:u.addButton,children:"Add visible label"}),n.jsx(ae,{figureType:k.type,onMove:_,onRemove:I})]})},u=Z.StyleSheet.create({row:{display:"flex",flexDirection:"row",alignItems:"center"},spaceUnder:{marginBottom:m.xSmall_8},errorText:{color:T.red},addButton:{alignSelf:"start"},horizontalRule:{height:1,backgroundColor:T.offBlack16},labelContainer:{backgroundColor:T.white}});oe.__docgenInfo={description:"",methods:[],displayName:"LockedLineSettings",props:{type:{required:!0,tsType:{name:"literal",value:'"line"'},description:""},kind:{required:!0,tsType:{name:"union",raw:'"line" | "ray" | "segment"',elements:[{name:"literal",value:'"line"'},{name:"literal",value:'"ray"'},{name:"literal",value:'"segment"'}]},description:""},points:{required:!0,tsType:{name:"tuple",raw:"[point1: LockedPointType, point2: LockedPointType]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},color:{required:!0,tsType:{name:"unknown[number]",raw:"(typeof lockedFigureColorNames)[number]"},description:""},lineStyle:{required:!0,tsType:{name:"union",raw:'"solid" | "dashed"',elements:[{name:"literal",value:'"solid"'},{name:"literal",value:'"dashed"'}]},description:""},showPoint1:{required:!0,tsType:{name:"boolean"},description:""},showPoint2:{required:!0,tsType:{name:"boolean"},description:""},labels:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    type: "label";
    coord: Coord;
