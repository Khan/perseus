var j=Object.defineProperty;var A=(l,o,e)=>o in l?j(l,o,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[o]=e;var t=(l,o,e)=>(A(l,typeof o!="symbol"?o+"":o,e),e);import{r as C,bs as q,bt as w,_ as T,bu as L,bv as E,j as s,ah as h,V as v,H as x,n as m,bw as f,bx as K,by as P,s as p,y as S,a0 as b,bz as k,bA as I,bB as N,e as g}from"./iframe-C_FVBbyS.js";import"./item-version-Dg33Ll3Y.js";import"./article-renderer-DaKBJR0u.js";import"./server-item-renderer-BY7itV5_.js";import"./hints-renderer-BBvEvVOB.js";import{c as V}from"./components-CxTrYglq.js";const{ButtonGroup:D,InfoTip:c}=V,F=["basic","trig","prealgebra","logarithms","scientific","basic relations","advanced relations"];class y extends C.Component{constructor(e){super(e);t(this,"getSaveWarnings",()=>{const e=[];return this.props.answerForms.length===0?e.push("No answers specified"):(this.props.answerForms.some(n=>n.considered==="correct")||e.push("No correct answer specified"),T(this.props.answerForms).each((n,r)=>{if(this.props.value==="")e.push(`Answer ${r+1} is empty`);else{const u=L(n.value,{functions:this.props.functions});u.parsed?n.simplify&&!u.expr.isSimplified()&&e.push(`${n.value} isn't simplified, but is required" +
