import{aD as m,j as e,V as g,n as y,S as w,u as f,a1 as b,v,s as k}from"./iframe-B7rrjhX-.js";import"./item-version-C71bDQee.js";import"./article-renderer-CKpNj7Wm.js";import"./server-item-renderer-CzC3QTOf.js";import"./hints-renderer-B1JL43nH.js";import{l as P}from"./constants-kyOY0S4e.js";function T({question:a,apiOptions:r,seamless:i,linterContext:o,legacyPerseusLint:s,previewDevice:d}){const l=m(),n=d!=="desktop",u=n?"perseus-mobile":"";return e.jsx(g,{className:`framework-perseus ${u}`,style:[t.container,i?void 0:t.gutter],children:e.jsx(w,{children:e.jsx(f.Consumer,{children:({setKeypadActive:h,keypadElement:c,setKeypadElement:p})=>e.jsxs(e.Fragment,{children:[e.jsx(b,{strings:l.strings,apiOptions:{...r,isMobile:n},keypadElement:c,linterContext:o,legacyPerseusLint:s,...a}),e.jsx(v,{onAnalyticsEvent:()=>Promise.resolve(),onDismiss:()=>h(!1),onElementMounted:p})]})})})})}const t=y.StyleSheet.create({container:{padding:k.xxxSmall_4,containerType:"inline-size",containerName:"perseus-root"},gutter:{marginRight:P}});T.__docgenInfo={description:"The `ContentPreview` component provides a simple preview system for Perseus\nContent. Due to how Persus styles are built, the preview styling matches the\ncurrent device based on the viewport width (using `@media` queries for\n`min-width` and `max-width`).\n\nThe preview will render the mobile variant (styling and layout) when the\n`previewDevice` is phone or tablet. Note that the styling cannot be matched\n100% due to the above `@media` query limitation.",methods:[],displayName:"ContentPreview",props:{question:{required:!1,tsType:{name:"signature",type:"object",raw:`{
    /**
