import{a as o,j as l}from"./jsx-runtime-BGVbfQ2Z.js";const s=({path:n,width:t,height:i,style:a={},title:e})=>o("svg",{role:"img","aria-hidden":!e,style:{verticalAlign:"middle",...a},width:`${t/i}em`,height:"1em",viewBox:`0 0 ${t} ${i}`,children:[!!e&&l("title",{children:e}),l("path",{d:n,fill:"currentColor"})]});try{inlineicon.displayName="inlineicon",inlineicon.__docgenInfo={description:`A stripped version of Icon.jsx from webapp. Takes an SVG icon and renders it
