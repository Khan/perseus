import{aI as e,j as L}from"./iframe-jmhP5DYq.js";import{S as d}from"./server-item-renderer-with-debug-ui-Chm0X_M6.js";import{q as p,c as V,S as X,a as Y,m as Z,b as H,d as $,o as ee}from"./radio.testdata-BHusjmhp.js";import"./server-item-renderer-CabVEdQ3.js";import"./hints-renderer-CreeJyil.js";import"./main-DR6B44_1.js";import"./test-keypad-context-wrapper-Dtxp-6AN.js";import"./Popper-D9H0qOEa.js";import"./radio-question-builder-CVptyQHR.js";const pe={title:"Widgets/RadioNew/Widget Demo",component:d,tags:["!autodocs"],parameters:{docs:{description:{component:"A new version of the radio widget that allows users to select a single option from a list of choices,                    with improved accessibility and interface features."}}},args:{static:!1,startAnswerless:!1,reviewMode:!1,showSolutions:"none",item:e({question:p})},argTypes:{showSolutions:{options:["none","all","selected"],control:{type:"select"}}},render:t=>L.jsx(d,{item:te(t),apiOptions:se(),reviewMode:t.reviewMode,showSolutions:t.showSolutions,startAnswerless:t.startAnswerless})},te=t=>{const g={...t.item,question:{...t.item.question,widgets:{}},apiOptions:{flags:{"new-radio-widget":!0}}};for(const[J,K]of Object.entries(t.item.question.widgets))g.question.widgets[J]={...K,static:t.static};return g},se=t=>({flags:{"new-radio-widget":!0}}),s={args:{item:e({question:p})}},r={args:{item:e({question:V})}},o={args:{item:e({question:X})}},n={args:{item:e({question:Y})}},i={args:{item:e({question:Z})}},a={args:{item:e({question:H})}},c={args:{item:e({question:$})}},l={args:{item:e({question:ee})}},m={args:{item:e({question:p}),startAnswerless:!0}},u={args:{item:e({question:H}),startAnswerless:!0}};var S,w,h;s.parameters={...s.parameters,docs:{...(S=s.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
...
}`,...(E=(R=l.parameters)==null?void 0:R.docs)==null?void 0:E.source}}};var N,U,k;m.parameters={...m.parameters,docs:{...(N=m.parameters)==null?void 0:N.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: questionWithPassage
    }),
