import{j as e}from"./jsx-runtime-BT65X5dW.js";import{B as h}from"./index-CQe11mMd.js";import{V as l}from"./index-CskvhqFA.js";import{P as S}from"./index-CIHqsnLr.js";import{S as y}from"./index-CbIoTxL4.js";import{S as D}from"./all-widgets-ChcfxzLK.js";import{T as E,d as C}from"./test-keypad-context-wrapper-BSnfrmIh.js";import{r as s}from"./index-C6mWTJJr.js";import"./underscore-U-AHniOr.js";import"./core-widget-registry-DuWAbnlP.js";import{s as W}from"./split-perseus-item-BxFzlaYC.js";import{s as M}from"./util-DuhzGyTK.js";import"./jquery-CkHB0_Mt.js";import{a as O}from"./mobile-keypad-BeZwNCVa.js";import{S as K}from"./server-item-renderer-BsrxX4A1.js";import{P as G,E as U}from"./perseus-error-CSETqePQ.js";import{H as f}from"./index-CbNKSLRm.js";import{R as w,S as L}from"./split-view-ymrOLumz.js";import{s as H}from"./test-dependencies-CInEMbRo.js";function V(n){return n.type==="points"&&n.earned>=n.total}function z(n,t,r){if(n.type==="points")return{empty:!1,correct:V(n),message:n.message,guess:t,state:r};if(n.type==="invalid")return{empty:!0,correct:!1,message:n.message,suppressAlmostThere:n.suppressAlmostThere,guess:t,state:r};throw new G("Invalid score type: "+n.type,U.InvalidInput,{metadata:{score:JSON.stringify(n),guess:JSON.stringify(t),state:JSON.stringify(r)}})}function b({score:n}){return n==null?null:e.jsxs(e.Fragment,{children:[e.jsxs("table",{style:{marginTop:"20px"},children:[e.jsx("thead",{children:e.jsxs("tr",{style:{fontWeight:"bold"},children:[e.jsx("td",{children:"Empty"}),e.jsx("td",{children:"Correct"}),e.jsx("td",{style:{width:"100%"},children:"Message"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{children:[e.jsx("td",{children:n.empty.toString()}),e.jsx("td",{children:n.correct.toString()}),e.jsx("td",{children:n.message})]})})]}),e.jsx(f,{style:{marginTop:"10px"},children:"Guess"}),e.jsx(w,{quotesOnKeys:!1,enableClipboard:!1,src:n.guess}),e.jsx(f,{style:{marginTop:"10px"},children:"State"}),e.jsx(w,{quotesOnKeys:!1,enableClipboard:!1,src:n.state})]})}b.__docgenInfo={description:"",methods:[],displayName:"KEScoreUI",props:{score:{required:!0,tsType:{name:"union",raw:"KEScore | null | undefined",elements:[{name:"signature",type:"object",raw:`{
    empty: boolean;
    correct: boolean;
    ...
    guess: any;
    state: any;
}`,signature:{properties:[{key:"empty",value:{name:"boolean",required:!0}},{key:"correct",value:{name:"boolean",required:!0}},{key:"message",value:{name:"union",raw:"string | null | undefined",elements:[{name:"string"},{name:"null"},{name:"undefined"}],required:!1}},{key:"suppressAlmostThere",value:{name:"union",raw:"boolean | null | undefined",elements:[{name:"boolean"},{name:"null"},{name:"undefined"}],required:!1}},{key:"guess",value:{name:"any",required:!0}},{key:"state",value:{name:"any",required:!0}}]}},{name:"null"},{name:"undefined"}]},description:""}}};const _=({title:n="Widget",item:t,apiOptions:r=Object.freeze({}),linterContext:v,reviewMode:c=!1,startAnswerless:k=!1,showSolutions:u})=>{const o=s.useRef(null),[p,P]=s.useState(null),[d,T]=s.useState(r.isMobile??!1),[i,R]=s.useState(0),[x,m]=s.useState(k),q={...r,isMobile:d,customKeypad:d},A=()=>{const a=o.current;if(!a)return;const j=a.getUserInput(),F=M(t.question,j,"en"),N=[a.getUserInputLegacy(),[]];return z(F,N,a.getSerializedState().question)},I=x&&!c&&(u==="none"||!u)?W(t.question):t.question,g={...t,question:I};return e.jsx(E,{children:e.jsx(L,{rendererTitle:e.jsxs(l,{style:{flexDirection:"row",alignItems:"center",width:"100%"},children:[n,e.jsx(l,{style:{marginLeft:"auto"},children:e.jsx(D,{icon:e.jsx(S,{icon:C}),checked:d,onChange:T})})]}),renderer:e.jsxs(e.Fragment,{children:[e.jsx(l,{className:d?"perseus-mobile":"",children:e.jsx(O.Consumer,{children:({keypadElement:a})=>e.jsx(K,{ref:o,problemNum:0,score:p,apiOptions:q,item:g,dependencies:H,keypadElement:a,linterContext:v,reviewMode:c,showSolutions:u,hintsVisible:i})})}),e.jsxs(l,{style:{flexDirection:"row",alignItems:"center"},children:[e.jsx(h,{onClick:()=>{m(!1),o.current&&P(A())},children:"Check"}),e.jsx(y,{size:8}),e.jsx(h,{onClick:()=>{var a;m(!1),(a=o.current)==null||a.showRationalesForCurrentlySelectedChoices()},children:"Show Rationales"}),e.jsx(y,{size:8}),e.jsx(h,{disabled:i>=t.hints.length,onClick:()=>{R(i+1)},children:i>=t.hints.length?"No hints left":`Take Hint ${i+1}`})]}),e.jsx(b,{score:p})]}),jsonObject:g})})};_.__docgenInfo={description:"",methods:[],displayName:"ServerItemRendererWithDebugUI",props:{title:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'"Widget"',computed:!1}},item:{required:!0,tsType:{name:"signature",type:"object",raw:`{
