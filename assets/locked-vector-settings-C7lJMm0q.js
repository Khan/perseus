import{c2 as _,j as e,V as d,n as M,aF as j,L as q,y as g,s as m,r as R,z as I,cN as u,e as v}from"./iframe-Fv9__JIn.js";import{p as B}from"./plus-circle-DsgEZe2H.js";import{C as F,L as E,a as D}from"./locked-label-settings-DK-HYlXZ.js";import{P as f}from"./trash-bold-BXOwgqOZ.js";import{C as W}from"./color-select-jDOn1p5o.js";import{L as J}from"./line-swatch-DQ_Eq31u.js";import{L as O}from"./locked-figure-aria-BVGR8kkY.js";import{g as Y,j as U,a as b,b as G}from"./util-DTnki1AO.js";const H="The vector cannot have length 0.",K=p=>{const{points:x,color:y,labels:i,ariaLabel:S,onChangeProps:s,onMove:P,onRemove:z}=p,[t,o]=x,$=`Vector (${t[0]}, ${t[1]}), (${o[0]}, ${o[1]})`,w=_(t,o);async function N(){const n=await U(i),r=await b(`$${t[0]}$`),a=await b(`$${t[1]}$`),c=await b(`$${o[0]}$`),h=await b(`$${o[1]}$`);let k=`Vector${n} from ${r} comma ${a} to ${c} comma ${h}`;const L=G(y);return k+=L,k}function C(n,r){if(typeof n<"u"){const a=[...x];a[r]=[...n];const c=u.midpoint(t,o),h=u.midpoint(a[0],a[1]),k=u.sub(h,c),L=i.map(T=>({...T,coord:u.add(T.coord,k)}));s({points:a,labels:L})}}function A(n){const r={color:n};r.labels=i.map(a=>({...a,color:n})),s(r)}function V(n,r){const a=[...i];a[r]={...i[r],...n},s({labels:a})}function X(n){const r=i.filter((a,c)=>c!==n);s({labels:r})}return e.jsxs(f,{expanded:p.expanded,onToggle:p.onToggle,header:e.jsxs(d,{style:l.row,children:[e.jsx(q,{children:$}),e.jsx(g,{size:m.xSmall_8}),e.jsx(J,{color:y,lineStyle:"solid"})]}),children:[e.jsx(d,{style:[l.row,l.spaceUnder],children:e.jsx(W,{selectedValue:y,onChange:A})}),w&&e.jsx(j,{style:l.errorText,children:H}),e.jsx(f,{expanded:!0,containerStyle:l.container,panelStyle:l.accordionPanel,header:e.jsx(d,{style:l.row,children:e.jsx(q,{children:`Tail (${t[0]}, ${t[1]})`})}),children:e.jsx(F,{coord:t,error:w,onChange:n=>{C(n,0)}})}),e.jsx(f,{expanded:!0,containerStyle:l.container,panelStyle:l.accordionPanel,header:e.jsx(d,{style:l.row,children:e.jsx(q,{children:`Tip (${o[0]}, ${o[1]})`})}),children:e.jsx(F,{coord:o,error:w,onChange:n=>{C(n,1)}})}),e.jsx(g,{size:m.small_12}),e.jsx(d,{style:l.horizontalRule}),e.jsx(O,{ariaLabel:S,getPrepopulatedAriaLabel:N,onChangeProps:n=>{s(n)}}),e.jsx(g,{size:m.xxxSmall_4}),e.jsx(d,{style:l.horizontalRule}),e.jsx(g,{size:m.small_12}),e.jsx(j,{children:"Visible labels"}),i.map((n,r)=>R.createElement(E,{...n,key:r,expanded:!0,onChangeProps:a=>{V(a,r)},onRemove:()=>{X(r)},containerStyle:l.labelContainer})),e.jsx(I,{kind:"tertiary",startIcon:B,onClick:()=>{const n=[0,-1],r=u.add(u.scale(n,i.length),u.midpoint(t,o)),a={...Y("label"),coord:r,color:y};s({labels:[...i,a]})},style:l.addButton,children:"Add visible label"}),e.jsx(D,{figureType:p.type,onMove:P,onRemove:z})]})},l=M.StyleSheet.create({accordionPanel:{paddingBottom:m.medium_16},container:{marginTop:m.xSmall_8,marginBottom:0,marginLeft:-4,marginRight:-4,backgroundColor:v.white},errorText:{color:v.red,marginTop:m.xSmall_8},row:{flexDirection:"row",alignItems:"center"},addButton:{alignSelf:"start"},horizontalRule:{height:1,backgroundColor:v.offBlack16},labelContainer:{backgroundColor:v.white}});K.__docgenInfo={description:"",methods:[],displayName:"LockedVectorSettings",props:{type:{required:!0,tsType:{name:"literal",value:'"vector"'},description:""},points:{required:!0,tsType:{name:"tuple",raw:"[tail: Coord, tip: Coord]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},color:{required:!0,tsType:{name:"unknown[number]",raw:"(typeof lockedFigureColorNames)[number]"},description:""},labels:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    type: "label";
    coord: Coord;
