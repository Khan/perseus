import{j as y}from"./jsx-runtime-63Ea5SlK.js";import{a as Ce}from"./version-akiLXZts.js";import{P as E,E as R}from"./perseus-error-l3K_anoI.js";import{g as un}from"./_commonjsHelpers-4gQjN7DL.js";import{e as dn,i as mn}from"./invariant-bu5zBsRS.js";import{e as gn}from"./index-J2t_5nK1.js";import{c as fe}from"./index-dnMhQZ-1.js";import{_ as g,d as pn,$ as yn}from"./jquery-yG1GhClm.js";import{r as j}from"./index-6oxdNXpR.js";import{F as we}from"./index-9gkyvru-.js";import{c as ye}from"./asset-context-H6Iqp7Gi.js";import{P as cn}from"./i18n-context-fsWEgybQ.js";import{L as K,b as ve,S as hn}from"./svg-image-1rx1Oqc_.js";import{T as Se}from"./tex-MX5FPdQh.js";import{Z as bn}from"./zoomable-_uYFBX1Q.js";import{Z as fn}from"./zoomable-tex-Jjwex-Ep.js";import{g as Y,D as wn}from"./dependencies-CP7Uh8Kq.js";import{A as vn,C as ce}from"./perseus-api-1-ethIrW.js";import{L as kn}from"./lint-CRWxUAIQ.js";import{U as qn}from"./util-_iDv4tVD.js";import{f as Tn,t as An,u as Rn,z as Pn}from"./constants-iPV6vHZm.js";class X{static parse(e){return new me(e).parse()}match(e){throw new E("Selector subclasses must implement match()",R.NotAllowed)}toString(){return"Unknown selector class"}}class me{constructor(e){e=e.trim().replace(/\s+/g," "),this.tokens=e.match(me.TOKENS)||[],this.tokenIndex=0}nextToken(){return this.tokens[this.tokenIndex]||""}consume(){this.tokenIndex++}isIdentifier(){const e=this.tokens[this.tokenIndex][0];return e>="a"&&e<="z"||e>="A"&&e<="Z"}skipSpace(){for(;this.nextToken()===" ";)this.consume()}parse(){const e=this.parseTreeSelector();let n=this.nextToken();if(!n)return e;const t=[e];for(;n;){if(n===",")this.consume();else throw new he("Expected comma");t.push(this.parseTreeSelector()),n=this.nextToken()}return new Cn(t)}parseTreeSelector(){this.skipSpace();let e=this.parseNodeSelector();for(;;){const n=this.nextToken();if(!n||n===",")break;if(n===" ")this.consume(),e=new On(e,this.parseNodeSelector());else if(n===">")this.consume(),e=new En(e,this.parseNodeSelector());else if(n==="+")this.consume(),e=new Nn(e,this.parseNodeSelector());else if(n==="~")this.consume(),e=new Sn(e,this.parseNodeSelector());else throw new he("Unexpected token: "+n)}return e}parseNodeSelector(){this.skipSpace();const e=this.nextToken();if(e==="*")return this.consume(),new xn;if(this.isIdentifier())return this.consume(),new In(e);throw new he("Expected node type")}}me.TOKENS=/([a-zA-Z][\w-]*)|(\d+)|[^\s]|(\s(?=[a-zA-Z\*]))/g;class he extends Error{constructor(e){super(e)}}class Cn extends X{constructor(e){super(),this.selectors=e}match(e){for(let n=0;n<this.selectors.length;n++){const a=this.selectors[n].match(e);if(a)return a}return null}toString(){let e="";for(let n=0;n<this.selectors.length;n++)e+=n>0?", ":"",e+=this.selectors[n].toString();return e}}class xn extends X{match(e){return[e.currentNode()]}toString(){return"*"}}class In extends X{constructor(e){super(),this.type=e}match(e){const n=e.currentNode();return n.type===this.type?[n]:null}toString(){return this.type}}class ge extends X{constructor(e,n){super(),this.left=e,this.right=n}}class On extends ge{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n)for(e=e.clone();e.hasParent();){e.goToParent();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" "+this.right.toString()}}class En extends ge{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n&&e.hasParent()){e=e.clone(),e.goToParent();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" > "+this.right.toString()}}class Nn extends ge{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n&&e.hasPreviousSibling()){e=e.clone(),e.goToPreviousSibling();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" + "+this.right.toString()}}class Sn extends ge{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n)for(e=e.clone();e.hasPreviousSibling();){e.goToPreviousSibling();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" ~ "+this.right.toString()}}const L=class L{constructor(e,n,t,a,i,o){if(!t&&!a)throw new E("Lint rules must have a selector or pattern",R.InvalidInput,{metadata:{name:e}});this.name=e||"unnamed rule",this.severity=n||L.Severity.BULK_WARNING,this.selector=t||L.DEFAULT_SELECTOR,this.pattern=a||null,typeof i=="function"?(this.lint=i,this.message=null):(this.lint=(...s)=>this._defaultLintFunction(...s),this.message=i),this.applies=o||function(){return!0}}static makeRule(e){return new L(e.name,e.severity,e.selector?X.parse(e.selector):null,L.makePattern(e.pattern),e.lint||e.message,e.applies)}check(e,n,t,a){const i=this.selector.match(n);if(!i)return null;let o;if(this.pattern?o=t.match(this.pattern):o=L.FakePatternMatch(t,t,0),!o)return null;try{const s=this.lint(n,t,i,o,a);return s?typeof s=="string"?{rule:this.name,severity:this.severity,message:s,start:0,end:t.length}:{rule:this.name,severity:this.severity,message:s.message,start:s.start,end:s.end}:null}catch(s){return{rule:"lint-rule-failure",message:`Exception in rule ${this.name}: ${s.message}
Stack trace:
${s.stack}`,start:0,end:t.length}}}_defaultLintFunction(e,n,t,a,i){return{message:this.message||"",start:a.index,end:a.index+a[0].length}}static makePattern(e){if(!e)return null;if(e instanceof RegExp)return e;if(e[0]==="/"){const n=e.lastIndexOf("/"),t=e.substring(1,n),a=e.substring(n+1);return new RegExp(t,a)}return new RegExp(e)}static FakePatternMatch(e,n,t){const a=[n];return a.index=t,a.input=e,a}};L.Severity={ERROR:1,WARNING:2,GUIDELINE:3,BULK_WARNING:4};let d=L;d.DEFAULT_SELECTOR=X.parse("text");const jn=/\/\/([^\/]+)/;function Wn(r){if(!r)return"";const e=r.match(jn);return e?e[1]:""}const Ln=d.makeRule({name:"absolute-url",severity:d.Severity.GUIDELINE,selector:"link, image",lint:function(r,e,n,t){const a=n[0].target,i=Wn(a);if(i==="khanacademy.org"||i.endsWith(".khanacademy.org"))return`Don't use absolute URLs:
When linking to KA content or images, omit the
https://www.khanacademy.org URL prefix.
Use a relative URL beginning with / instead.`}}),Mn=d.makeRule({name:"blockquoted-math",severity:d.Severity.WARNING,selector:"blockQuote math, blockQuote blockMath",message:`Blockquoted math:
math should not be indented.`}),Fn=d.makeRule({name:"blockquoted-widget",severity:d.Severity.WARNING,selector:"blockQuote widget",message:`Blockquoted widget:
widgets should not be indented.`}),_n=d.makeRule({name:"double-spacing-after-terminal",severity:d.Severity.BULK_WARNING,selector:"paragraph",pattern:/[.!\?] {2}/i,message:`Use a single space after a sentence-ending period, or
any other kind of terminal punctuation.`});function Dn(r,e){return`Answer requires a button not found in the button sets: ${r} (in ${e})`}const Gn={"\\sqrt":"prealgebra","\\sin":"trig","\\cos":"trig","\\tan":"trig","\\log":"logarithms","\\ln":"logarithms"},Vn=d.makeRule({name:"expression-widget",severity:d.Severity.WARNING,selector:"widget",lint:function(r,e,n,t,a){var u;if(r.currentNode().widgetType!=="expression")return;const i=r.currentNode().id;if(!i)return;const o=(u=a==null?void 0:a.widgets)==null?void 0:u[i];if(!o)return;const s=o.options.answerForms,l=o.options.buttonSets;for(const m of s)for(const[p,b]of Object.entries(Gn))if(m.value.includes(p)&&!l.includes(b))return Dn(p,b)}}),zn=d.makeRule({name:"extra-content-spacing",selector:"paragraph",pattern:/\s+$/,applies:function(r){return(r==null?void 0:r.contentType)==="article"},message:"No extra whitespace at the end of content blocks."}),Un=d.makeRule({name:"heading-level-1",severity:d.Severity.WARNING,selector:"heading",lint:function(r,e,n,t){if(n[0].level===1)return`Don't use level-1 headings:
Begin headings with two or more # characters.`}}),Hn=d.makeRule({name:"heading-level-skip",severity:d.Severity.WARNING,selector:"heading ~ heading",lint:function(r,e,n,t){const a=n[1],i=n[0];if(a.level>i.level+1)return`Skipped heading level:
this heading is level ${a.level} but
the previous heading was level ${i.level}`}}),Kn=d.makeRule({name:"heading-sentence-case",severity:d.Severity.GUIDELINE,selector:"heading",pattern:/^\W*[a-z]/,message:`First letter is lowercase:
the first letter of a heading should be capitalized.`}),Xn={and:!0,nor:!0,but:!0,the:!0,for:!0};function Bn(r){const e=r[0];return e===e.toUpperCase()}const $n=d.makeRule({name:"heading-title-case",severity:d.Severity.GUIDELINE,selector:"heading",pattern:/[^\s:]\s+[A-Z]+[a-z]/,locale:"en",lint:function(r,e,n,t){let i=e.trim().split(/\s+/);if(i.shift(),i=i.filter(o=>o.length>2&&!Xn.hasOwnProperty(o)),i.length>=3&&i.every(o=>Bn(o)))return`Title-case heading:
This heading appears to be in title-case, but should be sentence-case.
Only capitalize the first letter and proper nouns.`}}),Yn=d.makeRule({name:"image-alt-text",severity:d.Severity.WARNING,selector:"image",lint:function(r,e,n,t){const a=n[0];if(!a.alt||!a.alt.trim())return`Images should have alt text:
...
Don't include math expressions in image captions.`}}),er=d.makeRule({name:"link-click-here",severity:d.Severity.WARNING,selector:"link",pattern:/click here/i,message:`Inappropriate link text:
Do not use the words "click here" in links.`}),nr=d.makeRule({name:"long-paragraph",severity:d.Severity.GUIDELINE,selector:"paragraph",pattern:/^.{501,}/,lint:function(r,e,n,t){return`Paragraph too long:
This paragraph is ${e.length} characters long.
Shorten it to 500 characters or fewer.`}}),rr=d.makeRule({name:"math-adjacent",severity:d.Severity.WARNING,selector:"blockMath+blockMath",message:`Adjacent math blocks:
combine the blocks between \\begin{align} and \\end{align}`}),tr=d.makeRule({name:"math-align-extra-break",severity:d.Severity.WARNING,selector:"blockMath",pattern:/(\\{2,})\s*\\end{align}/,message:`Extra space at end of block:
Don't end an align block with backslashes`}),ar=d.makeRule({name:"math-align-linebreaks",severity:d.Severity.WARNING,selector:"blockMath",pattern:/\\begin{align}[\s\S]*\\\\[\s\S]+\\end{align}/,lint:function(r,e,n,t){let a=t[0];for(;a.length;){const i=a.indexOf("\\\\");if(i===-1)return;a=a.substring(i+2);const o=a.match(/^\s*\\\\\s*(?!\\\\)/);if(!o)return"Use four backslashes between lines of an align block";a=a.substring(o[0].length)}}}),ir=d.makeRule({name:"math-empty",severity:d.Severity.WARNING,selector:"math, blockMath",pattern:/^$/,message:"Empty math: don't use $$ in your markdown."}),sr=d.makeRule({name:"math-font-size",severity:d.Severity.GUIDELINE,selector:"math, blockMath",pattern:/\\(tiny|Tiny|small|large|Large|LARGE|huge|Huge|scriptsize|normalsize)\s*{/,message:`Math font size:
Don't change the default font size with \\Large{} or similar commands`}),or=d.makeRule({name:"math-frac",severity:d.Severity.GUIDELINE,selector:"math, blockMath",pattern:/\\frac[ {]/,message:"Use \\dfrac instead of \\frac in your math expressions."}),lr=d.makeRule({name:"math-nested",severity:d.Severity.ERROR,selector:"math, blockMath",pattern:/\\text{[^$}]*\$[^$}]*\$[^}]*}/,message:`Nested math:
Don't nest math expressions inside \\text{} blocks`}),ur=d.makeRule({name:"math-starts-with-space",severity:d.Severity.GUIDELINE,selector:"math, blockMath",pattern:/^\s*(~|\\qquad|\\quad|\\,|\\;|\\:|\\ |\\!|\\enspace|\\phantom)/,message:`Math starts with space:
math should not be indented. Do not begin math expressions with
LaTeX space commands like ~, \\;, \\quad, or \\phantom`}),dr=d.makeRule({name:"math-text-empty",severity:d.Severity.WARNING,selector:"math, blockMath",pattern:/\\text{\s*}/,message:"Empty \\text{} block in math expression"}),mr=d.makeRule({name:"math-without-dollars",severity:d.Severity.GUIDELINE,pattern:/\\\w+{[^}]*}|{|}/,message:`This looks like LaTeX:
did you mean to put it inside dollar signs?`}),gr=d.makeRule({name:"nested-lists",severity:d.Severity.WARNING,selector:"list list",message:`Nested lists:
nested lists are hard to read on mobile devices;
do not use additional indentation.`}),pr=d.makeRule({name:"static-widget-in-question-stem",severity:d.Severity.WARNING,selector:"widget",lint:(r,e,n,t,a)=>{var s;if((a==null?void 0:a.contentType)!=="exercise"||a.stack.includes("hint"))return;const i=r.currentNode().id;if(!i)return;const o=(s=a==null?void 0:a.widgets)==null?void 0:s[i];if(o&&o.static)return"Widget in question stem is static (non-interactive)."}}),yr=d.makeRule({name:"table-missing-cells",severity:d.Severity.WARNING,selector:"table",lint:function(r,e,n,t){const a=n[0],i=a.header.length,o=a.cells.map(s=>s.length);for(let s=0;s<o.length;s++)if(o[s]!==i)return`Table rows don't match header:
The table header has ${i} cells, but
Row ${s+1} has ${o[s]} cells.`}}),cr=d.makeRule({name:"unbalanced-code-delimiters",severity:d.Severity.ERROR,pattern:/[`~]+/,message:`Unbalanced code delimiters:
code blocks should begin and end with the same type and number of delimiters`}),hr=d.makeRule({name:"unescaped-dollar",severity:d.Severity.ERROR,selector:"unescapedDollar",message:`Unescaped dollar sign:
Dollar signs must appear in pairs or be escaped as \\$`}),br=d.makeRule({name:"widget-in-table",severity:d.Severity.BULK_WARNING,selector:"table widget",message:`Widget in table:
do not put widgets inside of tables.`}),fr=[Ln,Mn,Fn,_n,Vn,zn,Un,Hn,Kn,$n,Yn,Jn,er,nr,rr,tr,ar,ir,sr,or,lr,ur,dr,gr,pr,yr,hr,br,mr,cr,Qn,Zn];class U{constructor(e){this.root=e}static isNode(e){return e&&typeof e=="object"&&typeof e.type=="string"}static isTextNode(e){return U.isNode(e)&&e.type==="text"&&typeof e.content=="string"}traverse(e){this._traverse(this.root,new xe(this.root),e)}_traverse(e,n,t){let a="";if(U.isNode(e)){const i=e;n._containers.push(i),n._ancestors.push(i),typeof i.content=="string"&&(a=i.content),Object.keys(i).forEach(s=>{if(s==="type")return;const l=i[s];l&&typeof l=="object"&&(n._indexes.push(s),a+=this._traverse(l,n,t),n._indexes.pop())}),n._currentNode=n._ancestors.pop(),n._containers.pop(),t(i,n,a)}else if(Array.isArray(e)){const i=e;n._containers.push(i);let o=0;for(;o<i.length;)n._indexes.push(o),a+=this._traverse(i[o],n,t),o=n._indexes.pop()+1;n._containers.pop()}return a}}class xe{constructor(e){this.root=e,this._currentNode=null,this._containers=new J,this._indexes=new J,this._ancestors=new J}currentNode(){return this._currentNode||this.root}parent(){return this._ancestors.top()}ancestors(){return this._ancestors.values()}nextSibling(){const e=this._containers.top();if(!e||!Array.isArray(e))return null;const n=this._indexes.top();return e.length>n+1?e[n+1]:null}previousSibling(){const e=this._containers.top();if(!e||!Array.isArray(e))return null;const n=this._indexes.top();return n>0?e[n-1]:null}removeNextSibling(){const e=this._containers.top();if(e&&Array.isArray(e)){const n=this._indexes.top();if(e.length>n+1)return e.splice(n+1,1)[0]}return null}replace(...e){const n=this._containers.top();if(!n)throw new E("Can't replace the root of the tree",R.Internal);if(Array.isArray(n)){const t=this._indexes.top();n.splice(t,1,...e),this._indexes.pop(),this._indexes.push(t+e.length-1)}else{const t=this._indexes.top();e.length===0?delete n[t]:e.length===1?n[t]=e[0]:n[t]=e}}hasPreviousSibling(){return Array.isArray(this._containers.top())&&this._indexes.top()>0}goToPreviousSibling(){if(!this.hasPreviousSibling())throw new E("goToPreviousSibling(): node has no previous sibling",R.Internal);this._currentNode=this.previousSibling();const e=this._indexes.pop();this._indexes.push(e-1)}hasParent(){return this._ancestors.size()!==0}goToParent(){if(!this.hasParent())throw new E("goToParent(): node has no ancestor",R.NotAllowed);for(this._currentNode=this._ancestors.pop();this._containers.size()&&this._containers.top()[this._indexes.top()]!==this._currentNode;)this._containers.pop(),this._indexes.pop()}clone(){const e=new xe(this.root);return e._currentNode=this._currentNode,e._containers=this._containers.clone(),e._indexes=this._indexes.clone(),e._ancestors=this._ancestors.clone(),e}equals(e){return this.root===e.root&&this._currentNode===e._currentNode&&this._containers.equals(e._containers)&&this._indexes.equals(e._indexes)&&this._ancestors.equals(e._ancestors)}}class J{constructor(e){this.stack=e?e.slice(0):[]}push(e){this.stack.push(e)}pop(){return this.stack.pop()}top(){return this.stack[this.stack.length-1]}values(){return this.stack.slice(0)}size(){return this.stack.length}toString(){return this.stack.toString()}clone(){return new J(this.stack)}equals(e){if(!e||!e.stack||e.stack.length!==this.stack.length)return!1;for(let n=0;n<this.stack.length;n++)if(this.stack[n]!==e.stack[n])return!1;return!0}}const wr="@khanacademy/perseus-linter",vr="__lib_version__";Ce(wr,vr);var Ue={exports:{}},kr="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",qr=kr,Tr=dn,Ar=mn,Rr=qr,Pr=function(){function r(t,a,i,o,s,l){l!==Rr&&Ar(!1,"Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types")}r.isRequired=r;function e(){return r}var n={array:r,bool:r,func:r,number:r,object:r,string:r,symbol:r,any:r,arrayOf:e,element:r,instanceOf:e,node:r,objectOf:e,oneOf:e,oneOfType:e,shape:e,exact:e};return n.checkPropTypes=Tr,n.PropTypes=n,n};Ue.exports=Pr();var Cr=Ue.exports;const F=un(Cr);F.shape({contentType:F.string,highlightLint:F.bool,paths:F.arrayOf(F.string),stack:F.arrayOf(F.string)});const He={contentType:"",highlightLint:!1,paths:[],stack:[]},xr=fr.filter(r=>r.severity<d.Severity.BULK_WARNING);function Ir(r,e,n,t=xr){const a=[],i=new U(r);i.traverse((l,u,m)=>{if(U.isTextNode(l)){let p=u.nextSibling();for(;U.isTextNode(p);)l.content+=p.content,u.removeNextSibling(),p=u.nextSibling()}});let o=[],s=!1;return i.traverse((l,u,m)=>{const p=[],b=t.filter(c=>c.applies(e)),q=[...e.stack];q.push(l.type);const A={...e,stack:q.join(".")};if(b.forEach(c=>{const w=c.check(l,u,m,A);w&&((w.start||w.end)&&(w.target=m.substring(w.start,w.end)),a.push(w),n&&p.push(w))}),!!n&&(l.type==="table"?(o.length&&p.push(...o),s=!1,o=[]):s||(s=u.ancestors().some(c=>c.type==="table")),s&&p.length&&o.push(...p),p.length))if(p.sort((c,w)=>c.severity-w.severity),l.type!=="text"||p.length>1)u.replace({type:"lint",content:l,message:p.map(c=>c.message).join(`

`),ruleName:p[0].rule,blockHighlight:A.blockHighlight,insideTable:s,severity:p[0].severity});else{const c=l.content,w=p[0],P=w.start||0,I=w.end||c.length,M=c.substring(0,P),C=c.substring(P,I),ee=c.substring(I),ne=[];M&&ne.push({type:"text",content:M}),ne.push({type:"lint",content:{type:"text",content:C},message:w.message,ruleName:w.rule,insideTable:s,severity:w.severity}),ee&&ne.push({type:"text",content:ee}),u.replace(...ne)}}),a}function Or(r,e){const n=r.stack||[];return{...r,stack:n.concat(e)}}const Er={activeDefinitionId:null,setActiveDefinitionId:()=>{}},Ke=j.createContext(Er);class ke extends j.Component{constructor(){super(...arguments),this.state={activeDefinitionId:null},this.setActiveDefinitionId=e=>{this.setState(n=>({activeDefinitionId:e}))}}render(){const{children:e}=this.props,{activeDefinitionId:n}=this.state,{setActiveDefinitionId:t}=this;return y.jsx(Ke.Provider,{value:{activeDefinitionId:n,setActiveDefinitionId:t},children:e})}}const ca=Ke.Consumer;ke.__docgenInfo={description:"",methods:[{name:"setActiveDefinitionId",docblock:null,modifiers:[],params:[{name:"activeDefinitionId",optional:!0,type:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]}}],returns:{type:{name:"void"}}}],displayName:"DefinitionProvider",props:{children:{required:!0,tsType:{name:"any"},description:""}}};class S extends j.Component{constructor(e){super(e),this.state={error:""}}componentDidCatch(e,n){var t,a;this.setState({error:e.toString()}),(a=(t=this.props).onError)==null||a.call(t,e,n),K.error("Unhandled Perseus error: "+e.message,R.Internal,{cause:e,loggedMetadata:{componentStack:n&&"componentStack"in n?n.componentStack:"componentStack not provided",...this.props.metadata}})}render(){return this.state.error?y.jsxs("svg",{height:"16",width:"16",viewBox:"0 0 16 16",role:"img",children:[y.jsx("title",{children:"Rendering Error!"}),y.jsx("path",{d:"m8 16c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm0-3c0.55 0 1-0.45 1-1s-0.45-1-1-1-1 0.45-1 1 0.45 1 1 1zm0-9c-0.55 0-1 0.45-1 1v4c0 0.55.45 1 1 1s1-0.45 1-1v-4c0-0.55-0.45-1-1-1z",fill:"#d92916",fillRule:"evenodd"})]}):this.props.children}}S.__docgenInfo={description:"",methods:[],displayName:"ErrorBoundary",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},metadata:{required:!1,tsType:{name:"Record",elements:[{name:"string"},{name:"string"}],raw:"Record<string, string>"},description:""},onError:{required:!1,tsType:{name:"signature",type:"function",raw:"(error: Error, info: any) => void",signature:{arguments:[{type:{name:"Error"},name:"error"},{type:{name:"any"},name:"info"}],return:{name:"void"}}},description:""}}};function Nr(){}class Sr{constructor(e,n,t,a){this._track=i=>{this._tracked&&!this.setting||(this._tracked=!0,this.trackApi({type:this.widgetType,id:this.widgetID,...i}))},e?(this._tracked=!1,this.trackApi=e,this.widgetType=n,this.widgetID=t,this.setting=a,this.track=this._track):this.track=Nr}}const jr="@khanacademy/simple-markdown",Wr="__lib_version__";Ce(jr,Wr);var Lr=/\r\n?/g,Mr=/\t/g,Fr=/\f/g,Xe=function(r){return r.replace(Lr,`
`).replace(Fr,"").replace(Mr,"    ")},Be=function(r,e){var n=r||{};if(e!=null)for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&(n[t]=e[t]);return n},$e=function(r,e){var n=Object.keys(r).filter(function(o){var s=r[o];if(s==null||s.match==null)return!1;var l=s.order;return(typeof l!="number"||!isFinite(l))&&typeof console<"u"&&console.warn("simple-markdown: Invalid order for rule `"+o+"`: "+String(l)),!0});n.sort(function(o,s){var l=r[o],u=r[s],m=l.order,p=u.order;if(m!==p)return m-p;var b=l.quality?0:1,q=u.quality?0:1;return b!==q?b-q:o<s?-1:o>s?1:0});var t,a=function(o,s){var l=[];for(s=s||t,t=s;o;){var u=null,m=null,p=null,b=NaN,q=0,A=n[0],c=r[A];do{var w=c.order,P=s.prevCapture==null?"":s.prevCapture[0],I=c.match(o,s,P);if(I){var M=c.quality?c.quality(I,s,P):0;M<=b||(u=A,m=c,p=I,b=M)}q++,A=n[q],c=r[A]}while(c&&(!p||c.order===w&&c.quality));if(m==null||p==null)throw new Error("Could not find a matching rule for the below content. The rule with highest `order` should always match content provided to it. Check the definition of `match` for '"+n[n.length-1]+`'. It seems to not match the following source:
`+o);if(p.index)throw new Error("`match` must return a capture starting at index 0 (the current parse index). Did you forget a ^ at the start of the RegExp?");var C=m.parse(p,a,s);if(Array.isArray(C))Array.prototype.push.apply(l,C);else{if(C==null||typeof C!="object")throw new Error(`parse() function returned invalid parse result: '${C}'`);C.type==null&&(C.type=u),l.push(C)}s.prevCapture=p,o=o.substring(s.prevCapture[0].length)}return l},i=function(o,s){return t=Be(s,e),!t.inline&&!t.disableAutoBlockNewlines&&(o=o+`

`),t.prevCapture=null,a(Xe(o),t)};return i},x=function(r){var e=function(n,t,a){return t.inline?r.exec(n):null};return e.regex=r,e},N=function(r){var e=function(n,t){return t.inline?null:r.exec(n)};return e.regex=r,e},qe=function(r){var e=function(n,t){return r.exec(n)};return e.regex=r,e},_r=typeof Symbol=="function"&&Symbol.for&&Symbol.for("react.element")||60103,v=function(r,e,n){var t={$$typeof:_r,type:r,key:e??void 0,ref:null,props:n,_owner:null};return t},T=function(r,e,n,t){n=n||{},t=typeof t<"u"?t:!0;var a="";for(var i in n){var o=n[i];Object.prototype.hasOwnProperty.call(n,i)&&o&&(a+=" "+H(i)+'="'+H(o)+'"')}var s="<"+r+a+">";return t?s+e+"</"+r+">":s},Dr={},$=function(r){if(r==null)return null;try{var e=new URL(r,"https://localhost").protocol;if(e.indexOf("javascript:")===0||e.indexOf("vbscript:")===0||e.indexOf("data:")===0)return null}catch{return null}return r},Gr=/[<>&"']/g,Vr={"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;","'":"&#x27;","/":"&#x2F;","`":"&#96;"},H=function(r){return String(r).replace(Gr,function(e){return Vr[e]})},zr=/\\([^0-9A-Za-z\s])/g,Te=function(r){return r.replace(zr,"$1")},oe=function(r,e,n){var t=n.inline||!1;n.inline=!0;var a=r(e,n);return n.inline=t,a},Ur=function(r,e,n){var t=n.inline||!1;n.inline=!1;var a=r(e+`

`,n);return n.inline=t,a},re=function(r,e,n){return{content:oe(e,r[1],n)}},be=function(){return{}},le="(?:[*+-]|\\d+\\.)",Ye="( *)("+le+") +",je=new RegExp("^"+Ye),Hr=new RegExp(Ye+"[^\\n]*(?:\\n(?!\\1"+le+` )[^\\n]*)*(
|$)`,"gm"),Je=/\n{2,}$/,Kr=/^ (?= *`)|(` *) $/g,Xr=Je,We=/ *\n+$/,Br=new RegExp("^( *)("+le+`) [\\s\\S]+?(?:
{2,}(?! )(?!\\1`+le+` )\\n*|\\s*
*$)`),$r=/(?:^|\n)( *)$/,te=function(){var r=/^ *\| *| *\| *$/g,e=/ *$/,n=/^ *-+: *$/,t=/^ *:-+: *$/,a=/^ *:-+ *$/,i=function(m){return n.test(m)?"right":t.test(m)?"center":a.test(m)?"left":null},o=function(m,p,b,q){q&&(m=m.replace(r,""));var A=m.trim().split("|");return A.map(i)},s=function(m,p,b,q){var A=b.inTable;b.inTable=!0;var c=p(m.trim(),b);b.inTable=A;var w=[[]];return c.forEach(function(P,I){P.type==="tableSeparator"?(!q||I!==0&&I!==c.length-1)&&w.push([]):(P.type==="text"&&(c[I+1]==null||c[I+1].type==="tableSeparator")&&(P.content=P.content.replace(e,"")),w[w.length-1].push(P))}),w},l=function(m,p,b,q){var A=m.trim().split(`
`);return A.map(function(c){return s(c,p,b,q)})},u=function(m){return function(p,b,q){q.inline=!0;var A=s(p[1],b,q,m),c=o(p[2],b,q,m),w=l(p[3],b,q,m);return q.inline=!1,{type:"table",header:A,align:c,cells:w}}};return{parseTable:u(!0),parseNpTable:u(!1),TABLE_REGEX:/^ *(\|.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/,NPTABLE_REGEX:/^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/}}(),ae="(?:\\[[^\\]]*\\]|[^\\[\\]]|\\](?=[^\\[]*\\]))*",Le=`\\s*<?((?:\\([^)]*\\)|[^\\s\\\\]|\\\\.)*?)>?(?:\\s+['"]([\\s\\S]*?)['"])?\\s*`,Yr=/mailto:/i,Me=function(r,e,n){var t=(r[2]||r[1]).replace(/\s+/g," ").toLowerCase();if(e._defs&&e._defs[t]){var a=e._defs[t];n.target=a.target,n.title=a.title}return e._refs=e._refs||{},e._refs[t]=e._refs[t]||[],e._refs[t].push(n),n},f=0,Z={Array:{react:function(r,e,n){for(var t=n.key,a=[],i=0,o=0;i<r.length;i++,o++){n.key=""+i;var s=r[i];if(s.type==="text")for(s={type:"text",content:s.content};i+1<r.length&&r[i+1].type==="text";i++)s.content+=r[i+1].content;a.push(e(s,n))}return n.key=t,a},html:function(r,e,n){for(var t="",a=0;a<r.length;a++){var i=r[a];if(i.type==="text")for(i={type:"text",content:i.content};a+1<r.length&&r[a+1].type==="text";a++)i.content+=r[a+1].content;t+=e(i,n)}return t}},heading:{order:f++,match:N(/^ *(#{1,6})([^\n]+?)#* *(?:\n *)+\n/),parse:function(r,e,n){return{level:r[1].length,content:oe(e,r[2].trim(),n)}},react:function(r,e,n){return v("h"+r.level,n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("h"+r.level,e(r.content,n))}},nptable:{order:f++,match:N(te.NPTABLE_REGEX),parse:te.parseNpTable,react:null,html:null},lheading:{order:f++,match:N(/^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/),parse:function(r,e,n){return{type:"heading",level:r[2]==="="?1:2,content:oe(e,r[1],n)}},react:null,html:null},hr:{order:f++,match:N(/^( *[-*_]){3,} *(?:\n *)+\n/),parse:be,react:function(r,e,n){return v("hr",n.key,{"aria-hidden":!0})},html:function(r,e,n){return'<hr aria-hidden="true">'}},codeBlock:{order:f++,match:N(/^(?:    [^\n]+\n*)+(?:\n *)+\n/),parse:function(r,e,n){var t=r[0].replace(/^    /gm,"").replace(/\n+$/,"");return{lang:void 0,content:t}},react:function(r,e,n){var t=r.lang?"markdown-code-"+r.lang:void 0;return v("pre",n.key,{children:v("code",null,{className:t,children:r.content})})},html:function(r,e,n){var t=r.lang?"markdown-code-"+r.lang:void 0,a=T("code",H(r.content),{class:t});return T("pre",a)}},fence:{order:f++,match:N(/^ *(`{3,}|~{3,}) *(?:(\S+) *)?\n([\s\S]+?)\n?\1 *(?:\n *)+\n/),parse:function(r,e,n){return{type:"codeBlock",lang:r[2]||void 0,content:r[3]}},react:null,html:null},blockQuote:{order:f++,match:N(/^( *>[^\n]+(\n[^\n]+)*\n*)+\n{2,}/),parse:function(r,e,n){var t=r[0].replace(/^ *> ?/gm,"");return{content:e(t,n)}},react:function(r,e,n){return v("blockquote",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("blockquote",e(r.content,n))}},list:{order:f++,match:function(r,e){var n=e.prevCapture==null?"":e.prevCapture[0],t=$r.exec(n),a=e._list||!e.inline;return t&&a?(r=t[1]+r,Br.exec(r)):null},parse:function(r,e,n){var t=r[2],a=t.length>1,i=a?+t:void 0,o=r[0].replace(Xr,`
`).match(Hr),s=!1,l=o.map(function(u,m){var p=je.exec(u),b=p?p[0].length:0,q=new RegExp("^ {1,"+b+"}","gm"),A=u.replace(q,"").replace(je,""),c=m===o.length-1,w=A.indexOf(`

`)!==-1,P=w||c&&s;s=P;var I=n.inline,M=n._list;n._list=!0;var C;P?(n.inline=!1,C=A.replace(We,`

`)):(n.inline=!0,C=A.replace(We,""));var ee=e(C,n);return n.inline=I,n._list=M,ee});return{ordered:a,start:i,items:l}},react:function(r,e,n){var t=r.ordered?"ol":"ul";return v(t,n.key,{start:r.start,children:r.items.map(function(a,i){return v("li",""+i,{children:e(a,n)})})})},html:function(r,e,n){var t=r.items.map(function(o){return T("li",e(o,n))}).join(""),a=r.ordered?"ol":"ul",i={start:r.start};return T(a,t,i)}},def:{order:f++,match:N(/^ *\[([^\]]+)\]: *<?([^\s>]*)>?(?: +["(]([^\n]+)[")])? *\n(?: *\n)*/),parse:function(r,e,n){var t=r[1].replace(/\s+/g," ").toLowerCase(),a=r[2],i=r[3];return n._refs&&n._refs[t]&&n._refs[t].forEach(function(o){o.target=a,o.title=i}),n._defs=n._defs||{},n._defs[t]={target:a,title:i},{def:t,target:a,title:i}},react:function(){return null},html:function(){return""}},table:{order:f++,match:N(te.TABLE_REGEX),parse:te.parseTable,react:function(r,e,n){var t=function(o){return r.align[o]==null?{}:{textAlign:r.align[o]}},a=r.header.map(function(o,s){return v("th",""+s,{style:t(s),scope:"col",children:e(o,n)})}),i=r.cells.map(function(o,s){return v("tr",""+s,{children:o.map(function(l,u){return v("td",""+u,{style:t(u),children:e(l,n)})})})});return v("table",n.key,{children:[v("thead","thead",{children:v("tr",null,{children:a})}),v("tbody","tbody",{children:i})]})},html:function(r,e,n){var t=function(l){return r.align[l]==null?"":"text-align:"+r.align[l]+";"},a=r.header.map(function(l,u){return T("th",e(l,n),{style:t(u),scope:"col"})}).join(""),i=r.cells.map(function(l){var u=l.map(function(m,p){return T("td",e(m,n),{style:t(p)})}).join("");return T("tr",u)}).join(""),o=T("thead",T("tr",a)),s=T("tbody",i);return T("table",o+s)}},newline:{order:f++,match:N(/^(?:\n *)*\n/),parse:be,react:function(r,e,n){return`
`},html:function(r,e,n){return`
`}},paragraph:{order:f++,match:N(/^((?:[^\n]|\n(?! *\n))+)(?:\n *)+\n/),parse:re,react:function(r,e,n){return v("div",n.key,{className:"paragraph",children:e(r.content,n)})},html:function(r,e,n){var t={class:"paragraph"};return T("div",e(r.content,n),t)}},escape:{order:f++,match:x(/^\\([^0-9A-Za-z\s])/),parse:function(r,e,n){return{type:"text",content:r[1]}},react:null,html:null},tableSeparator:{order:f++,match:function(r,e){return e.inTable?/^ *\| */.exec(r):null},parse:function(){return{type:"tableSeparator"}},react:function(){return" | "},html:function(){return" &vert; "}},autolink:{order:f++,match:x(/^<([^: >]+:\/[^ >]+)>/),parse:function(r,e,n){return{type:"link",content:[{type:"text",content:r[1]}],target:r[1]}},react:null,html:null},mailto:{order:f++,match:x(/^<([^ >]+@[^ >]+)>/),parse:function(r,e,n){var t=r[1],a=r[1];return Yr.test(a)||(a="mailto:"+a),{type:"link",content:[{type:"text",content:t}],target:a}},react:null,html:null},url:{order:f++,match:x(/^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/),parse:function(r,e,n){return{type:"link",content:[{type:"text",content:r[1]}],target:r[1],title:void 0}},react:null,html:null},link:{order:f++,match:x(new RegExp("^\\[("+ae+")\\]\\("+Le+"\\)")),parse:function(r,e,n){var t={content:e(r[1],n),target:Te(r[2]),title:r[3]};return t},react:function(r,e,n){return v("a",n.key,{href:$(r.target),title:r.title,children:e(r.content,n)})},html:function(r,e,n){var t={href:$(r.target),title:r.title};return T("a",e(r.content,n),t)}},image:{order:f++,match:x(new RegExp("^!\\[("+ae+")\\]\\("+Le+"\\)")),parse:function(r,e,n){var t={alt:r[1],target:Te(r[2]),title:r[3]};return t},react:function(r,e,n){return v("img",n.key,{src:$(r.target),alt:r.alt,title:r.title})},html:function(r,e,n){var t={src:$(r.target),alt:r.alt,title:r.title};return T("img","",t,!1)}},reflink:{order:f++,match:x(new RegExp("^\\[("+ae+")\\]\\s*\\[([^\\]]*)\\]")),parse:function(r,e,n){return Me(r,n,{type:"link",content:e(r[1],n)})},react:null,html:null},refimage:{order:f++,match:x(new RegExp("^!\\[("+ae+")\\]\\s*\\[([^\\]]*)\\]")),parse:function(r,e,n){return Me(r,n,{type:"image",alt:r[1]})},react:null,html:null},em:{order:f,match:x(new RegExp("^\\b_((?:__|\\\\[\\s\\S]|[^\\\\_])+?)_\\b|^\\*(?=\\S)((?:\\*\\*|\\\\[\\s\\S]|\\s+(?:\\\\[\\s\\S]|[^\\s\\*\\\\]|\\*\\*)|[^\\s\\*\\\\])+?)\\*(?!\\*)")),quality:function(r){return r[0].length+.2},parse:function(r,e,n){return{content:e(r[2]||r[1],n)}},react:function(r,e,n){return v("em",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("em",e(r.content,n))}},strong:{order:f,match:x(/^\*\*((?:\\[\s\S]|[^\\])+?)\*\*(?!\*)/),quality:function(r){return r[0].length+.1},parse:re,react:function(r,e,n){return v("strong",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("strong",e(r.content,n))}},u:{order:f++,match:x(/^__((?:\\[\s\S]|[^\\])+?)__(?!_)/),quality:function(r){return r[0].length},parse:re,react:function(r,e,n){return v("u",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("u",e(r.content,n))}},del:{order:f++,match:x(/^~~(?=\S)((?:\\[\s\S]|~(?!~)|[^\s~\\]|\s(?!~~))+?)~~/),parse:re,react:function(r,e,n){return v("del",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("del",e(r.content,n))}},inlineCode:{order:f++,match:x(/^(`+)([\s\S]*?[^`])\1(?!`)/),parse:function(r,e,n){return{content:r[2].replace(Kr,"$1")}},react:function(r,e,n){return v("code",n.key,{children:r.content})},html:function(r,e,n){return T("code",H(r.content))}},br:{order:f++,match:qe(/^ {2,}\n/),parse:be,react:function(r,e,n){return v("br",n.key,Dr)},html:function(r,e,n){return"<br>"}},text:{order:f++,match:qe(/^[\s\S]+?(?=[^0-9A-Za-z\s\u00c0-\uffff]|\n\n| {2,}\n|\w+:\S|$)/),parse:function(r,e,n){return{content:r[0]}},react:function(r,e,n){return r.content},html:function(r,e,n){return H(r.content)}}},Jr=function(r,e){!e&&typeof console<"u"&&console.warn("simple-markdown ruleOutput should take 'react' or 'html' as the second argument.");var n=function(t,a,i){return r[t.type][e](t,a,i)};return n},Qr=function(r){var e=function(n,t){if(t=t||{},Array.isArray(n)){for(var a=t.key,i=[],o=null,s=0;s<n.length;s++){t.key=""+s;var l=e(n[s],t);typeof l=="string"&&typeof o=="string"?(o=o+l,i[i.length-1]=o):(i.push(l),o=l)}return t.key=a,i}else return r(n,e,t)};return e},Zr=function(r){var e=function(n,t){return t=t||{},Array.isArray(n)?n.map(function(a){return e(a,t)}).join(""):r(n,e,t)};return e},Ie=function(r,e,n={}){if(!e)throw new Error("simple-markdown: outputFor: `property` must be defined. if you just upgraded, you probably need to replace `outputFor` with `reactFor`");var t,a=r.Array||Z.Array,i=a[e];if(!i)throw new Error("simple-markdown: outputFor: to join nodes of type `"+e+"` you must provide an `Array:` joiner rule with that type, Please see the docs for details on specifying an Array rule.");var o=i,s=function(u,m){return m=m||t,t=m,Array.isArray(u)?o(u,s,m):r[u.type][e](u,s,m)},l=function(u,m){return t=Be(m,n),s(u,t)};return l},pe=$e(Z),Oe=function(r,e){return e=e||{},e.inline=!1,pe(r,e)},et=function(r,e){return e=e||{},e.inline=!0,pe(r,e)},Fe=function(r,e){var n=Je.test(r);return e=e||{},e.inline=!n,pe(r,e)},Ae=Ie(Z,"react"),Qe=Ie(Z,"html"),Ze=function(r,e){return Ae(Oe(r,e),e)},nt=function(r,e){return Qe(Oe(r,e),e)},rt=function(r){var e={};for(var n in r)n!=="source"&&Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n]);return e.children=Ze(r.source),v("div",null,e)},h={defaultRules:Z,parserFor:$e,outputFor:Ie,inlineRegex:x,blockRegex:N,anyScopeRegex:qe,parseInline:oe,parseBlock:Ur,markdownToReact:Ze,markdownToHtml:nt,ReactMarkdown:rt,defaultBlockParse:Oe,defaultInlineParse:et,defaultImplicitParse:Fe,defaultReactOutput:Ae,defaultHtmlOutput:Qe,preprocess:Xe,sanitizeText:H,sanitizeUrl:$,unescapeUrl:Te,htmlTag:T,reactElement:v,defaultRawParse:pe,ruleOutput:Jr,reactFor:Qr,htmlFor:Zr,defaultParse:function(...r){return typeof console<"u"&&console.warn("defaultParse is deprecated, please use `defaultImplicitParse`"),Fe.apply(null,r)},defaultOutput:function(...r){return typeof console<"u"&&console.warn("defaultOutput is deprecated, please use `defaultReactOutput`"),Ae.apply(null,r)}};const tt={fence:{match:h.defaultRules.fence.match,order:1,parse:(r,e,n)=>({type:"codeBlock",lang:r[2]||void 0,content:r[3]})},paragraph:{match:h.defaultRules.paragraph.match,order:2,parse:(r,e,n)=>({content:r[1]})}},at=h.parserFor(tt),it=r=>{const e=r.replace(/^\n\s*\n/,"")+`

`;return at(e,{inline:!1}).map(n=>n.content)},st=r=>r.join(`

`),_e={parseToArray:it,joinFromArray:st},ot="@khanacademy/pure-markdown",lt="__lib_version__";Ce(ot,lt);const ut=/^\[\[\u2603 (([a-z-]+) ([0-9]+))\]\]/,en=(r,e,n)=>{const t=r.length;let a=0;if(n){if(e.inline)return null;for(;a<t&&r[a]===" ";)a++}if(!(a<t&&r[a]==="$"))return null;a++;const i=a;let o=0;for(;a<t;){const s=r[a];if(s==="\\")a++;else if(o<=0&&s==="$"){let l=a+1;if(n){const u=/^(?: *\n){2,}/.exec(r.slice(l));l=u?l+u[0].length:null}return l?[r.substring(0,l),r.substring(i,a)]:null}else if(s==="{")o++;else if(s==="}")o--;else if(s===`
`&&r[a-1]===`
`)return null;a++}return null},dt=(r,e)=>en(r,e,!1),mt=(r,e)=>en(r,e,!0),gt=new RegExp("^\\|\\| +(.*) +\\|\\| *\\n("+h.defaultRules.nptable.match.regex.source.substring(1)+")"),pt=h.blockRegex(/^(crwdns.*)\n\s*\n/),O={...h.defaultRules,columns:{order:-2,match:h.blockRegex(/^([\s\S]*\n\n)={5,}\n\n([\s\S]*)/),parse:(r,e,n)=>({col1:e(r[1],n),col2:e(r[2],n)})},crowdinId:{order:-1,match:(r,e,n)=>e.isJipt?pt(r,e,n):null,parse:(r,e,n)=>({id:r[1]})},titledTable:{order:h.defaultRules.nptable.order-.5,match:h.blockRegex(gt),parse:(r,e,n)=>{const t=h.parseInline(e,r[1],n),a=r.slice(2),i=h.defaultRules.nptable.parse(a,e,n);return{title:t,table:i}}},widget:{order:h.defaultRules.link.order-.75,match:h.inlineRegex(ut),parse:(r,e,n)=>({id:r[1],widgetType:r[2]})},blockMath:{order:h.defaultRules.codeBlock.order+.5,match:mt,parse:(r,e,n)=>({content:r[1]})},math:{order:h.defaultRules.link.order-.25,match:dt,parse:(r,e,n)=>({content:r[1]})},unescapedDollar:{order:h.defaultRules.link.order-.24,match:h.inlineRegex(/^(?!\\)\$/),parse:(r,e,n)=>({})},fence:{...h.defaultRules.fence,parse:(r,e,n)=>{const t=h.defaultRules.fence.parse(r,e,n);return t.lang==="alt"?{type:"codeBlock",lang:"alt",content:e(t.content+`

`,n)}:t}},blockQuote:{...h.defaultRules.blockQuote,match:h.blockRegex(/^ *>[^\n]+(\n( *>)?[^\n]+)*\n{2,}/)},lint:{order:1e3,match:r=>null,parse:(r,e,n)=>({})}};h.parserFor(O);const Q={...O,columns:{...O.columns,react:(r,e,n)=>y.jsxs("div",{className:"perseus-two-columns",children:[y.jsx("div",{className:"perseus-column",children:y.jsx("div",{className:"perseus-column-content",children:e(r.col1,n)})}),y.jsx("div",{className:"perseus-column",children:y.jsx("div",{className:"perseus-column-content",children:e(r.col2,n)})})]},n.key)},crowdinId:{...O.crowdinId,react:(r,e,n)=>r.id},table:{...O.table,react:function(r,e,n){const t=h.defaultRules.table.react(r,e,n);return n.isMobile?j.cloneElement(t,{tabIndex:0}):t}},titledTable:{...O.titledTable,react:(r,e,n)=>{var a;let t;if(!r.table)t="//invalid table//";else if(r.table.type==="lint")((a=r.table.content)==null?void 0:a.type)==="table"?t=Q.lint.react({...r.table,content:{...r,table:r.table.content}},e,{...n,unwrapTitledTableContents:!0}):t=Q.lint.react(r.table,e,n);else{const i=h.defaultRules.table.react(r.table,e,n),o=y.jsx("caption",{className:"perseus-table-title",children:e(r.title,n)},"caption");t=j.cloneElement(i,null,[o,...i.props.children])}return n.unwrapTitledTableContents?t:y.jsx("div",{className:"perseus-titled-table",children:t},n.key)}},widget:{...O.widget,react:(r,e,n)=>y.jsx("em",{children:`[Widget: ${r.id}]`},n.key)},blockMath:{...O.blockMath,react:(r,e,n)=>{const{TeX:t}=Y();return y.jsx(t,{children:r.content},n.key)}},math:{...O.math,react:(r,e,n)=>{const{TeX:t}=Y();return y.jsx(t,{children:r.content},n.key)}},unescapedDollar:{...O.unescapedDollar,react:(r,e,n)=>"$"},link:{...O.link,react:function(r,e,n){const t=h.defaultRules.link.react(r,e,n),a=t.props.href;let i=null;(a?a.match(/https?:\/\/[^/]*khanacademy.org|^\//):!1)||(i="noopener noreferrer");const s={...t.props,target:"_blank",href:a,rel:i};return n.baseElements&&n.baseElements.Link?n.baseElements.Link(s):j.cloneElement(t,s)}},codeBlock:{...O.codeBlock,react:(r,e,n)=>r.lang==="alt"?y.jsx("div",{className:"perseus-markdown-alt perseus-sr-only",children:e(r.content,n)},n.key):h.defaultRules.codeBlock.react(r,e,n)},lint:{...O.lint,react:(r,e,n)=>y.jsx(kn,{message:r.message,ruleName:r.ruleName,inline:yt(r.content),blockHighlight:r.blockHighlight,insideTable:r.insideTable,severity:r.severity,children:e(r.content,n)})}};function yt(r){return!!(r&&r.type&&ct.hasOwnProperty(r.type))}const ct={text:!0,math:!0,unescapedDollar:!0,link:!0,img:!0,strong:!0,u:!0,em:!0,del:!0,code:!0},nn=h.parserFor(Q),rn=(r,e)=>{const n=r+`

`;return nn(n,{...e,inline:!1})},ht=(r,e)=>nn(r,{...e,inline:!0}),W=(r,e)=>{g.isArray(r)?g.each(r,n=>W(n,e)):g.isObject(r)&&(e(r),r.type==="table"?(W(r.header,e),W(r.cells,e)):r.type==="list"?W(r.items,e):r.type==="titledTable"?W(r.table,e):r.type==="columns"?(W(r.col1,e),W(r.col2,e)):g.isArray(r.content)&&W(r.content,e))},Re=r=>{if(g.isArray(r))return g.flatten(g.map(r,Re));if(r.content&&g.isString(r.content))return r.type.toLowerCase().indexOf("code")!==-1?["",r.content,""]:[r.content.replace(/\s+/g," ")];const e=g.chain(r).values().flatten().filter(t=>t!=null&&g.has(t,"type")).value();if(!e.length)return[];const n=Re(e);if(r.type==="paragraph"&&n.length){n[0]=n[0].replace(/^\s+/,"");const t=n.length-1;n[t]=n[t].replace(/\s+$/,"")}return n},bt=r=>{const e=rn(r);return Re(e).join("").length},D={characterCount:bt,traverseContent:W,parse:rn,parseInline:ht,reactFor:h.reactFor,ruleOutput:h.ruleOutput(Q,"react"),basicOutput:h.reactFor(h.ruleOutput(Q,"react")),sanitizeUrl:h.sanitizeUrl};class tn extends j.Component{render(){const e=this.props.className?"paragraph "+this.props.className:"paragraph";return y.jsx("div",{className:this.props.inline?this.props.className??void 0:e,"data-perseus-component-index":this.props.translationIndex,"data-perseus-paragraph-index":this.props.paragraphIndex,children:this.props.children})}}tn.__docgenInfo={description:"",methods:[],displayName:"QuestionParagraph",props:{className:{required:!1,tsType:{name:"union",raw:"string | null | undefined",elements:[{name:"string"},{name:"null"},{name:"undefined"}]},description:""},translationIndex:{required:!0,tsType:{name:"number"},description:""},paragraphIndex:{required:!1,tsType:{name:"number"},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},inline:{required:!1,tsType:{name:"boolean"},description:""}}};const ft={type:"points",earned:0,total:0,message:null};function wt(r){return r.type==="invalid"&&(!r.message||r.message.length===0)}function vt(r,e){let n;if(r.type==="points"&&e.type==="points")return r.message&&e.message&&r.message!==e.message?n=null:n=r.message||e.message,{type:"points",earned:r.earned+e.earned,total:r.total+e.total,message:n};if(r.type==="points"&&e.type==="invalid")return e;if(r.type==="invalid"&&e.type==="points")return r;if(r.type==="invalid"&&e.type==="invalid")return r.message&&e.message&&r.message!==e.message?n=null:n=r.message||e.message,{type:"invalid",message:n};throw new E("PerseusScore with unknown type encountered",R.InvalidInput,{metadata:{scoreA:JSON.stringify(r),scoreB:JSON.stringify(e)}})}function an(r){return Object.values(r).reduce(vt,ft)}function kt(r){return r.type==="points"&&r.earned>=r.total}function ha(r,e,n){if(r.type==="points")return{empty:!1,correct:kt(r),message:r.message,guess:e,state:n};if(r.type==="invalid")return{empty:!0,correct:!1,message:r.message,suppressAlmostThere:r.suppressAlmostThere,guess:e,state:n};throw new E("Invalid score type: "+r.type,R.InvalidInput,{metadata:{score:JSON.stringify(r),guess:JSON.stringify(e),state:JSON.stringify(n)}})}function qt(){return/\[\[☃ ([A-Za-z0-9- ]+)\]\]/g}function Tt(r){const e=[],n=qt();let t=n.exec(r);for(;t!==null;)e.push(t[1]),t=n.exec(r);return e}const De="block",At=["default"],Rt=!1,Pt="",Ct=!1,k={},_={},sn=(r,e)=>{k[r]=e},ba=r=>{r.forEach(e=>{sn(e.name,e)}),jt()},G=(r,e)=>{const n=k[e];if(!n){const t=`Failed to replace ${r} with ${e}`;throw new E(t,R.Internal)}sn(r,n)},fa=()=>{G("transformer","deprecated-standin"),G("lights-puzzle","deprecated-standin"),G("reaction-diagram","deprecated-standin"),G("sequence","deprecated-standin"),G("simulator","deprecated-standin"),G("unit-input","deprecated-standin")},wa=r=>{r.forEach(e=>{if(!e.widgetName)throw new E(`Editor ${e.displayName} doesn't have a widgetName property`,R.Internal);_[e.widgetName]=e})},V=(r,e)=>{const n=_[e];if(!n&&K){const t=`Failed to replace editor ${r} with ${e}`;K.error(t,R.Internal);return}_[r]=n},va=()=>{V("transformer","deprecated-standin"),V("lights-puzzle","deprecated-standin"),V("reaction-diagram","deprecated-standin"),V("sequence","deprecated-standin"),V("simulator","deprecated-standin"),V("unit-input","deprecated-standin")},xt=r=>{var e,n,t;return g.has(k,r)?(e=k[r])!=null&&e.getWidget?(t=(n=k[r]).getWidget)==null?void 0:t.call(n):k[r].widget:null},on=r=>{var e;return((e=k[r])==null?void 0:e.scorer)??null},ka=r=>g.has(_,r)?_[r]:null,It=r=>{if(k[r])return k[r].version||{major:0,minor:0}},qa=()=>{const r={};return g.each(g.keys(k),function(e){r[e]=It(e)}),r},Ta=()=>g.pick(k,g.reject(g.keys(k),function(r){return k[r].hidden})),Aa=()=>g.keys(k),Ot=r=>{const e=r.type;if(!g.isString(e))throw new E("widget type must be a string, but was: "+e,R.Internal);const n=k[e];if(n==null)return r;const t=r.version||{major:0,minor:0},a=n.version||{major:0,minor:0};if(t.major>a.major||t.major===a.major&&t.minor>a.minor)return r;let i=g.clone(r.options)||{};const o=n.propUpgrades||{};if(g.keys(i).length!==0)for(let m=t.major+1;m<=a.major;m++)o[String(m)]?i=o[String(m)](i):K.error("No upgrade found for widget. Cannot render.",R.Internal,{loggedMetadata:{type:e,fromMajorVersion:m-1,toMajorVersion:m}});i={...e in _?_[e].defaultProps:{},...i};let l=r.alignment;(l==null||l==="default")&&(l=Nt(e)[0]);let u=r.static;return u==null&&(u=Rt),g.extend({},r,{version:a,graded:r.graded!=null?r.graded:!0,alignment:l,static:u,options:i})},Et=(r,e,n)=>{const t=r.type,a=k[t];if(a==null)return r;let i;return r.static?i=Wt(t)||g.identity:i=a.transform||g.identity,i(r.options,e,n)},Nt=r=>{const e=k[r];return e&&e.supportedAlignments||At},St=r=>{const e=k[r];let n;return e?(e.getDefaultAlignment?n=e.getDefaultAlignment():n=e.defaultAlignment,n||De):De},Ge=["block","inline-block","inline","float-left","float-right","full-width"],jt=()=>{g.each(k,function(r){if(r.defaultAlignment&&!g.contains(Ge,r.defaultAlignment))throw new E("Widget '"+r.displayName+"' has an invalid defaultAlignment value: "+r.defaultAlignment,R.InvalidInput);if(r.supportedAlignments){const e=g.difference(r.supportedAlignments,Ge);if(e.length)throw new E("Widget '"+r.displayName+"' has an invalid value for supportedAlignments: "+e.join(" "),R.InvalidInput)}})},Ra=r=>{const e=k[r];return e&&e.staticTransform!=null},Wt=r=>{const e=k[r];return e&&e.staticTransform},Lt=r=>{const e=k[r];return e&&e.tracking||Pt},Mt=r=>{const e=k[r];return e&&e.isLintable||Ct};function Ee(r){return ve(r,(e,n)=>{if(!e.type||!e.alignment){const t={};e.type||(t.type=n.split(" ")[0]),e.alignment||(t.alignment="default"),e={...e,...t}}return Ot(e)})}function Ft(r,e,n,t,a){const i=Ee(r);return e.filter(o=>{const s=i[o];if(!s||s.static)return!1;const l=on(s.type),u=l==null?void 0:l(n[o],s.options,t,a);if(u)return wt(u)})}function Pa(r,e,n,t){const a=Tt(r.content),i=ln(r.widgets,a,e,n,t);return an(i)}function ln(r,e,n,t,a){const i=Ee(r),o=e.filter(l=>{const u=i[l],m=(u==null?void 0:u.graded)==null||u.graded,p=!!(u!=null&&u.static);return m&&!p}),s={};return o.forEach(l=>{const u=i[l];if(!u)return;const m=n[l],p=on(u.type),b=p==null?void 0:p(m,u.options,t,a);b!=null&&(s[l]=b)}),s}const _t=1e3;class Dt{constructor(){this.previousContent=null,this.runLinter=pn((e,n)=>{if(!(typeof KA>"u")&&e!==this.previousContent){if(this.previousContent=e,e===""){n([]);return}fetch("/api/internal/translations/lint_poentry?preview=1&lang=en",{headers:{"Content-Type":"application/json"},body:JSON.stringify({msgid:e,msgstr:e,format:"perseus_text",filename:""}),method:"POST"}).then(t=>t.status>=400?{status:"error",message:"Could not run i18n linter."}:t.json(),t=>({status:"error",message:"Could not run i18n linter."})).then(t=>{t.status==="error"?n(["Some part of this text makes it untranslatable. The specific message from the i18n linter was: "+t.message.replace(/\n/g," ")]):n([])})}},_t)}applyLintErrors(e,n){if(n.length){const t=n.join(`

`);e.unshift({content:{type:"text",content:""},insideTable:!1,message:t,ruleName:"legacy-error",severity:d.Severity.ERROR,type:"lint"})}}}const Gt=r=>r.replace(/\{align[*]?\}/g,"{aligned}").replace(/[\u00a0]/g," "),{interactiveSizes:ie}=Tn,Vt=An,zt=Rn,z={SMALL:"small",MEDIUM:"medium",LARGE:"large",XLARGE:"xlarge"},Ut=r=>r?r<=Vt?z.SMALL:r<=zt?z.MEDIUM:z.LARGE:z.MEDIUM,Ca=r=>r===z.SMALL?[ie.defaultBoxSizeSmall,ie.defaultBoxSizeSmall]:[ie.defaultBoxSize,ie.defaultBoxSize],Ne=class Ne extends j.Component{constructor(){super(...arguments),this.widgetRef=j.createRef(),this.state={sizeClass:z.MEDIUM,widgetProps:this.props.initialProps},this.getWidget=()=>this.widgetRef.current,this.replaceWidgetProps=e=>{this.setState({widgetProps:e})}}componentDidMount(){if(this.state.widgetProps.apiOptions.isMobile){const e=we.findDOMNode(this).offsetWidth;this.setState({sizeClass:Ut(e)})}}UNSAFE_componentWillReceiveProps(e){if(this.props.type!==e.type)throw new Error("WidgetContainer can't change widget type; set a different key instead to recreate the container.")}shouldComponentUpdate(e,n){return this.props.shouldHighlight!==e.shouldHighlight||this.props.type!==e.type||this.state.widgetProps!==n.widgetProps||this.state.sizeClass!==n.sizeClass}render(){let e=fe({"perseus-widget-container":!0,"widget-highlight":this.props.shouldHighlight,"widget-nohighlight":!this.props.shouldHighlight,"perseus-widget__definition":this.props.type==="definition"});const n=this.props.type,t=xt(n);if(t==null)return console.warn(`Widget type '${n}' not found!`),y.jsx("div",{className:e});let a=this.state.widgetProps.alignment;a==="default"&&(a=St(n)),e+=" widget-"+a;const i=this.state.widgetProps.apiOptions,o=this.state.widgetProps.static||i.readOnly,s={position:"relative",overflow:"visible"},l={width:"100%",height:"100%",position:"absolute",top:0,left:0,zIndex:Pn},u=Mt(n)?this.props.linterContext:{...this.props.linterContext,highlightLint:!1};return y.jsx("div",{className:e,style:o?s:{},children:y.jsx(wn.Consumer,{children:({analytics:m})=>y.jsxs(S,{metadata:{widget_type:n,widget_id:this.props.id},onError:()=>{m.onAnalyticsEvent({type:"perseus:widget-rendering-error",payload:{widgetType:n,widgetId:this.props.id}})},children:[y.jsx(t,{...this.state.widgetProps,linterContext:u,containerSizeClass:this.state.sizeClass,ref:this.widgetRef}),o&&y.jsx("div",{style:l})]})})})}};Ne.defaultProps={linterContext:He};let ue=Ne;ue.__docgenInfo={description:"",methods:[{name:"getWidget",docblock:null,modifiers:[],params:[],returns:null},{name:"replaceWidgetProps",docblock:null,modifiers:[],params:[{name:"newWidgetProps",optional:!1,type:null}],returns:null}],displayName:"WidgetContainer",props:{shouldHighlight:{required:!0,tsType:{name:"boolean"},description:""},type:{required:!0,tsType:{name:"string"},description:""},id:{required:!0,tsType:{name:"string"},description:""},initialProps:{required:!0,tsType:{name:"intersection",raw:`RenderProps & {
...
}`,signature:{properties:[{key:"content",value:{name:"string",required:!0}},{key:"alignment",value:{name:"string",required:!0}},{key:"coordinates",value:{name:"ReadonlyArray",elements:[{name:"number"}],raw:"ReadonlyArray<number>",required:!0}}]}}],raw:"ReadonlyArray<PerseusImageLabel>",required:!1}},{key:"range",value:{name:"tuple",raw:"[Interval, Interval]",elements:[{name:"Interval"},{name:"Interval"}],required:!1}},{key:"box",value:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}],required:!0}}]}},{name:"signature",type:"object",raw:`{
    answerType?:
        | "number"
        | "decimal"
        | "integer"
...
}`,signature:{properties:[{key:"editableSettings",value:{name:"ReadonlyArray",elements:[{name:"union",raw:'"canvas" | "graph"',elements:[{name:"literal",value:'"canvas"'},{name:"literal",value:'"graph"'}]}],raw:'ReadonlyArray<"canvas" | "graph">',required:!1}},{key:"box",value:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}],required:!0}},{key:"labels",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!0}},{key:"range",value:{name:"tuple",raw:"[Interval, Interval]",elements:[{name:"Interval"},{name:"Interval"}],required:!0}},{key:"gridStep",value:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}],required:!0}},{key:"markings",value:{name:"union",raw:'"graph" | "grid" | "none"',elements:[{name:"literal",value:'"graph"'},{name:"literal",value:'"grid"'},{name:"literal",value:'"none"'}],required:!0},description:`The type of markings to display on the graph.
- graph: shows the axes and the grid lines
- grid: shows only the grid lines
...
| PerseusGraphTypeSinusoid`,elements:[{name:"signature",type:"object",raw:`{
    ...
    // production data that still has this.
    coord?: Coord; // Legacy!
}`,signature:{properties:[{key:"coord",value:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}],required:!0}}]}}]}],required:!1}},{key:"correct",value:{name:"union",raw:`| PerseusGraphTypeAngle
| PerseusGraphTypeCircle
| PerseusGraphTypeLinear
| PerseusGraphTypeLinearSystem
| PerseusGraphTypeNone
...
| PerseusGraphTypeSinusoid`,elements:[{name:"signature",type:"object",raw:`{
    ...
    // production data that still has this.
    coord?: Coord; // Legacy!
}`,signature:{properties:[{key:"coord",value:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}],required:!0}}]}}]}],required:!1}},{key:"lockedFigures",value:{name:"ReadonlyArray",elements:[{name:"union",raw:`| LockedPointType
| LockedLineType
| LockedVectorType
| LockedEllipseType
| LockedPolygonType
...
field.`},{key:"metadata",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!1}},{key:"images",value:{name:"signature",type:"object",raw:`{
    ...
    summaryText: string;
}`,signature:{properties:[{key:"passageNumber",value:{name:"number",required:!0}},{key:"referenceNumber",value:{name:"number",required:!0}},{key:"summaryText",value:{name:"string",required:!0}}]}},{name:"signature",type:"object",raw:`{
...
| PerseusGraphTypeSinusoid`,elements:[{name:"signature",type:"object",raw:`{
    ...
    // production data that still has this.
    coord?: Coord; // Legacy!
}`,signature:{properties:[{key:"coord",value:{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}],required:!0}}]}}]}],required:!1}}]}},name:"arg1"},{type:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},name:"callback"},{type:{name:"boolean"},name:"silent"}],return:{name:"unknown"}},required:!0}},{key:"trackInteraction",value:{name:"signature",type:"function",raw:"(extraData?: TrackingExtraArgs) => void",signature:{arguments:[{type:{name:"Empty"},name:"extraData"}],return:{name:"void"}},required:!0}},{key:"isLastUsedWidget",value:{name:"boolean",required:!0}},{key:"linterContext",value:{name:"signature",type:"object",raw:`{
    contentType: string;
    highlightLint: boolean;
    paths: ReadonlyArray<string>;
    stack: ReadonlyArray<string>;
...
}`,computed:!1}}}};const Ht=/\S/,Kt=/(web\+graphie|https):\/\/[^\s]*/,B=()=>{},Ve=["content","problemNum","widgets"],se=r=>"container:"+r,Xt=function(r,e){return r===null||e===null?r===e:g.every(r,(n,t)=>{if(e!=null)return g.isEqual(n,e[t])})},de=class de extends j.Component{constructor(e){super(e),this._widgetContainers=new Map,this.getApiOptions=()=>({...vn.defaults,...this.props.apiOptions}),this._getInitialWidgetState=n=>{const t=Ee(n.widgets);return{widgetInfo:t,widgetProps:this._getAllWidgetsStartProps(t,n)}},this._getAllWidgetsStartProps=(n,t)=>{var l;const{apiOptions:a,problemNum:i}=t,o={},{strings:s}=this.props;return gn(n).forEach(([u,m])=>{o[u]=Et(m,s,i)}),(l=a==null?void 0:a.onWidgetStartProps)==null||l.call(a,o),o},this._getDefaultWidgetInfo=n=>{const t=qn.rTypeFromWidgetId.exec(n);return t==null?{}:{type:t[1],graded:!0,options:{}}},this._getWidgetInfo=n=>this.state.widgetInfo[n]||this._getDefaultWidgetInfo(n),this.renderWidget=(n,t,a)=>{const i=this.state.widgetInfo[t];if(i&&i.alignment==="full-width"&&(a.foundFullWidth=!0),i){const o=i&&i.type||n,s=g.contains(this.props.highlightedWidgets,t);return y.jsx(ue,{id:t,ref:l=>{const u=se(t);l!=null?this._widgetContainers.set(u,l):this._widgetContainers.delete(u)},type:o,initialProps:this.getWidgetProps(t),shouldHighlight:s,linterContext:Or(this.props.linterContext,"widget")},se(t))}return null},this.getSerializedState=n=>ve(n||this.state.widgetProps,(t,a)=>{const i=this.getWidgetInstance(a);return i&&i.getSerializedState?i.getSerializedState():t}),this.restoreSerializedState=(n,t)=>{const a=g.keys(n),i=g.keys(this.state.widgetProps);if(a.length!==i.length||g.intersection(a,i).length!==a.length){K.error("Refusing to restore bad serialized state:",R.Internal,{loggedMetadata:{serializedState:JSON.stringify(n),currentProps:JSON.stringify(this.state.widgetProps)}});return}let o=1;const s=()=>{--o,t&&o===0&&t()};this.setState({widgetProps:ve(n,(l,u)=>{const m=this.getWidgetInstance(u);if(m&&m.restoreSerializedState){++o;const p=m.restoreSerializedState(l,s);return g.extend({},this.state.widgetProps[u],p)}return l})},()=>{setTimeout(s,0)})},this.showRationalesForCurrentlySelectedChoices=()=>{Object.keys(this.props.widgets).forEach(n=>{const t=this.getWidgetInstance(n);t&&t.showRationalesForCurrentlySelectedChoices&&t.showRationalesForCurrentlySelectedChoices(this._getWidgetInfo(n).options)})},this.deselectIncorrectSelectedChoices=()=>{Object.keys(this.props.widgets).forEach(n=>{const t=this.getWidgetInstance(n);t&&t.deselectIncorrectSelectedChoices&&t.deselectIncorrectSelectedChoices()})},this.findInternalWidgets=n=>{let t;if(typeof n=="string")if(n.indexOf(" ")!==-1){const i=n;t=(o,s,l)=>o===i}else{const i=n;t=(o,s,l)=>s.type===i}else t=n;return this.widgetIds.filter(i=>{const o=this._getWidgetInfo(i),s=this.getWidgetInstance(i);return t(i,o,s)}).map(this.getWidgetInstance)},this.findWidgets=n=>[...this.findInternalWidgets(n),...this.props.findExternalWidgets(n)],this.getWidgetInstance=n=>{const t=this._widgetContainers.get(se(n));return t?t.getWidget():null},this._onWidgetFocus=(n,t=[])=>{if(!g.isArray(t))throw new E("widget props.onFocus focusPath must be an Array, but was"+JSON.stringify(t),R.Internal);this._setCurrentFocus([n].concat(t))},this._onWidgetBlur=(n,t)=>{const a=this._currentFocus,i=[n].concat(t);g.isEqual(i,a)&&g.defer(()=>{g.isEqual(this._currentFocus,a)&&this._setCurrentFocus(null)})},this.getContent=(n,t)=>t.jiptContent||n.content,this.shouldRenderJiptPlaceholder=(n,t)=>Y().JIPT.useJIPT&&t.jiptContent==null&&n.content.indexOf("crwdns")!==-1,this.replaceJiptContent=(n,t)=>{if(t==null)this.setState({jiptContent:n});else{/^\s*(`{3,}|~{3,})\s*(\S+)?\s*\n([\s\S]+?)\s*\1\s*$/.test(n)||(/\S\n\s*\n\S/.test(n)?n="$\\large{\\red{\\text{Please translate each paragraph to a single paragraph.}}}$":/^\s*$/.test(n)&&(n="$\\large{\\red{\\text{Translated paragraph is currently empty}}}$"));const i=this.getContent(this.props,this.state),o=_e.parseToArray(i);o[t]=n,this.setState({jiptContent:_e.joinFromArray(o)})}},this.outputMarkdown=(n,t)=>{if(g.isArray(n)){const o=t.key,s=[];let l=!1;for(let u=0;u<n.length;u++){t.key=u,t.paragraphIndex=u;const m=this.outputMarkdown(n[u],t),p=typeof m=="string";typeof m=="string"&&l?s[s.length-1]+=m:s.push(m),l=p}return t.key=o,s}this._foundTextNodes=!1,t.foundFullWidth=!1;const a=this.outputNested(n,t);let i;return this.translationIndex!=null?i=null:i=fe({"perseus-paragraph-centered":!this._foundTextNodes,"perseus-paragraph-full-width":t.foundFullWidth&&n.content.length===1}),y.jsx(tn,{className:i,translationIndex:this.translationIndex,paragraphIndex:t.paragraphIndex,inline:this.props.inline,children:y.jsx(S,{children:a})},t.key)},this.outputNested=(n,t)=>{if(g.isArray(n)){const a=t.key,i=[];let o=!1;for(let s=0;s<n.length;s++){t.key=s;const l=this.outputNested(n[s],t),u=typeof l=="string";typeof l=="string"&&o?i[i.length-1]+=l:i.push(l),o=u}return t.key=a,i}return this.outputNode(n,this.outputNested,t)},this.outputNode=(n,t,a)=>{const i=this.getApiOptions(),o=i.imagePlaceholder;if(n.type==="widget"){const s=i.widgetPlaceholder;return s||(this._foundTextNodes=!0,this.widgetIds.includes(n.id)?y.jsx("span",{className:"renderer-widget-error",children:["Widget [[","☃"," ",n.id,"]] already exists."].join("")},a.key):(this.widgetIds.push(n.id),this.renderWidget(n.widgetType,n.id,a)))}if(n.type==="blockMath"){const s=Gt(n.content),l={overflowX:"auto",overflowY:"hidden",paddingTop:10,paddingBottom:10,marginTop:-10,marginBottom:-10};if(i.isMobile){const m={marginLeft:-16,marginRight:-16},p={paddingLeft:16,paddingRight:16},b={...l,...ze.mobileZoomableParentFix};return y.jsx("div",{className:"perseus-block-math",style:m,children:y.jsx(S,{children:y.jsx("div",{className:"perseus-block-math-inner",style:{...b,...p},children:y.jsx(fn,{children:s})})})},a.key)}return y.jsx("div",{className:"perseus-block-math",children:y.jsx(S,{children:y.jsx("div",{className:"perseus-block-math-inner",style:l,children:y.jsx(ye.Consumer,{children:({setAssetStatus:u})=>y.jsx(Se,{setAssetStatus:u,children:s})})})})},a.key)}if(n.type==="math"){const s=n.content.replace(/\{align[*]?\}/g,"{aligned}");return y.jsx("span",{style:{whiteSpace:"nowrap"},children:y.jsxs(S,{children:[y.jsx("span",{}),y.jsx(ye.Consumer,{children:({setAssetStatus:l})=>y.jsx(Se,{onRender:this.props.onRender,setAssetStatus:l,children:s})}),y.jsx("span",{})]})},a.key)}if(n.type==="image"){if(o)return o;const s=g.has(this.props.images,n.target)?this.props.images[n.target]:null,l=!a.inTable;return y.jsx(S,{children:y.jsx(ye.Consumer,{children:({setAssetStatus:u})=>y.jsx(hn,{setAssetStatus:u,src:D.sanitizeUrl(n.target),alt:n.alt,title:n.title,responsive:l,onUpdate:this.props.onRender,zoomToFullSizeOnMobile:i.isMobile&&i.isArticle,...s})})},a.key)}if(n.type==="columns")return this._isTwoColumn=!0,y.jsx(S,{children:D.ruleOutput(n,t,a)},a.key);if(n.type==="text")return Ht.test(n.content)&&(this._foundTextNodes=!0),o&&Kt.test(n.content)?o:n.content;if(n.type==="table"||n.type==="titledTable"){const s=D.ruleOutput(n,t,{...a,isMobile:i.isMobile,inTable:!0});if(!i.isMobile)return s;const l=16,u={marginLeft:-l,marginRight:-l},p={...{paddingLeft:0,paddingRight:0},...ze.mobileZoomableParentFix},b=y.jsx("div",{style:{...p,overflowX:"auto"},children:y.jsx(S,{children:y.jsx(bn,{animateHeight:!0,children:s})})});return y.jsx("div",{style:u,children:b})}return y.jsx(S,{children:D.ruleOutput(n,t,a)},a.key)},this.handleRender=n=>{const t=this.props.onRender,a=n.onRender;if(t!==B||a!==B){const i=yn(we.findDOMNode(this)).find("img");a!==B&&i.off("load",a),t!==B&&i.on("load",t)}t()},this._setCurrentFocus=n=>{const t=this.getApiOptions();if(!Xt(n,this._currentFocus)){const a=this._currentFocus;a&&this.blurPath(a),this._currentFocus=n,t.onFocusChange(this._currentFocus,a)}},this.focus=()=>{var a;let n,t;for(let i=0;i<this.widgetIds.length;i++){const o=this.widgetIds[i],s=this.getWidgetInstance(o),l=(a=s==null?void 0:s.focus)==null?void 0:a.call(s);if(l){n=o,t=l;break}}if(n){let i;return typeof t=="object"?(i=[n].concat(t.path||[]),K.error("Renderer received a focus result of type 'object' instead of the expected type 'boolean'",R.Internal,{loggedMetadata:{focusResult:JSON.stringify(t),currentProps:JSON.stringify(this.state.widgetProps)}})):i=[n],this._setCurrentFocus(i),!0}},this.getDOMNodeForPath=n=>{const t=g.first(n),a=g.rest(n),i=this.getWidgetInstance(t);if(i!=null&&i.getDOMNodeForPath)return i.getDOMNodeForPath(a);if(a.length===0)return we.findDOMNode(i)},this.getInputPaths=()=>{const n=[];return this.widgetIds.forEach(t=>{const a=this.getWidgetInstance(t);a&&a.getInputPaths&&a.getInputPaths().forEach(o=>{const s=[t].concat(o);n.push(s)})}),n},this.focusPath=n=>{var o;if(g.isEqual(this._currentFocus,n))return;this._currentFocus&&this.blurPath(this._currentFocus);const t=g.first(n),a=g.rest(n),i=this.getWidgetInstance(t);(o=i==null?void 0:i.focusInputPath)==null||o.call(i,a)},this.blurPath=n=>{var o;if(!g.isEqual(this._currentFocus,n))return;const t=g.first(n),a=g.rest(n);if(this.getWidgetInstance(t)){const s=this.getWidgetInstance(t);(o=s==null?void 0:s.blurInputPath)==null||o.call(s,a)}},this.blur=()=>{this._currentFocus&&this.blurPath(this._currentFocus)},this.serialize=()=>{const n={};return g.each(this.state.widgetInfo,function(t,a){const o=this.getWidgetInstance(a).serialize();g.isEmpty(o)||(n[a]=o)},this),n},this._setWidgetProps=(n,t,a,i)=>{this.setState(o=>{const s={...o.widgetProps,[n]:{...o.widgetProps[n],...t}},l=i?o.lastUsedWidgetId:n;return i||this.props.onSerializedStateUpdated(this.getSerializedState(s)),{lastUsedWidgetId:l,widgetProps:s}},()=>{setTimeout(()=>{const o=a&&a();i||this.props.onInteractWithWidget(n),o!==!1&&this._setCurrentFocus([n])},0)})},this.setInputValue=(n,t,a)=>{var l;const i=g.first(n),o=g.rest(n),s=this.getWidgetInstance(i);(l=s==null?void 0:s.setInputValue)==null||l.call(s,o,t,a)},this.getWidgetIds=()=>this.widgetIds,this.guessAndScore=()=>{const n=this.getUserInput(),t=this.score();return[n,t]},this.handletranslationLintErrors=n=>{this._isMounted&&this.setState({translationLintErrors:n})},this._translationLinter=new Dt,this.state={jiptContent:null,translationLintErrors:[],lastUsedWidgetId:null,...this._getInitialWidgetState(e)}}componentDidMount(){this._isMounted=!0,this.handleRender({}),this._currentFocus=null,this.props.serializedState&&this.restoreSerializedState(this.props.serializedState),this.props.linterContext.highlightLint&&this._translationLinter.runLinter(this.props.content,this.handletranslationLintErrors)}UNSAFE_componentWillReceiveProps(e){g.isEqual(g.pick(this.props,Ve),g.pick(e,Ve))||this.setState(this._getInitialWidgetState(e))}shouldComponentUpdate(e,n){if(this.props.alwaysUpdate)return!0;const t=!g.isEqual(this.state,n);return!g.isEqual(this.props,e)||t}UNSAFE_componentWillUpdate(e,n){const t=this.shouldRenderJiptPlaceholder(this.props,this.state),a=this.shouldRenderJiptPlaceholder(e,n),i=this.getContent(this.props,this.state),o=this.getContent(e,n),s=this.props.highlightedWidgets,l=e.highlightedWidgets;this.reuseMarkdown=!t&&!a&&i===o&&g.isEqual(this.state.translationLintErrors,n.translationLintErrors)&&(!this.props.linterContext.highlightLint||g.isEqual(this.props.widgets,e.widgets))&&this.props.linterContext.highlightLint===e.linterContext.highlightLint&&s===l}componentDidUpdate(e,n){this.handleRender(e),this.widgetIds.forEach(t=>{const a=this._widgetContainers.get(se(t));a==null||a.replaceWidgetProps(this.getWidgetProps(t))}),this.props.serializedState&&!g.isEqual(this.props.serializedState,this.getSerializedState())&&this.restoreSerializedState(this.props.serializedState),this.props.linterContext.highlightLint&&this._translationLinter.runLinter(this.props.content,this.handletranslationLintErrors)}componentWillUnmount(){this.widgetIds=[],this.translationIndex!=null&&Y().rendererTranslationComponents.removeComponentAtIndex(this.translationIndex),this._isMounted=!1}getWidgetProps(e){const n=this.getApiOptions(),t=this.state.widgetProps[e]||{},a=this.state.widgetInfo[e],i=this.props.reviewMode&&a?a.options:null;this._interactionTrackers||(this._interactionTrackers={});let o=this._interactionTrackers[e];return o||(o=this._interactionTrackers[e]=new Sr(n.trackInteraction,a&&a.type,e,Lt(a&&a.type))),{...t,widgetId:e,alignment:a&&a.alignment,static:a==null?void 0:a.static,problemNum:this.props.problemNum,apiOptions:this.getApiOptions(),keypadElement:this.props.keypadElement,questionCompleted:this.props.questionCompleted,showSolutions:this.props.showSolutions,onFocus:g.partial(this._onWidgetFocus,e),onBlur:g.partial(this._onWidgetBlur,e),findWidgets:this.findWidgets,reviewModeRubric:i,reviewMode:this.props.reviewMode,onChange:(s,l,u=!1)=>{this._setWidgetProps(e,s,l,u)},trackInteraction:o.track,isLastUsedWidget:e===this.state.lastUsedWidgetId}}emptyWidgets(){return Ft(this.state.widgetInfo,this.widgetIds,this.getUserInputMap(),this.props.strings,this.context.locale)}getUserInput(){return this.widgetIds.map(e=>{const n=this.getWidgetInstance(e);if(n&&n.getUserInput)return n.getUserInput()})}getUserInputMap(){const e={};return this.widgetIds.forEach(n=>{const t=this.getWidgetInstance(n);t!=null&&t.getUserInputMap?e[n]=t.getUserInputMap():t!=null&&t.getUserInput&&(e[n]=t.getUserInput())}),e}getPromptJSON(){const{content:e}=this.props,n={};return this.widgetIds.forEach(t=>{var i;const a=this.getWidgetInstance(t);n[t]=((i=a==null?void 0:a.getPromptJSON)==null?void 0:i.call(a))||{}}),{content:e,widgets:n}}score(){const e=ln(this.state.widgetInfo,this.widgetIds,this.getUserInputMap(),this.props.strings,this.context.locale);return an(e)}render(){const e=this.getApiOptions();if(this.reuseMarkdown)return this.lastRenderedMarkdown;const n=this.getContent(this.props,this.state);if(this.widgetIds=[],this.shouldRenderJiptPlaceholder(this.props,this.state)&&(this.translationIndex||(this.translationIndex=Y().rendererTranslationComponents.addComponent(this)),!e.isArticle))return y.jsx(ke,{children:y.jsx("div",{"data-perseus-component-index":this.translationIndex,children:n})});this._isTwoColumn=!1;const t=this.props.inline?D.parseInline(n,{isJipt:this.translationIndex!=null}):D.parse(n,{isJipt:this.translationIndex!=null});if(this.props.linterContext.highlightLint){const o={content:this.props.content,widgets:this.props.widgets,...this.props.linterContext};Ir(t,o,!0),this._translationLinter.applyLintErrors(t,[...this.state.translationLintErrors,...this.props.legacyPerseusLint||[]])}const a=this.outputMarkdown(t,{baseElements:e.baseElements}),i=fe({[ce.RENDERER]:!0,[ce.RESPONSIVE_RENDERER]:!0,[ce.TWO_COLUMN_RENDERER]:this._isTwoColumn});return this.lastRenderedMarkdown=y.jsx(ke,{children:y.jsx("div",{className:i,children:a})}),this.lastRenderedMarkdown}};de.contextType=cn,de.defaultProps={content:"",widgets:{},images:{},highlightedWidgets:[],questionCompleted:!1,showSolutions:"none",onRender:B,onInteractWithWidget:function(){},findExternalWidgets:()=>[],alwaysUpdate:!1,reviewMode:!1,serializedState:null,onSerializedStateUpdated:()=>{},linterContext:He};let Pe=de;const ze={mobileZoomableParentFix:{transform:"translate3d(0,0,0)"}};Pe.__docgenInfo={description:"",methods:[{name:"getApiOptions",docblock:null,modifiers:[],params:[],returns:null},{name:"_getInitialWidgetState",docblock:null,modifiers:[],params:[{name:"props",optional:!1,type:{name:"intersection",raw:`Partial<React.ContextType<typeof DependenciesContext>> & {
...
the linter and any warnings will be highlighted in the rendered output.`},{key:"legacyPerseusLint",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!1}},{key:"widgets",value:{name:"signature",raw:'PerseusRenderer["widgets"]',required:!0}},{key:"inline",value:{name:"boolean",required:!1},description:"Skip adding paragraph class"},{key:"strings",value:{name:"signature",type:"object",raw:`{
    ...
    x: string;
    y: string;
}`,signature:{properties:[{key:"num",value:{name:"number",required:!0}},{key:"x",value:{name:"string",required:!0}},{key:"y",value:{name:"string",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}},{key:"srInteractiveElements",value:{name:"signature",type:"function",raw:"({elements}: {elements: string}) => string",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{elements: string}",signature:{properties:[{key:"elements",value:{name:"string",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}},{key:"srNoInteractiveElements",value:{name:"string",required:!0}},{key:"selectAnAnswer",value:{name:"string",required:!0}}]},required:!0}}]}}],alias:"Props"}}],returns:null},{name:"_getAllWidgetsStartProps",docblock:null,modifiers:[],params:[{name:"allWidgetInfo",optional:!1,type:null},{name:"props",optional:!1,type:null}],returns:null},{name:"_getDefaultWidgetInfo",docblock:null,modifiers:[],params:[{name:"widgetId",optional:!1,type:{name:"string"}}],returns:null},{name:"_getWidgetInfo",docblock:null,modifiers:[],params:[{name:"widgetId",optional:!1,type:{name:"string"}}],returns:{type:{name:"union",raw:`| CategorizerWidget
| CSProgramWidget
| DefinitionWidget
| DropdownWidget
| ExplanationWidget
...
| TableWidget
| VideoWidget
| AutoCorrectWidget`,elements:[{name:"signature",type:"object",raw:`{
...
the linter and any warnings will be highlighted in the rendered output.`},{key:"legacyPerseusLint",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!1}},{key:"widgets",value:{name:"signature",raw:'PerseusRenderer["widgets"]',required:!0}},{key:"inline",value:{name:"boolean",required:!1},description:"Skip adding paragraph class"},{key:"strings",value:{name:"signature",type:"object",raw:`{
    ...
    x: string;
    y: string;
}`,signature:{properties:[{key:"num",value:{name:"number",required:!0}},{key:"x",value:{name:"string",required:!0}},{key:"y",value:{name:"string",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}},{key:"srInteractiveElements",value:{name:"signature",type:"function",raw:"({elements}: {elements: string}) => string",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{elements: string}",signature:{properties:[{key:"elements",value:{name:"string",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}},{key:"srNoInteractiveElements",value:{name:"string",required:!0}},{key:"selectAnAnswer",value:{name:"string",required:!0}}]},required:!0}}]}}],alias:"Props"}},{name:"state",optional:!1,type:{name:"signature",type:"object",raw:`{
...
the linter and any warnings will be highlighted in the rendered output.`},{key:"legacyPerseusLint",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!1}},{key:"widgets",value:{name:"signature",raw:'PerseusRenderer["widgets"]',required:!0}},{key:"inline",value:{name:"boolean",required:!1},description:"Skip adding paragraph class"},{key:"strings",value:{name:"signature",type:"object",raw:`{
    ...
    x: string;
    y: string;
}`,signature:{properties:[{key:"num",value:{name:"number",required:!0}},{key:"x",value:{name:"string",required:!0}},{key:"y",value:{name:"string",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}},{key:"srInteractiveElements",value:{name:"signature",type:"function",raw:"({elements}: {elements: string}) => string",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{elements: string}",signature:{properties:[{key:"elements",value:{name:"string",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}},{key:"srNoInteractiveElements",value:{name:"string",required:!0}},{key:"selectAnAnswer",value:{name:"string",required:!0}}]},required:!0}}]}}],alias:"Props"}}],returns:null},{name:"_setCurrentFocus",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"focus",docblock:null,modifiers:[],params:[],returns:null},{name:"getDOMNodeForPath",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"getInputPaths",docblock:null,modifiers:[],params:[],returns:null},{name:"focusPath",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"blurPath",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"blur",docblock:null,modifiers:[],params:[],returns:null},{name:"serialize",docblock:null,modifiers:[],params:[],returns:null},{name:"emptyWidgets",docblock:`Returns an array of widget ids that are empty (meaning widgets where the
...
| {
    ...
    total: number;
    message?: string | null | undefined;
}`,signature:{properties:[{key:"type",value:{name:"literal",value:'"points"',required:!0}},{key:"earned",value:{name:"number",required:!0}},{key:"total",value:{name:"number",required:!0}},{key:"message",value:{name:"union",raw:"string | null | undefined",elements:[{name:"string"},{name:"null"},{name:"undefined"}],required:!1}}]}}]}},description:"Scores the content."},{name:"guessAndScore",docblock:"@deprecated use scorePerseusItem",modifiers:[],params:[],returns:null,description:null},{name:"handletranslationLintErrors",docblock:null,modifiers:[],params:[{name:"lintErrors",optional:!1,type:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",alias:"ReadonlyArray"}}],returns:null}],displayName:"Renderer",props:{content:{defaultValue:{value:'""',computed:!1},required:!1},widgets:{defaultValue:{value:"{}",computed:!1},required:!1},images:{defaultValue:{value:"{}",computed:!1},required:!1},highlightedWidgets:{defaultValue:{value:"[]",computed:!1},required:!1},questionCompleted:{defaultValue:{value:"false",computed:!1},required:!1},showSolutions:{defaultValue:{value:'"none"',computed:!1},required:!1},onRender:{defaultValue:{value:"() => {}",computed:!1},required:!1},onInteractWithWidget:{defaultValue:{value:"function () {}",computed:!1},required:!1},findExternalWidgets:{defaultValue:{value:"() => []",computed:!1},required:!1},alwaysUpdate:{defaultValue:{value:"false",computed:!1},required:!1},reviewMode:{defaultValue:{value:"false",computed:!1},required:!1},serializedState:{defaultValue:{value:"null",computed:!1},required:!1},onSerializedStateUpdated:{defaultValue:{value:"() => {}",computed:!1},required:!1},linterContext:{defaultValue:{value:`{
    contentType: "",
    highlightLint: false,
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{ca as D,_e as J,D as P,Pe as R,h as S,fa as a,Ra as b,wa as c,va as d,ka as e,Ta as f,Nt as g,Aa as h,St as i,It as j,Gt as k,He as l,kt as m,Ca as n,z as o,Or as p,qa as q,ba as r,Pa as s,ha as t,Ot as u,vt as v,xt as w,ln as x,an as y,O as z};
