...
}`,computed:!1},required:!1},onRendered:{defaultValue:{value:"(isRendered: boolean) => {}",computed:!1},required:!1}}};rn.__docgenInfo={description:"",methods:[],displayName:"ref"};const tn={type:"content"},qe={type:"hint"},an={type:"tags"},Pe=n=>({type:"array",elementShape:n}),sn=n=>({type:"object",shape:n}),on=Pe(qe),W={content:tn,hint:qe,hints:on,tags:an,arrayOf:Pe,shape:sn};class O{constructor(e,r,i){this.content=e,this.hint=r,this.tags=i,this.array=z}setContentMapper(e){return new O(e,this.hint,this.tags)}setHintMapper(e){return new O(this.content,e,this.tags)}setTagsMapper(e){return new O(this.content,this.hint,e)}setArrayMapper(e){return new de(this.content,this.hint,this.tags,e)}mapTree(e,r){return V(e,r,[],this)}}class de{constructor(e,r,i,s){this.content=e,this.hint=r,this.tags=i,this.array=s}setArrayMapper(e){return new de(this.content,this.hint,this.tags,e)}mapTree(e,r){return V(e,r,[],this)}}function z(n){return n}function M(){return new O(z,z,z)}function V(n,e,r,i){if(e.type==="content"){const s=n;return i.content(s,e,r)}if(e.type==="hint"){const s=n;return i.hint(s,e,r)}if(e.type==="tags"){const s=n;return i.tags(s,e,r)}if(e.type==="array"){const s=n;if(!Array.isArray(s))throw new x(`Invalid object of type "${typeof s}" found at path ${["<root>"].concat(r).join(".")}. Expected array.`,j.Internal);const g=e.elementShape,c=s.map((p,R)=>V(p,g,r.concat(R),i));return i.array(c,s,e,r)}if(e.type==="object"){const s=n;if(s&&typeof s!="object")throw new x(`Invalid object of type "${typeof s}" found at path ${["<root>"].concat(r).join(".")}. Expected "object" type.`,j.InvalidInput);const g=e.shape;if(!g)throw new x(`Unexpected shape ${JSON.stringify(e)} at path ${["<root>"].concat(r).join(".")}.`,j.InvalidInput);const c={};return Object.keys(g).forEach(p=>{if(!(p in s))throw new x(`Key "${p}" is missing from shape at path ${["<root>"].concat(r).join(".")}.`,j.InvalidInput);c[p]=V(s[p],g[p],r.concat(p),i)}),c}throw new x(`unexpected shape type ${e.type}`,j.InvalidInput)}function Ce(n){if(n.type==="content")return{__type:"content",content:"",images:{},widgets:{}};if(n.type==="hint")return{__type:"hint",replace:!1,content:"",images:{},widgets:{}};if(n.type==="tags")return[];if(n.type==="array")return[];if(n.type==="object"){const e=n.shape,r={};return Object.keys(e).forEach(i=>{r[i]=Ce(e[i])}),r}throw new x(`unexpected shape type ${n.type}`,j.InvalidInput)}function Kr(n){return un(Ce(n))}function Jr(n,e,r){const i=Q(n);M().setContentMapper(r).mapTree(i,e)}function Br(n,e,r){const i=Q(n);M().setHintMapper(r).mapTree(i,e)}function Xr(n){const e=Q(n);return oe(e)}function oe(n){if(Array.isArray(n))return n.length?typeof n[0]=="string"?W.tags:W.arrayOf(oe(n[0])):W.arrayOf(W.content);if(typeof n=="object"&&(n.__type==="content"||n.__type==="item"))return W.content;if(typeof n=="object"&&n.__type==="hint")return W.hint;if(typeof n=="object"){const e={};return Object.keys(n).forEach(r=>{e[r]=oe(n[r])}),W.shape(e)}throw new x(`unexpected multi-item node ${JSON.stringify(n)}`,j.InvalidInput)}function Q(n){return n._multi}function un(n){return{_multi:n}}var Ae=function(n){return n===Object(n)},Se=function(){for(var n={},e=0;e<arguments.length;e++){var r=arguments[e];if(r)for(var i in r)n[i]=r[i]}return n},_=function(n){return Ae(n)?Array.isArray(n)?n.slice():Se(n):n},L=function(n){if(Array.isArray(n))return ln;if(Ae(n))return dn;if(typeof n=="string")return mn},k=function(n){if(n instanceof k)return n;if(!(this instanceof k))return new k(n);var e=L(n);this._wrapped=e.thaw?e.thaw(n):n};k.prototype.freeze=function(){var n=this._wrapped,e=L(n);return e.freeze?e.freeze(n):n};k.prototype.zoom=function(n){return this._zoomStack===void 0&&(this._zoomStack=[]),this._zoomStack.push({zoom:n,wrapped:this._wrapped}),this._wrapped=k(this._wrapped).get(n),this};k.prototype.deZoom=function(){var n=this._zoomStack.pop();return this._wrapped=k(n.wrapped).set(n.zoom,this._wrapped).freeze(),this};k.prototype.get=function(n){for(var e=this._wrapped,r=0;r<n.length;r++)e=L(e).get(e,n[r]);return e};k.prototype.mod=function(n,e){var r=this._wrapped,i=_(r),s=L(r);if(n.length===0)this._wrapped=e(this._wrapped);else if(n.length===1)this._wrapped=s.mod(i,n[0],e);else{var g=n[0],c=n.slice(1);i[g]=k(r[g]).mod(c,e).freeze(),this._wrapped=i}return this};k.prototype.merge=function(n,e){return this._wrapped=k(this._wrapped).mod(n,function(r){return Se(r,e)}).freeze(),this};k.prototype.del=function(n){var e=this._wrapped,r=L(e);if(n.length===1)this._wrapped=r.del(e,n[0]);else{var i=n[0],s=n.slice(1),g=_(e);g[i]=k(e[i]).del(s).freeze(),this._wrapped=g}return this};k.prototype.set=function(n,e){return this.mod(n,function(){return e})};const ln={get:function(n,e){return n[e]},set:function(n,e,r){var i=n.splice();return i[e]=r,i},mod:function(n,e,r){var i=n.slice();return i[e]=r(n[e]),i},del:function(n,e){var r=n.slice();return r.splice(e,1),r}},dn={get:function(n,e){return n[e]},set:function(n,e,r){var i=_(n);return i[e]=r,i},mod:function(n,e,r){var i=_(n);return i[e]=r(n[e]),i},del:function(n,e){var r=_(n);return delete r[e],r}},mn={get:function(n,e){return n[e]},set:function(n,e,r){var i=n.splice();return i[e]=r,i},mod:function(n,e,r){var i=n.splice();return i[e]=r(n[e]),i},del:function(n,e){var r=n.slice();return r.splice(e),r}},he=class he extends Y.Component{constructor(e){super(e),this._handleSerializedStateUpdated=(r,i)=>{const{onSerializedStateUpdated:s}=this.props;if(s){const g=this._getSerializedState(this.props.serializedState);s(k(g).set(r,i).freeze())}},this.rendererDataTreeMapper=M().setContentMapper((r,i,s)=>this._makeContentRendererData(r,s)).setHintMapper(r=>this._makeHintRendererData(r)).setTagsMapper(r=>null),this.getRenderersMapper=M().setContentMapper(r=>r.makeRenderer()).setHintMapper(r=>r.makeRenderer()).setArrayMapper((r,i,s)=>this._annotateRendererArray(r,i,s)),this.state=this._tryMakeRendererState(this.props)}UNSAFE_componentWillReceiveProps(e){e.item!==this.props.item&&this.setState(this._tryMakeRendererState(e))}_tryMakeRendererState(e){try{return{rendererDataTree:this._makeRendererDataTree(e.item,e.shape),renderError:null}}catch(r){return Je.error("Error building tree state",j.Internal,{cause:r}),{rendererDataTree:null,renderError:r}}}_getRendererProps(){const{item:e,children:r,shape:i,serializedState:s,onSerializedStateUpdated:g,...c}=this.props;return{...c,strings:this.context.strings}}_makeContentRendererData(e,r){const i={ref:null,makeRenderer:null},s=p=>i.ref=p,g=p=>this._findWidgets(i,p),c=p=>this._handleSerializedStateUpdated(r,p);return i.makeRenderer=()=>q.jsx(ke,{...this._getRendererProps(),...e,ref:s,findExternalWidgets:g,serializedState:this.props.serializedState?k(this.props.serializedState).get(r):null,onSerializedStateUpdated:c}),i}_makeHintRendererData(e){const r=i=>this._findWidgets({},i);return{hint:e,findExternalWidgets:r,ref:null,makeRenderer:()=>q.jsx(se,{...this._getRendererProps(),findExternalWidgets:r,hints:[e]})}}_makeRendererDataTree(e,r){const i=Q(e);return this.rendererDataTreeMapper.mapTree(i,r)}_findWidgets(e,r){const i=[];return this._mapRenderers(s=>{e!==s&&s.ref&&i.push(...s.ref.findInternalWidgets(r))}),i}_mapRenderers(e){const{rendererDataTree:r}=this.state;return r?M().setContentMapper(e).setHintMapper(e).mapTree(r,this.props.shape):null}_scoreFromRef(e){if(!e)return null;const[r,i]=e.guessAndScore();let s;return e.getSerializedState&&(s=e.getSerializedState()),ie(i,r,s)}getScores(){return this._mapRenderers(e=>this._scoreFromRef(e.ref))}score(){const e=[],r=[],i=this._mapRenderers(g=>{var c;return g.ref?(g.ref.getSerializedState&&r.push(g.ref.getSerializedState()),e.push(g.ref.score()),(c=g.ref)==null?void 0:c.getUserInput()):null}),s=e.reduce(Ue);return ie(s,i,r)}_getSerializedState(e){return this._mapRenderers((r,i,s)=>r.ref?r.ref.getSerializedState():e?k(e).get(s):null)}restoreSerializedState(e,r){let i=0;const s=()=>{i--,r&&i===0&&r()};this._mapRenderers((g,c,p)=>{var P;if(!g.ref)return;const R=k(e).get(p);R&&(i++,(P=g.ref)==null||P.restoreSerializedState(R,s))})}_annotateRendererArray(e,r,i){if(i.elementShape.type==="hint"){const s=r;e=[...e],e.firstN=g=>q.jsx(se,{...this._getRendererProps(),findExternalWidgets:s[0]?s[0].findExternalWidgets:void 0,hints:s.map(c=>c.hint),hintsVisible:g})}return e}_getRenderers(){return this.getRenderersMapper.mapTree(this.state.rendererDataTree,this.props.shape)}render(){return this.state.renderError?q.jsx("div",{className:X.css(pn.error),children:this.context.strings.errorRendering({error:String(this.state.renderError)})}):q.jsx(Re.Provider,{value:this.props.dependencies,children:this.props.children({renderers:this._getRenderers()})})}};he.contextType=Te;let ue=he;const pn=X.StyleSheet.create({error:{color:"red"}});ue.__docgenInfo={description:"",methods:[{name:"_tryMakeRendererState",docblock:"Attempt to build a State that includes a renderer tree corresponding to\nthe item provided in props. On error, return a state with `renderError`\nset instead.",modifiers:[],params:[{name:"props",optional:!1,type:{name:"signature",type:"object",raw:`{
    item: Item;
    shape: Shape;
...
the available choices.`}]}}],raw:`Readonly<{
     ...
     */
    onWidgetStartProps?: (widgets: PerseusWidgetsMap) => void;
}>`},description:""},reviewMode:{required:!1,tsType:{name:"union",raw:"boolean | null | undefined",elements:[{name:"boolean"},{name:"null"},{name:"undefined"}]},description:""},dependencies:{required:!0,tsType:{name:"PerseusDependenciesV2"},description:""}}};function Ie(n){return{type:"success",value:n}}function me(n){return{type:"failure",detail:n}}function C(n){return n.type==="failure"}function K(n){return n.type==="success"}function cn(n,e=r=>r){const r=[],i=[];for(const s of n)s.type==="success"?r.push(s.value):i.push(s.detail);return i.length>0?me(i.reduce(e)):Ie(r)}const H=(n,e)=>e.success(n);function m(n){return(e,r)=>{if(!Array.isArray(e))return r.failure("array",e);const i=e.map((s,g)=>n(s,r.forSubtree(g)));return cn(i,gn)}}function gn(n,e){return[...n,...e]}function l(n,e){return typeof n=="boolean"?e.success(n):e.failure("boolean",n)}function d(n){return(e,r)=>e!==n?r.failure(String(JSON.stringify(n)),e):r.success(n)}function f(...n){return(e,r)=>{if(typeof e=="string"){const s=n.indexOf(e);if(s>-1)return r.success(n[s])}const i=n.map(s=>JSON.stringify(s));return r.failure(i,e)}}function pe(n){return n!=null&&Object.getPrototypeOf(n)===Object.prototype}function w(n){return(e,r)=>e===null?r.success(e):n(e,r)}const u=(n,e)=>typeof n=="number"?e.success(n):e.failure("number",n);function o(n){return(e,r)=>{if(!pe(e))return r.failure("object",e);const i={...e},s=[];for(const[g,c]of Object.entries(n)){const p=c(e[g],r.forSubtree(g));K(p)?i[g]=p.value:s.push(...p.detail)}return s.length>0?me(s):r.success(i)}}function t(n){return(e,r)=>e===void 0?r.success(e):n(e,r)}function b(n,e){return(r,i)=>{if(!Array.isArray(r))return i.failure("array",r);if(r.length!==2)return i.failure("array of length 2",r);const[s,g]=r,c=n(s,i.forSubtree(0));if(C(c))return c;const p=e(g,i.forSubtree(1));return C(p)?p:i.success([c.value,p.value])}}function G(n){return new ce(n)}class ce{constructor(e){this.parser=e}then(e){return new ce(yn(this.parser,e))}}function yn(n,e){return(r,i)=>{const s=n(r,i);return C(s)?s:e(s.value,i)}}function ge(n,e){return(r,i)=>{if(!pe(r))return i.failure("object",r);const s={},g=[];for(const[c,p]of Object.entries(r)){const R=i.forSubtree(c),P=n(c,R);C(P)&&g.push(...P.detail);const S=e(p,R);C(S)&&g.push(...S.detail),K(P)&&K(S)&&(s[P.value]=S.value)}return g.length>0?me(g):i.success(s)}}const a=(n,e)=>typeof n=="string"?e.success(n):e.failure("string",n);function J(n,e,r){return(i,s)=>{if(!Array.isArray(i))return s.failure("array",i);if(i.length!==3)return s.failure("array of length 3",i);const g=n(i[0],s.forSubtree(0));if(C(g))return g;const c=e(i[1],s.forSubtree(1));if(C(c))return c;const p=r(i[2],s.forSubtree(2));return C(p)?p:s.success([g.value,c.value,p.value])}}function T(n){return new ye(n)}class ye{constructor(e){this.parser=e}or(e){return new ye(hn(this.parser,e))}}function hn(n,e){return(r,i)=>{const s=n(r,i);return K(s)?s:e(r,i)}}function v(n,e){return(r,i)=>r==null?Ie(e(r)):n(r,i)}const je=v(ge(a,o({width:u,height:u})),()=>({}));function h(n,e){return o({type:n,static:t(l),graded:t(l),alignment:t(a),options:e,key:t(u),version:t(o({major:u,minor:u}))})}function We(n,e,r){return o({type:e,static:t(l),graded:t(l),alignment:t(a),options:r,key:t(u),version:n})}const fn=h(d("categorizer"),o({items:m(a),categories:m(a),randomizeItems:l,static:v(l,()=>!1),values:m(u),highlightLint:t(l),linterContext:t(o({contentType:a,paths:m(a),stack:m(a)}))})),wn=h(d("cs-program"),o({programID:a,programType:H,settings:m(o({name:a,value:a})),showEditor:l,showButtons:l,width:u,height:u,static:l})),bn=h(d("definition"),o({togglePrompt:a,definition:a,static:v(l,()=>!1)})),vn=h(d("dropdown"),o({placeholder:a,ariaLabel:t(a),visibleLabel:t(a),static:v(l,()=>!1),choices:m(o({content:a,correct:l}))})),kn=h(d("explanation"),o({showPrompt:a,hidePrompt:a,explanation:a,widgets:(n,e)=>U(n,e),static:l})),Tn=o({value:a,form:l,simplify:l,considered:f("correct","wrong","ungraded"),key:G(t(T(a).or(u).parser)).then((n,e)=>e.success(String(n))).parser}),Rn=We(o({major:d(1),minor:u}),d("expression"),o({answerForms:m(Tn),functions:m(a),times:l,visibleLabel:t(a),ariaLabel:t(a),buttonSets:m(f("basic","basic+div","trig","prealgebra","logarithms","basic relations","advanced relations")),buttonsVisible:t(f("always","never","focused"))})),qn=We(t(o({major:d(0),minor:u})),d("expression"),o({functions:m(a),times:l,visibleLabel:t(a),ariaLabel:t(a),form:l,simplify:l,value:a,buttonSets:m(f("basic","basic+div","trig","prealgebra","logarithms","basic relations","advanced relations")),buttonsVisible:t(f("always","never","focused"))}));function Pn(n,e){const{options:r}=n;return e.success({...n,version:{major:1,minor:0},options:{times:r.times,buttonSets:r.buttonSets,functions:r.functions,buttonsVisible:r.buttonsVisible,visibleLabel:r.visibleLabel,ariaLabel:r.ariaLabel,answerForms:[{considered:"correct",form:r.form,simplify:r.simplify,value:r.value}]}})}const Cn=T(Rn).or(G(qn).then(Pn).parser).parser,Z=v(o({content:v(a,()=>""),widgets:v((n,e)=>U(n,e),()=>({})),metadata:t(m(a)),images:je}),()=>({content:"",widgets:{},images:{}})),xe=o({title:v(a,()=>""),hasHint:t(w(l)),hint:t(w((n,e)=>Z(n,e))),content:a,widgets:(n,e)=>U(n,e),widgetEnabled:t(w(l)),immutableWidgets:t(w(l)),images:ge(a,o({width:u,height:u}))}),An=h(d("graded-group"),xe),Sn=h(d("graded-group-set"),o({gradedGroups:m(xe)})),I=b(u,u),A=b(I,I),In=h(d("grapher"),o({availableTypes:m(f("absolute_value","exponential","linear","logarithm","quadratic","sinusoid","tangent")),correct:T(o({type:d("absolute_value"),coords:A})).or(o({type:d("exponential"),asymptote:A,coords:A})).or(o({type:d("linear"),coords:A})).or(o({type:d("logarithm"),asymptote:A,coords:A})).or(o({type:d("quadratic"),coords:A})).or(o({type:d("sinusoid"),coords:A})).or(o({type:d("tangent"),coords:A})).parser,graph:o({backgroundImage:o({bottom:t(u),height:t(u),left:t(u),scale:t(u),url:t(w(a)),width:t(u)}),box:t(I),editableSettings:t(m(f("graph","snap","image","measure"))),gridStep:t(I),labels:b(a,a),markings:f("graph","none","grid"),range:b(I,I),rulerLabel:d(""),rulerTicks:u,showProtractor:t(l),showRuler:t(l),showTooltips:t(l),snapStep:t(I),step:I,valid:t(T(l).or(a).parser)})})),jn=h(d("group"),(n,e)=>Z(n,e)),Wn=h(d("iframe"),o({url:a,settings:m(o({name:a,value:a})),width:T(u).or(a).parser,height:T(u).or(a).parser,allowFullScreen:l,allowTopNavigation:t(l),static:v(l,()=>!1)})),xn=(n,e)=>{if(typeof n=="number")return e.success(n);const r=+n;return n===""||isNaN(r)?e.failure("a number or numeric string",n):e.success(r)},F=G(T(u).or(a).parser).then(xn).parser,ee=o({url:t(w(a)),width:t(F),height:t(F),top:t(F),left:t(F),bottom:t(F),scale:t(F)}),te=b(u,u),En=h(d("image"),o({title:t(a),caption:t(a),alt:t(a),backgroundImage:ee,static:t(l),labels:t(m(o({content:a,alignment:a,coordinates:m(u)}))),range:t(b(te,te)),box:t(te)})),Nn=(n,e)=>typeof n=="boolean"?e.success(String(n)):e.failure("boolean",n),Fn=h(d("input-number"),o({answerType:t(f("number","decimal","integer","rational","improper","mixed","percent","pi")),inexact:t(l),maxError:t(T(u).or(a).parser),rightAlign:t(l),simplify:f("required","optional","enforced"),size:f("normal","small"),value:T(u).or(a).or(Nn).parser,customKeypad:t(l)})),D=b(u,u),Dn=o({type:d("function"),key:a,options:o({value:a,funcName:a,rangeMin:a,rangeMax:a,color:a,strokeDasharray:a,strokeWidth:u})}),On=o({type:d("label"),key:a,options:o({label:a,color:a,coordX:a,coordY:a})}),Mn=o({type:d("line"),key:a,options:o({color:a,startX:a,startY:a,endX:a,endY:a,strokeDasharray:a,strokeWidth:u,arrows:a})}),_n=o({type:d("movable-line"),key:a,options:o({startX:a,startY:a,startSubscript:u,endX:a,endY:a,endSubscript:u,constraint:a,snap:u,constraintFn:a,constraintXMin:a,constraintXMax:a,constraintYMin:a,constraintYMax:a})}),Hn=o({type:d("movable-point"),key:a,options:o({startX:a,startY:a,varSubscript:u,constraint:a,snap:u,constraintFn:a,constraintXMin:a,constraintXMax:a,constraintYMin:a,constraintYMax:a})}),Ln=o({type:d("parametric"),key:a,options:o({x:a,y:a,rangeMin:a,rangeMax:a,color:a,strokeDasharray:a,strokeWidth:u})}),Gn=o({type:d("point"),key:a,options:o({color:a,coordX:a,coordY:a})}),Un=o({type:d("rectangle"),key:a,options:o({color:a,coordX:a,coordY:a,width:a,height:a})}),zn=h(d("interaction"),o({static:l,graph:o({editableSettings:t(m(f("canvas","graph"))),box:D,labels:m(a),range:b(D,D),gridStep:D,markings:f("graph","grid","none"),snapStep:t(D),valid:t(T(l).or(a).parser),backgroundImage:t(ee),showProtractor:t(l),showRuler:t(l),rulerLabel:t(a),rulerTicks:t(u),tickStep:D}),elements:m(T(Dn).or(On).or(Mn).or(_n).or(Hn).or(Ln).or(Gn).or(Un).parser)})),y=b(u,u),we=o({type:d("angle"),showAngles:t(l),allowReflexAngles:t(l),angleOffsetDeg:t(u),snapDegrees:t(u),match:t(d("congruent")),coords:t(J(y,y,y)),startCoords:t(J(y,y,y))}),$n=o({type:d("circle"),center:t(y),radius:t(u),startCoords:t(o({center:y,radius:u})),coord:t(y)}),Vn=o({type:d("linear"),coords:t(w(b(y,y))),startCoords:t(b(y,y)),coord:t(y)}),Kn=o({type:d("linear-system"),coords:t(w(m(b(y,y)))),startCoords:t(m(b(y,y))),coord:t(y)}),Jn=o({type:d("none")}),Bn=o({type:d("point"),numPoints:t(T(u).or(d("unlimited")).parser),coords:t(w(m(y))),startCoords:t(m(y)),coord:t(y)}),Xn=o({type:d("polygon"),numSides:t(T(u).or(d("unlimited")).parser),showAngles:t(l),showSides:t(l),snapTo:t(f("grid","angles","sides")),match:t(f("similar","congruent","approx")),startCoords:t(m(y)),coord:t(y)}),Yn=o({type:d("quadratic"),coords:t(w(J(y,y,y))),startCoords:t(J(y,y,y)),coord:t(y)}),Qn=o({type:d("ray"),coords:t(w(b(y,y))),startCoords:t(b(y,y)),coord:t(y)}),Zn=o({type:d("segment"),numSegments:t(u),coords:t(w(m(b(y,y)))),startCoords:t(m(b(y,y))),coord:t(y)}),er=o({type:d("sinusoid"),coords:t(w(m(y))),startCoords:t(m(y)),coord:t(y)}),be=T(we).or(we).or($n).or(Vn).or(Kn).or(Jn).or(Bn).or(Xn).or(Yn).or(Qn).or(Zn).or(er).parser,E=f(...De),Ee=f("none","white","translucent","solid"),ne=f("solid","dashed"),N=o({type:d("label"),coord:y,text:a,color:E,size:f("small","medium","large")}),le=o({type:d("point"),coord:y,color:E,filled:l,labels:t(m(N)),ariaLabel:t(a)}),nr=o({type:d("line"),kind:f("line","ray","segment"),points:b(le,le),color:E,lineStyle:ne,showPoint1:l,showPoint2:l,labels:t(m(N)),ariaLabel:t(a)}),rr=o({type:d("vector"),points:b(y,y),color:E,labels:t(m(N)),ariaLabel:t(a)}),tr=o({type:d("ellipse"),center:y,radius:y,angle:u,color:E,fillStyle:Ee,strokeStyle:ne,labels:t(m(N)),ariaLabel:t(a)}),ar=o({type:d("polygon"),points:m(y),color:E,showVertices:l,fillStyle:Ee,strokeStyle:ne,labels:t(m(N)),ariaLabel:t(a)}),ir=o({type:d("function"),color:E,strokeStyle:ne,equation:a,directionalAxis:f("x","y"),domain:t(y),labels:t(m(N)),ariaLabel:t(a)}),sr=T(le).or(nr).or(rr).or(tr).or(ar).or(ir).or(N).parser,or=h(d("interactive-graph"),o({step:y,gridStep:t(y),snapStep:t(y),backgroundImage:t(ee),markings:f("graph","grid","none"),labels:t(m(a)),showProtractor:l,showRuler:t(l),showTooltips:t(l),rulerLabel:t(a),rulerTicks:t(u),range:b(y,y),graph:v(be,()=>({type:"linear"})),correct:be,lockedFigures:t(m(sr)),fullGraphLabel:t(a),fullGraphAriaDescription:t(a)})),ur=h(d("label-image"),o({choices:m(a),imageUrl:a,imageAlt:a,imageHeight:u,imageWidth:u,markers:m(o({answers:m(a),label:a,x:u,y:u})),hideChoicesFromInstructions:l,multipleAnswers:l,static:l})),lr=h(d("matcher"),o({labels:m(a),left:m(a),right:m(a),orderMatters:l,padding:l})),dr=h(v(d("matrix"),()=>"matrix"),o({prefix:t(a),suffix:t(a),answers:m(m(u)),cursorPosition:t(m(u)),matrixBoardSize:m(u),static:t(l)})),mr=h(d("measurer"),o({image:ee,showProtractor:l,showRuler:l,rulerLabel:a,rulerTicks:u,rulerPixels:u,rulerLength:u,box:b(u,u),static:l})),pr=h(d("molecule-renderer"),o({widgetId:a,rotationAngle:t(u),smiles:t(a)})),cr=h(d("number-line"),o({range:m(u),labelRange:m(w(u)),labelStyle:a,labelTicks:l,isTickCtrl:t(w(l)),divisionRange:m(u),numDivisions:t(w(u)),snapDivisions:v(u,()=>2),tickStep:t(w(u)),correctRel:t(w(a)),correctX:u,initialX:t(w(u)),showTooltip:t(l),static:l})),ve=f("integer","mixed","improper","proper","decimal","percent","pi"),gr=h(d("numeric-input"),o({answers:m(o({message:a,value:t(u),status:a,answerForms:t(m(ve)),strict:l,maxError:t(w(u)),simplify:t(w(a))})),labelText:t(a),size:a,coefficient:l,rightAlign:t(l),static:v(l,()=>!1),answerForms:t(m(o({name:ve,simplify:t(w(f("required","correct","enforced","optional")))})))}));function ae(n,e){return Z(n,e)}const yr=(n,e)=>n==="large"?e.success("auto"):e.success(n),hr=h(d("orderer"),o({options:v(m(ae),()=>[]),correctOptions:m(ae),otherOptions:m(ae),height:G(f("normal","auto","large")).then(yr).parser,layout:v(f("horizontal","vertical"),()=>"horizontal")})),fr=h(d("passage-ref"),o({passageNumber:u,referenceNumber:u,summaryText:a})),wr=h(d("passage"),o({footnotes:a,passageText:a,passageTitle:a,showLineNumbers:l,static:v(l,()=>!1)})),br=h(d("phet-simulation"),o({url:a,description:a})),vr=h(d("plotter"),o({labels:m(a),categories:m(a),type:f(...Oe),maxY:u,scaleY:u,labelInterval:t(w(u)),snapsPerLine:u,starting:m(u),correct:m(u),picUrl:t(w(a)),picSize:t(w(u)),picBoxHeight:t(w(u)),plotDimensions:v(m(u),()=>[380,300])})),kr=h(d("python-program"),o({programID:a,height:u})),Tr=h(d("radio"),o({choices:m(o({content:v(a,()=>""),clue:t(a),correct:t(l),isNoneOfTheAbove:t(l),widgets:t((n,e)=>U(n,e))})),hasNoneOfTheAbove:t(l),countChoices:t(l),randomize:t(l),multipleSelect:t(l),deselectEnabled:t(l),onePerLine:t(l),displayCount:t(H),noneOfTheAbove:t(d(!1))})),Rr=h(d("sorter"),o({correct:m(a),padding:l,layout:f("horizontal","vertical")})),qr=h(d("table"),o({headers:m(a),rows:u,columns:u,answers:m(m(a))})),Pr=h(d("video"),o({location:a,static:t(l)})),U=(n,e)=>{if(!pe(n))return e.failure("PerseusWidgetsMap",n);const r={};for(const i of Object.keys(n)){const s=Cr([i,n[i]],r,e.forSubtree(i));if(C(s))return s}return e.success(r)},Cr=([n,e],r,i)=>{const s=Ir(n.split(" "),i);if(C(s))return s;const[g,c]=s.value;function p(R,P){const S=P(e,i);return C(S)?S:(r[R]=S.value,i.success(void 0))}switch(g){case"categorizer":return p(`categorizer ${c}`,fn);case"cs-program":return p(`cs-program ${c}`,wn);case"definition":return p(`definition ${c}`,bn);case"dropdown":return p(`dropdown ${c}`,vn);case"explanation":return p(`explanation ${c}`,kn);case"expression":return p(`expression ${c}`,Cn);case"grapher":return p(`grapher ${c}`,In);case"group":return p(`group ${c}`,jn);case"graded-group":return p(`graded-group ${c}`,An);case"graded-group-set":return p(`graded-group-set ${c}`,Sn);case"iframe":return p(`iframe ${c}`,Wn);case"image":return p(`image ${c}`,En);case"input-number":return p(`input-number ${c}`,Fn);case"interaction":return p(`interaction ${c}`,zn);case"interactive-graph":return p(`interactive-graph ${c}`,or);case"label-image":return p(`label-image ${c}`,ur);case"matcher":return p(`matcher ${c}`,lr);case"matrix":return p(`matrix ${c}`,dr);case"measurer":return p(`measurer ${c}`,mr);case"molecule-renderer":return p(`molecule-renderer ${c}`,pr);case"number-line":return p(`number-line ${c}`,cr);case"numeric-input":return p(`numeric-input ${c}`,gr);case"orderer":return p(`orderer ${c}`,hr);case"passage":return p(`passage ${c}`,wr);case"passage-ref":return p(`passage-ref ${c}`,fr);case"passage-ref-target":return p(`passage-ref-target ${c}`,H);case"phet-simulation":return p(`phet-simulation ${c}`,br);case"plotter":return p(`plotter ${c}`,vr);case"python-program":return p(`python-program ${c}`,kr);case"radio":return p(`radio ${c}`,Tr);case"sorter":return p(`sorter ${c}`,Rr);case"table":return p(`table ${c}`,qr);case"video":return p(`video ${c}`,Pr);case"sequence":return p(`sequence ${c}`,Ar);default:return ze(g)?p(`${g} ${c}`,H):i.failure("a valid widget type",g)}},Ar=h((n,e)=>e.success("deprecated-standin"),o({})),Sr=(n,e)=>typeof n!="string"||!/^[1-9][0-9]*$/.test(n)?e.failure("numeric string",n):e.success(+n),Ir=b(a,Sr),jr=o({replace:t(l),content:a,widgets:v(U,()=>({})),metadata:t(m(a)),images:je});o({question:Z,hints:v(m(jr),()=>[]),answerArea:G(v(o({}),()=>({}))).then(Wr).then(ge(f(...Me),l)).parser,itemDataVersion:t(o({major:u,minor:u})),answer:H});function Wr(n,e){const{type:r,options:i,...s}=n;return e.success(s)}export{ue as M,$ as S,Br as a,Kr as b,Ye as c,M as d,Q as e,Jr as f,Ce as g,Xr as i,k as l,rn as r,W as s};
