import{cL as a}from"./iframe-B7jCOty_.js";import{S as g}from"./server-item-renderer-with-debug-ui-Bjf5Wzf5.js";import"./split-view-DShA4TOb.js";import"./test-keypad-context-wrapper-B43RCEQl.js";import"./server-item-renderer-DsVgY6_U.js";import"./hints-renderer-CEDzZJBN.js";const p={content:`[[☃ passage 1]]
...
The authors characterized the rates of sequence evolution within mitochondrial DNA to establish the evolutionary relationships between the different eagle species. Their analysis places Haast's eagle in the same evolutionary lineage as a group of small eagle species in the genus _Hieraaetus_. Surprisingly, the genetic distance separating the giant eagle and its more diminutive _Hieraaetus_ cousins from their last {{common}} ancestor is relatively small.
`,passageTitle:"Passage 1",showLineNumbers:!0,static:!1},static:!1,type:"passage",version:{major:0,minor:0}}}},N={title:"Perseus/Widgets/Passage",component:g},e={args:{item:a({question:p})}},t={args:{item:a({question:m})}},s={args:{item:a({question:f})}};var i,o,n;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
...
}`,...(u=(c=s.parameters)==null?void 0:c.docs)==null?void 0:u.source}}};const k=["SimpleQuestion","MultiPassageQuestion","SingleNumberedPassage"];export{t as MultiPassageQuestion,e as SimpleQuestion,s as SingleNumberedPassage,k as __namedExportsOrder,N as default};
