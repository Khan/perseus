import{j as e}from"./jsx-runtime-63Ea5SlK.js";import{B as l}from"./choice-Xr-SKHrB.js";import{V as r}from"./index-0DbkllkJ.js";import{P as b}from"./index-469F30Ub.js";import{S as v}from"./index-nqMmpXbO.js";import{S as w}from"./article-renderer-JIlzqaPM.js";import{H as u}from"./index-18qWGOW7.js";import{r as s}from"./index-6oxdNXpR.js";import{S as f,R as d}from"./side-by-side-MBJuyilC.js";import"./jquery-yG1GhClm.js";import"./util-AYeX86gl.js";import"./phet-simulation-_7qOO4_B.js";import"./version-akiLXZts.js";import"./dependencies-CP7Uh8Kq.js";import"./perseus-api-1-ethIrW.js";import"./perseus-item-YhL5oSPz.js";import"./hints-renderer-mroHfjtV.js";import{R as k}from"./renderer-6G9zNccl.js";import"./base-radio-AH6_jTIn.js";import"./button-group-G5CZaedn.js";import"./graph-ASQAtWJc.js";import"./svg-image-8VV-_RGO.js";import"./hud-ifw9Ofbw.js";import"./icon-7RFbyLiL.js";import"./index-BIPwuHvF.js";import"./inline-icon-6fh0Wu1y.js";import"./math-input-ILg8RrvB.js";import"./multi-button-group-QUVHbBcE.js";import"./number-input-ogh82yD8.js";import"./range-input-w5Z3sPK5.js";import"./text-input-5e4vF1bl.js";import"./text-list-editor-aj1SAzcA.js";import"./index-k-0mNqHS.js";import{u as q}from"./i18n-context-fsWEgybQ.js";import{r as T}from"./register-all-widgets-for-testing-T8ZmPb9R.js";import"./index-smZ6iCr_.js";const R=""+new URL("device-mobile-o16X2EYh.svg",import.meta.url).href,A=({question:t,apiOptions:y,reviewMode:m=!1,...g})=>{T();const n=s.useRef(null),[a,h]=s.useState(null),[i,p]=s.useState(!1),{strings:c}=q();return e.jsx(f,{leftTitle:e.jsxs(r,{style:{flexDirection:"row",alignItems:"center",width:"100%"},children:["Widget",e.jsx(r,{style:{marginLeft:"auto"},children:e.jsx(w,{icon:e.jsx(b,{icon:R}),checked:i,onChange:p})})]}),left:e.jsxs(r,{children:[e.jsx(r,{className:i?"perseus-mobile":"",children:e.jsx(k,{ref:n,content:t.content,images:t.images,widgets:t.widgets,problemNum:0,apiOptions:{...y,isMobile:i},reviewMode:m,strings:c,...g})}),e.jsxs(r,{style:{flexDirection:"row",alignItems:"center"},children:[e.jsx(l,{onClick:()=>{n.current&&h(n.current.guessAndScore())},children:"Check"}),e.jsx(v,{size:8}),e.jsx(l,{onClick:()=>{var o;(o=n.current)==null||o.showRationalesForCurrentlySelectedChoices()},children:"Show Rationales"})]}),a!=null&&e.jsxs(e.Fragment,{children:[e.jsx(u,{style:{marginTop:"10px"},children:"Guess"}),e.jsx(d,{quotesOnKeys:!1,enableClipboard:!1,src:a[0]}),e.jsx(u,{style:{marginTop:"10px"},children:"Score"}),e.jsx(d,{quotesOnKeys:!1,enableClipboard:!1,src:a[1]})]})]}),jsonObject:t})};A.__docgenInfo={description:"",methods:[],displayName:"RendererWithDebugUI",props:{question:{required:!0,tsType:{name:"signature",type:"object",raw:`{
    ...
    height: number;
}`,signature:{properties:[{key:"width",value:{name:"number",required:!0}},{key:"height",value:{name:"number",required:!0}}]},required:!0}}]},required:!0}}]}},description:""},reviewMode:{defaultValue:{value:"false",computed:!1},required:!1}}};export{A as R};
