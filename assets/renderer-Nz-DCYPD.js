import{j as c}from"./jsx-runtime-63Ea5SlK.js";import{_ as g,d as mn}from"./index-default-4_ZsnO94.js";import{a as Ie}from"./version-zYAx5FCH.js";import{P as N,E as x}from"./perseus-error-l3K_anoI.js";import{L as H,b as ve,S as gn}from"./svg-image-5xpyV1oq.js";import{g as pn}from"./_commonjsHelpers-4gQjN7DL.js";import{e as cn}from"./index-J2t_5nK1.js";import{c as ke}from"./index-dnMhQZ-1.js";import{$ as yn}from"./jquery-5v7aFUvu.js";import{r as j}from"./index-6oxdNXpR.js";import{F as qe}from"./index-9gkyvru-.js";import{c as he}from"./asset-context-H6Iqp7Gi.js";import{P as hn}from"./i18n-context-QDJ9FYgZ.js";import{T as je}from"./tex-MX5FPdQh.js";import{Z as bn}from"./zoomable-_uYFBX1Q.js";import{Z as wn}from"./zoomable-tex-Jjwex-Ep.js";import{g as $,D as fn}from"./dependencies-CP7Uh8Kq.js";import{A as vn,C as be}from"./perseus-api-_PWPZoDE.js";import{L as kn}from"./lint-CRWxUAIQ.js";import{U as qn}from"./util-FOHsj4WS.js";import{f as Tn,t as An,u as xn,z as Rn}from"./constants-iPV6vHZm.js";function Pn(){return/\[\[☃ ([A-Za-z0-9- ]+)\]\]/g}function Cn(r){const e=[],n=Pn();let t=n.exec(r);for(;t!==null;)e.push(t[1]),t=n.exec(r);return e}class K{static parse(e){return new ge(e).parse()}match(e){throw new N("Selector subclasses must implement match()",x.NotAllowed)}toString(){return"Unknown selector class"}}class ge{constructor(e){e=e.trim().replace(/\s+/g," "),this.tokens=e.match(ge.TOKENS)||[],this.tokenIndex=0}nextToken(){return this.tokens[this.tokenIndex]||""}consume(){this.tokenIndex++}isIdentifier(){const e=this.tokens[this.tokenIndex][0];return e>="a"&&e<="z"||e>="A"&&e<="Z"}skipSpace(){for(;this.nextToken()===" ";)this.consume()}parse(){const e=this.parseTreeSelector();let n=this.nextToken();if(!n)return e;const t=[e];for(;n;){if(n===",")this.consume();else throw new we("Expected comma");t.push(this.parseTreeSelector()),n=this.nextToken()}return new In(t)}parseTreeSelector(){this.skipSpace();let e=this.parseNodeSelector();for(;;){const n=this.nextToken();if(!n||n===",")break;if(n===" ")this.consume(),e=new En(e,this.parseNodeSelector());else if(n===">")this.consume(),e=new On(e,this.parseNodeSelector());else if(n==="+")this.consume(),e=new jn(e,this.parseNodeSelector());else if(n==="~")this.consume(),e=new Ln(e,this.parseNodeSelector());else throw new we("Unexpected token: "+n)}return e}parseNodeSelector(){this.skipSpace();const e=this.nextToken();if(e==="*")return this.consume(),new Sn;if(this.isIdentifier())return this.consume(),new Nn(e);throw new we("Expected node type")}}ge.TOKENS=/([a-zA-Z][\w-]*)|(\d+)|[^\s]|(\s(?=[a-zA-Z\*]))/g;class we extends Error{constructor(e){super(e)}}class In extends K{constructor(e){super(),this.selectors=e}match(e){for(let n=0;n<this.selectors.length;n++){const a=this.selectors[n].match(e);if(a)return a}return null}toString(){let e="";for(let n=0;n<this.selectors.length;n++)e+=n>0?", ":"",e+=this.selectors[n].toString();return e}}class Sn extends K{match(e){return[e.currentNode()]}toString(){return"*"}}class Nn extends K{constructor(e){super(),this.type=e}match(e){const n=e.currentNode();return n.type===this.type?[n]:null}toString(){return this.type}}class pe extends K{constructor(e,n){super(),this.left=e,this.right=n}}class En extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n)for(e=e.clone();e.hasParent();){e.goToParent();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" "+this.right.toString()}}class On extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n&&e.hasParent()){e=e.clone(),e.goToParent();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" > "+this.right.toString()}}class jn extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n&&e.hasPreviousSibling()){e=e.clone(),e.goToPreviousSibling();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" + "+this.right.toString()}}class Ln extends pe{constructor(e,n){super(e,n)}match(e){const n=this.right.match(e);if(n)for(e=e.clone();e.hasPreviousSibling();){e.goToPreviousSibling();const t=this.left.match(e);if(t)return t.concat(n)}return null}toString(){return this.left.toString()+" ~ "+this.right.toString()}}const X=class X{constructor(e,n,t,a,i,o){if(!t&&!a)throw new N("Lint rules must have a selector or pattern",x.InvalidInput,{metadata:{name:e}});this.name=e||"unnamed rule",this.severity=n||X.Severity.BULK_WARNING,this.selector=t||X.DEFAULT_SELECTOR,this.pattern=a||null,typeof i=="function"?(this.lint=i,this.message=null):(this.lint=(...s)=>this._defaultLintFunction(...s),this.message=i),this.applies=o||function(){return!0}}static makeRule(e){return new X(e.name,e.severity,e.selector?K.parse(e.selector):null,X.makePattern(e.pattern),e.lint||e.message,e.applies)}check(e,n,t,a){const i=this.selector.match(n);if(!i)return null;let o;if(this.pattern?o=t.match(this.pattern):o=X.FakePatternMatch(t,t,0),!o)return null;try{const s=this.lint(n,t,i,o,a);return s?typeof s=="string"?{rule:this.name,severity:this.severity,message:s,start:0,end:t.length}:{rule:this.name,severity:this.severity,message:s.message,start:s.start,end:s.end}:null}catch(s){return{rule:"lint-rule-failure",message:`Exception in rule ${this.name}: ${s.message}
Stack trace:
${s.stack}`,start:0,end:t.length}}}_defaultLintFunction(e,n,t,a,i){return{message:this.message||"",start:a.index,end:a.index+a[0].length}}static makePattern(e){if(!e)return null;if(e instanceof RegExp)return e;if(e[0]==="/"){const n=e.lastIndexOf("/"),t=e.substring(1,n),a=e.substring(n+1);return new RegExp(t,a)}return new RegExp(e)}static FakePatternMatch(e,n,t){const a=[n];return a.index=t,a.input=e,a}};X.Severity={ERROR:1,WARNING:2,GUIDELINE:3,BULK_WARNING:4};let m=X;m.DEFAULT_SELECTOR=K.parse("text");const Xn=/\/\/([^\/]+)/;function Mn(r){if(!r)return"";const e=r.match(Xn);return e?e[1]:""}const Yn=m.makeRule({name:"absolute-url",severity:m.Severity.GUIDELINE,selector:"link, image",lint:function(r,e,n,t){const a=n[0].target,i=Mn(a);if(i==="khanacademy.org"||i.endsWith(".khanacademy.org"))return`Don't use absolute URLs:
When linking to KA content or images, omit the
https://www.khanacademy.org URL prefix.
Use a relative URL beginning with / instead.`}}),Wn=m.makeRule({name:"blockquoted-math",severity:m.Severity.WARNING,selector:"blockQuote math, blockQuote blockMath",message:`Blockquoted math:
...
widgets should not be indented.`}),Gn=m.makeRule({name:"double-spacing-after-terminal",severity:m.Severity.BULK_WARNING,selector:"paragraph",pattern:/[.!\?] {2}/i,message:`Use a single space after a sentence-ending period, or
any other kind of terminal punctuation.`});function Dn(r,e){return`Answer requires a button not found in the button sets: ${r} (in ${e})`}const _n={"\\sqrt":"prealgebra","\\sin":"trig","\\cos":"trig","\\tan":"trig","\\log":"logarithms","\\ln":"logarithms"},Un=m.makeRule({name:"expression-widget",severity:m.Severity.WARNING,selector:"widget",lint:function(r,e,n,t,a){var l;if(r.currentNode().widgetType!=="expression")return;const i=r.currentNode().id;if(!i)return;const o=(l=a==null?void 0:a.widgets)==null?void 0:l[i];if(!o)return;const s=o.options.answerForms,u=o.options.buttonSets;for(const d of s)for(const[p,h]of Object.entries(_n))if(d.value.includes(p)&&!u.includes(h))return Dn(p,h)}}),Vn=m.makeRule({name:"extra-content-spacing",selector:"paragraph",pattern:/\s+$/,applies:function(r){return(r==null?void 0:r.contentType)==="article"},message:"No extra whitespace at the end of content blocks."}),zn=m.makeRule({name:"heading-level-1",severity:m.Severity.WARNING,selector:"heading",lint:function(r,e,n,t){if(n[0].level===1)return`Don't use level-1 headings:
Begin headings with two or more # characters.`}}),Hn=m.makeRule({name:"heading-level-skip",severity:m.Severity.WARNING,selector:"heading ~ heading",lint:function(r,e,n,t){const a=n[1],i=n[0];if(a.level>i.level+1)return`Skipped heading level:
this heading is level ${a.level} but
the previous heading was level ${i.level}`}}),Kn=m.makeRule({name:"heading-sentence-case",severity:m.Severity.GUIDELINE,selector:"heading",pattern:/^\W*[a-z]/,message:`First letter is lowercase:
the first letter of a heading should be capitalized.`}),Qn={and:!0,nor:!0,but:!0,the:!0,for:!0};function Bn(r){const e=r[0];return e===e.toUpperCase()}const $n=m.makeRule({name:"heading-title-case",severity:m.Severity.GUIDELINE,selector:"heading",pattern:/[^\s:]\s+[A-Z]+[a-z]/,locale:"en",lint:function(r,e,n,t){let i=e.trim().split(/\s+/);if(i.shift(),i=i.filter(o=>o.length>2&&!Qn.hasOwnProperty(o)),i.length>=3&&i.every(o=>Bn(o)))return`Title-case heading:
This heading appears to be in title-case, but should be sentence-case.
Only capitalize the first letter and proper nouns.`}}),Jn=m.makeRule({name:"image-alt-text",severity:m.Severity.WARNING,selector:"image",lint:function(r,e,n,t){const a=n[0];if(!a.alt||!a.alt.trim())return`Images should have alt text:
...
Don't include math expressions in image captions.`}}),rr=m.makeRule({name:"link-click-here",severity:m.Severity.WARNING,selector:"link",pattern:/click here/i,message:`Inappropriate link text:
Do not use the words "click here" in links.`}),tr=m.makeRule({name:"long-paragraph",severity:m.Severity.GUIDELINE,selector:"paragraph",pattern:/^.{501,}/,lint:function(r,e,n,t){return`Paragraph too long:
This paragraph is ${e.length} characters long.
Shorten it to 500 characters or fewer.`}}),ar=m.makeRule({name:"math-adjacent",severity:m.Severity.WARNING,selector:"blockMath+blockMath",message:`Adjacent math blocks:
combine the blocks between \\begin{align} and \\end{align}`}),ir=m.makeRule({name:"math-align-extra-break",severity:m.Severity.WARNING,selector:"blockMath",pattern:/(\\{2,})\s*\\end{align}/,message:`Extra space at end of block:
Don't end an align block with backslashes`}),sr=m.makeRule({name:"math-align-linebreaks",severity:m.Severity.WARNING,selector:"blockMath",pattern:/\\begin{align}[\s\S]*\\\\[\s\S]+\\end{align}/,lint:function(r,e,n,t){let a=t[0];for(;a.length;){const i=a.indexOf("\\\\");if(i===-1)return;a=a.substring(i+2);const o=a.match(/^\s*\\\\\s*(?!\\\\)/);if(!o)return"Use four backslashes between lines of an align block";a=a.substring(o[0].length)}}}),or=m.makeRule({name:"math-empty",severity:m.Severity.WARNING,selector:"math, blockMath",pattern:/^$/,message:"Empty math: don't use $$ in your markdown."}),ur=m.makeRule({name:"math-font-size",severity:m.Severity.GUIDELINE,selector:"math, blockMath",pattern:/\\(tiny|Tiny|small|large|Large|LARGE|huge|Huge|scriptsize|normalsize)\s*{/,message:`Math font size:
Don't change the default font size with \\Large{} or similar commands`}),lr=m.makeRule({name:"math-frac",severity:m.Severity.GUIDELINE,selector:"math, blockMath",pattern:/\\frac[ {]/,message:"Use \\dfrac instead of \\frac in your math expressions."}),dr=m.makeRule({name:"math-nested",severity:m.Severity.ERROR,selector:"math, blockMath",pattern:/\\text{[^$}]*\$[^$}]*\$[^}]*}/,message:`Nested math:
Don't nest math expressions inside \\text{} blocks`}),mr=m.makeRule({name:"math-starts-with-space",severity:m.Severity.GUIDELINE,selector:"math, blockMath",pattern:/^\s*(~|\\qquad|\\quad|\\,|\\;|\\:|\\ |\\!|\\enspace|\\phantom)/,message:`Math starts with space:
math should not be indented. Do not begin math expressions with
LaTeX space commands like ~, \\;, \\quad, or \\phantom`}),gr=m.makeRule({name:"math-text-empty",severity:m.Severity.WARNING,selector:"math, blockMath",pattern:/\\text{\s*}/,message:"Empty \\text{} block in math expression"}),pr=m.makeRule({name:"math-without-dollars",severity:m.Severity.GUIDELINE,pattern:/\\\w+{[^}]*}|{|}/,message:`This looks like LaTeX:
did you mean to put it inside dollar signs?`}),cr=m.makeRule({name:"nested-lists",severity:m.Severity.WARNING,selector:"list list",message:`Nested lists:
nested lists are hard to read on mobile devices;
do not use additional indentation.`}),yr=m.makeRule({name:"static-widget-in-question-stem",severity:m.Severity.WARNING,selector:"widget",lint:(r,e,n,t,a)=>{var s;if((a==null?void 0:a.contentType)!=="exercise"||a.stack.includes("hint"))return;const i=r.currentNode().id;if(!i)return;const o=(s=a==null?void 0:a.widgets)==null?void 0:s[i];if(o&&o.static)return"Widget in question stem is static (non-interactive)."}}),hr=m.makeRule({name:"table-missing-cells",severity:m.Severity.WARNING,selector:"table",lint:function(r,e,n,t){const a=n[0],i=a.header.length,o=a.cells.map(s=>s.length);for(let s=0;s<o.length;s++)if(o[s]!==i)return`Table rows don't match header:
The table header has ${i} cells, but
Row ${s+1} has ${o[s]} cells.`}}),br=m.makeRule({name:"unbalanced-code-delimiters",severity:m.Severity.ERROR,pattern:/[`~]+/,message:`Unbalanced code delimiters:
code blocks should begin and end with the same type and number of delimiters`}),wr=m.makeRule({name:"unescaped-dollar",severity:m.Severity.ERROR,selector:"unescapedDollar",message:`Unescaped dollar sign:
Dollar signs must appear in pairs or be escaped as \\$`}),fr=m.makeRule({name:"widget-in-table",severity:m.Severity.BULK_WARNING,selector:"table widget",message:`Widget in table:
do not put widgets inside of tables.`}),vr=[Yn,Wn,Fn,Gn,Un,Vn,zn,Hn,Kn,$n,Jn,Zn,rr,tr,ar,ir,sr,or,ur,lr,dr,mr,gr,cr,yr,hr,wr,fr,pr,br,er,nr];class V{constructor(e){this.root=e}static isNode(e){return e&&typeof e=="object"&&typeof e.type=="string"}static isTextNode(e){return V.isNode(e)&&e.type==="text"&&typeof e.content=="string"}traverse(e){this._traverse(this.root,new Se(this.root),e)}_traverse(e,n,t){let a="";if(V.isNode(e)){const i=e;n._containers.push(i),n._ancestors.push(i),typeof i.content=="string"&&(a=i.content),Object.keys(i).forEach(s=>{if(s==="type")return;const u=i[s];u&&typeof u=="object"&&(n._indexes.push(s),a+=this._traverse(u,n,t),n._indexes.pop())}),n._currentNode=n._ancestors.pop(),n._containers.pop(),t(i,n,a)}else if(Array.isArray(e)){const i=e;n._containers.push(i);let o=0;for(;o<i.length;)n._indexes.push(o),a+=this._traverse(i[o],n,t),o=n._indexes.pop()+1;n._containers.pop()}return a}}class Se{constructor(e){this.root=e,this._currentNode=null,this._containers=new J,this._indexes=new J,this._ancestors=new J}currentNode(){return this._currentNode||this.root}parent(){return this._ancestors.top()}ancestors(){return this._ancestors.values()}nextSibling(){const e=this._containers.top();if(!e||!Array.isArray(e))return null;const n=this._indexes.top();return e.length>n+1?e[n+1]:null}previousSibling(){const e=this._containers.top();if(!e||!Array.isArray(e))return null;const n=this._indexes.top();return n>0?e[n-1]:null}removeNextSibling(){const e=this._containers.top();if(e&&Array.isArray(e)){const n=this._indexes.top();if(e.length>n+1)return e.splice(n+1,1)[0]}return null}replace(...e){const n=this._containers.top();if(!n)throw new N("Can't replace the root of the tree",x.Internal);if(Array.isArray(n)){const t=this._indexes.top();n.splice(t,1,...e),this._indexes.pop(),this._indexes.push(t+e.length-1)}else{const t=this._indexes.top();e.length===0?delete n[t]:e.length===1?n[t]=e[0]:n[t]=e}}hasPreviousSibling(){return Array.isArray(this._containers.top())&&this._indexes.top()>0}goToPreviousSibling(){if(!this.hasPreviousSibling())throw new N("goToPreviousSibling(): node has no previous sibling",x.Internal);this._currentNode=this.previousSibling();const e=this._indexes.pop();this._indexes.push(e-1)}hasParent(){return this._ancestors.size()!==0}goToParent(){if(!this.hasParent())throw new N("goToParent(): node has no ancestor",x.NotAllowed);for(this._currentNode=this._ancestors.pop();this._containers.size()&&this._containers.top()[this._indexes.top()]!==this._currentNode;)this._containers.pop(),this._indexes.pop()}clone(){const e=new Se(this.root);return e._currentNode=this._currentNode,e._containers=this._containers.clone(),e._indexes=this._indexes.clone(),e._ancestors=this._ancestors.clone(),e}equals(e){return this.root===e.root&&this._currentNode===e._currentNode&&this._containers.equals(e._containers)&&this._indexes.equals(e._indexes)&&this._ancestors.equals(e._ancestors)}}class J{constructor(e){this.stack=e?e.slice(0):[]}push(e){this.stack.push(e)}pop(){return this.stack.pop()}top(){return this.stack[this.stack.length-1]}values(){return this.stack.slice(0)}size(){return this.stack.length}toString(){return this.stack.toString()}clone(){return new J(this.stack)}equals(e){if(!e||!e.stack||e.stack.length!==this.stack.length)return!1;for(let n=0;n<this.stack.length;n++)if(this.stack[n]!==e.stack[n])return!1;return!0}}const kr="@khanacademy/perseus-linter",qr="__lib_version__";Ie(kr,qr);var Ve={exports:{}};function ce(r){return function(){return r}}var F=function(){};F.thatReturns=ce;F.thatReturnsFalse=ce(!1);F.thatReturnsTrue=ce(!0);F.thatReturnsNull=ce(null);F.thatReturnsThis=function(){return this};F.thatReturnsArgument=function(r){return r};var Tr=F;function Ar(r,e,n,t,a,i,o,s){if(!r){var u;if(e===void 0)u=new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[n,t,a,i,o,s],d=0;u=new Error(e.replace(/%s/g,function(){return l[d++]})),u.name="Invariant Violation"}throw u.framesToPop=1,u}}var xr=Ar,Rr="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",Pr=Rr,Cr=Tr,Ir=xr,Sr=Pr,Nr=function(){function r(t,a,i,o,s,u){u!==Sr&&Ir(!1,"Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types")}r.isRequired=r;function e(){return r}var n={array:r,bool:r,func:r,number:r,object:r,string:r,symbol:r,any:r,arrayOf:e,element:r,instanceOf:e,node:r,objectOf:e,oneOf:e,oneOfType:e,shape:e,exact:e};return n.checkPropTypes=Cr,n.PropTypes=n,n};Ve.exports=Nr();var Er=Ve.exports;const Y=pn(Er);Y.shape({contentType:Y.string,highlightLint:Y.bool,paths:Y.arrayOf(Y.string),stack:Y.arrayOf(Y.string)});const ze={contentType:"",highlightLint:!1,paths:[],stack:[]},Or=vr.filter(r=>r.severity<m.Severity.BULK_WARNING);function jr(r,e,n,t=Or){const a=[],i=new V(r);i.traverse((u,l,d)=>{if(V.isTextNode(u)){let p=l.nextSibling();for(;V.isTextNode(p);)u.content+=p.content,l.removeNextSibling(),p=l.nextSibling()}});let o=[],s=!1;return i.traverse((u,l,d)=>{const p=[],h=t.filter(y=>y.applies(e)),v=[...e.stack];v.push(u.type);const A={...e,stack:v.join(".")};if(h.forEach(y=>{const f=y.check(u,l,d,A);f&&((f.start||f.end)&&(f.target=d.substring(f.start,f.end)),a.push(f),n&&p.push(f))}),!!n&&(u.type==="table"?(o.length&&p.push(...o),s=!1,o=[]):s||(s=l.ancestors().some(y=>y.type==="table")),s&&p.length&&o.push(...p),p.length))if(p.sort((y,f)=>y.severity-f.severity),u.type!=="text"||p.length>1)l.replace({type:"lint",content:u,message:p.map(y=>y.message).join(`

`),ruleName:p[0].rule,blockHighlight:A.blockHighlight,insideTable:s,severity:p[0].severity});else{const y=u.content,f=p[0],R=f.start||0,I=f.end||y.length,M=y.substring(0,R),P=y.substring(R,I),ne=y.substring(I),re=[];M&&re.push({type:"text",content:M}),re.push({type:"lint",content:{type:"text",content:P},message:f.message,ruleName:f.rule,insideTable:s,severity:f.severity}),ne&&re.push({type:"text",content:ne}),l.replace(...re)}}),a}function Lr(r,e){const n=r.stack||[];return{...r,stack:n.concat(e)}}const Xr={activeDefinitionId:null,setActiveDefinitionId:()=>{}},He=j.createContext(Xr);class Te extends j.Component{constructor(){super(...arguments),this.state={activeDefinitionId:null},this.setActiveDefinitionId=e=>{this.setState(n=>({activeDefinitionId:e}))}}render(){const{children:e}=this.props,{activeDefinitionId:n}=this.state,{setActiveDefinitionId:t}=this;return c.jsx(He.Provider,{value:{activeDefinitionId:n,setActiveDefinitionId:t},children:e})}}const fa=He.Consumer;Te.__docgenInfo={description:"",methods:[{name:"setActiveDefinitionId",docblock:null,modifiers:[],params:[{name:"activeDefinitionId",optional:!0,type:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]}}],returns:{type:{name:"void"}}}],displayName:"DefinitionProvider",props:{children:{required:!0,tsType:{name:"any"},description:""}}};class O extends j.Component{constructor(e){super(e),this.state={error:""}}componentDidCatch(e,n){var t,a;this.setState({error:e.toString()}),(a=(t=this.props).onError)==null||a.call(t,e,n),H.error("Unhandled Perseus error: "+e.message,x.Internal,{cause:e,loggedMetadata:{componentStack:n&&"componentStack"in n?n.componentStack:"componentStack not provided",...this.props.metadata}})}render(){return this.state.error?c.jsxs("svg",{height:"16",width:"16",viewBox:"0 0 16 16",role:"img",children:[c.jsx("title",{children:"Rendering Error!"}),c.jsx("path",{d:"m8 16c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm0-3c0.55 0 1-0.45 1-1s-0.45-1-1-1-1 0.45-1 1 0.45 1 1 1zm0-9c-0.55 0-1 0.45-1 1v4c0 0.55.45 1 1 1s1-0.45 1-1v-4c0-0.55-0.45-1-1-1z",fill:"#d92916",fillRule:"evenodd"})]}):this.props.children}}O.__docgenInfo={description:"",methods:[],displayName:"ErrorBoundary",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},metadata:{required:!1,tsType:{name:"Record",elements:[{name:"string"},{name:"string"}],raw:"Record<string, string>"},description:""},onError:{required:!1,tsType:{name:"signature",type:"function",raw:"(error: Error, info: any) => void",signature:{arguments:[{type:{name:"Error"},name:"error"},{type:{name:"any"},name:"info"}],return:{name:"void"}}},description:""}}};function Mr(){}class Yr{constructor(e,n,t,a){this._track=i=>{this._tracked&&!this.setting||(this._tracked=!0,this.trackApi({type:this.widgetType,id:this.widgetID,...i}))},e?(this._tracked=!1,this.trackApi=e,this.widgetType=n,this.widgetID=t,this.setting=a,this.track=this._track):this.track=Mr}}const Wr="@khanacademy/simple-markdown",Fr="__lib_version__";Ie(Wr,Fr);var Gr=/\r\n?/g,Dr=/\t/g,_r=/\f/g,Ke=function(r){return r.replace(Gr,`
`).replace(_r,"").replace(Dr,"    ")},Qe=function(r,e){var n=r||{};if(e!=null)for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&(n[t]=e[t]);return n},Be=function(r,e){var n=Object.keys(r).filter(function(o){var s=r[o];if(s==null||s.match==null)return!1;var u=s.order;return(typeof u!="number"||!isFinite(u))&&typeof console<"u"&&console.warn("simple-markdown: Invalid order for rule `"+o+"`: "+String(u)),!0});n.sort(function(o,s){var u=r[o],l=r[s],d=u.order,p=l.order;if(d!==p)return d-p;var h=u.quality?0:1,v=l.quality?0:1;return h!==v?h-v:o<s?-1:o>s?1:0});var t,a=function(o,s){var u=[];for(s=s||t,t=s;o;){var l=null,d=null,p=null,h=NaN,v=0,A=n[0],y=r[A];do{var f=y.order,R=s.prevCapture==null?"":s.prevCapture[0],I=y.match(o,s,R);if(I){var M=y.quality?y.quality(I,s,R):0;M<=h||(l=A,d=y,p=I,h=M)}v++,A=n[v],y=r[A]}while(y&&(!p||y.order===f&&y.quality));if(d==null||p==null)throw new Error("Could not find a matching rule for the below content. The rule with highest `order` should always match content provided to it. Check the definition of `match` for '"+n[n.length-1]+`'. It seems to not match the following source:
`+o);if(p.index)throw new Error("`match` must return a capture starting at index 0 (the current parse index). Did you forget a ^ at the start of the RegExp?");var P=d.parse(p,a,s);if(Array.isArray(P))Array.prototype.push.apply(u,P);else{if(P==null||typeof P!="object")throw new Error(`parse() function returned invalid parse result: '${P}'`);P.type==null&&(P.type=l),u.push(P)}s.prevCapture=p,o=o.substring(s.prevCapture[0].length)}return u},i=function(o,s){return t=Qe(s,e),!t.inline&&!t.disableAutoBlockNewlines&&(o=o+`

`),t.prevCapture=null,a(Ke(o),t)};return i},C=function(r){var e=function(n,t,a){return t.inline?r.exec(n):null};return e.regex=r,e},E=function(r){var e=function(n,t){return t.inline?null:r.exec(n)};return e.regex=r,e},Ae=function(r){var e=function(n,t){return r.exec(n)};return e.regex=r,e},Ur=typeof Symbol=="function"&&Symbol.for&&Symbol.for("react.element")||60103,k=function(r,e,n){var t={$$typeof:Ur,type:r,key:e??void 0,ref:null,props:n,_owner:null};return t},T=function(r,e,n,t){n=n||{},t=typeof t<"u"?t:!0;var a="";for(var i in n){var o=n[i];Object.prototype.hasOwnProperty.call(n,i)&&o&&(a+=" "+z(i)+'="'+z(o)+'"')}var s="<"+r+a+">";return t?s+e+"</"+r+">":s},Vr={},B=function(r){if(r==null)return null;try{var e=new URL(r,"https://localhost").protocol;if(e.indexOf("javascript:")===0||e.indexOf("vbscript:")===0||e.indexOf("data:")===0)return null}catch{return null}return r},zr=/[<>&"']/g,Hr={"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;","'":"&#x27;","/":"&#x2F;","`":"&#96;"},z=function(r){return String(r).replace(zr,function(e){return Hr[e]})},Kr=/\\([^0-9A-Za-z\s])/g,xe=function(r){return r.replace(Kr,"$1")},ue=function(r,e,n){var t=n.inline||!1;n.inline=!0;var a=r(e,n);return n.inline=t,a},Qr=function(r,e,n){var t=n.inline||!1;n.inline=!1;var a=r(e+`

`,n);return n.inline=t,a},te=function(r,e,n){return{content:ue(e,r[1],n)}},fe=function(){return{}},le="(?:[*+-]|\\d+\\.)",$e="( *)("+le+") +",Le=new RegExp("^"+$e),Br=new RegExp($e+"[^\\n]*(?:\\n(?!\\1"+le+` )[^\\n]*)*(
|$)`,"gm"),Je=/\n{2,}$/,$r=/^ (?= *`)|(` *) $/g,Jr=Je,Xe=/ *\n+$/,Zr=new RegExp("^( *)("+le+`) [\\s\\S]+?(?:
{2,}(?! )(?!\\1`+le+` )\\n*|\\s*
*$)`),et=/(?:^|\n)( *)$/,ae=function(){var r=/^ *\| *| *\| *$/g,e=/ *$/,n=/^ *-+: *$/,t=/^ *:-+: *$/,a=/^ *:-+ *$/,i=function(d){return n.test(d)?"right":t.test(d)?"center":a.test(d)?"left":null},o=function(d,p,h,v){v&&(d=d.replace(r,""));var A=d.trim().split("|");return A.map(i)},s=function(d,p,h,v){var A=h.inTable;h.inTable=!0;var y=p(d.trim(),h);h.inTable=A;var f=[[]];return y.forEach(function(R,I){R.type==="tableSeparator"?(!v||I!==0&&I!==y.length-1)&&f.push([]):(R.type==="text"&&(y[I+1]==null||y[I+1].type==="tableSeparator")&&(R.content=R.content.replace(e,"")),f[f.length-1].push(R))}),f},u=function(d,p,h,v){var A=d.trim().split(`
`);return A.map(function(y){return s(y,p,h,v)})},l=function(d){return function(p,h,v){v.inline=!0;var A=s(p[1],h,v,d),y=o(p[2],h,v,d),f=u(p[3],h,v,d);return v.inline=!1,{type:"table",header:A,align:y,cells:f}}};return{parseTable:l(!0),parseNpTable:l(!1),TABLE_REGEX:/^ *(\|.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/,NPTABLE_REGEX:/^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/}}(),ie="(?:\\[[^\\]]*\\]|[^\\[\\]]|\\](?=[^\\[]*\\]))*",Me=`\\s*<?((?:\\([^)]*\\)|[^\\s\\\\]|\\\\.)*?)>?(?:\\s+['"]([\\s\\S]*?)['"])?\\s*`,nt=/mailto:/i,Ye=function(r,e,n){var t=(r[2]||r[1]).replace(/\s+/g," ").toLowerCase();if(e._defs&&e._defs[t]){var a=e._defs[t];n.target=a.target,n.title=a.title}return e._refs=e._refs||{},e._refs[t]=e._refs[t]||[],e._refs[t].push(n),n},w=0,ee={Array:{react:function(r,e,n){for(var t=n.key,a=[],i=0,o=0;i<r.length;i++,o++){n.key=""+i;var s=r[i];if(s.type==="text")for(s={type:"text",content:s.content};i+1<r.length&&r[i+1].type==="text";i++)s.content+=r[i+1].content;a.push(e(s,n))}return n.key=t,a},html:function(r,e,n){for(var t="",a=0;a<r.length;a++){var i=r[a];if(i.type==="text")for(i={type:"text",content:i.content};a+1<r.length&&r[a+1].type==="text";a++)i.content+=r[a+1].content;t+=e(i,n)}return t}},heading:{order:w++,match:E(/^ *(#{1,6})([^\n]+?)#* *(?:\n *)+\n/),parse:function(r,e,n){return{level:r[1].length,content:ue(e,r[2].trim(),n)}},react:function(r,e,n){return k("h"+r.level,n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("h"+r.level,e(r.content,n))}},nptable:{order:w++,match:E(ae.NPTABLE_REGEX),parse:ae.parseNpTable,react:null,html:null},lheading:{order:w++,match:E(/^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/),parse:function(r,e,n){return{type:"heading",level:r[2]==="="?1:2,content:ue(e,r[1],n)}},react:null,html:null},hr:{order:w++,match:E(/^( *[-*_]){3,} *(?:\n *)+\n/),parse:fe,react:function(r,e,n){return k("hr",n.key,{"aria-hidden":!0})},html:function(r,e,n){return'<hr aria-hidden="true">'}},codeBlock:{order:w++,match:E(/^(?:    [^\n]+\n*)+(?:\n *)+\n/),parse:function(r,e,n){var t=r[0].replace(/^    /gm,"").replace(/\n+$/,"");return{lang:void 0,content:t}},react:function(r,e,n){var t=r.lang?"markdown-code-"+r.lang:void 0;return k("pre",n.key,{children:k("code",null,{className:t,children:r.content})})},html:function(r,e,n){var t=r.lang?"markdown-code-"+r.lang:void 0,a=T("code",z(r.content),{class:t});return T("pre",a)}},fence:{order:w++,match:E(/^ *(`{3,}|~{3,}) *(?:(\S+) *)?\n([\s\S]+?)\n?\1 *(?:\n *)+\n/),parse:function(r,e,n){return{type:"codeBlock",lang:r[2]||void 0,content:r[3]}},react:null,html:null},blockQuote:{order:w++,match:E(/^( *>[^\n]+(\n[^\n]+)*\n*)+\n{2,}/),parse:function(r,e,n){var t=r[0].replace(/^ *> ?/gm,"");return{content:e(t,n)}},react:function(r,e,n){return k("blockquote",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("blockquote",e(r.content,n))}},list:{order:w++,match:function(r,e){var n=e.prevCapture==null?"":e.prevCapture[0],t=et.exec(n),a=e._list||!e.inline;return t&&a?(r=t[1]+r,Zr.exec(r)):null},parse:function(r,e,n){var t=r[2],a=t.length>1,i=a?+t:void 0,o=r[0].replace(Jr,`
`).match(Br),s=!1,u=o.map(function(l,d){var p=Le.exec(l),h=p?p[0].length:0,v=new RegExp("^ {1,"+h+"}","gm"),A=l.replace(v,"").replace(Le,""),y=d===o.length-1,f=A.indexOf(`

`)!==-1,R=f||y&&s;s=R;var I=n.inline,M=n._list;n._list=!0;var P;R?(n.inline=!1,P=A.replace(Xe,`

`)):(n.inline=!0,P=A.replace(Xe,""));var ne=e(P,n);return n.inline=I,n._list=M,ne});return{ordered:a,start:i,items:u}},react:function(r,e,n){var t=r.ordered?"ol":"ul";return k(t,n.key,{start:r.start,children:r.items.map(function(a,i){return k("li",""+i,{children:e(a,n)})})})},html:function(r,e,n){var t=r.items.map(function(o){return T("li",e(o,n))}).join(""),a=r.ordered?"ol":"ul",i={start:r.start};return T(a,t,i)}},def:{order:w++,match:E(/^ *\[([^\]]+)\]: *<?([^\s>]*)>?(?: +["(]([^\n]+)[")])? *\n(?: *\n)*/),parse:function(r,e,n){var t=r[1].replace(/\s+/g," ").toLowerCase(),a=r[2],i=r[3];return n._refs&&n._refs[t]&&n._refs[t].forEach(function(o){o.target=a,o.title=i}),n._defs=n._defs||{},n._defs[t]={target:a,title:i},{def:t,target:a,title:i}},react:function(){return null},html:function(){return""}},table:{order:w++,match:E(ae.TABLE_REGEX),parse:ae.parseTable,react:function(r,e,n){var t=function(o){return r.align[o]==null?{}:{textAlign:r.align[o]}},a=r.header.map(function(o,s){return k("th",""+s,{style:t(s),scope:"col",children:e(o,n)})}),i=r.cells.map(function(o,s){return k("tr",""+s,{children:o.map(function(u,l){return k("td",""+l,{style:t(l),children:e(u,n)})})})});return k("table",n.key,{children:[k("thead","thead",{children:k("tr",null,{children:a})}),k("tbody","tbody",{children:i})]})},html:function(r,e,n){var t=function(u){return r.align[u]==null?"":"text-align:"+r.align[u]+";"},a=r.header.map(function(u,l){return T("th",e(u,n),{style:t(l),scope:"col"})}).join(""),i=r.cells.map(function(u){var l=u.map(function(d,p){return T("td",e(d,n),{style:t(p)})}).join("");return T("tr",l)}).join(""),o=T("thead",T("tr",a)),s=T("tbody",i);return T("table",o+s)}},newline:{order:w++,match:E(/^(?:\n *)*\n/),parse:fe,react:function(r,e,n){return`
`},html:function(r,e,n){return`
`}},paragraph:{order:w++,match:E(/^((?:[^\n]|\n(?! *\n))+)(?:\n *)+\n/),parse:te,react:function(r,e,n){return k("div",n.key,{className:"paragraph",children:e(r.content,n)})},html:function(r,e,n){var t={class:"paragraph"};return T("div",e(r.content,n),t)}},escape:{order:w++,match:C(/^\\([^0-9A-Za-z\s])/),parse:function(r,e,n){return{type:"text",content:r[1]}},react:null,html:null},tableSeparator:{order:w++,match:function(r,e){return e.inTable?/^ *\| */.exec(r):null},parse:function(){return{type:"tableSeparator"}},react:function(){return" | "},html:function(){return" &vert; "}},autolink:{order:w++,match:C(/^<([^: >]+:\/[^ >]+)>/),parse:function(r,e,n){return{type:"link",content:[{type:"text",content:r[1]}],target:r[1]}},react:null,html:null},mailto:{order:w++,match:C(/^<([^ >]+@[^ >]+)>/),parse:function(r,e,n){var t=r[1],a=r[1];return nt.test(a)||(a="mailto:"+a),{type:"link",content:[{type:"text",content:t}],target:a}},react:null,html:null},url:{order:w++,match:C(/^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/),parse:function(r,e,n){return{type:"link",content:[{type:"text",content:r[1]}],target:r[1],title:void 0}},react:null,html:null},link:{order:w++,match:C(new RegExp("^\\[("+ie+")\\]\\("+Me+"\\)")),parse:function(r,e,n){var t={content:e(r[1],n),target:xe(r[2]),title:r[3]};return t},react:function(r,e,n){return k("a",n.key,{href:B(r.target),title:r.title,children:e(r.content,n)})},html:function(r,e,n){var t={href:B(r.target),title:r.title};return T("a",e(r.content,n),t)}},image:{order:w++,match:C(new RegExp("^!\\[("+ie+")\\]\\("+Me+"\\)")),parse:function(r,e,n){var t={alt:r[1],target:xe(r[2]),title:r[3]};return t},react:function(r,e,n){return k("img",n.key,{src:B(r.target),alt:r.alt,title:r.title})},html:function(r,e,n){var t={src:B(r.target),alt:r.alt,title:r.title};return T("img","",t,!1)}},reflink:{order:w++,match:C(new RegExp("^\\[("+ie+")\\]\\s*\\[([^\\]]*)\\]")),parse:function(r,e,n){return Ye(r,n,{type:"link",content:e(r[1],n)})},react:null,html:null},refimage:{order:w++,match:C(new RegExp("^!\\[("+ie+")\\]\\s*\\[([^\\]]*)\\]")),parse:function(r,e,n){return Ye(r,n,{type:"image",alt:r[1]})},react:null,html:null},em:{order:w,match:C(new RegExp("^\\b_((?:__|\\\\[\\s\\S]|[^\\\\_])+?)_\\b|^\\*(?=\\S)((?:\\*\\*|\\\\[\\s\\S]|\\s+(?:\\\\[\\s\\S]|[^\\s\\*\\\\]|\\*\\*)|[^\\s\\*\\\\])+?)\\*(?!\\*)")),quality:function(r){return r[0].length+.2},parse:function(r,e,n){return{content:e(r[2]||r[1],n)}},react:function(r,e,n){return k("em",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("em",e(r.content,n))}},strong:{order:w,match:C(/^\*\*((?:\\[\s\S]|[^\\])+?)\*\*(?!\*)/),quality:function(r){return r[0].length+.1},parse:te,react:function(r,e,n){return k("strong",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("strong",e(r.content,n))}},u:{order:w++,match:C(/^__((?:\\[\s\S]|[^\\])+?)__(?!_)/),quality:function(r){return r[0].length},parse:te,react:function(r,e,n){return k("u",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("u",e(r.content,n))}},del:{order:w++,match:C(/^~~(?=\S)((?:\\[\s\S]|~(?!~)|[^\s~\\]|\s(?!~~))+?)~~/),parse:te,react:function(r,e,n){return k("del",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("del",e(r.content,n))}},inlineCode:{order:w++,match:C(/^(`+)([\s\S]*?[^`])\1(?!`)/),parse:function(r,e,n){return{content:r[2].replace($r,"$1")}},react:function(r,e,n){return k("code",n.key,{children:r.content})},html:function(r,e,n){return T("code",z(r.content))}},br:{order:w++,match:Ae(/^ {2,}\n/),parse:fe,react:function(r,e,n){return k("br",n.key,Vr)},html:function(r,e,n){return"<br>"}},text:{order:w++,match:Ae(/^[\s\S]+?(?=[^0-9A-Za-z\s\u00c0-\uffff]|\n\n| {2,}\n|\w+:\S|$)/),parse:function(r,e,n){return{content:r[0]}},react:function(r,e,n){return r.content},html:function(r,e,n){return z(r.content)}}},rt=function(r,e){!e&&typeof console<"u"&&console.warn("simple-markdown ruleOutput should take 'react' or 'html' as the second argument.");var n=function(t,a,i){return r[t.type][e](t,a,i)};return n},tt=function(r){var e=function(n,t){if(t=t||{},Array.isArray(n)){for(var a=t.key,i=[],o=null,s=0;s<n.length;s++){t.key=""+s;var u=e(n[s],t);typeof u=="string"&&typeof o=="string"?(o=o+u,i[i.length-1]=o):(i.push(u),o=u)}return t.key=a,i}else return r(n,e,t)};return e},at=function(r){var e=function(n,t){return t=t||{},Array.isArray(n)?n.map(function(a){return e(a,t)}).join(""):r(n,e,t)};return e},Ne=function(r,e,n={}){if(!e)throw new Error("simple-markdown: outputFor: `property` must be defined. if you just upgraded, you probably need to replace `outputFor` with `reactFor`");var t,a=r.Array||ee.Array,i=a[e];if(!i)throw new Error("simple-markdown: outputFor: to join nodes of type `"+e+"` you must provide an `Array:` joiner rule with that type, Please see the docs for details on specifying an Array rule.");var o=i,s=function(l,d){return d=d||t,t=d,Array.isArray(l)?o(l,s,d):r[l.type][e](l,s,d)},u=function(l,d){return t=Qe(d,n),s(l,t)};return u},ye=Be(ee),Ee=function(r,e){return e=e||{},e.inline=!1,ye(r,e)},it=function(r,e){return e=e||{},e.inline=!0,ye(r,e)},We=function(r,e){var n=Je.test(r);return e=e||{},e.inline=!n,ye(r,e)},Re=Ne(ee,"react"),Ze=Ne(ee,"html"),en=function(r,e){return Re(Ee(r,e),e)},st=function(r,e){return Ze(Ee(r,e),e)},ot=function(r){var e={};for(var n in r)n!=="source"&&Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n]);return e.children=en(r.source),k("div",null,e)},b={defaultRules:ee,parserFor:Be,outputFor:Ne,inlineRegex:C,blockRegex:E,anyScopeRegex:Ae,parseInline:ue,parseBlock:Qr,markdownToReact:en,markdownToHtml:st,ReactMarkdown:ot,defaultBlockParse:Ee,defaultInlineParse:it,defaultImplicitParse:We,defaultReactOutput:Re,defaultHtmlOutput:Ze,preprocess:Ke,sanitizeText:z,sanitizeUrl:B,unescapeUrl:xe,htmlTag:T,reactElement:k,defaultRawParse:ye,ruleOutput:rt,reactFor:tt,htmlFor:at,defaultParse:function(...r){return typeof console<"u"&&console.warn("defaultParse is deprecated, please use `defaultImplicitParse`"),We.apply(null,r)},defaultOutput:function(...r){return typeof console<"u"&&console.warn("defaultOutput is deprecated, please use `defaultReactOutput`"),Re.apply(null,r)}};const ut={fence:{match:b.defaultRules.fence.match,order:1,parse:(r,e,n)=>({type:"codeBlock",lang:r[2]||void 0,content:r[3]})},paragraph:{match:b.defaultRules.paragraph.match,order:2,parse:(r,e,n)=>({content:r[1]})}},lt=b.parserFor(ut),dt=r=>{const e=r.replace(/^\n\s*\n/,"")+`

`;return lt(e,{inline:!1}).map(n=>n.content)},mt=r=>r.join(`

`),Fe={parseToArray:dt,joinFromArray:mt},gt="@khanacademy/pure-markdown",pt="__lib_version__";Ie(gt,pt);const ct=/^\[\[\u2603 (([a-z-]+) ([0-9]+))\]\]/,nn=(r,e,n)=>{const t=r.length;let a=0;if(n){if(e.inline)return null;for(;a<t&&r[a]===" ";)a++}if(!(a<t&&r[a]==="$"))return null;a++;const i=a;let o=0;for(;a<t;){const s=r[a];if(s==="\\")a++;else if(o<=0&&s==="$"){let u=a+1;if(n){const l=/^(?: *\n){2,}/.exec(r.slice(u));u=l?u+l[0].length:null}return u?[r.substring(0,u),r.substring(i,a)]:null}else if(s==="{")o++;else if(s==="}")o--;else if(s===`
`&&r[a-1]===`
`)return null;a++}return null},yt=(r,e)=>nn(r,e,!1),ht=(r,e)=>nn(r,e,!0),bt=new RegExp("^\\|\\| +(.*) +\\|\\| *\\n("+b.defaultRules.nptable.match.regex.source.substring(1)+")"),wt=b.blockRegex(/^(crwdns.*)\n\s*\n/),S={...b.defaultRules,columns:{order:-2,match:b.blockRegex(/^([\s\S]*\n\n)={5,}\n\n([\s\S]*)/),parse:(r,e,n)=>({col1:e(r[1],n),col2:e(r[2],n)})},crowdinId:{order:-1,match:(r,e,n)=>e.isJipt?wt(r,e,n):null,parse:(r,e,n)=>({id:r[1]})},titledTable:{order:b.defaultRules.nptable.order-.5,match:b.blockRegex(bt),parse:(r,e,n)=>{const t=b.parseInline(e,r[1],n),a=r.slice(2),i=b.defaultRules.nptable.parse(a,e,n);return{title:t,table:i}}},widget:{order:b.defaultRules.link.order-.75,match:b.inlineRegex(ct),parse:(r,e,n)=>({id:r[1],widgetType:r[2]})},blockMath:{order:b.defaultRules.codeBlock.order+.5,match:ht,parse:(r,e,n)=>({content:r[1]})},math:{order:b.defaultRules.link.order-.25,match:yt,parse:(r,e,n)=>({content:r[1]})},unescapedDollar:{order:b.defaultRules.link.order-.24,match:b.inlineRegex(/^(?!\\)\$/),parse:(r,e,n)=>({})},fence:{...b.defaultRules.fence,parse:(r,e,n)=>{const t=b.defaultRules.fence.parse(r,e,n);return t.lang==="alt"?{type:"codeBlock",lang:"alt",content:e(t.content+`

`,n)}:t}},blockQuote:{...b.defaultRules.blockQuote,match:b.blockRegex(/^ *>[^\n]+(\n( *>)?[^\n]+)*\n{2,}/)},lint:{order:1e3,match:r=>null,parse:(r,e,n)=>({})}};b.parserFor(S);const Z={...S,columns:{...S.columns,react:(r,e,n)=>c.jsxs("div",{className:"perseus-two-columns",children:[c.jsx("div",{className:"perseus-column",children:c.jsx("div",{className:"perseus-column-content",children:e(r.col1,n)})}),c.jsx("div",{className:"perseus-column",children:c.jsx("div",{className:"perseus-column-content",children:e(r.col2,n)})})]},n.key)},crowdinId:{...S.crowdinId,react:(r,e,n)=>r.id},table:{...S.table,react:function(r,e,n){const t=b.defaultRules.table.react(r,e,n);return n.isMobile?j.cloneElement(t,{tabIndex:0}):t}},titledTable:{...S.titledTable,react:(r,e,n)=>{var a;let t;if(!r.table)t="//invalid table//";else if(r.table.type==="lint")((a=r.table.content)==null?void 0:a.type)==="table"?t=Z.lint.react({...r.table,content:{...r,table:r.table.content}},e,{...n,unwrapTitledTableContents:!0}):t=Z.lint.react(r.table,e,n);else{const i=b.defaultRules.table.react(r.table,e,n),o=c.jsx("caption",{className:"perseus-table-title",children:e(r.title,n)},"caption");t=j.cloneElement(i,null,[o,...i.props.children])}return n.unwrapTitledTableContents?t:c.jsx("div",{className:"perseus-titled-table",children:t},n.key)}},widget:{...S.widget,react:(r,e,n)=>c.jsx("em",{children:`[Widget: ${r.id}]`},n.key)},blockMath:{...S.blockMath,react:(r,e,n)=>{const{TeX:t}=$();return c.jsx(t,{children:r.content},n.key)}},math:{...S.math,react:(r,e,n)=>{const{TeX:t}=$();return c.jsx(t,{children:r.content},n.key)}},unescapedDollar:{...S.unescapedDollar,react:(r,e,n)=>"$"},link:{...S.link,react:function(r,e,n){const t=b.defaultRules.link.react(r,e,n),a=t.props.href;let i=null;(a?a.match(/https?:\/\/[^/]*khanacademy.org|^\//):!1)||(i="noopener noreferrer");const s={...t.props,target:"_blank",href:a,rel:i};return n.baseElements&&n.baseElements.Link?n.baseElements.Link(s):j.cloneElement(t,s)}},codeBlock:{...S.codeBlock,react:(r,e,n)=>r.lang==="alt"?c.jsx("div",{className:"perseus-markdown-alt perseus-sr-only",children:e(r.content,n)},n.key):b.defaultRules.codeBlock.react(r,e,n)},lint:{...S.lint,react:(r,e,n)=>c.jsx(kn,{message:r.message,ruleName:r.ruleName,inline:ft(r.content),blockHighlight:r.blockHighlight,insideTable:r.insideTable,severity:r.severity,children:e(r.content,n)})}};function ft(r){return!!(r&&r.type&&vt.hasOwnProperty(r.type))}const vt={text:!0,math:!0,unescapedDollar:!0,link:!0,img:!0,strong:!0,u:!0,em:!0,del:!0,code:!0},rn=b.parserFor(Z),tn=(r,e)=>{const n=r+`

`;return rn(n,{...e,inline:!1})},kt=(r,e)=>rn(r,{...e,inline:!0}),L=(r,e)=>{g.isArray(r)?g.each(r,n=>L(n,e)):g.isObject(r)&&(e(r),r.type==="table"?(L(r.header,e),L(r.cells,e)):r.type==="list"?L(r.items,e):r.type==="titledTable"?L(r.table,e):r.type==="columns"?(L(r.col1,e),L(r.col2,e)):g.isArray(r.content)&&L(r.content,e))},Pe=r=>{if(g.isArray(r))return g.flatten(g.map(r,Pe));if(r.content&&g.isString(r.content))return r.type.toLowerCase().indexOf("code")!==-1?["",r.content,""]:[r.content.replace(/\s+/g," ")];const e=g.chain(r).values().flatten().filter(t=>t!=null&&g.has(t,"type")).value();if(!e.length)return[];const n=Pe(e);if(r.type==="paragraph"&&n.length){n[0]=n[0].replace(/^\s+/,"");const t=n.length-1;n[t]=n[t].replace(/\s+$/,"")}return n},qt=r=>{const e=tn(r);return Pe(e).join("").length},G={characterCount:qt,traverseContent:L,parse:tn,parseInline:kt,reactFor:b.reactFor,ruleOutput:b.ruleOutput(Z,"react"),basicOutput:b.reactFor(b.ruleOutput(Z,"react")),sanitizeUrl:b.sanitizeUrl};class an extends j.Component{render(){const e=this.props.className?"paragraph "+this.props.className:"paragraph";return c.jsx("div",{className:this.props.inline?this.props.className??void 0:e,"data-perseus-component-index":this.props.translationIndex,"data-perseus-paragraph-index":this.props.paragraphIndex,children:this.props.children})}}an.__docgenInfo={description:"",methods:[],displayName:"QuestionParagraph",props:{className:{required:!1,tsType:{name:"union",raw:"string | null | undefined",elements:[{name:"string"},{name:"null"},{name:"undefined"}]},description:""},translationIndex:{required:!0,tsType:{name:"number"},description:""},paragraphIndex:{required:!1,tsType:{name:"number"},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},inline:{required:!1,tsType:{name:"boolean"},description:""}}};const Tt={type:"points",earned:0,total:0,message:null};function At(r){return r.type==="invalid"&&(!r.message||r.message.length===0)}function xt(r,e){let n;if(r.type==="points"&&e.type==="points")return r.message&&e.message&&r.message!==e.message?n=null:n=r.message||e.message,{type:"points",earned:r.earned+e.earned,total:r.total+e.total,message:n};if(r.type==="points"&&e.type==="invalid")return e;if(r.type==="invalid"&&e.type==="points")return r;if(r.type==="invalid"&&e.type==="invalid")return r.message&&e.message&&r.message!==e.message?n=null:n=r.message||e.message,{type:"invalid",message:n};throw new N("PerseusScore with unknown type encountered",x.InvalidInput,{metadata:{scoreA:JSON.stringify(r),scoreB:JSON.stringify(e)}})}function sn(r){return Object.values(r).reduce(xt,Tt)}function Rt(r){return r.type==="points"&&r.earned>=r.total}function va(r,e,n){if(r.type==="points")return{empty:!1,correct:Rt(r),message:r.message,guess:e,state:n};if(r.type==="invalid")return{empty:!0,correct:!1,message:r.message,suppressAlmostThere:r.suppressAlmostThere,guess:e,state:n};throw new N("Invalid score type: "+r.type,x.InvalidInput,{metadata:{score:JSON.stringify(r),guess:JSON.stringify(e),state:JSON.stringify(n)}})}const Ge="block",Pt=["default"],Ct=!1,It="",St=!1,q={},W={},on=(r,e)=>{q[r]=e},ka=r=>{r.forEach(e=>{on(e.name,e)}),Yt()},D=(r,e)=>{const n=q[e];if(!n){const t=`Failed to replace ${r} with ${e}`;throw new N(t,x.Internal)}on(r,n)},qa=()=>{D("transformer","deprecated-standin"),D("lights-puzzle","deprecated-standin"),D("reaction-diagram","deprecated-standin"),D("sequence","deprecated-standin"),D("simulator","deprecated-standin"),D("unit-input","deprecated-standin")},Ta=r=>{r.forEach(e=>{if(!e.widgetName)throw new N(`Editor ${e.displayName} doesn't have a widgetName property`,x.Internal);W[e.widgetName]=e})},_=(r,e)=>{const n=W[e];if(!n&&H){const t=`Failed to replace editor ${r} with ${e}`;H.error(t,x.Internal);return}W[r]=n},Aa=()=>{_("transformer","deprecated-standin"),_("lights-puzzle","deprecated-standin"),_("reaction-diagram","deprecated-standin"),_("sequence","deprecated-standin"),_("simulator","deprecated-standin"),_("unit-input","deprecated-standin")},Nt=r=>{var e,n,t;return g.has(q,r)?(e=q[r])!=null&&e.getWidget?(t=(n=q[r]).getWidget)==null?void 0:t.call(n):q[r].widget:null},un=r=>{var e;return((e=q[r])==null?void 0:e.validator)??null},Et=r=>{var e;return((e=q[r])==null?void 0:e.scorer)??null},xa=r=>g.has(W,r)?W[r]:null,Ot=r=>{if(q[r])return q[r].version||{major:0,minor:0}},Ra=()=>{const r={};return g.each(g.keys(q),function(e){r[e]=Ot(e)}),r},Pa=()=>g.pick(q,g.reject(g.keys(q),function(r){return q[r].hidden})),Ca=()=>g.keys(q),jt=r=>{const e=r.type;if(!g.isString(e))throw new N("widget type must be a string, but was: "+e,x.Internal);const n=q[e];if(n==null)return r;const t=r.version||{major:0,minor:0},a=n.version||{major:0,minor:0};if(t.major>a.major||t.major===a.major&&t.minor>a.minor)return r;let i=g.clone(r.options)||{};const o=n.propUpgrades||{};if(g.keys(i).length!==0)for(let d=t.major+1;d<=a.major;d++)o[String(d)]?i=o[String(d)](i):H.error("No upgrade found for widget. Cannot render.",x.Internal,{loggedMetadata:{type:e,fromMajorVersion:d-1,toMajorVersion:d}});i={...e in W?W[e].defaultProps:{},...i};let u=r.alignment;(u==null||u==="default")&&(u=Xt(e)[0]);let l=r.static;return l==null&&(l=Ct),g.extend({},r,{version:a,graded:r.graded!=null?r.graded:!0,alignment:u,static:l,options:i})},Lt=(r,e,n)=>{const t=r.type,a=q[t];if(a==null)return r;let i;return r.static?i=Wt(t)||g.identity:i=a.transform||g.identity,i(r.options,e,n)},Xt=r=>{const e=q[r];return e&&e.supportedAlignments||Pt},Mt=r=>{const e=q[r];let n;return e?(e.getDefaultAlignment?n=e.getDefaultAlignment():n=e.defaultAlignment,n||Ge):Ge},De=["block","inline-block","inline","float-left","float-right","full-width"],Yt=()=>{g.each(q,function(r){if(r.defaultAlignment&&!g.contains(De,r.defaultAlignment))throw new N("Widget '"+r.displayName+"' has an invalid defaultAlignment value: "+r.defaultAlignment,x.InvalidInput);if(r.supportedAlignments){const e=g.difference(r.supportedAlignments,De);if(e.length)throw new N("Widget '"+r.displayName+"' has an invalid value for supportedAlignments: "+e.join(" "),x.InvalidInput)}})},Ia=r=>{const e=q[r];return e&&e.staticTransform!=null},Wt=r=>{const e=q[r];return e&&e.staticTransform},Ft=r=>{const e=q[r];return e&&e.tracking||It},Gt=r=>{const e=q[r];return e&&e.isLintable||St};function ln(r){return ve(r,(e,n)=>{if(!e.type||!e.alignment){const t={};e.type||(t.type=n.split(" ")[0]),e.alignment||(t.alignment="default"),e={...e,...t}}return jt(e)})}function Dt(r,e,n,t,a){return e.filter(i=>{const o=r[i];if(!o||o.static===!0)return!1;const s=un(o.type),u=n[i],l=o.options,d=s==null?void 0:s(u,l,t,a);if(d)return At(d)})}function Sa(r,e,n,t){const a=Cn(r.content),i=dn(r.widgets,a,e,n,t);return sn(i)}function dn(r,e,n,t,a){const i=ln(r),o=e.filter(u=>{const l=i[u],d=(l==null?void 0:l.graded)==null||l.graded,p=!!(l!=null&&l.static);return d&&!p}),s={};return o.forEach(u=>{const l=i[u];if(!l)return;const d=n[u],p=un(l.type),h=Et(l.type),v=(p==null?void 0:p(d,l.options,t,a))??(h==null?void 0:h(d,l.options,t,a));v!=null&&(s[u]=v)}),s}const _t=1e3;class Ut{constructor(){this.previousContent=null,this.runLinter=mn((e,n)=>{if(!(typeof KA>"u")&&e!==this.previousContent){if(this.previousContent=e,e===""){n([]);return}fetch("/api/internal/translations/lint_poentry?preview=1&lang=en",{headers:{"Content-Type":"application/json"},body:JSON.stringify({msgid:e,msgstr:e,format:"perseus_text",filename:""}),method:"POST"}).then(t=>t.status>=400?{status:"error",message:"Could not run i18n linter."}:t.json(),t=>({status:"error",message:"Could not run i18n linter."})).then(t=>{t.status==="error"?n(["Some part of this text makes it untranslatable. The specific message from the i18n linter was: "+t.message.replace(/\n/g," ")]):n([])})}},_t)}applyLintErrors(e,n){if(n.length){const t=n.join(`

`);e.unshift({content:{type:"text",content:""},insideTable:!1,message:t,ruleName:"legacy-error",severity:m.Severity.ERROR,type:"lint"})}}}const Vt=r=>r.replace(/\{align[*]?\}/g,"{aligned}").replace(/[\u00a0]/g," "),{interactiveSizes:se}=Tn,zt=An,Ht=xn,U={SMALL:"small",MEDIUM:"medium",LARGE:"large",XLARGE:"xlarge"},Kt=r=>r?r<=zt?U.SMALL:r<=Ht?U.MEDIUM:U.LARGE:U.MEDIUM,Na=r=>r===U.SMALL?[se.defaultBoxSizeSmall,se.defaultBoxSizeSmall]:[se.defaultBoxSize,se.defaultBoxSize],Oe=class Oe extends j.Component{constructor(){super(...arguments),this.widgetRef=j.createRef(),this.state={sizeClass:U.MEDIUM,widgetProps:this.props.initialProps},this.getWidget=()=>this.widgetRef.current,this.replaceWidgetProps=e=>{this.setState({widgetProps:e})}}componentDidMount(){if(this.state.widgetProps.apiOptions.isMobile){const e=qe.findDOMNode(this).offsetWidth;this.setState({sizeClass:Kt(e)})}}UNSAFE_componentWillReceiveProps(e){if(this.props.type!==e.type)throw new Error("WidgetContainer can't change widget type; set a different key instead to recreate the container.")}shouldComponentUpdate(e,n){return this.props.shouldHighlight!==e.shouldHighlight||this.props.type!==e.type||this.state.widgetProps!==n.widgetProps||this.state.sizeClass!==n.sizeClass}render(){let e=ke({"perseus-widget-container":!0,"widget-highlight":this.props.shouldHighlight,"widget-nohighlight":!this.props.shouldHighlight,"perseus-widget__definition":this.props.type==="definition"});const n=this.props.type,t=Nt(n);if(t==null)return console.warn(`Widget type '${n}' not found!`),c.jsx("div",{className:e});let a=this.state.widgetProps.alignment;a==="default"&&(a=Mt(n)),e+=" widget-"+a;const i=this.state.widgetProps.apiOptions,o=this.state.widgetProps.static||i.readOnly,s={position:"relative",overflow:"visible"},u={width:"100%",height:"100%",position:"absolute",top:0,left:0,zIndex:Rn},l=Gt(n)?this.props.linterContext:{...this.props.linterContext,highlightLint:!1};return c.jsx("div",{className:e,style:o?s:{},children:c.jsx(fn.Consumer,{children:({analytics:d})=>c.jsxs(O,{metadata:{widget_type:n,widget_id:this.props.id},onError:()=>{d.onAnalyticsEvent({type:"perseus:widget-rendering-error",payload:{widgetType:n,widgetId:this.props.id}})},children:[c.jsx(t,{...this.state.widgetProps,linterContext:l,containerSizeClass:this.state.sizeClass,ref:this.widgetRef}),o&&c.jsx("div",{style:u})]})})})}};Oe.defaultProps={linterContext:ze};let de=Oe;de.__docgenInfo={description:"",methods:[{name:"getWidget",docblock:null,modifiers:[],params:[],returns:null},{name:"replaceWidgetProps",docblock:null,modifiers:[],params:[{name:"newWidgetProps",optional:!1,type:null}],returns:null}],displayName:"WidgetContainer",props:{shouldHighlight:{required:!0,tsType:{name:"boolean"},description:""},type:{required:!0,tsType:{name:"string"},description:""},id:{required:!0,tsType:{name:"string"},description:""},initialProps:{required:!0,tsType:{name:"intersection",raw:`RenderProps & {
...
the linter and any warnings will be highlighted in the rendered output.`},{key:"legacyPerseusLint",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!1}},{key:"widgets",value:{name:"signature",raw:'PerseusRenderer["widgets"]',required:!0}},{key:"inline",value:{name:"boolean",required:!1},description:"Skip adding paragraph class"},{key:"strings",value:{name:"signature",type:"object",raw:`{
    ...
    point3X: string;
    point3Y: string;
}`,signature:{properties:[{key:"point1X",value:{name:"string",required:!0}},{key:"point1Y",value:{name:"string",required:!0}},{key:"point2X",value:{name:"string",required:!0}},{key:"point2Y",value:{name:"string",required:!0}},{key:"point3X",value:{name:"string",required:!0}},{key:"point3Y",value:{name:"string",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}}]},required:!0}}]}}],alias:"Props"}}],returns:null},{name:"_getAllWidgetsStartProps",docblock:null,modifiers:[],params:[{name:"allWidgetInfo",optional:!1,type:null},{name:"props",optional:!1,type:null}],returns:null},{name:"_getDefaultWidgetInfo",docblock:null,modifiers:[],params:[{name:"widgetId",optional:!1,type:{name:"string"}}],returns:null},{name:"_getWidgetInfo",docblock:null,modifiers:[],params:[{name:"widgetId",optional:!1,type:{name:"string"}}],returns:{type:{name:"PerseusWidgetTypes[PerseusWidgetTypes]",raw:"PerseusWidgetTypes[keyof PerseusWidgetTypes]"}}},{name:"renderWidget",docblock:null,modifiers:[],params:[{name:"impliedType",optional:!1,type:{name:"string"}},{name:"id",optional:!1,type:{name:"string"}},{name:"state",optional:!1,type:{name:"signature",type:"object",raw:`{
    isMobile?: boolean;
    inTable?: boolean;
    key?: number;
...
the linter and any warnings will be highlighted in the rendered output.`},{key:"legacyPerseusLint",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!1}},{key:"widgets",value:{name:"signature",raw:'PerseusRenderer["widgets"]',required:!0}},{key:"inline",value:{name:"boolean",required:!1},description:"Skip adding paragraph class"},{key:"strings",value:{name:"signature",type:"object",raw:`{
    ...
    point3X: string;
    point3Y: string;
}`,signature:{properties:[{key:"point1X",value:{name:"string",required:!0}},{key:"point1Y",value:{name:"string",required:!0}},{key:"point2X",value:{name:"string",required:!0}},{key:"point2Y",value:{name:"string",required:!0}},{key:"point3X",value:{name:"string",required:!0}},{key:"point3Y",value:{name:"string",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}}]},required:!0}}]}}],alias:"Props"}},{name:"state",optional:!1,type:{name:"signature",type:"object",raw:`{
...
the linter and any warnings will be highlighted in the rendered output.`},{key:"legacyPerseusLint",value:{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>",required:!1}},{key:"widgets",value:{name:"signature",raw:'PerseusRenderer["widgets"]',required:!0}},{key:"inline",value:{name:"boolean",required:!1},description:"Skip adding paragraph class"},{key:"strings",value:{name:"signature",type:"object",raw:`{
    ...
    point3X: string;
    point3Y: string;
}`,signature:{properties:[{key:"point1X",value:{name:"string",required:!0}},{key:"point1Y",value:{name:"string",required:!0}},{key:"point2X",value:{name:"string",required:!0}},{key:"point2Y",value:{name:"string",required:!0}},{key:"point3X",value:{name:"string",required:!0}},{key:"point3Y",value:{name:"string",required:!0}}]}},name:""}],return:{name:"string"}},required:!0}}]},required:!0}}]}}],alias:"Props"}}],returns:null},{name:"_setCurrentFocus",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"focus",docblock:null,modifiers:[],params:[],returns:null},{name:"getDOMNodeForPath",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"getInputPaths",docblock:null,modifiers:[],params:[],returns:null},{name:"focusPath",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"blurPath",docblock:null,modifiers:[],params:[{name:"path",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"blur",docblock:null,modifiers:[],params:[],returns:null},{name:"serialize",docblock:null,modifiers:[],params:[],returns:null},{name:"emptyWidgets",docblock:`Returns an array of widget ids that are empty (meaning widgets where the
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{fa as D,Fe as J,G as P,Ce as R,b as S,qa as a,Ia as b,Ta as c,Aa as d,xa as e,Pa as f,Xt as g,Ca as h,Mt as i,Ot as j,va as k,ze as l,Vt as m,Rt as n,Na as o,Lr as p,U as q,ka as r,Sa as s,Ra as t,jt as u,Nt as v,dn as w,sn as x,Dt as y,S as z};
