...
[[☃ radio 1]]`).addChoice("Choice A",{correct:void 0}).addChoice("Choice B",{correct:!0}).addChoice("Choice C",{correct:void 0}).withMultipleSelect(!0).withRandomize(!0).build();export{f as S,l as a,u as b,d as c,m as d,g as e,p as m,h as q};
