...
`,correct:!0,isNoneOfTheAbove:!1,rationale:"$8$ is the positive square root of $64$."},{content:"No value of $x$ satisfies the equation.",correct:!1,isNoneOfTheAbove:!1,clue:"$8$ satisfies the equation."}],countChoices:!1,hasNoneOfTheAbove:!1,multipleSelect:!1,randomize:!1,deselectEnabled:!1},alignment:"default"},"passage 1":{alignment:"default",graded:!0,options:{footnotes:"",passageText:"Here's a passage about the positive square root. It contains a {{reference to something}}.",passageTitle:"",showLineNumbers:!0,static:!1},static:!1,type:"passage",version:{major:0,minor:0}}}},d={content:"The following options have images. All but one of them should be on their own line. [[☃ radio 1]]",images:{},widgets:{"radio 1":{graded:!0,version:{major:1,minor:0},static:!1,type:"radio",options:{choices:[{content:`Same 
Line
...
[[☃ radio 1]]`).addChoice("Choice A",{correct:void 0}).addChoice("Choice B",{correct:!0}).addChoice("Choice C",{correct:void 0}).withMultipleSelect(!0).withRandomize(!0).build();export{u as S,l as a,f as b,d as c,m as d,g as e,p as m,h as q};
