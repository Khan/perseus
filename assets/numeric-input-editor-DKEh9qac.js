import{K as E,U as M}from"./util-Cjm22Ttl.js";import{_ as h}from"./underscore-U-AHniOr.js";import{f as W}from"./core-widget-registry-2tCIH_GM.js";import{c as L}from"./all-widgets-tRlJWtrE.js";import"./phet-simulation-CRP1AVh1.js";import"./dependencies-BsVPGK1s.js";import"./perseus-api-DmwU2RjF.js";import"./server-item-renderer-BYboQbOk.js";import"./article-renderer-BDBMlFVD.js";import"./hints-renderer-D7pIA0Cj.js";import"./renderer-Dk-W13T9.js";import"./base-radio-_o7Aud29.js";import{c as H}from"./components-B7LnuaJz.js";import"./i18n-context-glBZFVwC.js";import"./svg-image-DAYn0iDa.js";import"./index-Dd-cahjY.js";import{E as K}from"./editor-jsonify-Ce5yzgxx.js";import{B as I}from"./index-DpD-xBMx.js";import{P as g}from"./index-IRljdxki.js";import{L as j}from"./index-CbNKSLRm.js";import{P as z,t as G}from"./trash-bold-DJt3xu6o.js";import{r as e}from"./index-C6mWTJJr.js";import{H as O}from"./heading-Doe0CpA_.js";import{E as $}from"./editor-CQO2CBtg.js";const{InfoTip:y,NumberInput:T,TextInput:U}=H,{firstNumericalParse:x}=M,B=[{title:"Integers",value:"integer",content:"6"},{title:"Decimals",value:"decimal",content:"0.75"},{title:"Proper fractions",value:"proper",content:"⅗"},{title:"Improper fractions",value:"improper",content:"⁷⁄₄"},{title:"Mixed numbers",value:"mixed",content:"1¾"},{title:"Numbers with π",value:"pi",content:"π"}],C=R=>({value:null,status:R,message:"",simplify:"required",answerForms:[],strict:!1,maxError:null}),v=class v extends e.Component{constructor(l){super(l),this.change=(...n)=>L.apply(this,n),this.onToggleAnswers=n=>{const t=this.state.showAnswerDetails.slice();t[n]=!t[n],this.setState({showAnswerDetails:t})},this.onToggleAnswerForm=(n,t)=>{let a=[...this.props.answers[n].answerForms??[]];a.includes(t)?a=a.filter(w=>w!==t):a.push(t);const i=this.updateAnswer(n,"answerForms");i&&i(a)},this.onToggleHeading=n=>()=>{const t=`show${n}`,a={...this.state};a[t]=!a[t],this.setState(a)},this.onTrashAnswer=n=>{if(n>=0&&n<this.props.answers.length){const t=this.props.answers.slice(0);t.splice(n,1),this.props.onChange({answers:t})}},this.onSpace=(n,t,...a)=>{n.key===" "&&(n.preventDefault(),t.apply(this,a))},this.onStatusChange=n=>{const t=["wrong","ungraded","correct"],a=this.props.answers,o=t.indexOf(a[n].status),i=t[(o+1)%t.length];this.updateAnswer(n,{status:i,simplify:i==="correct"?"required":"accepted"})},this.onEvaluationChange=(n,t)=>{this.updateAnswer(n,{status:t,simplify:t==="correct"?"required":"accepted"})},this.updateAnswer=(n,t)=>{if(!h.isObject(t))return h.partial((o,i,w)=>{const A={};A[i]=w,this.updateAnswer(o,A)},n,t);let a=[...this.props.answers];if(n===a.length){const o=C(this.state.lastStatus);a=a.concat(o)}a[n]=h.extend({},a[n],t),this.props.onChange({answers:a})},this.addAnswer=()=>{const n=C(this.state.lastStatus),t=this.props.answers.concat(n),a=this.state.showAnswerDetails.concat(!0);this.setState({showAnswerDetails:a}),this.props.onChange({answers:t})},this.getSaveWarnings=()=>{const n=[];return h.contains(h.pluck(this.props.answers,"value"),"")&&n.push("One or more answers is empty"),this.props.answers.forEach((t,a)=>{t.strict&&(!t.answerForms||t.answerForms.length===0)&&n.push(`Answer ${a+1} is set to string format matching, but no format was selected`)}),n},this.serialize=()=>K.serialize.call(this),this.state={lastStatus:"wrong",showAnswerDetails:Array(this.props.answers.length).fill(!0),showSettings:!0,showAnswers:!0}}render(){const l=this.props.answers,n={size:"medium",role:"radio",style:{marginRight:"8px"}},t=r=>{const{kind:s,onClick:p,ariaLabel:d,children:c}=r,m=r.role??"radio",b={...n,"aria-label":d,kind:s,role:m,onClick:p};return e.createElement(g,{...b},c)},a=r=>{const{answerIndex:s,answerProperty:p,value:d,children:c}=r,b=l[s][p]===d?"accent":"transparent",f={};f[p]=d;const u=r.onClick??(()=>{this.updateAnswer(s,f)});return e.createElement(t,{kind:b,onClick:u},c)},o=r=>e.createElement("fieldset",{className:"perseus-widget-row unsimplified-options"},l[r].status!=="correct"&&e.createElement(e.Fragment,null,e.createElement("legend",{className:"inline-options"},"Unsimplified answers are irrelevant for this status")),l[r].status==="correct"&&e.createElement(e.Fragment,null,e.createElement("legend",{className:"inline-options"},"Unsimplified answers are"),e.createElement("span",{className:"tooltip-for-legend"},e.createElement(y,null,e.createElement("p",null,'Normally select "ungraded". This will give the user a message saying the answer is correct but not simplified. The user will then have to simplify it and re-enter, but will not be penalized. (5th grade and after)'),e.createElement("p",null,'Select "accepted" only if the user is not expected to know how to simplify fractions yet. (Anything prior to 5th grade)'),e.createElement("p",null,'Select "wrong" ',e.createElement("em",null,"only")," if we are specifically assessing the ability to simplify."))),e.createElement("br",null),e.createElement(a,{answerIndex:r,answerProperty:"simplify",value:"required"},"Ungraded"),e.createElement(a,{answerIndex:r,answerProperty:"simplify",value:"optional"},"Accepted"),e.createElement(a,{answerIndex:r,answerProperty:"simplify",value:"enforced"},"Wrong"))),i=r=>e.createElement(e.Fragment,null,e.createElement("div",{className:"perseus-widget-row"},e.createElement("label",null,"Possible answer formats "),e.createElement(y,null,e.createElement("p",null,'Formats will be autoselected for you based on the given answer; to show no suggested formats and accept all types, simply have a decimal/integer be the answer. Values with π will have format "pi", and values that are fractions will have some subset (mixed will be "mixed" and "proper"; improper/proper will both be "improper" and "proper"). If you would like to specify that it is only a proper fraction (or only a mixed/improper fraction), deselect the other format. Except for specific cases, you should not need to change the autoselected formats.'),e.createElement("p",null,"To restrict the answer to ",e.createElement("em",null,"only"),' an improper fraction (i.e. 7/4), select the improper fraction and toggle "strict" to true. This ',e.createElement("b",null,"will not")," ","accept 1.75 as an answer."," "),e.createElement("p",null,"Unless you are testing that specific skill, please do not restrict the answer format.")),e.createElement("br",null),B.map(s=>{var m;const d=((m=l[r].answerForms)==null?void 0:m.includes(s.value))?"accent":"transparent",c=()=>{this.onToggleAnswerForm(r,s.value)};return e.createElement(t,{key:s.value,ariaLabel:s.title,kind:d,role:"checkbox",onClick:c},s.content)})),e.createElement("fieldset",{className:"perseus-widget-row"},e.createElement("legend",null,"Answer formats are: "),e.createElement(a,{answerIndex:r,answerProperty:"strict",value:!1},"Suggested"),e.createElement(a,{answerIndex:r,answerProperty:"strict",value:!0},"Required"))),w=e.createElement("fieldset",{className:"perseus-widget-row"},e.createElement("legend",{className:"inline-options"},"Width: "),e.createElement(g,{...n,kind:this.props.size==="normal"?"accent":"transparent",onClick:()=>{this.change("size")("normal")}},"Normal (80px)"),e.createElement(g,{...n,kind:this.props.size==="small"?"accent":"transparent",onClick:()=>{this.change("size")("small")}},"Small (40px)"),e.createElement(y,null,e.createElement("p",null,'Use size "Normal" for all text boxes, unless there are multiple text boxes in one line and the answer area is too narrow to fit them.'))),A=e.createElement("fieldset",{className:"perseus-widget-row"},e.createElement("legend",{className:"inline-options"},"Alignment: "),e.createElement(g,{...n,kind:this.props.rightAlign?"transparent":"accent",onClick:()=>{this.props.onChange({rightAlign:!1})}},"Left"),e.createElement(g,{...n,kind:this.props.rightAlign?"accent":"transparent",onClick:()=>{this.props.onChange({rightAlign:!0})}},"Right")),F=e.createElement(e.Fragment,null,e.createElement("div",{className:"perseus-widget-row"},e.createElement("label",null,"Aria label"),e.createElement(y,null,e.createElement("p",null,"Text to describe this input. This will be shown to users using screenreaders."))),e.createElement(U,{labelText:"aria label",value:this.props.labelText,onChange:this.change("labelText")})),q=e.createElement("fieldset",{className:"perseus-widget-row"},e.createElement("legend",{className:"inline-options"},"Number style: "),e.createElement(g,{...n,kind:this.props.coefficient?"transparent":"accent",onClick:()=>{this.props.onChange({coefficient:!1})}},"Standard"),e.createElement(g,{...n,kind:this.props.coefficient?"accent":"transparent",onClick:()=>{this.props.onChange({coefficient:!0})}},"Coefficient"),e.createElement(y,null,e.createElement("p",null,"A coefficient style number allows the student to use - for -1 and an empty string to mean 1."))),S={wrong:"(address the mistake/misconception)",ungraded:"(explain in detail to avoid confusion)",correct:"(reinforce the user's understanding)"},D=()=>l.map((r,s)=>{const p=e.createElement($,{apiOptions:this.props.apiOptions,content:r.message||"",placeholder:"Why is this answer "+r.status+"?	"+S[r.status],widgetEnabled:!1,onChange:u=>{"content"in u&&this.updateAnswer(s,{message:u.content})}}),d=r.status.charAt(0).toUpperCase()+r.status.slice(1),c=(r.answerForms||[]).at(-1),m=E.toNumericString(r.value??0,c),b=r.maxError?`± ${E.toNumericString(r.maxError,c)}`:"",f=r.value===null?"New Answer":`${d} answer: ${m} ${b}`;return e.createElement("div",{className:"perseus-widget-row answer-option",key:s},e.createElement(z,{animated:!0,expanded:this.state.showAnswerDetails[s],onToggle:()=>{this.onToggleAnswers(s)},header:e.createElement(j,null,f)},e.createElement("div",{className:"input-answer-editor-value-container"+(r.maxError?" with-max-error":"")},e.createElement("label",null,"User input:",e.createElement(T,{value:r.value,className:"numeric-input-value",placeholder:"answer",format:h.last(r.answerForms||[]),onFormatChange:(u,k)=>{let N;k==="pi"?N=["pi"]:k==="mixed"?N=["proper","mixed"]:(k==="proper"||k==="improper")&&(N=["proper","improper"]),this.updateAnswer(s,{value:x(u),answerForms:N})},onChange:u=>{this.updateAnswer(s,{value:x(u)})}})),e.createElement("span",{className:"max-error-plusmn"},"±"),e.createElement(T,{className:"max-error-input-value",placeholder:0,value:l[s].maxError,format:h.last(r.answerForms||[]),onChange:this.updateAnswer(s,"maxError")})),e.createElement("fieldset",{className:"perseus-widget-row"},e.createElement("legend",{className:"inline-options"},"Status:"),e.createElement(a,{answerIndex:s,answerProperty:"status",value:"correct",onClick:()=>{this.onEvaluationChange(s,"correct")}},"Correct"),e.createElement(a,{answerIndex:s,answerProperty:"status",value:"wrong",onClick:()=>{this.onEvaluationChange(s,"wrong")}},"Wrong"),e.createElement(a,{answerIndex:s,answerProperty:"status",value:"ungraded",onClick:()=>{this.onEvaluationChange(s,"ungraded")}},"Ungraded")),o(s),e.createElement("div",{className:"perseus-widget-row"},"(Articles only) Message shown to user:"),p,i(s),e.createElement(I,{startIcon:G,"aria-label":`Delete ${f}`,className:"delete-item-button",onClick:()=>{this.onTrashAnswer(s)},kind:"tertiary"},"Delete")))});return e.createElement("div",{className:"perseus-input-number-editor"},e.createElement(O,{title:"General Settings",isCollapsible:!0,isOpen:this.state.showSettings,onToggle:this.onToggleHeading("Settings")}),e.createElement("div",{className:`perseus-editor-accordion-container ${this.state.showSettings?"expanded":"collapsed"}`},e.createElement("div",{className:"perseus-editor-accordion-content"},w,A,q,F)),e.createElement(O,{title:"Answers",isCollapsible:!0,isOpen:this.state.showAnswers,onToggle:this.onToggleHeading("Answers")}),e.createElement("div",{className:`perseus-editor-accordion-container ${this.state.showAnswers?"expanded":"collapsed"}`},e.createElement("div",{className:"perseus-editor-accordion-content"},D(),e.createElement(I,{kind:"tertiary",onClick:this.addAnswer},"Add new answer"))))}};v.widgetName="numeric-input",v.displayName="NumericInputEditor",v.defaultProps=W.defaultWidgetOptions;let P=v;P.__docgenInfo={description:"",methods:[{name:"change",docblock:null,modifiers:[],params:[{name:"...args",optional:!1,type:null}],returns:null},{name:"onToggleAnswers",docblock:null,modifiers:[],params:[{name:"answerIndex",optional:!1,type:{name:"number"}}],returns:null},{name:"onToggleAnswerForm",docblock:null,modifiers:[],params:[{name:"answerIndex",optional:!1,type:{name:"number"}},{name:"answerForm",optional:!1,type:null}],returns:null},{name:"onToggleHeading",docblock:null,modifiers:[],params:[{name:"accordionName",optional:!1,type:{name:"string"}}],returns:null},{name:"onTrashAnswer",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null}],returns:null},{name:"onSpace",docblock:null,modifiers:[],params:[{name:"e",optional:!1,type:null},{name:"callback",optional:!1,type:null},{name:"...args",optional:!1,type:null}],returns:null},{name:"onStatusChange",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null}],returns:null},{name:"onEvaluationChange",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null},{name:"newStatus",optional:!1,type:null}],returns:null},{name:"updateAnswer",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null},{name:"update",optional:!1,type:null}],returns:null},{name:"addAnswer",docblock:null,modifiers:[],params:[],returns:null},{name:"getSaveWarnings",docblock:null,modifiers:[],params:[],returns:null},{name:"serialize",docblock:null,modifiers:[],params:[],returns:null}],displayName:"NumericInputEditor",props:{onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(results: any) => any",signature:{arguments:[{type:{name:"any"},name:"results"}],return:{name:"any"}}},description:""},apiOptions:{required:!1,tsType:{name:"Readonly",elements:[{name:"intersection",raw:`APIOptions & {
