import{b_ as O,j as n,bf as C,p as U,q as p,s as m,bC as J,bD as T,V as w,r as Y,t as K,cy as y,L as W,d as P}from"./iframe-CiZ4rom4.js";import{p as Z}from"./plus-circle-DsgEZe2H.js";import{P as G}from"./trash-bold-CBNk1Rb_.js";import{C as H}from"./color-select-DEYIoEID.js";import{L as Q}from"./line-stroke-select-BqvcYVMh.js";import{L as ee}from"./line-swatch-ICDQTLM-.js";import{L as ne}from"./locked-figure-aria-DsPtqjuL.js";import{L as re,a as ae}from"./locked-label-settings-C_Cnfp2w.js";import{L as A}from"./locked-point-settings-B0MdsZoC.js";import{g as le,j,a as L,b as te}from"./util-H5sE61uR.js";const S="The line cannot have length 0.",oe=k=>{const{kind:h,points:s,color:b,lineStyle:q="solid",showPoint1:N,showPoint2:V,labels:t,ariaLabel:_,onChangeProps:l,onMove:X,onRemove:I}=k,[o,i]=s,F=h.charAt(0).toUpperCase()+h.slice(1),M=`${F} (${o.coord[0]},
        ${o.coord[1]}), (${i.coord[0]}, ${i.coord[1]})`,x=O(o.coord,i.coord);async function R(){const e=await j(t),a=await j(o.labels),r=await j(i.labels),d=await L(`$${o.coord[0]}$`),g=await L(`$${o.coord[1]}$`),v=await L(`$${i.coord[0]}$`),f=await L(`$${i.coord[1]}$`);let c=`${F}${e} from point${a} at ${d} comma ${g} to point${r} at ${v} comma ${f}`;const $=te(b,q);return c+=$,c}function z(e,a){const r=[...s];r[a]={...s[a],...e};const d=y.midpoint(s[0].coord,s[1].coord),g=y.midpoint(r[0].coord,r[1].coord),v=[g[0]-d[0],g[1]-d[1]],f=t.map((c,$)=>({...c,coord:[c.coord[0]+v[0],c.coord[1]+v[1]]}));l({points:r,labels:f})}function B(e){const a=t.map(r=>({...r,color:e}));l({color:e,points:[{...o,color:e,labels:o.labels.map(r=>({...r,color:e}))},{...i,color:e,labels:i.labels.map(r=>({...r,color:e}))}],labels:a})}function D(e,a){const r=[...t];r[a]={...t[a],...e},l({labels:r})}function E(e){const a=t.filter((r,d)=>d!==e);l({labels:a})}return n.jsxs(G,{expanded:k.expanded,onToggle:k.onToggle,header:n.jsxs(w,{style:u.row,children:[n.jsx(W,{children:M}),n.jsx(p,{size:m.xSmall_8}),n.jsx(ee,{color:b,lineStyle:q})]}),children:[n.jsxs(C,{tag:"label",style:[u.row,u.spaceUnder],children:["kind",n.jsx(p,{size:m.xxxSmall_4}),n.jsxs(J,{selectedValue:h,onChange:e=>l({kind:e}),placeholder:"",children:[n.jsx(T,{value:"line",label:"line"}),n.jsx(T,{value:"ray",label:"ray"}),n.jsx(T,{value:"segment",label:"segment"})]})]}),n.jsxs(w,{style:u.row,children:[n.jsx(H,{selectedValue:b,onChange:B}),n.jsx(p,{size:m.small_12}),n.jsx(Q,{selectedValue:q,onChange:e=>l({lineStyle:e})})]}),x&&n.jsx(C,{style:u.errorText,children:S}),n.jsx(A,{headerLabel:"Point 1",expanded:!0,showPoint:N,error:x?S:null,...o,onTogglePoint:e=>l({showPoint1:e}),onChangeProps:e=>z(e,0)}),n.jsx(A,{headerLabel:"Point 2",expanded:!0,showPoint:V,error:x?S:null,...i,onTogglePoint:e=>l({showPoint2:e}),onChangeProps:e=>z(e,1)}),n.jsx(p,{size:m.small_12}),n.jsx(w,{style:u.horizontalRule}),n.jsx(ne,{ariaLabel:_,getPrepopulatedAriaLabel:R,onChangeProps:e=>{l(e)}}),n.jsx(p,{size:m.xxxSmall_4}),n.jsx(w,{style:u.horizontalRule}),n.jsx(p,{size:m.small_12}),n.jsx(C,{children:"Visible labels"}),t.map((e,a)=>Y.createElement(re,{...e,key:a,expanded:!0,onChangeProps:r=>{D(r,a)},onRemove:()=>{E(a)},containerStyle:u.labelContainer})),n.jsx(K,{kind:"tertiary",startIcon:Z,onClick:()=>{const e=[0,-1],a=y.add(y.scale(e,t.length),y.midpoint(s[0].coord,s[1].coord)),r={...le("label"),coord:a,color:b};l({labels:[...t,r]})},style:u.addButton,children:"Add visible label"}),n.jsx(ae,{figureType:k.type,onMove:X,onRemove:I})]})},u=U.StyleSheet.create({row:{display:"flex",flexDirection:"row",alignItems:"center"},spaceUnder:{marginBottom:m.xSmall_8},errorText:{color:P.red},addButton:{alignSelf:"start"},horizontalRule:{height:1,backgroundColor:P.offBlack16},labelContainer:{backgroundColor:P.white}});oe.__docgenInfo={description:"",methods:[],displayName:"LockedLineSettings",props:{type:{required:!0,tsType:{name:"literal",value:'"line"'},description:""},kind:{required:!0,tsType:{name:"union",raw:'"line" | "ray" | "segment"',elements:[{name:"literal",value:'"line"'},{name:"literal",value:'"ray"'},{name:"literal",value:'"segment"'}]},description:""},points:{required:!0,tsType:{name:"tuple",raw:"[point1: LockedPointType, point2: LockedPointType]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},color:{required:!0,tsType:{name:"unknown[number]",raw:"(typeof lockedFigureColorNames)[number]"},description:""},lineStyle:{required:!0,tsType:{name:"union",raw:'"solid" | "dashed"',elements:[{name:"literal",value:'"solid"'},{name:"literal",value:'"dashed"'}]},description:""},showPoint1:{required:!0,tsType:{name:"boolean"},description:""},showPoint2:{required:!0,tsType:{name:"boolean"},description:""},labels:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    type: "label";
    coord: Coord;
