var M=Object.defineProperty;var L=(d,c,n)=>c in d?M(d,c,{enumerable:!0,configurable:!0,writable:!0,value:n}):d[c]=n;var i=(d,c,n)=>(L(d,typeof c!="symbol"?c+"":c,n),n);import{j as e}from"./jsx-runtime-BT65X5dW.js";import{j as W,K as I,U as H}from"./util-AEEC48XJ.js";import{_ as w}from"./index-default-BcKQpA1a.js";import"./index-DktHmiAd.js";import{c as K}from"./all-widgets-DbXhSGpA.js";import"./index-DyG-XbLr.js";import"./answer-choices-By4zjEDp.js";import{L as z}from"./index-gdjMQqRz.js";import{r as G}from"./index-C6mWTJJr.js";import"./index-B1Gws05u.js";import"./i18n-context-CwGtWZ68.js";import"./perseus-api-fTM3z0tF.js";import"./renderer-C1IoSrZC.js";import"./free-response-Dtj1JbM2.js";import"./index-D7h-teXI.js";import"./jquery-CkHB0_Mt.js";import"./dependencies-BsVPGK1s.js";import"./zoomable-tex-Dy-nElJT.js";import"./svg-image-8T6Bqk5w.js";import"./no-important-DlFk8a1I.js";import"./number-input-Bqp2ujXM.js";import"./simple-keypad-input-Bl9QRvgR.js";import"./text-input-BdlNOW-6.js";import{B as O}from"./phet-simulation-DB19JjkO.js";import"./sortable-02mkrIKd.js";import"./fixed-to-responsive-CTsII9Xx.js";import"./math-input-DR_U1ncu.js";import"./video-transcript-link-CkTN7Z-b.js";import"./item-version-Bo-kovBX.js";import"./article-renderer-DQZ_NlRP.js";import"./server-item-renderer-Dl2jhlsm.js";import"./hints-renderer-C62gY8Lh.js";import"./base-radio-Bu4Eqt0j.js";import{c as $}from"./components-D_6o-wmV.js";import"./index-Dd-cahjY.js";import{E as U}from"./editor-jsonify-DU_LijSx.js";import{P as f}from"./index-MxyfnP9n.js";import{P as B,t as V}from"./trash-bold-D84F0Ijw.js";import{H as T}from"./heading-CX3Kt_jc.js";import{E as _}from"./editor-C6zq-Vey.js";const{InfoTip:v,NumberInput:j,TextInput:J}=$,{firstNumericalParse:R}=H,Q=[{title:"Integers",value:"integer",content:"6"},{title:"Decimals",value:"decimal",content:"0.75"},{title:"Proper fractions",value:"proper",content:"⅗"},{title:"Improper fractions",value:"improper",content:"⁷⁄₄"},{title:"Mixed numbers",value:"mixed",content:"1¾"},{title:"Numbers with π",value:"pi",content:"π"}],C=d=>({value:null,status:d,message:"",simplify:"required",answerForms:[],strict:!1,maxError:null});class P extends G.Component{constructor(n){super(n);i(this,"change",(...n)=>K.apply(this,n));i(this,"onToggleAnswers",n=>{const t=this.state.showAnswerDetails.slice();t[n]=!t[n],this.setState({showAnswerDetails:t})});i(this,"onToggleAnswerForm",(n,t)=>{let r=[...this.props.answers[n].answerForms??[]];r.includes(t)?r=r.filter(b=>b!==t):r.push(t);const l=this.updateAnswer(n,"answerForms");l&&l(r)});i(this,"onToggleHeading",n=>()=>{const t=`show${n}`,r={...this.state};r[t]=!r[t],this.setState(r)});i(this,"onTrashAnswer",n=>{if(n>=0&&n<this.props.answers.length){const t=this.props.answers.slice(0);t.splice(n,1),this.props.onChange({answers:t})}});i(this,"onSpace",(n,t,...r)=>{n.key===" "&&(n.preventDefault(),t.apply(this,r))});i(this,"onStatusChange",n=>{const t=["wrong","ungraded","correct"],r=this.props.answers,o=t.indexOf(r[n].status),l=t[(o+1)%t.length];this.updateAnswer(n,{status:l,simplify:l==="correct"?"required":"accepted"})});i(this,"onEvaluationChange",(n,t)=>{this.updateAnswer(n,{status:t,simplify:t==="correct"?"required":"accepted"})});i(this,"updateAnswer",(n,t)=>{if(!w.isObject(t))return w.partial((o,l,b)=>{const k={};k[l]=b,this.updateAnswer(o,k)},n,t);let r=[...this.props.answers];if(n===r.length){const o=C(this.state.lastStatus);r=r.concat(o)}r[n]=w.extend({},r[n],t),this.props.onChange({answers:r})});i(this,"addAnswer",()=>{const n=C(this.state.lastStatus),t=this.props.answers.concat(n),r=this.state.showAnswerDetails.concat(!0);this.setState({showAnswerDetails:r}),this.props.onChange({answers:t})});i(this,"getSaveWarnings",()=>{const n=[];return w.contains(w.pluck(this.props.answers,"value"),"")&&n.push("One or more answers is empty"),this.props.answers.forEach((t,r)=>{t.strict&&(!t.answerForms||t.answerForms.length===0)&&n.push(`Answer ${r+1} is set to string format matching, but no format was selected`)}),n});i(this,"serialize",()=>U.serialize.call(this));this.state={lastStatus:"wrong",showAnswerDetails:Array(this.props.answers.length).fill(!0),showSettings:!0,showAnswers:!0}}render(){const n=this.props.answers,t={size:"medium",role:"radio",style:{marginRight:"8px"}},r=a=>{const{kind:s,onClick:m,ariaLabel:u,children:p}=a,g=a.role??"radio",y={...t,"aria-label":u,kind:s,role:g,onClick:m};return e.jsx(f,{...y,children:p})},o=a=>{const{answerIndex:s,answerProperty:m,value:u,children:p}=a,y=n[s][m]===u?"accent":"transparent",A={};A[m]=u;const h=a.onClick??(()=>{this.updateAnswer(s,A)});return e.jsx(r,{kind:y,onClick:h,children:p})},l=a=>e.jsxs("fieldset",{className:"perseus-widget-row unsimplified-options",children:[n[a].status!=="correct"&&e.jsx(e.Fragment,{children:e.jsx("legend",{className:"inline-options",children:"Unsimplified answers are irrelevant for this status"})}),n[a].status==="correct"&&e.jsxs(e.Fragment,{children:[e.jsx("legend",{className:"inline-options",children:"Unsimplified answers are"}),e.jsx("span",{className:"tooltip-for-legend",children:e.jsxs(v,{children:[e.jsx("p",{children:'Normally select "ungraded". This will give the user a message saying the answer is correct but not simplified. The user will then have to simplify it and re-enter, but will not be penalized. (5th grade and after)'}),e.jsx("p",{children:'Select "accepted" only if the user is not expected to know how to simplify fractions yet. (Anything prior to 5th grade)'}),e.jsxs("p",{children:['Select "wrong" ',e.jsx("em",{children:"only"})," if we are specifically assessing the ability to simplify."]})]})}),e.jsx("br",{}),e.jsx(o,{answerIndex:a,answerProperty:"simplify",value:"required",children:"Ungraded"}),e.jsx(o,{answerIndex:a,answerProperty:"simplify",value:"optional",children:"Accepted"}),e.jsx(o,{answerIndex:a,answerProperty:"simplify",value:"enforced",children:"Wrong"})]})]}),b=a=>e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"perseus-widget-row",children:[e.jsx("label",{children:"Possible answer formats "}),e.jsxs(v,{children:[e.jsx("p",{children:'Formats will be autoselected for you based on the given answer; to show no suggested formats and accept all types, simply have a decimal/integer be the answer. Values with π will have format "pi", and values that are fractions will have some subset (mixed will be "mixed" and "proper"; improper/proper will both be "improper" and "proper"). If you would like to specify that it is only a proper fraction (or only a mixed/improper fraction), deselect the other format. Except for specific cases, you should not need to change the autoselected formats.'}),e.jsxs("p",{children:["To restrict the answer to ",e.jsx("em",{children:"only"}),' an improper fraction (i.e. 7/4), select the improper fraction and toggle "strict" to true. This ',e.jsx("b",{children:"will not"})," ","accept 1.75 as an answer."," "]}),e.jsx("p",{children:"Unless you are testing that specific skill, please do not restrict the answer format."})]}),e.jsx("br",{}),Q.map(s=>{var g;const u=((g=n[a].answerForms)==null?void 0:g.includes(s.value))?"accent":"transparent",p=()=>{this.onToggleAnswerForm(a,s.value)};return e.jsx(r,{ariaLabel:s.title,kind:u,role:"checkbox",onClick:p,children:s.content},s.value)})]}),e.jsxs("fieldset",{className:"perseus-widget-row",children:[e.jsx("legend",{children:"Answer formats are: "}),e.jsx(o,{answerIndex:a,answerProperty:"strict",value:!1,children:"Suggested"}),e.jsx(o,{answerIndex:a,answerProperty:"strict",value:!0,children:"Required"})]})]}),k=e.jsxs("fieldset",{className:"perseus-widget-row",children:[e.jsx("legend",{className:"inline-options",children:"Width: "}),e.jsx(f,{...t,kind:this.props.size==="normal"?"accent":"transparent",onClick:()=>{this.change("size")("normal")},children:"Normal (80px)"}),e.jsx(f,{...t,kind:this.props.size==="small"?"accent":"transparent",onClick:()=>{this.change("size")("small")},children:"Small (40px)"}),e.jsx(v,{children:e.jsx("p",{children:'Use size "Normal" for all text boxes, unless there are multiple text boxes in one line and the answer area is too narrow to fit them.'})})]}),F=e.jsxs("fieldset",{className:"perseus-widget-row",children:[e.jsx("legend",{className:"inline-options",children:"Alignment: "}),e.jsx(f,{...t,kind:this.props.rightAlign?"transparent":"accent",onClick:()=>{this.props.onChange({rightAlign:!1})},children:"Left"}),e.jsx(f,{...t,kind:this.props.rightAlign?"accent":"transparent",onClick:()=>{this.props.onChange({rightAlign:!0})},children:"Right"})]}),q=e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"perseus-widget-row",children:[e.jsx("label",{children:"Aria label"}),e.jsx(v,{children:e.jsx("p",{children:"Text to describe this input. This will be shown to users using screenreaders."})})]}),e.jsx(J,{labelText:"aria label",value:this.props.labelText,onChange:this.change("labelText")})]}),E=e.jsxs("fieldset",{className:"perseus-widget-row",children:[e.jsx("legend",{className:"inline-options",children:"Number style: "}),e.jsx(f,{...t,kind:this.props.coefficient?"transparent":"accent",onClick:()=>{this.props.onChange({coefficient:!1})},children:"Standard"}),e.jsx(f,{...t,kind:this.props.coefficient?"accent":"transparent",onClick:()=>{this.props.onChange({coefficient:!0})},children:"Coefficient"}),e.jsx(v,{children:e.jsx("p",{children:"A coefficient style number allows the student to use - for -1 and an empty string to mean 1."})})]}),D={wrong:"(address the mistake/misconception)",ungraded:"(explain in detail to avoid confusion)",correct:"(reinforce the user's understanding)"},S=()=>n.map((a,s)=>{const m=e.jsx(_,{apiOptions:this.props.apiOptions,content:a.message||"",placeholder:"Why is this answer "+a.status+"?	"+D[a.status],widgetEnabled:!1,onChange:h=>{"content"in h&&this.updateAnswer(s,{message:h.content})}}),u=a.status.charAt(0).toUpperCase()+a.status.slice(1),p=(a.answerForms||[]).at(-1),g=I.toNumericString(a.value??0,p),y=a.maxError?`± ${I.toNumericString(a.maxError,p)}`:"",A=a.value===null?"New Answer":`${u} answer: ${g} ${y}`;return e.jsx("div",{className:"perseus-widget-row answer-option",children:e.jsxs(B,{animated:!0,expanded:this.state.showAnswerDetails[s],onToggle:()=>{this.onToggleAnswers(s)},header:e.jsx(z,{children:A}),children:[e.jsxs("div",{className:"input-answer-editor-value-container"+(a.maxError?" with-max-error":""),children:[e.jsxs("label",{children:["User input:",e.jsx(j,{value:a.value,className:"numeric-input-value",placeholder:"answer",format:w.last(a.answerForms||[]),onFormatChange:(h,x)=>{let N;x==="pi"?N=["pi"]:x==="mixed"?N=["proper","mixed"]:(x==="proper"||x==="improper")&&(N=["proper","improper"]),this.updateAnswer(s,{value:R(h),answerForms:N})},onChange:h=>{this.updateAnswer(s,{value:R(h)})}})]}),e.jsx("span",{className:"max-error-plusmn",children:"±"}),e.jsx(j,{className:"max-error-input-value",placeholder:0,value:n[s].maxError,format:w.last(a.answerForms||[]),onChange:this.updateAnswer(s,"maxError")})]}),e.jsxs("fieldset",{className:"perseus-widget-row",children:[e.jsx("legend",{className:"inline-options",children:"Status:"}),e.jsx(o,{answerIndex:s,answerProperty:"status",value:"correct",onClick:()=>{this.onEvaluationChange(s,"correct")},children:"Correct"}),e.jsx(o,{answerIndex:s,answerProperty:"status",value:"wrong",onClick:()=>{this.onEvaluationChange(s,"wrong")},children:"Wrong"}),e.jsx(o,{answerIndex:s,answerProperty:"status",value:"ungraded",onClick:()=>{this.onEvaluationChange(s,"ungraded")},children:"Ungraded"})]}),l(s),e.jsx("div",{className:"perseus-widget-row",children:"(Articles only) Message shown to user:"}),m,b(s),e.jsx(O,{startIcon:V,"aria-label":`Delete ${A}`,className:"delete-item-button",onClick:()=>{this.onTrashAnswer(s)},kind:"tertiary",children:"Delete"})]})},s)});return e.jsxs("div",{className:"perseus-input-number-editor",children:[e.jsx(T,{title:"General Settings",isCollapsible:!0,isOpen:this.state.showSettings,onToggle:this.onToggleHeading("Settings")}),e.jsx("div",{className:`perseus-editor-accordion-container ${this.state.showSettings?"expanded":"collapsed"}`,children:e.jsxs("div",{className:"perseus-editor-accordion-content",children:[k,F,E,q]})}),e.jsx(T,{title:"Answers",isCollapsible:!0,isOpen:this.state.showAnswers,onToggle:this.onToggleHeading("Answers")}),e.jsx("div",{className:`perseus-editor-accordion-container ${this.state.showAnswers?"expanded":"collapsed"}`,children:e.jsxs("div",{className:"perseus-editor-accordion-content",children:[S(),e.jsx(O,{kind:"tertiary",onClick:this.addAnswer,children:"Add new answer"})]})})]})}}i(P,"widgetName","numeric-input"),i(P,"displayName","NumericInputEditor"),i(P,"defaultProps",W.defaultWidgetOptions);P.__docgenInfo={description:"",methods:[{name:"change",docblock:null,modifiers:[],params:[{name:"...args",optional:!1,type:null}],returns:null},{name:"onToggleAnswers",docblock:null,modifiers:[],params:[{name:"answerIndex",optional:!1,type:{name:"number"}}],returns:null},{name:"onToggleAnswerForm",docblock:null,modifiers:[],params:[{name:"answerIndex",optional:!1,type:{name:"number"}},{name:"answerForm",optional:!1,type:null}],returns:null},{name:"onToggleHeading",docblock:null,modifiers:[],params:[{name:"accordionName",optional:!1,type:{name:"string"}}],returns:null},{name:"onTrashAnswer",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null}],returns:null},{name:"onSpace",docblock:null,modifiers:[],params:[{name:"e",optional:!1,type:null},{name:"callback",optional:!1,type:null},{name:"...args",optional:!1,type:null}],returns:null},{name:"onStatusChange",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null}],returns:null},{name:"onEvaluationChange",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null},{name:"newStatus",optional:!1,type:null}],returns:null},{name:"updateAnswer",docblock:null,modifiers:[],params:[{name:"choiceIndex",optional:!1,type:null},{name:"update",optional:!1,type:null}],returns:null},{name:"addAnswer",docblock:null,modifiers:[],params:[],returns:null},{name:"getSaveWarnings",docblock:null,modifiers:[],params:[],returns:null},{name:"serialize",docblock:null,modifiers:[],params:[],returns:null}],displayName:"NumericInputEditor",props:{onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(results: any) => any",signature:{arguments:[{type:{name:"any"},name:"results"}],return:{name:"any"}}},description:""},apiOptions:{required:!1,tsType:{name:"Readonly",elements:[{name:"intersection",raw:`APIOptions & {
