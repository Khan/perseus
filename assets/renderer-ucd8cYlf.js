...
any other kind of terminal punctuation.`});function Dn(r,e){return`Answer requires a button not found in the button sets: ${r} (in ${e})`}const Gn={"\\sqrt":"prealgebra","\\sin":"trig","\\cos":"trig","\\tan":"trig","\\log":"logarithms","\\ln":"logarithms"},zn=d.makeRule({name:"expression-widget",severity:d.Severity.WARNING,selector:"widget",lint:function(r,e,n,t,a){var u;if(r.currentNode().widgetType!=="expression")return;const i=r.currentNode().id;if(!i)return;const o=(u=a==null?void 0:a.widgets)==null?void 0:u[i];if(!o)return;const s=o.options.answerForms,l=o.options.buttonSets;for(const m of s)for(const[y,w]of Object.entries(Gn))if(m.value.includes(y)&&!l.includes(w))return Dn(y,w)}}),Un=d.makeRule({name:"extra-content-spacing",selector:"paragraph",pattern:/\s+$/,applies:function(r){return(r==null?void 0:r.contentType)==="article"},message:"No extra whitespace at the end of content blocks."}),Vn=d.makeRule({name:"heading-level-1",severity:d.Severity.WARNING,selector:"heading",lint:function(r,e,n,t){if(n[0].level===1)return`Don't use level-1 headings:
...
do not use additional indentation.`}),yr=d.makeRule({name:"static-widget-in-question-stem",severity:d.Severity.WARNING,selector:"widget",lint:(r,e,n,t,a)=>{var s;if((a==null?void 0:a.contentType)!=="exercise"||a.stack.includes("hint"))return;const i=r.currentNode().id;if(!i)return;const o=(s=a==null?void 0:a.widgets)==null?void 0:s[i];if(o&&o.static)return"Widget in question stem is static (non-interactive)."}}),pr=d.makeRule({name:"table-missing-cells",severity:d.Severity.WARNING,selector:"table",lint:function(r,e,n,t){const a=n[0],i=a.header.length,o=a.cells.map(s=>s.length);for(let s=0;s<o.length;s++)if(o[s]!==i)return`Table rows don't match header:
The table header has ${i} cells, but
Row ${s+1} has ${o[s]} cells.`}}),hr=d.makeRule({name:"unbalanced-code-delimiters",severity:d.Severity.ERROR,pattern:/[`~]+/,message:`Unbalanced code delimiters:
code blocks should begin and end with the same type and number of delimiters`}),cr=d.makeRule({name:"unescaped-dollar",severity:d.Severity.ERROR,selector:"unescapedDollar",message:`Unescaped dollar sign:
Dollar signs must appear in pairs or be escaped as \\$`}),wr=d.makeRule({name:"widget-in-table",severity:d.Severity.BULK_WARNING,selector:"table widget",message:`Widget in table:
do not put widgets inside of tables.`}),br=[Ln,Mn,Fn,_n,zn,Un,Vn,Hn,Kn,$n,Yn,Jn,er,nr,rr,tr,ar,ir,sr,or,lr,ur,dr,gr,yr,pr,cr,wr,mr,hr,Qn,Zn];class V{constructor(e){this.root=e}static isNode(e){return e&&typeof e=="object"&&typeof e.type=="string"}static isTextNode(e){return V.isNode(e)&&e.type==="text"&&typeof e.content=="string"}traverse(e){this._traverse(this.root,new Pe(this.root),e)}_traverse(e,n,t){let a="";if(V.isNode(e)){const i=e;n._containers.push(i),n._ancestors.push(i),typeof i.content=="string"&&(a=i.content),Object.keys(i).forEach(s=>{if(s==="type")return;const l=i[s];l&&typeof l=="object"&&(n._indexes.push(s),a+=this._traverse(l,n,t),n._indexes.pop())}),n._currentNode=n._ancestors.pop(),n._containers.pop(),t(i,n,a)}else if(Array.isArray(e)){const i=e;n._containers.push(i);let o=0;for(;o<i.length;)n._indexes.push(o),a+=this._traverse(i[o],n,t),o=n._indexes.pop()+1;n._containers.pop()}return a}}class Pe{constructor(e){this.root=e,this._currentNode=null,this._containers=new J,this._indexes=new J,this._ancestors=new J}currentNode(){return this._currentNode||this.root}parent(){return this._ancestors.top()}ancestors(){return this._ancestors.values()}nextSibling(){const e=this._containers.top();if(!e||!Array.isArray(e))return null;const n=this._indexes.top();return e.length>n+1?e[n+1]:null}previousSibling(){const e=this._containers.top();if(!e||!Array.isArray(e))return null;const n=this._indexes.top();return n>0?e[n-1]:null}removeNextSibling(){const e=this._containers.top();if(e&&Array.isArray(e)){const n=this._indexes.top();if(e.length>n+1)return e.splice(n+1,1)[0]}return null}replace(...e){const n=this._containers.top();if(!n)throw new E("Can't replace the root of the tree",R.Internal);if(Array.isArray(n)){const t=this._indexes.top();n.splice(t,1,...e),this._indexes.pop(),this._indexes.push(t+e.length-1)}else{const t=this._indexes.top();e.length===0?delete n[t]:e.length===1?n[t]=e[0]:n[t]=e}}hasPreviousSibling(){return Array.isArray(this._containers.top())&&this._indexes.top()>0}goToPreviousSibling(){if(!this.hasPreviousSibling())throw new E("goToPreviousSibling(): node has no previous sibling",R.Internal);this._currentNode=this.previousSibling();const e=this._indexes.pop();this._indexes.push(e-1)}hasParent(){return this._ancestors.size()!==0}goToParent(){if(!this.hasParent())throw new E("goToParent(): node has no ancestor",R.NotAllowed);for(this._currentNode=this._ancestors.pop();this._containers.size()&&this._containers.top()[this._indexes.top()]!==this._currentNode;)this._containers.pop(),this._indexes.pop()}clone(){const e=new Pe(this.root);return e._currentNode=this._currentNode,e._containers=this._containers.clone(),e._indexes=this._indexes.clone(),e._ancestors=this._ancestors.clone(),e}equals(e){return this.root===e.root&&this._currentNode===e._currentNode&&this._containers.equals(e._containers)&&this._indexes.equals(e._indexes)&&this._ancestors.equals(e._ancestors)}}class J{constructor(e){this.stack=e?e.slice(0):[]}push(e){this.stack.push(e)}pop(){return this.stack.pop()}top(){return this.stack[this.stack.length-1]}values(){return this.stack.slice(0)}size(){return this.stack.length}toString(){return this.stack.toString()}clone(){return new J(this.stack)}equals(e){if(!e||!e.stack||e.stack.length!==this.stack.length)return!1;for(let n=0;n<this.stack.length;n++)if(this.stack[n]!==e.stack[n])return!1;return!0}}const fr="@khanacademy/perseus-linter",vr="__lib_version__";Ce(fr,vr);var Ve={exports:{}},kr="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",qr=kr,Tr=dn,Ar=mn,Rr=qr,xr=function(){function r(t,a,i,o,s,l){l!==Rr&&Ar(!1,"Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types")}r.isRequired=r;function e(){return r}var n={array:r,bool:r,func:r,number:r,object:r,string:r,symbol:r,any:r,arrayOf:e,element:r,instanceOf:e,node:r,objectOf:e,oneOf:e,oneOfType:e,shape:e,exact:e};return n.checkPropTypes=Tr,n.PropTypes=n,n};Ve.exports=xr();var Cr=Ve.exports;const F=un(Cr);F.shape({contentType:F.string,highlightLint:F.bool,paths:F.arrayOf(F.string),stack:F.arrayOf(F.string)});const He={contentType:"",highlightLint:!1,paths:[],stack:[]},Pr=br.filter(r=>r.severity<d.Severity.BULK_WARNING);function Ir(r,e,n,t=Pr){const a=[],i=new V(r);i.traverse((l,u,m)=>{if(V.isTextNode(l)){let y=u.nextSibling();for(;V.isTextNode(y);)l.content+=y.content,u.removeNextSibling(),y=u.nextSibling()}});let o=[],s=!1;return i.traverse((l,u,m)=>{const y=[],w=t.filter(h=>h.applies(e)),q=[...e.stack];q.push(l.type);const A={...e,stack:q.join(".")};if(w.forEach(h=>{const f=h.check(l,u,m,A);f&&((f.start||f.end)&&(f.target=m.substring(f.start,f.end)),a.push(f),n&&y.push(f))}),!!n&&(l.type==="table"?(o.length&&y.push(...o),s=!1,o=[]):s||(s=u.ancestors().some(h=>h.type==="table")),s&&y.length&&o.push(...y),y.length))if(y.sort((h,f)=>h.severity-f.severity),l.type!=="text"||y.length>1)u.replace({type:"lint",content:l,message:y.map(h=>h.message).join(`

`),ruleName:y[0].rule,blockHighlight:A.blockHighlight,insideTable:s,severity:y[0].severity});else{const h=l.content,f=y[0],x=f.start||0,I=f.end||h.length,M=h.substring(0,x),C=h.substring(x,I),ee=h.substring(I),ne=[];M&&ne.push({type:"text",content:M}),ne.push({type:"lint",content:{type:"text",content:C},message:f.message,ruleName:f.rule,insideTable:s,severity:f.severity}),ee&&ne.push({type:"text",content:ee}),u.replace(...ne)}}),a}function Or(r,e){const n=r.stack||[];return{...r,stack:n.concat(e)}}const Er={activeDefinitionId:null,setActiveDefinitionId:()=>{}},Ke=j.createContext(Er);class ke extends j.Component{constructor(){super(...arguments),this.state={activeDefinitionId:null},this.setActiveDefinitionId=e=>{this.setState(n=>({activeDefinitionId:e}))}}render(){const{children:e}=this.props,{activeDefinitionId:n}=this.state,{setActiveDefinitionId:t}=this;return p.jsx(Ke.Provider,{value:{activeDefinitionId:n,setActiveDefinitionId:t},children:e})}}const ha=Ke.Consumer;ke.__docgenInfo={description:"",methods:[{name:"setActiveDefinitionId",docblock:null,modifiers:[],params:[{name:"activeDefinitionId",optional:!0,type:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]}}],returns:{type:{name:"void"}}}],displayName:"DefinitionProvider",props:{children:{required:!0,tsType:{name:"any"},description:""}}};class S extends j.Component{constructor(e){super(e),this.state={error:""}}componentDidCatch(e,n){var t,a;this.setState({error:e.toString()}),(a=(t=this.props).onError)==null||a.call(t,e,n),K.error("Unhandled Perseus error: "+e.message,R.Internal,{cause:e,loggedMetadata:{componentStack:n&&"componentStack"in n?n.componentStack:"componentStack not provided",...this.props.metadata}})}render(){return this.state.error?p.jsxs("svg",{height:"16",width:"16",viewBox:"0 0 16 16",role:"img",children:[p.jsx("title",{children:"Rendering Error!"}),p.jsx("path",{d:"m8 16c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm0-3c0.55 0 1-0.45 1-1s-0.45-1-1-1-1 0.45-1 1 0.45 1 1 1zm0-9c-0.55 0-1 0.45-1 1v4c0 0.55.45 1 1 1s1-0.45 1-1v-4c0-0.55-0.45-1-1-1z",fill:"#d92916",fillRule:"evenodd"})]}):this.props.children}}S.__docgenInfo={description:"",methods:[],displayName:"ErrorBoundary",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},metadata:{required:!1,tsType:{name:"Record",elements:[{name:"string"},{name:"string"}],raw:"Record<string, string>"},description:""},onError:{required:!1,tsType:{name:"signature",type:"function",raw:"(error: Error, info: any) => void",signature:{arguments:[{type:{name:"Error"},name:"error"},{type:{name:"any"},name:"info"}],return:{name:"void"}}},description:""}}};function Nr(){}class Sr{constructor(e,n,t,a){this._track=i=>{this._tracked&&!this.setting||(this._tracked=!0,this.trackApi({type:this.widgetType,id:this.widgetID,...i}))},e?(this._tracked=!1,this.trackApi=e,this.widgetType=n,this.widgetID=t,this.setting=a,this.track=this._track):this.track=Nr}}const jr="@khanacademy/simple-markdown",Wr="__lib_version__";Ce(jr,Wr);var Lr=/\r\n?/g,Mr=/\t/g,Fr=/\f/g,Xe=function(r){return r.replace(Lr,`
`).replace(Fr,"").replace(Mr,"    ")},Be=function(r,e){var n=r||{};if(e!=null)for(var t in e)Object.prototype.hasOwnProperty.call(e,t)&&(n[t]=e[t]);return n},$e=function(r,e){var n=Object.keys(r).filter(function(o){var s=r[o];if(s==null||s.match==null)return!1;var l=s.order;return(typeof l!="number"||!isFinite(l))&&typeof console<"u"&&console.warn("simple-markdown: Invalid order for rule `"+o+"`: "+String(l)),!0});n.sort(function(o,s){var l=r[o],u=r[s],m=l.order,y=u.order;if(m!==y)return m-y;var w=l.quality?0:1,q=u.quality?0:1;return w!==q?w-q:o<s?-1:o>s?1:0});var t,a=function(o,s){var l=[];for(s=s||t,t=s;o;){var u=null,m=null,y=null,w=NaN,q=0,A=n[0],h=r[A];do{var f=h.order,x=s.prevCapture==null?"":s.prevCapture[0],I=h.match(o,s,x);if(I){var M=h.quality?h.quality(I,s,x):0;M<=w||(u=A,m=h,y=I,w=M)}q++,A=n[q],h=r[A]}while(h&&(!y||h.order===f&&h.quality));if(m==null||y==null)throw new Error("Could not find a matching rule for the below content. The rule with highest `order` should always match content provided to it. Check the definition of `match` for '"+n[n.length-1]+`'. It seems to not match the following source:
`+o);if(y.index)throw new Error("`match` must return a capture starting at index 0 (the current parse index). Did you forget a ^ at the start of the RegExp?");var C=m.parse(y,a,s);if(Array.isArray(C))Array.prototype.push.apply(l,C);else{if(C==null||typeof C!="object")throw new Error(`parse() function returned invalid parse result: '${C}'`);C.type==null&&(C.type=u),l.push(C)}s.prevCapture=y,o=o.substring(s.prevCapture[0].length)}return l},i=function(o,s){return t=Be(s,e),!t.inline&&!t.disableAutoBlockNewlines&&(o=o+`

`),t.prevCapture=null,a(Xe(o),t)};return i},P=function(r){var e=function(n,t,a){return t.inline?r.exec(n):null};return e.regex=r,e},N=function(r){var e=function(n,t){return t.inline?null:r.exec(n)};return e.regex=r,e},qe=function(r){var e=function(n,t){return r.exec(n)};return e.regex=r,e},_r=typeof Symbol=="function"&&Symbol.for&&Symbol.for("react.element")||60103,v=function(r,e,n){var t={$$typeof:_r,type:r,key:e??void 0,ref:null,props:n,_owner:null};return t},T=function(r,e,n,t){n=n||{},t=typeof t<"u"?t:!0;var a="";for(var i in n){var o=n[i];Object.prototype.hasOwnProperty.call(n,i)&&o&&(a+=" "+H(i)+'="'+H(o)+'"')}var s="<"+r+a+">";return t?s+e+"</"+r+">":s},Dr={},$=function(r){if(r==null)return null;try{var e=new URL(r,"https://localhost").protocol;if(e.indexOf("javascript:")===0||e.indexOf("vbscript:")===0||e.indexOf("data:")===0)return null}catch{return null}return r},Gr=/[<>&"']/g,zr={"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;","'":"&#x27;","/":"&#x2F;","`":"&#96;"},H=function(r){return String(r).replace(Gr,function(e){return zr[e]})},Ur=/\\([^0-9A-Za-z\s])/g,Te=function(r){return r.replace(Ur,"$1")},oe=function(r,e,n){var t=n.inline||!1;n.inline=!0;var a=r(e,n);return n.inline=t,a},Vr=function(r,e,n){var t=n.inline||!1;n.inline=!1;var a=r(e+`

`,n);return n.inline=t,a},re=function(r,e,n){return{content:oe(e,r[1],n)}},we=function(){return{}},le="(?:[*+-]|\\d+\\.)",Ye="( *)("+le+") +",je=new RegExp("^"+Ye),Hr=new RegExp(Ye+"[^\\n]*(?:\\n(?!\\1"+le+` )[^\\n]*)*(
|$)`,"gm"),Je=/\n{2,}$/,Kr=/^ (?= *`)|(` *) $/g,Xr=Je,We=/ *\n+$/,Br=new RegExp("^( *)("+le+`) [\\s\\S]+?(?:
{2,}(?! )(?!\\1`+le+` )\\n*|\\s*
*$)`),$r=/(?:^|\n)( *)$/,te=function(){var r=/^ *\| *| *\| *$/g,e=/ *$/,n=/^ *-+: *$/,t=/^ *:-+: *$/,a=/^ *:-+ *$/,i=function(m){return n.test(m)?"right":t.test(m)?"center":a.test(m)?"left":null},o=function(m,y,w,q){q&&(m=m.replace(r,""));var A=m.trim().split("|");return A.map(i)},s=function(m,y,w,q){var A=w.inTable;w.inTable=!0;var h=y(m.trim(),w);w.inTable=A;var f=[[]];return h.forEach(function(x,I){x.type==="tableSeparator"?(!q||I!==0&&I!==h.length-1)&&f.push([]):(x.type==="text"&&(h[I+1]==null||h[I+1].type==="tableSeparator")&&(x.content=x.content.replace(e,"")),f[f.length-1].push(x))}),f},l=function(m,y,w,q){var A=m.trim().split(`
`);return A.map(function(h){return s(h,y,w,q)})},u=function(m){return function(y,w,q){q.inline=!0;var A=s(y[1],w,q,m),h=o(y[2],w,q,m),f=l(y[3],w,q,m);return q.inline=!1,{type:"table",header:A,align:h,cells:f}}};return{parseTable:u(!0),parseNpTable:u(!1),TABLE_REGEX:/^ *(\|.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/,NPTABLE_REGEX:/^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/}}(),ae="(?:\\[[^\\]]*\\]|[^\\[\\]]|\\](?=[^\\[]*\\]))*",Le=`\\s*<?((?:\\([^)]*\\)|[^\\s\\\\]|\\\\.)*?)>?(?:\\s+['"]([\\s\\S]*?)['"])?\\s*`,Yr=/mailto:/i,Me=function(r,e,n){var t=(r[2]||r[1]).replace(/\s+/g," ").toLowerCase();if(e._defs&&e._defs[t]){var a=e._defs[t];n.target=a.target,n.title=a.title}return e._refs=e._refs||{},e._refs[t]=e._refs[t]||[],e._refs[t].push(n),n},b=0,Z={Array:{react:function(r,e,n){for(var t=n.key,a=[],i=0,o=0;i<r.length;i++,o++){n.key=""+i;var s=r[i];if(s.type==="text")for(s={type:"text",content:s.content};i+1<r.length&&r[i+1].type==="text";i++)s.content+=r[i+1].content;a.push(e(s,n))}return n.key=t,a},html:function(r,e,n){for(var t="",a=0;a<r.length;a++){var i=r[a];if(i.type==="text")for(i={type:"text",content:i.content};a+1<r.length&&r[a+1].type==="text";a++)i.content+=r[a+1].content;t+=e(i,n)}return t}},heading:{order:b++,match:N(/^ *(#{1,6})([^\n]+?)#* *(?:\n *)+\n/),parse:function(r,e,n){return{level:r[1].length,content:oe(e,r[2].trim(),n)}},react:function(r,e,n){return v("h"+r.level,n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("h"+r.level,e(r.content,n))}},nptable:{order:b++,match:N(te.NPTABLE_REGEX),parse:te.parseNpTable,react:null,html:null},lheading:{order:b++,match:N(/^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/),parse:function(r,e,n){return{type:"heading",level:r[2]==="="?1:2,content:oe(e,r[1],n)}},react:null,html:null},hr:{order:b++,match:N(/^( *[-*_]){3,} *(?:\n *)+\n/),parse:we,react:function(r,e,n){return v("hr",n.key,{"aria-hidden":!0})},html:function(r,e,n){return'<hr aria-hidden="true">'}},codeBlock:{order:b++,match:N(/^(?:    [^\n]+\n*)+(?:\n *)+\n/),parse:function(r,e,n){var t=r[0].replace(/^    /gm,"").replace(/\n+$/,"");return{lang:void 0,content:t}},react:function(r,e,n){var t=r.lang?"markdown-code-"+r.lang:void 0;return v("pre",n.key,{children:v("code",null,{className:t,children:r.content})})},html:function(r,e,n){var t=r.lang?"markdown-code-"+r.lang:void 0,a=T("code",H(r.content),{class:t});return T("pre",a)}},fence:{order:b++,match:N(/^ *(`{3,}|~{3,}) *(?:(\S+) *)?\n([\s\S]+?)\n?\1 *(?:\n *)+\n/),parse:function(r,e,n){return{type:"codeBlock",lang:r[2]||void 0,content:r[3]}},react:null,html:null},blockQuote:{order:b++,match:N(/^( *>[^\n]+(\n[^\n]+)*\n*)+\n{2,}/),parse:function(r,e,n){var t=r[0].replace(/^ *> ?/gm,"");return{content:e(t,n)}},react:function(r,e,n){return v("blockquote",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("blockquote",e(r.content,n))}},list:{order:b++,match:function(r,e){var n=e.prevCapture==null?"":e.prevCapture[0],t=$r.exec(n),a=e._list||!e.inline;return t&&a?(r=t[1]+r,Br.exec(r)):null},parse:function(r,e,n){var t=r[2],a=t.length>1,i=a?+t:void 0,o=r[0].replace(Xr,`
`).match(Hr),s=!1,l=o.map(function(u,m){var y=je.exec(u),w=y?y[0].length:0,q=new RegExp("^ {1,"+w+"}","gm"),A=u.replace(q,"").replace(je,""),h=m===o.length-1,f=A.indexOf(`

`)!==-1,x=f||h&&s;s=x;var I=n.inline,M=n._list;n._list=!0;var C;x?(n.inline=!1,C=A.replace(We,`

`)):(n.inline=!0,C=A.replace(We,""));var ee=e(C,n);return n.inline=I,n._list=M,ee});return{ordered:a,start:i,items:l}},react:function(r,e,n){var t=r.ordered?"ol":"ul";return v(t,n.key,{start:r.start,children:r.items.map(function(a,i){return v("li",""+i,{children:e(a,n)})})})},html:function(r,e,n){var t=r.items.map(function(o){return T("li",e(o,n))}).join(""),a=r.ordered?"ol":"ul",i={start:r.start};return T(a,t,i)}},def:{order:b++,match:N(/^ *\[([^\]]+)\]: *<?([^\s>]*)>?(?: +["(]([^\n]+)[")])? *\n(?: *\n)*/),parse:function(r,e,n){var t=r[1].replace(/\s+/g," ").toLowerCase(),a=r[2],i=r[3];return n._refs&&n._refs[t]&&n._refs[t].forEach(function(o){o.target=a,o.title=i}),n._defs=n._defs||{},n._defs[t]={target:a,title:i},{def:t,target:a,title:i}},react:function(){return null},html:function(){return""}},table:{order:b++,match:N(te.TABLE_REGEX),parse:te.parseTable,react:function(r,e,n){var t=function(o){return r.align[o]==null?{}:{textAlign:r.align[o]}},a=r.header.map(function(o,s){return v("th",""+s,{style:t(s),scope:"col",children:e(o,n)})}),i=r.cells.map(function(o,s){return v("tr",""+s,{children:o.map(function(l,u){return v("td",""+u,{style:t(u),children:e(l,n)})})})});return v("table",n.key,{children:[v("thead","thead",{children:v("tr",null,{children:a})}),v("tbody","tbody",{children:i})]})},html:function(r,e,n){var t=function(l){return r.align[l]==null?"":"text-align:"+r.align[l]+";"},a=r.header.map(function(l,u){return T("th",e(l,n),{style:t(u),scope:"col"})}).join(""),i=r.cells.map(function(l){var u=l.map(function(m,y){return T("td",e(m,n),{style:t(y)})}).join("");return T("tr",u)}).join(""),o=T("thead",T("tr",a)),s=T("tbody",i);return T("table",o+s)}},newline:{order:b++,match:N(/^(?:\n *)*\n/),parse:we,react:function(r,e,n){return`
`},html:function(r,e,n){return`
`}},paragraph:{order:b++,match:N(/^((?:[^\n]|\n(?! *\n))+)(?:\n *)+\n/),parse:re,react:function(r,e,n){return v("div",n.key,{className:"paragraph",children:e(r.content,n)})},html:function(r,e,n){var t={class:"paragraph"};return T("div",e(r.content,n),t)}},escape:{order:b++,match:P(/^\\([^0-9A-Za-z\s])/),parse:function(r,e,n){return{type:"text",content:r[1]}},react:null,html:null},tableSeparator:{order:b++,match:function(r,e){return e.inTable?/^ *\| */.exec(r):null},parse:function(){return{type:"tableSeparator"}},react:function(){return" | "},html:function(){return" &vert; "}},autolink:{order:b++,match:P(/^<([^: >]+:\/[^ >]+)>/),parse:function(r,e,n){return{type:"link",content:[{type:"text",content:r[1]}],target:r[1]}},react:null,html:null},mailto:{order:b++,match:P(/^<([^ >]+@[^ >]+)>/),parse:function(r,e,n){var t=r[1],a=r[1];return Yr.test(a)||(a="mailto:"+a),{type:"link",content:[{type:"text",content:t}],target:a}},react:null,html:null},url:{order:b++,match:P(/^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/),parse:function(r,e,n){return{type:"link",content:[{type:"text",content:r[1]}],target:r[1],title:void 0}},react:null,html:null},link:{order:b++,match:P(new RegExp("^\\[("+ae+")\\]\\("+Le+"\\)")),parse:function(r,e,n){var t={content:e(r[1],n),target:Te(r[2]),title:r[3]};return t},react:function(r,e,n){return v("a",n.key,{href:$(r.target),title:r.title,children:e(r.content,n)})},html:function(r,e,n){var t={href:$(r.target),title:r.title};return T("a",e(r.content,n),t)}},image:{order:b++,match:P(new RegExp("^!\\[("+ae+")\\]\\("+Le+"\\)")),parse:function(r,e,n){var t={alt:r[1],target:Te(r[2]),title:r[3]};return t},react:function(r,e,n){return v("img",n.key,{src:$(r.target),alt:r.alt,title:r.title})},html:function(r,e,n){var t={src:$(r.target),alt:r.alt,title:r.title};return T("img","",t,!1)}},reflink:{order:b++,match:P(new RegExp("^\\[("+ae+")\\]\\s*\\[([^\\]]*)\\]")),parse:function(r,e,n){return Me(r,n,{type:"link",content:e(r[1],n)})},react:null,html:null},refimage:{order:b++,match:P(new RegExp("^!\\[("+ae+")\\]\\s*\\[([^\\]]*)\\]")),parse:function(r,e,n){return Me(r,n,{type:"image",alt:r[1]})},react:null,html:null},em:{order:b,match:P(new RegExp("^\\b_((?:__|\\\\[\\s\\S]|[^\\\\_])+?)_\\b|^\\*(?=\\S)((?:\\*\\*|\\\\[\\s\\S]|\\s+(?:\\\\[\\s\\S]|[^\\s\\*\\\\]|\\*\\*)|[^\\s\\*\\\\])+?)\\*(?!\\*)")),quality:function(r){return r[0].length+.2},parse:function(r,e,n){return{content:e(r[2]||r[1],n)}},react:function(r,e,n){return v("em",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("em",e(r.content,n))}},strong:{order:b,match:P(/^\*\*((?:\\[\s\S]|[^\\])+?)\*\*(?!\*)/),quality:function(r){return r[0].length+.1},parse:re,react:function(r,e,n){return v("strong",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("strong",e(r.content,n))}},u:{order:b++,match:P(/^__((?:\\[\s\S]|[^\\])+?)__(?!_)/),quality:function(r){return r[0].length},parse:re,react:function(r,e,n){return v("u",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("u",e(r.content,n))}},del:{order:b++,match:P(/^~~(?=\S)((?:\\[\s\S]|~(?!~)|[^\s~\\]|\s(?!~~))+?)~~/),parse:re,react:function(r,e,n){return v("del",n.key,{children:e(r.content,n)})},html:function(r,e,n){return T("del",e(r.content,n))}},inlineCode:{order:b++,match:P(/^(`+)([\s\S]*?[^`])\1(?!`)/),parse:function(r,e,n){return{content:r[2].replace(Kr,"$1")}},react:function(r,e,n){return v("code",n.key,{children:r.content})},html:function(r,e,n){return T("code",H(r.content))}},br:{order:b++,match:qe(/^ {2,}\n/),parse:we,react:function(r,e,n){return v("br",n.key,Dr)},html:function(r,e,n){return"<br>"}},text:{order:b++,match:qe(/^[\s\S]+?(?=[^0-9A-Za-z\s\u00c0-\uffff]|\n\n| {2,}\n|\w+:\S|$)/),parse:function(r,e,n){return{content:r[0]}},react:function(r,e,n){return r.content},html:function(r,e,n){return H(r.content)}}},Jr=function(r,e){!e&&typeof console<"u"&&console.warn("simple-markdown ruleOutput should take 'react' or 'html' as the second argument.");var n=function(t,a,i){return r[t.type][e](t,a,i)};return n},Qr=function(r){var e=function(n,t){if(t=t||{},Array.isArray(n)){for(var a=t.key,i=[],o=null,s=0;s<n.length;s++){t.key=""+s;var l=e(n[s],t);typeof l=="string"&&typeof o=="string"?(o=o+l,i[i.length-1]=o):(i.push(l),o=l)}return t.key=a,i}else return r(n,e,t)};return e},Zr=function(r){var e=function(n,t){return t=t||{},Array.isArray(n)?n.map(function(a){return e(a,t)}).join(""):r(n,e,t)};return e},Ie=function(r,e,n={}){if(!e)throw new Error("simple-markdown: outputFor: `property` must be defined. if you just upgraded, you probably need to replace `outputFor` with `reactFor`");var t,a=r.Array||Z.Array,i=a[e];if(!i)throw new Error("simple-markdown: outputFor: to join nodes of type `"+e+"` you must provide an `Array:` joiner rule with that type, Please see the docs for details on specifying an Array rule.");var o=i,s=function(u,m){return m=m||t,t=m,Array.isArray(u)?o(u,s,m):r[u.type][e](u,s,m)},l=function(u,m){return t=Be(m,n),s(u,t)};return l},ye=$e(Z),Oe=function(r,e){return e=e||{},e.inline=!1,ye(r,e)},et=function(r,e){return e=e||{},e.inline=!0,ye(r,e)},Fe=function(r,e){var n=Je.test(r);return e=e||{},e.inline=!n,ye(r,e)},Ae=Ie(Z,"react"),Qe=Ie(Z,"html"),Ze=function(r,e){return Ae(Oe(r,e),e)},nt=function(r,e){return Qe(Oe(r,e),e)},rt=function(r){var e={};for(var n in r)n!=="source"&&Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n]);return e.children=Ze(r.source),v("div",null,e)},c={defaultRules:Z,parserFor:$e,outputFor:Ie,inlineRegex:P,blockRegex:N,anyScopeRegex:qe,parseInline:oe,parseBlock:Vr,markdownToReact:Ze,markdownToHtml:nt,ReactMarkdown:rt,defaultBlockParse:Oe,defaultInlineParse:et,defaultImplicitParse:Fe,defaultReactOutput:Ae,defaultHtmlOutput:Qe,preprocess:Xe,sanitizeText:H,sanitizeUrl:$,unescapeUrl:Te,htmlTag:T,reactElement:v,defaultRawParse:ye,ruleOutput:Jr,reactFor:Qr,htmlFor:Zr,defaultParse:function(...r){return typeof console<"u"&&console.warn("defaultParse is deprecated, please use `defaultImplicitParse`"),Fe.apply(null,r)},defaultOutput:function(...r){return typeof console<"u"&&console.warn("defaultOutput is deprecated, please use `defaultReactOutput`"),Ae.apply(null,r)}};const tt={fence:{match:c.defaultRules.fence.match,order:1,parse:(r,e,n)=>({type:"codeBlock",lang:r[2]||void 0,content:r[3]})},paragraph:{match:c.defaultRules.paragraph.match,order:2,parse:(r,e,n)=>({content:r[1]})}},at=c.parserFor(tt),it=r=>{const e=r.replace(/^\n\s*\n/,"")+`
...
`&&r[a-1]===`
`)return null;a++}return null},dt=(r,e)=>en(r,e,!1),mt=(r,e)=>en(r,e,!0),gt=new RegExp("^\\|\\| +(.*) +\\|\\| *\\n("+c.defaultRules.nptable.match.regex.source.substring(1)+")"),yt=c.blockRegex(/^(crwdns.*)\n\s*\n/),O={...c.defaultRules,columns:{order:-2,match:c.blockRegex(/^([\s\S]*\n\n)={5,}\n\n([\s\S]*)/),parse:(r,e,n)=>({col1:e(r[1],n),col2:e(r[2],n)})},crowdinId:{order:-1,match:(r,e,n)=>e.isJipt?yt(r,e,n):null,parse:(r,e,n)=>({id:r[1]})},titledTable:{order:c.defaultRules.nptable.order-.5,match:c.blockRegex(gt),parse:(r,e,n)=>{const t=c.parseInline(e,r[1],n),a=r.slice(2),i=c.defaultRules.nptable.parse(a,e,n);return{title:t,table:i}}},widget:{order:c.defaultRules.link.order-.75,match:c.inlineRegex(ut),parse:(r,e,n)=>({id:r[1],widgetType:r[2]})},blockMath:{order:c.defaultRules.codeBlock.order+.5,match:mt,parse:(r,e,n)=>({content:r[1]})},math:{order:c.defaultRules.link.order-.25,match:dt,parse:(r,e,n)=>({content:r[1]})},unescapedDollar:{order:c.defaultRules.link.order-.24,match:c.inlineRegex(/^(?!\\)\$/),parse:(r,e,n)=>({})},fence:{...c.defaultRules.fence,parse:(r,e,n)=>{const t=c.defaultRules.fence.parse(r,e,n);return t.lang==="alt"?{type:"codeBlock",lang:"alt",content:e(t.content+`

`,n)}:t}},blockQuote:{...c.defaultRules.blockQuote,match:c.blockRegex(/^ *>[^\n]+(\n( *>)?[^\n]+)*\n{2,}/)},lint:{order:1e3,match:r=>null,parse:(r,e,n)=>({})}};c.parserFor(O);const Q={...O,columns:{...O.columns,react:(r,e,n)=>p.jsxs("div",{className:"perseus-two-columns",children:[p.jsx("div",{className:"perseus-column",children:p.jsx("div",{className:"perseus-column-content",children:e(r.col1,n)})}),p.jsx("div",{className:"perseus-column",children:p.jsx("div",{className:"perseus-column-content",children:e(r.col2,n)})})]},n.key)},crowdinId:{...O.crowdinId,react:(r,e,n)=>r.id},table:{...O.table,react:function(r,e,n){const t=c.defaultRules.table.react(r,e,n);return n.isMobile?j.cloneElement(t,{tabIndex:0}):t}},titledTable:{...O.titledTable,react:(r,e,n)=>{var a;let t;if(!r.table)t="//invalid table//";else if(r.table.type==="lint")((a=r.table.content)==null?void 0:a.type)==="table"?t=Q.lint.react({...r.table,content:{...r,table:r.table.content}},e,{...n,unwrapTitledTableContents:!0}):t=Q.lint.react(r.table,e,n);else{const i=c.defaultRules.table.react(r.table,e,n),o=p.jsx("caption",{className:"perseus-table-title",children:e(r.title,n)},"caption");t=j.cloneElement(i,null,[o,...i.props.children])}return n.unwrapTitledTableContents?t:p.jsx("div",{className:"perseus-titled-table",children:t},n.key)}},widget:{...O.widget,react:(r,e,n)=>p.jsx("em",{children:`[Widget: ${r.id}]`},n.key)},blockMath:{...O.blockMath,react:(r,e,n)=>{const{TeX:t}=Y();return p.jsx(t,{children:r.content},n.key)}},math:{...O.math,react:(r,e,n)=>{const{TeX:t}=Y();return p.jsx(t,{children:r.content},n.key)}},unescapedDollar:{...O.unescapedDollar,react:(r,e,n)=>"$"},link:{...O.link,react:function(r,e,n){const t=c.defaultRules.link.react(r,e,n),a=t.props.href;let i=null;(a?a.match(/https?:\/\/[^/]*khanacademy.org|^\//):!1)||(i="noopener noreferrer");const s={...t.props,target:"_blank",href:a,rel:i};return n.baseElements&&n.baseElements.Link?n.baseElements.Link(s):j.cloneElement(t,s)}},codeBlock:{...O.codeBlock,react:(r,e,n)=>r.lang==="alt"?p.jsx("div",{className:"perseus-markdown-alt perseus-sr-only",children:e(r.content,n)},n.key):c.defaultRules.codeBlock.react(r,e,n)},lint:{...O.lint,react:(r,e,n)=>p.jsx(kn,{message:r.message,ruleName:r.ruleName,inline:pt(r.content),blockHighlight:r.blockHighlight,insideTable:r.insideTable,severity:r.severity,children:e(r.content,n)})}};function pt(r){return!!(r&&r.type&&ht.hasOwnProperty(r.type))}const ht={text:!0,math:!0,unescapedDollar:!0,link:!0,img:!0,strong:!0,u:!0,em:!0,del:!0,code:!0},nn=c.parserFor(Q),rn=(r,e)=>{const n=r+`

`;return nn(n,{...e,inline:!1})},ct=(r,e)=>nn(r,{...e,inline:!0}),W=(r,e)=>{g.isArray(r)?g.each(r,n=>W(n,e)):g.isObject(r)&&(e(r),r.type==="table"?(W(r.header,e),W(r.cells,e)):r.type==="list"?W(r.items,e):r.type==="titledTable"?W(r.table,e):r.type==="columns"?(W(r.col1,e),W(r.col2,e)):g.isArray(r.content)&&W(r.content,e))},Re=r=>{if(g.isArray(r))return g.flatten(g.map(r,Re));if(r.content&&g.isString(r.content))return r.type.toLowerCase().indexOf("code")!==-1?["",r.content,""]:[r.content.replace(/\s+/g," ")];const e=g.chain(r).values().flatten().filter(t=>t!=null&&g.has(t,"type")).value();if(!e.length)return[];const n=Re(e);if(r.type==="paragraph"&&n.length){n[0]=n[0].replace(/^\s+/,"");const t=n.length-1;n[t]=n[t].replace(/\s+$/,"")}return n},wt=r=>{const e=rn(r);return Re(e).join("").length},D={characterCount:wt,traverseContent:W,parse:rn,parseInline:ct,reactFor:c.reactFor,ruleOutput:c.ruleOutput(Q,"react"),basicOutput:c.reactFor(c.ruleOutput(Q,"react")),sanitizeUrl:c.sanitizeUrl};class tn extends j.Component{render(){const e=this.props.className?"paragraph "+this.props.className:"paragraph";return p.jsx("div",{className:this.props.inline?this.props.className??void 0:e,"data-perseus-component-index":this.props.translationIndex,"data-perseus-paragraph-index":this.props.paragraphIndex,children:this.props.children})}}tn.__docgenInfo={description:"",methods:[],displayName:"QuestionParagraph",props:{className:{required:!1,tsType:{name:"union",raw:"string | null | undefined",elements:[{name:"string"},{name:"null"},{name:"undefined"}]},description:""},translationIndex:{required:!0,tsType:{name:"number"},description:""},paragraphIndex:{required:!1,tsType:{name:"number"},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},inline:{required:!1,tsType:{name:"boolean"},description:""}}};const bt={type:"points",earned:0,total:0,message:null};function ft(r){return r.type==="invalid"&&(!r.message||r.message.length===0)}function vt(r,e){let n;if(r.type==="points"&&e.type==="points")return r.message&&e.message&&r.message!==e.message?n=null:n=r.message||e.message,{type:"points",earned:r.earned+e.earned,total:r.total+e.total,message:n};if(r.type==="points"&&e.type==="invalid")return e;if(r.type==="invalid"&&e.type==="points")return r;if(r.type==="invalid"&&e.type==="invalid")return r.message&&e.message&&r.message!==e.message?n=null:n=r.message||e.message,{type:"invalid",message:n};throw new E("PerseusScore with unknown type encountered",R.InvalidInput,{metadata:{scoreA:JSON.stringify(r),scoreB:JSON.stringify(e)}})}function an(r){return Object.values(r).reduce(vt,bt)}function kt(r){return r.type==="points"&&r.earned>=r.total}function ca(r,e,n){if(r.type==="points")return{empty:!1,correct:kt(r),message:r.message,guess:e,state:n};if(r.type==="invalid")return{empty:!0,correct:!1,message:r.message,suppressAlmostThere:r.suppressAlmostThere,guess:e,state:n};throw new E("Invalid score type: "+r.type,R.InvalidInput,{metadata:{score:JSON.stringify(r),guess:JSON.stringify(e),state:JSON.stringify(n)}})}function qt(){return/\[\[☃ ([A-Za-z0-9- ]+)\]\]/g}function Tt(r){const e=[],n=qt();let t=n.exec(r);for(;t!==null;)e.push(t[1]),t=n.exec(r);return e}const De="block",At=["default"],Rt=!1,xt="",Ct=!1,k={},_={},sn=(r,e)=>{k[r]=e},wa=r=>{r.forEach(e=>{sn(e.name,e)}),jt()},G=(r,e)=>{const n=k[e];if(!n){const t=`Failed to replace ${r} with ${e}`;throw new E(t,R.Internal)}sn(r,n)},ba=()=>{G("transformer","deprecated-standin"),G("lights-puzzle","deprecated-standin"),G("reaction-diagram","deprecated-standin"),G("sequence","deprecated-standin"),G("simulator","deprecated-standin"),G("unit-input","deprecated-standin")},fa=r=>{r.forEach(e=>{if(!e.widgetName)throw new E(`Editor ${e.displayName} doesn't have a widgetName property`,R.Internal);_[e.widgetName]=e})},z=(r,e)=>{const n=_[e];if(!n&&K){const t=`Failed to replace editor ${r} with ${e}`;K.error(t,R.Internal);return}_[r]=n},va=()=>{z("transformer","deprecated-standin"),z("lights-puzzle","deprecated-standin"),z("reaction-diagram","deprecated-standin"),z("sequence","deprecated-standin"),z("simulator","deprecated-standin"),z("unit-input","deprecated-standin")},Pt=r=>{var e,n,t;return g.has(k,r)?(e=k[r])!=null&&e.getWidget?(t=(n=k[r]).getWidget)==null?void 0:t.call(n):k[r].widget:null},on=r=>{var e;return((e=k[r])==null?void 0:e.scorer)??null},ka=r=>g.has(_,r)?_[r]:null,It=r=>{if(k[r])return k[r].version||{major:0,minor:0}},qa=()=>{const r={};return g.each(g.keys(k),function(e){r[e]=It(e)}),r},Ta=()=>g.pick(k,g.reject(g.keys(k),function(r){return k[r].hidden})),Aa=()=>g.keys(k),Ot=r=>{const e=r.type;if(!g.isString(e))throw new E("widget type must be a string, but was: "+e,R.Internal);const n=k[e];if(n==null)return r;const t=r.version||{major:0,minor:0},a=n.version||{major:0,minor:0};if(t.major>a.major||t.major===a.major&&t.minor>a.minor)return r;let i=g.clone(r.options)||{};const o=n.propUpgrades||{};if(g.keys(i).length!==0)for(let m=t.major+1;m<=a.major;m++)o[String(m)]?i=o[String(m)](i):K.error("No upgrade found for widget. Cannot render.",R.Internal,{loggedMetadata:{type:e,fromMajorVersion:m-1,toMajorVersion:m}});i={...e in _?_[e].defaultProps:{},...i};let l=r.alignment;(l==null||l==="default")&&(l=Nt(e)[0]);let u=r.static;return u==null&&(u=Rt),g.extend({},r,{version:a,graded:r.graded!=null?r.graded:!0,alignment:l,static:u,options:i})},Et=(r,e,n)=>{const t=r.type,a=k[t];if(a==null)return r;let i;return r.static?i=Wt(t)||g.identity:i=a.transform||g.identity,i(r.options,e,n)},Nt=r=>{const e=k[r];return e&&e.supportedAlignments||At},St=r=>{const e=k[r];let n;return e?(e.getDefaultAlignment?n=e.getDefaultAlignment():n=e.defaultAlignment,n||De):De},Ge=["block","inline-block","inline","float-left","float-right","full-width"],jt=()=>{g.each(k,function(r){if(r.defaultAlignment&&!g.contains(Ge,r.defaultAlignment))throw new E("Widget '"+r.displayName+"' has an invalid defaultAlignment value: "+r.defaultAlignment,R.InvalidInput);if(r.supportedAlignments){const e=g.difference(r.supportedAlignments,Ge);if(e.length)throw new E("Widget '"+r.displayName+"' has an invalid value for supportedAlignments: "+e.join(" "),R.InvalidInput)}})},Ra=r=>{const e=k[r];return e&&e.staticTransform!=null},Wt=r=>{const e=k[r];return e&&e.staticTransform},Lt=r=>{const e=k[r];return e&&e.tracking||xt},Mt=r=>{const e=k[r];return e&&e.isLintable||Ct};function Ee(r){return ve(r,(e,n)=>{if(!e.type||!e.alignment){const t={};e.type||(t.type=n.split(" ")[0]),e.alignment||(t.alignment="default"),e={...e,...t}}return Ot(e)})}function Ft(r,e,n,t,a){const i=Ee(r);return e.filter(o=>{const s=i[o];if(!s||s.static)return!1;const l=on(s.type),u=l==null?void 0:l(n[o],s.options,t,a);if(u)return ft(u)})}function xa(r,e,n,t){const a=Tt(r.content),i=ln(r.widgets,a,e,n,t);return an(i)}function ln(r,e,n,t,a){const i=Ee(r),o=e.filter(l=>{const u=i[l],m=(u==null?void 0:u.graded)==null||u.graded,y=!!(u!=null&&u.static);return m&&!y}),s={};return o.forEach(l=>{const u=i[l];if(!u)return;const m=n[l],y=on(u.type),w=y==null?void 0:y(m,u.options,t,a);w!=null&&(s[l]=w)}),s}const _t=1e3;class Dt{constructor(){this.previousContent=null,this.runLinter=yn((e,n)=>{if(!(typeof KA>"u")&&e!==this.previousContent){if(this.previousContent=e,e===""){n([]);return}fetch("/api/internal/translations/lint_poentry?preview=1&lang=en",{headers:{"Content-Type":"application/json"},body:JSON.stringify({msgid:e,msgstr:e,format:"perseus_text",filename:""}),method:"POST"}).then(t=>t.status>=400?{status:"error",message:"Could not run i18n linter."}:t.json(),t=>({status:"error",message:"Could not run i18n linter."})).then(t=>{t.status==="error"?n(["Some part of this text makes it untranslatable. The specific message from the i18n linter was: "+t.message.replace(/\n/g," ")]):n([])})}},_t)}applyLintErrors(e,n){if(n.length){const t=n.join(`

`);e.unshift({content:{type:"text",content:""},insideTable:!1,message:t,ruleName:"legacy-error",severity:d.Severity.ERROR,type:"lint"})}}}const Gt=r=>r.replace(/\{align[*]?\}/g,"{aligned}").replace(/[\u00a0]/g," "),{interactiveSizes:ie}=Tn,zt=An,Ut=Rn,U={SMALL:"small",MEDIUM:"medium",LARGE:"large",XLARGE:"xlarge"},Vt=r=>r?r<=zt?U.SMALL:r<=Ut?U.MEDIUM:U.LARGE:U.MEDIUM,Ca=r=>r===U.SMALL?[ie.defaultBoxSizeSmall,ie.defaultBoxSizeSmall]:[ie.defaultBoxSize,ie.defaultBoxSize],Ne=class Ne extends j.Component{constructor(){super(...arguments),this.widgetRef=j.createRef(),this.state={sizeClass:U.MEDIUM,widgetProps:this.props.initialProps},this.getWidget=()=>this.widgetRef.current,this.replaceWidgetProps=e=>{this.setState({widgetProps:e})}}componentDidMount(){if(this.state.widgetProps.apiOptions.isMobile){const e=fe.findDOMNode(this).offsetWidth;this.setState({sizeClass:Vt(e)})}}UNSAFE_componentWillReceiveProps(e){if(this.props.type!==e.type)throw new Error("WidgetContainer can't change widget type; set a different key instead to recreate the container.")}shouldComponentUpdate(e,n){return this.props.shouldHighlight!==e.shouldHighlight||this.props.type!==e.type||this.state.widgetProps!==n.widgetProps||this.state.sizeClass!==n.sizeClass}render(){let e=be({"perseus-widget-container":!0,"widget-highlight":this.props.shouldHighlight,"widget-nohighlight":!this.props.shouldHighlight,"perseus-widget__definition":this.props.type==="definition"});const n=this.props.type,t=Pt(n);if(t==null)return console.warn(`Widget type '${n}' not found!`),p.jsx("div",{className:e});let a=this.state.widgetProps.alignment;a==="default"&&(a=St(n)),e+=" widget-"+a;const i=this.state.widgetProps.apiOptions,o=this.state.widgetProps.static||i.readOnly,s={position:"relative",overflow:"visible"},l={width:"100%",height:"100%",position:"absolute",top:0,left:0,zIndex:xn},u=Mt(n)?this.props.linterContext:{...this.props.linterContext,highlightLint:!1};return p.jsx("div",{className:e,style:o?s:{},children:p.jsx(fn.Consumer,{children:({analytics:m})=>p.jsxs(S,{metadata:{widget_type:n,widget_id:this.props.id},onError:()=>{m.onAnalyticsEvent({type:"perseus:widget-rendering-error",payload:{widgetType:n,widgetId:this.props.id}})},children:[p.jsx(t,{...this.state.widgetProps,linterContext:u,containerSizeClass:this.state.sizeClass,ref:this.widgetRef}),o&&p.jsx("div",{style:l})]})})})}};Ne.defaultProps={linterContext:He};let ue=Ne;ue.__docgenInfo={description:"",methods:[{name:"getWidget",docblock:null,modifiers:[],params:[],returns:null},{name:"replaceWidgetProps",docblock:null,modifiers:[],params:[{name:"newWidgetProps",optional:!1,type:null}],returns:null}],displayName:"WidgetContainer",props:{shouldHighlight:{required:!0,tsType:{name:"boolean"},description:""},type:{required:!0,tsType:{name:"string"},description:""},id:{required:!0,tsType:{name:"string"},description:""},initialProps:{required:!0,tsType:{name:"intersection",raw:`RenderProps & {
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{ha as D,_e as J,D as P,xe as R,c as S,ba as a,Ra as b,fa as c,va as d,ka as e,Ta as f,Nt as g,Aa as h,St as i,It as j,Gt as k,He as l,kt as m,Ca as n,U as o,Or as p,qa as q,wa as r,xa as s,ca as t,Ot as u,Pt as v,ln as w,an as x,O as y};
