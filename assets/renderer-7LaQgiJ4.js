...
{2,}(?! )(?!\\1`+le+` )\\n*|\\s*
*$)`),$r=/(?:^|\n)( *)$/,te=function(){var r=/^ *\| *| *\| *$/g,e=/ *$/,n=/^ *-+: *$/,t=/^ *:-+: *$/,a=/^ *:-+ *$/,i=function(m){return n.test(m)?"right":t.test(m)?"center":a.test(m)?"left":null},o=function(m,p,b,q){q&&(m=m.replace(r,""));var A=m.trim().split("|");return A.map(i)},s=function(m,p,b,q){var A=b.inTable;b.inTable=!0;var c=p(m.trim(),b);b.inTable=A;var w=[[]];return c.forEach(function(C,I){C.type==="tableSeparator"?(!q||I!==0&&I!==c.length-1)&&w.push([]):(C.type==="text"&&(c[I+1]==null||c[I+1].type==="tableSeparator")&&(C.content=C.content.replace(e,"")),w[w.length-1].push(C))}),w},l=function(m,p,b,q){var A=m.trim().split(`
...
`)!==-1,C=w||c&&s;s=C;var I=n.inline,M=n._list;n._list=!0;var P;C?(n.inline=!1,P=A.replace(We,`
...
`),_e={parseToArray:it,joinFromArray:st},ot="@khanacademy/pure-markdown",lt="__lib_version__";Pe(ot,lt);const ut=/^\[\[\u2603 (([a-z-]+) ([0-9]+))\]\]/,en=(r,e,n)=>{const t=r.length;let a=0;if(n){if(e.inline)return null;for(;a<t&&r[a]===" ";)a++}if(!(a<t&&r[a]==="$"))return null;a++;const i=a;let o=0;for(;a<t;){const s=r[a];if(s==="\\")a++;else if(o<=0&&s==="$"){let l=a+1;if(n){const u=/^(?: *\n){2,}/.exec(r.slice(l));l=u?l+u[0].length:null}return l?[r.substring(0,l),r.substring(i,a)]:null}else if(s==="{")o++;else if(s==="}")o--;else if(s===`
`&&r[a-1]===`
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{ca as D,_e as J,D as P,Ce as R,h as S,fa as a,Ra as b,wa as c,va as d,ka as e,Ta as f,Nt as g,Aa as h,St as i,It as j,Gt as k,He as l,kt as m,Pa as n,z as o,Or as p,qa as q,ba as r,Ca as s,ha as t,Ot as u,xt as v,ln as w,an as x,O as y};
