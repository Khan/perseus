import{T as d}from"./index-CieYLtDP.js";import{r as n}from"./index-C6mWTJJr.js";const f=o=>{const{value:i,onChange:u,...l}=o,[c,a]=n.useState(!1),[h,r]=n.useState(""),s=n.useRef(null);return n.useEffect(()=>{const e=s.current,t=m=>{m.stopPropagation()};return e==null||e.addEventListener("wheel",t),()=>{e==null||e.removeEventListener("wheel",t)}},[s]),n.createElement(d,{...l,type:"number",value:c?h:i,onChange:e=>{r(e),u(e)},onFocus:e=>{var t;r(i),a(!0),(t=o.onFocus)==null||t.call(o,e)},onBlur:e=>{var t;a(!1),(t=o.onBlur)==null||t.call(o,e)},ref:s})};f.__docgenInfo={description:`This is a custom text field of type="number" for use in Perseus Editors.
