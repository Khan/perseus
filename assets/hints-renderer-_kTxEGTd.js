...
Define the feature flag name in packages/perseus-core/src/feature-flags.ts`}]}}],raw:`Readonly<{
    ...
    paths: [],
    stack: [],
}`,computed:!1}},className:{required:!1,tsType:{name:"string"},description:""},hint:{required:!0,tsType:{name:"any"},description:""},lastHint:{required:!1,tsType:{name:"boolean"},description:""},lastRendered:{required:!1,tsType:{name:"boolean"},description:""},pos:{required:!0,tsType:{name:"number"},description:""},totalHints:{required:!1,tsType:{name:"number"},description:""},findExternalWidgets:{required:!1,tsType:{name:"any"},description:""}}};class P extends x.Component{constructor(){super(...arguments);a(this,"state",{isFinalHelpPage:!1});a(this,"_hintsVisible",()=>this.props.hintsVisible==null||this.props.hintsVisible===-1?this.props.hints.length:this.props.hintsVisible);a(this,"_cacheImagesInHint",e=>{w.each(e.images,(t,n)=>{const i=new Image;i.src=L.getRealImageUrl(n)})});a(this,"_cacheHintImages",()=>{this._hintsVisible()>0?w.each(this.props.hints,this._cacheImagesInHint):this.props.hints.length>0&&this._cacheImagesInHint(this.props.hints[0])});a(this,"getApiOptions",()=>({...W.defaults,...this.props.apiOptions,readOnly:!1}));a(this,"getSerializedState",()=>w.times(this._hintsVisible(),e=>this.refs["hintRenderer"+e].getSerializedState()));a(this,"restoreSerializedState",(e,t)=>{let n=1;const i=()=>{--n,t&&n===0&&t()};w.each(e,(s,g)=>{const y=this.refs["hintRenderer"+g];y&&(++n,y.restoreSerializedState(s,i))}),i()})}componentDidMount(){this._cacheHintImages()}UNSAFE_componentWillReceiveProps(e){e.hintsVisible-this.props.hintsVisible>1&&this.setState({isFinalHelpPage:!0})}componentDidUpdate(e,t){(!w.isEqual(e.hints,this.props.hints)||e.hintsVisible!==this.props.hintsVisible)&&this._cacheHintImages();const n=e.hintsVisible||0,i=this.props.hintsVisible||0;if(n<i&&i<=this.props.hints.length&&i>=0){const s=i-1;j.findDOMNode(this.refs["hintRenderer"+s]).focus()}}render(){const e=this.getApiOptions(),t=this._hintsVisible(),n=[],i=this.state.isFinalHelpPage;this.props.hints.slice(0,t).forEach((d,h)=>{const v=h===this.props.hints.length-1&&!/\*\*/.test(d.content),R=h===t-1,f=r.jsx(k,{lastHint:v,lastRendered:R,hint:d,pos:h,totalHints:this.props.hints.length,ref:"hintRenderer"+h,apiOptions:e,findExternalWidgets:this.props.findExternalWidgets,linterContext:H(this.props.linterContext,"hints["+h+"]")},"hintRenderer"+h);i?n.push(f):d.replace&&n.length>0?n[n.length-1]=f:n.push(f)});const{getAnotherHint:s}=e,g=s&&t>0&&t<this.props.hints.length,y=`(${t}/${this.props.hints.length})`,b=S(this.props.className,e.isMobile&&t>0&&l.css(c.mobileHintStylesHintsRenderer));return r.jsxs("div",{className:b,children:[e.isMobile&&t>0&&r.jsx("div",{className:l.css(c.mobileHintStylesHintTitle,V.responsiveLabel),children:this.context.strings.hints}),n,g&&r.jsxs("button",{rel:"button",className:l.css(c.linkButton,c.getAnotherHintButton,e.isMobile&&c.mobileHintStylesGetAnotherHintButton),onClick:d=>{d.preventDefault(),d.stopPropagation(),s&&s()},children:[r.jsx("span",{className:l.css(c.plusText,e.isMobile&&c.mobileHintStylesPlusText),children:"+"}),r.jsxs("span",{className:l.css(c.getAnotherHintText),children:[this.context.strings.getAnotherHint," ",y]})]})]})}}a(P,"contextType",I),a(P,"defaultProps",{linterContext:q});const T=p+N,c=l.StyleSheet.create({rendererMargins:{marginTop:p},linkButton:{cursor:"pointer",border:"none",backgroundColor:"transparent",fontSize:"100%",fontFamily:"inherit",fontWeight:"bold",color:F,padding:0,position:"relative"},plusText:{fontSize:20,position:"absolute",top:-3,left:0},getAnotherHintText:{marginLeft:16},mobileHintStylesHintsRenderer:{marginTop:4*p,border:`solid ${G}`,borderWidth:"1px 0 0 0",position:"relative",":before":{content:'""',display:"table",clear:"both"},":after":{content:'""',display:"table",clear:"both"}},mobileHintStylesHintTitle:{fontFamily:"inherit",fontStyle:"normal",fontWeight:"bold",color:_,paddingTop:p,paddingBottom:1.5*p,[u.lgOrSmaller]:{paddingLeft:0},[u.smOrSmaller]:{paddingLeft:T}},getAnotherHintButton:{marginTop:1.5*p},mobileHintStylesGetAnotherHintButton:{[u.lgOrSmaller]:{paddingLeft:0},[u.smOrSmaller]:{paddingLeft:T}},mobileHintStylesPlusText:{[u.lgOrSmaller]:{left:0},[u.smOrSmaller]:{left:T}}});P.__docgenInfo={description:"",methods:[{name:"_hintsVisible",docblock:null,modifiers:[],params:[],returns:null},{name:"_cacheImagesInHint",docblock:null,modifiers:[],params:[{name:"hint",optional:!1,type:null}],returns:null},{name:"_cacheHintImages",docblock:null,modifiers:[],params:[],returns:null},{name:"getApiOptions",docblock:null,modifiers:[],params:[],returns:null},{name:"getSerializedState",docblock:"@deprecated - do not use in new code.",modifiers:[],params:[],returns:null,description:null},{name:"restoreSerializedState",docblock:"@deprecated - do not use in new code.",modifiers:[],params:[{name:"state",optional:!1},{name:"callback",optional:!1}],returns:null,description:null}],displayName:"HintsRenderer",props:{className:{required:!1,tsType:{name:"string"},description:""},hints:{required:!0,tsType:{name:"ReadonlyArray",elements:[{name:"intersection",raw:`PerseusRenderer & {
    /**
