...
`,passageTitle:"",showLineNumbers:!0,static:!1},static:!1,type:"passage",version:{major:0,minor:0}},"passage-ref 1":{options:{passageNumber:1,referenceNumber:1,summaryText:""},type:"passage-ref",version:{major:0,minor:1}},"passage-ref 2":{options:{passageNumber:1,referenceNumber:2,summaryText:""},type:"passage-ref",version:{major:0,minor:1}},"passage-ref 3":{options:{passageNumber:1,referenceNumber:3,summaryText:""},type:"passage-ref",version:{major:0,minor:1}}}},b={title:"Widgets/Passage Ref",component:d,tags:["!dev"],parameters:{docs:{description:{component:"A widget that creates references to specific parts of a passage,                    allowing users to navigate to and highlight relevant sections of text."}}}},e={args:{item:h({question:u})}},a={args:{item:h({question:l})}};var s,t,n;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: question1
    })
  }
}`,...(n=(t=e.parameters)==null?void 0:t.docs)==null?void 0:n.source}}};var o,r,i;a.parameters={...a.parameters,docs:{...(o=a.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    item: generateTestPerseusItem({
      question: question2
    })
  }
}`,...(i=(r=a.parameters)==null?void 0:r.docs)==null?void 0:i.source}}};const v=["ShortPassage","LongPassage"];export{a as LongPassage,e as ShortPassage,v as __namedExportsOrder,b as default};
