...
`&&r[a-1]===`
`)return null;a++}return null},mt=(r,e)=>Ze(r,e,!1),gt=(r,e)=>Ze(r,e,!0),pt=new RegExp("^\\|\\| +(.*) +\\|\\| *\\n("+h.defaultRules.nptable.match.regex.source.substring(1)+")"),yt=h.blockRegex(/^(crwdns.*)\n\s*\n/),S={...h.defaultRules,columns:{order:-2,match:h.blockRegex(/^([\s\S]*\n\n)={5,}\n\n([\s\S]*)/),parse:(r,e,n)=>({col1:e(r[1],n),col2:e(r[2],n)})},crowdinId:{order:-1,match:(r,e,n)=>e.isJipt?yt(r,e,n):null,parse:(r,e,n)=>({id:r[1]})},titledTable:{order:h.defaultRules.nptable.order-.5,match:h.blockRegex(pt),parse:(r,e,n)=>{const t=h.parseInline(e,r[1],n),a=r.slice(2),i=h.defaultRules.nptable.parse(a,e,n);return{title:t,table:i}}},widget:{order:h.defaultRules.link.order-.75,match:h.inlineRegex(dt),parse:(r,e,n)=>({id:r[1],widgetType:r[2]})},blockMath:{order:h.defaultRules.codeBlock.order+.5,match:gt,parse:(r,e,n)=>({content:r[1]})},math:{order:h.defaultRules.link.order-.25,match:mt,parse:(r,e,n)=>({content:r[1]})},unescapedDollar:{order:h.defaultRules.link.order-.24,match:h.inlineRegex(/^(?!\\)\$/),parse:(r,e,n)=>({})},fence:{...h.defaultRules.fence,parse:(r,e,n)=>{const t=h.defaultRules.fence.parse(r,e,n);return t.lang==="alt"?{type:"codeBlock",lang:"alt",content:e(t.content+`

`,n)}:t}},blockQuote:{...h.defaultRules.blockQuote,match:h.blockRegex(/^ *>[^\n]+(\n( *>)?[^\n]+)*\n{2,}/)},lint:{order:1e3,match:r=>null,parse:(r,e,n)=>({})}};h.parserFor(S);const J={...S,columns:{...S.columns,react:(r,e,n)=>p.jsxs("div",{className:"perseus-two-columns",children:[p.jsx("div",{className:"perseus-column",children:p.jsx("div",{className:"perseus-column-content",children:e(r.col1,n)})}),p.jsx("div",{className:"perseus-column",children:p.jsx("div",{className:"perseus-column-content",children:e(r.col2,n)})})]},n.key)},crowdinId:{...S.crowdinId,react:(r,e,n)=>r.id},table:{...S.table,react:function(r,e,n){const t=h.defaultRules.table.react(r,e,n);return n.isMobile?O.cloneElement(t,{tabIndex:0}):t}},titledTable:{...S.titledTable,react:(r,e,n)=>{var a;let t;if(!r.table)t="//invalid table//";else if(r.table.type==="lint")((a=r.table.content)==null?void 0:a.type)==="table"?t=J.lint.react({...r.table,content:{...r,table:r.table.content}},e,{...n,unwrapTitledTableContents:!0}):t=J.lint.react(r.table,e,n);else{const i=h.defaultRules.table.react(r.table,e,n),o=p.jsx("caption",{className:"perseus-table-title",children:e(r.title,n)},"caption");t=O.cloneElement(i,null,[o,...i.props.children])}return n.unwrapTitledTableContents?t:p.jsx("div",{className:"perseus-titled-table",children:t},n.key)}},widget:{...S.widget,react:(r,e,n)=>p.jsx("em",{children:`[Widget: ${r.id}]`},n.key)},blockMath:{...S.blockMath,react:(r,e,n)=>{const{TeX:t}=B();return p.jsx(t,{children:r.content},n.key)}},math:{...S.math,react:(r,e,n)=>{const{TeX:t}=B();return p.jsx(t,{children:r.content},n.key)}},unescapedDollar:{...S.unescapedDollar,react:(r,e,n)=>"$"},link:{...S.link,react:function(r,e,n){const t=h.defaultRules.link.react(r,e,n),a=t.props.href;let i=null;(a?a.match(/https?:\/\/[^/]*khanacademy.org|^\//):!1)||(i="noopener noreferrer");const s={...t.props,target:"_blank",href:a,rel:i};return n.baseElements&&n.baseElements.Link?n.baseElements.Link(s):O.cloneElement(t,s)}},codeBlock:{...S.codeBlock,react:(r,e,n)=>r.lang==="alt"?p.jsx("div",{className:"perseus-markdown-alt perseus-sr-only",children:e(r.content,n)},n.key):h.defaultRules.codeBlock.react(r,e,n)},lint:{...S.lint,react:(r,e,n)=>p.jsx(vn,{message:r.message,ruleName:r.ruleName,inline:ct(r.content),blockHighlight:r.blockHighlight,insideTable:r.insideTable,severity:r.severity,children:e(r.content,n)})}};function ct(r){return!!(r&&r.type&&ht.hasOwnProperty(r.type))}const ht={text:!0,math:!0,unescapedDollar:!0,link:!0,img:!0,strong:!0,u:!0,em:!0,del:!0,code:!0},en=h.parserFor(J),nn=(r,e)=>{const n=r+`
...
`);e.unshift({content:{type:"text",content:""},insideTable:!1,message:t,ruleName:"legacy-error",severity:d.Severity.ERROR,type:"lint"})}}}const vt=r=>r.replace(/\{align[*]?\}/g,"{aligned}").replace(/[\u00a0]/g," "),{interactiveSizes:se}=qn,qt=Tn,Tt=xn,_={SMALL:"small",MEDIUM:"medium",LARGE:"large",XLARGE:"xlarge"},xt=r=>r?r<=qt?_.SMALL:r<=Tt?_.MEDIUM:_.LARGE:_.MEDIUM,ta=r=>r===_.SMALL?[se.defaultBoxSizeSmall,se.defaultBoxSizeSmall]:[se.defaultBoxSize,se.defaultBoxSize],At="",Pt=!1,x={},Z={},tn=(r,e)=>{x[r]=e},aa=r=>{r.forEach(e=>{tn(e.name,e)})},D=(r,e)=>{const n=x[e];if(!n){const t=`Failed to replace ${r} with ${e}`;throw new L(t,N.Internal)}tn(r,n)},ia=()=>{D("transformer","deprecated-standin"),D("lights-puzzle","deprecated-standin"),D("reaction-diagram","deprecated-standin"),D("sequence","deprecated-standin"),D("simulator","deprecated-standin"),D("unit-input","deprecated-standin")},sa=r=>{r.forEach(e=>{if(!e.widgetName)throw new L(`Editor ${e.displayName} doesn't have a widgetName property`,N.Internal);Z[e.widgetName]=e})},F=(r,e)=>{const n=Z[e];if(!n&&$){const t=`Failed to replace editor ${r} with ${e}`;$.error(t,N.Internal);return}Z[r]=n},oa=()=>{F("transformer","deprecated-standin"),F("lights-puzzle","deprecated-standin"),F("reaction-diagram","deprecated-standin"),F("sequence","deprecated-standin"),F("simulator","deprecated-standin"),F("unit-input","deprecated-standin")},Rt=r=>{var e,n,t;return g.has(x,r)?(e=x[r])!=null&&e.getWidget?(t=(n=x[r]).getWidget)==null?void 0:t.call(n):x[r].widget:null},ua=r=>g.has(Z,r)?Z[r]:null,Ct=r=>{if(x[r])return x[r].version||{major:0,minor:0}},la=()=>{const r={};return g.each(g.keys(x),function(e){r[e]=Ct(e)}),r},da=()=>g.pick(x,g.reject(g.keys(x),function(r){return x[r].hidden})),ma=()=>g.keys(x),St=(r,e,n)=>{const t=r.type,a=x[t];if(a==null)return r;let i;return r.static?i=It(t)||g.identity:i=a.transform||g.identity,i(r.options,e,n)},ga=r=>{const e=x[r];return e&&e.staticTransform!=null},It=r=>{const e=x[r];return e&&e.staticTransform},Nt=r=>{const e=x[r];return e&&e.tracking||At},Et=r=>{const e=x[r];return e&&e.isLintable||Pt},Ee=class Ee extends O.Component{constructor(){super(...arguments),this.widgetRef=O.createRef(),this.state={sizeClass:_.MEDIUM,widgetProps:this.props.initialProps},this.getWidget=()=>this.widgetRef.current,this.replaceWidgetProps=e=>{this.setState({widgetProps:e})}}componentDidMount(){if(this.state.widgetProps.apiOptions.isMobile){const e=ve.findDOMNode(this).offsetWidth;this.setState({sizeClass:xt(e)})}}UNSAFE_componentWillReceiveProps(e){if(this.props.type!==e.type)throw new Error("WidgetContainer can't change widget type; set a different key instead to recreate the container.")}shouldComponentUpdate(e,n){return this.props.shouldHighlight!==e.shouldHighlight||this.props.type!==e.type||this.state.widgetProps!==n.widgetProps||this.state.sizeClass!==n.sizeClass}render(){var b;let e=ke({"perseus-widget-container":!0,"widget-highlight":this.props.shouldHighlight,"widget-nohighlight":!this.props.shouldHighlight,"perseus-widget__definition":this.props.type==="definition"});const n=this.props.type,t=navigator.userAgent,a=Rt(n);if(a==null)return console.warn(`Widget type '${n}' not found!`),p.jsx("div",{className:e});let i="null";n==="interactive-graph"&&(i=((b=this.state.widgetProps.graph)==null?void 0:b.type)??"null");let o=this.state.widgetProps.alignment;o==="default"&&(o=sn(n)),e+=" widget-"+o;const s=this.state.widgetProps.apiOptions,u=this.state.widgetProps.static||s.readOnly,l={position:"relative",overflow:"visible"},m={width:"100%",height:"100%",position:"absolute",top:0,left:0,zIndex:3},y=Et(n)?this.props.linterContext:{...this.props.linterContext,highlightLint:!1};return p.jsx("div",{className:e,style:u?l:{},children:p.jsx(fn.Consumer,{children:({analytics:k})=>p.jsxs(E,{metadata:{widget_type:n,widget_id:this.props.id},onError:q=>{k.onAnalyticsEvent({type:"perseus:widget-rendering-error",payload:{widgetSubType:i,widgetType:n,widgetId:this.props.id,message:q.message,userAgent:t}}),k.onAnalyticsEvent({type:"perseus:widget-rendering-error:ti",payload:{widgetSubType:i,widgetType:n,widgetId:this.props.id,message:q.message,userAgent:t}})},children:[p.jsx(a,{...this.state.widgetProps,linterContext:y,containerSizeClass:this.state.sizeClass,ref:this.widgetRef}),u&&p.jsx("div",{style:m})]})})})}};Ee.defaultProps={linterContext:Ue};let de=Ee;de.__docgenInfo={description:"",methods:[{name:"getWidget",docblock:null,modifiers:[],params:[],returns:null},{name:"replaceWidgetProps",docblock:null,modifiers:[],params:[{name:"newWidgetProps",optional:!1,type:null}],returns:null}],displayName:"WidgetContainer",props:{shouldHighlight:{required:!0,tsType:{name:"boolean"},description:""},type:{required:!0,tsType:{name:"string"},description:""},id:{required:!0,tsType:{name:"string"},description:""},initialProps:{required:!0,tsType:{name:"intersection",raw:`RenderProps & {
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{ra as D,Ge as J,G as P,Re as R,h as S,ia as a,sa as b,oa as c,ua as d,da as e,ma as f,la as g,Ct as h,vt as i,ta as j,_ as k,Ue as l,S as m,Nr as p,aa as r,ga as s};
