var j=Object.defineProperty;var A=(l,o,e)=>o in l?j(l,o,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[o]=e;var t=(l,o,e)=>(A(l,typeof o!="symbol"?o+"":o,e),e);import{r as C,br as q,bs as w,_ as T,bt as L,bu as E,j as s,ah as h,V as v,H as x,n as m,bv as f,bw as K,bx as P,s as p,y as S,z as b,by as k,bz as N,bA as V,e as g}from"./iframe-B_16MRTp.js";import"./item-version-9W43G8cZ.js";import"./article-renderer-LUbgHaPn.js";import"./server-item-renderer-1LUmkp6m.js";import"./hints-renderer-B-q9yvuG.js";import{c as D}from"./components-CA-pBWcu.js";const{ButtonGroup:I,InfoTip:c}=D,F=["basic","trig","prealgebra","logarithms","scientific","basic relations","advanced relations"];class y extends C.Component{constructor(e){super(e);t(this,"getSaveWarnings",()=>{const e=[];return this.props.answerForms.length===0?e.push("No answers specified"):(this.props.answerForms.some(a=>a.considered==="correct")||e.push("No correct answer specified"),T(this.props.answerForms).each((a,r)=>{if(this.props.value==="")e.push(`Answer ${r+1} is empty`);else{const u=L(a.value,{functions:this.props.functions});u.parsed?a.simplify&&!u.expr.isSimplified()&&e.push(`${a.value} isn't simplified, but is required" +
