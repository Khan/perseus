var j=Object.defineProperty;var A=(l,o,e)=>o in l?j(l,o,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[o]=e;var t=(l,o,e)=>A(l,typeof o!="symbol"?o+"":o,e);import{r as C,al as q,am as w,_ as T,an as L,ao as E,j as s,ae as h,V as v,H as x,n as m,ap as f,aq as K,ar as P,s as p,k as S,as as b,at as k,au as I,av as N,l as g}from"./iframe-DPME5Wfc.js";import"./item-version-Re2Bf6tc.js";import"./article-renderer-CLC0QY8e.js";import"./server-item-renderer-DYWMp5OE.js";import"./hints-renderer-CVWgBD1c.js";import{c as V}from"./components-5GyRNmEy.js";const{ButtonGroup:D,InfoTip:c}=V,F=["basic","trig","prealgebra","logarithms","scientific","basic relations","advanced relations"];class y extends C.Component{constructor(e){super(e);t(this,"getSaveWarnings",()=>{const e=[];return this.props.answerForms.length===0?e.push("No answers specified"):(this.props.answerForms.some(a=>a.considered==="correct")||e.push("No correct answer specified"),T(this.props.answerForms).each((a,r)=>{if(this.props.value==="")e.push(`Answer ${r+1} is empty`);else{const u=L(a.value,{functions:this.props.functions});u.parsed?a.simplify&&!u.expr.isSimplified()&&e.push(`${a.value} isn't simplified, but is required" +
