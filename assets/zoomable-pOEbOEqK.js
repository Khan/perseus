import{j as b}from"./jsx-runtime-63Ea5SlK.js";import{r as y}from"./index-6oxdNXpR.js";import{F as C}from"./index-9gkyvru-.js";const u=class u extends y.Component{constructor(){super(...arguments),this.state={visible:!1,marginBottomPx:0,zoomed:!0},this.reset=()=>{this._isMounted&&this.state.visible&&(this._originalWidth=null,this.setState({visible:!1,compactHeight:null,expandedHeight:null,zoomed:!0},()=>{this.measureAndScaleChildToFit(!1)}))},this.stopPropagationIfZoomed=e=>{this.state.zoomed||e.stopPropagation()},this.handleClickIfZoomed=e=>{this.state.zoomed||(e.stopPropagation(),this.handleClick())},this.handleClick=()=>{this.setState({zoomed:!this.state.zoomed})}}componentDidMount(){this._isMounted=!0,this.maybeInitializeMeasuring()}componentDidUpdate(){this.maybeInitializeMeasuring()}componentWillUnmount(){window.removeEventListener("resize",this.reset),this._observer&&this._observer.disconnect(),this._isMounted=!1}maybeInitializeMeasuring(){const e=this.props.readyToMeasure&&!this._measuringInitialized;this._isMounted&&e&&(this._measuringInitialized=!0,this._node=C.findDOMNode(this),setTimeout(()=>this.measureAndScaleChildToFit(!1),0),window.MutationObserver&&(this._observer=new MutationObserver(t=>{if(this._isMounted){for(const i of t)if(i.target!==this._node){this.measureAndScaleChildToFit(this.state.zoomed);break}}}),this._observer.observe(this._node,{childList:!0,subtree:!0,attributes:!0})),window.addEventListener("resize",this.reset))}measureAndScaleChildToFit(e){var l;if(!this._isMounted)return;let t=this._node,i=t;for(;i&&i.offsetWidth===0;)i=((l=i.parentElement)==null?void 0:l.closest(".perseus-renderer"))??null;i&&(t=i);const n={width:t.offsetWidth,height:t.offsetHeight},s=this.props.computeChildBounds(this._node,n),o=s.width+1,a=s.height+1;if(o>n.width){const r=n.width/o;this.setState({scale:r,zoomed:e,compactHeight:Math.ceil(r*a),expandedHeight:a}),setTimeout(()=>{this._isMounted&&this.setState({visible:!0})})}else this.setState({visible:!0})}render(){const{visible:e,scale:t,compactHeight:i,expandedHeight:n,zoomed:s}=this.state,{animateHeight:o,disableEntranceAnimation:a}=this.props,r=e?{transitionProperty:o?"opacity transform height":"opacity transform",transitionDuration:"0.3s",transitionTimingFunction:"ease-out"}:{},h=!a&&!e,c=h?" translate(0, 8px)":"",p=h?0:1,m=(t??1).toString(),f=s?`scale(1, 1) ${c}`:`scale(${m}, ${m}) ${c}`,g={display:"block",width:"100%",height:s?n:i,transform:f,transformOrigin:"0 0",opacity:p,WebkitTapHighlightColor:"transparent",...r};return b.jsx("span",{onClick:this.handleClick,onClickCapture:this.handleClickIfZoomed,onTouchCancelCapture:this.stopPropagationIfZoomed,onTouchEndCapture:this.stopPropagationIfZoomed,onTouchStartCapture:this.stopPropagationIfZoomed,style:g,children:this.props.children})}};u.defaultProps={animateHeight:!1,readyToMeasure:!0,disableEntranceAnimation:!1,computeChildBounds:e=>{const t=e.firstElementChild;return{width:t.offsetWidth,height:t.offsetHeight}}};let d=u;d.__docgenInfo={description:"",methods:[{name:"reset",docblock:null,modifiers:[],params:[],returns:{type:{name:"void"}}},{name:"maybeInitializeMeasuring",docblock:`Calls measureAndScaleChildToFit and sets up a MutationObserver
...
or not.  Defaults to true for synchronous components like tables.`,defaultValue:{value:"true",computed:!1}}}};export{d as Z};
