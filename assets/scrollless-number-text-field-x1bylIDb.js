import{j as f}from"./jsx-runtime-FVsy8kgq.js";import{T as v}from"./index-QCAhLhLD.js";import{r as s}from"./index-TT1qJ6UJ.js";const l=o=>{const{value:i,onChange:u,...c}=o,[h,a]=s.useState(!1),[m,r]=s.useState(""),n=s.useRef(null);return s.useEffect(()=>{const e=n.current,t=d=>{d.stopPropagation()};return e==null||e.addEventListener("wheel",t),()=>{e==null||e.removeEventListener("wheel",t)}},[n]),f(v,{...c,type:"number",value:h?m:i,onChange:e=>{r(e),u(e)},onFocus:e=>{var t;r(i),a(!0),(t=o.onFocus)==null||t.call(o,e)},onBlur:e=>{var t;a(!1),(t=o.onBlur)==null||t.call(o,e)},ref:n})},g=l;l.__docgenInfo={description:`This is a custom text field of type="number" for use in Perseus Editors.
