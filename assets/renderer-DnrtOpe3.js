var nn=Object.defineProperty;var rn=(r,n,e)=>n in r?nn(r,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[n]=e;var l=(r,n,e)=>(rn(r,typeof n!="symbol"?n+"":n,e),e);import{j as c}from"./jsx-runtime-BT65X5dW.js";import{_ as p,u as tn}from"./underscore-U-AHniOr.js";import{x as Ae,A as an}from"./core-widget-registry-CDUNr9Qn.js";import{P as j,E}from"./perseus-error-CSETqePQ.js";import{g as sn,U as un,E as Ne,F as on,G as ln,H as dn}from"./util-Ds56MQN3.js";import{P as M}from"./index-CrGd2QqM.js";import{$ as mn}from"./jquery-CkHB0_Mt.js";import{e as gn}from"./index-BzwLglMS.js";import{c as we}from"./index-D7h-teXI.js";import{r as X}from"./index-C6mWTJJr.js";import{h as ve}from"./index-B1Gws05u.js";import{Z as pn,c as ce}from"./zoomable-tex-Dy-nElJT.js";import{a as cn}from"./i18n-context-3AkWzTTj.js";import{L as $,S as yn}from"./svg-image-x8RQbND1.js";import{T as Ee}from"./tex-BONImhZG.js";import{Z as hn}from"./zoomable-C_CCSKDG.js";import{g as B,D as bn}from"./dependencies-BsVPGK1s.js";import{A as wn,C as ye}from"./perseus-api-Ty_QvlNi.js";import{L as vn}from"./lint-D0FI20JF.js";import{c as kn,t as fn,u as qn}from"./constants-BIpV3g0K.js";class V{static parse(n){return new oe(n).parse()}match(n){throw new j("Selector subclasses must implement match()",E.NotAllowed)}toString(){return"Unknown selector class"}}const me=class me{constructor(n){l(this,"tokens");l(this,"tokenIndex");n=n.trim().replace(/\s+/g," "),this.tokens=n.match(me.TOKENS)||[],this.tokenIndex=0}nextToken(){return this.tokens[this.tokenIndex]||""}consume(){this.tokenIndex++}isIdentifier(){const n=this.tokens[this.tokenIndex][0];return n>="a"&&n<="z"||n>="A"&&n<="Z"}skipSpace(){for(;this.nextToken()===" ";)this.consume()}parse(){const n=this.parseTreeSelector();let e=this.nextToken();if(!e)return n;const t=[n];for(;e;){if(e===",")this.consume();else throw new he("Expected comma");t.push(this.parseTreeSelector()),e=this.nextToken()}return new xn(t)}parseTreeSelector(){this.skipSpace();let n=this.parseNodeSelector();for(;;){const e=this.nextToken();if(!e||e===",")break;if(e===" ")this.consume(),n=new An(n,this.parseNodeSelector());else if(e===">")this.consume(),n=new Rn(n,this.parseNodeSelector());else if(e==="+")this.consume(),n=new Sn(n,this.parseNodeSelector());else if(e==="~")this.consume(),n=new In(n,this.parseNodeSelector());else throw new he("Unexpected token: "+e)}return n}parseNodeSelector(){this.skipSpace();const n=this.nextToken();if(n==="*")return this.consume(),new Pn;if(this.isIdentifier())return this.consume(),new Tn(n);throw new he("Expected node type")}};l(me,"TOKENS");let oe=me;oe.TOKENS=/([a-zA-Z][\w-]*)|(\d+)|[^\s]|(\s(?=[a-zA-Z\*]))/g;class he extends Error{constructor(n){super(n)}}class xn extends V{constructor(e){super();l(this,"selectors");this.selectors=e}match(e){for(let t=0;t<this.selectors.length;t++){const i=this.selectors[t].match(e);if(i)return i}return null}toString(){let e="";for(let t=0;t<this.selectors.length;t++)e+=t>0?", ":"",e+=this.selectors[t].toString();return e}}class Pn extends V{match(n){return[n.currentNode()]}toString(){return"*"}}class Tn extends V{constructor(e){super();l(this,"type");this.type=e}match(e){const t=e.currentNode();return t.type===this.type?[t]:null}toString(){return this.type}}class ge extends V{constructor(e,t){super();l(this,"left");l(this,"right");this.left=e,this.right=t}}class An extends ge{constructor(n,e){super(n,e)}match(n){const e=this.right.match(n);if(e)for(n=n.clone();n.hasParent();){n.goToParent();const t=this.left.match(n);if(t)return t.concat(e)}return null}toString(){return this.left.toString()+" "+this.right.toString()}}class Rn extends ge{constructor(n,e){super(n,e)}match(n){const e=this.right.match(n);if(e&&n.hasParent()){n=n.clone(),n.goToParent();const t=this.left.match(n);if(t)return t.concat(e)}return null}toString(){return this.left.toString()+" > "+this.right.toString()}}class Sn extends ge{constructor(n,e){super(n,e)}match(n){const e=this.right.match(n);if(e&&n.hasPreviousSibling()){n=n.clone(),n.goToPreviousSibling();const t=this.left.match(n);if(t)return t.concat(e)}return null}toString(){return this.left.toString()+" + "+this.right.toString()}}class In extends ge{constructor(n,e){super(n,e)}match(n){const e=this.right.match(n);if(e)for(n=n.clone();n.hasPreviousSibling();){n.goToPreviousSibling();const t=this.left.match(n);if(t)return t.concat(e)}return null}toString(){return this.left.toString()+" ~ "+this.right.toString()}}const L=class L{constructor(n,e,t,a,i,u){l(this,"name");l(this,"severity");l(this,"selector");l(this,"pattern");l(this,"lint");l(this,"applies");l(this,"message");if(!t&&!a)throw new j("Lint rules must have a selector or pattern",E.InvalidInput,{metadata:{name:n}});this.name=n||"unnamed rule",this.severity=e||L.Severity.BULK_WARNING,this.selector=t||L.DEFAULT_SELECTOR,this.pattern=a||null,typeof i=="function"?(this.lint=i,this.message=null):(this.lint=(...s)=>this._defaultLintFunction(...s),this.message=i),this.applies=u||function(){return!0}}static makeRule(n){return new L(n.name,n.severity,n.selector?V.parse(n.selector):null,L.makePattern(n.pattern),n.lint||n.message,n.applies)}check(n,e,t,a){const i=this.selector.match(e);if(!i)return null;let u;if(this.pattern?u=t.match(this.pattern):u=L.FakePatternMatch(t,t,0),!u)return null;try{const s=this.lint(e,t,i,u,a);return s?typeof s=="string"?{rule:this.name,severity:this.severity,message:s,start:0,end:t.length}:{rule:this.name,severity:this.severity,message:s.message,start:s.start,end:s.end}:null}catch(s){return{rule:"lint-rule-failure",message:`Exception in rule ${this.name}: ${s.message}
Stack trace:
${s.stack}`,start:0,end:t.length}}}_defaultLintFunction(n,e,t,a,i){return{message:this.message||"",start:a.index,end:a.index+a[0].length}}static makePattern(n){if(!n)return null;if(n instanceof RegExp)return n;if(n[0]==="/"){const e=n.lastIndexOf("/"),t=n.substring(1,e),a=n.substring(e+1);return new RegExp(t,a)}return new RegExp(n)}static FakePatternMatch(n,e,t){const a=[e];return a.index=t,a.input=n,a}};l(L,"DEFAULT_SELECTOR"),l(L,"Severity",{ERROR:1,WARNING:2,GUIDELINE:3,BULK_WARNING:4});let m=L;m.DEFAULT_SELECTOR=V.parse("text");const Cn=/\/\/([^\/]+)/;function Nn(r){if(!r)return"";const n=r.match(Cn);return n?n[1]:""}const En=m.makeRule({name:"absolute-url",severity:m.Severity.GUIDELINE,selector:"link, image",lint:function(r,n,e,t){const a=e[0].target,i=Nn(a);if(i==="khanacademy.org"||i.endsWith(".khanacademy.org"))return`Don't use absolute URLs:
...
math should not be indented.`}),Xn=m.makeRule({name:"blockquoted-widget",severity:m.Severity.WARNING,selector:"blockQuote widget",message:`Blockquoted widget:
widgets should not be indented.`}),Yn=m.makeRule({name:"double-spacing-after-terminal",severity:m.Severity.BULK_WARNING,selector:"paragraph",pattern:/[.!\?] {2}/i,message:`Use a single space after a sentence-ending period, or
any other kind of terminal punctuation.`});function Ln(r,n){return`Answer requires a button not found in the button sets: ${r} (in ${n})`}const jn={"\\sqrt":"prealgebra","\\sin":"trig","\\cos":"trig","\\tan":"trig","\\log":"logarithms","\\ln":"logarithms"},Wn=m.makeRule({name:"expression-widget",severity:m.Severity.WARNING,selector:"widget",lint:function(r,n,e,t,a){var d;if(r.currentNode().widgetType!=="expression")return;const i=r.currentNode().id;if(!i)return;const u=(d=a==null?void 0:a.widgets)==null?void 0:d[i];if(!u)return;const s=u.options.answerForms,o=u.options.buttonSets;for(const g of s)for(const[y,w]of Object.entries(jn))if(g.value.includes(y)&&!o.includes(w))return Ln(y,w)}}),Mn=m.makeRule({name:"extra-content-spacing",selector:"paragraph",pattern:/\s+$/,applies:function(r){return(r==null?void 0:r.contentType)==="article"},message:"No extra whitespace at the end of content blocks."}),Fn=m.makeRule({name:"heading-level-1",severity:m.Severity.WARNING,selector:"heading",lint:function(r,n,e,t){if(e[0].level===1)return`Don't use level-1 headings:
Begin headings with two or more # characters.`}}),Dn=m.makeRule({name:"heading-level-skip",severity:m.Severity.WARNING,selector:"heading ~ heading",lint:function(r,n,e,t){const a=e[1],i=e[0];if(a.level>i.level+1)return`Skipped heading level:
this heading is level ${a.level} but
the previous heading was level ${i.level}`}}),Gn=m.makeRule({name:"heading-sentence-case",severity:m.Severity.GUIDELINE,selector:"heading",pattern:/^\W*[a-z]/,message:`First letter is lowercase:
the first letter of a heading should be capitalized.`}),_n={and:!0,nor:!0,but:!0,the:!0,for:!0};function Un(r){const n=r[0];return n===n.toUpperCase()}const zn=m.makeRule({name:"heading-title-case",severity:m.Severity.GUIDELINE,selector:"heading",pattern:/[^\s:]\s+[A-Z]+[a-z]/,locale:"en",lint:function(r,n,e,t){let i=n.trim().split(/\s+/);if(i.shift(),i=i.filter(u=>u.length>2&&!_n.hasOwnProperty(u)),i.length>=3&&i.every(u=>Un(u)))return`Title-case heading:
This heading appears to be in title-case, but should be sentence-case.
Only capitalize the first letter and proper nouns.`}}),Vn=m.makeRule({name:"image-alt-text",severity:m.Severity.WARNING,selector:"image",lint:function(r,n,e,t){const a=e[0];if(!a.alt||!a.alt.trim())return`Images should have alt text:
...
do not put images inside of tables.`}),Kn=m.makeRule({name:"image-spaces-around-urls",severity:m.Severity.ERROR,selector:"image",lint:function(r,n,e,t,a){const u=e[0].target;if(a&&a.content){const s=a.content.indexOf(u);if(s===-1)return;if(a.content[s-1]!=="("||a.content[s+u.length]!==")")return`Whitespace before or after image url:
For images, don't include any space or newlines after '(' or before ')'.
Whitespace in image URLs causes translation difficulties.`}}}),Bn=m.makeRule({name:"image-url-empty",severity:m.Severity.ERROR,selector:"image",lint:function(r,n,e){const a=e[0].target;if(!a||!a.trim())return"Images should have a URL"}}),Qn=m.makeRule({name:"image-widget",severity:m.Severity.WARNING,selector:"widget",lint:function(r,n,e,t,a){if(r.currentNode().widgetType!=="image")return;const i=r.currentNode().id;if(!i)return;const u=a&&a.widgets&&a.widgets[i];if(!u)return;const s=u.options.alt;if(!s)return`Images should have alt text:
...
LaTeX space commands like ~, \\;, \\quad, or \\phantom`}),sr=m.makeRule({name:"math-text-empty",severity:m.Severity.WARNING,selector:"math, blockMath",pattern:/\\text{\s*}/,message:"Empty \\text{} block in math expression"}),ur=m.makeRule({name:"math-without-dollars",severity:m.Severity.GUIDELINE,pattern:/\\\w+{[^}]*}|{|}/,message:`This looks like LaTeX:
did you mean to put it inside dollar signs?`}),or=m.makeRule({name:"nested-lists",severity:m.Severity.WARNING,selector:"list list",message:`Nested lists:
nested lists are hard to read on mobile devices;
do not use additional indentation.`}),lr=m.makeRule({name:"static-widget-in-question-stem",severity:m.Severity.WARNING,selector:"widget",lint:(r,n,e,t,a)=>{var s;if((a==null?void 0:a.contentType)!=="exercise"||a.stack.includes("hint"))return;const i=r.currentNode().id;if(!i)return;const u=(s=a==null?void 0:a.widgets)==null?void 0:s[i];if(u&&u.static)return"Widget in question stem is static (non-interactive)."}}),dr=m.makeRule({name:"table-missing-cells",severity:m.Severity.WARNING,selector:"table",lint:function(r,n,e,t){const a=e[0],i=a.header.length,u=a.cells.map(s=>s.length);for(let s=0;s<u.length;s++)if(u[s]!==i)return`Table rows don't match header:
The table header has ${i} cells, but
Row ${s+1} has ${u[s]} cells.`}}),mr=m.makeRule({name:"unbalanced-code-delimiters",severity:m.Severity.ERROR,pattern:/[`~]+/,message:`Unbalanced code delimiters:
...
do not put widgets inside of tables.`}),cr=[En,On,Xn,Yn,Bn,Wn,Mn,Fn,Dn,Gn,zn,Vn,Hn,$n,Jn,Zn,er,nr,rr,tr,ar,ir,sr,or,lr,dr,gr,pr,ur,mr,Kn,Qn];class U{constructor(n){l(this,"root");this.root=n}static isNode(n){return n&&typeof n=="object"&&typeof n.type=="string"}static isTextNode(n){return U.isNode(n)&&n.type==="text"&&typeof n.content=="string"}traverse(n){this._traverse(this.root,new Re(this.root),n)}_traverse(n,e,t){let a="";if(U.isNode(n)){const i=n;e._containers.push(i),e._ancestors.push(i),typeof i.content=="string"&&(a=i.content),Object.keys(i).forEach(s=>{if(s==="type")return;const o=i[s];o&&typeof o=="object"&&(e._indexes.push(s),a+=this._traverse(o,e,t),e._indexes.pop())}),e._currentNode=e._ancestors.pop(),e._containers.pop(),t(i,e,a)}else if(Array.isArray(n)){const i=n;e._containers.push(i);let u=0;for(;u<i.length;)e._indexes.push(u),a+=this._traverse(i[u],e,t),u=e._indexes.pop()+1;e._containers.pop()}return a}}class Re{constructor(n){l(this,"root");l(this,"_currentNode");l(this,"_containers");l(this,"_indexes");l(this,"_ancestors");this.root=n,this._currentNode=null,this._containers=new Q,this._indexes=new Q,this._ancestors=new Q}currentNode(){return this._currentNode||this.root}parent(){return this._ancestors.top()}ancestors(){return this._ancestors.values()}nextSibling(){const n=this._containers.top();if(!n||!Array.isArray(n))return null;const e=this._indexes.top();return n.length>e+1?n[e+1]:null}previousSibling(){const n=this._containers.top();if(!n||!Array.isArray(n))return null;const e=this._indexes.top();return e>0?n[e-1]:null}removeNextSibling(){const n=this._containers.top();if(n&&Array.isArray(n)){const e=this._indexes.top();if(n.length>e+1)return n.splice(e+1,1)[0]}return null}replace(...n){const e=this._containers.top();if(!e)throw new j("Can't replace the root of the tree",E.Internal);if(Array.isArray(e)){const t=this._indexes.top();e.splice(t,1,...n),this._indexes.pop(),this._indexes.push(t+n.length-1)}else{const t=this._indexes.top();n.length===0?delete e[t]:n.length===1?e[t]=n[0]:e[t]=n}}hasPreviousSibling(){return Array.isArray(this._containers.top())&&this._indexes.top()>0}goToPreviousSibling(){if(!this.hasPreviousSibling())throw new j("goToPreviousSibling(): node has no previous sibling",E.Internal);this._currentNode=this.previousSibling();const n=this._indexes.pop();this._indexes.push(n-1)}hasParent(){return this._ancestors.size()!==0}goToParent(){if(!this.hasParent())throw new j("goToParent(): node has no ancestor",E.NotAllowed);for(this._currentNode=this._ancestors.pop();this._containers.size()&&this._containers.top()[this._indexes.top()]!==this._currentNode;)this._containers.pop(),this._indexes.pop()}clone(){const n=new Re(this.root);return n._currentNode=this._currentNode,n._containers=this._containers.clone(),n._indexes=this._indexes.clone(),n._ancestors=this._ancestors.clone(),n}equals(n){return this.root===n.root&&this._currentNode===n._currentNode&&this._containers.equals(n._containers)&&this._indexes.equals(n._indexes)&&this._ancestors.equals(n._ancestors)}}class Q{constructor(n){l(this,"stack");this.stack=n?n.slice(0):[]}push(n){this.stack.push(n)}pop(){return this.stack.pop()}top(){return this.stack[this.stack.length-1]}values(){return this.stack.slice(0)}size(){return this.stack.length}toString(){return this.stack.toString()}clone(){return new Q(this.stack)}equals(n){if(!n||!n.stack||n.stack.length!==this.stack.length)return!1;for(let e=0;e<this.stack.length;e++)if(this.stack[e]!==n.stack[e])return!1;return!0}}const yr="@khanacademy/perseus-linter",hr="__lib_version__";Ae(yr,hr);M.shape({contentType:M.string,highlightLint:M.bool,paths:M.arrayOf(M.string),stack:M.arrayOf(M.string)});const De={contentType:"",highlightLint:!1,paths:[],stack:[]},br=cr.filter(r=>r.severity<m.Severity.BULK_WARNING);function wr(r,n,e,t=br){const a=[],i=new U(r);i.traverse((o,d,g)=>{if(U.isTextNode(o)){let y=d.nextSibling();for(;U.isTextNode(y);)o.content+=y.content,d.removeNextSibling(),y=d.nextSibling()}});let u=[],s=!1;return i.traverse((o,d,g)=>{const y=[],w=t.filter(h=>h.applies(n)),f=[...n.stack];f.push(o.type);const x={...n,stack:f.join(".")};if(w.forEach(h=>{const k=h.check(o,d,g,x);k&&((k.start||k.end)&&(k.target=g.substring(k.start,k.end)),a.push(k),y.push(k))}),o.type==="table"?(u.length&&y.push(...u),s=!1,u=[]):s||(s=d.ancestors().some(h=>h.type==="table")),s&&y.length&&u.push(...y),y.length)if(y.sort((h,k)=>h.severity-k.severity),o.type!=="text"||y.length>1)d.replace({type:"lint",content:o,message:y.map(h=>h.message).join(`

`),ruleName:y[0].rule,blockHighlight:x.blockHighlight,insideTable:s,severity:y[0].severity});else{const h=o.content,k=y[0],A=k.start||0,I=k.end||h.length,W=h.substring(0,A),R=h.substring(A,I),ne=h.substring(I),re=[];W&&re.push({type:"text",content:W}),re.push({type:"lint",content:{type:"text",content:R},message:k.message,ruleName:k.rule,insideTable:s,severity:k.severity}),ne&&re.push({type:"text",content:ne}),d.replace(...re)}}),a}function vr(r,n){const e=r.stack||[];return{...r,stack:e.concat(n)}}const kr={activeDefinitionId:null,setActiveDefinitionId:()=>{}},Ge=X.createContext(kr);class ke extends X.Component{constructor(){super(...arguments);l(this,"state",{activeDefinitionId:null});l(this,"setActiveDefinitionId",e=>{this.setState(t=>({activeDefinitionId:e}))})}render(){const{children:e}=this.props,{activeDefinitionId:t}=this.state,{setActiveDefinitionId:a}=this;return c.jsx(Ge.Provider,{value:{activeDefinitionId:t,setActiveDefinitionId:a},children:e})}}const zt=Ge.Consumer;ke.__docgenInfo={description:"",methods:[{name:"setActiveDefinitionId",docblock:null,modifiers:[],params:[{name:"activeDefinitionId",optional:!0,type:{name:"union",raw:"string | null",elements:[{name:"string"},{name:"null"}]}}],returns:{type:{name:"void"}}}],displayName:"DefinitionProvider",props:{children:{required:!0,tsType:{name:"any"},description:""}}};class O extends X.Component{constructor(n){super(n),this.state={error:""}}componentDidCatch(n,e){var t,a;this.setState({error:n.toString()}),(a=(t=this.props).onError)==null||a.call(t,n,e),$.error("Unhandled Perseus error: "+n.message,E.Internal,{cause:n,loggedMetadata:{componentStack:e&&"componentStack"in e?e.componentStack:"componentStack not provided",...this.props.metadata}})}render(){return this.state.error?c.jsxs("svg",{height:"16",width:"16",viewBox:"0 0 16 16",role:"img",children:[c.jsx("title",{children:"Rendering Error!"}),c.jsx("path",{d:"m8 16c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm0-3c0.55 0 1-0.45 1-1s-0.45-1-1-1-1 0.45-1 1 0.45 1 1 1zm0-9c-0.55 0-1 0.45-1 1v4c0 0.55.45 1 1 1s1-0.45 1-1v-4c0-0.55-0.45-1-1-1z",fill:"#d92916",fillRule:"evenodd"})]}):this.props.children}}O.__docgenInfo={description:"",methods:[],displayName:"ErrorBoundary",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},metadata:{required:!1,tsType:{name:"Record",elements:[{name:"string"},{name:"string"}],raw:"Record<string, string>"},description:""},onError:{required:!1,tsType:{name:"signature",type:"function",raw:"(error: Error, info: any) => void",signature:{arguments:[{type:{name:"Error"},name:"error"},{type:{name:"any"},name:"info"}],return:{name:"void"}}},description:""}}};function fr(){}class qr{constructor(n,e,t,a){l(this,"_tracked");l(this,"setting");l(this,"track");l(this,"trackApi");l(this,"widgetID");l(this,"widgetType");l(this,"_track",n=>{this._tracked&&!this.setting||(this._tracked=!0,this.trackApi({type:this.widgetType,id:this.widgetID,...n}))});n?(this._tracked=!1,this.trackApi=n,this.widgetType=e,this.widgetID=t,this.setting=a,this.track=this._track):this.track=fr}}const xr="@khanacademy/simple-markdown",Pr="__lib_version__";Ae(xr,Pr);var Tr=/\r\n?/g,Ar=/\t/g,Rr=/\f/g,_e=function(r){return r.replace(Tr,`
`).replace(Rr,"").replace(Ar,"    ")},Ue=function(r,n){var e=r||{};if(n!=null)for(var t in n)Object.prototype.hasOwnProperty.call(n,t)&&(e[t]=n[t]);return e},ze=function(r,n){var e=Object.keys(r).filter(function(u){var s=r[u];if(s==null||s.match==null)return!1;var o=s.order;return(typeof o!="number"||!isFinite(o))&&typeof console<"u"&&console.warn("simple-markdown: Invalid order for rule `"+u+"`: "+String(o)),!0});e.sort(function(u,s){var o=r[u],d=r[s],g=o.order,y=d.order;if(g!==y)return g-y;var w=o.quality?0:1,f=d.quality?0:1;return w!==f?w-f:u<s?-1:u>s?1:0});var t,a=function(u,s){var o=[];for(s=s||t,t=s;u;){var d=null,g=null,y=null,w=NaN,f=0,x=e[0],h=r[x];do{var k=h.order,A=s.prevCapture==null?"":s.prevCapture[0],I=h.match(u,s,A);if(I){var W=h.quality?h.quality(I,s,A):0;W<=w||(d=x,g=h,y=I,w=W)}f++,x=e[f],h=r[x]}while(h&&(!y||h.order===k&&h.quality));if(g==null||y==null)throw new Error("Could not find a matching rule for the below content. The rule with highest `order` should always match content provided to it. Check the definition of `match` for '"+e[e.length-1]+`'. It seems to not match the following source:
`+u);if(y.index)throw new Error("`match` must return a capture starting at index 0 (the current parse index). Did you forget a ^ at the start of the RegExp?");var R=g.parse(y,a,s);if(Array.isArray(R))Array.prototype.push.apply(o,R);else{if(R==null||typeof R!="object")throw new Error(`parse() function returned invalid parse result: '${R}'`);R.type==null&&(R.type=d),o.push(R)}s.prevCapture=y,u=u.substring(s.prevCapture[0].length)}return o},i=function(u,s){return t=Ue(s,n),!t.inline&&!t.disableAutoBlockNewlines&&(u=u+`

`),t.prevCapture=null,a(_e(u),t)};return i},S=function(r){var n=function(e,t,a){return t.inline?r.exec(e):null};return n.regex=r,n},N=function(r){var n=function(e,t){return t.inline?null:r.exec(e)};return n.regex=r,n},fe=function(r){var n=function(e,t){return r.exec(e)};return n.regex=r,n},Sr=typeof Symbol=="function"&&Symbol.for&&Symbol.for("react.element")||60103,q=function(r,n,e){var t={$$typeof:Sr,type:r,key:n??void 0,ref:null,props:e,_owner:null};return t},P=function(r,n,e,t){e=e||{},t=typeof t<"u"?t:!0;var a="";for(var i in e){var u=e[i];Object.prototype.hasOwnProperty.call(e,i)&&u&&(a+=" "+z(i)+'="'+z(u)+'"')}var s="<"+r+a+">";return t?s+n+"</"+r+">":s},Ir={},K=function(r){if(r==null)return null;try{var n=new URL(r,"https://localhost").protocol;if(n.indexOf("javascript:")===0||n.indexOf("vbscript:")===0||n.indexOf("data:")===0)return null}catch{return null}return r},Cr=/[<>&"']/g,Nr={"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;","'":"&#x27;","/":"&#x2F;","`":"&#96;"},z=function(r){return String(r).replace(Cr,function(n){return Nr[n]})},Er=/\\([^0-9A-Za-z\s])/g,qe=function(r){return r.replace(Er,"$1")},le=function(r,n,e){var t=e.inline||!1;e.inline=!0;var a=r(n,e);return e.inline=t,a},Or=function(r,n,e){var t=e.inline||!1;e.inline=!1;var a=r(n+`

`,e);return e.inline=t,a},te=function(r,n,e){return{content:le(n,r[1],e)}},be=function(){return{}},de="(?:[*+-]|\\d+\\.)",Ve="( *)("+de+") +",Oe=new RegExp("^"+Ve),Xr=new RegExp(Ve+"[^\\n]*(?:\\n(?!\\1"+de+` )[^\\n]*)*(
|$)`,"gm"),He=/\n{2,}$/,Yr=/^ (?= *`)|(` *) $/g,Lr=He,Xe=/ *\n+$/,jr=new RegExp("^( *)("+de+`) [\\s\\S]+?(?:
{2,}(?! )(?!\\1`+de+` )\\n*|\\s*
*$)`),Wr=/(?:^|\n)( *)$/,ae=function(){var r=/^ *\| *| *\| *$/g,n=/ *$/,e=/^ *-+: *$/,t=/^ *:-+: *$/,a=/^ *:-+ *$/,i=function(g){return e.test(g)?"right":t.test(g)?"center":a.test(g)?"left":null},u=function(g,y,w,f){f&&(g=g.replace(r,""));var x=g.trim().split("|");return x.map(i)},s=function(g,y,w,f){var x=w.inTable;w.inTable=!0;var h=y(g.trim(),w);w.inTable=x;var k=[[]];return h.forEach(function(A,I){A.type==="tableSeparator"?(!f||I!==0&&I!==h.length-1)&&k.push([]):(A.type==="text"&&(h[I+1]==null||h[I+1].type==="tableSeparator")&&(A.content=A.content.replace(n,"")),k[k.length-1].push(A))}),k},o=function(g,y,w,f){var x=g.trim().split(`
`);return x.map(function(h){return s(h,y,w,f)})},d=function(g){return function(y,w,f){f.inline=!0;var x=s(y[1],w,f,g),h=u(y[2],w,f,g),k=o(y[3],w,f,g);return f.inline=!1,{type:"table",header:x,align:h,cells:k}}};return{parseTable:d(!0),parseNpTable:d(!1),TABLE_REGEX:/^ *(\|.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/,NPTABLE_REGEX:/^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/}}(),ie="(?:\\[[^\\]]*\\]|[^\\[\\]]|\\](?=[^\\[]*\\]))*",Ye=`\\s*<?((?:\\([^)]*\\)|[^\\s\\\\]|\\\\.)*?)>?(?:\\s+['"]([\\s\\S]*?)['"])?\\s*`,Mr=/mailto:/i,Le=function(r,n,e){var t=(r[2]||r[1]).replace(/\s+/g," ").toLowerCase();if(n._defs&&n._defs[t]){var a=n._defs[t];e.target=a.target,e.title=a.title}return n._refs=n._refs||{},n._refs[t]=n._refs[t]||[],n._refs[t].push(e),e},v=0,ee={Array:{react:function(r,n,e){for(var t=e.key,a=[],i=0,u=0;i<r.length;i++,u++){e.key=""+i;var s=r[i];if(s.type==="text")for(s={type:"text",content:s.content};i+1<r.length&&r[i+1].type==="text";i++)s.content+=r[i+1].content;a.push(n(s,e))}return e.key=t,a},html:function(r,n,e){for(var t="",a=0;a<r.length;a++){var i=r[a];if(i.type==="text")for(i={type:"text",content:i.content};a+1<r.length&&r[a+1].type==="text";a++)i.content+=r[a+1].content;t+=n(i,e)}return t}},heading:{order:v++,match:N(/^ *(#{1,6})([^\n]+?)#* *(?:\n *)+\n/),parse:function(r,n,e){return{level:r[1].length,content:le(n,r[2].trim(),e)}},react:function(r,n,e){return q("h"+r.level,e.key,{children:n(r.content,e)})},html:function(r,n,e){return P("h"+r.level,n(r.content,e))}},nptable:{order:v++,match:N(ae.NPTABLE_REGEX),parse:ae.parseNpTable,react:null,html:null},lheading:{order:v++,match:N(/^([^\n]+)\n *(=|-){3,} *(?:\n *)+\n/),parse:function(r,n,e){return{type:"heading",level:r[2]==="="?1:2,content:le(n,r[1],e)}},react:null,html:null},hr:{order:v++,match:N(/^( *[-*_]){3,} *(?:\n *)+\n/),parse:be,react:function(r,n,e){return q("hr",e.key,{"aria-hidden":!0})},html:function(r,n,e){return'<hr aria-hidden="true">'}},codeBlock:{order:v++,match:N(/^(?:    [^\n]+\n*)+(?:\n *)+\n/),parse:function(r,n,e){var t=r[0].replace(/^    /gm,"").replace(/\n+$/,"");return{lang:void 0,content:t}},react:function(r,n,e){var t=r.lang?"markdown-code-"+r.lang:void 0;return q("pre",e.key,{children:q("code",null,{className:t,children:r.content})})},html:function(r,n,e){var t=r.lang?"markdown-code-"+r.lang:void 0,a=P("code",z(r.content),{class:t});return P("pre",a)}},fence:{order:v++,match:N(/^ *(`{3,}|~{3,}) *(?:(\S+) *)?\n([\s\S]+?)\n?\1 *(?:\n *)+\n/),parse:function(r,n,e){return{type:"codeBlock",lang:r[2]||void 0,content:r[3]}},react:null,html:null},blockQuote:{order:v++,match:N(/^( *>[^\n]+(\n[^\n]+)*\n*)+\n{2,}/),parse:function(r,n,e){var t=r[0].replace(/^ *> ?/gm,"");return{content:n(t,e)}},react:function(r,n,e){return q("blockquote",e.key,{children:n(r.content,e)})},html:function(r,n,e){return P("blockquote",n(r.content,e))}},list:{order:v++,match:function(r,n){var e=n.prevCapture==null?"":n.prevCapture[0],t=Wr.exec(e),a=n._list||!n.inline;return t&&a?(r=t[1]+r,jr.exec(r)):null},parse:function(r,n,e){var t=r[2],a=t.length>1,i=a?+t:void 0,u=r[0].replace(Lr,`
`).match(Xr),s=!1,o=u.map(function(d,g){var y=Oe.exec(d),w=y?y[0].length:0,f=new RegExp("^ {1,"+w+"}","gm"),x=d.replace(f,"").replace(Oe,""),h=g===u.length-1,k=x.indexOf(`

`)!==-1,A=k||h&&s;s=A;var I=e.inline,W=e._list;e._list=!0;var R;A?(e.inline=!1,R=x.replace(Xe,`

`)):(e.inline=!0,R=x.replace(Xe,""));var ne=n(R,e);return e.inline=I,e._list=W,ne});return{ordered:a,start:i,items:o}},react:function(r,n,e){var t=r.ordered?"ol":"ul";return q(t,e.key,{start:r.start,children:r.items.map(function(a,i){return q("li",""+i,{children:n(a,e)})})})},html:function(r,n,e){var t=r.items.map(function(u){return P("li",n(u,e))}).join(""),a=r.ordered?"ol":"ul",i={start:r.start};return P(a,t,i)}},def:{order:v++,match:N(/^ *\[([^\]]+)\]: *<?([^\s>]*)>?(?: +["(]([^\n]+)[")])? *\n(?: *\n)*/),parse:function(r,n,e){var t=r[1].replace(/\s+/g," ").toLowerCase(),a=r[2],i=r[3];return e._refs&&e._refs[t]&&e._refs[t].forEach(function(u){u.target=a,u.title=i}),e._defs=e._defs||{},e._defs[t]={target:a,title:i},{def:t,target:a,title:i}},react:function(){return null},html:function(){return""}},table:{order:v++,match:N(ae.TABLE_REGEX),parse:ae.parseTable,react:function(r,n,e){var t=function(u){return r.align[u]==null?{}:{textAlign:r.align[u]}},a=r.header.map(function(u,s){return q("th",""+s,{style:t(s),scope:"col",children:n(u,e)})}),i=r.cells.map(function(u,s){return q("tr",""+s,{children:u.map(function(o,d){return q("td",""+d,{style:t(d),children:n(o,e)})})})});return q("table",e.key,{children:[q("thead","thead",{children:q("tr",null,{children:a})}),q("tbody","tbody",{children:i})]})},html:function(r,n,e){var t=function(o){return r.align[o]==null?"":"text-align:"+r.align[o]+";"},a=r.header.map(function(o,d){return P("th",n(o,e),{style:t(d),scope:"col"})}).join(""),i=r.cells.map(function(o){var d=o.map(function(g,y){return P("td",n(g,e),{style:t(y)})}).join("");return P("tr",d)}).join(""),u=P("thead",P("tr",a)),s=P("tbody",i);return P("table",u+s)}},newline:{order:v++,match:N(/^(?:\n *)*\n/),parse:be,react:function(r,n,e){return`
`},html:function(r,n,e){return`
`}},paragraph:{order:v++,match:N(/^((?:[^\n]|\n(?! *\n))+)(?:\n *)+\n/),parse:te,react:function(r,n,e){return q("div",e.key,{className:"paragraph",children:n(r.content,e)})},html:function(r,n,e){var t={class:"paragraph"};return P("div",n(r.content,e),t)}},escape:{order:v++,match:S(/^\\([^0-9A-Za-z\s])/),parse:function(r,n,e){return{type:"text",content:r[1]}},react:null,html:null},tableSeparator:{order:v++,match:function(r,n){return n.inTable?/^ *\| */.exec(r):null},parse:function(){return{type:"tableSeparator"}},react:function(){return" | "},html:function(){return" &vert; "}},autolink:{order:v++,match:S(/^<([^: >]+:\/[^ >]+)>/),parse:function(r,n,e){return{type:"link",content:[{type:"text",content:r[1]}],target:r[1]}},react:null,html:null},mailto:{order:v++,match:S(/^<([^ >]+@[^ >]+)>/),parse:function(r,n,e){var t=r[1],a=r[1];return Mr.test(a)||(a="mailto:"+a),{type:"link",content:[{type:"text",content:t}],target:a}},react:null,html:null},url:{order:v++,match:S(/^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/),parse:function(r,n,e){return{type:"link",content:[{type:"text",content:r[1]}],target:r[1],title:void 0}},react:null,html:null},link:{order:v++,match:S(new RegExp("^\\[("+ie+")\\]\\("+Ye+"\\)")),parse:function(r,n,e){var t={content:n(r[1],e),target:qe(r[2]),title:r[3]};return t},react:function(r,n,e){return q("a",e.key,{href:K(r.target),title:r.title,children:n(r.content,e)})},html:function(r,n,e){var t={href:K(r.target),title:r.title};return P("a",n(r.content,e),t)}},image:{order:v++,match:S(new RegExp("^!\\[("+ie+")\\]\\("+Ye+"\\)")),parse:function(r,n,e){var t={alt:r[1],target:qe(r[2]),title:r[3]};return t},react:function(r,n,e){return q("img",e.key,{src:K(r.target),alt:r.alt,title:r.title})},html:function(r,n,e){var t={src:K(r.target),alt:r.alt,title:r.title};return P("img","",t,!1)}},reflink:{order:v++,match:S(new RegExp("^\\[("+ie+")\\]\\s*\\[([^\\]]*)\\]")),parse:function(r,n,e){return Le(r,e,{type:"link",content:n(r[1],e)})},react:null,html:null},refimage:{order:v++,match:S(new RegExp("^!\\[("+ie+")\\]\\s*\\[([^\\]]*)\\]")),parse:function(r,n,e){return Le(r,e,{type:"image",alt:r[1]})},react:null,html:null},em:{order:v,match:S(new RegExp("^\\b_((?:__|\\\\[\\s\\S]|[^\\\\_])+?)_\\b|^\\*(?=\\S)((?:\\*\\*|\\\\[\\s\\S]|\\s+(?:\\\\[\\s\\S]|[^\\s\\*\\\\]|\\*\\*)|[^\\s\\*\\\\])+?)\\*(?!\\*)")),quality:function(r){return r[0].length+.2},parse:function(r,n,e){return{content:n(r[2]||r[1],e)}},react:function(r,n,e){return q("em",e.key,{children:n(r.content,e)})},html:function(r,n,e){return P("em",n(r.content,e))}},strong:{order:v,match:S(/^\*\*((?:\\[\s\S]|[^\\])+?)\*\*(?!\*)/),quality:function(r){return r[0].length+.1},parse:te,react:function(r,n,e){return q("strong",e.key,{children:n(r.content,e)})},html:function(r,n,e){return P("strong",n(r.content,e))}},u:{order:v++,match:S(/^__((?:\\[\s\S]|[^\\])+?)__(?!_)/),quality:function(r){return r[0].length},parse:te,react:function(r,n,e){return q("u",e.key,{children:n(r.content,e)})},html:function(r,n,e){return P("u",n(r.content,e))}},del:{order:v++,match:S(/^~~(?=\S)((?:\\[\s\S]|~(?!~)|[^\s~\\]|\s(?!~~))+?)~~/),parse:te,react:function(r,n,e){return q("del",e.key,{children:n(r.content,e)})},html:function(r,n,e){return P("del",n(r.content,e))}},inlineCode:{order:v++,match:S(/^(`+)([\s\S]*?[^`])\1(?!`)/),parse:function(r,n,e){return{content:r[2].replace(Yr,"$1")}},react:function(r,n,e){return q("code",e.key,{children:r.content})},html:function(r,n,e){return P("code",z(r.content))}},br:{order:v++,match:fe(/^ {2,}\n/),parse:be,react:function(r,n,e){return q("br",e.key,Ir)},html:function(r,n,e){return"<br>"}},text:{order:v++,match:fe(/^[\s\S]+?(?=[^0-9A-Za-z\s\u00c0-\uffff]|\n\n| {2,}\n|\w+:\S|$)/),parse:function(r,n,e){return{content:r[0]}},react:function(r,n,e){return r.content},html:function(r,n,e){return z(r.content)}}},Fr=function(r,n){!n&&typeof console<"u"&&console.warn("simple-markdown ruleOutput should take 'react' or 'html' as the second argument.");var e=function(t,a,i){return r[t.type][n](t,a,i)};return e},Dr=function(r){var n=function(e,t){if(t=t||{},Array.isArray(e)){for(var a=t.key,i=[],u=null,s=0;s<e.length;s++){t.key=""+s;var o=n(e[s],t);typeof o=="string"&&typeof u=="string"?(u=u+o,i[i.length-1]=u):(i.push(o),u=o)}return t.key=a,i}else return r(e,n,t)};return n},Gr=function(r){var n=function(e,t){return t=t||{},Array.isArray(e)?e.map(function(a){return n(a,t)}).join(""):r(e,n,t)};return n},Se=function(r,n,e={}){if(!n)throw new Error("simple-markdown: outputFor: `property` must be defined. if you just upgraded, you probably need to replace `outputFor` with `reactFor`");var t,a=r.Array||ee.Array,i=a[n];if(!i)throw new Error("simple-markdown: outputFor: to join nodes of type `"+n+"` you must provide an `Array:` joiner rule with that type, Please see the docs for details on specifying an Array rule.");var u=i,s=function(d,g){return g=g||t,t=g,Array.isArray(d)?u(d,s,g):r[d.type][n](d,s,g)},o=function(d,g){return t=Ue(g,e),s(d,t)};return o},pe=ze(ee),Ie=function(r,n){return n=n||{},n.inline=!1,pe(r,n)},_r=function(r,n){return n=n||{},n.inline=!0,pe(r,n)},je=function(r,n){var e=He.test(r);return n=n||{},n.inline=!e,pe(r,n)},xe=Se(ee,"react"),Ke=Se(ee,"html"),Be=function(r,n){return xe(Ie(r,n),n)},Ur=function(r,n){return Ke(Ie(r,n),n)},zr=function(r){var n={};for(var e in r)e!=="source"&&Object.prototype.hasOwnProperty.call(r,e)&&(n[e]=r[e]);return n.children=Be(r.source),q("div",null,n)},b={defaultRules:ee,parserFor:ze,outputFor:Se,inlineRegex:S,blockRegex:N,anyScopeRegex:fe,parseInline:le,parseBlock:Or,markdownToReact:Be,markdownToHtml:Ur,ReactMarkdown:zr,defaultBlockParse:Ie,defaultInlineParse:_r,defaultImplicitParse:je,defaultReactOutput:xe,defaultHtmlOutput:Ke,preprocess:_e,sanitizeText:z,sanitizeUrl:K,unescapeUrl:qe,htmlTag:P,reactElement:q,defaultRawParse:pe,ruleOutput:Fr,reactFor:Dr,htmlFor:Gr,defaultParse:function(...r){return typeof console<"u"&&console.warn("defaultParse is deprecated, please use `defaultImplicitParse`"),je.apply(null,r)},defaultOutput:function(...r){return typeof console<"u"&&console.warn("defaultOutput is deprecated, please use `defaultReactOutput`"),xe.apply(null,r)}};const Vr={fence:{match:b.defaultRules.fence.match,order:1,parse:(r,n,e)=>({type:"codeBlock",lang:r[2]||void 0,content:r[3]})},paragraph:{match:b.defaultRules.paragraph.match,order:2,parse:(r,n,e)=>({content:r[1]})}},Hr=b.parserFor(Vr),Kr=r=>{const n=r.replace(/^\n\s*\n/,"")+`

`;return Hr(n,{inline:!1}).map(e=>e.content)},Br=r=>r.join(`

`),We={parseToArray:Kr,joinFromArray:Br},Qr="@khanacademy/pure-markdown",$r="__lib_version__";Ae(Qr,$r);const Jr=/^\[\[\u2603 (([a-z-]+) ([0-9]+))\]\]/,Qe=(r,n,e)=>{const t=r.length;let a=0;if(e){if(n.inline)return null;for(;a<t&&r[a]===" ";)a++}if(!(a<t&&r[a]==="$"))return null;a++;const i=a;let u=0;for(;a<t;){const s=r[a];if(s==="\\")a++;else if(u<=0&&s==="$"){let o=a+1;if(e){const d=/^(?: *\n){2,}/.exec(r.slice(o));o=d?o+d[0].length:null}return o?[r.substring(0,o),r.substring(i,a)]:null}else if(s==="{")u++;else if(s==="}")u--;else if(s===`
`&&r[a-1]===`
`)return null;a++}return null},Zr=(r,n)=>Qe(r,n,!1),et=(r,n)=>Qe(r,n,!0),nt=new RegExp("^\\|\\| +(.*) +\\|\\| *\\n("+b.defaultRules.nptable.match.regex.source.substring(1)+")"),rt=b.blockRegex(/^(crwdns.*)\n\s*\n/),C={...b.defaultRules,columns:{order:-2,match:b.blockRegex(/^([\s\S]*\n\n)={5,}\n\n([\s\S]*)/),parse:(r,n,e)=>({col1:n(r[1],e),col2:n(r[2],e)})},crowdinId:{order:-1,match:(r,n,e)=>n.isJipt?rt(r,n,e):null,parse:(r,n,e)=>({id:r[1]})},titledTable:{order:b.defaultRules.nptable.order-.5,match:b.blockRegex(nt),parse:(r,n,e)=>{const t=b.parseInline(n,r[1],e),a=r.slice(2),i=b.defaultRules.nptable.parse(a,n,e);return{title:t,table:i}}},widget:{order:b.defaultRules.link.order-.75,match:b.inlineRegex(Jr),parse:(r,n,e)=>({id:r[1],widgetType:r[2]})},blockMath:{order:b.defaultRules.codeBlock.order+.5,match:et,parse:(r,n,e)=>({content:r[1]})},math:{order:b.defaultRules.link.order-.25,match:Zr,parse:(r,n,e)=>({content:r[1]})},unescapedDollar:{order:b.defaultRules.link.order-.24,match:b.inlineRegex(/^(?!\\)\$/),parse:(r,n,e)=>({})},fence:{...b.defaultRules.fence,parse:(r,n,e)=>{const t=b.defaultRules.fence.parse(r,n,e);return t.lang==="alt"?{type:"codeBlock",lang:"alt",content:n(t.content+`

`,e)}:t}},blockQuote:{...b.defaultRules.blockQuote,match:b.blockRegex(/^ *>[^\n]+(\n( *>)?[^\n]+)*\n{2,}/)},lint:{order:1e3,match:r=>null,parse:(r,n,e)=>({})}};b.parserFor(C);const J={...C,columns:{...C.columns,react:(r,n,e)=>c.jsxs("div",{className:"perseus-two-columns",children:[c.jsx("div",{className:"perseus-column",children:c.jsx("div",{className:"perseus-column-content",children:n(r.col1,e)})}),c.jsx("div",{className:"perseus-column",children:c.jsx("div",{className:"perseus-column-content",children:n(r.col2,e)})})]},e.key)},crowdinId:{...C.crowdinId,react:(r,n,e)=>r.id},table:{...C.table,react:function(r,n,e){const t=b.defaultRules.table.react(r,n,e);return e.isMobile?X.cloneElement(t,{tabIndex:0}):t}},titledTable:{...C.titledTable,react:(r,n,e)=>{var a;let t;if(!r.table)t="//invalid table//";else if(r.table.type==="lint")((a=r.table.content)==null?void 0:a.type)==="table"?t=J.lint.react({...r.table,content:{...r,table:r.table.content}},n,{...e,unwrapTitledTableContents:!0}):t=J.lint.react(r.table,n,e);else{const i=b.defaultRules.table.react(r.table,n,e),u=c.jsx("caption",{className:"perseus-table-title",children:n(r.title,e)},"caption");t=X.cloneElement(i,null,[u,...i.props.children])}return e.unwrapTitledTableContents?t:c.jsx("div",{className:"perseus-titled-table",children:t},e.key)}},widget:{...C.widget,react:(r,n,e)=>c.jsx("em",{children:`[Widget: ${r.id}]`},e.key)},blockMath:{...C.blockMath,react:(r,n,e)=>{const{TeX:t}=B();return c.jsx(t,{children:r.content},e.key)}},math:{...C.math,react:(r,n,e)=>{const{TeX:t}=B();return c.jsx(t,{children:r.content},e.key)}},unescapedDollar:{...C.unescapedDollar,react:(r,n,e)=>"$"},link:{...C.link,react:function(r,n,e){const t=b.defaultRules.link.react(r,n,e),a=t.props.href;let i=null;(a?a.match(/https?:\/\/[^/]*khanacademy.org|^\//):!1)||(i="noopener noreferrer");const s={...t.props,target:"_blank",href:a,rel:i};return e.baseElements&&e.baseElements.Link?e.baseElements.Link(s):X.cloneElement(t,s)}},codeBlock:{...C.codeBlock,react:(r,n,e)=>r.lang==="alt"?c.jsx("div",{className:"perseus-markdown-alt perseus-sr-only",children:n(r.content,e)},e.key):b.defaultRules.codeBlock.react(r,n,e)},lint:{...C.lint,react:(r,n,e)=>c.jsx(vn,{message:r.message,ruleName:r.ruleName,inline:tt(r.content),blockHighlight:r.blockHighlight,insideTable:r.insideTable,severity:r.severity,children:n(r.content,e)})}};function tt(r){return!!(r&&r.type&&at.hasOwnProperty(r.type))}const at={text:!0,math:!0,unescapedDollar:!0,link:!0,img:!0,strong:!0,u:!0,em:!0,del:!0,code:!0},$e=b.parserFor(J),Je=(r,n)=>{const e=r+`

`;return $e(e,{...n,inline:!1})},it=(r,n)=>$e(r,{...n,inline:!0}),Y=(r,n)=>{p.isArray(r)?p.each(r,e=>Y(e,n)):p.isObject(r)&&(n(r),r.type==="table"?(Y(r.header,n),Y(r.cells,n)):r.type==="list"?Y(r.items,n):r.type==="titledTable"?Y(r.table,n):r.type==="columns"?(Y(r.col1,n),Y(r.col2,n)):p.isArray(r.content)&&Y(r.content,n))},Pe=r=>{if(p.isArray(r))return p.flatten(p.map(r,Pe));if(r.content&&p.isString(r.content))return r.type.toLowerCase().indexOf("code")!==-1?["",r.content,""]:[r.content.replace(/\s+/g," ")];const n=p.chain(r).values().flatten().filter(t=>t!=null&&p.has(t,"type")).value();if(!n.length)return[];const e=Pe(n);if(r.type==="paragraph"&&e.length){e[0]=e[0].replace(/^\s+/,"");const t=e.length-1;e[t]=e[t].replace(/\s+$/,"")}return e},st=r=>{const n=Je(r);return Pe(n).join("").length},F={characterCount:st,traverseContent:Y,parse:Je,parseInline:it,reactFor:b.reactFor,ruleOutput:b.ruleOutput(J,"react"),basicOutput:b.reactFor(b.ruleOutput(J,"react")),sanitizeUrl:b.sanitizeUrl};class Ze extends X.Component{render(){const n=this.props.className?"paragraph "+this.props.className:"paragraph";return c.jsx("div",{className:this.props.inline?this.props.className??void 0:n,"data-perseus-component-index":this.props.translationIndex,"data-perseus-paragraph-index":this.props.paragraphIndex,children:this.props.children})}}Ze.__docgenInfo={description:"",methods:[],displayName:"QuestionParagraph",props:{className:{required:!1,tsType:{name:"union",raw:"string | null | undefined",elements:[{name:"string"},{name:"null"},{name:"undefined"}]},description:""},translationIndex:{required:!0,tsType:{name:"number"},description:""},paragraphIndex:{required:!1,tsType:{name:"number"},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},inline:{required:!1,tsType:{name:"boolean"},description:""}}};const ut=1e3;class ot{constructor(){l(this,"previousContent",null);l(this,"runLinter",tn.debounce((n,e)=>{if(!(typeof KA>"u")&&n!==this.previousContent){if(this.previousContent=n,n===""){e([]);return}fetch("/api/internal/translations/lint_poentry?preview=1&lang=en",{headers:{"Content-Type":"application/json"},body:JSON.stringify({msgid:n,msgstr:n,format:"perseus_text",filename:""}),method:"POST"}).then(t=>t.status>=400?{status:"error",message:"Could not run i18n linter."}:t.json(),t=>({status:"error",message:"Could not run i18n linter."})).then(t=>{t.status==="error"?e(["Some part of this text makes it untranslatable. The specific message from the i18n linter was: "+t.message.replace(/\n/g," ")]):e([])})}},ut))}applyLintErrors(n,e){if(e.length){const t=e.join(`

`);n.unshift({content:{type:"text",content:""},insideTable:!1,message:t,ruleName:"legacy-error",severity:m.Severity.ERROR,type:"lint"})}}}const lt=r=>r.replace(/\{align[*]?\}/g,"{aligned}").replace(/[\u00a0]/g," "),{interactiveSizes:se}=kn,dt=fn,mt=qn,_={SMALL:"small",MEDIUM:"medium",LARGE:"large"},gt=r=>r?r<=dt?_.SMALL:r<=mt?_.MEDIUM:_.LARGE:_.MEDIUM,Vt=r=>r===_.SMALL?[se.defaultBoxSizeSmall,se.defaultBoxSizeSmall]:[se.defaultBoxSize,se.defaultBoxSize],pt="",ct=!1,T={},Z={},en=(r,n)=>{T[r]=n},Ht=r=>{r.forEach(n=>{en(n.name,n)})},D=(r,n)=>{const e=T[n];if(!e){const t=`Failed to replace ${r} with ${n}`;throw new j(t,E.Internal)}en(r,e)},Kt=()=>{D("transformer","deprecated-standin"),D("lights-puzzle","deprecated-standin"),D("reaction-diagram","deprecated-standin"),D("sequence","deprecated-standin"),D("simulator","deprecated-standin"),D("unit-input","deprecated-standin")},Bt=r=>{r.forEach(n=>{if(!n.widgetName)throw new j(`Editor ${n.displayName} doesn't have a widgetName property`,E.Internal);Z[n.widgetName]=n})},G=(r,n)=>{const e=Z[n];if(!e&&$){const t=`Failed to replace editor ${r} with ${n}`;$.error(t,E.Internal);return}Z[r]=e},Qt=()=>{G("transformer","deprecated-standin"),G("lights-puzzle","deprecated-standin"),G("reaction-diagram","deprecated-standin"),G("sequence","deprecated-standin"),G("simulator","deprecated-standin"),G("unit-input","deprecated-standin")},yt=r=>{var n,e,t;return p.has(T,r)?(n=T[r])!=null&&n.getWidget?(t=(e=T[r]).getWidget)==null?void 0:t.call(e):T[r].widget:null},$t=r=>p.has(Z,r)?Z[r]:null,ht=r=>{if(T[r])return T[r].version||{major:0,minor:0}},Jt=()=>{const r={};return p.each(p.keys(T),function(n){r[n]=ht(n)}),r},Zt=()=>p.pick(T,p.reject(p.keys(T),function(r){return T[r].hidden})),ea=()=>p.keys(T),bt=(r,n,e)=>{const t=r.type,a=T[t];if(a==null)return r;let i;return r.static?i=wt(t)||p.identity:i=a.transform||p.identity,i(r.options,n,e)},na=r=>{const n=T[r];return n&&n.staticTransform!=null},wt=r=>{const n=T[r];return n&&n.staticTransform},vt=r=>{const n=T[r];return n&&n.tracking||pt},kt=r=>{const n=T[r];return n&&n.isLintable||ct};class Ce extends X.Component{constructor(){super(...arguments);l(this,"widgetRef",X.createRef());l(this,"state",{sizeClass:_.MEDIUM,widgetProps:this.props.initialProps});l(this,"getWidget",()=>this.widgetRef.current);l(this,"replaceWidgetProps",e=>{this.setState({widgetProps:e})})}componentDidMount(){if(this.state.widgetProps.apiOptions.isMobile){const e=ve.findDOMNode(this).offsetWidth;this.setState({sizeClass:gt(e)})}}UNSAFE_componentWillReceiveProps(e){if(this.props.type!==e.type)throw new Error("WidgetContainer can't change widget type; set a different key instead to recreate the container.")}shouldComponentUpdate(e,t){return this.props.shouldHighlight!==e.shouldHighlight||this.props.type!==e.type||this.state.widgetProps!==t.widgetProps||this.state.sizeClass!==t.sizeClass}render(){var f;let e=we({"perseus-widget-container":!0,"widget-highlight":this.props.shouldHighlight,"widget-nohighlight":!this.props.shouldHighlight,"perseus-widget__definition":this.props.type==="definition"});const t=this.props.type,a=navigator.userAgent,i=yt(t);if(i==null)return console.warn(`Widget type '${t}' not found!`),c.jsx("div",{className:e});let u="null";t==="interactive-graph"&&(u=((f=this.state.widgetProps.graph)==null?void 0:f.type)??"null");let s=this.state.widgetProps.alignment;s==="default"&&(s=an(t)),e+=" widget-"+s;const o=this.state.widgetProps.apiOptions,d=this.state.widgetProps.static||o.readOnly,g={position:"relative",overflow:"visible"},y={width:"100%",height:"100%",position:"absolute",top:0,left:0,zIndex:3},w=kt(t)?this.props.linterContext:{...this.props.linterContext,highlightLint:!1};return c.jsx("div",{className:e,style:d?g:{},children:c.jsx(bn.Consumer,{children:({analytics:x})=>c.jsxs(O,{metadata:{widget_type:t,widget_id:this.props.id},onError:h=>{x.onAnalyticsEvent({type:"perseus:widget-rendering-error:ti",payload:{widgetSubType:u,widgetType:t,widgetId:this.props.id,message:h.message,userAgent:a}})},children:[c.jsx(i,{...this.state.widgetProps,linterContext:w,containerSizeClass:this.state.sizeClass,ref:this.widgetRef}),d&&c.jsx("div",{style:y})]})})})}}l(Ce,"defaultProps",{linterContext:De});Ce.__docgenInfo={description:"",methods:[{name:"getWidget",docblock:null,modifiers:[],params:[],returns:null},{name:"replaceWidgetProps",docblock:null,modifiers:[],params:[{name:"newWidgetProps",optional:!1,type:null}],returns:null}],displayName:"WidgetContainer",props:{shouldHighlight:{required:!0,tsType:{name:"boolean"},description:""},type:{required:!0,tsType:{name:"string"},description:""},id:{required:!0,tsType:{name:"string"},description:""},initialProps:{required:!0,tsType:{name:"intersection",raw:`RenderProps & {
...
| PerseusGraphTypeSinusoid`,elements:[{name:"signature",type:"object",raw:`{
    ...
    // The initial coordinates the graph renders with.
    startCoords?: Coord[];
}`,signature:{properties:[{key:"type",value:{name:"literal",value:'"sinusoid"',required:!0}},{key:"coords",value:{name:"union",raw:"Coord[] | null",elements:[{name:"Array",elements:[{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}],required:!0}],raw:"Coord[]"},{name:"null"}],required:!1}},{key:"startCoords",value:{name:"Array",elements:[{name:"tuple",raw:"[x: number, y: number]",elements:[{name:"unknown"},{name:"unknown"}],required:!0}],raw:"Coord[]",required:!1}}]}}],required:!1}},{key:"lockedFigures",value:{name:"Array",elements:[{name:"union",raw:`| LockedPointType
| LockedLineType
| LockedVectorType
| LockedEllipseType
| LockedPolygonType
...
}`,computed:!1}}}};const ft=/\S/,qt=/(web\+graphie|https):\/\/[^\s]*/,H=()=>{},Me=["content","problemNum","widgets"],ue=r=>"container:"+r,xt=function(r,n){return r===null||n===null?r===n:p.every(r,(e,t)=>{if(n!=null)return p.isEqual(e,n[t])})};class Te extends X.Component{constructor(e){super(e);l(this,"_currentFocus");l(this,"_foundTextNodes");l(this,"_interactionTrackers");l(this,"_isMounted");l(this,"_isTwoColumn");l(this,"_translationLinter");l(this,"_widgetContainers",new Map);l(this,"lastRenderedMarkdown");l(this,"reuseMarkdown");l(this,"translationIndex");l(this,"widgetIds");l(this,"getApiOptions",()=>({...wn.defaults,...this.props.apiOptions}));l(this,"_getInitialWidgetState",e=>{const t=sn(e.widgets);return{widgetInfo:t,widgetProps:this._getAllWidgetsStartProps(t,e)}});l(this,"_getAllWidgetsStartProps",(e,t)=>{var o;const{apiOptions:a,problemNum:i}=t,u={},{strings:s}=this.props;return gn(e).forEach(([d,g])=>{u[d]=bt(g,s,i)}),(o=a==null?void 0:a.onWidgetStartProps)==null||o.call(a,u),u});l(this,"_getDefaultWidgetInfo",e=>{const t=un.rTypeFromWidgetId.exec(e);return t==null?{}:{type:t[1],graded:!0,options:{}}});l(this,"_getWidgetInfo",e=>this.state.widgetInfo[e]||this._getDefaultWidgetInfo(e));l(this,"renderWidget",(e,t,a)=>{const i=this.state.widgetInfo[t];if(i&&i.alignment==="full-width"&&(a.foundFullWidth=!0),i){const u=i&&i.type||e,s=p.contains(this.props.highlightedWidgets,t);return c.jsx(Ce,{id:t,ref:o=>{const d=ue(t);o!=null?this._widgetContainers.set(d,o):this._widgetContainers.delete(d)},type:u,initialProps:this.getWidgetProps(t),shouldHighlight:s,linterContext:vr(this.props.linterContext,"widget")},ue(t))}return null});l(this,"getSerializedState",e=>Ne(e||this.state.widgetProps,(t,a)=>{const i=this.getWidgetInstance(a);return i&&i.getSerializedState?i.getSerializedState():t}));l(this,"restoreSerializedState",(e,t)=>{const a=p.keys(e),i=p.keys(this.state.widgetProps);if(a.length!==i.length||p.intersection(a,i).length!==a.length){$.error("Refusing to restore bad serialized state:",E.Internal,{loggedMetadata:{serializedState:JSON.stringify(e),currentProps:JSON.stringify(this.state.widgetProps)}});return}let u=1;const s=()=>{--u,t&&u===0&&t()};this.setState({widgetProps:Ne(e,(o,d)=>{const g=this.getWidgetInstance(d);if(g&&g.restoreSerializedState){++u;const y=g.restoreSerializedState(o,s);return p.extend({},this.state.widgetProps[d],y)}return o})},()=>{setTimeout(s,0)})});l(this,"showRationalesForCurrentlySelectedChoices",()=>{Object.keys(this.props.widgets).forEach(e=>{const t=this.getWidgetInstance(e);t&&t.showRationalesForCurrentlySelectedChoices&&t.showRationalesForCurrentlySelectedChoices(this._getWidgetInfo(e).options)})});l(this,"deselectIncorrectSelectedChoices",()=>{Object.keys(this.props.widgets).forEach(e=>{const t=this.getWidgetInstance(e);t&&t.deselectIncorrectSelectedChoices&&t.deselectIncorrectSelectedChoices()})});l(this,"findInternalWidgets",e=>{let t;if(typeof e=="string")if(e.indexOf(" ")!==-1){const i=e;t=(u,s,o)=>u===i}else{const i=e;t=(u,s,o)=>s.type===i}else t=e;return this.widgetIds.filter(i=>{const u=this._getWidgetInfo(i),s=this.getWidgetInstance(i);return t(i,u,s)}).map(this.getWidgetInstance)});l(this,"findWidgets",e=>[...this.findInternalWidgets(e),...this.props.findExternalWidgets(e)]);l(this,"getWidgetInstance",e=>{const t=this._widgetContainers.get(ue(e));return t?t.getWidget():null});l(this,"_onWidgetFocus",(e,t=[])=>{if(!p.isArray(t))throw new j("widget props.onFocus focusPath must be an Array, but was"+JSON.stringify(t),E.Internal);this._setCurrentFocus([e].concat(t))});l(this,"_onWidgetBlur",(e,t)=>{const a=this._currentFocus,i=[e].concat(t);p.isEqual(i,a)&&p.defer(()=>{p.isEqual(this._currentFocus,a)&&this._setCurrentFocus(null)})});l(this,"getContent",(e,t)=>t.jiptContent||e.content);l(this,"shouldRenderJiptPlaceholder",(e,t)=>B().JIPT.useJIPT&&t.jiptContent==null&&e.content.indexOf("crwdns")!==-1);l(this,"replaceJiptContent",(e,t)=>{if(t==null)this.setState({jiptContent:e});else{/^\s*(`{3,}|~{3,})\s*(\S+)?\s*\n([\s\S]+?)\s*\1\s*$/.test(e)||(/\S\n\s*\n\S/.test(e)?e="$\\large{\\red{\\text{Please translate each paragraph to a single paragraph.}}}$":/^\s*$/.test(e)&&(e="$\\large{\\red{\\text{Translated paragraph is currently empty}}}$"));const i=this.getContent(this.props,this.state),u=We.parseToArray(i);u[t]=e,this.setState({jiptContent:We.joinFromArray(u)})}});l(this,"outputMarkdown",(e,t)=>{if(p.isArray(e)){const u=t.key,s=[];let o=!1;for(let d=0;d<e.length;d++){t.key=d,t.paragraphIndex=d;const g=this.outputMarkdown(e[d],t),y=typeof g=="string";typeof g=="string"&&o?s[s.length-1]+=g:s.push(g),o=y}return t.key=u,s}this._foundTextNodes=!1,t.foundFullWidth=!1;const a=this.outputNested(e,t);let i;return this.translationIndex!=null?i=null:i=we({"perseus-paragraph-centered":!this._foundTextNodes,"perseus-paragraph-full-width":t.foundFullWidth&&e.content.length===1}),c.jsx(Ze,{className:i,translationIndex:this.translationIndex,paragraphIndex:t.paragraphIndex,inline:this.props.inline,children:c.jsx(O,{children:a})},t.key)});l(this,"outputNested",(e,t)=>{if(p.isArray(e)){const a=t.key,i=[];let u=!1;for(let s=0;s<e.length;s++){t.key=s;const o=this.outputNested(e[s],t),d=typeof o=="string";typeof o=="string"&&u?i[i.length-1]+=o:i.push(o),u=d}return t.key=a,i}return this.outputNode(e,this.outputNested,t)});l(this,"outputNode",(e,t,a)=>{const i=this.getApiOptions(),u=i.imagePlaceholder;if(e.type==="widget"){const s=i.widgetPlaceholder;return s||(this._foundTextNodes=!0,this.widgetIds.includes(e.id)?c.jsx("span",{className:"renderer-widget-error",children:["Widget [[","☃"," ",e.id,"]] already exists."].join("")},a.key):(this.widgetIds.push(e.id),this.renderWidget(e.widgetType,e.id,a)))}if(e.type==="blockMath"){const s=lt(e.content),o={overflowX:"auto",overflowY:"hidden",paddingTop:10,paddingBottom:10,marginTop:-10,marginBottom:-10};if(i.isMobile){const g={marginLeft:-16,marginRight:-16},y={paddingLeft:16,paddingRight:16},w={...o,...Fe.mobileZoomableParentFix};return c.jsx("div",{className:"perseus-block-math",style:g,children:c.jsx(O,{children:c.jsx("div",{className:"perseus-block-math-inner",style:{...w,...y},children:c.jsx(pn,{children:s})})})},a.key)}return c.jsx("div",{className:"perseus-block-math",children:c.jsx(O,{children:c.jsx("div",{className:"perseus-block-math-inner",style:o,children:c.jsx(ce.Consumer,{children:({setAssetStatus:d})=>c.jsx(Ee,{setAssetStatus:d,children:s})})})})},a.key)}if(e.type==="math"){const s=e.content;return c.jsx("span",{style:{whiteSpace:"nowrap"},children:c.jsxs(O,{children:[c.jsx("span",{}),c.jsx(ce.Consumer,{children:({setAssetStatus:o})=>c.jsx(Ee,{onRender:this.props.onRender,setAssetStatus:o,children:s})}),c.jsx("span",{})]})},a.key)}if(e.type==="image"){if(u)return u;const s=p.has(this.props.images,e.target)?this.props.images[e.target]:null,o=!a.inTable;return c.jsx(O,{children:c.jsx(ce.Consumer,{children:({setAssetStatus:d})=>c.jsx(yn,{setAssetStatus:d,src:F.sanitizeUrl(e.target),alt:e.alt,title:e.title,responsive:o,onUpdate:this.props.onRender,zoomToFullSizeOnMobile:i.isMobile&&i.isArticle,...s})})},a.key)}if(e.type==="columns")return this._isTwoColumn=!0,c.jsx(O,{children:F.ruleOutput(e,t,a)},a.key);if(e.type==="text")return ft.test(e.content)&&(this._foundTextNodes=!0),u&&qt.test(e.content)?u:e.content;if(e.type==="table"||e.type==="titledTable"){const s=F.ruleOutput(e,t,{...a,isMobile:i.isMobile,inTable:!0});if(!i.isMobile)return s;const o={marginLeft:-16,marginRight:-16},g={...{paddingLeft:0,paddingRight:0},...Fe.mobileZoomableParentFix},y=c.jsx("div",{style:{...g,overflowX:"auto"},children:c.jsx(O,{children:c.jsx(hn,{animateHeight:!0,children:s})})});return c.jsx("div",{style:o,children:y})}return c.jsx(O,{children:F.ruleOutput(e,t,a)},a.key)});l(this,"handleRender",e=>{const t=this.props.onRender,a=e.onRender;if(t!==H||a!==H){const i=mn(ve.findDOMNode(this)).find("img");a!==H&&i.off("load",a),t!==H&&i.on("load",t)}t()});l(this,"_setCurrentFocus",e=>{const t=this.getApiOptions();if(!xt(e,this._currentFocus)){const a=this._currentFocus;a&&this.blurPath(a),this._currentFocus=e,t.onFocusChange(this._currentFocus,a)}});l(this,"focus",()=>{var a;let e,t;for(let i=0;i<this.widgetIds.length;i++){const u=this.widgetIds[i],s=this.getWidgetInstance(u),o=(a=s==null?void 0:s.focus)==null?void 0:a.call(s);if(o){e=u,t=o;break}}if(e){let i;return typeof t=="object"?(i=[e].concat(t.path||[]),$.error("Renderer received a focus result of type 'object' instead of the expected type 'boolean'",E.Internal,{loggedMetadata:{focusResult:JSON.stringify(t),currentProps:JSON.stringify(this.state.widgetProps)}})):i=[e],this._setCurrentFocus(i),!0}});l(this,"getDOMNodeForPath",e=>{const t=p.first(e),a=p.rest(e),i=this.getWidgetInstance(t);if(i!=null&&i.getDOMNodeForPath)return i.getDOMNodeForPath(a);if(a.length===0)return ve.findDOMNode(i)});l(this,"getInputPaths",()=>{const e=[];return this.widgetIds.forEach(t=>{const a=this.getWidgetInstance(t);a&&a.getInputPaths&&a.getInputPaths().forEach(u=>{const s=[t].concat(u);e.push(s)})}),e});l(this,"focusPath",e=>{var u;if(p.isEqual(this._currentFocus,e))return;this._currentFocus&&this.blurPath(this._currentFocus);const t=p.first(e),a=p.rest(e),i=this.getWidgetInstance(t);(u=i==null?void 0:i.focusInputPath)==null||u.call(i,a)});l(this,"blurPath",e=>{var u;if(!p.isEqual(this._currentFocus,e))return;const t=p.first(e),a=p.rest(e);if(this.getWidgetInstance(t)){const s=this.getWidgetInstance(t);(u=s==null?void 0:s.blurInputPath)==null||u.call(s,a)}});l(this,"blur",()=>{this._currentFocus&&this.blurPath(this._currentFocus)});l(this,"serialize",()=>{const e={};return p.each(this.state.widgetInfo,function(t,a){const u=this.getWidgetInstance(a).serialize();p.isEmpty(u)||(e[a]=u)},this),e});l(this,"_setWidgetProps",(e,t,a,i)=>{this.setState(u=>{const s={...u.widgetProps,[e]:{...u.widgetProps[e],...t}},o=i?u.lastUsedWidgetId:e;return i||this.props.onSerializedStateUpdated(this.getSerializedState(s)),{lastUsedWidgetId:o,widgetProps:s}},()=>{setTimeout(()=>{const u=a&&a();i||this.props.onInteractWithWidget(e),u!==!1&&this._setCurrentFocus([e])},0)})});l(this,"setInputValue",(e,t,a)=>{var o;const i=p.first(e),u=p.rest(e),s=this.getWidgetInstance(i);(o=s==null?void 0:s.setInputValue)==null||o.call(s,u,t,a)});l(this,"getWidgetIds",()=>this.widgetIds);l(this,"handletranslationLintErrors",e=>{this._isMounted&&this.setState({translationLintErrors:e})});this._translationLinter=new ot,this.state={jiptContent:null,translationLintErrors:[],lastUsedWidgetId:null,...this._getInitialWidgetState(e)}}componentDidMount(){this._isMounted=!0,this.handleRender({}),this._currentFocus=null,this.props.serializedState&&this.restoreSerializedState(this.props.serializedState),this.props.linterContext.highlightLint&&this._translationLinter.runLinter(this.props.content,this.handletranslationLintErrors)}UNSAFE_componentWillReceiveProps(e){p.isEqual(p.pick(this.props,Me),p.pick(e,Me))||this.setState(this._getInitialWidgetState(e))}shouldComponentUpdate(e,t){if(this.props.alwaysUpdate)return!0;const a=!p.isEqual(this.state,t);return!p.isEqual(this.props,e)||a}UNSAFE_componentWillUpdate(e,t){const a=this.shouldRenderJiptPlaceholder(this.props,this.state),i=this.shouldRenderJiptPlaceholder(e,t),u=this.getContent(this.props,this.state),s=this.getContent(e,t),o=this.props.highlightedWidgets,d=e.highlightedWidgets;this.reuseMarkdown=!a&&!i&&u===s&&p.isEqual(this.state.translationLintErrors,t.translationLintErrors)&&(!this.props.linterContext.highlightLint||p.isEqual(this.props.widgets,e.widgets))&&this.props.linterContext.highlightLint===e.linterContext.highlightLint&&o===d}componentDidUpdate(e,t){this.handleRender(e),this.widgetIds.forEach(a=>{const i=this._widgetContainers.get(ue(a));i==null||i.replaceWidgetProps(this.getWidgetProps(a))}),this.props.serializedState&&!p.isEqual(this.props.serializedState,this.getSerializedState())&&this.restoreSerializedState(this.props.serializedState),this.props.linterContext.highlightLint&&this._translationLinter.runLinter(this.props.content,this.handletranslationLintErrors)}componentWillUnmount(){this.widgetIds=[],this.translationIndex!=null&&B().rendererTranslationComponents.removeComponentAtIndex(this.translationIndex),this._isMounted=!1}getWidgetProps(e){const t=this.getApiOptions(),a=this.state.widgetProps[e]||{},i=this.state.widgetInfo[e],u=this.props.reviewMode&&i?i.options:null;this._interactionTrackers||(this._interactionTrackers={});let s=this._interactionTrackers[e];return s||(s=this._interactionTrackers[e]=new qr(t.trackInteraction,i&&i.type,e,vt(i&&i.type))),{...a,widgetId:e,alignment:i&&i.alignment,static:i==null?void 0:i.static,problemNum:this.props.problemNum,apiOptions:this.getApiOptions(),keypadElement:this.props.keypadElement,questionCompleted:this.props.questionCompleted,showSolutions:this.props.showSolutions,onFocus:p.partial(this._onWidgetFocus,e),onBlur:p.partial(this._onWidgetBlur,e),findWidgets:this.findWidgets,reviewModeRubric:u,reviewMode:this.props.reviewMode,onChange:(o,d,g=!1)=>{this._setWidgetProps(e,o,d,g)},trackInteraction:s.track,isLastUsedWidget:e===this.state.lastUsedWidgetId}}emptyWidgets(){return on(this.state.widgetInfo,this.widgetIds,this.getUserInputMap(),this.context.locale)}getUserInput(){return this.widgetIds.map(e=>{const t=this.getWidgetInstance(e);if(t&&t.getUserInput)return t.getUserInput()})}getUserInputMap(){const e={};return this.widgetIds.forEach(t=>{const a=this.getWidgetInstance(t);a!=null&&a.getUserInputMap?e[t]=a.getUserInputMap():a!=null&&a.getUserInput&&(e[t]=a.getUserInput())}),e}getPromptJSON(){const{content:e}=this.props,t={};return this.widgetIds.forEach(a=>{var u;const i=this.getWidgetInstance(a);t[a]=((u=i==null?void 0:i.getPromptJSON)==null?void 0:u.call(i))||{}}),{content:e,widgets:t}}score(){const e=ln(this.state.widgetInfo,this.widgetIds,this.getUserInputMap(),this.context.locale);return dn(e)}render(){const e=this.getApiOptions();if(this.reuseMarkdown)return this.lastRenderedMarkdown;const t=this.getContent(this.props,this.state);if(this.widgetIds=[],this.shouldRenderJiptPlaceholder(this.props,this.state)&&(this.translationIndex||(this.translationIndex=B().rendererTranslationComponents.addComponent(this)),!e.isArticle))return c.jsx(ke,{children:c.jsx("div",{"data-perseus-component-index":this.translationIndex,children:t})});this._isTwoColumn=!1;const a=this.props.inline?F.parseInline(t,{isJipt:this.translationIndex!=null}):F.parse(t,{isJipt:this.translationIndex!=null});if(this.props.linterContext.highlightLint){const s={content:this.props.content,widgets:this.props.widgets,...this.props.linterContext};wr(a,s),this._translationLinter.applyLintErrors(a,[...this.state.translationLintErrors,...this.props.legacyPerseusLint||[]])}const i=this.outputMarkdown(a,{baseElements:e.baseElements}),u=we({[ye.RENDERER]:!0,[ye.RESPONSIVE_RENDERER]:!0,[ye.TWO_COLUMN_RENDERER]:this._isTwoColumn});return this.lastRenderedMarkdown=c.jsx(ke,{children:c.jsx("div",{className:u,children:i})}),this.lastRenderedMarkdown}}l(Te,"contextType",cn),l(Te,"defaultProps",{content:"",widgets:{},images:{},highlightedWidgets:[],questionCompleted:!1,showSolutions:"none",onRender:H,onInteractWithWidget:function(){},findExternalWidgets:()=>[],alwaysUpdate:!1,reviewMode:!1,serializedState:null,onSerializedStateUpdated:()=>{},linterContext:De});const Fe={mobileZoomableParentFix:{transform:"translate3d(0,0,0)"}};Te.__docgenInfo={description:"",methods:[{name:"getApiOptions",docblock:null,modifiers:[],params:[],returns:null},{name:"_getInitialWidgetState",docblock:null,modifiers:[],params:[{name:"props",optional:!1,type:{name:"intersection",raw:`Partial<React.ContextType<typeof DependenciesContext>> & {
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{zt as D,We as J,F as P,Te as R,b as S,Kt as a,Bt as b,Qt as c,$t as d,Zt as e,ea as f,Jt as g,ht as h,lt as i,_ as j,Vt as k,De as l,C as m,vr as p,Ht as r,na as s};
