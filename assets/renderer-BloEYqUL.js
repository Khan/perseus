var rn=Object.defineProperty;var an=(t,n,e)=>n in t?rn(t,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[n]=e;var l=(t,n,e)=>(an(t,typeof n!="symbol"?n+"":n,e),e);import{j as p}from"./jsx-runtime-BT65X5dW.js";import{_ as y,d as sn}from"./index-default-BcKQpA1a.js";import{e as Ae}from"./index-vrbntoJ2.js";import{P as j,E as C}from"./perseus-error-CSETqePQ.js";import{ad as We,C as un,ae as on,U as ln,af as Ce,ag as gn,ah as dn,ai as mn}from"./util-ChfG68Ch.js";import{P as G}from"./index-CrGd2QqM.js";import{$ as pn}from"./jquery-CkHB0_Mt.js";import{e as cn}from"./index-BzwLglMS.js";import{c as we}from"./index-D7h-teXI.js";import{r as O}from"./index-C6mWTJJr.js";import{h as ve}from"./index-B1Gws05u.js";import{Z as yn,c as ce}from"./zoomable-tex-Dy-nElJT.js";import{a as hn}from"./i18n-context-B1nYTGwG.js";import{L as $,S as bn}from"./svg-image-CkLr5mqM.js";import{T as Ee}from"./tex-BONImhZG.js";import{Z as wn}from"./zoomable-C_CCSKDG.js";import{g as Q,D as vn}from"./dependencies-BsVPGK1s.js";import{A as fn,C as ye}from"./perseus-api-DFYLNfT-.js";import{L as kn}from"./lint-D0FI20JF.js";import{c as qn,t as xn,u as Pn}from"./constants-BIpV3g0K.js";class z{static parse(n){return new ue(n).parse()}match(n){throw new j("Selector subclasses must implement match()",C.NotAllowed)}toString(){return"Unknown selector class"}}const de=class de{constructor(n){l(this,"tokens");l(this,"tokenIndex");n=n.trim().replace(/\s+/g," "),this.tokens=n.match(de.TOKENS)||[],this.tokenIndex=0}nextToken(){return this.tokens[this.tokenIndex]||""}consume(){this.tokenIndex++}isIdentifier(){const n=this.tokens[this.tokenIndex][0];return n>="a"&&n<="z"||n>="A"&&n<="Z"}skipSpace(){for(;this.nextToken()===" ";)this.consume()}parse(){const n=this.parseTreeSelector();let e=this.nextToken();if(!e)return n;const r=[n];for(;e;){if(e===",")this.consume();else throw new he("Expected comma");r.push(this.parseTreeSelector()),e=this.nextToken()}return new Rn(r)}parseTreeSelector(){this.skipSpace();let n=this.parseNodeSelector();for(;;){const e=this.nextToken();if(!e||e===",")break;if(e===" ")this.consume(),n=new In(n,this.parseNodeSelector());else if(e===">")this.consume(),n=new Tn(n,this.parseNodeSelector());else if(e==="+")this.consume(),n=new Nn(n,this.parseNodeSelector());else if(e==="~")this.consume(),n=new Cn(n,this.parseNodeSelector());else throw new he("Unexpected token: "+e)}return n}parseNodeSelector(){this.skipSpace();const n=this.nextToken();if(n==="*")return this.consume(),new An;if(this.isIdentifier())return this.consume(),new Sn(n);throw new he("Expected node type")}};l(de,"TOKENS");let ue=de;ue.TOKENS=/([a-zA-Z][\w-]*)|(\d+)|[^\s]|(\s(?=[a-zA-Z\*]))/g;class he extends Error{constructor(n){super(n)}}class Rn extends z{constructor(e){super();l(this,"selectors");this.selectors=e}match(e){for(let r=0;r<this.selectors.length;r++){const a=this.selectors[r].match(e);if(a)return a}return null}toString(){let e="";for(let r=0;r<this.selectors.length;r++)e+=r>0?", ":"",e+=this.selectors[r].toString();return e}}class An extends z{match(n){return[n.currentNode()]}toString(){return"*"}}class Sn extends z{constructor(e){super();l(this,"type");this.type=e}match(e){const r=e.currentNode();return r.type===this.type?[r]:null}toString(){return this.type}}class me extends z{constructor(e,r){super();l(this,"left");l(this,"right");this.left=e,this.right=r}}class In extends me{constructor(n,e){super(n,e)}match(n){const e=this.right.match(n);if(e)for(n=n.clone();n.hasParent();){n.goToParent();const r=this.left.match(n);if(r)return r.concat(e)}return null}toString(){return this.left.toString()+" "+this.right.toString()}}class Tn extends me{constructor(n,e){super(n,e)}match(n){const e=this.right.match(n);if(e&&n.hasParent()){n=n.clone(),n.goToParent();const r=this.left.match(n);if(r)return r.concat(e)}return null}toString(){return this.left.toString()+" > "+this.right.toString()}}class Nn extends me{constructor(n,e){super(n,e)}match(n){const e=this.right.match(n);if(e&&n.hasPreviousSibling()){n=n.clone(),n.goToPreviousSibling();const r=this.left.match(n);if(r)return r.concat(e)}return null}toString(){return this.left.toString()+" + "+this.right.toString()}}class Cn extends me{constructor(n,e){super(n,e)}match(n){const e=this.right.match(n);if(e)for(n=n.clone();n.hasPreviousSibling();){n.goToPreviousSibling();const r=this.left.match(n);if(r)return r.concat(e)}return null}toString(){return this.left.toString()+" ~ "+this.right.toString()}}const L=class L{constructor(n,e,r,i,a,u){l(this,"name");l(this,"severity");l(this,"selector");l(this,"pattern");l(this,"lint");l(this,"applies");l(this,"message");if(!r&&!i)throw new j("Lint rules must have a selector or pattern",C.InvalidInput,{metadata:{name:n}});this.name=n||"unnamed rule",this.severity=e||L.Severity.BULK_WARNING,this.selector=r||L.DEFAULT_SELECTOR,this.pattern=i||null,typeof a=="function"?(this.lint=a,this.message=null):(this.lint=(...s)=>this._defaultLintFunction(...s),this.message=a),this.applies=u||function(){return!0}}static makeRule(n){return new L(n.name,n.severity,n.selector?z.parse(n.selector):null,L.makePattern(n.pattern),n.lint||n.message,n.applies)}check(n,e,r,i){const a=this.selector.match(e);if(!a)return null;let u;if(this.pattern?u=r.match(this.pattern):u=L.FakePatternMatch(r,r,0),!u)return null;try{const s=this.lint(e,r,a,u,i);return s?typeof s=="string"?{rule:this.name,severity:this.severity,message:s,start:0,end:r.length}:{rule:this.name,severity:this.severity,message:s.message,start:s.start,end:s.end}:null}catch(s){return{rule:"lint-rule-failure",message:`Exception in rule ${this.name}: ${s.message}
Stack trace:
${s.stack}`,start:0,end:r.length}}}_defaultLintFunction(n,e,r,i,a){return{message:this.message||"",start:i.index,end:i.index+i[0].length}}static makePattern(n){if(!n)return null;if(n instanceof RegExp)return n;if(n[0]==="/"){const e=n.lastIndexOf("/"),r=n.substring(1,e),i=n.substring(e+1);return new RegExp(r,i)}return new RegExp(n)}static FakePatternMatch(n,e,r){const i=[e];return i.index=r,i.input=n,i}};l(L,"DEFAULT_SELECTOR"),l(L,"Severity",{ERROR:1,WARNING:2,GUIDELINE:3,BULK_WARNING:4});let d=L;d.DEFAULT_SELECTOR=z.parse("text");const En=/\/\/([^\/]+)/;function Xn(t){if(!t)return"";const n=t.match(En);return n?n[1]:""}const On=d.makeRule({name:"absolute-url",severity:d.Severity.GUIDELINE,selector:"link, image",lint:function(t,n,e,r){const i=e[0].target,a=Xn(i);if(a==="khanacademy.org"||a.endsWith(".khanacademy.org"))return`Don't use absolute URLs:
When linking to KA content or images, omit the
https://www.khanacademy.org URL prefix.
Use a relative URL beginning with / instead.`}}),Yn=d.makeRule({name:"blockquoted-math",severity:d.Severity.WARNING,selector:"blockQuote math, blockQuote blockMath",message:`Blockquoted math:
...
any other kind of terminal punctuation.`});function Mn(t,n){return`Answer requires a button not found in the button sets: ${t} (in ${n})`}const Gn={"\\sqrt":"prealgebra","\\sin":"trig","\\cos":"trig","\\tan":"trig","\\log":"logarithms","\\ln":"logarithms"},Fn=d.makeRule({name:"expression-widget",severity:d.Severity.WARNING,selector:"widget",lint:function(t,n,e,r,i){var g;if(t.currentNode().widgetType!=="expression")return;const a=t.currentNode().id;if(!a)return;const u=(g=i==null?void 0:i.widgets)==null?void 0:g[a];if(!u)return;const s=u.options.answerForms,o=u.options.buttonSets;for(const m of s)for(const[c,w]of Object.entries(Gn))if(m.value.includes(c)&&!o.includes(w))return Mn(c,w)}}),Dn=d.makeRule({name:"extra-content-spacing",selector:"paragraph",pattern:/\s+$/,applies:function(t){return(t==null?void 0:t.contentType)==="article"},message:"No extra whitespace at the end of content blocks."}),Wn=d.makeRule({name:"heading-level-1",severity:d.Severity.WARNING,selector:"heading",lint:function(t,n,e,r){if(e[0].level===1)return`Don't use level-1 headings:
Begin headings with two or more # characters.`}}),_n=d.makeRule({name:"heading-level-skip",severity:d.Severity.WARNING,selector:"heading ~ heading",lint:function(t,n,e,r){const i=e[1],a=e[0];if(i.level>a.level+1)return`Skipped heading level:
...
the first letter of a heading should be capitalized.`}),Vn={and:!0,nor:!0,but:!0,the:!0,for:!0};function zn(t){const n=t[0];return n===n.toUpperCase()}const Hn=d.makeRule({name:"heading-title-case",severity:d.Severity.GUIDELINE,selector:"heading",pattern:/[^\s:]\s+[A-Z]+[a-z]/,locale:"en",lint:function(t,n,e,r){let a=n.trim().split(/\s+/);if(a.shift(),a=a.filter(u=>u.length>2&&!Vn.hasOwnProperty(u)),a.length>=3&&a.every(u=>zn(u)))return`Title-case heading:
This heading appears to be in title-case, but should be sentence-case.
Only capitalize the first letter and proper nouns.`}}),Kn=d.makeRule({name:"image-alt-text",severity:d.Severity.WARNING,selector:"image",lint:function(t,n,e,r){const i=e[0];if(!i.alt||!i.alt.trim())return`Images should have alt text:
...
| {
    ...
    paths: [] as ReadonlyArray<any>,
    stack: [] as ReadonlyArray<any>,
}`,computed:!1},required:!1}}};export{Hr as D,Me as J,F as P,Re as R,b as S,Br as a,$r as b,Jr as c,Zr as d,ni as e,ti as f,ei as g,wr as h,dr as i,_ as j,Kr as k,_e as l,T as m,kt as p,Qr as r,ri as s};
