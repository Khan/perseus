import{cD as s,j as v}from"./iframe-CiZ4rom4.js";import{S as O}from"./server-item-renderer-with-debug-ui-fSh-i1vP.js";import{a as c,c as b,m as R,d as C}from"./radio.testdata-C1vj3X_t.js";import"./split-view-CgYgUifl.js";import"./test-keypad-context-wrapper-6ynLXwUe.js";import"./server-item-renderer-BPtEzFPN.js";import"./hints-renderer-DUBe4pQj.js";const H={title:"Perseus/Widgets/Radio",args:{static:!1,startAnswerless:!1,reviewMode:!1,showSolutions:"none",item:s({question:c})},argTypes:{showSolutions:{options:["none","all","selected"],control:{type:"select"}}},render:e=>v.jsx(O,{item:_(e),apiOptions:D(),reviewMode:e.reviewMode,showSolutions:e.showSolutions,startAnswerless:e.startAnswerless})},_=e=>{const m={...e.item,question:{...e.item.question,widgets:{}}};for(const[Q,j]of Object.entries(e.item.question.widgets))m.question.widgets[Q]={...j,static:e.static};return m},D=e=>({}),t={args:{item:s({question:c})}},r={args:{item:s({question:b})}},o={args:{item:s({question:R})}},i={args:{item:s({question:C})}},n={args:{item:s({question:c}),startAnswerless:!0}},a={args:{item:s({question:C}),startAnswerless:!0}};var u,l,p;t.parameters={...t.parameters,docs:{...(u=t.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
