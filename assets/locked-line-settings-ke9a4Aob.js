import{j as n}from"./jsx-runtime-63Ea5SlK.js";import{r as K}from"./index-6oxdNXpR.js";import"./util-_iDv4tVD.js";import{e as W}from"./svg-image-wIdVOlIq.js";import{B as Z}from"./index-69t9pbsh.js";import{V as v}from"./index-CgfdZoMj.js";import{S as G,O as x}from"./answer-choices-0E6R-XMj.js";import{S as y}from"./index-C1N8lBvx.js";import{s as c,c as h}from"./index-dmcq622U.js";import{L as H,c as C}from"./index-6ID5EQ9c.js";import{L as J,p as Q}from"./locked-figure-aria-1Hn9A7el.js";import{l as Y}from"./index-awljIyHI.js";import{v as k}from"./index-smZ6iCr_.js";import{P as ee,L as ne,a as re}from"./locked-label-settings-9IeTafVY.js";import{C as ae}from"./color-select-mdjTD_4v.js";import{L as le}from"./line-stroke-select-K8tsOvC1.js";import{L as oe}from"./line-swatch-B198KtDT.js";import{L as N}from"./locked-point-settings-UNzoXM5Z.js";import{g as te,j as T,a as ie}from"./util-LRFNLe52.js";const j="The line cannot have length 0.",$=g=>{var P,z;const{flags:d,kind:w,points:p,color:b,lineStyle:L="solid",showPoint1:R,showPoint2:V,labels:r,ariaLabel:_,onChangeProps:o,onMove:X,onRemove:M}=g,[u,s]=p,S=w.charAt(0).toUpperCase()+w.slice(1),B=`${S} (${u.coord[0]},
        ${u.coord[1]}), (${s.coord[0]}, ${s.coord[1]})`,q=W(u.coord,s.coord);async function E(){const e=await T(r),a=await T(u.labels),l=await T(s.labels);let t=`${S}${e} from point${a} at ${u.coord[0]} comma ${u.coord[1]} to point${l} at ${s.coord[0]} comma ${s.coord[1]}`;const i=ie(b,L);return t+=i,t}function F(e,a){const l=[...p];l[a]={...p[a],...e};const t=k.midpoint(p[0].coord,p[1].coord),i=k.midpoint(l[0].coord,l[1].coord),A=[i[0]-t[0],i[1]-t[1]],U=r==null?void 0:r.map((f,ue)=>({...f,coord:[f.coord[0]+A[0],f.coord[1]+A[1]]}));o({points:l,labels:U})}function I(e){var l,t;const a=r==null?void 0:r.map(i=>({...i,color:e}));o({color:e,points:[{...u,color:e,labels:(l=u.labels)==null?void 0:l.map(i=>({...i,color:e}))},{...s,color:e,labels:(t=s.labels)==null?void 0:t.map(i=>({...i,color:e}))}],labels:a})}function D(e,a){if(!r)return;const l=[...r];l[a]={...r[a],...e},o({labels:l})}function O(e){if(!r)return;const a=r.filter((l,t)=>t!==e);o({labels:a})}return n.jsxs(ee,{expanded:g.expanded,onToggle:g.onToggle,header:n.jsxs(v,{style:m.row,children:[n.jsx(H,{children:B}),n.jsx(y,{size:c.xSmall_8}),n.jsx(oe,{color:b,lineStyle:L})]}),children:[n.jsxs(C,{tag:"label",style:[m.row,m.spaceUnder],children:["kind",n.jsx(y,{size:c.xxxSmall_4}),n.jsxs(G,{selectedValue:w,onChange:e=>o({kind:e}),placeholder:"",children:[n.jsx(x,{value:"line",label:"line"}),n.jsx(x,{value:"ray",label:"ray"}),n.jsx(x,{value:"segment",label:"segment"})]})]}),n.jsxs(v,{style:m.row,children:[n.jsx(ae,{selectedValue:b,onChange:I}),n.jsx(y,{size:c.small_12}),n.jsx(le,{selectedValue:L,onChange:e=>o({lineStyle:e})})]}),q&&n.jsx(C,{style:m.errorText,children:j}),n.jsx(N,{flags:d,headerLabel:"Point 1",expanded:!0,showPoint:R,error:q?j:null,...u,onTogglePoint:e=>o({showPoint1:e}),onChangeProps:e=>F(e,0)}),n.jsx(N,{flags:d,headerLabel:"Point 2",expanded:!0,showPoint:V,error:q?j:null,...s,onTogglePoint:e=>o({showPoint2:e}),onChangeProps:e=>F(e,1)}),((P=d==null?void 0:d.mafs)==null?void 0:P["locked-figures-aria"])&&n.jsxs(n.Fragment,{children:[n.jsx(y,{size:c.small_12}),n.jsx(v,{style:m.horizontalRule}),n.jsx(J,{ariaLabel:_,getPrepopulatedAriaLabel:E,onChangeProps:e=>{o(e)}})]}),((z=d==null?void 0:d.mafs)==null?void 0:z["locked-line-labels"])&&n.jsxs(n.Fragment,{children:[n.jsx(y,{size:c.xxxSmall_4}),n.jsx(v,{style:m.horizontalRule}),n.jsx(y,{size:c.small_12}),n.jsx(C,{children:"Visible labels"}),r==null?void 0:r.map((e,a)=>K.createElement(ne,{...e,key:a,expanded:!0,onChangeProps:l=>{D(l,a)},onRemove:()=>{O(a)},containerStyle:m.labelContainer})),n.jsx(Z,{kind:"tertiary",startIcon:Q,onClick:()=>{const e=[0,-1],a=k.add(k.scale(e,(r==null?void 0:r.length)??0),k.midpoint(p[0].coord,p[1].coord)),l={...te("label"),coord:a,color:b};o({labels:[...r??[],l]})},style:m.addButton,children:"Add visible label"})]}),n.jsx(re,{figureType:g.type,onMove:X,onRemove:M})]})},m=Y.StyleSheet.create({row:{display:"flex",flexDirection:"row",alignItems:"center"},spaceUnder:{marginBottom:c.xSmall_8},errorText:{color:h.red},addButton:{alignSelf:"start"},horizontalRule:{height:1,backgroundColor:h.offBlack16},labelContainer:{backgroundColor:h.white}}),Se=$;$.__docgenInfo={description:"",methods:[],displayName:"LockedLineSettings",props:{type:{required:!0,tsType:{name:"literal",value:'"line"'},description:""},kind:{required:!0,tsType:{name:"union",raw:'"line" | "ray" | "segment"',elements:[{name:"literal",value:'"line"'},{name:"literal",value:'"ray"'},{name:"literal",value:'"segment"'}]},description:""},points:{required:!0,tsType:{name:"tuple",raw:"[point1: LockedPointType, point2: LockedPointType]",elements:[{name:"unknown"},{name:"unknown"}]},description:""},color:{required:!0,tsType:{name:"unknown[number]",raw:"(typeof lockedFigureColorNames)[number]"},description:""},lineStyle:{required:!0,tsType:{name:"union",raw:'"solid" | "dashed"',elements:[{name:"literal",value:'"solid"'},{name:"literal",value:'"dashed"'}]},description:""},showPoint1:{required:!0,tsType:{name:"boolean"},description:""},showPoint2:{required:!0,tsType:{name:"boolean"},description:""},labels:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    type: "label";
    coord: Coord;
