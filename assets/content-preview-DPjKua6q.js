import{j as e,bm as f,V as v,n as k,S as P,e as T,y as R,R as x,f as A,s as I}from"./iframe-BEpDFuEi.js";import"./item-version-CjJ8BGV5.js";import"./article-renderer-CqL6Br8Y.js";import"./server-item-renderer-Cm8HzarJ.js";import"./hints-renderer-CMCzx8se.js";import{c as q}from"./components-C6zBg3Ka.js";import{d as i,c as F,e as D,f as C,l as N}from"./icon-paths-BO0gJZqD.js";const{ButtonGroup:E,InlineIcon:o}=q,j=n=>{const t=e.jsxs("span",{children:[e.jsx(o,{...F})," Phone"]}),a=e.jsxs("span",{children:[e.jsx(o,{...D})," Tablet"]}),r=e.jsxs("span",{children:[e.jsx(o,{...C})," Desktop"]});return e.jsxs("span",{className:"viewport-resizer",children:["Viewport:"," ",e.jsx(E,{value:n.deviceType,allowEmpty:!1,buttons:[{value:i.PHONE,content:t},{value:i.TABLET,content:a},{value:i.DESKTOP,content:r}],onChange:n.onViewportSizeChanged})]})};j.__docgenInfo={description:"",methods:[],displayName:"ViewportResizer",props:{deviceType:{required:!0,tsType:{name:"union",raw:'"phone" | "tablet" | "desktop"',elements:[{name:"literal",value:'"phone"'},{name:"literal",value:'"tablet"'},{name:"literal",value:'"desktop"'}]},description:"The current device type that is selected."},onViewportSizeChanged:{required:!0,tsType:{name:"signature",type:"function",raw:"(deviceType: DeviceType) => unknown",signature:{arguments:[{type:{name:"union",raw:'"phone" | "tablet" | "desktop"',elements:[{name:"literal",value:'"phone"'},{name:"literal",value:'"tablet"'},{name:"literal",value:'"desktop"'}]},name:"deviceType"}],return:{name:"unknown"}}},description:`A callback that is passed (width, height) as the dimensions of the
...
media queries based on the screen width).`}}};export{M as C,j as V};
