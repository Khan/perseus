import{t as w}from"./core-widget-registry-uiKfW1Am.js";import{_ as d}from"./index-default-4_ZsnO94.js";import{w as b}from"./article-renderer-QI85RjyP.js";import{r as f,g as v,l as k,R as q,p as g}from"./renderer-A6MykUCq.js";import{j as i}from"./jsx-runtime-63Ea5SlK.js";import{l as y}from"./index-awljIyHI.js";import{r as m}from"./index-6oxdNXpR.js";import{c as R}from"./asset-context-H6Iqp7Gi.js";import{P as A}from"./i18n-context-YAdgKrxn.js";import{D as P}from"./dependencies-CP7Uh8Kq.js";import{H as I}from"./hints-renderer-KaiZgtxB.js";import{A as T}from"./perseus-api-DO0X8arb.js";import{U as C}from"./util-CFc6mjZH.js";const x="@khanacademy/perseus",S="__lib_version__";w(x,S);const j={major:0,minor:1};f(b);const N=v();N["::renderer::"]=j;const O={onRendered:p=>{}},F=m.createContext(O),u=class u extends m.Component{constructor(e){super(e),this._handleFocusChange=(n,r)=>{n!=null?this._setCurrentFocus(n):this._onRendererBlur(r)},this.handleInteractWithWidget=n=>{var t,a;const r=d.difference(this.state.questionHighlightedWidgets,[n]);this.setState({questionCompleted:!1,questionHighlightedWidgets:r}),(a=(t=this.props.apiOptions)==null?void 0:t.interactionCallback)==null||a.call(t,this.questionRenderer.getUserInputMap())},this.setAssetStatus=(n,r)=>{const t={...this.state.assetStatuses,[n]:r};this.setState({assetStatuses:t})},this.state={questionCompleted:!1,questionHighlightedWidgets:[],assetStatuses:{}},this._fullyRendered=!1}componentDidMount(){this._currentFocus=null,this._fullyRendered=!1}UNSAFE_componentWillReceiveProps(e){this.setState({questionHighlightedWidgets:[]})}componentDidUpdate(e,n){const r=this.props.apiOptions.answerableCallback;if(r!=null){const t=this.questionRenderer.emptyWidgets().length===0;r(t)}if(this._fullyRendered||Object.values(this.state.assetStatuses).every(Boolean)&&(this._fullyRendered=!0,this.props.onRendered(!0)),this.props.score&&this.props.score!==e.score){const t=this.questionRenderer.emptyWidgets();this.setState({questionCompleted:this.props.score.correct,questionHighlightedWidgets:t})}}componentWillUnmount(){this.blurTimeoutID!=null&&(clearTimeout(this.blurTimeoutID),this.blurTimeoutID=null)}_setCurrentFocus(e){const{apiOptions:{isMobile:n,onFocusChange:r},keypadElement:t}=this.props,a=this._currentFocus;this._currentFocus=e;const c=this.getInputPaths(),l=this._currentFocus&&c.some(s=>C.inputPathsEqual(s,this._currentFocus));r!=null&&setTimeout(()=>{const s=t==null?void 0:t.getDOMNode(),h=s&&l?s.getBoundingClientRect().height:0;r(this._currentFocus,a,h,l&&this.questionRenderer.getDOMNodeForPath(e))},0),t&&n&&(l?t.activate():t.dismiss())}_onRendererBlur(e){const n=this._currentFocus;d.isEqual(e,n)&&(this.blurTimeoutID=setTimeout(()=>{d.isEqual(this._currentFocus,n)&&this._setCurrentFocus(null)},0))}_setWidgetProps(e,n,r){this.questionRenderer._setWidgetProps(e,n,r)}setInputValue(e,n,r){return this.questionRenderer.setInputValue(e,n,r)}focusPath(e){return this.questionRenderer.focusPath(e)}blurPath(e){return this.questionRenderer.blurPath(e)}getDOMNodeForPath(e){return this.questionRenderer.getDOMNodeForPath(e)}getInputPaths(){return this.questionRenderer.getInputPaths()}focus(){return this.questionRenderer.focus()}blur(){this._currentFocus&&this.blurPath(this._currentFocus)}getNumHints(){return this.props.item.hints.length}getPromptJSON(){return this.questionRenderer.getPromptJSON()}getUserInputLegacy(){return this.questionRenderer.getUserInput()}getUserInput(){return this.questionRenderer.getUserInputMap()}getWidgetIds(){return this.questionRenderer.getWidgetIds()}getSerializedState(){return{question:this.questionRenderer.getSerializedState(),hints:this.hintsRenderer.getSerializedState()}}restoreSerializedState(e,n){let r=2;const t=()=>{--r,n&&r===0&&n()};this.questionRenderer.restoreSerializedState(e.question,t),this.hintsRenderer.restoreSerializedState(e.hints,t)}showRationalesForCurrentlySelectedChoices(){this.questionRenderer.showRationalesForCurrentlySelectedChoices()}deselectIncorrectSelectedChoices(){this.questionRenderer.deselectIncorrectSelectedChoices()}render(){const e={...T.defaults,...this.props.apiOptions,onFocusChange:this._handleFocusChange},n={assetStatuses:this.state.assetStatuses,setAssetStatus:this.setAssetStatus},r=i.jsx(R.Provider,{value:n,children:i.jsx(q,{keypadElement:this.props.keypadElement,problemNum:this.props.problemNum,onInteractWithWidget:this.handleInteractWithWidget,highlightedWidgets:this.state.questionHighlightedWidgets,apiOptions:e,questionCompleted:this.state.questionCompleted,reviewMode:this.props.reviewMode,showSolutions:this.props.showSolutions,ref:a=>{a!=null&&(this.questionRenderer=a)},content:this.props.item.question.content,widgets:this.props.item.question.widgets,images:this.props.item.question.images,linterContext:g(this.props.linterContext,"question"),strings:this.context.strings,...this.props.dependencies})}),t=i.jsx(I,{hints:this.props.item.hints,hintsVisible:this.props.hintsVisible,apiOptions:e,ref:a=>this.hintsRenderer=a,linterContext:g(this.props.linterContext,"hints"),strings:this.context.strings});return i.jsx(P.Provider,{value:this.props.dependencies,children:i.jsxs("div",{children:[i.jsx("div",{children:r}),i.jsx("div",{className:e.isMobile?void 0:y.css(D.hintsContainer),children:t})]})})}};u.contextType=A,u.defaultProps={apiOptions:{},linterContext:k,onRendered:e=>{}};let o=u;const D=y.StyleSheet.create({hintsContainer:{marginLeft:50}}),M=m.forwardRef((p,e)=>i.jsx(F.Consumer,{children:({onRendered:n})=>i.jsx(o,{...p,onRendered:n,ref:e})}));o.__docgenInfo={description:"",methods:[{name:"_handleFocusChange",docblock:null,modifiers:[],params:[{name:"newFocus",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}},{name:"oldFocus",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"_setCurrentFocus",docblock:null,modifiers:[],params:[{name:"newFocus",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"_onRendererBlur",docblock:null,modifiers:[],params:[{name:"blurPath",optional:!1,type:{name:"union",raw:"ReadonlyArray<string> | null | undefined",elements:[{name:"ReadonlyArray",elements:[{name:"string"}],raw:"ReadonlyArray<string>"},{name:"null"},{name:"undefined"}],alias:"FocusPath"}}],returns:null},{name:"_setWidgetProps",docblock:`Accepts a question area widgetId, or an answer area widgetId of
...
}`,computed:!1},required:!1},onRendered:{defaultValue:{value:"(isRendered: boolean) => {}",computed:!1},required:!1}}};M.__docgenInfo={description:"",methods:[],displayName:"ref"};export{o as S,j as i,M as r};
