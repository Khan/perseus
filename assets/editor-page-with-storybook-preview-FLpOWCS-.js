import{r as a,j as n,V as l,aj as w,a7 as b,ak as f,R as k,al as v}from"./iframe-Bqs4JwNG.js";import"./changeable-C7GyetS0.js";import"./article-renderer-eSUBpUdX.js";import"./server-item-renderer-BO69CDoX.js";import"./hints-renderer-DSrX6IHN.js";import{C as P}from"./content-preview-n_lWhwaj.js";import{E as R}from"./editor-page-NcHF4sIz.js";import{P as T,s as A}from"./preview-panel-DhDtRo87.js";const{action:I}=__STORYBOOK_MODULE_ACTIONS__,x={analytics:{onAnalyticsEvent:async()=>{}},generateUrl:t=>t.url,useVideo:()=>({status:"success",data:{video:null}})},q=I("onChange");function F(t){const[o,u]=a.useState("phone"),[h,c]=a.useState(!1),[p,m]=a.useState(),[s,g]=a.useState(t.question),[r,y]=a.useState(t.hints),i=t.apiOptions??{isMobile:!1};return n.jsxs(l,{children:[n.jsx(R,{apiOptions:i,previewDevice:o,onPreviewDeviceChange:e=>u(e),dependencies:x,developerMode:!0,jsonMode:h,answerArea:p,question:s,hints:r,previewURL:"about:blank",itemId:"1",onChange:e=>{q(e),"jsonMode"in e&&c(e.jsonMode),"answerArea"in e&&m(e.answerArea),"question"in e&&g(e.question),"hints"in e&&y(e.hints)},additionalTemplates:{"Side by Side":`Left hand side
=====
Right hand side`}}),n.jsxs(T,{openButtonText:"Open preview (storybook only)",children:[n.jsx(P,{question:s,previewDevice:o,apiOptions:i,linterContext:{contentType:"exercise",highlightLint:!0,paths:[],stack:[]}}),r==null?void 0:r.map((e,d)=>n.jsxs(l,{className:A.innerPanel,children:[n.jsx(w,{size:b.medium_16}),n.jsx(f,{children:`Hint ${d+1}`}),n.jsx(k,{strings:v,apiOptions:i,...e})]},d))]})]})}F.__docgenInfo={description:"",methods:[],displayName:"EditorPageWithStorybookPreview",props:{apiOptions:{required:!1,tsType:{name:"Readonly",elements:[{name:"signature",type:"object",raw:`{
    isArticle?: boolean;
    onFocusChange?: (
