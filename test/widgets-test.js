...
function testMultipleAnswer(component, inputs, result, description) {
    _.chain($("#qunit-fixture input")).zip(inputs).each(function(args) {
...
asyncTest("widget input-number", 27, function() {
...
asyncTest("widget input-number multiple simplify-enforced", 21, function() {
    var component = React.renderComponent(Perseus.Renderer({
        "content": "[[☃ input-number 1]]\n[[☃ input-number 2]]",
        "widgets": {
            "input-number 1": {
