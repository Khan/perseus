...
import performDiff from "./widget-diff-performer.jsx";
...
class DiffSide extends React.Component<$FlowFixMe> {
    static propTypes = {
...
class CollapsedRow extends React.Component<$FlowFixMe> {
    static propTypes = {
...
class DiffEntry extends React.Component<$FlowFixMe, $FlowFixMe> {
    static propTypes = {
        depth: PropTypes.number,
...
class ImageWidgetDiff extends React.Component<$FlowFixMe> {
    static propTypes = {
...
class WidgetDiff extends React.Component<$FlowFixMe> {
    static propTypes = {
        after: PropTypes.shape({
            options: PropTypes.objectOf(PropTypes.any),
        }),
