...
import LineStyleSelect, {StyleOptions} from "./line-style-select";
...
export const LockedFunctionSettings = (props: Props) => {
    const {color: lineColor, strokeStyle, onChangeProps, onMove, onRemove} = props;
    ...
    return (
        ...
        >
            <View style={[styles.row, styles.spaceUnder]}>
                ...
                {/* Line style settings */}
                <LineStyleSelect selectedValue={strokeStyle} onChange={handleStyleChange}/>
            </View>
