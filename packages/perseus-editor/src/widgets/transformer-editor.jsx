...
class ToolSettings extends React.Component<$FlowFixMe> {
    static defaultProps = {
        allowFixed: true,
    };
...
class TransformationExplorerSettings extends React.Component<$FlowFixMe> {
    render(): React.Node {
        return (
...
class TransformationsShapeEditor extends React.Component<$FlowFixMe> {
    render(): React.Node {
        return (
            <div>
                <Graph
...
class TransformerEditor extends React.Component<$FlowFixMe> {
    // TODO (jack): These should be refactored into a nice object at the top
    // so that we don't have all this duplication
    static defaultProps: $FlowFixMe = defaultTransformerProps;
    ...
    // this.props.graph
    changeGraph: ($FlowFixMe, $FlowFixMe) => void = (
        graphChanges,
        callback,
    ) => {
    ...
    // this.props.starting
    changeStarting: ($FlowFixMe) => void = (startingChanges) => {
    ...
    changeTransformer: ($FlowFixMe, $FlowFixMe) => void = (
        changes,
        callback,
    ) => {
