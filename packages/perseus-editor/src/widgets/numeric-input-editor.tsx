...
const fieldStyles = StyleSheet.create({
    // A labelled setting: the label (and optional InfoTip) sit on their own
    // line, with the control stacked below and a gap between them.
    field: {
        marginBlock: sizing.size_120,
        gap: sizing.size_080,
