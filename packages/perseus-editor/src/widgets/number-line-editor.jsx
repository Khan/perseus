...
class NumberLineEditor extends React.Component<Props> {
    ...
    onRangeChange: (Range) => void = (range) => {
    ...
    onLabelRangeChange: (number, number) => void = (i, num) => {
    ...
    onDivisionRangeChange: (Range) => void = (divisionRange) => {
    ...
    onNumChange: ("correctX" | "initialX" | "snapDivisions", number) => void = (
        key,
        value,
    ) => {
        const opts = {};
    ...
    onNumDivisionsChange: (number) => void = (numDivisions) => {
    ...
    onTickStepChange: (number) => void = (tickStep) => {
        this.props.onChange({
            numDivisions: null,
            tickStep: tickStep,
        });
    ...
    onChangeRelation: (SyntheticInputEvent<>) => void = (e) => {
    ...
    onLabelStyleChange: ($FlowFixMe) => void = (labelStyle) => {
        this.props.onChange({
