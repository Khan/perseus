...
import ViewportResizer from "./components/viewport-resizer.jsx";
import CombinedHintsEditor from "./hint-editor.jsx";
...
type Props = {|
    ...
    answerArea?: $FlowFixMe, // related to the question
    ...
    onPreviewDeviceChange: (DeviceType) => mixed,
...
class EditorPage extends React.Component<Props, State> {
    ...
    changeJSON: (newJson: PerseusJson) => void = (newJson: PerseusJson) => {
        ...
        // $FlowIgnore[incompatible-call]: PerseusJson is incompatible with first param of ChangeHandler
        this.props.onChange(newJson);
    };

    scorePreview(): ?KEScore {
