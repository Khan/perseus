...
type Props = {|
    ...
    preloader?: (dimensions: Dimensions) => React.Node,
...
type LabelsRenderedMap = {[label: string]: boolean, ...};
...
class SvgImage extends React.Component<Props, State> {
    ...
    onDataLoaded: (
        data: {labels: $ReadOnlyArray<any>, range: $ReadOnlyArray<any>, ...},
        localized: boolean,
    ) => void = (
        data: {
            labels: $ReadOnlyArray<any>,
    ...
    _handleZoomClick: (e: SyntheticEvent<>) => void = (e: SyntheticEvent<>) => {
