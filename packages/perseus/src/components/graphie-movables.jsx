...
import GraphieClasses from "./graphie-classes.jsx";

const MovablePoint: $FlowFixMe = GraphieClasses.createClass({
...
const MovableLine: $FlowFixMe = GraphieClasses.createClass({
...
const Label: $FlowFixMe = GraphieClasses.createSimpleClass((graphie, props) => {
...
const Line: $FlowFixMe = GraphieClasses.createClass({
    displayName: "Line",
...
const Parabola: $FlowFixMe = GraphieClasses.createClass({
...
const Sinusoid: $FlowFixMe = GraphieClasses.createClass({
...
const Plot: $FlowFixMe = GraphieClasses.createSimpleClass((graphie, props) => {
    return graphie.plot(props.fn, props.range, props.style);
});

const PlotParametric: $FlowFixMe = GraphieClasses.createSimpleClass(
    (graphie, props) => {
        return graphie.plotParametric(props.fn, props.range, props.style);
    },
);

const Point: $FlowFixMe = GraphieClasses.createSimpleClass((graphie, props) => {
...
const Path: $FlowFixMe = GraphieClasses.createClass({
    displayName: "Path",
...
const Arc: $FlowFixMe = GraphieClasses.createSimpleClass((graphie, props) => {
...
const Circle: $FlowFixMe = GraphieClasses.createSimpleClass(
    (graphie, props) => {
        return graphie.circle(props.center, props.radius, props.style);
    },
);

const Rect: $FlowFixMe = GraphieClasses.createSimpleClass((graphie, props) => {
    return graphie.rect(
        props.x,
        props.y,
        props.width,
