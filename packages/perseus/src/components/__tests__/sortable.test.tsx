...
describe("Sortable AssetContext integration", () => {
    // Quiescence-timer behavior is covered in detail by sortable-asset-tracker.test.ts.
    // These tests only verify Sortable's wiring to AssetContext at mount and unmount.
    ...
    function renderInContext(): {unmount: () => void} {
        return render(
    ...
    it("marks itself unsettled on mount", () => {
        // Arrange, Act
        renderInContext();
    ...
    it("marks itself settled on unmount", () => {
        // Arrange
        const {unmount} = renderInContext();
