...
import VisibilityObserver from "../visibility-observer.jsx";

import type {ScrollVisibility} from "../visibility-observer.jsx";
...
export const AlertWhenNotVisible = (args: StoryArgs): React.Node => {
