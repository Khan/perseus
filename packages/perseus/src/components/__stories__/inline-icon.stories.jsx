...
import InlineIcon from "../inline-icon.jsx";
...
export const BasicIconPathAndSizing = (args: StoryArgs): React.Node => {
    return <InlineIcon {...defaultPath} />;
};

export const BasicIconWithAdditionalStyling = (args: StoryArgs): React.Node => {
    return (
        <InlineIcon
            {...defaultPath}
            style={{
...
export const BasicIconWithAriaTitle = (args: StoryArgs): React.Node => {
