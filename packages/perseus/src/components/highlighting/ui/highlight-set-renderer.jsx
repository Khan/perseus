...
import HighlightRenderer from "./highlight-renderer.jsx";
...
> {
    ...
    _handleMouseMove: (e: MouseEvent) => void = (e: MouseEvent) => {
        const mouseClientPosition = {left: e.clientX, top: e.clientY};
        const hoveredHighlightKey =
            this._getHoveredHighlightKey(mouseClientPosition);
        this.setState({hoveredHighlightKey});
    };

    _getHoveredHighlightKey(mouseClientPosition: Position): ?string {
    ...
    _renderTooltip(): null | React.Node {
