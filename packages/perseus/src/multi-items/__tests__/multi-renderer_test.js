...
import MockWidgetExport from "../../__tests__/mock-widget.jsx";
...
import {
    ...
    question1,
    simpleQuestionShape,
} from "../__testdata__/multi-renderer_testdata.js";
import MultiRenderer from "../multi-renderer.jsx";
import shapes from "../shapes.js";

import type {Widget} from "../../renderer.jsx";
import type {FilterCriterion} from "../../types.js";
...
const SimpleLayout = ({renderers}: {|renderers: any|}): React.Node => {
    if (renderers == null) {
...
const renderSimpleQuestion = (question: Item) => {
    // Arrange
    let renderer: ?MultiRenderer = null;
    const result = render(
        <RenderStateRoot>
            <MultiRenderer
                item={question}
...
): Tree<$ReadOnlyArray<?Widget>, $ReadOnlyArray<?Widget>, null> => {
