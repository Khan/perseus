...
import type {APIOptions, FilterCriterion} from "../types.js";
...
import type {TreeMapper, ContentMapper, HintMapper, Path} from "./trees.js";
...
type ContentRendererElement = React.Element<any>;
type HintRendererElement = React.Element<any>;
type ContentRendererData = {|
    makeRenderer: () => ContentRendererElement,
    ref: ?Renderer,
|};
type FindWidgetsFunc = (criterion: FilterCriterion) => $ReadOnlyArray<?Widget>;
...
type Props = {|
    item: Item,
    shape: Shape,
    children: (tree: {|renderers: RendererTree|}) => React.Element<any>,
...
class MultiRenderer extends React.Component<Props, State> {
    ...
    _makeHintRendererData(hint: HintNode): HintRendererData {
        ...
        const findExternalWidgets = (criterion) =>
            this._findWidgets(({}: any), criterion);
