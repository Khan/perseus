...
import WrappedPath from "../interactive2/wrapped-path.js";
...
const InteractiveUtils: $FlowFixMe = {
...
_.extend(GraphUtils.Graphie.prototype, {
    ...
    //
    addMovableLineSegment: function (options: $FlowFixMe) {
...
function Ruler(graphie, options) {
    ...
    function getTickHeight(i): number {
