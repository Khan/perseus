...
import WrappedLine from "./wrapped-line.js";
import WrappedPath from "./wrapped-path.js";
...
const draw = {
    basic: function (state: $FlowFixMe) {
    ...
    arrows: function (state: $FlowFixMe) {
...
const constraints = {
    ...
    snap: function (snap: $FlowFixMe): (Coord, Coord) => $FlowFixMe {
