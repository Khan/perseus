...
type Props = {|
    ...
    onShowCalculator?: () => mixed,
    onShowChi2Table?: () => mixed,
    onShowPeriodicTable?: () => mixed,
    onShowTTable?: () => mixed,
    onShowZTable?: () => mixed,
...
type State = {|
    keypadElement: ?HTMLElement, // from ProvideKeypad.getInitialState
    hintsVisible: number,
...
type SerializedState = {|
    hints: $FlowFixMe,
    question: {|[id: string]: $FlowFixMe|},
|};

class ItemRenderer extends React.Component<Props, State> {
    questionRenderer: Renderer;
    hintsRenderer: ?React.ElementRef<typeof HintsRenderer>;
     ...
     * from `getWidgetIds`.
     */
    scoreWidgets(): {|[id: string]: KEScore|} {
