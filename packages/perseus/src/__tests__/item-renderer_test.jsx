...
import ItemRenderer from "../item-renderer.jsx";
import {registerWidget} from "../widgets.js";
import {multiChoiceQuestion} from "../widgets/__testdata__/radio_testdata.js";
import DefinitionExport from "../widgets/definition.jsx";
import InputNumberExport from "../widgets/input-number.jsx";
import LabelImageExport from "../widgets/label-image.jsx";
import RadioWidgetExport from "../widgets/radio.jsx";

import MockWidgetExport from "./mock-widget.jsx";

import type {PerseusItem, PerseusRenderer} from "../perseus-types.js";
import type {Widget as WidgetInstance} from "../renderer.jsx";
import type {APIOptions, PerseusScore} from "../types.js";
...
export const renderQuestion = (
    ...
    optionalProps: $Shape<ItemRenderer["props"]> = Object.freeze({}),
): {|
...
describe("item renderer", () => {
    ...
    describe("support functions", () => {
        ...
        it("should forward deselectIncorrectSelectedChoices calls to questionRenderer", () => {
            ...
            expect(listitems[0].getAttribute("data-test-checked")).toBe(
                "false",
            );
            expect(listitems[1].getAttribute("data-test-checked")).toBe(
                "false",
            );
            expect(listitems[2].getAttribute("data-test-checked")).toBe(
                "false",
            );
            expect(listitems[3].getAttribute("data-test-checked")).toBe("true");
        });
    ...
    describe("controlPeripherals is disabled", () => {
        const extraProps = {controlPeripherals: false};

        it("should hide peripherals if answerArea flag(s) are false", () => {
            // Arrange
            const item = {...itemWithInput, answerArea: null};
    ...
    describe("controlPeripherals is enabled", () => {
        const extraProps: $Shape<ItemRenderer["props"]> = {
