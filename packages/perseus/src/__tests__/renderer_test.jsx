...
import {
    ...
    question2,
    mockedItem,
} from "../__testdata__/renderer_testdata.js";
...
describe("renderer", () => {
    ...
    describe("focus management", () => {
        ...
        it("should focus the input at the requested FocusPath", () => {
            ...
            // Act
            renderer.focusPath(["numeric-input 1"]);
        ...
        it("should blur current widget when focus changes", () => {
            ...
            // Act
            renderer.focusPath(["numeric-input 2"]);
        ...
        it("should do nothing if blurred widget is not focused", () => {
            ...
            // Act
            renderer.blurPath(["numeric-input 1"]);
    ...
    describe("setInputValue", () => {
        it("should set the value on the requested FocusPath", () => {
            ...
            // Act
            renderer.setInputValue(["numeric-input 2"], "1000", cb);
            ...
            const {renderer} = renderQuestion({
                ...
                widgets: {
                    ...
                    "numeric-input 2": {
                        ...numericInputWidget,
                        options: (({
                            ...numericInputWidget.options,
                            answers: [
                                {
                                    // $FlowFixMe[incompatible-use] answers is marked as nullable
                                    ...numericInputWidget.options.answers[0],
                                    answerForms: ["pi"],
                                },
                            ],
                        }: any): PerseusNumericInputWidgetOptions),
                    },
                    "dropdown 1": dropdownWidget,
                },
                images: {},
