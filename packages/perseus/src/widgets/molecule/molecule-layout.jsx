 ...
 */
function bondLayout(bond: $FlowFixMe, atoms: $FlowFixMe): $FlowFixMe {
 ...
 */
function layout(tree: $FlowFixMe, rotationAngle: $FlowFixMe): $FlowFixMe {
