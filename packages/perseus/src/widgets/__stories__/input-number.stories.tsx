...
const updateWidgetOptions = (question: Question, widgetId: string, options: InputNumberOptions): Question => {
...
export const Rational: React.FC<InputNumberOptions> = (args): React.ReactElement => {
...
export const PiSimplify: React.FC<InputNumberOptions> = (args): React.ReactElement => {
    const question = updateWidgetOptions(question2, "input-number 1", args);
    return <RendererWithDebugUI question={question} />;
};
PiSimplify.args = question2.widgets["input-number 1"].options;

export const Percent: React.FC<InputNumberOptions> = (args): React.ReactElement => {
