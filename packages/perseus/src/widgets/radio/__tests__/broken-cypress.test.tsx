        ...
        widgets: {
            "definition 1": {
                ...
                options: {
                    ...
                    definition:
                        "Phy·si·cal (fih-sic-ull): Having to do with the body",
                    static: false,
                },
            },
            "definition 3": {
                ...
                options: {
                    togglePrompt: "mental",
                    definition:
                        "Men·tal (men-tull): Having to do with the mind",
                    static: false,
                },
            },
            "explanation 1": {
                ...
                options: {
                    ...
                    explanation:
                        "Public domain image provided by [Pxhere](https://pxhere.com/en/photo/1033461)",
                    widgets: {},
                    static: false,
                },
            },
            ...
            "radio 1": {
                ...
                options: {
                    choices: [
                        {
                            content:
                                "“The United Nations has declared that playing is a basic human right.” (paragraph 1)\n\n",
                            rationale: "",
                            correct: false,
                            isNoneOfTheAbove: false,
                            id: "",
                            widgets: null,
                            clue: "\nThis line doesn’t support the idea that recess may increase learning. In fact, it doesn’t mention recess or learning at all. ",
                        },
                        {
                            content:
                                "“Research shows that exercise makes people healthier and happier.”  (paragraph 2)\n\n",
                            rationale: "",
                            correct: false,
                            isNoneOfTheAbove: false,
                            id: "",
                            widgets: null,
                            clue: "This line doesn’t support the idea that recess may increase learning. It doesn’t mention learning at all.\n",
                        },
                        {
                            content:
                                "“As the amount of time we spend taking standardized tests has grown, our recess has shrunk.”  (paragraph 5)\n\n",
                            rationale: "",
                            correct: false,
                            isNoneOfTheAbove: false,
                            id: "",
                            widgets: null,
                            clue: "This line doesn’t support the idea that recess may increase learning. It mentions standardized tests, which can show what students have learned, but it only talks about the time spent taking tests. It doesn’t discuss any results from those tests. \n",
                        },
                        {
                            content:
                                "“Furthermore, several studies show that students focus better in class when they have recess during the school day.”  (paragraph 6)\n",
                            rationale: "",
                            correct: true,
                            isNoneOfTheAbove: false,
                            id: "",
                            widgets: null,
                            clue: "**This is the best choice.** If you focus in class, you are likely to learn more.\n",
                        },
                    ],
                    numCorrect: 0,
...
describe("Broken Cypress", () => {
    it("should show rationales", async () => {
        // Arrange / Act
        const rv = parseAndMigratePerseusItem(item);

        let result: any;
        if (isFailure(rv)) {
            result = rv.detail.invalidObject;
        } else {
            result = rv.value;
        }
        ...
        // Assert
        expect(
            result.question.widgets["radio 1"].options.choices[0].rationale,
        ).toBe(
            "\nThis line doesn’t support the idea that recess may increase learning. In fact, it doesn’t mention recess or learning at all. ",
        );
        expect(
            result.question.widgets["radio 1"].options.choices[0].clue,
        ).toBeUndefined();
        assertSuccess(rv);
    });
});
