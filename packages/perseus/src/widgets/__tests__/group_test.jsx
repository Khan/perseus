...
import {traverse} from "../../../perseus-all-package/traversal.jsx";
...
import {question1} from "../__testdata__/group_testdata.js";
...
describe("group widget", () => {
    ...
    describe("traverseChildWidgets", () => {
        ...
        it("should call the widgetCallback for every widget anywhere in the tree", () => {
            // Arrange
            const widgetIds = [];
            const widgetCallback = (_, widgetId) => widgetIds.push(widgetId);
