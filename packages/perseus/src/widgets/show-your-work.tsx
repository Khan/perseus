...
const Step = (props: StepProps) => {
    ...
    const expression = <ExpressionWidget
        ...
        onChange={(arg1, arg2, arg3) => props.onChange({...step, value: arg1.value})}
...
class ShowYourWork extends React.Component<Props, State> {
    ...
    state: State = {
        steps: [
            {value: "2x=5", status: "correct"},
            {value: "2x=5", status: "waiting"},
        ],
    };
        ...
        return (
            <View style={styles.contentWrapper}>
                {steps.map((step, i) => {
                    ...
                    const disableCheck =
                        isLast && (
                            steps[steps.length - 2].value === steps[steps.length - 1].value ||
                    ...
                    return <Step
                        ...
                        onCheckStep={() => {
                            if (isLast) {
                                ...
                                const {result, mistakes} = checkStep(prev, next);
