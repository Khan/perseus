    ...
    implements Widget
{
    ...
    onRelease: (arg1: any) => void = (loc) => {
        ...
        const onAnimationEnd = () => {
            ...
            this.props.onChange({
                // @ts-expect-error - TS2345 - Argument of type '{ current: any[]; }' is not assignable to parameter of type '{ hints?: readonly Hint[] | undefined; replace?: boolean | undefined; content?: string | undefined; widgets?: PerseusWidgetsMap | undefined; images?: PerseusImagesMap | undefined; ... 13 more ...; plot?: any; }'.
                current: list,
            });
            this.setState({
                current: list,
    ...
    setListValues: (arg1: ReadonlyArray<string>) => void = (values) => {
        ...
        this.props.onChange({
            // @ts-expect-error - TS2345 - Argument of type '{ current: { content: string; }[]; }' is not assignable to parameter of type '{ hints?: readonly Hint[] | undefined; replace?: boolean | undefined; content?: string | undefined; widgets?: PerseusWidgetsMap | undefined; images?: PerseusImagesMap | undefined; ... 13 more ...; plot?: any; }'.
            current: list,
        });
