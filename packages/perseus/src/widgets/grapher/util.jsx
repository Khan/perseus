...
export const allTypes: $FlowFixMe = _.keys(functionTypeMapping);
...
export const getEquationString = (props: $FlowFixMe): string => {
...
export const DEFAULT_GRAPHER_PROPS: $FlowFixMe = {
    graph: defaultGraph,
    plot: defaultPlot,
    availableTypes: [defaultPlot.type],
};

export const typeToButton = (type: string): $FlowFixMe => {
