...
export type ImageUploader = (file: string, callback: (url: string) => unknown) => unknown;
...
export type APIOptions = Readonly<{
    ...
    onInputError?: (widgetId: any, value: string, message?: string | null | undefined) => unknown,
    onFocusChange?: (
    ...
    groupAnnotator?: (groupNumber: number, widgetId: string) => React.ReactElement<any> | null | undefined,
...
export type DomInsertCheckFn = (text: string, node: HTMLElement, attribute?: string, jiptString?: string) => string | false;
...
interface StaticUrlFn {
    ...
    (maybeRelativeUrl?: undefined | null | undefined): undefined | null | undefined;
}
...
export type PerseusDependencies = {
    ...
    logKaTeXError: (expression: string, error: Error) => Promise<Response | null | undefined>,
    ...
    // framework.
    useVideo(id: string, kind: VideoKind): Result<{
...
export type APIOptionsWithDefaults = Readonly<(APIOptions) & {
...
export type WidgetTransform = (arg1: WidgetOptions, problemNumber?: number) => any;

export type WidgetExports<T extends React.ComponentType<any> = React.ComponentType<any>> = Readonly<{
    name: string,
    displayName: string,
...
export type FilterCriterion = string | ((id: string, widgetInfo: WidgetInfo, widget?: Widget | null | undefined) => boolean);
...
export type ChangeFn = (
    newPropsOrSinglePropName: string | {
        [key: string]: any
    },
    propValue?: any,
    callback?: () => unknown,
