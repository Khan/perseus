  ...
  var parser = (function() {
    var parser = {
      ...
      performAction: function anonymous(
        ...
        switch (yystate) {
          ...
          case 5:
            ...
            break;
          case 6:
            this.$ = yy.Add.createOrAppend(
              $$[$0 - 2],
              yy.Mul.handleNegative($$[$0], 'subtract')
            );
            break;
          case 7:
            this.$ = $$[$0];
      ...
      table: [
        ...
        { 8: [1, 36], 10: [1, 37], 33: [1, 67] },
        { 8: [1, 36], 10: [1, 37], 35: [1, 68] },
        {
          7: 69,
          9: 5,
          10: [1, 7],
        ...
        { 8: [1, 36], 10: [1, 37], 41: [1, 72] },
        { 8: [1, 36], 10: [1, 37], 43: [1, 73] },
        {
          7: 74,
          9: 5,
          10: [1, 7],
        ...
        { 8: [1, 36], 10: [1, 37], 35: [1, 77] },
        { 8: [1, 36], 10: [1, 37], 33: [1, 78] },
        { 8: [1, 36], 10: [1, 37], 35: [1, 79] },
        {
          5: [2, 38],
          6: [2, 38],
          8: [2, 38],
  ...
  _.extend(Mul, {
    ...
    handleDivide: function(left, right) {
      ...
      if (isInt(right) && left instanceof Mul && _.any(left.terms, isInt)) {
        ...
        if (!isInt(num)) {
          return new Mul(
            left.terms.concat([new Rational(1, right.n).addHint('fraction')])
          );
        }
    ...
    fold: function(expr) {
      if (expr instanceof Mul) {
        ...
        var trigLog = _.find(_.initial(expr.terms), function(term) {
          return (
            (term instanceof Trig || term instanceof Log) && term.hints.open
          );
        });
  ...
  _.extend(Eq.prototype, {
    ...
    sameForm: function(other) {
      ...
      if (eq1.isEquality()) {
        ...
        return (
          same || (eq1.left.sameForm(eq2.right) && eq1.right.sameForm(eq2.left))
        );
      } else {
        return same;
      }
