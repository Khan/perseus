...
export default {
    ...
    hints: [
        ...
        {
            content:
                "Only one expression matches all three clues in the description:\\n\\n$\\\\goldD{7}x^\\\\blueD{5}+2x^2+\\\\greenD{6}$",
            widgets: {},
            replace: false,
            metadata: null,
            images: {},
