...
export default {
    ...
    question: {
        content:
            "Stella's friends got her a skydiving lesson for her birthday. Her helicopter took off from the skydiving center, ascending in an angle of $37^\\circ$, and traveled a distance of $2.1$ kilometers before she fell in a straight line perpendicular to the ground.\n \n**How far from the skydiving center did Stella land?** \n*Round your final answer to the nearest hundredth.*\n\n[[☃ numeric-input 1]] kilometers\n \n\n\n[[☃ image 1]]\n\n",
        images: {},
        widgets: {
            "image 1": {
                alignment: "block",
                ...
                options: {
                    answers: [
                        ...
                        },
                        {
                            maxError: 0.2,
                            message:
                                "You probably solved correctly but your answer is not precise enough. Try rounding only at the last step of your solution.",
                            simplify: "accepted",
                            status: "ungraded",
                            strict: false,
                            value: 1.68,
                        },
                        {
                            maxError: 0.5,
                            message:
                                "You probably used radians instead of degrees. Make sure your calculator is set to degrees.",
                            simplify: "accepted",
                            status: "ungraded",
                            strict: false,
                            value: 1.61,
                        },
                        {
                            maxError: 0.1,
                            message:
                                "This is the height of Stella's fall. We asked for the distance from her landing point to the skydiving center.",
                            simplify: "required",
                            status: "wrong",
                            strict: false,
                            value: 1.2,
