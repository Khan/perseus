...
export default {
    ...
    hints: [
        ...
        },
        {
            replace: false,
            content:
                "Taking the vertical component of $B_E$,\n\n$\\begin{align} \n\\purpleD{B_V} &= B_E \\sin I \\\\\\\\\n&= B_E \\sin 45\\degree \n \\end{align}$\n\n[[☃ explanation 1]]",
            images: {},
            widgets: {
                "explanation 1": {
                    type: "explanation",
        ...
        },
        {
            replace: false,
            content:
                "The vertical component of the magnetic field vector is:\n\n$B_E\\ \\sin{45\\degree}\\downarrow$\n",
            images: {},
            widgets: {},
        },
    ],
