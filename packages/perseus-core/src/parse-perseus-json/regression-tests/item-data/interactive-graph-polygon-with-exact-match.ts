...
export default {
    ...
    question: {
        content:
            "**Click on the graph to draw a rhombus with an acute angle at $(0, 3)$, another vertex at $(3,7)$, side length of $5$ units, and two sides parallel to the $x$-axis.**  \n\nDraw the rhombus in the first quadrant.\n\n\n\n[[☃ interactive-graph 1]]",
        images: {},
        widgets: {
            "interactive-graph 1": {
                graded: true,
