        ...
        widgets: {
            "image 1": {
                ...
                options: {
                    ...
                    caption:
                        "*Incandescent light bulbs with tungsten filaments*",
                },
                version: {
                    major: 0,
                    minor: 0,
    ...
    hints: [
        {
            replace: false,
            content:
                "To solve this problem, we need to identify the connection between what we’re given and what we want to find. We’re given the amount of tungsten in *grams*, and we’re asked to find how many *atoms* that represents.\n\nThere’s no single quantity that converts from grams to the number of atoms, so we must use multiple conversion factors. ",
            images: {},
            widgets: {},
        },
        {
        ...
        },
        {
            replace: false,
            content:
                "There are $5.77\\times 10^{19}$ atoms of tungsten in the light bulb filament. ",
            images: {},
            widgets: {},
        },
    ],
