...
export default {
    ...
    hints: [
        ...
        },
        {
            replace: false,
            content:
                "Let Michael's current age be $m$ and Brandon's current age be $b$.",
            images: {},
            widgets: {},
        },
        {
        ...
        },
        {
            replace: false,
            content:
                "Seventeen years ago, Michael was $m - 17$ years old, and Brandon was $b - 17$ years old.",
            images: {},
            widgets: {},
        },
        {
        ...
        },
        {
            replace: false,
            content:
                "Because we are looking for $m$, it might be easiest to solve our first equation for $b$ and substitute it into our second equation.",
            images: {},
            widgets: {},
        },
        {
            replace: false,
            content:
                "Solving our first equation for $b$, we get: $\\blue{b = m - 12}$. Substituting this into our second equation, we get the equation: \n\n  $\\red{m - 17 = 4(} \\blue{(m - 12)}\\red{ - 17)}$ \n\n which combines the information about $m$ from both of our original equations.",
            images: {},
            widgets: {},
        },
        {
            replace: false,
            content:
                "Simplifying the right side of this equation, we get: $m - 17 = 4m - 116$.",
            images: {},
            widgets: {},
        },
        {
