...
const parsePossiblyInvalidAnswerForm = looseObject({
...
const version2 = looseObject({major: constant(2), minor: number});
...
const version1 = looseObject({major: constant(1), minor: number});
