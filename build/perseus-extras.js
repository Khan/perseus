...
/***/ function(module, exports, __webpack_require__) {
	...
	var Changeable = __webpack_require__(83);
	...
	var InlineIcon = __webpack_require__(84);

	var Renderer = __webpack_require__(8);

	var Util = __webpack_require__(19);

	var mediaQueries = __webpack_require__(93);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateQueryString = __webpack_require__(19).updateQueryString;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var styleConstants = __webpack_require__(34);

	var captureScratchpadTouchStart = __webpack_require__(19).captureScratchpadTouchStart;
	...
	var Dropdown = React.createClass({
	    ...
	    render: function render() {
	        ...
	        if (this.props.apiOptions.fancyDropdowns) return React.createElement(FancySelect, {
	            onChange: this._handleChange,
	            className: selectClasses + " " + ApiClassNames.INTERACTIVE,
	            value: this.props.selected
	        }, React.createElement(FancyOption, {
	            value: 0,
	            visible: false
	        }, React.createElement("span", {
	            ...
	            return React.createElement(FancyOption, {
	                key: i + 1,
	                value: i + 1,
	                visible: true
	            }, choice);
	        }));
	        var mobileStyling = this.props.apiOptions.xomManatee;
	        return React.createElement("select", {
	            onChange: this._handleChangeEvent,
	            onTouchStart: captureScratchpadTouchStart,
	            className: selectClasses + " " + css(mobileStyling && styles.dropdownMobile) + " " + ApiClassNames.INTERACTIVE,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _explanationLink, _xomExplanationLink;
	...
	var styles = StyleSheet.create({
	    ...
	    xomExplanationLink: (_xomExplanationLink = {
	        color: styleConstants.kaGreen,
	        borderBottom: "dashed 1px " + styleConstants.kaGreen,
	        textDecoration: "none"
	    }, _xomExplanationLink[mediaQueries.xl] = {
	        fontSize: 22,
	        lineHeight: 1.4
	    }, _xomExplanationLink[mediaQueries.lgOrSmaller] = {
	        fontSize: 20,
	        lineHeight: 1.5
	    }, _xomExplanationLink[mediaQueries.smOrSmaller] = {
	        fontSize: 18,
	        lineHeight: 1.2
	    }, _xomExplanationLink),
	    content: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var knumber = __webpack_require__(125).number;

	var kvector = __webpack_require__(125).vector;

	var kpoint = __webpack_require__(125).point;
	...
	var _require4 = __webpack_require__(116);
	...
	var FunctionGrapher = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var pointForCoord = function pointForCoord(coord, i) {
	            return React.createElement(MovablePoint, {
	                ...
	                xomManatee: _this.props.xomManatee
	            });
	        };
	    ...
	    renderPlot: function renderPlot() {
	        ...
	        var style = _extends({
	            stroke: this.props.xomManatee ? KhanColors.BLUE_C : KhanColors.DYNAMIC
	        }, this.props.xomManatee ? {
	            "stroke-width": 3
	        } : {});
	    ...
	    renderAsymptote: function renderAsymptote() {
	        ...
	        return asymptote && React.createElement(MovableLine, {
	            ...
	            return React.createElement(MovablePoint, {
	                ...
	                xomManatee: _this2.props.xomManatee
	            });
	        }));
	    }
	});
	    ...
	    _setupGraphie: function _setupGraphie(graphie, options) {
	        ...
	        if ("graph" === options.markings) {
	            graphie.graphInit({
	                ...
	                snapStep: options.snapStep,
	                tickStep: xomManatee ? [ 2, 2 ] : _.pluck(options.gridConfig, "tickStep"),
	                labelStep: 1,
	                unityLabels: _.pluck(options.gridConfig, "unityLabel"),
	                xomManatee: xomManatee
	            });
	            graphie.label([ 0, options.range[1][1] ], options.labels[1], xomManatee ? "below right" : "above");
	            graphie.label([ options.range[0][1], 0 ], options.labels[0], xomManatee ? "above left" : "right");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GradedGroup = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var classes = classNames((_classNames = {}, _classNames[css(styles.gradedGroup)] = apiOptions.xomManatee && !this.props.transparentBackground, 
	        _classNames["perseus-graded-group"] = true, _classNames["answer-correct"] = apiOptions.xomManatee ? false : this.state.status === GRADING_STATUSES.correct, 
	        _classNames["answer-incorrect"] = apiOptions.xomManatee ? false : this.state.status === GRADING_STATUSES.incorrect, 
	        _classNames));
	        var answerBarState = this.state.answerBarState;
	        ...
	        var readOnly = apiOptions.readOnly || apiOptions.xomManatee && isCorrect;
	        return React.createElement("div", {
	            className: classes
	        ...
	        })), !apiOptions.xomManatee && icon && React.createElement("div", {
	            className: "group-icon"
	        }, icon), !apiOptions.xomManatee && React.createElement("p", null, this.state.message), !apiOptions.xomManatee && React.createElement("input", {
	            type: "button",
	            value: i18n._("Check"),
	        ...
	        }, i18n._("Explain"))), apiOptions.xomManatee && answerBarState !== ANSWER_BAR_STATES.HIDDEN && React.createElement(GradedGroupAnswerBar, {
	            apiOptions: apiOptions,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GradedGroup = __webpack_require__(43).widget;
	...
	var InteractiveGraph = React.createClass({
	    ...
	    addLine: function addLine(type) {
	        ...
	        var points = self.points = _.map(coords, function(coord) {
	            return Interactive2.addMaybeXOMMovablePoint(_this2, {
	                coord: coord,
	        ...
	        var lineConfig = {
	            ...
	            normalStyle: _extends({
	                stroke: this.props.apiOptions.xomManatee ? KhanColors.BLUE_C : KhanColors.INTERACTIVE
	            }, this._lineStroke())
	        };
	    ...
	    updateQuadratic: function updateQuadratic() {
	        ...
	        if (this.parabola) {
	            ...
	            this.parabola.attr(_extends({
	                stroke: this.props.apiOptions.xomManatee ? KhanColors.BLUE_C : KhanColors.DYNAMIC
	            }, this._lineStroke()));
	    ...
	    addLinearSystemControls: function addLinearSystemControls() {
	        ...
	        var points = this.points = _.map(coords, function(segmentCoords, segmentIndex) {
	            var segmentPoints = _.map(segmentCoords, function(coord, i) {
	                return Interactive2.addMaybeXOMMovablePoint(_this6, {
	                    coord: coord,
	                    constraints: [ Interactive2.MovablePoint.constraints.bound(), Interactive2.MovablePoint.constraints.snap(), function(coord) {
	    ...
	    createPointForPointsType: function createPointForPointsType(coord, i) {
	        ...
	        var point = Interactive2.addMaybeXOMMovablePoint(this, _extends({
	            coord: coord,
	            constraints: [ Interactive2.MovablePoint.constraints.bound(), Interactive2.MovablePoint.constraints.snap(), function(coord) {
	    ...
	    addSegmentControls: function addSegmentControls() {
	        ...
	        var createPoint = function createPoint(options) {
	            return Interactive2.addMaybeXOMMovablePoint(_this8, options);
	        };
	        this.points = [];
	        this.lines = _.map(coords, function(segment, i) {
	            ...
	            var line = Interactive2.addMovableLine(graphie, {
	                ...
	                highlightStyle: _extends({
	                    stroke: this.props.apiOptions.xomManatee ? KhanColors.BLUE_C : KhanColors.INTERACTING
	                }, this._lineStroke())
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SimpleKeypadInput = __webpack_require__(74);

	var ApiOptions = __webpack_require__(18).Options;

	var KhanAnswerTypes = __webpack_require__(71);

	var keypadElementPropType = __webpack_require__(72).propTypes.keypadElementPropType;

	var assert = __webpack_require__(108).assert;

	var stringArrayOfSize = __webpack_require__(19).stringArrayOfSize;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var shuffle = __webpack_require__(19).shuffle;

	var seededRNG = __webpack_require__(19).seededRNG;
	...
	var NumberLine = React.createClass({
	    ...
	    _renderGraphie: function _renderGraphie() {
	        ...
	        return React.createElement(Graphie, {
	            ...
	            setup: this._setupGraphie,
	            setDrawingAreaAvailable: this.props.apiOptions.setDrawingAreaAvailable
	        }, React.createElement(TickMarks, _.pick(props, [ "range", "numDivisions", "labelTicks", "labelStyle", "labelRange", "tickStep" ])), this._renderInequality(props), this._renderNumberLinePoint(props));
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PassageMarkdown = __webpack_require__(120);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deepEq = __webpack_require__(19).deepEq;
	...
	var Plotter = React.createClass({
	    ...
	    setupGraphie: function setupGraphie(prevState) {
	        ...
	        var plotDimensions = xomManatee ? [ 288, 336 ] : self.props.plotDimensions;
	        if (isLine) c.dimX += 1; else if (isHistogram) {
	            c.barPad = 0;
	            c.barWidth = 1;
	        } else if (isBar) {
	            c.barPad = xomManatee ? .08 : .15;
	        ...
	        var padX = 25;
	        var padY = 25;
	        isBar && xomManatee && (padX = 0 !== self.props.labels[1].length ? 17 : 11);
	        // Since dotplot doesn't have an axis along the left it looks weird
	        // with the same padding as the others
	        isDotplot && (padX /= 2);
	        xomManatee && isTiledPlot && 0 === self.props.labels[1].length && (padX = 0);
	        xomManatee ? c.scale = _.map([ [ c.dimX, padX ], [ c.dimY, padY ] ], // We multiply pad by 4 because we add 3*pad padding on the left
	        ...
	        if (!isTiledPlot) for (var y = 0; y <= c.dimY; y += c.scaleY) {
	            ...
	            graphie.style({
	                ...
	                strokeWidth: 1,
	                opacity: xomManatee ? 1 : .3
	            }, function() {
	                graphie.line([ 0, y ], [ c.dimX, y ]);
	            });
	        }
	        isBar && xomManatee && (self.graphie.dragPrompt = graphie.label([ c.dimX / 2, c.dimY / 2 ], "Drag handles to make graph", "center", false).css("font-weight", "bold").css("color", KhanColors.KA_GREEN).css("display", "none"));
	        self.setupCategories(config);
	        isTiledPlot && xomManatee && (self.graphie.dotPrompt = graphie.label([ c.dimX / 2, c.dimY / 2 ], "Tap to add points", "center", false).css("font-weight", "bold").css("color", KhanColors.KA_GREEN).css("display", "none"));
	        ...
	        graphie.style({
	            ...
	            graphie.style({
	                ...
	                return graphie.line([ xomManatee ? 0 : .5, 0 ], [ c.dimX - (xomManatee ? 0 : .5), 0 ]);
	            }); else {
	                graphie.line([ 0, 0 ], [ c.dimX, 0 ]);
	                // Draw the left axis for non-dotplots
	                0 === self.props.labels[1].length && xomManatee || graphie.style({
	                    stroke: xomManatee ? KhanColors.GRAY_G : "#000"
	                }, function() {
	                ...
	                graphie.style({
	                    ...
	                    return graphie.line([ 0, 0 ], [ c.dimX, 0 ]);
	                });
	                isBar && xomManatee || graphie.style({
	                    stroke: xomManatee ? KhanColors.GRAY_G : "#000",
	                    strokeWidth: xomManatee ? 1 : 2
	                }, function() {
	                    return graphie.line([ 0, 0 ], [ 0, c.dimY ]);
	        ...
	        graphie.label([ c.dimX / 2, (xomManatee ? -85 : -35) / c.scale[1] ], self.props.labels[0], xomManatee ? "above" : "below", false).css("font-weight", "bold").css("color", xomManatee && KhanColors.GRAY_F);
	        graphie.label([ (xomManatee ? -35 : -60) / c.scale[0], c.dimY / 2 ], self.props.labels[1], "center", false).css("font-weight", "bold").css("color", xomManatee && KhanColors.GRAY_F).addClass("rotate");
	    },
	    labelCategory: function labelCategory(x, category) {
	        ...
	        var labelRotation = "translateX(-50%) translateX(10px) translateY(-50%) translateY(10px) rotate(-45deg)";
	        graphie.style({
	            color: xomManatee ? KhanColors.GRAY_G : "inherit",
	            transform: xomManatee && !mathyCategory ? labelRotation : "none",
	            transformOrigin: "100%"
	        }, function() {
	            return graphie.label([ x, xomManatee ? -.5 : 0 ], category, "below", isTeX);
	        });
	    },
	    setupCategories: function setupCategories(config) {
	        ...
	        if (self.props.type === HISTOGRAM) {
	            ...
	            self.props.type !== DOTPLOT || xomManatee || (tickStart = -tickEnd);
	    ...
	    setupBar: function setupBar(args) {
	        ...
	        var x;
	        x = isHistogram ? .5 + i * config.barWidth + barHalfWidth : (xomManatee ? barHalfWidth : .5 + config.barPad) + i;
	        /**
	        ...
	        var scaleBar = function scaleBar(i, height) {
	            ...
	            config.graph.bars[i].scale(1, Math.max(xomManatee ? .2 : .01, height / config.scaleY), center[0], center[1]);
	            if (isHistogram) {
	        ...
	        if (xomManatee) !function() {
	            var snap = config.scaleY / self.props.snapsPerLine;
	            config.graph.lines[i] = Interactive2.addMaybeXOMMovablePoint(_this, {
	                coord: [ x, startHeight ],
	                constraints: [ function(coord, prev, options) {
	                    return [ x, _this._clampValue(Math.round(coord[1] / snap) * snap, .2, config.dimY) ];
	                } ],
	                onMove: function onMove() {
	                    ...
	                    graphie.dragPrompt[0].style.display = shouldDisplay ? "inline" : "none";
	                    scaleBar(i, y);
	                }
	            });
	            var shouldDisplay = self.state.values.every(function(v) {
	                return 0 === v;
	            });
	            graphie.dragPrompt[0].style.display = shouldDisplay ? "inline" : "none";
	        }(); else {
	    ...
	    setupDotplot: function setupDotplot(i, config) {
	        ...
	        return this.setupTiledPlot(i, 1, config, function(x, y) {
	            return graphie.ellipse([ x, y ], [ _this2.DOT_PLOT_POINT_SIZE() / graphie.scale[0], _this2.DOT_PLOT_POINT_SIZE() / graphie.scale[1] ], {
	                fill: KhanColors.INTERACTIVE,
	                stroke: KhanColors.INTERACTIVE
	            });
	        });
	    ...
	    setupPic: function setupPic(i, config) {
	        ...
	        return this.setupTiledPlot(i, 0, config, function(x, y) {
	            ...
	            var size = _this3.props.picSize;
	            return graphie.raphael.image(_this3.props.picUrl, scaledCenter[0] - size / 2, scaledCenter[1] - size / 2, size, size);
	        });
	    },
	    ...
	    drawPicHeights: function drawPicHeights(values, prevValues) {
	        ...
	        _.each(pics, function(ps, i) {
	            _.each(ps, function(pic, j) {
	                ...
	                graphie.dotTicks[i][j][0].style.display = show || !xomManatee ? "none" : "inline";
	            });
	        });
	    },
	    getUserInput: function getUserInput() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Molecule = __webpack_require__(54).molecule;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getGridStep = __webpack_require__(19).getGridStep;
	...
	var kray = __webpack_require__(125).ray;

	var kline = __webpack_require__(125).line;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// value?
	var lens = __webpack_require__(91);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FixedToResponsive = __webpack_require__(77);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GradedGroupAnswerBar = React.createClass({
	    ...
	    render: function render() {
	        ...
	        // empty span keeps the button the right side
	        return answerBarState !== ANSWER_BAR_STATES.CORRECT ? React.createElement("div", {
	...
	var Graph = React.createClass({
	    ...
	    _setupGraphie: function _setupGraphie(initialMount) {
	        ...
	        if ("graph" === this.props.markings) {
	            ...
	            graphie.label([ 0, range[1][1] ], labels[1], this.props.xomManatee ? "below right" : "above");
	            graphie.label([ range[0][1], 0 ], labels[0], this.props.xomManatee ? "above left" : "right");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var firstNumericalParse = __webpack_require__(19).firstNumericalParse;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SimpleMarkdown = __webpack_require__(92);
