...
/***/ function(module, exports, __webpack_require__) {
	...
	var mediaQueries = __webpack_require__(40);

	var sharedStyles = __webpack_require__(41);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var styleConstants = __webpack_require__(42);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Interactive2 = __webpack_require__(104);

	var SvgImage = __webpack_require__(33);

	var Util = __webpack_require__(17);

	var ButtonGroup = __webpack_require__(105);
	...
	var WrappedLine = __webpack_require__(106);
	...
	var KhanColors = __webpack_require__(107);

	var _require = __webpack_require__(77), containerSizeClassPropType = _require.containerSizeClassPropType;

	var _require2 = __webpack_require__(42), interactiveSizes = _require2.interactiveSizes;

	var _require3 = __webpack_require__(77), getInteractiveBoxFromSizeClass = _require3.getInteractiveBoxFromSizeClass;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require = __webpack_require__(89), iconOk = _require.iconOk, iconRemove = _require.iconRemove;
	...
	var _require2 = __webpack_require__(42), gray76 = _require2.gray76, phoneMargin = _require2.phoneMargin, negativePhoneMargin = _require2.negativePhoneMargin, tableBackgroundAccent = _require2.tableBackgroundAccent, kaGreen = _require2.kaGreen;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require2 = __webpack_require__(42), grayLight = _require2.grayLight, gray76 = _require2.gray76, tableBackgroundAccent = _require2.tableBackgroundAccent, kaGreen = _require2.kaGreen, phoneMargin = _require2.phoneMargin, negativePhoneMargin = _require2.negativePhoneMargin;
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _require2 = __webpack_require__(42), baseUnitPx = _require2.baseUnitPx;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require = __webpack_require__(42), interactiveSizes = _require.interactiveSizes;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HighlightableContent = __webpack_require__(125);

	var Renderer = __webpack_require__(8);

	var PassageMarkdown = __webpack_require__(127);

	var babelPluginFlowReactPropTypes_proptype_ChangeableProps = __webpack_require__(85).babelPluginFlowReactPropTypes_proptype_ChangeableProps || __webpack_require__(10).PropTypes.any;

	var babelPluginFlowReactPropTypes_proptype_SerializedHighlight = __webpack_require__(126).babelPluginFlowReactPropTypes_proptype_SerializedHighlight || __webpack_require__(10).PropTypes.any;
	...
	var Passage = function(_React$Component2) {
	    ...
	    Passage.prototype.wordsInSection = function wordsInSection(section) {
	        ...
	        return section.split(/\s+/).filter(function(word) {
	    ...
	    Passage.prototype.getSelectionIndex = function getSelectionIndex(selection, nodeType) {
	        ...
	        while (node && !(node.classList && node.classList.contains("passage-text"))) {
	            while (node.previousSibling) {
	                ...
	                (punctuation.indexOf(lastChar) !== -1 || !node.nextSibling || "_" === lastChar && node.nextSibling.textContent.charAt(0).match(/[\w ]/)) && priorText.length > 0 && (spacer = " ");
	    ...
	    Passage.prototype.stringToArrayOfWords = function stringToArrayOfWords(rawContent) {
	        ...
	        return (_ref3 = []).concat.apply(_ref3, nestedFragments).filter(function(fragment) {
	            return "" !== fragment;
	        });
	    };
	    /**
	    ...
	    Passage.prototype.adjustIndexforMarkdownAndWhitespace = function adjustIndexforMarkdownAndWhitespace(index, textArray) {
	        ...
	        for (var i = 0; i <= stopIter; i++) {
	            (textArray[i].match(/^\s+$/) || [ "{highlighting.end}{highlighting.start}", "{highlighting.end}", "{highlighting.start}" ].includes(textArray[i])) && index++;
	        }
	        return index;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require = __webpack_require__(89), iconOk = _require.iconOk;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require = __webpack_require__(89), iconStar = _require.iconStar, iconTryAgain = _require.iconTryAgain;

	var _require2 = __webpack_require__(42), boldFontFamily = _require2.boldFontFamily, gray68 = _require2.gray68, gray76 = _require2.gray76, gray85 = _require2.gray85, gray95 = _require2.gray95, kaGreen = _require2.kaGreen, phoneMargin = _require2.phoneMargin, negativePhoneMargin = _require2.negativePhoneMargin;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactComponentsInfoTip = __webpack_require__(148);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HighlightingUI = __webpack_require__(159);
	...
	var babelPluginFlowReactPropTypes_proptype_DOMRange = __webpack_require__(126).babelPluginFlowReactPropTypes_proptype_DOMRange || __webpack_require__(10).PropTypes.any;

	var babelPluginFlowReactPropTypes_proptype_SerializedHighlight = __webpack_require__(126).babelPluginFlowReactPropTypes_proptype_SerializedHighlight || __webpack_require__(10).PropTypes.any;

	var babelPluginFlowReactPropTypes_proptype_DOMHighlight = __webpack_require__(126).babelPluginFlowReactPropTypes_proptype_DOMHighlight || __webpack_require__(10).PropTypes.any;
	...
	HighlightableContent.propTypes = {
	    ...
	    serializedHighlights: __webpack_require__(10).PropTypes.arrayOf(babelPluginFlowReactPropTypes_proptype_SerializedHighlight).isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(module.exports, "babelPluginFlowReactPropTypes_proptype_DOMHighlight", __webpack_require__(10).PropTypes.shape({
	    key: __webpack_require__(10).PropTypes.string.isRequired,
	    range: __webpack_require__(10).PropTypes.any.isRequired
	}));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HighlightRenderer = __webpack_require__(187);

	var SelectionTracker = __webpack_require__(188);

	var babelPluginFlowReactPropTypes_proptype_ZIndexes = __webpack_require__(189).babelPluginFlowReactPropTypes_proptype_ZIndexes || __webpack_require__(10).PropTypes.any;

	var babelPluginFlowReactPropTypes_proptype_Position = __webpack_require__(189).babelPluginFlowReactPropTypes_proptype_Position || __webpack_require__(10).PropTypes.any;

	var babelPluginFlowReactPropTypes_proptype_DOMRange = __webpack_require__(189).babelPluginFlowReactPropTypes_proptype_DOMRange || __webpack_require__(10).PropTypes.any;

	var babelPluginFlowReactPropTypes_proptype_DOMHighlight = __webpack_require__(189).babelPluginFlowReactPropTypes_proptype_DOMHighlight || __webpack_require__(10).PropTypes.any;
	...
	var HighlightingUI = function(_React$PureComponent) {
	    ...
	    HighlightingUI.prototype.componentDidMount = function componentDidMount() {
	        var willListen = this._shouldListenToMouseMove(this.props);
	        this._updateMouseMoveListener(false, willListen);
	    };
	    HighlightingUI.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
	        var wasListening = this._shouldListenToMouseMove(this.props);
	        var willListen = this._shouldListenToMouseMove(nextProps);
	    ...
	    HighlightingUI.prototype._shouldListenToMouseMove = function _shouldListenToMouseMove(props) {
	     ...
	     */
	    HighlightingUI.prototype._updateMouseMoveListener = function _updateMouseMoveListener(wasListening, willListen) {
	    ...
	    HighlightingUI.prototype.render = function render() {
	        ...
	        }), this.props.editable && React.createElement(SelectionTracker, {
	...
	HighlightingUI.propTypes = {
	    editable: __webpack_require__(10).PropTypes.bool.isRequired,
	    highlights: __webpack_require__(10).PropTypes.arrayOf(babelPluginFlowReactPropTypes_proptype_DOMHighlight).isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	function mergeRanges(a, b) {
	    if (compareRangeBoundaryPoints(a, "end", b, "start") < 0 || compareRangeBoundaryPoints(b, "end", a, "start") < 0) return null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var babelPluginFlowReactPropTypes_proptype_Rect = __webpack_require__(189).babelPluginFlowReactPropTypes_proptype_Rect || __webpack_require__(10).PropTypes.any;
	...
	var HighlightRenderer = function(_React$PureComponent) {
	    ...
	    HighlightRenderer.prototype._getRects = function _getRects() {
	        ...
	        return Array.prototype.map.call(domRects, function(domRect) {
	            var _getRelativePosition = getRelativePosition(domRect, offsetParentRect);
	            return {
