...
/***/ function(module, exports, __webpack_require__) {
	...
	var Graphie = __webpack_require__(96);
	...
	var _require = __webpack_require__(89), containerSizeClassPropType = _require.containerSizeClassPropType;

	var _require2 = __webpack_require__(42), interactiveSizes = _require2.interactiveSizes;

	var _require3 = __webpack_require__(89), getInteractiveBoxFromSizeClass = _require3.getInteractiveBoxFromSizeClass;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require2 = __webpack_require__(89), containerSizeClassPropType = _require2.containerSizeClassPropType, getInteractiveBoxFromSizeClass = _require2.getInteractiveBoxFromSizeClass;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SimpleKeypadInput = __webpack_require__(78);

	var ApiOptions = __webpack_require__(18).Options;

	var KhanAnswerTypes = __webpack_require__(76);

	var keypadElementPropType = __webpack_require__(88).propTypes.keypadElementPropType;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var babelPluginFlowReactPropTypes_proptype_ChangeableProps = __webpack_require__(83).babelPluginFlowReactPropTypes_proptype_ChangeableProps || __webpack_require__(11).PropTypes.any;

	var babelPluginFlowReactPropTypes_proptype_SerializedHighlight = __webpack_require__(126).babelPluginFlowReactPropTypes_proptype_SerializedHighlight || __webpack_require__(11).PropTypes.any;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FixedToResponsive = __webpack_require__(95);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HighlightsRenderer = __webpack_require__(150);

	var WordIndexer = __webpack_require__(151);

	var _require2 = __webpack_require__(152), addHighlight = _require2.addHighlight, deserializeHighlight = _require2.deserializeHighlight, serializeHighlight = _require2.serializeHighlight;

	var babelPluginFlowReactPropTypes_proptype_DOMRange = __webpack_require__(126).babelPluginFlowReactPropTypes_proptype_DOMRange || __webpack_require__(11).PropTypes.any;

	var babelPluginFlowReactPropTypes_proptype_SerializedHighlight = __webpack_require__(126).babelPluginFlowReactPropTypes_proptype_SerializedHighlight || __webpack_require__(11).PropTypes.any;

	var babelPluginFlowReactPropTypes_proptype_DOMHighlight = __webpack_require__(126).babelPluginFlowReactPropTypes_proptype_DOMHighlight || __webpack_require__(11).PropTypes.any;
	...
	var HighlightableContent = function(_React$PureComponent) {
	    ...
	    function HighlightableContent() {
	        ...
	        _this), _this.state = {
	            ...
	            var selectionRange = selection && selection.rangeCount && selection.getRangeAt(0);
	    ...
	    /* eslint-disable react/sort-comp */
	    /* eslint-enable react/sort-comp */
	    HighlightableContent.prototype.componentDidMount = function componentDidMount() {
	        document.addEventListener("selectionchange", this._handleSelectionChange);
	    };
	    HighlightableContent.prototype.componentWillUnmount = function componentWillUnmount() {
	    ...
	    HighlightableContent.prototype.render = function render() {
	        return React.createElement("div", null, React.createElement("div", {
	            ...
	            className: css(styles.highlights)
	        }, React.createElement(HighlightsRenderer, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SingleHighlightRenderer = function(_React$PureComponent) {
	    _inherits(SingleHighlightRenderer, _React$PureComponent);
	    /* eslint-enable react/sort-comp */
	    /* eslint-disable react/sort-comp */
	    function SingleHighlightRenderer(props) {
	        _classCallCheck(this, SingleHighlightRenderer);
	        var _this = _possibleConstructorReturn(this, _React$PureComponent.call(this, props));
	        _this._handleGlobalClick = function(e) {
	            ...
	            _this._highlightIsHovered(mouseClientPosition) && _this.props.onClick(_this.props.highlight.key);
	        };
	        _this.state = {
	            cachedHighlightRects: _this._getRects(props)
	        };
	        return _this;
	    }
	    SingleHighlightRenderer.prototype.componentDidMount = function componentDidMount() {
	    ...
	    SingleHighlightRenderer.prototype.componentWillUnmount = function componentWillUnmount() {
	        // TODO(mdr): When we move to an Add/Remove Highlight tooltip instead,
	        //     remove this global click listener entirely.
	        window.removeEventListener("mousedown", this._handleGlobalClick);
	    };
	    SingleHighlightRenderer.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
	     ...
	     * for CSS positioning.
	     */
	    SingleHighlightRenderer.prototype._getRects = function _getRects() {
	     ...
	     */
	    SingleHighlightRenderer.prototype._highlightIsHovered = function _highlightIsHovered(mouseClientPosition) {
	        var _this2 = this;
	     ...
	     */
	    SingleHighlightRenderer.prototype._rectIsHovered = function _rectIsHovered(rect, mouseOffsetPosition) {
	        var PositionWithinRect = {
	    ...
	    SingleHighlightRenderer.prototype.render = function render() {
	        var highlightIsHovered = this._highlightIsHovered(this.props.mouseClientPosition);
	        var rects = this.state.cachedHighlightRects;
	        return React.createElement("div", {
	            className: css(styles.highlight, highlightIsHovered && styles.hoveredHighlight)
	    ...
	    return SingleHighlightRenderer;
	}(React.PureComponent);

	SingleHighlightRenderer.propTypes = {
	    highlight: babelPluginFlowReactPropTypes_proptype_DOMHighlight,
	    mouseClientPosition: __webpack_require__(11).PropTypes.shape({
	...
	var HighlightsRenderer = function(_React$PureComponent2) {
	    _inherits(HighlightsRenderer, _React$PureComponent2);
	    function HighlightsRenderer() {
	        var _temp, _this3, _ret;
	        _classCallCheck(this, HighlightsRenderer);
	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
	        return _ret = (_temp = (_this3 = _possibleConstructorReturn(this, _React$PureComponent2.call.apply(_React$PureComponent2, [ this ].concat(args))), 
	        _this3), _this3.state = {
	            mouseClientPosition: null
	        }, _this3._container = null, _this3._handleMouseMove = function(e) {
	            _this3.setState({
	                mouseClientPosition: {
	                    left: e.clientX,
	                    top: e.clientY
	    ...
	    /* eslint-disable react/sort-comp */
	    /* eslint-enable react/sort-comp */
	    HighlightsRenderer.prototype.componentDidMount = function componentDidMount() {
	        window.addEventListener("mousemove", this._handleMouseMove);
	        // This component renders twice on mount; see `render` for details.
	        this.forceUpdate();
	    };
	    HighlightsRenderer.prototype.componentWillUnmount = function componentWillUnmount() {
	     ...
	     */
	    HighlightsRenderer.prototype.renderHighlights = function renderHighlights(container) {
	        var _this4 = this;
	        return this.props.highlights.map(function(highlight) {
	            return React.createElement(SingleHighlightRenderer, {
	                key: highlight.key,
	                highlight: highlight,
	                mouseClientPosition: _this4.state.mouseClientPosition,
	                offsetParent: container.offsetParent,
	                onClick: _this4.props.onRemoveHighlight
	            });
	        });
	    };
	    /**
	     ...
	     */
	    HighlightsRenderer.prototype.render = function render() {
	        var _this5 = this;
	        ...
	        // mount, then immediately again after mount. (We test whether we've
	        // mounted yet by testing our reference to `this._container`)
	        return this._container ? React.createElement("div", {
	            ref: function ref(container) {
	                return _this5._container = container;
	            }
	        }, this.renderHighlights(this._container)) : React.createElement("div", {
	            ref: function ref(container) {
	                return _this5._container = container;
	            }
	        });
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var _require = __webpack_require__(176), findFirstAndLastWordIndexes = _require.findFirstAndLastWordIndexes, mergeRanges = _require.mergeRanges, spanRanges = _require.spanRanges;
