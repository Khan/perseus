...
Perseus is in charge of creating, parsing, rendering, and scoring exercises.

A high-level overview:

1. Content is created using widget editors
2. We parse and migrate the data before using it
3. The renderers take the data and render a UI
4. We use the data and the user input to generate a score
